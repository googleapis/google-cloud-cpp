...
function bazel::msvc_args() {
  local args=(
    ...
    "--per_file_copt=^//google/cloud,-.*\.pb\.cc@-WX"
    ...
    # Disable the C4090 warning ('function': different 'const' qualifiers) on
    # upb-files and files generated by upb.
    "--per_file_copt=.*\.upb\.c,.*\.upbdefs\.c@/wd4090"
    "--per_file_copt=@com_github_grpc_grpc//.*\.c,@com_github_grpc_grpc//.*\.cc@/wd4090"
