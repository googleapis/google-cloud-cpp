...
RUN curl -fsSL https://github.com/protocolbuffers/protobuf/archive/v26.0-rc2.tar.gz | \
    tar -xzf - --strip-components=1 && \
    cmake \
        -DCMAKE_BUILD_TYPE=Release \
        -DBUILD_SHARED_LIBS=yes \
...
RUN curl -fsSL https://github.com/google/re2/archive/2024-02-01.tar.gz | \
    tar -xzf - --strip-components=1 && \
...
RUN curl -fsSL https://github.com/mozilla/sccache/releases/download/v0.7.6/sccache-v0.7.6-x86_64-unknown-linux-musl.tar.gz | \
