...
RUN curl -fsSL https://github.com/google/re2/archive/2023-11-01.tar.gz | \
    tar -xzf - --strip-components=1 && \
...
RUN curl -fsSL https://github.com/grpc/grpc/archive/v1.60.0-pre1.tar.gz | \
    tar -xzf - --strip-components=1 && \
    cmake \
...
RUN curl -fsSL https://github.com/mozilla/sccache/releases/download/v0.7.1/sccache-v0.7.1-x86_64-unknown-linux-musl.tar.gz | \
