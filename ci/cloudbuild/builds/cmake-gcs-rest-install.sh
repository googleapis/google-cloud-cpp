...
cmake --build "${out_dir}"
env -C "${out_dir}" GOOGLE_CLOUD_CPP_STORAGE_HAVE_REST_CLIENT=yes ctest "${ctest_args[@]}"
...
GOOGLE_CLOUD_CPP_STORAGE_HAVE_REST_CLIENT=yes quickstart::run_cmake_and_make "${INSTALL_PREFIX}"
