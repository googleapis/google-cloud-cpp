...
if should_run_integration_tests; then
  ...
  bazel_args+=(
    ...
    "--test_env=ENABLE_BIGTABLE_ADMIN_BACKUP_INTEGRATION_TESTS=${ENABLE_BIGTABLE_ADMIN_BACKUP_INTEGRATION_TESTS:-no}"
    "--test_env=ENABLE_BIGTABLE_ADMIN_BACKUP_ASYNC_INTEGRATION_TESTS=${ENABLE_BIGTABLE_ADMIN_BACKUP_ASYNC_INTEGRATION_TESTS:-no}"
    "--test_env=ENABLE_BIGTABLE_ADMIN_BACKUP_INTEGRATION_SNIPPETS=${ENABLE_BIGTABLE_ADMIN_BACKUP_INTEGRATION_SNIPPETS:-no}"
    "--test_env=ENABLE_BIGTABLE_ADMIN_BACKUP_ASYNC_INTEGRATION_SNIPPETS=${ENABLE_BIGTABLE_ADMIN_BACKUP_ASYNC_INTEGRATION_SNIPPETS:-no}"
