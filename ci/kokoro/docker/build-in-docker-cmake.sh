...
"${CMAKE_DRIVER}" "${CMAKE_DRIVER_ARGS[@]}" cmake \
...
if [[ "${TEST_INSTALL:-}" == "yes" ]]; then
  ...
  EXPECTED_LIB_DIRS=(
    ...
    "/var/tmp/staging/${libdir}/cmake/google_cloud_cpp_bigquery"
  ...
  EXPECTED_PROTO_DIRS=(
    ...
    "/var/tmp/staging/include/google/cloud/bigquery/storage/v1"
  ...
  EXPECTED_INCLUDE_DIRS=(
    ...
    "/var/tmp/staging/include/google/cloud/bigquery/mocks"
