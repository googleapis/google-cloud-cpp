...
if (Test-Integration-Enabled) {
    ...
    # Use RawRootsPath (Backslashes) for the MSVC binary env vars
    $env:GRPC_DEFAULT_SSL_ROOTS_FILE_PATH = $RawRootsPath
    $env:CURL_CA_BUNDLE = $RawRootsPath
    $env:SSL_CERT_FILE = $RawRootsPath
