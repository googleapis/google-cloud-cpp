...
(
  ...
  ci/retry-command.sh 3 60 curl -fsSL -o cmake.rb https://raw.githubusercontent.com/Homebrew/homebrew-core/fd21fcf239bcd0231c9fed5719403ec128151af4/Formula/cmake.rb
  mv cmake.rb ./Formula/
  ...
  ci/retry-command.sh 3 60 brew tap user/homebrew-tap "${HOME}/user/homebrew-tap"

  # Uninstall existing CMake and install CMake from the local tap
  brew uninstall cmake
  ci/retry-command.sh 3 60 brew install --build-from-source user/homebrew-tap/cmake
)
