...
some of the files generated by Protobuf. The `google-cloud-cpp` CMake files
disable the affected client libraries (with a warning). If these libraries are
important to you, openSUSE provides different versions of GCC. Install one of
these versions and configure CMake to use them.
...
curl -fsSL https://github.com/protocolbuffers/protobuf/archive/v24.3.tar.gz | \
    tar -xzf - --strip-components=1 && \
    cmake \
        -DCMAKE_BUILD_TYPE=Release \
        -DBUILD_SHARED_LIBS=yes \
...
curl -fsSL https://github.com/grpc/grpc/archive/v1.59.0.tar.gz | \
    tar -xzf - --strip-components=1 && \
    cmake \
        -DCMAKE_BUILD_TYPE=Release \
        -DBUILD_SHARED_LIBS=yes \
...
curl -fsSL https://github.com/google/re2/archive/2023-09-01.tar.gz | \
    tar -xzf - --strip-components=1 && \
