...
#define STORAGE_CLIENT_VCONCAT(Ma, Mi) v##Ma
#define STORAGE_CLIENT_VEVAL(Ma, Mi) STORAGE_CLIENT_VCONCAT(Ma, Mi)
#define STORAGE_CLIENT_NS                            \
  STORAGE_CLIENT_VEVAL(STORAGE_CLIENT_VERSION_MAJOR, \
