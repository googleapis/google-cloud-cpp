...
function run_all_instance_admin_examples() {
  ...
  ../examples/bigtable_samples_instance_admin create-instance "${project_id}" "${INSTANCE}" "${zone_id}"

  echo
  echo "Run list-instances example."
  ../examples/bigtable_samples_instance_admin list-instances "${project_id}"

  echo
  echo "Run get-instance example."
  ../examples/bigtable_samples_instance_admin get-instance "${project_id}" "${INSTANCE}"

#  echo
#  echo "Run list-clusters example."
#  ../examples/bigtable_samples_instance_admin list-clusters "${project_id}"

  echo
  echo "Run delete-instance example."
  ../examples/bigtable_samples_instance_admin delete-instance "${project_id}" "${INSTANCE}"
}
