...
inline std::unique_ptr<$product_namespace$::$retry_policy_name$> retry_policy() {
  return internal::CurrentOptions()
      .get<$product_namespace$::$retry_policy_name$Option>()
      ->clone();
}

inline std::unique_ptr<BackoffPolicy> backoff_policy() {
  return internal::CurrentOptions()
      .get<$product_namespace$::$service_name$BackoffPolicyOption>()
      ->clone();
}

inline std::unique_ptr<$product_namespace$::$idempotency_class_name$> idempotency_policy() {
  return internal::CurrentOptions()
      .get<$product_namespace$::$idempotency_class_name$Option>()
      ->clone();
}
)""");
