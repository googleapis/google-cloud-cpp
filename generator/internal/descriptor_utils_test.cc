...
TEST_F(FormatMethodReturnTypeTest, NonEmptyReturnType) {
  ...
  EXPECT_EQ(
      FormatMethodReturnType(*nonempty_return_method, false, false, "", ""),
      R"""(StatusOr<$response_type$>)""");
  EXPECT_EQ(
      FormatMethodReturnType(*nonempty_return_method, false, true, "", ""),
      R"""(StatusOr<$longrunning_operation_type$>)""");
  EXPECT_EQ(
      FormatMethodReturnType(*nonempty_return_method, true, false, "", ""),
