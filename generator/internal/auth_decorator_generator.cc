...
Status AuthDecoratorGenerator::GenerateHeader() {
  ...
  HeaderPrint(
      R"""(// Generated by the Codegen C++ plugin.
...
#define $header_include_guard$
  ...
  HeaderPrint(
      R"""(class $auth_class_name$ : public $stub_class_name$ {
 public:
  ...
  std::unique_ptr<Async$method_name$Stream> Async$method_name$(
...
// source: $proto_file_name$
  ...
  // constructor
  CcPrint(
      R"""($auth_class_name$::$auth_class_name$(
    std::shared_ptr<google::cloud::internal::GrpcAuthenticationStrategy> auth,
    std::shared_ptr<$stub_class_name$> child)
...
std::unique_ptr<$stub_class_name$::Async$method_name$Stream>
