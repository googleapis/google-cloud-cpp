...
/**
 * A retry policy for `$connection_class_name$` that stops retrying after a
...
class $limited_error_count_retry_policy_name$ : public $retry_policy_name$ {
 public:
  $limited_error_count_retry_policy_name$(int maximum_failures)
...
/// A retry policy for `$connection_class_name$` that stops retrying after
