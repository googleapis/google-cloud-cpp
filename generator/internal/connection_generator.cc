...
Status ConnectionGenerator::Generate() const { return {}; }

void ConnectionGenerator::SetVars() {
  vars_["connection_header_include_guard_const"] =
      absl::StrCat(service_descriptor_->name(), "_CONNECTION", "_H_");
}
