...
/**
 * Generates the header file and cc file for the TracingConnection class for a
 * particular service.
 */
class TracingConnectionGenerator : public ServiceCodeGenerator {
 public:
  ...
  ~TracingConnectionGenerator() override = default;
...
#endif  // GOOGLE_CLOUD_CPP_GENERATOR_INTERNAL_TRACING_CONNECTION_GENERATOR_H
