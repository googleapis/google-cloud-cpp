...
/**
 * Generates a sample showing how to initialize the client.
 */
class SampleGenerator : public ServiceCodeGenerator {
 public:
  ...
  SampleGenerator(SampleGenerator const&) = delete;
  SampleGenerator& operator=(SampleGenerator const&) = delete;
...
#endif  // GOOGLE_CLOUD_CPP_GENERATOR_INTERNAL_SAMPLE_GENERATOR_H
