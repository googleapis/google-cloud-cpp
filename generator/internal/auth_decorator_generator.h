...
class AuthDecoratorGenerator : public ServiceCodeGenerator {
 public:
  ...
  AuthDecoratorGenerator(AuthDecoratorGenerator const&) = delete;
  AuthDecoratorGenerator& operator=(AuthDecoratorGenerator const&) = delete;
  AuthDecoratorGenerator(AuthDecoratorGenerator&&) = default;
  AuthDecoratorGenerator& operator=(AuthDecoratorGenerator&&) = default;
...
#endif  // GOOGLE_CLOUD_CPP_GENERATOR_INTERNAL_AUTH_DECORATOR_GENERATOR_H
