...
/**
 * Generates the header file and cc file for the ConnectionImpl class for a
 * particular service using REST transport.
 */
class ConnectionImplRestGenerator : public ServiceCodeGenerator {
 public:
  ConnectionImplRestGenerator(
...
#endif  // GOOGLE_CLOUD_CPP_GENERATOR_INTERNAL_CONNECTION_IMPL_REST_GENERATOR_H
