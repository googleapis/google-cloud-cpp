...
#ifndef GOOGLE_CLOUD_CPP_GENERATOR_INTEGRATION_TESTS_GOLDEN_INTERNAL_GOLDEN_DATABASE_ADMIN_LOGGING_DECORATOR_GCPCXX_PB_H
#define GOOGLE_CLOUD_CPP_GENERATOR_INTEGRATION_TESTS_GOLDEN_INTERNAL_GOLDEN_DATABASE_ADMIN_LOGGING_DECORATOR_GCPCXX_PB_H
...
class GoldenDatabaseAdminLogging : public GoldenDatabaseAdminStub {
 public:
  ~GoldenDatabaseAdminLogging() override = default;
  GoldenDatabaseAdminLogging(std::shared_ptr<GoldenDatabaseAdminStub> child,
...
#endif  // GOOGLE_CLOUD_CPP_GENERATOR_INTEGRATION_TESTS_GOLDEN_INTERNAL_GOLDEN_DATABASE_ADMIN_LOGGING_DECORATOR_GCPCXX_PB_H
