...
#ifndef GOOGLE_CLOUD_CPP_GENERATOR_INTEGRATION_TESTS_GOLDEN_INTERNAL_GOLDEN_THING_ADMIN_LOGGING_DECORATOR_GCPCXX_PB_H
#define GOOGLE_CLOUD_CPP_GENERATOR_INTEGRATION_TESTS_GOLDEN_INTERNAL_GOLDEN_THING_ADMIN_LOGGING_DECORATOR_GCPCXX_PB_H
...
class GoldenThingAdminLogging : public GoldenThingAdminStub {
 public:
  ~GoldenThingAdminLogging() override = default;
  GoldenThingAdminLogging(std::shared_ptr<GoldenThingAdminStub> child,
...
#endif  // GOOGLE_CLOUD_CPP_GENERATOR_INTEGRATION_TESTS_GOLDEN_INTERNAL_GOLDEN_THING_ADMIN_LOGGING_DECORATOR_GCPCXX_PB_H
