...
#ifndef GOOGLE_CLOUD_CPP_GENERATOR_INTEGRATION_TESTS_GOLDEN_INTERNAL_GOLDEN_DATABASE_ADMIN_METADATA_DECORATOR_GCPCXX_PB_H
#define GOOGLE_CLOUD_CPP_GENERATOR_INTEGRATION_TESTS_GOLDEN_INTERNAL_GOLDEN_DATABASE_ADMIN_METADATA_DECORATOR_GCPCXX_PB_H
...
class GoldenDatabaseAdminMetadata : public GoldenDatabaseAdminStub {
 public:
  ~GoldenDatabaseAdminMetadata() override = default;
  explicit GoldenDatabaseAdminMetadata(std::shared_ptr<GoldenDatabaseAdminStub> child);
 ...
 private:
  ...
  std::shared_ptr<GoldenDatabaseAdminStub> child_;
  std::string api_client_header_;
};  // GoldenDatabaseAdminMetadata
...
#endif  // GOOGLE_CLOUD_CPP_GENERATOR_INTEGRATION_TESTS_GOLDEN_INTERNAL_GOLDEN_DATABASE_ADMIN_METADATA_DECORATOR_GCPCXX_PB_H
