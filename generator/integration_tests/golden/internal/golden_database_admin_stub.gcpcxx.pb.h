...
#ifndef GOOGLE_CLOUD_CPP_GENERATOR_INTEGRATION_TESTS_GOLDEN_INTERNAL_GOLDEN_DATABASE_ADMIN_STUB_GCPCXX_PB_H
#define GOOGLE_CLOUD_CPP_GENERATOR_INTEGRATION_TESTS_GOLDEN_INTERNAL_GOLDEN_DATABASE_ADMIN_STUB_GCPCXX_PB_H
...
class GoldenDatabaseAdminStub {
 public:
  virtual ~GoldenDatabaseAdminStub() = 0;
...
class DefaultGoldenDatabaseAdminStub : public GoldenDatabaseAdminStub {
 public:
  DefaultGoldenDatabaseAdminStub(
      std::unique_ptr<::google::test::admin::database::v1::GoldenDatabaseAdmin::StubInterface> grpc_stub,
 ...
 private:
  std::unique_ptr<::google::test::admin::database::v1::GoldenDatabaseAdmin::StubInterface> grpc_stub_;
...
#endif  // GOOGLE_CLOUD_CPP_GENERATOR_INTEGRATION_TESTS_GOLDEN_INTERNAL_GOLDEN_DATABASE_ADMIN_STUB_GCPCXX_PB_H
