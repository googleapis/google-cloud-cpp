...
std::shared_ptr<GoldenThingAdminStub> CreateDefaultGoldenThingAdminStub(
...
#endif  // GOOGLE_CLOUD_CPP_GENERATOR_INTEGRATION_TESTS_GOLDEN_INTERNAL_GOLDEN_THING_ADMIN_STUB_FACTORY_H
