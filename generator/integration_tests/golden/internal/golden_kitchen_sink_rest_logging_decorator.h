...
#ifndef GOOGLE_CLOUD_CPP_GENERATOR_INTEGRATION_TESTS_GOLDEN_INTERNAL_GOLDEN_KITCHEN_SINK_REST_LOGGING_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GENERATOR_INTEGRATION_TESTS_GOLDEN_INTERNAL_GOLDEN_KITCHEN_SINK_REST_LOGGING_DECORATOR_H
...
class GoldenKitchenSinkRestLogging : public GoldenKitchenSinkRestStub {
 public:
  ~GoldenKitchenSinkRestLogging() override = default;
  GoldenKitchenSinkRestLogging(std::shared_ptr<GoldenKitchenSinkRestStub> child,
...
#endif  // GOOGLE_CLOUD_CPP_GENERATOR_INTEGRATION_TESTS_GOLDEN_INTERNAL_GOLDEN_KITCHEN_SINK_REST_LOGGING_DECORATOR_H
