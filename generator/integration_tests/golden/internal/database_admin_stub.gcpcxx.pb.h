...
class DefaultDatabaseAdminStub : public DatabaseAdminStub {
 public:
  DefaultDatabaseAdminStub(
      std::unique_ptr<::google::test::admin::database::v1::DatabaseAdmin::StubInterface> grpc_stub,
 ...
 private:
  std::unique_ptr<::google::test::admin::database::v1::DatabaseAdmin::StubInterface> grpc_stub_;
...
#endif  // GOOGLE_CLOUD_CPP_GENERATOR_INTEGRATION_TESTS_GOLDEN_INTERNAL_DATABASE_ADMIN_STUB_GCPCXX_PB_H
