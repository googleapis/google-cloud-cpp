...
#ifndef GOOGLE_CLOUD_CPP_GENERATOR_INTEGRATION_TESTS_GOLDEN_GOLDEN_DATABASE_ADMIN_CONNECTION_IDEMPOTENCY_POLICY_GCPCXX_PB_H
#define GOOGLE_CLOUD_CPP_GENERATOR_INTEGRATION_TESTS_GOLDEN_GOLDEN_DATABASE_ADMIN_CONNECTION_IDEMPOTENCY_POLICY_GCPCXX_PB_H
...
class GoldenDatabaseAdminConnectionIdempotencyPolicy {
 public:
  virtual ~GoldenDatabaseAdminConnectionIdempotencyPolicy() = 0;

  /// Create a new copy of this object.
  virtual std::unique_ptr<GoldenDatabaseAdminConnectionIdempotencyPolicy> clone() const = 0;
...
#endif  // GOOGLE_CLOUD_CPP_GENERATOR_INTEGRATION_TESTS_GOLDEN_GOLDEN_DATABASE_ADMIN_CONNECTION_IDEMPOTENCY_POLICY_GCPCXX_PB_H
