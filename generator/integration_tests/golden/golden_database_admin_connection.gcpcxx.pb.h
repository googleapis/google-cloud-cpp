...
#ifndef GOOGLE_CLOUD_CPP_GENERATOR_INTEGRATION_TESTS_GOLDEN_GOLDEN_DATABASE_ADMIN_CONNECTION_GCPCXX_PB_H
#define GOOGLE_CLOUD_CPP_GENERATOR_INTEGRATION_TESTS_GOLDEN_GOLDEN_DATABASE_ADMIN_CONNECTION_GCPCXX_PB_H
...
struct GoldenDatabaseAdminConnectionOptionsTraits {
  static std::string default_endpoint();
  static std::string user_agent_prefix();
  static int default_num_channels();
};

using GoldenDatabaseAdminConnectionOptions =
  google::cloud::ConnectionOptions<GoldenDatabaseAdminConnectionOptionsTraits>;

using GoldenDatabaseAdminRetryPolicy = google::cloud::internal::TraitBasedRetryPolicy<
    golden_internal::GoldenDatabaseAdminRetryTraits>;

using GoldenDatabaseAdminLimitedTimeRetryPolicy = google::cloud::internal::LimitedTimeRetryPolicy<
    golden_internal::GoldenDatabaseAdminRetryTraits>;

using GoldenDatabaseAdminLimitedErrorCountRetryPolicy =
    google::cloud::internal::LimitedErrorCountRetryPolicy<
        golden_internal::GoldenDatabaseAdminRetryTraits>;

class GoldenDatabaseAdminConnection {
 public:
  virtual ~GoldenDatabaseAdminConnection() = 0;
...
std::shared_ptr<GoldenDatabaseAdminConnection> MakeGoldenDatabaseAdminConnection(
    GoldenDatabaseAdminConnectionOptions const& options = GoldenDatabaseAdminConnectionOptions());
...
#endif  // GOOGLE_CLOUD_CPP_GENERATOR_INTEGRATION_TESTS_GOLDEN_GOLDEN_DATABASE_ADMIN_CONNECTION_GCPCXX_PB_H
