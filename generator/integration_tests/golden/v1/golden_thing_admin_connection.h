...
/**
 * A retry policy for `GoldenThingAdminConnection` that stops retrying after a
...
class GoldenThingAdminLimitedErrorCountRetryPolicy : public GoldenThingAdminRetryPolicy {
 public:
  GoldenThingAdminLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `GoldenThingAdminConnection` that stops retrying after
