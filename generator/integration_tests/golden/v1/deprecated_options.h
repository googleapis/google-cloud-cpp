 ...
 * @ingroup generator-integration_tests-golden-options
 */
struct DeprecatedServiceBackoffPolicyOption {
 ...
 * @ingroup generator-integration_tests-golden-options
 */
struct DeprecatedServiceConnectionIdempotencyPolicyOption {
  using Type = std::shared_ptr<DeprecatedServiceConnectionIdempotencyPolicy>;
};

/**
 * The options applicable to DeprecatedService.
 *
 * @ingroup generator-integration_tests-golden-options
 */
using DeprecatedServicePolicyOptionList =
    OptionList<DeprecatedServiceRetryPolicyOption,
               DeprecatedServiceBackoffPolicyOption,
               DeprecatedServiceConnectionIdempotencyPolicyOption>;
