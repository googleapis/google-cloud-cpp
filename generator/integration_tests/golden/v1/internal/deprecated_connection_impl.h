...
class DeprecatedServiceConnectionImpl
    : public golden_v1::DeprecatedServiceConnection {
 public:
  ~DeprecatedServiceConnectionImpl() override = default;

  DeprecatedServiceConnectionImpl(
 ...
 private:
  ...
  std::shared_ptr<golden_v1_internal::DeprecatedServiceStub> stub_;
  Options options_;
};
