...
class DeprecatedServiceRestStub {
 public:
  virtual ~DeprecatedServiceRestStub() = default;

  virtual Status Noop(
      google::cloud::rest_internal::RestContext& rest_context,
      Options const& options, google::test::deprecated::v1::DeprecatedServiceRequest const& request) = 0;
};

class DefaultDeprecatedServiceRestStub : public DeprecatedServiceRestStub {
 public:
  ~DefaultDeprecatedServiceRestStub() override = default;

  explicit DefaultDeprecatedServiceRestStub(Options options);
  DefaultDeprecatedServiceRestStub(
