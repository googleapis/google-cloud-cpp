...
std::shared_ptr<GoldenKitchenSinkRestStub>
CreateDefaultGoldenKitchenSinkRestStub(Options& options) {
  ...
  std::shared_ptr<GoldenKitchenSinkRestStub> stub =
      std::make_shared<DefaultGoldenKitchenSinkRestStub>(std::move(stub_creation_opts));
  ...
  if (internal::Contains(
    ...
    stub = std::make_shared<GoldenKitchenSinkRestLogging>(
        std::move(stub),
