...
#ifndef GOOGLE_CLOUD_CPP_GENERATOR_INTEGRATION_TESTS_GOLDEN_V1_INTERNAL_GOLDEN_THING_ADMIN_TRACING_STUB_H
...
class GoldenThingAdminTracingStub : public GoldenThingAdminStub {
 public:
  ...
  explicit GoldenThingAdminTracingStub(std::shared_ptr<GoldenThingAdminStub> child);
...
#endif  // GOOGLE_CLOUD_CPP_GENERATOR_INTEGRATION_TESTS_GOLDEN_V1_INTERNAL_GOLDEN_THING_ADMIN_TRACING_STUB_H
