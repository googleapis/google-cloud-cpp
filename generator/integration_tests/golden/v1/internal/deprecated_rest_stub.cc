...
DefaultDeprecatedServiceRestStub::DefaultDeprecatedServiceRestStub(Options options)
    : service_(rest_internal::MakePooledRestClient(
          options.get<EndpointOption>(), options)),
      options_(std::move(options)) {}

DefaultDeprecatedServiceRestStub::DefaultDeprecatedServiceRestStub(
    std::shared_ptr<rest_internal::RestClient> service,
    Options options)
    : service_(std::move(service)),
      options_(std::move(options)) {}

Status DefaultDeprecatedServiceRestStub::Noop(
