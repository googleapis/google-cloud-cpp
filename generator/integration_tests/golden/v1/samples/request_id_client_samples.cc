...
// clang-format off
// main-dox-marker: golden_v1::RequestIdServiceClient
// lro-marker: true
// clang-format on
namespace {
...
class CustomIdempotencyPolicy
   : public google::cloud::golden_v1::RequestIdServiceConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::golden_v1::RequestIdServiceConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::golden_v1::RequestIdServiceConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::golden_v1::RequestIdServiceRetryPolicyOption>(
      google::cloud::golden_v1::RequestIdServiceLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::golden_v1::RequestIdServiceBackoffPolicyOption>(
  ...
  auto c3 = google::cloud::golden_v1::RequestIdServiceClient(
    connection, google::cloud::Options{}.set<google::cloud::golden_v1::RequestIdServiceRetryPolicyOption>(
      google::cloud::golden_v1::RequestIdServiceLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::golden_v1::RequestIdServiceRetryPolicyOption>(
  //       google::cloud::golden_v1::RequestIdServiceLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::golden_v1::RequestIdServicePollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::golden_v1::RequestIdServiceRetryPolicyOption::Type,
            google::cloud::golden_v1::RequestIdServiceBackoffPolicyOption::Type>(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::golden_v1::RequestIdServiceClient(
      google::cloud::golden_v1::MakeRequestIdServiceConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
