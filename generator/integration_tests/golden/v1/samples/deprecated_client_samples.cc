...
// clang-format off
// main-dox-marker: golden_v1::DeprecatedServiceClient
// clang-format on
namespace {
...
class CustomIdempotencyPolicy
 ...
 public:
  ...
  std::unique_ptr<google::cloud::golden_v1::DeprecatedServiceConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::golden_v1::DeprecatedServiceConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::golden_v1::DeprecatedServiceRetryPolicyOption>(
      google::cloud::golden_v1::DeprecatedServiceLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::golden_v1::DeprecatedServiceBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::golden_v1::MakeDeprecatedServiceConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::golden_v1::DeprecatedServiceClient(connection);
  auto c2 = google::cloud::golden_v1::DeprecatedServiceClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::golden_v1::DeprecatedServiceClient(
    connection, google::cloud::Options{}.set<google::cloud::golden_v1::DeprecatedServiceRetryPolicyOption>(
      google::cloud::golden_v1::DeprecatedServiceLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::golden_v1::DeprecatedServiceRetryPolicyOption>(
  //       google::cloud::golden_v1::DeprecatedServiceLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::golden_v1::DeprecatedServiceClient(
      google::cloud::golden_v1::MakeDeprecatedServiceConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
