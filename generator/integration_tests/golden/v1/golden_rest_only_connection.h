...
/**
 * A retry policy for `GoldenRestOnlyConnection` that stops retrying after a
...
class GoldenRestOnlyLimitedErrorCountRetryPolicy : public GoldenRestOnlyRetryPolicy {
 public:
  GoldenRestOnlyLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `GoldenRestOnlyConnection` that stops retrying after
