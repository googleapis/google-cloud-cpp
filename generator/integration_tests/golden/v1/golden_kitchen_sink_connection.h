...
/**
 * A retry policy for `GoldenKitchenSinkConnection` that stops retrying after a
...
class GoldenKitchenSinkLimitedErrorCountRetryPolicy : public GoldenKitchenSinkRetryPolicy {
 public:
  GoldenKitchenSinkLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `GoldenKitchenSinkConnection` that stops retrying after
