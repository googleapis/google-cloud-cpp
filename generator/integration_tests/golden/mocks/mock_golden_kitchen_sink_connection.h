 ...
 * including errors from a `GoldenKitchenSinkClient`. To do so, construct a
 * `GoldenKitchenSinkClient` with an instance of this class. Then use the Google
 ...
 *
 * [bq-mock]: https://googleapis.dev/cpp/google-cloud-bigquery/latest/bigquery-read-mock.html
 */
