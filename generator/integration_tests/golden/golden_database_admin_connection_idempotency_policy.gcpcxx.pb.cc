...
GoldenDatabaseAdminConnectionIdempotencyPolicy::~GoldenDatabaseAdminConnectionIdempotencyPolicy() = default;

namespace {
class DefaultGoldenDatabaseAdminConnectionIdempotencyPolicy : public GoldenDatabaseAdminConnectionIdempotencyPolicy {
 public:
  ~DefaultGoldenDatabaseAdminConnectionIdempotencyPolicy() override = default;

  /// Create a new copy of this object.
  std::unique_ptr<GoldenDatabaseAdminConnectionIdempotencyPolicy> clone() const override {
    return absl::make_unique<DefaultGoldenDatabaseAdminConnectionIdempotencyPolicy>(*this);
  }
...
std::unique_ptr<GoldenDatabaseAdminConnectionIdempotencyPolicy>
    MakeDefaultGoldenDatabaseAdminConnectionIdempotencyPolicy() {
  return absl::make_unique<DefaultGoldenDatabaseAdminConnectionIdempotencyPolicy>();
}
