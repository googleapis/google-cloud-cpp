...
#ifndef GOOGLE_CLOUD_CPP_GENERATOR_INTEGRATION_TESTS_GOLDEN_GOLDEN_DATABASE_ADMIN_CLIENT_GCPCXX_PB_H
#define GOOGLE_CLOUD_CPP_GENERATOR_INTEGRATION_TESTS_GOLDEN_GOLDEN_DATABASE_ADMIN_CLIENT_GCPCXX_PB_H
 ...
 */
class GoldenDatabaseAdminClient {
 public:
  explicit GoldenDatabaseAdminClient(std::shared_ptr<GoldenDatabaseAdminConnection> connection);
  ~GoldenDatabaseAdminClient();

  //@{
  // @name Copy and move support
  GoldenDatabaseAdminClient(GoldenDatabaseAdminClient const&) = default;
  GoldenDatabaseAdminClient& operator=(GoldenDatabaseAdminClient const&) = default;
  GoldenDatabaseAdminClient(GoldenDatabaseAdminClient&&) noexcept = default;
  GoldenDatabaseAdminClient& operator=(GoldenDatabaseAdminClient&&) noexcept = default;
  //@}

  //@{
  // @name Equality
  friend bool operator==(GoldenDatabaseAdminClient const& a, GoldenDatabaseAdminClient const& b) {
 ...
 private:
  std::shared_ptr<GoldenDatabaseAdminConnection> connection_;
};
...
#endif  // GOOGLE_CLOUD_CPP_GENERATOR_INTEGRATION_TESTS_GOLDEN_GOLDEN_DATABASE_ADMIN_CLIENT_GCPCXX_PB_H
