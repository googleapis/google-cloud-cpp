...
find generator/integration_tests/golden/ -path generator/integration_tests/golden/tests -prune -false -o -name '*golden*.h' -print0 -o -name '*golden*.cc' -print0 | sort -z |
