...
def gl_cpp_workspace0(name = None):
    ...
    maybe(
        ...
        urls = [
            "https://github.com/grpc/grpc/archive/v1.69.0-pre1.tar.gz",
        ],
        sha256 = "390cbcf4f3a2f45b4086f6f33d1483487c857ad7aa975304d3d133e78b89abb2",
        strip_prefix = "grpc-1.69.0-pre1",
    )
