...
def gl_cpp_workspace0(name = None):
    ...
    maybe(
        ...
        urls = [
            "https://github.com/protocolbuffers/protobuf/archive/v31.0-rc1.tar.gz",
        ],
        sha256 = "5bd5a5f6a2dd75aeff85a21362de2944f1a7226d3e100bcb92bed1c90178454c",
        strip_prefix = "protobuf-31.0-rc1",
    )
