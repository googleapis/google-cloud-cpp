...
def gl_cpp_workspace0(name = None):
    ...
    maybe(
        ...
        urls = [
            "https://github.com/grpc/grpc/archive/v1.72.0-pre1.tar.gz",
        ],
        sha256 = "05a21b2d85c5f22a28ea7b5061080a9163f175f3deab0497a325455cd24bbe4a",
        strip_prefix = "grpc-1.72.0-pre1",
    )
