...
def gl_cpp_workspace0(name = None):
    ...
    maybe(
        ...
        urls = [
            "https://github.com/grpc/grpc/archive/v1.73.0-pre1.tar.gz",
        ],
        sha256 = "c2d5837086286f303dd88a9701dddca37a008babd0a5b91692e7415d05235dab",
        strip_prefix = "grpc-1.73.0-pre1",
    )
