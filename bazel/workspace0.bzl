...
def gl_cpp_workspace0(name = None):
    ...
    maybe(
        ...
        urls = [
            "https://github.com/grpc/grpc/archive/v1.73.0-pre2.tar.gz",
        ],
        sha256 = "eca156adb79c921c146c7d8330454da851b6f3f82030375e0e09cb4199e112bd",
        strip_prefix = "grpc-1.73.0-pre2",
    )
