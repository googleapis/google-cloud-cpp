...
def gl_cpp_workspace0(name = None):
    ...
    maybe(
        ...
        name = "googleapis",
        urls = [
            "https://github.com/googleapis/googleapis/archive/258563af0e9d6e7219de9afdffe74687d1eb7b83.tar.gz",
        ],
        sha256 = "5234d0853154cf5498ea7e1bcb76fe63e3eb2629da6d5777e15b3d2fa09cd498",
