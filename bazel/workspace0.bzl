...
def gl_cpp_workspace0(name = None):
    ...
    maybe(
        ...
        urls = [
            "https://github.com/protocolbuffers/protobuf/archive/v32.0-rc1.tar.gz",
        ],
        sha256 = "9edd96b5b05010fea319e53fea1655961c21ea10524456662bb005b21f75905e",
        strip_prefix = "protobuf-32.0-rc1",
    )
