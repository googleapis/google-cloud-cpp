...
def gl_cpp_workspace0(name = None):
    ...
    maybe(
        ...
        urls = [
            "https://github.com/bazelbuild/rules_apple/releases/download/5.2.0/rules_apple.5.2.0.tar.gz",
        ],
        sha256 = "cbc2eae8a78d29c1d7c412b24945bc645a1584f64c0a5ed71bf1781c2ae1e5bc",
    )
