...
def gl_cpp_workspace0(name = None):
    ...
    maybe(
        ...
        urls = [
            "https://github.com/protocolbuffers/protobuf/archive/v31.0-rc2.tar.gz",
        ],
        sha256 = "61a948c028574647fe8426ef8e1063b583364c727fbd089c848e505c9bea029f",
        strip_prefix = "protobuf-31.0-rc2",
    )
