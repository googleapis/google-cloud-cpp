...
def gl_cpp_workspace0(name = None):
    ...
    maybe(
        ...
        name = "googleapis",
        urls = [
            "https://github.com/googleapis/googleapis/archive/7b2b58ff4fb3eee3c0923af35fdee90134fabe3b.tar.gz",
        ],
        sha256 = "0423ca28471f4cb8f1d1a006633ff94fb51c629c0cbde231eb4101cc6bf98361",
