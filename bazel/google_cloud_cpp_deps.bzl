...
def google_cloud_cpp_deps(name = None):
    ...
    maybe(
        ...
        urls = [
            "https://storage.googleapis.com/cloud-cpp-community-archive/com_google_googleapis/d30f4754a7f97a6ca5ada83507b0a0d365739818.tar.gz",
            "https://github.com/googleapis/googleapis/archive/d30f4754a7f97a6ca5ada83507b0a0d365739818.tar.gz",
        ],
        sha256 = "f0cc01e7d9c9a7b966b57322d1097476bef1a838b8d1b5757a6fc4131697bf90",
    ...
    maybe(
        ...
        urls = [
            "https://storage.googleapis.com/cloud-cpp-community-archive/com_github_grpc_grpc/v1.53.0-pre1.tar.gz",
            "https://github.com/grpc/grpc/archive/v1.53.0-pre1.tar.gz",
        ],
        sha256 = "f1ad0071c3740f235e369bbe293d86ba8eac3a0a2f2904ac5438eb25989587d1",
        strip_prefix = "grpc-1.53.0-pre1",
    )
