...
def google_cloud_cpp_deps():
    ...
    if "rules_cc" not in native.existing_rules():
        http_archive(
            ...
            urls = [
                "https://github.com/bazelbuild/rules_cc/archive/8d3ab5f22b8f4a29f3f32c8fbdcc777589d91042.tar.gz",
            ],
            sha256 = "4cc8561aaa47bd44e597db439bde754fab5c627e0635798de7ab3314def8174a",
        )
    ...
    if "com_google_protobuf" not in native.existing_rules():
        http_archive(
            ...
            urls = [
                "https://github.com/google/protobuf/archive/v3.17.2.tar.gz",
            ],
    ...
    if "boringssl" not in native.existing_rules():
        http_archive(
            ...
            sha256 = "5020999ac6c3317c80adf8cac7083c87509e346a49e0903c219b26d5dbb40eba",
            strip_prefix = "boringssl-83a49939abb5a15508548ed1d33af8128d70cab5",
            urls = [
                "https://github.com/google/boringssl/archive/83a49939abb5a15508548ed1d33af8128d70cab5.tar.gz",
            ],
        )
