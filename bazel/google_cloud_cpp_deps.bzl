...
def google_cloud_cpp_deps():
    ...
    if "com_github_grpc_grpc" not in native.existing_rules():
        http_archive(
            ...
            strip_prefix = "grpc-1.52.0-pre1",
            urls = [
                "https://github.com/grpc/grpc/archive/v1.52.0-pre1.tar.gz",
            ],
            sha256 = "13fff10e443b92b26010b45907d0590bfdad72ed2d7d70b81134f202d2cc0325",
        )
