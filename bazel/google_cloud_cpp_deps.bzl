...
def google_cloud_cpp_deps(name = None):
    ...
    maybe(
        ...
        urls = [
            "https://storage.googleapis.com/cloud-cpp-community-archive/com_google_googleapis/babab51d7d23ed1b95a2d9daff59012220f56e08.tar.gz",
            "https://github.com/googleapis/googleapis/archive/babab51d7d23ed1b95a2d9daff59012220f56e08.tar.gz",
        ],
        sha256 = "38fc2e56b5ab2971ac59cf9849bce3cbe41892ea2a8c5fb2ce1c0f2fed0a21bb",
    ...
    maybe(
        ...
        urls = [
            "https://storage.googleapis.com/cloud-cpp-community-archive/com_google_protobuf/v24.3.tar.gz",
    ...
    maybe(
        ...
        urls = [
            "https://storage.googleapis.com/cloud-cpp-community-archive/com_github_grpc_grpc/v1.58.1.tar.gz",
            "https://github.com/grpc/grpc/archive/v1.58.1.tar.gz",
        ],
