...
option(SANITIZE_LEAKS "Enable LeakSanitizer for the build." OFF)
if (SANITIZE_LEAKS)
...
if (SANITIZE_MEMORY)
    if (${AddressSanitizer_ENABLED})
        message(WARNING "Cannot enable MemorySanitizer when AddressSanitizer is enabled")
    else()
...
if (SANITIZE_THREAD)
    if (${AddressSanitizer_ENABLED})
        message(WARNING "Cannot enable ThreadSanitizer when AddressSanitizer is enabled")
    else()
