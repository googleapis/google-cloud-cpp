 ...
 */
struct EssentialContactsServiceRetryPolicyOption {
  using Type = std::shared_ptr<EssentialContactsServiceRetryPolicy>;
};
 ...
 * @ingroup google-cloud-essentialcontacts-options
 */
struct EssentialContactsServiceBackoffPolicyOption {
...
/**
 * The options applicable to EssentialContactsService.
 *
 * @ingroup google-cloud-essentialcontacts-options
 */
using EssentialContactsServicePolicyOptionList =
    OptionList<EssentialContactsServiceRetryPolicyOption,
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_ESSENTIALCONTACTS_V1_ESSENTIAL_CONTACTS_OPTIONS_H
