# HOWTO: using the Essential Contacts API C++ client in your project

This directory contains small examples showing how to use the Essential Contacts API C++
...
Like most Google Cloud Platform (GCP) services, Essential Contacts API requires that
...
1. Install the dependencies with your favorite tools. As an example, if you use
   ...
   ```bash
   cd $HOME/vcpkg
   ./vcpkg install google-cloud-cpp[core,essentialcontacts]
   ```
...
[quickstart-link]: https://cloud.google.com/essentialcontacts/docs/quickstart
