...
// clang-format off
// main-dox-marker: vectorsearch_v1::DataObjectSearchServiceClient
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client =
      google::cloud::vectorsearch_v1::DataObjectSearchServiceClient(
          google::cloud::vectorsearch_v1::MakeDataObjectSearchServiceConnection(
              options));
  //! [set-client-endpoint]
}
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
      ...
      google::cloud::Options{}
          ...
          .set<google::cloud::vectorsearch_v1::
              ...
              google::cloud::vectorsearch_v1::
                  DataObjectSearchServiceLimitedErrorCountRetryPolicy(3)
                      .clone())
          .set<google::cloud::vectorsearch_v1::
  ...
  auto c1 =
      google::cloud::vectorsearch_v1::DataObjectSearchServiceClient(connection);
  auto c2 =
      google::cloud::vectorsearch_v1::DataObjectSearchServiceClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::vectorsearch_v1::DataObjectSearchServiceClient(
  ...
  //     .set<google::cloud::vectorsearch_v1::DataObjectSearchServiceRetryPolicyOption>(
  //       google::cloud::vectorsearch_v1::DataObjectSearchServiceLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::vectorsearch_v1::DataObjectSearchServiceClient(
        google::cloud::vectorsearch_v1::MakeDataObjectSearchServiceConnection(
            options));
  }
  //! [with-service-account]
