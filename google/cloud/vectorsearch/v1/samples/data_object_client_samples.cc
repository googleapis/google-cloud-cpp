...
// clang-format off
// main-dox-marker: vectorsearch_v1::DataObjectServiceClient
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::vectorsearch_v1::DataObjectServiceClient(
      google::cloud::vectorsearch_v1::MakeDataObjectServiceConnection(options));
  //! [set-client-endpoint]
}
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::vectorsearch_v1::DataObjectServiceClient(
      google::cloud::vectorsearch_v1::MakeDataObjectServiceConnection(
          *ud_options));
  //! [set-client-universe-domain]
}
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
      ...
      google::cloud::Options{}
          ...
          .set<google::cloud::vectorsearch_v1::
              ...
              google::cloud::vectorsearch_v1::
                  DataObjectServiceLimitedErrorCountRetryPolicy(3)
                      .clone())
          .set<google::cloud::vectorsearch_v1::
  ...
  auto c1 = google::cloud::vectorsearch_v1::DataObjectServiceClient(connection);
  auto c2 = google::cloud::vectorsearch_v1::DataObjectServiceClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::vectorsearch_v1::DataObjectServiceClient(
  ...
  //     .set<google::cloud::vectorsearch_v1::DataObjectServiceRetryPolicyOption>(
  //       google::cloud::vectorsearch_v1::DataObjectServiceLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::vectorsearch_v1::DataObjectServiceClient(
        google::cloud::vectorsearch_v1::MakeDataObjectServiceConnection(
            options));
  }
  //! [with-service-account]
