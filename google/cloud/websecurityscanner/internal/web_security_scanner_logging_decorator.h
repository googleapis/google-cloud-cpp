...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_WEBSECURITYSCANNER_INTERNAL_WEB_SECURITY_SCANNER_LOGGING_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_WEBSECURITYSCANNER_INTERNAL_WEB_SECURITY_SCANNER_LOGGING_DECORATOR_H
...
class WebSecurityScannerLogging : public WebSecurityScannerStub {
 public:
  ~WebSecurityScannerLogging() override = default;
  WebSecurityScannerLogging(std::shared_ptr<WebSecurityScannerStub> child,
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_WEBSECURITYSCANNER_INTERNAL_WEB_SECURITY_SCANNER_LOGGING_DECORATOR_H
