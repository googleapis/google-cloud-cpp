...
// main-dox-marker: GOOGLE_CLOUD_CPP_NS::WebSecurityScannerClient
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::GOOGLE_CLOUD_CPP_NS::WebSecurityScannerClient(
      google::cloud::GOOGLE_CLOUD_CPP_NS::MakeWebSecurityScannerConnection(
          options));
  //! [set-client-endpoint]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::GOOGLE_CLOUD_CPP_NS::WebSecurityScannerClient(
        google::cloud::GOOGLE_CLOUD_CPP_NS::MakeWebSecurityScannerConnection(
            options));
  }
  //! [with-service-account]
