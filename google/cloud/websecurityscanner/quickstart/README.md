...
This directory contains small examples showing how to use the Web Security
Scanner API C++ client library in your own project. These instructions assume
...
1. Install the dependencies with your favorite tools. As an example, if you use
   ...
   ```bash
   cd $HOME/vcpkg
   ./vcpkg install google-cloud-cpp[core,websecurityscanner]
   ```
