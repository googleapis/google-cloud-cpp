...
// main-dox-marker: GOOGLE_CLOUD_CPP_NS::SystemPolicyV1Client
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::GOOGLE_CLOUD_CPP_NS::SystemPolicyV1Client(
      google::cloud::GOOGLE_CLOUD_CPP_NS::MakeSystemPolicyV1Connection(
          options));
  //! [set-client-endpoint]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::GOOGLE_CLOUD_CPP_NS::SystemPolicyV1Client(
        google::cloud::GOOGLE_CLOUD_CPP_NS::MakeSystemPolicyV1Connection(
            options));
  }
  //! [with-service-account]
