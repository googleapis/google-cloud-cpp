...
class ValidationHelperV1RetryPolicy : public ::google::cloud::RetryPolicy {
 public:
  ...
  /// handled.
  virtual std::unique_ptr<ValidationHelperV1RetryPolicy> clone() const = 0;
};

/**
 * A retry policy for `ValidationHelperV1Connection` that stops retrying after a
...
class ValidationHelperV1LimitedErrorCountRetryPolicy
 ...
 public:
  ValidationHelperV1LimitedErrorCountRetryPolicy(int maximum_failures)
  ...
  std::unique_ptr<ValidationHelperV1RetryPolicy> clone() const override {
...
/// A retry policy for `ValidationHelperV1Connection` that stops retrying after
