...
CreateDefaultBinauthzManagementServiceV1Stub(google::cloud::CompletionQueue cq,
  ...
  auto endpoint = internal::DetermineServiceEndpoint(
      ...
      std::move(endpoint_option), "binaryauthorization.googleapis.com",
      options);
  ...
  if (!endpoint.ok()) {
    ...
    auto service_grpc_stub = google::cloud::binaryauthorization::v1::
        BinauthzManagementServiceV1::NewStub(channel);
    stub = std::make_shared<DefaultBinauthzManagementServiceV1Stub>(
