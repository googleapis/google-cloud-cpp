...
class SystemPolicyV1ConnectionImpl
 ...
 private:
  std::unique_ptr<binaryauthorization_v1::SystemPolicyV1RetryPolicy>
  retry_policy() {
    auto const& options = internal::CurrentOptions();
    if (options
            .has<binaryauthorization_v1::SystemPolicyV1RetryPolicyOption>()) {
      return options
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_BINARYAUTHORIZATION_V1_INTERNAL_SYSTEM_POLICY_V1_CONNECTION_IMPL_H
