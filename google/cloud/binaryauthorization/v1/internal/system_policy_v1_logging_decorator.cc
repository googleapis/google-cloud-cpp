...
StatusOr<google::iam::v1::Policy> SystemPolicyV1Logging::SetIamPolicy(
    grpc::ClientContext& context, Options const& options,
...
StatusOr<google::iam::v1::Policy> SystemPolicyV1Logging::GetIamPolicy(
    grpc::ClientContext& context, Options const& options,
...
SystemPolicyV1Logging::TestIamPermissions(
    grpc::ClientContext& context, Options const& options,
