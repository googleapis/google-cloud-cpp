...
BinauthzManagementServiceV1ConnectionImpl::SetIamPolicy(
...
StatusOr<google::iam::v1::Policy>
BinauthzManagementServiceV1ConnectionImpl::GetIamPolicy(
...
BinauthzManagementServiceV1ConnectionImpl::TestIamPermissions(
