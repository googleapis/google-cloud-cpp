...
StatusOr<google::iam::v1::Policy> ValidationHelperV1Metadata::SetIamPolicy(
    grpc::ClientContext& context, Options const& options,
...
StatusOr<google::iam::v1::Policy> ValidationHelperV1Metadata::GetIamPolicy(
    grpc::ClientContext& context, Options const& options,
...
ValidationHelperV1Metadata::TestIamPermissions(
    grpc::ClientContext& context, Options const& options,
