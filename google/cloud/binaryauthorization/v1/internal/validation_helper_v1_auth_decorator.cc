...
StatusOr<google::iam::v1::Policy> ValidationHelperV1Auth::SetIamPolicy(
    grpc::ClientContext& context, Options const& options,
...
StatusOr<google::iam::v1::Policy> ValidationHelperV1Auth::GetIamPolicy(
    grpc::ClientContext& context, Options const& options,
...
ValidationHelperV1Auth::TestIamPermissions(
    grpc::ClientContext& context, Options const& options,
