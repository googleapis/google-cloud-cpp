...
StatusOr<google::iam::v1::Policy> SystemPolicyV1ConnectionImpl::SetIamPolicy(
...
StatusOr<google::iam::v1::Policy> SystemPolicyV1ConnectionImpl::GetIamPolicy(
...
SystemPolicyV1ConnectionImpl::TestIamPermissions(
