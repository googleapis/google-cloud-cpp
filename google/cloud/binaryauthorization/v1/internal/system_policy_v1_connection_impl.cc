...
retry_policy(Options const& options) {
  return options.get<binaryauthorization_v1::SystemPolicyV1RetryPolicyOption>()->clone();
}

std::unique_ptr<BackoffPolicy>
backoff_policy(Options const& options) {
  return options.get<binaryauthorization_v1::SystemPolicyV1BackoffPolicyOption>()->clone();
}

std::unique_ptr<binaryauthorization_v1::SystemPolicyV1ConnectionIdempotencyPolicy>
idempotency_policy(Options const& options) {
  return options.get<binaryauthorization_v1::SystemPolicyV1ConnectionIdempotencyPolicyOption>()->clone();
}
...
SystemPolicyV1ConnectionImpl::GetSystemPolicy(google::cloud::binaryauthorization::v1::GetSystemPolicyRequest const& request) {
