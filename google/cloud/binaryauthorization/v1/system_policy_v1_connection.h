...
/**
 * A retry policy for `SystemPolicyV1Connection` that stops retrying after a
...
class SystemPolicyV1LimitedErrorCountRetryPolicy
 ...
 public:
  SystemPolicyV1LimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `SystemPolicyV1Connection` that stops retrying after
