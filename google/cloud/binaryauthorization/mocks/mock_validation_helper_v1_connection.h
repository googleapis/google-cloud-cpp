...
/// @deprecated Use binaryauthorization_v1_mocks::MockValidationHelperV1Connection directly.
using ::google::cloud::binaryauthorization_v1_mocks::MockValidationHelperV1Connection;
