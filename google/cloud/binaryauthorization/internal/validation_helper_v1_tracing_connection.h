...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_BINARYAUTHORIZATION_INTERNAL_VALIDATION_HELPER_V1_TRACING_CONNECTION_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_BINARYAUTHORIZATION_INTERNAL_VALIDATION_HELPER_V1_TRACING_CONNECTION_H
...
class ValidationHelperV1TracingConnection
 ...
 public:
  ...
  explicit ValidationHelperV1TracingConnection(
      std::shared_ptr<binaryauthorization::ValidationHelperV1Connection> child);
 ...
 private:
  std::shared_ptr<binaryauthorization::ValidationHelperV1Connection> child_;
};
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_BINARYAUTHORIZATION_INTERNAL_VALIDATION_HELPER_V1_TRACING_CONNECTION_H
