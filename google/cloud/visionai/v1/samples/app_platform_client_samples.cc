...
// clang-format off
// main-dox-marker: visionai_v1::AppPlatformClient
// lro-marker: true
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::visionai_v1::AppPlatformClient(
      google::cloud::visionai_v1::MakeAppPlatformConnection(options));
  //! [set-client-endpoint]
}
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::visionai_v1::AppPlatformClient(
      google::cloud::visionai_v1::MakeAppPlatformConnection(*ud_options));
  //! [set-client-universe-domain]
}
...
class CustomIdempotencyPolicy : public google::cloud::visionai_v1::
 ...
 public:
  ...
  std::unique_ptr<
      google::cloud::visionai_v1::AppPlatformConnectionIdempotencyPolicy>
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options =
      google::cloud::Options{}
          ...
          .set<google::cloud::visionai_v1::AppPlatformRetryPolicyOption>(
              google::cloud::visionai_v1::
                  AppPlatformLimitedErrorCountRetryPolicy(3)
                      .clone())
          .set<google::cloud::visionai_v1::AppPlatformBackoffPolicyOption>(
  ...
  auto c1 = google::cloud::visionai_v1::AppPlatformClient(connection);
  auto c2 = google::cloud::visionai_v1::AppPlatformClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::visionai_v1::AppPlatformClient(
      connection,
      google::cloud::Options{}
          .set<google::cloud::visionai_v1::AppPlatformRetryPolicyOption>(
              google::cloud::visionai_v1::AppPlatformLimitedTimeRetryPolicy(
  ...
  //     .set<google::cloud::visionai_v1::AppPlatformRetryPolicyOption>(
  //       google::cloud::visionai_v1::AppPlatformLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options =
      google::cloud::Options{}
          .set<google::cloud::visionai_v1::AppPlatformPollingPolicyOption>(
              google::cloud::GenericPollingPolicy<
                  google::cloud::visionai_v1::AppPlatformRetryPolicyOption::
                      Type,
                  google::cloud::visionai_v1::AppPlatformBackoffPolicyOption::
                      Type>(
                  google::cloud::visionai_v1::AppPlatformLimitedTimeRetryPolicy(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::visionai_v1::AppPlatformClient(
        google::cloud::visionai_v1::MakeAppPlatformConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
