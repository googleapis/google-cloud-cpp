...
// clang-format off
// main-dox-marker: visionai_v1::LiveVideoAnalyticsClient
// lro-marker: true
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::visionai_v1::LiveVideoAnalyticsClient(
      google::cloud::visionai_v1::MakeLiveVideoAnalyticsConnection(options));
  //! [set-client-endpoint]
}
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::visionai_v1::LiveVideoAnalyticsClient(
      google::cloud::visionai_v1::MakeLiveVideoAnalyticsConnection(
          *ud_options));
  //! [set-client-universe-domain]
}
...
class CustomIdempotencyPolicy
 ...
 public:
  ...
  std::unique_ptr<
      google::cloud::visionai_v1::LiveVideoAnalyticsConnectionIdempotencyPolicy>
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options =
      google::cloud::Options{}
          ...
          .set<google::cloud::visionai_v1::LiveVideoAnalyticsRetryPolicyOption>(
              google::cloud::visionai_v1::
                  LiveVideoAnalyticsLimitedErrorCountRetryPolicy(3)
                      .clone())
          .set<google::cloud::visionai_v1::
  ...
  auto c2 = google::cloud::visionai_v1::LiveVideoAnalyticsClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::visionai_v1::LiveVideoAnalyticsClient(
      connection,
      google::cloud::Options{}
          .set<google::cloud::visionai_v1::LiveVideoAnalyticsRetryPolicyOption>(
              google::cloud::visionai_v1::
  ...
  //     .set<google::cloud::visionai_v1::LiveVideoAnalyticsRetryPolicyOption>(
  //       google::cloud::visionai_v1::LiveVideoAnalyticsLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
      ...
      google::cloud::Options{}
          .set<google::cloud::visionai_v1::
              ...
              google::cloud::GenericPollingPolicy<
                  google::cloud::visionai_v1::
                      LiveVideoAnalyticsRetryPolicyOption::Type,
                  google::cloud::visionai_v1::
                      LiveVideoAnalyticsBackoffPolicyOption::Type>(
                  google::cloud::visionai_v1::
                      LiveVideoAnalyticsLimitedTimeRetryPolicy(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::visionai_v1::LiveVideoAnalyticsClient(
        google::cloud::visionai_v1::MakeLiveVideoAnalyticsConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
