...
// clang-format off
// main-dox-marker: visionai_v1::StreamsServiceClient
// lro-marker: true
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::visionai_v1::StreamsServiceClient(
      google::cloud::visionai_v1::MakeStreamsServiceConnection(options));
  //! [set-client-endpoint]
}
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::visionai_v1::StreamsServiceClient(
      google::cloud::visionai_v1::MakeStreamsServiceConnection(*ud_options));
  //! [set-client-universe-domain]
}

//! [custom-idempotency-policy]
class CustomIdempotencyPolicy : public google::cloud::visionai_v1::
                                    StreamsServiceConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<
      google::cloud::visionai_v1::StreamsServiceConnectionIdempotencyPolicy>
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options =
      google::cloud::Options{}
          .set<google::cloud::visionai_v1::
                   StreamsServiceConnectionIdempotencyPolicyOption>(
              CustomIdempotencyPolicy().clone())
          .set<google::cloud::visionai_v1::StreamsServiceRetryPolicyOption>(
              google::cloud::visionai_v1::
                  StreamsServiceLimitedErrorCountRetryPolicy(3)
                      .clone())
          .set<google::cloud::visionai_v1::StreamsServiceBackoffPolicyOption>(
  ...
  auto c1 = google::cloud::visionai_v1::StreamsServiceClient(connection);
  auto c2 = google::cloud::visionai_v1::StreamsServiceClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::visionai_v1::StreamsServiceClient(
      connection,
      google::cloud::Options{}
          .set<google::cloud::visionai_v1::StreamsServiceRetryPolicyOption>(
              google::cloud::visionai_v1::StreamsServiceLimitedTimeRetryPolicy(
  ...
  //     .set<google::cloud::visionai_v1::StreamsServiceRetryPolicyOption>(
  //       google::cloud::visionai_v1::StreamsServiceLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options =
      google::cloud::Options{}
          .set<google::cloud::visionai_v1::StreamsServicePollingPolicyOption>(
              google::cloud::GenericPollingPolicy<
                  google::cloud::visionai_v1::StreamsServiceRetryPolicyOption::
                      Type,
                  google::cloud::visionai_v1::
                      StreamsServiceBackoffPolicyOption::Type>(
                  google::cloud::visionai_v1::
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::visionai_v1::StreamsServiceClient(
        google::cloud::visionai_v1::MakeStreamsServiceConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
