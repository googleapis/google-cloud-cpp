...
// clang-format off
// main-dox-marker: visionai_v1::WarehouseClient
// lro-marker: true
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::visionai_v1::WarehouseClient(
      google::cloud::visionai_v1::MakeWarehouseConnection(options));
  //! [set-client-endpoint]
}
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::visionai_v1::WarehouseClient(
      google::cloud::visionai_v1::MakeWarehouseConnection(*ud_options));
  //! [set-client-universe-domain]
}

//! [custom-idempotency-policy]
class CustomIdempotencyPolicy
    : public google::cloud::visionai_v1::WarehouseConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<
      google::cloud::visionai_v1::WarehouseConnectionIdempotencyPolicy>
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options =
      google::cloud::Options{}
          ...
          .set<google::cloud::visionai_v1::WarehouseRetryPolicyOption>(
              google::cloud::visionai_v1::WarehouseLimitedErrorCountRetryPolicy(
                  3)
                  .clone())
          .set<google::cloud::visionai_v1::WarehouseBackoffPolicyOption>(
  ...
  auto c1 = google::cloud::visionai_v1::WarehouseClient(connection);
  auto c2 = google::cloud::visionai_v1::WarehouseClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::visionai_v1::WarehouseClient(
      connection,
      google::cloud::Options{}
          .set<google::cloud::visionai_v1::WarehouseRetryPolicyOption>(
              google::cloud::visionai_v1::WarehouseLimitedTimeRetryPolicy(
  ...
  //     .set<google::cloud::visionai_v1::WarehouseRetryPolicyOption>(
  //       google::cloud::visionai_v1::WarehouseLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options =
      google::cloud::Options{}
          .set<google::cloud::visionai_v1::WarehousePollingPolicyOption>(
              google::cloud::GenericPollingPolicy<
                  google::cloud::visionai_v1::WarehouseRetryPolicyOption::Type,
                  google::cloud::visionai_v1::WarehouseBackoffPolicyOption::
                      Type>(
                  google::cloud::visionai_v1::WarehouseLimitedTimeRetryPolicy(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::visionai_v1::WarehouseClient(
        google::cloud::visionai_v1::MakeWarehouseConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
