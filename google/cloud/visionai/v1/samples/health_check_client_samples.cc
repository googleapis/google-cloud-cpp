...
// clang-format off
// main-dox-marker: visionai_v1::HealthCheckServiceClient
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::visionai_v1::HealthCheckServiceClient(
      google::cloud::visionai_v1::MakeHealthCheckServiceConnection(options));
  //! [set-client-endpoint]
}
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::visionai_v1::HealthCheckServiceClient(
      google::cloud::visionai_v1::MakeHealthCheckServiceConnection(
          *ud_options));
  //! [set-client-universe-domain]
}
...
class CustomIdempotencyPolicy
    : public google::cloud::visionai_v1::
          HealthCheckServiceConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<
      google::cloud::visionai_v1::HealthCheckServiceConnectionIdempotencyPolicy>
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options =
      google::cloud::Options{}
          ...
          .set<google::cloud::visionai_v1::HealthCheckServiceRetryPolicyOption>(
              google::cloud::visionai_v1::
                  HealthCheckServiceLimitedErrorCountRetryPolicy(3)
                      .clone())
          .set<google::cloud::visionai_v1::
  ...
  auto c2 = google::cloud::visionai_v1::HealthCheckServiceClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::visionai_v1::HealthCheckServiceClient(
      connection,
      google::cloud::Options{}
          .set<google::cloud::visionai_v1::HealthCheckServiceRetryPolicyOption>(
              google::cloud::visionai_v1::
  ...
  //     .set<google::cloud::visionai_v1::HealthCheckServiceRetryPolicyOption>(
  //       google::cloud::visionai_v1::HealthCheckServiceLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::visionai_v1::HealthCheckServiceClient(
        google::cloud::visionai_v1::MakeHealthCheckServiceConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
