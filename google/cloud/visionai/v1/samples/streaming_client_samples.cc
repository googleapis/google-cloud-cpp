...
// clang-format off
// main-dox-marker: visionai_v1::StreamingServiceClient
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::visionai_v1::StreamingServiceClient(
      google::cloud::visionai_v1::MakeStreamingServiceConnection(options));
  //! [set-client-endpoint]
}
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::visionai_v1::StreamingServiceClient(
      google::cloud::visionai_v1::MakeStreamingServiceConnection(*ud_options));
  //! [set-client-universe-domain]
}
...
class CustomIdempotencyPolicy
 ...
 public:
  ...
  std::unique_ptr<
      google::cloud::visionai_v1::StreamingServiceConnectionIdempotencyPolicy>
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options =
      google::cloud::Options{}
          ...
          .set<google::cloud::visionai_v1::StreamingServiceRetryPolicyOption>(
              google::cloud::visionai_v1::
                  StreamingServiceLimitedErrorCountRetryPolicy(3)
                      .clone())
          .set<google::cloud::visionai_v1::StreamingServiceBackoffPolicyOption>(
  ...
  auto c1 = google::cloud::visionai_v1::StreamingServiceClient(connection);
  auto c2 = google::cloud::visionai_v1::StreamingServiceClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::visionai_v1::StreamingServiceClient(
      connection,
      google::cloud::Options{}
          .set<google::cloud::visionai_v1::StreamingServiceRetryPolicyOption>(
              google::cloud::visionai_v1::
  ...
  //     .set<google::cloud::visionai_v1::StreamingServiceRetryPolicyOption>(
  //       google::cloud::visionai_v1::StreamingServiceLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::visionai_v1::StreamingServiceClient(
        google::cloud::visionai_v1::MakeStreamingServiceConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
