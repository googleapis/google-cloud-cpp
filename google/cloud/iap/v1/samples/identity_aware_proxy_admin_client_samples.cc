...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::iap_v1::IdentityAwareProxyAdminServiceClient(
      google::cloud::iap_v1::MakeIdentityAwareProxyAdminServiceConnection(
          options));
  //! [set-client-endpoint]
}
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::iap_v1::IdentityAwareProxyAdminServiceClient(
      google::cloud::iap_v1::MakeIdentityAwareProxyAdminServiceConnection(
          ud_options));
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options =
      google::cloud::Options{}
          ...
          .set<google::cloud::iap_v1::
              ...
              google::cloud::iap_v1::
                  IdentityAwareProxyAdminServiceLimitedErrorCountRetryPolicy(3)
                      .clone())
          .set<google::cloud::iap_v1::
  ...
  auto c1 =
      google::cloud::iap_v1::IdentityAwareProxyAdminServiceClient(connection);
  auto c2 =
      google::cloud::iap_v1::IdentityAwareProxyAdminServiceClient(connection);
