...
class IdentityAwareProxyAdminServiceClient {
 public:
  ...
  /// [`StatusOr`]: @ref google::cloud::StatusOr
  /// [`Status`]: @ref google::cloud::Status
  /// [google.cloud.iap.v1.ValidateIapAttributeExpressionRequest]: @googleapis_reference_link{google/cloud/iap/v1/service.proto#L701}
  /// [google.cloud.iap.v1.ValidateIapAttributeExpressionResponse]: @googleapis_reference_link{google/cloud/iap/v1/service.proto#L712}
  ///
  // clang-format on
