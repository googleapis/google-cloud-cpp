...
StatusOr<google::cloud::iap::v1::ListBrandsResponse> IdentityAwareProxyOAuthServiceAuth::ListBrands(
...
StatusOr<google::cloud::iap::v1::Brand> IdentityAwareProxyOAuthServiceAuth::CreateBrand(
    grpc::ClientContext& context,
    Options const& options,
...
StatusOr<google::cloud::iap::v1::Brand> IdentityAwareProxyOAuthServiceAuth::GetBrand(
    grpc::ClientContext& context,
    Options const& options,
...
StatusOr<google::cloud::iap::v1::IdentityAwareProxyClient> IdentityAwareProxyOAuthServiceAuth::CreateIdentityAwareProxyClient(
    grpc::ClientContext& context,
    Options const& options,
...
StatusOr<google::cloud::iap::v1::ListIdentityAwareProxyClientsResponse> IdentityAwareProxyOAuthServiceAuth::ListIdentityAwareProxyClients(
    grpc::ClientContext& context,
    Options const& options,
...
StatusOr<google::cloud::iap::v1::IdentityAwareProxyClient> IdentityAwareProxyOAuthServiceAuth::GetIdentityAwareProxyClient(
    grpc::ClientContext& context,
    Options const& options,
...
StatusOr<google::cloud::iap::v1::IdentityAwareProxyClient> IdentityAwareProxyOAuthServiceAuth::ResetIdentityAwareProxyClientSecret(
    grpc::ClientContext& context,
    Options const& options,
