...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_IAP_V1_INTERNAL_IDENTITY_AWARE_PROXY_O_AUTH_AUTH_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_IAP_V1_INTERNAL_IDENTITY_AWARE_PROXY_O_AUTH_AUTH_DECORATOR_H
...
class IdentityAwareProxyOAuthServiceAuth : public IdentityAwareProxyOAuthServiceStub {
 public:
  ~IdentityAwareProxyOAuthServiceAuth() override = default;
  IdentityAwareProxyOAuthServiceAuth(
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_IAP_V1_INTERNAL_IDENTITY_AWARE_PROXY_O_AUTH_AUTH_DECORATOR_H
