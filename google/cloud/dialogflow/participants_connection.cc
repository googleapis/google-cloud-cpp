...
#include "google/cloud/dialogflow/internal/participants_connection_impl.h"
#include "google/cloud/dialogflow/internal/participants_option_defaults.h"
#include "google/cloud/dialogflow/internal/participants_stub_factory.h"
#include "google/cloud/dialogflow/participants_options.h"
...
std::shared_ptr<ParticipantsConnection> MakeParticipantsConnection(
  ...
  internal::CheckExpectedOptions<CommonOptionList, GrpcOptionList,
                                 ParticipantsPolicyOptionList>(options,
                                                               __func__);
  options = dialogflow_internal::ParticipantsDefaultOptions(std::move(options));
  auto background = internal::MakeBackgroundThreadsFactory(options)();
  auto stub = dialogflow_internal::CreateDefaultParticipantsStub(
      background->cq(), options);
  return std::make_shared<dialogflow_internal::ParticipantsConnectionImpl>(
...
std::shared_ptr<dialogflow::ParticipantsConnection> MakeParticipantsConnection(
    std::shared_ptr<ParticipantsStub> stub, Options options) {
  options = ParticipantsDefaultOptions(std::move(options));
  auto background = internal::MakeBackgroundThreadsFactory(options)();
  return std::make_shared<dialogflow_internal::ParticipantsConnectionImpl>(
      std::move(background), std::move(stub), std::move(options));
}
