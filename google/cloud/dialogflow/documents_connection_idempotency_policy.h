...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_DOCUMENTS_CONNECTION_IDEMPOTENCY_POLICY_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_DOCUMENTS_CONNECTION_IDEMPOTENCY_POLICY_H
...
class DocumentsConnectionIdempotencyPolicy {
 public:
  virtual ~DocumentsConnectionIdempotencyPolicy() = 0;

  /// Create a new copy of this object.
  virtual std::unique_ptr<DocumentsConnectionIdempotencyPolicy> clone()
      const = 0;

  virtual google::cloud::Idempotency ListDocuments(
      google::cloud::dialogflow::v2::ListDocumentsRequest request) = 0;
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_DOCUMENTS_CONNECTION_IDEMPOTENCY_POLICY_H
