...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_KNOWLEDGE_BASES_CONNECTION_IDEMPOTENCY_POLICY_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_KNOWLEDGE_BASES_CONNECTION_IDEMPOTENCY_POLICY_H
...
class KnowledgeBasesConnectionIdempotencyPolicy {
 public:
  virtual ~KnowledgeBasesConnectionIdempotencyPolicy() = 0;
  ...
  virtual google::cloud::Idempotency ListKnowledgeBases(
      google::cloud::dialogflow::v2::ListKnowledgeBasesRequest request) = 0;
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_KNOWLEDGE_BASES_CONNECTION_IDEMPOTENCY_POLICY_H
