...
#include "google/cloud/dialogflow/internal/entity_types_connection_impl.h"
#include "google/cloud/dialogflow/internal/entity_types_option_defaults.h"
#include "google/cloud/dialogflow/internal/entity_types_stub_factory.h"
...
std::shared_ptr<EntityTypesConnection> MakeEntityTypesConnection(
  ...
  internal::CheckExpectedOptions<CommonOptionList, GrpcOptionList,
                                 EntityTypesPolicyOptionList>(options,
                                                              __func__);
  options = dialogflow_internal::EntityTypesDefaultOptions(std::move(options));
  auto background = internal::MakeBackgroundThreadsFactory(options)();
  auto stub = dialogflow_internal::CreateDefaultEntityTypesStub(
      background->cq(), options);
  return std::make_shared<dialogflow_internal::EntityTypesConnectionImpl>(
...
std::shared_ptr<dialogflow::EntityTypesConnection> MakeEntityTypesConnection(
  ...
  options = EntityTypesDefaultOptions(std::move(options));
  auto background = internal::MakeBackgroundThreadsFactory(options)();
  return std::make_shared<dialogflow_internal::EntityTypesConnectionImpl>(
      std::move(background), std::move(stub), std::move(options));
}
