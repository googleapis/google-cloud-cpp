...
#include "google/cloud/dialogflow/internal/agents_connection_impl.h"
#include "google/cloud/dialogflow/internal/agents_option_defaults.h"
#include "google/cloud/dialogflow/internal/agents_stub_factory.h"
...
std::shared_ptr<AgentsConnection> MakeAgentsConnection(Options options) {
  ...
  options = dialogflow_internal::AgentsDefaultOptions(std::move(options));
  auto background = internal::MakeBackgroundThreadsFactory(options)();
  auto stub =
      dialogflow_internal::CreateDefaultAgentsStub(background->cq(), options);
  return std::make_shared<dialogflow_internal::AgentsConnectionImpl>(
