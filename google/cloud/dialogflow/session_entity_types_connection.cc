...
#include "google/cloud/dialogflow/internal/session_entity_types_connection_impl.h"
#include "google/cloud/dialogflow/internal/session_entity_types_option_defaults.h"
#include "google/cloud/dialogflow/internal/session_entity_types_stub_factory.h"
...
std::shared_ptr<SessionEntityTypesConnection> MakeSessionEntityTypesConnection(
  ...
  internal::CheckExpectedOptions<CommonOptionList, GrpcOptionList,
                                 SessionEntityTypesPolicyOptionList>(options,
                                                                     __func__);
  options =
      dialogflow_internal::SessionEntityTypesDefaultOptions(std::move(options));
  auto background = internal::MakeBackgroundThreadsFactory(options)();
  auto stub = dialogflow_internal::CreateDefaultSessionEntityTypesStub(
      background->cq(), options);
  return std::make_shared<
      dialogflow_internal::SessionEntityTypesConnectionImpl>(
...
std::shared_ptr<dialogflow::SessionEntityTypesConnection>
MakeSessionEntityTypesConnection(std::shared_ptr<SessionEntityTypesStub> stub,
                                 Options options) {
  options = SessionEntityTypesDefaultOptions(std::move(options));
  auto background = internal::MakeBackgroundThreadsFactory(options)();
  return std::make_shared<
      dialogflow_internal::SessionEntityTypesConnectionImpl>(
      std::move(background), std::move(stub), std::move(options));
