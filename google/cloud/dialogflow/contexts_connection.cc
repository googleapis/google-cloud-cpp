...
#include "google/cloud/dialogflow/internal/contexts_connection_impl.h"
#include "google/cloud/dialogflow/internal/contexts_option_defaults.h"
#include "google/cloud/dialogflow/internal/contexts_stub_factory.h"
...
std::shared_ptr<ContextsConnection> MakeContextsConnection(Options options) {
  ...
  options = dialogflow_internal::ContextsDefaultOptions(std::move(options));
  auto background = internal::MakeBackgroundThreadsFactory(options)();
  auto stub =
      dialogflow_internal::CreateDefaultContextsStub(background->cq(), options);
  return std::make_shared<dialogflow_internal::ContextsConnectionImpl>(
...
std::shared_ptr<dialogflow::ContextsConnection> MakeContextsConnection(
