...
#include "google/cloud/dialogflow/internal/environments_stub_factory.h"
...
std::shared_ptr<EnvironmentsConnection> MakeEnvironmentsConnection(
  ...
  internal::CheckExpectedOptions<CommonOptionList, GrpcOptionList,
                                 EnvironmentsPolicyOptionList>(options,
                                                               __func__);
  options = dialogflow_internal::EnvironmentsDefaultOptions(std::move(options));
  auto background = internal::MakeBackgroundThreadsFactory(options)();
  auto stub = dialogflow_internal::CreateDefaultEnvironmentsStub(
      background->cq(), options);
  return std::make_shared<dialogflow_internal::EnvironmentsConnectionImpl>(
