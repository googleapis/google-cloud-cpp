...
#include "google/cloud/dialogflow/internal/documents_stub_factory.h"
...
std::shared_ptr<DocumentsConnection> MakeDocumentsConnection(Options options) {
  ...
  options = dialogflow_internal::DocumentsDefaultOptions(std::move(options));
  auto background = internal::MakeBackgroundThreadsFactory(options)();
  auto stub = dialogflow_internal::CreateDefaultDocumentsStub(background->cq(),
                                                              options);
  return std::make_shared<dialogflow_internal::DocumentsConnectionImpl>(
...
std::shared_ptr<dialogflow::DocumentsConnection> MakeDocumentsConnection(
  ...
  options = DocumentsDefaultOptions(std::move(options));
  auto background = internal::MakeBackgroundThreadsFactory(options)();
  return std::make_shared<dialogflow_internal::DocumentsConnectionImpl>(
      std::move(background), std::move(stub), std::move(options));
}
