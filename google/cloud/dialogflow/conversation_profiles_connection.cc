...
#include "google/cloud/dialogflow/internal/conversation_profiles_stub_factory.h"
...
MakeConversationProfilesConnection(Options options) {
  internal::CheckExpectedOptions<CommonOptionList, GrpcOptionList,
      ...
      options, __func__);
  options = dialogflow_internal::ConversationProfilesDefaultOptions(
      std::move(options));
  auto background = internal::MakeBackgroundThreadsFactory(options)();
  auto stub = dialogflow_internal::CreateDefaultConversationProfilesStub(
      background->cq(), options);
  return std::make_shared<
      dialogflow_internal::ConversationProfilesConnectionImpl>(
...
MakeConversationProfilesConnection(
  ...
  options = ConversationProfilesDefaultOptions(std::move(options));
  auto background = internal::MakeBackgroundThreadsFactory(options)();
  return std::make_shared<
      dialogflow_internal::ConversationProfilesConnectionImpl>(
      std::move(background), std::move(stub), std::move(options));
