...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_SESSION_ENTITY_TYPES_CONNECTION_IDEMPOTENCY_POLICY_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_SESSION_ENTITY_TYPES_CONNECTION_IDEMPOTENCY_POLICY_H
...
class SessionEntityTypesConnectionIdempotencyPolicy {
 public:
  virtual ~SessionEntityTypesConnectionIdempotencyPolicy() = 0;
  ...
  virtual google::cloud::Idempotency ListSessionEntityTypes(
      google::cloud::dialogflow::v2::ListSessionEntityTypesRequest request) = 0;
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_SESSION_ENTITY_TYPES_CONNECTION_IDEMPOTENCY_POLICY_H
