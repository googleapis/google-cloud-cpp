...
std::shared_ptr<VersionsConnection> MakeVersionsConnection(Options options) {
  ...
  options = dialogflow_internal::VersionsDefaultOptions(std::move(options));
  auto background = internal::MakeBackgroundThreadsFactory(options)();
  auto stub =
      dialogflow_internal::CreateDefaultVersionsStub(background->cq(), options);
  return std::make_shared<dialogflow_internal::VersionsConnectionImpl>(
