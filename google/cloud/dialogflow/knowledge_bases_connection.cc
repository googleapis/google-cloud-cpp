...
std::shared_ptr<KnowledgeBasesConnection> MakeKnowledgeBasesConnection(
  ...
  internal::CheckExpectedOptions<CommonOptionList, GrpcOptionList,
                                 KnowledgeBasesPolicyOptionList>(options,
                                                                 __func__);
  options =
      dialogflow_internal::KnowledgeBasesDefaultOptions(std::move(options));
  auto background = internal::MakeBackgroundThreadsFactory(options)();
  auto stub = dialogflow_internal::CreateDefaultKnowledgeBasesStub(
      background->cq(), options);
  return std::make_shared<dialogflow_internal::KnowledgeBasesConnectionImpl>(
