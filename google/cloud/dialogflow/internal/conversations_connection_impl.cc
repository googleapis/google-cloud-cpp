...
ConversationsConnectionImpl::ConversationsConnectionImpl(
    ...
    std::shared_ptr<dialogflow_internal::ConversationsStub> stub,
    Options options)
    : background_(std::move(background)),
      stub_(std::move(stub)),
      options_(internal::MergeOptions(
          std::move(options), dialogflow_internal::ConversationsDefaultOptions(
...
ConversationsConnectionImpl::ListConversations(
  ...
  auto stub = stub_;
  auto retry = std::shared_ptr<dialogflow::ConversationsRetryPolicy const>(
      retry_policy());
