...
#include "google/cloud/dialogflow/internal/intents_connection_impl.h"
...
IntentsConnectionImpl::IntentsConnectionImpl(
    ...
    : background_(std::move(background)),
      ...
      options_(internal::MergeOptions(
          std::move(options), dialogflow_internal::IntentsDefaultOptions(
...
IntentsConnectionImpl::ListIntents(
  ...
  auto stub = stub_;
  auto retry =
      std::shared_ptr<dialogflow::IntentsRetryPolicy const>(retry_policy());
