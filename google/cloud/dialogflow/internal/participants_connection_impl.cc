...
ParticipantsConnectionImpl::ParticipantsConnectionImpl(
    ...
    std::shared_ptr<dialogflow_internal::ParticipantsStub> stub,
    Options options)
    : background_(std::move(background)),
      stub_(std::move(stub)),
      options_(internal::MergeOptions(
          std::move(options), dialogflow_internal::ParticipantsDefaultOptions(
...
ParticipantsConnectionImpl::ListParticipants(
  ...
  auto stub = stub_;
  auto retry = std::shared_ptr<dialogflow::ParticipantsRetryPolicy const>(
      retry_policy());
