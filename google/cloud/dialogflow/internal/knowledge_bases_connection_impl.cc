...
#include "google/cloud/dialogflow/internal/knowledge_bases_connection_impl.h"
...
KnowledgeBasesConnectionImpl::KnowledgeBasesConnectionImpl(
    ...
    : background_(std::move(background)),
      ...
      options_(internal::MergeOptions(
          std::move(options), dialogflow_internal::KnowledgeBasesDefaultOptions(
...
KnowledgeBasesConnectionImpl::ListKnowledgeBases(
  ...
  auto stub = stub_;
  auto retry = std::shared_ptr<dialogflow::KnowledgeBasesRetryPolicy const>(
      retry_policy());
