...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_INTERNAL_VERSIONS_STUB_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_INTERNAL_VERSIONS_STUB_H
...
class DefaultVersionsStub : public VersionsStub {
 public:
  explicit DefaultVersionsStub(
      std::unique_ptr<google::cloud::dialogflow::v2::Versions::StubInterface>
          grpc_stub)
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_INTERNAL_VERSIONS_STUB_H
