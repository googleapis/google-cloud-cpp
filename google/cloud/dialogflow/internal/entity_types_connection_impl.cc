...
EntityTypesConnectionImpl::EntityTypesConnectionImpl(
    ...
    std::shared_ptr<dialogflow_internal::EntityTypesStub> stub, Options options)
    : background_(std::move(background)),
      stub_(std::move(stub)),
      options_(internal::MergeOptions(
          std::move(options), dialogflow_internal::EntityTypesDefaultOptions(
...
EntityTypesConnectionImpl::ListEntityTypes(
  ...
  auto stub = stub_;
  auto retry =
      std::shared_ptr<dialogflow::EntityTypesRetryPolicy const>(retry_policy());
