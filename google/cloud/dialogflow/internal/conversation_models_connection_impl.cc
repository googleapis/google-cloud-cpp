...
#include "google/cloud/dialogflow/internal/conversation_models_connection_impl.h"
...
ConversationModelsConnectionImpl::ListConversationModels(
  ...
  auto stub = stub_;
  auto retry = std::shared_ptr<dialogflow::ConversationModelsRetryPolicy const>(
      retry_policy());
