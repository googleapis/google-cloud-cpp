...
#include "google/cloud/dialogflow/internal/versions_connection_impl.h"
#include "google/cloud/dialogflow/internal/versions_option_defaults.h"
...
VersionsConnectionImpl::VersionsConnectionImpl(
    ...
    : background_(std::move(background)),
      ...
      options_(internal::MergeOptions(
          std::move(options), dialogflow_internal::VersionsDefaultOptions(
...
VersionsConnectionImpl::ListVersions(
  ...
  auto stub = stub_;
  auto retry =
      std::shared_ptr<dialogflow::VersionsRetryPolicy const>(retry_policy());
