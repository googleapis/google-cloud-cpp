...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_INTERNAL_CONTEXTS_AUTH_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_INTERNAL_CONTEXTS_AUTH_DECORATOR_H
...
class ContextsAuth : public ContextsStub {
 public:
  ~ContextsAuth() override = default;
  ContextsAuth(
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_INTERNAL_CONTEXTS_AUTH_DECORATOR_H
