...
#include "google/cloud/dialogflow/internal/fulfillments_connection_impl.h"
#include "google/cloud/dialogflow/internal/fulfillments_option_defaults.h"
...
FulfillmentsConnectionImpl::FulfillmentsConnectionImpl(
    ...
    : background_(std::move(background)),
      ...
      options_(internal::MergeOptions(
          std::move(options), dialogflow_internal::FulfillmentsDefaultOptions(
