...
#include "google/cloud/dialogflow/internal/environments_connection_impl.h"
#include "google/cloud/dialogflow/internal/environments_option_defaults.h"
...
EnvironmentsConnectionImpl::EnvironmentsConnectionImpl(
    ...
    : background_(std::move(background)),
      ...
      options_(internal::MergeOptions(
          std::move(options), dialogflow_internal::EnvironmentsDefaultOptions(
...
EnvironmentsConnectionImpl::ListEnvironments(
  ...
  auto stub = stub_;
  auto retry = std::shared_ptr<dialogflow::EnvironmentsRetryPolicy const>(
      retry_policy());
