...
#include "google/cloud/dialogflow/internal/sessions_auth_decorator.h"
#include "google/cloud/dialogflow/internal/sessions_logging_decorator.h"
...
std::shared_ptr<SessionsStub> CreateDefaultSessionsStub(
  ...
  auto service_grpc_stub =
      google::cloud::dialogflow::v2::Sessions::NewStub(channel);
