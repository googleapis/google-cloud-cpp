...
#include "google/cloud/dialogflow/internal/conversation_models_stub_factory.h"
...
std::shared_ptr<ConversationModelsConnection> MakeConversationModelsConnection(
  ...
  internal::CheckExpectedOptions<CommonOptionList, GrpcOptionList,
                                 ConversationModelsPolicyOptionList>(options,
                                                                     __func__);
  options =
      dialogflow_internal::ConversationModelsDefaultOptions(std::move(options));
  auto background = internal::MakeBackgroundThreadsFactory(options)();
  auto stub = dialogflow_internal::CreateDefaultConversationModelsStub(
      background->cq(), options);
  return std::make_shared<
      dialogflow_internal::ConversationModelsConnectionImpl>(
