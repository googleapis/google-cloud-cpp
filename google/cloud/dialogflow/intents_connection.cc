...
std::shared_ptr<IntentsConnection> MakeIntentsConnection(Options options) {
  ...
  options = dialogflow_internal::IntentsDefaultOptions(std::move(options));
  auto background = internal::MakeBackgroundThreadsFactory(options)();
  auto stub =
      dialogflow_internal::CreateDefaultIntentsStub(background->cq(), options);
  return std::make_shared<dialogflow_internal::IntentsConnectionImpl>(
...
std::shared_ptr<dialogflow::IntentsConnection> MakeIntentsConnection(
  ...
  options = IntentsDefaultOptions(std::move(options));
  auto background = internal::MakeBackgroundThreadsFactory(options)();
  return std::make_shared<dialogflow_internal::IntentsConnectionImpl>(
      std::move(background), std::move(stub), std::move(options));
}
