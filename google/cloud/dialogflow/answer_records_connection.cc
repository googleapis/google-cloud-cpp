...
#include "google/cloud/dialogflow/internal/answer_records_connection_impl.h"
#include "google/cloud/dialogflow/internal/answer_records_option_defaults.h"
#include "google/cloud/dialogflow/internal/answer_records_stub_factory.h"
...
std::shared_ptr<AnswerRecordsConnection> MakeAnswerRecordsConnection(
  ...
  internal::CheckExpectedOptions<CommonOptionList, GrpcOptionList,
                                 AnswerRecordsPolicyOptionList>(options,
                                                                __func__);
  options =
      dialogflow_internal::AnswerRecordsDefaultOptions(std::move(options));
  auto background = internal::MakeBackgroundThreadsFactory(options)();
  auto stub = dialogflow_internal::CreateDefaultAnswerRecordsStub(
      background->cq(), options);
  return std::make_shared<dialogflow_internal::AnswerRecordsConnectionImpl>(
...
std::shared_ptr<dialogflow::AnswerRecordsConnection>
