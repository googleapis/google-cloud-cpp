# HOWTO: using the Apigee Registry API C++ client in your project

This directory contains small examples showing how to use the Apigee Registry
...
Like most Google Cloud Platform (GCP) services, Apigee Registry API requires
...
1. Compile this example using Bazel:
   ...
   ```bash
   cd $HOME/google-cloud-cpp/google/cloud/apigeeregistry/quickstart
   bazel build ...
   ```
...
1. Install the dependencies with your favorite tools. As an example, if you use
   ...
   ```bash
   cd $HOME/vcpkg
   ./vcpkg install google-cloud-cpp[core,apigeeregistry]
   ```
...
[quickstart-link]: https://cloud.google.com/apigeeregistry/docs/quickstart
