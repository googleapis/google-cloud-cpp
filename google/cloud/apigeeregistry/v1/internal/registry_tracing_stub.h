...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_APIGEEREGISTRY_V1_INTERNAL_REGISTRY_TRACING_STUB_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_APIGEEREGISTRY_V1_INTERNAL_REGISTRY_TRACING_STUB_H
...
class RegistryTracingStub : public RegistryStub {
 public:
  ~RegistryTracingStub() override = default;

  explicit RegistryTracingStub(std::shared_ptr<RegistryStub> child);
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_APIGEEREGISTRY_V1_INTERNAL_REGISTRY_TRACING_STUB_H
