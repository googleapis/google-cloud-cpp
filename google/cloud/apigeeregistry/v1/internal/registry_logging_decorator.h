...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_APIGEEREGISTRY_V1_INTERNAL_REGISTRY_LOGGING_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_APIGEEREGISTRY_V1_INTERNAL_REGISTRY_LOGGING_DECORATOR_H
...
class RegistryLogging : public RegistryStub {
 public:
  ~RegistryLogging() override = default;
  RegistryLogging(std::shared_ptr<RegistryStub> child,
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_APIGEEREGISTRY_V1_INTERNAL_REGISTRY_LOGGING_DECORATOR_H
