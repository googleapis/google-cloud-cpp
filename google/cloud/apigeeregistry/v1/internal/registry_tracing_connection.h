...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_APIGEEREGISTRY_V1_INTERNAL_REGISTRY_TRACING_CONNECTION_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_APIGEEREGISTRY_V1_INTERNAL_REGISTRY_TRACING_CONNECTION_H
...
class RegistryTracingConnection : public apigeeregistry_v1::RegistryConnection {
 public:
  ~RegistryTracingConnection() override = default;

  explicit RegistryTracingConnection(
 ...
 private:
  std::shared_ptr<apigeeregistry_v1::RegistryConnection> child_;
};
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_APIGEEREGISTRY_V1_INTERNAL_REGISTRY_TRACING_CONNECTION_H
