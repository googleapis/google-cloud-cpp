...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_APIGEEREGISTRY_V1_INTERNAL_REGISTRY_METADATA_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_APIGEEREGISTRY_V1_INTERNAL_REGISTRY_METADATA_DECORATOR_H
...
class RegistryMetadata : public RegistryStub {
 public:
  ~RegistryMetadata() override = default;
  RegistryMetadata(std::shared_ptr<RegistryStub> child,
 ...
 private:
  ...
  std::shared_ptr<RegistryStub> child_;
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_APIGEEREGISTRY_V1_INTERNAL_REGISTRY_METADATA_DECORATOR_H
