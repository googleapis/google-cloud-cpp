...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_POLICYTROUBLESHOOTER_IAM_V3_POLICIES_CONNECTION_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_POLICYTROUBLESHOOTER_IAM_V3_POLICIES_CONNECTION_H

#include "google/cloud/policytroubleshooter/iam/v3/internal/policies_retry_traits.h"
...
class PoliciesRetryPolicy : public ::google::cloud::RetryPolicy {
 public:
  /// Creates a new instance of the policy, reset to the initial state.
  virtual std::unique_ptr<PoliciesRetryPolicy> clone() const = 0;
};

/**
 * A retry policy for `PoliciesConnection` based on counting errors.
 *
 ...
 */
class PoliciesLimitedErrorCountRetryPolicy : public PoliciesRetryPolicy {
 public:
  /**
  ...
  std::unique_ptr<PoliciesRetryPolicy> clone() const override {
    return std::make_unique<PoliciesLimitedErrorCountRetryPolicy>(
        maximum_failures());
  }
 ...
 private:
  google::cloud::internal::LimitedErrorCountRetryPolicy<
      policytroubleshooter_iam_v3_internal::PoliciesRetryTraits>
      impl_;
};

/**
 * A retry policy for `PoliciesConnection` based on elapsed time.
 *
 * This policy stops retrying if:
 * - An RPC returns a non-transient error.
 ...
 * - [`kUnavailable`](@ref google::cloud::StatusCode)
 */
class PoliciesLimitedTimeRetryPolicy : public PoliciesRetryPolicy {
 public:
  /**
 ...
 *
 * For mocking, see `policytroubleshooter_iam_v3_mocks::MockPoliciesConnection`.
 */
 ...
 * - `google::cloud::policytroubleshooter_iam_v3::PoliciesPolicyOptionList`
 *
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_POLICYTROUBLESHOOTER_IAM_V3_POLICIES_CONNECTION_H
