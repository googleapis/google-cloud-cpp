...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client =
      google::cloud::policytroubleshooter_iam_v3::PolicyTroubleshooterClient(
          google::cloud::policytroubleshooter_iam_v3::
              MakePolicyTroubleshooterConnection(ud_options));
  ...
  auto options =
      google::cloud::Options{}
          ...
          .set<google::cloud::policytroubleshooter_iam_v3::
              ...
              google::cloud::policytroubleshooter_iam_v3::
                  PolicyTroubleshooterLimitedErrorCountRetryPolicy(3)
                      .clone())
          .set<google::cloud::policytroubleshooter_iam_v3::
              ...
              google::cloud::ExponentialBackoffPolicy(
                  ...
                  /*scaling=*/2.0)
                  .clone());
  auto connection = google::cloud::policytroubleshooter_iam_v3::
      MakePolicyTroubleshooterConnection(options);
