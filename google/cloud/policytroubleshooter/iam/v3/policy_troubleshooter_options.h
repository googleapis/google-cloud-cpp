...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_POLICYTROUBLESHOOTER_IAM_V3_POLICY_TROUBLESHOOTER_OPTIONS_H
 ...
 */
struct PolicyTroubleshooterRetryPolicyOption {
  using Type = std::shared_ptr<PolicyTroubleshooterRetryPolicy>;
};
 ...
 * @ingroup google-cloud-policytroubleshooter-options
 */
struct PolicyTroubleshooterBackoffPolicyOption {
 ...
 * @ingroup google-cloud-policytroubleshooter-options
 */
struct PolicyTroubleshooterConnectionIdempotencyPolicyOption {
  using Type = std::shared_ptr<PolicyTroubleshooterConnectionIdempotencyPolicy>;
};
 ...
 * @ingroup google-cloud-policytroubleshooter-options
 */
using PolicyTroubleshooterPolicyOptionList =
    OptionList<PolicyTroubleshooterRetryPolicyOption,
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_POLICYTROUBLESHOOTER_IAM_V3_POLICY_TROUBLESHOOTER_OPTIONS_H
