...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_POLICYTROUBLESHOOTER_IAM_V3_INTERNAL_POLICY_TROUBLESHOOTER_AUTH_DECORATOR_H
...
class PolicyTroubleshooterAuth : public PolicyTroubleshooterStub {
 public:
  ~PolicyTroubleshooterAuth() override = default;
  PolicyTroubleshooterAuth(
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_POLICYTROUBLESHOOTER_IAM_V3_INTERNAL_POLICY_TROUBLESHOOTER_AUTH_DECORATOR_H
