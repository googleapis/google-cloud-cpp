...
std::shared_ptr<PolicyTroubleshooterStub> CreateDefaultPolicyTroubleshooterStub(
  ...
  auto endpoint = internal::DetermineServiceEndpoint(
      internal::GetEnv("GOOGLE_CLOUD_CPP_POLICY_TROUBLESHOOTER_ENDPOINT"),
  ...
  if (!endpoint.ok()) {
    ...
    stub = std::make_shared<DefaultPolicyTroubleshooterStub>(
  ...
  if (internal::TracingEnabled(options)) {
    stub = MakePolicyTroubleshooterTracingStub(std::move(stub));
  }
  return stub;
}
