...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_POLICYTROUBLESHOOTER_IAM_V3_POLICIES_OPTIONS_H
...
struct PoliciesRetryPolicyOption {
  using Type = std::shared_ptr<PoliciesRetryPolicy>;
};
...
struct PoliciesConnectionIdempotencyPolicyOption {
  using Type = std::shared_ptr<PoliciesConnectionIdempotencyPolicy>;
};
...
/**
 * The options applicable to Policies.
 *
 * @ingroup google-cloud-policytroubleshooter-options
 */
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_POLICYTROUBLESHOOTER_IAM_V3_POLICIES_OPTIONS_H
