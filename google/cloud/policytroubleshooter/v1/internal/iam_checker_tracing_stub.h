...
class IamCheckerTracingStub : public IamCheckerStub {
 public:
  ~IamCheckerTracingStub() override = default;
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_POLICYTROUBLESHOOTER_V1_INTERNAL_IAM_CHECKER_TRACING_STUB_H
