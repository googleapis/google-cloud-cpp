...
retry_policy(Options const& options) {
  return options.get<policytroubleshooter_v1::IamCheckerRetryPolicyOption>()->clone();
}

std::unique_ptr<BackoffPolicy>
backoff_policy(Options const& options) {
  return options.get<policytroubleshooter_v1::IamCheckerBackoffPolicyOption>()->clone();
}

std::unique_ptr<policytroubleshooter_v1::IamCheckerConnectionIdempotencyPolicy>
idempotency_policy(Options const& options) {
  return options.get<policytroubleshooter_v1::IamCheckerConnectionIdempotencyPolicyOption>()->clone();
}
