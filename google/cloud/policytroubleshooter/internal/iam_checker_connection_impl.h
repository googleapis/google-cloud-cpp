 ...
 private:
  std::unique_ptr<policytroubleshooter::IamCheckerRetryPolicy> retry_policy() {
    ...
    if (options.has<policytroubleshooter::IamCheckerRetryPolicyOption>()) {
      return options.get<policytroubleshooter::IamCheckerRetryPolicyOption>()->clone();
    }
  ...
  std::unique_ptr<BackoffPolicy> backoff_policy() {
    ...
    if (options.has<policytroubleshooter::IamCheckerBackoffPolicyOption>()) {
      return options.get<policytroubleshooter::IamCheckerBackoffPolicyOption>()->clone();
    }
    return backoff_policy_prototype_->clone();
  }

  std::unique_ptr<policytroubleshooter::IamCheckerConnectionIdempotencyPolicy> idempotency_policy() {
    auto const& options = internal::CurrentOptions();
    if (options.has<policytroubleshooter::IamCheckerConnectionIdempotencyPolicyOption>()) {
      return options.get<policytroubleshooter::IamCheckerConnectionIdempotencyPolicyOption>()->clone();
    }
  ...
  std::unique_ptr<policytroubleshooter::IamCheckerRetryPolicy const> retry_policy_prototype_;
  std::unique_ptr<BackoffPolicy const> backoff_policy_prototype_;
  std::unique_ptr<policytroubleshooter::IamCheckerConnectionIdempotencyPolicy> idempotency_policy_;
};
