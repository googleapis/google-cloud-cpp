...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::connectors::ConnectorsClient(
      google::cloud::connectors::MakeConnectorsConnection(options));
  //! [set-client-endpoint]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::connectors::ConnectorsClient(
        google::cloud::connectors::MakeConnectorsConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
