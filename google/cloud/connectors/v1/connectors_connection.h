...
/**
 * A retry policy for `ConnectorsConnection` that stops retrying after a
...
class ConnectorsLimitedErrorCountRetryPolicy : public ConnectorsRetryPolicy {
 public:
  ConnectorsLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `ConnectorsConnection` that stops retrying after
