...
// clang-format off
// main-dox-marker: connectors_v1::ConnectorsClient
// lro-marker: true
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::connectors_v1::ConnectorsClient(
      google::cloud::connectors_v1::MakeConnectorsConnection(options));
  //! [set-client-endpoint]
}

//! [custom-idempotency-policy]
class CustomIdempotencyPolicy
   : public google::cloud::connectors_v1::ConnectorsConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::connectors_v1::ConnectorsConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::connectors_v1::ConnectorsConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::connectors_v1::ConnectorsRetryPolicyOption>(
      google::cloud::connectors_v1::ConnectorsLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::connectors_v1::ConnectorsBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::connectors_v1::MakeConnectorsConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::connectors_v1::ConnectorsClient(connection);
  auto c2 = google::cloud::connectors_v1::ConnectorsClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::connectors_v1::ConnectorsClient(
    connection, google::cloud::Options{}.set<google::cloud::connectors_v1::ConnectorsRetryPolicyOption>(
      google::cloud::connectors_v1::ConnectorsLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::connectors_v1::ConnectorsRetryPolicyOption>(
  //       google::cloud::connectors_v1::ConnectorsLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::connectors_v1::ConnectorsPollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::connectors_v1::ConnectorsRetryPolicyOption::Type,
            google::cloud::connectors_v1::ConnectorsBackoffPolicyOption::Type>(
            google::cloud::connectors_v1::ConnectorsLimitedTimeRetryPolicy(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::connectors_v1::ConnectorsClient(
      google::cloud::connectors_v1::MakeConnectorsConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
