...
std::shared_ptr<ConnectorsStub> CreateDefaultConnectorsStub(
  ...
  auto endpoint = internal::DetermineServiceEndpoint(
      internal::GetEnv("GOOGLE_CLOUD_CPP_CONNECTORS_ENDPOINT"),
      std::move(endpoint_option), "connectors.googleapis.com", options);
  ...
  if (!endpoint.ok()) {
    ...
    stub = std::make_shared<DefaultConnectorsStub>(
