...
Options ConnectorsDefaultOptions(Options options) {
  options = internal::PopulateCommonOptions(
      ...
      "", "GOOGLE_CLOUD_CPP_CONNECTORS_AUTHORITY",
  ...
  if (!options.has<connectors_v1::ConnectorsConnectionIdempotencyPolicyOption>()) {
    options.set<connectors_v1::ConnectorsConnectionIdempotencyPolicyOption>(
        connectors_v1::MakeDefaultConnectorsConnectionIdempotencyPolicy());
  }
