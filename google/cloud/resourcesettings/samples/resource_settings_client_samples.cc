...
// main-dox-marker: GOOGLE_CLOUD_CPP_NS::ResourceSettingsServiceClient
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client =
      google::cloud::GOOGLE_CLOUD_CPP_NS::ResourceSettingsServiceClient(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::GOOGLE_CLOUD_CPP_NS::ResourceSettingsServiceClient(
        google::cloud::GOOGLE_CLOUD_CPP_NS::
            MakeResourceSettingsServiceConnection(options));
  }
  //! [with-service-account]
