# HOWTO: using the Network Connectivity API C++ client in your project

This directory contains small examples showing how to use the Network Connectivity API C++
...
Like most Google Cloud Platform (GCP) services, Network Connectivity API requires that
...
1. Install the dependencies with your favorite tools. As an example, if you use
   ...
   ```bash
   cd $HOME/vcpkg
   ./vcpkg install google-cloud-cpp[core,networkconnectivity]
   ```
...
1. Configure CMake, if necessary, configure the directory where you installed
   ...
   ```bash
   cd $HOME/gooogle-cloud-cpp/google/cloud/networkconnectivity/quickstart
...
[quickstart-link]: https://cloud.google.com/network-connectivity/docs/network-connectivity-center/how-to/working-with-hubs-spokes
