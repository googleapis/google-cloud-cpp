...
///     types defined in networkconnectivity_v1 instead of the aliases defined in
///     this namespace.
namespace networkconnectivity {
GOOGLE_CLOUD_CPP_INLINE_NAMESPACE_BEGIN

/// @deprecated Use networkconnectivity_v1::HubServiceClient directly.
using ::google::cloud::networkconnectivity_v1::HubServiceClient;
