...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::networkconnectivity_v1::HubServiceClient(
...
class CustomIdempotencyPolicy
   : public google::cloud::networkconnectivity_v1::HubServiceConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::networkconnectivity_v1::HubServiceConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::networkconnectivity_v1::HubServiceConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::networkconnectivity_v1::HubServiceRetryPolicyOption>(
      google::cloud::networkconnectivity_v1::HubServiceLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::networkconnectivity_v1::HubServiceBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::networkconnectivity_v1::MakeHubServiceConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::networkconnectivity_v1::HubServiceClient(connection);
  auto c2 = google::cloud::networkconnectivity_v1::HubServiceClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::networkconnectivity_v1::HubServiceClient(
    connection, google::cloud::Options{}.set<google::cloud::networkconnectivity_v1::HubServiceRetryPolicyOption>(
      google::cloud::networkconnectivity_v1::HubServiceLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::networkconnectivity_v1::HubServiceRetryPolicyOption>(
  //       google::cloud::networkconnectivity_v1::HubServiceLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::networkconnectivity_v1::HubServicePollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::networkconnectivity_v1::HubServiceRetryPolicyOption::Type,
            google::cloud::networkconnectivity_v1::HubServiceBackoffPolicyOption::Type>(
            google::cloud::networkconnectivity_v1::HubServiceLimitedTimeRetryPolicy(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::networkconnectivity_v1::HubServiceClient(
      google::cloud::networkconnectivity_v1::MakeHubServiceConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
