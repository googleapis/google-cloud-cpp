...
Status
PolicyBasedRoutingServiceMetadata::DeleteOperation(
    grpc::ClientContext& context,
    Options const& options,
...
Status
PolicyBasedRoutingServiceMetadata::CancelOperation(
    grpc::ClientContext& context,
    Options const& options,
...
void PolicyBasedRoutingServiceMetadata::SetMetadata(grpc::ClientContext& context,
                                        Options const& options,
