...
class StorageControlAuth : public StorageControlStub {
 public:
  ~StorageControlAuth() override = default;
  StorageControlAuth(
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_STORAGECONTROL_V2_INTERNAL_STORAGE_CONTROL_AUTH_DECORATOR_H
