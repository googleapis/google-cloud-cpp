...
std::shared_ptr<StorageControlStub> CreateDefaultStorageControlStub(
  ...
  auto service_grpc_stub =
      google::storage::control::v2::StorageControl::NewStub(channel);
  ...
  if (auth->RequiresConfigureContext()) {
    stub =
        std::make_shared<StorageControlAuth>(std::move(auth), std::move(stub));
  }
  std::multimap<std::string, std::string> fixed_metadata;
  stub = std::make_shared<StorageControlMetadata>(std::move(stub),
