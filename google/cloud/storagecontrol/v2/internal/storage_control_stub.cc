...
DefaultStorageControlStub::AsyncCreateAnywhereCache(
  ...
  return internal::MakeUnaryRpcImpl<google::storage::control::v2::CreateAnywhereCacheRequest,
                                    google::longrunning::Operation>(
      cq,
      [this](grpc::ClientContext* context,
             google::storage::control::v2::CreateAnywhereCacheRequest const& request,
...
DefaultStorageControlStub::CreateAnywhereCache(
    ...
    google::longrunning::Operation response;
    auto status =
        grpc_stub_->CreateAnywhereCache(&context, request, &response);
    if (!status.ok()) {
      return google::cloud::MakeStatusFromRpcError(status);
    }
    return response;
...
DefaultStorageControlStub::AsyncUpdateAnywhereCache(
  ...
  return internal::MakeUnaryRpcImpl<google::storage::control::v2::UpdateAnywhereCacheRequest,
                                    google::longrunning::Operation>(
      cq,
      [this](grpc::ClientContext* context,
             google::storage::control::v2::UpdateAnywhereCacheRequest const& request,
...
DefaultStorageControlStub::UpdateAnywhereCache(
    ...
    google::longrunning::Operation response;
    auto status =
        grpc_stub_->UpdateAnywhereCache(&context, request, &response);
    if (!status.ok()) {
      return google::cloud::MakeStatusFromRpcError(status);
    }
    return response;
...
DefaultStorageControlStub::DisableAnywhereCache(
  ...
  google::storage::control::v2::DisableAnywhereCacheRequest const& request) {
    ...
    auto status =
        grpc_stub_->DisableAnywhereCache(&context, request, &response);
    if (!status.ok()) {
      return google::cloud::MakeStatusFromRpcError(status);
    }
    return response;
...
DefaultStorageControlStub::PauseAnywhereCache(
  ...
  google::storage::control::v2::PauseAnywhereCacheRequest const& request) {
    google::storage::control::v2::AnywhereCache response;
    auto status =
        grpc_stub_->PauseAnywhereCache(&context, request, &response);
    if (!status.ok()) {
      return google::cloud::MakeStatusFromRpcError(status);
    }
    return response;
...
DefaultStorageControlStub::ResumeAnywhereCache(
  ...
  google::storage::control::v2::ResumeAnywhereCacheRequest const& request) {
    google::storage::control::v2::AnywhereCache response;
    auto status =
        grpc_stub_->ResumeAnywhereCache(&context, request, &response);
    if (!status.ok()) {
      return google::cloud::MakeStatusFromRpcError(status);
    }
    return response;
...
DefaultStorageControlStub::GetAnywhereCache(
  ...
  google::storage::control::v2::GetAnywhereCacheRequest const& request) {
    google::storage::control::v2::AnywhereCache response;
    auto status =
        grpc_stub_->GetAnywhereCache(&context, request, &response);
    if (!status.ok()) {
      return google::cloud::MakeStatusFromRpcError(status);
    }
    return response;
...
DefaultStorageControlStub::ListAnywhereCaches(
  ...
  google::storage::control::v2::ListAnywhereCachesRequest const& request) {
    ...
    auto status =
        grpc_stub_->ListAnywhereCaches(&context, request, &response);
    if (!status.ok()) {
      return google::cloud::MakeStatusFromRpcError(status);
    }
    return response;
...
DefaultStorageControlStub::GetOrganizationIntelligenceConfig(
  ...
  google::storage::control::v2::GetOrganizationIntelligenceConfigRequest const& request) {
    google::storage::control::v2::IntelligenceConfig response;
    auto status =
        grpc_stub_->GetOrganizationIntelligenceConfig(&context, request, &response);
    if (!status.ok()) {
      return google::cloud::MakeStatusFromRpcError(status);
    }
    return response;
...
DefaultStorageControlStub::UpdateOrganizationIntelligenceConfig(
  ...
  google::storage::control::v2::UpdateOrganizationIntelligenceConfigRequest const& request) {
    google::storage::control::v2::IntelligenceConfig response;
    auto status =
        grpc_stub_->UpdateOrganizationIntelligenceConfig(&context, request, &response);
    if (!status.ok()) {
      return google::cloud::MakeStatusFromRpcError(status);
    }
    return response;
