...
StorageControlConnectionImpl::DisableAnywhereCache(
  ...
  return google::cloud::internal::RetryLoop(
      retry_policy(*current), backoff_policy(*current),
      idempotency_policy(*current)->DisableAnywhereCache(request),
      [this](grpc::ClientContext& context, Options const& options,
...
StorageControlConnectionImpl::PauseAnywhereCache(
  ...
  return google::cloud::internal::RetryLoop(
      retry_policy(*current), backoff_policy(*current),
      idempotency_policy(*current)->PauseAnywhereCache(request),
      [this](grpc::ClientContext& context, Options const& options,
...
StorageControlConnectionImpl::ResumeAnywhereCache(
  ...
  return google::cloud::internal::RetryLoop(
      retry_policy(*current), backoff_policy(*current),
      idempotency_policy(*current)->ResumeAnywhereCache(request),
      [this](grpc::ClientContext& context, Options const& options,
...
StorageControlConnectionImpl::GetAnywhereCache(
  ...
  return google::cloud::internal::RetryLoop(
      retry_policy(*current), backoff_policy(*current),
      idempotency_policy(*current)->GetAnywhereCache(request),
      [this](grpc::ClientContext& context, Options const& options,
