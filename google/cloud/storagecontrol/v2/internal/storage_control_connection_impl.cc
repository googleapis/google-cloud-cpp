...
StatusOr<google::iam::v1::Policy> StorageControlConnectionImpl::GetIamPolicy(
...
StatusOr<google::iam::v1::Policy> StorageControlConnectionImpl::SetIamPolicy(
...
StorageControlConnectionImpl::TestIamPermissions(
