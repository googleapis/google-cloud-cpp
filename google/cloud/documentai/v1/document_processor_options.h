...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DOCUMENTAI_V1_DOCUMENT_PROCESSOR_OPTIONS_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DOCUMENTAI_V1_DOCUMENT_PROCESSOR_OPTIONS_H
 ...
 *
 * @ingroup google-cloud-documentai-options
 */
...
struct DocumentProcessorServiceConnectionIdempotencyPolicyOption {
  using Type = std::shared_ptr<DocumentProcessorServiceConnectionIdempotencyPolicy>;
};
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DOCUMENTAI_V1_DOCUMENT_PROCESSOR_OPTIONS_H
