...
// main-dox-marker: GOOGLE_CLOUD_CPP_NS::DocumentProcessorServiceClient
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client =
      google::cloud::GOOGLE_CLOUD_CPP_NS::DocumentProcessorServiceClient(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::GOOGLE_CLOUD_CPP_NS::DocumentProcessorServiceClient(
        google::cloud::GOOGLE_CLOUD_CPP_NS::
            MakeDocumentProcessorServiceConnection(options));
  }
  //! [with-service-account]
