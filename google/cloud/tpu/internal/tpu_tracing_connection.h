...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_TPU_INTERNAL_TPU_TRACING_CONNECTION_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_TPU_INTERNAL_TPU_TRACING_CONNECTION_H
...
class TpuTracingConnection : public tpu::TpuConnection {
 public:
  ~TpuTracingConnection() override = default;

  explicit TpuTracingConnection(std::shared_ptr<tpu::TpuConnection> child);
 ...
 private:
  std::shared_ptr<tpu::TpuConnection> child_;
};
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_TPU_INTERNAL_TPU_TRACING_CONNECTION_H
