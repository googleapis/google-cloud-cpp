 ...
 * (e.g., with a Google Mock object) in a `TpuClient` object for use
 * in their own tests.
 *
...
/**
 * A factory function to construct a `TpuConnection` object.
 *
 * The returned connection object should not be used directly; instead it
 * should be given to a `TpuClient` instance, and methods should be
 * invoked on `TpuClient`.
 *
