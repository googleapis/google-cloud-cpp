...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_TPU_V1_INTERNAL_TPU_AUTH_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_TPU_V1_INTERNAL_TPU_AUTH_DECORATOR_H
...
class TpuAuth : public TpuStub {
 public:
  ~TpuAuth() override = default;
  TpuAuth(
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_TPU_V1_INTERNAL_TPU_AUTH_DECORATOR_H
