...
class TpuStub {
 public:
  ...
  virtual StatusOr<google::cloud::tpu::v2::ListQueuedResourcesResponse> ListQueuedResources(
      grpc::ClientContext& context,
      Options const& options,
  ...
  virtual future<StatusOr<google::longrunning::Operation>> AsyncCreateQueuedResource(
      google::cloud::CompletionQueue& cq,
      std::shared_ptr<grpc::ClientContext> context,
      google::cloud::internal::ImmutableOptions options,
  ...
  virtual future<StatusOr<google::longrunning::Operation>> AsyncDeleteQueuedResource(
      google::cloud::CompletionQueue& cq,
      std::shared_ptr<grpc::ClientContext> context,
      google::cloud::internal::ImmutableOptions options,
  ...
  virtual future<StatusOr<google::longrunning::Operation>> AsyncResetQueuedResource(
      google::cloud::CompletionQueue& cq,
      std::shared_ptr<grpc::ClientContext> context,
      google::cloud::internal::ImmutableOptions options,
