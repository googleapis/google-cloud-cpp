...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_TPU_V2_INTERNAL_TPU_LOGGING_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_TPU_V2_INTERNAL_TPU_LOGGING_DECORATOR_H
...
class TpuLogging : public TpuStub {
 public:
  ...
  StatusOr<google::cloud::tpu::v2::ListQueuedResourcesResponse> ListQueuedResources(
      grpc::ClientContext& context,
      Options const& options,
      google::cloud::tpu::v2::ListQueuedResourcesRequest const& request) override;
  ...
  StatusOr<google::cloud::tpu::v2::GenerateServiceIdentityResponse> GenerateServiceIdentity(
      grpc::ClientContext& context,
      Options const& options,
      google::cloud::tpu::v2::GenerateServiceIdentityRequest const& request) override;

  StatusOr<google::cloud::tpu::v2::ListAcceleratorTypesResponse> ListAcceleratorTypes(
      grpc::ClientContext& context,
      Options const& options,
      google::cloud::tpu::v2::ListAcceleratorTypesRequest const& request) override;
  ...
  StatusOr<google::cloud::tpu::v2::ListRuntimeVersionsResponse> ListRuntimeVersions(
      grpc::ClientContext& context,
      Options const& options,
      google::cloud::tpu::v2::ListRuntimeVersionsRequest const& request) override;
  ...
  StatusOr<google::cloud::tpu::v2::GetGuestAttributesResponse> GetGuestAttributes(
      grpc::ClientContext& context,
      Options const& options,
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_TPU_V2_INTERNAL_TPU_LOGGING_DECORATOR_H
