...
/**
 * A retry policy for `TpuConnection` that stops retrying after a
...
class TpuLimitedErrorCountRetryPolicy : public TpuRetryPolicy {
 public:
  TpuLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `TpuConnection` that stops retrying after
