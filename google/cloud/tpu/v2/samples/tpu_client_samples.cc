...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::tpu_v2::TpuClient(
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::tpu_v2::TpuClient(
      google::cloud::tpu_v2::MakeTpuConnection(ud_options));
...
class CustomIdempotencyPolicy
 ...
 public:
  ...
  std::unique_ptr<google::cloud::tpu_v2::TpuConnectionIdempotencyPolicy> clone()
      const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto c3 = google::cloud::tpu_v2::TpuClient(
      connection,
      google::cloud::Options{}.set<google::cloud::tpu_v2::TpuRetryPolicyOption>(
