# HOWTO: using the Cloud TPU API C++ client in your project
...
Like most Google Cloud Platform (GCP) services, Cloud TPU API requires that
...
3. Configure CMake, if necessary, configure the directory where you installed
   ...
   ```bash
   cd $HOME/gooogle-cloud-cpp/google/cloud/tpu/quickstart
...
[quickstart-link]: https://cloud.google.com/tpu/docs/quickstart
