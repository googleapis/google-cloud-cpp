...
/**
 * A retry policy for `FleetRoutingConnection` that stops retrying after a
...
class FleetRoutingLimitedErrorCountRetryPolicy
 ...
 public:
  FleetRoutingLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `FleetRoutingConnection` that stops retrying after
