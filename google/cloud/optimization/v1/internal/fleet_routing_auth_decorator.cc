...
StatusOr<google::cloud::optimization::v1::OptimizeToursResponse> FleetRoutingAuth::OptimizeTours(
...
FleetRoutingAuth::AsyncBatchOptimizeTours(
  ...
  return auth_->AsyncConfigureContext(std::move(context)).then(
      [cq, child = child_, options = std::move(options), request](
        ...
        return child->AsyncBatchOptimizeTours(
            cq, *std::move(context), std::move(options), request);
      });
}

StatusOr<google::longrunning::Operation>
FleetRoutingAuth::BatchOptimizeTours(
      grpc::ClientContext& context,
      Options options,
      google::cloud::optimization::v1::BatchOptimizeToursRequest const& request) {
  auto status = auth_->ConfigureContext(context);
...
StatusOr<google::longrunning::Operation> FleetRoutingAuth::GetOperation(
    grpc::ClientContext& context,
    Options const& options,
