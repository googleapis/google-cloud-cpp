# HOWTO: using the Cloud Optimization API C++ client in your project

This directory contains small examples showing how to use the Cloud Optimization API C++
...
Like most Google Cloud Platform (GCP) services, Cloud Optimization API requires that
...
1. Install the dependencies with your favorite tools. As an example, if you use
   ...
   ```bash
   cd $HOME/vcpkg
   ./vcpkg install google-cloud-cpp[core,optimization]
   ```
...
1. Configure CMake, if necessary, configure the directory where you installed
   ...
   ```bash
   cd $HOME/gooogle-cloud-cpp/google/cloud/optimization/quickstart
...
[quickstart-link]: https://cloud.google.com/optimization/docs/introduction/all_quickstarts
