...
// clang-format off
// main-dox-marker: financialservices_v1::AMLClient
// lro-marker: true
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::financialservices_v1::AMLClient(
      google::cloud::financialservices_v1::MakeAMLConnection(options));
  //! [set-client-endpoint]
}

//! [custom-idempotency-policy]
class CustomIdempotencyPolicy
   : public google::cloud::financialservices_v1::AMLConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::financialservices_v1::AMLConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::financialservices_v1::AMLConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::financialservices_v1::AMLRetryPolicyOption>(
      google::cloud::financialservices_v1::AMLLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::financialservices_v1::AMLBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::financialservices_v1::MakeAMLConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::financialservices_v1::AMLClient(connection);
  auto c2 = google::cloud::financialservices_v1::AMLClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::financialservices_v1::AMLClient(
    connection, google::cloud::Options{}.set<google::cloud::financialservices_v1::AMLRetryPolicyOption>(
      google::cloud::financialservices_v1::AMLLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::financialservices_v1::AMLRetryPolicyOption>(
  //       google::cloud::financialservices_v1::AMLLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::financialservices_v1::AMLPollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::financialservices_v1::AMLRetryPolicyOption::Type,
            google::cloud::financialservices_v1::AMLBackoffPolicyOption::Type>(
            google::cloud::financialservices_v1::AMLLimitedTimeRetryPolicy(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::financialservices_v1::AMLClient(
      google::cloud::financialservices_v1::MakeAMLConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
