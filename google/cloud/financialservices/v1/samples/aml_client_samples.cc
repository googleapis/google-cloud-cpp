...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::financialservices_v1::AMLClient(
      google::cloud::financialservices_v1::MakeAMLConnection(*ud_options));
  //! [set-client-universe-domain]
}

//! [custom-idempotency-policy]
class CustomIdempotencyPolicy : public google::cloud::financialservices_v1::
                                    AMLConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<
      google::cloud::financialservices_v1::AMLConnectionIdempotencyPolicy>
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options =
      google::cloud::Options{}
          .set<google::cloud::financialservices_v1::
                   AMLConnectionIdempotencyPolicyOption>(
              CustomIdempotencyPolicy().clone())
          .set<google::cloud::financialservices_v1::AMLRetryPolicyOption>(
              google::cloud::financialservices_v1::
                  AMLLimitedErrorCountRetryPolicy(3)
                      .clone())
      ...
      google::cloud::Options{}
          .set<google::cloud::financialservices_v1::AMLPollingPolicyOption>(
              google::cloud::GenericPollingPolicy<
                  google::cloud::financialservices_v1::AMLRetryPolicyOption::
                      Type,
                  google::cloud::financialservices_v1::AMLBackoffPolicyOption::
                      Type>(
                  google::cloud::financialservices_v1::
