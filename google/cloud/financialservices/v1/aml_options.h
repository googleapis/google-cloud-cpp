 ...
 */
struct AMLRetryPolicyOption {
  using Type = std::shared_ptr<AMLRetryPolicy>;
};
 ...
 * @ingroup google-cloud-financialservices-options
 */
struct AMLConnectionIdempotencyPolicyOption {
  using Type = std::shared_ptr<AMLConnectionIdempotencyPolicy>;
};
 ...
 * @ingroup google-cloud-financialservices-options
 */
struct AMLPollingPolicyOption {
  using Type = std::shared_ptr<PollingPolicy>;
};

/**
 * The options applicable to AML.
 *
 * @ingroup google-cloud-financialservices-options
 */
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_FINANCIALSERVICES_V1_AML_OPTIONS_H
