...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_FINANCIALSERVICES_V1_INTERNAL_AML_TRACING_STUB_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_FINANCIALSERVICES_V1_INTERNAL_AML_TRACING_STUB_H
...
class AMLTracingStub : public AMLStub {
 public:
  ~AMLTracingStub() override = default;

  explicit AMLTracingStub(std::shared_ptr<AMLStub> child);
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_FINANCIALSERVICES_V1_INTERNAL_AML_TRACING_STUB_H
