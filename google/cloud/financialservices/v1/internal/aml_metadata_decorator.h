...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_FINANCIALSERVICES_V1_INTERNAL_AML_METADATA_DECORATOR_H
...
class AMLMetadata : public AMLStub {
 public:
  ~AMLMetadata() override = default;
  AMLMetadata(std::shared_ptr<AMLStub> child,
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_FINANCIALSERVICES_V1_INTERNAL_AML_METADATA_DECORATOR_H
