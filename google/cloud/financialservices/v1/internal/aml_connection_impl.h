...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_FINANCIALSERVICES_V1_INTERNAL_AML_CONNECTION_IMPL_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_FINANCIALSERVICES_V1_INTERNAL_AML_CONNECTION_IMPL_H
...
class AMLConnectionImpl : public financialservices_v1::AMLConnection {
 public:
  ~AMLConnectionImpl() override = default;
 ...
 private:
  ...
  std::shared_ptr<financialservices_v1_internal::AMLStub> stub_;
  Options options_;
};
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_FINANCIALSERVICES_V1_INTERNAL_AML_CONNECTION_IMPL_H
