...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_FINANCIALSERVICES_V1_INTERNAL_AML_LOGGING_DECORATOR_H
...
class AMLLogging : public AMLStub {
 public:
  ~AMLLogging() override = default;
  AMLLogging(std::shared_ptr<AMLStub> child, TracingOptions tracing_options,
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_FINANCIALSERVICES_V1_INTERNAL_AML_LOGGING_DECORATOR_H
