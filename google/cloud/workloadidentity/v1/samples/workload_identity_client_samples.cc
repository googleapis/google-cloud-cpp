...
// clang-format off
// main-dox-marker: workloadidentity_v1::WorkloadIdentityClient
// lro-marker: true
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::workloadidentity_v1::WorkloadIdentityClient(
      google::cloud::workloadidentity_v1::MakeWorkloadIdentityConnection(
          options));
  //! [set-client-endpoint]
}
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::workloadidentity_v1::WorkloadIdentityClient(
      google::cloud::workloadidentity_v1::MakeWorkloadIdentityConnection(
          *ud_options));
  //! [set-client-universe-domain]
}
...
class CustomIdempotencyPolicy
    : public google::cloud::workloadidentity_v1::
          WorkloadIdentityConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::workloadidentity_v1::
                      WorkloadIdentityConnectionIdempotencyPolicy>
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options =
      google::cloud::Options{}
          .set<google::cloud::workloadidentity_v1::
                   WorkloadIdentityConnectionIdempotencyPolicyOption>(
              CustomIdempotencyPolicy().clone())
          .set<google::cloud::workloadidentity_v1::
                   WorkloadIdentityRetryPolicyOption>(
              google::cloud::workloadidentity_v1::
                  WorkloadIdentityLimitedErrorCountRetryPolicy(3)
                      .clone())
          .set<google::cloud::workloadidentity_v1::
  ...
  auto c1 =
      google::cloud::workloadidentity_v1::WorkloadIdentityClient(connection);
  auto c2 =
      google::cloud::workloadidentity_v1::WorkloadIdentityClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::workloadidentity_v1::WorkloadIdentityClient(
  ...
  //     .set<google::cloud::workloadidentity_v1::WorkloadIdentityRetryPolicyOption>(
  //       google::cloud::workloadidentity_v1::WorkloadIdentityLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
      ...
      google::cloud::Options{}
          .set<google::cloud::workloadidentity_v1::
              ...
              google::cloud::GenericPollingPolicy<
                  google::cloud::workloadidentity_v1::
                      WorkloadIdentityRetryPolicyOption::Type,
                  google::cloud::workloadidentity_v1::
                      WorkloadIdentityBackoffPolicyOption::Type>(
                  google::cloud::workloadidentity_v1::
                      WorkloadIdentityLimitedTimeRetryPolicy(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::workloadidentity_v1::WorkloadIdentityClient(
        google::cloud::workloadidentity_v1::MakeWorkloadIdentityConnection(
            options));
  }
  //! [with-service-account]
