...
/**
 * A retry policy for `FlowsConnection` that stops retrying after a
 ...
 */
class FlowsLimitedErrorCountRetryPolicy : public FlowsRetryPolicy {
 public:
  FlowsLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `FlowsConnection` that stops retrying after
/// some wall clock time has elapsed.
class FlowsLimitedTimeRetryPolicy : public FlowsRetryPolicy {
 public:
  /**
