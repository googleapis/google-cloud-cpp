...
inline std::unique_ptr<dialogflow_cx::FlowsRetryPolicy> retry_policy() {
  return internal::CurrentOptions()
      .get<dialogflow_cx::FlowsRetryPolicyOption>()
      ->clone();
}

inline std::unique_ptr<BackoffPolicy> backoff_policy() {
  return internal::CurrentOptions()
      .get<dialogflow_cx::FlowsBackoffPolicyOption>()
      ->clone();
}

inline std::unique_ptr<dialogflow_cx::FlowsConnectionIdempotencyPolicy>
idempotency_policy() {
  return internal::CurrentOptions()
...
inline std::unique_ptr<PollingPolicy> polling_policy() {
  return internal::CurrentOptions()
      .get<dialogflow_cx::FlowsPollingPolicyOption>()
      ->clone();
}
