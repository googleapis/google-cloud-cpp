...
StatusOr<google::cloud::dialogflow::cx::v3::ListIntentsResponse> IntentsAuth::ListIntents(
...
IntentsAuth::AsyncImportIntents(
  ...
  return auth_->AsyncConfigureContext(std::move(context)).then(
      [cq, child = child_, options = std::move(options), request](
        ...
        return child->AsyncImportIntents(
            cq, *std::move(context), std::move(options), request);
      });
}

StatusOr<google::longrunning::Operation>
IntentsAuth::ImportIntents(
      grpc::ClientContext& context,
      Options options,
      google::cloud::dialogflow::cx::v3::ImportIntentsRequest const& request) {
  auto status = auth_->ConfigureContext(context);
...
IntentsAuth::AsyncExportIntents(
  ...
  return auth_->AsyncConfigureContext(std::move(context)).then(
      [cq, child = child_, options = std::move(options), request](
        ...
        return child->AsyncExportIntents(
            cq, *std::move(context), std::move(options), request);
      });
}

StatusOr<google::longrunning::Operation>
IntentsAuth::ExportIntents(
      grpc::ClientContext& context,
      Options options,
      google::cloud::dialogflow::cx::v3::ExportIntentsRequest const& request) {
  auto status = auth_->ConfigureContext(context);
