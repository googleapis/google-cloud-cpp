...
DefaultChangelogsStub::ListChangelogs(
  ...
  google::cloud::dialogflow::cx::v3::ListChangelogsRequest const& request) {
    ...
    auto status =
        grpc_stub_->ListChangelogs(&context, request, &response);
    if (!status.ok()) {
...
DefaultChangelogsStub::GetChangelog(
  ...
  google::cloud::dialogflow::cx::v3::GetChangelogRequest const& request) {
    ...
    auto status =
        grpc_stub_->GetChangelog(&context, request, &response);
    if (!status.ok()) {
      return google::cloud::MakeStatusFromRpcError(status);
    }
    return response;
...
DefaultChangelogsStub::GetLocation(
  grpc::ClientContext& context, Options const&,
...
DefaultChangelogsStub::GetOperation(
  grpc::ClientContext& context, Options const&,
...
Status
DefaultChangelogsStub::CancelOperation(
  grpc::ClientContext& context, Options const&,
