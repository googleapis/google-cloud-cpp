...
class AgentsStub {
 public:
  ...
  virtual StatusOr<google::cloud::dialogflow::cx::v3::ListAgentsResponse> ListAgents(
  ...
  virtual future<StatusOr<google::longrunning::Operation>> AsyncRestoreAgent(
      ...
      std::shared_ptr<grpc::ClientContext> context,
      google::cloud::internal::ImmutableOptions options,
      google::cloud::dialogflow::cx::v3::RestoreAgentRequest const& request) = 0;
  ...
  virtual StatusOr<google::cloud::dialogflow::cx::v3::AgentValidationResult> ValidateAgent(
      grpc::ClientContext& context,
      Options const& options,
      google::cloud::dialogflow::cx::v3::ValidateAgentRequest const& request) = 0;

  virtual StatusOr<google::cloud::dialogflow::cx::v3::AgentValidationResult> GetAgentValidationResult(
      grpc::ClientContext& context,
      Options const& options,
      google::cloud::dialogflow::cx::v3::GetAgentValidationResultRequest const& request) = 0;

  virtual StatusOr<google::cloud::dialogflow::cx::v3::GenerativeSettings> GetGenerativeSettings(
      grpc::ClientContext& context,
      Options const& options,
      google::cloud::dialogflow::cx::v3::GetGenerativeSettingsRequest const& request) = 0;

  virtual StatusOr<google::cloud::dialogflow::cx::v3::GenerativeSettings> UpdateGenerativeSettings(
      grpc::ClientContext& context,
      Options const& options,
      google::cloud::dialogflow::cx::v3::UpdateGenerativeSettingsRequest const& request) = 0;
...
class DefaultAgentsStub : public AgentsStub {
 public:
  DefaultAgentsStub(
      std::unique_ptr<google::cloud::dialogflow::cx::v3::Agents::StubInterface> grpc_stub,
 ...
 private:
  std::unique_ptr<google::cloud::dialogflow::cx::v3::Agents::StubInterface> grpc_stub_;
