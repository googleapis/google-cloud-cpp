...
class SecuritySettingsServiceStub {
 public:
  ...
  virtual StatusOr<google::cloud::dialogflow::cx::v3::SecuritySettings> CreateSecuritySettings(
      grpc::ClientContext& context,
      Options const& options,
      google::cloud::dialogflow::cx::v3::CreateSecuritySettingsRequest const& request) = 0;

  virtual StatusOr<google::cloud::dialogflow::cx::v3::SecuritySettings> GetSecuritySettings(
      grpc::ClientContext& context,
      Options const& options,
      google::cloud::dialogflow::cx::v3::GetSecuritySettingsRequest const& request) = 0;

  virtual StatusOr<google::cloud::dialogflow::cx::v3::SecuritySettings> UpdateSecuritySettings(
      grpc::ClientContext& context,
      Options const& options,
      google::cloud::dialogflow::cx::v3::UpdateSecuritySettingsRequest const& request) = 0;

  virtual StatusOr<google::cloud::dialogflow::cx::v3::ListSecuritySettingsResponse> ListSecuritySettings(
      grpc::ClientContext& context,
      Options const& options,
      google::cloud::dialogflow::cx::v3::ListSecuritySettingsRequest const& request) = 0;

  virtual Status DeleteSecuritySettings(
      grpc::ClientContext& context,
      Options const& options,
      google::cloud::dialogflow::cx::v3::DeleteSecuritySettingsRequest const& request) = 0;
...
class DefaultSecuritySettingsServiceStub : public SecuritySettingsServiceStub {
 public:
  explicit DefaultSecuritySettingsServiceStub(
      std::unique_ptr<google::cloud::dialogflow::cx::v3::SecuritySettingsService::StubInterface> grpc_stub,
...
,
 ...
 private:
  std::unique_ptr<google::cloud::dialogflow::cx::v3::SecuritySettingsService::StubInterface> grpc_stub_;
