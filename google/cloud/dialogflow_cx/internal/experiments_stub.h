...
class ExperimentsStub {
 public:
  ...
  virtual StatusOr<google::cloud::dialogflow::cx::v3::ListExperimentsResponse> ListExperiments(
      grpc::ClientContext& context,
      Options const& options,
      google::cloud::dialogflow::cx::v3::ListExperimentsRequest const& request) = 0;

  virtual StatusOr<google::cloud::dialogflow::cx::v3::Experiment> GetExperiment(
      grpc::ClientContext& context,
      Options const& options,
      google::cloud::dialogflow::cx::v3::GetExperimentRequest const& request) = 0;

  virtual StatusOr<google::cloud::dialogflow::cx::v3::Experiment> CreateExperiment(
      grpc::ClientContext& context,
      Options const& options,
      google::cloud::dialogflow::cx::v3::CreateExperimentRequest const& request) = 0;

  virtual StatusOr<google::cloud::dialogflow::cx::v3::Experiment> UpdateExperiment(
      grpc::ClientContext& context,
      Options const& options,
      google::cloud::dialogflow::cx::v3::UpdateExperimentRequest const& request) = 0;

  virtual Status DeleteExperiment(
      grpc::ClientContext& context,
      Options const& options,
      google::cloud::dialogflow::cx::v3::DeleteExperimentRequest const& request) = 0;

  virtual StatusOr<google::cloud::dialogflow::cx::v3::Experiment> StartExperiment(
      grpc::ClientContext& context,
      Options const& options,
      google::cloud::dialogflow::cx::v3::StartExperimentRequest const& request) = 0;

  virtual StatusOr<google::cloud::dialogflow::cx::v3::Experiment> StopExperiment(
      grpc::ClientContext& context,
      Options const& options,
      google::cloud::dialogflow::cx::v3::StopExperimentRequest const& request) = 0;
...
class DefaultExperimentsStub : public ExperimentsStub {
 public:
  explicit DefaultExperimentsStub(
      std::unique_ptr<google::cloud::dialogflow::cx::v3::Experiments::StubInterface> grpc_stub,
...
,
 ...
 private:
  std::unique_ptr<google::cloud::dialogflow::cx::v3::Experiments::StubInterface> grpc_stub_;
