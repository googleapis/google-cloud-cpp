...
class WebhooksStub {
 public:
  ...
  virtual StatusOr<google::cloud::dialogflow::cx::v3::ListWebhooksResponse> ListWebhooks(
      grpc::ClientContext& context,
      Options const& options,
      google::cloud::dialogflow::cx::v3::ListWebhooksRequest const& request) = 0;
  ...
  virtual StatusOr<google::cloud::dialogflow::cx::v3::Webhook> CreateWebhook(
      grpc::ClientContext& context,
      Options const& options,
      google::cloud::dialogflow::cx::v3::CreateWebhookRequest const& request) = 0;

  virtual StatusOr<google::cloud::dialogflow::cx::v3::Webhook> UpdateWebhook(
      grpc::ClientContext& context,
      Options const& options,
      google::cloud::dialogflow::cx::v3::UpdateWebhookRequest const& request) = 0;

  virtual Status DeleteWebhook(
      grpc::ClientContext& context,
      Options const& options,
      google::cloud::dialogflow::cx::v3::DeleteWebhookRequest const& request) = 0;
...
class DefaultWebhooksStub : public WebhooksStub {
 public:
  explicit DefaultWebhooksStub(
      std::unique_ptr<google::cloud::dialogflow::cx::v3::Webhooks::StubInterface> grpc_stub,
...
,
 ...
 private:
  std::unique_ptr<google::cloud::dialogflow::cx::v3::Webhooks::StubInterface> grpc_stub_;
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_CX_INTERNAL_WEBHOOKS_STUB_H
