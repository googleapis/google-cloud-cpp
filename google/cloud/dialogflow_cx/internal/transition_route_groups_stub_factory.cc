...
CreateDefaultTransitionRouteGroupsStub(
  ...
  auto service_grpc_stub = google::cloud::dialogflow::cx::v3::TransitionRouteGroups::NewStub(channel);
  ...
  std::shared_ptr<TransitionRouteGroupsStub> stub =
    std::make_shared<DefaultTransitionRouteGroupsStub>(std::move(service_grpc_stub), std::move(service_operations_stub), std::move(service_locations_stub));

  if (auth->RequiresConfigureContext()) {
    stub = std::make_shared<TransitionRouteGroupsAuth>(
