...
class PagesStub {
 public:
  ...
  virtual StatusOr<google::cloud::dialogflow::cx::v3::ListPagesResponse> ListPages(
...
class DefaultPagesStub : public PagesStub {
 public:
  explicit DefaultPagesStub(
      std::unique_ptr<google::cloud::dialogflow::cx::v3::Pages::StubInterface> grpc_stub,
...
,
 ...
 private:
  std::unique_ptr<google::cloud::dialogflow::cx::v3::Pages::StubInterface> grpc_stub_;
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_CX_INTERNAL_PAGES_STUB_H
