...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_CX_INTERNAL_SESSION_ENTITY_TYPES_TRACING_STUB_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_CX_INTERNAL_SESSION_ENTITY_TYPES_TRACING_STUB_H
...
class SessionEntityTypesTracingStub : public SessionEntityTypesStub {
 public:
  ~SessionEntityTypesTracingStub() override = default;

  explicit SessionEntityTypesTracingStub(std::shared_ptr<SessionEntityTypesStub> child);
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_CX_INTERNAL_SESSION_ENTITY_TYPES_TRACING_STUB_H
