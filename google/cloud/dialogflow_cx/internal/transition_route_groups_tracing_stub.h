...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_CX_INTERNAL_TRANSITION_ROUTE_GROUPS_TRACING_STUB_H
...
class TransitionRouteGroupsTracingStub : public TransitionRouteGroupsStub {
 public:
  ~TransitionRouteGroupsTracingStub() override = default;

  explicit TransitionRouteGroupsTracingStub(std::shared_ptr<TransitionRouteGroupsStub> child);
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_CX_INTERNAL_TRANSITION_ROUTE_GROUPS_TRACING_STUB_H
