...
CreateDefaultSecuritySettingsServiceStub(google::cloud::CompletionQueue cq,
                                         Options const& options) {
  auto endpoint = internal::DetermineServiceEndpoint(
      internal::GetEnv("GOOGLE_CLOUD_CPP_SECURITY_SETTINGS_SERVICE_ENDPOINT"),
  ...
  if (!endpoint.ok()) {
    ...
    auto service_grpc_stub =
        google::cloud::dialogflow::cx::v3::SecuritySettingsService::NewStub(
            channel);
    stub = std::make_shared<DefaultSecuritySettingsServiceStub>(
