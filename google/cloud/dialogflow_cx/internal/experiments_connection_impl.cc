...
inline std::unique_ptr<dialogflow_cx::ExperimentsRetryPolicy> retry_policy() {
  return internal::CurrentOptions()
      .get<dialogflow_cx::ExperimentsRetryPolicyOption>()
      ->clone();
}

inline std::unique_ptr<BackoffPolicy> backoff_policy() {
  return internal::CurrentOptions()
      .get<dialogflow_cx::ExperimentsBackoffPolicyOption>()
      ->clone();
}

inline std::unique_ptr<dialogflow_cx::ExperimentsConnectionIdempotencyPolicy>
idempotency_policy() {
  return internal::CurrentOptions()
