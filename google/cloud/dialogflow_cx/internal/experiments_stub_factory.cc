...
std::shared_ptr<ExperimentsStub> CreateDefaultExperimentsStub(
  ...
  auto endpoint = internal::DetermineServiceEndpoint(
      internal::GetEnv("GOOGLE_CLOUD_CPP_EXPERIMENTS_ENDPOINT"),
  ...
  if (!endpoint.ok()) {
    ...
    auto service_grpc_stub =
        google::cloud::dialogflow::cx::v3::Experiments::NewStub(channel);
    stub =
        std::make_shared<DefaultExperimentsStub>(std::move(service_grpc_stub));
  }
