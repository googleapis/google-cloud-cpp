...
inline std::unique_ptr<dialogflow_cx::EntityTypesRetryPolicy> retry_policy() {
  return internal::CurrentOptions()
      .get<dialogflow_cx::EntityTypesRetryPolicyOption>()
      ->clone();
}

inline std::unique_ptr<BackoffPolicy> backoff_policy() {
  return internal::CurrentOptions()
      .get<dialogflow_cx::EntityTypesBackoffPolicyOption>()
      ->clone();
}

inline std::unique_ptr<dialogflow_cx::EntityTypesConnectionIdempotencyPolicy>
idempotency_policy() {
  return internal::CurrentOptions()
