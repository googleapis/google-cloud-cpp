...
DefaultEnvironmentsStub::AsyncCreateEnvironment(
  ...
  return internal::MakeUnaryRpcImpl<google::cloud::dialogflow::cx::v3::CreateEnvironmentRequest,
...
DefaultEnvironmentsStub::AsyncUpdateEnvironment(
  ...
  return internal::MakeUnaryRpcImpl<google::cloud::dialogflow::cx::v3::UpdateEnvironmentRequest,
                                    google::longrunning::Operation>(
      cq,
      [this](grpc::ClientContext* context,
             google::cloud::dialogflow::cx::v3::UpdateEnvironmentRequest const& request,
...
DefaultEnvironmentsStub::AsyncRunContinuousTest(
  ...
  return internal::MakeUnaryRpcImpl<google::cloud::dialogflow::cx::v3::RunContinuousTestRequest,
                                    google::longrunning::Operation>(
      cq,
      [this](grpc::ClientContext* context,
             google::cloud::dialogflow::cx::v3::RunContinuousTestRequest const& request,
...
DefaultEnvironmentsStub::RunContinuousTest(
    ...
    google::longrunning::Operation response;
    auto status =
        grpc_stub_->RunContinuousTest(&context, request, &response);
    if (!status.ok()) {
      return google::cloud::MakeStatusFromRpcError(status);
    }
    return response;
...
DefaultEnvironmentsStub::AsyncDeployFlow(
  ...
  return internal::MakeUnaryRpcImpl<google::cloud::dialogflow::cx::v3::DeployFlowRequest,
                                    google::longrunning::Operation>(
      cq,
      [this](grpc::ClientContext* context,
             google::cloud::dialogflow::cx::v3::DeployFlowRequest const& request,
...
StatusOr<google::longrunning::Operation>
DefaultEnvironmentsStub::DeployFlow(
      grpc::ClientContext& context,
      Options,
      google::cloud::dialogflow::cx::v3::DeployFlowRequest const& request) {
    google::longrunning::Operation response;
    auto status =
        grpc_stub_->DeployFlow(&context, request, &response);
    if (!status.ok()) {
      return google::cloud::MakeStatusFromRpcError(status);
    }
    return response;
