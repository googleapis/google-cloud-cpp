...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_CX_INTERNAL_SECURITY_SETTINGS_AUTH_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_CX_INTERNAL_SECURITY_SETTINGS_AUTH_DECORATOR_H
...
class SecuritySettingsServiceAuth : public SecuritySettingsServiceStub {
 public:
  ~SecuritySettingsServiceAuth() override = default;
  SecuritySettingsServiceAuth(
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_CX_INTERNAL_SECURITY_SETTINGS_AUTH_DECORATOR_H
