...
class SessionEntityTypesStub {
 public:
  ...
  virtual StatusOr<google::cloud::dialogflow::cx::v3::ListSessionEntityTypesResponse> ListSessionEntityTypes(
      grpc::ClientContext& context,
      Options const& options,
      google::cloud::dialogflow::cx::v3::ListSessionEntityTypesRequest const& request) = 0;

  virtual StatusOr<google::cloud::dialogflow::cx::v3::SessionEntityType> GetSessionEntityType(
      grpc::ClientContext& context,
      Options const& options,
      google::cloud::dialogflow::cx::v3::GetSessionEntityTypeRequest const& request) = 0;

  virtual StatusOr<google::cloud::dialogflow::cx::v3::SessionEntityType> CreateSessionEntityType(
      grpc::ClientContext& context,
      Options const& options,
      google::cloud::dialogflow::cx::v3::CreateSessionEntityTypeRequest const& request) = 0;

  virtual StatusOr<google::cloud::dialogflow::cx::v3::SessionEntityType> UpdateSessionEntityType(
      grpc::ClientContext& context,
      Options const& options,
      google::cloud::dialogflow::cx::v3::UpdateSessionEntityTypeRequest const& request) = 0;

  virtual Status DeleteSessionEntityType(
      grpc::ClientContext& context,
      Options const& options,
      google::cloud::dialogflow::cx::v3::DeleteSessionEntityTypeRequest const& request) = 0;
...
class DefaultSessionEntityTypesStub : public SessionEntityTypesStub {
 public:
  explicit DefaultSessionEntityTypesStub(
      std::unique_ptr<google::cloud::dialogflow::cx::v3::SessionEntityTypes::StubInterface> grpc_stub,
...
,
 ...
 private:
  std::unique_ptr<google::cloud::dialogflow::cx::v3::SessionEntityTypes::StubInterface> grpc_stub_;
