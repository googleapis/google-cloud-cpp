...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_CX_INTERNAL_TRANSITION_ROUTE_GROUPS_AUTH_DECORATOR_H
...
class TransitionRouteGroupsAuth : public TransitionRouteGroupsStub {
 public:
  ~TransitionRouteGroupsAuth() override = default;
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_CX_INTERNAL_TRANSITION_ROUTE_GROUPS_AUTH_DECORATOR_H
