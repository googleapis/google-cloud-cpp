...
DefaultSessionsStub::DetectIntent(
  ...
  google::cloud::dialogflow::cx::v3::DetectIntentRequest const& request) {
    ...
    auto status =
        grpc_stub_->DetectIntent(&context, request, &response);
    if (!status.ok()) {
...
DefaultSessionsStub::AsyncStreamingDetectIntent(
  ...
  return google::cloud::internal::MakeStreamingReadWriteRpc<google::cloud::dialogflow::cx::v3::StreamingDetectIntentRequest, google::cloud::dialogflow::cx::v3::StreamingDetectIntentResponse>(
...
DefaultSessionsStub::MatchIntent(
  ...
  google::cloud::dialogflow::cx::v3::MatchIntentRequest const& request) {
    ...
    auto status =
        grpc_stub_->MatchIntent(&context, request, &response);
    if (!status.ok()) {
      return google::cloud::MakeStatusFromRpcError(status);
    }
    return response;
...
DefaultSessionsStub::FulfillIntent(
  ...
  google::cloud::dialogflow::cx::v3::FulfillIntentRequest const& request) {
    ...
    auto status =
        grpc_stub_->FulfillIntent(&context, request, &response);
    if (!status.ok()) {
      return google::cloud::MakeStatusFromRpcError(status);
    }
    return response;
...
DefaultSessionsStub::SubmitAnswerFeedback(
  ...
  google::cloud::dialogflow::cx::v3::SubmitAnswerFeedbackRequest const& request) {
    ...
    auto status =
        grpc_stub_->SubmitAnswerFeedback(&context, request, &response);
    if (!status.ok()) {
      return google::cloud::MakeStatusFromRpcError(status);
    }
    return response;
...
DefaultSessionsStub::GetLocation(
  grpc::ClientContext& context, Options const&,
...
DefaultSessionsStub::GetOperation(
  grpc::ClientContext& context, Options const&,
...
Status
DefaultSessionsStub::CancelOperation(
  grpc::ClientContext& context, Options const&,
