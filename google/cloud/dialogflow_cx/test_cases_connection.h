...
/**
 * A retry policy for `TestCasesConnection` that stops retrying after a
...
class TestCasesLimitedErrorCountRetryPolicy : public TestCasesRetryPolicy {
 public:
  TestCasesLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `TestCasesConnection` that stops retrying after
