...
/**
 * A retry policy for `PagesConnection` that stops retrying after a
...
class PagesLimitedErrorCountRetryPolicy : public PagesRetryPolicy {
 public:
  PagesLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `PagesConnection` that stops retrying after
