...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::dialogflow_cx::SecuritySettingsServiceClient(
      google::cloud::dialogflow_cx::MakeSecuritySettingsServiceConnection(options));
  //! [set-client-endpoint]
}

//! [custom-idempotency-policy]
class CustomIdempotencyPolicy
   : public google::cloud::dialogflow_cx::SecuritySettingsServiceConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::dialogflow_cx::SecuritySettingsServiceConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::dialogflow_cx::SecuritySettingsServiceConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::dialogflow_cx::SecuritySettingsServiceRetryPolicyOption>(
      google::cloud::dialogflow_cx::SecuritySettingsServiceLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::dialogflow_cx::SecuritySettingsServiceBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::dialogflow_cx::MakeSecuritySettingsServiceConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::dialogflow_cx::SecuritySettingsServiceClient(connection);
  auto c2 = google::cloud::dialogflow_cx::SecuritySettingsServiceClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::dialogflow_cx::SecuritySettingsServiceClient(
    connection, google::cloud::Options{}.set<google::cloud::dialogflow_cx::SecuritySettingsServiceRetryPolicyOption>(
      google::cloud::dialogflow_cx::SecuritySettingsServiceLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));
