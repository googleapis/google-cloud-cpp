...
// main-dox-marker: GOOGLE_CLOUD_CPP_NS::FlowsClient
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::GOOGLE_CLOUD_CPP_NS::FlowsClient(
      google::cloud::GOOGLE_CLOUD_CPP_NS::MakeFlowsConnection(options));
  //! [set-client-endpoint]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::GOOGLE_CLOUD_CPP_NS::FlowsClient(
        google::cloud::GOOGLE_CLOUD_CPP_NS::MakeFlowsConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
