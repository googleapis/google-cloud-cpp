...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::dialogflow_cx::FlowsClient(
      google::cloud::dialogflow_cx::MakeFlowsConnection(*ud_options));
  //! [set-client-universe-domain]
}
...
class CustomIdempotencyPolicy
 ...
 public:
  ...
  std::unique_ptr<
      google::cloud::dialogflow_cx::FlowsConnectionIdempotencyPolicy>
  ...
  auto options =
      google::cloud::Options{}
          ...
          .set<google::cloud::dialogflow_cx::FlowsRetryPolicyOption>(
              google::cloud::dialogflow_cx::FlowsLimitedErrorCountRetryPolicy(3)
                  .clone())
