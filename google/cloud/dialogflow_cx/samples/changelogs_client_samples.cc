...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::dialogflow_cx::ChangelogsClient(
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::dialogflow_cx::ChangelogsClient(
      google::cloud::dialogflow_cx::MakeChangelogsConnection(ud_options));
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto c2 = google::cloud::dialogflow_cx::ChangelogsClient(connection);
  ...
  //     .set<google::cloud::dialogflow_cx::ChangelogsRetryPolicyOption>(
  //       google::cloud::dialogflow_cx::ChangelogsLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
