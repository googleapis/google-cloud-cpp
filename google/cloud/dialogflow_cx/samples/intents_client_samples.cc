...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::dialogflow_cx::IntentsClient(
...
class CustomIdempotencyPolicy
   : public google::cloud::dialogflow_cx::IntentsConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::dialogflow_cx::IntentsConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::dialogflow_cx::IntentsConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::dialogflow_cx::IntentsRetryPolicyOption>(
      google::cloud::dialogflow_cx::IntentsLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::dialogflow_cx::IntentsBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::dialogflow_cx::MakeIntentsConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::dialogflow_cx::IntentsClient(connection);
  auto c2 = google::cloud::dialogflow_cx::IntentsClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::dialogflow_cx::IntentsClient(
    connection, google::cloud::Options{}.set<google::cloud::dialogflow_cx::IntentsRetryPolicyOption>(
      google::cloud::dialogflow_cx::IntentsLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::dialogflow_cx::IntentsRetryPolicyOption>(
  //       google::cloud::dialogflow_cx::IntentsLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::dialogflow_cx::IntentsPollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::dialogflow_cx::IntentsRetryPolicyOption::Type,
            google::cloud::dialogflow_cx::IntentsBackoffPolicyOption::Type>(
            google::cloud::dialogflow_cx::IntentsLimitedTimeRetryPolicy(
