...
// main-dox-marker: GOOGLE_CLOUD_CPP_NS::DeploymentsClient
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::GOOGLE_CLOUD_CPP_NS::DeploymentsClient(
      google::cloud::GOOGLE_CLOUD_CPP_NS::MakeDeploymentsConnection(options));
  //! [set-client-endpoint]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::GOOGLE_CLOUD_CPP_NS::DeploymentsClient(
        google::cloud::GOOGLE_CLOUD_CPP_NS::MakeDeploymentsConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
