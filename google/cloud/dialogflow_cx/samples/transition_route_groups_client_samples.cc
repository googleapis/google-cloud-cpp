...
// main-dox-marker: GOOGLE_CLOUD_CPP_NS::TransitionRouteGroupsClient
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::GOOGLE_CLOUD_CPP_NS::TransitionRouteGroupsClient(
      google::cloud::GOOGLE_CLOUD_CPP_NS::MakeTransitionRouteGroupsConnection(
          options));
  //! [set-client-endpoint]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::GOOGLE_CLOUD_CPP_NS::TransitionRouteGroupsClient(
        google::cloud::GOOGLE_CLOUD_CPP_NS::MakeTransitionRouteGroupsConnection(
            options));
  }
  //! [with-service-account]
