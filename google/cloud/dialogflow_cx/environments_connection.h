...
/**
 * A retry policy for `EnvironmentsConnection` that stops retrying after a
...
class EnvironmentsLimitedErrorCountRetryPolicy
 ...
 public:
  EnvironmentsLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `EnvironmentsConnection` that stops retrying after
