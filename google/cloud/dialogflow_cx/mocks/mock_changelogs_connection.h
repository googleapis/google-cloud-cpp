...
class MockChangelogsConnection : public dialogflow_cx::ChangelogsConnection {
 public:
  ...
  MOCK_METHOD((StreamRange<google::cloud::dialogflow::cx::v3::Changelog>),
  ListChangelogs,
  (google::cloud::dialogflow::cx::v3::ListChangelogsRequest request), (override));

  MOCK_METHOD(StatusOr<google::cloud::dialogflow::cx::v3::Changelog>,
  GetChangelog,
