...
class MockIntentsConnection : public dialogflow_cx::IntentsConnection {
 public:
  ...
  MOCK_METHOD(StatusOr<google::cloud::dialogflow::cx::v3::Intent>,
  GetIntent,
  (google::cloud::dialogflow::cx::v3::GetIntentRequest const& request), (override));

  MOCK_METHOD(StatusOr<google::cloud::dialogflow::cx::v3::Intent>,
  CreateIntent,
  (google::cloud::dialogflow::cx::v3::CreateIntentRequest const& request), (override));

  MOCK_METHOD(StatusOr<google::cloud::dialogflow::cx::v3::Intent>,
  UpdateIntent,
  (google::cloud::dialogflow::cx::v3::UpdateIntentRequest const& request), (override));

  MOCK_METHOD(Status,
  DeleteIntent,
  (google::cloud::dialogflow::cx::v3::DeleteIntentRequest const& request), (override));
  ...
  /// EXPECT_CALL(*mock, ImportIntents(Matcher<google::cloud::dialogflow::cx::v3::ImportIntentsRequest const&>(_)))
  /// @endcode
  MOCK_METHOD(future<StatusOr<google::cloud::dialogflow::cx::v3::ImportIntentsResponse>>,
  ImportIntents,
  ...
  /// using ::testing::_;
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock, ImportIntents(Matcher<google::longrunning::Operation const&>(_)))
  /// @endcode
  MOCK_METHOD(future<StatusOr<google::cloud::dialogflow::cx::v3::ImportIntentsResponse>>,
  ImportIntents, (
  ...
  /// using ::testing::_;
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock, ExportIntents(Matcher<google::cloud::dialogflow::cx::v3::ExportIntentsRequest const&>(_)))
  /// @endcode
  MOCK_METHOD(future<StatusOr<google::cloud::dialogflow::cx::v3::ExportIntentsResponse>>,
  ExportIntents,
  ...
  /// using ::testing::_;
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock, ExportIntents(Matcher<google::longrunning::Operation const&>(_)))
  /// @endcode
  MOCK_METHOD(future<StatusOr<google::cloud::dialogflow::cx::v3::ExportIntentsResponse>>,
  ExportIntents, (
    google::longrunning::Operation const& operation), (override));
