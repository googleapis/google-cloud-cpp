...
class MockEntityTypesConnection : public dialogflow_cx::EntityTypesConnection {
 public:
  ...
  MOCK_METHOD((StreamRange<google::cloud::dialogflow::cx::v3::EntityType>),
  ListEntityTypes,
  (google::cloud::dialogflow::cx::v3::ListEntityTypesRequest request), (override));
  ...
  /// EXPECT_CALL(*mock, ExportEntityTypes(Matcher<google::cloud::dialogflow::cx::v3::ExportEntityTypesRequest const&>(_)))
  /// @endcode
  MOCK_METHOD(future<StatusOr<google::cloud::dialogflow::cx::v3::ExportEntityTypesResponse>>,
  ExportEntityTypes,
  ...
  /// using ::testing::_;
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock, ExportEntityTypes(Matcher<google::longrunning::Operation const&>(_)))
  /// @endcode
  MOCK_METHOD(future<StatusOr<google::cloud::dialogflow::cx::v3::ExportEntityTypesResponse>>,
  ExportEntityTypes, (
  ...
  /// using ::testing::_;
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock, ImportEntityTypes(Matcher<google::cloud::dialogflow::cx::v3::ImportEntityTypesRequest const&>(_)))
  /// @endcode
  MOCK_METHOD(future<StatusOr<google::cloud::dialogflow::cx::v3::ImportEntityTypesResponse>>,
  ImportEntityTypes,
  ...
  /// using ::testing::_;
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock, ImportEntityTypes(Matcher<google::longrunning::Operation const&>(_)))
  /// @endcode
  MOCK_METHOD(future<StatusOr<google::cloud::dialogflow::cx::v3::ImportEntityTypesResponse>>,
  ImportEntityTypes, (
    google::longrunning::Operation const& operation), (override));
