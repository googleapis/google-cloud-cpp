...
class MockTestCasesConnection : public dialogflow_cx::TestCasesConnection {
 public:
  ...
  // EXPECT_CALL(*mock, RunTestCase(_)) instead.
  MOCK_METHOD(
  ...
  // EXPECT_CALL(*mock, BatchRunTestCases(_)) instead.
  MOCK_METHOD(
      future<StatusOr<
  ...
  // EXPECT_CALL(*mock, ImportTestCases(_)) instead.
  MOCK_METHOD(
      future<
  ...
  // EXPECT_CALL(*mock, ExportTestCases(_)) instead.
  MOCK_METHOD(
      future<
