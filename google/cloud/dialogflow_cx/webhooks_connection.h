...
/**
 * A retry policy for `WebhooksConnection` that stops retrying after a
...
class WebhooksLimitedErrorCountRetryPolicy : public WebhooksRetryPolicy {
 public:
  WebhooksLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `WebhooksConnection` that stops retrying after
