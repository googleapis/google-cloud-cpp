 ...
 * (e.g., with a Google Mock object) in a `WebhooksClient` object for use
 * in their own tests.
 *
...
/**
 * A factory function to construct a `WebhooksConnection` object.
 *
 * The returned connection object should not be used directly; instead it
 * should be given to a `WebhooksClient` instance, and methods should be
 * invoked on `WebhooksClient`.
 *
