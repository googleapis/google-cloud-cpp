...
std::shared_ptr<DeploymentsConnection> MakeDeploymentsConnection(
  ...
  internal::CheckExpectedOptions<CommonOptionList, GrpcOptionList,
                                 ...
                                 DeploymentsPolicyOptionList>(options,
                                                              __func__);
  options = GOOGLE_CLOUD_CPP_NS::DeploymentsDefaultOptions(location,
                                                           std::move(options));
  auto background = internal::MakeBackgroundThreadsFactory(options)();
  auto stub = GOOGLE_CLOUD_CPP_NS::CreateDefaultDeploymentsStub(
      background->cq(), options);
  return std::make_shared<GOOGLE_CLOUD_CPP_NS::DeploymentsConnectionImpl>(
