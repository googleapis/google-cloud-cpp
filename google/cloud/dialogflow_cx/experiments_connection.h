...
/**
 * A retry policy for `ExperimentsConnection` that stops retrying after a
...
class ExperimentsLimitedErrorCountRetryPolicy : public ExperimentsRetryPolicy {
 public:
  ExperimentsLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `ExperimentsConnection` that stops retrying after
