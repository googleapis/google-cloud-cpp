...
/**
 * A retry policy for `DeploymentsConnection` that stops retrying after a
...
class DeploymentsLimitedErrorCountRetryPolicy : public DeploymentsRetryPolicy {
 public:
  DeploymentsLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `DeploymentsConnection` that stops retrying after
