...
/**
 * A retry policy for `ChangelogsConnection` that stops retrying after a
...
class ChangelogsLimitedErrorCountRetryPolicy : public ChangelogsRetryPolicy {
 public:
  ChangelogsLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `ChangelogsConnection` that stops retrying after
