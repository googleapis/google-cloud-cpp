...
class AccessContextManagerConnectionImpl
    : public AccessContextManagerConnection {
 public:
  AccessContextManagerConnectionImpl(
      ...
      : background_(std::move(background)),
        ...
        retry_policy_prototype_(
            options.get<AccessContextManagerRetryPolicyOption>()->clone()),
        backoff_policy_prototype_(
            options.get<AccessContextManagerBackoffPolicyOption>()->clone()),
        polling_policy_prototype_(
            options.get<AccessContextManagerPollingPolicyOption>()->clone()),
        idempotency_policy_(
            options
 ...
 private:
  ...
  std::shared_ptr<accesscontextmanager_internal::AccessContextManagerStub>
      stub_;
  std::unique_ptr<AccessContextManagerRetryPolicy const>
      retry_policy_prototype_;
...
MakeAccessContextManagerConnection(Options options) {
  ...
  return std::make_shared<AccessContextManagerConnectionImpl>(
...
MakeAccessContextManagerConnection(
  ...
  return std::make_shared<
      accesscontextmanager::AccessContextManagerConnectionImpl>(
