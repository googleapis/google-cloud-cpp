...
/**
 * A retry policy for `AccessContextManagerConnection` that stops retrying after
...
class AccessContextManagerLimitedErrorCountRetryPolicy
 ...
 public:
  AccessContextManagerLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `AccessContextManagerConnection` that stops retrying
