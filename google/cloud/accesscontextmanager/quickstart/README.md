...
This directory contains small examples showing how to use the Access Context
...
1. Install the dependencies with your favorite tools. As an example, if you use
   ...
   ```bash
   cd $HOME/vcpkg
   ./vcpkg install google-cloud-cpp[core,accesscontextmanager]
   ```
...
[quickstart-link]: https://cloud.google.com/access-context-manager/docs/quickstart
