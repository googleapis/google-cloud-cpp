...
// clang-format off
// main-dox-marker: vision_v1::ImageAnnotatorClient
// lro-marker: true
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::vision_v1::ImageAnnotatorClient(
...
class CustomIdempotencyPolicy
   : public google::cloud::vision_v1::ImageAnnotatorConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::vision_v1::ImageAnnotatorConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::vision_v1::ImageAnnotatorConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::vision_v1::ImageAnnotatorRetryPolicyOption>(
      google::cloud::vision_v1::ImageAnnotatorLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::vision_v1::ImageAnnotatorBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::vision_v1::MakeImageAnnotatorConnection(options);
  ...
  auto c3 = google::cloud::vision_v1::ImageAnnotatorClient(
    connection, google::cloud::Options{}.set<google::cloud::vision_v1::ImageAnnotatorRetryPolicyOption>(
      google::cloud::vision_v1::ImageAnnotatorLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::vision_v1::ImageAnnotatorPollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::vision_v1::ImageAnnotatorRetryPolicyOption::Type,
            google::cloud::vision_v1::ImageAnnotatorBackoffPolicyOption::Type>(
