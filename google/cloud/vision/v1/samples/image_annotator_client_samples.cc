...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::vision_v1::ImageAnnotatorClient(
      google::cloud::vision_v1::MakeImageAnnotatorConnection(*ud_options));
  //! [set-client-universe-domain]
}
      ...
      google::cloud::Options{}
          .set<google::cloud::vision_v1::ImageAnnotatorPollingPolicyOption>(
              google::cloud::GenericPollingPolicy<
                  google::cloud::vision_v1::ImageAnnotatorRetryPolicyOption::
                      Type,
                  google::cloud::vision_v1::ImageAnnotatorBackoffPolicyOption::
                      Type>(
                  google::cloud::vision_v1::
