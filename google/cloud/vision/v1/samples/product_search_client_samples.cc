...
// clang-format off
// main-dox-marker: vision_v1::ProductSearchClient
// lro-marker: true
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::vision_v1::ProductSearchClient(
...
class CustomIdempotencyPolicy
   : public google::cloud::vision_v1::ProductSearchConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::vision_v1::ProductSearchConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::vision_v1::ProductSearchConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::vision_v1::ProductSearchRetryPolicyOption>(
      google::cloud::vision_v1::ProductSearchLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::vision_v1::ProductSearchBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::vision_v1::MakeProductSearchConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::vision_v1::ProductSearchClient(connection);
  auto c2 = google::cloud::vision_v1::ProductSearchClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::vision_v1::ProductSearchClient(
    connection, google::cloud::Options{}.set<google::cloud::vision_v1::ProductSearchRetryPolicyOption>(
      google::cloud::vision_v1::ProductSearchLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::vision_v1::ProductSearchRetryPolicyOption>(
  //       google::cloud::vision_v1::ProductSearchLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::vision_v1::ProductSearchPollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::vision_v1::ProductSearchRetryPolicyOption::Type,
            google::cloud::vision_v1::ProductSearchBackoffPolicyOption::Type>(
            google::cloud::vision_v1::ProductSearchLimitedTimeRetryPolicy(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::vision_v1::ProductSearchClient(
      google::cloud::vision_v1::MakeProductSearchConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
