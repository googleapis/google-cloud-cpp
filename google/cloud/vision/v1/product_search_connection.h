...
/**
 * A retry policy for `ProductSearchConnection` that stops retrying after a
...
class ProductSearchLimitedErrorCountRetryPolicy
 ...
 public:
  ProductSearchLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `ProductSearchConnection` that stops retrying after
