...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_VISION_V1_INTERNAL_PRODUCT_SEARCH_AUTH_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_VISION_V1_INTERNAL_PRODUCT_SEARCH_AUTH_DECORATOR_H
...
class ProductSearchAuth : public ProductSearchStub {
 public:
  ~ProductSearchAuth() override = default;
  ProductSearchAuth(
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_VISION_V1_INTERNAL_PRODUCT_SEARCH_AUTH_DECORATOR_H
