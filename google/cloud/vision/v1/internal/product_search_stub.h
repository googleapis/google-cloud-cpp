...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_VISION_V1_INTERNAL_PRODUCT_SEARCH_STUB_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_VISION_V1_INTERNAL_PRODUCT_SEARCH_STUB_H
...
class ProductSearchStub {
 public:
  ...
  virtual StatusOr<google::cloud::vision::v1::ListProductSetsResponse> ListProductSets(
      grpc::ClientContext& context,
      Options const& options,
  ...
  virtual StatusOr<google::cloud::vision::v1::ListProductsResponse> ListProducts(
      grpc::ClientContext& context,
      Options const& options,
  ...
  virtual StatusOr<google::cloud::vision::v1::ReferenceImage> CreateReferenceImage(
      grpc::ClientContext& context,
      Options const& options,
      google::cloud::vision::v1::CreateReferenceImageRequest const& request) = 0;

  virtual Status DeleteReferenceImage(
      grpc::ClientContext& context,
      Options const& options,
      google::cloud::vision::v1::DeleteReferenceImageRequest const& request) = 0;

  virtual StatusOr<google::cloud::vision::v1::ListReferenceImagesResponse> ListReferenceImages(
      grpc::ClientContext& context,
      Options const& options,
  ...
  virtual Status AddProductToProductSet(
      grpc::ClientContext& context,
      Options const& options,
      google::cloud::vision::v1::AddProductToProductSetRequest const& request) = 0;

  virtual Status RemoveProductFromProductSet(
      grpc::ClientContext& context,
      Options const& options,
      google::cloud::vision::v1::RemoveProductFromProductSetRequest const& request) = 0;

  virtual StatusOr<google::cloud::vision::v1::ListProductsInProductSetResponse> ListProductsInProductSet(
      grpc::ClientContext& context,
      Options const& options,
      google::cloud::vision::v1::ListProductsInProductSetRequest const& request) = 0;

  virtual future<StatusOr<google::longrunning::Operation>> AsyncImportProductSets(
...
class DefaultProductSearchStub : public ProductSearchStub {
 public:
  DefaultProductSearchStub(
      std::unique_ptr<google::cloud::vision::v1::ProductSearch::StubInterface> grpc_stub,
 ...
 private:
  std::unique_ptr<google::cloud::vision::v1::ProductSearch::StubInterface> grpc_stub_;
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_VISION_V1_INTERNAL_PRODUCT_SEARCH_STUB_H
