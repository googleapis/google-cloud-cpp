...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_VISION_V1_INTERNAL_PRODUCT_SEARCH_CONNECTION_IMPL_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_VISION_V1_INTERNAL_PRODUCT_SEARCH_CONNECTION_IMPL_H
...
class ProductSearchConnectionImpl : public vision_v1::ProductSearchConnection {
 public:
 ...
 private:
  std::unique_ptr<vision_v1::ProductSearchRetryPolicy> retry_policy() {
    ...
    return options_.get<vision_v1::ProductSearchRetryPolicyOption>()->clone();
  }

  std::unique_ptr<BackoffPolicy> backoff_policy() {
    auto const& options = internal::CurrentOptions();
    if (options.has<vision_v1::ProductSearchBackoffPolicyOption>()) {
      return options.get<vision_v1::ProductSearchBackoffPolicyOption>()
          ->clone();
    }
    return options_.get<vision_v1::ProductSearchBackoffPolicyOption>()->clone();
  }
  ...
  std::unique_ptr<PollingPolicy> polling_policy() {
    ...
    if (options.has<vision_v1::ProductSearchPollingPolicyOption>()) {
      return options.get<vision_v1::ProductSearchPollingPolicyOption>()
          ->clone();
    }
    return options_.get<vision_v1::ProductSearchPollingPolicyOption>()->clone();
  }
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_VISION_V1_INTERNAL_PRODUCT_SEARCH_CONNECTION_IMPL_H
