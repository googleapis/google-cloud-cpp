...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_VISION_INTERNAL_PRODUCT_SEARCH_TRACING_CONNECTION_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_VISION_INTERNAL_PRODUCT_SEARCH_TRACING_CONNECTION_H
...
class ProductSearchTracingConnection : public vision::ProductSearchConnection {
 public:
  ~ProductSearchTracingConnection() override = default;

  explicit ProductSearchTracingConnection(
      std::shared_ptr<vision::ProductSearchConnection> child);
 ...
 private:
  std::shared_ptr<vision::ProductSearchConnection> child_;
};
 ...
 */
std::shared_ptr<vision::ProductSearchConnection>
MakeProductSearchTracingConnection(
    std::shared_ptr<vision::ProductSearchConnection> conn);
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_VISION_INTERNAL_PRODUCT_SEARCH_TRACING_CONNECTION_H
