...
Options WebRiskServiceDefaultOptions(Options options) {
  options = internal::PopulateCommonOptions(
      ...
      "", "GOOGLE_CLOUD_CPP_WEB_RISK_SERVICE_AUTHORITY",
  ...
  if (!options.has<webrisk_v1::WebRiskServiceConnectionIdempotencyPolicyOption>()) {
    options.set<webrisk_v1::WebRiskServiceConnectionIdempotencyPolicyOption>(
        webrisk_v1::MakeDefaultWebRiskServiceConnectionIdempotencyPolicy());
  }
