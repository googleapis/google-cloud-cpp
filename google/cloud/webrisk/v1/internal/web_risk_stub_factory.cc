...
std::shared_ptr<WebRiskServiceStub> CreateDefaultWebRiskServiceStub(
  ...
  auto endpoint = internal::DetermineServiceEndpoint(
      internal::GetEnv("GOOGLE_CLOUD_CPP_WEB_RISK_SERVICE_ENDPOINT"),
      internal::FetchOption<EndpointOption>(options), "webrisk.googleapis.com",
      options);
  ...
  if (!endpoint.ok()) {
    ...
    stub = std::make_shared<DefaultWebRiskServiceStub>(
