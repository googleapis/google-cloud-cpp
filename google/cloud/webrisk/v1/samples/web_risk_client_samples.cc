...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::webrisk_v1::WebRiskServiceClient(
...
class CustomIdempotencyPolicy
   : public google::cloud::webrisk_v1::WebRiskServiceConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::webrisk_v1::WebRiskServiceConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::webrisk_v1::WebRiskServiceConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::webrisk_v1::WebRiskServiceRetryPolicyOption>(
      google::cloud::webrisk_v1::WebRiskServiceLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::webrisk_v1::WebRiskServiceBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::webrisk_v1::MakeWebRiskServiceConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::webrisk_v1::WebRiskServiceClient(connection);
  auto c2 = google::cloud::webrisk_v1::WebRiskServiceClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::webrisk_v1::WebRiskServiceClient(
    connection, google::cloud::Options{}.set<google::cloud::webrisk_v1::WebRiskServiceRetryPolicyOption>(
      google::cloud::webrisk_v1::WebRiskServiceLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::webrisk_v1::WebRiskServiceRetryPolicyOption>(
  //       google::cloud::webrisk_v1::WebRiskServiceLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::webrisk_v1::WebRiskServicePollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::webrisk_v1::WebRiskServiceRetryPolicyOption::Type,
            google::cloud::webrisk_v1::WebRiskServiceBackoffPolicyOption::Type>(
            google::cloud::webrisk_v1::WebRiskServiceLimitedTimeRetryPolicy(
