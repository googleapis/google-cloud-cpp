...
// main-dox-marker: GOOGLE_CLOUD_CPP_NS::WebRiskServiceClient
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::GOOGLE_CLOUD_CPP_NS::WebRiskServiceClient(
      google::cloud::GOOGLE_CLOUD_CPP_NS::MakeWebRiskServiceConnection(
          options));
  //! [set-client-endpoint]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::GOOGLE_CLOUD_CPP_NS::WebRiskServiceClient(
        google::cloud::GOOGLE_CLOUD_CPP_NS::MakeWebRiskServiceConnection(
            options));
  }
  //! [with-service-account]
