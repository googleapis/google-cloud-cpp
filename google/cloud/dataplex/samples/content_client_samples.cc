...
// main-dox-marker: GOOGLE_CLOUD_CPP_NS::ContentServiceClient
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::GOOGLE_CLOUD_CPP_NS::ContentServiceClient(
      google::cloud::GOOGLE_CLOUD_CPP_NS::MakeContentServiceConnection(
          options));
  //! [set-client-endpoint]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::GOOGLE_CLOUD_CPP_NS::ContentServiceClient(
        google::cloud::GOOGLE_CLOUD_CPP_NS::MakeContentServiceConnection(
            options));
  }
  //! [with-service-account]
