...
// main-dox-marker: GOOGLE_CLOUD_CPP_NS::MetadataServiceClient
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::GOOGLE_CLOUD_CPP_NS::MetadataServiceClient(
      google::cloud::GOOGLE_CLOUD_CPP_NS::MakeMetadataServiceConnection(
          options));
  //! [set-client-endpoint]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::GOOGLE_CLOUD_CPP_NS::MetadataServiceClient(
        google::cloud::GOOGLE_CLOUD_CPP_NS::MakeMetadataServiceConnection(
            options));
  }
  //! [with-service-account]
