...
// main-dox-marker: GOOGLE_CLOUD_CPP_NS::DataplexServiceClient
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::GOOGLE_CLOUD_CPP_NS::DataplexServiceClient(
      google::cloud::GOOGLE_CLOUD_CPP_NS::MakeDataplexServiceConnection(
          options));
  //! [set-client-endpoint]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::GOOGLE_CLOUD_CPP_NS::DataplexServiceClient(
        google::cloud::GOOGLE_CLOUD_CPP_NS::MakeDataplexServiceConnection(
            options));
  }
  //! [with-service-account]
