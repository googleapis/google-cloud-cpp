...
// clang-format off
// main-dox-marker: dataplex_v1::BusinessGlossaryServiceClient
// lro-marker: true
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::dataplex_v1::BusinessGlossaryServiceClient(
      google::cloud::dataplex_v1::MakeBusinessGlossaryServiceConnection(
          options));
  //! [set-client-endpoint]
}
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::dataplex_v1::BusinessGlossaryServiceClient(
      google::cloud::dataplex_v1::MakeBusinessGlossaryServiceConnection(
          *ud_options));
  //! [set-client-universe-domain]
}
...
class CustomIdempotencyPolicy
    : public google::cloud::dataplex_v1::
          BusinessGlossaryServiceConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::dataplex_v1::
                      BusinessGlossaryServiceConnectionIdempotencyPolicy>
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options =
      google::cloud::Options{}
          .set<google::cloud::dataplex_v1::
                   BusinessGlossaryServiceConnectionIdempotencyPolicyOption>(
              CustomIdempotencyPolicy().clone())
          .set<google::cloud::dataplex_v1::
                   BusinessGlossaryServiceRetryPolicyOption>(
              google::cloud::dataplex_v1::
                  BusinessGlossaryServiceLimitedErrorCountRetryPolicy(3)
                      .clone())
          .set<google::cloud::dataplex_v1::
                   BusinessGlossaryServiceBackoffPolicyOption>(
  ...
  auto c1 =
      google::cloud::dataplex_v1::BusinessGlossaryServiceClient(connection);
  auto c2 =
      google::cloud::dataplex_v1::BusinessGlossaryServiceClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::dataplex_v1::BusinessGlossaryServiceClient(
  ...
  //     .set<google::cloud::dataplex_v1::BusinessGlossaryServiceRetryPolicyOption>(
  //       google::cloud::dataplex_v1::BusinessGlossaryServiceLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options =
      google::cloud::Options{}
          .set<google::cloud::dataplex_v1::
                   BusinessGlossaryServicePollingPolicyOption>(
              google::cloud::GenericPollingPolicy<
                  google::cloud::dataplex_v1::
                      BusinessGlossaryServiceRetryPolicyOption::Type,
                  google::cloud::dataplex_v1::
                      BusinessGlossaryServiceBackoffPolicyOption::Type>(
                  google::cloud::dataplex_v1::
                      BusinessGlossaryServiceLimitedTimeRetryPolicy(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::dataplex_v1::BusinessGlossaryServiceClient(
        google::cloud::dataplex_v1::MakeBusinessGlossaryServiceConnection(
            options));
  }
  //! [with-service-account]
