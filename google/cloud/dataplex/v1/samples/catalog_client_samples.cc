...
// clang-format off
// main-dox-marker: dataplex_v1::CatalogServiceClient
// lro-marker: true
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::dataplex_v1::CatalogServiceClient(
...
class CustomIdempotencyPolicy
   : public google::cloud::dataplex_v1::CatalogServiceConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::dataplex_v1::CatalogServiceConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::dataplex_v1::CatalogServiceConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::dataplex_v1::CatalogServiceRetryPolicyOption>(
      google::cloud::dataplex_v1::CatalogServiceLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::dataplex_v1::CatalogServiceBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::dataplex_v1::MakeCatalogServiceConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::dataplex_v1::CatalogServiceClient(connection);
  auto c2 = google::cloud::dataplex_v1::CatalogServiceClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::dataplex_v1::CatalogServiceClient(
    connection, google::cloud::Options{}.set<google::cloud::dataplex_v1::CatalogServiceRetryPolicyOption>(
      google::cloud::dataplex_v1::CatalogServiceLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::dataplex_v1::CatalogServiceRetryPolicyOption>(
  //       google::cloud::dataplex_v1::CatalogServiceLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::dataplex_v1::CatalogServicePollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::dataplex_v1::CatalogServiceRetryPolicyOption::Type,
            google::cloud::dataplex_v1::CatalogServiceBackoffPolicyOption::Type>(
            google::cloud::dataplex_v1::CatalogServiceLimitedTimeRetryPolicy(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::dataplex_v1::CatalogServiceClient(
      google::cloud::dataplex_v1::MakeCatalogServiceConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
