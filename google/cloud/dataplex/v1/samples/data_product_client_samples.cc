...
// clang-format off
// main-dox-marker: dataplex_v1::DataProductServiceClient
// lro-marker: true
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::dataplex_v1::DataProductServiceClient(
      google::cloud::dataplex_v1::MakeDataProductServiceConnection(options));
  //! [set-client-endpoint]
}
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::dataplex_v1::DataProductServiceClient(
      google::cloud::dataplex_v1::MakeDataProductServiceConnection(
          *ud_options));
  //! [set-client-universe-domain]
}
...
class CustomIdempotencyPolicy
 ...
 public:
  ...
  std::unique_ptr<
      google::cloud::dataplex_v1::DataProductServiceConnectionIdempotencyPolicy>
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options =
      google::cloud::Options{}
          .set<google::cloud::dataplex_v1::
                   DataProductServiceConnectionIdempotencyPolicyOption>(
              CustomIdempotencyPolicy().clone())
          .set<google::cloud::dataplex_v1::DataProductServiceRetryPolicyOption>(
              google::cloud::dataplex_v1::
                  DataProductServiceLimitedErrorCountRetryPolicy(3)
                      .clone())
          .set<google::cloud::dataplex_v1::
                   DataProductServiceBackoffPolicyOption>(
  ...
  auto c1 = google::cloud::dataplex_v1::DataProductServiceClient(connection);
  auto c2 = google::cloud::dataplex_v1::DataProductServiceClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::dataplex_v1::DataProductServiceClient(
      connection,
      google::cloud::Options{}
          .set<google::cloud::dataplex_v1::DataProductServiceRetryPolicyOption>(
              google::cloud::dataplex_v1::
                  DataProductServiceLimitedTimeRetryPolicy(
  ...
  //     .set<google::cloud::dataplex_v1::DataProductServiceRetryPolicyOption>(
  //       google::cloud::dataplex_v1::DataProductServiceLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options =
      google::cloud::Options{}
          .set<google::cloud::dataplex_v1::
                   DataProductServicePollingPolicyOption>(
              google::cloud::GenericPollingPolicy<
                  google::cloud::dataplex_v1::
                      DataProductServiceRetryPolicyOption::Type,
                  google::cloud::dataplex_v1::
                      DataProductServiceBackoffPolicyOption::Type>(
                  google::cloud::dataplex_v1::
                      DataProductServiceLimitedTimeRetryPolicy(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::dataplex_v1::DataProductServiceClient(
        google::cloud::dataplex_v1::MakeDataProductServiceConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
