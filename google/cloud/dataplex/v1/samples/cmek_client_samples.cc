...
// clang-format off
// main-dox-marker: dataplex_v1::CmekServiceClient
// lro-marker: true
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::dataplex_v1::CmekServiceClient(
      google::cloud::dataplex_v1::MakeCmekServiceConnection(options));
  //! [set-client-endpoint]
}
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::dataplex_v1::CmekServiceClient(
      google::cloud::dataplex_v1::MakeCmekServiceConnection(*ud_options));
  //! [set-client-universe-domain]
}
...
class CustomIdempotencyPolicy : public google::cloud::dataplex_v1::
 ...
 public:
  ...
  std::unique_ptr<
      google::cloud::dataplex_v1::CmekServiceConnectionIdempotencyPolicy>
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options =
      google::cloud::Options{}
          .set<google::cloud::dataplex_v1::
                   CmekServiceConnectionIdempotencyPolicyOption>(
              CustomIdempotencyPolicy().clone())
          .set<google::cloud::dataplex_v1::CmekServiceRetryPolicyOption>(
              google::cloud::dataplex_v1::
                  CmekServiceLimitedErrorCountRetryPolicy(3)
                      .clone())
          .set<google::cloud::dataplex_v1::CmekServiceBackoffPolicyOption>(
  ...
  auto c1 = google::cloud::dataplex_v1::CmekServiceClient(connection);
  auto c2 = google::cloud::dataplex_v1::CmekServiceClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::dataplex_v1::CmekServiceClient(
      connection,
      google::cloud::Options{}
          .set<google::cloud::dataplex_v1::CmekServiceRetryPolicyOption>(
              google::cloud::dataplex_v1::CmekServiceLimitedTimeRetryPolicy(
  ...
  //     .set<google::cloud::dataplex_v1::CmekServiceRetryPolicyOption>(
  //       google::cloud::dataplex_v1::CmekServiceLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options =
      google::cloud::Options{}
          .set<google::cloud::dataplex_v1::CmekServicePollingPolicyOption>(
              google::cloud::GenericPollingPolicy<
                  google::cloud::dataplex_v1::CmekServiceRetryPolicyOption::
                      Type,
                  google::cloud::dataplex_v1::CmekServiceBackoffPolicyOption::
                      Type>(
                  google::cloud::dataplex_v1::CmekServiceLimitedTimeRetryPolicy(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::dataplex_v1::CmekServiceClient(
        google::cloud::dataplex_v1::MakeCmekServiceConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
