...
// clang-format off
// main-dox-marker: dataplex_v1::DataScanServiceClient
// lro-marker: true
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::dataplex_v1::DataScanServiceClient(
...
class CustomIdempotencyPolicy
   : public google::cloud::dataplex_v1::DataScanServiceConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::dataplex_v1::DataScanServiceConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::dataplex_v1::DataScanServiceConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::dataplex_v1::DataScanServiceRetryPolicyOption>(
      google::cloud::dataplex_v1::DataScanServiceLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::dataplex_v1::DataScanServiceBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::dataplex_v1::MakeDataScanServiceConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::dataplex_v1::DataScanServiceClient(connection);
  auto c2 = google::cloud::dataplex_v1::DataScanServiceClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::dataplex_v1::DataScanServiceClient(
    connection, google::cloud::Options{}.set<google::cloud::dataplex_v1::DataScanServiceRetryPolicyOption>(
      google::cloud::dataplex_v1::DataScanServiceLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::dataplex_v1::DataScanServiceRetryPolicyOption>(
  //       google::cloud::dataplex_v1::DataScanServiceLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::dataplex_v1::DataScanServicePollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::dataplex_v1::DataScanServiceRetryPolicyOption::Type,
            google::cloud::dataplex_v1::DataScanServiceBackoffPolicyOption::Type>(
            google::cloud::dataplex_v1::DataScanServiceLimitedTimeRetryPolicy(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::dataplex_v1::DataScanServiceClient(
      google::cloud::dataplex_v1::MakeDataScanServiceConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
