...
/**
 * A retry policy for `ContentServiceConnection` that stops retrying after a
...
class ContentServiceLimitedErrorCountRetryPolicy
 ...
 public:
  ContentServiceLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `ContentServiceConnection` that stops retrying after
