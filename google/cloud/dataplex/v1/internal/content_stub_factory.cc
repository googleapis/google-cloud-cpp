...
std::shared_ptr<ContentServiceStub> CreateDefaultContentServiceStub(
  ...
  auto endpoint = internal::DetermineServiceEndpoint(
      internal::GetEnv("GOOGLE_CLOUD_CPP_CONTENT_SERVICE_ENDPOINT"),
      internal::FetchOption<EndpointOption>(options), "dataplex.googleapis.com",
      options);
  ...
  if (!endpoint.ok()) {
    ...
    stub = std::make_shared<DefaultContentServiceStub>(
