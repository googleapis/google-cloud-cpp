...
DataplexServiceMetadata::AsyncCreateLake(
  ...
  return child_->AsyncCreateLake(
      cq, std::move(context), std::move(options), request);
}

StatusOr<google::longrunning::Operation>
DataplexServiceMetadata::CreateLake(
...
DataplexServiceMetadata::AsyncUpdateLake(
  ...
  SetMetadata(*context, *options, absl::StrCat("lake.name=", internal::UrlEncode(request.lake().name())));
  return child_->AsyncUpdateLake(
      cq, std::move(context), std::move(options), request);
}

StatusOr<google::longrunning::Operation>
DataplexServiceMetadata::UpdateLake(
    grpc::ClientContext& context,
    Options options,
    google::cloud::dataplex::v1::UpdateLakeRequest const& request) {
  SetMetadata(context, options, absl::StrCat("lake.name=", internal::UrlEncode(request.lake().name())));
...
DataplexServiceMetadata::AsyncDeleteLake(
  ...
  return child_->AsyncDeleteLake(
      cq, std::move(context), std::move(options), request);
}

StatusOr<google::longrunning::Operation>
DataplexServiceMetadata::DeleteLake(
    grpc::ClientContext& context,
    Options options,
    google::cloud::dataplex::v1::DeleteLakeRequest const& request) {
  SetMetadata(context, options, absl::StrCat("name=", internal::UrlEncode(request.name())));
...
DataplexServiceMetadata::GetLake(
    grpc::ClientContext& context,
    Options const& options,
...
DataplexServiceMetadata::AsyncCreateZone(
  ...
  SetMetadata(*context, *options, absl::StrCat("parent=", internal::UrlEncode(request.parent())));
  return child_->AsyncCreateZone(
      cq, std::move(context), std::move(options), request);
}

StatusOr<google::longrunning::Operation>
DataplexServiceMetadata::CreateZone(
    grpc::ClientContext& context,
    Options options,
    google::cloud::dataplex::v1::CreateZoneRequest const& request) {
  SetMetadata(context, options, absl::StrCat("parent=", internal::UrlEncode(request.parent())));
...
DataplexServiceMetadata::AsyncUpdateZone(
  ...
  SetMetadata(*context, *options, absl::StrCat("zone.name=", internal::UrlEncode(request.zone().name())));
  return child_->AsyncUpdateZone(
      cq, std::move(context), std::move(options), request);
}

StatusOr<google::longrunning::Operation>
DataplexServiceMetadata::UpdateZone(
    grpc::ClientContext& context,
    Options options,
    google::cloud::dataplex::v1::UpdateZoneRequest const& request) {
  SetMetadata(context, options, absl::StrCat("zone.name=", internal::UrlEncode(request.zone().name())));
...
DataplexServiceMetadata::AsyncDeleteZone(
  ...
  SetMetadata(*context, *options, absl::StrCat("name=", internal::UrlEncode(request.name())));
  return child_->AsyncDeleteZone(
      cq, std::move(context), std::move(options), request);
}

StatusOr<google::longrunning::Operation>
DataplexServiceMetadata::DeleteZone(
    grpc::ClientContext& context,
    Options options,
    google::cloud::dataplex::v1::DeleteZoneRequest const& request) {
  SetMetadata(context, options, absl::StrCat("name=", internal::UrlEncode(request.name())));
...
DataplexServiceMetadata::GetZone(
    grpc::ClientContext& context,
    Options const& options,
...
DataplexServiceMetadata::AsyncCreateAsset(
  ...
  SetMetadata(*context, *options, absl::StrCat("parent=", internal::UrlEncode(request.parent())));
  return child_->AsyncCreateAsset(
      cq, std::move(context), std::move(options), request);
}

StatusOr<google::longrunning::Operation>
DataplexServiceMetadata::CreateAsset(
    grpc::ClientContext& context,
    Options options,
    google::cloud::dataplex::v1::CreateAssetRequest const& request) {
  SetMetadata(context, options, absl::StrCat("parent=", internal::UrlEncode(request.parent())));
...
DataplexServiceMetadata::AsyncUpdateAsset(
  ...
  SetMetadata(*context, *options, absl::StrCat("asset.name=", internal::UrlEncode(request.asset().name())));
  return child_->AsyncUpdateAsset(
      cq, std::move(context), std::move(options), request);
}

StatusOr<google::longrunning::Operation>
DataplexServiceMetadata::UpdateAsset(
    grpc::ClientContext& context,
    Options options,
    google::cloud::dataplex::v1::UpdateAssetRequest const& request) {
  SetMetadata(context, options, absl::StrCat("asset.name=", internal::UrlEncode(request.asset().name())));
...
DataplexServiceMetadata::AsyncDeleteAsset(
  ...
  SetMetadata(*context, *options, absl::StrCat("name=", internal::UrlEncode(request.name())));
  return child_->AsyncDeleteAsset(
      cq, std::move(context), std::move(options), request);
}

StatusOr<google::longrunning::Operation>
DataplexServiceMetadata::DeleteAsset(
    grpc::ClientContext& context,
    Options options,
    google::cloud::dataplex::v1::DeleteAssetRequest const& request) {
  SetMetadata(context, options, absl::StrCat("name=", internal::UrlEncode(request.name())));
...
DataplexServiceMetadata::GetAsset(
    grpc::ClientContext& context,
    Options const& options,
...
DataplexServiceMetadata::AsyncCreateTask(
  ...
  SetMetadata(*context, *options, absl::StrCat("parent=", internal::UrlEncode(request.parent())));
  return child_->AsyncCreateTask(
      cq, std::move(context), std::move(options), request);
}

StatusOr<google::longrunning::Operation>
DataplexServiceMetadata::CreateTask(
    grpc::ClientContext& context,
    Options options,
    google::cloud::dataplex::v1::CreateTaskRequest const& request) {
  SetMetadata(context, options, absl::StrCat("parent=", internal::UrlEncode(request.parent())));
...
DataplexServiceMetadata::AsyncUpdateTask(
  ...
  SetMetadata(*context, *options, absl::StrCat("task.name=", internal::UrlEncode(request.task().name())));
  return child_->AsyncUpdateTask(
      cq, std::move(context), std::move(options), request);
}

StatusOr<google::longrunning::Operation>
DataplexServiceMetadata::UpdateTask(
    grpc::ClientContext& context,
    Options options,
    google::cloud::dataplex::v1::UpdateTaskRequest const& request) {
  SetMetadata(context, options, absl::StrCat("task.name=", internal::UrlEncode(request.task().name())));
...
DataplexServiceMetadata::AsyncDeleteTask(
  ...
  SetMetadata(*context, *options, absl::StrCat("name=", internal::UrlEncode(request.name())));
  return child_->AsyncDeleteTask(
      cq, std::move(context), std::move(options), request);
}

StatusOr<google::longrunning::Operation>
DataplexServiceMetadata::DeleteTask(
    grpc::ClientContext& context,
    Options options,
    google::cloud::dataplex::v1::DeleteTaskRequest const& request) {
  SetMetadata(context, options, absl::StrCat("name=", internal::UrlEncode(request.name())));
...
DataplexServiceMetadata::GetTask(
    grpc::ClientContext& context,
    Options const& options,
...
DataplexServiceMetadata::GetJob(
    grpc::ClientContext& context,
    Options const& options,
...
Status
DataplexServiceMetadata::CancelJob(
    grpc::ClientContext& context,
    Options const& options,
...
DataplexServiceMetadata::SetIamPolicy(
    grpc::ClientContext& context,
    Options const& options,
...
StatusOr<google::iam::v1::Policy>
DataplexServiceMetadata::GetIamPolicy(
    grpc::ClientContext& context,
    Options const& options,
...
StatusOr<google::longrunning::Operation>
DataplexServiceMetadata::GetOperation(
    grpc::ClientContext& context,
    Options const& options,
...
Status
DataplexServiceMetadata::DeleteOperation(
    grpc::ClientContext& context,
    Options const& options,
...
Status
DataplexServiceMetadata::CancelOperation(
    grpc::ClientContext& context,
    Options const& options,
