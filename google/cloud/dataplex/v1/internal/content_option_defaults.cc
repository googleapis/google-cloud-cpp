...
Options ContentServiceDefaultOptions(Options options) {
  options = internal::PopulateCommonOptions(
      std::move(options), "GOOGLE_CLOUD_CPP_CONTENT_SERVICE_ENDPOINT",
      "", "GOOGLE_CLOUD_CPP_CONTENT_SERVICE_AUTHORITY",
  ...
  if (!options.has<dataplex_v1::ContentServiceConnectionIdempotencyPolicyOption>()) {
    options.set<dataplex_v1::ContentServiceConnectionIdempotencyPolicyOption>(
        dataplex_v1::MakeDefaultContentServiceConnectionIdempotencyPolicy());
  }
