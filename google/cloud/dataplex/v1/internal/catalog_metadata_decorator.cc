...
CatalogServiceMetadata::AsyncUpdateEntryType(
  ...
  SetMetadata(*context, *options, absl::StrCat("entry_type.name=", internal::UrlEncode(request.entry_type().name())));
...
CatalogServiceMetadata::AsyncUpdateAspectType(
  ...
  SetMetadata(*context, *options, absl::StrCat("aspect_type.name=", internal::UrlEncode(request.aspect_type().name())));
...
StatusOr<google::cloud::dataplex::v1::Entry>
CatalogServiceMetadata::GetEntry(
    grpc::ClientContext& context,
    Options const& options,
...
Status
CatalogServiceMetadata::CancelMetadataJob(
    grpc::ClientContext& context,
    Options const& options,
...
CatalogServiceMetadata::GetLocation(
    grpc::ClientContext& context,
    Options const& options,
...
CatalogServiceMetadata::SetIamPolicy(
    grpc::ClientContext& context,
    Options const& options,
...
StatusOr<google::iam::v1::Policy>
CatalogServiceMetadata::GetIamPolicy(
    grpc::ClientContext& context,
    Options const& options,
...
Status
CatalogServiceMetadata::DeleteOperation(
    grpc::ClientContext& context,
    Options const& options,
...
Status
CatalogServiceMetadata::CancelOperation(
    grpc::ClientContext& context,
    Options const& options,
