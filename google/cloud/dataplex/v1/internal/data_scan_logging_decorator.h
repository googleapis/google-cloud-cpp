...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DATAPLEX_V1_INTERNAL_DATA_SCAN_LOGGING_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DATAPLEX_V1_INTERNAL_DATA_SCAN_LOGGING_DECORATOR_H
...
class DataScanServiceLogging : public DataScanServiceStub {
 public:
  ~DataScanServiceLogging() override = default;
  DataScanServiceLogging(std::shared_ptr<DataScanServiceStub> child,
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DATAPLEX_V1_INTERNAL_DATA_SCAN_LOGGING_DECORATOR_H
