...
std::shared_ptr<DataplexServiceStub> CreateDefaultDataplexServiceStub(
  ...
  auto endpoint = internal::DetermineServiceEndpoint(
      internal::GetEnv("GOOGLE_CLOUD_CPP_DATAPLEX_SERVICE_ENDPOINT"),
  ...
  if (!endpoint.ok()) {
    ...
    auto service_grpc_stub =
        google::cloud::dataplex::v1::DataplexService::NewStub(channel);
    stub = std::make_shared<DefaultDataplexServiceStub>(
  ...
  if (internal::TracingEnabled(options)) {
    stub = MakeDataplexServiceTracingStub(std::move(stub));
  }
  return stub;
}
