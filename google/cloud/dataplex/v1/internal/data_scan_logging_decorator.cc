...
DataScanServiceLogging::AsyncCreateDataScan(
  ...
  return google::cloud::internal::LogWrapper(
      [this](google::cloud::CompletionQueue& cq,
             ...
             google::cloud::internal::ImmutableOptions options,
             google::cloud::dataplex::v1::CreateDataScanRequest const& request) {
        return child_->AsyncCreateDataScan(
...
DataScanServiceLogging::CreateDataScan(
...
DataScanServiceLogging::AsyncUpdateDataScan(
  ...
  return google::cloud::internal::LogWrapper(
      [this](google::cloud::CompletionQueue& cq,
             ...
             google::cloud::internal::ImmutableOptions options,
             google::cloud::dataplex::v1::UpdateDataScanRequest const& request) {
        return child_->AsyncUpdateDataScan(
            cq, std::move(context), std::move(options), request);
      },
      cq, std::move(context), std::move(options), request, __func__,
      tracing_options_);
...
StatusOr<google::longrunning::Operation>
DataScanServiceLogging::UpdateDataScan(
      grpc::ClientContext& context,
      Options options,
      google::cloud::dataplex::v1::UpdateDataScanRequest const& request) {
  return google::cloud::internal::LogWrapper(
...
DataScanServiceLogging::AsyncDeleteDataScan(
  ...
  return google::cloud::internal::LogWrapper(
      [this](google::cloud::CompletionQueue& cq,
             ...
             google::cloud::internal::ImmutableOptions options,
             google::cloud::dataplex::v1::DeleteDataScanRequest const& request) {
        return child_->AsyncDeleteDataScan(
            cq, std::move(context), std::move(options), request);
      },
      cq, std::move(context), std::move(options), request, __func__,
      tracing_options_);
...
StatusOr<google::longrunning::Operation>
DataScanServiceLogging::DeleteDataScan(
      grpc::ClientContext& context,
      Options options,
      google::cloud::dataplex::v1::DeleteDataScanRequest const& request) {
  return google::cloud::internal::LogWrapper(
...
DataScanServiceLogging::ListLocations(
    grpc::ClientContext& context,
    Options const& options,
...
DataScanServiceLogging::GetLocation(
    grpc::ClientContext& context,
    Options const& options,
...
DataScanServiceLogging::SetIamPolicy(
    grpc::ClientContext& context,
    Options const& options,
...
StatusOr<google::iam::v1::Policy>
DataScanServiceLogging::GetIamPolicy(
    grpc::ClientContext& context,
    Options const& options,
...
DataScanServiceLogging::TestIamPermissions(
    grpc::ClientContext& context,
    Options const& options,
...
DataScanServiceLogging::ListOperations(
    grpc::ClientContext& context,
    Options const& options,
...
StatusOr<google::longrunning::Operation>
DataScanServiceLogging::GetOperation(
    grpc::ClientContext& context,
    Options const& options,
...
Status
DataScanServiceLogging::DeleteOperation(
    grpc::ClientContext& context,
    Options const& options,
...
Status
DataScanServiceLogging::CancelOperation(
    grpc::ClientContext& context,
    Options const& options,
