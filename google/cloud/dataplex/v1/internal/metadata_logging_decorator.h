...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DATAPLEX_V1_INTERNAL_METADATA_LOGGING_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DATAPLEX_V1_INTERNAL_METADATA_LOGGING_DECORATOR_H
...
class MetadataServiceLogging : public MetadataServiceStub {
 public:
  ...
  StatusOr<google::cloud::dataplex::v1::ListPartitionsResponse> ListPartitions(
      grpc::ClientContext& context,
      Options const& options,
      google::cloud::dataplex::v1::ListPartitionsRequest const& request) override;
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DATAPLEX_V1_INTERNAL_METADATA_LOGGING_DECORATOR_H
