...
ContentServiceMetadata::UpdateContent(
  ...
  SetMetadata(context, options, absl::StrCat("content.name=", internal::UrlEncode(request.content().name())));
  return child_->UpdateContent(context, options, request);
}

Status
ContentServiceMetadata::DeleteContent(
    grpc::ClientContext& context,
    Options const& options,
...
ContentServiceMetadata::GetIamPolicy(
    grpc::ClientContext& context,
    Options const& options,
...
StatusOr<google::iam::v1::Policy>
ContentServiceMetadata::SetIamPolicy(
    grpc::ClientContext& context,
    Options const& options,
...
ContentServiceMetadata::GetLocation(
    grpc::ClientContext& context,
    Options const& options,
...
ContentServiceMetadata::GetOperation(
    grpc::ClientContext& context,
    Options const& options,
...
Status
ContentServiceMetadata::DeleteOperation(
    grpc::ClientContext& context,
    Options const& options,
...
Status
ContentServiceMetadata::CancelOperation(
    grpc::ClientContext& context,
    Options const& options,
