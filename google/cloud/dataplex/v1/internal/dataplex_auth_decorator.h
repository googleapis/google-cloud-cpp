...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DATAPLEX_V1_INTERNAL_DATAPLEX_AUTH_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DATAPLEX_V1_INTERNAL_DATAPLEX_AUTH_DECORATOR_H
...
class DataplexServiceAuth : public DataplexServiceStub {
 public:
  ~DataplexServiceAuth() override = default;
  DataplexServiceAuth(
