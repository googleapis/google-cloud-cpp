...
/**
 * A retry policy for `DataplexServiceConnection` that stops retrying after a
...
class DataplexServiceLimitedErrorCountRetryPolicy
 ...
 public:
  DataplexServiceLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `DataplexServiceConnection` that stops retrying after
