...
#include "google/cloud/dataplex/v1/mocks/mock_dataplex_connection.h"
...
/// @deprecated Use dataplex_v1_mocks::MockDataplexServiceConnection directly.
using ::google::cloud::dataplex_v1_mocks::MockDataplexServiceConnection;
