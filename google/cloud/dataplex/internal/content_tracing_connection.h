...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DATAPLEX_INTERNAL_CONTENT_TRACING_CONNECTION_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DATAPLEX_INTERNAL_CONTENT_TRACING_CONNECTION_H
...
class ContentServiceTracingConnection
    : public dataplex::ContentServiceConnection {
 public:
 ...
 private:
  std::shared_ptr<dataplex::ContentServiceConnection> child_;
};
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DATAPLEX_INTERNAL_CONTENT_TRACING_CONNECTION_H
