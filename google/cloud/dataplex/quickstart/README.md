# HOWTO: using the Cloud Dataplex API C++ client in your project

This directory contains small examples showing how to use the Cloud Dataplex API C++
...
2. Install the dependencies with your favorite tools. As an example, if you use
   ...
   ```bash
   cd $HOME/vcpkg
   ./vcpkg install google-cloud-cpp[core,dataplex]
   ```
...
3. Configure CMake, if necessary, configure the directory where you installed
   ...
   ```bash
   cd $HOME/gooogle-cloud-cpp/google/cloud/dataplex/quickstart
...
[quickstart-link]: https://cloud.google.com/dataplex/docs/quickstart-guide
