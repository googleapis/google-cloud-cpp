...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::cloudquotas_v1::CloudQuotasClient(
      google::cloud::cloudquotas_v1::MakeCloudQuotasConnection(ud_options));

  //! [set-client-universe-domain]
}

//! [custom-idempotency-policy]
class CustomIdempotencyPolicy : public google::cloud::cloudquotas_v1::
                                    CloudQuotasConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<
      google::cloud::cloudquotas_v1::CloudQuotasConnectionIdempotencyPolicy>
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
      ...
      google::cloud::Options{}
          ...
          .set<google::cloud::cloudquotas_v1::CloudQuotasRetryPolicyOption>(
              google::cloud::cloudquotas_v1::
                  CloudQuotasLimitedErrorCountRetryPolicy(3)
                      .clone())
  ...
  auto c3 = google::cloud::cloudquotas_v1::CloudQuotasClient(
      ...
      google::cloud::Options{}
          .set<google::cloud::cloudquotas_v1::CloudQuotasRetryPolicyOption>(
              google::cloud::cloudquotas_v1::CloudQuotasLimitedTimeRetryPolicy(
