...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_CLOUDQUOTAS_V1_INTERNAL_QUOTA_ADJUSTER_SETTINGS_MANAGER_METADATA_DECORATOR_H
...
class QuotaAdjusterSettingsManagerMetadata
    : public QuotaAdjusterSettingsManagerStub {
 public:
  ~QuotaAdjusterSettingsManagerMetadata() override = default;
  QuotaAdjusterSettingsManagerMetadata(
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_CLOUDQUOTAS_V1_INTERNAL_QUOTA_ADJUSTER_SETTINGS_MANAGER_METADATA_DECORATOR_H
