...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_CLOUDQUOTAS_V1_INTERNAL_CLOUD_QUOTAS_LOGGING_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_CLOUDQUOTAS_V1_INTERNAL_CLOUD_QUOTAS_LOGGING_DECORATOR_H
...
class CloudQuotasLogging : public CloudQuotasStub {
 public:
  ~CloudQuotasLogging() override = default;
  CloudQuotasLogging(std::shared_ptr<CloudQuotasStub> child,
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_CLOUDQUOTAS_V1_INTERNAL_CLOUD_QUOTAS_LOGGING_DECORATOR_H
