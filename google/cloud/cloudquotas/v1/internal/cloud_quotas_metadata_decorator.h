...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_CLOUDQUOTAS_V1_INTERNAL_CLOUD_QUOTAS_METADATA_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_CLOUDQUOTAS_V1_INTERNAL_CLOUD_QUOTAS_METADATA_DECORATOR_H
...
class CloudQuotasMetadata : public CloudQuotasStub {
 public:
  ~CloudQuotasMetadata() override = default;
  CloudQuotasMetadata(std::shared_ptr<CloudQuotasStub> child,
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_CLOUDQUOTAS_V1_INTERNAL_CLOUD_QUOTAS_METADATA_DECORATOR_H
