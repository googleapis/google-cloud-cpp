...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_CLOUDQUOTAS_V1_INTERNAL_QUOTA_ADJUSTER_SETTINGS_MANAGER_TRACING_STUB_H
...
class QuotaAdjusterSettingsManagerTracingStub
    : public QuotaAdjusterSettingsManagerStub {
 public:
  ~QuotaAdjusterSettingsManagerTracingStub() override = default;
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_CLOUDQUOTAS_V1_INTERNAL_QUOTA_ADJUSTER_SETTINGS_MANAGER_TRACING_STUB_H
