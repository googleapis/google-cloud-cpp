...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_CLOUDQUOTAS_V1_INTERNAL_CLOUD_QUOTAS_AUTH_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_CLOUDQUOTAS_V1_INTERNAL_CLOUD_QUOTAS_AUTH_DECORATOR_H
...
class CloudQuotasAuth : public CloudQuotasStub {
 public:
  ~CloudQuotasAuth() override = default;
  CloudQuotasAuth(
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_CLOUDQUOTAS_V1_INTERNAL_CLOUD_QUOTAS_AUTH_DECORATOR_H
