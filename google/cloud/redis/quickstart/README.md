...
This directory contains small examples showing how to use the Google Cloud Memorystore for Redis API C++
...
[quickstart-link]: https://cloud.google.com/redis/docs/quickstart
