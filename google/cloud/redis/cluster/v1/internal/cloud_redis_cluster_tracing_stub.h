...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_REDIS_CLUSTER_V1_INTERNAL_CLOUD_REDIS_CLUSTER_TRACING_STUB_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_REDIS_CLUSTER_V1_INTERNAL_CLOUD_REDIS_CLUSTER_TRACING_STUB_H
...
class CloudRedisClusterTracingStub : public CloudRedisClusterStub {
 public:
  ~CloudRedisClusterTracingStub() override = default;

  explicit CloudRedisClusterTracingStub(std::shared_ptr<CloudRedisClusterStub> child);
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_REDIS_CLUSTER_V1_INTERNAL_CLOUD_REDIS_CLUSTER_TRACING_STUB_H
