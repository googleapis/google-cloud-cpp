...
class MockCloudRedisClusterConnection : public redis_cluster_v1::CloudRedisClusterConnection {
 public:
  ...
  /// using ::testing::_;
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock, RescheduleClusterMaintenance(Matcher<google::cloud::redis::cluster::v1::RescheduleClusterMaintenanceRequest const&>(_)))
  /// @endcode
  MOCK_METHOD(future<StatusOr<google::cloud::redis::cluster::v1::Cluster>>,
  ...
  /// using ::testing::_;
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock, RescheduleClusterMaintenance(Matcher<google::longrunning::Operation const&>(_)))
  /// @endcode
  MOCK_METHOD(future<StatusOr<google::cloud::redis::cluster::v1::Cluster>>,
  RescheduleClusterMaintenance, (
    google::longrunning::Operation const& operation), (override));

  MOCK_METHOD((StreamRange<google::cloud::redis::cluster::v1::BackupCollection>),
  ListBackupCollections,
  (google::cloud::redis::cluster::v1::ListBackupCollectionsRequest request), (override));

  MOCK_METHOD(StatusOr<google::cloud::redis::cluster::v1::BackupCollection>,
  GetBackupCollection,
  ...
  MOCK_METHOD(StatusOr<google::cloud::redis::cluster::v1::Backup>,
  GetBackup,
  ...
  /// using ::testing::_;
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock, DeleteBackup(Matcher<google::cloud::redis::cluster::v1::DeleteBackupRequest const&>(_)))
  /// @endcode
  MOCK_METHOD(future<StatusOr<google::protobuf::Any>>,
  DeleteBackup,
  ...
  /// using ::testing::_;
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock, ExportBackup(Matcher<google::cloud::redis::cluster::v1::ExportBackupRequest const&>(_)))
  /// @endcode
  ...
  /// using ::testing::_;
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock, BackupCluster(Matcher<google::cloud::redis::cluster::v1::BackupClusterRequest const&>(_)))
  /// @endcode
  MOCK_METHOD(future<StatusOr<google::cloud::redis::cluster::v1::Cluster>>,
  BackupCluster,
  ...
  /// using ::testing::_;
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock, BackupCluster(Matcher<google::longrunning::Operation const&>(_)))
  /// @endcode
  MOCK_METHOD(future<StatusOr<google::cloud::redis::cluster::v1::Cluster>>,
  BackupCluster, (
    google::longrunning::Operation const& operation), (override));
