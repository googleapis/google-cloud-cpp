...
std::shared_ptr<CloudRedisStub> CreateDefaultCloudRedisStub(
  ...
  auto endpoint = internal::DetermineServiceEndpoint(
      internal::GetEnv("GOOGLE_CLOUD_CPP_CLOUD_REDIS_ENDPOINT"),
      std::move(endpoint_option), "redis.googleapis.com", options);
  ...
  if (!endpoint.ok()) {
    ...
    auto service_grpc_stub =
        google::cloud::redis::v1::CloudRedis::NewStub(channel);
    stub = std::make_shared<DefaultCloudRedisStub>(
