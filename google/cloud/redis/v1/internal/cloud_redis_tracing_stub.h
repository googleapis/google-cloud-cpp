...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_REDIS_V1_INTERNAL_CLOUD_REDIS_TRACING_STUB_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_REDIS_V1_INTERNAL_CLOUD_REDIS_TRACING_STUB_H
...
class CloudRedisTracingStub : public CloudRedisStub {
 public:
  ...
  explicit CloudRedisTracingStub(std::shared_ptr<CloudRedisStub> child);
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_REDIS_V1_INTERNAL_CLOUD_REDIS_TRACING_STUB_H
