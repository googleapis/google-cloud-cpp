...
/**
 * A retry policy for `CloudRedisConnection` that stops retrying after a
...
class CloudRedisLimitedErrorCountRetryPolicy : public CloudRedisRetryPolicy {
 public:
  CloudRedisLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `CloudRedisConnection` that stops retrying after
