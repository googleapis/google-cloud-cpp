...
// clang-format off
// main-dox-marker: redis_v1::CloudRedisClient
// lro-marker: true
// clang-format on
namespace {
...
class CustomIdempotencyPolicy
 ...
 public:
  ...
  std::unique_ptr<google::cloud::redis_v1::CloudRedisConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::redis_v1::CloudRedisConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::redis_v1::CloudRedisRetryPolicyOption>(
      google::cloud::redis_v1::CloudRedisLimitedErrorCountRetryPolicy(3).clone())
  ...
  auto c3 = google::cloud::redis_v1::CloudRedisClient(
    connection, google::cloud::Options{}.set<google::cloud::redis_v1::CloudRedisRetryPolicyOption>(
      google::cloud::redis_v1::CloudRedisLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::redis_v1::CloudRedisPollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::redis_v1::CloudRedisRetryPolicyOption::Type,
            google::cloud::redis_v1::CloudRedisBackoffPolicyOption::Type>(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::redis_v1::CloudRedisClient(
      google::cloud::redis_v1::MakeCloudRedisConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
