...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_REDIS_INTERNAL_CLOUD_REDIS_TRACING_CONNECTION_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_REDIS_INTERNAL_CLOUD_REDIS_TRACING_CONNECTION_H
...
class CloudRedisTracingConnection : public redis::CloudRedisConnection {
 public:
 ...
 private:
  std::shared_ptr<redis::CloudRedisConnection> child_;
};
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_REDIS_INTERNAL_CLOUD_REDIS_TRACING_CONNECTION_H
