...
// clang-format off
// main-dox-marker: compute_future_reservations_v1::FutureReservationsClient
// lro-marker: true
// clang-format on
namespace {
...
class CustomIdempotencyPolicy
    : public google::cloud::compute_future_reservations_v1::
          FutureReservationsConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::compute_future_reservations_v1::
                      FutureReservationsConnectionIdempotencyPolicy>
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options =
      google::cloud::Options{}
          .set<google::cloud::compute_future_reservations_v1::
                   FutureReservationsConnectionIdempotencyPolicyOption>(
              CustomIdempotencyPolicy().clone())
          .set<google::cloud::compute_future_reservations_v1::
                   FutureReservationsRetryPolicyOption>(
              google::cloud::compute_future_reservations_v1::
                  FutureReservationsLimitedErrorCountRetryPolicy(3)
                      .clone())
          .set<google::cloud::compute_future_reservations_v1::
              ...
              google::cloud::ExponentialBackoffPolicy(
                  ...
                  /*scaling=*/2.0)
                  .clone());
  auto connection = google::cloud::compute_future_reservations_v1::
      MakeFutureReservationsConnectionRest(options);
  ...
  //     .set<google::cloud::compute_future_reservations_v1::FutureReservationsRetryPolicyOption>(
  //       google::cloud::compute_future_reservations_v1::FutureReservationsLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
      ...
      google::cloud::Options{}
          .set<google::cloud::compute_future_reservations_v1::
              ...
              google::cloud::GenericPollingPolicy<
                  google::cloud::compute_future_reservations_v1::
                      FutureReservationsRetryPolicyOption::Type,
                  google::cloud::compute_future_reservations_v1::
                      FutureReservationsBackoffPolicyOption::Type>(
                  google::cloud::compute_future_reservations_v1::
                      FutureReservationsLimitedTimeRetryPolicy(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::compute_future_reservations_v1::
