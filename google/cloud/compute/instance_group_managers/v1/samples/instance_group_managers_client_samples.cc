...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::compute_instance_group_managers_v1::
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::compute_instance_group_managers_v1::
      InstanceGroupManagersClient(
          google::cloud::compute_instance_group_managers_v1::
              MakeInstanceGroupManagersConnectionRest(*ud_options));
  //! [set-client-universe-domain]
}
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto c1 = google::cloud::compute_instance_group_managers_v1::
      InstanceGroupManagersClient(connection);
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::compute_instance_group_managers_v1::
        InstanceGroupManagersClient(
            google::cloud::compute_instance_group_managers_v1::
                MakeInstanceGroupManagersConnectionRest(options));
  }
