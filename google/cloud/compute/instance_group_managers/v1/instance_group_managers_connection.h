...
using InstanceGroupManagersRetryPolicy = ::google::cloud::internal::TraitBasedRetryPolicy<
    compute_instance_group_managers_v1_internal::InstanceGroupManagersRetryTraits>;

using InstanceGroupManagersLimitedTimeRetryPolicy = ::google::cloud::internal::LimitedTimeRetryPolicy<
    compute_instance_group_managers_v1_internal::InstanceGroupManagersRetryTraits>;
...
class InstanceGroupManagersConnection {
 public:
  ...
  virtual StatusOr<google::cloud::cpp::compute::v1::InstanceGroupManagerAggregatedList>
