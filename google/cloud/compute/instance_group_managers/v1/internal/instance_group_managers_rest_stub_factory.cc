...
CreateDefaultInstanceGroupManagersRestStub(Options& options) {
  ...
  auto service_endpoint = internal::DetermineServiceEndpoint(
      internal::GetEnv("GOOGLE_CLOUD_CPP_INSTANCE_GROUP_MANAGERS_ENDPOINT"),
  ...
  std::shared_ptr<InstanceGroupManagersRestStub> stub =
      std::make_shared<DefaultInstanceGroupManagersRestStub>(
          std::move(stub_creation_opts));
  stub = std::make_shared<InstanceGroupManagersRestMetadata>(std::move(stub));
  if (internal::Contains(options.get<TracingComponentsOption>(), "rpc")) {
    GCP_LOG(INFO) << "Enabled logging for REST rpc calls";
    stub = std::make_shared<InstanceGroupManagersRestLogging>(
