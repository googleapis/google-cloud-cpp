...
class MachineTypesConnection {
 public:
  ...
  AggregatedListMachineTypes(google::cloud::cpp::compute::machineTypes::v1::AggregatedListMachineTypesRequest const& request);

  virtual StatusOr<google::cloud::cpp::compute::v1::MachineType>
  GetMachineTypes(google::cloud::cpp::compute::machineTypes::v1::GetMachineTypesRequest const& request);

  virtual StreamRange<google::cloud::cpp::compute::v1::MachineType>
  ListMachineTypes(google::cloud::cpp::compute::machineTypes::v1::ListMachineTypesRequest request);
};
