...
Idempotency MachineTypesConnectionIdempotencyPolicy::AggregatedListMachineTypes(google::cloud::cpp::compute::machineTypes::v1::AggregatedListMachineTypesRequest const&) {
  return Idempotency::kIdempotent;
}

Idempotency MachineTypesConnectionIdempotencyPolicy::GetMachineTypes(google::cloud::cpp::compute::machineTypes::v1::GetMachineTypesRequest const&) {
  return Idempotency::kIdempotent;
}

Idempotency MachineTypesConnectionIdempotencyPolicy::ListMachineTypes(google::cloud::cpp::compute::machineTypes::v1::ListMachineTypesRequest) {  // NOLINT
  return Idempotency::kIdempotent;
}
