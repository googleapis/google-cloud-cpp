...
class MachineTypesClient {
 public:
  ...
  /// [google.cloud.cpp.compute.v1.MachineTypeAggregatedList]: @googleapis_reference_link{google/cloud/compute/v1/internal/common_file_072.proto#L101}
  ///
  // clang-format on
  ...
  /// [google.cloud.cpp.compute.v1.MachineType]: @googleapis_reference_link{google/cloud/compute/v1/internal/common_file_072.proto#L29}
  ///
  // clang-format on
