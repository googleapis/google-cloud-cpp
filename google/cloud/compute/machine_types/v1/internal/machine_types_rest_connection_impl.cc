...
MachineTypesRestConnectionImpl::AggregatedListMachineTypes(google::cloud::cpp::compute::machine_types::v1::AggregatedListMachineTypesRequest const& request) {
...
MachineTypesRestConnectionImpl::GetMachineTypes(google::cloud::cpp::compute::machine_types::v1::GetMachineTypesRequest const& request) {
  return google::cloud::rest_internal::RestRetryLoop(
      retry_policy(), backoff_policy(),
...
MachineTypesRestConnectionImpl::ListMachineTypes(google::cloud::cpp::compute::machine_types::v1::ListMachineTypesRequest request) {
  ...
  return google::cloud::internal::MakePaginationRange<StreamRange<google::cloud::cpp::compute::v1::MachineType>>(
      ...
      [stub, retry, backoff, idempotency, function_name]
        (google::cloud::cpp::compute::machine_types::v1::ListMachineTypesRequest const& r) {
        return google::cloud::rest_internal::RestRetryLoop(
            retry->clone(), backoff->clone(), idempotency,
            [stub](rest_internal::RestContext& rest_context, google::cloud::cpp::compute::machine_types::v1::ListMachineTypesRequest const& request) {
