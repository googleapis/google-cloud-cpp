...
DefaultMachineTypesRestStub::AggregatedListMachineTypes(
  ...
  return rest_internal::Get<google::cloud::cpp::compute::v1::MachineTypeAggregatedList>(
      *service_, rest_context, request, false,
      absl::StrCat("/", "compute", "/", rest_internal::DetermineApiVersion("v1", options), "/", "projects", "/", request.project(), "/", "aggregated", "/", "machineTypes"), std::move(query_params));
}
...
DefaultMachineTypesRestStub::GetMachineType(
      google::cloud::rest_internal::RestContext& rest_context,
      Options const& options,
      google::cloud::cpp::compute::machine_types::v1::GetMachineTypeRequest const& request) {
  std::vector<std::pair<std::string, std::string>> query_params;
  return rest_internal::Get<google::cloud::cpp::compute::v1::MachineType>(
      *service_, rest_context, request, false,
      absl::StrCat("/", "compute", "/", rest_internal::DetermineApiVersion("v1", options), "/", "projects", "/", request.project(), "/", "zones", "/", request.zone(), "/", "machineTypes", "/", request.machine_type()), std::move(query_params));
}
...
DefaultMachineTypesRestStub::ListMachineTypes(
  ...
  return rest_internal::Get<google::cloud::cpp::compute::v1::MachineTypeList>(
      *service_, rest_context, request, false,
      absl::StrCat("/", "compute", "/", rest_internal::DetermineApiVersion("v1", options), "/", "projects", "/", request.project(), "/", "zones", "/", request.zone(), "/", "machineTypes"), std::move(query_params));
}
