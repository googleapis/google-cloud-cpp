...
class MachineTypesRestStub {
 public:
  ...
  virtual StatusOr<google::cloud::cpp::compute::v1::MachineTypeAggregatedList> AggregatedListMachineTypes(
      ...
      google::cloud::cpp::compute::machineTypes::v1::AggregatedListMachineTypesRequest const& request) = 0;

  virtual StatusOr<google::cloud::cpp::compute::v1::MachineType> GetMachineTypes(
      google::cloud::rest_internal::RestContext& rest_context,
      google::cloud::cpp::compute::machineTypes::v1::GetMachineTypesRequest const& request) = 0;

  virtual StatusOr<google::cloud::cpp::compute::v1::MachineTypeList> ListMachineTypes(
      google::cloud::rest_internal::RestContext& rest_context,
      google::cloud::cpp::compute::machineTypes::v1::ListMachineTypesRequest const& request) = 0;
};
