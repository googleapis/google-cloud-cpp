...
MachineTypesTracingConnection::AggregatedListMachineTypes(google::cloud::cpp::compute::machineTypes::v1::AggregatedListMachineTypesRequest const& request) {
...
MachineTypesTracingConnection::GetMachineTypes(google::cloud::cpp::compute::machineTypes::v1::GetMachineTypesRequest const& request) {
...
MachineTypesTracingConnection::ListMachineTypes(google::cloud::cpp::compute::machineTypes::v1::ListMachineTypesRequest request) {
