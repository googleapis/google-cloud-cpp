...
#include "google/cloud/compute/advice/v1/internal/advice_rest_metadata_decorator.h"
...
AdviceRestMetadata::AdviceRestMetadata(std::shared_ptr<AdviceRestStub> child,
...
AdviceRestMetadata::CalendarMode(
