...
// clang-format off
// main-dox-marker: compute_advice_v1::AdviceClient
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::compute_advice_v1::AdviceClient(
      google::cloud::compute_advice_v1::MakeAdviceConnectionRest(options));
  //! [set-client-endpoint]
}
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::compute_advice_v1::AdviceClient(
      google::cloud::compute_advice_v1::MakeAdviceConnectionRest(*ud_options));
  //! [set-client-universe-domain]
}

//! [custom-idempotency-policy]
class CustomIdempotencyPolicy : public google::cloud::compute_advice_v1::
                                    AdviceConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<
      google::cloud::compute_advice_v1::AdviceConnectionIdempotencyPolicy>
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options =
      google::cloud::Options{}
          .set<google::cloud::compute_advice_v1::
                   AdviceConnectionIdempotencyPolicyOption>(
              CustomIdempotencyPolicy().clone())
          .set<google::cloud::compute_advice_v1::AdviceRetryPolicyOption>(
              google::cloud::compute_advice_v1::
                  AdviceLimitedErrorCountRetryPolicy(3)
                      .clone())
          .set<google::cloud::compute_advice_v1::AdviceBackoffPolicyOption>(
  ...
  auto c1 = google::cloud::compute_advice_v1::AdviceClient(connection);
  auto c2 = google::cloud::compute_advice_v1::AdviceClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::compute_advice_v1::AdviceClient(
      connection,
      google::cloud::Options{}
          .set<google::cloud::compute_advice_v1::AdviceRetryPolicyOption>(
              google::cloud::compute_advice_v1::AdviceLimitedTimeRetryPolicy(
  ...
  //     .set<google::cloud::compute_advice_v1::AdviceRetryPolicyOption>(
  //       google::cloud::compute_advice_v1::AdviceLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::compute_advice_v1::AdviceClient(
        google::cloud::compute_advice_v1::MakeAdviceConnectionRest(options));
  }
  //! [with-service-account]
  (argv.at(0));
