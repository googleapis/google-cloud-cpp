...
std::shared_ptr<RegionNotificationEndpointsConnection> MakeRegionNotificationEndpointsConnectionRest(
  ...
  internal::CheckExpectedOptions<CommonOptionList, RestOptionList,
      ...
      RegionNotificationEndpointsPolicyOptionList>(options, __func__);
  options = compute_region_notification_endpoints_v1_internal::RegionNotificationEndpointsDefaultOptions(
      std::move(options));
  auto background = std::make_unique<
      rest_internal::AutomaticallyCreatedRestBackgroundThreads>();
  auto stub = compute_region_notification_endpoints_v1_internal::CreateDefaultRegionNotificationEndpointsRestStub(
      options);
  return compute_region_notification_endpoints_v1_internal::MakeRegionNotificationEndpointsTracingConnection(
      std::make_shared<
          compute_region_notification_endpoints_v1_internal::RegionNotificationEndpointsRestConnectionImpl>(
