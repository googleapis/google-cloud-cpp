...
class RegionNotificationEndpointsRestStub {
 public:
  ...
  virtual future<StatusOr<google::cloud::cpp::compute::v1::Operation>> AsyncDeleteRegionNotificationEndpoints(
      google::cloud::CompletionQueue& cq,
      std::unique_ptr<google::cloud::rest_internal::RestContext> rest_context,
      google::cloud::cpp::compute::region_notification_endpoints::v1::DeleteRegionNotificationEndpointsRequest const& request) = 0;

  virtual StatusOr<google::cloud::cpp::compute::v1::NotificationEndpoint> GetRegionNotificationEndpoints(
      google::cloud::rest_internal::RestContext& rest_context,
      google::cloud::cpp::compute::region_notification_endpoints::v1::GetRegionNotificationEndpointsRequest const& request) = 0;

  virtual future<StatusOr<google::cloud::cpp::compute::v1::Operation>> AsyncInsertRegionNotificationEndpoints(
      google::cloud::CompletionQueue& cq,
      std::unique_ptr<google::cloud::rest_internal::RestContext> rest_context,
      google::cloud::cpp::compute::region_notification_endpoints::v1::InsertRegionNotificationEndpointsRequest const& request) = 0;

  virtual StatusOr<google::cloud::cpp::compute::v1::NotificationEndpointList> ListRegionNotificationEndpoints(
      google::cloud::rest_internal::RestContext& rest_context,
      google::cloud::cpp::compute::region_notification_endpoints::v1::ListRegionNotificationEndpointsRequest const& request) = 0;
...
class DefaultRegionNotificationEndpointsRestStub : public RegionNotificationEndpointsRestStub {
 public:
  ...
  future<StatusOr<google::cloud::cpp::compute::v1::Operation>> AsyncDeleteRegionNotificationEndpoints(
      google::cloud::CompletionQueue& cq,
      std::unique_ptr<google::cloud::rest_internal::RestContext> rest_context,
  ...
  future<StatusOr<google::cloud::cpp::compute::v1::Operation>> AsyncInsertRegionNotificationEndpoints(
      google::cloud::CompletionQueue& cq,
      std::unique_ptr<google::cloud::rest_internal::RestContext> rest_context,
