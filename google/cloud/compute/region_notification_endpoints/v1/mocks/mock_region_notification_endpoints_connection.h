 ...
 * including errors, from an object of type `RegionNotificationEndpointsClient`.
 * To do so, construct an object of type `RegionNotificationEndpointsClient`
...
class MockRegionNotificationEndpointsConnection
 ...
 public:
  ...
  // EXPECT_CALL(*mock, DeleteNotificationEndpoint(_)) instead.
  ...
  // EXPECT_CALL(*mock, InsertNotificationEndpoint(_)) instead.
  MOCK_METHOD(future<StatusOr<google::cloud::cpp::compute::v1::Operation>>,
