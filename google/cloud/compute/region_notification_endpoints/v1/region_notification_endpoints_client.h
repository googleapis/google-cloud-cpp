...
class RegionNotificationEndpointsClient {
 public:
  ...
  /// https://cloud.google.com/compute/docs/reference/rest/v1/regionNotificationEndpoints/aggregatedList
  ///
  ...
  ///     [google.cloud.cpp.compute.v1.NotificationEndpointsScopedList], or rather,
  ...
  AggregatedListRegionNotificationEndpoints(std::string const& project,
                                            Options opts = {});
  ...
  ///     [google.cloud.cpp.compute.region_notification_endpoints.v1.AggregatedListRegionNotificationEndpointsRequest].
  ...
  /// https://cloud.google.com/compute/docs/reference/rest/v1/regionNotificationEndpoints/testIamPermissions
  ///
  /// @param project  Project ID for this request.
  ...
  ///     function, receive a single `request` proto message which includes all
  ///     the inputs for the RPC. In this case, the proto message is a
  ///     [google.cloud.cpp.compute.region_notification_endpoints.v1.TestIamPermissionsRequest].
  ///     Proto messages are converted to C++ classes by Protobuf, using the
  ///     [Protobuf mapping rules].
  /// @param opts Optional. Override the class-level options, such as retry and
  ///     backoff policies.
