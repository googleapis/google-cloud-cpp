...
class NetworkAttachmentsClient {
 public:
  ...
  /// [google.cloud.cpp.compute.v1.NetworkAttachmentsScopedList]: @cloud_cpp_reference_link{google/cloud/compute/v1/internal/common_081.proto#L352}
  ///
  // clang-format on
  StreamRange<
      std::pair<std::string,
  ...
  /// [google.cloud.cpp.compute.v1.NetworkAttachment]: @cloud_cpp_reference_link{google/cloud/compute/v1/internal/common_081.proto#L25}
  ///
  // clang-format on
