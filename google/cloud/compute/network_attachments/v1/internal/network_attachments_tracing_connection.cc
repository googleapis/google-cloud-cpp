...
NetworkAttachmentsTracingConnection::AggregatedListNetworkAttachments(google::cloud::cpp::compute::network_attachments::v1::AggregatedListNetworkAttachmentsRequest const& request) {
...
NetworkAttachmentsTracingConnection::DeleteNetworkAttachments(google::cloud::cpp::compute::network_attachments::v1::DeleteNetworkAttachmentsRequest const& request) {
  auto span = internal::MakeSpan(
      "compute_network_attachments_v1::NetworkAttachmentsConnection::DeleteNetworkAttachments");
  auto scope = opentelemetry::trace::Scope(span);
  return internal::EndSpan(std::move(span), child_->DeleteNetworkAttachments(request));
}

StatusOr<google::cloud::cpp::compute::v1::NetworkAttachment>
NetworkAttachmentsTracingConnection::GetNetworkAttachments(google::cloud::cpp::compute::network_attachments::v1::GetNetworkAttachmentsRequest const& request) {
...
future<StatusOr<google::cloud::cpp::compute::v1::Operation>>
NetworkAttachmentsTracingConnection::InsertNetworkAttachments(google::cloud::cpp::compute::network_attachments::v1::InsertNetworkAttachmentsRequest const& request) {
  auto span = internal::MakeSpan(
      "compute_network_attachments_v1::NetworkAttachmentsConnection::InsertNetworkAttachments");
  auto scope = opentelemetry::trace::Scope(span);
  return internal::EndSpan(std::move(span), child_->InsertNetworkAttachments(request));
}
