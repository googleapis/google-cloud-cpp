...
/**
 * A retry policy for `NetworkAttachmentsConnection` that stops retrying after a
...
class NetworkAttachmentsLimitedErrorCountRetryPolicy
 ...
 public:
  NetworkAttachmentsLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `NetworkAttachmentsConnection` that stops retrying after
