 ...
 */
struct NodeTemplatesRetryPolicyOption {
  using Type = std::shared_ptr<NodeTemplatesRetryPolicy>;
};
 ...
 * @ingroup google-cloud-compute-options
 */
struct NodeTemplatesBackoffPolicyOption {
 ...
 * @ingroup google-cloud-compute-options
 */
struct NodeTemplatesConnectionIdempotencyPolicyOption {
  using Type = std::shared_ptr<NodeTemplatesConnectionIdempotencyPolicy>;
};
 ...
 * @ingroup google-cloud-compute-options
 */
struct NodeTemplatesPollingPolicyOption {
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_COMPUTE_NODE_TEMPLATES_V1_NODE_TEMPLATES_OPTIONS_H
