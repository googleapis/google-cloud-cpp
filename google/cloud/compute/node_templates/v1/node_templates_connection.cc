...
NodeTemplatesConnection::AggregatedListNodeTemplates(
    google::cloud::cpp::compute::node_templates::v1::AggregatedListNodeTemplatesRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

future<StatusOr<google::cloud::cpp::compute::v1::Operation>>
NodeTemplatesConnection::DeleteNodeTemplates(
    google::cloud::cpp::compute::node_templates::v1::DeleteNodeTemplatesRequest const&) {
...
NodeTemplatesConnection::GetNodeTemplates(
    google::cloud::cpp::compute::node_templates::v1::GetNodeTemplatesRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}
...
NodeTemplatesConnection::InsertNodeTemplates(
    google::cloud::cpp::compute::node_templates::v1::InsertNodeTemplatesRequest const&) {
  return google::cloud::make_ready_future<
    StatusOr<google::cloud::cpp::compute::v1::Operation>>(
    Status(StatusCode::kUnimplemented, "not implemented"));
}
...
StreamRange<google::cloud::cpp::compute::v1::NodeTemplate> NodeTemplatesConnection::ListNodeTemplates(
    google::cloud::cpp::compute::node_templates::v1::ListNodeTemplatesRequest) {  // NOLINT(performance-unnecessary-value-param)
