...
GlobalOperationsConnection::AggregatedListGlobalOperations(
    google::cloud::cpp::compute::globalOperations::v1::AggregatedListGlobalOperationsRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

Status
GlobalOperationsConnection::DeleteGlobalOperations(
    google::cloud::cpp::compute::globalOperations::v1::DeleteGlobalOperationsRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

StatusOr<google::cloud::cpp::compute::v1::Operation>
GlobalOperationsConnection::GetGlobalOperations(
    google::cloud::cpp::compute::globalOperations::v1::GetGlobalOperationsRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

StreamRange<google::cloud::cpp::compute::v1::Operation> GlobalOperationsConnection::ListGlobalOperations(
    google::cloud::cpp::compute::globalOperations::v1::ListGlobalOperationsRequest) {  // NOLINT(performance-unnecessary-value-param)
  return google::cloud::internal::MakeUnimplementedPaginationRange<
      StreamRange<google::cloud::cpp::compute::v1::Operation>>();
}

StatusOr<google::cloud::cpp::compute::v1::Operation>
GlobalOperationsConnection::Wait(
