...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::compute_global_operations_v1::GlobalOperationsClient(google::cloud::ExperimentalTag{},
      google::cloud::compute_global_operations_v1::MakeGlobalOperationsConnectionRest(google::cloud::ExperimentalTag{},options));
  //! [set-client-endpoint]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::compute_global_operations_v1::GlobalOperationsClient(google::cloud::ExperimentalTag{},
      google::cloud::compute_global_operations_v1::MakeGlobalOperationsConnectionRest(google::cloud::ExperimentalTag{},options));
  }
  //! [with-service-account]
  (argv.at(0));
