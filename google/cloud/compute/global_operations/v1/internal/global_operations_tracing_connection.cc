...
GlobalOperationsTracingConnection::AggregatedListGlobalOperations(google::cloud::cpp::compute::globalOperations::v1::AggregatedListGlobalOperationsRequest const& request) {
...
Status
GlobalOperationsTracingConnection::DeleteGlobalOperations(google::cloud::cpp::compute::globalOperations::v1::DeleteGlobalOperationsRequest const& request) {
...
GlobalOperationsTracingConnection::GetGlobalOperations(google::cloud::cpp::compute::globalOperations::v1::GetGlobalOperationsRequest const& request) {
...
GlobalOperationsTracingConnection::ListGlobalOperations(google::cloud::cpp::compute::globalOperations::v1::ListGlobalOperationsRequest request) {
...
StatusOr<google::cloud::cpp::compute::v1::Operation>
GlobalOperationsTracingConnection::Wait(google::cloud::cpp::compute::globalOperations::v1::WaitRequest const& request) {
