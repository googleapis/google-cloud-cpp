...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_COMPUTE_GLOBAL_OPERATIONS_V1_INTERNAL_GLOBAL_OPERATIONS_REST_LOGGING_DECORATOR_H
...
class GlobalOperationsRestLogging : public GlobalOperationsRestStub {
 public:
  ~GlobalOperationsRestLogging() override = default;
  GlobalOperationsRestLogging(std::shared_ptr<GlobalOperationsRestStub> child,
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_COMPUTE_GLOBAL_OPERATIONS_V1_INTERNAL_GLOBAL_OPERATIONS_REST_LOGGING_DECORATOR_H
