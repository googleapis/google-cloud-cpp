...
class GlobalOperationsRestStub {
 public:
  ...
  virtual StatusOr<google::cloud::cpp::compute::v1::OperationAggregatedList> AggregatedListGlobalOperations(
      ...
      google::cloud::cpp::compute::global_operations::v1::AggregatedListGlobalOperationsRequest const& request) = 0;
  ...
  virtual StatusOr<google::cloud::cpp::compute::v1::OperationList> ListGlobalOperations(
      google::cloud::rest_internal::RestContext& rest_context,
      google::cloud::cpp::compute::global_operations::v1::ListGlobalOperationsRequest const& request) = 0;

  virtual StatusOr<google::cloud::cpp::compute::v1::Operation> Wait(
      google::cloud::rest_internal::RestContext& rest_context,
      google::cloud::cpp::compute::global_operations::v1::WaitRequest const& request) = 0;
};
...
class DefaultGlobalOperationsRestStub : public GlobalOperationsRestStub {
 public:
  ...
  StatusOr<google::cloud::cpp::compute::v1::OperationAggregatedList> AggregatedListGlobalOperations(
      google::cloud::rest_internal::RestContext& rest_context,
      google::cloud::cpp::compute::global_operations::v1::AggregatedListGlobalOperationsRequest const& request) override;
  ...
  StatusOr<google::cloud::cpp::compute::v1::OperationList> ListGlobalOperations(
      google::cloud::rest_internal::RestContext& rest_context,
      google::cloud::cpp::compute::global_operations::v1::ListGlobalOperationsRequest const& request) override;
