...
class GlobalOperationsClient {
 public:
  ...
  /// [google.cloud.cpp.compute.v1.OperationAggregatedList]: @googleapis_reference_link{google/cloud/compute/v1/internal/common_file_083.proto#L26}
  ///
  // clang-format on
  ...
  /// [google.cloud.cpp.compute.v1.Operation]: @googleapis_reference_link{google/cloud/compute/v1/internal/common_file_029.proto#L98}
  ///
  // clang-format on
