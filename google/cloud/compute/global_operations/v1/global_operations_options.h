 ...
 */
struct GlobalOperationsRetryPolicyOption {
  using Type = std::shared_ptr<GlobalOperationsRetryPolicy>;
};
 ...
 * @ingroup google-cloud-compute-options
 */
struct GlobalOperationsBackoffPolicyOption {
 ...
 * @ingroup google-cloud-compute-options
 */
struct GlobalOperationsConnectionIdempotencyPolicyOption {
  using Type = std::shared_ptr<GlobalOperationsConnectionIdempotencyPolicy>;
};
 ...
 * @ingroup google-cloud-compute-options
 */
using GlobalOperationsPolicyOptionList =
    OptionList<GlobalOperationsRetryPolicyOption,
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_COMPUTE_GLOBAL_OPERATIONS_V1_GLOBAL_OPERATIONS_OPTIONS_H
