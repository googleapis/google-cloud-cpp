...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_COMPUTE_GLOBAL_OPERATIONS_V1_MOCKS_MOCK_GLOBAL_OPERATIONS_CONNECTION_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_COMPUTE_GLOBAL_OPERATIONS_V1_MOCKS_MOCK_GLOBAL_OPERATIONS_CONNECTION_H
...
namespace google {
namespace cloud {
namespace compute_global_operations_v1_mocks {
 ...
 * including errors, from an object of type `GlobalOperationsClient`. To do so,
 * construct an object of type `GlobalOperationsClient` with an instance of this
...
class MockGlobalOperationsConnection : public compute_global_operations_v1::GlobalOperationsConnection {
 public:
  ...
  MOCK_METHOD(StatusOr<google::cloud::cpp::compute::v1::OperationAggregatedList>,
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_COMPUTE_GLOBAL_OPERATIONS_V1_MOCKS_MOCK_GLOBAL_OPERATIONS_CONNECTION_H
