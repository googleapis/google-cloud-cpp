...
class TargetInstancesClient {
 public:
  ...
  /// [google.cloud.cpp.compute.v1.TargetInstancesScopedList]: @cloud_cpp_reference_link{google/cloud/compute/v1/internal/common_134.proto#L304}
  ///
  // clang-format on
  ...
  /// [google.cloud.cpp.compute.v1.TargetInstance]: @cloud_cpp_reference_link{google/cloud/compute/v1/internal/common_134.proto#L28}
  ///
  // clang-format on
