...
TargetInstancesTracingConnection::AggregatedListTargetInstances(google::cloud::cpp::compute::target_instances::v1::AggregatedListTargetInstancesRequest const& request) {
...
TargetInstancesTracingConnection::DeleteTargetInstances(google::cloud::cpp::compute::target_instances::v1::DeleteTargetInstancesRequest const& request) {
  auto span = internal::MakeSpan(
      "compute_target_instances_v1::TargetInstancesConnection::DeleteTargetInstances");
  auto scope = opentelemetry::trace::Scope(span);
  return internal::EndSpan(std::move(span), child_->DeleteTargetInstances(request));
}

StatusOr<google::cloud::cpp::compute::v1::TargetInstance>
TargetInstancesTracingConnection::GetTargetInstances(google::cloud::cpp::compute::target_instances::v1::GetTargetInstancesRequest const& request) {
...
future<StatusOr<google::cloud::cpp::compute::v1::Operation>>
TargetInstancesTracingConnection::InsertTargetInstances(google::cloud::cpp::compute::target_instances::v1::InsertTargetInstancesRequest const& request) {
  auto span = internal::MakeSpan(
      "compute_target_instances_v1::TargetInstancesConnection::InsertTargetInstances");
  auto scope = opentelemetry::trace::Scope(span);
  return internal::EndSpan(std::move(span), child_->InsertTargetInstances(request));
}
