...
DefaultTargetInstancesRestStub::AggregatedListTargetInstances(
  ...
  return rest_internal::Get<google::cloud::cpp::compute::v1::TargetInstanceAggregatedList>(
      *service_, rest_context, request,
      absl::StrCat("/compute/v1/projects/", request.project(), "/aggregated/targetInstances"),
...
DefaultTargetInstancesRestStub::AsyncDeleteTargetInstances(
      CompletionQueue& cq,
  ...
  std::thread t{[](auto p, auto service, auto request, auto rest_context) {
      p.set_value(rest_internal::Delete<google::cloud::cpp::compute::v1::Operation>(
          *service, *rest_context, request,
          absl::StrCat("/compute/v1/projects/", request.project(), "/zones/", request.zone(), "/targetInstances/", request.target_instance(), "")));
...
future<StatusOr<google::cloud::cpp::compute::v1::Operation>>
DefaultTargetInstancesRestStub::AsyncInsertTargetInstances(
      CompletionQueue& cq,
      std::unique_ptr<rest_internal::RestContext> rest_context,
  ...
  std::thread t{[](auto p, auto service, auto request, auto rest_context) {
      p.set_value(rest_internal::Post<google::cloud::cpp::compute::v1::Operation>(
          *service, *rest_context, request.target_instance_resource(),
          absl::StrCat("/compute/v1/projects/", request.project(), "/zones/", request.zone(), "/targetInstances")));
  }, std::move(p), service_, request, std::move(rest_context)};
  return f.then([t = std::move(t), cq](auto f) mutable {
    cq.RunAsync([t = std::move(t)]() mutable {
      t.join();
