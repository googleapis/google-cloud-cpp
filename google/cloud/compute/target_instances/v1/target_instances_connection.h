...
/**
 * A retry policy for `TargetInstancesConnection` that stops retrying after a
...
class TargetInstancesLimitedErrorCountRetryPolicy
 ...
 public:
  TargetInstancesLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `TargetInstancesConnection` that stops retrying after
