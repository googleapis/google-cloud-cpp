...
TargetInstancesConnection::AggregatedListTargetInstances(
    google::cloud::cpp::compute::targetInstances::v1::AggregatedListTargetInstancesRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

StatusOr<google::cloud::cpp::compute::v1::Operation>
TargetInstancesConnection::DeleteTargetInstances(
    google::cloud::cpp::compute::targetInstances::v1::DeleteTargetInstancesRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

StatusOr<google::cloud::cpp::compute::v1::TargetInstance>
TargetInstancesConnection::GetTargetInstances(
    google::cloud::cpp::compute::targetInstances::v1::GetTargetInstancesRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

StatusOr<google::cloud::cpp::compute::v1::Operation>
TargetInstancesConnection::InsertTargetInstances(
    google::cloud::cpp::compute::targetInstances::v1::InsertTargetInstancesRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

StreamRange<google::cloud::cpp::compute::v1::TargetInstance> TargetInstancesConnection::ListTargetInstances(
    google::cloud::cpp::compute::targetInstances::v1::ListTargetInstancesRequest) {  // NOLINT(performance-unnecessary-value-param)
