...
Status
GlobalOrganizationOperationsRestMetadata::DeleteOperation(
...
GlobalOrganizationOperationsRestMetadata::GetOperation(
    rest_internal::RestContext& rest_context,
...
GlobalOrganizationOperationsRestMetadata::ListGlobalOrganizationOperations(
    rest_internal::RestContext& rest_context,
    Options const& options, google::cloud::cpp::compute::global_organization_operations::v1::ListGlobalOrganizationOperationsRequest const& request) {
  SetMetadata(rest_context, options);
