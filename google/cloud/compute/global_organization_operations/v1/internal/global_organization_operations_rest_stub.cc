...
Status DefaultGlobalOrganizationOperationsRestStub::DeleteGlobalOrganizationOperations(
  ...
  return rest_internal::Delete(
      *service_, rest_context, request,
      absl::StrCat("/compute/v1/locations/global/operations/", request.operation(), ""));
}

StatusOr<google::cloud::cpp::compute::v1::Operation>
DefaultGlobalOrganizationOperationsRestStub::GetGlobalOrganizationOperations(
      google::cloud::rest_internal::RestContext& rest_context,
