...
GlobalOrganizationOperationsRestLogging::GlobalOrganizationOperationsRestLogging(
...
GlobalOrganizationOperationsRestLogging::DeleteGlobalOrganizationOperations(
    ...
    google::cloud::cpp::compute::globalOrganizationOperations::v1::DeleteGlobalOrganizationOperationsRequest const& request) {
...
GlobalOrganizationOperationsRestLogging::GetGlobalOrganizationOperations(
    rest_internal::RestContext& rest_context,
    google::cloud::cpp::compute::globalOrganizationOperations::v1::GetGlobalOrganizationOperationsRequest const& request) {
  return google::cloud::internal::LogWrapper(
      [this](rest_internal::RestContext& rest_context,
             google::cloud::cpp::compute::globalOrganizationOperations::v1::GetGlobalOrganizationOperationsRequest const& request) {
...
GlobalOrganizationOperationsRestLogging::ListGlobalOrganizationOperations(
    rest_internal::RestContext& rest_context,
    google::cloud::cpp::compute::globalOrganizationOperations::v1::ListGlobalOrganizationOperationsRequest const& request) {
  return google::cloud::internal::LogWrapper(
      [this](rest_internal::RestContext& rest_context,
             google::cloud::cpp::compute::globalOrganizationOperations::v1::ListGlobalOrganizationOperationsRequest const& request) {
