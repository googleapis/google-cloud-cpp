...
class GlobalOrganizationOperationsClient {
 public:
  explicit GlobalOrganizationOperationsClient(std::shared_ptr<GlobalOrganizationOperationsConnection> connection, Options opts = {});
  ...
  // clang-format on
  Status
  DeleteOperation(std::string const& operation, Options opts = {});
  ...
  // clang-format on
  Status
  DeleteOperation(google::cloud::cpp::compute::global_organization_operations::v1::DeleteOperationRequest const& request, Options opts = {});
  ...
  GetOperation(std::string const& operation, Options opts = {});
  ...
  // clang-format on
  StatusOr<google::cloud::cpp::compute::v1::Operation>
  GetOperation(google::cloud::cpp::compute::global_organization_operations::v1::GetOperationRequest const& request, Options opts = {});
