...
std::shared_ptr<GlobalOrganizationOperationsConnection> MakeGlobalOrganizationOperationsConnectionRest(
    Options options) {
  internal::CheckExpectedOptions<CommonOptionList, RestOptionList,
      UnifiedCredentialsOptionList, rest_internal::TargetApiVersionOption,
      GlobalOrganizationOperationsPolicyOptionList>(options, __func__);
  options = compute_global_organization_operations_v1_internal::GlobalOrganizationOperationsDefaultOptions(
      std::move(options));
  auto background = std::make_unique<
      rest_internal::AutomaticallyCreatedRestBackgroundThreads>();
  auto stub = compute_global_organization_operations_v1_internal::CreateDefaultGlobalOrganizationOperationsRestStub(
      options);
  return compute_global_organization_operations_v1_internal::MakeGlobalOrganizationOperationsTracingConnection(
      std::make_shared<
          compute_global_organization_operations_v1_internal::GlobalOrganizationOperationsRestConnectionImpl>(
