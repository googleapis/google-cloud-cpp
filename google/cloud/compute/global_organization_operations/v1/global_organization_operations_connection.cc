...
GlobalOrganizationOperationsConnection::ListGlobalOrganizationOperations(
    google::cloud::cpp::compute::global_organization_operations::v1::
        ListGlobalOrganizationOperationsRequest) {  // NOLINT(performance-unnecessary-value-param)
