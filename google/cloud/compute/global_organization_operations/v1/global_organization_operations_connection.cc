...
GlobalOrganizationOperationsConnection::DeleteGlobalOrganizationOperations(
    google::cloud::cpp::compute::globalOrganizationOperations::v1::DeleteGlobalOrganizationOperationsRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

StatusOr<google::cloud::cpp::compute::v1::Operation>
GlobalOrganizationOperationsConnection::GetGlobalOrganizationOperations(
    google::cloud::cpp::compute::globalOrganizationOperations::v1::GetGlobalOrganizationOperationsRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}
...
StreamRange<google::cloud::cpp::compute::v1::Operation> GlobalOrganizationOperationsConnection::ListGlobalOrganizationOperations(
    google::cloud::cpp::compute::globalOrganizationOperations::v1::ListGlobalOrganizationOperationsRequest) {  // NOLINT(performance-unnecessary-value-param)
