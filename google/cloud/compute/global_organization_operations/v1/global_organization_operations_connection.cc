...
GlobalOrganizationOperationsConnection::~GlobalOrganizationOperationsConnection() = default;

Status
GlobalOrganizationOperationsConnection::DeleteOperation(
    google::cloud::cpp::compute::global_organization_operations::v1::DeleteOperationRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

StatusOr<google::cloud::cpp::compute::v1::Operation>
GlobalOrganizationOperationsConnection::GetOperation(
    google::cloud::cpp::compute::global_organization_operations::v1::GetOperationRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

StreamRange<google::cloud::cpp::compute::v1::Operation> GlobalOrganizationOperationsConnection::ListGlobalOrganizationOperations(
    google::cloud::cpp::compute::global_organization_operations::v1::ListGlobalOrganizationOperationsRequest) {  // NOLINT(performance-unnecessary-value-param)
