...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::compute_global_organization_operations_v1::GlobalOrganizationOperationsClient(google::cloud::ExperimentalTag{},
      google::cloud::compute_global_organization_operations_v1::MakeGlobalOrganizationOperationsConnectionRest(google::cloud::ExperimentalTag{},options));
  //! [set-client-endpoint]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::compute_global_organization_operations_v1::GlobalOrganizationOperationsClient(google::cloud::ExperimentalTag{},
      google::cloud::compute_global_organization_operations_v1::MakeGlobalOrganizationOperationsConnectionRest(google::cloud::ExperimentalTag{},options));
  }
  //! [with-service-account]
  (argv.at(0));
