 ...
 * `GlobalOrganizationOperationsClient`. To do so, construct an object of type
 * `GlobalOrganizationOperationsClient` with an instance of this class. Then use
...
class MockGlobalOrganizationOperationsConnection
 ...
 public:
  ...
  MOCK_METHOD(Status, DeleteGlobalOrganizationOperations,
