...
Idempotency GlobalOrganizationOperationsConnectionIdempotencyPolicy::DeleteGlobalOrganizationOperations(google::cloud::cpp::compute::globalOrganizationOperations::v1::DeleteGlobalOrganizationOperationsRequest const&) {
  return Idempotency::kNonIdempotent;
}

Idempotency GlobalOrganizationOperationsConnectionIdempotencyPolicy::GetGlobalOrganizationOperations(google::cloud::cpp::compute::globalOrganizationOperations::v1::GetGlobalOrganizationOperationsRequest const&) {
  return Idempotency::kIdempotent;
}

Idempotency GlobalOrganizationOperationsConnectionIdempotencyPolicy::ListGlobalOrganizationOperations(google::cloud::cpp::compute::globalOrganizationOperations::v1::ListGlobalOrganizationOperationsRequest) {  // NOLINT
  return Idempotency::kIdempotent;
}
