...
// clang-format off
// main-dox-marker: compute_cross_site_networks_v1::CrossSiteNetworksClient
// lro-marker: true
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client =
      google::cloud::compute_cross_site_networks_v1::CrossSiteNetworksClient(
          google::cloud::compute_cross_site_networks_v1::
              MakeCrossSiteNetworksConnectionRest(options));
  //! [set-client-endpoint]
}
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client =
      google::cloud::compute_cross_site_networks_v1::CrossSiteNetworksClient(
          google::cloud::compute_cross_site_networks_v1::
              MakeCrossSiteNetworksConnectionRest(*ud_options));
  //! [set-client-universe-domain]
}

//! [custom-idempotency-policy]
class CustomIdempotencyPolicy
    : public google::cloud::compute_cross_site_networks_v1::
          CrossSiteNetworksConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::compute_cross_site_networks_v1::
                      CrossSiteNetworksConnectionIdempotencyPolicy>
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options =
      google::cloud::Options{}
          .set<google::cloud::compute_cross_site_networks_v1::
                   CrossSiteNetworksConnectionIdempotencyPolicyOption>(
              CustomIdempotencyPolicy().clone())
          .set<google::cloud::compute_cross_site_networks_v1::
                   CrossSiteNetworksRetryPolicyOption>(
              google::cloud::compute_cross_site_networks_v1::
                  CrossSiteNetworksLimitedErrorCountRetryPolicy(3)
                      .clone())
          .set<google::cloud::compute_cross_site_networks_v1::
              ...
              google::cloud::ExponentialBackoffPolicy(
                  ...
                  /*scaling=*/2.0)
                  .clone());
  auto connection = google::cloud::compute_cross_site_networks_v1::
      MakeCrossSiteNetworksConnectionRest(options);
  ...
  //     .set<google::cloud::compute_cross_site_networks_v1::CrossSiteNetworksRetryPolicyOption>(
  //       google::cloud::compute_cross_site_networks_v1::CrossSiteNetworksLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
      ...
      google::cloud::Options{}
          .set<google::cloud::compute_cross_site_networks_v1::
              ...
              google::cloud::GenericPollingPolicy<
                  google::cloud::compute_cross_site_networks_v1::
                      CrossSiteNetworksRetryPolicyOption::Type,
                  google::cloud::compute_cross_site_networks_v1::
                      CrossSiteNetworksBackoffPolicyOption::Type>(
                  google::cloud::compute_cross_site_networks_v1::
                      CrossSiteNetworksLimitedTimeRetryPolicy(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::compute_cross_site_networks_v1::
