  ...
  std::thread t{[](auto p, auto service, auto request, auto rest_context) {
      p.set_value(rest_internal::Delete<google::cloud::cpp::compute::v1::Operation>(
          *service, *rest_context, request,
          absl::StrCat("/compute/v1/projects/", request.project(), "/regions/", request.region(), "/backendServices/", request.backend_service(), "")));
...
DefaultRegionBackendServicesRestStub::GetHealth(
  ...
  return rest_internal::Post<google::cloud::cpp::compute::v1::BackendServiceGroupHealth>(
      *service_, rest_context, request.resource_group_reference_resource(),
      absl::StrCat("/compute/v1/projects/", request.project(), "/regions/", request.region(), "/backendServices/", request.backend_service(), "/getHealth"));
}
...
DefaultRegionBackendServicesRestStub::GetIamPolicy(
  ...
  return rest_internal::Get<google::cloud::cpp::compute::v1::Policy>(
      *service_, rest_context, request,
      absl::StrCat("/compute/v1/projects/", request.project(), "/regions/", request.region(), "/backendServices/", request.resource(), "/getIamPolicy"),
  ...
  std::thread t{[](auto p, auto service, auto request, auto rest_context) {
      p.set_value(rest_internal::Post<google::cloud::cpp::compute::v1::Operation>(
          *service, *rest_context, request.backend_service_resource(),
          absl::StrCat("/compute/v1/projects/", request.project(), "/regions/", request.region(), "/backendServices")));
  }, std::move(p), service_, request, std::move(rest_context)};
  return f.then([t = std::move(t), cq](auto f) mutable {
    cq.RunAsync([t = std::move(t)]() mutable {
      t.join();
...
DefaultRegionBackendServicesRestStub::SetIamPolicy(
  ...
  return rest_internal::Post<google::cloud::cpp::compute::v1::Policy>(
      *service_, rest_context, request.region_set_policy_request_resource(),
      absl::StrCat("/compute/v1/projects/", request.project(), "/regions/", request.region(), "/backendServices/", request.resource(), "/setIamPolicy"));
}
