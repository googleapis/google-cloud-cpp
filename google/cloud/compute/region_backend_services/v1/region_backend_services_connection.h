...
/**
 * A retry policy for `RegionBackendServicesConnection` based on counting errors.
 *
 ...
 */
class RegionBackendServicesLimitedErrorCountRetryPolicy : public RegionBackendServicesRetryPolicy {
 public:
  /**
   ...
   */
  explicit RegionBackendServicesLimitedErrorCountRetryPolicy(int maximum_failures)
    : impl_(maximum_failures) {}

  RegionBackendServicesLimitedErrorCountRetryPolicy(
      RegionBackendServicesLimitedErrorCountRetryPolicy&& rhs) noexcept
    : RegionBackendServicesLimitedErrorCountRetryPolicy(rhs.maximum_failures()) {}
  RegionBackendServicesLimitedErrorCountRetryPolicy(
 ...
 private:
  google::cloud::internal::LimitedErrorCountRetryPolicy<compute_region_backend_services_v1_internal::RegionBackendServicesRetryTraits> impl_;
};
 ...
 * - [`kUnavailable`](@ref google::cloud::StatusCode)
 */
class RegionBackendServicesLimitedTimeRetryPolicy : public RegionBackendServicesRetryPolicy {
 public:
  /**
  ...
  RegionBackendServicesLimitedTimeRetryPolicy(RegionBackendServicesLimitedTimeRetryPolicy&& rhs) noexcept
    : RegionBackendServicesLimitedTimeRetryPolicy(rhs.maximum_duration()) {}
  RegionBackendServicesLimitedTimeRetryPolicy(RegionBackendServicesLimitedTimeRetryPolicy const& rhs) noexcept
    : RegionBackendServicesLimitedTimeRetryPolicy(rhs.maximum_duration()) {}
 ...
 private:
  google::cloud::internal::LimitedTimeRetryPolicy<compute_region_backend_services_v1_internal::RegionBackendServicesRetryTraits> impl_;
};
...
class RegionBackendServicesConnection {
 public:
  ...
  DeleteBackendService(google::cloud::cpp::compute::region_backend_services::v1::DeleteBackendServiceRequest const& request);

  virtual StatusOr<google::cloud::cpp::compute::v1::Operation>
  DeleteBackendService(NoAwaitTag, google::cloud::cpp::compute::region_backend_services::v1::DeleteBackendServiceRequest const& request);
  ...
  GetBackendService(google::cloud::cpp::compute::region_backend_services::v1::GetBackendServiceRequest const& request);
  ...
  virtual future<StatusOr<google::cloud::cpp::compute::v1::Operation>>
  InsertBackendService(google::cloud::cpp::compute::region_backend_services::v1::InsertBackendServiceRequest const& request);

  virtual StatusOr<google::cloud::cpp::compute::v1::Operation>
  InsertBackendService(NoAwaitTag, google::cloud::cpp::compute::region_backend_services::v1::InsertBackendServiceRequest const& request);
  ...
  virtual StreamRange<google::cloud::cpp::compute::v1::BackendService>
  ListUsable(google::cloud::cpp::compute::region_backend_services::v1::ListUsableRequest request);

  virtual future<StatusOr<google::cloud::cpp::compute::v1::Operation>>
  PatchBackendService(google::cloud::cpp::compute::region_backend_services::v1::PatchBackendServiceRequest const& request);

  virtual StatusOr<google::cloud::cpp::compute::v1::Operation>
  PatchBackendService(NoAwaitTag, google::cloud::cpp::compute::region_backend_services::v1::PatchBackendServiceRequest const& request);
  ...
  virtual future<StatusOr<google::cloud::cpp::compute::v1::Operation>>
  SetSecurityPolicy(google::cloud::cpp::compute::region_backend_services::v1::SetSecurityPolicyRequest const& request);

  virtual StatusOr<google::cloud::cpp::compute::v1::Operation>
  SetSecurityPolicy(NoAwaitTag, google::cloud::cpp::compute::region_backend_services::v1::SetSecurityPolicyRequest const& request);

  virtual future<StatusOr<google::cloud::cpp::compute::v1::Operation>>
  SetSecurityPolicy( google::cloud::cpp::compute::v1::Operation const& operation);

  virtual StatusOr<google::cloud::cpp::compute::v1::TestPermissionsResponse>
  TestIamPermissions(google::cloud::cpp::compute::region_backend_services::v1::TestIamPermissionsRequest const& request);

  virtual future<StatusOr<google::cloud::cpp::compute::v1::Operation>>
  UpdateBackendService(google::cloud::cpp::compute::region_backend_services::v1::UpdateBackendServiceRequest const& request);

  virtual StatusOr<google::cloud::cpp::compute::v1::Operation>
  UpdateBackendService(NoAwaitTag, google::cloud::cpp::compute::region_backend_services::v1::UpdateBackendServiceRequest const& request);
