...
RegionBackendServicesConnectionIdempotencyPolicy::
    ~RegionBackendServicesConnectionIdempotencyPolicy() = default;
...
Idempotency
RegionBackendServicesConnectionIdempotencyPolicy::DeleteBackendService(
    google::cloud::cpp::compute::region_backend_services::v1::
        DeleteBackendServiceRequest const&) {
  return Idempotency::kNonIdempotent;
}

Idempotency RegionBackendServicesConnectionIdempotencyPolicy::GetBackendService(
    google::cloud::cpp::compute::region_backend_services::v1::
        GetBackendServiceRequest const&) {
  return Idempotency::kIdempotent;
}

Idempotency RegionBackendServicesConnectionIdempotencyPolicy::GetHealth(
    google::cloud::cpp::compute::region_backend_services::v1::
        GetHealthRequest const&) {
  return Idempotency::kNonIdempotent;
}

Idempotency RegionBackendServicesConnectionIdempotencyPolicy::GetIamPolicy(
    google::cloud::cpp::compute::region_backend_services::v1::
...
Idempotency
RegionBackendServicesConnectionIdempotencyPolicy::InsertBackendService(
    google::cloud::cpp::compute::region_backend_services::v1::
...
Idempotency
RegionBackendServicesConnectionIdempotencyPolicy::ListRegionBackendServices(
    google::cloud::cpp::compute::region_backend_services::v1::
        ListRegionBackendServicesRequest) {  // NOLINT
  return Idempotency::kIdempotent;
}
...
Idempotency RegionBackendServicesConnectionIdempotencyPolicy::SetIamPolicy(
    google::cloud::cpp::compute::region_backend_services::v1::
...
Idempotency
RegionBackendServicesConnectionIdempotencyPolicy::TestIamPermissions(
    google::cloud::cpp::compute::region_backend_services::v1::
