...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::compute_region_backend_services_v1::RegionBackendServicesClient(
      google::cloud::compute_region_backend_services_v1::MakeRegionBackendServicesConnectionRest(options));
  //! [set-client-endpoint]
}

//! [custom-idempotency-policy]
class CustomIdempotencyPolicy
   : public google::cloud::compute_region_backend_services_v1::RegionBackendServicesConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::compute_region_backend_services_v1::RegionBackendServicesConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::compute_region_backend_services_v1::RegionBackendServicesConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::compute_region_backend_services_v1::RegionBackendServicesRetryPolicyOption>(
      google::cloud::compute_region_backend_services_v1::RegionBackendServicesLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::compute_region_backend_services_v1::RegionBackendServicesBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::compute_region_backend_services_v1::MakeRegionBackendServicesConnectionRest(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::compute_region_backend_services_v1::RegionBackendServicesClient(connection);
  auto c2 = google::cloud::compute_region_backend_services_v1::RegionBackendServicesClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::compute_region_backend_services_v1::RegionBackendServicesClient(
    connection, google::cloud::Options{}.set<google::cloud::compute_region_backend_services_v1::RegionBackendServicesRetryPolicyOption>(
      google::cloud::compute_region_backend_services_v1::RegionBackendServicesLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::compute_region_backend_services_v1::RegionBackendServicesPollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::compute_region_backend_services_v1::RegionBackendServicesRetryPolicyOption::Type,
            google::cloud::compute_region_backend_services_v1::RegionBackendServicesBackoffPolicyOption::Type>(
            google::cloud::compute_region_backend_services_v1::RegionBackendServicesLimitedTimeRetryPolicy(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::compute_region_backend_services_v1::RegionBackendServicesClient(
      google::cloud::compute_region_backend_services_v1::MakeRegionBackendServicesConnectionRest(options));
  }
  //! [with-service-account]
  (argv.at(0));
