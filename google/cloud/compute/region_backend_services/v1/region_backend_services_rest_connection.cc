...
std::shared_ptr<RegionBackendServicesConnection> MakeRegionBackendServicesConnectionRest(
  ...
  internal::CheckExpectedOptions<CommonOptionList, RestOptionList,
      ...
      RegionBackendServicesPolicyOptionList>(options, __func__);
  options = compute_region_backend_services_v1_internal::RegionBackendServicesDefaultOptions(
      std::move(options));
  auto background = std::make_unique<
      rest_internal::AutomaticallyCreatedRestBackgroundThreads>();
  auto stub = compute_region_backend_services_v1_internal::CreateDefaultRegionBackendServicesRestStub(
      options);
  return compute_region_backend_services_v1_internal::MakeRegionBackendServicesTracingConnection(
      std::make_shared<
          compute_region_backend_services_v1_internal::RegionBackendServicesRestConnectionImpl>(
