...
future<StatusOr<google::cloud::cpp::compute::v1::Operation>>
NetworksRestConnectionImpl::CancelRequestRemovePeering(
  ...
  return rest_internal::AsyncRestLongRunningOperation<
      ...
      [stub = stub_](CompletionQueue& cq,
                     ...
                     google::cloud::cpp::compute::networks::v1::
                         CancelRequestRemovePeeringRequest const& request) {
        return stub->AsyncCancelRequestRemovePeering(
      ...
      [](StatusOr<google::cloud::cpp::compute::v1::Operation> op,
         std::string const&) { return op; },
      retry_policy(*current), backoff_policy(*current),
      idempotency_policy(*current)->CancelRequestRemovePeering(request),
      polling_policy(*current), __func__,
      [](google::cloud::cpp::compute::v1::Operation const& op) {
        return op.status() == "DONE";
      },
...
NetworksRestConnectionImpl::CancelRequestRemovePeering(
  ...
  return google::cloud::rest_internal::RestRetryLoop(
      ...
      [this](rest_internal::RestContext& rest_context, Options const& options,
             google::cloud::cpp::compute::networks::v1::
                 CancelRequestRemovePeeringRequest const& request) {
        return stub_->CancelRequestRemovePeering(rest_context, options,
                                                 request);
      },
      *current, request, __func__);
}
...
future<StatusOr<google::cloud::cpp::compute::v1::Operation>>
NetworksRestConnectionImpl::RequestRemovePeering(
    google::cloud::cpp::compute::networks::v1::
  ...
  return rest_internal::AsyncRestLongRunningOperation<
      ...
      [stub = stub_](CompletionQueue& cq,
                     ...
                     google::cloud::cpp::compute::networks::v1::
                         RequestRemovePeeringRequest const& request) {
        return stub->AsyncRequestRemovePeering(cq, std::move(context),
                                               std::move(options), request);
      },
      [stub = stub_](CompletionQueue& cq,
                     std::unique_ptr<rest_internal::RestContext> context,
      ...
      [](StatusOr<google::cloud::cpp::compute::v1::Operation> op,
         std::string const&) { return op; },
      retry_policy(*current), backoff_policy(*current),
      idempotency_policy(*current)->RequestRemovePeering(request),
      polling_policy(*current), __func__,
      [](google::cloud::cpp::compute::v1::Operation const& op) {
        return op.status() == "DONE";
      },
...
NetworksRestConnectionImpl::RequestRemovePeering(
  ...
  return google::cloud::rest_internal::RestRetryLoop(
      ...
      [this](rest_internal::RestContext& rest_context, Options const& options,
             google::cloud::cpp::compute::networks::v1::
                 RequestRemovePeeringRequest const& request) {
        return stub_->RequestRemovePeering(rest_context, options, request);
      },
      *current, request, __func__);
}
