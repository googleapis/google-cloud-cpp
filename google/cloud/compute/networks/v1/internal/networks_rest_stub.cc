...
future<StatusOr<google::cloud::cpp::compute::v1::Operation>>
DefaultNetworksRestStub::AsyncCancelRequestRemovePeering(
    CompletionQueue& cq,
    std::unique_ptr<rest_internal::RestContext> rest_context,
    google::cloud::internal::ImmutableOptions options,
...
StatusOr<google::cloud::cpp::compute::v1::Operation>
DefaultNetworksRestStub::CancelRequestRemovePeering(
    google::cloud::rest_internal::RestContext& rest_context,
    Options const& options,
    google::cloud::cpp::compute::networks::v1::
        CancelRequestRemovePeeringRequest const& request) {
  ...
  return rest_internal::Post<google::cloud::cpp::compute::v1::Operation>(
      *service_, rest_context,
      request.networks_cancel_request_remove_peering_request_resource(), false,
      absl::StrCat("/", "compute", "/",
                   rest_internal::DetermineApiVersion("v1", options), "/",
                   "projects", "/", request.project(), "/", "global", "/",
...
future<StatusOr<google::cloud::cpp::compute::v1::Operation>>
DefaultNetworksRestStub::AsyncRequestRemovePeering(
    CompletionQueue& cq,
    std::unique_ptr<rest_internal::RestContext> rest_context,
    google::cloud::internal::ImmutableOptions options,
    google::cloud::cpp::compute::networks::v1::
...
StatusOr<google::cloud::cpp::compute::v1::Operation>
DefaultNetworksRestStub::RequestRemovePeering(
    google::cloud::rest_internal::RestContext& rest_context,
    Options const& options,
    google::cloud::cpp::compute::networks::v1::
        RequestRemovePeeringRequest const& request) {
  ...
  return rest_internal::Post<google::cloud::cpp::compute::v1::Operation>(
      *service_, rest_context,
      request.networks_request_remove_peering_request_resource(), false,
      absl::StrCat("/", "compute", "/",
                   rest_internal::DetermineApiVersion("v1", options), "/",
                   "projects", "/", request.project(), "/", "global", "/",
                   "networks", "/", request.network(), "/",
