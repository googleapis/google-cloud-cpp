...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_COMPUTE_ORGANIZATION_SECURITY_POLICIES_V1_INTERNAL_ORGANIZATION_SECURITY_POLICIES_REST_LOGGING_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_COMPUTE_ORGANIZATION_SECURITY_POLICIES_V1_INTERNAL_ORGANIZATION_SECURITY_POLICIES_REST_LOGGING_DECORATOR_H
...
class OrganizationSecurityPoliciesRestLogging
    : public OrganizationSecurityPoliciesRestStub {
 public:
  ~OrganizationSecurityPoliciesRestLogging() override = default;
 ...
 private:
  std::shared_ptr<OrganizationSecurityPoliciesRestStub> child_;
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_COMPUTE_ORGANIZATION_SECURITY_POLICIES_V1_INTERNAL_ORGANIZATION_SECURITY_POLICIES_REST_LOGGING_DECORATOR_H
