...
// clang-format off
// main-dox-marker: compute_accelerator_types_v1::AcceleratorTypesClient
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::compute_accelerator_types_v1::AcceleratorTypesClient(
      google::cloud::compute_accelerator_types_v1::MakeAcceleratorTypesConnectionRest(options));
  //! [set-client-endpoint]
}

//! [custom-idempotency-policy]
class CustomIdempotencyPolicy
   : public google::cloud::compute_accelerator_types_v1::AcceleratorTypesConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::compute_accelerator_types_v1::AcceleratorTypesConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::compute_accelerator_types_v1::AcceleratorTypesConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::compute_accelerator_types_v1::AcceleratorTypesRetryPolicyOption>(
      google::cloud::compute_accelerator_types_v1::AcceleratorTypesLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::compute_accelerator_types_v1::AcceleratorTypesBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::compute_accelerator_types_v1::MakeAcceleratorTypesConnectionRest(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::compute_accelerator_types_v1::AcceleratorTypesClient(connection);
  auto c2 = google::cloud::compute_accelerator_types_v1::AcceleratorTypesClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::compute_accelerator_types_v1::AcceleratorTypesClient(
    connection, google::cloud::Options{}.set<google::cloud::compute_accelerator_types_v1::AcceleratorTypesRetryPolicyOption>(
      google::cloud::compute_accelerator_types_v1::AcceleratorTypesLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));
