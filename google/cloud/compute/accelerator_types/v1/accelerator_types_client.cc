...
AcceleratorTypesClient::AggregatedListAcceleratorTypes(std::string const& project, Options opts) {
  ...
  google::cloud::cpp::compute::acceleratorTypes::v1::AggregatedListAcceleratorTypesRequest request;
  request.set_project(project);
  return connection_->AggregatedListAcceleratorTypes(request);
}

StatusOr<google::cloud::cpp::compute::v1::AcceleratorTypeAggregatedList>
AcceleratorTypesClient::AggregatedListAcceleratorTypes(google::cloud::cpp::compute::acceleratorTypes::v1::AggregatedListAcceleratorTypesRequest const& request, Options opts) {
  internal::OptionsSpan span(internal::MergeOptions(std::move(opts), options_));
  return connection_->AggregatedListAcceleratorTypes(request);
}
...
AcceleratorTypesClient::GetAcceleratorTypes(std::string const& project, std::string const& zone, std::string const& accelerator_type, Options opts) {
  internal::OptionsSpan span(internal::MergeOptions(std::move(opts), options_));
  google::cloud::cpp::compute::acceleratorTypes::v1::GetAcceleratorTypesRequest request;
  request.set_project(project);
...
StatusOr<google::cloud::cpp::compute::v1::AcceleratorType>
AcceleratorTypesClient::GetAcceleratorTypes(google::cloud::cpp::compute::acceleratorTypes::v1::GetAcceleratorTypesRequest const& request, Options opts) {
  internal::OptionsSpan span(internal::MergeOptions(std::move(opts), options_));
  return connection_->GetAcceleratorTypes(request);
}
...
AcceleratorTypesClient::ListAcceleratorTypes(std::string const& project, std::string const& zone, Options opts) {
  internal::OptionsSpan span(internal::MergeOptions(std::move(opts), options_));
  google::cloud::cpp::compute::acceleratorTypes::v1::ListAcceleratorTypesRequest request;
  request.set_project(project);
  request.set_zone(zone);
...
StreamRange<google::cloud::cpp::compute::v1::AcceleratorType>
AcceleratorTypesClient::ListAcceleratorTypes(google::cloud::cpp::compute::acceleratorTypes::v1::ListAcceleratorTypesRequest request, Options opts) {
  internal::OptionsSpan span(internal::MergeOptions(std::move(opts), options_));
