...
Idempotency AcceleratorTypesConnectionIdempotencyPolicy::AggregatedListAcceleratorTypes(google::cloud::cpp::compute::accelerator_types::v1::AggregatedListAcceleratorTypesRequest const&) {
  return Idempotency::kIdempotent;
}

Idempotency AcceleratorTypesConnectionIdempotencyPolicy::GetAcceleratorTypes(google::cloud::cpp::compute::accelerator_types::v1::GetAcceleratorTypesRequest const&) {
  return Idempotency::kIdempotent;
}

Idempotency AcceleratorTypesConnectionIdempotencyPolicy::ListAcceleratorTypes(google::cloud::cpp::compute::accelerator_types::v1::ListAcceleratorTypesRequest) {  // NOLINT
  return Idempotency::kIdempotent;
}
