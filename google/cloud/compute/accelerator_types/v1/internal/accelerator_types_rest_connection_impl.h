...
class AcceleratorTypesRestConnectionImpl
 ...
 public:
  ...
  AggregatedListAcceleratorTypes(google::cloud::cpp::compute::accelerator_types::v1::AggregatedListAcceleratorTypesRequest const& request) override;

  StatusOr<google::cloud::cpp::compute::v1::AcceleratorType>
  GetAcceleratorTypes(google::cloud::cpp::compute::accelerator_types::v1::GetAcceleratorTypesRequest const& request) override;
