...
AcceleratorTypesRestConnectionImpl::AggregatedListAcceleratorTypes(google::cloud::cpp::compute::acceleratorTypes::v1::AggregatedListAcceleratorTypesRequest const& request) {
...
AcceleratorTypesRestConnectionImpl::GetAcceleratorTypes(google::cloud::cpp::compute::acceleratorTypes::v1::GetAcceleratorTypesRequest const& request) {
  return google::cloud::rest_internal::RestRetryLoop(
      retry_policy(), backoff_policy(),
...
AcceleratorTypesRestConnectionImpl::ListAcceleratorTypes(google::cloud::cpp::compute::acceleratorTypes::v1::ListAcceleratorTypesRequest request) {
  request.clear_page_token();
  auto& stub = stub_;
  auto retry = std::shared_ptr<compute_accelerator_types_v1::AcceleratorTypesRetryPolicy const>(retry_policy());
  ...
  return google::cloud::internal::MakePaginationRange<StreamRange<google::cloud::cpp::compute::v1::AcceleratorType>>(
      ...
      [stub, retry, backoff, idempotency, function_name]
        (google::cloud::cpp::compute::acceleratorTypes::v1::ListAcceleratorTypesRequest const& r) {
        return google::cloud::rest_internal::RestRetryLoop(
            retry->clone(), backoff->clone(), idempotency,
            [stub](rest_internal::RestContext& rest_context, google::cloud::cpp::compute::acceleratorTypes::v1::ListAcceleratorTypesRequest const& request) {
