...
class AcceleratorTypesClient {
 public:
  ...
  /// [google.cloud.cpp.compute.v1.AcceleratorTypeAggregatedList]: @googleapis_reference_link{google/cloud/compute/v1/internal/common_file_001.proto#L63}
  ///
  // clang-format on
  ...
  /// [google.cloud.cpp.compute.v1.AcceleratorType]: @googleapis_reference_link{google/cloud/compute/v1/internal/common_file_001.proto#L30}
  ///
  // clang-format on
