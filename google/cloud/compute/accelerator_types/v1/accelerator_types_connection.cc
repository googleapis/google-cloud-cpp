...
AcceleratorTypesConnection::AggregatedListAcceleratorTypes(
    google::cloud::cpp::compute::accelerator_types::v1::AggregatedListAcceleratorTypesRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

StatusOr<google::cloud::cpp::compute::v1::AcceleratorType>
AcceleratorTypesConnection::GetAcceleratorTypes(
    google::cloud::cpp::compute::accelerator_types::v1::GetAcceleratorTypesRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}
