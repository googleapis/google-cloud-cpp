...
MakeInstanceGroupManagerResizeRequestsConnectionRest(Options options) {
  ...
  options = compute_instance_group_manager_resize_requests_v1_internal::
      InstanceGroupManagerResizeRequestsDefaultOptions(std::move(options));
  auto background = std::make_unique<
      rest_internal::AutomaticallyCreatedRestBackgroundThreads>();
  auto stub = compute_instance_group_manager_resize_requests_v1_internal::
      CreateDefaultInstanceGroupManagerResizeRequestsRestStub(options);
  return compute_instance_group_manager_resize_requests_v1_internal::
