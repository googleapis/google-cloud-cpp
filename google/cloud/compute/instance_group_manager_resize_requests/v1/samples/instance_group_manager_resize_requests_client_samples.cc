...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client =
      google::cloud::compute_instance_group_manager_resize_requests_v1::
          InstanceGroupManagerResizeRequestsClient(
              google::cloud::compute_instance_group_manager_resize_requests_v1::
                  MakeInstanceGroupManagerResizeRequestsConnection(ud_options));
...
class CustomIdempotencyPolicy
    : public google::cloud::compute_instance_group_manager_resize_requests_v1::
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto c1 = google::cloud::compute_instance_group_manager_resize_requests_v1::
      InstanceGroupManagerResizeRequestsClient(connection);
  auto c2 = google::cloud::compute_instance_group_manager_resize_requests_v1::
      InstanceGroupManagerResizeRequestsClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::compute_instance_group_manager_resize_requests_v1::
      InstanceGroupManagerResizeRequestsClient(
          connection,
          google::cloud::Options{}
              .set<google::cloud::
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::compute_instance_group_manager_resize_requests_v1::
        InstanceGroupManagerResizeRequestsClient(
            google::cloud::compute_instance_group_manager_resize_requests_v1::
                MakeInstanceGroupManagerResizeRequestsConnectionRest(options));
  }
