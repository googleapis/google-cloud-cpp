...
class ResourcePoliciesClient {
 public:
  ...
  /// [google.cloud.cpp.compute.v1.ResourcePoliciesScopedList]: @cloud_cpp_reference_link{google/cloud/compute/v1/internal/common_137.proto#L24}
  ///
  // clang-format on
  ...
  /// [google.cloud.cpp.compute.v1.ResourcePolicy]: @cloud_cpp_reference_link{google/cloud/compute/v1/internal/common_137.proto#L141}
  ///
  // clang-format on
