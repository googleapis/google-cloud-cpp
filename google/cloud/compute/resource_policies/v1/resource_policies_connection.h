...
/**
 * A retry policy for `ResourcePoliciesConnection` that stops retrying after a
...
class ResourcePoliciesLimitedErrorCountRetryPolicy
 ...
 public:
  ResourcePoliciesLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `ResourcePoliciesConnection` that stops retrying after
