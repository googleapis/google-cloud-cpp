...
Idempotency ResourcePoliciesConnectionIdempotencyPolicy::AggregatedListResourcePolicies(google::cloud::cpp::compute::resource_policies::v1::AggregatedListResourcePoliciesRequest const&) {
  return Idempotency::kIdempotent;
}

Idempotency ResourcePoliciesConnectionIdempotencyPolicy::DeleteResourcePolicies(google::cloud::cpp::compute::resource_policies::v1::DeleteResourcePoliciesRequest const&) {
  return Idempotency::kNonIdempotent;
}

Idempotency ResourcePoliciesConnectionIdempotencyPolicy::GetResourcePolicies(google::cloud::cpp::compute::resource_policies::v1::GetResourcePoliciesRequest const&) {
  return Idempotency::kIdempotent;
}
...
Idempotency ResourcePoliciesConnectionIdempotencyPolicy::InsertResourcePolicies(google::cloud::cpp::compute::resource_policies::v1::InsertResourcePoliciesRequest const&) {
  return Idempotency::kNonIdempotent;
}
