...
class ResourcePoliciesRestConnectionImpl
 ...
 private:
  static std::unique_ptr<compute_resource_policies_v1::ResourcePoliciesRetryPolicy>
  ...
  static std::unique_ptr<compute_resource_policies_v1::ResourcePoliciesConnectionIdempotencyPolicy>
