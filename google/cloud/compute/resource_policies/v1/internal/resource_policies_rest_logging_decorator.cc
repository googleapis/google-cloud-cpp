...
ResourcePoliciesRestLogging::DeleteResourcePolicies(
    rest_internal::RestContext& rest_context,
    google::cloud::cpp::compute::resourcePolicies::v1::DeleteResourcePoliciesRequest const& request) {
  return google::cloud::internal::LogWrapper(
      [this](rest_internal::RestContext& rest_context,
             google::cloud::cpp::compute::resourcePolicies::v1::DeleteResourcePoliciesRequest const& request) {
        return child_->DeleteResourcePolicies(rest_context, request);
      },
      rest_context, request, __func__, tracing_options_);
}
...
StatusOr<google::cloud::cpp::compute::v1::Operation>
ResourcePoliciesRestLogging::InsertResourcePolicies(
    rest_internal::RestContext& rest_context,
    google::cloud::cpp::compute::resourcePolicies::v1::InsertResourcePoliciesRequest const& request) {
  return google::cloud::internal::LogWrapper(
      [this](rest_internal::RestContext& rest_context,
             google::cloud::cpp::compute::resourcePolicies::v1::InsertResourcePoliciesRequest const& request) {
        return child_->InsertResourcePolicies(rest_context, request);
      },
      rest_context, request, __func__, tracing_options_);
}
