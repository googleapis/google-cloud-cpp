...
ResourcePoliciesTracingConnection::AggregatedListResourcePolicies(google::cloud::cpp::compute::resourcePolicies::v1::AggregatedListResourcePoliciesRequest const& request) {
...
ResourcePoliciesTracingConnection::DeleteResourcePolicies(google::cloud::cpp::compute::resourcePolicies::v1::DeleteResourcePoliciesRequest const& request) {
  auto span = internal::MakeSpan("compute_resource_policies_v1::ResourcePoliciesConnection::DeleteResourcePolicies");
  auto scope = opentelemetry::trace::Scope(span);
  return internal::EndSpan(*span, child_->DeleteResourcePolicies(request));
}

StatusOr<google::cloud::cpp::compute::v1::ResourcePolicy>
ResourcePoliciesTracingConnection::GetResourcePolicies(google::cloud::cpp::compute::resourcePolicies::v1::GetResourcePoliciesRequest const& request) {
...
ResourcePoliciesTracingConnection::GetIamPolicy(google::cloud::cpp::compute::resourcePolicies::v1::GetIamPolicyRequest const& request) {
...
StatusOr<google::cloud::cpp::compute::v1::Operation>
ResourcePoliciesTracingConnection::InsertResourcePolicies(google::cloud::cpp::compute::resourcePolicies::v1::InsertResourcePoliciesRequest const& request) {
  auto span = internal::MakeSpan("compute_resource_policies_v1::ResourcePoliciesConnection::InsertResourcePolicies");
  auto scope = opentelemetry::trace::Scope(span);
  return internal::EndSpan(*span, child_->InsertResourcePolicies(request));
}

StreamRange<google::cloud::cpp::compute::v1::ResourcePolicy>
ResourcePoliciesTracingConnection::ListResourcePolicies(google::cloud::cpp::compute::resourcePolicies::v1::ListResourcePoliciesRequest request) {
...
StatusOr<google::cloud::cpp::compute::v1::Policy>
ResourcePoliciesTracingConnection::SetIamPolicy(google::cloud::cpp::compute::resourcePolicies::v1::SetIamPolicyRequest const& request) {
...
ResourcePoliciesTracingConnection::TestIamPermissions(google::cloud::cpp::compute::resourcePolicies::v1::TestIamPermissionsRequest const& request) {
