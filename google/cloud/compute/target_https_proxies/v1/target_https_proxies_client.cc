...
TargetHttpsProxiesClient::SetCertificateMap(
    ...
    Options opts) {
  internal::OptionsSpan span(internal::MergeOptions(std::move(opts), options_));
  google::cloud::cpp::compute::targetHttpsProxies::v1::SetCertificateMapRequest
      request;
  request.set_project(project);
  request.set_target_https_proxy(target_https_proxy);
...
TargetHttpsProxiesClient::SetQuicOverride(
    ...
    Options opts) {
  internal::OptionsSpan span(internal::MergeOptions(std::move(opts), options_));
  google::cloud::cpp::compute::targetHttpsProxies::v1::SetQuicOverrideRequest
      request;
  request.set_project(project);
  request.set_target_https_proxy(target_https_proxy);
...
TargetHttpsProxiesClient::SetSslCertificates(
    ...
    Options opts) {
  internal::OptionsSpan span(internal::MergeOptions(std::move(opts), options_));
  google::cloud::cpp::compute::targetHttpsProxies::v1::SetSslCertificatesRequest
      request;
  request.set_project(project);
  request.set_target_https_proxy(target_https_proxy);
  *request
...
TargetHttpsProxiesClient::SetSslPolicy(
    ...
    Options opts) {
  internal::OptionsSpan span(internal::MergeOptions(std::move(opts), options_));
  google::cloud::cpp::compute::targetHttpsProxies::v1::SetSslPolicyRequest
      request;
  request.set_project(project);
  request.set_target_https_proxy(target_https_proxy);
