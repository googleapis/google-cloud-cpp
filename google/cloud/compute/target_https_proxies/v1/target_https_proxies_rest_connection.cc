...
std::shared_ptr<TargetHttpsProxiesConnection> MakeTargetHttpsProxiesConnectionRest(
  ...
  internal::CheckExpectedOptions<CommonOptionList, RestOptionList,
      ...
      TargetHttpsProxiesPolicyOptionList>(options, __func__);
  options = compute_target_https_proxies_v1_internal::TargetHttpsProxiesDefaultOptions(
      std::move(options));
  auto background = std::make_unique<
      rest_internal::AutomaticallyCreatedRestBackgroundThreads>();
  auto stub = compute_target_https_proxies_v1_internal::CreateDefaultTargetHttpsProxiesRestStub(
      options);
  return compute_target_https_proxies_v1_internal::MakeTargetHttpsProxiesTracingConnection(
      std::make_shared<
          compute_target_https_proxies_v1_internal::TargetHttpsProxiesRestConnectionImpl>(
