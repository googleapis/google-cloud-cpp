...
using TargetHttpsProxiesRetryPolicy =
    ::google::cloud::internal::TraitBasedRetryPolicy<
        compute_target_https_proxies_v1_internal::
            TargetHttpsProxiesRetryTraits>;

using TargetHttpsProxiesLimitedTimeRetryPolicy =
...
class TargetHttpsProxiesConnection {
 public:
  ...
  DeleteTargetHttpsProxies(google::cloud::cpp::compute::targetHttpsProxies::v1::
                               DeleteTargetHttpsProxiesRequest const& request);

  virtual StatusOr<google::cloud::cpp::compute::v1::TargetHttpsProxy>
  GetTargetHttpsProxies(google::cloud::cpp::compute::targetHttpsProxies::v1::
                            GetTargetHttpsProxiesRequest const& request);

  virtual StatusOr<google::cloud::cpp::compute::v1::Operation>
  InsertTargetHttpsProxies(google::cloud::cpp::compute::targetHttpsProxies::v1::
                               InsertTargetHttpsProxiesRequest const& request);

  virtual StreamRange<google::cloud::cpp::compute::v1::TargetHttpsProxy>
  ListTargetHttpsProxies(google::cloud::cpp::compute::targetHttpsProxies::v1::
                             ListTargetHttpsProxiesRequest request);

  virtual StatusOr<google::cloud::cpp::compute::v1::Operation>
  PatchTargetHttpsProxies(google::cloud::cpp::compute::targetHttpsProxies::v1::
                              PatchTargetHttpsProxiesRequest const& request);

  virtual StatusOr<google::cloud::cpp::compute::v1::Operation>
  SetCertificateMap(google::cloud::cpp::compute::targetHttpsProxies::v1::
  ...
  virtual StatusOr<google::cloud::cpp::compute::v1::Operation>
  SetSslCertificates(google::cloud::cpp::compute::targetHttpsProxies::v1::
