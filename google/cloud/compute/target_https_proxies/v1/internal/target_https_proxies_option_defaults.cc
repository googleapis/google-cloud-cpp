...
Options TargetHttpsProxiesDefaultOptions(Options options) {
  ...
  if (!options.has<compute_target_https_proxies_v1::
    ...
    options.set<
        compute_target_https_proxies_v1::TargetHttpsProxiesRetryPolicyOption>(
        compute_target_https_proxies_v1::
            TargetHttpsProxiesLimitedTimeRetryPolicy(std::chrono::minutes(30))
                .clone());
  }
  if (!options.has<compute_target_https_proxies_v1::
  ...
  if (!options.has<compute_target_https_proxies_v1::
    ...
    options.set<
        compute_target_https_proxies_v1::TargetHttpsProxiesPollingPolicyOption>(
        GenericPollingPolicy<compute_target_https_proxies_v1::
  ...
  if (!options.has<compute_target_https_proxies_v1::
    ...
    options.set<compute_target_https_proxies_v1::
                    TargetHttpsProxiesConnectionIdempotencyPolicyOption>(
        compute_target_https_proxies_v1::
