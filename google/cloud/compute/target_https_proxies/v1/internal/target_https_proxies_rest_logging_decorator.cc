...
TargetHttpsProxiesRestLogging::AsyncDeleteTargetHttpsProxy(
      CompletionQueue& cq,
...
TargetHttpsProxiesRestLogging::DeleteTargetHttpsProxy(
    rest_internal::RestContext& rest_context,
    Options const& options,
    google::cloud::cpp::compute::target_https_proxies::v1::DeleteTargetHttpsProxyRequest const& request) {
  return google::cloud::internal::LogWrapper(
...
TargetHttpsProxiesRestLogging::GetTargetHttpsProxy(
    rest_internal::RestContext& rest_context,
    Options const& options,
...
future<StatusOr<google::cloud::cpp::compute::v1::Operation>>
TargetHttpsProxiesRestLogging::AsyncInsertTargetHttpsProxy(
      CompletionQueue& cq,
      std::unique_ptr<rest_internal::RestContext> rest_context,
      google::cloud::internal::ImmutableOptions options,
...
StatusOr<google::cloud::cpp::compute::v1::Operation>
TargetHttpsProxiesRestLogging::InsertTargetHttpsProxy(
    rest_internal::RestContext& rest_context,
    Options const& options,
    google::cloud::cpp::compute::target_https_proxies::v1::InsertTargetHttpsProxyRequest const& request) {
  return google::cloud::internal::LogWrapper(
...
future<StatusOr<google::cloud::cpp::compute::v1::Operation>>
TargetHttpsProxiesRestLogging::AsyncPatchTargetHttpsProxy(
      CompletionQueue& cq,
      std::unique_ptr<rest_internal::RestContext> rest_context,
      google::cloud::internal::ImmutableOptions options,
...
StatusOr<google::cloud::cpp::compute::v1::Operation>
TargetHttpsProxiesRestLogging::PatchTargetHttpsProxy(
    rest_internal::RestContext& rest_context,
    Options const& options,
    google::cloud::cpp::compute::target_https_proxies::v1::PatchTargetHttpsProxyRequest const& request) {
  return google::cloud::internal::LogWrapper(
