...
class TargetHttpsProxiesClient {
 public:
  ...
  /// [google.cloud.cpp.compute.v1.TargetHttpsProxiesScopedList]: @cloud_cpp_reference_link{google/cloud/compute/v1/internal/common_164.proto#L26}
  ///
  // clang-format on
  StreamRange<
      std::pair<std::string,
  ...
  /// [google.cloud.cpp.compute.v1.TargetHttpsProxy]: @cloud_cpp_reference_link{google/cloud/compute/v1/internal/common_165.proto#L45}
  ///
  // clang-format on
  ...
  ///
  /// @param project  Project ID for this request.
  /// @param target_https_proxy  Name of the TargetHttpsProxy resource whose CertificateMap is
  ...
  ///
  /// @param project  Project ID for this request.
  /// @param target_https_proxy  Name of the TargetHttpsProxy resource whose SSL policy is
  ///  to be set. The name must be 1-63 characters long, and comply with RFC1035.
  ...
  ///
  /// @param project  Project ID for this request.
  /// @param target_https_proxy  Name of the TargetHttpsProxy resource whose URL map is
  ///  to be set.
