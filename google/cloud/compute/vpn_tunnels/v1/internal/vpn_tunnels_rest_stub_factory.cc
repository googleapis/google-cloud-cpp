...
std::shared_ptr<VpnTunnelsRestStub> CreateDefaultVpnTunnelsRestStub(
    Options& options) {
  ...
  auto service_endpoint = internal::DetermineServiceEndpoint(
      internal::GetEnv("GOOGLE_CLOUD_CPP_VPN_TUNNELS_ENDPOINT"),
  ...
  std::shared_ptr<VpnTunnelsRestStub> stub =
      std::make_shared<DefaultVpnTunnelsRestStub>(
          std::move(stub_creation_opts));
  stub = std::make_shared<VpnTunnelsRestMetadata>(std::move(stub));
  if (internal::Contains(options.get<TracingComponentsOption>(), "rpc")) {
    GCP_LOG(INFO) << "Enabled logging for REST rpc calls";
    stub = std::make_shared<VpnTunnelsRestLogging>(
