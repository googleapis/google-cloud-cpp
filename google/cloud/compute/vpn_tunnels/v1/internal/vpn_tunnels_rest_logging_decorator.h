...
class VpnTunnelsRestLogging : public VpnTunnelsRestStub {
 public:
  ~VpnTunnelsRestLogging() override = default;
  VpnTunnelsRestLogging(std::shared_ptr<VpnTunnelsRestStub> child,
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_COMPUTE_VPN_TUNNELS_V1_INTERNAL_VPN_TUNNELS_REST_LOGGING_DECORATOR_H
