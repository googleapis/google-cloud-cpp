...
VpnTunnelsRestMetadata::AggregatedListVpnTunnels(
    ...
    Options const& options, google::cloud::cpp::compute::vpn_tunnels::v1::AggregatedListVpnTunnelsRequest const& request) {
...
VpnTunnelsRestMetadata::ListVpnTunnels(
    rest_internal::RestContext& rest_context,
    Options const& options, google::cloud::cpp::compute::vpn_tunnels::v1::ListVpnTunnelsRequest const& request) {
  SetMetadata(rest_context, options);
...
future<Status>
VpnTunnelsRestMetadata::AsyncCancelOperation(
    google::cloud::CompletionQueue& cq,
    std::unique_ptr<rest_internal::RestContext> rest_context,
    google::cloud::internal::ImmutableOptions options,
