...
class VpnTunnelsRestConnectionImpl
 ...
 public:
  ...
  AggregatedListVpnTunnels(google::cloud::cpp::compute::vpnTunnels::v1::AggregatedListVpnTunnelsRequest const& request) override;

  StatusOr<google::cloud::cpp::compute::v1::Operation>
  DeleteVpnTunnels(google::cloud::cpp::compute::vpnTunnels::v1::DeleteVpnTunnelsRequest const& request) override;

  StatusOr<google::cloud::cpp::compute::v1::VpnTunnel>
  GetVpnTunnels(google::cloud::cpp::compute::vpnTunnels::v1::GetVpnTunnelsRequest const& request) override;

  StatusOr<google::cloud::cpp::compute::v1::Operation>
  InsertVpnTunnels(google::cloud::cpp::compute::vpnTunnels::v1::InsertVpnTunnelsRequest const& request) override;

  StreamRange<google::cloud::cpp::compute::v1::VpnTunnel>
  ListVpnTunnels(google::cloud::cpp::compute::vpnTunnels::v1::ListVpnTunnelsRequest request) override;

  StatusOr<google::cloud::cpp::compute::v1::Operation>
  SetLabels(google::cloud::cpp::compute::vpnTunnels::v1::SetLabelsRequest const& request) override;

 private:
  std::unique_ptr<compute_vpn_tunnels_v1::VpnTunnelsRetryPolicy> retry_policy() {
    auto const& options = internal::CurrentOptions();
    if (options.has<compute_vpn_tunnels_v1::VpnTunnelsRetryPolicyOption>()) {
      return options.get<compute_vpn_tunnels_v1::VpnTunnelsRetryPolicyOption>()->clone();
    }
    return options_.get<compute_vpn_tunnels_v1::VpnTunnelsRetryPolicyOption>()->clone();
  }

  std::unique_ptr<BackoffPolicy> backoff_policy() {
    auto const& options = internal::CurrentOptions();
    if (options.has<compute_vpn_tunnels_v1::VpnTunnelsBackoffPolicyOption>()) {
      return options.get<compute_vpn_tunnels_v1::VpnTunnelsBackoffPolicyOption>()->clone();
    }
    return options_.get<compute_vpn_tunnels_v1::VpnTunnelsBackoffPolicyOption>()->clone();
  }

  std::unique_ptr<compute_vpn_tunnels_v1::VpnTunnelsConnectionIdempotencyPolicy> idempotency_policy() {
    auto const& options = internal::CurrentOptions();
    if (options.has<compute_vpn_tunnels_v1::VpnTunnelsConnectionIdempotencyPolicyOption>()) {
      return options.get<compute_vpn_tunnels_v1::VpnTunnelsConnectionIdempotencyPolicyOption>()->clone();
    }
    return options_.get<compute_vpn_tunnels_v1::VpnTunnelsConnectionIdempotencyPolicyOption>()->
clone();
  }
