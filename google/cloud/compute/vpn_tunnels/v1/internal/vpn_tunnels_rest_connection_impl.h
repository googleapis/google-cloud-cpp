...
clone();
  ...
  std::unique_ptr<PollingPolicy> polling_policy() {
    ...
    if (options.has<compute_vpn_tunnels_v1::VpnTunnelsPollingPolicyOption>()) {
      return options.get<compute_vpn_tunnels_v1::VpnTunnelsPollingPolicyOption>()->clone();
    }
    return options_.get<compute_vpn_tunnels_v1::VpnTunnelsPollingPolicyOption>()->clone();
  }
