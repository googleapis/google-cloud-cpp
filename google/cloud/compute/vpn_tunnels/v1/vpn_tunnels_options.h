 ...
 */
struct VpnTunnelsRetryPolicyOption {
  using Type = std::shared_ptr<VpnTunnelsRetryPolicy>;
};
 ...
 * @ingroup google-cloud-compute-options
 */
struct VpnTunnelsBackoffPolicyOption {
 ...
 * @ingroup google-cloud-compute-options
 */
struct VpnTunnelsConnectionIdempotencyPolicyOption {
  using Type = std::shared_ptr<VpnTunnelsConnectionIdempotencyPolicy>;
};
 ...
 * @ingroup google-cloud-compute-options
 */
struct VpnTunnelsPollingPolicyOption {
  using Type = std::shared_ptr<PollingPolicy>;
};

/**
 * The options applicable to VpnTunnels.
 *
 * @ingroup google-cloud-compute-options
 */
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_COMPUTE_VPN_TUNNELS_V1_VPN_TUNNELS_OPTIONS_H
