...
VpnTunnelsConnection::DeleteVpnTunnels(google::cloud::cpp::compute::vpnTunnels::
                                           v1::DeleteVpnTunnelsRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}
...
StatusOr<google::cloud::cpp::compute::v1::Operation>
VpnTunnelsConnection::InsertVpnTunnels(google::cloud::cpp::compute::vpnTunnels::
                                           v1::InsertVpnTunnelsRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}
