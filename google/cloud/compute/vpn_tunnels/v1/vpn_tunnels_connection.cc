...
VpnTunnelsConnection::AggregatedListVpnTunnels(
    google::cloud::cpp::compute::vpnTunnels::v1::AggregatedListVpnTunnelsRequest const&) {
...
StreamRange<google::cloud::cpp::compute::v1::VpnTunnel> VpnTunnelsConnection::ListVpnTunnels(
    google::cloud::cpp::compute::vpnTunnels::v1::ListVpnTunnelsRequest) {  // NOLINT(performance-unnecessary-value-param)
