...
/**
 * A retry policy for `RegionDiskTypesConnection` that stops retrying after a
...
class RegionDiskTypesLimitedErrorCountRetryPolicy
 ...
 public:
  RegionDiskTypesLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `RegionDiskTypesConnection` that stops retrying after
...
class RegionDiskTypesConnection {
 public:
  ...
  GetRegionDiskTypes(google::cloud::cpp::compute::region_disk_types::v1::
