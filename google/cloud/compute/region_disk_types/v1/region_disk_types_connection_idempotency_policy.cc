...
Idempotency RegionDiskTypesConnectionIdempotencyPolicy::GetRegionDiskTypes(google::cloud::cpp::compute::regionDiskTypes::v1::GetRegionDiskTypesRequest const&) {
  return Idempotency::kIdempotent;
}

Idempotency RegionDiskTypesConnectionIdempotencyPolicy::ListRegionDiskTypes(google::cloud::cpp::compute::regionDiskTypes::v1::ListRegionDiskTypesRequest) {  // NOLINT
  return Idempotency::kIdempotent;
}
