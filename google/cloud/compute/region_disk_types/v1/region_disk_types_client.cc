...
RegionDiskTypesClient::GetRegionDiskTypes(std::string const& project, std::string const& region, std::string const& disk_type, Options opts) {
  ...
  google::cloud::cpp::compute::regionDiskTypes::v1::GetRegionDiskTypesRequest request;
...
StatusOr<google::cloud::cpp::compute::v1::DiskType>
RegionDiskTypesClient::GetRegionDiskTypes(google::cloud::cpp::compute::regionDiskTypes::v1::GetRegionDiskTypesRequest const& request, Options opts) {
  internal::OptionsSpan span(internal::MergeOptions(std::move(opts), options_));
  return connection_->GetRegionDiskTypes(request);
}
...
RegionDiskTypesClient::ListRegionDiskTypes(std::string const& project, std::string const& region, Options opts) {
  internal::OptionsSpan span(internal::MergeOptions(std::move(opts), options_));
  google::cloud::cpp::compute::regionDiskTypes::v1::ListRegionDiskTypesRequest request;
  request.set_project(project);
  request.set_region(region);
...
StreamRange<google::cloud::cpp::compute::v1::DiskType>
RegionDiskTypesClient::ListRegionDiskTypes(google::cloud::cpp::compute::regionDiskTypes::v1::ListRegionDiskTypesRequest request, Options opts) {
  internal::OptionsSpan span(internal::MergeOptions(std::move(opts), options_));
