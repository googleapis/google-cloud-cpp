...
std::shared_ptr<RegionDiskTypesConnection> MakeRegionDiskTypesConnectionRest(
  ...
  internal::CheckExpectedOptions<CommonOptionList, RestOptionList,
      ...
      RegionDiskTypesPolicyOptionList>(options, __func__);
  options = compute_region_disk_types_v1_internal::RegionDiskTypesDefaultOptions(
      std::move(options));
  auto background = std::make_unique<
      rest_internal::AutomaticallyCreatedRestBackgroundThreads>();
  auto stub = compute_region_disk_types_v1_internal::CreateDefaultRegionDiskTypesRestStub(
      options);
  return compute_region_disk_types_v1_internal::MakeRegionDiskTypesTracingConnection(
      std::make_shared<
          compute_region_disk_types_v1_internal::RegionDiskTypesRestConnectionImpl>(
