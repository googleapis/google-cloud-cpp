...
RegionDiskTypesTracingConnection::GetRegionDiskTypes(google::cloud::cpp::compute::regionDiskTypes::v1::GetRegionDiskTypesRequest const& request) {
  auto span = internal::MakeSpan("compute_region_disk_types_v1::RegionDiskTypesConnection::GetRegionDiskTypes");
  auto scope = opentelemetry::trace::Scope(span);
  return internal::EndSpan(*span, child_->GetRegionDiskTypes(request));
}

StreamRange<google::cloud::cpp::compute::v1::DiskType>
RegionDiskTypesTracingConnection::ListRegionDiskTypes(google::cloud::cpp::compute::regionDiskTypes::v1::ListRegionDiskTypesRequest request) {
