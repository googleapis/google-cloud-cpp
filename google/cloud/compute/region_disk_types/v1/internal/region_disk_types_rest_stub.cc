...
DefaultRegionDiskTypesRestStub::GetDiskType(
      ...
      google::cloud::cpp::compute::region_disk_types::v1::GetDiskTypeRequest const& request) {
  std::vector<std::pair<std::string, std::string>> query_params;
  return rest_internal::Get<google::cloud::cpp::compute::v1::DiskType>(
      *service_, rest_context, request, false,
      absl::StrCat("/", "compute", "/", rest_internal::DetermineApiVersion("v1", options), "/", "projects", "/", request.project(), "/", "regions", "/", request.region(), "/", "diskTypes", "/", request.disk_type()), std::move(query_params));
}
...
DefaultRegionDiskTypesRestStub::ListRegionDiskTypes(
  ...
  return rest_internal::Get<google::cloud::cpp::compute::v1::RegionDiskTypeList>(
      *service_, rest_context, request, false,
      absl::StrCat("/", "compute", "/", rest_internal::DetermineApiVersion("v1", options), "/", "projects", "/", request.project(), "/", "regions", "/", request.region(), "/", "diskTypes"), std::move(query_params));
}
