...
RegionDiskTypesRestConnectionImpl::GetDiskType(google::cloud::cpp::compute::region_disk_types::v1::GetDiskTypeRequest const& request) {
...
RegionDiskTypesRestConnectionImpl::ListRegionDiskTypes(google::cloud::cpp::compute::region_disk_types::v1::ListRegionDiskTypesRequest request) {
  ...
  return google::cloud::internal::MakePaginationRange<StreamRange<google::cloud::cpp::compute::v1::DiskType>>(
      ...
      [idempotency, function_name, stub = stub_,
       retry = std::shared_ptr<compute_region_disk_types_v1::RegionDiskTypesRetryPolicy>(retry_policy(*current)),
       backoff = std::shared_ptr<BackoffPolicy>(backoff_policy(*current))](
          Options const& options, google::cloud::cpp::compute::region_disk_types::v1::ListRegionDiskTypesRequest const& r) {
        return google::cloud::rest_internal::RestRetryLoop(
