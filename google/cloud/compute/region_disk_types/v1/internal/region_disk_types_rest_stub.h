...
class RegionDiskTypesRestStub {
 public:
  ...
  virtual StatusOr<google::cloud::cpp::compute::v1::DiskType> GetRegionDiskTypes(
      ...
      google::cloud::cpp::compute::regionDiskTypes::v1::GetRegionDiskTypesRequest const& request) = 0;

  virtual StatusOr<google::cloud::cpp::compute::v1::RegionDiskTypeList> ListRegionDiskTypes(
      google::cloud::rest_internal::RestContext& rest_context,
      google::cloud::cpp::compute::regionDiskTypes::v1::ListRegionDiskTypesRequest const& request) = 0;
};
