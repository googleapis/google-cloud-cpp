...
DiskTypesClient::DiskTypesClient(ExperimentalTag,
...
DiskTypesClient::AggregatedListDiskTypes(std::string const& project, Options opts) {
  ...
  google::cloud::cpp::compute::diskTypes::v1::AggregatedListDiskTypesRequest request;
  request.set_project(project);
  return connection_->AggregatedListDiskTypes(request);
}

StatusOr<google::cloud::cpp::compute::v1::DiskTypeAggregatedList>
DiskTypesClient::AggregatedListDiskTypes(google::cloud::cpp::compute::diskTypes::v1::AggregatedListDiskTypesRequest const& request, Options opts) {
  internal::OptionsSpan span(internal::MergeOptions(std::move(opts), options_));
  return connection_->AggregatedListDiskTypes(request);
}

StatusOr<google::cloud::cpp::compute::v1::DiskType>
DiskTypesClient::GetDiskTypes(std::string const& project, std::string const& zone, std::string const& disk_type, Options opts) {
  internal::OptionsSpan span(internal::MergeOptions(std::move(opts), options_));
  google::cloud::cpp::compute::diskTypes::v1::GetDiskTypesRequest request;
  request.set_project(project);
  request.set_zone(zone);
  request.set_disk_type(disk_type);
  return connection_->GetDiskTypes(request);
}

StatusOr<google::cloud::cpp::compute::v1::DiskType>
DiskTypesClient::GetDiskTypes(google::cloud::cpp::compute::diskTypes::v1::GetDiskTypesRequest const& request, Options opts) {
  internal::OptionsSpan span(internal::MergeOptions(std::move(opts), options_));
  return connection_->GetDiskTypes(request);
}
...
StreamRange<google::cloud::cpp::compute::v1::DiskType>
DiskTypesClient::ListDiskTypes(google::cloud::cpp::compute::diskTypes::v1::ListDiskTypesRequest request, Options opts) {
  internal::OptionsSpan span(internal::MergeOptions(std::move(opts), options_));
