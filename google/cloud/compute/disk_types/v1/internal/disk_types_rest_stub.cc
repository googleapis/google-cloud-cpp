...
DefaultDiskTypesRestStub::DefaultDiskTypesRestStub(Options options)
...
DefaultDiskTypesRestStub::AggregatedListDiskTypes(
  ...
  return rest_internal::Get<google::cloud::cpp::compute::v1::DiskTypeAggregatedList>(
      *service_, rest_context, request,
      absl::StrCat("/compute/v1/projects/", request.project(), "/aggregated/diskTypes"),
...
DefaultDiskTypesRestStub::GetDiskTypes(
      google::cloud::rest_internal::RestContext& rest_context,
      google::cloud::cpp::compute::disk_types::v1::GetDiskTypesRequest const& request) {
  return rest_internal::Get<google::cloud::cpp::compute::v1::DiskType>(
      *service_, rest_context, request,
      absl::StrCat("/compute/v1/projects/", request.project(), "/zones/", request.zone(), "/diskTypes/", request.disk_type(), ""),
...
DefaultDiskTypesRestStub::ListDiskTypes(
  ...
  return rest_internal::Get<google::cloud::cpp::compute::v1::DiskTypeList>(
      *service_, rest_context, request,
      absl::StrCat("/compute/v1/projects/", request.project(), "/zones/", request.zone(), "/diskTypes"),
      {std::make_pair("filter", request.filter()),
       std::make_pair("max_results", std::to_string(request.max_results())),
       std::make_pair("order_by", request.order_by()),
       std::make_pair("page_token", request.page_token()),
