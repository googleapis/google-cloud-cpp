...
DiskTypesTracingConnection::AggregatedListDiskTypes(google::cloud::cpp::compute::diskTypes::v1::AggregatedListDiskTypesRequest const& request) {
...
DiskTypesTracingConnection::GetDiskTypes(google::cloud::cpp::compute::diskTypes::v1::GetDiskTypesRequest const& request) {
...
DiskTypesTracingConnection::ListDiskTypes(google::cloud::cpp::compute::diskTypes::v1::ListDiskTypesRequest request) {
