...
std::shared_ptr<ReservationsRestStub> CreateDefaultReservationsRestStub(
    Options& options) {
  ...
  auto service_endpoint = internal::DetermineServiceEndpoint(
      internal::GetEnv("GOOGLE_CLOUD_CPP_RESERVATIONS_ENDPOINT"),
  ...
  std::shared_ptr<ReservationsRestStub> stub =
      std::make_shared<DefaultReservationsRestStub>(
