...
DefaultRegionCommitmentsRestStub::AggregatedListRegionCommitments(
  ...
  return rest_internal::Get<google::cloud::cpp::compute::v1::CommitmentAggregatedList>(
      *service_, rest_context, request, false,
      absl::StrCat("/", "compute", "/", rest_internal::DetermineApiVersion("v1", options), "/", "projects", "/", request.project(), "/", "aggregated", "/", "commitments"), std::move(query_params));
}
...
DefaultRegionCommitmentsRestStub::GetCommitment(
  ...
  return rest_internal::Get<google::cloud::cpp::compute::v1::Commitment>(
      *service_, rest_context, request, false,
      absl::StrCat("/", "compute", "/", rest_internal::DetermineApiVersion("v1", options), "/", "projects", "/", request.project(), "/", "regions", "/", request.region(), "/", "commitments", "/", request.commitment()), std::move(query_params));
}
  ...
  query_params = rest_internal::TrimEmptyQueryParameters(std::move(query_params));
      p.set_value(rest_internal::Post<google::cloud::cpp::compute::v1::Operation>(
          *service, *rest_context, request.commitment_resource(),
          false,
          absl::StrCat("/", "compute", "/", rest_internal::DetermineApiVersion("v1", *options), "/", "projects", "/", request.project(), "/", "regions", "/", request.region(), "/", "commitments"), std::move(query_params)));
    },
...
DefaultRegionCommitmentsRestStub::InsertCommitment(
      google::cloud::rest_internal::RestContext& rest_context,
      Options const& options,
      google::cloud::cpp::compute::region_commitments::v1::InsertCommitmentRequest const& request) {
  std::vector<std::pair<std::string, std::string>> query_params;
...
StatusOr<google::cloud::cpp::compute::v1::Operation>
DefaultRegionCommitmentsRestStub::UpdateCommitment(
      google::cloud::rest_internal::RestContext& rest_context,
      Options const& options,
      google::cloud::cpp::compute::region_commitments::v1::UpdateCommitmentRequest const& request) {
  std::vector<std::pair<std::string, std::string>> query_params;
