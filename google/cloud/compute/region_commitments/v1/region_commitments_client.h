...
class RegionCommitmentsClient {
 public:
  ...
  /// [google.cloud.cpp.compute.v1.CommitmentAggregatedList]: @googleapis_reference_link{google/cloud/compute/v1/internal/common_file_017.proto#L143}
  ///
  // clang-format on
  ...
  /// [google.cloud.cpp.compute.v1.Commitment]: @googleapis_reference_link{google/cloud/compute/v1/internal/common_file_017.proto#L31}
  ///
  // clang-format on
