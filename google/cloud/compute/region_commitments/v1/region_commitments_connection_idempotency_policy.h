...
class RegionCommitmentsConnectionIdempotencyPolicy {
 public:
  ...
  AggregatedListRegionCommitments(google::cloud::cpp::compute::regionCommitments::v1::AggregatedListRegionCommitmentsRequest const& request);

  virtual google::cloud::Idempotency
  GetRegionCommitments(google::cloud::cpp::compute::regionCommitments::v1::GetRegionCommitmentsRequest const& request);

  virtual google::cloud::Idempotency
  InsertRegionCommitments(google::cloud::cpp::compute::regionCommitments::v1::InsertRegionCommitmentsRequest const& request);

  virtual google::cloud::Idempotency
  ListRegionCommitments(google::cloud::cpp::compute::regionCommitments::v1::ListRegionCommitmentsRequest request);

  virtual google::cloud::Idempotency
  UpdateRegionCommitments(google::cloud::cpp::compute::regionCommitments::v1::UpdateRegionCommitmentsRequest const& request);
};
