...
Idempotency RegionCommitmentsConnectionIdempotencyPolicy::AggregatedListRegionCommitments(google::cloud::cpp::compute::region_commitments::v1::AggregatedListRegionCommitmentsRequest const&) {
  return Idempotency::kIdempotent;
}

Idempotency RegionCommitmentsConnectionIdempotencyPolicy::GetRegionCommitments(google::cloud::cpp::compute::region_commitments::v1::GetRegionCommitmentsRequest const&) {
  return Idempotency::kIdempotent;
}

Idempotency RegionCommitmentsConnectionIdempotencyPolicy::InsertRegionCommitments(google::cloud::cpp::compute::region_commitments::v1::InsertRegionCommitmentsRequest const&) {
...
Idempotency RegionCommitmentsConnectionIdempotencyPolicy::UpdateRegionCommitments(google::cloud::cpp::compute::region_commitments::v1::UpdateRegionCommitmentsRequest const&) {
  return Idempotency::kNonIdempotent;
}
