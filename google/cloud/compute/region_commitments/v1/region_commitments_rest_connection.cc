...
std::shared_ptr<RegionCommitmentsConnection> MakeRegionCommitmentsConnectionRest(
  ...
  auto stub = compute_region_commitments_v1_internal::CreateDefaultRegionCommitmentsRestStub(
      options);
  return compute_region_commitments_v1_internal::MakeRegionCommitmentsTracingConnection(
      std::make_shared<
          compute_region_commitments_v1_internal::RegionCommitmentsRestConnectionImpl>(
