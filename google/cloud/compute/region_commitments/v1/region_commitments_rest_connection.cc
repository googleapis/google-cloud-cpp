...
MakeRegionCommitmentsConnectionRest(Options options) {
  internal::CheckExpectedOptions<
      CommonOptionList, RestOptionList, UnifiedCredentialsOptionList,
      rest_internal::TargetApiVersionOption, RegionCommitmentsPolicyOptionList>(
      options, __func__);
  options =
  ...
  return compute_region_commitments_v1_internal::
      MakeRegionCommitmentsTracingConnection(
          std::make_shared<compute_region_commitments_v1_internal::
