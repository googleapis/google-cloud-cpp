...
using NetworkFirewallPoliciesRetryPolicy =
    ::google::cloud::internal::TraitBasedRetryPolicy<
        compute_network_firewall_policies_v1_internal::
            NetworkFirewallPoliciesRetryTraits>;

using NetworkFirewallPoliciesLimitedTimeRetryPolicy =
...
class NetworkFirewallPoliciesConnection {
 public:
  ...
  GetAssociation(google::cloud::cpp::compute::networkFirewallPolicies::v1::
  ...
  virtual StatusOr<google::cloud::cpp::compute::v1::Operation>
  RemoveAssociation(google::cloud::cpp::compute::networkFirewallPolicies::v1::
  ...
  TestIamPermissions(google::cloud::cpp::compute::networkFirewallPolicies::v1::
