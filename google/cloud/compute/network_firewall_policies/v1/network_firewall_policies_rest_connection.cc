...
std::shared_ptr<NetworkFirewallPoliciesConnection> MakeNetworkFirewallPoliciesConnectionRest(
  ...
  internal::CheckExpectedOptions<CommonOptionList, RestOptionList,
      ...
      NetworkFirewallPoliciesPolicyOptionList>(options, __func__);
  options = compute_network_firewall_policies_v1_internal::NetworkFirewallPoliciesDefaultOptions(
      std::move(options));
  auto background = std::make_unique<
      rest_internal::AutomaticallyCreatedRestBackgroundThreads>();
  auto stub = compute_network_firewall_policies_v1_internal::CreateDefaultNetworkFirewallPoliciesRestStub(
      options);
  return compute_network_firewall_policies_v1_internal::MakeNetworkFirewallPoliciesTracingConnection(
      std::make_shared<
          compute_network_firewall_policies_v1_internal::NetworkFirewallPoliciesRestConnectionImpl>(
