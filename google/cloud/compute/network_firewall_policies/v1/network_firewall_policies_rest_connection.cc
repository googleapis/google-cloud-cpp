...
MakeNetworkFirewallPoliciesConnectionRest(ExperimentalTag, Options options) {
  internal::CheckExpectedOptions<CommonOptionList, RestOptionList,
                                 UnifiedCredentialsOptionList,
                                 NetworkFirewallPoliciesPolicyOptionList>(
      options, __func__);
  options = compute_network_firewall_policies_v1_internal::
      NetworkFirewallPoliciesDefaultOptions(std::move(options));
