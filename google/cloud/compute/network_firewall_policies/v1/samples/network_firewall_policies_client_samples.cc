...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::compute_network_firewall_policies_v1::NetworkFirewallPoliciesClient(google::cloud::ExperimentalTag{},
      google::cloud::compute_network_firewall_policies_v1::MakeNetworkFirewallPoliciesConnectionRest(google::cloud::ExperimentalTag{},options));
  //! [set-client-endpoint]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::compute_network_firewall_policies_v1::NetworkFirewallPoliciesClient(google::cloud::ExperimentalTag{},
      google::cloud::compute_network_firewall_policies_v1::MakeNetworkFirewallPoliciesConnectionRest(google::cloud::ExperimentalTag{},options));
  }
  //! [with-service-account]
  (argv.at(0));
