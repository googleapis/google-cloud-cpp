...
class NetworkFirewallPoliciesRestStub {
 public:
  ...
  AsyncAddPacketMirroringRule(
      ...
      google::cloud::internal::ImmutableOptions options,
      google::cloud::cpp::compute::network_firewall_policies::v1::
          AddPacketMirroringRuleRequest const& request) = 0;
  ...
  DeleteFirewallPolicy(google::cloud::rest_internal::RestContext& rest_context,
                       ...
                       google::cloud::cpp::compute::network_firewall_policies::
                           v1::DeleteFirewallPolicyRequest const& request) = 0;
  ...
  GetPacketMirroringRule(
      ...
      Options const& options,
      google::cloud::cpp::compute::network_firewall_policies::v1::
          GetPacketMirroringRuleRequest const& request) = 0;
  ...
  InsertFirewallPolicy(google::cloud::rest_internal::RestContext& rest_context,
                       Options const& options,
                       google::cloud::cpp::compute::network_firewall_policies::
                           v1::InsertFirewallPolicyRequest const& request) = 0;
  ...
  PatchFirewallPolicy(google::cloud::rest_internal::RestContext& rest_context,
                      Options const& options,
                      google::cloud::cpp::compute::network_firewall_policies::
                          v1::PatchFirewallPolicyRequest const& request) = 0;
  ...
  AsyncPatchPacketMirroringRule(
      ...
      google::cloud::internal::ImmutableOptions options,
      google::cloud::cpp::compute::network_firewall_policies::v1::
          PatchPacketMirroringRuleRequest const& request) = 0;
  ...
  AsyncRemovePacketMirroringRule(
      ...
      google::cloud::internal::ImmutableOptions options,
      google::cloud::cpp::compute::network_firewall_policies::v1::
          RemovePacketMirroringRuleRequest const& request) = 0;
