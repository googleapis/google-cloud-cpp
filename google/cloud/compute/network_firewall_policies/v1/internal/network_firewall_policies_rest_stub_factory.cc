...
std::shared_ptr<NetworkFirewallPoliciesRestStub>
CreateDefaultNetworkFirewallPoliciesRestStub(Options& options) {
  ...
  auto service_endpoint = internal::DetermineServiceEndpoint(
      internal::GetEnv("GOOGLE_CLOUD_CPP_NETWORK_FIREWALL_POLICIES_ENDPOINT"),
  ...
  std::shared_ptr<NetworkFirewallPoliciesRestStub> stub =
      std::make_shared<DefaultNetworkFirewallPoliciesRestStub>(
