...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::compute_target_vpn_gateways_v1::TargetVpnGatewaysClient(google::cloud::ExperimentalTag{},
      google::cloud::compute_target_vpn_gateways_v1::MakeTargetVpnGatewaysConnectionRest(google::cloud::ExperimentalTag{},options));
  //! [set-client-endpoint]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::compute_target_vpn_gateways_v1::TargetVpnGatewaysClient(google::cloud::ExperimentalTag{},
      google::cloud::compute_target_vpn_gateways_v1::MakeTargetVpnGatewaysConnectionRest(google::cloud::ExperimentalTag{},options));
  }
  //! [with-service-account]
  (argv.at(0));
