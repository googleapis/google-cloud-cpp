...
class TargetVpnGatewaysClient {
 public:
  ...
  /// [google.cloud.cpp.compute.v1.TargetVpnGatewaysScopedList]: @cloud_cpp_reference_link{google/cloud/compute/v1/internal/common_137.proto#L317}
  ///
  // clang-format on
  StreamRange<
      std::pair<std::string,
  ...
  /// [google.cloud.cpp.compute.v1.TargetVpnGateway]: @cloud_cpp_reference_link{google/cloud/compute/v1/internal/common_137.proto#L27}
  ///
  // clang-format on
