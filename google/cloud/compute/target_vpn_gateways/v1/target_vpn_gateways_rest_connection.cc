...
MakeTargetVpnGatewaysConnectionRest(Options options) {
  internal::CheckExpectedOptions<
      ...
      rest_internal::TargetApiVersionOption, TargetVpnGatewaysPolicyOptionList>(
      options, __func__);
  options =
  ...
  return compute_target_vpn_gateways_v1_internal::
      MakeTargetVpnGatewaysTracingConnection(
          std::make_shared<compute_target_vpn_gateways_v1_internal::
