...
std::shared_ptr<TargetVpnGatewaysConnection> MakeTargetVpnGatewaysConnectionRest(
  ...
  auto stub = compute_target_vpn_gateways_v1_internal::CreateDefaultTargetVpnGatewaysRestStub(
      options);
  return compute_target_vpn_gateways_v1_internal::MakeTargetVpnGatewaysTracingConnection(
      std::make_shared<
          compute_target_vpn_gateways_v1_internal::TargetVpnGatewaysRestConnectionImpl>(
