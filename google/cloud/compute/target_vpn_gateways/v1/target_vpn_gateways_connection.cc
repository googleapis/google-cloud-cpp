...
TargetVpnGatewaysConnection::AggregatedListTargetVpnGateways(
    google::cloud::cpp::compute::targetVpnGateways::v1::AggregatedListTargetVpnGatewaysRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

StatusOr<google::cloud::cpp::compute::v1::Operation>
TargetVpnGatewaysConnection::DeleteTargetVpnGateways(
    google::cloud::cpp::compute::targetVpnGateways::v1::DeleteTargetVpnGatewaysRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

StatusOr<google::cloud::cpp::compute::v1::TargetVpnGateway>
TargetVpnGatewaysConnection::GetTargetVpnGateways(
    google::cloud::cpp::compute::targetVpnGateways::v1::GetTargetVpnGatewaysRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

StatusOr<google::cloud::cpp::compute::v1::Operation>
TargetVpnGatewaysConnection::InsertTargetVpnGateways(
    google::cloud::cpp::compute::targetVpnGateways::v1::InsertTargetVpnGatewaysRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

StreamRange<google::cloud::cpp::compute::v1::TargetVpnGateway> TargetVpnGatewaysConnection::ListTargetVpnGateways(
    google::cloud::cpp::compute::targetVpnGateways::v1::ListTargetVpnGatewaysRequest) {  // NOLINT(performance-unnecessary-value-param)
