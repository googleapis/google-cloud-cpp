...
MakePublicAdvertisedPrefixesConnectionRest(ExperimentalTag, Options options) {
  internal::CheckExpectedOptions<CommonOptionList, RestOptionList,
                                 UnifiedCredentialsOptionList,
                                 PublicAdvertisedPrefixesPolicyOptionList>(
      options, __func__);
  options = compute_public_advertised_prefixes_v1_internal::
      PublicAdvertisedPrefixesDefaultOptions(std::move(options));
