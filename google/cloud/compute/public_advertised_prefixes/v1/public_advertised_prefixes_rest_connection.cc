...
std::shared_ptr<PublicAdvertisedPrefixesConnection> MakePublicAdvertisedPrefixesConnectionRest(
  ...
  internal::CheckExpectedOptions<CommonOptionList, RestOptionList,
      ...
      PublicAdvertisedPrefixesPolicyOptionList>(options, __func__);
  options = compute_public_advertised_prefixes_v1_internal::PublicAdvertisedPrefixesDefaultOptions(
      std::move(options));
  auto background = std::make_unique<
      rest_internal::AutomaticallyCreatedRestBackgroundThreads>();
  auto stub = compute_public_advertised_prefixes_v1_internal::CreateDefaultPublicAdvertisedPrefixesRestStub(
      options);
  return compute_public_advertised_prefixes_v1_internal::MakePublicAdvertisedPrefixesTracingConnection(
      std::make_shared<
          compute_public_advertised_prefixes_v1_internal::PublicAdvertisedPrefixesRestConnectionImpl>(
