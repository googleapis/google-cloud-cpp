...
PublicAdvertisedPrefixesConnection::DeletePublicAdvertisedPrefixes(
    google::cloud::cpp::compute::publicAdvertisedPrefixes::v1::DeletePublicAdvertisedPrefixesRequest const&) {
...
PublicAdvertisedPrefixesConnection::GetPublicAdvertisedPrefixes(
    google::cloud::cpp::compute::publicAdvertisedPrefixes::v1::GetPublicAdvertisedPrefixesRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

StatusOr<google::cloud::cpp::compute::v1::Operation>
PublicAdvertisedPrefixesConnection::InsertPublicAdvertisedPrefixes(
    google::cloud::cpp::compute::publicAdvertisedPrefixes::v1::InsertPublicAdvertisedPrefixesRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}
...
StreamRange<google::cloud::cpp::compute::v1::PublicAdvertisedPrefix> PublicAdvertisedPrefixesConnection::ListPublicAdvertisedPrefixes(
    google::cloud::cpp::compute::publicAdvertisedPrefixes::v1::ListPublicAdvertisedPrefixesRequest) {  // NOLINT(performance-unnecessary-value-param)
...
PublicAdvertisedPrefixesConnection::PatchPublicAdvertisedPrefixes(
    google::cloud::cpp::compute::publicAdvertisedPrefixes::v1::PatchPublicAdvertisedPrefixesRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}
