...
RegionSslPoliciesConnection::DeleteRegionSslPolicies(
    google::cloud::cpp::compute::regionSslPolicies::v1::DeleteRegionSslPoliciesRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

StatusOr<google::cloud::cpp::compute::v1::SslPolicy>
RegionSslPoliciesConnection::GetRegionSslPolicies(
    google::cloud::cpp::compute::regionSslPolicies::v1::GetRegionSslPoliciesRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

StatusOr<google::cloud::cpp::compute::v1::Operation>
RegionSslPoliciesConnection::InsertRegionSslPolicies(
    google::cloud::cpp::compute::regionSslPolicies::v1::InsertRegionSslPoliciesRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

StreamRange<google::cloud::cpp::compute::v1::SslPolicy> RegionSslPoliciesConnection::ListRegionSslPolicies(
    google::cloud::cpp::compute::regionSslPolicies::v1::ListRegionSslPoliciesRequest) {  // NOLINT(performance-unnecessary-value-param)
...
RegionSslPoliciesConnection::ListAvailableFeatures(
    google::cloud::cpp::compute::regionSslPolicies::v1::ListAvailableFeaturesRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

StatusOr<google::cloud::cpp::compute::v1::Operation>
RegionSslPoliciesConnection::PatchRegionSslPolicies(
    google::cloud::cpp::compute::regionSslPolicies::v1::PatchRegionSslPoliciesRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}
