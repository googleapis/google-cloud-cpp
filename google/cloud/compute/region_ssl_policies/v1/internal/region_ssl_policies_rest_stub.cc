...
DefaultRegionSslPoliciesRestStub::AsyncDeleteRegionSslPolicy(
    CompletionQueue& cq,
...
DefaultRegionSslPoliciesRestStub::GetRegionSslPolicy(
...
future<StatusOr<google::cloud::cpp::compute::v1::Operation>>
DefaultRegionSslPoliciesRestStub::AsyncInsertRegionSslPolicy(
    CompletionQueue& cq,
    std::unique_ptr<rest_internal::RestContext> rest_context,
    google::cloud::cpp::compute::region_ssl_policies::v1::
...
future<StatusOr<google::cloud::cpp::compute::v1::Operation>>
DefaultRegionSslPoliciesRestStub::AsyncPatchRegionSslPolicy(
    CompletionQueue& cq,
    std::unique_ptr<rest_internal::RestContext> rest_context,
    google::cloud::cpp::compute::region_ssl_policies::v1::
