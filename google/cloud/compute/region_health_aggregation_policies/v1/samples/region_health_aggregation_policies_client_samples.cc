...
// clang-format off
// main-dox-marker: compute_region_health_aggregation_policies_v1::RegionHealthAggregationPoliciesClient
// lro-marker: true
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client =
      google::cloud::compute_region_health_aggregation_policies_v1::
          RegionHealthAggregationPoliciesClient(
              google::cloud::compute_region_health_aggregation_policies_v1::
                  MakeRegionHealthAggregationPoliciesConnectionRest(options));
  //! [set-client-endpoint]
}
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client =
      google::cloud::compute_region_health_aggregation_policies_v1::
          RegionHealthAggregationPoliciesClient(
              google::cloud::compute_region_health_aggregation_policies_v1::
                  MakeRegionHealthAggregationPoliciesConnectionRest(
                      *ud_options));
  //! [set-client-universe-domain]
}
...
class CustomIdempotencyPolicy
    : public google::cloud::compute_region_health_aggregation_policies_v1::
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options =
      google::cloud::Options{}
          ...
          .set<google::cloud::compute_region_health_aggregation_policies_v1::
                   RegionHealthAggregationPoliciesRetryPolicyOption>(
              google::cloud::compute_region_health_aggregation_policies_v1::
                  RegionHealthAggregationPoliciesLimitedErrorCountRetryPolicy(3)
                      .clone())
          .set<google::cloud::compute_region_health_aggregation_policies_v1::
  ...
  auto c1 = google::cloud::compute_region_health_aggregation_policies_v1::
      RegionHealthAggregationPoliciesClient(connection);
  auto c2 = google::cloud::compute_region_health_aggregation_policies_v1::
      RegionHealthAggregationPoliciesClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::compute_region_health_aggregation_policies_v1::
      RegionHealthAggregationPoliciesClient(
          connection,
          google::cloud::Options{}
              .set<
  ...
  //     .set<google::cloud::compute_region_health_aggregation_policies_v1::RegionHealthAggregationPoliciesRetryPolicyOption>(
  //       google::cloud::compute_region_health_aggregation_policies_v1::RegionHealthAggregationPoliciesLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::compute_region_health_aggregation_policies_v1::
        RegionHealthAggregationPoliciesClient(
            google::cloud::compute_region_health_aggregation_policies_v1::
                MakeRegionHealthAggregationPoliciesConnectionRest(options));
  }
