...
class TargetTcpProxiesClient {
 public:
  ...
  /// [google.cloud.cpp.compute.v1.TargetTcpProxiesScopedList]: @cloud_cpp_reference_link{google/cloud/compute/v1/internal/common_138.proto#L26}
  ///
  // clang-format on
  ...
  /// [google.cloud.cpp.compute.v1.TargetTcpProxy]: @cloud_cpp_reference_link{google/cloud/compute/v1/internal/common_139.proto#L28}
  ///
  // clang-format on
