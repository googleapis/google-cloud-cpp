...
MakeInterconnectAttachmentGroupsConnectionRest(Options options) {
  internal::CheckExpectedOptions<CommonOptionList, RestOptionList,
                                 ...
                                 InterconnectAttachmentGroupsPolicyOptionList>(
      options, __func__);
  options = compute_interconnect_attachment_groups_v1_internal::
      InterconnectAttachmentGroupsDefaultOptions(std::move(options));
  auto background = std::make_unique<
      rest_internal::AutomaticallyCreatedRestBackgroundThreads>();
  auto stub = compute_interconnect_attachment_groups_v1_internal::
      CreateDefaultInterconnectAttachmentGroupsRestStub(options);
  return compute_interconnect_attachment_groups_v1_internal::
      MakeInterconnectAttachmentGroupsTracingConnection(
          std::make_shared<compute_interconnect_attachment_groups_v1_internal::
