...
std::shared_ptr<RoutersRestStub> CreateDefaultRoutersRestStub(
    Options& options) {
  ...
  auto service_endpoint = internal::DetermineServiceEndpoint(
      internal::GetEnv("GOOGLE_CLOUD_CPP_ROUTERS_ENDPOINT"),
  ...
  std::shared_ptr<RoutersRestStub> stub =
      std::make_shared<DefaultRoutersRestStub>(std::move(stub_creation_opts));
  stub = std::make_shared<RoutersRestMetadata>(std::move(stub));
  if (internal::Contains(options.get<TracingComponentsOption>(), "rpc")) {
    GCP_LOG(INFO) << "Enabled logging for REST rpc calls";
    stub = std::make_shared<RoutersRestLogging>(
