...
// clang-format off
// main-dox-marker: compute_routers_v1::RoutersClient
// lro-marker: true
// clang-format on
namespace {
...
class CustomIdempotencyPolicy
   : public google::cloud::compute_routers_v1::RoutersConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::compute_routers_v1::RoutersConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::compute_routers_v1::RoutersConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::compute_routers_v1::RoutersRetryPolicyOption>(
      google::cloud::compute_routers_v1::RoutersLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::compute_routers_v1::RoutersBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::compute_routers_v1::MakeRoutersConnectionRest(options);
  ...
  auto c3 = google::cloud::compute_routers_v1::RoutersClient(
    connection, google::cloud::Options{}.set<google::cloud::compute_routers_v1::RoutersRetryPolicyOption>(
      google::cloud::compute_routers_v1::RoutersLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::compute_routers_v1::RoutersRetryPolicyOption>(
  //       google::cloud::compute_routers_v1::RoutersLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::compute_routers_v1::RoutersPollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::compute_routers_v1::RoutersRetryPolicyOption::Type,
            google::cloud::compute_routers_v1::RoutersBackoffPolicyOption::Type>(
