...
ForwardingRulesRestConnectionImpl::AggregatedListForwardingRules(google::cloud::cpp::compute::forwardingRules::v1::AggregatedListForwardingRulesRequest const& request) {
...
ForwardingRulesRestConnectionImpl::DeleteForwardingRules(google::cloud::cpp::compute::forwardingRules::v1::DeleteForwardingRulesRequest const& request) {
  return google::cloud::rest_internal::RestRetryLoop(
      retry_policy(), backoff_policy(),
...
ForwardingRulesRestConnectionImpl::GetForwardingRules(google::cloud::cpp::compute::forwardingRules::v1::GetForwardingRulesRequest const& request) {
  return google::cloud::rest_internal::RestRetryLoop(
      retry_policy(), backoff_policy(),
...
StatusOr<google::cloud::cpp::compute::v1::Operation>
ForwardingRulesRestConnectionImpl::InsertForwardingRules(google::cloud::cpp::compute::forwardingRules::v1::InsertForwardingRulesRequest const& request) {
  return google::cloud::rest_internal::RestRetryLoop(
      retry_policy(), backoff_policy(),
...
ForwardingRulesRestConnectionImpl::ListForwardingRules(google::cloud::cpp::compute::forwardingRules::v1::ListForwardingRulesRequest request) {
  ...
  return google::cloud::internal::MakePaginationRange<StreamRange<google::cloud::cpp::compute::v1::ForwardingRule>>(
      ...
      [stub, retry, backoff, idempotency, function_name]
        (google::cloud::cpp::compute::forwardingRules::v1::ListForwardingRulesRequest const& r) {
        return google::cloud::rest_internal::RestRetryLoop(
            retry->clone(), backoff->clone(), idempotency,
            [stub](rest_internal::RestContext& rest_context, google::cloud::cpp::compute::forwardingRules::v1::ListForwardingRulesRequest const& request) {
...
StatusOr<google::cloud::cpp::compute::v1::Operation>
ForwardingRulesRestConnectionImpl::PatchForwardingRules(google::cloud::cpp::compute::forwardingRules::v1::PatchForwardingRulesRequest const& request) {
  return google::cloud::rest_internal::RestRetryLoop(
      retry_policy(), backoff_policy(),
...
StatusOr<google::cloud::cpp::compute::v1::Operation>
ForwardingRulesRestConnectionImpl::SetLabels(google::cloud::cpp::compute::forwardingRules::v1::SetLabelsRequest const& request) {
  return google::cloud::rest_internal::RestRetryLoop(
      retry_policy(), backoff_policy(),
...
StatusOr<google::cloud::cpp::compute::v1::Operation>
ForwardingRulesRestConnectionImpl::SetTarget(google::cloud::cpp::compute::forwardingRules::v1::SetTargetRequest const& request) {
  return google::cloud::rest_internal::RestRetryLoop(
      retry_policy(), backoff_policy(),
