...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_COMPUTE_FORWARDING_RULES_V1_INTERNAL_FORWARDING_RULES_REST_LOGGING_DECORATOR_H
...
class ForwardingRulesRestLogging : public ForwardingRulesRestStub {
 public:
  ~ForwardingRulesRestLogging() override = default;
  ForwardingRulesRestLogging(std::shared_ptr<ForwardingRulesRestStub> child,
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_COMPUTE_FORWARDING_RULES_V1_INTERNAL_FORWARDING_RULES_REST_LOGGING_DECORATOR_H
