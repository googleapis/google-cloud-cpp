...
/**
 * A retry policy for `ForwardingRulesConnection` that stops retrying after a
...
class ForwardingRulesLimitedErrorCountRetryPolicy
 ...
 public:
  ForwardingRulesLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `ForwardingRulesConnection` that stops retrying after
