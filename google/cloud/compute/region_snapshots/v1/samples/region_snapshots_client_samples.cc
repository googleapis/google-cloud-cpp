...
// clang-format off
// main-dox-marker: compute_region_snapshots_v1::RegionSnapshotsClient
// lro-marker: true
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client =
      google::cloud::compute_region_snapshots_v1::RegionSnapshotsClient(
          google::cloud::compute_region_snapshots_v1::
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client =
      google::cloud::compute_region_snapshots_v1::RegionSnapshotsClient(
          google::cloud::compute_region_snapshots_v1::
              MakeRegionSnapshotsConnectionRest(*ud_options));
  //! [set-client-universe-domain]
}

//! [custom-idempotency-policy]
class CustomIdempotencyPolicy
    : public google::cloud::compute_region_snapshots_v1::
          RegionSnapshotsConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::compute_region_snapshots_v1::
                      RegionSnapshotsConnectionIdempotencyPolicy>
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
                     .set<google::cloud::compute_region_snapshots_v1::
                              RegionSnapshotsConnectionIdempotencyPolicyOption>(
                         CustomIdempotencyPolicy().clone())
                     .set<google::cloud::compute_region_snapshots_v1::
                              RegionSnapshotsRetryPolicyOption>(
                         google::cloud::compute_region_snapshots_v1::
                             RegionSnapshotsLimitedErrorCountRetryPolicy(3)
                                 .clone())
                     .set<google::cloud::compute_region_snapshots_v1::
                         ...
                         google::cloud::ExponentialBackoffPolicy(
                             ...
                             /*scaling=*/2.0)
                             .clone());
  auto connection = google::cloud::compute_region_snapshots_v1::
      MakeRegionSnapshotsConnectionRest(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::compute_region_snapshots_v1::RegionSnapshotsClient(
      connection);
  auto c2 = google::cloud::compute_region_snapshots_v1::RegionSnapshotsClient(
      connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::compute_region_snapshots_v1::RegionSnapshotsClient(
      connection,
      google::cloud::Options{}
          .set<google::cloud::compute_region_snapshots_v1::
                   RegionSnapshotsRetryPolicyOption>(
              google::cloud::compute_region_snapshots_v1::
                  RegionSnapshotsLimitedTimeRetryPolicy(std::chrono::minutes(5))
                      .clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::compute_region_snapshots_v1::RegionSnapshotsRetryPolicyOption>(
  //       google::cloud::compute_region_snapshots_v1::RegionSnapshotsLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
      ...
      google::cloud::Options{}
          .set<google::cloud::compute_region_snapshots_v1::
              ...
              google::cloud::GenericPollingPolicy<
                  google::cloud::compute_region_snapshots_v1::
                      RegionSnapshotsRetryPolicyOption::Type,
                  google::cloud::compute_region_snapshots_v1::
                      RegionSnapshotsBackoffPolicyOption::Type>(
                  google::cloud::compute_region_snapshots_v1::
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::compute_region_snapshots_v1::RegionSnapshotsClient(
        google::cloud::compute_region_snapshots_v1::
            MakeRegionSnapshotsConnectionRest(options));
  }
  //! [with-service-account]
