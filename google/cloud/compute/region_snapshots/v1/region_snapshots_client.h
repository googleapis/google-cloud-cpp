...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_COMPUTE_REGION_SNAPSHOTS_V1_REGION_SNAPSHOTS_CLIENT_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_COMPUTE_REGION_SNAPSHOTS_V1_REGION_SNAPSHOTS_CLIENT_H

#include "google/cloud/compute/region_snapshots/v1/region_snapshots_rest_connection.h"
...
class RegionSnapshotsClient {
 public:
  explicit RegionSnapshotsClient(
      std::shared_ptr<RegionSnapshotsConnection> connection, Options opts = {});
  ~RegionSnapshotsClient();

  ///@{
  /// @name Copy and move support
  RegionSnapshotsClient(RegionSnapshotsClient const&) = default;
  RegionSnapshotsClient& operator=(RegionSnapshotsClient const&) = default;
  RegionSnapshotsClient(RegionSnapshotsClient&&) = default;
  RegionSnapshotsClient& operator=(RegionSnapshotsClient&&) = default;
  ///@}

  ///@{
  /// @name Equality
  friend bool operator==(RegionSnapshotsClient const& a,
                         RegionSnapshotsClient const& b) {
  ...
  /// snapshots.
  /// https://cloud.google.com/compute/docs/reference/rest/v1/regionSnapshots/delete
  ///
  ...
  /// https://cloud.google.com/compute/docs/reference/rest/v1/regionSnapshots/get
  ///
  /// @param project  Project ID for this request.
  ...
  /// [google.cloud.cpp.compute.v1.Snapshot]: @cloud_cpp_reference_link{google/cloud/compute/v1/internal/common_148.proto#L31}
  ///
  // clang-format on
  ...
  ///     function, receive a single `request` proto message which includes all
  ///     the inputs for the RPC. In this case, the proto message is a
  ///     [google.cloud.cpp.compute.region_snapshots.v1.GetSnapshotRequest].
  ///     Proto messages are converted to C++ classes by Protobuf, using the
  ///     [Protobuf mapping rules].
  /// @param opts Optional. Override the class-level options, such as retry and
  ///     backoff policies.
  ...
  /// https://cloud.google.com/compute/docs/reference/rest/v1/regionSnapshots/getIamPolicy
  ///
  /// @param project  Project ID for this request.
  /// @param region  The name of the region for this request.
  ...
  /// in the request.
  /// https://cloud.google.com/compute/docs/reference/rest/v1/regionSnapshots/insert
  ///
  /// @param project  Project ID for this request.
  /// @param region  Name of the region for this request.
  ...
  /// https://cloud.google.com/compute/docs/reference/rest/v1/regionSnapshots/list
  ///
  /// @param project  Project ID for this request.
  /// @param region  Name of the region for this request.
  /// @param opts Optional. Override the class-level options, such as retry and
  ...
  /// https://cloud.google.com/compute/docs/reference/rest/v1/regionSnapshots/setIamPolicy
  ///
  /// @param project  Project ID for this request.
  /// @param region  The name of the region for this request.
  /// @param resource  Name or id of the resource for this request.
  ...
  /// documentation.
  /// https://cloud.google.com/compute/docs/reference/rest/v1/regionSnapshots/setLabels
  ///
  /// @param project  Project ID for this request.
  ...
  ///     function, receive a single `request` proto message which includes all
  ///     the inputs for the RPC. In this case, the proto message is a
  ///     [google.cloud.cpp.compute.region_snapshots.v1.SetLabelsRequest].
  ///     Proto messages are converted to C++ classes by Protobuf, using the
  ///     [Protobuf mapping rules].
  /// @param opts Optional. Override the class-level options, such as retry and
  ///     backoff policies.
  ...
  /// https://cloud.google.com/compute/docs/reference/rest/v1/regionSnapshots/testIamPermissions
  ///
  /// @param project  Project ID for this request.
  /// @param region  The name of the region for this request.
  /// @param resource  Name or id of the resource for this request.
  ...
  /// https://cloud.google.com/compute/docs/reference/rest/v1/regionSnapshots/updateKmsKey
  ///
  /// @param project  Project ID for this request.
  /// @param region  Name of the region for this request.
  /// @param snapshot  Name of the snapshot resource to update. Should conform to RFC1035.
  /// @param region_snapshot_update_kms_key_request_resource  The RegionSnapshotUpdateKmsKeyRequest for this request.
  /// @param opts Optional. Override the class-level options, such as retry and
  ///     backoff policies.
  /// @return A [`future`] that becomes satisfied when the LRO
  ///     ([Long Running Operation]) completes or the polling policy in effect
 ...
 private:
  std::shared_ptr<RegionSnapshotsConnection> connection_;
  Options options_;
};
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_COMPUTE_REGION_SNAPSHOTS_V1_REGION_SNAPSHOTS_CLIENT_H
