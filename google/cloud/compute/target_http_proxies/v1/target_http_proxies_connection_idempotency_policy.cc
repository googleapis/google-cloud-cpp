...
Idempotency TargetHttpProxiesConnectionIdempotencyPolicy::AggregatedListTargetHttpProxies(google::cloud::cpp::compute::target_http_proxies::v1::AggregatedListTargetHttpProxiesRequest const&) {
  return Idempotency::kIdempotent;
}

Idempotency TargetHttpProxiesConnectionIdempotencyPolicy::DeleteTargetHttpProxies(google::cloud::cpp::compute::target_http_proxies::v1::DeleteTargetHttpProxiesRequest const&) {
  return Idempotency::kNonIdempotent;
}

Idempotency TargetHttpProxiesConnectionIdempotencyPolicy::GetTargetHttpProxies(google::cloud::cpp::compute::target_http_proxies::v1::GetTargetHttpProxiesRequest const&) {
  return Idempotency::kIdempotent;
}

Idempotency TargetHttpProxiesConnectionIdempotencyPolicy::InsertTargetHttpProxies(google::cloud::cpp::compute::target_http_proxies::v1::InsertTargetHttpProxiesRequest const&) {
  return Idempotency::kNonIdempotent;
}
...
Idempotency TargetHttpProxiesConnectionIdempotencyPolicy::PatchTargetHttpProxies(google::cloud::cpp::compute::target_http_proxies::v1::PatchTargetHttpProxiesRequest const&) {
  return Idempotency::kNonIdempotent;
}
