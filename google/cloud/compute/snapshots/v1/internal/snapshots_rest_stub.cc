...
future<StatusOr<google::cloud::cpp::compute::v1::Operation>>
DefaultSnapshotsRestStub::AsyncUpdateKmsKey(
    CompletionQueue& cq,
    std::unique_ptr<rest_internal::RestContext> rest_context,
    google::cloud::internal::ImmutableOptions options,
  ...
  std::thread t{
      [](auto p, auto service, auto request, auto rest_context, auto options) {
        ...
        p.set_value(
            rest_internal::Post<google::cloud::cpp::compute::v1::Operation>(
                *service, *rest_context,
                request.snapshot_update_kms_key_request_resource(), false,
                absl::StrCat("/", "compute", "/",
                             rest_internal::DetermineApiVersion("v1", *options),
                             "/", "projects", "/", request.project(), "/",
                             "global", "/", "snapshots", "/",
...
StatusOr<google::cloud::cpp::compute::v1::Operation>
DefaultSnapshotsRestStub::UpdateKmsKey(
    google::cloud::rest_internal::RestContext& rest_context,
    Options const& options,
    google::cloud::cpp::compute::snapshots::v1::UpdateKmsKeyRequest const&
        request) {
  ...
  return rest_internal::Post<google::cloud::cpp::compute::v1::Operation>(
      *service_, rest_context,
      ...
      absl::StrCat("/", "compute", "/",
                   rest_internal::DetermineApiVersion("v1", options), "/",
                   "projects", "/", request.project(), "/", "global", "/",
                   "snapshots", "/", request.snapshot(), "/", "updateKmsKey"),
      std::move(query_params));
}
