...
class SnapshotsRestStub {
 public:
  ...
  virtual future<StatusOr<google::cloud::cpp::compute::v1::Operation>> AsyncDeleteSnapshots(
  ...
  virtual future<StatusOr<google::cloud::cpp::compute::v1::Operation>> AsyncInsertSnapshots(
      google::cloud::CompletionQueue& cq,
      std::unique_ptr<google::cloud::rest_internal::RestContext> rest_context,
...
class DefaultSnapshotsRestStub : public SnapshotsRestStub {
 public:
  ...
  future<StatusOr<google::cloud::cpp::compute::v1::Operation>> AsyncDeleteSnapshots(
      google::cloud::CompletionQueue& cq,
      std::unique_ptr<google::cloud::rest_internal::RestContext> rest_context,
  ...
  future<StatusOr<google::cloud::cpp::compute::v1::Operation>> AsyncInsertSnapshots(
      google::cloud::CompletionQueue& cq,
      std::unique_ptr<google::cloud::rest_internal::RestContext> rest_context,
