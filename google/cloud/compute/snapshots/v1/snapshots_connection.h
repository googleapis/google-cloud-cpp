...
/**
 * A retry policy for `SnapshotsConnection` that stops retrying after a
...
class SnapshotsLimitedErrorCountRetryPolicy : public SnapshotsRetryPolicy {
 public:
  SnapshotsLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `SnapshotsConnection` that stops retrying after
