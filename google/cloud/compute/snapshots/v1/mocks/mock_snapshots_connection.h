...
class MockSnapshotsConnection
 ...
 public:
  ...
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock,
  /// UpdateKmsKey(Matcher<google::cloud::cpp::compute::snapshots::v1::UpdateKmsKeyRequest
  /// const&>(_)))
  /// @endcode
  MOCK_METHOD(
      future<StatusOr<google::cloud::cpp::compute::v1::Operation>>,
  ...
  /// @code
  /// using ::testing::_;
  /// EXPECT_CALL(*mock, UpdateKmsKey(_, _))
  /// @endcode
  MOCK_METHOD(
  ...
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock,
  /// UpdateKmsKey(Matcher<google::cloud::cpp::compute::v1::Operation
  /// const&>(_)))
  /// @endcode
  MOCK_METHOD(future<StatusOr<google::cloud::cpp::compute::v1::Operation>>,
              UpdateKmsKey,
