...
MakeRegionNetworkFirewallPoliciesConnectionRest(ExperimentalTag,
  ...
  internal::CheckExpectedOptions<CommonOptionList, RestOptionList,
      ...
      options, __func__);
  options = compute_region_network_firewall_policies_v1_internal::
      RegionNetworkFirewallPoliciesDefaultOptions(std::move(options));
  auto background = std::make_unique<
      rest_internal::AutomaticallyCreatedRestBackgroundThreads>();
  auto stub = compute_region_network_firewall_policies_v1_internal::
      CreateDefaultRegionNetworkFirewallPoliciesRestStub(options);
  return std::make_shared<compute_region_network_firewall_policies_v1_internal::
