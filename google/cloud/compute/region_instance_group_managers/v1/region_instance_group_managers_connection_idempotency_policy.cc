...
Idempotency RegionInstanceGroupManagersConnectionIdempotencyPolicy::ResumeInstances(google::cloud::cpp::compute::region_instance_group_managers::v1::ResumeInstancesRequest const&) {
  return Idempotency::kNonIdempotent;
}
...
Idempotency RegionInstanceGroupManagersConnectionIdempotencyPolicy::StartInstances(google::cloud::cpp::compute::region_instance_group_managers::v1::StartInstancesRequest const&) {
  return Idempotency::kNonIdempotent;
}

Idempotency RegionInstanceGroupManagersConnectionIdempotencyPolicy::StopInstances(google::cloud::cpp::compute::region_instance_group_managers::v1::StopInstancesRequest const&) {
  return Idempotency::kNonIdempotent;
}

Idempotency RegionInstanceGroupManagersConnectionIdempotencyPolicy::SuspendInstances(google::cloud::cpp::compute::region_instance_group_managers::v1::SuspendInstancesRequest const&) {
  return Idempotency::kNonIdempotent;
}
