...
class RegionInstanceGroupManagersRetryPolicy
    : public ::google::cloud::RetryPolicy {
 public:
  /// Creates a new instance of the policy, reset to the initial state.
  virtual std::unique_ptr<RegionInstanceGroupManagersRetryPolicy> clone()
      const = 0;
};

/**
 * A retry policy for `RegionInstanceGroupManagersConnection` based on counting
 * errors.
 *
 ...
 */
class RegionInstanceGroupManagersLimitedErrorCountRetryPolicy
    : public RegionInstanceGroupManagersRetryPolicy {
 public:
  /**
   ...
   */
  explicit RegionInstanceGroupManagersLimitedErrorCountRetryPolicy(
  ...
  RegionInstanceGroupManagersLimitedErrorCountRetryPolicy(
      RegionInstanceGroupManagersLimitedErrorCountRetryPolicy const&
          rhs) noexcept
      : RegionInstanceGroupManagersLimitedErrorCountRetryPolicy(
            rhs.maximum_failures()) {}
  ...
  std::unique_ptr<RegionInstanceGroupManagersRetryPolicy> clone()
      const override {
...
/**
 * A retry policy for `RegionInstanceGroupManagersConnection` based on elapsed
 * time.
 *
 * This policy stops retrying if:
 * - An RPC returns a non-transient error.
 ...
 * - [`kUnavailable`](@ref google::cloud::StatusCode)
 */
class RegionInstanceGroupManagersLimitedTimeRetryPolicy
    : public RegionInstanceGroupManagersRetryPolicy {
 public:
  /**
  ...
  RegionInstanceGroupManagersLimitedTimeRetryPolicy(
      RegionInstanceGroupManagersLimitedTimeRetryPolicy&& rhs) noexcept
      : RegionInstanceGroupManagersLimitedTimeRetryPolicy(
            rhs.maximum_duration()) {}
  RegionInstanceGroupManagersLimitedTimeRetryPolicy(
      RegionInstanceGroupManagersLimitedTimeRetryPolicy const& rhs) noexcept
      : RegionInstanceGroupManagersLimitedTimeRetryPolicy(
            rhs.maximum_duration()) {}
...
class RegionInstanceGroupManagersConnection {
 public:
  ...
  virtual future<StatusOr<google::cloud::cpp::compute::v1::Operation>>
  AbandonInstances(google::cloud::ExperimentalTag,
  ...
  virtual future<StatusOr<google::cloud::cpp::compute::v1::Operation>>
  CreateInstances(google::cloud::ExperimentalTag,
                  google::cloud::cpp::compute::v1::Operation const& operation);
  ...
  virtual future<StatusOr<google::cloud::cpp::compute::v1::Operation>>
  DeleteInstances(google::cloud::ExperimentalTag,
                  google::cloud::cpp::compute::v1::Operation const& operation);
  ...
  virtual future<StatusOr<google::cloud::cpp::compute::v1::Operation>>
  SetTargetPools(google::cloud::ExperimentalTag,
                 google::cloud::cpp::compute::v1::Operation const& operation);
