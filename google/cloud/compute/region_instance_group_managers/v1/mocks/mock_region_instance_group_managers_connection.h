...
class MockRegionInstanceGroupManagersConnection : public compute_region_instance_group_managers_v1::RegionInstanceGroupManagersConnection {
 public:
  ...
  (google::cloud::cpp::compute::regionInstanceGroupManagers::v1::ListRegionInstanceGroupManagersRequest request), (override));

  MOCK_METHOD(StreamRange<google::cloud::cpp::compute::v1::InstanceManagedByIgmError>,
  ListErrors,
  (google::cloud::cpp::compute::regionInstanceGroupManagers::v1::ListErrorsRequest request), (override));
  ...
  (google::cloud::cpp::compute::regionInstanceGroupManagers::v1::ListPerInstanceConfigsRequest request), (override));
