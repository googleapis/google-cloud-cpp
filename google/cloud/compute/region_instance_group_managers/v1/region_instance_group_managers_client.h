...
class RegionInstanceGroupManagersClient {
 public:
  ...
  /// [google.cloud.cpp.compute.v1.RegionInstanceGroupManagersListInstancesResponse]: @cloud_cpp_reference_link{google/cloud/compute/v1/internal/common_123.proto#L405}
  ///
  // clang-format on
