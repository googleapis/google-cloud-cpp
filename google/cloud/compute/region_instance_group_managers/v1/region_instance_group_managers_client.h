...
class RegionInstanceGroupManagersClient {
 public:
  ...
  /// [google.cloud.cpp.compute.v1.RegionInstanceGroupManagersListInstancesResponse]: @cloud_cpp_reference_link{google/cloud/compute/v1/internal/common_096.proto#L335}
  ///
  // clang-format on
