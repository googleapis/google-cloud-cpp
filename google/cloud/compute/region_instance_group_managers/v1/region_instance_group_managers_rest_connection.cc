...
std::shared_ptr<RegionInstanceGroupManagersConnection> MakeRegionInstanceGroupManagersConnectionRest(
  ...
  internal::CheckExpectedOptions<CommonOptionList, RestOptionList,
      ...
      RegionInstanceGroupManagersPolicyOptionList>(options, __func__);
  options = compute_region_instance_group_managers_v1_internal::RegionInstanceGroupManagersDefaultOptions(
      std::move(options));
  auto background = std::make_unique<
      rest_internal::AutomaticallyCreatedRestBackgroundThreads>();
  auto stub = compute_region_instance_group_managers_v1_internal::CreateDefaultRegionInstanceGroupManagersRestStub(
      options);
  return compute_region_instance_group_managers_v1_internal::MakeRegionInstanceGroupManagersTracingConnection(
      std::make_shared<
          compute_region_instance_group_managers_v1_internal::RegionInstanceGroupManagersRestConnectionImpl>(
