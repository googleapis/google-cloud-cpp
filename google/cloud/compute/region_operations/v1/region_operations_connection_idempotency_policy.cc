...
Idempotency RegionOperationsConnectionIdempotencyPolicy::DeleteRegionOperations(google::cloud::cpp::compute::region_operations::v1::DeleteRegionOperationsRequest const&) {
  return Idempotency::kNonIdempotent;
}

Idempotency RegionOperationsConnectionIdempotencyPolicy::GetRegionOperations(google::cloud::cpp::compute::region_operations::v1::GetRegionOperationsRequest const&) {
