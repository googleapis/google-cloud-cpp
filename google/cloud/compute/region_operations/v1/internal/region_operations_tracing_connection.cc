...
Status
RegionOperationsTracingConnection::DeleteRegionOperations(google::cloud::cpp::compute::regionOperations::v1::DeleteRegionOperationsRequest const& request) {
  auto span = internal::MakeSpan("compute_region_operations_v1::RegionOperationsConnection::DeleteRegionOperations");
  auto scope = opentelemetry::trace::Scope(span);
  return internal::EndSpan(*span, child_->DeleteRegionOperations(request));
}

StatusOr<google::cloud::cpp::compute::v1::Operation>
RegionOperationsTracingConnection::GetRegionOperations(google::cloud::cpp::compute::regionOperations::v1::GetRegionOperationsRequest const& request) {
  auto span = internal::MakeSpan("compute_region_operations_v1::RegionOperationsConnection::GetRegionOperations");
  auto scope = opentelemetry::trace::Scope(span);
  return internal::EndSpan(*span, child_->GetRegionOperations(request));
}

StreamRange<google::cloud::cpp::compute::v1::Operation>
RegionOperationsTracingConnection::ListRegionOperations(google::cloud::cpp::compute::regionOperations::v1::ListRegionOperationsRequest request) {
...
StatusOr<google::cloud::cpp::compute::v1::Operation>
RegionOperationsTracingConnection::Wait(google::cloud::cpp::compute::regionOperations::v1::WaitRequest const& request) {
