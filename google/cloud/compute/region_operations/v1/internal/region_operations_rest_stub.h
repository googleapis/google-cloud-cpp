...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_COMPUTE_REGION_OPERATIONS_V1_INTERNAL_REGION_OPERATIONS_REST_STUB_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_COMPUTE_REGION_OPERATIONS_V1_INTERNAL_REGION_OPERATIONS_REST_STUB_H
...
class RegionOperationsRestStub {
 public:
  ...
  virtual Status DeleteRegionOperations(
      ...
      google::cloud::cpp::compute::regionOperations::v1::DeleteRegionOperationsRequest const& request) = 0;

  virtual StatusOr<google::cloud::cpp::compute::v1::Operation> GetRegionOperations(
      google::cloud::rest_internal::RestContext& rest_context,
      google::cloud::cpp::compute::regionOperations::v1::GetRegionOperationsRequest const& request) = 0;

  virtual StatusOr<google::cloud::cpp::compute::v1::OperationList> ListRegionOperations(
      google::cloud::rest_internal::RestContext& rest_context,
      google::cloud::cpp::compute::regionOperations::v1::ListRegionOperationsRequest const& request) = 0;

  virtual StatusOr<google::cloud::cpp::compute::v1::Operation> Wait(
      google::cloud::rest_internal::RestContext& rest_context,
      google::cloud::cpp::compute::regionOperations::v1::WaitRequest const& request) = 0;
};

class DefaultRegionOperationsRestStub : public RegionOperationsRestStub {
 public:
  ~DefaultRegionOperationsRestStub() override = default;
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_COMPUTE_REGION_OPERATIONS_V1_INTERNAL_REGION_OPERATIONS_REST_STUB_H
