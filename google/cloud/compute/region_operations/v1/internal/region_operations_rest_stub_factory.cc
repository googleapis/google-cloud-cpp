...
std::shared_ptr<RegionOperationsRestStub> CreateDefaultRegionOperationsRestStub(
    Options& options) {
  ...
  auto service_endpoint = internal::DetermineServiceEndpoint(
      internal::GetEnv("GOOGLE_CLOUD_CPP_REGION_OPERATIONS_ENDPOINT"),
  ...
  std::shared_ptr<RegionOperationsRestStub> stub =
      std::make_shared<DefaultRegionOperationsRestStub>(
          std::move(stub_creation_opts));
  stub = std::make_shared<RegionOperationsRestMetadata>(std::move(stub));
  if (internal::Contains(options.get<TracingComponentsOption>(), "rpc")) {
    GCP_LOG(INFO) << "Enabled logging for REST rpc calls";
    stub = std::make_shared<RegionOperationsRestLogging>(
