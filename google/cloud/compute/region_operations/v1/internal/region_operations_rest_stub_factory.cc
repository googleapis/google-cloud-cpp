...
std::shared_ptr<RegionOperationsRestStub>
CreateDefaultRegionOperationsRestStub(Options const& options) {
  auto opts = internal::PopulateRestOptions(options);
  std::shared_ptr<RegionOperationsRestStub> stub =
      std::make_shared<DefaultRegionOperationsRestStub>(std::move(opts));
