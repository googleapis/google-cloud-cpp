...
DefaultRegionOperationsRestStub::DefaultRegionOperationsRestStub(Options options)
    : service_(rest_internal::MakePooledRestClient(
          options.get<EndpointOption>(), options)),
      options_(std::move(options)) {}

DefaultRegionOperationsRestStub::DefaultRegionOperationsRestStub(
...
Status DefaultRegionOperationsRestStub::DeleteOperation(
  ...
  return rest_internal::Delete<google::cloud::rest_internal::EmptyResponseType>(
      *service_, rest_context, request, false,
      absl::StrCat("/", "compute", "/", rest_internal::DetermineApiVersion("v1", options), "/", "projects", "/", request.project(), "/", "regions", "/", request.region(), "/", "operations", "/", request.operation()), std::move(query_params));
}
...
DefaultRegionOperationsRestStub::ListRegionOperations(
      google::cloud::rest_internal::RestContext& rest_context,
      Options const& options,
      google::cloud::cpp::compute::region_operations::v1::ListRegionOperationsRequest const& request) {
  std::vector<std::pair<std::string, std::string>> query_params;
  ...
  return rest_internal::Get<google::cloud::cpp::compute::v1::OperationList>(
      *service_, rest_context, request, false,
      absl::StrCat("/", "compute", "/", rest_internal::DetermineApiVersion("v1", options), "/", "projects", "/", request.project(), "/", "regions", "/", request.region(), "/", "operations"), std::move(query_params));
}

StatusOr<google::cloud::cpp::compute::v1::Operation>
DefaultRegionOperationsRestStub::Wait(
      google::cloud::rest_internal::RestContext& rest_context,
      Options const& options,
      google::cloud::cpp::compute::region_operations::v1::WaitRequest const& request) {
  std::vector<std::pair<std::string, std::string>> query_params;
  return rest_internal::Post<google::cloud::cpp::compute::v1::Operation>(
      *service_, rest_context, request, false,
      absl::StrCat("/", "compute", "/", rest_internal::DetermineApiVersion("v1", options), "/", "projects", "/", request.project(), "/", "regions", "/", request.region(), "/", "operations", "/", request.operation(), "/", "wait"), std::move(query_params));
}
