...
RegionOperationsConnection::DeleteRegionOperations(
    google::cloud::cpp::compute::regionOperations::v1::DeleteRegionOperationsRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

StatusOr<google::cloud::cpp::compute::v1::Operation>
RegionOperationsConnection::GetRegionOperations(
    google::cloud::cpp::compute::regionOperations::v1::GetRegionOperationsRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

StreamRange<google::cloud::cpp::compute::v1::Operation> RegionOperationsConnection::ListRegionOperations(
    google::cloud::cpp::compute::regionOperations::v1::ListRegionOperationsRequest) {  // NOLINT(performance-unnecessary-value-param)
  return google::cloud::internal::MakeUnimplementedPaginationRange<
      StreamRange<google::cloud::cpp::compute::v1::Operation>>();
}

StatusOr<google::cloud::cpp::compute::v1::Operation>
RegionOperationsConnection::Wait(
