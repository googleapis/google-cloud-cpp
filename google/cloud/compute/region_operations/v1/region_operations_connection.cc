...
Status
RegionOperationsConnection::DeleteOperation(
    google::cloud::cpp::compute::region_operations::v1::DeleteOperationRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

StatusOr<google::cloud::cpp::compute::v1::Operation>
RegionOperationsConnection::GetOperation(
    google::cloud::cpp::compute::region_operations::v1::GetOperationRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}
