...
DefaultGlobalPublicDelegatedPrefixesRestStub::AsyncDeleteGlobalPublicDelegatedPrefixes(
      CompletionQueue& cq,
  ...
  std::thread t{[](auto p, auto service, auto request, auto rest_context) {
      p.set_value(rest_internal::Delete<google::cloud::cpp::compute::v1::Operation>(
          *service, *rest_context, request,
          absl::StrCat("/compute/v1/projects/", request.project(), "/global/publicDelegatedPrefixes/", request.public_delegated_prefix(), "")));
...
future<StatusOr<google::cloud::cpp::compute::v1::Operation>>
DefaultGlobalPublicDelegatedPrefixesRestStub::AsyncInsertGlobalPublicDelegatedPrefixes(
      CompletionQueue& cq,
      std::unique_ptr<rest_internal::RestContext> rest_context,
  ...
  std::thread t{[](auto p, auto service, auto request, auto rest_context) {
      p.set_value(rest_internal::Post<google::cloud::cpp::compute::v1::Operation>(
          *service, *rest_context, request.public_delegated_prefix_resource(),
          absl::StrCat("/compute/v1/projects/", request.project(), "/global/publicDelegatedPrefixes")));
  }, std::move(p), service_, request, std::move(rest_context)};
  return f.then([t = std::move(t), cq](auto f) mutable {
    cq.RunAsync([t = std::move(t)]() mutable {
      t.join();
...
future<StatusOr<google::cloud::cpp::compute::v1::Operation>>
DefaultGlobalPublicDelegatedPrefixesRestStub::AsyncPatchGlobalPublicDelegatedPrefixes(
      CompletionQueue& cq,
      std::unique_ptr<rest_internal::RestContext> rest_context,
