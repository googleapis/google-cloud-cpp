...
CreateDefaultGlobalPublicDelegatedPrefixesRestStub(Options const& options) {
  ...
  std::shared_ptr<GlobalPublicDelegatedPrefixesRestStub> stub =
      std::make_shared<DefaultGlobalPublicDelegatedPrefixesRestStub>(std::move(opts));
  stub = std::make_shared<GlobalPublicDelegatedPrefixesRestMetadata>(std::move(stub));
