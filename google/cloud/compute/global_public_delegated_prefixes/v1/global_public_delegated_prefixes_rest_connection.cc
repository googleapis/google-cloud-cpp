...
std::shared_ptr<GlobalPublicDelegatedPrefixesConnection> MakeGlobalPublicDelegatedPrefixesConnectionRest(
  ...
  internal::CheckExpectedOptions<CommonOptionList, RestOptionList,
      ...
      GlobalPublicDelegatedPrefixesPolicyOptionList>(options, __func__);
  options = compute_global_public_delegated_prefixes_v1_internal::GlobalPublicDelegatedPrefixesDefaultOptions(
      std::move(options));
  auto background = std::make_unique<
      rest_internal::AutomaticallyCreatedRestBackgroundThreads>();
  auto stub = compute_global_public_delegated_prefixes_v1_internal::CreateDefaultGlobalPublicDelegatedPrefixesRestStub(
      options);
  return compute_global_public_delegated_prefixes_v1_internal::MakeGlobalPublicDelegatedPrefixesTracingConnection(
      std::make_shared<
          compute_global_public_delegated_prefixes_v1_internal::GlobalPublicDelegatedPrefixesRestConnectionImpl>(
