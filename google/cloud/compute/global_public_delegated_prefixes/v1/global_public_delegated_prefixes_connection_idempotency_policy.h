...
class GlobalPublicDelegatedPrefixesConnectionIdempotencyPolicy {
 public:
  ...
  DeleteGlobalPublicDelegatedPrefixes(google::cloud::cpp::compute::globalPublicDelegatedPrefixes::v1::DeleteGlobalPublicDelegatedPrefixesRequest const& request);

  virtual google::cloud::Idempotency
  GetGlobalPublicDelegatedPrefixes(google::cloud::cpp::compute::globalPublicDelegatedPrefixes::v1::GetGlobalPublicDelegatedPrefixesRequest const& request);

  virtual google::cloud::Idempotency
  InsertGlobalPublicDelegatedPrefixes(google::cloud::cpp::compute::globalPublicDelegatedPrefixes::v1::InsertGlobalPublicDelegatedPrefixesRequest const& request);

  virtual google::cloud::Idempotency
  ListGlobalPublicDelegatedPrefixes(google::cloud::cpp::compute::globalPublicDelegatedPrefixes::v1::ListGlobalPublicDelegatedPrefixesRequest request);

  virtual google::cloud::Idempotency
  PatchGlobalPublicDelegatedPrefixes(google::cloud::cpp::compute::globalPublicDelegatedPrefixes::v1::PatchGlobalPublicDelegatedPrefixesRequest const& request);
};
