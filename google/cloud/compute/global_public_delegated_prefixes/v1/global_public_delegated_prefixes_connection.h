...
using GlobalPublicDelegatedPrefixesRetryPolicy = ::google::cloud::internal::TraitBasedRetryPolicy<
    compute_global_public_delegated_prefixes_v1_internal::GlobalPublicDelegatedPrefixesRetryTraits>;

using GlobalPublicDelegatedPrefixesLimitedTimeRetryPolicy = ::google::cloud::internal::LimitedTimeRetryPolicy<
    compute_global_public_delegated_prefixes_v1_internal::GlobalPublicDelegatedPrefixesRetryTraits>;
