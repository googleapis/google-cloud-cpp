...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_COMPUTE_GLOBAL_PUBLIC_DELEGATED_PREFIXES_V1_GLOBAL_PUBLIC_DELEGATED_PREFIXES_OPTIONS_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_COMPUTE_GLOBAL_PUBLIC_DELEGATED_PREFIXES_V1_GLOBAL_PUBLIC_DELEGATED_PREFIXES_OPTIONS_H
 ...
 * @ingroup google-cloud-compute-options
 */
struct GlobalPublicDelegatedPrefixesBackoffPolicyOption {
 ...
 * @ingroup google-cloud-compute-options
 */
struct GlobalPublicDelegatedPrefixesConnectionIdempotencyPolicyOption {
  using Type = std::shared_ptr<GlobalPublicDelegatedPrefixesConnectionIdempotencyPolicy>;
};
 ...
 * @ingroup google-cloud-compute-options
 */
struct GlobalPublicDelegatedPrefixesPollingPolicyOption {
 ...
 * @ingroup google-cloud-compute-options
 */
using GlobalPublicDelegatedPrefixesPolicyOptionList =
    OptionList<GlobalPublicDelegatedPrefixesRetryPolicyOption,
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_COMPUTE_GLOBAL_PUBLIC_DELEGATED_PREFIXES_V1_GLOBAL_PUBLIC_DELEGATED_PREFIXES_OPTIONS_H
