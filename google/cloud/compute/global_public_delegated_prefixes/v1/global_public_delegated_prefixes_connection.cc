...
GlobalPublicDelegatedPrefixesConnection::DeleteGlobalPublicDelegatedPrefixes(
    google::cloud::cpp::compute::globalPublicDelegatedPrefixes::v1::DeleteGlobalPublicDelegatedPrefixesRequest const&) {
...
GlobalPublicDelegatedPrefixesConnection::GetGlobalPublicDelegatedPrefixes(
    google::cloud::cpp::compute::globalPublicDelegatedPrefixes::v1::GetGlobalPublicDelegatedPrefixesRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

StatusOr<google::cloud::cpp::compute::v1::Operation>
GlobalPublicDelegatedPrefixesConnection::InsertGlobalPublicDelegatedPrefixes(
    google::cloud::cpp::compute::globalPublicDelegatedPrefixes::v1::InsertGlobalPublicDelegatedPrefixesRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}
...
StreamRange<google::cloud::cpp::compute::v1::PublicDelegatedPrefix> GlobalPublicDelegatedPrefixesConnection::ListGlobalPublicDelegatedPrefixes(
    google::cloud::cpp::compute::globalPublicDelegatedPrefixes::v1::ListGlobalPublicDelegatedPrefixesRequest) {  // NOLINT(performance-unnecessary-value-param)
...
GlobalPublicDelegatedPrefixesConnection::PatchGlobalPublicDelegatedPrefixes(
    google::cloud::cpp::compute::globalPublicDelegatedPrefixes::v1::PatchGlobalPublicDelegatedPrefixesRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}
