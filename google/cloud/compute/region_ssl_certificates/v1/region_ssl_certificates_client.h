...
class RegionSslCertificatesClient {
 public:
  explicit RegionSslCertificatesClient(
      std::shared_ptr<RegionSslCertificatesConnection> connection,
      Options opts = {});
  ...
  RegionSslCertificatesClient& operator=(RegionSslCertificatesClient const&) =
      default;
  RegionSslCertificatesClient(RegionSslCertificatesClient&&) = default;
  RegionSslCertificatesClient& operator=(RegionSslCertificatesClient&&) =
      default;
  ///@}

  ///@{
  /// @name Equality
  friend bool operator==(RegionSslCertificatesClient const& a,
                         RegionSslCertificatesClient const& b) {
  ...
  DeleteSslCertificate(std::string const& project, std::string const& region,
  ...
  /// [`StatusOr`]: @ref google::cloud::StatusOr
  /// [`Status`]: @ref google::cloud::Status
  /// [google.cloud.cpp.compute.region_ssl_certificates.v1.GetSslCertificateRequest]: @cloud_cpp_reference_link{google/cloud/compute/region_ssl_certificates/v1/region_ssl_certificates.proto#L119}
  ...
  /// [`StatusOr`]: @ref google::cloud::StatusOr
  /// [`Status`]: @ref google::cloud::Status
  /// [google.cloud.cpp.compute.region_ssl_certificates.v1.InsertSslCertificateRequest]: @cloud_cpp_reference_link{google/cloud/compute/region_ssl_certificates/v1/region_ssl_certificates.proto#L131}
  ///
  // clang-format on
  future<StatusOr<google::cloud::cpp::compute::v1::Operation>>
  InsertSslCertificate(std::string const& project, std::string const& region,
  ...
  /// [`StatusOr`]: @ref google::cloud::StatusOr
  /// [`Status`]: @ref google::cloud::Status
  /// [google.cloud.cpp.compute.region_ssl_certificates.v1.ListRegionSslCertificatesRequest]: @cloud_cpp_reference_link{google/cloud/compute/region_ssl_certificates/v1/region_ssl_certificates.proto#L162}
  /// [google.cloud.cpp.compute.v1.SslCertificate]: @cloud_cpp_reference_link{google/cloud/compute/v1/internal/common_112.proto#L36}
  ///
  // clang-format on
