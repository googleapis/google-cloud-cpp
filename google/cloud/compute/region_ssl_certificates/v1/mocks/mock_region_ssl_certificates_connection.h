 ...
 * including errors, from an object of type `RegionSslCertificatesClient`. To do so,
 * construct an object of type `RegionSslCertificatesClient` with an instance of this
 ...
 */
class MockRegionSslCertificatesConnection : public compute_region_ssl_certificates_v1::RegionSslCertificatesConnection {
 public:
  ...
  /// EXPECT_CALL(*mock, DeleteSslCertificate(Matcher<google::cloud::cpp::compute::region_ssl_certificates::v1::DeleteSslCertificateRequest const&>(_)))
  /// @endcode
  ...
  GetSslCertificate,
  (google::cloud::cpp::compute::region_ssl_certificates::v1::GetSslCertificateRequest const& request), (override));
  ...
  /// using ::testing::_;
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock, InsertSslCertificate(Matcher<google::cloud::cpp::compute::region_ssl_certificates::v1::InsertSslCertificateRequest const&>(_)))
  /// @endcode
  MOCK_METHOD(future<StatusOr<google::cloud::cpp::compute::v1::Operation>>,
  ...
  (google::cloud::cpp::compute::region_ssl_certificates::v1::ListRegionSslCertificatesRequest request), (override));
};
