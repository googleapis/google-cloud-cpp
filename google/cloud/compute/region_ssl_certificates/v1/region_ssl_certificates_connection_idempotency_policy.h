...
class RegionSslCertificatesConnectionIdempotencyPolicy {
 public:
  ...
  DeleteRegionSslCertificates(google::cloud::cpp::compute::regionSslCertificates::v1::DeleteRegionSslCertificatesRequest const& request);

  virtual google::cloud::Idempotency
  GetRegionSslCertificates(google::cloud::cpp::compute::regionSslCertificates::v1::GetRegionSslCertificatesRequest const& request);

  virtual google::cloud::Idempotency
  InsertRegionSslCertificates(google::cloud::cpp::compute::regionSslCertificates::v1::InsertRegionSslCertificatesRequest const& request);

  virtual google::cloud::Idempotency
  ListRegionSslCertificates(google::cloud::cpp::compute::regionSslCertificates::v1::ListRegionSslCertificatesRequest request);
};
