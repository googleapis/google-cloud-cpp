...
class RegionSslCertificatesConnectionIdempotencyPolicy {
 public:
  ...
  virtual std::unique_ptr<RegionSslCertificatesConnectionIdempotencyPolicy> clone() const;

  virtual google::cloud::Idempotency
  DeleteRegionSslCertificates(google::cloud::cpp::compute::region_ssl_certificates::v1::DeleteRegionSslCertificatesRequest const& request);

  virtual google::cloud::Idempotency
  GetRegionSslCertificates(google::cloud::cpp::compute::region_ssl_certificates::v1::GetRegionSslCertificatesRequest const& request);

  virtual google::cloud::Idempotency
  InsertRegionSslCertificates(google::cloud::cpp::compute::region_ssl_certificates::v1::InsertRegionSslCertificatesRequest const& request);

  virtual google::cloud::Idempotency
  ListRegionSslCertificates(google::cloud::cpp::compute::region_ssl_certificates::v1::ListRegionSslCertificatesRequest request);
};
