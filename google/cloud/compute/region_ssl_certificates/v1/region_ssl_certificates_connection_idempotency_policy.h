...
class RegionSslCertificatesConnectionIdempotencyPolicy {
 public:
  ...
  DeleteSslCertificate(google::cloud::cpp::compute::region_ssl_certificates::v1::DeleteSslCertificateRequest const& request);

  virtual google::cloud::Idempotency
  GetSslCertificate(google::cloud::cpp::compute::region_ssl_certificates::v1::GetSslCertificateRequest const& request);

  virtual google::cloud::Idempotency
  InsertSslCertificate(google::cloud::cpp::compute::region_ssl_certificates::v1::InsertSslCertificateRequest const& request);
