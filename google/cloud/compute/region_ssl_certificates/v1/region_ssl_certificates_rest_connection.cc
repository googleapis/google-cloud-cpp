...
MakeRegionSslCertificatesConnectionRest(Options options) {
  ...
  options = compute_region_ssl_certificates_v1_internal::
      RegionSslCertificatesDefaultOptions(std::move(options));
  auto background = std::make_unique<
      rest_internal::AutomaticallyCreatedRestBackgroundThreads>();
  auto stub = compute_region_ssl_certificates_v1_internal::
      CreateDefaultRegionSslCertificatesRestStub(options);
  return compute_region_ssl_certificates_v1_internal::
      MakeRegionSslCertificatesTracingConnection(
          std::make_shared<compute_region_ssl_certificates_v1_internal::
