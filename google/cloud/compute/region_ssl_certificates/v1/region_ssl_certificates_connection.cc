...
RegionSslCertificatesConnection::DeleteRegionSslCertificates(
    google::cloud::cpp::compute::regionSslCertificates::v1::DeleteRegionSslCertificatesRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

StatusOr<google::cloud::cpp::compute::v1::SslCertificate>
RegionSslCertificatesConnection::GetRegionSslCertificates(
    google::cloud::cpp::compute::regionSslCertificates::v1::GetRegionSslCertificatesRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

StatusOr<google::cloud::cpp::compute::v1::Operation>
RegionSslCertificatesConnection::InsertRegionSslCertificates(
    google::cloud::cpp::compute::regionSslCertificates::v1::InsertRegionSslCertificatesRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

StreamRange<google::cloud::cpp::compute::v1::SslCertificate> RegionSslCertificatesConnection::ListRegionSslCertificates(
    google::cloud::cpp::compute::regionSslCertificates::v1::ListRegionSslCertificatesRequest) {  // NOLINT(performance-unnecessary-value-param)
