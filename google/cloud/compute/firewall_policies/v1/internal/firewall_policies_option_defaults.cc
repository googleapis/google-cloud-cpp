...
Options FirewallPoliciesDefaultOptions(Options options) {
  ...
  if (!options.has<compute_firewall_policies_v1::FirewallPoliciesPollingPolicyOption>()) {
    options.set<compute_firewall_policies_v1::FirewallPoliciesPollingPolicyOption>(
        GenericPollingPolicy<
            compute_firewall_policies_v1::FirewallPoliciesRetryPolicyOption::Type,
            compute_firewall_policies_v1::FirewallPoliciesBackoffPolicyOption::Type>(
            options.get<compute_firewall_policies_v1::FirewallPoliciesRetryPolicyOption>()->clone(),
            options.get<compute_firewall_policies_v1::FirewallPoliciesBackoffPolicyOption>()->clone())
            .clone());
  }
