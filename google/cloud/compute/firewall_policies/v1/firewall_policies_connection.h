...
class FirewallPoliciesRetryPolicy : public ::google::cloud::RetryPolicy {
 public:
  /// Creates a new instance of the policy, reset to the initial state.
  virtual std::unique_ptr<FirewallPoliciesRetryPolicy> clone() const = 0;
};

/**
 * A retry policy for `FirewallPoliciesConnection` based on counting errors.
 *
...
class FirewallPoliciesLimitedErrorCountRetryPolicy
 ...
 public:
  ...
  std::unique_ptr<FirewallPoliciesRetryPolicy> clone() const override {
    return std::make_unique<FirewallPoliciesLimitedErrorCountRetryPolicy>(
        maximum_failures());
  }
...
/**
 * A retry policy for `FirewallPoliciesConnection` based on elapsed time.
 *
 * This policy stops retrying if:
 * - An RPC returns a non-transient error.
...
class FirewallPoliciesLimitedTimeRetryPolicy
 ...
 public:
  ...
  std::unique_ptr<FirewallPoliciesRetryPolicy> clone() const override {
    return std::make_unique<FirewallPoliciesLimitedTimeRetryPolicy>(
        maximum_duration());
  }
...
class FirewallPoliciesConnection {
 public:
  ...
  virtual future<StatusOr<google::cloud::cpp::compute::v1::Operation>>
  AddAssociation(google::cloud::ExperimentalTag,
  ...
  virtual future<StatusOr<google::cloud::cpp::compute::v1::Operation>>
  CloneRules(google::cloud::ExperimentalTag,
             google::cloud::cpp::compute::v1::Operation const& operation);
  ...
  DeleteFirewallPolicy(google::cloud::ExperimentalTag,
  ...
  virtual StatusOr<google::cloud::cpp::compute::v1::Operation>
  InsertFirewallPolicy(google::cloud::ExperimentalTag,
                       google::cloud::NoAwaitTag,
                       google::cloud::cpp::compute::firewall_policies::v1::
                           InsertFirewallPolicyRequest const& request);
  ...
  virtual StatusOr<google::cloud::cpp::compute::v1::Operation>
  PatchFirewallPolicy(google::cloud::ExperimentalTag, google::cloud::NoAwaitTag,
                      google::cloud::cpp::compute::firewall_policies::v1::
                          PatchFirewallPolicyRequest const& request);
  ...
  virtual StatusOr<google::cloud::cpp::compute::v1::Operation>
  RemoveAssociation(google::cloud::ExperimentalTag, google::cloud::NoAwaitTag,
                    google::cloud::cpp::compute::firewall_policies::v1::
                        RemoveAssociationRequest const& request);
