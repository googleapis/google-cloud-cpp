...
/**
 * A retry policy for `FirewallPoliciesConnection` that stops retrying after a
...
class FirewallPoliciesLimitedErrorCountRetryPolicy
 ...
 public:
  FirewallPoliciesLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `FirewallPoliciesConnection` that stops retrying after
