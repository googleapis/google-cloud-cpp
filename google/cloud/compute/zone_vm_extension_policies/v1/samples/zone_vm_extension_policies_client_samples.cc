...
// clang-format off
// main-dox-marker: compute_zone_vm_extension_policies_v1::ZoneVmExtensionPoliciesClient
// lro-marker: true
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::compute_zone_vm_extension_policies_v1::
      ZoneVmExtensionPoliciesClient(
          google::cloud::compute_zone_vm_extension_policies_v1::
              MakeZoneVmExtensionPoliciesConnectionRest(options));
  //! [set-client-endpoint]
}
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::compute_zone_vm_extension_policies_v1::
      ZoneVmExtensionPoliciesClient(
          google::cloud::compute_zone_vm_extension_policies_v1::
              MakeZoneVmExtensionPoliciesConnectionRest(*ud_options));
  //! [set-client-universe-domain]
}

//! [custom-idempotency-policy]
class CustomIdempotencyPolicy
    : public google::cloud::compute_zone_vm_extension_policies_v1::
          ZoneVmExtensionPoliciesConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::compute_zone_vm_extension_policies_v1::
                      ZoneVmExtensionPoliciesConnectionIdempotencyPolicy>
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options =
      google::cloud::Options{}
          .set<google::cloud::compute_zone_vm_extension_policies_v1::
                   ZoneVmExtensionPoliciesConnectionIdempotencyPolicyOption>(
              CustomIdempotencyPolicy().clone())
          .set<google::cloud::compute_zone_vm_extension_policies_v1::
                   ZoneVmExtensionPoliciesRetryPolicyOption>(
              google::cloud::compute_zone_vm_extension_policies_v1::
                  ZoneVmExtensionPoliciesLimitedErrorCountRetryPolicy(3)
                      .clone())
          .set<google::cloud::compute_zone_vm_extension_policies_v1::
              ...
              google::cloud::ExponentialBackoffPolicy(
                  ...
                  /*scaling=*/2.0)
                  .clone());
  auto connection = google::cloud::compute_zone_vm_extension_policies_v1::
      MakeZoneVmExtensionPoliciesConnectionRest(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::compute_zone_vm_extension_policies_v1::
      ZoneVmExtensionPoliciesClient(connection);
  auto c2 = google::cloud::compute_zone_vm_extension_policies_v1::
      ZoneVmExtensionPoliciesClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::compute_zone_vm_extension_policies_v1::
      ZoneVmExtensionPoliciesClient(
          connection,
          google::cloud::Options{}
              .set<google::cloud::compute_zone_vm_extension_policies_v1::
  ...
  //     .set<google::cloud::compute_zone_vm_extension_policies_v1::ZoneVmExtensionPoliciesRetryPolicyOption>(
  //       google::cloud::compute_zone_vm_extension_policies_v1::ZoneVmExtensionPoliciesLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::compute_zone_vm_extension_policies_v1::
        ZoneVmExtensionPoliciesClient(
            google::cloud::compute_zone_vm_extension_policies_v1::
                MakeZoneVmExtensionPoliciesConnectionRest(options));
  }
