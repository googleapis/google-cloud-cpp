...
/**
 * A retry policy for `TargetSslProxiesConnection` that stops retrying after a
...
class TargetSslProxiesLimitedErrorCountRetryPolicy
 ...
 public:
  TargetSslProxiesLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `TargetSslProxiesConnection` that stops retrying after
