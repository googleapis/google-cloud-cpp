...
clone();
  ...
  std::unique_ptr<PollingPolicy> polling_policy() {
    ...
    if (options.has<compute_target_ssl_proxies_v1::TargetSslProxiesPollingPolicyOption>()) {
      return options.get<compute_target_ssl_proxies_v1::TargetSslProxiesPollingPolicyOption>()->clone();
    }
    return options_.get<compute_target_ssl_proxies_v1::TargetSslProxiesPollingPolicyOption>()->clone();
  }
