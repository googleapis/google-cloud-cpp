...
std::shared_ptr<RegionUrlMapsRestStub> CreateDefaultRegionUrlMapsRestStub(
    Options& options) {
  ...
  auto service_endpoint = internal::DetermineServiceEndpoint(
      internal::GetEnv("GOOGLE_CLOUD_CPP_REGION_URL_MAPS_ENDPOINT"),
  ...
  std::shared_ptr<RegionUrlMapsRestStub> stub =
      std::make_shared<DefaultRegionUrlMapsRestStub>(
          std::move(stub_creation_opts));
  stub = std::make_shared<RegionUrlMapsRestMetadata>(std::move(stub));
  if (internal::Contains(options.get<TracingComponentsOption>(), "rpc")) {
    GCP_LOG(INFO) << "Enabled logging for REST rpc calls";
    stub = std::make_shared<RegionUrlMapsRestLogging>(
