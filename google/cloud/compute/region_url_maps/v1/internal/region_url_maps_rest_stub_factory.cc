...
std::shared_ptr<RegionUrlMapsRestStub>
CreateDefaultRegionUrlMapsRestStub(Options const& options) {
  auto opts = internal::PopulateRestOptions(options);
  std::shared_ptr<RegionUrlMapsRestStub> stub =
      std::make_shared<DefaultRegionUrlMapsRestStub>(std::move(opts));
