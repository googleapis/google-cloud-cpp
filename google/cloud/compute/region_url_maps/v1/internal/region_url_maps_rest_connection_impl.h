...
clone();
  ...
  std::unique_ptr<PollingPolicy> polling_policy() {
    ...
    if (options.has<compute_region_url_maps_v1::RegionUrlMapsPollingPolicyOption>()) {
      return options.get<compute_region_url_maps_v1::RegionUrlMapsPollingPolicyOption>()->clone();
    }
    return options_.get<compute_region_url_maps_v1::RegionUrlMapsPollingPolicyOption>()->clone();
  }
