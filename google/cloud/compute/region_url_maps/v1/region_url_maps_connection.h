...
/**
 * A retry policy for `RegionUrlMapsConnection` that stops retrying after a
...
class RegionUrlMapsLimitedErrorCountRetryPolicy
 ...
 public:
  RegionUrlMapsLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `RegionUrlMapsConnection` that stops retrying after
