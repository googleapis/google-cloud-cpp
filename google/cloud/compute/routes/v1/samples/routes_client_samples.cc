...
// clang-format off
// main-dox-marker: compute_routes_v1::RoutesClient
// lro-marker: true
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::compute_routes_v1::RoutesClient(
...
class CustomIdempotencyPolicy
   : public google::cloud::compute_routes_v1::RoutesConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::compute_routes_v1::RoutesConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::compute_routes_v1::RoutesConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::compute_routes_v1::RoutesRetryPolicyOption>(
      google::cloud::compute_routes_v1::RoutesLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::compute_routes_v1::RoutesBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::compute_routes_v1::MakeRoutesConnectionRest(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::compute_routes_v1::RoutesClient(connection);
  auto c2 = google::cloud::compute_routes_v1::RoutesClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::compute_routes_v1::RoutesClient(
    connection, google::cloud::Options{}.set<google::cloud::compute_routes_v1::RoutesRetryPolicyOption>(
      google::cloud::compute_routes_v1::RoutesLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::compute_routes_v1::RoutesRetryPolicyOption>(
  //       google::cloud::compute_routes_v1::RoutesLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::compute_routes_v1::RoutesPollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::compute_routes_v1::RoutesRetryPolicyOption::Type,
            google::cloud::compute_routes_v1::RoutesBackoffPolicyOption::Type>(
            google::cloud::compute_routes_v1::RoutesLimitedTimeRetryPolicy(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::compute_routes_v1::RoutesClient(
      google::cloud::compute_routes_v1::MakeRoutesConnectionRest(options));
  }
  //! [with-service-account]
  (argv.at(0));
