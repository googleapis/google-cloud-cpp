...
RoutesTracingConnection::DeleteRoutes(google::cloud::cpp::compute::routes::v1::DeleteRoutesRequest const& request) {
  auto span = internal::MakeSpan("compute_routes_v1::RoutesConnection::DeleteRoutes");
  auto scope = opentelemetry::trace::Scope(span);
  return internal::EndSpan(*span, child_->DeleteRoutes(request));
}
...
RoutesTracingConnection::InsertRoutes(google::cloud::cpp::compute::routes::v1::InsertRoutesRequest const& request) {
  auto span = internal::MakeSpan("compute_routes_v1::RoutesConnection::InsertRoutes");
  auto scope = opentelemetry::trace::Scope(span);
  return internal::EndSpan(*span, child_->InsertRoutes(request));
}
