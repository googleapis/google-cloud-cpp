...
class FirewallsLimitedErrorCountRetryPolicy : public FirewallsRetryPolicy {
 ...
 private:
  google::cloud::internal::LimitedErrorCountRetryPolicy<compute_firewalls_v1_internal::FirewallsRetryTraits> impl_;
};
...
class FirewallsLimitedTimeRetryPolicy : public FirewallsRetryPolicy {
 public:
  ...
  FirewallsLimitedTimeRetryPolicy(FirewallsLimitedTimeRetryPolicy&& rhs) noexcept
    : FirewallsLimitedTimeRetryPolicy(rhs.maximum_duration()) {}
  FirewallsLimitedTimeRetryPolicy(FirewallsLimitedTimeRetryPolicy const& rhs) noexcept
    : FirewallsLimitedTimeRetryPolicy(rhs.maximum_duration()) {}
 ...
 private:
  google::cloud::internal::LimitedTimeRetryPolicy<compute_firewalls_v1_internal::FirewallsRetryTraits> impl_;
};
...
class FirewallsConnection {
 public:
  ...
  DeleteFirewall(NoAwaitTag, google::cloud::cpp::compute::firewalls::v1::DeleteFirewallRequest const& request);
  ...
  virtual StatusOr<google::cloud::cpp::compute::v1::Operation>
  InsertFirewall(NoAwaitTag, google::cloud::cpp::compute::firewalls::v1::InsertFirewallRequest const& request);
  ...
  virtual StatusOr<google::cloud::cpp::compute::v1::Operation>
  PatchFirewall(NoAwaitTag, google::cloud::cpp::compute::firewalls::v1::PatchFirewallRequest const& request);
  ...
  virtual StatusOr<google::cloud::cpp::compute::v1::Operation>
  UpdateFirewall(NoAwaitTag, google::cloud::cpp::compute::firewalls::v1::UpdateFirewallRequest const& request);
