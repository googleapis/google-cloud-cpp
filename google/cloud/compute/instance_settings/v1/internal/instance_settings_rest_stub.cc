...
DefaultInstanceSettingsRestStub::DefaultInstanceSettingsRestStub(Options options)
...
DefaultInstanceSettingsRestStub::GetInstanceSettings(
  ...
  return rest_internal::Get<google::cloud::cpp::compute::v1::InstanceSettings>(
      *service_, rest_context, request, false,
      absl::StrCat("/", "compute", "/", rest_internal::DetermineApiVersion("v1", options), "/", "projects", "/", request.project(), "/", "zones", "/", request.zone(), "/", "instanceSettings"), std::move(query_params));
}
...
future<Status>
DefaultInstanceSettingsRestStub::AsyncCancelOperation(
    google::cloud::CompletionQueue& cq,
    std::unique_ptr<rest_internal::RestContext> rest_context,
    google::cloud::internal::ImmutableOptions options,
