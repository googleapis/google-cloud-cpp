...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_COMPUTE_INSTANCE_SETTINGS_V1_INTERNAL_INSTANCE_SETTINGS_REST_METADATA_DECORATOR_H
...
class InstanceSettingsRestMetadata : public InstanceSettingsRestStub {
 public:
  ~InstanceSettingsRestMetadata() override = default;
  explicit InstanceSettingsRestMetadata(
      std::shared_ptr<InstanceSettingsRestStub> child,
  ...
  google::cloud::future<StatusOr<google::cloud::cpp::compute::v1::Operation>> AsyncPatchInstanceSettings(
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_COMPUTE_INSTANCE_SETTINGS_V1_INTERNAL_INSTANCE_SETTINGS_REST_METADATA_DECORATOR_H
