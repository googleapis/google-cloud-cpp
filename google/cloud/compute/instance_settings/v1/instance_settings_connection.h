...
/**
 * A retry policy for `InstanceSettingsConnection` based on elapsed time.
 *
 * This policy stops retrying if:
 * - An RPC returns a non-transient error.
...
/**
 * The `InstanceSettingsConnection` object for `InstanceSettingsClient`.
 *
 * This interface defines virtual methods for each of the user-facing overload
 * sets in `InstanceSettingsClient`. This allows users to inject custom behavior
...
class InstanceSettingsConnection {
 public:
  virtual ~InstanceSettingsConnection() = 0;
  ...
  PatchInstanceSettings(ExperimentalTag, NoAwaitTag,
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_COMPUTE_INSTANCE_SETTINGS_V1_INSTANCE_SETTINGS_CONNECTION_H
