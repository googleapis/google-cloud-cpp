...
MakeRegionTargetHttpsProxiesConnectionRest(ExperimentalTag, Options options) {
  internal::CheckExpectedOptions<CommonOptionList, RestOptionList,
                                 UnifiedCredentialsOptionList,
                                 RegionTargetHttpsProxiesPolicyOptionList>(
      options, __func__);
  options = compute_region_target_https_proxies_v1_internal::
      RegionTargetHttpsProxiesDefaultOptions(std::move(options));
  auto background = std::make_unique<
      rest_internal::AutomaticallyCreatedRestBackgroundThreads>();
  auto stub = compute_region_target_https_proxies_v1_internal::
      CreateDefaultRegionTargetHttpsProxiesRestStub(options);
  return compute_region_target_https_proxies_v1_internal::
      MakeRegionTargetHttpsProxiesTracingConnection(
          std::make_shared<compute_region_target_https_proxies_v1_internal::
