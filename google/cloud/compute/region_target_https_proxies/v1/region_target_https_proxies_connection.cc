...
RegionTargetHttpsProxiesConnection::DeleteRegionTargetHttpsProxies(
    google::cloud::cpp::compute::regionTargetHttpsProxies::v1::DeleteRegionTargetHttpsProxiesRequest const&) {
...
RegionTargetHttpsProxiesConnection::GetRegionTargetHttpsProxies(
    google::cloud::cpp::compute::regionTargetHttpsProxies::v1::GetRegionTargetHttpsProxiesRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

StatusOr<google::cloud::cpp::compute::v1::Operation>
RegionTargetHttpsProxiesConnection::InsertRegionTargetHttpsProxies(
    google::cloud::cpp::compute::regionTargetHttpsProxies::v1::InsertRegionTargetHttpsProxiesRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

StreamRange<google::cloud::cpp::compute::v1::TargetHttpsProxy> RegionTargetHttpsProxiesConnection::ListRegionTargetHttpsProxies(
    google::cloud::cpp::compute::regionTargetHttpsProxies::v1::ListRegionTargetHttpsProxiesRequest) {  // NOLINT(performance-unnecessary-value-param)
...
RegionTargetHttpsProxiesConnection::PatchRegionTargetHttpsProxies(
    google::cloud::cpp::compute::regionTargetHttpsProxies::v1::PatchRegionTargetHttpsProxiesRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

StatusOr<google::cloud::cpp::compute::v1::Operation>
RegionTargetHttpsProxiesConnection::SetSslCertificates(
    google::cloud::cpp::compute::regionTargetHttpsProxies::v1::SetSslCertificatesRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

StatusOr<google::cloud::cpp::compute::v1::Operation>
RegionTargetHttpsProxiesConnection::SetUrlMap(
    google::cloud::cpp::compute::regionTargetHttpsProxies::v1::SetUrlMapRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}
