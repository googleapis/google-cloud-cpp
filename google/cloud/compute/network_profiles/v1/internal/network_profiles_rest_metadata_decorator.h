...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_COMPUTE_NETWORK_PROFILES_V1_INTERNAL_NETWORK_PROFILES_REST_METADATA_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_COMPUTE_NETWORK_PROFILES_V1_INTERNAL_NETWORK_PROFILES_REST_METADATA_DECORATOR_H
...
class NetworkProfilesRestMetadata : public NetworkProfilesRestStub {
 public:
  ~NetworkProfilesRestMetadata() override = default;
  explicit NetworkProfilesRestMetadata(
      std::shared_ptr<NetworkProfilesRestStub> child,
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_COMPUTE_NETWORK_PROFILES_V1_INTERNAL_NETWORK_PROFILES_REST_METADATA_DECORATOR_H
