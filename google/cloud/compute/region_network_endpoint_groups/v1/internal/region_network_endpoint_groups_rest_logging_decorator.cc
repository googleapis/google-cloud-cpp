...
RegionNetworkEndpointGroupsRestLogging::AsyncAttachNetworkEndpoints(
      CompletionQueue& cq,
...
RegionNetworkEndpointGroupsRestLogging::AttachNetworkEndpoints(
...
StatusOr<google::cloud::cpp::compute::v1::Operation>
RegionNetworkEndpointGroupsRestLogging::DeleteNetworkEndpointGroup(
    rest_internal::RestContext& rest_context,
    Options const& options,
    google::cloud::cpp::compute::region_network_endpoint_groups::v1::DeleteNetworkEndpointGroupRequest const& request) {
  return google::cloud::internal::LogWrapper(
...
future<StatusOr<google::cloud::cpp::compute::v1::Operation>>
RegionNetworkEndpointGroupsRestLogging::AsyncDetachNetworkEndpoints(
      CompletionQueue& cq,
      std::unique_ptr<rest_internal::RestContext> rest_context,
      google::cloud::internal::ImmutableOptions options,
...
StatusOr<google::cloud::cpp::compute::v1::Operation>
RegionNetworkEndpointGroupsRestLogging::DetachNetworkEndpoints(
    rest_internal::RestContext& rest_context,
    Options const& options,
    google::cloud::cpp::compute::region_network_endpoint_groups::v1::DetachNetworkEndpointsRequest const& request) {
  return google::cloud::internal::LogWrapper(
...
StatusOr<google::cloud::cpp::compute::v1::Operation>
RegionNetworkEndpointGroupsRestLogging::InsertNetworkEndpointGroup(
    rest_internal::RestContext& rest_context,
    Options const& options,
    google::cloud::cpp::compute::region_network_endpoint_groups::v1::InsertNetworkEndpointGroupRequest const& request) {
  return google::cloud::internal::LogWrapper(
...
RegionNetworkEndpointGroupsRestLogging::ListNetworkEndpoints(
    rest_internal::RestContext& rest_context,
    Options const& options,
