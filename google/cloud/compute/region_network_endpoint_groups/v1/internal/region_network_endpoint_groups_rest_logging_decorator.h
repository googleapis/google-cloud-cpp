...
class RegionNetworkEndpointGroupsRestLogging : public RegionNetworkEndpointGroupsRestStub {
 public:
  ...
  future<StatusOr<google::cloud::cpp::compute::v1::Operation>> AsyncDeleteRegionNetworkEndpointGroups(
  ...
  future<StatusOr<google::cloud::cpp::compute::v1::Operation>> AsyncInsertRegionNetworkEndpointGroups(
      google::cloud::CompletionQueue& cq,
      std::unique_ptr<google::cloud::rest_internal::RestContext> rest_context,
