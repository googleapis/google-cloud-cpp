...
RegionNetworkEndpointGroupsRestConnectionImpl::ListRegionNetworkEndpointGroups(
  ...
  auto retry =
      std::shared_ptr<compute_region_network_endpoint_groups_v1::
                          RegionNetworkEndpointGroupsRetryPolicy const>(
          retry_policy());
  auto backoff = std::shared_ptr<BackoffPolicy const>(backoff_policy());
  auto idempotency =
      idempotency_policy()->ListRegionNetworkEndpointGroups(request);
  char const* function_name = __func__;
  return google::cloud::internal::MakePaginationRange<
      StreamRange<google::cloud::cpp::compute::v1::NetworkEndpointGroup>>(
      std::move(request),
      [stub, retry, backoff, idempotency,
       function_name](google::cloud::cpp::compute::regionNetworkEndpointGroups::
                          v1::ListRegionNetworkEndpointGroupsRequest const& r) {
        return google::cloud::rest_internal::RestRetryLoop(
