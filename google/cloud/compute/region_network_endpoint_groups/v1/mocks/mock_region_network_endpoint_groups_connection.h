...
class MockRegionNetworkEndpointGroupsConnection
 ...
 public:
  ...
  /// EXPECT_CALL(*mock,
  /// AttachNetworkEndpoints(Matcher<google::cloud::cpp::compute::region_network_endpoint_groups::v1::AttachNetworkEndpointsRequest
  /// const&>(_)))
  /// @endcode
  ...
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock,
  /// DeleteNetworkEndpointGroup(Matcher<google::cloud::cpp::compute::region_network_endpoint_groups::v1::DeleteNetworkEndpointGroupRequest
  /// const&>(_)))
  /// @endcode
  MOCK_METHOD(future<StatusOr<google::cloud::cpp::compute::v1::Operation>>,
  ...
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock,
  /// DetachNetworkEndpoints(Matcher<google::cloud::cpp::compute::region_network_endpoint_groups::v1::DetachNetworkEndpointsRequest
  /// const&>(_)))
  /// @endcode
  MOCK_METHOD(future<StatusOr<google::cloud::cpp::compute::v1::Operation>>,
  ...
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock,
  /// InsertNetworkEndpointGroup(Matcher<google::cloud::cpp::compute::region_network_endpoint_groups::v1::InsertNetworkEndpointGroupRequest
  /// const&>(_)))
  /// @endcode
  MOCK_METHOD(future<StatusOr<google::cloud::cpp::compute::v1::Operation>>,
