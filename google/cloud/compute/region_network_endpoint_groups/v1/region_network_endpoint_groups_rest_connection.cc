...
MakeRegionNetworkEndpointGroupsConnectionRest(Options options) {
  internal::CheckExpectedOptions<CommonOptionList, RestOptionList,
                                 UnifiedCredentialsOptionList,
                                 rest_internal::TargetApiVersionOption,
                                 RegionNetworkEndpointGroupsPolicyOptionList>(
      options, __func__);
  options = compute_region_network_endpoint_groups_v1_internal::
      RegionNetworkEndpointGroupsDefaultOptions(std::move(options));
