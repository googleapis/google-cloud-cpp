...
std::shared_ptr<RegionNetworkEndpointGroupsConnection> MakeRegionNetworkEndpointGroupsConnectionRest(
    Options options) {
  internal::CheckExpectedOptions<CommonOptionList, RestOptionList,
      UnifiedCredentialsOptionList, rest_internal::TargetApiVersionOption,
      RegionNetworkEndpointGroupsPolicyOptionList>(options, __func__);
  options = compute_region_network_endpoint_groups_v1_internal::RegionNetworkEndpointGroupsDefaultOptions(
      std::move(options));
  auto background = std::make_unique<
      rest_internal::AutomaticallyCreatedRestBackgroundThreads>();
  auto stub = compute_region_network_endpoint_groups_v1_internal::CreateDefaultRegionNetworkEndpointGroupsRestStub(
      options);
  return compute_region_network_endpoint_groups_v1_internal::MakeRegionNetworkEndpointGroupsTracingConnection(
      std::make_shared<
          compute_region_network_endpoint_groups_v1_internal::RegionNetworkEndpointGroupsRestConnectionImpl>(
