...
RegionNetworkEndpointGroupsConnection::DeleteRegionNetworkEndpointGroups(
    google::cloud::cpp::compute::regionNetworkEndpointGroups::v1::DeleteRegionNetworkEndpointGroupsRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

StatusOr<google::cloud::cpp::compute::v1::NetworkEndpointGroup>
RegionNetworkEndpointGroupsConnection::GetRegionNetworkEndpointGroups(
    google::cloud::cpp::compute::regionNetworkEndpointGroups::v1::GetRegionNetworkEndpointGroupsRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

StatusOr<google::cloud::cpp::compute::v1::Operation>
RegionNetworkEndpointGroupsConnection::InsertRegionNetworkEndpointGroups(
    google::cloud::cpp::compute::regionNetworkEndpointGroups::v1::InsertRegionNetworkEndpointGroupsRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}
...
StreamRange<google::cloud::cpp::compute::v1::NetworkEndpointGroup> RegionNetworkEndpointGroupsConnection::ListRegionNetworkEndpointGroups(
    google::cloud::cpp::compute::regionNetworkEndpointGroups::v1::ListRegionNetworkEndpointGroupsRequest) {  // NOLINT(performance-unnecessary-value-param)
