...
AutoscalersRestMetadata::DeleteAutoscalers(
    rest_internal::RestContext& rest_context,
    google::cloud::cpp::compute::autoscalers::v1::
...
StatusOr<google::cloud::cpp::compute::v1::Operation>
AutoscalersRestMetadata::InsertAutoscalers(
    rest_internal::RestContext& rest_context,
    google::cloud::cpp::compute::autoscalers::v1::
...
StatusOr<google::cloud::cpp::compute::v1::Operation>
AutoscalersRestMetadata::PatchAutoscalers(
    rest_internal::RestContext& rest_context,
...
StatusOr<google::cloud::cpp::compute::v1::Operation>
AutoscalersRestMetadata::UpdateAutoscalers(
    rest_internal::RestContext& rest_context,
    google::cloud::cpp::compute::autoscalers::v1::
