...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_COMPUTE_AUTOSCALERS_V1_INTERNAL_AUTOSCALERS_REST_LOGGING_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_COMPUTE_AUTOSCALERS_V1_INTERNAL_AUTOSCALERS_REST_LOGGING_DECORATOR_H
...
class AutoscalersRestLogging : public AutoscalersRestStub {
 public:
  ~AutoscalersRestLogging() override = default;
  AutoscalersRestLogging(std::shared_ptr<AutoscalersRestStub> child,
  ...
  future<StatusOr<google::cloud::cpp::compute::v1::Operation>> AsyncDeleteAutoscalers(
  ...
  future<StatusOr<google::cloud::cpp::compute::v1::Operation>> AsyncInsertAutoscalers(
      google::cloud::CompletionQueue& cq,
      std::unique_ptr<google::cloud::rest_internal::RestContext> rest_context,
  ...
  future<StatusOr<google::cloud::cpp::compute::v1::Operation>> AsyncPatchAutoscalers(
      google::cloud::CompletionQueue& cq,
      std::unique_ptr<google::cloud::rest_internal::RestContext> rest_context,
      google::cloud::cpp::compute::autoscalers::v1::PatchAutoscalersRequest const& request) override;

  future<StatusOr<google::cloud::cpp::compute::v1::Operation>> AsyncUpdateAutoscalers(
      google::cloud::CompletionQueue& cq,
      std::unique_ptr<google::cloud::rest_internal::RestContext> rest_context,
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_COMPUTE_AUTOSCALERS_V1_INTERNAL_AUTOSCALERS_REST_LOGGING_DECORATOR_H
