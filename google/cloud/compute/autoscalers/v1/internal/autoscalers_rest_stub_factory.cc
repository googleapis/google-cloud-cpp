...
std::shared_ptr<AutoscalersRestStub> CreateDefaultAutoscalersRestStub(
    Options& options) {
  ...
  auto service_endpoint = internal::DetermineServiceEndpoint(
      internal::GetEnv("GOOGLE_CLOUD_CPP_AUTOSCALERS_ENDPOINT"),
  ...
  std::shared_ptr<AutoscalersRestStub> stub =
      std::make_shared<DefaultAutoscalersRestStub>(
          std::move(stub_creation_opts));
  stub = std::make_shared<AutoscalersRestMetadata>(std::move(stub));
  if (internal::Contains(options.get<TracingComponentsOption>(), "rpc")) {
    GCP_LOG(INFO) << "Enabled logging for REST rpc calls";
    stub = std::make_shared<AutoscalersRestLogging>(
