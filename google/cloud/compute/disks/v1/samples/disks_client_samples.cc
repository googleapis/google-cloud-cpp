...
// clang-format off
// main-dox-marker: compute_disks_v1::DisksClient
// lro-marker: true
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::compute_disks_v1::DisksClient(
...
class CustomIdempotencyPolicy
   : public google::cloud::compute_disks_v1::DisksConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::compute_disks_v1::DisksConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::compute_disks_v1::DisksConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::compute_disks_v1::DisksRetryPolicyOption>(
      google::cloud::compute_disks_v1::DisksLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::compute_disks_v1::DisksBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::compute_disks_v1::MakeDisksConnectionRest(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::compute_disks_v1::DisksClient(connection);
  auto c2 = google::cloud::compute_disks_v1::DisksClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::compute_disks_v1::DisksClient(
    connection, google::cloud::Options{}.set<google::cloud::compute_disks_v1::DisksRetryPolicyOption>(
      google::cloud::compute_disks_v1::DisksLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::compute_disks_v1::DisksRetryPolicyOption>(
  //       google::cloud::compute_disks_v1::DisksLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::compute_disks_v1::DisksPollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::compute_disks_v1::DisksRetryPolicyOption::Type,
            google::cloud::compute_disks_v1::DisksBackoffPolicyOption::Type>(
            google::cloud::compute_disks_v1::DisksLimitedTimeRetryPolicy(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::compute_disks_v1::DisksClient(
      google::cloud::compute_disks_v1::MakeDisksConnectionRest(options));
  }
  //! [with-service-account]
  (argv.at(0));
