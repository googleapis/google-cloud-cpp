...
class MockDisksConnection : public compute_disks_v1::DisksConnection {
 public:
  ...
  MOCK_METHOD(StatusOr<google::cloud::cpp::compute::v1::Operation>, DeleteDisks,
  ...
  MOCK_METHOD(StatusOr<google::cloud::cpp::compute::v1::Operation>, InsertDisks,
  ...
  MOCK_METHOD(StatusOr<google::cloud::cpp::compute::v1::Operation>, UpdateDisks,
