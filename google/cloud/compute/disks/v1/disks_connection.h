...
/**
 * A retry policy for `DisksConnection` that stops retrying after a
...
class DisksLimitedErrorCountRetryPolicy : public DisksRetryPolicy {
 public:
  DisksLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `DisksConnection` that stops retrying after
