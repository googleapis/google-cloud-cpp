...
std::shared_ptr<SecurityPoliciesRestStub>
CreateDefaultSecurityPoliciesRestStub(Options const& options) {
  auto opts = internal::PopulateRestOptions(options);
  std::shared_ptr<SecurityPoliciesRestStub> stub =
      std::make_shared<DefaultSecurityPoliciesRestStub>(std::move(opts));
