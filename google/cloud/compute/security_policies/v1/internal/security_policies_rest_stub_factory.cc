...
std::shared_ptr<SecurityPoliciesRestStub> CreateDefaultSecurityPoliciesRestStub(
  ...
  auto service_endpoint = internal::DetermineServiceEndpoint(
      internal::GetEnv("GOOGLE_CLOUD_CPP_SECURITY_POLICIES_ENDPOINT"),
  ...
  std::shared_ptr<SecurityPoliciesRestStub> stub =
      std::make_shared<DefaultSecurityPoliciesRestStub>(
          std::move(stub_creation_opts));
  stub = std::make_shared<SecurityPoliciesRestMetadata>(std::move(stub));
  if (internal::Contains(options.get<TracingComponentsOption>(), "rpc")) {
    GCP_LOG(INFO) << "Enabled logging for REST rpc calls";
    stub = std::make_shared<SecurityPoliciesRestLogging>(
