...
class SecurityPoliciesClient {
 public:
  ...
  /// [google.cloud.cpp.compute.v1.SecurityPoliciesScopedList]: @cloud_cpp_reference_link{google/cloud/compute/v1/internal/common_089.proto#L149}
  ///
  // clang-format on
  ...
  /// [google.cloud.cpp.compute.v1.SecurityPoliciesListPreconfiguredExpressionSetsResponse]: @cloud_cpp_reference_link{google/cloud/compute/v1/internal/common_089.proto#L144}
  ///
  // clang-format on
