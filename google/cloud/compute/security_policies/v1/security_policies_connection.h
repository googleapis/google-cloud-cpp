...
/**
 * A retry policy for `SecurityPoliciesConnection` that stops retrying after a
...
class SecurityPoliciesLimitedErrorCountRetryPolicy
 ...
 public:
  SecurityPoliciesLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `SecurityPoliciesConnection` that stops retrying after
