...
std::shared_ptr<InterconnectsRestStub>
CreateDefaultInterconnectsRestStub(Options const& options) {
  auto opts = internal::PopulateRestOptions(options);
  std::shared_ptr<InterconnectsRestStub> stub =
      std::make_shared<DefaultInterconnectsRestStub>(std::move(opts));
