...
class ExternalVpnGatewaysConnectionIdempotencyPolicy {
 public:
  ...
  virtual std::unique_ptr<ExternalVpnGatewaysConnectionIdempotencyPolicy> clone() const;

  virtual google::cloud::Idempotency
  DeleteExternalVpnGateways(google::cloud::cpp::compute::external_vpn_gateways::v1::DeleteExternalVpnGatewaysRequest const& request);

  virtual google::cloud::Idempotency
  GetExternalVpnGateways(google::cloud::cpp::compute::external_vpn_gateways::v1::GetExternalVpnGatewaysRequest const& request);

  virtual google::cloud::Idempotency
  InsertExternalVpnGateways(google::cloud::cpp::compute::external_vpn_gateways::v1::InsertExternalVpnGatewaysRequest const& request);

  virtual google::cloud::Idempotency
  ListExternalVpnGateways(google::cloud::cpp::compute::external_vpn_gateways::v1::ListExternalVpnGatewaysRequest request);

  virtual google::cloud::Idempotency
  SetLabels(google::cloud::cpp::compute::external_vpn_gateways::v1::SetLabelsRequest const& request);

  virtual google::cloud::Idempotency
  TestIamPermissions(google::cloud::cpp::compute::external_vpn_gateways::v1::TestIamPermissionsRequest const& request);
};
