...
class ExternalVpnGatewaysConnectionIdempotencyPolicy {
 public:
  ...
  DeleteExternalVpnGateway(google::cloud::cpp::compute::external_vpn_gateways::v1::DeleteExternalVpnGatewayRequest const& request);

  virtual google::cloud::Idempotency
  GetExternalVpnGateway(google::cloud::cpp::compute::external_vpn_gateways::v1::GetExternalVpnGatewayRequest const& request);

  virtual google::cloud::Idempotency
  InsertExternalVpnGateway(google::cloud::cpp::compute::external_vpn_gateways::v1::InsertExternalVpnGatewayRequest const& request);
