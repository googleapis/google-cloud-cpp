...
std::shared_ptr<ExternalVpnGatewaysConnection> MakeExternalVpnGatewaysConnectionRest(
  ...
  internal::CheckExpectedOptions<CommonOptionList, RestOptionList,
      ...
      ExternalVpnGatewaysPolicyOptionList>(options, __func__);
  options = compute_external_vpn_gateways_v1_internal::ExternalVpnGatewaysDefaultOptions(
      std::move(options));
  auto background = std::make_unique<
      rest_internal::AutomaticallyCreatedRestBackgroundThreads>();
  auto stub = compute_external_vpn_gateways_v1_internal::CreateDefaultExternalVpnGatewaysRestStub(
      options);
  return compute_external_vpn_gateways_v1_internal::MakeExternalVpnGatewaysTracingConnection(
      std::make_shared<
          compute_external_vpn_gateways_v1_internal::ExternalVpnGatewaysRestConnectionImpl>(
