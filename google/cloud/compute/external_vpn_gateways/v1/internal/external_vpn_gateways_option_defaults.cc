...
Options ExternalVpnGatewaysDefaultOptions(Options options) {
  ...
  if (!options.has<compute_external_vpn_gateways_v1::ExternalVpnGatewaysRetryPolicyOption>()) {
    options.set<compute_external_vpn_gateways_v1::ExternalVpnGatewaysRetryPolicyOption>(
        compute_external_vpn_gateways_v1::ExternalVpnGatewaysLimitedTimeRetryPolicy(
            std::chrono::minutes(30)).clone());
  }
  if (!options.has<compute_external_vpn_gateways_v1::ExternalVpnGatewaysBackoffPolicyOption>()) {
    options.set<compute_external_vpn_gateways_v1::ExternalVpnGatewaysBackoffPolicyOption>(
        ExponentialBackoffPolicy(std::chrono::seconds(1),
            std::chrono::minutes(5), kBackoffScaling).clone());
  }
  if (!options.has<compute_external_vpn_gateways_v1::ExternalVpnGatewaysPollingPolicyOption>()) {
    options.set<compute_external_vpn_gateways_v1::ExternalVpnGatewaysPollingPolicyOption>(
        GenericPollingPolicy<
            compute_external_vpn_gateways_v1::ExternalVpnGatewaysRetryPolicyOption::Type,
            compute_external_vpn_gateways_v1::ExternalVpnGatewaysBackoffPolicyOption::Type>(
            options.get<compute_external_vpn_gateways_v1::ExternalVpnGatewaysRetryPolicyOption>()->clone(),
            options.get<compute_external_vpn_gateways_v1::ExternalVpnGatewaysBackoffPolicyOption>()->clone())
            .clone());
  }
  if (!options.has<compute_external_vpn_gateways_v1::ExternalVpnGatewaysConnectionIdempotencyPolicyOption>()) {
    options.set<compute_external_vpn_gateways_v1::ExternalVpnGatewaysConnectionIdempotencyPolicyOption>(
        compute_external_vpn_gateways_v1::MakeDefaultExternalVpnGatewaysConnectionIdempotencyPolicy());
  }
