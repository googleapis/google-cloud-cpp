...
ExternalVpnGatewaysTracingConnection::DeleteExternalVpnGateways(google::cloud::cpp::compute::externalVpnGateways::v1::DeleteExternalVpnGatewaysRequest const& request) {
  auto span = internal::MakeSpan("compute_external_vpn_gateways_v1::ExternalVpnGatewaysConnection::DeleteExternalVpnGateways");
  auto scope = opentelemetry::trace::Scope(span);
  return internal::EndSpan(*span, child_->DeleteExternalVpnGateways(request));
}

StatusOr<google::cloud::cpp::compute::v1::ExternalVpnGateway>
ExternalVpnGatewaysTracingConnection::GetExternalVpnGateways(google::cloud::cpp::compute::externalVpnGateways::v1::GetExternalVpnGatewaysRequest const& request) {
...
StatusOr<google::cloud::cpp::compute::v1::Operation>
ExternalVpnGatewaysTracingConnection::InsertExternalVpnGateways(google::cloud::cpp::compute::externalVpnGateways::v1::InsertExternalVpnGatewaysRequest const& request) {
  auto span = internal::MakeSpan("compute_external_vpn_gateways_v1::ExternalVpnGatewaysConnection::InsertExternalVpnGateways");
  auto scope = opentelemetry::trace::Scope(span);
  return internal::EndSpan(*span, child_->InsertExternalVpnGateways(request));
}

StreamRange<google::cloud::cpp::compute::v1::ExternalVpnGateway>
ExternalVpnGatewaysTracingConnection::ListExternalVpnGateways(google::cloud::cpp::compute::externalVpnGateways::v1::ListExternalVpnGatewaysRequest request) {
...
StatusOr<google::cloud::cpp::compute::v1::Operation>
ExternalVpnGatewaysTracingConnection::SetLabels(google::cloud::cpp::compute::externalVpnGateways::v1::SetLabelsRequest const& request) {
  auto span = internal::MakeSpan("compute_external_vpn_gateways_v1::ExternalVpnGatewaysConnection::SetLabels");
  auto scope = opentelemetry::trace::Scope(span);
  return internal::EndSpan(*span, child_->SetLabels(request));
}

StatusOr<google::cloud::cpp::compute::v1::TestPermissionsResponse>
ExternalVpnGatewaysTracingConnection::TestIamPermissions(google::cloud::cpp::compute::externalVpnGateways::v1::TestIamPermissionsRequest const& request) {
