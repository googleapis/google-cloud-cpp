...
class ExternalVpnGatewaysRestMetadata : public ExternalVpnGatewaysRestStub {
 public:
  ...
  explicit ExternalVpnGatewaysRestMetadata(std::shared_ptr<ExternalVpnGatewaysRestStub> child);

  google::cloud::future<StatusOr<google::cloud::cpp::compute::v1::Operation>> AsyncDeleteExternalVpnGateways(
  ...
  google::cloud::future<StatusOr<google::cloud::cpp::compute::v1::Operation>> AsyncInsertExternalVpnGateways(
      google::cloud::CompletionQueue& cq,
      std::unique_ptr<google::cloud::rest_internal::RestContext> rest_context,
