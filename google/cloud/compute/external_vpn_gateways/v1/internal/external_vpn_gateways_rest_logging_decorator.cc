...
ExternalVpnGatewaysRestLogging::DeleteExternalVpnGateway(
...
StatusOr<google::cloud::cpp::compute::v1::Operation>
ExternalVpnGatewaysRestLogging::InsertExternalVpnGateway(
    rest_internal::RestContext& rest_context,
    Options const& options,
    google::cloud::cpp::compute::external_vpn_gateways::v1::InsertExternalVpnGatewayRequest const& request) {
  return google::cloud::internal::LogWrapper(
...
future<Status>
ExternalVpnGatewaysRestLogging::AsyncCancelOperation(
    google::cloud::CompletionQueue& cq,
    std::unique_ptr<rest_internal::RestContext> rest_context,
    google::cloud::internal::ImmutableOptions options,
