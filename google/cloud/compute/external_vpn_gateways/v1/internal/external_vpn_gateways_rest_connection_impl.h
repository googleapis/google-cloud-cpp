...
class ExternalVpnGatewaysRestConnectionImpl
 ...
 public:
  ...
  DeleteExternalVpnGateways(google::cloud::cpp::compute::externalVpnGateways::v1::DeleteExternalVpnGatewaysRequest const& request) override;

  StatusOr<google::cloud::cpp::compute::v1::ExternalVpnGateway>
  GetExternalVpnGateways(google::cloud::cpp::compute::externalVpnGateways::v1::GetExternalVpnGatewaysRequest const& request) override;

  StatusOr<google::cloud::cpp::compute::v1::Operation>
  InsertExternalVpnGateways(google::cloud::cpp::compute::externalVpnGateways::v1::InsertExternalVpnGatewaysRequest const& request) override;

  StreamRange<google::cloud::cpp::compute::v1::ExternalVpnGateway>
  ListExternalVpnGateways(google::cloud::cpp::compute::externalVpnGateways::v1::ListExternalVpnGatewaysRequest request) override;

  StatusOr<google::cloud::cpp::compute::v1::Operation>
  SetLabels(google::cloud::cpp::compute::externalVpnGateways::v1::SetLabelsRequest const& request) override;

  StatusOr<google::cloud::cpp::compute::v1::TestPermissionsResponse>
  TestIamPermissions(google::cloud::cpp::compute::externalVpnGateways::v1::TestIamPermissionsRequest const& request) override;
