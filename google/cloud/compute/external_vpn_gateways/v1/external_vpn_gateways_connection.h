...
using ExternalVpnGatewaysRetryPolicy = ::google::cloud::internal::TraitBasedRetryPolicy<
    compute_external_vpn_gateways_v1_internal::ExternalVpnGatewaysRetryTraits>;

using ExternalVpnGatewaysLimitedTimeRetryPolicy = ::google::cloud::internal::LimitedTimeRetryPolicy<
    compute_external_vpn_gateways_v1_internal::ExternalVpnGatewaysRetryTraits>;
