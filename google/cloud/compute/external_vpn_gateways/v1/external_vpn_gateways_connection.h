 ...
 */
class ExternalVpnGatewaysLimitedErrorCountRetryPolicy : public ExternalVpnGatewaysRetryPolicy {
 public:
  /**
  ...
  ExternalVpnGatewaysLimitedErrorCountRetryPolicy(
    ...
    : ExternalVpnGatewaysLimitedErrorCountRetryPolicy(rhs.maximum_failures()) {}
  ExternalVpnGatewaysLimitedErrorCountRetryPolicy(
 ...
 private:
  google::cloud::internal::LimitedErrorCountRetryPolicy<compute_external_vpn_gateways_v1_internal::ExternalVpnGatewaysRetryTraits> impl_;
};
 ...
 * - [`kUnavailable`](@ref google::cloud::StatusCode)
 */
class ExternalVpnGatewaysLimitedTimeRetryPolicy : public ExternalVpnGatewaysRetryPolicy {
 public:
  /**
  ...
  ExternalVpnGatewaysLimitedTimeRetryPolicy(ExternalVpnGatewaysLimitedTimeRetryPolicy&& rhs) noexcept
    : ExternalVpnGatewaysLimitedTimeRetryPolicy(rhs.maximum_duration()) {}
  ExternalVpnGatewaysLimitedTimeRetryPolicy(ExternalVpnGatewaysLimitedTimeRetryPolicy const& rhs) noexcept
    : ExternalVpnGatewaysLimitedTimeRetryPolicy(rhs.maximum_duration()) {}
 ...
 private:
  google::cloud::internal::LimitedTimeRetryPolicy<compute_external_vpn_gateways_v1_internal::ExternalVpnGatewaysRetryTraits> impl_;
};
 ...
 * sets in `ExternalVpnGatewaysClient`. This allows users to inject custom behavior
 * (e.g., with a Google Mock object) when writing tests that use objects of type
 * `ExternalVpnGatewaysClient`.
 *
 * To create a concrete instance, see `MakeExternalVpnGatewaysConnection()`.
 *
 * For mocking, see `compute_external_vpn_gateways_v1_mocks::MockExternalVpnGatewaysConnection`.
 */
class ExternalVpnGatewaysConnection {
 public:
  ...
  DeleteExternalVpnGateway(NoAwaitTag, google::cloud::cpp::compute::external_vpn_gateways::v1::DeleteExternalVpnGatewayRequest const& request);

  virtual future<StatusOr<google::cloud::cpp::compute::v1::Operation>>
  DeleteExternalVpnGateway( google::cloud::cpp::compute::v1::Operation const& operation);
  ...
  virtual StatusOr<google::cloud::cpp::compute::v1::Operation>
  InsertExternalVpnGateway(NoAwaitTag, google::cloud::cpp::compute::external_vpn_gateways::v1::InsertExternalVpnGatewayRequest const& request);

  virtual future<StatusOr<google::cloud::cpp::compute::v1::Operation>>
  InsertExternalVpnGateway( google::cloud::cpp::compute::v1::Operation const& operation);
  ...
  virtual StatusOr<google::cloud::cpp::compute::v1::Operation>
  SetLabels(NoAwaitTag, google::cloud::cpp::compute::external_vpn_gateways::v1::SetLabelsRequest const& request);
