...
StatusOr<google::cloud::cpp::compute::v1::Operation> ImagesClient::DeleteImages(
...
StatusOr<google::cloud::cpp::compute::v1::Operation> ImagesClient::InsertImages(
...
StatusOr<google::cloud::cpp::compute::v1::Operation> ImagesClient::PatchImages(
    std::string const& project, std::string const& image,
    google::cloud::cpp::compute::v1::Image const& image_resource,
    Options opts) {
  internal::OptionsSpan span(internal::MergeOptions(std::move(opts), options_));
