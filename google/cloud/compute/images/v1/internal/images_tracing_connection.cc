...
ImagesTracingConnection::DeleteImages(google::cloud::cpp::compute::images::v1::DeleteImagesRequest const& request) {
  auto span = internal::MakeSpan("compute_images_v1::ImagesConnection::DeleteImages");
  auto scope = opentelemetry::trace::Scope(span);
  return internal::EndSpan(*span, child_->DeleteImages(request));
}

StatusOr<google::cloud::cpp::compute::v1::Operation>
ImagesTracingConnection::Deprecate(google::cloud::cpp::compute::images::v1::DeprecateRequest const& request) {
  auto span = internal::MakeSpan("compute_images_v1::ImagesConnection::Deprecate");
  auto scope = opentelemetry::trace::Scope(span);
  return internal::EndSpan(*span, child_->Deprecate(request));
}
...
ImagesTracingConnection::InsertImages(google::cloud::cpp::compute::images::v1::InsertImagesRequest const& request) {
  auto span = internal::MakeSpan("compute_images_v1::ImagesConnection::InsertImages");
  auto scope = opentelemetry::trace::Scope(span);
  return internal::EndSpan(*span, child_->InsertImages(request));
}
...
ImagesTracingConnection::PatchImages(google::cloud::cpp::compute::images::v1::PatchImagesRequest const& request) {
  auto span = internal::MakeSpan("compute_images_v1::ImagesConnection::PatchImages");
  auto scope = opentelemetry::trace::Scope(span);
  return internal::EndSpan(*span, child_->PatchImages(request));
}
...
ImagesTracingConnection::SetLabels(google::cloud::cpp::compute::images::v1::SetLabelsRequest const& request) {
  auto span = internal::MakeSpan("compute_images_v1::ImagesConnection::SetLabels");
  auto scope = opentelemetry::trace::Scope(span);
