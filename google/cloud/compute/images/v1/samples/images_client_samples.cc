...
// clang-format off
// main-dox-marker: compute_images_v1::ImagesClient
// lro-marker: true
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::compute_images_v1::ImagesClient(
...
class CustomIdempotencyPolicy
   : public google::cloud::compute_images_v1::ImagesConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::compute_images_v1::ImagesConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::compute_images_v1::ImagesConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::compute_images_v1::ImagesRetryPolicyOption>(
      google::cloud::compute_images_v1::ImagesLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::compute_images_v1::ImagesBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::compute_images_v1::MakeImagesConnectionRest(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::compute_images_v1::ImagesClient(connection);
  auto c2 = google::cloud::compute_images_v1::ImagesClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::compute_images_v1::ImagesClient(
    connection, google::cloud::Options{}.set<google::cloud::compute_images_v1::ImagesRetryPolicyOption>(
      google::cloud::compute_images_v1::ImagesLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::compute_images_v1::ImagesRetryPolicyOption>(
  //       google::cloud::compute_images_v1::ImagesLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::compute_images_v1::ImagesPollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::compute_images_v1::ImagesRetryPolicyOption::Type,
            google::cloud::compute_images_v1::ImagesBackoffPolicyOption::Type>(
            google::cloud::compute_images_v1::ImagesLimitedTimeRetryPolicy(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::compute_images_v1::ImagesClient(
      google::cloud::compute_images_v1::MakeImagesConnectionRest(options));
  }
  //! [with-service-account]
  (argv.at(0));
