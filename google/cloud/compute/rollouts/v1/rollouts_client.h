...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_COMPUTE_ROLLOUTS_V1_ROLLOUTS_CLIENT_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_COMPUTE_ROLLOUTS_V1_ROLLOUTS_CLIENT_H

#include "google/cloud/compute/rollouts/v1/rollouts_rest_connection.h"
...
class RolloutsClient {
 public:
  explicit RolloutsClient(std::shared_ptr<RolloutsConnection> connection,
                          Options opts = {});
  ~RolloutsClient();

  ///@{
  /// @name Copy and move support
  RolloutsClient(RolloutsClient const&) = default;
  RolloutsClient& operator=(RolloutsClient const&) = default;
  RolloutsClient(RolloutsClient&&) = default;
  RolloutsClient& operator=(RolloutsClient&&) = default;
  ///@}

  ///@{
  /// @name Equality
  friend bool operator==(RolloutsClient const& a, RolloutsClient const& b) {
  ...
  /// https://cloud.google.com/compute/docs/reference/rest/v1/rollouts/advance
  ///
  ...
  future<StatusOr<google::cloud::cpp::compute::v1::Operation>> Advance(
      std::string const& project, std::string const& rollout,
      Options opts = {});
  ...
  ///     [google.cloud.cpp.compute.rollouts.v1.AdvanceRequest].
  ...
  ///
  /// Cancels a Rollout.
  /// https://cloud.google.com/compute/docs/reference/rest/v1/rollouts/cancel
  ///
  ...
  ///     function, receive a single `request` proto message which includes all
  ///     the inputs for the RPC. In this case, the proto message is a
  ///     [google.cloud.cpp.compute.rollouts.v1.CancelRequest].
  ///     Proto messages are converted to C++ classes by Protobuf, using the
  ///     [Protobuf mapping rules].
  /// @param opts Optional. Override the class-level options, such as retry and
  ///     backoff policies.
  ...
  ///
  /// Deletes a Rollout.
  /// https://cloud.google.com/compute/docs/reference/rest/v1/rollouts/delete
  ///
  /// @param project  Project ID for this request.
  ...
  ///     function, receive a single `request` proto message which includes all
  ///     the inputs for the RPC. In this case, the proto message is a
  ///     [google.cloud.cpp.compute.rollouts.v1.DeleteRolloutRequest].
  ///     Proto messages are converted to C++ classes by Protobuf, using the
  ///     [Protobuf mapping rules].
  /// @param opts Optional. Override the class-level options, such as retry and
  ///     backoff policies.
  ...
  /// https://cloud.google.com/compute/docs/reference/rest/v1/rollouts/get
  ///
  /// @param project  Project ID for this request.
  ...
  ///     ([google.cloud.cpp.compute.v1.Rollout])
  ...
  ///     function, receive a single `request` proto message which includes all
  ///     the inputs for the RPC. In this case, the proto message is a
  ///     [google.cloud.cpp.compute.rollouts.v1.GetRolloutRequest].
  ///     Proto messages are converted to C++ classes by Protobuf, using the
  ///     [Protobuf mapping rules].
  /// @param opts Optional. Override the class-level options, such as retry and
  ///     backoff policies.
  ...
  /// https://cloud.google.com/compute/docs/reference/rest/v1/rollouts/list
  ///
  /// @param project  Project ID for this request.
  /// @param opts Optional. Override the class-level options, such as retry and
  ///     backoff policies.
  ...
  ///     [google.cloud.cpp.compute.v1.Rollout], or rather,
  ...
  ///
  /// Pauses a Rollout.
  /// https://cloud.google.com/compute/docs/reference/rest/v1/rollouts/pause
  ///
  /// @param project  Required. Project ID for this request.
  ...
  ///     function, receive a single `request` proto message which includes all
  ///     the inputs for the RPC. In this case, the proto message is a
  ///     [google.cloud.cpp.compute.rollouts.v1.PauseRequest].
  ///     Proto messages are converted to C++ classes by Protobuf, using the
  ///     [Protobuf mapping rules].
  /// @param opts Optional. Override the class-level options, such as retry and
  ///     backoff policies.
  ...
  ///
  /// Resumes a Rollout.
  /// https://cloud.google.com/compute/docs/reference/rest/v1/rollouts/resume
  ///
  /// @param project  Required. Project ID for this request.
  ...
  ///     function, receive a single `request` proto message which includes all
  ///     the inputs for the RPC. In this case, the proto message is a
  ///     [google.cloud.cpp.compute.rollouts.v1.ResumeRequest].
  ///     Proto messages are converted to C++ classes by Protobuf, using the
  ///     [Protobuf mapping rules].
  /// @param opts Optional. Override the class-level options, such as retry and
  ///     backoff policies.
 ...
 private:
  std::shared_ptr<RolloutsConnection> connection_;
  Options options_;
};
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_COMPUTE_ROLLOUTS_V1_ROLLOUTS_CLIENT_H
