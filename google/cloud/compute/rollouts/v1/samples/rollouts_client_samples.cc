...
// clang-format off
// main-dox-marker: compute_rollouts_v1::RolloutsClient
// lro-marker: true
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::compute_rollouts_v1::RolloutsClient(
      google::cloud::compute_rollouts_v1::MakeRolloutsConnectionRest(options));
  //! [set-client-endpoint]
}
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::compute_rollouts_v1::RolloutsClient(
      google::cloud::compute_rollouts_v1::MakeRolloutsConnectionRest(
          *ud_options));
  //! [set-client-universe-domain]
}

//! [custom-idempotency-policy]
class CustomIdempotencyPolicy : public google::cloud::compute_rollouts_v1::
                                    RolloutsConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<
      google::cloud::compute_rollouts_v1::RolloutsConnectionIdempotencyPolicy>
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options =
      google::cloud::Options{}
          .set<google::cloud::compute_rollouts_v1::
                   RolloutsConnectionIdempotencyPolicyOption>(
              CustomIdempotencyPolicy().clone())
          .set<google::cloud::compute_rollouts_v1::RolloutsRetryPolicyOption>(
              google::cloud::compute_rollouts_v1::
                  RolloutsLimitedErrorCountRetryPolicy(3)
                      .clone())
          .set<google::cloud::compute_rollouts_v1::RolloutsBackoffPolicyOption>(
  ...
  auto c1 = google::cloud::compute_rollouts_v1::RolloutsClient(connection);
  auto c2 = google::cloud::compute_rollouts_v1::RolloutsClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::compute_rollouts_v1::RolloutsClient(
      connection,
      google::cloud::Options{}
          .set<google::cloud::compute_rollouts_v1::RolloutsRetryPolicyOption>(
              google::cloud::compute_rollouts_v1::
                  RolloutsLimitedTimeRetryPolicy(std::chrono::minutes(5))
                      .clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::compute_rollouts_v1::RolloutsRetryPolicyOption>(
  //       google::cloud::compute_rollouts_v1::RolloutsLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options =
      google::cloud::Options{}
          .set<google::cloud::compute_rollouts_v1::RolloutsPollingPolicyOption>(
              google::cloud::GenericPollingPolicy<
                  google::cloud::compute_rollouts_v1::
                      RolloutsRetryPolicyOption::Type,
                  google::cloud::compute_rollouts_v1::
                      RolloutsBackoffPolicyOption::Type>(
                  google::cloud::compute_rollouts_v1::
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::compute_rollouts_v1::RolloutsClient(
        google::cloud::compute_rollouts_v1::MakeRolloutsConnectionRest(
            options));
  }
  //! [with-service-account]
