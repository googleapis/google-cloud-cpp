...
RegionSnapshotSettingsClient::RegionSnapshotSettingsClient(
    std::shared_ptr<RegionSnapshotSettingsConnection> connection, Options opts)
...
RegionSnapshotSettingsClient::GetSnapshotSettings(std::string const& project,
                                                  std::string const& region,
                                                  Options opts) {
  internal::OptionsSpan span(internal::MergeOptions(std::move(opts), options_));
  google::cloud::cpp::compute::region_snapshot_settings::v1::
      GetSnapshotSettingsRequest request;
...
StatusOr<google::cloud::cpp::compute::v1::SnapshotSettings>
RegionSnapshotSettingsClient::GetSnapshotSettings(
    google::cloud::cpp::compute::region_snapshot_settings::v1::
...
RegionSnapshotSettingsClient::PatchSnapshotSettings(
