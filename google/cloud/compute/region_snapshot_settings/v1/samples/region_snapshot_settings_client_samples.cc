...
#include "google/cloud/compute/region_snapshot_settings/v1/region_snapshot_settings_client.h"
...
// clang-format off
// main-dox-marker: compute_region_snapshot_settings_v1::RegionSnapshotSettingsClient
// lro-marker: true
// clang-format on
namespace {
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::compute_region_snapshot_settings_v1::
      RegionSnapshotSettingsClient(
          google::cloud::compute_region_snapshot_settings_v1::
              MakeRegionSnapshotSettingsConnectionRest(*ud_options));
  //! [set-client-universe-domain]
}

//! [custom-idempotency-policy]
class CustomIdempotencyPolicy
    : public google::cloud::compute_region_snapshot_settings_v1::
          RegionSnapshotSettingsConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::compute_region_snapshot_settings_v1::
                      RegionSnapshotSettingsConnectionIdempotencyPolicy>
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options =
      google::cloud::Options{}
          .set<google::cloud::compute_region_snapshot_settings_v1::
                   RegionSnapshotSettingsConnectionIdempotencyPolicyOption>(
              CustomIdempotencyPolicy().clone())
          .set<google::cloud::compute_region_snapshot_settings_v1::
                   RegionSnapshotSettingsRetryPolicyOption>(
              google::cloud::compute_region_snapshot_settings_v1::
                  RegionSnapshotSettingsLimitedErrorCountRetryPolicy(3)
                      .clone())
          .set<google::cloud::compute_region_snapshot_settings_v1::
              ...
              google::cloud::ExponentialBackoffPolicy(
                  ...
                  /*scaling=*/2.0)
                  .clone());
  auto connection = google::cloud::compute_region_snapshot_settings_v1::
      MakeRegionSnapshotSettingsConnectionRest(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::compute_region_snapshot_settings_v1::
      RegionSnapshotSettingsClient(connection);
  auto c2 = google::cloud::compute_region_snapshot_settings_v1::
      RegionSnapshotSettingsClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::compute_region_snapshot_settings_v1::
      RegionSnapshotSettingsClient(
          connection,
          google::cloud::Options{}
              .set<google::cloud::compute_region_snapshot_settings_v1::
  ...
  //     .set<google::cloud::compute_region_snapshot_settings_v1::RegionSnapshotSettingsRetryPolicyOption>(
  //       google::cloud::compute_region_snapshot_settings_v1::RegionSnapshotSettingsLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
      ...
      google::cloud::Options{}
          .set<google::cloud::compute_region_snapshot_settings_v1::
              ...
              google::cloud::GenericPollingPolicy<
                  google::cloud::compute_region_snapshot_settings_v1::
                      RegionSnapshotSettingsRetryPolicyOption::Type,
                  google::cloud::compute_region_snapshot_settings_v1::
                      RegionSnapshotSettingsBackoffPolicyOption::Type>(
                  google::cloud::compute_region_snapshot_settings_v1::
                      RegionSnapshotSettingsLimitedTimeRetryPolicy(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::compute_region_snapshot_settings_v1::
        RegionSnapshotSettingsClient(
            google::cloud::compute_region_snapshot_settings_v1::
                MakeRegionSnapshotSettingsConnectionRest(options));
  }
