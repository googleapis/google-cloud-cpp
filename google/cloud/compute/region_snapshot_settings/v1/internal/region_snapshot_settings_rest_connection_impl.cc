...
#include "google/cloud/compute/region_snapshot_settings/v1/internal/region_snapshot_settings_rest_connection_impl.h"
#include "google/cloud/compute/region_snapshot_settings/v1/internal/region_snapshot_settings_rest_stub_factory.h"
...
RegionSnapshotSettingsRestConnectionImpl::
    ...
    : background_(std::move(background)),
      ...
      options_(internal::MergeOptions(
          std::move(options), RegionSnapshotSettingsConnection::options())) {}

StatusOr<google::cloud::cpp::compute::v1::SnapshotSettings>
RegionSnapshotSettingsRestConnectionImpl::GetSnapshotSettings(
...
RegionSnapshotSettingsRestConnectionImpl::PatchSnapshotSettings(
    google::cloud::cpp::compute::region_snapshot_settings::v1::
