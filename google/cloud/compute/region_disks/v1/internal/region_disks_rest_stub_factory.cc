...
std::shared_ptr<RegionDisksRestStub> CreateDefaultRegionDisksRestStub(
  ...
  auto service_endpoint = internal::DetermineServiceEndpoint(
      internal::GetEnv("GOOGLE_CLOUD_CPP_REGION_DISKS_ENDPOINT"),
  ...
  std::shared_ptr<RegionDisksRestStub> stub =
      std::make_shared<DefaultRegionDisksRestStub>(
          std::move(stub_creation_opts));
  stub = std::make_shared<RegionDisksRestMetadata>(std::move(stub));
  if (internal::Contains(options.get<TracingComponentsOption>(), "rpc")) {
    GCP_LOG(INFO) << "Enabled logging for REST rpc calls";
    stub = std::make_shared<RegionDisksRestLogging>(
