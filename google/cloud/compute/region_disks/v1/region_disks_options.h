 ...
 */
struct RegionDisksRetryPolicyOption {
  using Type = std::shared_ptr<RegionDisksRetryPolicy>;
};
 ...
 * @ingroup google-cloud-compute-options
 */
struct RegionDisksBackoffPolicyOption {
 ...
 * @ingroup google-cloud-compute-options
 */
struct RegionDisksConnectionIdempotencyPolicyOption {
  using Type = std::shared_ptr<RegionDisksConnectionIdempotencyPolicy>;
};
 ...
 * @ingroup google-cloud-compute-options
 */
struct RegionDisksPollingPolicyOption {
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_COMPUTE_REGION_DISKS_V1_REGION_DISKS_OPTIONS_H
