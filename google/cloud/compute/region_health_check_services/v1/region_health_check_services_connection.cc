...
RegionHealthCheckServicesConnection::DeleteRegionHealthCheckServices(
    google::cloud::cpp::compute::regionHealthCheckServices::v1::DeleteRegionHealthCheckServicesRequest const&) {
...
RegionHealthCheckServicesConnection::GetRegionHealthCheckServices(
    google::cloud::cpp::compute::regionHealthCheckServices::v1::GetRegionHealthCheckServicesRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

StatusOr<google::cloud::cpp::compute::v1::Operation>
RegionHealthCheckServicesConnection::InsertRegionHealthCheckServices(
    google::cloud::cpp::compute::regionHealthCheckServices::v1::InsertRegionHealthCheckServicesRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}
...
StreamRange<google::cloud::cpp::compute::v1::HealthCheckService> RegionHealthCheckServicesConnection::ListRegionHealthCheckServices(
    google::cloud::cpp::compute::regionHealthCheckServices::v1::ListRegionHealthCheckServicesRequest) {  // NOLINT(performance-unnecessary-value-param)
...
RegionHealthCheckServicesConnection::PatchRegionHealthCheckServices(
    google::cloud::cpp::compute::regionHealthCheckServices::v1::PatchRegionHealthCheckServicesRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}
