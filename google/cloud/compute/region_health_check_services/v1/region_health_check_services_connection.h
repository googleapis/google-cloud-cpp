 ...
 */
class RegionHealthCheckServicesLimitedErrorCountRetryPolicy
    : public RegionHealthCheckServicesRetryPolicy {
 public:
  /**
   ...
   */
  explicit RegionHealthCheckServicesLimitedErrorCountRetryPolicy(
...
/**
 * A retry policy for `RegionHealthCheckServicesConnection` based on elapsed
 * time.
 *
 * This policy stops retrying if:
 * - An RPC returns a non-transient error.
 ...
 * - [`kUnavailable`](@ref google::cloud::StatusCode)
 */
class RegionHealthCheckServicesLimitedTimeRetryPolicy
    : public RegionHealthCheckServicesRetryPolicy {
 public:
  /**
  ...
  RegionHealthCheckServicesLimitedTimeRetryPolicy(
      RegionHealthCheckServicesLimitedTimeRetryPolicy&& rhs) noexcept
      : RegionHealthCheckServicesLimitedTimeRetryPolicy(
            rhs.maximum_duration()) {}
  RegionHealthCheckServicesLimitedTimeRetryPolicy(
      RegionHealthCheckServicesLimitedTimeRetryPolicy const& rhs) noexcept
      : RegionHealthCheckServicesLimitedTimeRetryPolicy(
            rhs.maximum_duration()) {}
...
class RegionHealthCheckServicesConnection {
 public:
  ...
  DeleteHealthCheckService(
      NoAwaitTag, google::cloud::cpp::compute::region_health_check_services::
