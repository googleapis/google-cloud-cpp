...
class RegionHealthCheckServicesClient {
 public:
  ...
  /// https://cloud.google.com/compute/docs/reference/rest/v1/regionHealthCheckServices/aggregatedList
  ///
  ...
  ///     [google.cloud.cpp.compute.v1.HealthCheckServicesScopedList], or rather,
  ...
  /// [google.cloud.cpp.compute.v1.HealthCheckServicesScopedList]: @cloud_cpp_reference_link{google/cloud/compute/v1/internal/common_062.proto#L394}
  ///
  // clang-format on
  StreamRange<
      std::pair<std::string,
                google::cloud::cpp::compute::v1::HealthCheckServicesScopedList>>
  AggregatedListRegionHealthCheckServices(std::string const& project,
                                          Options opts = {});
  ...
  /// @param health_check_service  Name of the HealthCheckService to delete. The name
  ...
  /// @param project  Project ID for this request.
  /// @param region  Name of the region scoping this request.
  /// @param health_check_service  Name of the HealthCheckService to update. The name
  ///  must be 1-63 characters long, and comply with RFC1035.
  /// @param opts Optional. Override the class-level options, such as retry and
  ///     backoff policies.
  ...
  /// [google.cloud.cpp.compute.v1.HealthCheckService]: @cloud_cpp_reference_link{google/cloud/compute/v1/internal/common_062.proto#L25}
  ///
  // clang-format on
  ...
  ///     function, receive a single `request` proto message which includes all
  ///     the inputs for the RPC. In this case, the proto message is a
  ///     [google.cloud.cpp.compute.region_health_check_services.v1.TestIamPermissionsRequest].
  ///     Proto messages are converted to C++ classes by Protobuf, using the
  ///     [Protobuf mapping rules].
  /// @param opts Optional. Override the class-level options, such as retry and
  ///     backoff policies.
