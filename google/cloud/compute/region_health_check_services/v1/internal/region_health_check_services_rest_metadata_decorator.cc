...
RegionHealthCheckServicesRestMetadata::ListRegionHealthCheckServices(
    rest_internal::RestContext& rest_context,
    Options const& options, google::cloud::cpp::compute::region_health_check_services::v1::ListRegionHealthCheckServicesRequest const& request) {
  SetMetadata(rest_context, options);
...
future<Status>
RegionHealthCheckServicesRestMetadata::AsyncCancelOperation(
    google::cloud::CompletionQueue& cq,
    std::unique_ptr<rest_internal::RestContext> rest_context,
    google::cloud::internal::ImmutableOptions options,
