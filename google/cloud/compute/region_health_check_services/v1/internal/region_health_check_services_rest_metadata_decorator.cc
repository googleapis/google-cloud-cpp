...
RegionHealthCheckServicesRestMetadata::AsyncDeleteRegionHealthCheckServices(
  ...
  return child_->AsyncDeleteRegionHealthCheckServices(cq, std::move(rest_context), request);
}
...
RegionHealthCheckServicesRestMetadata::AsyncInsertRegionHealthCheckServices(
  ...
  SetMetadata(*rest_context);
  return child_->AsyncInsertRegionHealthCheckServices(cq, std::move(rest_context), request);
}
...
RegionHealthCheckServicesRestMetadata::AsyncPatchRegionHealthCheckServices(
  ...
  SetMetadata(*rest_context);
  return child_->AsyncPatchRegionHealthCheckServices(cq, std::move(rest_context), request);
}
