...
class RegionHealthCheckServicesConnectionIdempotencyPolicy {
 public:
  ...
  DeleteRegionHealthCheckServices(google::cloud::cpp::compute::regionHealthCheckServices::v1::DeleteRegionHealthCheckServicesRequest const& request);

  virtual google::cloud::Idempotency
  GetRegionHealthCheckServices(google::cloud::cpp::compute::regionHealthCheckServices::v1::GetRegionHealthCheckServicesRequest const& request);

  virtual google::cloud::Idempotency
  InsertRegionHealthCheckServices(google::cloud::cpp::compute::regionHealthCheckServices::v1::InsertRegionHealthCheckServicesRequest const& request);

  virtual google::cloud::Idempotency
  ListRegionHealthCheckServices(google::cloud::cpp::compute::regionHealthCheckServices::v1::ListRegionHealthCheckServicesRequest request);

  virtual google::cloud::Idempotency
  PatchRegionHealthCheckServices(google::cloud::cpp::compute::regionHealthCheckServices::v1::PatchRegionHealthCheckServicesRequest const& request);
};
