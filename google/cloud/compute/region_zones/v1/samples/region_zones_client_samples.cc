...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::compute_region_zones_v1::RegionZonesClient(
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::compute_region_zones_v1::RegionZonesClient(
      google::cloud::compute_region_zones_v1::MakeRegionZonesConnection(
          *ud_options));
  //! [set-client-universe-domain]
}

//! [custom-idempotency-policy]
class CustomIdempotencyPolicy : public google::cloud::compute_region_zones_v1::
                                    RegionZonesConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::compute_region_zones_v1::
                      RegionZonesConnectionIdempotencyPolicy>
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto c1 =
      google::cloud::compute_region_zones_v1::RegionZonesClient(connection);
  auto c2 =
      google::cloud::compute_region_zones_v1::RegionZonesClient(connection);
  ...
  auto c3 = google::cloud::compute_region_zones_v1::RegionZonesClient(
      ...
      google::cloud::Options{}
          .set<google::cloud::compute_region_zones_v1::
                   RegionZonesRetryPolicyOption>(
              google::cloud::compute_region_zones_v1::
                  RegionZonesLimitedTimeRetryPolicy(std::chrono::minutes(5))
                      .clone()));
