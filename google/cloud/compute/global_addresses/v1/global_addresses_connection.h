...
/**
 * A retry policy for `GlobalAddressesConnection` that stops retrying after a
...
class GlobalAddressesLimitedErrorCountRetryPolicy
 ...
 public:
  GlobalAddressesLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `GlobalAddressesConnection` that stops retrying after
