...
class GlobalAddressesConnection {
 public:
  ...
  DeleteGlobalAddresses(google::cloud::cpp::compute::globalAddresses::v1::
  ...
  virtual StatusOr<google::cloud::cpp::compute::v1::Operation>
  InsertGlobalAddresses(google::cloud::cpp::compute::globalAddresses::v1::
                            InsertGlobalAddressesRequest const& request);

  virtual StreamRange<google::cloud::cpp::compute::v1::Address>
  ListGlobalAddresses(google::cloud::cpp::compute::globalAddresses::v1::
