...
#include "google/cloud/compute/global_addresses/v1/internal/global_addresses_rest_logging_decorator.h"
...
std::shared_ptr<GlobalAddressesRestStub> CreateDefaultGlobalAddressesRestStub(
  ...
  auto service_endpoint = internal::DetermineServiceEndpoint(
      internal::GetEnv("GOOGLE_CLOUD_CPP_GLOBAL_ADDRESSES_ENDPOINT"),
  ...
  std::shared_ptr<GlobalAddressesRestStub> stub =
      std::make_shared<DefaultGlobalAddressesRestStub>(
