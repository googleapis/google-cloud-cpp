...
DefaultGlobalAddressesRestStub::AsyncDeleteGlobalAddress(
    CompletionQueue& cq,
...
DefaultGlobalAddressesRestStub::GetGlobalAddress(
...
future<StatusOr<google::cloud::cpp::compute::v1::Operation>>
DefaultGlobalAddressesRestStub::AsyncInsertGlobalAddress(
    CompletionQueue& cq,
    std::unique_ptr<rest_internal::RestContext> rest_context,
    google::cloud::cpp::compute::global_addresses::v1::
