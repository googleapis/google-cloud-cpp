...
std::shared_ptr<AddressesRestStub> CreateDefaultAddressesRestStub(
    Options& options) {
  ...
  auto service_endpoint = internal::DetermineServiceEndpoint(
      internal::GetEnv("GOOGLE_CLOUD_CPP_ADDRESSES_ENDPOINT"),
  ...
  std::shared_ptr<AddressesRestStub> stub =
      std::make_shared<DefaultAddressesRestStub>(std::move(stub_creation_opts));
  stub = std::make_shared<AddressesRestMetadata>(std::move(stub));
  if (internal::Contains(options.get<TracingComponentsOption>(), "rpc")) {
    GCP_LOG(INFO) << "Enabled logging for REST rpc calls";
    stub = std::make_shared<AddressesRestLogging>(
