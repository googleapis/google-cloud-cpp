...
// clang-format off
// main-dox-marker: compute_addresses_v1::AddressesClient
// lro-marker: true
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::compute_addresses_v1::AddressesClient(
      google::cloud::compute_addresses_v1::MakeAddressesConnectionRest(options));
  //! [set-client-endpoint]
}

//! [custom-idempotency-policy]
class CustomIdempotencyPolicy
   : public google::cloud::compute_addresses_v1::AddressesConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::compute_addresses_v1::AddressesConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::compute_addresses_v1::AddressesConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::compute_addresses_v1::AddressesRetryPolicyOption>(
      google::cloud::compute_addresses_v1::AddressesLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::compute_addresses_v1::AddressesBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::compute_addresses_v1::MakeAddressesConnectionRest(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::compute_addresses_v1::AddressesClient(connection);
  auto c2 = google::cloud::compute_addresses_v1::AddressesClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::compute_addresses_v1::AddressesClient(
    connection, google::cloud::Options{}.set<google::cloud::compute_addresses_v1::AddressesRetryPolicyOption>(
      google::cloud::compute_addresses_v1::AddressesLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::compute_addresses_v1::AddressesRetryPolicyOption>(
  //       google::cloud::compute_addresses_v1::AddressesLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::compute_addresses_v1::AddressesPollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::compute_addresses_v1::AddressesRetryPolicyOption::Type,
            google::cloud::compute_addresses_v1::AddressesBackoffPolicyOption::Type>(
            google::cloud::compute_addresses_v1::AddressesLimitedTimeRetryPolicy(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::compute_addresses_v1::AddressesClient(
      google::cloud::compute_addresses_v1::MakeAddressesConnectionRest(options));
  }
  //! [with-service-account]
  (argv.at(0));
