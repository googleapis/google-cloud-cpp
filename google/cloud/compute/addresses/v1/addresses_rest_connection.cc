...
std::shared_ptr<AddressesConnection> MakeAddressesConnectionRest(
  ...
  internal::CheckExpectedOptions<CommonOptionList, RestOptionList,
      ...
      AddressesPolicyOptionList>(options, __func__);
  options = compute_addresses_v1_internal::AddressesDefaultOptions(
      std::move(options));
  auto background = std::make_unique<
      rest_internal::AutomaticallyCreatedRestBackgroundThreads>();
  auto stub = compute_addresses_v1_internal::CreateDefaultAddressesRestStub(
    options);
  return std::make_shared<compute_addresses_v1_internal::AddressesRestConnectionImpl>(
