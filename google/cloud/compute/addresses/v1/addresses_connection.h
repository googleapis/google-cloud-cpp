...
/**
 * A retry policy for `AddressesConnection` that stops retrying after a
 ...
 */
class AddressesLimitedErrorCountRetryPolicy : public AddressesRetryPolicy {
 public:
  AddressesLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `AddressesConnection` that stops retrying after
/// some wall clock time has elapsed.
class AddressesLimitedTimeRetryPolicy : public AddressesRetryPolicy {
 public:
  /**
