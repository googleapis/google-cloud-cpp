...
// clang-format off
// main-dox-marker: compute_wire_groups_v1::WireGroupsClient
// lro-marker: true
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::compute_wire_groups_v1::WireGroupsClient(
      google::cloud::compute_wire_groups_v1::MakeWireGroupsConnectionRest(
          options));
  //! [set-client-endpoint]
}
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::compute_wire_groups_v1::WireGroupsClient(
      google::cloud::compute_wire_groups_v1::MakeWireGroupsConnectionRest(
          *ud_options));
  //! [set-client-universe-domain]
}
...
class CustomIdempotencyPolicy : public google::cloud::compute_wire_groups_v1::
                                    WireGroupsConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::compute_wire_groups_v1::
                      WireGroupsConnectionIdempotencyPolicy>
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
                     .set<google::cloud::compute_wire_groups_v1::
                              WireGroupsConnectionIdempotencyPolicyOption>(
                         CustomIdempotencyPolicy().clone())
                     .set<google::cloud::compute_wire_groups_v1::
                              WireGroupsRetryPolicyOption>(
                         google::cloud::compute_wire_groups_v1::
                             WireGroupsLimitedErrorCountRetryPolicy(3)
                                 .clone())
                     .set<google::cloud::compute_wire_groups_v1::
                              WireGroupsBackoffPolicyOption>(
  ...
  auto c1 = google::cloud::compute_wire_groups_v1::WireGroupsClient(connection);
  auto c2 = google::cloud::compute_wire_groups_v1::WireGroupsClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::compute_wire_groups_v1::WireGroupsClient(
      connection,
      google::cloud::Options{}
          .set<google::cloud::compute_wire_groups_v1::
                   WireGroupsRetryPolicyOption>(
              google::cloud::compute_wire_groups_v1::
                  WireGroupsLimitedTimeRetryPolicy(std::chrono::minutes(5))
                      .clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::compute_wire_groups_v1::WireGroupsRetryPolicyOption>(
  //       google::cloud::compute_wire_groups_v1::WireGroupsLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options =
      google::cloud::Options{}
          .set<google::cloud::compute_wire_groups_v1::
                   WireGroupsPollingPolicyOption>(
              google::cloud::GenericPollingPolicy<
                  google::cloud::compute_wire_groups_v1::
                      WireGroupsRetryPolicyOption::Type,
                  google::cloud::compute_wire_groups_v1::
                      WireGroupsBackoffPolicyOption::Type>(
                  google::cloud::compute_wire_groups_v1::
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::compute_wire_groups_v1::WireGroupsClient(
        google::cloud::compute_wire_groups_v1::MakeWireGroupsConnectionRest(
            options));
  }
  //! [with-service-account]
