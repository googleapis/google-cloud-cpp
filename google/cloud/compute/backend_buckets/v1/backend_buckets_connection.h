...
/**
 * A retry policy for `BackendBucketsConnection` that stops retrying after a
...
class BackendBucketsLimitedErrorCountRetryPolicy
 ...
 public:
  BackendBucketsLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `BackendBucketsConnection` that stops retrying after
