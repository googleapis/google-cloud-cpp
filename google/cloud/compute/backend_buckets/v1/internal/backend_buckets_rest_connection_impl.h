...
clone();
  ...
  std::unique_ptr<PollingPolicy> polling_policy() {
    auto const& options = internal::CurrentOptions();
    if (options.has<compute_backend_buckets_v1::BackendBucketsPollingPolicyOption>()) {
      return options.get<compute_backend_buckets_v1::BackendBucketsPollingPolicyOption>()->clone();
    }
    return options_.get<compute_backend_buckets_v1::BackendBucketsPollingPolicyOption>()->clone();
  }
