 ...
 */
struct BackendBucketsRetryPolicyOption {
  using Type = std::shared_ptr<BackendBucketsRetryPolicy>;
};
 ...
 * @ingroup google-cloud-compute-options
 */
struct BackendBucketsBackoffPolicyOption {
 ...
 * @ingroup google-cloud-compute-options
 */
struct BackendBucketsConnectionIdempotencyPolicyOption {
  using Type = std::shared_ptr<BackendBucketsConnectionIdempotencyPolicy>;
};
 ...
 * @ingroup google-cloud-compute-options
 */
struct BackendBucketsPollingPolicyOption {
 ...
 * @ingroup google-cloud-compute-options
 */
using BackendBucketsPolicyOptionList =
    OptionList<BackendBucketsRetryPolicyOption,
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_COMPUTE_BACKEND_BUCKETS_V1_BACKEND_BUCKETS_OPTIONS_H
