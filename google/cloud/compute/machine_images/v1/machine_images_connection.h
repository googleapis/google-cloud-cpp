...
/**
 * A retry policy for `MachineImagesConnection` that stops retrying after a
...
class MachineImagesLimitedErrorCountRetryPolicy
 ...
 public:
  MachineImagesLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `MachineImagesConnection` that stops retrying after
