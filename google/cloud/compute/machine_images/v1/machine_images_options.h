 ...
 */
struct MachineImagesRetryPolicyOption {
  using Type = std::shared_ptr<MachineImagesRetryPolicy>;
};
 ...
 * @ingroup google-cloud-compute-options
 */
struct MachineImagesBackoffPolicyOption {
 ...
 * @ingroup google-cloud-compute-options
 */
struct MachineImagesConnectionIdempotencyPolicyOption {
  using Type = std::shared_ptr<MachineImagesConnectionIdempotencyPolicy>;
};
 ...
 * @ingroup google-cloud-compute-options
 */
struct MachineImagesPollingPolicyOption {
  using Type = std::shared_ptr<PollingPolicy>;
};

/**
 * The options applicable to MachineImages.
 *
 * @ingroup google-cloud-compute-options
 */
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_COMPUTE_MACHINE_IMAGES_V1_MACHINE_IMAGES_OPTIONS_H
