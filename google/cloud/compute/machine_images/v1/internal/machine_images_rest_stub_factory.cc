...
std::shared_ptr<MachineImagesRestStub> CreateDefaultMachineImagesRestStub(
    Options& options) {
  ...
  auto service_endpoint = internal::DetermineServiceEndpoint(
      internal::GetEnv("GOOGLE_CLOUD_CPP_MACHINE_IMAGES_ENDPOINT"),
  ...
  std::shared_ptr<MachineImagesRestStub> stub =
      std::make_shared<DefaultMachineImagesRestStub>(
