...
NodeTypesTracingConnection::AggregatedListNodeTypes(google::cloud::cpp::compute::nodeTypes::v1::AggregatedListNodeTypesRequest const& request) {
...
NodeTypesTracingConnection::GetNodeTypes(google::cloud::cpp::compute::nodeTypes::v1::GetNodeTypesRequest const& request) {
...
NodeTypesTracingConnection::ListNodeTypes(google::cloud::cpp::compute::nodeTypes::v1::ListNodeTypesRequest request) {
