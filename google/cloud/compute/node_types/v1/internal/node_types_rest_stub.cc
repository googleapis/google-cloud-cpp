...
DefaultNodeTypesRestStub::AggregatedListNodeTypes(
  ...
  return rest_internal::Get<google::cloud::cpp::compute::v1::NodeTypeAggregatedList>(
      *service_, rest_context, request, false,
      absl::StrCat("/", "compute", "/", rest_internal::DetermineApiVersion("v1", options), "/", "projects", "/", request.project(), "/", "aggregated", "/", "nodeTypes"), std::move(query_params));
}
...
DefaultNodeTypesRestStub::GetNodeType(
  ...
  return rest_internal::Get<google::cloud::cpp::compute::v1::NodeType>(
      *service_, rest_context, request, false,
      absl::StrCat("/", "compute", "/", rest_internal::DetermineApiVersion("v1", options), "/", "projects", "/", request.project(), "/", "zones", "/", request.zone(), "/", "nodeTypes", "/", request.node_type()), std::move(query_params));
}
...
DefaultNodeTypesRestStub::ListNodeTypes(
  ...
  return rest_internal::Get<google::cloud::cpp::compute::v1::NodeTypeList>(
      *service_, rest_context, request, false,
      absl::StrCat("/", "compute", "/", rest_internal::DetermineApiVersion("v1", options), "/", "projects", "/", request.project(), "/", "zones", "/", request.zone(), "/", "nodeTypes"), std::move(query_params));
}
