...
/**
 * A retry policy for `NodeTypesConnection` that stops retrying after a
...
class NodeTypesLimitedErrorCountRetryPolicy : public NodeTypesRetryPolicy {
 public:
  NodeTypesLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `NodeTypesConnection` that stops retrying after
