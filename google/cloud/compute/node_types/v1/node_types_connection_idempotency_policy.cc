...
Idempotency NodeTypesConnectionIdempotencyPolicy::AggregatedListNodeTypes(google::cloud::cpp::compute::nodeTypes::v1::AggregatedListNodeTypesRequest const&) {
  return Idempotency::kIdempotent;
}

Idempotency NodeTypesConnectionIdempotencyPolicy::GetNodeTypes(google::cloud::cpp::compute::nodeTypes::v1::GetNodeTypesRequest const&) {
  return Idempotency::kIdempotent;
}

Idempotency NodeTypesConnectionIdempotencyPolicy::ListNodeTypes(google::cloud::cpp::compute::nodeTypes::v1::ListNodeTypesRequest) {  // NOLINT
  return Idempotency::kIdempotent;
}
