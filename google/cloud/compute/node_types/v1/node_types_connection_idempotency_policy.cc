...
Idempotency NodeTypesConnectionIdempotencyPolicy::AggregatedListNodeTypes(google::cloud::cpp::compute::node_types::v1::AggregatedListNodeTypesRequest const&) {
  return Idempotency::kIdempotent;
}

Idempotency NodeTypesConnectionIdempotencyPolicy::GetNodeTypes(google::cloud::cpp::compute::node_types::v1::GetNodeTypesRequest const&) {
  return Idempotency::kIdempotent;
}
