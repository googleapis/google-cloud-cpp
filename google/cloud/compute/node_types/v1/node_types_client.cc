...
StatusOr<google::cloud::cpp::compute::v1::NodeTypeAggregatedList>
NodeTypesClient::AggregatedListNodeTypes(google::cloud::cpp::compute::node_types::v1::AggregatedListNodeTypesRequest const& request, Options opts) {
  internal::OptionsSpan span(internal::MergeOptions(std::move(opts), options_));
  return connection_->AggregatedListNodeTypes(request);
}
...
StatusOr<google::cloud::cpp::compute::v1::NodeType>
NodeTypesClient::GetNodeTypes(google::cloud::cpp::compute::node_types::v1::GetNodeTypesRequest const& request, Options opts) {
  internal::OptionsSpan span(internal::MergeOptions(std::move(opts), options_));
  return connection_->GetNodeTypes(request);
}
