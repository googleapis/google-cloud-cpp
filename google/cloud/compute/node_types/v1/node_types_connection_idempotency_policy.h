...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_COMPUTE_NODE_TYPES_V1_NODE_TYPES_CONNECTION_IDEMPOTENCY_POLICY_H
...
class NodeTypesConnectionIdempotencyPolicy {
 public:
  virtual ~NodeTypesConnectionIdempotencyPolicy();
