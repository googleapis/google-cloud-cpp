...
class NodeTypesClient {
 public:
  ...
  /// [google.cloud.cpp.compute.v1.NodeTypeAggregatedList]: @googleapis_reference_link{google/cloud/compute/v1/internal/common_file_081.proto#L74}
  ///
  // clang-format on
  ...
  /// [google.cloud.cpp.compute.v1.NodeType]: @googleapis_reference_link{google/cloud/compute/v1/internal/common_file_081.proto#L31}
  ///
  // clang-format on
