...
class NodeTypesClient {
 public:
  ...
  /// [google.cloud.cpp.compute.v1.NodeTypeAggregatedList]: @googleapis_reference_link{google/cloud/compute/v1/internal/common.proto#L17842}
  ///
  // clang-format on
  ...
  /// [google.cloud.cpp.compute.v1.NodeType]: @googleapis_reference_link{google/cloud/compute/v1/internal/common.proto#L17799}
  ///
  // clang-format on
