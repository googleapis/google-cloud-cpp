...
class NodeTypesClient {
 public:
  ...
  /// [google.cloud.cpp.compute.v1.NodeTypesScopedList]: @cloud_cpp_reference_link{google/cloud/compute/v1/internal/common_084.proto#L294}
  ///
  // clang-format on
  ...
  /// [google.cloud.cpp.compute.v1.NodeType]: @cloud_cpp_reference_link{google/cloud/compute/v1/internal/common_084.proto#L31}
  ///
  // clang-format on
