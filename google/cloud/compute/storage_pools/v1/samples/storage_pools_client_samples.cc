...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::compute_storage_pools_v1::StoragePoolsClient(
      google::cloud::compute_storage_pools_v1::MakeStoragePoolsConnectionRest(options));
  //! [set-client-endpoint]
}

//! [custom-idempotency-policy]
class CustomIdempotencyPolicy
   : public google::cloud::compute_storage_pools_v1::StoragePoolsConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::compute_storage_pools_v1::StoragePoolsConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::compute_storage_pools_v1::StoragePoolsConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::compute_storage_pools_v1::StoragePoolsRetryPolicyOption>(
      google::cloud::compute_storage_pools_v1::StoragePoolsLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::compute_storage_pools_v1::StoragePoolsBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::compute_storage_pools_v1::MakeStoragePoolsConnectionRest(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::compute_storage_pools_v1::StoragePoolsClient(connection);
  auto c2 = google::cloud::compute_storage_pools_v1::StoragePoolsClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::compute_storage_pools_v1::StoragePoolsClient(
    connection, google::cloud::Options{}.set<google::cloud::compute_storage_pools_v1::StoragePoolsRetryPolicyOption>(
      google::cloud::compute_storage_pools_v1::StoragePoolsLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::compute_storage_pools_v1::StoragePoolsRetryPolicyOption>(
  //       google::cloud::compute_storage_pools_v1::StoragePoolsLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::compute_storage_pools_v1::StoragePoolsPollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::compute_storage_pools_v1::StoragePoolsRetryPolicyOption::Type,
            google::cloud::compute_storage_pools_v1::StoragePoolsBackoffPolicyOption::Type>(
            google::cloud::compute_storage_pools_v1::StoragePoolsLimitedTimeRetryPolicy(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::compute_storage_pools_v1::StoragePoolsClient(
      google::cloud::compute_storage_pools_v1::MakeStoragePoolsConnectionRest(options));
  }
  //! [with-service-account]
  (argv.at(0));
