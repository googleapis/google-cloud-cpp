...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::compute_storage_pools_v1::StoragePoolsClient(
      google::cloud::compute_storage_pools_v1::MakeStoragePoolsConnection(
          ud_options));
...
class CustomIdempotencyPolicy : public google::cloud::compute_storage_pools_v1::
                                    StoragePoolsConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::compute_storage_pools_v1::
                      StoragePoolsConnectionIdempotencyPolicy>
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto c1 =
      google::cloud::compute_storage_pools_v1::StoragePoolsClient(connection);
  auto c2 =
      google::cloud::compute_storage_pools_v1::StoragePoolsClient(connection);
  ...
  auto c3 = google::cloud::compute_storage_pools_v1::StoragePoolsClient(
      ...
      google::cloud::Options{}
          .set<google::cloud::compute_storage_pools_v1::
                   StoragePoolsRetryPolicyOption>(
              google::cloud::compute_storage_pools_v1::
                  StoragePoolsLimitedTimeRetryPolicy(std::chrono::minutes(5))
                      .clone()));
      ...
      google::cloud::Options{}
          .set<google::cloud::compute_storage_pools_v1::
              ...
              google::cloud::GenericPollingPolicy<
                  google::cloud::compute_storage_pools_v1::
                      StoragePoolsRetryPolicyOption::Type,
                  google::cloud::compute_storage_pools_v1::
                      StoragePoolsBackoffPolicyOption::Type>(
                  google::cloud::compute_storage_pools_v1::
