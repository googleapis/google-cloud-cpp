# HOWTO: using the Compute Engine API C++ client in your project

This directory contains small examples showing how to use the Compute Engine
API C++ client library in your own project. These instructions assume
...
1. Install the dependencies with your favorite tools. As an example, if you use
   ...
   ```bash
   cd $HOME/vcpkg
   ./vcpkg install google-cloud-cpp[core,compute]
   ```
