...
InterconnectAttachmentsConnection::~InterconnectAttachmentsConnection() = default;
...
InterconnectAttachmentsConnection::AggregatedListInterconnectAttachments(
    google::cloud::cpp::compute::interconnectAttachments::v1::AggregatedListInterconnectAttachmentsRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

StatusOr<google::cloud::cpp::compute::v1::Operation>
InterconnectAttachmentsConnection::DeleteInterconnectAttachments(
    google::cloud::cpp::compute::interconnectAttachments::v1::DeleteInterconnectAttachmentsRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

StatusOr<google::cloud::cpp::compute::v1::InterconnectAttachment>
InterconnectAttachmentsConnection::GetInterconnectAttachments(
    google::cloud::cpp::compute::interconnectAttachments::v1::GetInterconnectAttachmentsRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

StatusOr<google::cloud::cpp::compute::v1::Operation>
InterconnectAttachmentsConnection::InsertInterconnectAttachments(
    google::cloud::cpp::compute::interconnectAttachments::v1::InsertInterconnectAttachmentsRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

StreamRange<google::cloud::cpp::compute::v1::InterconnectAttachment> InterconnectAttachmentsConnection::ListInterconnectAttachments(
    google::cloud::cpp::compute::interconnectAttachments::v1::ListInterconnectAttachmentsRequest) {  // NOLINT(performance-unnecessary-value-param)
...
InterconnectAttachmentsConnection::PatchInterconnectAttachments(
    google::cloud::cpp::compute::interconnectAttachments::v1::PatchInterconnectAttachmentsRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

StatusOr<google::cloud::cpp::compute::v1::Operation>
InterconnectAttachmentsConnection::SetLabels(
    google::cloud::cpp::compute::interconnectAttachments::v1::SetLabelsRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}
