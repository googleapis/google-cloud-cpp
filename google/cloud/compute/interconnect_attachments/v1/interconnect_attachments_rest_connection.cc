...
std::shared_ptr<InterconnectAttachmentsConnection> MakeInterconnectAttachmentsConnectionRest(
    Options options) {
  internal::CheckExpectedOptions<CommonOptionList, RestOptionList,
      UnifiedCredentialsOptionList, rest_internal::TargetApiVersionOption,
      InterconnectAttachmentsPolicyOptionList>(options, __func__);
  options = compute_interconnect_attachments_v1_internal::InterconnectAttachmentsDefaultOptions(
      std::move(options));
  auto background = std::make_unique<
      rest_internal::AutomaticallyCreatedRestBackgroundThreads>();
  auto stub = compute_interconnect_attachments_v1_internal::CreateDefaultInterconnectAttachmentsRestStub(
      options);
  return compute_interconnect_attachments_v1_internal::MakeInterconnectAttachmentsTracingConnection(
      std::make_shared<
          compute_interconnect_attachments_v1_internal::InterconnectAttachmentsRestConnectionImpl>(
