...
GlobalNetworkEndpointGroupsConnection::AttachNetworkEndpoints(
    google::cloud::cpp::compute::globalNetworkEndpointGroups::v1::AttachNetworkEndpointsRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

StatusOr<google::cloud::cpp::compute::v1::Operation>
GlobalNetworkEndpointGroupsConnection::DeleteGlobalNetworkEndpointGroups(
    google::cloud::cpp::compute::globalNetworkEndpointGroups::v1::DeleteGlobalNetworkEndpointGroupsRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

StatusOr<google::cloud::cpp::compute::v1::Operation>
GlobalNetworkEndpointGroupsConnection::DetachNetworkEndpoints(
    google::cloud::cpp::compute::globalNetworkEndpointGroups::v1::DetachNetworkEndpointsRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

StatusOr<google::cloud::cpp::compute::v1::NetworkEndpointGroup>
GlobalNetworkEndpointGroupsConnection::GetGlobalNetworkEndpointGroups(
    google::cloud::cpp::compute::globalNetworkEndpointGroups::v1::GetGlobalNetworkEndpointGroupsRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

StatusOr<google::cloud::cpp::compute::v1::Operation>
GlobalNetworkEndpointGroupsConnection::InsertGlobalNetworkEndpointGroups(
    google::cloud::cpp::compute::globalNetworkEndpointGroups::v1::InsertGlobalNetworkEndpointGroupsRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}
...
StreamRange<google::cloud::cpp::compute::v1::NetworkEndpointGroup> GlobalNetworkEndpointGroupsConnection::ListGlobalNetworkEndpointGroups(
    google::cloud::cpp::compute::globalNetworkEndpointGroups::v1::ListGlobalNetworkEndpointGroupsRequest) {  // NOLINT(performance-unnecessary-value-param)
...
StreamRange<google::cloud::cpp::compute::v1::NetworkEndpointWithHealthStatus> GlobalNetworkEndpointGroupsConnection::ListNetworkEndpoints(
    google::cloud::cpp::compute::globalNetworkEndpointGroups::v1::ListNetworkEndpointsRequest) {  // NOLINT(performance-unnecessary-value-param)
  return google::cloud::internal::MakeUnimplementedPaginationRange<
