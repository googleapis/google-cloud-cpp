...
GlobalNetworkEndpointGroupsConnectionIdempotencyPolicy::
    ~GlobalNetworkEndpointGroupsConnectionIdempotencyPolicy() = default;
...
GlobalNetworkEndpointGroupsConnectionIdempotencyPolicy::clone() const {
  return std::make_unique<
      GlobalNetworkEndpointGroupsConnectionIdempotencyPolicy>(*this);
}

Idempotency
GlobalNetworkEndpointGroupsConnectionIdempotencyPolicy::AttachNetworkEndpoints(
...
Idempotency
GlobalNetworkEndpointGroupsConnectionIdempotencyPolicy::DetachNetworkEndpoints(
    google::cloud::cpp::compute::globalNetworkEndpointGroups::v1::
...
Idempotency GlobalNetworkEndpointGroupsConnectionIdempotencyPolicy::
    ListGlobalNetworkEndpointGroups(
        google::cloud::cpp::compute::globalNetworkEndpointGroups::v1::
            ListGlobalNetworkEndpointGroupsRequest) {  // NOLINT
  return Idempotency::kIdempotent;
}

Idempotency
GlobalNetworkEndpointGroupsConnectionIdempotencyPolicy::ListNetworkEndpoints(
    google::cloud::cpp::compute::globalNetworkEndpointGroups::v1::
