...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::compute_global_network_endpoint_groups_v1::GlobalNetworkEndpointGroupsClient(google::cloud::ExperimentalTag{},
      google::cloud::compute_global_network_endpoint_groups_v1::MakeGlobalNetworkEndpointGroupsConnectionRest(google::cloud::ExperimentalTag{},options));
  //! [set-client-endpoint]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::compute_global_network_endpoint_groups_v1::GlobalNetworkEndpointGroupsClient(google::cloud::ExperimentalTag{},
      google::cloud::compute_global_network_endpoint_groups_v1::MakeGlobalNetworkEndpointGroupsConnectionRest(google::cloud::ExperimentalTag{},options));
  }
  //! [with-service-account]
  (argv.at(0));
