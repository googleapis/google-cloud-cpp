...
GlobalNetworkEndpointGroupsRestMetadata::AsyncAttachNetworkEndpoints(
  ...
  return child_->AsyncAttachNetworkEndpoints(cq, std::move(rest_context), request);
}
...
GlobalNetworkEndpointGroupsRestMetadata::AsyncDeleteGlobalNetworkEndpointGroups(
  ...
  SetMetadata(*rest_context);
  return child_->AsyncDeleteGlobalNetworkEndpointGroups(cq, std::move(rest_context), request);
}
...
GlobalNetworkEndpointGroupsRestMetadata::AsyncDetachNetworkEndpoints(
  ...
  SetMetadata(*rest_context);
  return child_->AsyncDetachNetworkEndpoints(cq, std::move(rest_context), request);
}
...
GlobalNetworkEndpointGroupsRestMetadata::AsyncInsertGlobalNetworkEndpointGroups(
  ...
  SetMetadata(*rest_context);
  return child_->AsyncInsertGlobalNetworkEndpointGroups(cq, std::move(rest_context), request);
}
