...
GlobalNetworkEndpointGroupsRestConnectionImpl::GetGlobalNetworkEndpointGroups(
    google::cloud::cpp::compute::globalNetworkEndpointGroups::v1::
...
GlobalNetworkEndpointGroupsRestConnectionImpl::ListGlobalNetworkEndpointGroups(
  ...
  auto retry =
      std::shared_ptr<compute_global_network_endpoint_groups_v1::
                          GlobalNetworkEndpointGroupsRetryPolicy const>(
          retry_policy());
  auto backoff = std::shared_ptr<BackoffPolicy const>(backoff_policy());
  auto idempotency =
      idempotency_policy()->ListGlobalNetworkEndpointGroups(request);
  char const* function_name = __func__;
  return google::cloud::internal::MakePaginationRange<
      StreamRange<google::cloud::cpp::compute::v1::NetworkEndpointGroup>>(
      std::move(request),
      [stub, retry, backoff, idempotency,
       function_name](google::cloud::cpp::compute::globalNetworkEndpointGroups::
                          v1::ListGlobalNetworkEndpointGroupsRequest const& r) {
        return google::cloud::rest_internal::RestRetryLoop(
...
GlobalNetworkEndpointGroupsRestConnectionImpl::ListNetworkEndpoints(
  ...
  return google::cloud::internal::MakePaginationRange<StreamRange<
      ...
      [stub, retry, backoff, idempotency,
       function_name](google::cloud::cpp::compute::globalNetworkEndpointGroups::
                          v1::ListNetworkEndpointsRequest const& r) {
        return google::cloud::rest_internal::RestRetryLoop(
            retry->clone(), backoff->clone(), idempotency,
            [stub](rest_internal::RestContext& rest_context,
                   google::cloud::cpp::compute::globalNetworkEndpointGroups::
