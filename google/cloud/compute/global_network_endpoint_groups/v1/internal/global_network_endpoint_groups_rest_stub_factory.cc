...
CreateDefaultGlobalNetworkEndpointGroupsRestStub(Options& options) {
  ...
  std::shared_ptr<GlobalNetworkEndpointGroupsRestStub> stub =
      std::make_shared<DefaultGlobalNetworkEndpointGroupsRestStub>(
          std::move(stub_creation_opts));
  stub = std::make_shared<GlobalNetworkEndpointGroupsRestMetadata>(
      std::move(stub));
  if (internal::Contains(options.get<TracingComponentsOption>(), "rpc")) {
    GCP_LOG(INFO) << "Enabled logging for REST rpc calls";
    stub = std::make_shared<GlobalNetworkEndpointGroupsRestLogging>(
