...
StatusOr<google::cloud::cpp::compute::v1::TargetPoolAggregatedList>
TargetPoolsClient::AggregatedListTargetPools(google::cloud::cpp::compute::target_pools::v1::AggregatedListTargetPoolsRequest const& request, Options opts) {
  internal::OptionsSpan span(internal::MergeOptions(std::move(opts), options_));
  return connection_->AggregatedListTargetPools(request);
}
...
TargetPoolsClient::DeleteTargetPools(std::string const& project, std::string const& region, std::string const& target_pool, Options opts) {
  internal::OptionsSpan span(internal::MergeOptions(std::move(opts), options_));
  google::cloud::cpp::compute::target_pools::v1::DeleteTargetPoolsRequest request;
  request.set_project(project);
  request.set_region(region);
  request.set_target_pool(target_pool);
...
future<StatusOr<google::cloud::cpp::compute::v1::Operation>>
TargetPoolsClient::DeleteTargetPools(google::cloud::cpp::compute::target_pools::v1::DeleteTargetPoolsRequest const& request, Options opts) {
  internal::OptionsSpan span(internal::MergeOptions(std::move(opts), options_));
  return connection_->DeleteTargetPools(request);
}
...
StatusOr<google::cloud::cpp::compute::v1::TargetPool>
TargetPoolsClient::GetTargetPools(google::cloud::cpp::compute::target_pools::v1::GetTargetPoolsRequest const& request, Options opts) {
  internal::OptionsSpan span(internal::MergeOptions(std::move(opts), options_));
  return connection_->GetTargetPools(request);
}
...
TargetPoolsClient::InsertTargetPools(std::string const& project, std::string const& region, google::cloud::cpp::compute::v1::TargetPool const& target_pool_resource, Options opts) {
  internal::OptionsSpan span(internal::MergeOptions(std::move(opts), options_));
  google::cloud::cpp::compute::target_pools::v1::InsertTargetPoolsRequest request;
  request.set_project(project);
  request.set_region(region);
...
future<StatusOr<google::cloud::cpp::compute::v1::Operation>>
TargetPoolsClient::InsertTargetPools(google::cloud::cpp::compute::target_pools::v1::InsertTargetPoolsRequest const& request, Options opts) {
  internal::OptionsSpan span(internal::MergeOptions(std::move(opts), options_));
  return connection_->InsertTargetPools(request);
}
