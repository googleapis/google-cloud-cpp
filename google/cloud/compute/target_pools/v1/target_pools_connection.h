...
/**
 * A retry policy for `TargetPoolsConnection` that stops retrying after a
...
class TargetPoolsLimitedErrorCountRetryPolicy : public TargetPoolsRetryPolicy {
 public:
  TargetPoolsLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `TargetPoolsConnection` that stops retrying after
