...
// clang-format off
// main-dox-marker: compute_target_pools_v1::TargetPoolsClient
// lro-marker: true
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::compute_target_pools_v1::TargetPoolsClient(
      google::cloud::compute_target_pools_v1::MakeTargetPoolsConnectionRest(options));
  //! [set-client-endpoint]
}

//! [custom-idempotency-policy]
class CustomIdempotencyPolicy
   : public google::cloud::compute_target_pools_v1::TargetPoolsConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::compute_target_pools_v1::TargetPoolsConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::compute_target_pools_v1::TargetPoolsConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::compute_target_pools_v1::TargetPoolsRetryPolicyOption>(
      google::cloud::compute_target_pools_v1::TargetPoolsLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::compute_target_pools_v1::TargetPoolsBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::compute_target_pools_v1::MakeTargetPoolsConnectionRest(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::compute_target_pools_v1::TargetPoolsClient(connection);
  auto c2 = google::cloud::compute_target_pools_v1::TargetPoolsClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::compute_target_pools_v1::TargetPoolsClient(
    connection, google::cloud::Options{}.set<google::cloud::compute_target_pools_v1::TargetPoolsRetryPolicyOption>(
      google::cloud::compute_target_pools_v1::TargetPoolsLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::compute_target_pools_v1::TargetPoolsRetryPolicyOption>(
  //       google::cloud::compute_target_pools_v1::TargetPoolsLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::compute_target_pools_v1::TargetPoolsPollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::compute_target_pools_v1::TargetPoolsRetryPolicyOption::Type,
            google::cloud::compute_target_pools_v1::TargetPoolsBackoffPolicyOption::Type>(
            google::cloud::compute_target_pools_v1::TargetPoolsLimitedTimeRetryPolicy(
