...
StreamRange<std::pair<std::string, google::cloud::cpp::compute::v1::TargetPoolsScopedList>> TargetPoolsConnection::AggregatedListTargetPools(
    google::cloud::cpp::compute::target_pools::v1::AggregatedListTargetPoolsRequest) {  // NOLINT(performance-unnecessary-value-param)
...
TargetPoolsConnection::GetTargetPool(
...
StreamRange<google::cloud::cpp::compute::v1::TargetPool> TargetPoolsConnection::ListTargetPools(
    google::cloud::cpp::compute::target_pools::v1::ListTargetPoolsRequest) {  // NOLINT(performance-unnecessary-value-param)
  return google::cloud::internal::MakeUnimplementedPaginationRange<
