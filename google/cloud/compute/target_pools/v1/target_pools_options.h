 ...
 */
struct TargetPoolsRetryPolicyOption {
  using Type = std::shared_ptr<TargetPoolsRetryPolicy>;
};
 ...
 * @ingroup google-cloud-compute-options
 */
struct TargetPoolsBackoffPolicyOption {
 ...
 * @ingroup google-cloud-compute-options
 */
struct TargetPoolsConnectionIdempotencyPolicyOption {
  using Type = std::shared_ptr<TargetPoolsConnectionIdempotencyPolicy>;
};
 ...
 * @ingroup google-cloud-compute-options
 */
struct TargetPoolsPollingPolicyOption {
  using Type = std::shared_ptr<PollingPolicy>;
};

/**
 * The options applicable to TargetPools.
 *
 * @ingroup google-cloud-compute-options
 */
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_COMPUTE_TARGET_POOLS_V1_TARGET_POOLS_OPTIONS_H
