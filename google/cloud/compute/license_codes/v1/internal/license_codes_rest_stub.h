...
class LicenseCodesRestStub {
 public:
  ...
  virtual StatusOr<google::cloud::cpp::compute::v1::LicenseCode> GetLicenseCodes(
      ...
      google::cloud::cpp::compute::licenseCodes::v1::GetLicenseCodesRequest const& request) = 0;

  virtual StatusOr<google::cloud::cpp::compute::v1::TestPermissionsResponse> TestIamPermissions(
      google::cloud::rest_internal::RestContext& rest_context,
      google::cloud::cpp::compute::licenseCodes::v1::TestIamPermissionsRequest const& request) = 0;
};
