 ...
 */
struct LicenseCodesRetryPolicyOption {
  using Type = std::shared_ptr<LicenseCodesRetryPolicy>;
};
 ...
 * @ingroup google-cloud-compute-options
 */
struct LicenseCodesBackoffPolicyOption {
 ...
 * @ingroup google-cloud-compute-options
 */
struct LicenseCodesConnectionIdempotencyPolicyOption {
  using Type = std::shared_ptr<LicenseCodesConnectionIdempotencyPolicy>;
};

/**
 * The options applicable to LicenseCodes.
 *
 * @ingroup google-cloud-compute-options
 */
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_COMPUTE_LICENSE_CODES_V1_LICENSE_CODES_OPTIONS_H
