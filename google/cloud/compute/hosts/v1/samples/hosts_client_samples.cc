...
// clang-format off
// main-dox-marker: compute_hosts_v1::HostsClient
// lro-marker: true
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::compute_hosts_v1::HostsClient(
      google::cloud::compute_hosts_v1::MakeHostsConnectionRest(options));
  //! [set-client-endpoint]
}
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::compute_hosts_v1::HostsClient(
      google::cloud::compute_hosts_v1::MakeHostsConnectionRest(*ud_options));
  //! [set-client-universe-domain]
}

//! [custom-idempotency-policy]
class CustomIdempotencyPolicy
    : public google::cloud::compute_hosts_v1::HostsConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<
      google::cloud::compute_hosts_v1::HostsConnectionIdempotencyPolicy>
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options =
      google::cloud::Options{}
          .set<google::cloud::compute_hosts_v1::
                   HostsConnectionIdempotencyPolicyOption>(
              CustomIdempotencyPolicy().clone())
          .set<google::cloud::compute_hosts_v1::HostsRetryPolicyOption>(
              google::cloud::compute_hosts_v1::
                  HostsLimitedErrorCountRetryPolicy(3)
                      .clone())
          .set<google::cloud::compute_hosts_v1::HostsBackoffPolicyOption>(
  ...
  auto c1 = google::cloud::compute_hosts_v1::HostsClient(connection);
  auto c2 = google::cloud::compute_hosts_v1::HostsClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::compute_hosts_v1::HostsClient(
      connection,
      google::cloud::Options{}
          .set<google::cloud::compute_hosts_v1::HostsRetryPolicyOption>(
              google::cloud::compute_hosts_v1::HostsLimitedTimeRetryPolicy(
  ...
  //     .set<google::cloud::compute_hosts_v1::HostsRetryPolicyOption>(
  //       google::cloud::compute_hosts_v1::HostsLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options =
      google::cloud::Options{}
          .set<google::cloud::compute_hosts_v1::HostsPollingPolicyOption>(
              google::cloud::GenericPollingPolicy<
                  google::cloud::compute_hosts_v1::HostsRetryPolicyOption::Type,
                  google::cloud::compute_hosts_v1::HostsBackoffPolicyOption::
                      Type>(
                  google::cloud::compute_hosts_v1::HostsLimitedTimeRetryPolicy(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::compute_hosts_v1::HostsClient(
        google::cloud::compute_hosts_v1::MakeHostsConnectionRest(options));
  }
  //! [with-service-account]
  (argv.at(0));
