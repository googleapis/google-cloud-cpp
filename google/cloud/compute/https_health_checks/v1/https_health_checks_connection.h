...
/**
 * A retry policy for `HttpsHealthChecksConnection` that stops retrying after a
...
class HttpsHealthChecksLimitedErrorCountRetryPolicy
 ...
 public:
  HttpsHealthChecksLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `HttpsHealthChecksConnection` that stops retrying after
