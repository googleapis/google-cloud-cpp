...
class HttpsHealthChecksRestConnectionImpl
 ...
 public:
  ...
  DeleteHttpsHealthChecks(google::cloud::cpp::compute::httpsHealthChecks::v1::DeleteHttpsHealthChecksRequest const& request) override;

  StatusOr<google::cloud::cpp::compute::v1::HttpsHealthCheck>
  GetHttpsHealthChecks(google::cloud::cpp::compute::httpsHealthChecks::v1::GetHttpsHealthChecksRequest const& request) override;

  StatusOr<google::cloud::cpp::compute::v1::Operation>
  InsertHttpsHealthChecks(google::cloud::cpp::compute::httpsHealthChecks::v1::InsertHttpsHealthChecksRequest const& request) override;

  StreamRange<google::cloud::cpp::compute::v1::HttpsHealthCheck>
  ListHttpsHealthChecks(google::cloud::cpp::compute::httpsHealthChecks::v1::ListHttpsHealthChecksRequest request) override;

  StatusOr<google::cloud::cpp::compute::v1::Operation>
  PatchHttpsHealthChecks(google::cloud::cpp::compute::httpsHealthChecks::v1::PatchHttpsHealthChecksRequest const& request) override;

  StatusOr<google::cloud::cpp::compute::v1::Operation>
  UpdateHttpsHealthChecks(google::cloud::cpp::compute::httpsHealthChecks::v1::UpdateHttpsHealthChecksRequest const& request) override;
