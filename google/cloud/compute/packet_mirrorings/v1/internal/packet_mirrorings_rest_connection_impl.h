...
class PacketMirroringsRestConnectionImpl
 ...
 private:
  static std::unique_ptr<compute_packet_mirrorings_v1::PacketMirroringsRetryPolicy>
  ...
  static std::unique_ptr<compute_packet_mirrorings_v1::PacketMirroringsConnectionIdempotencyPolicy>
  ...
  static std::unique_ptr<PollingPolicy> polling_policy(Options const& options) {
    return options.get<compute_packet_mirrorings_v1::PacketMirroringsPollingPolicyOption>()->clone();
  }
