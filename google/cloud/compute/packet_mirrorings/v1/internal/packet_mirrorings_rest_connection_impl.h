...
clone();
  ...
  std::unique_ptr<PollingPolicy> polling_policy() {
    auto const& options = internal::CurrentOptions();
    if (options.has<compute_packet_mirrorings_v1::PacketMirroringsPollingPolicyOption>()) {
      return options.get<compute_packet_mirrorings_v1::PacketMirroringsPollingPolicyOption>()->clone();
    }
    return options_.get<compute_packet_mirrorings_v1::PacketMirroringsPollingPolicyOption>()->clone();
  }
