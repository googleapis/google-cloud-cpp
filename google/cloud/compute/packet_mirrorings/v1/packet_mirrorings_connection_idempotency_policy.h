...
class PacketMirroringsConnectionIdempotencyPolicy {
 public:
  ...
  virtual std::unique_ptr<PacketMirroringsConnectionIdempotencyPolicy> clone() const;

  virtual google::cloud::Idempotency
  AggregatedListPacketMirrorings(google::cloud::cpp::compute::packet_mirrorings::v1::AggregatedListPacketMirroringsRequest const& request);

  virtual google::cloud::Idempotency
  DeletePacketMirrorings(google::cloud::cpp::compute::packet_mirrorings::v1::DeletePacketMirroringsRequest const& request);

  virtual google::cloud::Idempotency
  GetPacketMirrorings(google::cloud::cpp::compute::packet_mirrorings::v1::GetPacketMirroringsRequest const& request);

  virtual google::cloud::Idempotency
  InsertPacketMirrorings(google::cloud::cpp::compute::packet_mirrorings::v1::InsertPacketMirroringsRequest const& request);

  virtual google::cloud::Idempotency
  ListPacketMirrorings(google::cloud::cpp::compute::packet_mirrorings::v1::ListPacketMirroringsRequest request);

  virtual google::cloud::Idempotency
  PatchPacketMirrorings(google::cloud::cpp::compute::packet_mirrorings::v1::PatchPacketMirroringsRequest const& request);
