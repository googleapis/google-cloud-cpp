...
/**
 * A retry policy for `PacketMirroringsConnection` that stops retrying after a
...
class PacketMirroringsLimitedErrorCountRetryPolicy
 ...
 public:
  PacketMirroringsLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `PacketMirroringsConnection` that stops retrying after
