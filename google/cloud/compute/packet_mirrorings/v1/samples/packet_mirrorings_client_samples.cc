...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::compute_packet_mirrorings_v1::PacketMirroringsClient(google::cloud::ExperimentalTag{},
      google::cloud::compute_packet_mirrorings_v1::MakePacketMirroringsConnectionRest(google::cloud::ExperimentalTag{},options));
  //! [set-client-endpoint]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::compute_packet_mirrorings_v1::PacketMirroringsClient(google::cloud::ExperimentalTag{},
      google::cloud::compute_packet_mirrorings_v1::MakePacketMirroringsConnectionRest(google::cloud::ExperimentalTag{},options));
  }
  //! [with-service-account]
  (argv.at(0));
