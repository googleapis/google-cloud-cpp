...
MakeReservationSubBlocksConnectionRest(Options options) {
  internal::CheckExpectedOptions<CommonOptionList, RestOptionList,
                                 UnifiedCredentialsOptionList,
                                 rest_internal::TargetApiVersionOption,
                                 ReservationSubBlocksPolicyOptionList>(
      options, __func__);
  options = compute_reservation_sub_blocks_v1_internal::
      ReservationSubBlocksDefaultOptions(std::move(options));
  auto background = std::make_unique<
      rest_internal::AutomaticallyCreatedRestBackgroundThreads>();
  auto stub = compute_reservation_sub_blocks_v1_internal::
      CreateDefaultReservationSubBlocksRestStub(options);
  return compute_reservation_sub_blocks_v1_internal::
      MakeReservationSubBlocksTracingConnection(
          std::make_shared<compute_reservation_sub_blocks_v1_internal::
