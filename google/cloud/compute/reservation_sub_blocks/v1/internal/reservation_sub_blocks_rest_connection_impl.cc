...
ReservationSubBlocksRestConnectionImpl::GetIamPolicy(
    google::cloud::cpp::compute::reservation_sub_blocks::v1::
...
ReservationSubBlocksRestConnectionImpl::GetVersion(
    google::cloud::cpp::compute::reservation_sub_blocks::v1::
...
future<StatusOr<google::cloud::cpp::compute::v1::Operation>>
ReservationSubBlocksRestConnectionImpl::PerformMaintenance(
    google::cloud::cpp::compute::reservation_sub_blocks::v1::
...
future<StatusOr<google::cloud::cpp::compute::v1::Operation>>
ReservationSubBlocksRestConnectionImpl::ReportFaulty(
    google::cloud::cpp::compute::reservation_sub_blocks::v1::
  ...
  return rest_internal::AsyncRestLongRunningOperation<
      ...
      [stub = stub_](CompletionQueue& cq,
                     ...
                     google::cloud::cpp::compute::reservation_sub_blocks::v1::
                         ReportFaultyRequest const& request) {
        return stub->AsyncReportFaulty(cq, std::move(context),
                                       std::move(options), request);
      },
      [stub = stub_](CompletionQueue& cq,
                     std::unique_ptr<rest_internal::RestContext> context,
      ...
      [](StatusOr<google::cloud::cpp::compute::v1::Operation> op,
         std::string const&) { return op; },
      retry_policy(*current), backoff_policy(*current),
      idempotency_policy(*current)->ReportFaulty(request),
      polling_policy(*current), __func__,
      [](google::cloud::cpp::compute::v1::Operation const& op) {
        return op.status() == "DONE";
      },
...
ReservationSubBlocksRestConnectionImpl::ReportFaulty(
  ...
  return google::cloud::rest_internal::RestRetryLoop(
      ...
      [this](rest_internal::RestContext& rest_context, Options const& options,
             google::cloud::cpp::compute::reservation_sub_blocks::v1::
                 ReportFaultyRequest const& request) {
        return stub_->ReportFaulty(rest_context, options, request);
      },
      *current, request, __func__);
}
...
StatusOr<google::cloud::cpp::compute::v1::Policy>
ReservationSubBlocksRestConnectionImpl::SetIamPolicy(
    google::cloud::cpp::compute::reservation_sub_blocks::v1::
...
ReservationSubBlocksRestConnectionImpl::TestIamPermissions(
    google::cloud::cpp::compute::reservation_sub_blocks::v1::
