...
using InterconnectLocationsRetryPolicy = ::google::cloud::internal::TraitBasedRetryPolicy<
    compute_interconnect_locations_v1_internal::InterconnectLocationsRetryTraits>;

using InterconnectLocationsLimitedTimeRetryPolicy = ::google::cloud::internal::LimitedTimeRetryPolicy<
    compute_interconnect_locations_v1_internal::InterconnectLocationsRetryTraits>;
...
class InterconnectLocationsConnection {
 public:
  ...
  GetInterconnectLocations(google::cloud::cpp::compute::interconnectLocations::v1::GetInterconnectLocationsRequest const& request);

  virtual StreamRange<google::cloud::cpp::compute::v1::InterconnectLocation>
  ListInterconnectLocations(google::cloud::cpp::compute::interconnectLocations::v1::ListInterconnectLocationsRequest request);
};
