 ...
 */
class InterconnectLocationsLimitedErrorCountRetryPolicy : public InterconnectLocationsRetryPolicy {
 public:
  /**
   ...
   */
  explicit InterconnectLocationsLimitedErrorCountRetryPolicy(int maximum_failures)
    : impl_(maximum_failures) {}

  InterconnectLocationsLimitedErrorCountRetryPolicy(
      InterconnectLocationsLimitedErrorCountRetryPolicy&& rhs) noexcept
    : InterconnectLocationsLimitedErrorCountRetryPolicy(rhs.maximum_failures()) {}
  InterconnectLocationsLimitedErrorCountRetryPolicy(
 ...
 private:
  google::cloud::internal::LimitedErrorCountRetryPolicy<compute_interconnect_locations_v1_internal::InterconnectLocationsRetryTraits> impl_;
};
 ...
 * - [`kUnavailable`](@ref google::cloud::StatusCode)
 */
class InterconnectLocationsLimitedTimeRetryPolicy : public InterconnectLocationsRetryPolicy {
 public:
  /**
  ...
  InterconnectLocationsLimitedTimeRetryPolicy(InterconnectLocationsLimitedTimeRetryPolicy&& rhs) noexcept
    : InterconnectLocationsLimitedTimeRetryPolicy(rhs.maximum_duration()) {}
  InterconnectLocationsLimitedTimeRetryPolicy(InterconnectLocationsLimitedTimeRetryPolicy const& rhs) noexcept
    : InterconnectLocationsLimitedTimeRetryPolicy(rhs.maximum_duration()) {}
 ...
 private:
  google::cloud::internal::LimitedTimeRetryPolicy<compute_interconnect_locations_v1_internal::InterconnectLocationsRetryTraits> impl_;
};
 ...
 * sets in `InterconnectLocationsClient`. This allows users to inject custom behavior
...
class InterconnectLocationsConnection {
 public:
  ...
  GetInterconnectLocation(google::cloud::cpp::compute::interconnect_locations::v1::GetInterconnectLocationRequest const& request);
