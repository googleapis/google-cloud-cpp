...
std::shared_ptr<InterconnectLocationsConnection> MakeInterconnectLocationsConnectionRest(
    Options options) {
  internal::CheckExpectedOptions<CommonOptionList, RestOptionList,
      UnifiedCredentialsOptionList, rest_internal::TargetApiVersionOption,
      InterconnectLocationsPolicyOptionList>(options, __func__);
  options = compute_interconnect_locations_v1_internal::InterconnectLocationsDefaultOptions(
      std::move(options));
  auto background = std::make_unique<
      rest_internal::AutomaticallyCreatedRestBackgroundThreads>();
  auto stub = compute_interconnect_locations_v1_internal::CreateDefaultInterconnectLocationsRestStub(
      options);
  return compute_interconnect_locations_v1_internal::MakeInterconnectLocationsTracingConnection(
      std::make_shared<
          compute_interconnect_locations_v1_internal::InterconnectLocationsRestConnectionImpl>(
