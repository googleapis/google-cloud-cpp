...
InterconnectLocationsRestConnectionImpl::ListInterconnectLocations(
    google::cloud::cpp::compute::interconnectLocations::v1::
        ListInterconnectLocationsRequest request) {
  request.clear_page_token();
  auto& stub = stub_;
  auto retry = std::shared_ptr<compute_interconnect_locations_v1::
                                   InterconnectLocationsRetryPolicy const>(
      retry_policy());
  ...
  return google::cloud::internal::MakePaginationRange<
      ...
      [stub, retry, backoff, idempotency,
       function_name](google::cloud::cpp::compute::interconnectLocations::v1::
