...
DefaultInterconnectLocationsRestStub::DefaultInterconnectLocationsRestStub(Options options)
...
DefaultInterconnectLocationsRestStub::GetInterconnectLocation(
  ...
  return rest_internal::Get<google::cloud::cpp::compute::v1::InterconnectLocation>(
      *service_, rest_context, request, false,
      absl::StrCat("/", "compute", "/", rest_internal::DetermineApiVersion("v1", options), "/", "projects", "/", request.project(), "/", "global", "/", "interconnectLocations", "/", request.interconnect_location()), std::move(query_params));
}
...
DefaultInterconnectLocationsRestStub::ListInterconnectLocations(
  ...
  return rest_internal::Get<google::cloud::cpp::compute::v1::InterconnectLocationList>(
      *service_, rest_context, request, false,
      absl::StrCat("/", "compute", "/", rest_internal::DetermineApiVersion("v1", options), "/", "projects", "/", request.project(), "/", "global", "/", "interconnectLocations"), std::move(query_params));
}
