...
DefaultInterconnectLocationsRestStub::GetInterconnectLocations(
  ...
  return rest_internal::Get<google::cloud::cpp::compute::v1::InterconnectLocation>(
      *service_, rest_context, request,
      absl::StrCat("/compute/v1/projects/", request.project(), "/global/interconnectLocations/", request.interconnect_location(), ""),
...
DefaultInterconnectLocationsRestStub::ListInterconnectLocations(
  ...
  return rest_internal::Get<google::cloud::cpp::compute::v1::InterconnectLocationList>(
      *service_, rest_context, request,
      absl::StrCat("/compute/v1/projects/", request.project(), "/global/interconnectLocations"),
