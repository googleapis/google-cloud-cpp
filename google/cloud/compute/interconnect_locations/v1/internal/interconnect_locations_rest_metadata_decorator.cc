...
InterconnectLocationsRestMetadata::GetInterconnectLocations(
    ...
    google::cloud::cpp::compute::interconnect_locations::v1::GetInterconnectLocationsRequest const& request) {
...
InterconnectLocationsRestMetadata::ListInterconnectLocations(
    rest_internal::RestContext& rest_context,
    google::cloud::cpp::compute::interconnect_locations::v1::ListInterconnectLocationsRequest const& request) {
  SetMetadata(rest_context);
