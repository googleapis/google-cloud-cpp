...
InterconnectLocationsConnection::GetInterconnectLocations(
    google::cloud::cpp::compute::interconnectLocations::v1::GetInterconnectLocationsRequest const&) {
...
StreamRange<google::cloud::cpp::compute::v1::InterconnectLocation> InterconnectLocationsConnection::ListInterconnectLocations(
    google::cloud::cpp::compute::interconnectLocations::v1::ListInterconnectLocationsRequest) {  // NOLINT(performance-unnecessary-value-param)
