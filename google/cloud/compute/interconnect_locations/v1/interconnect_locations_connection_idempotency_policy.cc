...
Idempotency InterconnectLocationsConnectionIdempotencyPolicy::GetInterconnectLocations(google::cloud::cpp::compute::interconnectLocations::v1::GetInterconnectLocationsRequest const&) {
  return Idempotency::kIdempotent;
}

Idempotency InterconnectLocationsConnectionIdempotencyPolicy::ListInterconnectLocations(google::cloud::cpp::compute::interconnectLocations::v1::ListInterconnectLocationsRequest) {  // NOLINT
  return Idempotency::kIdempotent;
}
