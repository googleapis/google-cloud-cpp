...
Idempotency InterconnectLocationsConnectionIdempotencyPolicy::GetInterconnectLocation(google::cloud::cpp::compute::interconnect_locations::v1::GetInterconnectLocationRequest const&) {
