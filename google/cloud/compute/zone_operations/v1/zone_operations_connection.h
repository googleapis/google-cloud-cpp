...
/**
 * A retry policy for `ZoneOperationsConnection` that stops retrying after a
...
class ZoneOperationsLimitedErrorCountRetryPolicy
 ...
 public:
  ZoneOperationsLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `ZoneOperationsConnection` that stops retrying after
