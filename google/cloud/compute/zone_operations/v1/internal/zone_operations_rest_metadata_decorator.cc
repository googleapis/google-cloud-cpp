...
Status
ZoneOperationsRestMetadata::DeleteOperation(
...
ZoneOperationsRestMetadata::GetOperation(
    rest_internal::RestContext& rest_context,
...
ZoneOperationsRestMetadata::ListZoneOperations(
    rest_internal::RestContext& rest_context,
    Options const& options, google::cloud::cpp::compute::zone_operations::v1::ListZoneOperationsRequest const& request) {
  SetMetadata(rest_context, options);
  return child_->ListZoneOperations(rest_context, options, request);
}
