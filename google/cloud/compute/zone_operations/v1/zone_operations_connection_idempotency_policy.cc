...
Idempotency ZoneOperationsConnectionIdempotencyPolicy::DeleteZoneOperations(google::cloud::cpp::compute::zone_operations::v1::DeleteZoneOperationsRequest const&) {
  return Idempotency::kNonIdempotent;
}

Idempotency ZoneOperationsConnectionIdempotencyPolicy::GetZoneOperations(google::cloud::cpp::compute::zone_operations::v1::GetZoneOperationsRequest const&) {
  return Idempotency::kIdempotent;
}

Idempotency ZoneOperationsConnectionIdempotencyPolicy::ListZoneOperations(google::cloud::cpp::compute::zone_operations::v1::ListZoneOperationsRequest) {  // NOLINT
  return Idempotency::kIdempotent;
}

Idempotency ZoneOperationsConnectionIdempotencyPolicy::Wait(google::cloud::cpp::compute::zone_operations::v1::WaitRequest const&) {
  return Idempotency::kNonIdempotent;
}
