...
ZoneOperationsClient::DeleteZoneOperations(std::string const& project, std::string const& zone, std::string const& operation, Options opts) {
  ...
  google::cloud::cpp::compute::zone_operations::v1::DeleteZoneOperationsRequest request;
...
Status
ZoneOperationsClient::DeleteZoneOperations(google::cloud::cpp::compute::zone_operations::v1::DeleteZoneOperationsRequest const& request, Options opts) {
  internal::OptionsSpan span(internal::MergeOptions(std::move(opts), options_));
  return connection_->DeleteZoneOperations(request);
}
...
ZoneOperationsClient::GetZoneOperations(std::string const& project, std::string const& zone, std::string const& operation, Options opts) {
  internal::OptionsSpan span(internal::MergeOptions(std::move(opts), options_));
  google::cloud::cpp::compute::zone_operations::v1::GetZoneOperationsRequest request;
  request.set_project(project);
  request.set_zone(zone);
  request.set_operation(operation);
...
StatusOr<google::cloud::cpp::compute::v1::Operation>
ZoneOperationsClient::GetZoneOperations(google::cloud::cpp::compute::zone_operations::v1::GetZoneOperationsRequest const& request, Options opts) {
  internal::OptionsSpan span(internal::MergeOptions(std::move(opts), options_));
  return connection_->GetZoneOperations(request);
}
