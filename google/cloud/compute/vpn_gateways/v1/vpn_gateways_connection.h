...
/**
 * A retry policy for `VpnGatewaysConnection` that stops retrying after a
...
class VpnGatewaysLimitedErrorCountRetryPolicy : public VpnGatewaysRetryPolicy {
 public:
  VpnGatewaysLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `VpnGatewaysConnection` that stops retrying after
