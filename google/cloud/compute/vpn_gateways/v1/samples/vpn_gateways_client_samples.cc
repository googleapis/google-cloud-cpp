...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::compute_vpn_gateways_v1::VpnGatewaysClient(
      google::cloud::compute_vpn_gateways_v1::MakeVpnGatewaysConnectionRest(options));
  //! [set-client-endpoint]
}

//! [custom-idempotency-policy]
class CustomIdempotencyPolicy
   : public google::cloud::compute_vpn_gateways_v1::VpnGatewaysConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::compute_vpn_gateways_v1::VpnGatewaysConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::compute_vpn_gateways_v1::VpnGatewaysConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::compute_vpn_gateways_v1::VpnGatewaysRetryPolicyOption>(
      google::cloud::compute_vpn_gateways_v1::VpnGatewaysLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::compute_vpn_gateways_v1::VpnGatewaysBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::compute_vpn_gateways_v1::MakeVpnGatewaysConnectionRest(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::compute_vpn_gateways_v1::VpnGatewaysClient(connection);
  auto c2 = google::cloud::compute_vpn_gateways_v1::VpnGatewaysClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::compute_vpn_gateways_v1::VpnGatewaysClient(
    connection, google::cloud::Options{}.set<google::cloud::compute_vpn_gateways_v1::VpnGatewaysRetryPolicyOption>(
      google::cloud::compute_vpn_gateways_v1::VpnGatewaysLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::compute_vpn_gateways_v1::VpnGatewaysRetryPolicyOption>(
  //       google::cloud::compute_vpn_gateways_v1::VpnGatewaysLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::compute_vpn_gateways_v1::VpnGatewaysPollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::compute_vpn_gateways_v1::VpnGatewaysRetryPolicyOption::Type,
            google::cloud::compute_vpn_gateways_v1::VpnGatewaysBackoffPolicyOption::Type>(
            google::cloud::compute_vpn_gateways_v1::VpnGatewaysLimitedTimeRetryPolicy(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::compute_vpn_gateways_v1::VpnGatewaysClient(
      google::cloud::compute_vpn_gateways_v1::MakeVpnGatewaysConnectionRest(options));
  }
  //! [with-service-account]
  (argv.at(0));
