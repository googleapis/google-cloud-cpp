 ...
 */
struct VpnGatewaysRetryPolicyOption {
  using Type = std::shared_ptr<VpnGatewaysRetryPolicy>;
};
 ...
 * @ingroup google-cloud-compute-options
 */
struct VpnGatewaysBackoffPolicyOption {
 ...
 * @ingroup google-cloud-compute-options
 */
struct VpnGatewaysConnectionIdempotencyPolicyOption {
  using Type = std::shared_ptr<VpnGatewaysConnectionIdempotencyPolicy>;
};
 ...
 * @ingroup google-cloud-compute-options
 */
struct VpnGatewaysPollingPolicyOption {
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_COMPUTE_VPN_GATEWAYS_V1_VPN_GATEWAYS_OPTIONS_H
