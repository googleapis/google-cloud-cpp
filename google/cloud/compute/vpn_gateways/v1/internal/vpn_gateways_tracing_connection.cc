...
VpnGatewaysTracingConnection::AggregatedListVpnGateways(google::cloud::cpp::compute::vpnGateways::v1::AggregatedListVpnGatewaysRequest const& request) {
...
VpnGatewaysTracingConnection::DeleteVpnGateways(google::cloud::cpp::compute::vpnGateways::v1::DeleteVpnGatewaysRequest const& request) {
  auto span = internal::MakeSpan("compute_vpn_gateways_v1::VpnGatewaysConnection::DeleteVpnGateways");
  auto scope = opentelemetry::trace::Scope(span);
  return internal::EndSpan(*span, child_->DeleteVpnGateways(request));
}

StatusOr<google::cloud::cpp::compute::v1::VpnGateway>
VpnGatewaysTracingConnection::GetVpnGateways(google::cloud::cpp::compute::vpnGateways::v1::GetVpnGatewaysRequest const& request) {
...
VpnGatewaysTracingConnection::GetStatus(google::cloud::cpp::compute::vpnGateways::v1::GetStatusRequest const& request) {
...
StatusOr<google::cloud::cpp::compute::v1::Operation>
VpnGatewaysTracingConnection::InsertVpnGateways(google::cloud::cpp::compute::vpnGateways::v1::InsertVpnGatewaysRequest const& request) {
  auto span = internal::MakeSpan("compute_vpn_gateways_v1::VpnGatewaysConnection::InsertVpnGateways");
  auto scope = opentelemetry::trace::Scope(span);
  return internal::EndSpan(*span, child_->InsertVpnGateways(request));
}

StreamRange<google::cloud::cpp::compute::v1::VpnGateway>
VpnGatewaysTracingConnection::ListVpnGateways(google::cloud::cpp::compute::vpnGateways::v1::ListVpnGatewaysRequest request) {
...
StatusOr<google::cloud::cpp::compute::v1::Operation>
VpnGatewaysTracingConnection::SetLabels(google::cloud::cpp::compute::vpnGateways::v1::SetLabelsRequest const& request) {
  auto span = internal::MakeSpan("compute_vpn_gateways_v1::VpnGatewaysConnection::SetLabels");
  auto scope = opentelemetry::trace::Scope(span);
  return internal::EndSpan(*span, child_->SetLabels(request));
}

StatusOr<google::cloud::cpp::compute::v1::TestPermissionsResponse>
VpnGatewaysTracingConnection::TestIamPermissions(google::cloud::cpp::compute::vpnGateways::v1::TestIamPermissionsRequest const& request) {
