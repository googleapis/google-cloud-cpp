...
VpnGatewaysRestConnectionImpl::AggregatedListVpnGateways(google::cloud::cpp::compute::vpnGateways::v1::AggregatedListVpnGatewaysRequest const& request) {
...
VpnGatewaysRestConnectionImpl::DeleteVpnGateways(google::cloud::cpp::compute::vpnGateways::v1::DeleteVpnGatewaysRequest const& request) {
  return google::cloud::rest_internal::RestRetryLoop(
      retry_policy(), backoff_policy(),
      ...
      [this](rest_internal::RestContext& rest_context,
        ...
        return stub_->DeleteVpnGateways(rest_context, request);
      },
      request, __func__);
}

StatusOr<google::cloud::cpp::compute::v1::VpnGateway>
VpnGatewaysRestConnectionImpl::GetVpnGateways(google::cloud::cpp::compute::vpnGateways::v1::GetVpnGatewaysRequest const& request) {
  return google::cloud::rest_internal::RestRetryLoop(
      retry_policy(), backoff_policy(),
...
VpnGatewaysRestConnectionImpl::GetStatus(google::cloud::cpp::compute::vpnGateways::v1::GetStatusRequest const& request) {
  return google::cloud::rest_internal::RestRetryLoop(
      retry_policy(), backoff_policy(),
...
StatusOr<google::cloud::cpp::compute::v1::Operation>
VpnGatewaysRestConnectionImpl::InsertVpnGateways(google::cloud::cpp::compute::vpnGateways::v1::InsertVpnGatewaysRequest const& request) {
  return google::cloud::rest_internal::RestRetryLoop(
      retry_policy(), backoff_policy(),
      ...
      [this](rest_internal::RestContext& rest_context,
        ...
        return stub_->InsertVpnGateways(rest_context, request);
      },
      request, __func__);
}

StreamRange<google::cloud::cpp::compute::v1::VpnGateway>
VpnGatewaysRestConnectionImpl::ListVpnGateways(google::cloud::cpp::compute::vpnGateways::v1::ListVpnGatewaysRequest request) {
  ...
  return google::cloud::internal::MakePaginationRange<StreamRange<google::cloud::cpp::compute::v1::VpnGateway>>(
      ...
      [stub, retry, backoff, idempotency, function_name]
        (google::cloud::cpp::compute::vpnGateways::v1::ListVpnGatewaysRequest const& r) {
        return google::cloud::rest_internal::RestRetryLoop(
            retry->clone(), backoff->clone(), idempotency,
            [stub](rest_internal::RestContext& rest_context, google::cloud::cpp::compute::vpnGateways::v1::ListVpnGatewaysRequest const& request) {
...
StatusOr<google::cloud::cpp::compute::v1::Operation>
VpnGatewaysRestConnectionImpl::SetLabels(google::cloud::cpp::compute::vpnGateways::v1::SetLabelsRequest const& request) {
  return google::cloud::rest_internal::RestRetryLoop(
      retry_policy(), backoff_policy(),
...
VpnGatewaysRestConnectionImpl::TestIamPermissions(google::cloud::cpp::compute::vpnGateways::v1::TestIamPermissionsRequest const& request) {
  return google::cloud::rest_internal::RestRetryLoop(
      retry_policy(), backoff_policy(),
