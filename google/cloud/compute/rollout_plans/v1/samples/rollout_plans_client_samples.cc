...
// clang-format off
// main-dox-marker: compute_rollout_plans_v1::RolloutPlansClient
// lro-marker: true
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::compute_rollout_plans_v1::RolloutPlansClient(
      google::cloud::compute_rollout_plans_v1::MakeRolloutPlansConnectionRest(
          options));
  //! [set-client-endpoint]
}
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::compute_rollout_plans_v1::RolloutPlansClient(
      google::cloud::compute_rollout_plans_v1::MakeRolloutPlansConnectionRest(
          *ud_options));
  //! [set-client-universe-domain]
}
...
class CustomIdempotencyPolicy : public google::cloud::compute_rollout_plans_v1::
                                    RolloutPlansConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::compute_rollout_plans_v1::
                      RolloutPlansConnectionIdempotencyPolicy>
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
                     .set<google::cloud::compute_rollout_plans_v1::
                              RolloutPlansConnectionIdempotencyPolicyOption>(
                         CustomIdempotencyPolicy().clone())
                     .set<google::cloud::compute_rollout_plans_v1::
                              RolloutPlansRetryPolicyOption>(
                         google::cloud::compute_rollout_plans_v1::
                             RolloutPlansLimitedErrorCountRetryPolicy(3)
                                 .clone())
                     .set<google::cloud::compute_rollout_plans_v1::
  ...
  auto c1 =
      google::cloud::compute_rollout_plans_v1::RolloutPlansClient(connection);
  auto c2 =
      google::cloud::compute_rollout_plans_v1::RolloutPlansClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::compute_rollout_plans_v1::RolloutPlansClient(
      connection,
      google::cloud::Options{}
          .set<google::cloud::compute_rollout_plans_v1::
                   RolloutPlansRetryPolicyOption>(
              google::cloud::compute_rollout_plans_v1::
                  RolloutPlansLimitedTimeRetryPolicy(std::chrono::minutes(5))
                      .clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::compute_rollout_plans_v1::RolloutPlansRetryPolicyOption>(
  //       google::cloud::compute_rollout_plans_v1::RolloutPlansLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
      ...
      google::cloud::Options{}
          .set<google::cloud::compute_rollout_plans_v1::
              ...
              google::cloud::GenericPollingPolicy<
                  google::cloud::compute_rollout_plans_v1::
                      RolloutPlansRetryPolicyOption::Type,
                  google::cloud::compute_rollout_plans_v1::
                      RolloutPlansBackoffPolicyOption::Type>(
                  google::cloud::compute_rollout_plans_v1::
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::compute_rollout_plans_v1::RolloutPlansClient(
        google::cloud::compute_rollout_plans_v1::MakeRolloutPlansConnectionRest(
            options));
  }
  //! [with-service-account]
