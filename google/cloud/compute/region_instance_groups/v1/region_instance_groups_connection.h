...
class RegionInstanceGroupsLimitedErrorCountRetryPolicy
 ...
 public:
   ...
   */
  explicit RegionInstanceGroupsLimitedErrorCountRetryPolicy(
...
class RegionInstanceGroupsConnection {
 public:
  ...
  GetInstanceGroup(google::cloud::cpp::compute::region_instance_groups::v1::
  ...
  SetNamedPorts(google::cloud::cpp::compute::region_instance_groups::v1::
  ...
  virtual future<StatusOr<google::cloud::cpp::compute::v1::Operation>>
  SetNamedPorts(google::cloud::ExperimentalTag,
