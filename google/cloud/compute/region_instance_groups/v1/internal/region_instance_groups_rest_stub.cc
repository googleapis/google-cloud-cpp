...
DefaultRegionInstanceGroupsRestStub::GetRegionInstanceGroups(
      ...
      google::cloud::cpp::compute::region_instance_groups::v1::GetRegionInstanceGroupsRequest const& request) {
  return rest_internal::Get<google::cloud::cpp::compute::v1::InstanceGroup>(
      *service_, rest_context, request,
      absl::StrCat("/compute/v1/projects/", request.project(), "/regions/", request.region(), "/instanceGroups/", request.instance_group(), ""),
...
DefaultRegionInstanceGroupsRestStub::ListRegionInstanceGroups(
  ...
  return rest_internal::Get<google::cloud::cpp::compute::v1::RegionInstanceGroupList>(
      *service_, rest_context, request,
      absl::StrCat("/compute/v1/projects/", request.project(), "/regions/", request.region(), "/instanceGroups"),
...
DefaultRegionInstanceGroupsRestStub::ListInstances(
  ...
  return rest_internal::Post<google::cloud::cpp::compute::v1::RegionInstanceGroupsListInstances>(
      *service_, rest_context, request.region_instance_groups_list_instances_request_resource(),
      absl::StrCat("/compute/v1/projects/", request.project(), "/regions/", request.region(), "/instanceGroups/", request.instance_group(), "/listInstances"));
}
  ...
  std::thread t{[](auto p, auto service, auto request, auto rest_context) {
      p.set_value(rest_internal::Post<google::cloud::cpp::compute::v1::Operation>(
          *service, *rest_context, request.region_instance_groups_set_named_ports_request_resource(),
          absl::StrCat("/compute/v1/projects/", request.project(), "/regions/", request.region(), "/instanceGroups/", request.instance_group(), "/setNamedPorts")));
