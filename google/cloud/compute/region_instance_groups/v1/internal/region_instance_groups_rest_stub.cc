...
DefaultRegionInstanceGroupsRestStub::GetInstanceGroup(
  ...
  return rest_internal::Get<google::cloud::cpp::compute::v1::InstanceGroup>(
      *service_, rest_context, request, false,
      absl::StrCat("/", "compute", "/", rest_internal::DetermineApiVersion("v1", options), "/", "projects", "/", request.project(), "/", "regions", "/", request.region(), "/", "instanceGroups", "/", request.instance_group()), std::move(query_params));
}
...
DefaultRegionInstanceGroupsRestStub::ListRegionInstanceGroups(
  ...
  return rest_internal::Get<google::cloud::cpp::compute::v1::RegionInstanceGroupList>(
      *service_, rest_context, request, false,
      absl::StrCat("/", "compute", "/", rest_internal::DetermineApiVersion("v1", options), "/", "projects", "/", request.project(), "/", "regions", "/", request.region(), "/", "instanceGroups"), std::move(query_params));
}
...
DefaultRegionInstanceGroupsRestStub::ListInstances(
  ...
  return rest_internal::Post<google::cloud::cpp::compute::v1::RegionInstanceGroupsListInstances>(
      *service_, rest_context, request.region_instance_groups_list_instances_request_resource(), false,
      absl::StrCat("/", "compute", "/", rest_internal::DetermineApiVersion("v1", options), "/", "projects", "/", request.project(), "/", "regions", "/", request.region(), "/", "instanceGroups", "/", request.instance_group(), "/", "listInstances"), std::move(query_params));
}
...
DefaultRegionInstanceGroupsRestStub::AsyncSetNamedPorts(
  ...
  query_params = rest_internal::TrimEmptyQueryParameters(std::move(query_params));
      p.set_value(rest_internal::Post<google::cloud::cpp::compute::v1::Operation>(
          *service, *rest_context, request.region_instance_groups_set_named_ports_request_resource(),
          false,
          absl::StrCat("/", "compute", "/", rest_internal::DetermineApiVersion("v1", *options), "/", "projects", "/", request.project(), "/", "regions", "/", request.region(), "/", "instanceGroups", "/", request.instance_group(), "/", "setNamedPorts"), std::move(query_params)));
    },
...
DefaultRegionInstanceGroupsRestStub::SetNamedPorts(
  ...
  return rest_internal::Post<google::cloud::cpp::compute::v1::Operation>(
      *service_, rest_context, request.region_instance_groups_set_named_ports_request_resource(), false,
      absl::StrCat("/", "compute", "/", rest_internal::DetermineApiVersion("v1", options), "/", "projects", "/", request.project(), "/", "regions", "/", request.region(), "/", "instanceGroups", "/", request.instance_group(), "/", "setNamedPorts"), std::move(query_params));
}
...
future<Status>
DefaultRegionInstanceGroupsRestStub::AsyncCancelOperation(
    google::cloud::CompletionQueue& cq,
    std::unique_ptr<rest_internal::RestContext> rest_context,
    google::cloud::internal::ImmutableOptions options,
