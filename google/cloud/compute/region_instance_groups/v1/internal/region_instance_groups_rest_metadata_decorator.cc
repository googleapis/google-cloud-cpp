...
RegionInstanceGroupsRestMetadata::GetInstanceGroup(
    ...
    Options const& options, google::cloud::cpp::compute::region_instance_groups::v1::GetInstanceGroupRequest const& request) {
...
RegionInstanceGroupsRestMetadata::ListRegionInstanceGroups(
    rest_internal::RestContext& rest_context,
    Options const& options, google::cloud::cpp::compute::region_instance_groups::v1::ListRegionInstanceGroupsRequest const& request) {
  SetMetadata(rest_context, options);
...
RegionInstanceGroupsRestMetadata::ListInstances(
    rest_internal::RestContext& rest_context,
    Options const& options, google::cloud::cpp::compute::region_instance_groups::v1::ListInstancesRequest const& request) {
  SetMetadata(rest_context, options);
...
RegionInstanceGroupsRestMetadata::SetNamedPorts(
    rest_internal::RestContext& rest_context,
    Options const& options, google::cloud::cpp::compute::region_instance_groups::v1::SetNamedPortsRequest const& request) {
  SetMetadata(rest_context, options);
...
future<Status>
RegionInstanceGroupsRestMetadata::AsyncCancelOperation(
    google::cloud::CompletionQueue& cq,
    std::unique_ptr<rest_internal::RestContext> rest_context,
    google::cloud::internal::ImmutableOptions options,
