...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_COMPUTE_REGION_INSTANCE_GROUPS_V1_INTERNAL_REGION_INSTANCE_GROUPS_REST_METADATA_DECORATOR_H
...
class RegionInstanceGroupsRestMetadata : public RegionInstanceGroupsRestStub {
 public:
  ...
  StatusOr<google::cloud::cpp::compute::v1::InstanceGroup> GetInstanceGroup(
      ...
      Options const& options, google::cloud::cpp::compute::region_instance_groups::v1::GetInstanceGroupRequest const& request) override;

  StatusOr<google::cloud::cpp::compute::v1::RegionInstanceGroupList> ListRegionInstanceGroups(
      google::cloud::rest_internal::RestContext& rest_context,
      Options const& options, google::cloud::cpp::compute::region_instance_groups::v1::ListRegionInstanceGroupsRequest const& request) override;

  StatusOr<google::cloud::cpp::compute::v1::RegionInstanceGroupsListInstances> ListInstances(
      google::cloud::rest_internal::RestContext& rest_context,
      Options const& options, google::cloud::cpp::compute::region_instance_groups::v1::ListInstancesRequest const& request) override;
  ...
  StatusOr<google::cloud::cpp::compute::v1::Operation> SetNamedPorts(
      google::cloud::rest_internal::RestContext& rest_context,
      Options const& options, google::cloud::cpp::compute::region_instance_groups::v1::SetNamedPortsRequest const& request) override;
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_COMPUTE_REGION_INSTANCE_GROUPS_V1_INTERNAL_REGION_INSTANCE_GROUPS_REST_METADATA_DECORATOR_H
