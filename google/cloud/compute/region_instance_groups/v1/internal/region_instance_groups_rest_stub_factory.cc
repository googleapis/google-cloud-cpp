...
std::shared_ptr<RegionInstanceGroupsRestStub>
CreateDefaultRegionInstanceGroupsRestStub(Options& options) {
  ...
  auto service_endpoint = internal::DetermineServiceEndpoint(
      internal::GetEnv("GOOGLE_CLOUD_CPP_REGION_INSTANCE_GROUPS_ENDPOINT"),
  ...
  std::shared_ptr<RegionInstanceGroupsRestStub> stub =
      std::make_shared<DefaultRegionInstanceGroupsRestStub>(
          std::move(stub_creation_opts));
  stub = std::make_shared<RegionInstanceGroupsRestMetadata>(std::move(stub));
  if (internal::Contains(options.get<TracingComponentsOption>(), "rpc")) {
    GCP_LOG(INFO) << "Enabled logging for REST rpc calls";
    stub = std::make_shared<RegionInstanceGroupsRestLogging>(
