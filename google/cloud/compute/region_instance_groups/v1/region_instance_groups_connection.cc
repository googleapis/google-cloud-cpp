...
RegionInstanceGroupsConnection::GetRegionInstanceGroups(
    google::cloud::cpp::compute::regionInstanceGroups::v1::GetRegionInstanceGroupsRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

StreamRange<google::cloud::cpp::compute::v1::InstanceGroup> RegionInstanceGroupsConnection::ListRegionInstanceGroups(
    google::cloud::cpp::compute::regionInstanceGroups::v1::ListRegionInstanceGroupsRequest) {  // NOLINT(performance-unnecessary-value-param)
  return google::cloud::internal::MakeUnimplementedPaginationRange<
      StreamRange<google::cloud::cpp::compute::v1::InstanceGroup>>();
}

StreamRange<google::cloud::cpp::compute::v1::InstanceWithNamedPorts> RegionInstanceGroupsConnection::ListInstances(
    google::cloud::cpp::compute::regionInstanceGroups::v1::ListInstancesRequest) {  // NOLINT(performance-unnecessary-value-param)
  return google::cloud::internal::MakeUnimplementedPaginationRange<
...
RegionInstanceGroupsConnection::SetNamedPorts(
    google::cloud::cpp::compute::regionInstanceGroups::v1::SetNamedPortsRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}
