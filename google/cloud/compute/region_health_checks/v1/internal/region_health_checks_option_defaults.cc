...
Options RegionHealthChecksDefaultOptions(Options options) {
  ...
  if (!options.has<compute_region_health_checks_v1::
    ...
    options.set<
        compute_region_health_checks_v1::RegionHealthChecksRetryPolicyOption>(
        compute_region_health_checks_v1::
            RegionHealthChecksLimitedTimeRetryPolicy(std::chrono::minutes(30))
                .clone());
  }
  if (!options.has<compute_region_health_checks_v1::
                       RegionHealthChecksBackoffPolicyOption>()) {
    options.set<
        compute_region_health_checks_v1::RegionHealthChecksBackoffPolicyOption>(
  ...
  if (!options.has<compute_region_health_checks_v1::
    ...
    options.set<
        compute_region_health_checks_v1::RegionHealthChecksPollingPolicyOption>(
        GenericPollingPolicy<compute_region_health_checks_v1::
                                 RegionHealthChecksRetryPolicyOption::Type,
                             compute_region_health_checks_v1::
                                 RegionHealthChecksBackoffPolicyOption::Type>(
            options
  ...
  if (!options.has<compute_region_health_checks_v1::
    ...
    options.set<compute_region_health_checks_v1::
                    RegionHealthChecksConnectionIdempotencyPolicyOption>(
        compute_region_health_checks_v1::
