...
DefaultRegionHealthChecksRestStub::DefaultRegionHealthChecksRestStub(Options options)
...
DefaultRegionHealthChecksRestStub::AsyncDeleteRegionHealthChecks(
      CompletionQueue& cq,
  ...
  std::thread t{[](auto p, auto service, auto request, auto rest_context) {
      p.set_value(rest_internal::Delete<google::cloud::cpp::compute::v1::Operation>(
          *service, *rest_context, request,
          absl::StrCat("/compute/v1/projects/", request.project(), "/regions/", request.region(), "/healthChecks/", request.health_check(), "")));
...
DefaultRegionHealthChecksRestStub::GetRegionHealthChecks(
...
future<StatusOr<google::cloud::cpp::compute::v1::Operation>>
DefaultRegionHealthChecksRestStub::AsyncInsertRegionHealthChecks(
      CompletionQueue& cq,
      std::unique_ptr<rest_internal::RestContext> rest_context,
  ...
  std::thread t{[](auto p, auto service, auto request, auto rest_context) {
      p.set_value(rest_internal::Post<google::cloud::cpp::compute::v1::Operation>(
          *service, *rest_context, request.health_check_resource(),
          absl::StrCat("/compute/v1/projects/", request.project(), "/regions/", request.region(), "/healthChecks")));
  }, std::move(p), service_, request, std::move(rest_context)};
  return f.then([t = std::move(t), cq](auto f) mutable {
    cq.RunAsync([t = std::move(t)]() mutable {
      t.join();
...
future<StatusOr<google::cloud::cpp::compute::v1::Operation>>
DefaultRegionHealthChecksRestStub::AsyncPatchRegionHealthChecks(
      CompletionQueue& cq,
      std::unique_ptr<rest_internal::RestContext> rest_context,
...
future<StatusOr<google::cloud::cpp::compute::v1::Operation>>
DefaultRegionHealthChecksRestStub::AsyncUpdateRegionHealthChecks(
      CompletionQueue& cq,
      std::unique_ptr<rest_internal::RestContext> rest_context,
...
future<Status>
DefaultRegionHealthChecksRestStub::AsyncCancelOperation(
    google::cloud::CompletionQueue& cq,
    std::unique_ptr<rest_internal::RestContext> rest_context,
