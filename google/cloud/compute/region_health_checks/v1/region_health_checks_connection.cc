...
RegionHealthChecksConnection::DeleteRegionHealthChecks(
    google::cloud::cpp::compute::regionHealthChecks::v1::DeleteRegionHealthChecksRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

StatusOr<google::cloud::cpp::compute::v1::HealthCheck>
RegionHealthChecksConnection::GetRegionHealthChecks(
    google::cloud::cpp::compute::regionHealthChecks::v1::GetRegionHealthChecksRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

StatusOr<google::cloud::cpp::compute::v1::Operation>
RegionHealthChecksConnection::InsertRegionHealthChecks(
    google::cloud::cpp::compute::regionHealthChecks::v1::InsertRegionHealthChecksRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

StreamRange<google::cloud::cpp::compute::v1::HealthCheck> RegionHealthChecksConnection::ListRegionHealthChecks(
    google::cloud::cpp::compute::regionHealthChecks::v1::ListRegionHealthChecksRequest) {  // NOLINT(performance-unnecessary-value-param)
...
RegionHealthChecksConnection::PatchRegionHealthChecks(
    google::cloud::cpp::compute::regionHealthChecks::v1::PatchRegionHealthChecksRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

StatusOr<google::cloud::cpp::compute::v1::Operation>
RegionHealthChecksConnection::UpdateRegionHealthChecks(
    google::cloud::cpp::compute::regionHealthChecks::v1::UpdateRegionHealthChecksRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}
