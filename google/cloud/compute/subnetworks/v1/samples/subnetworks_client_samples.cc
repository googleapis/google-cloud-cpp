...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::compute_subnetworks_v1::SubnetworksClient(
      google::cloud::compute_subnetworks_v1::MakeSubnetworksConnectionRest(options));
  //! [set-client-endpoint]
}

//! [custom-idempotency-policy]
class CustomIdempotencyPolicy
   : public google::cloud::compute_subnetworks_v1::SubnetworksConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::compute_subnetworks_v1::SubnetworksConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::compute_subnetworks_v1::SubnetworksConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::compute_subnetworks_v1::SubnetworksRetryPolicyOption>(
      google::cloud::compute_subnetworks_v1::SubnetworksLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::compute_subnetworks_v1::SubnetworksBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::compute_subnetworks_v1::MakeSubnetworksConnectionRest(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::compute_subnetworks_v1::SubnetworksClient(connection);
  auto c2 = google::cloud::compute_subnetworks_v1::SubnetworksClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::compute_subnetworks_v1::SubnetworksClient(
    connection, google::cloud::Options{}.set<google::cloud::compute_subnetworks_v1::SubnetworksRetryPolicyOption>(
      google::cloud::compute_subnetworks_v1::SubnetworksLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::compute_subnetworks_v1::SubnetworksRetryPolicyOption>(
  //       google::cloud::compute_subnetworks_v1::SubnetworksLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::compute_subnetworks_v1::SubnetworksPollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::compute_subnetworks_v1::SubnetworksRetryPolicyOption::Type,
            google::cloud::compute_subnetworks_v1::SubnetworksBackoffPolicyOption::Type>(
            google::cloud::compute_subnetworks_v1::SubnetworksLimitedTimeRetryPolicy(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::compute_subnetworks_v1::SubnetworksClient(
      google::cloud::compute_subnetworks_v1::MakeSubnetworksConnectionRest(options));
  }
  //! [with-service-account]
  (argv.at(0));
