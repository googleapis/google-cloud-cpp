...
/**
 * A retry policy for `SubnetworksConnection` that stops retrying after a
...
class SubnetworksLimitedErrorCountRetryPolicy : public SubnetworksRetryPolicy {
 public:
  SubnetworksLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `SubnetworksConnection` that stops retrying after
