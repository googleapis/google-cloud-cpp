...
class SubnetworksRestConnectionImpl
 ...
 private:
  std::unique_ptr<compute_subnetworks_v1::SubnetworksRetryPolicy> retry_policy() {
    ...
    return options_.get<compute_subnetworks_v1::SubnetworksRetryPolicyOption>()->clone();
  }
  ...
  std::unique_ptr<BackoffPolicy> backoff_policy() {
    ...
    return options_.get<compute_subnetworks_v1::SubnetworksBackoffPolicyOption>()->clone();
  }

  std::unique_ptr<compute_subnetworks_v1::SubnetworksConnectionIdempotencyPolicy> idempotency_policy() {
    auto const& options = internal::CurrentOptions();
    ...
    return options_.get<compute_subnetworks_v1::SubnetworksConnectionIdempotencyPolicyOption>()->
clone();
  }
  ...
  std::unique_ptr<PollingPolicy> polling_policy() {
    ...
    return options_.get<compute_subnetworks_v1::SubnetworksPollingPolicyOption>()->clone();
  }
