...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_COMPUTE_SUBNETWORKS_V1_INTERNAL_SUBNETWORKS_REST_LOGGING_DECORATOR_H
...
class SubnetworksRestLogging : public SubnetworksRestStub {
 public:
  ...
  future<StatusOr<google::cloud::cpp::compute::v1::Operation>> AsyncDeleteSubnetwork(
  ...
  future<StatusOr<google::cloud::cpp::compute::v1::Operation>> AsyncInsertSubnetwork(
      google::cloud::CompletionQueue& cq,
      std::unique_ptr<google::cloud::rest_internal::RestContext> rest_context,
      google::cloud::internal::ImmutableOptions options,
  ...
  future<StatusOr<google::cloud::cpp::compute::v1::Operation>> AsyncPatchSubnetwork(
      google::cloud::CompletionQueue& cq,
      std::unique_ptr<google::cloud::rest_internal::RestContext> rest_context,
      google::cloud::internal::ImmutableOptions options,
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_COMPUTE_SUBNETWORKS_V1_INTERNAL_SUBNETWORKS_REST_LOGGING_DECORATOR_H
