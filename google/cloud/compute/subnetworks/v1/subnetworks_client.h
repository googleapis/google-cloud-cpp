...
class SubnetworksClient {
 public:
  ...
  /// @param subnetworks_expand_ip_cidr_range_request_resource  The
  /// SubnetworksExpandIpCidrRangeRequest for this request.
  /// @param opts Optional. Override the class-level options, such as retry and
  ///     backoff policies.
  /// @return
  /// @googleapis_link{google::cloud::cpp::compute::v1::Operation,google/cloud/compute/v1/internal/common.proto#L17443}
  ...
  /// @param subnetworks_set_private_ip_google_access_request_resource  The
  /// SubnetworksSetPrivateIpGoogleAccessRequest for this request.
  /// @param opts Optional. Override the class-level options, such as retry and
  ///     backoff policies.
  /// @return
  /// @googleapis_link{google::cloud::cpp::compute::v1::Operation,google/cloud/compute/v1/internal/common.proto#L17443}
