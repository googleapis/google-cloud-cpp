...
RegionInstanceTemplatesRestMetadata::AsyncDeleteRegionInstanceTemplates(
  ...
  return child_->AsyncDeleteRegionInstanceTemplates(cq, std::move(rest_context), request);
}
...
RegionInstanceTemplatesRestMetadata::AsyncInsertRegionInstanceTemplates(
  ...
  SetMetadata(*rest_context);
  return child_->AsyncInsertRegionInstanceTemplates(cq, std::move(rest_context), request);
}
