...
RegionInstanceTemplatesRestMetadata::DeleteRegionInstanceTemplates(
    rest_internal::RestContext& rest_context,
    google::cloud::cpp::compute::regionInstanceTemplates::v1::
        DeleteRegionInstanceTemplatesRequest const& request) {
  SetMetadata(rest_context);
  return child_->DeleteRegionInstanceTemplates(rest_context, request);
}
...
StatusOr<google::cloud::cpp::compute::v1::Operation>
RegionInstanceTemplatesRestMetadata::InsertRegionInstanceTemplates(
    rest_internal::RestContext& rest_context,
    google::cloud::cpp::compute::regionInstanceTemplates::v1::
        InsertRegionInstanceTemplatesRequest const& request) {
  SetMetadata(rest_context);
  return child_->InsertRegionInstanceTemplates(rest_context, request);
}
