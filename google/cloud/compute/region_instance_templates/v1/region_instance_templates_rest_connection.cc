...
std::shared_ptr<RegionInstanceTemplatesConnection> MakeRegionInstanceTemplatesConnectionRest(
  ...
  internal::CheckExpectedOptions<CommonOptionList, RestOptionList,
      ...
      RegionInstanceTemplatesPolicyOptionList>(options, __func__);
  options = compute_region_instance_templates_v1_internal::RegionInstanceTemplatesDefaultOptions(
      std::move(options));
  auto background = std::make_unique<
      rest_internal::AutomaticallyCreatedRestBackgroundThreads>();
  auto stub = compute_region_instance_templates_v1_internal::CreateDefaultRegionInstanceTemplatesRestStub(
      options);
  return compute_region_instance_templates_v1_internal::MakeRegionInstanceTemplatesTracingConnection(
      std::make_shared<
          compute_region_instance_templates_v1_internal::RegionInstanceTemplatesRestConnectionImpl>(
