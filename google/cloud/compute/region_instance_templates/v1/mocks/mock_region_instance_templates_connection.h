 ...
 * including errors, from an object of type `RegionInstanceTemplatesClient`. To do so,
 * construct an object of type `RegionInstanceTemplatesClient` with an instance of this
 ...
 */
class MockRegionInstanceTemplatesConnection : public compute_region_instance_templates_v1::RegionInstanceTemplatesConnection {
 public:
  ...
  /// EXPECT_CALL(*mock, DeleteInstanceTemplate(Matcher<google::cloud::cpp::compute::region_instance_templates::v1::DeleteInstanceTemplateRequest const&>(_)))
  /// @endcode
  ...
  GetInstanceTemplate,
  (google::cloud::cpp::compute::region_instance_templates::v1::GetInstanceTemplateRequest const& request), (override));
  ...
  /// using ::testing::_;
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock, InsertInstanceTemplate(Matcher<google::cloud::cpp::compute::region_instance_templates::v1::InsertInstanceTemplateRequest const&>(_)))
  /// @endcode
  MOCK_METHOD(future<StatusOr<google::cloud::cpp::compute::v1::Operation>>,
  ...
  (google::cloud::cpp::compute::region_instance_templates::v1::ListRegionInstanceTemplatesRequest request), (override));
};
