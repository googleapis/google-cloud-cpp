...
std::shared_ptr<HttpHealthChecksRestStub>
CreateDefaultHttpHealthChecksRestStub(Options const& options) {
  auto opts = internal::PopulateRestOptions(options);
  std::shared_ptr<HttpHealthChecksRestStub> stub =
      std::make_shared<DefaultHttpHealthChecksRestStub>(std::move(opts));
