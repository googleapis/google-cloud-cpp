...
class HttpHealthChecksClient {
 public:
  ...
  /// [google.cloud.cpp.compute.v1.HttpHealthCheck]: @cloud_cpp_reference_link{google/cloud/compute/v1/internal/common_067.proto#L33}
  ///
  // clang-format on
  ...
  /// https://cloud.google.com/compute/docs/reference/rest/v1/httpHealthChecks/testIamPermissions
  ///
  /// @param project  Project ID for this request.
