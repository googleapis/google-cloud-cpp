...
class NetworkEndpointGroupsRestConnectionImpl
 ...
 public:
  ...
  AggregatedListNetworkEndpointGroups(google::cloud::cpp::compute::networkEndpointGroups::v1::AggregatedListNetworkEndpointGroupsRequest const& request) override;

  StatusOr<google::cloud::cpp::compute::v1::Operation>
  AttachNetworkEndpoints(google::cloud::cpp::compute::networkEndpointGroups::v1::AttachNetworkEndpointsRequest const& request) override;

  StatusOr<google::cloud::cpp::compute::v1::Operation>
  DeleteNetworkEndpointGroups(google::cloud::cpp::compute::networkEndpointGroups::v1::DeleteNetworkEndpointGroupsRequest const& request) override;

  StatusOr<google::cloud::cpp::compute::v1::Operation>
  DetachNetworkEndpoints(google::cloud::cpp::compute::networkEndpointGroups::v1::DetachNetworkEndpointsRequest const& request) override;

  StatusOr<google::cloud::cpp::compute::v1::NetworkEndpointGroup>
  GetNetworkEndpointGroups(google::cloud::cpp::compute::networkEndpointGroups::v1::GetNetworkEndpointGroupsRequest const& request) override;

  StatusOr<google::cloud::cpp::compute::v1::Operation>
  InsertNetworkEndpointGroups(google::cloud::cpp::compute::networkEndpointGroups::v1::InsertNetworkEndpointGroupsRequest const& request) override;

  StreamRange<google::cloud::cpp::compute::v1::NetworkEndpointGroup>
  ListNetworkEndpointGroups(google::cloud::cpp::compute::networkEndpointGroups::v1::ListNetworkEndpointGroupsRequest request) override;

  StreamRange<google::cloud::cpp::compute::v1::NetworkEndpointWithHealthStatus>
  ListNetworkEndpoints(google::cloud::cpp::compute::networkEndpointGroups::v1::ListNetworkEndpointsRequest request) override;

  StatusOr<google::cloud::cpp::compute::v1::TestPermissionsResponse>
  TestIamPermissions(google::cloud::cpp::compute::networkEndpointGroups::v1::TestIamPermissionsRequest const& request) override;
