...
CreateDefaultNetworkEndpointGroupsRestStub(Options& options) {
  ...
  auto service_endpoint = internal::DetermineServiceEndpoint(
      internal::GetEnv("GOOGLE_CLOUD_CPP_NETWORK_ENDPOINT_GROUPS_ENDPOINT"),
  ...
  std::shared_ptr<NetworkEndpointGroupsRestStub> stub =
      std::make_shared<DefaultNetworkEndpointGroupsRestStub>(
          std::move(stub_creation_opts));
  stub = std::make_shared<NetworkEndpointGroupsRestMetadata>(std::move(stub));
  if (internal::Contains(options.get<TracingComponentsOption>(), "rpc")) {
    GCP_LOG(INFO) << "Enabled logging for REST rpc calls";
    stub = std::make_shared<NetworkEndpointGroupsRestLogging>(
