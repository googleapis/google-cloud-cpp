...
class ServiceAttachmentsClient {
 public:
  ...
  /// [google.cloud.cpp.compute.v1.ServiceAttachmentsScopedList]: @cloud_cpp_reference_link{google/cloud/compute/v1/internal/common_112.proto#L411}
  ///
  // clang-format on
  StreamRange<
      std::pair<std::string,
  ...
  /// [google.cloud.cpp.compute.v1.ServiceAttachment]: @cloud_cpp_reference_link{google/cloud/compute/v1/internal/common_112.proto#L28}
  ///
  // clang-format on
