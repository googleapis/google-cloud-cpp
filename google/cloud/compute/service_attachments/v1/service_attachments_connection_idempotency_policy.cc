...
Idempotency ServiceAttachmentsConnectionIdempotencyPolicy::AggregatedListServiceAttachments(google::cloud::cpp::compute::service_attachments::v1::AggregatedListServiceAttachmentsRequest const&) {
  return Idempotency::kIdempotent;
}

Idempotency ServiceAttachmentsConnectionIdempotencyPolicy::DeleteServiceAttachments(google::cloud::cpp::compute::service_attachments::v1::DeleteServiceAttachmentsRequest const&) {
  return Idempotency::kNonIdempotent;
}

Idempotency ServiceAttachmentsConnectionIdempotencyPolicy::GetServiceAttachments(google::cloud::cpp::compute::service_attachments::v1::GetServiceAttachmentsRequest const&) {
  return Idempotency::kIdempotent;
}
...
Idempotency ServiceAttachmentsConnectionIdempotencyPolicy::InsertServiceAttachments(google::cloud::cpp::compute::service_attachments::v1::InsertServiceAttachmentsRequest const&) {
  return Idempotency::kNonIdempotent;
}
...
Idempotency ServiceAttachmentsConnectionIdempotencyPolicy::PatchServiceAttachments(google::cloud::cpp::compute::service_attachments::v1::PatchServiceAttachmentsRequest const&) {
  return Idempotency::kNonIdempotent;
}
