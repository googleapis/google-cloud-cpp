...
ServiceAttachmentsRestMetadata::AsyncDeleteServiceAttachments(
      ...
      google::cloud::cpp::compute::service_attachments::v1::DeleteServiceAttachmentsRequest const& request) {
  SetMetadata(*rest_context);
  return child_->AsyncDeleteServiceAttachments(cq, std::move(rest_context), request);
}

StatusOr<google::cloud::cpp::compute::v1::ServiceAttachment>
ServiceAttachmentsRestMetadata::GetServiceAttachments(
    rest_internal::RestContext& rest_context,
    google::cloud::cpp::compute::service_attachments::v1::GetServiceAttachmentsRequest const& request) {
  SetMetadata(rest_context);
...
ServiceAttachmentsRestMetadata::GetIamPolicy(
    rest_internal::RestContext& rest_context,
    google::cloud::cpp::compute::service_attachments::v1::GetIamPolicyRequest const& request) {
  SetMetadata(rest_context);
...
ServiceAttachmentsRestMetadata::AsyncInsertServiceAttachments(
      CompletionQueue& cq,
      std::unique_ptr<rest_internal::RestContext> rest_context,
      google::cloud::cpp::compute::service_attachments::v1::InsertServiceAttachmentsRequest const& request) {
  SetMetadata(*rest_context);
  return child_->AsyncInsertServiceAttachments(cq, std::move(rest_context), request);
}
...
ServiceAttachmentsRestMetadata::AsyncPatchServiceAttachments(
      CompletionQueue& cq,
      std::unique_ptr<rest_internal::RestContext> rest_context,
      google::cloud::cpp::compute::service_attachments::v1::PatchServiceAttachmentsRequest const& request) {
  SetMetadata(*rest_context);
  return child_->AsyncPatchServiceAttachments(cq, std::move(rest_context), request);
}

StatusOr<google::cloud::cpp::compute::v1::Policy>
ServiceAttachmentsRestMetadata::SetIamPolicy(
    rest_internal::RestContext& rest_context,
    google::cloud::cpp::compute::service_attachments::v1::SetIamPolicyRequest const& request) {
  SetMetadata(rest_context);
...
ServiceAttachmentsRestMetadata::TestIamPermissions(
    rest_internal::RestContext& rest_context,
    google::cloud::cpp::compute::service_attachments::v1::TestIamPermissionsRequest const& request) {
  SetMetadata(rest_context);
...
future<Status>
ServiceAttachmentsRestMetadata::AsyncCancelOperation(
    google::cloud::CompletionQueue& cq,
    std::unique_ptr<rest_internal::RestContext> rest_context,
