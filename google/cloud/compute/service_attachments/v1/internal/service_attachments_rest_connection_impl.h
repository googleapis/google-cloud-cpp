...
class ServiceAttachmentsRestConnectionImpl
 ...
 public:
  ...
  AggregatedListServiceAttachments(google::cloud::cpp::compute::service_attachments::v1::AggregatedListServiceAttachmentsRequest const& request) override;

  future<StatusOr<google::cloud::cpp::compute::v1::Operation>>
  DeleteServiceAttachments(google::cloud::cpp::compute::service_attachments::v1::DeleteServiceAttachmentsRequest const& request) override;

  StatusOr<google::cloud::cpp::compute::v1::ServiceAttachment>
  GetServiceAttachments(google::cloud::cpp::compute::service_attachments::v1::GetServiceAttachmentsRequest const& request) override;

  StatusOr<google::cloud::cpp::compute::v1::Policy>
  GetIamPolicy(google::cloud::cpp::compute::service_attachments::v1::GetIamPolicyRequest const& request) override;

  future<StatusOr<google::cloud::cpp::compute::v1::Operation>>
  InsertServiceAttachments(google::cloud::cpp::compute::service_attachments::v1::InsertServiceAttachmentsRequest const& request) override;
  ...
  future<StatusOr<google::cloud::cpp::compute::v1::Operation>>
  PatchServiceAttachments(google::cloud::cpp::compute::service_attachments::v1::PatchServiceAttachmentsRequest const& request) override;
 ...
 private:
  std::unique_ptr<compute_service_attachments_v1::ServiceAttachmentsRetryPolicy> retry_policy() {
    auto const& options = internal::CurrentOptions();
    if (options.has<compute_service_attachments_v1::ServiceAttachmentsRetryPolicyOption>()) {
      return options.get<compute_service_attachments_v1::ServiceAttachmentsRetryPolicyOption>()->clone();
    }
    return options_.get<compute_service_attachments_v1::ServiceAttachmentsRetryPolicyOption>()->clone();
  }

  std::unique_ptr<BackoffPolicy> backoff_policy() {
    auto const& options = internal::CurrentOptions();
    if (options.has<compute_service_attachments_v1::ServiceAttachmentsBackoffPolicyOption>()) {
      return options.get<compute_service_attachments_v1::ServiceAttachmentsBackoffPolicyOption>()->clone();
    }
    return options_.get<compute_service_attachments_v1::ServiceAttachmentsBackoffPolicyOption>()->clone();
  }

  std::unique_ptr<compute_service_attachments_v1::ServiceAttachmentsConnectionIdempotencyPolicy> idempotency_policy() {
    auto const& options = internal::CurrentOptions();
    if (options.has<compute_service_attachments_v1::ServiceAttachmentsConnectionIdempotencyPolicyOption>()) {
      return options.get<compute_service_attachments_v1::ServiceAttachmentsConnectionIdempotencyPolicyOption>()->clone();
    }
    return options_.get<compute_service_attachments_v1::ServiceAttachmentsConnectionIdempotencyPolicyOption>()->
clone();
  }
  ...
  std::unique_ptr<PollingPolicy> polling_policy() {
    ...
    if (options.has<compute_service_attachments_v1::ServiceAttachmentsPollingPolicyOption>()) {
      return options.get<compute_service_attachments_v1::ServiceAttachmentsPollingPolicyOption>()->clone();
    }
    return options_.get<compute_service_attachments_v1::ServiceAttachmentsPollingPolicyOption>()->clone();
  }

  std::unique_ptr<google::cloud::BackgroundThreads> background_;
  std::shared_ptr<compute_service_attachments_v1_internal::ServiceAttachmentsRestStub> stub_;
  Options options_;
};
