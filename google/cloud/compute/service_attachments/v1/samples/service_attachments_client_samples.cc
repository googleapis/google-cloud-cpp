...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::compute_service_attachments_v1::ServiceAttachmentsClient(google::cloud::ExperimentalTag{},
      google::cloud::compute_service_attachments_v1::MakeServiceAttachmentsConnectionRest(google::cloud::ExperimentalTag{},options));
  //! [set-client-endpoint]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::compute_service_attachments_v1::ServiceAttachmentsClient(google::cloud::ExperimentalTag{},
      google::cloud::compute_service_attachments_v1::MakeServiceAttachmentsConnectionRest(google::cloud::ExperimentalTag{},options));
  }
  //! [with-service-account]
  (argv.at(0));
