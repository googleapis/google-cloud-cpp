...
std::shared_ptr<BackendServicesRestStub>
CreateDefaultBackendServicesRestStub(Options const& options) {
  auto opts = internal::PopulateRestOptions(options);
  std::shared_ptr<BackendServicesRestStub> stub =
      std::make_shared<DefaultBackendServicesRestStub>(std::move(opts));
