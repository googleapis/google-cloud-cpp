  ...
  std::thread t{[](auto p, auto service, auto request, auto rest_context) {
      p.set_value(rest_internal::Post<google::cloud::cpp::compute::v1::Operation>(
          *service, *rest_context, request.signed_url_key_resource(),
          absl::StrCat("/compute/v1/projects/", request.project(), "/global/backendServices/", request.backend_service(), "/addSignedUrlKey")));
...
DefaultBackendServicesRestStub::AggregatedListBackendServices(
  ...
  return rest_internal::Get<google::cloud::cpp::compute::v1::BackendServiceAggregatedList>(
      *service_, rest_context, request,
      absl::StrCat("/compute/v1/projects/", request.project(), "/aggregated/backendServices"),
  ...
  std::thread t{[](auto p, auto service, auto request, auto rest_context) {
      p.set_value(rest_internal::Delete<google::cloud::cpp::compute::v1::Operation>(
          *service, *rest_context, request,
          absl::StrCat("/compute/v1/projects/", request.project(), "/global/backendServices/", request.backend_service(), "")));
  }, std::move(p), service_, request, std::move(rest_context)};
  return f.then([t = std::move(t), cq](auto f) mutable {
    cq.RunAsync([t = std::move(t)]() mutable {
      t.join();
...
DefaultBackendServicesRestStub::AsyncDeleteSignedUrlKey(
  ...
  std::thread t{[](auto p, auto service, auto request, auto rest_context) {
      p.set_value(rest_internal::Post<google::cloud::cpp::compute::v1::Operation>(
          *service, *rest_context, request,
          absl::StrCat("/compute/v1/projects/", request.project(), "/global/backendServices/", request.backend_service(), "/deleteSignedUrlKey")));
  }, std::move(p), service_, request, std::move(rest_context)};
  return f.then([t = std::move(t), cq](auto f) mutable {
    cq.RunAsync([t = std::move(t)]() mutable {
      t.join();
...
DefaultBackendServicesRestStub::GetHealth(
  ...
  return rest_internal::Post<google::cloud::cpp::compute::v1::BackendServiceGroupHealth>(
      *service_, rest_context, request.resource_group_reference_resource(),
      absl::StrCat("/compute/v1/projects/", request.project(), "/global/backendServices/", request.backend_service(), "/getHealth"));
}
...
DefaultBackendServicesRestStub::GetIamPolicy(
  ...
  return rest_internal::Get<google::cloud::cpp::compute::v1::Policy>(
      *service_, rest_context, request,
      absl::StrCat("/compute/v1/projects/", request.project(), "/global/backendServices/", request.resource(), "/getIamPolicy"),
  ...
  std::thread t{[](auto p, auto service, auto request, auto rest_context) {
      p.set_value(rest_internal::Post<google::cloud::cpp::compute::v1::Operation>(
          *service, *rest_context, request.backend_service_resource(),
          absl::StrCat("/compute/v1/projects/", request.project(), "/global/backendServices")));
  }, std::move(p), service_, request, std::move(rest_context)};
  return f.then([t = std::move(t), cq](auto f) mutable {
    cq.RunAsync([t = std::move(t)]() mutable {
      t.join();
  ...
  std::thread t{[](auto p, auto service, auto request, auto rest_context) {
      p.set_value(rest_internal::Post<google::cloud::cpp::compute::v1::Operation>(
          *service, *rest_context, request.security_policy_reference_resource(),
          absl::StrCat("/compute/v1/projects/", request.project(), "/global/backendServices/", request.backend_service(), "/setEdgeSecurityPolicy")));
  }, std::move(p), service_, request, std::move(rest_context)};
  return f.then([t = std::move(t), cq](auto f) mutable {
    cq.RunAsync([t = std::move(t)]() mutable {
      t.join();
...
DefaultBackendServicesRestStub::SetIamPolicy(
  ...
  return rest_internal::Post<google::cloud::cpp::compute::v1::Policy>(
      *service_, rest_context, request.global_set_policy_request_resource(),
      absl::StrCat("/compute/v1/projects/", request.project(), "/global/backendServices/", request.resource(), "/setIamPolicy"));
}
...
DefaultBackendServicesRestStub::AsyncSetSecurityPolicy(
  ...
  std::thread t{[](auto p, auto service, auto request, auto rest_context) {
      p.set_value(rest_internal::Post<google::cloud::cpp::compute::v1::Operation>(
          *service, *rest_context, request.security_policy_reference_resource(),
          absl::StrCat("/compute/v1/projects/", request.project(), "/global/backendServices/", request.backend_service(), "/setSecurityPolicy")));
  }, std::move(p), service_, request, std::move(rest_context)};
  return f.then([t = std::move(t), cq](auto f) mutable {
    cq.RunAsync([t = std::move(t)]() mutable {
      t.join();
