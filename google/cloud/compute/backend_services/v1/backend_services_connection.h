...
class BackendServicesConnection {
 public:
  ...
  DeleteBackendServices(google::cloud::cpp::compute::backendServices::v1::
                            DeleteBackendServicesRequest const& request);

  virtual StatusOr<google::cloud::cpp::compute::v1::Operation>
  DeleteSignedUrlKey(google::cloud::cpp::compute::backendServices::v1::
                         DeleteSignedUrlKeyRequest const& request);

  virtual StatusOr<google::cloud::cpp::compute::v1::BackendService>
  GetBackendServices(google::cloud::cpp::compute::backendServices::v1::
  ...
  virtual StatusOr<google::cloud::cpp::compute::v1::Operation>
  InsertBackendServices(google::cloud::cpp::compute::backendServices::v1::
                            InsertBackendServicesRequest const& request);

  virtual StreamRange<google::cloud::cpp::compute::v1::BackendService>
  ListBackendServices(google::cloud::cpp::compute::backendServices::v1::
                          ListBackendServicesRequest request);

  virtual StatusOr<google::cloud::cpp::compute::v1::Operation>
  PatchBackendServices(google::cloud::cpp::compute::backendServices::v1::
                           PatchBackendServicesRequest const& request);

  virtual StatusOr<google::cloud::cpp::compute::v1::Operation>
  SetEdgeSecurityPolicy(google::cloud::cpp::compute::backendServices::v1::
  ...
  virtual StatusOr<google::cloud::cpp::compute::v1::Operation>
  SetSecurityPolicy(google::cloud::cpp::compute::backendServices::v1::
                        SetSecurityPolicyRequest const& request);

  virtual StatusOr<google::cloud::cpp::compute::v1::Operation>
  UpdateBackendServices(google::cloud::cpp::compute::backendServices::v1::
