...
/**
 * A retry policy for `BackendServicesConnection` that stops retrying after a
...
class BackendServicesLimitedErrorCountRetryPolicy
 ...
 public:
  BackendServicesLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `BackendServicesConnection` that stops retrying after
