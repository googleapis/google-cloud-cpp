 ...
 */
struct HealthChecksRetryPolicyOption {
  using Type = std::shared_ptr<HealthChecksRetryPolicy>;
};
 ...
 * @ingroup google-cloud-compute-options
 */
struct HealthChecksBackoffPolicyOption {
 ...
 * @ingroup google-cloud-compute-options
 */
struct HealthChecksConnectionIdempotencyPolicyOption {
  using Type = std::shared_ptr<HealthChecksConnectionIdempotencyPolicy>;
};
 ...
 * @ingroup google-cloud-compute-options
 */
struct HealthChecksPollingPolicyOption {
  using Type = std::shared_ptr<PollingPolicy>;
};

/**
 * The options applicable to HealthChecks.
 *
 * @ingroup google-cloud-compute-options
 */
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_COMPUTE_HEALTH_CHECKS_V1_HEALTH_CHECKS_OPTIONS_H
