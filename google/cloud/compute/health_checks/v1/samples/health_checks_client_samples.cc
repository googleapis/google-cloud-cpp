...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::compute_health_checks_v1::HealthChecksClient(
      google::cloud::compute_health_checks_v1::MakeHealthChecksConnectionRest(options));
  //! [set-client-endpoint]
}

//! [custom-idempotency-policy]
class CustomIdempotencyPolicy
   : public google::cloud::compute_health_checks_v1::HealthChecksConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::compute_health_checks_v1::HealthChecksConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::compute_health_checks_v1::HealthChecksConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::compute_health_checks_v1::HealthChecksRetryPolicyOption>(
      google::cloud::compute_health_checks_v1::HealthChecksLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::compute_health_checks_v1::HealthChecksBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::compute_health_checks_v1::MakeHealthChecksConnectionRest(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::compute_health_checks_v1::HealthChecksClient(connection);
  auto c2 = google::cloud::compute_health_checks_v1::HealthChecksClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::compute_health_checks_v1::HealthChecksClient(
    connection, google::cloud::Options{}.set<google::cloud::compute_health_checks_v1::HealthChecksRetryPolicyOption>(
      google::cloud::compute_health_checks_v1::HealthChecksLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::compute_health_checks_v1::HealthChecksRetryPolicyOption>(
  //       google::cloud::compute_health_checks_v1::HealthChecksLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::compute_health_checks_v1::HealthChecksPollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::compute_health_checks_v1::HealthChecksRetryPolicyOption::Type,
            google::cloud::compute_health_checks_v1::HealthChecksBackoffPolicyOption::Type>(
            google::cloud::compute_health_checks_v1::HealthChecksLimitedTimeRetryPolicy(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::compute_health_checks_v1::HealthChecksClient(
      google::cloud::compute_health_checks_v1::MakeHealthChecksConnectionRest(options));
  }
  //! [with-service-account]
  (argv.at(0));
