...
/**
 * A retry policy for `ZonesConnection` that stops retrying after a
...
class ZonesLimitedErrorCountRetryPolicy : public ZonesRetryPolicy {
 public:
  ZonesLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `ZonesConnection` that stops retrying after
