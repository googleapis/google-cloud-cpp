...
DefaultZonesRestStub::GetZone(
  ...
  return rest_internal::Get<google::cloud::cpp::compute::v1::Zone>(
      *service_, rest_context, request, false,
      absl::StrCat("/", "compute", "/", rest_internal::DetermineApiVersion("v1", options), "/", "projects", "/", request.project(), "/", "zones", "/", request.zone()), std::move(query_params));
}
...
DefaultZonesRestStub::ListZones(
  ...
  return rest_internal::Get<google::cloud::cpp::compute::v1::ZoneList>(
      *service_, rest_context, request, false,
      absl::StrCat("/", "compute", "/", rest_internal::DetermineApiVersion("v1", options), "/", "projects", "/", request.project(), "/", "zones"), std::move(query_params));
}
