...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_COMPUTE_INSTANT_SNAPSHOTS_V1_INTERNAL_INSTANT_SNAPSHOTS_REST_LOGGING_DECORATOR_H
...
class InstantSnapshotsRestLogging : public InstantSnapshotsRestStub {
 public:
  ~InstantSnapshotsRestLogging() override = default;
  InstantSnapshotsRestLogging(std::shared_ptr<InstantSnapshotsRestStub> child,
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_COMPUTE_INSTANT_SNAPSHOTS_V1_INTERNAL_INSTANT_SNAPSHOTS_REST_LOGGING_DECORATOR_H
