...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client =
      google::cloud::compute_instant_snapshots_v1::InstantSnapshotsClient(
          google::cloud::compute_instant_snapshots_v1::
              MakeInstantSnapshotsConnectionRest(*ud_options));
  //! [set-client-universe-domain]
}

//! [custom-idempotency-policy]
class CustomIdempotencyPolicy
    : public google::cloud::compute_instant_snapshots_v1::
          InstantSnapshotsConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::compute_instant_snapshots_v1::
                      InstantSnapshotsConnectionIdempotencyPolicy>
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options =
      google::cloud::Options{}
          .set<google::cloud::compute_instant_snapshots_v1::
                   InstantSnapshotsConnectionIdempotencyPolicyOption>(
              CustomIdempotencyPolicy().clone())
          .set<google::cloud::compute_instant_snapshots_v1::
                   InstantSnapshotsRetryPolicyOption>(
              google::cloud::compute_instant_snapshots_v1::
                  InstantSnapshotsLimitedErrorCountRetryPolicy(3)
                      .clone())
          .set<google::cloud::compute_instant_snapshots_v1::
              ...
              google::cloud::ExponentialBackoffPolicy(
                  ...
                  /*scaling=*/2.0)
                  .clone());
  auto connection = google::cloud::compute_instant_snapshots_v1::
      MakeInstantSnapshotsConnectionRest(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::compute_instant_snapshots_v1::InstantSnapshotsClient(
      connection);
  auto c2 = google::cloud::compute_instant_snapshots_v1::InstantSnapshotsClient(
      connection);
