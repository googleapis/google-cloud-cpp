 ...
 * sets in `InstantSnapshotsClient`. This allows users to inject custom behavior
...
class InstantSnapshotsConnection {
 public:
  virtual ~InstantSnapshotsConnection() = 0;
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_COMPUTE_INSTANT_SNAPSHOTS_V1_INSTANT_SNAPSHOTS_CONNECTION_H
