...
class InstantSnapshotsClient {
 public:
  ...
  /// [google.cloud.cpp.compute.v1.InstantSnapshotsScopedList]: @cloud_cpp_reference_link{google/cloud/compute/v1/internal/common_066.proto#L138}
  ///
  // clang-format on
  ...
  /// [google.cloud.cpp.compute.v1.InstantSnapshot]: @cloud_cpp_reference_link{google/cloud/compute/v1/internal/common_065.proto#L26}
  ///
  // clang-format on
