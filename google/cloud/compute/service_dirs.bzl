...
service_dirs = [
    ...
    "region_instances/v1/",
    "region_instant_snapshot_groups/v1/",
    ...
    "region_zones/v1/",
    "regions/v1/",
    "reliability_risks/v1/",
    "reservation_blocks/v1/",
    "reservation_slots/v1/",
