...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::compute_licenses_v1::LicensesClient(
...
class CustomIdempotencyPolicy
   : public google::cloud::compute_licenses_v1::LicensesConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::compute_licenses_v1::LicensesConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::compute_licenses_v1::LicensesConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::compute_licenses_v1::LicensesRetryPolicyOption>(
      google::cloud::compute_licenses_v1::LicensesLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::compute_licenses_v1::LicensesBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::compute_licenses_v1::MakeLicensesConnectionRest(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::compute_licenses_v1::LicensesClient(connection);
  auto c2 = google::cloud::compute_licenses_v1::LicensesClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::compute_licenses_v1::LicensesClient(
    connection, google::cloud::Options{}.set<google::cloud::compute_licenses_v1::LicensesRetryPolicyOption>(
      google::cloud::compute_licenses_v1::LicensesLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::compute_licenses_v1::LicensesRetryPolicyOption>(
  //       google::cloud::compute_licenses_v1::LicensesLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::compute_licenses_v1::LicensesPollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::compute_licenses_v1::LicensesRetryPolicyOption::Type,
            google::cloud::compute_licenses_v1::LicensesBackoffPolicyOption::Type>(
            google::cloud::compute_licenses_v1::LicensesLimitedTimeRetryPolicy(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::compute_licenses_v1::LicensesClient(
      google::cloud::compute_licenses_v1::MakeLicensesConnectionRest(options));
  }
  //! [with-service-account]
  (argv.at(0));
