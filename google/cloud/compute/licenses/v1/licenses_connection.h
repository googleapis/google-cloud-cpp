...
/**
 * A retry policy for `LicensesConnection` that stops retrying after a
...
class LicensesLimitedErrorCountRetryPolicy : public LicensesRetryPolicy {
 public:
  LicensesLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `LicensesConnection` that stops retrying after
