...
class LicensesRestConnectionImpl
 ...
 private:
  std::unique_ptr<compute_licenses_v1::LicensesRetryPolicy> retry_policy() {
    ...
    return options_.get<compute_licenses_v1::LicensesRetryPolicyOption>()->clone();
  }
  ...
  std::unique_ptr<BackoffPolicy> backoff_policy() {
    ...
    return options_.get<compute_licenses_v1::LicensesBackoffPolicyOption>()->clone();
  }

  std::unique_ptr<compute_licenses_v1::LicensesConnectionIdempotencyPolicy> idempotency_policy() {
    auto const& options = internal::CurrentOptions();
    ...
    return options_.get<compute_licenses_v1::LicensesConnectionIdempotencyPolicyOption>()->
clone();
  }
  ...
  std::unique_ptr<PollingPolicy> polling_policy() {
    ...
    return options_.get<compute_licenses_v1::LicensesPollingPolicyOption>()->clone();
  }
