...
std::shared_ptr<LicensesRestStub> CreateDefaultLicensesRestStub(
  ...
  auto service_endpoint = internal::DetermineServiceEndpoint(
      internal::GetEnv("GOOGLE_CLOUD_CPP_LICENSES_ENDPOINT"),
  ...
  std::shared_ptr<LicensesRestStub> stub =
      std::make_shared<DefaultLicensesRestStub>(std::move(stub_creation_opts));
  stub = std::make_shared<LicensesRestMetadata>(std::move(stub));
  if (internal::Contains(options.get<TracingComponentsOption>(), "rpc")) {
    GCP_LOG(INFO) << "Enabled logging for REST rpc calls";
    stub = std::make_shared<LicensesRestLogging>(
