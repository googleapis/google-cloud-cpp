...
LicensesRestMetadata::AsyncDeleteLicense(
  ...
  return child_->AsyncDeleteLicense(
...
LicensesRestMetadata::AsyncInsertLicense(
  ...
  SetMetadata(*rest_context, *options);
  return child_->AsyncInsertLicense(
      cq, std::move(rest_context), std::move(options), request);
}
...
LicensesRestMetadata::ListLicenses(
    rest_internal::RestContext& rest_context,
    Options const& options, google::cloud::cpp::compute::licenses::v1::ListLicensesRequest const& request) {
  SetMetadata(rest_context, options);
...
LicensesRestMetadata::AsyncUpdateLicense(
  ...
  SetMetadata(*rest_context, *options);
  return child_->AsyncUpdateLicense(
      cq, std::move(rest_context), std::move(options), request);
}
...
future<Status>
LicensesRestMetadata::AsyncCancelOperation(
    google::cloud::CompletionQueue& cq,
    std::unique_ptr<rest_internal::RestContext> rest_context,
    google::cloud::internal::ImmutableOptions options,
