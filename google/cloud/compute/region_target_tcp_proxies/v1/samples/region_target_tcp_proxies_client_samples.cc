...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::compute_region_target_tcp_proxies_v1::
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto c1 = google::cloud::compute_region_target_tcp_proxies_v1::
      RegionTargetTcpProxiesClient(connection);
      ...
      google::cloud::Options{}
          .set<google::cloud::compute_region_target_tcp_proxies_v1::
              ...
              google::cloud::GenericPollingPolicy<
                  google::cloud::compute_region_target_tcp_proxies_v1::
                      RegionTargetTcpProxiesRetryPolicyOption::Type,
                  google::cloud::compute_region_target_tcp_proxies_v1::
                      RegionTargetTcpProxiesBackoffPolicyOption::Type>(
                  google::cloud::compute_region_target_tcp_proxies_v1::
                      RegionTargetTcpProxiesLimitedTimeRetryPolicy(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::compute_region_target_tcp_proxies_v1::
        RegionTargetTcpProxiesClient(
            google::cloud::compute_region_target_tcp_proxies_v1::
                MakeRegionTargetTcpProxiesConnectionRest(options));
  }
