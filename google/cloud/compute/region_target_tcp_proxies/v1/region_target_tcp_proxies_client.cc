...
RegionTargetTcpProxiesClient::DeleteRegionTargetTcpProxies(std::string const& project, std::string const& region, std::string const& target_tcp_proxy, Options opts) {
  ...
  google::cloud::cpp::compute::regionTargetTcpProxies::v1::DeleteRegionTargetTcpProxiesRequest request;
...
StatusOr<google::cloud::cpp::compute::v1::Operation>
RegionTargetTcpProxiesClient::DeleteRegionTargetTcpProxies(google::cloud::cpp::compute::regionTargetTcpProxies::v1::DeleteRegionTargetTcpProxiesRequest const& request, Options opts) {
  internal::OptionsSpan span(internal::MergeOptions(std::move(opts), options_));
  return connection_->DeleteRegionTargetTcpProxies(request);
}
...
RegionTargetTcpProxiesClient::GetRegionTargetTcpProxies(std::string const& project, std::string const& region, std::string const& target_tcp_proxy, Options opts) {
  internal::OptionsSpan span(internal::MergeOptions(std::move(opts), options_));
  google::cloud::cpp::compute::regionTargetTcpProxies::v1::GetRegionTargetTcpProxiesRequest request;
  request.set_project(project);
  request.set_region(region);
  request.set_target_tcp_proxy(target_tcp_proxy);
...
StatusOr<google::cloud::cpp::compute::v1::TargetTcpProxy>
RegionTargetTcpProxiesClient::GetRegionTargetTcpProxies(google::cloud::cpp::compute::regionTargetTcpProxies::v1::GetRegionTargetTcpProxiesRequest const& request, Options opts) {
  internal::OptionsSpan span(internal::MergeOptions(std::move(opts), options_));
  return connection_->GetRegionTargetTcpProxies(request);
}
...
RegionTargetTcpProxiesClient::InsertRegionTargetTcpProxies(std::string const& project, std::string const& region, google::cloud::cpp::compute::v1::TargetTcpProxy const& target_tcp_proxy_resource, Options opts) {
  internal::OptionsSpan span(internal::MergeOptions(std::move(opts), options_));
  google::cloud::cpp::compute::regionTargetTcpProxies::v1::InsertRegionTargetTcpProxiesRequest request;
  request.set_project(project);
  request.set_region(region);
...
StatusOr<google::cloud::cpp::compute::v1::Operation>
RegionTargetTcpProxiesClient::InsertRegionTargetTcpProxies(google::cloud::cpp::compute::regionTargetTcpProxies::v1::InsertRegionTargetTcpProxiesRequest const& request, Options opts) {
  internal::OptionsSpan span(internal::MergeOptions(std::move(opts), options_));
  return connection_->InsertRegionTargetTcpProxies(request);
}
...
RegionTargetTcpProxiesClient::ListRegionTargetTcpProxies(std::string const& project, std::string const& region, Options opts) {
  internal::OptionsSpan span(internal::MergeOptions(std::move(opts), options_));
  google::cloud::cpp::compute::regionTargetTcpProxies::v1::ListRegionTargetTcpProxiesRequest request;
  request.set_project(project);
  request.set_region(region);
...
StreamRange<google::cloud::cpp::compute::v1::TargetTcpProxy>
RegionTargetTcpProxiesClient::ListRegionTargetTcpProxies(google::cloud::cpp::compute::regionTargetTcpProxies::v1::ListRegionTargetTcpProxiesRequest request, Options opts) {
  internal::OptionsSpan span(internal::MergeOptions(std::move(opts), options_));
