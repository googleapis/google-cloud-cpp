...
DefaultRegionTargetTcpProxiesRestStub::DefaultRegionTargetTcpProxiesRestStub(Options options)
...
DefaultRegionTargetTcpProxiesRestStub::DefaultRegionTargetTcpProxiesRestStub(
...
DefaultRegionTargetTcpProxiesRestStub::AsyncDeleteTargetTcpProxy(
      ...
      google::cloud::cpp::compute::region_target_tcp_proxies::v1::DeleteTargetTcpProxyRequest const& request) {
  ...
  query_params = rest_internal::TrimEmptyQueryParameters(std::move(query_params));
      p.set_value(rest_internal::Delete<google::cloud::cpp::compute::v1::Operation>(
          *service, *rest_context, request,
          false,
          absl::StrCat("/", "compute", "/", rest_internal::DetermineApiVersion("v1", *options), "/", "projects", "/", request.project(), "/", "regions", "/", request.region(), "/", "targetTcpProxies", "/", request.target_tcp_proxy()), std::move(query_params)));
    },
...
DefaultRegionTargetTcpProxiesRestStub::DeleteTargetTcpProxy(
...
DefaultRegionTargetTcpProxiesRestStub::GetTargetTcpProxy(
      google::cloud::rest_internal::RestContext& rest_context,
      Options const& options,
      google::cloud::cpp::compute::region_target_tcp_proxies::v1::GetTargetTcpProxyRequest const& request) {
  std::vector<std::pair<std::string, std::string>> query_params;
...
DefaultRegionTargetTcpProxiesRestStub::AsyncInsertTargetTcpProxy(
      ...
      std::unique_ptr<rest_internal::RestContext> rest_context,
      google::cloud::internal::ImmutableOptions options,
      google::cloud::cpp::compute::region_target_tcp_proxies::v1::InsertTargetTcpProxyRequest const& request) {
  promise<StatusOr<google::cloud::cpp::compute::v1::Operation>> p;
  future<StatusOr<google::cloud::cpp::compute::v1::Operation>> f = p.get_future();
  std::thread t{[](
          auto p, auto service, auto request, auto rest_context, auto options) {
  ...
  query_params = rest_internal::TrimEmptyQueryParameters(std::move(query_params));
      p.set_value(rest_internal::Post<google::cloud::cpp::compute::v1::Operation>(
          *service, *rest_context, request.target_tcp_proxy_resource(),
          false,
          absl::StrCat("/", "compute", "/", rest_internal::DetermineApiVersion("v1", *options), "/", "projects", "/", request.project(), "/", "regions", "/", request.region(), "/", "targetTcpProxies"), std::move(query_params)));
    },
    std::move(p), service_, request, std::move(rest_context),
    std::move(options)};
  return f.then([t = std::move(t), cq](auto f) mutable {
...
StatusOr<google::cloud::cpp::compute::v1::Operation>
DefaultRegionTargetTcpProxiesRestStub::InsertTargetTcpProxy(
      google::cloud::rest_internal::RestContext& rest_context,
      Options const& options,
      google::cloud::cpp::compute::region_target_tcp_proxies::v1::InsertTargetTcpProxyRequest const& request) {
  std::vector<std::pair<std::string, std::string>> query_params;
...
DefaultRegionTargetTcpProxiesRestStub::ListRegionTargetTcpProxies(
      google::cloud::rest_internal::RestContext& rest_context,
      Options const& options,
      google::cloud::cpp::compute::region_target_tcp_proxies::v1::ListRegionTargetTcpProxiesRequest const& request) {
  std::vector<std::pair<std::string, std::string>> query_params;
...
future<Status>
DefaultRegionTargetTcpProxiesRestStub::AsyncCancelOperation(
    google::cloud::CompletionQueue& cq,
    std::unique_ptr<rest_internal::RestContext> rest_context,
    google::cloud::internal::ImmutableOptions options,
