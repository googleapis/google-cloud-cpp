...
class RegionTargetTcpProxiesRestMetadata : public RegionTargetTcpProxiesRestStub {
 public:
  ~RegionTargetTcpProxiesRestMetadata() override = default;
  explicit RegionTargetTcpProxiesRestMetadata(std::shared_ptr<RegionTargetTcpProxiesRestStub> child);

  google::cloud::future<StatusOr<google::cloud::cpp::compute::v1::Operation>> AsyncDeleteRegionTargetTcpProxies(
  ...
  google::cloud::future<StatusOr<google::cloud::cpp::compute::v1::Operation>> AsyncInsertRegionTargetTcpProxies(
      google::cloud::CompletionQueue& cq,
      std::unique_ptr<google::cloud::rest_internal::RestContext> rest_context,
