...
class RegionTargetTcpProxiesConnection {
 public:
  ...
  DeleteRegionTargetTcpProxies(google::cloud::cpp::compute::regionTargetTcpProxies::v1::DeleteRegionTargetTcpProxiesRequest const& request);

  virtual StatusOr<google::cloud::cpp::compute::v1::TargetTcpProxy>
  GetRegionTargetTcpProxies(google::cloud::cpp::compute::regionTargetTcpProxies::v1::GetRegionTargetTcpProxiesRequest const& request);

  virtual StatusOr<google::cloud::cpp::compute::v1::Operation>
  InsertRegionTargetTcpProxies(google::cloud::cpp::compute::regionTargetTcpProxies::v1::InsertRegionTargetTcpProxiesRequest const& request);

  virtual StreamRange<google::cloud::cpp::compute::v1::TargetTcpProxy>
  ListRegionTargetTcpProxies(google::cloud::cpp::compute::regionTargetTcpProxies::v1::ListRegionTargetTcpProxiesRequest request);
};
