 ...
 */
class RegionTargetTcpProxiesLimitedErrorCountRetryPolicy : public RegionTargetTcpProxiesRetryPolicy {
 public:
  /**
   ...
   */
  explicit RegionTargetTcpProxiesLimitedErrorCountRetryPolicy(int maximum_failures)
    : impl_(maximum_failures) {}

  RegionTargetTcpProxiesLimitedErrorCountRetryPolicy(
      RegionTargetTcpProxiesLimitedErrorCountRetryPolicy&& rhs) noexcept
    : RegionTargetTcpProxiesLimitedErrorCountRetryPolicy(rhs.maximum_failures()) {}
  RegionTargetTcpProxiesLimitedErrorCountRetryPolicy(
 ...
 private:
  google::cloud::internal::LimitedErrorCountRetryPolicy<compute_region_target_tcp_proxies_v1_internal::RegionTargetTcpProxiesRetryTraits> impl_;
};
 ...
 * - [`kUnavailable`](@ref google::cloud::StatusCode)
 */
class RegionTargetTcpProxiesLimitedTimeRetryPolicy : public RegionTargetTcpProxiesRetryPolicy {
 public:
  /**
  ...
  RegionTargetTcpProxiesLimitedTimeRetryPolicy(RegionTargetTcpProxiesLimitedTimeRetryPolicy&& rhs) noexcept
    : RegionTargetTcpProxiesLimitedTimeRetryPolicy(rhs.maximum_duration()) {}
  RegionTargetTcpProxiesLimitedTimeRetryPolicy(RegionTargetTcpProxiesLimitedTimeRetryPolicy const& rhs) noexcept
    : RegionTargetTcpProxiesLimitedTimeRetryPolicy(rhs.maximum_duration()) {}
 ...
 private:
  google::cloud::internal::LimitedTimeRetryPolicy<compute_region_target_tcp_proxies_v1_internal::RegionTargetTcpProxiesRetryTraits> impl_;
};
...
class RegionTargetTcpProxiesConnection {
 public:
  ...
  DeleteTargetTcpProxy(google::cloud::cpp::compute::region_target_tcp_proxies::v1::DeleteTargetTcpProxyRequest const& request);

  virtual StatusOr<google::cloud::cpp::compute::v1::Operation>
  DeleteTargetTcpProxy(NoAwaitTag, google::cloud::cpp::compute::region_target_tcp_proxies::v1::DeleteTargetTcpProxyRequest const& request);
  ...
  GetTargetTcpProxy(google::cloud::cpp::compute::region_target_tcp_proxies::v1::GetTargetTcpProxyRequest const& request);

  virtual future<StatusOr<google::cloud::cpp::compute::v1::Operation>>
  InsertTargetTcpProxy(google::cloud::cpp::compute::region_target_tcp_proxies::v1::InsertTargetTcpProxyRequest const& request);

  virtual StatusOr<google::cloud::cpp::compute::v1::Operation>
  InsertTargetTcpProxy(NoAwaitTag, google::cloud::cpp::compute::region_target_tcp_proxies::v1::InsertTargetTcpProxyRequest const& request);
