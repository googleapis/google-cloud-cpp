...
CreateDefaultInterconnectGroupsRestStub(Options const& options) {
  ...
  std::shared_ptr<InterconnectGroupsRestStub> stub =
      std::make_shared<DefaultInterconnectGroupsRestStub>(std::move(opts));
  stub = std::make_shared<InterconnectGroupsRestMetadata>(std::move(stub));
  if (internal::Contains(options.get<LoggingComponentsOption>(), "rpc")) {
    GCP_LOG(INFO) << "Enabled logging for REST rpc calls";
    stub = std::make_shared<InterconnectGroupsRestLogging>(
