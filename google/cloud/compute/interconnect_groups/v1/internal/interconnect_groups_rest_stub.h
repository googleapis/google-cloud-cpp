 ...
 public:
  ...
  AsyncCreateMembers(
      ...
      google::cloud::cpp::compute::interconnect_groups::v1::
          CreateMembersRequest const& request) = 0;
  ...
  AsyncDeleteInterconnectGroup(
      ...
      google::cloud::internal::ImmutableOptions options,
      google::cloud::cpp::compute::interconnect_groups::v1::
          DeleteInterconnectGroupRequest const& request) = 0;
  ...
  GetInterconnectGroup(google::cloud::rest_internal::RestContext& rest_context,
                       Options const& options,
                       google::cloud::cpp::compute::interconnect_groups::v1::
                           GetInterconnectGroupRequest const& request) = 0;
  ...
  AsyncInsertInterconnectGroup(
      ...
      google::cloud::internal::ImmutableOptions options,
      google::cloud::cpp::compute::interconnect_groups::v1::
          InsertInterconnectGroupRequest const& request) = 0;
  ...
  ListInterconnectGroups(
      ...
      Options const& options,
      google::cloud::cpp::compute::interconnect_groups::v1::
          ListInterconnectGroupsRequest const& request) = 0;
  ...
  AsyncPatchInterconnectGroup(
      ...
      google::cloud::internal::ImmutableOptions options,
      google::cloud::cpp::compute::interconnect_groups::v1::
          PatchInterconnectGroupRequest const& request) = 0;
