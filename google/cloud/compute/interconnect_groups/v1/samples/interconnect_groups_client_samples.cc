...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client =
      google::cloud::compute_interconnect_groups_v1::InterconnectGroupsClient(
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client =
      google::cloud::compute_interconnect_groups_v1::InterconnectGroupsClient(
          google::cloud::compute_interconnect_groups_v1::
              MakeInterconnectGroupsConnectionRest(*ud_options));
  //! [set-client-universe-domain]
}

//! [custom-idempotency-policy]
class CustomIdempotencyPolicy
    : public google::cloud::compute_interconnect_groups_v1::
          InterconnectGroupsConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::compute_interconnect_groups_v1::
                      InterconnectGroupsConnectionIdempotencyPolicy>
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options =
      google::cloud::Options{}
          .set<google::cloud::compute_interconnect_groups_v1::
                   InterconnectGroupsConnectionIdempotencyPolicyOption>(
              CustomIdempotencyPolicy().clone())
          .set<google::cloud::compute_interconnect_groups_v1::
                   InterconnectGroupsRetryPolicyOption>(
              google::cloud::compute_interconnect_groups_v1::
                  InterconnectGroupsLimitedErrorCountRetryPolicy(3)
                      .clone())
          .set<google::cloud::compute_interconnect_groups_v1::
              ...
              google::cloud::ExponentialBackoffPolicy(
                  ...
                  /*scaling=*/2.0)
                  .clone());
  auto connection = google::cloud::compute_interconnect_groups_v1::
      MakeInterconnectGroupsConnectionRest(options);
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::compute_interconnect_groups_v1::
