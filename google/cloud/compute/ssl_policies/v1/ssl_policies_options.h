 ...
 */
struct SslPoliciesRetryPolicyOption {
  using Type = std::shared_ptr<SslPoliciesRetryPolicy>;
};
 ...
 * @ingroup google-cloud-compute-options
 */
struct SslPoliciesBackoffPolicyOption {
 ...
 * @ingroup google-cloud-compute-options
 */
struct SslPoliciesConnectionIdempotencyPolicyOption {
  using Type = std::shared_ptr<SslPoliciesConnectionIdempotencyPolicy>;
};
 ...
 * @ingroup google-cloud-compute-options
 */
struct SslPoliciesPollingPolicyOption {
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_COMPUTE_SSL_POLICIES_V1_SSL_POLICIES_OPTIONS_H
