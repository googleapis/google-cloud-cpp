...
/**
 * A retry policy for `SslPoliciesConnection` that stops retrying after a
...
class SslPoliciesLimitedErrorCountRetryPolicy : public SslPoliciesRetryPolicy {
 public:
  SslPoliciesLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `SslPoliciesConnection` that stops retrying after
