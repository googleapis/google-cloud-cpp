...
RegionSecurityPoliciesClient::DeleteRegionSecurityPolicies(std::string const& project, std::string const& region, std::string const& security_policy, Options opts) {
  ...
  google::cloud::cpp::compute::regionSecurityPolicies::v1::DeleteRegionSecurityPoliciesRequest request;
...
StatusOr<google::cloud::cpp::compute::v1::Operation>
RegionSecurityPoliciesClient::DeleteRegionSecurityPolicies(google::cloud::cpp::compute::regionSecurityPolicies::v1::DeleteRegionSecurityPoliciesRequest const& request, Options opts) {
  internal::OptionsSpan span(internal::MergeOptions(std::move(opts), options_));
  return connection_->DeleteRegionSecurityPolicies(request);
}
...
RegionSecurityPoliciesClient::GetRegionSecurityPolicies(std::string const& project, std::string const& region, std::string const& security_policy, Options opts) {
  internal::OptionsSpan span(internal::MergeOptions(std::move(opts), options_));
  google::cloud::cpp::compute::regionSecurityPolicies::v1::GetRegionSecurityPoliciesRequest request;
  request.set_project(project);
  request.set_region(region);
  request.set_security_policy(security_policy);
...
StatusOr<google::cloud::cpp::compute::v1::SecurityPolicy>
RegionSecurityPoliciesClient::GetRegionSecurityPolicies(google::cloud::cpp::compute::regionSecurityPolicies::v1::GetRegionSecurityPoliciesRequest const& request, Options opts) {
  internal::OptionsSpan span(internal::MergeOptions(std::move(opts), options_));
  return connection_->GetRegionSecurityPolicies(request);
}
...
RegionSecurityPoliciesClient::InsertRegionSecurityPolicies(std::string const& project, std::string const& region, google::cloud::cpp::compute::v1::SecurityPolicy const& security_policy_resource, Options opts) {
  internal::OptionsSpan span(internal::MergeOptions(std::move(opts), options_));
  google::cloud::cpp::compute::regionSecurityPolicies::v1::InsertRegionSecurityPoliciesRequest request;
  request.set_project(project);
  request.set_region(region);
...
StatusOr<google::cloud::cpp::compute::v1::Operation>
RegionSecurityPoliciesClient::InsertRegionSecurityPolicies(google::cloud::cpp::compute::regionSecurityPolicies::v1::InsertRegionSecurityPoliciesRequest const& request, Options opts) {
  internal::OptionsSpan span(internal::MergeOptions(std::move(opts), options_));
  return connection_->InsertRegionSecurityPolicies(request);
}
...
RegionSecurityPoliciesClient::ListRegionSecurityPolicies(std::string const& project, std::string const& region, Options opts) {
  internal::OptionsSpan span(internal::MergeOptions(std::move(opts), options_));
  google::cloud::cpp::compute::regionSecurityPolicies::v1::ListRegionSecurityPoliciesRequest request;
  request.set_project(project);
  request.set_region(region);
...
StreamRange<google::cloud::cpp::compute::v1::SecurityPolicy>
RegionSecurityPoliciesClient::ListRegionSecurityPolicies(google::cloud::cpp::compute::regionSecurityPolicies::v1::ListRegionSecurityPoliciesRequest request, Options opts) {
  internal::OptionsSpan span(internal::MergeOptions(std::move(opts), options_));
...
RegionSecurityPoliciesClient::PatchRegionSecurityPolicies(std::string const& project, std::string const& region, std::string const& security_policy, google::cloud::cpp::compute::v1::SecurityPolicy const& security_policy_resource, Options opts) {
  internal::OptionsSpan span(internal::MergeOptions(std::move(opts), options_));
  google::cloud::cpp::compute::regionSecurityPolicies::v1::PatchRegionSecurityPoliciesRequest request;
  request.set_project(project);
  request.set_region(region);
  request.set_security_policy(security_policy);
  *request.mutable_security_policy_resource() = security_policy_resource;
...
StatusOr<google::cloud::cpp::compute::v1::Operation>
RegionSecurityPoliciesClient::PatchRegionSecurityPolicies(google::cloud::cpp::compute::regionSecurityPolicies::v1::PatchRegionSecurityPoliciesRequest const& request, Options opts) {
  internal::OptionsSpan span(internal::MergeOptions(std::move(opts), options_));
  return connection_->PatchRegionSecurityPolicies(request);
}
