...
std::shared_ptr<RegionSecurityPoliciesConnection> MakeRegionSecurityPoliciesConnectionRest(
  ...
  internal::CheckExpectedOptions<CommonOptionList, RestOptionList,
      ...
      RegionSecurityPoliciesPolicyOptionList>(options, __func__);
  options = compute_region_security_policies_v1_internal::RegionSecurityPoliciesDefaultOptions(
      std::move(options));
  auto background = std::make_unique<
      rest_internal::AutomaticallyCreatedRestBackgroundThreads>();
  auto stub = compute_region_security_policies_v1_internal::CreateDefaultRegionSecurityPoliciesRestStub(
      options);
  return compute_region_security_policies_v1_internal::MakeRegionSecurityPoliciesTracingConnection(
      std::make_shared<
          compute_region_security_policies_v1_internal::RegionSecurityPoliciesRestConnectionImpl>(
