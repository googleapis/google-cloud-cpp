...
DefaultRegionSecurityPoliciesRestStub::DeleteRegionSecurityPolicies(
...
StatusOr<google::cloud::cpp::compute::v1::Operation>
DefaultRegionSecurityPoliciesRestStub::InsertRegionSecurityPolicies(
    google::cloud::rest_internal::RestContext& rest_context,
    google::cloud::cpp::compute::regionSecurityPolicies::v1::
...
StatusOr<google::cloud::cpp::compute::v1::Operation>
DefaultRegionSecurityPoliciesRestStub::PatchRegionSecurityPolicies(
    google::cloud::rest_internal::RestContext& rest_context,
    google::cloud::cpp::compute::regionSecurityPolicies::v1::
