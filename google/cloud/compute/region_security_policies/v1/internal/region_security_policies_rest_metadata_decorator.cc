...
RegionSecurityPoliciesRestMetadata::DeleteRegionSecurityPolicies(
...
StatusOr<google::cloud::cpp::compute::v1::Operation>
RegionSecurityPoliciesRestMetadata::InsertRegionSecurityPolicies(
    rest_internal::RestContext& rest_context,
    google::cloud::cpp::compute::regionSecurityPolicies::v1::
...
StatusOr<google::cloud::cpp::compute::v1::Operation>
RegionSecurityPoliciesRestMetadata::PatchRegionSecurityPolicies(
    rest_internal::RestContext& rest_context,
    google::cloud::cpp::compute::regionSecurityPolicies::v1::
