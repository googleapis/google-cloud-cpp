...
std::shared_ptr<SslCertificatesRestStub> CreateDefaultSslCertificatesRestStub(
  ...
  auto service_endpoint = internal::DetermineServiceEndpoint(
      internal::GetEnv("GOOGLE_CLOUD_CPP_SSL_CERTIFICATES_ENDPOINT"),
  ...
  std::shared_ptr<SslCertificatesRestStub> stub =
      std::make_shared<DefaultSslCertificatesRestStub>(
          std::move(stub_creation_opts));
  stub = std::make_shared<SslCertificatesRestMetadata>(std::move(stub));
  if (internal::Contains(options.get<TracingComponentsOption>(), "rpc")) {
    GCP_LOG(INFO) << "Enabled logging for REST rpc calls";
    stub = std::make_shared<SslCertificatesRestLogging>(
