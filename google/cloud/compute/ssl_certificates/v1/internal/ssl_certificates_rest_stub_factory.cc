...
std::shared_ptr<SslCertificatesRestStub>
CreateDefaultSslCertificatesRestStub(Options const& options) {
  auto opts = internal::PopulateRestOptions(options);
  std::shared_ptr<SslCertificatesRestStub> stub =
      std::make_shared<DefaultSslCertificatesRestStub>(std::move(opts));
