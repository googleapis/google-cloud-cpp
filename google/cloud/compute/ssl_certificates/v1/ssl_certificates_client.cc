...
StatusOr<google::cloud::cpp::compute::v1::SslCertificateAggregatedList>
SslCertificatesClient::AggregatedListSslCertificates(google::cloud::cpp::compute::ssl_certificates::v1::AggregatedListSslCertificatesRequest const& request, Options opts) {
  internal::OptionsSpan span(internal::MergeOptions(std::move(opts), options_));
  return connection_->AggregatedListSslCertificates(request);
}
...
SslCertificatesClient::DeleteSslCertificates(std::string const& project, std::string const& ssl_certificate, Options opts) {
  internal::OptionsSpan span(internal::MergeOptions(std::move(opts), options_));
  google::cloud::cpp::compute::ssl_certificates::v1::DeleteSslCertificatesRequest request;
  request.set_project(project);
...
future<StatusOr<google::cloud::cpp::compute::v1::Operation>>
SslCertificatesClient::DeleteSslCertificates(google::cloud::cpp::compute::ssl_certificates::v1::DeleteSslCertificatesRequest const& request, Options opts) {
  internal::OptionsSpan span(internal::MergeOptions(std::move(opts), options_));
  return connection_->DeleteSslCertificates(request);
}
...
SslCertificatesClient::GetSslCertificates(std::string const& project, std::string const& ssl_certificate, Options opts) {
  internal::OptionsSpan span(internal::MergeOptions(std::move(opts), options_));
  google::cloud::cpp::compute::ssl_certificates::v1::GetSslCertificatesRequest request;
  request.set_project(project);
  request.set_ssl_certificate(ssl_certificate);
...
StatusOr<google::cloud::cpp::compute::v1::SslCertificate>
SslCertificatesClient::GetSslCertificates(google::cloud::cpp::compute::ssl_certificates::v1::GetSslCertificatesRequest const& request, Options opts) {
  internal::OptionsSpan span(internal::MergeOptions(std::move(opts), options_));
  return connection_->GetSslCertificates(request);
}
...
SslCertificatesClient::InsertSslCertificates(std::string const& project, google::cloud::cpp::compute::v1::SslCertificate const& ssl_certificate_resource, Options opts) {
  internal::OptionsSpan span(internal::MergeOptions(std::move(opts), options_));
  google::cloud::cpp::compute::ssl_certificates::v1::InsertSslCertificatesRequest request;
  request.set_project(project);
...
future<StatusOr<google::cloud::cpp::compute::v1::Operation>>
SslCertificatesClient::InsertSslCertificates(google::cloud::cpp::compute::ssl_certificates::v1::InsertSslCertificatesRequest const& request, Options opts) {
  internal::OptionsSpan span(internal::MergeOptions(std::move(opts), options_));
  return connection_->InsertSslCertificates(request);
}
