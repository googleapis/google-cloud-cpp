...
ProjectsRestMetadata::AsyncSetCommonInstanceMetadata(
  ...
  SetMetadata(*rest_context);
  return child_->AsyncSetCommonInstanceMetadata(cq, std::move(rest_context), request);
}
...
ProjectsRestMetadata::AsyncSetDefaultNetworkTier(
  ...
  SetMetadata(*rest_context);
  return child_->AsyncSetDefaultNetworkTier(cq, std::move(rest_context), request);
}
...
ProjectsRestMetadata::AsyncSetUsageExportBucket(
  ...
  SetMetadata(*rest_context);
  return child_->AsyncSetUsageExportBucket(cq, std::move(rest_context), request);
}
