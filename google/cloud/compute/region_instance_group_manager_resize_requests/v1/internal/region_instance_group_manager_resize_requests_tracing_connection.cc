...
RegionInstanceGroupManagerResizeRequestsTracingConnection::
    RegionInstanceGroupManagerResizeRequestsTracingConnection(
        std::shared_ptr<
...
RegionInstanceGroupManagerResizeRequestsTracingConnection::Cancel(
...
RegionInstanceGroupManagerResizeRequestsTracingConnection::
  ...
  internal::OTelScope scope(span);
  auto sr =
      child_->ListRegionInstanceGroupManagerResizeRequests(std::move(request));
