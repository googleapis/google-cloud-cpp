...
class InstanceTemplatesRestMetadata : public InstanceTemplatesRestStub {
 public:
  ...
  explicit InstanceTemplatesRestMetadata(std::shared_ptr<InstanceTemplatesRestStub> child);
  ...
  google::cloud::future<StatusOr<google::cloud::cpp::compute::v1::Operation>> AsyncDeleteInstanceTemplates(
  ...
  google::cloud::future<StatusOr<google::cloud::cpp::compute::v1::Operation>> AsyncInsertInstanceTemplates(
      google::cloud::CompletionQueue& cq,
      std::unique_ptr<google::cloud::rest_internal::RestContext> rest_context,
