...
Idempotency InstanceTemplatesConnectionIdempotencyPolicy::AggregatedListInstanceTemplates(google::cloud::cpp::compute::instance_templates::v1::AggregatedListInstanceTemplatesRequest const&) {
  return Idempotency::kIdempotent;
}

Idempotency InstanceTemplatesConnectionIdempotencyPolicy::DeleteInstanceTemplates(google::cloud::cpp::compute::instance_templates::v1::DeleteInstanceTemplatesRequest const&) {
  return Idempotency::kNonIdempotent;
}

Idempotency InstanceTemplatesConnectionIdempotencyPolicy::GetInstanceTemplates(google::cloud::cpp::compute::instance_templates::v1::GetInstanceTemplatesRequest const&) {
  return Idempotency::kIdempotent;
}
...
Idempotency InstanceTemplatesConnectionIdempotencyPolicy::InsertInstanceTemplates(google::cloud::cpp::compute::instance_templates::v1::InsertInstanceTemplatesRequest const&) {
  return Idempotency::kNonIdempotent;
}
