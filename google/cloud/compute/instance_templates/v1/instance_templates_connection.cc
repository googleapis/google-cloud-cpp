...
InstanceTemplatesConnection::AggregatedListInstanceTemplates(
    google::cloud::cpp::compute::instanceTemplates::v1::AggregatedListInstanceTemplatesRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

StatusOr<google::cloud::cpp::compute::v1::Operation>
InstanceTemplatesConnection::DeleteInstanceTemplates(
    google::cloud::cpp::compute::instanceTemplates::v1::DeleteInstanceTemplatesRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

StatusOr<google::cloud::cpp::compute::v1::InstanceTemplate>
InstanceTemplatesConnection::GetInstanceTemplates(
    google::cloud::cpp::compute::instanceTemplates::v1::GetInstanceTemplatesRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

StatusOr<google::cloud::cpp::compute::v1::Policy>
InstanceTemplatesConnection::GetIamPolicy(
    google::cloud::cpp::compute::instanceTemplates::v1::GetIamPolicyRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

StatusOr<google::cloud::cpp::compute::v1::Operation>
InstanceTemplatesConnection::InsertInstanceTemplates(
    google::cloud::cpp::compute::instanceTemplates::v1::InsertInstanceTemplatesRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

StreamRange<google::cloud::cpp::compute::v1::InstanceTemplate> InstanceTemplatesConnection::ListInstanceTemplates(
    google::cloud::cpp::compute::instanceTemplates::v1::ListInstanceTemplatesRequest) {  // NOLINT(performance-unnecessary-value-param)
...
InstanceTemplatesConnection::SetIamPolicy(
    google::cloud::cpp::compute::instanceTemplates::v1::SetIamPolicyRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

StatusOr<google::cloud::cpp::compute::v1::TestPermissionsResponse>
InstanceTemplatesConnection::TestIamPermissions(
    google::cloud::cpp::compute::instanceTemplates::v1::TestIamPermissionsRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}
