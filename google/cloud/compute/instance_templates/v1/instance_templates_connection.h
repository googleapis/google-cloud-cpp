...
/**
 * A retry policy for `InstanceTemplatesConnection` that stops retrying after a
...
class InstanceTemplatesLimitedErrorCountRetryPolicy
 ...
 public:
  InstanceTemplatesLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `InstanceTemplatesConnection` that stops retrying after
