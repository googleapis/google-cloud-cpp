...
class MockInstanceGroupsConnection : public compute_instance_groups_v1::InstanceGroupsConnection {
 public:
  ...
  /// EXPECT_CALL(*mock, AddInstances(Matcher<google::cloud::cpp::compute::instance_groups::v1::AddInstancesRequest const&>(_)))
  /// @endcode
  ...
  /// using ::testing::_;
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock, AddInstances(Matcher<google::cloud::cpp::compute::v1::Operation const&>(_)))
  /// @endcode
  MOCK_METHOD(future<StatusOr<google::cloud::cpp::compute::v1::Operation>>,
  AddInstances, (
    google::cloud::cpp::compute::v1::Operation const& operation), (override));

  MOCK_METHOD((StreamRange<std::pair<std::string, google::cloud::cpp::compute::v1::InstanceGroupsScopedList>>),
  AggregatedListInstanceGroups,
  (google::cloud::cpp::compute::instance_groups::v1::AggregatedListInstanceGroupsRequest request), (override));
  ...
  /// using ::testing::_;
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock, DeleteInstanceGroup(Matcher<google::cloud::cpp::compute::instance_groups::v1::DeleteInstanceGroupRequest const&>(_)))
  /// @endcode
  MOCK_METHOD(future<StatusOr<google::cloud::cpp::compute::v1::Operation>>,
  DeleteInstanceGroup,
  ...
  /// using ::testing::_;
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock, DeleteInstanceGroup(Matcher<google::cloud::cpp::compute::v1::Operation const&>(_)))
  /// @endcode
  MOCK_METHOD(future<StatusOr<google::cloud::cpp::compute::v1::Operation>>,
  DeleteInstanceGroup, (
    google::cloud::cpp::compute::v1::Operation const& operation), (override));
  ...
  GetInstanceGroup,
  (google::cloud::cpp::compute::instance_groups::v1::GetInstanceGroupRequest const& request), (override));
  ...
  /// using ::testing::_;
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock, InsertInstanceGroup(Matcher<google::cloud::cpp::compute::instance_groups::v1::InsertInstanceGroupRequest const&>(_)))
  /// @endcode
  MOCK_METHOD(future<StatusOr<google::cloud::cpp::compute::v1::Operation>>,
  InsertInstanceGroup,
  ...
  /// using ::testing::_;
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock, InsertInstanceGroup(Matcher<google::cloud::cpp::compute::v1::Operation const&>(_)))
  /// @endcode
  MOCK_METHOD(future<StatusOr<google::cloud::cpp::compute::v1::Operation>>,
  InsertInstanceGroup, (
    google::cloud::cpp::compute::v1::Operation const& operation), (override));
  ...
  ListInstanceGroups,
  (google::cloud::cpp::compute::instance_groups::v1::ListInstanceGroupsRequest request), (override));

  MOCK_METHOD((StreamRange<google::cloud::cpp::compute::v1::InstanceWithNamedPorts>),
  ListInstances,
  (google::cloud::cpp::compute::instance_groups::v1::ListInstancesRequest request), (override));
  ...
  /// using ::testing::_;
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock, RemoveInstances(Matcher<google::cloud::cpp::compute::instance_groups::v1::RemoveInstancesRequest const&>(_)))
  /// @endcode
  MOCK_METHOD(future<StatusOr<google::cloud::cpp::compute::v1::Operation>>,
  RemoveInstances,
  ...
  /// using ::testing::_;
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock, RemoveInstances(Matcher<google::cloud::cpp::compute::v1::Operation const&>(_)))
  /// @endcode
  MOCK_METHOD(future<StatusOr<google::cloud::cpp::compute::v1::Operation>>,
  RemoveInstances, (
    google::cloud::cpp::compute::v1::Operation const& operation), (override));
  ...
  /// using ::testing::_;
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock, SetNamedPorts(Matcher<google::cloud::cpp::compute::instance_groups::v1::SetNamedPortsRequest const&>(_)))
  /// @endcode
  MOCK_METHOD(future<StatusOr<google::cloud::cpp::compute::v1::Operation>>,
  SetNamedPorts,
  ...
  /// using ::testing::_;
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock, SetNamedPorts(Matcher<google::cloud::cpp::compute::v1::Operation const&>(_)))
  /// @endcode
  MOCK_METHOD(future<StatusOr<google::cloud::cpp::compute::v1::Operation>>,
  SetNamedPorts, (
    google::cloud::cpp::compute::v1::Operation const& operation), (override));
