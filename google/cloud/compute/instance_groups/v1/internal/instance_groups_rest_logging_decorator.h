...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_COMPUTE_INSTANCE_GROUPS_V1_INTERNAL_INSTANCE_GROUPS_REST_LOGGING_DECORATOR_H
...
class InstanceGroupsRestLogging : public InstanceGroupsRestStub {
 public:
  ~InstanceGroupsRestLogging() override = default;
  InstanceGroupsRestLogging(std::shared_ptr<InstanceGroupsRestStub> child,
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_COMPUTE_INSTANCE_GROUPS_V1_INTERNAL_INSTANCE_GROUPS_REST_LOGGING_DECORATOR_H
