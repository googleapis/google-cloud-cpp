...
std::shared_ptr<InstanceGroupsRestStub>
CreateDefaultInstanceGroupsRestStub(Options const& options) {
  auto opts = internal::PopulateRestOptions(options);
  std::shared_ptr<InstanceGroupsRestStub> stub =
      std::make_shared<DefaultInstanceGroupsRestStub>(std::move(opts));
