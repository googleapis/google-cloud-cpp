...
class InstanceGroupsRestConnectionImpl
 ...
 public:
  ...
  AddInstances(google::cloud::cpp::compute::instanceGroups::v1::AddInstancesRequest const& request) override;

  StatusOr<google::cloud::cpp::compute::v1::InstanceGroupAggregatedList>
  AggregatedListInstanceGroups(google::cloud::cpp::compute::instanceGroups::v1::AggregatedListInstanceGroupsRequest const& request) override;

  StatusOr<google::cloud::cpp::compute::v1::Operation>
  DeleteInstanceGroups(google::cloud::cpp::compute::instanceGroups::v1::DeleteInstanceGroupsRequest const& request) override;

  StatusOr<google::cloud::cpp::compute::v1::InstanceGroup>
  GetInstanceGroups(google::cloud::cpp::compute::instanceGroups::v1::GetInstanceGroupsRequest const& request) override;

  StatusOr<google::cloud::cpp::compute::v1::Operation>
  InsertInstanceGroups(google::cloud::cpp::compute::instanceGroups::v1::InsertInstanceGroupsRequest const& request) override;

  StreamRange<google::cloud::cpp::compute::v1::InstanceGroup>
  ListInstanceGroups(google::cloud::cpp::compute::instanceGroups::v1::ListInstanceGroupsRequest request) override;

  StreamRange<google::cloud::cpp::compute::v1::InstanceWithNamedPorts>
  ListInstances(google::cloud::cpp::compute::instanceGroups::v1::ListInstancesRequest request) override;

  StatusOr<google::cloud::cpp::compute::v1::Operation>
  RemoveInstances(google::cloud::cpp::compute::instanceGroups::v1::RemoveInstancesRequest const& request) override;

  StatusOr<google::cloud::cpp::compute::v1::Operation>
  SetNamedPorts(google::cloud::cpp::compute::instanceGroups::v1::SetNamedPortsRequest const& request) override;

 private:
  std::unique_ptr<compute_instance_groups_v1::InstanceGroupsRetryPolicy> retry_policy() {
    ...
    return options_.get<compute_instance_groups_v1::InstanceGroupsRetryPolicyOption>()->clone();
  }
  ...
  std::unique_ptr<BackoffPolicy> backoff_policy() {
    ...
    return options_.get<compute_instance_groups_v1::InstanceGroupsBackoffPolicyOption>()->clone();
  }

  std::unique_ptr<compute_instance_groups_v1::InstanceGroupsConnectionIdempotencyPolicy> idempotency_policy() {
    auto const& options = internal::CurrentOptions();
    ...
    return options_.get<compute_instance_groups_v1::InstanceGroupsConnectionIdempotencyPolicyOption>()->
clone();
  }
