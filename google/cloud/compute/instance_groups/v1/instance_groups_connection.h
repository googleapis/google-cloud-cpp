...
/**
 * A retry policy for `InstanceGroupsConnection` that stops retrying after a
...
class InstanceGroupsLimitedErrorCountRetryPolicy
 ...
 public:
  InstanceGroupsLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `InstanceGroupsConnection` that stops retrying after
