...
InstanceGroupsConnection::AggregatedListInstanceGroups(
    google::cloud::cpp::compute::instanceGroups::v1::AggregatedListInstanceGroupsRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

StatusOr<google::cloud::cpp::compute::v1::Operation>
InstanceGroupsConnection::DeleteInstanceGroups(
    google::cloud::cpp::compute::instanceGroups::v1::DeleteInstanceGroupsRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

StatusOr<google::cloud::cpp::compute::v1::InstanceGroup>
InstanceGroupsConnection::GetInstanceGroups(
    google::cloud::cpp::compute::instanceGroups::v1::GetInstanceGroupsRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

StatusOr<google::cloud::cpp::compute::v1::Operation>
InstanceGroupsConnection::InsertInstanceGroups(
    google::cloud::cpp::compute::instanceGroups::v1::InsertInstanceGroupsRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

StreamRange<google::cloud::cpp::compute::v1::InstanceGroup> InstanceGroupsConnection::ListInstanceGroups(
    google::cloud::cpp::compute::instanceGroups::v1::ListInstanceGroupsRequest) {  // NOLINT(performance-unnecessary-value-param)
...
StreamRange<google::cloud::cpp::compute::v1::InstanceWithNamedPorts> InstanceGroupsConnection::ListInstances(
    google::cloud::cpp::compute::instanceGroups::v1::ListInstancesRequest) {  // NOLINT(performance-unnecessary-value-param)
  return google::cloud::internal::MakeUnimplementedPaginationRange<
...
InstanceGroupsConnection::RemoveInstances(
    google::cloud::cpp::compute::instanceGroups::v1::RemoveInstancesRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}
