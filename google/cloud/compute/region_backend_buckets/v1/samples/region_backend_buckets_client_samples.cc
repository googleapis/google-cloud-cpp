...
// clang-format off
// main-dox-marker: compute_region_backend_buckets_v1::RegionBackendBucketsClient
// lro-marker: true
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::compute_region_backend_buckets_v1::
      RegionBackendBucketsClient(
          google::cloud::compute_region_backend_buckets_v1::
              MakeRegionBackendBucketsConnectionRest(options));
  //! [set-client-endpoint]
}
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::compute_region_backend_buckets_v1::
      RegionBackendBucketsClient(
          google::cloud::compute_region_backend_buckets_v1::
              MakeRegionBackendBucketsConnectionRest(*ud_options));
  //! [set-client-universe-domain]
}

//! [custom-idempotency-policy]
class CustomIdempotencyPolicy
    : public google::cloud::compute_region_backend_buckets_v1::
          RegionBackendBucketsConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::compute_region_backend_buckets_v1::
                      RegionBackendBucketsConnectionIdempotencyPolicy>
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options =
      google::cloud::Options{}
          .set<google::cloud::compute_region_backend_buckets_v1::
                   RegionBackendBucketsConnectionIdempotencyPolicyOption>(
              CustomIdempotencyPolicy().clone())
          .set<google::cloud::compute_region_backend_buckets_v1::
                   RegionBackendBucketsRetryPolicyOption>(
              google::cloud::compute_region_backend_buckets_v1::
                  RegionBackendBucketsLimitedErrorCountRetryPolicy(3)
                      .clone())
          .set<google::cloud::compute_region_backend_buckets_v1::
                   RegionBackendBucketsBackoffPolicyOption>(
              google::cloud::ExponentialBackoffPolicy(
                  /*initial_delay=*/std::chrono::milliseconds(200),
                  /*maximum_delay=*/std::chrono::seconds(45),
                  /*scaling=*/2.0)
                  .clone());
  auto connection = google::cloud::compute_region_backend_buckets_v1::
      MakeRegionBackendBucketsConnectionRest(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::compute_region_backend_buckets_v1::
      RegionBackendBucketsClient(connection);
  auto c2 = google::cloud::compute_region_backend_buckets_v1::
      RegionBackendBucketsClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::compute_region_backend_buckets_v1::
      RegionBackendBucketsClient(
          connection,
          google::cloud::Options{}
              .set<google::cloud::compute_region_backend_buckets_v1::
                       RegionBackendBucketsRetryPolicyOption>(
                  google::cloud::compute_region_backend_buckets_v1::
                      RegionBackendBucketsLimitedTimeRetryPolicy(
                          std::chrono::minutes(5))
                          .clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::compute_region_backend_buckets_v1::RegionBackendBucketsRetryPolicyOption>(
  //       google::cloud::compute_region_backend_buckets_v1::RegionBackendBucketsLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options =
      google::cloud::Options{}
          .set<google::cloud::compute_region_backend_buckets_v1::
                   RegionBackendBucketsPollingPolicyOption>(
              google::cloud::GenericPollingPolicy<
                  google::cloud::compute_region_backend_buckets_v1::
                      RegionBackendBucketsRetryPolicyOption::Type,
                  google::cloud::compute_region_backend_buckets_v1::
                      RegionBackendBucketsBackoffPolicyOption::Type>(
                  google::cloud::compute_region_backend_buckets_v1::
                      RegionBackendBucketsLimitedTimeRetryPolicy(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::compute_region_backend_buckets_v1::
        RegionBackendBucketsClient(
            google::cloud::compute_region_backend_buckets_v1::
                MakeRegionBackendBucketsConnectionRest(options));
  }
