...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_COMPUTE_REGION_BACKEND_BUCKETS_V1_INTERNAL_REGION_BACKEND_BUCKETS_REST_STUB_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_COMPUTE_REGION_BACKEND_BUCKETS_V1_INTERNAL_REGION_BACKEND_BUCKETS_REST_STUB_H
...
class RegionBackendBucketsRestStub {
 public:
  virtual ~RegionBackendBucketsRestStub() = default;
  ...
  ListRegionBackendBuckets(
      ...
      Options const& options,
      google::cloud::cpp::compute::region_backend_buckets::v1::
          ListRegionBackendBucketsRequest const& request) = 0;
...
class DefaultRegionBackendBucketsRestStub
    : public RegionBackendBucketsRestStub {
 public:
  ~DefaultRegionBackendBucketsRestStub() override = default;

  explicit DefaultRegionBackendBucketsRestStub(Options options);
  DefaultRegionBackendBucketsRestStub(
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_COMPUTE_REGION_BACKEND_BUCKETS_V1_INTERNAL_REGION_BACKEND_BUCKETS_REST_STUB_H
