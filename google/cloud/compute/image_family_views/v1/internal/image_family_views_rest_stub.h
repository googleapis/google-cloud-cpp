...
class ImageFamilyViewsRestStub {
 public:
  ...
  virtual StatusOr<google::cloud::cpp::compute::v1::ImageFamilyView> GetImageFamilyViews(
      google::cloud::rest_internal::RestContext& rest_context,
      google::cloud::cpp::compute::image_family_views::v1::GetImageFamilyViewsRequest const& request) = 0;
};
