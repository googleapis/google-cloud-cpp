...
ImageFamilyViewsTracingConnection::GetImageFamilyViews(google::cloud::cpp::compute::image_family_views::v1::GetImageFamilyViewsRequest const& request) {
  auto span = internal::MakeSpan("compute_image_family_views_v1::ImageFamilyViewsConnection::GetImageFamilyViews");
