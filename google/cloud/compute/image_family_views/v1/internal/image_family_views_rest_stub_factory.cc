...
std::shared_ptr<ImageFamilyViewsRestStub>
CreateDefaultImageFamilyViewsRestStub(Options const& options) {
  auto opts = internal::PopulateRestOptions(options);
  std::shared_ptr<ImageFamilyViewsRestStub> stub =
      std::make_shared<DefaultImageFamilyViewsRestStub>(std::move(opts));
