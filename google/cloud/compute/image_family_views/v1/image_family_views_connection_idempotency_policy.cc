...
Idempotency ImageFamilyViewsConnectionIdempotencyPolicy::GetImageFamilyViews(google::cloud::cpp::compute::imageFamilyViews::v1::GetImageFamilyViewsRequest const&) {
