...
class SnapshotSettingsRetryPolicy : public ::google::cloud::RetryPolicy {
 public:
  ...
  virtual std::unique_ptr<SnapshotSettingsRetryPolicy> clone() const = 0;
};

/**
 * A retry policy for `SnapshotSettingsConnection` based on counting errors.
 *
...
class SnapshotSettingsLimitedErrorCountRetryPolicy : public SnapshotSettingsRetryPolicy {
 public:
  ...
  std::unique_ptr<SnapshotSettingsRetryPolicy> clone() const override {
    return std::make_unique<SnapshotSettingsLimitedErrorCountRetryPolicy>(
        maximum_failures());
  }
...
/**
 * A retry policy for `SnapshotSettingsConnection` based on elapsed time.
 *
 * This policy stops retrying if:
 * - An RPC returns a non-transient error.
...
class SnapshotSettingsLimitedTimeRetryPolicy : public SnapshotSettingsRetryPolicy {
 public:
  ...
  std::unique_ptr<SnapshotSettingsRetryPolicy> clone() const override {
    return std::make_unique<SnapshotSettingsLimitedTimeRetryPolicy>(
        maximum_duration());
  }
...
/**
 * The `SnapshotSettingsConnection` object for `SnapshotSettingsClient`.
 *
 * This interface defines virtual methods for each of the user-facing overload
 * sets in `SnapshotSettingsClient`. This allows users to inject custom behavior
...
class SnapshotSettingsConnection {
 public:
  virtual ~SnapshotSettingsConnection() = 0;
  ...
  PatchSnapshotSettings(NoAwaitTag, google::cloud::cpp::compute::snapshot_settings::v1::PatchSnapshotSettingsRequest const& request);

  virtual future<StatusOr<google::cloud::cpp::compute::v1::Operation>>
  PatchSnapshotSettings( google::cloud::cpp::compute::v1::Operation const& operation);
};
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_COMPUTE_SNAPSHOT_SETTINGS_V1_SNAPSHOT_SETTINGS_CONNECTION_H
