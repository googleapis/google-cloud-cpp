...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_COMPUTE_SNAPSHOT_SETTINGS_V1_INTERNAL_SNAPSHOT_SETTINGS_REST_LOGGING_DECORATOR_H
...
class SnapshotSettingsRestLogging : public SnapshotSettingsRestStub {
 public:
  ~SnapshotSettingsRestLogging() override = default;
  SnapshotSettingsRestLogging(std::shared_ptr<SnapshotSettingsRestStub> child,
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_COMPUTE_SNAPSHOT_SETTINGS_V1_INTERNAL_SNAPSHOT_SETTINGS_REST_LOGGING_DECORATOR_H
