...
std::shared_ptr<RegionAutoscalersConnection> MakeRegionAutoscalersConnectionRest(
  ...
  internal::CheckExpectedOptions<CommonOptionList, RestOptionList,
      ...
      RegionAutoscalersPolicyOptionList>(options, __func__);
  options = compute_region_autoscalers_v1_internal::RegionAutoscalersDefaultOptions(
      std::move(options));
  auto background = std::make_unique<
      rest_internal::AutomaticallyCreatedRestBackgroundThreads>();
  auto stub = compute_region_autoscalers_v1_internal::CreateDefaultRegionAutoscalersRestStub(
      options);
  return compute_region_autoscalers_v1_internal::MakeRegionAutoscalersTracingConnection(
      std::make_shared<
          compute_region_autoscalers_v1_internal::RegionAutoscalersRestConnectionImpl>(
