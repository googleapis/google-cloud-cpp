...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::compute_url_maps_v1::UrlMapsClient(
...
class CustomIdempotencyPolicy
   : public google::cloud::compute_url_maps_v1::UrlMapsConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::compute_url_maps_v1::UrlMapsConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::compute_url_maps_v1::UrlMapsConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::compute_url_maps_v1::UrlMapsRetryPolicyOption>(
      google::cloud::compute_url_maps_v1::UrlMapsLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::compute_url_maps_v1::UrlMapsBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::compute_url_maps_v1::MakeUrlMapsConnectionRest(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::compute_url_maps_v1::UrlMapsClient(connection);
  auto c2 = google::cloud::compute_url_maps_v1::UrlMapsClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::compute_url_maps_v1::UrlMapsClient(
    connection, google::cloud::Options{}.set<google::cloud::compute_url_maps_v1::UrlMapsRetryPolicyOption>(
      google::cloud::compute_url_maps_v1::UrlMapsLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::compute_url_maps_v1::UrlMapsRetryPolicyOption>(
  //       google::cloud::compute_url_maps_v1::UrlMapsLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::compute_url_maps_v1::UrlMapsPollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::compute_url_maps_v1::UrlMapsRetryPolicyOption::Type,
            google::cloud::compute_url_maps_v1::UrlMapsBackoffPolicyOption::Type>(
            google::cloud::compute_url_maps_v1::UrlMapsLimitedTimeRetryPolicy(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::compute_url_maps_v1::UrlMapsClient(
      google::cloud::compute_url_maps_v1::MakeUrlMapsConnectionRest(options));
  }
  //! [with-service-account]
  (argv.at(0));
