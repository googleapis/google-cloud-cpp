 ...
 */
struct UrlMapsRetryPolicyOption {
  using Type = std::shared_ptr<UrlMapsRetryPolicy>;
};
 ...
 * @ingroup google-cloud-compute-options
 */
struct UrlMapsBackoffPolicyOption {
 ...
 * @ingroup google-cloud-compute-options
 */
struct UrlMapsConnectionIdempotencyPolicyOption {
  using Type = std::shared_ptr<UrlMapsConnectionIdempotencyPolicy>;
};
 ...
 * @ingroup google-cloud-compute-options
 */
struct UrlMapsPollingPolicyOption {
  using Type = std::shared_ptr<PollingPolicy>;
};

/**
 * The options applicable to UrlMaps.
 *
 * @ingroup google-cloud-compute-options
 */
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_COMPUTE_URL_MAPS_V1_URL_MAPS_OPTIONS_H
