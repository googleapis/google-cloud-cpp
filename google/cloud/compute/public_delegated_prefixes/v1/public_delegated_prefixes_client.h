...
class PublicDelegatedPrefixesClient {
 public:
  ...
  /// [google.cloud.cpp.compute.v1.PublicDelegatedPrefixesScopedList]: @cloud_cpp_reference_link{google/cloud/compute/v1/internal/common_090.proto#L137}
  ///
  // clang-format on
  ...
  /// [google.cloud.cpp.compute.v1.PublicDelegatedPrefix]: @cloud_cpp_reference_link{google/cloud/compute/v1/internal/common_089.proto#L29}
  ///
  // clang-format on
