...
std::shared_ptr<PublicDelegatedPrefixesConnection> MakePublicDelegatedPrefixesConnectionRest(
  ...
  internal::CheckExpectedOptions<CommonOptionList, RestOptionList,
      ...
      PublicDelegatedPrefixesPolicyOptionList>(options, __func__);
  options = compute_public_delegated_prefixes_v1_internal::PublicDelegatedPrefixesDefaultOptions(
      std::move(options));
  auto background = std::make_unique<
      rest_internal::AutomaticallyCreatedRestBackgroundThreads>();
  auto stub = compute_public_delegated_prefixes_v1_internal::CreateDefaultPublicDelegatedPrefixesRestStub(
      options);
  return compute_public_delegated_prefixes_v1_internal::MakePublicDelegatedPrefixesTracingConnection(
      std::make_shared<
          compute_public_delegated_prefixes_v1_internal::PublicDelegatedPrefixesRestConnectionImpl>(
