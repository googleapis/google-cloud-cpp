...
clone();
  ...
  std::unique_ptr<PollingPolicy> polling_policy() {
    ...
    if (options.has<compute_public_delegated_prefixes_v1::PublicDelegatedPrefixesPollingPolicyOption>()) {
      return options.get<compute_public_delegated_prefixes_v1::PublicDelegatedPrefixesPollingPolicyOption>()->clone();
    }
    return options_.get<compute_public_delegated_prefixes_v1::PublicDelegatedPrefixesPollingPolicyOption>()->clone();
  }
