...
PublicDelegatedPrefixesConnection::AggregatedListPublicDelegatedPrefixes(
    google::cloud::cpp::compute::publicDelegatedPrefixes::v1::AggregatedListPublicDelegatedPrefixesRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

StatusOr<google::cloud::cpp::compute::v1::Operation>
PublicDelegatedPrefixesConnection::DeletePublicDelegatedPrefixes(
    google::cloud::cpp::compute::publicDelegatedPrefixes::v1::DeletePublicDelegatedPrefixesRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

StatusOr<google::cloud::cpp::compute::v1::PublicDelegatedPrefix>
PublicDelegatedPrefixesConnection::GetPublicDelegatedPrefixes(
    google::cloud::cpp::compute::publicDelegatedPrefixes::v1::GetPublicDelegatedPrefixesRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

StatusOr<google::cloud::cpp::compute::v1::Operation>
PublicDelegatedPrefixesConnection::InsertPublicDelegatedPrefixes(
    google::cloud::cpp::compute::publicDelegatedPrefixes::v1::InsertPublicDelegatedPrefixesRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}
...
StreamRange<google::cloud::cpp::compute::v1::PublicDelegatedPrefix> PublicDelegatedPrefixesConnection::ListPublicDelegatedPrefixes(
    google::cloud::cpp::compute::publicDelegatedPrefixes::v1::ListPublicDelegatedPrefixesRequest) {  // NOLINT(performance-unnecessary-value-param)
...
PublicDelegatedPrefixesConnection::PatchPublicDelegatedPrefixes(
    google::cloud::cpp::compute::publicDelegatedPrefixes::v1::PatchPublicDelegatedPrefixesRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}
