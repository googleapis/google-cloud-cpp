...
DefaultRegionsRestStub::GetRegion(
  ...
  return rest_internal::Get<google::cloud::cpp::compute::v1::Region>(
      *service_, rest_context, request, false,
      absl::StrCat("/", "compute", "/", rest_internal::DetermineApiVersion("v1", options), "/", "projects", "/", request.project(), "/", "regions", "/", request.region()), std::move(query_params));
}
...
DefaultRegionsRestStub::ListRegions(
  ...
  return rest_internal::Get<google::cloud::cpp::compute::v1::RegionList>(
      *service_, rest_context, request, false,
      absl::StrCat("/", "compute", "/", rest_internal::DetermineApiVersion("v1", options), "/", "projects", "/", request.project(), "/", "regions"), std::move(query_params));
}
