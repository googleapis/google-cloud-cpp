...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_COMPUTE_REGIONS_V1_INTERNAL_REGIONS_REST_STUB_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_COMPUTE_REGIONS_V1_INTERNAL_REGIONS_REST_STUB_H
...
class RegionsRestStub {
 public:
  ...
  virtual StatusOr<google::cloud::cpp::compute::v1::Region> GetRegions(
      ...
      google::cloud::cpp::compute::regions::v1::GetRegionsRequest const& request) = 0;

  virtual StatusOr<google::cloud::cpp::compute::v1::RegionList> ListRegions(
      google::cloud::rest_internal::RestContext& rest_context,
      google::cloud::cpp::compute::regions::v1::ListRegionsRequest const& request) = 0;
};
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_COMPUTE_REGIONS_V1_INTERNAL_REGIONS_REST_STUB_H
