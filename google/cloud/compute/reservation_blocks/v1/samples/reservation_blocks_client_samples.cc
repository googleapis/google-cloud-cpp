...
class CustomIdempotencyPolicy
    : public google::cloud::compute_reservation_blocks_v1::
          ReservationBlocksConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::compute_reservation_blocks_v1::
                      ReservationBlocksConnectionIdempotencyPolicy>
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options =
      google::cloud::Options{}
          .set<google::cloud::compute_reservation_blocks_v1::
                   ReservationBlocksConnectionIdempotencyPolicyOption>(
              CustomIdempotencyPolicy().clone())
          .set<google::cloud::compute_reservation_blocks_v1::
                   ReservationBlocksRetryPolicyOption>(
              google::cloud::compute_reservation_blocks_v1::
                  ReservationBlocksLimitedErrorCountRetryPolicy(3)
                      .clone())
          .set<google::cloud::compute_reservation_blocks_v1::
              ...
              google::cloud::ExponentialBackoffPolicy(
                  ...
                  /*scaling=*/2.0)
                  .clone());
  auto connection = google::cloud::compute_reservation_blocks_v1::
      MakeReservationBlocksConnectionRest(options);
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::compute_reservation_blocks_v1::
