...
DefaultReservationBlocksRestStub::DefaultReservationBlocksRestStub(Options options)
...
DefaultReservationBlocksRestStub::DefaultReservationBlocksRestStub(
...
DefaultReservationBlocksRestStub::GetReservationBlocksGetResponse(
  ...
  return rest_internal::Get<google::cloud::cpp::compute::v1::ReservationBlocksGetResponse>(
      *service_, rest_context, request, false,
      absl::StrCat("/", "compute", "/", rest_internal::DetermineApiVersion("v1", options), "/", "projects", "/", request.project(), "/", "zones", "/", request.zone(), "/", "reservations", "/", request.reservation(), "/", "reservationBlocks", "/", request.reservation_block()), std::move(query_params));
}

StatusOr<google::cloud::cpp::compute::v1::ReservationBlocksListResponse>
DefaultReservationBlocksRestStub::ListReservationBlocks(
      google::cloud::rest_internal::RestContext& rest_context,
      Options const& options,
  ...
  return rest_internal::Get<google::cloud::cpp::compute::v1::ReservationBlocksListResponse>(
      *service_, rest_context, request, false,
      absl::StrCat("/", "compute", "/", rest_internal::DetermineApiVersion("v1", options), "/", "projects", "/", request.project(), "/", "zones", "/", request.zone(), "/", "reservations", "/", request.reservation(), "/", "reservationBlocks"), std::move(query_params));
}

future<StatusOr<google::cloud::cpp::compute::v1::Operation>>
DefaultReservationBlocksRestStub::AsyncPerformMaintenance(
      CompletionQueue& cq,
  ...
  query_params = rest_internal::TrimEmptyQueryParameters(std::move(query_params));
      p.set_value(rest_internal::Post<google::cloud::cpp::compute::v1::Operation>(
          *service, *rest_context, request.reservations_blocks_perform_maintenance_request_resource(),
          false,
          absl::StrCat("/", "compute", "/", rest_internal::DetermineApiVersion("v1", *options), "/", "projects", "/", request.project(), "/", "zones", "/", request.zone(), "/", "reservations", "/", request.reservation(), "/", "reservationBlocks", "/", request.reservation_block(), "/", "performMaintenance"), std::move(query_params)));
    },
...
DefaultReservationBlocksRestStub::PerformMaintenance(
      google::cloud::rest_internal::RestContext& rest_context,
      Options const& options,
      google::cloud::cpp::compute::reservation_blocks::v1::PerformMaintenanceRequest const& request) {
  std::vector<std::pair<std::string, std::string>> query_params;
  ...
  return rest_internal::Post<google::cloud::cpp::compute::v1::Operation>(
      *service_, rest_context, request.reservations_blocks_perform_maintenance_request_resource(), false,
      absl::StrCat("/", "compute", "/", rest_internal::DetermineApiVersion("v1", options), "/", "projects", "/", request.project(), "/", "zones", "/", request.zone(), "/", "reservations", "/", request.reservation(), "/", "reservationBlocks", "/", request.reservation_block(), "/", "performMaintenance"), std::move(query_params));
}

future<StatusOr<google::cloud::cpp::compute::v1::Operation>>
DefaultReservationBlocksRestStub::AsyncGetOperation(
...
future<Status>
DefaultReservationBlocksRestStub::AsyncCancelOperation(
    google::cloud::CompletionQueue& cq,
    std::unique_ptr<rest_internal::RestContext> rest_context,
    google::cloud::internal::ImmutableOptions options,
