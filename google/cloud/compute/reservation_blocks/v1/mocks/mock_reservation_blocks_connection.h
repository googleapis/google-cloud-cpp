...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_COMPUTE_RESERVATION_BLOCKS_V1_MOCKS_MOCK_RESERVATION_BLOCKS_CONNECTION_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_COMPUTE_RESERVATION_BLOCKS_V1_MOCKS_MOCK_RESERVATION_BLOCKS_CONNECTION_H
...
namespace google {
namespace cloud {
namespace compute_reservation_blocks_v1_mocks {
GOOGLE_CLOUD_CPP_INLINE_NAMESPACE_BEGIN

/**
 * A class to mock `ReservationBlocksConnection`.
 *
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_COMPUTE_RESERVATION_BLOCKS_V1_MOCKS_MOCK_RESERVATION_BLOCKS_CONNECTION_H
