...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::compute_region_target_http_proxies_v1::RegionTargetHttpProxiesClient(google::cloud::ExperimentalTag{},
      google::cloud::compute_region_target_http_proxies_v1::MakeRegionTargetHttpProxiesConnectionRest(google::cloud::ExperimentalTag{},options));
  //! [set-client-endpoint]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::compute_region_target_http_proxies_v1::RegionTargetHttpProxiesClient(google::cloud::ExperimentalTag{},
      google::cloud::compute_region_target_http_proxies_v1::MakeRegionTargetHttpProxiesConnectionRest(google::cloud::ExperimentalTag{},options));
  }
  //! [with-service-account]
  (argv.at(0));
