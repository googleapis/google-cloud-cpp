...
std::shared_ptr<RegionTargetHttpProxiesConnection> MakeRegionTargetHttpProxiesConnectionRest(
  ...
  internal::CheckExpectedOptions<CommonOptionList, RestOptionList,
      ...
      RegionTargetHttpProxiesPolicyOptionList>(options, __func__);
  options = compute_region_target_http_proxies_v1_internal::RegionTargetHttpProxiesDefaultOptions(
      std::move(options));
  auto background = std::make_unique<
      rest_internal::AutomaticallyCreatedRestBackgroundThreads>();
  auto stub = compute_region_target_http_proxies_v1_internal::CreateDefaultRegionTargetHttpProxiesRestStub(
      options);
  return compute_region_target_http_proxies_v1_internal::MakeRegionTargetHttpProxiesTracingConnection(
      std::make_shared<
          compute_region_target_http_proxies_v1_internal::RegionTargetHttpProxiesRestConnectionImpl>(
