...
// clang-format off
// main-dox-marker: compute_preview_features_v1::PreviewFeaturesClient
// lro-marker: true
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client =
      google::cloud::compute_preview_features_v1::PreviewFeaturesClient(
          google::cloud::compute_preview_features_v1::
              MakePreviewFeaturesConnectionRest(options));
  //! [set-client-endpoint]
}
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client =
      google::cloud::compute_preview_features_v1::PreviewFeaturesClient(
          google::cloud::compute_preview_features_v1::
              MakePreviewFeaturesConnectionRest(*ud_options));
  //! [set-client-universe-domain]
}

//! [custom-idempotency-policy]
class CustomIdempotencyPolicy
    : public google::cloud::compute_preview_features_v1::
          PreviewFeaturesConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::compute_preview_features_v1::
                      PreviewFeaturesConnectionIdempotencyPolicy>
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
                     .set<google::cloud::compute_preview_features_v1::
                              PreviewFeaturesConnectionIdempotencyPolicyOption>(
                         CustomIdempotencyPolicy().clone())
                     .set<google::cloud::compute_preview_features_v1::
                              PreviewFeaturesRetryPolicyOption>(
                         google::cloud::compute_preview_features_v1::
                             PreviewFeaturesLimitedErrorCountRetryPolicy(3)
                                 .clone())
                     .set<google::cloud::compute_preview_features_v1::
                              PreviewFeaturesBackoffPolicyOption>(
                         google::cloud::ExponentialBackoffPolicy(
                             /*initial_delay=*/std::chrono::milliseconds(200),
                             /*maximum_delay=*/std::chrono::seconds(45),
                             /*scaling=*/2.0)
                             .clone());
  auto connection = google::cloud::compute_preview_features_v1::
      MakePreviewFeaturesConnectionRest(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::compute_preview_features_v1::PreviewFeaturesClient(
      connection);
  auto c2 = google::cloud::compute_preview_features_v1::PreviewFeaturesClient(
      connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::compute_preview_features_v1::PreviewFeaturesClient(
      connection,
      google::cloud::Options{}
          .set<google::cloud::compute_preview_features_v1::
                   PreviewFeaturesRetryPolicyOption>(
              google::cloud::compute_preview_features_v1::
                  PreviewFeaturesLimitedTimeRetryPolicy(std::chrono::minutes(5))
                      .clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::compute_preview_features_v1::PreviewFeaturesRetryPolicyOption>(
  //       google::cloud::compute_preview_features_v1::PreviewFeaturesLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options =
      google::cloud::Options{}
          .set<google::cloud::compute_preview_features_v1::
                   PreviewFeaturesPollingPolicyOption>(
              google::cloud::GenericPollingPolicy<
                  google::cloud::compute_preview_features_v1::
                      PreviewFeaturesRetryPolicyOption::Type,
                  google::cloud::compute_preview_features_v1::
                      PreviewFeaturesBackoffPolicyOption::Type>(
                  google::cloud::compute_preview_features_v1::
                      PreviewFeaturesLimitedTimeRetryPolicy(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::compute_preview_features_v1::PreviewFeaturesClient(
        google::cloud::compute_preview_features_v1::
            MakePreviewFeaturesConnectionRest(options));
  }
  //! [with-service-account]
