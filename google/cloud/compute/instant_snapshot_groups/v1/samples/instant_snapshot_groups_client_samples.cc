...
// clang-format off
// main-dox-marker: compute_instant_snapshot_groups_v1::InstantSnapshotGroupsClient
// lro-marker: true
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::compute_instant_snapshot_groups_v1::
      InstantSnapshotGroupsClient(
          google::cloud::compute_instant_snapshot_groups_v1::
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::compute_instant_snapshot_groups_v1::
      InstantSnapshotGroupsClient(
          google::cloud::compute_instant_snapshot_groups_v1::
              MakeInstantSnapshotGroupsConnectionRest(*ud_options));
  //! [set-client-universe-domain]
}

//! [custom-idempotency-policy]
class CustomIdempotencyPolicy
    : public google::cloud::compute_instant_snapshot_groups_v1::
          InstantSnapshotGroupsConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::compute_instant_snapshot_groups_v1::
                      InstantSnapshotGroupsConnectionIdempotencyPolicy>
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options =
      google::cloud::Options{}
          .set<google::cloud::compute_instant_snapshot_groups_v1::
                   InstantSnapshotGroupsConnectionIdempotencyPolicyOption>(
              CustomIdempotencyPolicy().clone())
          .set<google::cloud::compute_instant_snapshot_groups_v1::
                   InstantSnapshotGroupsRetryPolicyOption>(
              google::cloud::compute_instant_snapshot_groups_v1::
                  InstantSnapshotGroupsLimitedErrorCountRetryPolicy(3)
                      .clone())
          .set<google::cloud::compute_instant_snapshot_groups_v1::
              ...
              google::cloud::ExponentialBackoffPolicy(
                  ...
                  /*scaling=*/2.0)
                  .clone());
  auto connection = google::cloud::compute_instant_snapshot_groups_v1::
      MakeInstantSnapshotGroupsConnectionRest(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::compute_instant_snapshot_groups_v1::
      InstantSnapshotGroupsClient(connection);
  auto c2 = google::cloud::compute_instant_snapshot_groups_v1::
      InstantSnapshotGroupsClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::compute_instant_snapshot_groups_v1::
      InstantSnapshotGroupsClient(
          connection,
          google::cloud::Options{}
              .set<google::cloud::compute_instant_snapshot_groups_v1::
  ...
  //     .set<google::cloud::compute_instant_snapshot_groups_v1::InstantSnapshotGroupsRetryPolicyOption>(
  //       google::cloud::compute_instant_snapshot_groups_v1::InstantSnapshotGroupsLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
      ...
      google::cloud::Options{}
          .set<google::cloud::compute_instant_snapshot_groups_v1::
              ...
              google::cloud::GenericPollingPolicy<
                  google::cloud::compute_instant_snapshot_groups_v1::
                      InstantSnapshotGroupsRetryPolicyOption::Type,
                  google::cloud::compute_instant_snapshot_groups_v1::
                      InstantSnapshotGroupsBackoffPolicyOption::Type>(
                  google::cloud::compute_instant_snapshot_groups_v1::
                      InstantSnapshotGroupsLimitedTimeRetryPolicy(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::compute_instant_snapshot_groups_v1::
        InstantSnapshotGroupsClient(
            google::cloud::compute_instant_snapshot_groups_v1::
                MakeInstantSnapshotGroupsConnectionRest(options));
  }
