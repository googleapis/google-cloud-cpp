 ...
 */
struct NodeGroupsRetryPolicyOption {
  using Type = std::shared_ptr<NodeGroupsRetryPolicy>;
};
 ...
 * @ingroup google-cloud-compute-options
 */
struct NodeGroupsBackoffPolicyOption {
 ...
 * @ingroup google-cloud-compute-options
 */
struct NodeGroupsConnectionIdempotencyPolicyOption {
  using Type = std::shared_ptr<NodeGroupsConnectionIdempotencyPolicy>;
};
 ...
 * @ingroup google-cloud-compute-options
 */
struct NodeGroupsPollingPolicyOption {
  using Type = std::shared_ptr<PollingPolicy>;
};

/**
 * The options applicable to NodeGroups.
 *
 * @ingroup google-cloud-compute-options
 */
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_COMPUTE_NODE_GROUPS_V1_NODE_GROUPS_OPTIONS_H
