...
NodeGroupsRestMetadata::AggregatedListNodeGroups(
    rest_internal::RestContext& rest_context,
    Options const& options, google::cloud::cpp::compute::node_groups::v1::AggregatedListNodeGroupsRequest const& request) {
  SetMetadata(rest_context, options);
...
NodeGroupsRestMetadata::ListNodeGroups(
    rest_internal::RestContext& rest_context,
    Options const& options, google::cloud::cpp::compute::node_groups::v1::ListNodeGroupsRequest const& request) {
  SetMetadata(rest_context, options);
...
NodeGroupsRestMetadata::ListNodes(
    rest_internal::RestContext& rest_context,
    Options const& options, google::cloud::cpp::compute::node_groups::v1::ListNodesRequest const& request) {
  SetMetadata(rest_context, options);
