...
Idempotency NodeGroupsConnectionIdempotencyPolicy::AggregatedListNodeGroups(google::cloud::cpp::compute::node_groups::v1::AggregatedListNodeGroupsRequest const&) {
  return Idempotency::kIdempotent;
}

Idempotency NodeGroupsConnectionIdempotencyPolicy::DeleteNodeGroups(google::cloud::cpp::compute::node_groups::v1::DeleteNodeGroupsRequest const&) {
  return Idempotency::kNonIdempotent;
}
...
Idempotency NodeGroupsConnectionIdempotencyPolicy::GetNodeGroups(google::cloud::cpp::compute::node_groups::v1::GetNodeGroupsRequest const&) {
  return Idempotency::kIdempotent;
}
...
Idempotency NodeGroupsConnectionIdempotencyPolicy::InsertNodeGroups(google::cloud::cpp::compute::node_groups::v1::InsertNodeGroupsRequest const&) {
  return Idempotency::kNonIdempotent;
}
...
Idempotency NodeGroupsConnectionIdempotencyPolicy::PatchNodeGroups(google::cloud::cpp::compute::node_groups::v1::PatchNodeGroupsRequest const&) {
  return Idempotency::kNonIdempotent;
}
