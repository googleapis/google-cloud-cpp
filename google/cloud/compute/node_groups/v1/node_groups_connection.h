...
/**
 * A retry policy for `NodeGroupsConnection` that stops retrying after a
...
class NodeGroupsLimitedErrorCountRetryPolicy : public NodeGroupsRetryPolicy {
 public:
  NodeGroupsLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `NodeGroupsConnection` that stops retrying after
