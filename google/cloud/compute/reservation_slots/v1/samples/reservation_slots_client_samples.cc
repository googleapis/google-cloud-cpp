...
// clang-format off
// main-dox-marker: compute_reservation_slots_v1::ReservationSlotsClient
// lro-marker: true
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client =
      google::cloud::compute_reservation_slots_v1::ReservationSlotsClient(
          google::cloud::compute_reservation_slots_v1::
              MakeReservationSlotsConnectionRest(options));
  //! [set-client-endpoint]
}
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client =
      google::cloud::compute_reservation_slots_v1::ReservationSlotsClient(
          google::cloud::compute_reservation_slots_v1::
              MakeReservationSlotsConnectionRest(*ud_options));
  //! [set-client-universe-domain]
}

//! [custom-idempotency-policy]
class CustomIdempotencyPolicy
    : public google::cloud::compute_reservation_slots_v1::
          ReservationSlotsConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::compute_reservation_slots_v1::
                      ReservationSlotsConnectionIdempotencyPolicy>
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options =
      google::cloud::Options{}
          .set<google::cloud::compute_reservation_slots_v1::
                   ReservationSlotsConnectionIdempotencyPolicyOption>(
              CustomIdempotencyPolicy().clone())
          .set<google::cloud::compute_reservation_slots_v1::
                   ReservationSlotsRetryPolicyOption>(
              google::cloud::compute_reservation_slots_v1::
                  ReservationSlotsLimitedErrorCountRetryPolicy(3)
                      .clone())
          .set<google::cloud::compute_reservation_slots_v1::
              ...
              google::cloud::ExponentialBackoffPolicy(
                  ...
                  /*scaling=*/2.0)
                  .clone());
  auto connection = google::cloud::compute_reservation_slots_v1::
      MakeReservationSlotsConnectionRest(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::compute_reservation_slots_v1::ReservationSlotsClient(
      connection);
  auto c2 = google::cloud::compute_reservation_slots_v1::ReservationSlotsClient(
      connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::compute_reservation_slots_v1::ReservationSlotsClient(
  ...
  //     .set<google::cloud::compute_reservation_slots_v1::ReservationSlotsRetryPolicyOption>(
  //       google::cloud::compute_reservation_slots_v1::ReservationSlotsLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::compute_reservation_slots_v1::ReservationSlotsClient(
        google::cloud::compute_reservation_slots_v1::
            MakeReservationSlotsConnectionRest(options));
  }
  //! [with-service-account]
