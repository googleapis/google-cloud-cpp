...
NetworkEdgeSecurityServicesRestMetadata::DeleteNetworkEdgeSecurityServices(
    rest_internal::RestContext& rest_context,
    google::cloud::cpp::compute::networkEdgeSecurityServices::v1::DeleteNetworkEdgeSecurityServicesRequest const& request) {
  SetMetadata(rest_context);
  return child_->DeleteNetworkEdgeSecurityServices(rest_context, request);
}
...
StatusOr<google::cloud::cpp::compute::v1::Operation>
NetworkEdgeSecurityServicesRestMetadata::InsertNetworkEdgeSecurityServices(
    rest_internal::RestContext& rest_context,
    google::cloud::cpp::compute::networkEdgeSecurityServices::v1::InsertNetworkEdgeSecurityServicesRequest const& request) {
  SetMetadata(rest_context);
  return child_->InsertNetworkEdgeSecurityServices(rest_context, request);
}

StatusOr<google::cloud::cpp::compute::v1::Operation>
NetworkEdgeSecurityServicesRestMetadata::PatchNetworkEdgeSecurityServices(
    rest_internal::RestContext& rest_context,
    google::cloud::cpp::compute::networkEdgeSecurityServices::v1::PatchNetworkEdgeSecurityServicesRequest const& request) {
  SetMetadata(rest_context);
  return child_->PatchNetworkEdgeSecurityServices(rest_context, request);
}
