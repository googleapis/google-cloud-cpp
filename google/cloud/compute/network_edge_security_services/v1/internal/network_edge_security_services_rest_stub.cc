...
DefaultNetworkEdgeSecurityServicesRestStub::DeleteNetworkEdgeSecurityServices(
      google::cloud::rest_internal::RestContext& rest_context,
  ...
  return rest_internal::Delete<google::cloud::cpp::compute::v1::Operation>(
      *service_, rest_context, request,
      "/compute/v1/projects/{project}/regions/{region}/networkEdgeSecurityServices/{network_edge_security_service}");
}
...
DefaultNetworkEdgeSecurityServicesRestStub::GetNetworkEdgeSecurityServices(
  ...
  return rest_internal::Get<google::cloud::cpp::compute::v1::NetworkEdgeSecurityService>(
      *service_, rest_context, request,
      "/compute/v1/projects/{project}/regions/{region}/networkEdgeSecurityServices/{network_edge_security_service}",
      {std::make_pair("network_edge_security_service", request.network_edge_security_service()),
       std::make_pair("project", request.project()),
       std::make_pair("region", request.region())});
}

StatusOr<google::cloud::cpp::compute::v1::Operation>
DefaultNetworkEdgeSecurityServicesRestStub::InsertNetworkEdgeSecurityServices(
      google::cloud::rest_internal::RestContext& rest_context,
...
StatusOr<google::cloud::cpp::compute::v1::Operation>
DefaultNetworkEdgeSecurityServicesRestStub::PatchNetworkEdgeSecurityServices(
      google::cloud::rest_internal::RestContext& rest_context,
