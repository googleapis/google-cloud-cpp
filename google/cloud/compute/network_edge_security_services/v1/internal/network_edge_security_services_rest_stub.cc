...
DefaultNetworkEdgeSecurityServicesRestStub::DefaultNetworkEdgeSecurityServicesRestStub(Options options)
...
DefaultNetworkEdgeSecurityServicesRestStub::DefaultNetworkEdgeSecurityServicesRestStub(
...
DefaultNetworkEdgeSecurityServicesRestStub::AggregatedListNetworkEdgeSecurityServices(
  ...
  return rest_internal::Get<google::cloud::cpp::compute::v1::NetworkEdgeSecurityServiceAggregatedList>(
      *service_, rest_context, request, false,
      absl::StrCat("/", "compute", "/", rest_internal::DetermineApiVersion("v1", options), "/", "projects", "/", request.project(), "/", "aggregated", "/", "networkEdgeSecurityServices"), std::move(query_params));
}

future<StatusOr<google::cloud::cpp::compute::v1::Operation>>
DefaultNetworkEdgeSecurityServicesRestStub::AsyncDeleteNetworkEdgeSecurityService(
      CompletionQueue& cq,
  ...
  query_params = rest_internal::TrimEmptyQueryParameters(std::move(query_params));
      p.set_value(rest_internal::Delete<google::cloud::cpp::compute::v1::Operation>(
          *service, *rest_context, request,
          false,
          absl::StrCat("/", "compute", "/", rest_internal::DetermineApiVersion("v1", *options), "/", "projects", "/", request.project(), "/", "regions", "/", request.region(), "/", "networkEdgeSecurityServices", "/", request.network_edge_security_service()), std::move(query_params)));
    },
...
DefaultNetworkEdgeSecurityServicesRestStub::GetNetworkEdgeSecurityService(
      google::cloud::rest_internal::RestContext& rest_context,
      Options const& options,
      google::cloud::cpp::compute::network_edge_security_services::v1::GetNetworkEdgeSecurityServiceRequest const& request) {
  std::vector<std::pair<std::string, std::string>> query_params;
  return rest_internal::Get<google::cloud::cpp::compute::v1::NetworkEdgeSecurityService>(
      *service_, rest_context, request, false,
      absl::StrCat("/", "compute", "/", rest_internal::DetermineApiVersion("v1", options), "/", "projects", "/", request.project(), "/", "regions", "/", request.region(), "/", "networkEdgeSecurityServices", "/", request.network_edge_security_service()), std::move(query_params));
}

future<StatusOr<google::cloud::cpp::compute::v1::Operation>>
DefaultNetworkEdgeSecurityServicesRestStub::AsyncInsertNetworkEdgeSecurityService(
      CompletionQueue& cq,
      std::unique_ptr<rest_internal::RestContext> rest_context,
      google::cloud::internal::ImmutableOptions options,
  ...
  query_params = rest_internal::TrimEmptyQueryParameters(std::move(query_params));
      p.set_value(rest_internal::Post<google::cloud::cpp::compute::v1::Operation>(
          *service, *rest_context, request.network_edge_security_service_resource(),
          false,
          absl::StrCat("/", "compute", "/", rest_internal::DetermineApiVersion("v1", *options), "/", "projects", "/", request.project(), "/", "regions", "/", request.region(), "/", "networkEdgeSecurityServices"), std::move(query_params)));
    },
    std::move(p), service_, request, std::move(rest_context),
    std::move(options)};
  return f.then([t = std::move(t), cq](auto f) mutable {
...
DefaultNetworkEdgeSecurityServicesRestStub::InsertNetworkEdgeSecurityService(
  ...
  return rest_internal::Post<google::cloud::cpp::compute::v1::Operation>(
      *service_, rest_context, request.network_edge_security_service_resource(), false,
      absl::StrCat("/", "compute", "/", rest_internal::DetermineApiVersion("v1", options), "/", "projects", "/", request.project(), "/", "regions", "/", request.region(), "/", "networkEdgeSecurityServices"), std::move(query_params));
}

future<StatusOr<google::cloud::cpp::compute::v1::Operation>>
DefaultNetworkEdgeSecurityServicesRestStub::AsyncPatchNetworkEdgeSecurityService(
      CompletionQueue& cq,
      std::unique_ptr<rest_internal::RestContext> rest_context,
      google::cloud::internal::ImmutableOptions options,
...
future<Status>
DefaultNetworkEdgeSecurityServicesRestStub::AsyncCancelOperation(
    google::cloud::CompletionQueue& cq,
    std::unique_ptr<rest_internal::RestContext> rest_context,
    google::cloud::internal::ImmutableOptions options,
