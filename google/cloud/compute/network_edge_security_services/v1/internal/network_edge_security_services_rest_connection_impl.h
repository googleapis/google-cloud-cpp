...
clone();
  ...
  std::unique_ptr<PollingPolicy> polling_policy() {
    ...
    if (options.has<compute_network_edge_security_services_v1::NetworkEdgeSecurityServicesPollingPolicyOption>()) {
      return options.get<compute_network_edge_security_services_v1::NetworkEdgeSecurityServicesPollingPolicyOption>()->clone();
    }
    return options_.get<compute_network_edge_security_services_v1::NetworkEdgeSecurityServicesPollingPolicyOption>()->clone();
  }
