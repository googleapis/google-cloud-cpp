...
class NetworkEdgeSecurityServicesClient {
 public:
  ...
  /// [google.cloud.cpp.compute.v1.NetworkEdgeSecurityServicesScopedList]: @cloud_cpp_reference_link{google/cloud/compute/v1/internal/common_079.proto#L187}
  ///
  // clang-format on
  ...
  /// [google.cloud.cpp.compute.v1.NetworkEdgeSecurityService]: @cloud_cpp_reference_link{google/cloud/compute/v1/internal/common_079.proto#L25}
  ///
  // clang-format on
