...
std::shared_ptr<NetworkEdgeSecurityServicesConnection> MakeNetworkEdgeSecurityServicesConnectionRest(
  ...
  internal::CheckExpectedOptions<CommonOptionList, RestOptionList,
      ...
      NetworkEdgeSecurityServicesPolicyOptionList>(options, __func__);
  options = compute_network_edge_security_services_v1_internal::NetworkEdgeSecurityServicesDefaultOptions(
      std::move(options));
  auto background = std::make_unique<
      rest_internal::AutomaticallyCreatedRestBackgroundThreads>();
  auto stub = compute_network_edge_security_services_v1_internal::CreateDefaultNetworkEdgeSecurityServicesRestStub(
      options);
  return compute_network_edge_security_services_v1_internal::MakeNetworkEdgeSecurityServicesTracingConnection(
      std::make_shared<
          compute_network_edge_security_services_v1_internal::NetworkEdgeSecurityServicesRestConnectionImpl>(
