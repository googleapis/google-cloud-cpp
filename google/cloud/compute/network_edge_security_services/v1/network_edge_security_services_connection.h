...
class NetworkEdgeSecurityServicesConnection {
 public:
  ...
  AggregatedListNetworkEdgeSecurityServices(google::cloud::cpp::compute::networkEdgeSecurityServices::v1::AggregatedListNetworkEdgeSecurityServicesRequest const& request);

  virtual StatusOr<google::cloud::cpp::compute::v1::Operation>
  DeleteNetworkEdgeSecurityServices(google::cloud::cpp::compute::networkEdgeSecurityServices::v1::DeleteNetworkEdgeSecurityServicesRequest const& request);

  virtual StatusOr<google::cloud::cpp::compute::v1::NetworkEdgeSecurityService>
  GetNetworkEdgeSecurityServices(google::cloud::cpp::compute::networkEdgeSecurityServices::v1::GetNetworkEdgeSecurityServicesRequest const& request);

  virtual StatusOr<google::cloud::cpp::compute::v1::Operation>
  InsertNetworkEdgeSecurityServices(google::cloud::cpp::compute::networkEdgeSecurityServices::v1::InsertNetworkEdgeSecurityServicesRequest const& request);

  virtual StatusOr<google::cloud::cpp::compute::v1::Operation>
  PatchNetworkEdgeSecurityServices(google::cloud::cpp::compute::networkEdgeSecurityServices::v1::PatchNetworkEdgeSecurityServicesRequest const& request);
};
