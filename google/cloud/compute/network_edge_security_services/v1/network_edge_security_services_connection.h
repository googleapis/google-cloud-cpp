...
using NetworkEdgeSecurityServicesRetryPolicy = ::google::cloud::internal::TraitBasedRetryPolicy<
    compute_network_edge_security_services_v1_internal::NetworkEdgeSecurityServicesRetryTraits>;

using NetworkEdgeSecurityServicesLimitedTimeRetryPolicy = ::google::cloud::internal::LimitedTimeRetryPolicy<
    compute_network_edge_security_services_v1_internal::NetworkEdgeSecurityServicesRetryTraits>;
...
class NetworkEdgeSecurityServicesConnection {
 public:
  ...
  virtual StatusOr<google::cloud::cpp::compute::v1::NetworkEdgeSecurityServiceAggregatedList>
  AggregatedListNetworkEdgeSecurityServices(google::cloud::cpp::compute::network_edge_security_services::v1::AggregatedListNetworkEdgeSecurityServicesRequest const& request);

  virtual future<StatusOr<google::cloud::cpp::compute::v1::Operation>>
  DeleteNetworkEdgeSecurityServices(google::cloud::cpp::compute::network_edge_security_services::v1::DeleteNetworkEdgeSecurityServicesRequest const& request);

  virtual StatusOr<google::cloud::cpp::compute::v1::NetworkEdgeSecurityService>
  GetNetworkEdgeSecurityServices(google::cloud::cpp::compute::network_edge_security_services::v1::GetNetworkEdgeSecurityServicesRequest const& request);

  virtual future<StatusOr<google::cloud::cpp::compute::v1::Operation>>
  InsertNetworkEdgeSecurityServices(google::cloud::cpp::compute::network_edge_security_services::v1::InsertNetworkEdgeSecurityServicesRequest const& request);

  virtual future<StatusOr<google::cloud::cpp::compute::v1::Operation>>
  PatchNetworkEdgeSecurityServices(google::cloud::cpp::compute::network_edge_security_services::v1::PatchNetworkEdgeSecurityServicesRequest const& request);
};
