...
class NetworkEdgeSecurityServicesRetryPolicy
    : public ::google::cloud::RetryPolicy {
 public:
  /// Creates a new instance of the policy, reset to the initial state.
  virtual std::unique_ptr<NetworkEdgeSecurityServicesRetryPolicy> clone()
      const = 0;
};

/**
 * A retry policy for `NetworkEdgeSecurityServicesConnection` based on counting
 * errors.
 *
 ...
 */
class NetworkEdgeSecurityServicesLimitedErrorCountRetryPolicy
 ...
 public:
   ...
   */
  NetworkEdgeSecurityServicesLimitedErrorCountRetryPolicy(int maximum_failures)
  ...
  NetworkEdgeSecurityServicesLimitedErrorCountRetryPolicy(
      NetworkEdgeSecurityServicesLimitedErrorCountRetryPolicy const&
          rhs) noexcept
      : NetworkEdgeSecurityServicesLimitedErrorCountRetryPolicy(
            rhs.maximum_failures()) {}
  ...
  std::unique_ptr<NetworkEdgeSecurityServicesRetryPolicy> clone()
      const override {
...
/**
 * A retry policy for `NetworkEdgeSecurityServicesConnection` based on elapsed
 * time.
 *
 * This policy stops retrying if:
 * - An RPC returns a non-transient error.
 ...
 * - [`kUnavailable`](@ref google::cloud::StatusCode)
 */
class NetworkEdgeSecurityServicesLimitedTimeRetryPolicy
    : public NetworkEdgeSecurityServicesRetryPolicy {
 public:
  /**
  ...
  NetworkEdgeSecurityServicesLimitedTimeRetryPolicy(
      NetworkEdgeSecurityServicesLimitedTimeRetryPolicy&& rhs) noexcept
      : NetworkEdgeSecurityServicesLimitedTimeRetryPolicy(
            rhs.maximum_duration()) {}
  NetworkEdgeSecurityServicesLimitedTimeRetryPolicy(
      NetworkEdgeSecurityServicesLimitedTimeRetryPolicy const& rhs) noexcept
      : NetworkEdgeSecurityServicesLimitedTimeRetryPolicy(
            rhs.maximum_duration()) {}
