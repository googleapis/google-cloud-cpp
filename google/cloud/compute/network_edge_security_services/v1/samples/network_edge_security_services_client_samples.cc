...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::compute_network_edge_security_services_v1::
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::compute_network_edge_security_services_v1::
      NetworkEdgeSecurityServicesClient(
          google::cloud::compute_network_edge_security_services_v1::
              MakeNetworkEdgeSecurityServicesConnectionRest(*ud_options));
  //! [set-client-universe-domain]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::compute_network_edge_security_services_v1::
        NetworkEdgeSecurityServicesClient(
            google::cloud::compute_network_edge_security_services_v1::
                MakeNetworkEdgeSecurityServicesConnectionRest(options));
  }
