 ...
 * including errors, from an object of type `GlobalForwardingRulesClient`. To do so,
 * construct an object of type `GlobalForwardingRulesClient` with an instance of this
 ...
 */
class MockGlobalForwardingRulesConnection : public compute_global_forwarding_rules_v1::GlobalForwardingRulesConnection {
 public:
  ...
  /// EXPECT_CALL(*mock, DeleteForwardingRule(Matcher<google::cloud::cpp::compute::global_forwarding_rules::v1::DeleteForwardingRuleRequest const&>(_)))
  /// @endcode
  ...
  GetForwardingRule,
  (google::cloud::cpp::compute::global_forwarding_rules::v1::GetForwardingRuleRequest const& request), (override));
  ...
  /// using ::testing::_;
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock, InsertForwardingRule(Matcher<google::cloud::cpp::compute::global_forwarding_rules::v1::InsertForwardingRuleRequest const&>(_)))
  /// @endcode
  MOCK_METHOD(future<StatusOr<google::cloud::cpp::compute::v1::Operation>>,
  ...
  (google::cloud::cpp::compute::global_forwarding_rules::v1::ListGlobalForwardingRulesRequest request), (override));
  ...
  /// using ::testing::_;
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock, PatchForwardingRule(Matcher<google::cloud::cpp::compute::global_forwarding_rules::v1::PatchForwardingRuleRequest const&>(_)))
  /// @endcode
  MOCK_METHOD(future<StatusOr<google::cloud::cpp::compute::v1::Operation>>,
  PatchForwardingRule,
  ...
  /// using ::testing::_;
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock, SetLabels(Matcher<google::cloud::cpp::compute::global_forwarding_rules::v1::SetLabelsRequest const&>(_)))
  /// @endcode
  MOCK_METHOD(future<StatusOr<google::cloud::cpp::compute::v1::Operation>>,
  SetLabels,
  ...
  /// using ::testing::_;
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock, SetTarget(Matcher<google::cloud::cpp::compute::global_forwarding_rules::v1::SetTargetRequest const&>(_)))
  /// @endcode
  MOCK_METHOD(future<StatusOr<google::cloud::cpp::compute::v1::Operation>>,
  SetTarget,
