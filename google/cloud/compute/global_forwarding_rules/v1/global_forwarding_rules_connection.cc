...
GlobalForwardingRulesConnection::DeleteGlobalForwardingRules(
    google::cloud::cpp::compute::globalForwardingRules::v1::DeleteGlobalForwardingRulesRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

StatusOr<google::cloud::cpp::compute::v1::ForwardingRule>
GlobalForwardingRulesConnection::GetGlobalForwardingRules(
    google::cloud::cpp::compute::globalForwardingRules::v1::GetGlobalForwardingRulesRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

StatusOr<google::cloud::cpp::compute::v1::Operation>
GlobalForwardingRulesConnection::InsertGlobalForwardingRules(
    google::cloud::cpp::compute::globalForwardingRules::v1::InsertGlobalForwardingRulesRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

StreamRange<google::cloud::cpp::compute::v1::ForwardingRule> GlobalForwardingRulesConnection::ListGlobalForwardingRules(
    google::cloud::cpp::compute::globalForwardingRules::v1::ListGlobalForwardingRulesRequest) {  // NOLINT(performance-unnecessary-value-param)
...
GlobalForwardingRulesConnection::PatchGlobalForwardingRules(
    google::cloud::cpp::compute::globalForwardingRules::v1::PatchGlobalForwardingRulesRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

StatusOr<google::cloud::cpp::compute::v1::Operation>
GlobalForwardingRulesConnection::SetLabels(
    google::cloud::cpp::compute::globalForwardingRules::v1::SetLabelsRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

StatusOr<google::cloud::cpp::compute::v1::Operation>
GlobalForwardingRulesConnection::SetTarget(
    google::cloud::cpp::compute::globalForwardingRules::v1::SetTargetRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}
