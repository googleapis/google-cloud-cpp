...
GlobalForwardingRulesRestMetadata::AsyncDeleteGlobalForwardingRules(
  ...
  return child_->AsyncDeleteGlobalForwardingRules(cq, std::move(rest_context), request);
}
...
GlobalForwardingRulesRestMetadata::AsyncInsertGlobalForwardingRules(
  ...
  SetMetadata(*rest_context);
  return child_->AsyncInsertGlobalForwardingRules(cq, std::move(rest_context), request);
}
...
GlobalForwardingRulesRestMetadata::AsyncPatchGlobalForwardingRules(
  ...
  SetMetadata(*rest_context);
  return child_->AsyncPatchGlobalForwardingRules(cq, std::move(rest_context), request);
}
