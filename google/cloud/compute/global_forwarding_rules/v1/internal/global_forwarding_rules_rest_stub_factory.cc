...
std::shared_ptr<GlobalForwardingRulesRestStub>
CreateDefaultGlobalForwardingRulesRestStub(Options& options) {
  ...
  auto service_endpoint = internal::DetermineServiceEndpoint(
      internal::GetEnv("GOOGLE_CLOUD_CPP_GLOBAL_FORWARDING_RULES_ENDPOINT"),
  ...
  std::shared_ptr<GlobalForwardingRulesRestStub> stub =
      std::make_shared<DefaultGlobalForwardingRulesRestStub>(
          std::move(stub_creation_opts));
  stub = std::make_shared<GlobalForwardingRulesRestMetadata>(std::move(stub));
  if (internal::Contains(options.get<TracingComponentsOption>(), "rpc")) {
    GCP_LOG(INFO) << "Enabled logging for REST rpc calls";
    stub = std::make_shared<GlobalForwardingRulesRestLogging>(
