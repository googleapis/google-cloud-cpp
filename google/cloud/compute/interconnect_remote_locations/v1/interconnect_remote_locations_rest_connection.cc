...
MakeInterconnectRemoteLocationsConnectionRest(Options options) {
  internal::CheckExpectedOptions<CommonOptionList, RestOptionList,
      ...
      options, __func__);
  options = compute_interconnect_remote_locations_v1_internal::
      InterconnectRemoteLocationsDefaultOptions(std::move(options));
  auto background = std::make_unique<
      rest_internal::AutomaticallyCreatedRestBackgroundThreads>();
  auto stub = compute_interconnect_remote_locations_v1_internal::
      CreateDefaultInterconnectRemoteLocationsRestStub(options);
  return compute_interconnect_remote_locations_v1_internal::
      MakeInterconnectRemoteLocationsTracingConnection(
          std::make_shared<compute_interconnect_remote_locations_v1_internal::
