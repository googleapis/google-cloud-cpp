...
class InterconnectRemoteLocationsClient {
 public:
  explicit InterconnectRemoteLocationsClient(std::shared_ptr<InterconnectRemoteLocationsConnection> connection, Options opts = {});
  ~InterconnectRemoteLocationsClient();

  ///@{
  /// @name Copy and move support
  InterconnectRemoteLocationsClient(InterconnectRemoteLocationsClient const&) = default;
  InterconnectRemoteLocationsClient& operator=(InterconnectRemoteLocationsClient const&) = default;
  InterconnectRemoteLocationsClient(InterconnectRemoteLocationsClient&&) = default;
  InterconnectRemoteLocationsClient& operator=(InterconnectRemoteLocationsClient&&) = default;
  ///@}

  ///@{
  /// @name Equality
  friend bool operator==(InterconnectRemoteLocationsClient const& a, InterconnectRemoteLocationsClient const& b) {
  ...
  GetInterconnectRemoteLocation(std::string const& project, std::string const& interconnect_remote_location, Options opts = {});
  ...
  // clang-format on
  StatusOr<google::cloud::cpp::compute::v1::InterconnectRemoteLocation>
  GetInterconnectRemoteLocation(google::cloud::cpp::compute::interconnect_remote_locations::v1::GetInterconnectRemoteLocationRequest const& request, Options opts = {});
  ...
  ListInterconnectRemoteLocations(std::string const& project, Options opts = {});
  ...
  // clang-format on
  StreamRange<google::cloud::cpp::compute::v1::InterconnectRemoteLocation>
  ListInterconnectRemoteLocations(google::cloud::cpp::compute::interconnect_remote_locations::v1::ListInterconnectRemoteLocationsRequest request, Options opts = {});
