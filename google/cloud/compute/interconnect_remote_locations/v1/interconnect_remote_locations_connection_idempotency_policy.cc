...
InterconnectRemoteLocationsConnectionIdempotencyPolicy::
    ~InterconnectRemoteLocationsConnectionIdempotencyPolicy() = default;
...
InterconnectRemoteLocationsConnectionIdempotencyPolicy::clone() const {
  return std::make_unique<
      InterconnectRemoteLocationsConnectionIdempotencyPolicy>(*this);
}
...
Idempotency InterconnectRemoteLocationsConnectionIdempotencyPolicy::
    ListInterconnectRemoteLocations(
        google::cloud::cpp::compute::interconnect_remote_locations::v1::
            ListInterconnectRemoteLocationsRequest) {  // NOLINT
  return Idempotency::kIdempotent;
}
