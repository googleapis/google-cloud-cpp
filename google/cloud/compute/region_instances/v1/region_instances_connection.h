...
/**
 * A retry policy for `RegionInstancesConnection` that stops retrying after a
...
class RegionInstancesLimitedErrorCountRetryPolicy
 ...
 public:
  RegionInstancesLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `RegionInstancesConnection` that stops retrying after
