...
class RegionInstancesRestConnectionImpl
 ...
 private:
  static std::unique_ptr<compute_region_instances_v1::RegionInstancesRetryPolicy>
  ...
  static std::unique_ptr<compute_region_instances_v1::RegionInstancesConnectionIdempotencyPolicy>
  ...
  static std::unique_ptr<PollingPolicy> polling_policy(Options const& options) {
    return options.get<compute_region_instances_v1::RegionInstancesPollingPolicyOption>()->clone();
  }
