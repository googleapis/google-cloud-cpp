...
std::shared_ptr<RegionInstancesConnection> MakeRegionInstancesConnectionRest(
  ...
  internal::CheckExpectedOptions<
      ...
      rest_internal::TargetApiVersionOption, RegionInstancesPolicyOptionList>(
      options, __func__);
  ...
  return compute_region_instances_v1_internal::
      MakeRegionInstancesTracingConnection(
          std::make_shared<compute_region_instances_v1_internal::
