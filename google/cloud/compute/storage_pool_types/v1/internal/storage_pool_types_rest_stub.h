...
class DefaultStoragePoolTypesRestStub : public StoragePoolTypesRestStub {
 public:
  ~DefaultStoragePoolTypesRestStub() override = default;
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_COMPUTE_STORAGE_POOL_TYPES_V1_INTERNAL_STORAGE_POOL_TYPES_REST_STUB_H
