...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_COMPUTE_STORAGE_POOL_TYPES_V1_MOCKS_MOCK_STORAGE_POOL_TYPES_CONNECTION_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_COMPUTE_STORAGE_POOL_TYPES_V1_MOCKS_MOCK_STORAGE_POOL_TYPES_CONNECTION_H
...
namespace google {
namespace cloud {
namespace compute_storage_pool_types_v1_mocks {
GOOGLE_CLOUD_CPP_INLINE_NAMESPACE_BEGIN

/**
 * A class to mock `StoragePoolTypesConnection`.
 *
 * Application developers may want to test their code with simulated responses,
 * including errors, from an object of type `StoragePoolTypesClient`. To do so,
 * construct an object of type `StoragePoolTypesClient` with an instance of this
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_COMPUTE_STORAGE_POOL_TYPES_V1_MOCKS_MOCK_STORAGE_POOL_TYPES_CONNECTION_H
