...
class TargetGrpcProxiesConnection {
 public:
  ...
  DeleteTargetGrpcProxies(google::cloud::cpp::compute::targetGrpcProxies::v1::
  ...
  virtual StatusOr<google::cloud::cpp::compute::v1::Operation>
  InsertTargetGrpcProxies(google::cloud::cpp::compute::targetGrpcProxies::v1::
  ...
  virtual StatusOr<google::cloud::cpp::compute::v1::Operation>
  PatchTargetGrpcProxies(google::cloud::cpp::compute::targetGrpcProxies::v1::
