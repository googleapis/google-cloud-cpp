...
/**
 * A retry policy for `TargetGrpcProxiesConnection` that stops retrying after a
...
class TargetGrpcProxiesLimitedErrorCountRetryPolicy
 ...
 public:
  TargetGrpcProxiesLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `TargetGrpcProxiesConnection` that stops retrying after
