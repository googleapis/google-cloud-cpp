...
Idempotency TargetGrpcProxiesConnectionIdempotencyPolicy::DeleteTargetGrpcProxy(google::cloud::cpp::compute::target_grpc_proxies::v1::DeleteTargetGrpcProxyRequest const&) {
  return Idempotency::kNonIdempotent;
}

Idempotency TargetGrpcProxiesConnectionIdempotencyPolicy::GetTargetGrpcProxy(google::cloud::cpp::compute::target_grpc_proxies::v1::GetTargetGrpcProxyRequest const&) {
  return Idempotency::kIdempotent;
}

Idempotency TargetGrpcProxiesConnectionIdempotencyPolicy::InsertTargetGrpcProxy(google::cloud::cpp::compute::target_grpc_proxies::v1::InsertTargetGrpcProxyRequest const&) {
  return Idempotency::kNonIdempotent;
}
...
Idempotency TargetGrpcProxiesConnectionIdempotencyPolicy::PatchTargetGrpcProxy(google::cloud::cpp::compute::target_grpc_proxies::v1::PatchTargetGrpcProxyRequest const&) {
  return Idempotency::kNonIdempotent;
}
