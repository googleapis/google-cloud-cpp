...
StorageInsightsMetadata::UpdateReportConfig(
  ...
  SetMetadata(context, options, absl::StrCat("report_config.name=", internal::UrlEncode(request.report_config().name())));
  return child_->UpdateReportConfig(context, options, request);
}

Status
StorageInsightsMetadata::DeleteReportConfig(
    grpc::ClientContext& context,
    Options const& options,
...
StorageInsightsMetadata::AsyncUpdateDatasetConfig(
  ...
  SetMetadata(*context, *options, absl::StrCat("dataset_config.name=", internal::UrlEncode(request.dataset_config().name())));
...
StatusOr<google::longrunning::Operation>
StorageInsightsMetadata::LinkDataset(
    grpc::ClientContext& context,
    Options options,
    google::cloud::storageinsights::v1::LinkDatasetRequest const& request) {
  SetMetadata(context, options, absl::StrCat("name=", internal::UrlEncode(request.name())));
...
StatusOr<google::longrunning::Operation>
StorageInsightsMetadata::UnlinkDataset(
    grpc::ClientContext& context,
    Options options,
    google::cloud::storageinsights::v1::UnlinkDatasetRequest const& request) {
  SetMetadata(context, options, absl::StrCat("name=", internal::UrlEncode(request.name())));
...
StatusOr<google::longrunning::Operation>
StorageInsightsMetadata::GetOperation(
    grpc::ClientContext& context,
    Options const& options,
...
Status
StorageInsightsMetadata::DeleteOperation(
    grpc::ClientContext& context,
    Options const& options,
...
Status
StorageInsightsMetadata::CancelOperation(
    grpc::ClientContext& context,
    Options const& options,
