# HOWTO: using the Storage Insights API C++ client in your project

This directory contains small examples showing how to use the Storage Insights API C++
...
Like most Google Cloud Platform (GCP) services, Storage Insights API requires that
...
1. Install the dependencies with your favorite tools. As an example, if you use
   ...
   ```bash
   cd $HOME/vcpkg
   ./vcpkg install google-cloud-cpp[core,storageinsights]
   ```
...
[quickstart-link]: https://cloud.google.com/storage/docs/insights/using-inventory-reports
