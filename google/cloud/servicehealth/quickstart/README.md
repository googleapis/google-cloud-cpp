# HOWTO: using the Service Health API C++ client in your project

This directory contains small examples showing how to use the Service Health API
...
1. Compile this example using Bazel:
   ...
   ```bash
   cd $HOME/google-cloud-cpp/google/cloud/servicehealth/quickstart
   bazel build ...
   ```
...
1. Install the dependencies with your favorite tools. As an example, if you use
   ...
   ```bash
   cd $HOME/vcpkg
   ./vcpkg install google-cloud-cpp[core,servicehealth]
   ```
...
[quickstart-link]: https://cloud.google.com/service-health/docs/view-events
