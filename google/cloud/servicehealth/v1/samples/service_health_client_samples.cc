...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::servicehealth_v1::ServiceHealthClient(
      google::cloud::servicehealth_v1::MakeServiceHealthConnection(ud_options));

  //! [set-client-universe-domain]
}

//! [custom-idempotency-policy]
class CustomIdempotencyPolicy : public google::cloud::servicehealth_v1::
                                    ServiceHealthConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<
      google::cloud::servicehealth_v1::ServiceHealthConnectionIdempotencyPolicy>
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options =
      google::cloud::Options{}
          .set<google::cloud::servicehealth_v1::
          ...
          .set<google::cloud::servicehealth_v1::ServiceHealthRetryPolicyOption>(
              google::cloud::servicehealth_v1::
                  ServiceHealthLimitedErrorCountRetryPolicy(3)
                      .clone())
          .set<google::cloud::servicehealth_v1::
  ...
  auto c3 = google::cloud::servicehealth_v1::ServiceHealthClient(
      ...
      google::cloud::Options{}
          .set<google::cloud::servicehealth_v1::ServiceHealthRetryPolicyOption>(
              google::cloud::servicehealth_v1::
                  ServiceHealthLimitedTimeRetryPolicy(std::chrono::minutes(5))
                      .clone()));
