 ...
 */
struct ServiceHealthRetryPolicyOption {
  using Type = std::shared_ptr<ServiceHealthRetryPolicy>;
};
 ...
 * @ingroup google-cloud-servicehealth-options
 */
struct ServiceHealthBackoffPolicyOption {
 ...
 * @ingroup google-cloud-servicehealth-options
 */
struct ServiceHealthConnectionIdempotencyPolicyOption {
  using Type = std::shared_ptr<ServiceHealthConnectionIdempotencyPolicy>;
};
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SERVICEHEALTH_V1_SERVICE_HEALTH_OPTIONS_H
