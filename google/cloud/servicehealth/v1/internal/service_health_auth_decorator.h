...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SERVICEHEALTH_V1_INTERNAL_SERVICE_HEALTH_AUTH_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SERVICEHEALTH_V1_INTERNAL_SERVICE_HEALTH_AUTH_DECORATOR_H
...
class ServiceHealthAuth : public ServiceHealthStub {
 public:
  ~ServiceHealthAuth() override = default;
  ServiceHealthAuth(
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SERVICEHEALTH_V1_INTERNAL_SERVICE_HEALTH_AUTH_DECORATOR_H
