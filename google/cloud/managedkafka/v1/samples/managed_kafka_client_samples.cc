...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::managedkafka_v1::ManagedKafkaClient(
      google::cloud::managedkafka_v1::MakeManagedKafkaConnection(ud_options));

  //! [set-client-universe-domain]
}

//! [custom-idempotency-policy]
class CustomIdempotencyPolicy : public google::cloud::managedkafka_v1::
                                    ManagedKafkaConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<
      google::cloud::managedkafka_v1::ManagedKafkaConnectionIdempotencyPolicy>
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options =
      google::cloud::Options{}
          .set<google::cloud::managedkafka_v1::
          ...
          .set<google::cloud::managedkafka_v1::ManagedKafkaRetryPolicyOption>(
              google::cloud::managedkafka_v1::
                  ManagedKafkaLimitedErrorCountRetryPolicy(3)
                      .clone())
  ...
  auto c3 = google::cloud::managedkafka_v1::ManagedKafkaClient(
      ...
      google::cloud::Options{}
          .set<google::cloud::managedkafka_v1::ManagedKafkaRetryPolicyOption>(
              google::cloud::managedkafka_v1::
                  ManagedKafkaLimitedTimeRetryPolicy(std::chrono::minutes(5))
                      .clone()));
      ...
      google::cloud::Options{}
          .set<google::cloud::managedkafka_v1::ManagedKafkaPollingPolicyOption>(
              google::cloud::GenericPollingPolicy<
                  google::cloud::managedkafka_v1::
                      ManagedKafkaRetryPolicyOption::Type,
                  google::cloud::managedkafka_v1::
                      ManagedKafkaBackoffPolicyOption::Type>(
                  google::cloud::managedkafka_v1::
