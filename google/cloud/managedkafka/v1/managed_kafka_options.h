 ...
 */
struct ManagedKafkaRetryPolicyOption {
  using Type = std::shared_ptr<ManagedKafkaRetryPolicy>;
};
 ...
 * @ingroup google-cloud-managedkafka-options
 */
struct ManagedKafkaBackoffPolicyOption {
 ...
 * @ingroup google-cloud-managedkafka-options
 */
struct ManagedKafkaConnectionIdempotencyPolicyOption {
  using Type = std::shared_ptr<ManagedKafkaConnectionIdempotencyPolicy>;
};
 ...
 * @ingroup google-cloud-managedkafka-options
 */
struct ManagedKafkaPollingPolicyOption {
  using Type = std::shared_ptr<PollingPolicy>;
};

/**
 * The options applicable to ManagedKafka.
 *
 * @ingroup google-cloud-managedkafka-options
 */
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_MANAGEDKAFKA_V1_MANAGED_KAFKA_OPTIONS_H
