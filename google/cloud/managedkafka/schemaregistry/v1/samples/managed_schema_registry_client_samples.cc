...
// clang-format off
// main-dox-marker: managedkafka_schemaregistry_v1::ManagedSchemaRegistryClient
// clang-format on
namespace {
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::managedkafka_schemaregistry_v1::
      ManagedSchemaRegistryClient(
          google::cloud::managedkafka_schemaregistry_v1::
              MakeManagedSchemaRegistryConnection(*ud_options));
  //! [set-client-universe-domain]
}

//! [custom-idempotency-policy]
class CustomIdempotencyPolicy
    : public google::cloud::managedkafka_schemaregistry_v1::
          ManagedSchemaRegistryConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::managedkafka_schemaregistry_v1::
                      ManagedSchemaRegistryConnectionIdempotencyPolicy>
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options =
      google::cloud::Options{}
          .set<google::cloud::managedkafka_schemaregistry_v1::
                   ManagedSchemaRegistryConnectionIdempotencyPolicyOption>(
              CustomIdempotencyPolicy().clone())
          .set<google::cloud::managedkafka_schemaregistry_v1::
                   ManagedSchemaRegistryRetryPolicyOption>(
              google::cloud::managedkafka_schemaregistry_v1::
                  ManagedSchemaRegistryLimitedErrorCountRetryPolicy(3)
                      .clone())
          .set<google::cloud::managedkafka_schemaregistry_v1::
              ...
              google::cloud::ExponentialBackoffPolicy(
                  ...
                  /*scaling=*/2.0)
                  .clone());
  auto connection = google::cloud::managedkafka_schemaregistry_v1::
      MakeManagedSchemaRegistryConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::managedkafka_schemaregistry_v1::
      ManagedSchemaRegistryClient(connection);
  auto c2 = google::cloud::managedkafka_schemaregistry_v1::
      ManagedSchemaRegistryClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::managedkafka_schemaregistry_v1::
      ManagedSchemaRegistryClient(
  ...
  //     .set<google::cloud::managedkafka_schemaregistry_v1::ManagedSchemaRegistryRetryPolicyOption>(
  //       google::cloud::managedkafka_schemaregistry_v1::ManagedSchemaRegistryLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::managedkafka_schemaregistry_v1::
        ManagedSchemaRegistryClient(
            google::cloud::managedkafka_schemaregistry_v1::
                MakeManagedSchemaRegistryConnection(options));
  }
