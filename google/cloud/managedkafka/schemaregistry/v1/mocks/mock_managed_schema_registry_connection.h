...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_MANAGEDKAFKA_SCHEMAREGISTRY_V1_MOCKS_MOCK_MANAGED_SCHEMA_REGISTRY_CONNECTION_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_MANAGEDKAFKA_SCHEMAREGISTRY_V1_MOCKS_MOCK_MANAGED_SCHEMA_REGISTRY_CONNECTION_H
...
namespace google {
namespace cloud {
namespace managedkafka_schemaregistry_v1_mocks {
 ...
 * including errors, from an object of type `ManagedSchemaRegistryClient`. To do
 * so, construct an object of type `ManagedSchemaRegistryClient` with an
 ...
 */
class MockManagedSchemaRegistryConnection
 ...
 public:
  ...
  MOCK_METHOD(StatusOr<google::cloud::managedkafka::schemaregistry::v1::
  ...
  MOCK_METHOD(Status, DeleteSchemaRegistry,
              (google::cloud::managedkafka::schemaregistry::v1::
  ...
  MOCK_METHOD(StatusOr<google::api::HttpBody>, ListContexts,
              (google::cloud::managedkafka::schemaregistry::v1::
  ...
  MOCK_METHOD(StatusOr<google::api::HttpBody>, ListSchemaVersions,
              (google::cloud::managedkafka::schemaregistry::v1::
                   ListSchemaVersionsRequest const& request),
              (override));

  MOCK_METHOD(StatusOr<google::api::HttpBody>, ListSchemaTypes,
              (google::cloud::managedkafka::schemaregistry::v1::
                   ListSchemaTypesRequest const& request),
              (override));

  MOCK_METHOD(StatusOr<google::api::HttpBody>, ListSubjects,
              (google::cloud::managedkafka::schemaregistry::v1::
                   ListSubjectsRequest const& request),
              (override));

  MOCK_METHOD(StatusOr<google::api::HttpBody>, ListSubjectsBySchemaId,
              (google::cloud::managedkafka::schemaregistry::v1::
                   ListSubjectsBySchemaIdRequest const& request),
              (override));

  MOCK_METHOD(StatusOr<google::api::HttpBody>, DeleteSubject,
              (google::cloud::managedkafka::schemaregistry::v1::
  ...
  MOCK_METHOD(StatusOr<google::api::HttpBody>, ListVersions,
              (google::cloud::managedkafka::schemaregistry::v1::
  ...
  MOCK_METHOD(StatusOr<google::api::HttpBody>, DeleteVersion,
              (google::cloud::managedkafka::schemaregistry::v1::
                   DeleteVersionRequest const& request),
              (override));

  MOCK_METHOD(StatusOr<google::api::HttpBody>, ListReferencedSchemas,
              (google::cloud::managedkafka::schemaregistry::v1::
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_MANAGEDKAFKA_SCHEMAREGISTRY_V1_MOCKS_MOCK_MANAGED_SCHEMA_REGISTRY_CONNECTION_H
