...
// clang-format off
// main-dox-marker: filestore_v1::CloudFilestoreManagerClient
// lro-marker: true
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::filestore_v1::CloudFilestoreManagerClient(
      google::cloud::filestore_v1::MakeCloudFilestoreManagerConnection(options));
  //! [set-client-endpoint]
}

//! [custom-idempotency-policy]
class CustomIdempotencyPolicy
   : public google::cloud::filestore_v1::CloudFilestoreManagerConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::filestore_v1::CloudFilestoreManagerConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::filestore_v1::CloudFilestoreManagerConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::filestore_v1::CloudFilestoreManagerRetryPolicyOption>(
      google::cloud::filestore_v1::CloudFilestoreManagerLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::filestore_v1::CloudFilestoreManagerBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::filestore_v1::MakeCloudFilestoreManagerConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::filestore_v1::CloudFilestoreManagerClient(connection);
  auto c2 = google::cloud::filestore_v1::CloudFilestoreManagerClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::filestore_v1::CloudFilestoreManagerClient(
    connection, google::cloud::Options{}.set<google::cloud::filestore_v1::CloudFilestoreManagerRetryPolicyOption>(
      google::cloud::filestore_v1::CloudFilestoreManagerLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::filestore_v1::CloudFilestoreManagerPollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::filestore_v1::CloudFilestoreManagerRetryPolicyOption::Type,
            google::cloud::filestore_v1::CloudFilestoreManagerBackoffPolicyOption::Type>(
            google::cloud::filestore_v1::CloudFilestoreManagerLimitedTimeRetryPolicy(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::filestore_v1::CloudFilestoreManagerClient(
      google::cloud::filestore_v1::MakeCloudFilestoreManagerConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
