...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_FILESTORE_V1_CLOUD_FILESTORE_MANAGER_OPTIONS_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_FILESTORE_V1_CLOUD_FILESTORE_MANAGER_OPTIONS_H
...
struct CloudFilestoreManagerConnectionIdempotencyPolicyOption {
  using Type = std::shared_ptr<CloudFilestoreManagerConnectionIdempotencyPolicy>;
};
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_FILESTORE_V1_CLOUD_FILESTORE_MANAGER_OPTIONS_H
