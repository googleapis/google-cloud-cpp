# HOWTO: using the Cloud Datastore API C++ client in your project

This directory contains small examples showing how to use the Cloud Datastore
...
1. Compile this example using Bazel:
   ...
   ```bash
   cd $HOME/google-cloud-cpp/google/cloud/datastore/quickstart
   bazel build ...
   ```
...
1. Install the dependencies with your favorite tools. As an example, if you use
   ...
   ```bash
   cd $HOME/vcpkg
   ./vcpkg install google-cloud-cpp[core,datastore]
   ```
...
[quickstart-link]: https://cloud.google.com/datastore/docs/quickstart
