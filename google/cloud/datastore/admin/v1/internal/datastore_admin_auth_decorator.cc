...
DatastoreAdminAuth::AsyncExportEntities(
  ...
  return auth_->AsyncConfigureContext(std::move(context))
      .then([cq, child = child_, options,
        ...
        return child->AsyncExportEntities(cq, *std::move(context), options,
                                          request);
      });
}
...
DatastoreAdminAuth::AsyncImportEntities(
  ...
  return auth_->AsyncConfigureContext(std::move(context))
      .then([cq, child = child_, options,
        ...
        return child->AsyncImportEntities(cq, *std::move(context), options,
                                          request);
      });
}
...
DatastoreAdminAuth::AsyncCreateIndex(
  ...
  return auth_->AsyncConfigureContext(std::move(context))
      .then([cq, child = child_, options,
        ...
        return child->AsyncCreateIndex(cq, *std::move(context), options,
                                       request);
      });
}
...
DatastoreAdminAuth::AsyncDeleteIndex(
  ...
  return auth_->AsyncConfigureContext(std::move(context))
      .then([cq, child = child_, options,
        ...
        return child->AsyncDeleteIndex(cq, *std::move(context), options,
                                       request);
      });
}
