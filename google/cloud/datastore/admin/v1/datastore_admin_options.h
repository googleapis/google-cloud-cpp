 ...
 */
struct DatastoreAdminRetryPolicyOption {
  using Type = std::shared_ptr<DatastoreAdminRetryPolicy>;
};
 ...
 * @ingroup google-cloud-datastore-options
 */
struct DatastoreAdminBackoffPolicyOption {
 ...
 * @ingroup google-cloud-datastore-options
 */
struct DatastoreAdminConnectionIdempotencyPolicyOption {
  using Type = std::shared_ptr<DatastoreAdminConnectionIdempotencyPolicy>;
};
 ...
 * @ingroup google-cloud-datastore-options
 */
struct DatastoreAdminPollingPolicyOption {
  using Type = std::shared_ptr<PollingPolicy>;
};

/**
 * The options applicable to DatastoreAdmin.
 *
 * @ingroup google-cloud-datastore-options
 */
using DatastoreAdminPolicyOptionList =
    OptionList<DatastoreAdminRetryPolicyOption,
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DATASTORE_ADMIN_V1_DATASTORE_ADMIN_OPTIONS_H
