...
/**
 * A retry policy for `AssetServiceConnection` that stops retrying after a
...
class AssetServiceLimitedErrorCountRetryPolicy
 ...
 public:
  AssetServiceLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `AssetServiceConnection` that stops retrying after
