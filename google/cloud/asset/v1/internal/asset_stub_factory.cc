...
std::shared_ptr<AssetServiceStub> CreateDefaultAssetServiceStub(
  ...
  auto endpoint = internal::DetermineServiceEndpoint(
      internal::GetEnv("GOOGLE_CLOUD_CPP_ASSET_SERVICE_ENDPOINT"),
      std::move(endpoint_option), "cloudasset.googleapis.com", options);
  ...
  if (!endpoint.ok()) {
    ...
    auto service_grpc_stub =
        google::cloud::asset::v1::AssetService::NewStub(channel);
    stub = std::make_shared<DefaultAssetServiceStub>(
