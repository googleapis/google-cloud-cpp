...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::asset_v1::AssetServiceClient(
      google::cloud::asset_v1::MakeAssetServiceConnection(*ud_options));
  //! [set-client-universe-domain]
}
...
class CustomIdempotencyPolicy
 ...
 public:
  ...
  std::unique_ptr<
      google::cloud::asset_v1::AssetServiceConnectionIdempotencyPolicy>
      ...
      google::cloud::Options{}
          .set<google::cloud::asset_v1::AssetServicePollingPolicyOption>(
              google::cloud::GenericPollingPolicy<
                  ...
                  google::cloud::asset_v1::AssetServiceBackoffPolicyOption::
                      Type>(
                  google::cloud::asset_v1::AssetServiceLimitedTimeRetryPolicy(
