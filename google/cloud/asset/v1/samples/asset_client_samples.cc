...
// clang-format off
// main-dox-marker: asset_v1::AssetServiceClient
// lro-marker: true
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::asset_v1::AssetServiceClient(
...
class CustomIdempotencyPolicy
   : public google::cloud::asset_v1::AssetServiceConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::asset_v1::AssetServiceConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::asset_v1::AssetServiceConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::asset_v1::AssetServiceRetryPolicyOption>(
      google::cloud::asset_v1::AssetServiceLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::asset_v1::AssetServiceBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::asset_v1::MakeAssetServiceConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::asset_v1::AssetServiceClient(connection);
  auto c2 = google::cloud::asset_v1::AssetServiceClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::asset_v1::AssetServiceClient(
    connection, google::cloud::Options{}.set<google::cloud::asset_v1::AssetServiceRetryPolicyOption>(
      google::cloud::asset_v1::AssetServiceLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::asset_v1::AssetServiceRetryPolicyOption>(
  //       google::cloud::asset_v1::AssetServiceLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::asset_v1::AssetServicePollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::asset_v1::AssetServiceRetryPolicyOption::Type,
            google::cloud::asset_v1::AssetServiceBackoffPolicyOption::Type>(
            google::cloud::asset_v1::AssetServiceLimitedTimeRetryPolicy(
