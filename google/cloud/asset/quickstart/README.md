# HOWTO: using the Cloud Asset API C++ client in your project

This directory contains small examples showing how to use the Cloud Asset API C++
...
1. Install the dependencies with your favorite tools. As an example, if you use
   ...
   ```bash
   cd $HOME/vcpkg
   ./vcpkg install google-cloud-cpp[core,asset]
   ```
...
1. Configure CMake, if necessary, configure the directory where you installed
   ...
   ```bash
   cd $HOME/gooogle-cloud-cpp/google/cloud/asset/quickstart
...
[quickstart-link]: https://cloud.google.com/asset-inventory/docs/quickstart
