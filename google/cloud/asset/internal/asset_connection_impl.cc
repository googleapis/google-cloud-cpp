...
inline std::unique_ptr<asset::AssetServiceRetryPolicy> retry_policy() {
  return internal::CurrentOptions()
      .get<asset::AssetServiceRetryPolicyOption>()
      ->clone();
}

inline std::unique_ptr<BackoffPolicy> backoff_policy() {
  return internal::CurrentOptions()
      .get<asset::AssetServiceBackoffPolicyOption>()
      ->clone();
}

inline std::unique_ptr<asset::AssetServiceConnectionIdempotencyPolicy>
idempotency_policy() {
  return internal::CurrentOptions()
...
inline std::unique_ptr<PollingPolicy> polling_policy() {
  return internal::CurrentOptions()
      .get<asset::AssetServicePollingPolicyOption>()
      ->clone();
}
