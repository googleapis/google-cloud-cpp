...
class AssetServiceConnectionIdempotencyPolicy {
 public:
  ...
  virtual google::cloud::internal::Idempotency ExportAssets(
      google::cloud::asset::v1::ExportAssetsRequest const& request) = 0;

  virtual google::cloud::internal::Idempotency ListAssets(
      google::cloud::asset::v1::ListAssetsRequest request) = 0;

  virtual google::cloud::internal::Idempotency BatchGetAssetsHistory(
      google::cloud::asset::v1::BatchGetAssetsHistoryRequest const&
          request) = 0;

  virtual google::cloud::internal::Idempotency CreateFeed(
      google::cloud::asset::v1::CreateFeedRequest const& request) = 0;

  virtual google::cloud::internal::Idempotency GetFeed(
      google::cloud::asset::v1::GetFeedRequest const& request) = 0;

  virtual google::cloud::internal::Idempotency ListFeeds(
      google::cloud::asset::v1::ListFeedsRequest const& request) = 0;

  virtual google::cloud::internal::Idempotency UpdateFeed(
      google::cloud::asset::v1::UpdateFeedRequest const& request) = 0;

  virtual google::cloud::internal::Idempotency DeleteFeed(
      google::cloud::asset::v1::DeleteFeedRequest const& request) = 0;

  virtual google::cloud::internal::Idempotency SearchAllResources(
      google::cloud::asset::v1::SearchAllResourcesRequest request) = 0;

  virtual google::cloud::internal::Idempotency SearchAllIamPolicies(
      google::cloud::asset::v1::SearchAllIamPoliciesRequest request) = 0;

  virtual google::cloud::internal::Idempotency AnalyzeIamPolicy(
      google::cloud::asset::v1::AnalyzeIamPolicyRequest const& request) = 0;

  virtual google::cloud::internal::Idempotency AnalyzeIamPolicyLongrunning(
      google::cloud::asset::v1::AnalyzeIamPolicyLongrunningRequest const&
          request) = 0;

  virtual google::cloud::internal::Idempotency AnalyzeMove(
