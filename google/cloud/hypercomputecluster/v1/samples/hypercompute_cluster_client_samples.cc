...
// clang-format off
// main-dox-marker: hypercomputecluster_v1::HypercomputeClusterClient
// lro-marker: true
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client =
      google::cloud::hypercomputecluster_v1::HypercomputeClusterClient(
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client =
      google::cloud::hypercomputecluster_v1::HypercomputeClusterClient(
          google::cloud::hypercomputecluster_v1::
              MakeHypercomputeClusterConnection(*ud_options));
  //! [set-client-universe-domain]
}

//! [custom-idempotency-policy]
class CustomIdempotencyPolicy
    : public google::cloud::hypercomputecluster_v1::
          HypercomputeClusterConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::hypercomputecluster_v1::
                      HypercomputeClusterConnectionIdempotencyPolicy>
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
      ...
      google::cloud::Options{}
          ...
          .set<google::cloud::hypercomputecluster_v1::
              ...
              google::cloud::ExponentialBackoffPolicy(
                  ...
                  .clone());
  auto connection =
      google::cloud::hypercomputecluster_v1::MakeHypercomputeClusterConnection(
          options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::hypercomputecluster_v1::HypercomputeClusterClient(
      connection);
  auto c2 = google::cloud::hypercomputecluster_v1::HypercomputeClusterClient(
      connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::hypercomputecluster_v1::HypercomputeClusterClient(
  ...
  //     .set<google::cloud::hypercomputecluster_v1::HypercomputeClusterRetryPolicyOption>(
  //       google::cloud::hypercomputecluster_v1::HypercomputeClusterLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
      ...
      google::cloud::Options{}
          .set<google::cloud::hypercomputecluster_v1::
              ...
              google::cloud::GenericPollingPolicy<
                  google::cloud::hypercomputecluster_v1::
                      HypercomputeClusterRetryPolicyOption::Type,
                  google::cloud::hypercomputecluster_v1::
                      HypercomputeClusterBackoffPolicyOption::Type>(
                  google::cloud::hypercomputecluster_v1::
                      HypercomputeClusterLimitedTimeRetryPolicy(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::hypercomputecluster_v1::HypercomputeClusterClient(
        google::cloud::hypercomputecluster_v1::
            MakeHypercomputeClusterConnection(options));
  }
  //! [with-service-account]
