# HOWTO: using the Cloud Data Loss Prevention (DLP) API C++ client in your project

This directory contains small examples showing how to use the Cloud Data Loss
Prevention (DLP) API C++ client library in your own project. These instructions
...
Like most Google Cloud Platform (GCP) services, Cloud Data Loss Prevention (DLP) API requires that
...
1. Install the dependencies with your favorite tools. As an example, if you use
   ...
   ```bash
   cd $HOME/vcpkg
   ./vcpkg install google-cloud-cpp[core,dlp]
   ```
...
1. Configure CMake, if necessary, configure the directory where you installed
   ...
   ```bash
   cd $HOME/gooogle-cloud-cpp/google/cloud/dlp/quickstart
...
[quickstart-link]: https://cloud.google.com/dlp/docs/quickstart
