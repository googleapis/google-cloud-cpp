...
Status
DlpServiceMetadata::DeleteInspectTemplate(
    grpc::ClientContext& context,
    Options const& options,
...
Status
DlpServiceMetadata::DeleteDeidentifyTemplate(
    grpc::ClientContext& context,
    Options const& options,
...
Status
DlpServiceMetadata::DeleteJobTrigger(
    grpc::ClientContext& context,
    Options const& options,
...
Status
DlpServiceMetadata::DeleteDiscoveryConfig(
    grpc::ClientContext& context,
    Options const& options,
...
StatusOr<google::privacy::dlp::v2::DlpJob>
DlpServiceMetadata::CreateDlpJob(
    grpc::ClientContext& context,
    Options const& options,
...
Status
DlpServiceMetadata::DeleteDlpJob(
    grpc::ClientContext& context,
    Options const& options,
...
Status
DlpServiceMetadata::CancelDlpJob(
    grpc::ClientContext& context,
    Options const& options,
...
Status
DlpServiceMetadata::DeleteStoredInfoType(
    grpc::ClientContext& context,
    Options const& options,
...
Status
DlpServiceMetadata::DeleteFileStoreDataProfile(
    grpc::ClientContext& context,
    Options const& options,
...
Status
DlpServiceMetadata::DeleteTableDataProfile(
    grpc::ClientContext& context,
    Options const& options,
...
Status
DlpServiceMetadata::FinishDlpJob(
    grpc::ClientContext& context,
    Options const& options,
...
Status
DlpServiceMetadata::DeleteConnection(
    grpc::ClientContext& context,
    Options const& options,
