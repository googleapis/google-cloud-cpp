...
/**
 * A retry policy for `IDSConnection` that stops retrying after a
...
class IDSLimitedErrorCountRetryPolicy : public IDSRetryPolicy {
 public:
  IDSLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `IDSConnection` that stops retrying after
