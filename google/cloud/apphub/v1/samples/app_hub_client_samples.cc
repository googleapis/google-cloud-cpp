...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::apphub_v1::AppHubClient(
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::apphub_v1::AppHubClient(
      google::cloud::apphub_v1::MakeAppHubConnection(*ud_options));
  //! [set-client-universe-domain]
}
