 ...
 * construct an object of type `SubscriptionAdminClient` with an instance of this
 ...
 */
class MockSubscriptionAdminConnection : public pubsub_admin::SubscriptionAdminConnection {
 public:
