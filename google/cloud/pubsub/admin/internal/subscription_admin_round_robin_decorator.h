...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_PUBSUB_ADMIN_INTERNAL_SUBSCRIPTION_ADMIN_ROUND_ROBIN_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_PUBSUB_ADMIN_INTERNAL_SUBSCRIPTION_ADMIN_ROUND_ROBIN_DECORATOR_H
...
class SubscriptionAdminRoundRobin : public SubscriptionAdminStub {
 public:
  explicit SubscriptionAdminRoundRobin(
      std::vector<std::shared_ptr<SubscriptionAdminStub>> children);
  ~SubscriptionAdminRoundRobin() override = default;
 ...
 private:
  ...
  std::vector<std::shared_ptr<SubscriptionAdminStub>> const children_;
  std::mutex mu_;
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_PUBSUB_ADMIN_INTERNAL_SUBSCRIPTION_ADMIN_ROUND_ROBIN_DECORATOR_H
