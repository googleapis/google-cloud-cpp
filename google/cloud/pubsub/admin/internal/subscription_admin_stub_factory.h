...
std::shared_ptr<SubscriptionAdminStub> CreateDefaultSubscriptionAdminStub(
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_PUBSUB_ADMIN_INTERNAL_SUBSCRIPTION_ADMIN_STUB_FACTORY_H
