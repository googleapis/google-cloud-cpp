...
class TopicAdminTracingStub : public TopicAdminStub {
 public:
  ~TopicAdminTracingStub() override = default;

  explicit TopicAdminTracingStub(std::shared_ptr<TopicAdminStub> child);
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_PUBSUB_ADMIN_INTERNAL_TOPIC_ADMIN_TRACING_STUB_H
