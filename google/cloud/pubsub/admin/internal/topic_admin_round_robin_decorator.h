...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_PUBSUB_ADMIN_INTERNAL_TOPIC_ADMIN_ROUND_ROBIN_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_PUBSUB_ADMIN_INTERNAL_TOPIC_ADMIN_ROUND_ROBIN_DECORATOR_H
...
class TopicAdminRoundRobin : public TopicAdminStub {
 public:
  explicit TopicAdminRoundRobin(
      std::vector<std::shared_ptr<TopicAdminStub>> children);
  ~TopicAdminRoundRobin() override = default;
 ...
 private:
  ...
  std::vector<std::shared_ptr<TopicAdminStub>> const children_;
  std::mutex mu_;
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_PUBSUB_ADMIN_INTERNAL_TOPIC_ADMIN_ROUND_ROBIN_DECORATOR_H
