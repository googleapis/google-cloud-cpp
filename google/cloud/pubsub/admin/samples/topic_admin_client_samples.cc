...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::pubsub_admin::TopicAdminClient(
      google::cloud::pubsub_admin::MakeTopicAdminConnection(*ud_options));
  //! [set-client-universe-domain]
}

//! [custom-idempotency-policy]
class CustomIdempotencyPolicy : public google::cloud::pubsub_admin::
                                    TopicAdminConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<
      google::cloud::pubsub_admin::TopicAdminConnectionIdempotencyPolicy>
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
      ...
      google::cloud::Options{}
          ...
          .set<google::cloud::pubsub_admin::TopicAdminRetryPolicyOption>(
              google::cloud::pubsub_admin::
                  TopicAdminLimitedErrorCountRetryPolicy(3)
                      .clone())
  ...
  auto c3 = google::cloud::pubsub_admin::TopicAdminClient(
      ...
      google::cloud::Options{}
          .set<google::cloud::pubsub_admin::TopicAdminRetryPolicyOption>(
              google::cloud::pubsub_admin::TopicAdminLimitedTimeRetryPolicy(
