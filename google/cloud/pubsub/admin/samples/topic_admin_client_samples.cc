...
// clang-format off
// main-dox-marker: pubsub_admin::TopicAdminClient
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::pubsub_admin::TopicAdminClient(
...
class CustomIdempotencyPolicy
   : public google::cloud::pubsub_admin::TopicAdminConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::pubsub_admin::TopicAdminConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::pubsub_admin::TopicAdminConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::pubsub_admin::TopicAdminRetryPolicyOption>(
      google::cloud::pubsub_admin::TopicAdminLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::pubsub_admin::TopicAdminBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::pubsub_admin::MakeTopicAdminConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::pubsub_admin::TopicAdminClient(connection);
  auto c2 = google::cloud::pubsub_admin::TopicAdminClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::pubsub_admin::TopicAdminClient(
    connection, google::cloud::Options{}.set<google::cloud::pubsub_admin::TopicAdminRetryPolicyOption>(
      google::cloud::pubsub_admin::TopicAdminLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::pubsub_admin::TopicAdminRetryPolicyOption>(
  //       google::cloud::pubsub_admin::TopicAdminLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::pubsub_admin::TopicAdminClient(
      google::cloud::pubsub_admin::MakeTopicAdminConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
