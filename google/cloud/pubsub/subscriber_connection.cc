...
SubscriberConnection::ListSubscriptions(
    google::pubsub::v1::
...
Status SubscriberConnection::DeleteSubscription(
    google::pubsub::v1::DeleteSubscriptionRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

StatusOr<google::pubsub::v1::PullResponse> SubscriberConnection::Pull(
...
Status SubscriberConnection::ModifyPushConfig(
    google::pubsub::v1::ModifyPushConfigRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

StatusOr<google::pubsub::v1::Snapshot> SubscriberConnection::GetSnapshot(
...
StatusOr<google::pubsub::v1::Snapshot> SubscriberConnection::CreateSnapshot(
    google::pubsub::v1::CreateSnapshotRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

StatusOr<google::pubsub::v1::Snapshot> SubscriberConnection::UpdateSnapshot(
    google::pubsub::v1::UpdateSnapshotRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

Status SubscriberConnection::DeleteSnapshot(
    google::pubsub::v1::DeleteSnapshotRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

StatusOr<google::pubsub::v1::SeekResponse> SubscriberConnection::Seek(
    google::pubsub::v1::SeekRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

future<Status> SubscriberConnection::AsyncModifyAckDeadline(
    google::pubsub::v1::ModifyAckDeadlineRequest const&) {
  return google::cloud::make_ready_future(
      Status(StatusCode::kUnimplemented, "not implemented"));
}

future<Status> SubscriberConnection::AsyncAcknowledge(
...
std::shared_ptr<SubscriberConnection> MakeSubscriberConnection(
  ...
  options = pubsub_internal::SubscriberDefaultOptions(std::move(options));
  auto background = internal::MakeBackgroundThreadsFactory(options)();
  auto stub =
      pubsub_internal::CreateDefaultSubscriberStub(background->cq(), options);
  return pubsub_internal::MakeSubscriberTracingConnection(
