...
std::unique_ptr<pubsub::SubscriberRetryPolicy> retry_policy(
    Options const& options) {
  return options.get<pubsub::SubscriberRetryPolicyOption>()->clone();
}

std::unique_ptr<BackoffPolicy> backoff_policy(Options const& options) {
  return options.get<pubsub::SubscriberBackoffPolicyOption>()->clone();
}

std::unique_ptr<pubsub::SubscriberConnectionIdempotencyPolicy>
idempotency_policy(Options const& options) {
  return options.get<pubsub::SubscriberConnectionIdempotencyPolicyOption>()
      ->clone();
}
...
SubscriberConnectionImpl::SubscriberConnectionImpl(
    ...
    std::shared_ptr<pubsub_internal::SubscriberStub> stub, Options options)
...
SubscriberConnectionImpl::CreateSubscription(
...
StatusOr<google::pubsub::v1::Subscription>
SubscriberConnectionImpl::GetSubscription(
...
StatusOr<google::pubsub::v1::Subscription>
SubscriberConnectionImpl::UpdateSubscription(
...
SubscriberConnectionImpl::ListSubscriptions(
  ...
  return google::cloud::internal::MakePaginationRange<
      ...
      [idempotency, function_name, stub = stub_,
       retry = std::shared_ptr<pubsub::SubscriberRetryPolicy>(
...
Status SubscriberConnectionImpl::DeleteSubscription(
...
StatusOr<google::pubsub::v1::PullResponse> SubscriberConnectionImpl::Pull(
...
Status SubscriberConnectionImpl::ModifyPushConfig(
...
StatusOr<google::pubsub::v1::Snapshot> SubscriberConnectionImpl::GetSnapshot(
...
SubscriberConnectionImpl::ListSnapshots(
...
StatusOr<google::pubsub::v1::Snapshot> SubscriberConnectionImpl::CreateSnapshot(
...
StatusOr<google::pubsub::v1::Snapshot> SubscriberConnectionImpl::UpdateSnapshot(
...
Status SubscriberConnectionImpl::DeleteSnapshot(
...
StatusOr<google::pubsub::v1::SeekResponse> SubscriberConnectionImpl::Seek(
...
future<Status> SubscriberConnectionImpl::AsyncModifyAckDeadline(
    google::pubsub::v1::ModifyAckDeadlineRequest const& request) {
  auto current = google::cloud::internal::SaveCurrentOptions();
  return google::cloud::internal::AsyncRetryLoop(
      retry_policy(*current), backoff_policy(*current),
      idempotency_policy(*current)->ModifyAckDeadline(request),
      background_->cq(),
      [stub = stub_](
...
future<Status> SubscriberConnectionImpl::AsyncAcknowledge(
    google::pubsub::v1::AcknowledgeRequest const& request) {
  auto current = google::cloud::internal::SaveCurrentOptions();
  return google::cloud::internal::AsyncRetryLoop(
      retry_policy(*current), backoff_policy(*current),
      idempotency_policy(*current)->Acknowledge(request), background_->cq(),
...
SubscriberConnectionImpl::AsyncStreamingPull(
    google::pubsub::v1::StreamingPullRequest const& request) {
  auto current = google::cloud::internal::SaveCurrentOptions();
  return google::cloud::internal::AsyncRetryLoop(
      retry_policy(*current), backoff_policy(*current),
      idempotency_policy(*current)->StreamingPull(request), background_->cq(),
      [stub = stub_](CompletionQueue& cq,
                     std::shared_ptr<grpc::ClientContext> context,
                     google::pubsub::v1::StreamingPullRequest const& request) {
        return stub->AsyncStreamingPull(cq, std::move(context), request);
      },
      request, __func__);
}
