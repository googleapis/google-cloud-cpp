...
class SubscriberTracingConnection
 ...
 public:
  ...
  future<Status>
  AsyncModifyAckDeadline(google::pubsub::v1::ModifyAckDeadlineRequest const& request) override;

  future<Status>
  AsyncAcknowledge(google::pubsub::v1::AcknowledgeRequest const& request) override;

  future<StatusOr<google::pubsub::v1::StreamingPullResponse>>
  AsyncStreamingPull(google::pubsub::v1::StreamingPullRequest const& request) override;
