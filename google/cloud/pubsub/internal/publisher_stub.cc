...
DefaultPublisherStub::CreateTopic(
...
StatusOr<google::pubsub::v1::Topic>
DefaultPublisherStub::UpdateTopic(
  grpc::ClientContext& context, Options const&,
...
DefaultPublisherStub::Publish(
  grpc::ClientContext& context, Options const&,
  google::pubsub::v1::PublishRequest const& request) {
    google::pubsub::v1::PublishResponse response;
    auto status =
        grpc_stub_->Publish(&context, request, &response);
    if (!status.ok()) {
      return google::cloud::MakeStatusFromRpcError(status);
    }
    return response;
...
Status
DefaultPublisherStub::DeleteTopic(
  grpc::ClientContext& context, Options const&,
...
DefaultPublisherStub::SetIamPolicy(
  grpc::ClientContext& context, Options const&,
...
StatusOr<google::iam::v1::Policy>
DefaultPublisherStub::GetIamPolicy(
  grpc::ClientContext& context, Options const&,
...
DefaultPublisherStub::TestIamPermissions(
  grpc::ClientContext& context, Options const&,
