...
SubscriberTracingConnection::CreateSubscription(google::pubsub::v1::Subscription const& request) {
  auto span = internal::MakeSpan("pubsub::SubscriberConnection::CreateSubscription");
...
SubscriberTracingConnection::GetSubscription(google::pubsub::v1::GetSubscriptionRequest const& request) {
  auto span = internal::MakeSpan("pubsub::SubscriberConnection::GetSubscription");
  auto scope = opentelemetry::trace::Scope(span);
...
SubscriberTracingConnection::UpdateSubscription(google::pubsub::v1::UpdateSubscriptionRequest const& request) {
  auto span = internal::MakeSpan("pubsub::SubscriberConnection::UpdateSubscription");
  auto scope = opentelemetry::trace::Scope(span);
...
SubscriberTracingConnection::ListSubscriptions(google::pubsub::v1::ListSubscriptionsRequest request) {
  auto span = internal::MakeSpan("pubsub::SubscriberConnection::ListSubscriptions");
  auto scope = opentelemetry::trace::Scope(span);
...
SubscriberTracingConnection::DeleteSubscription(google::pubsub::v1::DeleteSubscriptionRequest const& request) {
  auto span = internal::MakeSpan("pubsub::SubscriberConnection::DeleteSubscription");
  auto scope = opentelemetry::trace::Scope(span);
...
SubscriberTracingConnection::Pull(google::pubsub::v1::PullRequest const& request) {
  auto span = internal::MakeSpan("pubsub::SubscriberConnection::Pull");
  auto scope = opentelemetry::trace::Scope(span);
...
SubscriberTracingConnection::ModifyPushConfig(google::pubsub::v1::ModifyPushConfigRequest const& request) {
  auto span = internal::MakeSpan("pubsub::SubscriberConnection::ModifyPushConfig");
  auto scope = opentelemetry::trace::Scope(span);
...
SubscriberTracingConnection::GetSnapshot(google::pubsub::v1::GetSnapshotRequest const& request) {
  auto span = internal::MakeSpan("pubsub::SubscriberConnection::GetSnapshot");
  auto scope = opentelemetry::trace::Scope(span);
...
SubscriberTracingConnection::ListSnapshots(google::pubsub::v1::ListSnapshotsRequest request) {
  auto span = internal::MakeSpan("pubsub::SubscriberConnection::ListSnapshots");
  auto scope = opentelemetry::trace::Scope(span);
...
SubscriberTracingConnection::CreateSnapshot(google::pubsub::v1::CreateSnapshotRequest const& request) {
  auto span = internal::MakeSpan("pubsub::SubscriberConnection::CreateSnapshot");
  auto scope = opentelemetry::trace::Scope(span);
...
SubscriberTracingConnection::UpdateSnapshot(google::pubsub::v1::UpdateSnapshotRequest const& request) {
  auto span = internal::MakeSpan("pubsub::SubscriberConnection::UpdateSnapshot");
  auto scope = opentelemetry::trace::Scope(span);
...
SubscriberTracingConnection::DeleteSnapshot(google::pubsub::v1::DeleteSnapshotRequest const& request) {
  auto span = internal::MakeSpan("pubsub::SubscriberConnection::DeleteSnapshot");
  auto scope = opentelemetry::trace::Scope(span);
...
SubscriberTracingConnection::Seek(google::pubsub::v1::SeekRequest const& request) {
  auto span = internal::MakeSpan("pubsub::SubscriberConnection::Seek");
  auto scope = opentelemetry::trace::Scope(span);
  return internal::EndSpan(*span, child_->Seek(request));
}

future<Status>
SubscriberTracingConnection::AsyncModifyAckDeadline(google::pubsub::v1::ModifyAckDeadlineRequest const& request) {
  auto span = internal::MakeSpan(
      "pubsub::SubscriberConnection::AsyncModifyAckDeadline");
  auto scope = opentelemetry::trace::Scope(span);
  return internal::EndSpan(std::move(span), child_->AsyncModifyAckDeadline(request));
}

future<Status>
SubscriberTracingConnection::AsyncAcknowledge(google::pubsub::v1::AcknowledgeRequest const& request) {
  auto span = internal::MakeSpan(
      "pubsub::SubscriberConnection::AsyncAcknowledge");
  auto scope = opentelemetry::trace::Scope(span);
  return internal::EndSpan(std::move(span), child_->AsyncAcknowledge(request));
}

future<StatusOr<google::pubsub::v1::StreamingPullResponse>>
SubscriberTracingConnection::AsyncStreamingPull(google::pubsub::v1::StreamingPullRequest const& request) {
  auto span = internal::MakeSpan(
      "pubsub::SubscriberConnection::AsyncStreamingPull");
  auto scope = opentelemetry::trace::Scope(span);
  return internal::EndSpan(std::move(span), child_->AsyncStreamingPull(request));
}

#endif  // GOOGLE_CLOUD_CPP_HAVE_OPENTELEMETRY

std::shared_ptr<pubsub::SubscriberConnection>
MakeSubscriberTracingConnection(
    std::shared_ptr<pubsub::SubscriberConnection> conn) {
#ifdef GOOGLE_CLOUD_CPP_HAVE_OPENTELEMETRY
