...
StatusOr<google::pubsub::v1::Subscription>
SubscriberMetadata::GetSubscription(
    grpc::ClientContext& context,
    Options const& options,
...
Status
SubscriberMetadata::DeleteSubscription(
    grpc::ClientContext& context,
    Options const& options,
...
Status
SubscriberMetadata::ModifyPushConfig(
    grpc::ClientContext& context,
    Options const& options,
...
SubscriberMetadata::GetSnapshot(
    grpc::ClientContext& context,
    Options const& options,
...
StatusOr<google::pubsub::v1::Snapshot>
SubscriberMetadata::CreateSnapshot(
    grpc::ClientContext& context,
    Options const& options,
...
StatusOr<google::pubsub::v1::Snapshot>
SubscriberMetadata::UpdateSnapshot(
    grpc::ClientContext& context,
    Options const& options,
...
Status
SubscriberMetadata::DeleteSnapshot(
    grpc::ClientContext& context,
    Options const& options,
...
SubscriberMetadata::SetIamPolicy(
    grpc::ClientContext& context,
    Options const& options,
...
StatusOr<google::iam::v1::Policy>
SubscriberMetadata::GetIamPolicy(
    grpc::ClientContext& context,
    Options const& options,
...
future<Status>
SubscriberMetadata::AsyncModifyAckDeadline(
...
future<Status>
SubscriberMetadata::AsyncAcknowledge(
      google::cloud::CompletionQueue& cq,
      std::shared_ptr<grpc::ClientContext> context,
      google::cloud::internal::ImmutableOptions options,
