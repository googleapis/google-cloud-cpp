...
std::shared_ptr<SchemaServiceStub> CreateDefaultSchemaServiceStub(
  ...
  auto endpoint = internal::DetermineServiceEndpoint(
      internal::GetEnv("GOOGLE_CLOUD_CPP_SCHEMA_SERVICE_ENDPOINT"),
      std::move(endpoint_option), "pubsub.googleapis.com", options);
  ...
  if (!endpoint.ok()) {
    ...
    auto service_grpc_stub =
        google::pubsub::v1::SchemaService::NewStub(channel);
    stub = std::make_shared<DefaultSchemaServiceStub>(
