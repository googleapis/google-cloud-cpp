...
SubscriberLogging::SubscriberLogging(
...
StatusOr<google::pubsub::v1::Subscription>
SubscriberLogging::GetSubscription(
    grpc::ClientContext& context,
    Options const& options,
...
Status
SubscriberLogging::DeleteSubscription(
    grpc::ClientContext& context,
    Options const& options,
...
SubscriberLogging::AsyncStreamingPull(
  ...
  using LoggingStream =
     ::google::cloud::internal::AsyncStreamingReadWriteRpcLogging<google::pubsub::v1::StreamingPullRequest, google::pubsub::v1::StreamingPullResponse>;

  auto request_id = google::cloud::internal::RequestIdForLogging();
  GCP_LOG(DEBUG) << __func__ << "(" << request_id << ")";
  auto stream = child_->AsyncStreamingPull(
...
Status
SubscriberLogging::ModifyPushConfig(
    grpc::ClientContext& context,
    Options const& options,
...
StatusOr<google::pubsub::v1::Snapshot>
SubscriberLogging::CreateSnapshot(
    grpc::ClientContext& context,
    Options const& options,
...
StatusOr<google::pubsub::v1::Snapshot>
SubscriberLogging::UpdateSnapshot(
    grpc::ClientContext& context,
    Options const& options,
...
Status
SubscriberLogging::DeleteSnapshot(
    grpc::ClientContext& context,
    Options const& options,
...
SubscriberLogging::SetIamPolicy(
    grpc::ClientContext& context,
    Options const& options,
...
StatusOr<google::iam::v1::Policy>
SubscriberLogging::GetIamPolicy(
    grpc::ClientContext& context,
    Options const& options,
...
future<Status>
SubscriberLogging::AsyncModifyAckDeadline(
  ...
  return google::cloud::internal::LogWrapper(
      [this](google::cloud::CompletionQueue& cq,
             ...
             google::cloud::internal::ImmutableOptions options,
             google::pubsub::v1::ModifyAckDeadlineRequest const& request) {
        return child_->AsyncModifyAckDeadline(
...
future<Status>
SubscriberLogging::AsyncAcknowledge(
      google::cloud::CompletionQueue& cq,
      std::shared_ptr<grpc::ClientContext> context,
      google::cloud::internal::ImmutableOptions options,
  ...
  return google::cloud::internal::LogWrapper(
      [this](google::cloud::CompletionQueue& cq,
             ...
             google::cloud::internal::ImmutableOptions options,
             google::pubsub::v1::AcknowledgeRequest const& request) {
        return child_->AsyncAcknowledge(
            cq, std::move(context), std::move(options), request);
      },
      cq, std::move(context), std::move(options), request, __func__, tracing_options_);
}
