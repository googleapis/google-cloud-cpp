...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_PUBSUB_V1_INTERNAL_SUBSCRIBER_AUTH_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_PUBSUB_V1_INTERNAL_SUBSCRIBER_AUTH_DECORATOR_H
...
class SubscriberAuth : public SubscriberStub {
 public:
  ~SubscriberAuth() override = default;
  SubscriberAuth(
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_PUBSUB_V1_INTERNAL_SUBSCRIBER_AUTH_DECORATOR_H
