...
std::unique_ptr<pubsub_v1::PublisherRetryPolicy>
retry_policy(Options const& options) {
  return options.get<pubsub_v1::PublisherRetryPolicyOption>()->clone();
}

std::unique_ptr<BackoffPolicy>
backoff_policy(Options const& options) {
  return options.get<pubsub_v1::PublisherBackoffPolicyOption>()->clone();
}

std::unique_ptr<pubsub_v1::PublisherConnectionIdempotencyPolicy>
idempotency_policy(Options const& options) {
  return options.get<pubsub_v1::PublisherConnectionIdempotencyPolicyOption>()->clone();
}
...
PublisherConnectionImpl::ListTopics(google::pubsub::v1::ListTopicsRequest request) {
  ...
  return google::cloud::internal::MakePaginationRange<StreamRange<google::pubsub::v1::Topic>>(
      ...
      [idempotency, function_name, stub = stub_,
       retry = std::shared_ptr<pubsub_v1::PublisherRetryPolicy>(retry_policy(*current)),
