...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  // when creating the SchemaServiceConnection.
  // For example, to connect to "europe-central2-pubsub.googleapis.com":
  auto client = google::cloud::pubsub::SchemaServiceClient(
      google::cloud::pubsub::MakeSchemaServiceConnection("europe-central2"));

  // This configuration is common with Private Google Access:
  //     https://cloud.google.com/vpc/docs/private-google-access
  auto options = google::cloud::Options{}.set<google::cloud::EndpointOption>(
      "private.googleapis.com");
  auto vpc_client = google::cloud::pubsub::SchemaServiceClient(
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::pubsub::SchemaServiceClient(
      google::cloud::pubsub::MakeSchemaServiceConnection(ud_options));
...
class CustomIdempotencyPolicy
 ...
 public:
  ...
  std::unique_ptr<
      google::cloud::pubsub::SchemaServiceConnectionIdempotencyPolicy>
