...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_INTERNAL_GRPC_ASYNC_RETRY_UNARY_RPC_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_INTERNAL_GRPC_ASYNC_RETRY_UNARY_RPC_H

#include "google/cloud/completion_queue.h"
#include "google/cloud/idempotency.h"
#include "google/cloud/internal/grpc/completion_queue_impl.h"
#include "google/cloud/internal/grpc/setup_context.h"
  ...
  static void OnCompletion(std::shared_ptr<RetryAsyncUnaryRpc> self,
    ...
    if (!self->rpc_retry_policy_->OnFailure(result.status())) {
      auto failure_description =
          self->rpc_retry_policy_->IsPermanentFailure(result.status())
              ? "permanent failure"
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_INTERNAL_GRPC_ASYNC_RETRY_UNARY_RPC_H
