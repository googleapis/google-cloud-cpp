...
// UniverseDomainOption is contained in options, then the respective endpoint is
// computed by replacing the googleapis.com string in the default_host value
// with the value of the universe_domain, e.g.:
