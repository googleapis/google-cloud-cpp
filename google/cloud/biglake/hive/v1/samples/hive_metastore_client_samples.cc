...
// clang-format off
// main-dox-marker: biglake_hive_v1::HiveMetastoreServiceClient
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::biglake_hive_v1::HiveMetastoreServiceClient(
      google::cloud::biglake_hive_v1::MakeHiveMetastoreServiceConnection(
          options));
  //! [set-client-endpoint]
}
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::biglake_hive_v1::HiveMetastoreServiceClient(
      google::cloud::biglake_hive_v1::MakeHiveMetastoreServiceConnection(
          *ud_options));
  //! [set-client-universe-domain]
}
...
class CustomIdempotencyPolicy
    : public google::cloud::biglake_hive_v1::
          HiveMetastoreServiceConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::biglake_hive_v1::
                      HiveMetastoreServiceConnectionIdempotencyPolicy>
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options =
      google::cloud::Options{}
          .set<google::cloud::biglake_hive_v1::
          ...
          .set<google::cloud::biglake_hive_v1::
              ...
              google::cloud::biglake_hive_v1::
                  HiveMetastoreServiceLimitedErrorCountRetryPolicy(3)
                      .clone())
          .set<google::cloud::biglake_hive_v1::
  ...
  auto c1 =
      google::cloud::biglake_hive_v1::HiveMetastoreServiceClient(connection);
  auto c2 =
      google::cloud::biglake_hive_v1::HiveMetastoreServiceClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::biglake_hive_v1::HiveMetastoreServiceClient(
  ...
  //     .set<google::cloud::biglake_hive_v1::HiveMetastoreServiceRetryPolicyOption>(
  //       google::cloud::biglake_hive_v1::HiveMetastoreServiceLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::biglake_hive_v1::HiveMetastoreServiceClient(
        google::cloud::biglake_hive_v1::MakeHiveMetastoreServiceConnection(
            options));
  }
  //! [with-service-account]
