...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::alloydb_v1::AlloyDBAdminClient(
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::alloydb_v1::AlloyDBAdminClient(
      google::cloud::alloydb_v1::MakeAlloyDBAdminConnection(ud_options));

  //! [set-client-universe-domain]
}

//! [custom-idempotency-policy]
class CustomIdempotencyPolicy : public google::cloud::alloydb_v1::
                                    AlloyDBAdminConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<
      google::cloud::alloydb_v1::AlloyDBAdminConnectionIdempotencyPolicy>
      ...
      google::cloud::Options{}
          .set<google::cloud::alloydb_v1::AlloyDBAdminPollingPolicyOption>(
              google::cloud::GenericPollingPolicy<
                  google::cloud::alloydb_v1::AlloyDBAdminRetryPolicyOption::
                      Type,
                  google::cloud::alloydb_v1::AlloyDBAdminBackoffPolicyOption::
                      Type>(
                  google::cloud::alloydb_v1::AlloyDBAdminLimitedTimeRetryPolicy(
