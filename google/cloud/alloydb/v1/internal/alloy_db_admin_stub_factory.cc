...
std::shared_ptr<AlloyDBAdminStub> CreateDefaultAlloyDBAdminStub(
  ...
  auto endpoint = internal::DetermineServiceEndpoint(
      internal::GetEnv("GOOGLE_CLOUD_CPP_ALLOY_DB_ADMIN_ENDPOINT"),
      internal::FetchOption<EndpointOption>(options), "alloydb.googleapis.com",
      options);
  ...
  if (!endpoint.ok()) {
    ...
    stub = std::make_shared<DefaultAlloyDBAdminStub>(
