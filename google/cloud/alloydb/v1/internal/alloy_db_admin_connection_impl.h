...
class AlloyDBAdminConnectionImpl
 ...
 public:
  ...
  ExportCluster(google::cloud::alloydb::v1::ExportClusterRequest const& request) override;

  StatusOr<google::longrunning::Operation>
  ExportCluster(NoAwaitTag,
  ...
  ImportCluster(google::cloud::alloydb::v1::ImportClusterRequest const& request) override;

  StatusOr<google::longrunning::Operation>
  ImportCluster(NoAwaitTag,
  ...
  UpgradeCluster(google::cloud::alloydb::v1::UpgradeClusterRequest const& request) override;
  ...
  future<StatusOr<google::cloud::alloydb::v1::Cluster>>
  SwitchoverCluster(google::cloud::alloydb::v1::SwitchoverClusterRequest const& request) override;

  StatusOr<google::longrunning::Operation>
  SwitchoverCluster(NoAwaitTag,
  ...
  StatusOr<google::longrunning::Operation>
  CreateSecondaryCluster(NoAwaitTag,
  ...
  StatusOr<google::longrunning::Operation>
  CreateSecondaryInstance(NoAwaitTag,
  ...
  StatusOr<google::longrunning::Operation>
  BatchCreateInstances(NoAwaitTag,
  ...
  ExecuteSql(google::cloud::alloydb::v1::ExecuteSqlRequest const& request) override;
  ...
  ListDatabases(google::cloud::alloydb::v1::ListDatabasesRequest request) override;
