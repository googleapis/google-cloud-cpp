...
/**
 * A retry policy for `AlloyDBAdminConnection` that stops retrying after a
...
class AlloyDBAdminLimitedErrorCountRetryPolicy
 ...
 public:
  AlloyDBAdminLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `AlloyDBAdminConnection` that stops retrying after
