# HOWTO: using the AlloyDB API C++ client in your project

This directory contains small examples showing how to use the AlloyDB API C++
...
Like most Google Cloud Platform (GCP) services, AlloyDB API requires that
...
1. Install the dependencies with your favorite tools. As an example, if you use
   ...
   ```bash
   cd $HOME/vcpkg
   ./vcpkg install google-cloud-cpp[core,alloydb]
   ```
...
1. Configure CMake, if necessary, configure the directory where you installed
   ...
   ```bash
   cd $HOME/gooogle-cloud-cpp/google/cloud/alloydb/quickstart
...
[quickstart-link]: https://cloud.google.com/alloydb/docs/quickstart
