...
#include "google/cloud/gameservices/v1/internal/game_server_configs_connection_impl.h"
...
MakeGameServerConfigsServiceConnection(Options options) {
  internal::CheckExpectedOptions<CommonOptionList, GrpcOptionList,
      ...
      options, __func__);
  options = gameservices_v1_internal::GameServerConfigsServiceDefaultOptions(
      std::move(options));
  auto background = internal::MakeBackgroundThreadsFactory(options)();
  auto stub =
      gameservices_v1_internal::CreateDefaultGameServerConfigsServiceStub(
          background->cq(), options);
  return gameservices_v1_internal::
      MakeGameServerConfigsServiceTracingConnection(
          std::make_shared<
              gameservices_v1_internal::GameServerConfigsServiceConnectionImpl>(
