...
#include "google/cloud/gameservices/v1/internal/realms_connection_impl.h"
...
std::shared_ptr<RealmsServiceConnection> MakeRealmsServiceConnection(
  ...
  internal::CheckExpectedOptions<CommonOptionList, GrpcOptionList,
                                 ...
                                 RealmsServicePolicyOptionList>(options,
                                                                __func__);
  options =
      gameservices_v1_internal::RealmsServiceDefaultOptions(std::move(options));
  auto background = internal::MakeBackgroundThreadsFactory(options)();
  auto stub = gameservices_v1_internal::CreateDefaultRealmsServiceStub(
      background->cq(), options);
  return gameservices_v1_internal::MakeRealmsServiceTracingConnection(
      std::make_shared<gameservices_v1_internal::RealmsServiceConnectionImpl>(
