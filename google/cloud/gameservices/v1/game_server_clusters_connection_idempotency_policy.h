...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_GAMESERVICES_V1_GAME_SERVER_CLUSTERS_CONNECTION_IDEMPOTENCY_POLICY_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_GAMESERVICES_V1_GAME_SERVER_CLUSTERS_CONNECTION_IDEMPOTENCY_POLICY_H
...
class GameServerClustersServiceConnectionIdempotencyPolicy {
 public:
  virtual ~GameServerClustersServiceConnectionIdempotencyPolicy();
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_GAMESERVICES_V1_GAME_SERVER_CLUSTERS_CONNECTION_IDEMPOTENCY_POLICY_H
