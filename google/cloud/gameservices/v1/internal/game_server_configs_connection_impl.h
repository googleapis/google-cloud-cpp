...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_GAMESERVICES_V1_INTERNAL_GAME_SERVER_CONFIGS_CONNECTION_IMPL_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_GAMESERVICES_V1_INTERNAL_GAME_SERVER_CONFIGS_CONNECTION_IMPL_H
...
class GameServerConfigsServiceConnectionImpl
 ...
 public:
  ...
  GameServerConfigsServiceConnectionImpl(
      ...
      std::shared_ptr<gameservices_v1_internal::GameServerConfigsServiceStub>
          stub,
      Options options);
 ...
 private:
  std::unique_ptr<gameservices_v1::GameServerConfigsServiceRetryPolicy>
  retry_policy() {
    auto const& options = internal::CurrentOptions();
    if (options.has<
            gameservices_v1::GameServerConfigsServiceRetryPolicyOption>()) {
      return options
          .get<gameservices_v1::GameServerConfigsServiceRetryPolicyOption>()
          ->clone();
    }
    return options_
        .get<gameservices_v1::GameServerConfigsServiceRetryPolicyOption>()
  ...
  std::unique_ptr<BackoffPolicy> backoff_policy() {
    ...
    if (options.has<
      ...
      return options
          .get<gameservices_v1::GameServerConfigsServiceBackoffPolicyOption>()
          ->clone();
    }
    return options_
        .get<gameservices_v1::GameServerConfigsServiceBackoffPolicyOption>()
  ...
  std::unique_ptr<PollingPolicy> polling_policy() {
    ...
    if (options.has<
      ...
      return options
          .get<gameservices_v1::GameServerConfigsServicePollingPolicyOption>()
          ->clone();
    }
    return options_
        .get<gameservices_v1::GameServerConfigsServicePollingPolicyOption>()
  ...
  std::shared_ptr<gameservices_v1_internal::GameServerConfigsServiceStub> stub_;
  Options options_;
};
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_GAMESERVICES_V1_INTERNAL_GAME_SERVER_CONFIGS_CONNECTION_IMPL_H
