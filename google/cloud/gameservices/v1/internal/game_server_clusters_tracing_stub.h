...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_GAMESERVICES_V1_INTERNAL_GAME_SERVER_CLUSTERS_TRACING_STUB_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_GAMESERVICES_V1_INTERNAL_GAME_SERVER_CLUSTERS_TRACING_STUB_H
...
class GameServerClustersServiceTracingStub
    : public GameServerClustersServiceStub {
 public:
  ~GameServerClustersServiceTracingStub() override = default;

  explicit GameServerClustersServiceTracingStub(
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_GAMESERVICES_V1_INTERNAL_GAME_SERVER_CLUSTERS_TRACING_STUB_H
