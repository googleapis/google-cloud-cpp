...
#include "google/cloud/gameservices/v1/internal/realms_stub_factory.h"
#include "google/cloud/gameservices/v1/internal/realms_auth_decorator.h"
#include "google/cloud/gameservices/v1/internal/realms_logging_decorator.h"
#include "google/cloud/gameservices/v1/internal/realms_metadata_decorator.h"
...
std::shared_ptr<RealmsServiceStub> CreateDefaultRealmsServiceStub(
  ...
  if (internal::TracingEnabled(options)) {
    stub = MakeRealmsServiceTracingStub(std::move(stub));
  }
  return stub;
}
