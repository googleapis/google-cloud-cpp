...
#include "google/cloud/gameservices/v1/internal/realms_tracing_connection.h"
...
RealmsServiceTracingConnection::ListRealms(
  ...
  auto span = internal::MakeSpan(
      "gameservices_v1::RealmsServiceConnection::ListRealms");
...
RealmsServiceTracingConnection::GetRealm(
  ...
  auto span =
      internal::MakeSpan("gameservices_v1::RealmsServiceConnection::GetRealm");
  auto scope = opentelemetry::trace::Scope(span);
...
RealmsServiceTracingConnection::PreviewRealmUpdate(
  ...
  auto span = internal::MakeSpan(
      "gameservices_v1::RealmsServiceConnection::PreviewRealmUpdate");
  auto scope = opentelemetry::trace::Scope(span);
