...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_GAMESERVICES_V1_INTERNAL_REALMS_TRACING_CONNECTION_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_GAMESERVICES_V1_INTERNAL_REALMS_TRACING_CONNECTION_H
...
class RealmsServiceTracingConnection
 ...
 public:
  ...
  explicit RealmsServiceTracingConnection(
      std::shared_ptr<gameservices_v1::RealmsServiceConnection> child);
 ...
 private:
  std::shared_ptr<gameservices_v1::RealmsServiceConnection> child_;
};
 ...
 */
std::shared_ptr<gameservices_v1::RealmsServiceConnection>
MakeRealmsServiceTracingConnection(
    std::shared_ptr<gameservices_v1::RealmsServiceConnection> conn);
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_GAMESERVICES_V1_INTERNAL_REALMS_TRACING_CONNECTION_H
