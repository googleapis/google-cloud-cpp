...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_GAMESERVICES_V1_INTERNAL_REALMS_LOGGING_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_GAMESERVICES_V1_INTERNAL_REALMS_LOGGING_DECORATOR_H
...
class RealmsServiceLogging : public RealmsServiceStub {
 public:
  ~RealmsServiceLogging() override = default;
  RealmsServiceLogging(std::shared_ptr<RealmsServiceStub> child,
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_GAMESERVICES_V1_INTERNAL_REALMS_LOGGING_DECORATOR_H
