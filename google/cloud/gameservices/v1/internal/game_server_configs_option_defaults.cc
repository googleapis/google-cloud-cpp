...
#include "google/cloud/gameservices/v1/internal/game_server_configs_option_defaults.h"
...
Options GameServerConfigsServiceDefaultOptions(Options options) {
  ...
  if (!options
           .has<gameservices_v1::GameServerConfigsServiceRetryPolicyOption>()) {
    options.set<gameservices_v1::GameServerConfigsServiceRetryPolicyOption>(
        gameservices_v1::GameServerConfigsServiceLimitedTimeRetryPolicy(
            std::chrono::minutes(30))
            .clone());
  }
  if (!options.has<
          gameservices_v1::GameServerConfigsServiceBackoffPolicyOption>()) {
