...
#include "google/cloud/gameservices/v1/realms_client.h"
...
/// @deprecated Use gameservices_v1::RealmsServiceClient directly.
using ::google::cloud::gameservices_v1::RealmsServiceClient;
