...
class GameServerDeploymentsServiceConnectionImpl
    : public GameServerDeploymentsServiceConnection {
 public:
  GameServerDeploymentsServiceConnectionImpl(
      ...
      : background_(std::move(background)),
        ...
        retry_policy_prototype_(
            options.get<GameServerDeploymentsServiceRetryPolicyOption>()
                ->clone()),
        backoff_policy_prototype_(
            options.get<GameServerDeploymentsServiceBackoffPolicyOption>()
                ->clone()),
        polling_policy_prototype_(
            options.get<GameServerDeploymentsServicePollingPolicyOption>()
                ->clone()),
        idempotency_policy_(
            options
                .get<
  ...
  ListGameServerDeployments(
    ...
    auto stub = stub_;
    auto retry = std::shared_ptr<GameServerDeploymentsServiceRetryPolicy const>(
        retry_policy());
 ...
 private:
  std::unique_ptr<GameServerDeploymentsServiceRetryPolicy> retry_policy() {
    ...
    if (options.has<GameServerDeploymentsServiceRetryPolicyOption>()) {
      return options.get<GameServerDeploymentsServiceRetryPolicyOption>()
          ->clone();
    }
  ...
  std::unique_ptr<BackoffPolicy> backoff_policy() {
    ...
    if (options.has<GameServerDeploymentsServiceBackoffPolicyOption>()) {
      return options.get<GameServerDeploymentsServiceBackoffPolicyOption>()
          ->clone();
    }
  ...
  std::unique_ptr<PollingPolicy> polling_policy() {
    ...
    if (options.has<GameServerDeploymentsServicePollingPolicyOption>()) {
      return options.get<GameServerDeploymentsServicePollingPolicyOption>()
          ->clone();
    }
  ...
  idempotency_policy() {
    ...
    if (options.has<
            GameServerDeploymentsServiceConnectionIdempotencyPolicyOption>()) {
      return options
          .get<GameServerDeploymentsServiceConnectionIdempotencyPolicyOption>()
          ->clone();
    }
  ...
  std::shared_ptr<gameservices_internal::GameServerDeploymentsServiceStub>
      stub_;
  std::unique_ptr<GameServerDeploymentsServiceRetryPolicy const>
      retry_policy_prototype_;
...
MakeGameServerDeploymentsServiceConnection(
  ...
  return std::make_shared<
      gameservices::GameServerDeploymentsServiceConnectionImpl>(
