...
class GameServerClustersServiceConnectionImpl
 ...
 public:
  ...
  ListGameServerClusters(google::cloud::gaming::v1::ListGameServerClustersRequest request) override;

  StatusOr<google::cloud::gaming::v1::GameServerCluster>
  GetGameServerCluster(google::cloud::gaming::v1::GetGameServerClusterRequest const& request) override;
  ...
  PreviewCreateGameServerCluster(google::cloud::gaming::v1::PreviewCreateGameServerClusterRequest const& request) override;
  ...
  PreviewDeleteGameServerCluster(google::cloud::gaming::v1::PreviewDeleteGameServerClusterRequest const& request) override;
  ...
  PreviewUpdateGameServerCluster(google::cloud::gaming::v1::PreviewUpdateGameServerClusterRequest const& request) override;

 private:
  std::unique_ptr<gameservices::GameServerClustersServiceRetryPolicy> retry_policy() {
    auto const& options = internal::CurrentOptions();
    if (options.has<gameservices::GameServerClustersServiceRetryPolicyOption>()) {
      return options.get<gameservices::GameServerClustersServiceRetryPolicyOption>()->clone();
    }
  ...
  std::unique_ptr<BackoffPolicy> backoff_policy() {
    ...
    if (options.has<gameservices::GameServerClustersServiceBackoffPolicyOption>()) {
      return options.get<gameservices::GameServerClustersServiceBackoffPolicyOption>()->clone();
    }
    return backoff_policy_prototype_->clone();
  }

  std::unique_ptr<gameservices::GameServerClustersServiceConnectionIdempotencyPolicy> idempotency_policy() {
    auto const& options = internal::CurrentOptions();
    if (options.has<gameservices::GameServerClustersServiceConnectionIdempotencyPolicyOption>()) {
      return options.get<gameservices::GameServerClustersServiceConnectionIdempotencyPolicyOption>()->clone();
    }
  ...
  std::unique_ptr<gameservices::GameServerClustersServiceRetryPolicy const> retry_policy_prototype_;
  std::unique_ptr<BackoffPolicy const> backoff_policy_prototype_;
  std::unique_ptr<gameservices::GameServerClustersServiceConnectionIdempotencyPolicy> idempotency_policy_;

  std::unique_ptr<PollingPolicy> polling_policy() {
    auto const& options = internal::CurrentOptions();
    if (options.has<gameservices::GameServerClustersServicePollingPolicyOption>()) {
      return options.get<gameservices::GameServerClustersServicePollingPolicyOption>()->clone();
    }
