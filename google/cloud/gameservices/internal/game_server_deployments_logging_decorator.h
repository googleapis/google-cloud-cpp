...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_GAMESERVICES_INTERNAL_GAME_SERVER_DEPLOYMENTS_LOGGING_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_GAMESERVICES_INTERNAL_GAME_SERVER_DEPLOYMENTS_LOGGING_DECORATOR_H
...
class GameServerDeploymentsServiceLogging : public GameServerDeploymentsServiceStub {
 public:
  ~GameServerDeploymentsServiceLogging() override = default;
  GameServerDeploymentsServiceLogging(std::shared_ptr<GameServerDeploymentsServiceStub> child,
...
};  // GameServerDeploymentsServiceLogging
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_GAMESERVICES_INTERNAL_GAME_SERVER_DEPLOYMENTS_LOGGING_DECORATOR_H
