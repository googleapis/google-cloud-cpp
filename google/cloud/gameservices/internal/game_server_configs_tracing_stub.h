...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_GAMESERVICES_INTERNAL_GAME_SERVER_CONFIGS_TRACING_STUB_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_GAMESERVICES_INTERNAL_GAME_SERVER_CONFIGS_TRACING_STUB_H
...
class GameServerConfigsServiceTracingStub
    : public GameServerConfigsServiceStub {
 public:
  ~GameServerConfigsServiceTracingStub() override = default;

  explicit GameServerConfigsServiceTracingStub(
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_GAMESERVICES_INTERNAL_GAME_SERVER_CONFIGS_TRACING_STUB_H
