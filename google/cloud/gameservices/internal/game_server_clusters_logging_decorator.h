...
class GameServerClustersServiceLogging : public GameServerClustersServiceStub {
 public:
  ...
  GameServerClustersServiceLogging(std::shared_ptr<GameServerClustersServiceStub> child,
                       TracingOptions tracing_options,
                       std::set<std::string> components);

  StatusOr<google::cloud::gaming::v1::ListGameServerClustersResponse> ListGameServerClusters(
  ...
  StatusOr<google::cloud::gaming::v1::PreviewCreateGameServerClusterResponse> PreviewCreateGameServerCluster(
    grpc::ClientContext& context,
  ...
  StatusOr<google::cloud::gaming::v1::PreviewDeleteGameServerClusterResponse> PreviewDeleteGameServerCluster(
    grpc::ClientContext& context,
  ...
  StatusOr<google::cloud::gaming::v1::PreviewUpdateGameServerClusterResponse> PreviewUpdateGameServerCluster(
    grpc::ClientContext& context,
