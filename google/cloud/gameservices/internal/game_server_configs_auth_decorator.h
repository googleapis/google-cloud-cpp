...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_GAMESERVICES_INTERNAL_GAME_SERVER_CONFIGS_AUTH_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_GAMESERVICES_INTERNAL_GAME_SERVER_CONFIGS_AUTH_DECORATOR_H
...
class GameServerConfigsServiceAuth : public GameServerConfigsServiceStub {
 public:
  ~GameServerConfigsServiceAuth() override = default;
  GameServerConfigsServiceAuth(
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_GAMESERVICES_INTERNAL_GAME_SERVER_CONFIGS_AUTH_DECORATOR_H
