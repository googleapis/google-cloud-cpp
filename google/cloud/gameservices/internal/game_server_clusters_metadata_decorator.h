...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_GAMESERVICES_INTERNAL_GAME_SERVER_CLUSTERS_METADATA_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_GAMESERVICES_INTERNAL_GAME_SERVER_CLUSTERS_METADATA_DECORATOR_H
...
class GameServerClustersServiceMetadata : public GameServerClustersServiceStub {
 public:
  ...
  explicit GameServerClustersServiceMetadata(std::shared_ptr<GameServerClustersServiceStub> child);
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_GAMESERVICES_INTERNAL_GAME_SERVER_CLUSTERS_METADATA_DECORATOR_H
