...
StatusOr<google::cloud::gaming::v1::ListGameServerDeploymentsResponse> GameServerDeploymentsServiceAuth::ListGameServerDeployments(
...
StatusOr<google::cloud::gaming::v1::GameServerDeployment> GameServerDeploymentsServiceAuth::GetGameServerDeployment(
    grpc::ClientContext& context,
...
GameServerDeploymentsServiceAuth::AsyncCreateGameServerDeployment(
  ...
  return auth_->AsyncConfigureContext(std::move(context)).then(
      [cq, child, request](
        ...
        return child->AsyncCreateGameServerDeployment(cq, *std::move(context), request);
      });
}
...
GameServerDeploymentsServiceAuth::AsyncDeleteGameServerDeployment(
  ...
  return auth_->AsyncConfigureContext(std::move(context)).then(
      [cq, child, request](
        ...
        return child->AsyncDeleteGameServerDeployment(cq, *std::move(context), request);
      });
}
...
GameServerDeploymentsServiceAuth::AsyncUpdateGameServerDeployment(
  ...
  return auth_->AsyncConfigureContext(std::move(context)).then(
      [cq, child, request](
        ...
        return child->AsyncUpdateGameServerDeployment(cq, *std::move(context), request);
      });
}

StatusOr<google::cloud::gaming::v1::GameServerDeploymentRollout> GameServerDeploymentsServiceAuth::GetGameServerDeploymentRollout(
    grpc::ClientContext& context,
...
GameServerDeploymentsServiceAuth::AsyncUpdateGameServerDeploymentRollout(
  ...
  return auth_->AsyncConfigureContext(std::move(context)).then(
      [cq, child, request](
        ...
        return child->AsyncUpdateGameServerDeploymentRollout(cq, *std::move(context), request);
      });
}

StatusOr<google::cloud::gaming::v1::PreviewGameServerDeploymentRolloutResponse> GameServerDeploymentsServiceAuth::PreviewGameServerDeploymentRollout(
    grpc::ClientContext& context,
...
StatusOr<google::cloud::gaming::v1::FetchDeploymentStateResponse> GameServerDeploymentsServiceAuth::FetchDeploymentState(
    grpc::ClientContext& context,
