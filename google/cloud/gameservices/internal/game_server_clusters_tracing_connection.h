...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_GAMESERVICES_INTERNAL_GAME_SERVER_CLUSTERS_TRACING_CONNECTION_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_GAMESERVICES_INTERNAL_GAME_SERVER_CLUSTERS_TRACING_CONNECTION_H
...
class GameServerClustersServiceTracingConnection
 ...
 public:
  ...
  explicit GameServerClustersServiceTracingConnection(
      std::shared_ptr<gameservices::GameServerClustersServiceConnection> child);
 ...
 private:
  std::shared_ptr<gameservices::GameServerClustersServiceConnection> child_;
};
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_GAMESERVICES_INTERNAL_GAME_SERVER_CLUSTERS_TRACING_CONNECTION_H
