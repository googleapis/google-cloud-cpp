...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_GAMESERVICES_INTERNAL_GAME_SERVER_DEPLOYMENTS_TRACING_CONNECTION_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_GAMESERVICES_INTERNAL_GAME_SERVER_DEPLOYMENTS_TRACING_CONNECTION_H
...
class GameServerDeploymentsServiceTracingConnection
 ...
 private:
  std::shared_ptr<gameservices::GameServerDeploymentsServiceConnection> child_;
};
...
MakeGameServerDeploymentsServiceTracingConnection(
    std::shared_ptr<gameservices::GameServerDeploymentsServiceConnection> conn);
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_GAMESERVICES_INTERNAL_GAME_SERVER_DEPLOYMENTS_TRACING_CONNECTION_H
