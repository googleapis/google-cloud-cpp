...
StatusOr<google::cloud::gaming::v1::ListGameServerClustersResponse> GameServerClustersServiceAuth::ListGameServerClusters(
...
StatusOr<google::cloud::gaming::v1::GameServerCluster> GameServerClustersServiceAuth::GetGameServerCluster(
    grpc::ClientContext& context,
...
GameServerClustersServiceAuth::AsyncCreateGameServerCluster(
  ...
  return auth_->AsyncConfigureContext(std::move(context)).then(
      [cq, child, request](
        ...
        return child->AsyncCreateGameServerCluster(cq, *std::move(context), request);
      });
}

StatusOr<google::cloud::gaming::v1::PreviewCreateGameServerClusterResponse> GameServerClustersServiceAuth::PreviewCreateGameServerCluster(
    grpc::ClientContext& context,
...
GameServerClustersServiceAuth::AsyncDeleteGameServerCluster(
  ...
  return auth_->AsyncConfigureContext(std::move(context)).then(
      [cq, child, request](
        ...
        return child->AsyncDeleteGameServerCluster(cq, *std::move(context), request);
      });
}

StatusOr<google::cloud::gaming::v1::PreviewDeleteGameServerClusterResponse> GameServerClustersServiceAuth::PreviewDeleteGameServerCluster(
    grpc::ClientContext& context,
...
GameServerClustersServiceAuth::AsyncUpdateGameServerCluster(
  ...
  return auth_->AsyncConfigureContext(std::move(context)).then(
      [cq, child, request](
        ...
        return child->AsyncUpdateGameServerCluster(cq, *std::move(context), request);
      });
}

StatusOr<google::cloud::gaming::v1::PreviewUpdateGameServerClusterResponse> GameServerClustersServiceAuth::PreviewUpdateGameServerCluster(
    grpc::ClientContext& context,
