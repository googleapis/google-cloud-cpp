...
#include "google/cloud/gameservices/v1/game_server_configs_client.h"
...
/// @deprecated Use gameservices_v1::GameServerConfigsServiceClient directly.
using ::google::cloud::gameservices_v1::GameServerConfigsServiceClient;
