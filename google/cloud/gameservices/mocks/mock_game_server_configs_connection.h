...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_GAMESERVICES_MOCKS_MOCK_GAME_SERVER_CONFIGS_CONNECTION_H
 ...
 * including errors from a `GameServerConfigsServiceClient`. To do so, construct
 * a `GameServerConfigsServiceClient` with an instance of this class. Then use
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_GAMESERVICES_MOCKS_MOCK_GAME_SERVER_CONFIGS_CONNECTION_H
