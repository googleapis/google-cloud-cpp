 ...
 * `GameServerDeploymentsServiceClient` object for use in their own tests.
 *
...
/**
 * A factory function to construct a `GameServerDeploymentsServiceConnection`
 * object.
 *
 * The returned connection object should not be used directly; instead it
 * should be given to a `GameServerDeploymentsServiceClient` instance, and
 * methods should be invoked on `GameServerDeploymentsServiceClient`.
 *
