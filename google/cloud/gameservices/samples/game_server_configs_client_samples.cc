...
// main-dox-marker: GOOGLE_CLOUD_CPP_NS::GameServerConfigsServiceClient
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client =
      google::cloud::GOOGLE_CLOUD_CPP_NS::GameServerConfigsServiceClient(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::GOOGLE_CLOUD_CPP_NS::GameServerConfigsServiceClient(
        google::cloud::GOOGLE_CLOUD_CPP_NS::
            MakeGameServerConfigsServiceConnection(options));
  }
  //! [with-service-account]
