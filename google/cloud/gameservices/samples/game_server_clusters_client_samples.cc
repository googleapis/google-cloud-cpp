...
// main-dox-marker: GOOGLE_CLOUD_CPP_NS::GameServerClustersServiceClient
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client =
      google::cloud::GOOGLE_CLOUD_CPP_NS::GameServerClustersServiceClient(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::GOOGLE_CLOUD_CPP_NS::GameServerClustersServiceClient(
        google::cloud::GOOGLE_CLOUD_CPP_NS::
            MakeGameServerClustersServiceConnection(options));
  }
  //! [with-service-account]
