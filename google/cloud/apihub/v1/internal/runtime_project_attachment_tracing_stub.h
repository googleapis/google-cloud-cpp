...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_APIHUB_V1_INTERNAL_RUNTIME_PROJECT_ATTACHMENT_TRACING_STUB_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_APIHUB_V1_INTERNAL_RUNTIME_PROJECT_ATTACHMENT_TRACING_STUB_H
...
class RuntimeProjectAttachmentServiceTracingStub
    : public RuntimeProjectAttachmentServiceStub {
 public:
  ~RuntimeProjectAttachmentServiceTracingStub() override = default;

  explicit RuntimeProjectAttachmentServiceTracingStub(
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_APIHUB_V1_INTERNAL_RUNTIME_PROJECT_ATTACHMENT_TRACING_STUB_H
