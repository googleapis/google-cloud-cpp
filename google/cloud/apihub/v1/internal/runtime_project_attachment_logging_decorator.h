...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_APIHUB_V1_INTERNAL_RUNTIME_PROJECT_ATTACHMENT_LOGGING_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_APIHUB_V1_INTERNAL_RUNTIME_PROJECT_ATTACHMENT_LOGGING_DECORATOR_H
...
class RuntimeProjectAttachmentServiceLogging
    : public RuntimeProjectAttachmentServiceStub {
 public:
  ~RuntimeProjectAttachmentServiceLogging() override = default;
  RuntimeProjectAttachmentServiceLogging(
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_APIHUB_V1_INTERNAL_RUNTIME_PROJECT_ATTACHMENT_LOGGING_DECORATOR_H
