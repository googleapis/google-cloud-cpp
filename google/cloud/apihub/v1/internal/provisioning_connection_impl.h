...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_APIHUB_V1_INTERNAL_PROVISIONING_CONNECTION_IMPL_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_APIHUB_V1_INTERNAL_PROVISIONING_CONNECTION_IMPL_H
...
class ProvisioningConnectionImpl : public apihub_v1::ProvisioningConnection {
 public:
  ~ProvisioningConnectionImpl() override = default;

  ProvisioningConnectionImpl(
      std::unique_ptr<google::cloud::BackgroundThreads> background,
      std::shared_ptr<apihub_v1_internal::ProvisioningStub> stub,
      Options options);
 ...
 private:
  ...
  std::shared_ptr<apihub_v1_internal::ProvisioningStub> stub_;
  Options options_;
};
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_APIHUB_V1_INTERNAL_PROVISIONING_CONNECTION_IMPL_H
