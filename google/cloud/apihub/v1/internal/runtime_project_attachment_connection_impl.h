...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_APIHUB_V1_INTERNAL_RUNTIME_PROJECT_ATTACHMENT_CONNECTION_IMPL_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_APIHUB_V1_INTERNAL_RUNTIME_PROJECT_ATTACHMENT_CONNECTION_IMPL_H
...
class RuntimeProjectAttachmentServiceConnectionImpl
    : public apihub_v1::RuntimeProjectAttachmentServiceConnection {
 public:
  ~RuntimeProjectAttachmentServiceConnectionImpl() override = default;
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_APIHUB_V1_INTERNAL_RUNTIME_PROJECT_ATTACHMENT_CONNECTION_IMPL_H
