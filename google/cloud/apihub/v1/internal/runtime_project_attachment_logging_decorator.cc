...
#include "google/cloud/apihub/v1/internal/runtime_project_attachment_logging_decorator.h"
...
RuntimeProjectAttachmentServiceLogging::RuntimeProjectAttachmentServiceLogging(
...
RuntimeProjectAttachmentServiceLogging::CreateRuntimeProjectAttachment(
  ...
  return google::cloud::internal::LogWrapper(
      [this](grpc::ClientContext& context, Options const& options,
        ...
        return child_->CreateRuntimeProjectAttachment(context, options,
                                                      request);
      },
...
StatusOr<google::cloud::apihub::v1::RuntimeProjectAttachment>
RuntimeProjectAttachmentServiceLogging::GetRuntimeProjectAttachment(
    grpc::ClientContext& context, Options const& options,
...
RuntimeProjectAttachmentServiceLogging::ListRuntimeProjectAttachments(
    grpc::ClientContext& context, Options const& options,
...
Status RuntimeProjectAttachmentServiceLogging::DeleteRuntimeProjectAttachment(
    grpc::ClientContext& context, Options const& options,
  ...
  return google::cloud::internal::LogWrapper(
      [this](grpc::ClientContext& context, Options const& options,
        ...
        return child_->DeleteRuntimeProjectAttachment(context, options,
                                                      request);
      },
      context, options, request, __func__, tracing_options_);
}
...
RuntimeProjectAttachmentServiceLogging::LookupRuntimeProjectAttachment(
    grpc::ClientContext& context, Options const& options,
  ...
  return google::cloud::internal::LogWrapper(
      [this](grpc::ClientContext& context, Options const& options,
        ...
        return child_->LookupRuntimeProjectAttachment(context, options,
                                                      request);
      },
      context, options, request, __func__, tracing_options_);
}
