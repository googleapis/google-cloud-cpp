...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_APIHUB_V1_INTERNAL_API_HUB_DEPENDENCIES_LOGGING_DECORATOR_H
...
class ApiHubDependenciesLogging : public ApiHubDependenciesStub {
 public:
  ~ApiHubDependenciesLogging() override = default;
  ApiHubDependenciesLogging(std::shared_ptr<ApiHubDependenciesStub> child,
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_APIHUB_V1_INTERNAL_API_HUB_DEPENDENCIES_LOGGING_DECORATOR_H
