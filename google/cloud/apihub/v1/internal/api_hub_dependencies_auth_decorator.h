...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_APIHUB_V1_INTERNAL_API_HUB_DEPENDENCIES_AUTH_DECORATOR_H
...
class ApiHubDependenciesAuth : public ApiHubDependenciesStub {
 public:
  ~ApiHubDependenciesAuth() override = default;
  ApiHubDependenciesAuth(
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_APIHUB_V1_INTERNAL_API_HUB_DEPENDENCIES_AUTH_DECORATOR_H
