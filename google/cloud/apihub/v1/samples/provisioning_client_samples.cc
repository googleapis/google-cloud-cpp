...
// clang-format off
// main-dox-marker: apihub_v1::ProvisioningClient
// lro-marker: true
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::apihub_v1::ProvisioningClient(
      google::cloud::apihub_v1::MakeProvisioningConnection(options));
  //! [set-client-endpoint]
}

//! [custom-idempotency-policy]
class CustomIdempotencyPolicy
    : public google::cloud::apihub_v1::ProvisioningConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<
      google::cloud::apihub_v1::ProvisioningConnectionIdempotencyPolicy>
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options =
      google::cloud::Options{}
          ...
          .set<google::cloud::apihub_v1::ProvisioningRetryPolicyOption>(
              google::cloud::apihub_v1::
                  ProvisioningLimitedErrorCountRetryPolicy(3)
                      .clone())
          .set<google::cloud::apihub_v1::ProvisioningBackoffPolicyOption>(
  ...
  auto c1 = google::cloud::apihub_v1::ProvisioningClient(connection);
  auto c2 = google::cloud::apihub_v1::ProvisioningClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::apihub_v1::ProvisioningClient(
      connection,
      google::cloud::Options{}
          .set<google::cloud::apihub_v1::ProvisioningRetryPolicyOption>(
              google::cloud::apihub_v1::ProvisioningLimitedTimeRetryPolicy(
  ...
  //     .set<google::cloud::apihub_v1::ProvisioningRetryPolicyOption>(
  //       google::cloud::apihub_v1::ProvisioningLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options =
      google::cloud::Options{}
          .set<google::cloud::apihub_v1::ProvisioningPollingPolicyOption>(
              google::cloud::GenericPollingPolicy<
                  google::cloud::apihub_v1::ProvisioningRetryPolicyOption::Type,
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::apihub_v1::ProvisioningClient(
        google::cloud::apihub_v1::MakeProvisioningConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
