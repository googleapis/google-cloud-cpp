...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_APIHUB_V1_MOCKS_MOCK_RUNTIME_PROJECT_ATTACHMENT_CONNECTION_H
...
/**
 * A class to mock `RuntimeProjectAttachmentServiceConnection`.
 *
 * Application developers may want to test their code with simulated responses,
 * including errors, from an object of type
 * `RuntimeProjectAttachmentServiceClient`. To do so, construct an object of
 * type `RuntimeProjectAttachmentServiceClient` with an instance of this class.
 ...
 */
class MockRuntimeProjectAttachmentServiceConnection
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_APIHUB_V1_MOCKS_MOCK_RUNTIME_PROJECT_ATTACHMENT_CONNECTION_H
