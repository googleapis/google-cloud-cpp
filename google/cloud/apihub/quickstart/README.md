# HOWTO: using the API hub API C++ client in your project

This directory contains small examples showing how to use the API hub API C++
...
Like most Google Cloud Platform (GCP) services, API hub API requires that your
...
1. Compile this example using Bazel:
   ...
   ```bash
   cd $HOME/google-cloud-cpp/google/cloud/apihub/quickstart
   bazel build ...
   ```
...
1. Install the dependencies with your favorite tools. As an example, if you use
   ...
   ```bash
   cd $HOME/vcpkg
   ./vcpkg install google-cloud-cpp[core,apihub]
   ```
...
[quickstart-link]: https://cloud.google.com/apigee/docs/apihub/quickstart-intro
