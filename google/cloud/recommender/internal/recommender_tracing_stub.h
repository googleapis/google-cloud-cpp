...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_RECOMMENDER_INTERNAL_RECOMMENDER_TRACING_STUB_H
...
class RecommenderTracingStub : public RecommenderStub {
 public:
  ...
  explicit RecommenderTracingStub(std::shared_ptr<RecommenderStub> child);
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_RECOMMENDER_INTERNAL_RECOMMENDER_TRACING_STUB_H
