...
RecommenderConnectionImpl::RecommenderConnectionImpl(
  ...
  : background_(std::move(background)), stub_(std::move(stub)),
    retry_policy_prototype_(options.get<recommender::RecommenderRetryPolicyOption>()->clone()),
    backoff_policy_prototype_(options.get<recommender::RecommenderBackoffPolicyOption>()->clone()),
    idempotency_policy_(options.get<recommender::RecommenderConnectionIdempotencyPolicyOption>()->clone()) {}
...
RecommenderConnectionImpl::ListInsights(google::cloud::recommender::v1::ListInsightsRequest request) {
  ...
  auto stub = stub_;
  auto retry = std::shared_ptr<recommender::RecommenderRetryPolicy const>(retry_policy());
  ...
  return google::cloud::internal::MakePaginationRange<StreamRange<google::cloud::recommender::v1::Insight>>(
      ...
      [stub, retry, backoff, idempotency, function_name]
        ...
        return google::cloud::internal::RetryLoop(
            ...
            [stub](grpc::ClientContext& context, google::cloud::recommender::v1::ListInsightsRequest const& request) {
...
RecommenderConnectionImpl::ListRecommendations(google::cloud::recommender::v1::ListRecommendationsRequest request) {
  ...
  return google::cloud::internal::MakePaginationRange<StreamRange<google::cloud::recommender::v1::Recommendation>>(
      ...
      [stub, retry, backoff, idempotency, function_name]
        ...
        return google::cloud::internal::RetryLoop(
            retry->clone(), backoff->clone(), idempotency,
            [stub](grpc::ClientContext& context, google::cloud::recommender::v1::ListRecommendationsRequest const& request) {
