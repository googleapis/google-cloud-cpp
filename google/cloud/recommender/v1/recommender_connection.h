...
/**
 * A retry policy for `RecommenderConnection` that stops retrying after a
 ...
 */
class RecommenderLimitedErrorCountRetryPolicy : public RecommenderRetryPolicy {
 public:
  RecommenderLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `RecommenderConnection` that stops retrying after
/// some wall clock time has elapsed.
class RecommenderLimitedTimeRetryPolicy : public RecommenderRetryPolicy {
 public:
  /**
