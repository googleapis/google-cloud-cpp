...
StreamRange<google::cloud::recommender::v1::Insight> RecommenderConnection::ListInsights(
    google::cloud::recommender::v1::ListInsightsRequest) {  // NOLINT(performance-unnecessary-value-param)
...
StreamRange<google::cloud::recommender::v1::Recommendation> RecommenderConnection::ListRecommendations(
    google::cloud::recommender::v1::ListRecommendationsRequest) {  // NOLINT(performance-unnecessary-value-param)
  return google::cloud::internal::MakeUnimplementedPaginationRange<
...
std::shared_ptr<RecommenderConnection> MakeRecommenderConnection(
  ...
  internal::CheckExpectedOptions<CommonOptionList, GrpcOptionList,
      ...
      RecommenderPolicyOptionList>(options, __func__);
  options = recommender_v1_internal::RecommenderDefaultOptions(
      std::move(options));
