...
Options RecommenderDefaultOptions(Options options) {
  options = internal::PopulateCommonOptions(
      ...
      "", "GOOGLE_CLOUD_CPP_RECOMMENDER_AUTHORITY",
  ...
  if (!options.has<recommender_v1::RecommenderConnectionIdempotencyPolicyOption>()) {
    options.set<recommender_v1::RecommenderConnectionIdempotencyPolicyOption>(
        recommender_v1::MakeDefaultRecommenderConnectionIdempotencyPolicy());
  }
