...
std::shared_ptr<RecommenderStub> CreateDefaultRecommenderStub(
  ...
  auto endpoint = internal::DetermineServiceEndpoint(
      internal::GetEnv("GOOGLE_CLOUD_CPP_RECOMMENDER_ENDPOINT"),
      std::move(endpoint_option), "recommender.googleapis.com", options);
  ...
  if (!endpoint.ok()) {
    ...
    auto service_grpc_stub =
        google::cloud::recommender::v1::Recommender::NewStub(channel);
    stub =
