...
ConsumerProcurementServiceConnection::~ConsumerProcurementServiceConnection() = default;
...
StreamRange<google::cloud::commerce::consumer::procurement::v1::Order> ConsumerProcurementServiceConnection::ListOrders(
    google::cloud::commerce::consumer::procurement::v1::ListOrdersRequest) {  // NOLINT(performance-unnecessary-value-param)
...
std::shared_ptr<ConsumerProcurementServiceConnection> MakeConsumerProcurementServiceConnection(
  ...
  internal::CheckExpectedOptions<CommonOptionList, GrpcOptionList,
      ...
      ConsumerProcurementServicePolicyOptionList>(options, __func__);
  options = commerce_consumer_procurement_v1_internal::ConsumerProcurementServiceDefaultOptions(
      std::move(options));
  auto background = internal::MakeBackgroundThreadsFactory(options)();
  auto auth = internal::CreateAuthenticationStrategy(background->cq(), options);
  auto stub = commerce_consumer_procurement_v1_internal::CreateDefaultConsumerProcurementServiceStub(
    std::move(auth), options);
  return commerce_consumer_procurement_v1_internal::MakeConsumerProcurementServiceTracingConnection(
      std::make_shared<commerce_consumer_procurement_v1_internal::ConsumerProcurementServiceConnectionImpl>(
