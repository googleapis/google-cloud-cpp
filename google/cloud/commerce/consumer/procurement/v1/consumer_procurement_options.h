...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_COMMERCE_CONSUMER_PROCUREMENT_V1_CONSUMER_PROCUREMENT_OPTIONS_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_COMMERCE_CONSUMER_PROCUREMENT_V1_CONSUMER_PROCUREMENT_OPTIONS_H
 ...
 * @ingroup google-cloud-commerce-options
 */
struct ConsumerProcurementServiceBackoffPolicyOption {
 ...
 * @ingroup google-cloud-commerce-options
 */
struct ConsumerProcurementServiceConnectionIdempotencyPolicyOption {
  using Type = std::shared_ptr<ConsumerProcurementServiceConnectionIdempotencyPolicy>;
};
 ...
 * @ingroup google-cloud-commerce-options
 */
struct ConsumerProcurementServicePollingPolicyOption {
 ...
 * @ingroup google-cloud-commerce-options
 */
using ConsumerProcurementServicePolicyOptionList =
    OptionList<ConsumerProcurementServiceRetryPolicyOption,
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_COMMERCE_CONSUMER_PROCUREMENT_V1_CONSUMER_PROCUREMENT_OPTIONS_H
