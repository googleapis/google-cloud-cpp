...
ConsumerProcurementServiceMetadata::AsyncModifyOrder(
  ...
  SetMetadata(*context, *options, absl::StrCat("name=", internal::UrlEncode(request.name())));
  return child_->AsyncModifyOrder(
      cq, std::move(context), std::move(options), request);
}
...
ConsumerProcurementServiceMetadata::AsyncCancelOrder(
  ...
  SetMetadata(*context, *options, absl::StrCat("name=", internal::UrlEncode(request.name())));
  return child_->AsyncCancelOrder(
      cq, std::move(context), std::move(options), request);
}
...
void ConsumerProcurementServiceMetadata::SetMetadata(grpc::ClientContext& context,
                                        Options const& options,
