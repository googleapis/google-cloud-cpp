...
DefaultConsumerProcurementServiceStub::AsyncPlaceOrder(
  ...
  return internal::MakeUnaryRpcImpl<google::cloud::commerce::consumer::procurement::v1::PlaceOrderRequest,
...
DefaultConsumerProcurementServiceStub::PlaceOrder(
    ...
    auto status =
        grpc_stub_->PlaceOrder(&context, request, &response);
    if (!status.ok()) {
...
DefaultConsumerProcurementServiceStub::GetOrder(
  ...
  google::cloud::commerce::consumer::procurement::v1::GetOrderRequest const& request) {
    ...
    auto status =
        grpc_stub_->GetOrder(&context, request, &response);
    if (!status.ok()) {
      return google::cloud::MakeStatusFromRpcError(status);
    }
    return response;
...
DefaultConsumerProcurementServiceStub::ListOrders(
  ...
  google::cloud::commerce::consumer::procurement::v1::ListOrdersRequest const& request) {
    google::cloud::commerce::consumer::procurement::v1::ListOrdersResponse response;
    auto status =
        grpc_stub_->ListOrders(&context, request, &response);
    if (!status.ok()) {
      return google::cloud::MakeStatusFromRpcError(status);
    }
    return response;
...
DefaultConsumerProcurementServiceStub::AsyncModifyOrder(
  ...
  return internal::MakeUnaryRpcImpl<google::cloud::commerce::consumer::procurement::v1::ModifyOrderRequest,
                                    google::longrunning::Operation>(
      cq,
      [this](grpc::ClientContext* context,
             google::cloud::commerce::consumer::procurement::v1::ModifyOrderRequest const& request,
...
DefaultConsumerProcurementServiceStub::ModifyOrder(
    ...
    google::longrunning::Operation response;
    auto status =
        grpc_stub_->ModifyOrder(&context, request, &response);
    if (!status.ok()) {
      return google::cloud::MakeStatusFromRpcError(status);
    }
    return response;
...
DefaultConsumerProcurementServiceStub::AsyncCancelOrder(
  ...
  return internal::MakeUnaryRpcImpl<google::cloud::commerce::consumer::procurement::v1::CancelOrderRequest,
                                    google::longrunning::Operation>(
      cq,
      [this](grpc::ClientContext* context,
             google::cloud::commerce::consumer::procurement::v1::CancelOrderRequest const& request,
...
DefaultConsumerProcurementServiceStub::CancelOrder(
    ...
    google::longrunning::Operation response;
    auto status =
        grpc_stub_->CancelOrder(&context, request, &response);
    if (!status.ok()) {
      return google::cloud::MakeStatusFromRpcError(status);
    }
    return response;
