...
StatusOr<google::cloud::commerce::consumer::procurement::v1::Order> ConsumerProcurementServiceAuth::GetOrder(
    grpc::ClientContext& context,
...
StatusOr<google::cloud::commerce::consumer::procurement::v1::ListOrdersResponse> ConsumerProcurementServiceAuth::ListOrders(
    grpc::ClientContext& context,
    Options const& options,
...
StatusOr<google::longrunning::Operation> ConsumerProcurementServiceAuth::GetOperation(
    grpc::ClientContext& context,
    Options const& options,
