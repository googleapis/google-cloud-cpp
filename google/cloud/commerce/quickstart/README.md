...
This directory contains small examples showing how to use the Cloud Commerce Consumer Procurement API C++
...
Like most Google Cloud Platform (GCP) services, Cloud Commerce Consumer Procurement API requires that
