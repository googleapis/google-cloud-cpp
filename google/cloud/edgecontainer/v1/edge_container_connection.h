...
/**
 * A retry policy for `EdgeContainerConnection` that stops retrying after a
...
class EdgeContainerLimitedErrorCountRetryPolicy
 ...
 public:
  EdgeContainerLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `EdgeContainerConnection` that stops retrying after
