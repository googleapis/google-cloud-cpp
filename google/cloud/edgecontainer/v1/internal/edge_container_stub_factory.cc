...
std::shared_ptr<EdgeContainerStub> CreateDefaultEdgeContainerStub(
  ...
  auto endpoint = internal::DetermineServiceEndpoint(
      internal::GetEnv("GOOGLE_CLOUD_CPP_EDGE_CONTAINER_ENDPOINT"),
      std::move(endpoint_option), "edgecontainer.googleapis.com", options);
  ...
  if (!endpoint.ok()) {
    ...
    stub = std::make_shared<DefaultEdgeContainerStub>(
