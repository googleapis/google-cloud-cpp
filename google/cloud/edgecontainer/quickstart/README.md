# HOWTO: using the Distributed Cloud Edge Container API C++ client in your project

This directory contains small examples showing how to use the Distributed Cloud
Edge Container API C++ client library in your own project. These instructions
...
Like most Google Cloud Platform (GCP) services, Distributed Cloud Edge Container
...
1. Install the dependencies with your favorite tools. As an example, if you use
   ...
   ```bash
   cd $HOME/vcpkg
   ./vcpkg install google-cloud-cpp[core,edgecontainer]
   ```
