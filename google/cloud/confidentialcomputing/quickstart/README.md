...
This directory contains small examples showing how to use the Confidential
Computing API C++ client library in your own project. These instructions assume
