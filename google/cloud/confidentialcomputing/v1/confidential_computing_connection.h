...
using ConfidentialComputingRetryPolicy =
    ::google::cloud::internal::TraitBasedRetryPolicy<
        confidentialcomputing_v1_internal::ConfidentialComputingRetryTraits>;

using ConfidentialComputingLimitedTimeRetryPolicy =
    ::google::cloud::internal::LimitedTimeRetryPolicy<
        confidentialcomputing_v1_internal::ConfidentialComputingRetryTraits>;

using ConfidentialComputingLimitedErrorCountRetryPolicy =
...
class ConfidentialComputingConnection {
 public:
  virtual ~ConfidentialComputingConnection() = 0;
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_CONFIDENTIALCOMPUTING_V1_CONFIDENTIAL_COMPUTING_CONNECTION_H
