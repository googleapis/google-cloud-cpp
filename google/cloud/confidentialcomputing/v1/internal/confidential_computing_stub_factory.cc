...
CreateDefaultConfidentialComputingStub(google::cloud::CompletionQueue cq,
  ...
  auto endpoint = internal::DetermineServiceEndpoint(
      internal::GetEnv("GOOGLE_CLOUD_CPP_CONFIDENTIAL_COMPUTING_ENDPOINT"),
      std::move(endpoint_option), "confidentialcomputing.googleapis.com",
      options);
  ...
  if (!endpoint.ok()) {
    ...
    auto service_grpc_stub = google::cloud::confidentialcomputing::v1::
        ConfidentialComputing::NewStub(channel);
    stub = std::make_shared<DefaultConfidentialComputingStub>(
  ...
  if (internal::TracingEnabled(options)) {
    stub = MakeConfidentialComputingTracingStub(std::move(stub));
  }
  return stub;
}
