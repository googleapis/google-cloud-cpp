# HOWTO: using the Developer Connect API C++ client in your project

This directory contains small examples showing how to use the Developer Connect
...
1. Compile this example using Bazel:
   ...
   ```bash
   cd $HOME/google-cloud-cpp/google/cloud/developerconnect/quickstart
   bazel build ...
   ```
...
1. Install the dependencies with your favorite tools. As an example, if you use
   ...
   ```bash
   cd $HOME/vcpkg
   ./vcpkg install google-cloud-cpp[core,developerconnect]
   ```
