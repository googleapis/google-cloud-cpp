...
/**
 * A retry policy for `DeveloperConnectConnection` based on elapsed time.
 *
 * This policy stops retrying if:
 * - An RPC returns a non-transient error.
...
/**
 * The `DeveloperConnectConnection` object for `DeveloperConnectClient`.
 *
 * This interface defines virtual methods for each of the user-facing overload
 * sets in `DeveloperConnectClient`. This allows users to inject custom behavior
...
class DeveloperConnectConnection {
 public:
  virtual ~DeveloperConnectConnection() = 0;
 ...
 * - `google::cloud::developerconnect_v1::DeveloperConnectPolicyOptionList`
 *
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DEVELOPERCONNECT_V1_DEVELOPER_CONNECT_CONNECTION_H
