...
StatusOr<google::cloud::developerconnect::v1::ListAccountConnectorsResponse> DeveloperConnectAuth::ListAccountConnectors(
    grpc::ClientContext& context,
    Options const& options,
...
StatusOr<google::cloud::developerconnect::v1::AccountConnector> DeveloperConnectAuth::GetAccountConnector(
    grpc::ClientContext& context,
    Options const& options,
...
DeveloperConnectAuth::AsyncCreateAccountConnector(
  ...
  return auth_->AsyncConfigureContext(std::move(context)).then(
      [cq, child = child_, options = std::move(options), request](
        ...
        return child->AsyncCreateAccountConnector(
            cq, *std::move(context), std::move(options), request);
      });
}
...
DeveloperConnectAuth::AsyncUpdateAccountConnector(
  ...
  return auth_->AsyncConfigureContext(std::move(context)).then(
      [cq, child = child_, options = std::move(options), request](
        ...
        return child->AsyncUpdateAccountConnector(
            cq, *std::move(context), std::move(options), request);
      });
}
...
DeveloperConnectAuth::AsyncDeleteAccountConnector(
  ...
  return auth_->AsyncConfigureContext(std::move(context)).then(
      [cq, child = child_, options = std::move(options), request](
        ...
        return child->AsyncDeleteAccountConnector(
            cq, *std::move(context), std::move(options), request);
      });
}
...
StatusOr<google::cloud::developerconnect::v1::FetchAccessTokenResponse> DeveloperConnectAuth::FetchAccessToken(
    grpc::ClientContext& context,
    Options const& options,
...
StatusOr<google::cloud::developerconnect::v1::ListUsersResponse> DeveloperConnectAuth::ListUsers(
    grpc::ClientContext& context,
    Options const& options,
...
DeveloperConnectAuth::AsyncDeleteUser(
  ...
  return auth_->AsyncConfigureContext(std::move(context)).then(
      [cq, child = child_, options = std::move(options), request](
        ...
        return child->AsyncDeleteUser(
            cq, *std::move(context), std::move(options), request);
      });
}

StatusOr<google::longrunning::Operation>
DeveloperConnectAuth::DeleteUser(
      grpc::ClientContext& context,
      Options options,
      google::cloud::developerconnect::v1::DeleteUserRequest const& request) {
  auto status = auth_->ConfigureContext(context);
...
StatusOr<google::cloud::developerconnect::v1::User> DeveloperConnectAuth::FetchSelf(
    grpc::ClientContext& context,
    Options const& options,
...
DeveloperConnectAuth::AsyncDeleteSelf(
  ...
  return auth_->AsyncConfigureContext(std::move(context)).then(
      [cq, child = child_, options = std::move(options), request](
        ...
        return child->AsyncDeleteSelf(
            cq, *std::move(context), std::move(options), request);
      });
}

StatusOr<google::longrunning::Operation>
DeveloperConnectAuth::DeleteSelf(
      grpc::ClientContext& context,
      Options options,
      google::cloud::developerconnect::v1::DeleteSelfRequest const& request) {
  auto status = auth_->ConfigureContext(context);
