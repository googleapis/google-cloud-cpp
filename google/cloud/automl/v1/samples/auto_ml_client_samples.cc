...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::automl_v1::AutoMlClient(
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::automl_v1::AutoMlClient(
      google::cloud::automl_v1::MakeAutoMlConnection(ud_options));
