...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::automl_v1::PredictionServiceClient(
      google::cloud::automl_v1::MakePredictionServiceConnection(ud_options));
...
class CustomIdempotencyPolicy
    : public google::cloud::automl_v1::
          PredictionServiceConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<
      google::cloud::automl_v1::PredictionServiceConnectionIdempotencyPolicy>
      ...
      google::cloud::Options{}
          .set<google::cloud::automl_v1::PredictionServicePollingPolicyOption>(
              google::cloud::GenericPollingPolicy<
                  google::cloud::automl_v1::PredictionServiceRetryPolicyOption::
                      Type,
                  google::cloud::automl_v1::
                      PredictionServiceBackoffPolicyOption::Type>(
                  google::cloud::automl_v1::
