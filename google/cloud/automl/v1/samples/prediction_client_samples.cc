...
// clang-format off
// main-dox-marker: automl_v1::PredictionServiceClient
// lro-marker: true
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::automl_v1::PredictionServiceClient(
...
class CustomIdempotencyPolicy
   : public google::cloud::automl_v1::PredictionServiceConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::automl_v1::PredictionServiceConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::automl_v1::PredictionServiceConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::automl_v1::PredictionServiceRetryPolicyOption>(
      google::cloud::automl_v1::PredictionServiceLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::automl_v1::PredictionServiceBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::automl_v1::MakePredictionServiceConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::automl_v1::PredictionServiceClient(connection);
  auto c2 = google::cloud::automl_v1::PredictionServiceClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::automl_v1::PredictionServiceClient(
    connection, google::cloud::Options{}.set<google::cloud::automl_v1::PredictionServiceRetryPolicyOption>(
      google::cloud::automl_v1::PredictionServiceLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::automl_v1::PredictionServiceRetryPolicyOption>(
  //       google::cloud::automl_v1::PredictionServiceLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::automl_v1::PredictionServicePollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::automl_v1::PredictionServiceRetryPolicyOption::Type,
            google::cloud::automl_v1::PredictionServiceBackoffPolicyOption::Type>(
            google::cloud::automl_v1::PredictionServiceLimitedTimeRetryPolicy(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::automl_v1::PredictionServiceClient(
      google::cloud::automl_v1::MakePredictionServiceConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
