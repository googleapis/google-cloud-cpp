...
#include "google/cloud/automl/v1/internal/prediction_stub_factory.h"
...
std::shared_ptr<PredictionServiceStub> CreateDefaultPredictionServiceStub(
    google::cloud::CompletionQueue cq, Options& options) {
  auto endpoint = internal::DetermineServiceEndpoint(
      internal::GetEnv("GOOGLE_CLOUD_CPP_AUTOML_PREDICTION_SERVICE_ENDPOINT"),
      internal::FetchOption<EndpointOption>(options), "automl.googleapis.com",
      options);
  ...
  if (!endpoint.ok()) {
    ...
    auto service_grpc_stub =
        google::cloud::automl::v1::PredictionService::NewStub(channel);
    stub = std::make_shared<DefaultPredictionServiceStub>(
