...
std::shared_ptr<AutoMlStub> CreateDefaultAutoMlStub(
  ...
  auto endpoint = internal::DetermineServiceEndpoint(
      internal::GetEnv("GOOGLE_CLOUD_CPP_AUTO_ML_ENDPOINT"),
  ...
  if (!endpoint.ok()) {
    ...
    auto service_grpc_stub =
        google::cloud::automl::v1::AutoMl::NewStub(channel);
    stub = std::make_shared<DefaultAutoMlStub>(
  ...
  if (internal::TracingEnabled(options)) {
    stub = MakeAutoMlTracingStub(std::move(stub));
  }
  return stub;
}
