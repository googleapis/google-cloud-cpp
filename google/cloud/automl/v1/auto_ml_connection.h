...
/**
 * A retry policy for `AutoMlConnection` that stops retrying after a
...
class AutoMlLimitedErrorCountRetryPolicy : public AutoMlRetryPolicy {
 public:
  AutoMlLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `AutoMlConnection` that stops retrying after
