...
inline std::unique_ptr<automl::PredictionServiceRetryPolicy> retry_policy() {
  return internal::CurrentOptions()
      .get<automl::PredictionServiceRetryPolicyOption>()
      ->clone();
}

inline std::unique_ptr<BackoffPolicy> backoff_policy() {
  return internal::CurrentOptions()
      .get<automl::PredictionServiceBackoffPolicyOption>()
      ->clone();
}

inline std::unique_ptr<automl::PredictionServiceConnectionIdempotencyPolicy>
idempotency_policy() {
  return internal::CurrentOptions()
...
inline std::unique_ptr<PollingPolicy> polling_policy() {
  return internal::CurrentOptions()
      .get<automl::PredictionServicePollingPolicyOption>()
      ->clone();
}
