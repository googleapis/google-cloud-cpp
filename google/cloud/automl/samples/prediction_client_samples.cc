...
// main-dox-marker: GOOGLE_CLOUD_CPP_NS::PredictionServiceClient
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::GOOGLE_CLOUD_CPP_NS::PredictionServiceClient(
      google::cloud::GOOGLE_CLOUD_CPP_NS::MakePredictionServiceConnection(
          options));
  //! [set-client-endpoint]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::GOOGLE_CLOUD_CPP_NS::PredictionServiceClient(
        google::cloud::GOOGLE_CLOUD_CPP_NS::MakePredictionServiceConnection(
            options));
  }
  //! [with-service-account]
