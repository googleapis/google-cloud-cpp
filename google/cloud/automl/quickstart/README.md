# HOWTO: using the Cloud AutoML API C++ client in your project

This directory contains small examples showing how to use the Cloud AutoML API C++
...
2. Install the dependencies with your favorite tools. As an example, if you use
   ...
   ```bash
   cd $HOME/vcpkg
   ./vcpkg install google-cloud-cpp[core,automl]
   ```
...
3. Configure CMake, if necessary, configure the directory where you installed
   ...
   ```bash
   cd $HOME/gooogle-cloud-cpp/google/cloud/automl/quickstart
...
[quickstart-link]: https://cloud.google.com/automl/docs/quickstart
