...
// main-dox-marker: GOOGLE_CLOUD_CPP_NS::ContainerAnalysisClient
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::GOOGLE_CLOUD_CPP_NS::ContainerAnalysisClient(
      google::cloud::GOOGLE_CLOUD_CPP_NS::MakeContainerAnalysisConnection(
          options));
  //! [set-client-endpoint]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::GOOGLE_CLOUD_CPP_NS::ContainerAnalysisClient(
        google::cloud::GOOGLE_CLOUD_CPP_NS::MakeContainerAnalysisConnection(
            options));
  }
  //! [with-service-account]
