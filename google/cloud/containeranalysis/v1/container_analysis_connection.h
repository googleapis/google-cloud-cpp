...
/**
 * A retry policy for `ContainerAnalysisConnection` that stops retrying after a
...
class ContainerAnalysisLimitedErrorCountRetryPolicy
 ...
 public:
  ContainerAnalysisLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `ContainerAnalysisConnection` that stops retrying after
