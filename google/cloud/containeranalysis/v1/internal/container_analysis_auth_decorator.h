...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_CONTAINERANALYSIS_V1_INTERNAL_CONTAINER_ANALYSIS_AUTH_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_CONTAINERANALYSIS_V1_INTERNAL_CONTAINER_ANALYSIS_AUTH_DECORATOR_H
...
class ContainerAnalysisAuth : public ContainerAnalysisStub {
 public:
  ~ContainerAnalysisAuth() override = default;
  ContainerAnalysisAuth(
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_CONTAINERANALYSIS_V1_INTERNAL_CONTAINER_ANALYSIS_AUTH_DECORATOR_H
