...
DefaultGrafeasStub::ListOccurrences(
  ...
  grafeas::v1::ListOccurrencesRequest const& request) {
    ...
    auto status =
        grpc_stub_->ListOccurrences(&context, request, &response);
    if (!status.ok()) {
      return google::cloud::MakeStatusFromRpcError(status);
    }
    return response;
...
Status
DefaultGrafeasStub::DeleteOccurrence(
  grpc::ClientContext& context, Options const&,
  grafeas::v1::DeleteOccurrenceRequest const& request) {
    google::protobuf::Empty response;
    auto status =
        grpc_stub_->DeleteOccurrence(&context, request, &response);
    if (!status.ok()) {
      return google::cloud::MakeStatusFromRpcError(status);
    }
...
StatusOr<grafeas::v1::Occurrence>
DefaultGrafeasStub::CreateOccurrence(
  grpc::ClientContext& context, Options const&,
  grafeas::v1::CreateOccurrenceRequest const& request) {
    grafeas::v1::Occurrence response;
    auto status =
        grpc_stub_->CreateOccurrence(&context, request, &response);
    if (!status.ok()) {
      return google::cloud::MakeStatusFromRpcError(status);
    }
    return response;
...
StatusOr<grafeas::v1::Occurrence>
DefaultGrafeasStub::UpdateOccurrence(
  grpc::ClientContext& context, Options const&,
  grafeas::v1::UpdateOccurrenceRequest const& request) {
    grafeas::v1::Occurrence response;
    auto status =
        grpc_stub_->UpdateOccurrence(&context, request, &response);
    if (!status.ok()) {
      return google::cloud::MakeStatusFromRpcError(status);
    }
    return response;
...
DefaultGrafeasStub::GetOccurrenceNote(
  grpc::ClientContext& context, Options const&,
  grafeas::v1::GetOccurrenceNoteRequest const& request) {
    grafeas::v1::Note response;
    auto status =
        grpc_stub_->GetOccurrenceNote(&context, request, &response);
    if (!status.ok()) {
      return google::cloud::MakeStatusFromRpcError(status);
    }
    return response;
...
StatusOr<grafeas::v1::Note>
DefaultGrafeasStub::GetNote(
  grpc::ClientContext& context, Options const&,
  grafeas::v1::GetNoteRequest const& request) {
    grafeas::v1::Note response;
    auto status =
        grpc_stub_->GetNote(&context, request, &response);
    if (!status.ok()) {
      return google::cloud::MakeStatusFromRpcError(status);
    }
    return response;
...
StatusOr<grafeas::v1::ListNotesResponse>
DefaultGrafeasStub::ListNotes(
  grpc::ClientContext& context, Options const&,
  grafeas::v1::ListNotesRequest const& request) {
    grafeas::v1::ListNotesResponse response;
    auto status =
        grpc_stub_->ListNotes(&context, request, &response);
    if (!status.ok()) {
      return google::cloud::MakeStatusFromRpcError(status);
    }
    return response;
...
Status
DefaultGrafeasStub::DeleteNote(
  grpc::ClientContext& context, Options const&,
  grafeas::v1::DeleteNoteRequest const& request) {
    google::protobuf::Empty response;
    auto status =
        grpc_stub_->DeleteNote(&context, request, &response);
    if (!status.ok()) {
      return google::cloud::MakeStatusFromRpcError(status);
    }
    return google::cloud::Status();
...
StatusOr<grafeas::v1::Note>
DefaultGrafeasStub::CreateNote(
  grpc::ClientContext& context, Options const&,
  grafeas::v1::CreateNoteRequest const& request) {
    grafeas::v1::Note response;
    auto status =
        grpc_stub_->CreateNote(&context, request, &response);
    if (!status.ok()) {
      return google::cloud::MakeStatusFromRpcError(status);
    }
    return response;
...
DefaultGrafeasStub::BatchCreateNotes(
  ...
  grafeas::v1::BatchCreateNotesRequest const& request) {
    ...
    auto status =
        grpc_stub_->BatchCreateNotes(&context, request, &response);
    if (!status.ok()) {
      return google::cloud::MakeStatusFromRpcError(status);
    }
    return response;
...
StatusOr<grafeas::v1::Note>
DefaultGrafeasStub::UpdateNote(
  grpc::ClientContext& context, Options const&,
  grafeas::v1::UpdateNoteRequest const& request) {
    grafeas::v1::Note response;
    auto status =
        grpc_stub_->UpdateNote(&context, request, &response);
    if (!status.ok()) {
      return google::cloud::MakeStatusFromRpcError(status);
    }
    return response;
...
DefaultGrafeasStub::ListNoteOccurrences(
  ...
  grafeas::v1::ListNoteOccurrencesRequest const& request) {
    ...
    auto status =
        grpc_stub_->ListNoteOccurrences(&context, request, &response);
    if (!status.ok()) {
      return google::cloud::MakeStatusFromRpcError(status);
    }
    return response;
