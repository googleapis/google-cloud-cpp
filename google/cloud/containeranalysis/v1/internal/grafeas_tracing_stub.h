...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_CONTAINERANALYSIS_V1_INTERNAL_GRAFEAS_TRACING_STUB_H
...
class GrafeasTracingStub : public GrafeasStub {
 public:
  ...
  explicit GrafeasTracingStub(std::shared_ptr<GrafeasStub> child);
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_CONTAINERANALYSIS_V1_INTERNAL_GRAFEAS_TRACING_STUB_H
