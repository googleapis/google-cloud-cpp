...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_GKEBACKUP_V1_INTERNAL_BACKUP_FOR_GKE_LOGGING_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_GKEBACKUP_V1_INTERNAL_BACKUP_FOR_GKE_LOGGING_DECORATOR_H
...
class BackupForGKELogging : public BackupForGKEStub {
 public:
  ~BackupForGKELogging() override = default;
  BackupForGKELogging(std::shared_ptr<BackupForGKEStub> child,
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_GKEBACKUP_V1_INTERNAL_BACKUP_FOR_GKE_LOGGING_DECORATOR_H
