...
/**
 * A retry policy for `BackupForGKEConnection` that stops retrying after a
...
class BackupForGKELimitedErrorCountRetryPolicy
 ...
 public:
  BackupForGKELimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `BackupForGKEConnection` that stops retrying after
