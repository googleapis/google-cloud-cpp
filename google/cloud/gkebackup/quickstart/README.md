# HOWTO: using the Backup for GKE API C++ client in your project

This directory contains small examples showing how to use the Backup for GKE API C++
...
1. Install the dependencies with your favorite tools. As an example, if you use
   ...
   ```bash
   cd $HOME/vcpkg
   ./vcpkg install google-cloud-cpp[core,gkebackup]
   ```
...
[quickstart-link]: https://cloud.google.com/kubernetes-engine/docs/add-on/backup-for-gke/how-to/install
