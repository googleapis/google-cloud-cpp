...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::apikeys_v2::ApiKeysClient(
...
class CustomIdempotencyPolicy
 ...
 public:
  ...
  std::unique_ptr<google::cloud::apikeys_v2::ApiKeysConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::apikeys_v2::ApiKeysConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::apikeys_v2::ApiKeysRetryPolicyOption>(
      google::cloud::apikeys_v2::ApiKeysLimitedErrorCountRetryPolicy(3).clone())
  ...
  auto c3 = google::cloud::apikeys_v2::ApiKeysClient(
    connection, google::cloud::Options{}.set<google::cloud::apikeys_v2::ApiKeysRetryPolicyOption>(
      google::cloud::apikeys_v2::ApiKeysLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::apikeys_v2::ApiKeysPollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::apikeys_v2::ApiKeysRetryPolicyOption::Type,
            google::cloud::apikeys_v2::ApiKeysBackoffPolicyOption::Type>(
