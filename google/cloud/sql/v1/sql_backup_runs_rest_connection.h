 ...
 * should be passed as an argument to the constructor of SqlBackupRunsServiceClient.
 *
 * The optional @p options argument may be used to configure aspects of the
 * returned `SqlBackupRunsServiceConnection`. Expected options are any of the types in
 ...
 *
 * @param options (optional) Configure the `SqlBackupRunsServiceConnection` created by
 * this function.
 */
