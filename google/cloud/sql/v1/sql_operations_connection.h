...
/**
 * A retry policy for `SqlOperationsServiceConnection` that stops retrying after
...
class SqlOperationsServiceLimitedErrorCountRetryPolicy
 ...
 public:
  SqlOperationsServiceLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `SqlOperationsServiceConnection` that stops retrying
