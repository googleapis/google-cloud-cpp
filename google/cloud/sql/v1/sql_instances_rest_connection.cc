...
std::shared_ptr<SqlInstancesServiceConnection> MakeSqlInstancesServiceConnectionRest(
  ...
  internal::CheckExpectedOptions<CommonOptionList, RestOptionList,
      ...
      SqlInstancesServicePolicyOptionList>(options, __func__);
  options = sql_v1_internal::SqlInstancesServiceDefaultOptions(
      std::move(options));
  auto background = std::make_unique<
      rest_internal::AutomaticallyCreatedRestBackgroundThreads>();
  auto stub = sql_v1_internal::CreateDefaultSqlInstancesServiceRestStub(
      options);
  return sql_v1_internal::MakeSqlInstancesServiceTracingConnection(
      std::make_shared<
          sql_v1_internal::SqlInstancesServiceRestConnectionImpl>(
