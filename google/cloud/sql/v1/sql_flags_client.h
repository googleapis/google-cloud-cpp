...
class SqlFlagsServiceClient {
 public:
  ...
  /// [google.cloud.sql.v1.FlagsListResponse]: @googleapis_reference_link{google/cloud/sql/v1/cloud_sql_flags.proto#L57}
  /// [google.cloud.sql.v1.SqlFlagsListRequest]: @googleapis_reference_link{google/cloud/sql/v1/cloud_sql_flags.proto#L46}
  ///
  // clang-format on
