...
SqlBackupsServiceConnection::~SqlBackupsServiceConnection() = default;

StatusOr<google::cloud::sql::v1::Operation>
SqlBackupsServiceConnection::CreateBackup(
    google::cloud::sql::v1::CreateBackupRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

StatusOr<google::cloud::sql::v1::Backup> SqlBackupsServiceConnection::GetBackup(
    google::cloud::sql::v1::GetBackupRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

StreamRange<google::cloud::sql::v1::Backup>
SqlBackupsServiceConnection::ListBackups(
    google::cloud::sql::v1::
...
StatusOr<google::cloud::sql::v1::Operation>
SqlBackupsServiceConnection::UpdateBackup(
    google::cloud::sql::v1::UpdateBackupRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

StatusOr<google::cloud::sql::v1::Operation>
SqlBackupsServiceConnection::DeleteBackup(
