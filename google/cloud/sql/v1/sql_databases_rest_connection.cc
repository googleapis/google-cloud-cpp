...
MakeSqlDatabasesServiceConnectionRest(ExperimentalTag, Options options) {
  internal::CheckExpectedOptions<CommonOptionList, RestOptionList,
                                 ...
                                 SqlDatabasesServicePolicyOptionList>(options,
                                                                      __func__);
  options =
      sql_v1_internal::SqlDatabasesServiceDefaultOptions(std::move(options));
  auto background = std::make_unique<
      rest_internal::AutomaticallyCreatedRestBackgroundThreads>();
  auto stub =
      sql_v1_internal::CreateDefaultSqlDatabasesServiceRestStub(options);
  return sql_v1_internal::MakeSqlDatabasesServiceTracingConnection(
      std::make_shared<sql_v1_internal::SqlDatabasesServiceRestConnectionImpl>(
