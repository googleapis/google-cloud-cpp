 ...
 */
struct SqlAvailableDatabaseVersionsServiceRetryPolicyOption {
  using Type = std::shared_ptr<SqlAvailableDatabaseVersionsServiceRetryPolicy>;
};
 ...
 * @ingroup google-cloud-sql-options
 */
struct SqlAvailableDatabaseVersionsServiceBackoffPolicyOption {
...
/**
 * The options applicable to SqlAvailableDatabaseVersionsService.
 *
 * @ingroup google-cloud-sql-options
 */
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SQL_V1_SQL_AVAILABLE_DATABASE_VERSIONS_OPTIONS_H
