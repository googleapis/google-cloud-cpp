...
class SqlDatabasesServiceRestMetadata : public SqlDatabasesServiceRestStub {
 public:
  ~SqlDatabasesServiceRestMetadata() override = default;
  explicit SqlDatabasesServiceRestMetadata(
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SQL_V1_INTERNAL_SQL_DATABASES_REST_METADATA_DECORATOR_H
