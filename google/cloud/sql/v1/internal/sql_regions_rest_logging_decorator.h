...
class SqlRegionsServiceRestLogging : public SqlRegionsServiceRestStub {
 public:
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SQL_V1_INTERNAL_SQL_REGIONS_REST_LOGGING_DECORATOR_H
