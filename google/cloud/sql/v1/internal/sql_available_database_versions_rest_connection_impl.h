...
class SqlAvailableDatabaseVersionsServiceRestConnectionImpl
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SQL_V1_INTERNAL_SQL_AVAILABLE_DATABASE_VERSIONS_REST_CONNECTION_IMPL_H
