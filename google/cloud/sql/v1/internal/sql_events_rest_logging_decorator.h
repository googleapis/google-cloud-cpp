...
class SqlEventsServiceRestLogging : public SqlEventsServiceRestStub {
 public:
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SQL_V1_INTERNAL_SQL_EVENTS_REST_LOGGING_DECORATOR_H
