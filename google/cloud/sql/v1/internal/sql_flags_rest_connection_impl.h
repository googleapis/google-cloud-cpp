...
class SqlFlagsServiceRestConnectionImpl
    : public sql_v1::SqlFlagsServiceConnection {
 public:
 ...
 private:
  ...
  std::shared_ptr<sql_v1_internal::SqlFlagsServiceRestStub> stub_;
  Options options_;
};
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SQL_V1_INTERNAL_SQL_FLAGS_REST_CONNECTION_IMPL_H
