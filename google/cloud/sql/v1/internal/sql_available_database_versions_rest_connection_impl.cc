...
SqlAvailableDatabaseVersionsServiceRestConnectionImpl::SqlAvailableDatabaseVersionsServiceRestConnectionImpl(
  ...
  : background_(std::move(background)), stub_(std::move(stub)),
    options_(internal::MergeOptions(
        std::move(options),
        SqlAvailableDatabaseVersionsServiceConnection::options())) {}
