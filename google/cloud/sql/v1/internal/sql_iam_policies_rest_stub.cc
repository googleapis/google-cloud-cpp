...
DefaultSqlIamPoliciesServiceRestStub::DefaultSqlIamPoliciesServiceRestStub(Options options)
    : service_(rest_internal::MakePooledRestClient(
          options.get<EndpointOption>(), options)),
      options_(std::move(options)) {}

DefaultSqlIamPoliciesServiceRestStub::DefaultSqlIamPoliciesServiceRestStub(
