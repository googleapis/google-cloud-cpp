...
class SqlRegionsServiceRestMetadata : public SqlRegionsServiceRestStub {
 public:
  ~SqlRegionsServiceRestMetadata() override = default;
  explicit SqlRegionsServiceRestMetadata(
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SQL_V1_INTERNAL_SQL_REGIONS_REST_METADATA_DECORATOR_H
