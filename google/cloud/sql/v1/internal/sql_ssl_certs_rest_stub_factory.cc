...
std::shared_ptr<SqlSslCertsServiceRestStub>
CreateDefaultSqlSslCertsServiceRestStub(Options& options) {
  ...
  auto service_endpoint = internal::DetermineServiceEndpoint(
      internal::GetEnv("GOOGLE_CLOUD_CPP_SQL_SSL_CERTS_SERVICE_ENDPOINT"),
  ...
  std::shared_ptr<SqlSslCertsServiceRestStub> stub =
      std::make_shared<DefaultSqlSslCertsServiceRestStub>(
          std::move(stub_creation_opts));
  stub = std::make_shared<SqlSslCertsServiceRestMetadata>(std::move(stub));
  if (internal::Contains(options.get<TracingComponentsOption>(), "rpc")) {
    GCP_LOG(INFO) << "Enabled logging for REST rpc calls";
    stub = std::make_shared<SqlSslCertsServiceRestLogging>(
