...
class SqlIamPoliciesServiceRestConnectionImpl
 ...
 private:
  ...
  std::shared_ptr<sql_v1_internal::SqlIamPoliciesServiceRestStub> stub_;
  Options options_;
};
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SQL_V1_INTERNAL_SQL_IAM_POLICIES_REST_CONNECTION_IMPL_H
