...
std::shared_ptr<SqlInstancesServiceRestStub>
CreateDefaultSqlInstancesServiceRestStub(Options& options) {
  ...
  auto service_endpoint = internal::DetermineServiceEndpoint(
      internal::GetEnv("GOOGLE_CLOUD_CPP_SQL_INSTANCES_SERVICE_ENDPOINT"),
  ...
  std::shared_ptr<SqlInstancesServiceRestStub> stub =
      std::make_shared<DefaultSqlInstancesServiceRestStub>(
          std::move(stub_creation_opts));
  stub = std::make_shared<SqlInstancesServiceRestMetadata>(std::move(stub));
  if (internal::Contains(options.get<TracingComponentsOption>(), "rpc")) {
    GCP_LOG(INFO) << "Enabled logging for REST rpc calls";
    stub = std::make_shared<SqlInstancesServiceRestLogging>(
