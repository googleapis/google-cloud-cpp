...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SQL_V1_INTERNAL_SQL_FLAGS_REST_STUB_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SQL_V1_INTERNAL_SQL_FLAGS_REST_STUB_H
...
class SqlFlagsServiceRestStub {
 public:
  virtual ~SqlFlagsServiceRestStub() = default;
...
class DefaultSqlFlagsServiceRestStub : public SqlFlagsServiceRestStub {
 public:
  ~DefaultSqlFlagsServiceRestStub() override = default;
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SQL_V1_INTERNAL_SQL_FLAGS_REST_STUB_H
