...
std::shared_ptr<SqlUsersServiceRestStub>
CreateDefaultSqlUsersServiceRestStub(Options const& options) {
  auto opts = internal::PopulateRestOptions(options);
  std::shared_ptr<SqlUsersServiceRestStub> stub =
      std::make_shared<DefaultSqlUsersServiceRestStub>(std::move(opts));
