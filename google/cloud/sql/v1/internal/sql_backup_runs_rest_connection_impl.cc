...
SqlBackupRunsServiceRestConnectionImpl::Delete(google::cloud::sql::v1::SqlBackupRunsDeleteRequest const& request) {
...
SqlBackupRunsServiceRestConnectionImpl::Get(google::cloud::sql::v1::SqlBackupRunsGetRequest const& request) {
  auto current = google::cloud::internal::SaveCurrentOptions();
  return google::cloud::rest_internal::RestRetryLoop(
      retry_policy(*current), backoff_policy(*current),
...
StatusOr<google::cloud::sql::v1::Operation>
SqlBackupRunsServiceRestConnectionImpl::Insert(google::cloud::sql::v1::SqlBackupRunsInsertRequest const& request) {
  auto current = google::cloud::internal::SaveCurrentOptions();
  return google::cloud::rest_internal::RestRetryLoop(
      retry_policy(*current), backoff_policy(*current),
...
SqlBackupRunsServiceRestConnectionImpl::List(google::cloud::sql::v1::SqlBackupRunsListRequest const& request) {
  auto current = google::cloud::internal::SaveCurrentOptions();
  return google::cloud::rest_internal::RestRetryLoop(
      retry_policy(*current), backoff_policy(*current),
