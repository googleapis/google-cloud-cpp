...
class SqlOperationsServiceRestMetadata : public SqlOperationsServiceRestStub {
 public:
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SQL_V1_INTERNAL_SQL_OPERATIONS_REST_METADATA_DECORATOR_H
