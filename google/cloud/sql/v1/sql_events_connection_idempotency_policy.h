...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SQL_V1_SQL_EVENTS_CONNECTION_IDEMPOTENCY_POLICY_H
...
class SqlEventsServiceConnectionIdempotencyPolicy {
 public:
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SQL_V1_SQL_EVENTS_CONNECTION_IDEMPOTENCY_POLICY_H
