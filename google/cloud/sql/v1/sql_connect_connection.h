...
/**
 * A retry policy for `SqlConnectServiceConnection` that stops retrying after a
...
class SqlConnectServiceLimitedErrorCountRetryPolicy
 ...
 public:
  SqlConnectServiceLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `SqlConnectServiceConnection` that stops retrying after
