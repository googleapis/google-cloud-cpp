...
/**
 * A retry policy for `SqlBackupRunsServiceConnection` that stops retrying after
...
class SqlBackupRunsServiceLimitedErrorCountRetryPolicy
 ...
 public:
  SqlBackupRunsServiceLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `SqlBackupRunsServiceConnection` that stops retrying
