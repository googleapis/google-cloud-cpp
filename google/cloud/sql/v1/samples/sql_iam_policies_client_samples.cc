...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::sql_v1::SqlIamPoliciesServiceClient(
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::sql_v1::SqlIamPoliciesServiceClient(
      google::cloud::sql_v1::MakeSqlIamPoliciesServiceConnection(ud_options));
...
class CustomIdempotencyPolicy
 ...
 public:
  ...
  std::unique_ptr<
      google::cloud::sql_v1::SqlIamPoliciesServiceConnectionIdempotencyPolicy>
  ...
  auto options =
      google::cloud::Options{}
          ...
          .set<google::cloud::sql_v1::SqlIamPoliciesServiceRetryPolicyOption>(
              google::cloud::sql_v1::
                  SqlIamPoliciesServiceLimitedErrorCountRetryPolicy(3)
                      .clone())
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::sql_v1::SqlIamPoliciesServiceClient(
        google::cloud::sql_v1::MakeSqlIamPoliciesServiceConnectionRest(
            options));
  }
  //! [with-service-account]
  (argv.at(0));
