...
#include "google/cloud/sql/v1/sql_feature_eligibility_client.h"
...
// clang-format off
// main-dox-marker: sql_v1::SqlFeatureEligibilityServiceClient
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::sql_v1::SqlFeatureEligibilityServiceClient(
      google::cloud::sql_v1::MakeSqlFeatureEligibilityServiceConnectionRest(
          options));
  //! [set-client-endpoint]
}
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::sql_v1::SqlFeatureEligibilityServiceClient(
      google::cloud::sql_v1::MakeSqlFeatureEligibilityServiceConnectionRest(
          *ud_options));
  //! [set-client-universe-domain]
}
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options =
      google::cloud::Options{}
          ...
          .set<google::cloud::sql_v1::
                   SqlFeatureEligibilityServiceRetryPolicyOption>(
              google::cloud::sql_v1::
                  SqlFeatureEligibilityServiceLimitedErrorCountRetryPolicy(3)
                      .clone())
          .set<google::cloud::sql_v1::
                   SqlFeatureEligibilityServiceBackoffPolicyOption>(
  ...
  auto c1 =
      google::cloud::sql_v1::SqlFeatureEligibilityServiceClient(connection);
  auto c2 =
      google::cloud::sql_v1::SqlFeatureEligibilityServiceClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::sql_v1::SqlFeatureEligibilityServiceClient(
      connection,
      google::cloud::Options{}
          .set<google::cloud::sql_v1::
                   SqlFeatureEligibilityServiceRetryPolicyOption>(
  ...
  //     .set<google::cloud::sql_v1::SqlFeatureEligibilityServiceRetryPolicyOption>(
  //       google::cloud::sql_v1::SqlFeatureEligibilityServiceLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::sql_v1::SqlFeatureEligibilityServiceClient(
        google::cloud::sql_v1::MakeSqlFeatureEligibilityServiceConnectionRest(
            options));
  }
  //! [with-service-account]
