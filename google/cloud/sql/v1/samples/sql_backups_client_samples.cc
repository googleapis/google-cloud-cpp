...
// clang-format off
// main-dox-marker: sql_v1::SqlBackupsServiceClient
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::sql_v1::SqlBackupsServiceClient(
      google::cloud::sql_v1::MakeSqlBackupsServiceConnectionRest(options));
  //! [set-client-endpoint]
}
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::sql_v1::SqlBackupsServiceClient(
      google::cloud::sql_v1::MakeSqlBackupsServiceConnectionRest(*ud_options));
  //! [set-client-universe-domain]
}
...
class CustomIdempotencyPolicy
 ...
 public:
  ...
  std::unique_ptr<
      google::cloud::sql_v1::SqlBackupsServiceConnectionIdempotencyPolicy>
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options =
      google::cloud::Options{}
          ...
          .set<google::cloud::sql_v1::SqlBackupsServiceRetryPolicyOption>(
              google::cloud::sql_v1::
                  SqlBackupsServiceLimitedErrorCountRetryPolicy(3)
                      .clone())
          .set<google::cloud::sql_v1::SqlBackupsServiceBackoffPolicyOption>(
  ...
  auto c1 = google::cloud::sql_v1::SqlBackupsServiceClient(connection);
  auto c2 = google::cloud::sql_v1::SqlBackupsServiceClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::sql_v1::SqlBackupsServiceClient(
      connection,
      google::cloud::Options{}
          .set<google::cloud::sql_v1::SqlBackupsServiceRetryPolicyOption>(
              google::cloud::sql_v1::SqlBackupsServiceLimitedTimeRetryPolicy(
  ...
  //     .set<google::cloud::sql_v1::SqlBackupsServiceRetryPolicyOption>(
  //       google::cloud::sql_v1::SqlBackupsServiceLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::sql_v1::SqlBackupsServiceClient(
        google::cloud::sql_v1::MakeSqlBackupsServiceConnectionRest(options));
  }
  //! [with-service-account]
  (argv.at(0));
