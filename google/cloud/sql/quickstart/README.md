# HOWTO: using the Cloud SQL Admin API C++ client in your project

This directory contains small examples showing how to use the Cloud SQL Admin API C++
...
Like most Google Cloud Platform (GCP) services, Cloud SQL Admin API requires that
...
1. Install the dependencies with your favorite tools. As an example, if you use
   ...
   ```bash
   cd $HOME/vcpkg
   ./vcpkg install google-cloud-cpp[core,sql]
   ```
...
[quickstart-link]: https://cloud.google.com/sql/docs/quickstart
