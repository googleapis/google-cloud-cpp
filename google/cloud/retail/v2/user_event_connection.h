...
/**
 * A retry policy for `UserEventServiceConnection` that stops retrying after a
...
class UserEventServiceLimitedErrorCountRetryPolicy
 ...
 public:
  UserEventServiceLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `UserEventServiceConnection` that stops retrying after
