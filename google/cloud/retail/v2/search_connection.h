...
/**
 * A retry policy for `SearchServiceConnection` that stops retrying after a
...
class SearchServiceLimitedErrorCountRetryPolicy
 ...
 public:
  SearchServiceLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `SearchServiceConnection` that stops retrying after
