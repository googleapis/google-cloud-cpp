...
/**
 * A retry policy for `PredictionServiceConnection` that stops retrying after a
...
class PredictionServiceLimitedErrorCountRetryPolicy
 ...
 public:
  PredictionServiceLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `PredictionServiceConnection` that stops retrying after
