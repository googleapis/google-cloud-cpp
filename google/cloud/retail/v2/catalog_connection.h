...
/**
 * A retry policy for `CatalogServiceConnection` that stops retrying after a
...
class CatalogServiceLimitedErrorCountRetryPolicy
 ...
 public:
  CatalogServiceLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `CatalogServiceConnection` that stops retrying after
