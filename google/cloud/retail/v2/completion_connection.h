...
/**
 * A retry policy for `CompletionServiceConnection` that stops retrying after a
...
class CompletionServiceLimitedErrorCountRetryPolicy
 ...
 public:
  CompletionServiceLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `CompletionServiceConnection` that stops retrying after
