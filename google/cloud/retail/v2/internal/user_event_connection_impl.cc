...
std::unique_ptr<retail_v2::UserEventServiceRetryPolicy>
...
idempotency_policy(Options const& options) {
  return options.get<retail_v2::UserEventServiceConnectionIdempotencyPolicyOption>()->clone();
}
...
UserEventServiceConnectionImpl::PurgeUserEvents(
  ...
  auto current = google::cloud::internal::SaveCurrentOptions();
  if (!operation.metadata().Is<typename google::cloud::retail::v2::PurgeMetadata>()) {
    return make_ready_future<StatusOr<google::cloud::retail::v2::PurgeUserEventsResponse>>(
        internal::InvalidArgumentError("operation does not correspond to PurgeUserEvents",
                                       GCP_ERROR_INFO().WithMetadata("operation", operation.metadata().DebugString())));
  }

  return google::cloud::internal::AsyncAwaitLongRunningOperation<google::cloud::retail::v2::PurgeUserEventsResponse>(
...
UserEventServiceConnectionImpl::ImportUserEvents(
  ...
  if (!operation.metadata().Is<typename google::cloud::retail::v2::ImportMetadata>()) {
    return make_ready_future<StatusOr<google::cloud::retail::v2::ImportUserEventsResponse>>(
        internal::InvalidArgumentError("operation does not correspond to ImportUserEvents",
                                       GCP_ERROR_INFO().WithMetadata("operation", operation.metadata().DebugString())));
  }

  return google::cloud::internal::AsyncAwaitLongRunningOperation<google::cloud::retail::v2::ImportUserEventsResponse>(
    background_->cq(), current, operation,
    [stub = stub_](google::cloud::CompletionQueue& cq,
                   std::shared_ptr<grpc::ClientContext> context,
                   google::cloud::internal::ImmutableOptions options,
...
UserEventServiceConnectionImpl::RejoinUserEvents(google::cloud::retail::v2::RejoinUserEventsRequest const& request) {
  ...
  return google::cloud::internal::AsyncLongRunningOperation<google::cloud::retail::v2::RejoinUserEventsResponse>(
    ...
    [stub = stub_](google::cloud::CompletionQueue& cq,
     ...
     return stub->AsyncRejoinUserEvents(
         cq, std::move(context), std::move(options), request);
    },
    [stub = stub_](google::cloud::CompletionQueue& cq,
                   std::shared_ptr<grpc::ClientContext> context,
...
UserEventServiceConnectionImpl::RejoinUserEvents(
      google::longrunning::Operation const& operation) {
  auto current = google::cloud::internal::SaveCurrentOptions();
  if (!operation.metadata().Is<typename google::cloud::retail::v2::RejoinUserEventsMetadata>()) {
    return make_ready_future<StatusOr<google::cloud::retail::v2::RejoinUserEventsResponse>>(
        internal::InvalidArgumentError("operation does not correspond to RejoinUserEvents",
                                       GCP_ERROR_INFO().WithMetadata("operation", operation.metadata().DebugString())));
  }
...
UserEventServiceConnectionImpl::ListOperations(google::longrunning::ListOperationsRequest request) {
  ...
  return google::cloud::internal::MakePaginationRange<StreamRange<google::longrunning::Operation>>(
      ...
      [idempotency, function_name, stub = stub_,
       retry = std::shared_ptr<retail_v2::UserEventServiceRetryPolicy>(retry_policy(*current)),
