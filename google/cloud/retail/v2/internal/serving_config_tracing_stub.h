...
class ServingConfigServiceTracingStub : public ServingConfigServiceStub {
 public:
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_RETAIL_V2_INTERNAL_SERVING_CONFIG_TRACING_STUB_H
