...
#include "google/cloud/retail/v2/internal/search_logging_decorator.h"
#include "google/cloud/retail/v2/internal/search_metadata_decorator.h"
...
CreateDefaultSearchServiceStub(
  ...
  auto service_grpc_stub = google::cloud::retail::v2::SearchService::NewStub(channel);
