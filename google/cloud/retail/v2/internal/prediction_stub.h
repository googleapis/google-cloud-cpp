...
class DefaultPredictionServiceStub : public PredictionServiceStub {
 public:
  explicit DefaultPredictionServiceStub(
      std::unique_ptr<google::cloud::retail::v2::PredictionService::StubInterface> grpc_stub,
 ...
 private:
  std::unique_ptr<google::cloud::retail::v2::PredictionService::StubInterface> grpc_stub_;
