...
std::shared_ptr<ProductServiceStub> CreateDefaultProductServiceStub(
  ...
  auto endpoint = internal::DetermineServiceEndpoint(
      internal::GetEnv("GOOGLE_CLOUD_CPP_PRODUCT_SERVICE_ENDPOINT"),
  ...
  if (!endpoint.ok()) {
    ...
    stub = std::make_shared<DefaultProductServiceStub>(
  ...
  if (internal::TracingEnabled(options)) {
    stub = MakeProductServiceTracingStub(std::move(stub));
  }
  return stub;
}
