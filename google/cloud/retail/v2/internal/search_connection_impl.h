...
class SearchServiceConnectionImpl : public retail_v2::SearchServiceConnection {
 ...
 private:
  static std::unique_ptr<retail_v2::SearchServiceRetryPolicy> retry_policy(
  ...
  static std::unique_ptr<retail_v2::SearchServiceConnectionIdempotencyPolicy>
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_RETAIL_V2_INTERNAL_SEARCH_CONNECTION_IMPL_H
