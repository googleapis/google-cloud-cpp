...
std::unique_ptr<retail_v2::CompletionServiceRetryPolicy>
...
backoff_policy(Options const& options) {
  return options.get<retail_v2::CompletionServiceBackoffPolicyOption>()->clone();
}

std::unique_ptr<retail_v2::CompletionServiceConnectionIdempotencyPolicy>
idempotency_policy(Options const& options) {
  return options.get<retail_v2::CompletionServiceConnectionIdempotencyPolicyOption>()->clone();
}

std::unique_ptr<PollingPolicy> polling_policy(Options const& options) {
  return options.get<retail_v2::CompletionServicePollingPolicyOption>()->clone();
}
...
CompletionServiceConnectionImpl::ImportCompletionData(google::cloud::retail::v2::ImportCompletionDataRequest const& request) {
  ...
  return google::cloud::internal::AsyncLongRunningOperation<google::cloud::retail::v2::ImportCompletionDataResponse>(
    ...
    [stub = stub_](google::cloud::CompletionQueue& cq,
     ...
     return stub->AsyncImportCompletionData(
...
CompletionServiceConnectionImpl::ImportCompletionData(
  ...
  if (!operation.metadata().Is<typename google::cloud::retail::v2::ImportMetadata>()) {
    return make_ready_future<StatusOr<google::cloud::retail::v2::ImportCompletionDataResponse>>(
        internal::InvalidArgumentError("operation does not correspond to ImportCompletionData",
                                       GCP_ERROR_INFO().WithMetadata("operation", operation.metadata().DebugString())));
  }

  return google::cloud::internal::AsyncAwaitLongRunningOperation<google::cloud::retail::v2::ImportCompletionDataResponse>(
...
CompletionServiceConnectionImpl::ListOperations(google::longrunning::ListOperationsRequest request) {
  ...
  return google::cloud::internal::MakePaginationRange<StreamRange<google::longrunning::Operation>>(
      ...
      [idempotency, function_name, stub = stub_,
       retry = std::shared_ptr<retail_v2::CompletionServiceRetryPolicy>(retry_policy(*current)),
