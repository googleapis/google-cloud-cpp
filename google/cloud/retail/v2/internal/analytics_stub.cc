...
AnalyticsServiceStub::~AnalyticsServiceStub() = default;

future<StatusOr<google::longrunning::Operation>>
DefaultAnalyticsServiceStub::AsyncExportAnalyticsMetrics(
      google::cloud::CompletionQueue& cq,
      std::shared_ptr<grpc::ClientContext> context,
      google::cloud::internal::ImmutableOptions,
      google::cloud::retail::v2::ExportAnalyticsMetricsRequest const& request) {
  return internal::MakeUnaryRpcImpl<google::cloud::retail::v2::ExportAnalyticsMetricsRequest,
                                    google::longrunning::Operation>(
      cq,
      [this](grpc::ClientContext* context,
             google::cloud::retail::v2::ExportAnalyticsMetricsRequest const& request,
             grpc::CompletionQueue* cq) {
        return grpc_stub_->AsyncExportAnalyticsMetrics(context, request, cq);
      },
...
future<Status> DefaultAnalyticsServiceStub::AsyncCancelOperation(
    google::cloud::CompletionQueue& cq,
    std::shared_ptr<grpc::ClientContext> context,
    // NOLINTNEXTLINE(performance-unnecessary-value-param)
    google::cloud::internal::ImmutableOptions,
