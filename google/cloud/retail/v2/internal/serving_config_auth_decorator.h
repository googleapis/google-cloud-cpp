...
class ServingConfigServiceAuth : public ServingConfigServiceStub {
 public:
  ~ServingConfigServiceAuth() override = default;
  ServingConfigServiceAuth(
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_RETAIL_V2_INTERNAL_SERVING_CONFIG_AUTH_DECORATOR_H
