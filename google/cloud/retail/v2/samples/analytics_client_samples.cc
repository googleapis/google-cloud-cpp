...
// clang-format off
// main-dox-marker: retail_v2::AnalyticsServiceClient
// lro-marker: true
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::retail_v2::AnalyticsServiceClient(
...
class CustomIdempotencyPolicy
   : public google::cloud::retail_v2::AnalyticsServiceConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::retail_v2::AnalyticsServiceConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::retail_v2::AnalyticsServiceConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::retail_v2::AnalyticsServiceRetryPolicyOption>(
      google::cloud::retail_v2::AnalyticsServiceLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::retail_v2::AnalyticsServiceBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::retail_v2::MakeAnalyticsServiceConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::retail_v2::AnalyticsServiceClient(connection);
  auto c2 = google::cloud::retail_v2::AnalyticsServiceClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::retail_v2::AnalyticsServiceClient(
    connection, google::cloud::Options{}.set<google::cloud::retail_v2::AnalyticsServiceRetryPolicyOption>(
      google::cloud::retail_v2::AnalyticsServiceLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::retail_v2::AnalyticsServiceRetryPolicyOption>(
  //       google::cloud::retail_v2::AnalyticsServiceLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::retail_v2::AnalyticsServicePollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::retail_v2::AnalyticsServiceRetryPolicyOption::Type,
            google::cloud::retail_v2::AnalyticsServiceBackoffPolicyOption::Type>(
            google::cloud::retail_v2::AnalyticsServiceLimitedTimeRetryPolicy(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::retail_v2::AnalyticsServiceClient(
      google::cloud::retail_v2::MakeAnalyticsServiceConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
