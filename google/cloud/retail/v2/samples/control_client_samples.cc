...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::retail_v2::ControlServiceClient(
      google::cloud::retail_v2::MakeControlServiceConnection(*ud_options));
  //! [set-client-universe-domain]
}

//! [custom-idempotency-policy]
class CustomIdempotencyPolicy : public google::cloud::retail_v2::
                                    ControlServiceConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<
      google::cloud::retail_v2::ControlServiceConnectionIdempotencyPolicy>
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
      ...
      google::cloud::Options{}
          ...
          .set<google::cloud::retail_v2::ControlServiceRetryPolicyOption>(
              google::cloud::retail_v2::
                  ControlServiceLimitedErrorCountRetryPolicy(3)
                      .clone())
  ...
  auto c3 = google::cloud::retail_v2::ControlServiceClient(
      ...
      google::cloud::Options{}
          .set<google::cloud::retail_v2::ControlServiceRetryPolicyOption>(
              google::cloud::retail_v2::ControlServiceLimitedTimeRetryPolicy(
