...
// clang-format off
// main-dox-marker: retail_v2::ModelServiceClient
// lro-marker: true
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::retail_v2::ModelServiceClient(
      google::cloud::retail_v2::MakeModelServiceConnection(options));
  //! [set-client-endpoint]
}

//! [custom-idempotency-policy]
class CustomIdempotencyPolicy
   : public google::cloud::retail_v2::ModelServiceConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::retail_v2::ModelServiceConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::retail_v2::ModelServiceConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::retail_v2::ModelServiceRetryPolicyOption>(
      google::cloud::retail_v2::ModelServiceLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::retail_v2::ModelServiceBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::retail_v2::MakeModelServiceConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::retail_v2::ModelServiceClient(connection);
  auto c2 = google::cloud::retail_v2::ModelServiceClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::retail_v2::ModelServiceClient(
    connection, google::cloud::Options{}.set<google::cloud::retail_v2::ModelServiceRetryPolicyOption>(
      google::cloud::retail_v2::ModelServiceLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::retail_v2::ModelServiceRetryPolicyOption>(
  //       google::cloud::retail_v2::ModelServiceLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::retail_v2::ModelServicePollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::retail_v2::ModelServiceRetryPolicyOption::Type,
            google::cloud::retail_v2::ModelServiceBackoffPolicyOption::Type>(
            google::cloud::retail_v2::ModelServiceLimitedTimeRetryPolicy(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::retail_v2::ModelServiceClient(
      google::cloud::retail_v2::MakeModelServiceConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
