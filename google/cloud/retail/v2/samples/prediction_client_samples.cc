...
// clang-format off
// main-dox-marker: retail_v2::PredictionServiceClient
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::retail_v2::PredictionServiceClient(
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::retail_v2::PredictionServiceClient(
      google::cloud::retail_v2::MakePredictionServiceConnection(*ud_options));
  //! [set-client-universe-domain]
}
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto c2 = google::cloud::retail_v2::PredictionServiceClient(connection);
  ...
  //     .set<google::cloud::retail_v2::PredictionServiceRetryPolicyOption>(
  //       google::cloud::retail_v2::PredictionServiceLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
