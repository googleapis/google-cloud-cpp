...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::retail_v2::ServingConfigServiceClient(
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::retail_v2::ServingConfigServiceClient(
      google::cloud::retail_v2::MakeServingConfigServiceConnection(ud_options));
...
class CustomIdempotencyPolicy
 ...
 public:
  ...
  std::unique_ptr<
      google::cloud::retail_v2::ServingConfigServiceConnectionIdempotencyPolicy>
      ...
      google::cloud::Options{}
          ...
          .set<google::cloud::retail_v2::ServingConfigServiceRetryPolicyOption>(
              google::cloud::retail_v2::
                  ServingConfigServiceLimitedErrorCountRetryPolicy(3)
                      .clone())
          .set<google::cloud::retail_v2::
