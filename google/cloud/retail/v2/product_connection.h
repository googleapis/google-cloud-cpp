...
/**
 * A retry policy for `ProductServiceConnection` that stops retrying after a
...
class ProductServiceLimitedErrorCountRetryPolicy
 ...
 public:
  ProductServiceLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `ProductServiceConnection` that stops retrying after
