# HOWTO: using the Retail API C++ client in your project

This directory contains small examples showing how to use the Retail API C++
...
Like most Google Cloud Platform (GCP) services, Retail API requires that
...
2. Install the dependencies with your favorite tools. As an example, if you use
   ...
   ```bash
   cd $HOME/vcpkg
   ./vcpkg install google-cloud-cpp[core,retail]
   ```
...
3. Configure CMake, if necessary, configure the directory where you installed
   ...
   ```bash
   cd $HOME/gooogle-cloud-cpp/google/cloud/retail/quickstart
...
[quickstart-link]: https://cloud.google.com/retail/docs/setting-up
