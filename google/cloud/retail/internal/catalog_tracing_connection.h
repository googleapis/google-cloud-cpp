...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_RETAIL_INTERNAL_CATALOG_TRACING_CONNECTION_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_RETAIL_INTERNAL_CATALOG_TRACING_CONNECTION_H
...
class CatalogServiceTracingConnection
 ...
 private:
  std::shared_ptr<retail::CatalogServiceConnection> child_;
};
 ...
 */
std::shared_ptr<retail::CatalogServiceConnection>
MakeCatalogServiceTracingConnection(
    std::shared_ptr<retail::CatalogServiceConnection> conn);
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_RETAIL_INTERNAL_CATALOG_TRACING_CONNECTION_H
