...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_RETAIL_INTERNAL_COMPLETION_TRACING_CONNECTION_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_RETAIL_INTERNAL_COMPLETION_TRACING_CONNECTION_H
...
class CompletionServiceTracingConnection
 ...
 private:
  std::shared_ptr<retail::CompletionServiceConnection> child_;
};
...
MakeCompletionServiceTracingConnection(
    std::shared_ptr<retail::CompletionServiceConnection> conn);
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_RETAIL_INTERNAL_COMPLETION_TRACING_CONNECTION_H
