...
inline std::unique_ptr<retail::PredictionServiceRetryPolicy> retry_policy() {
  return internal::CurrentOptions()
      .get<retail::PredictionServiceRetryPolicyOption>()
      ->clone();
}

inline std::unique_ptr<BackoffPolicy> backoff_policy() {
  return internal::CurrentOptions()
      .get<retail::PredictionServiceBackoffPolicyOption>()
      ->clone();
}

inline std::unique_ptr<retail::PredictionServiceConnectionIdempotencyPolicy>
idempotency_policy() {
  return internal::CurrentOptions()
