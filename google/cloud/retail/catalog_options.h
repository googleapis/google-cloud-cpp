...
/// @deprecated Use retail_v2::CatalogServiceConnectionIdempotencyPolicyOption directly.
using ::google::cloud::retail_v2::CatalogServiceConnectionIdempotencyPolicyOption;
