...
// main-dox-marker: GOOGLE_CLOUD_CPP_NS::CompletionServiceClient
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::GOOGLE_CLOUD_CPP_NS::CompletionServiceClient(
      google::cloud::GOOGLE_CLOUD_CPP_NS::MakeCompletionServiceConnection(
          options));
  //! [set-client-endpoint]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::GOOGLE_CLOUD_CPP_NS::CompletionServiceClient(
        google::cloud::GOOGLE_CLOUD_CPP_NS::MakeCompletionServiceConnection(
            options));
  }
  //! [with-service-account]
