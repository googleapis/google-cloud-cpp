...
// main-dox-marker: GOOGLE_CLOUD_CPP_NS::CatalogServiceClient
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::GOOGLE_CLOUD_CPP_NS::CatalogServiceClient(
      google::cloud::GOOGLE_CLOUD_CPP_NS::MakeCatalogServiceConnection(
          options));
  //! [set-client-endpoint]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::GOOGLE_CLOUD_CPP_NS::CatalogServiceClient(
        google::cloud::GOOGLE_CLOUD_CPP_NS::MakeCatalogServiceConnection(
            options));
  }
  //! [with-service-account]
