...
// main-dox-marker: GOOGLE_CLOUD_CPP_NS::ProductServiceClient
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::GOOGLE_CLOUD_CPP_NS::ProductServiceClient(
      google::cloud::GOOGLE_CLOUD_CPP_NS::MakeProductServiceConnection(
          options));
  //! [set-client-endpoint]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::GOOGLE_CLOUD_CPP_NS::ProductServiceClient(
        google::cloud::GOOGLE_CLOUD_CPP_NS::MakeProductServiceConnection(
            options));
  }
  //! [with-service-account]
