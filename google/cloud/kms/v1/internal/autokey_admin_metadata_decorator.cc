...
AutokeyAdminMetadata::UpdateAutokeyConfig(
  ...
  SetMetadata(context, options, absl::StrCat("autokey_config.name=", internal::UrlEncode(request.autokey_config().name())));
...
AutokeyAdminMetadata::GetLocation(
    grpc::ClientContext& context,
    Options const& options,
...
AutokeyAdminMetadata::SetIamPolicy(
    grpc::ClientContext& context,
    Options const& options,
...
StatusOr<google::iam::v1::Policy>
AutokeyAdminMetadata::GetIamPolicy(
    grpc::ClientContext& context,
    Options const& options,
...
AutokeyAdminMetadata::GetOperation(
    grpc::ClientContext& context,
    Options const& options,
