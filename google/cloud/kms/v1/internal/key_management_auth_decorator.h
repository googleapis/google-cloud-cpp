...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_KMS_V1_INTERNAL_KEY_MANAGEMENT_AUTH_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_KMS_V1_INTERNAL_KEY_MANAGEMENT_AUTH_DECORATOR_H
...
class KeyManagementServiceAuth : public KeyManagementServiceStub {
 public:
  ~KeyManagementServiceAuth() override = default;
  KeyManagementServiceAuth(
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_KMS_V1_INTERNAL_KEY_MANAGEMENT_AUTH_DECORATOR_H
