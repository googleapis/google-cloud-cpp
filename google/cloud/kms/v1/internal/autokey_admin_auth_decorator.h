...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_KMS_V1_INTERNAL_AUTOKEY_ADMIN_AUTH_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_KMS_V1_INTERNAL_AUTOKEY_ADMIN_AUTH_DECORATOR_H
...
class AutokeyAdminAuth : public AutokeyAdminStub {
 public:
  ~AutokeyAdminAuth() override = default;
  AutokeyAdminAuth(
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_KMS_V1_INTERNAL_AUTOKEY_ADMIN_AUTH_DECORATOR_H
