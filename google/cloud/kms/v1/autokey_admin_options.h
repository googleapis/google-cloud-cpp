 ...
 */
struct AutokeyAdminRetryPolicyOption {
  using Type = std::shared_ptr<AutokeyAdminRetryPolicy>;
};
 ...
 * @ingroup google-cloud-kms-options
 */
struct AutokeyAdminBackoffPolicyOption {
 ...
 * @ingroup google-cloud-kms-options
 */
struct AutokeyAdminConnectionIdempotencyPolicyOption {
  using Type = std::shared_ptr<AutokeyAdminConnectionIdempotencyPolicy>;
};

/**
 * The options applicable to AutokeyAdmin.
 *
 * @ingroup google-cloud-kms-options
 */
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_KMS_V1_AUTOKEY_ADMIN_OPTIONS_H
