...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::kms_v1::AutokeyAdminClient(
      google::cloud::kms_v1::MakeAutokeyAdminConnection(*ud_options));
  //! [set-client-universe-domain]
}
...
class CustomIdempotencyPolicy
 ...
 public:
  ...
  std::unique_ptr<
      google::cloud::kms_v1::AutokeyAdminConnectionIdempotencyPolicy>
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto c3 = google::cloud::kms_v1::AutokeyAdminClient(
      ...
      google::cloud::Options{}
          .set<google::cloud::kms_v1::AutokeyAdminRetryPolicyOption>(
              google::cloud::kms_v1::AutokeyAdminLimitedTimeRetryPolicy(
