...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::kms_v1::AutokeyClient(
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::kms_v1::AutokeyClient(
      google::cloud::kms_v1::MakeAutokeyConnection(*ud_options));
  //! [set-client-universe-domain]
}
...
class CustomIdempotencyPolicy
 ...
 public:
  ...
  std::unique_ptr<google::cloud::kms_v1::AutokeyConnectionIdempotencyPolicy>
  ...
  auto options =
      google::cloud::Options{}
          ...
          .set<google::cloud::kms_v1::AutokeyRetryPolicyOption>(
              google::cloud::kms_v1::AutokeyLimitedErrorCountRetryPolicy(3)
                  .clone())
