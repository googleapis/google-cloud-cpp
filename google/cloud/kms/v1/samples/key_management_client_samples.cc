...
class CustomIdempotencyPolicy
   : public google::cloud::kms_v1::KeyManagementServiceConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::kms_v1::KeyManagementServiceConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::kms_v1::KeyManagementServiceConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::kms_v1::KeyManagementServiceRetryPolicyOption>(
      google::cloud::kms_v1::KeyManagementServiceLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::kms_v1::KeyManagementServiceBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::kms_v1::MakeKeyManagementServiceConnection(options);
  ...
  auto c3 = google::cloud::kms_v1::KeyManagementServiceClient(
    connection, google::cloud::Options{}.set<google::cloud::kms_v1::KeyManagementServiceRetryPolicyOption>(
      google::cloud::kms_v1::KeyManagementServiceLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::kms_v1::KeyManagementServiceRetryPolicyOption>(
  //       google::cloud::kms_v1::KeyManagementServiceLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::kms_v1::KeyManagementServiceClient(
      google::cloud::kms_v1::MakeKeyManagementServiceConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
