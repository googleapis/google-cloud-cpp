...
StatusOr<google::cloud::kms::v1::KeyHandle>
AutokeyConnection::GetKeyHandle(
    google::cloud::kms::v1::GetKeyHandleRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

StreamRange<google::cloud::kms::v1::KeyHandle> AutokeyConnection::ListKeyHandles(
    google::cloud::kms::v1::ListKeyHandlesRequest) {  // NOLINT(performance-unnecessary-value-param)
...
AutokeyConnection::GetLocation(
    google::cloud::location::GetLocationRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

StatusOr<google::iam::v1::Policy>
AutokeyConnection::SetIamPolicy(
    google::iam::v1::SetIamPolicyRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

StatusOr<google::iam::v1::Policy>
AutokeyConnection::GetIamPolicy(
...
StatusOr<google::longrunning::Operation>
AutokeyConnection::GetOperation(
...
std::shared_ptr<AutokeyConnection> MakeAutokeyConnection(
  ...
  options = kms_v1_internal::AutokeyDefaultOptions(
      std::move(options));
  auto background = internal::MakeBackgroundThreadsFactory(options)();
  auto auth = internal::CreateAuthenticationStrategy(background->cq(), options);
  auto stub = kms_v1_internal::CreateDefaultAutokeyStub(
