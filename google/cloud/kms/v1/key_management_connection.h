...
/**
 * A retry policy for `KeyManagementServiceConnection` that stops retrying after
...
class KeyManagementServiceLimitedErrorCountRetryPolicy
 ...
 public:
  KeyManagementServiceLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `KeyManagementServiceConnection` that stops retrying
