 ...
 private:
  ...
  std::unique_ptr<BackoffPolicy> backoff_policy() {
    ...
    if (options.has<kms::KeyManagementServiceBackoffPolicyOption>()) {
      return options.get<kms::KeyManagementServiceBackoffPolicyOption>()->clone();
    }
    return backoff_policy_prototype_->clone();
  }

  std::unique_ptr<kms::KeyManagementServiceConnectionIdempotencyPolicy> idempotency_policy() {
    auto const& options = internal::CurrentOptions();
    if (options.has<kms::KeyManagementServiceConnectionIdempotencyPolicyOption>()) {
      return options.get<kms::KeyManagementServiceConnectionIdempotencyPolicyOption>()->clone();
    }
  ...
  std::unique_ptr<kms::KeyManagementServiceRetryPolicy const> retry_policy_prototype_;
  std::unique_ptr<BackoffPolicy const> backoff_policy_prototype_;
  std::unique_ptr<kms::KeyManagementServiceConnectionIdempotencyPolicy> idempotency_policy_;
};
