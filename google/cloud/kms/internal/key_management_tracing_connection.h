...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_KMS_INTERNAL_KEY_MANAGEMENT_TRACING_CONNECTION_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_KMS_INTERNAL_KEY_MANAGEMENT_TRACING_CONNECTION_H
...
class KeyManagementServiceTracingConnection
 ...
 private:
  std::shared_ptr<kms::KeyManagementServiceConnection> child_;
};
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_KMS_INTERNAL_KEY_MANAGEMENT_TRACING_CONNECTION_H
