...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_KMS_INTERNAL_EKM_TRACING_CONNECTION_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_KMS_INTERNAL_EKM_TRACING_CONNECTION_H
...
class EkmServiceTracingConnection : public kms::EkmServiceConnection {
 public:
  ~EkmServiceTracingConnection() override = default;

  explicit EkmServiceTracingConnection(
      std::shared_ptr<kms::EkmServiceConnection> child);
 ...
 private:
  std::shared_ptr<kms::EkmServiceConnection> child_;
};
 ...
 */
std::shared_ptr<kms::EkmServiceConnection> MakeEkmServiceTracingConnection(
    std::shared_ptr<kms::EkmServiceConnection> conn);
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_KMS_INTERNAL_EKM_TRACING_CONNECTION_H
