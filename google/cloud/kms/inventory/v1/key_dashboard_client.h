...
class KeyDashboardServiceClient {
 public:
  ...
  ///
  /// @param parent  Required. The Google Cloud project for which to retrieve
  /// key metadata, in
  ///  the format `projects/*`
  ...
  /// @googleapis_reference_link{google/cloud/kms/inventory/v1/key_dashboard_service.proto#L52}
  ...
  ///
  /// @param request
  /// @googleapis_link{google::cloud::kms::inventory::v1::ListCryptoKeysRequest,google/cloud/kms/inventory/v1/key_dashboard_service.proto#L52}
  /// @param opts Optional. Override the class-level options, such as retry and
  ///     backoff policies.
  /// @return
  /// @googleapis_link{google::cloud::kms::v1::CryptoKey,google/cloud/kms/v1/resources.proto#L58}
