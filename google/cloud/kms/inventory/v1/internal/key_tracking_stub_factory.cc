...
std::shared_ptr<KeyTrackingServiceStub> CreateDefaultKeyTrackingServiceStub(
  ...
  auto endpoint = internal::DetermineServiceEndpoint(
      internal::GetEnv("GOOGLE_CLOUD_CPP_KEY_TRACKING_SERVICE_ENDPOINT"),
  ...
  if (!endpoint.ok()) {
    ...
    stub = std::make_shared<DefaultKeyTrackingServiceStub>(
  ...
  if (internal::TracingEnabled(options)) {
    stub = MakeKeyTrackingServiceTracingStub(std::move(stub));
  }
  return stub;
}
