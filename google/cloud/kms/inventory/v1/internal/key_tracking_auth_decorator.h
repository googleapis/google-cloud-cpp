...
class KeyTrackingServiceAuth : public KeyTrackingServiceStub {
 public:
  ~KeyTrackingServiceAuth() override = default;
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_KMS_INVENTORY_V1_INTERNAL_KEY_TRACKING_AUTH_DECORATOR_H
