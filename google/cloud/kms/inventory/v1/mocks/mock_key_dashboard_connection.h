 ...
 * including errors, from an object of type `KeyDashboardServiceClient`. To do so,
 * construct an object of type `KeyDashboardServiceClient` with an instance of this
 ...
 */
class MockKeyDashboardServiceConnection : public kms_inventory_v1::KeyDashboardServiceConnection {
 public:
  MOCK_METHOD(Options, options, (), (override));

  MOCK_METHOD((StreamRange<google::cloud::kms::v1::CryptoKey>),
  ListCryptoKeys,
  (google::cloud::kms::inventory::v1::ListCryptoKeysRequest request), (override));
};
