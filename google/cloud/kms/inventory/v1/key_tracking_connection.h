...
/**
 * A retry policy for `KeyTrackingServiceConnection` that stops retrying after a
...
class KeyTrackingServiceLimitedErrorCountRetryPolicy
 ...
 public:
  KeyTrackingServiceLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `KeyTrackingServiceConnection` that stops retrying after
