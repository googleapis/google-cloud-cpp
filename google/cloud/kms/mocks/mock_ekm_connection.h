...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_KMS_MOCKS_MOCK_EKM_CONNECTION_H
 ...
 * including errors from a `EkmServiceClient`. To do so, construct a
 * `EkmServiceClient` with an instance of this class. Then use the Google
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_KMS_MOCKS_MOCK_EKM_CONNECTION_H
