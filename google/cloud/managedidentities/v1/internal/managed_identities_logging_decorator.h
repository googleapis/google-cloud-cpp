...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_MANAGEDIDENTITIES_V1_INTERNAL_MANAGED_IDENTITIES_LOGGING_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_MANAGEDIDENTITIES_V1_INTERNAL_MANAGED_IDENTITIES_LOGGING_DECORATOR_H
...
class ManagedIdentitiesServiceLogging : public ManagedIdentitiesServiceStub {
 public:
  ...
  ManagedIdentitiesServiceLogging(std::shared_ptr<ManagedIdentitiesServiceStub> child,
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_MANAGEDIDENTITIES_V1_INTERNAL_MANAGED_IDENTITIES_LOGGING_DECORATOR_H
