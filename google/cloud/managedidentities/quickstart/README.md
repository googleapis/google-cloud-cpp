# HOWTO: using the Managed Service for Microsoft Active Directory API C++ client in your project

This directory contains small examples showing how to use the Managed Service for Microsoft Active Directory API C++
...
Like most Google Cloud Platform (GCP) services, Managed Service for Microsoft Active Directory API requires that
...
1. Install the dependencies with your favorite tools. As an example, if you use
   ...
   ```bash
   cd $HOME/vcpkg
   ./vcpkg install google-cloud-cpp[core,managedidentities]
   ```
...
1. Configure CMake, if necessary, configure the directory where you installed
   ...
   ```bash
   cd $HOME/gooogle-cloud-cpp/google/cloud/managedidentities/quickstart
...
[quickstart-link]: https://cloud.google.com/managed-microsoft-ad/docs/quickstarts
