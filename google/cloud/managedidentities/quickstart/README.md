...
for Microsoft Active Directory API C++ client library in your own project. These
...
Like most Google Cloud Platform (GCP) services, Managed Service for Microsoft
