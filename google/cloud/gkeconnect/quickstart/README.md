# HOWTO: using the Connect Gateway API C++ client in your project

This directory contains small examples showing how to use the Connect Gateway
...
1. Compile this example using Bazel:
   ...
   ```bash
   cd $HOME/google-cloud-cpp/google/cloud/gkeconnect/quickstart
   bazel build ...
   ```
...
1. Install the dependencies with your favorite tools. As an example, if you use
   ...
   ```bash
   cd $HOME/vcpkg
   ./vcpkg install google-cloud-cpp[core,gkeconnect]
   ```
...
[quickstart-link]: https://cloud.google.com/kubernetes-engine/fleet-management/docs/connect-agent/audit-logging-gateway
