...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_BIGQUERYCONTROL_ROUTINE_V2_INTERNAL_ROUTINE_TRACING_CONNECTION_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_BIGQUERYCONTROL_ROUTINE_V2_INTERNAL_ROUTINE_TRACING_CONNECTION_H
...
class RoutineServiceTracingConnection
 ...
 private:
  std::shared_ptr<bigquerycontrol_routine_v2::RoutineServiceConnection> child_;
};
...
MakeRoutineServiceTracingConnection(
    std::shared_ptr<bigquerycontrol_routine_v2::RoutineServiceConnection> conn);
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_BIGQUERYCONTROL_ROUTINE_V2_INTERNAL_ROUTINE_TRACING_CONNECTION_H
