...
#include "google/cloud/bigquerycontrol/job/v2/internal/job_tracing_connection.h"
...
JobServiceTracingConnection::JobServiceTracingConnection(
    std::shared_ptr<bigquerycontrol_job_v2::JobServiceConnection> child)
...
JobServiceTracingConnection::CancelJob(
  ...
  auto span = internal::MakeSpan(
      "bigquerycontrol_job_v2::JobServiceConnection::CancelJob");
...
StatusOr<google::cloud::bigquery::v2::Job> JobServiceTracingConnection::GetJob(
  ...
  auto span = internal::MakeSpan(
      "bigquerycontrol_job_v2::JobServiceConnection::GetJob");
  auto scope = opentelemetry::trace::Scope(span);
...
JobServiceTracingConnection::InsertJob(
  ...
  auto span = internal::MakeSpan(
      "bigquerycontrol_job_v2::JobServiceConnection::InsertJob");
  auto scope = opentelemetry::trace::Scope(span);
...
Status JobServiceTracingConnection::DeleteJob(
  ...
  auto span = internal::MakeSpan(
      "bigquerycontrol_job_v2::JobServiceConnection::DeleteJob");
  auto scope = opentelemetry::trace::Scope(span);
...
JobServiceTracingConnection::ListJobs(
  ...
  auto span = internal::MakeSpan(
      "bigquerycontrol_job_v2::JobServiceConnection::ListJobs");
...
JobServiceTracingConnection::GetQueryResults(
  ...
  auto span = internal::MakeSpan(
      "bigquerycontrol_job_v2::JobServiceConnection::GetQueryResults");
  auto scope = opentelemetry::trace::Scope(span);
...
JobServiceTracingConnection::Query(
  ...
  auto span =
      internal::MakeSpan("bigquerycontrol_job_v2::JobServiceConnection::Query");
  auto scope = opentelemetry::trace::Scope(span);
...
std::shared_ptr<bigquerycontrol_job_v2::JobServiceConnection>
MakeJobServiceTracingConnection(
    std::shared_ptr<bigquerycontrol_job_v2::JobServiceConnection> conn) {
#ifdef GOOGLE_CLOUD_CPP_HAVE_OPENTELEMETRY
