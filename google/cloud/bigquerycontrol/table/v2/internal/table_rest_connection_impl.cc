...
#include "google/cloud/bigquerycontrol/table/v2/internal/table_rest_connection_impl.h"
#include "google/cloud/bigquerycontrol/table/v2/internal/table_rest_stub_factory.h"
...
TableServiceRestConnectionImpl::ListTables(
  ...
  return google::cloud::internal::MakePaginationRange<
      ...
      [idempotency, function_name, stub = stub_,
       retry =
           std::shared_ptr<bigquerycontrol_table_v2::TableServiceRetryPolicy>(
