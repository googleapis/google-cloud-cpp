...
#include "google/cloud/bigquerycontrol/model/v2/model_connection.h"
...
class ModelServiceTracingConnection
    : public bigquerycontrol_model_v2::ModelServiceConnection {
 public:
 ...
 private:
  std::shared_ptr<bigquerycontrol_model_v2::ModelServiceConnection> child_;
};
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_BIGQUERYCONTROL_MODEL_V2_INTERNAL_MODEL_TRACING_CONNECTION_H
