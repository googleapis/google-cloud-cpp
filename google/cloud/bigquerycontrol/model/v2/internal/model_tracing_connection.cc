...
ModelServiceTracingConnection::ModelServiceTracingConnection(
    std::shared_ptr<bigquerycontrol_model_v2::ModelServiceConnection> child)
...
ModelServiceTracingConnection::GetModel(
  ...
  auto span = internal::MakeSpan(
      "bigquerycontrol_model_v2::ModelServiceConnection::GetModel");
...
ModelServiceTracingConnection::ListModels(
  ...
  auto span = internal::MakeSpan(
      "bigquerycontrol_model_v2::ModelServiceConnection::ListModels");
...
ModelServiceTracingConnection::PatchModel(
  ...
  auto span = internal::MakeSpan(
      "bigquerycontrol_model_v2::ModelServiceConnection::PatchModel");
  auto scope = opentelemetry::trace::Scope(span);
...
Status ModelServiceTracingConnection::DeleteModel(
  ...
  auto span = internal::MakeSpan(
      "bigquerycontrol_model_v2::ModelServiceConnection::DeleteModel");
  auto scope = opentelemetry::trace::Scope(span);
...
std::shared_ptr<bigquerycontrol_model_v2::ModelServiceConnection>
MakeModelServiceTracingConnection(
    std::shared_ptr<bigquerycontrol_model_v2::ModelServiceConnection> conn) {
#ifdef GOOGLE_CLOUD_CPP_HAVE_OPENTELEMETRY
