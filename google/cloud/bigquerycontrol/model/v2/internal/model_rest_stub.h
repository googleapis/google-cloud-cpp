...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_BIGQUERYCONTROL_MODEL_V2_INTERNAL_MODEL_REST_STUB_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_BIGQUERYCONTROL_MODEL_V2_INTERNAL_MODEL_REST_STUB_H
...
class ModelServiceRestStub {
 public:
  virtual ~ModelServiceRestStub() = default;
...
class DefaultModelServiceRestStub : public ModelServiceRestStub {
 public:
  ~DefaultModelServiceRestStub() override = default;

  explicit DefaultModelServiceRestStub(Options options);
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_BIGQUERYCONTROL_MODEL_V2_INTERNAL_MODEL_REST_STUB_H
