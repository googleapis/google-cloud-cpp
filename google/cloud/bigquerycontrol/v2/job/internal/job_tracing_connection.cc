...
JobServiceTracingConnection::JobServiceTracingConnection(
    std::shared_ptr<bigquerycontrol_v2_job::JobServiceConnection> child)
...
JobServiceTracingConnection::CancelJob(
  ...
  auto span = internal::MakeSpan(
      "bigquerycontrol_v2_job::JobServiceConnection::CancelJob");
...
StatusOr<google::cloud::bigquery::v2::Job> JobServiceTracingConnection::GetJob(
  ...
  auto span = internal::MakeSpan(
      "bigquerycontrol_v2_job::JobServiceConnection::GetJob");
  auto scope = opentelemetry::trace::Scope(span);
...
JobServiceTracingConnection::InsertJob(
  ...
  auto span = internal::MakeSpan(
      "bigquerycontrol_v2_job::JobServiceConnection::InsertJob");
  auto scope = opentelemetry::trace::Scope(span);
...
Status JobServiceTracingConnection::DeleteJob(
  ...
  auto span = internal::MakeSpan(
      "bigquerycontrol_v2_job::JobServiceConnection::DeleteJob");
  auto scope = opentelemetry::trace::Scope(span);
...
JobServiceTracingConnection::ListJobs(
  ...
  auto span = internal::MakeSpan(
      "bigquerycontrol_v2_job::JobServiceConnection::ListJobs");
...
JobServiceTracingConnection::GetQueryResults(
  ...
  auto span = internal::MakeSpan(
      "bigquerycontrol_v2_job::JobServiceConnection::GetQueryResults");
  auto scope = opentelemetry::trace::Scope(span);
...
JobServiceTracingConnection::Query(
  ...
  auto span =
      internal::MakeSpan("bigquerycontrol_v2_job::JobServiceConnection::Query");
  auto scope = opentelemetry::trace::Scope(span);
...
std::shared_ptr<bigquerycontrol_v2_job::JobServiceConnection>
MakeJobServiceTracingConnection(
    std::shared_ptr<bigquerycontrol_v2_job::JobServiceConnection> conn) {
#ifdef GOOGLE_CLOUD_CPP_HAVE_OPENTELEMETRY
