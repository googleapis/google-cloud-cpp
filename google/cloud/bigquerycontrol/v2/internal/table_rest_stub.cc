...
DefaultTableServiceRestStub::GetTable(
  ...
  return rest_internal::Get<google::cloud::bigquery::v2::Table>(
      *service_, rest_context, request, false,
      absl::StrCat("/", "bigquery", "/", rest_internal::DetermineApiVersion("v2", options), "/", "projects", "/", request.project_id(), "/", "datasets", "/", request.dataset_id(), "/", "tables", "/", request.table_id()), std::move(query_params));
}
...
DefaultTableServiceRestStub::InsertTable(
  ...
  return rest_internal::Post<google::cloud::bigquery::v2::Table>(
      *service_, rest_context, request.table(), false,
      absl::StrCat("/", "bigquery", "/", rest_internal::DetermineApiVersion("v2", options), "/", "projects", "/", request.project_id(), "/", "datasets", "/", request.dataset_id(), "/", "tables"), std::move(query_params));
}
...
DefaultTableServiceRestStub::PatchTable(
  ...
  std::vector<std::pair<std::string, std::string>> query_params;
  query_params.push_back({"autodetect_schema", (request.autodetect_schema() ? "1" : "0")});
  query_params = rest_internal::TrimEmptyQueryParameters(std::move(query_params));
