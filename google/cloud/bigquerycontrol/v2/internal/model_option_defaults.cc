...
Options ModelServiceDefaultOptions(Options options) {
  ...
  if (!options.has<bigquerycontrol_v2::ModelServiceBackoffPolicyOption>()) {
    options.set<bigquerycontrol_v2::ModelServiceBackoffPolicyOption>(
        ExponentialBackoffPolicy(std::chrono::seconds(0), std::chrono::seconds(1),
            std::chrono::minutes(5), kBackoffScaling, kBackoffScaling).clone());
  }
  if (!options.has<bigquerycontrol_v2::ModelServiceConnectionIdempotencyPolicyOption>()) {
    options.set<bigquerycontrol_v2::ModelServiceConnectionIdempotencyPolicyOption>(
        bigquerycontrol_v2::MakeDefaultModelServiceConnectionIdempotencyPolicy());
  }
