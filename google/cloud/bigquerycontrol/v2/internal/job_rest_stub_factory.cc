...
#include "google/cloud/bigquerycontrol/v2/internal/job_rest_logging_decorator.h"
...
std::shared_ptr<JobServiceRestStub>
CreateDefaultJobServiceRestStub(Options const& options) {
