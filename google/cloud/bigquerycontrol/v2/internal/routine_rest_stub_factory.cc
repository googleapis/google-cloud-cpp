...
#include "google/cloud/bigquerycontrol/v2/internal/routine_rest_logging_decorator.h"
...
std::shared_ptr<RoutineServiceRestStub>
CreateDefaultRoutineServiceRestStub(Options const& options) {
