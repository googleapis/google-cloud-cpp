...
class ModelServiceRestConnectionImpl
 ...
 private:
  ...
  std::shared_ptr<bigquerycontrol_v2_internal::ModelServiceRestStub> stub_;
  Options options_;
};
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_BIGQUERYCONTROL_V2_INTERNAL_MODEL_REST_CONNECTION_IMPL_H
