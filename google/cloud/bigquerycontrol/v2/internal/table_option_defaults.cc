...
Options TableServiceDefaultOptions(Options options) {
  options = internal::PopulateCommonOptions(
      ...
      "", "GOOGLE_CLOUD_CPP_TABLE_SERVICE_AUTHORITY",
  ...
  if (!options.has<bigquerycontrol_v2::TableServiceConnectionIdempotencyPolicyOption>()) {
    options.set<bigquerycontrol_v2::TableServiceConnectionIdempotencyPolicyOption>(
        bigquerycontrol_v2::MakeDefaultTableServiceConnectionIdempotencyPolicy());
  }
