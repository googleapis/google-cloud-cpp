...
#include "google/cloud/bigquerycontrol/v2/internal/dataset_rest_logging_decorator.h"
...
std::shared_ptr<DatasetServiceRestStub>
CreateDefaultDatasetServiceRestStub(Options const& options) {
