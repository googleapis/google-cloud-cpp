...
TableServiceTracingConnection::GetTable(
  ...
  auto span = internal::MakeSpan(
      "bigquerycontrol_v2_table::TableServiceConnection::GetTable");
...
TableServiceTracingConnection::InsertTable(
  ...
  auto span = internal::MakeSpan(
      "bigquerycontrol_v2_table::TableServiceConnection::InsertTable");
  auto scope = opentelemetry::trace::Scope(span);
...
TableServiceTracingConnection::PatchTable(
  ...
  auto span = internal::MakeSpan(
      "bigquerycontrol_v2_table::TableServiceConnection::PatchTable");
  auto scope = opentelemetry::trace::Scope(span);
...
TableServiceTracingConnection::UpdateTable(
    google::cloud::bigquery::v2::UpdateOrPatchTableRequest const& request) {
  auto span = internal::MakeSpan(
      "bigquerycontrol_v2_table::TableServiceConnection::UpdateTable");
  auto scope = opentelemetry::trace::Scope(span);
...
Status TableServiceTracingConnection::DeleteTable(
  ...
  auto span = internal::MakeSpan(
      "bigquerycontrol_v2_table::TableServiceConnection::DeleteTable");
  auto scope = opentelemetry::trace::Scope(span);
...
TableServiceTracingConnection::ListTables(
  ...
  auto span = internal::MakeSpan(
      "bigquerycontrol_v2_table::TableServiceConnection::ListTables");
