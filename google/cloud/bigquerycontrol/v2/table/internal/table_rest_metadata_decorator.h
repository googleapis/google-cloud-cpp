...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_BIGQUERYCONTROL_V2_TABLE_INTERNAL_TABLE_REST_METADATA_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_BIGQUERYCONTROL_V2_TABLE_INTERNAL_TABLE_REST_METADATA_DECORATOR_H
...
class TableServiceRestMetadata : public TableServiceRestStub {
 public:
  ~TableServiceRestMetadata() override = default;
  explicit TableServiceRestMetadata(std::shared_ptr<TableServiceRestStub> child,
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_BIGQUERYCONTROL_V2_TABLE_INTERNAL_TABLE_REST_METADATA_DECORATOR_H
