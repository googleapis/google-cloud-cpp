...
#include "google/cloud/bigquerycontrol/v2/table/internal/table_option_defaults.h"
#include "google/cloud/bigquerycontrol/v2/table/internal/table_tracing_connection.h"
