...
RoutineServiceTracingConnection::RoutineServiceTracingConnection(
    std::shared_ptr<bigquerycontrol_v2_routine::RoutineServiceConnection> child)
...
RoutineServiceTracingConnection::GetRoutine(
  ...
  auto span = internal::MakeSpan(
      "bigquerycontrol_v2_routine::RoutineServiceConnection::GetRoutine");
...
RoutineServiceTracingConnection::InsertRoutine(
  ...
  auto span = internal::MakeSpan(
      "bigquerycontrol_v2_routine::RoutineServiceConnection::InsertRoutine");
  auto scope = opentelemetry::trace::Scope(span);
...
RoutineServiceTracingConnection::UpdateRoutine(
  ...
  auto span = internal::MakeSpan(
      "bigquerycontrol_v2_routine::RoutineServiceConnection::UpdateRoutine");
  auto scope = opentelemetry::trace::Scope(span);
...
RoutineServiceTracingConnection::PatchRoutine(
  ...
  auto span = internal::MakeSpan(
      "bigquerycontrol_v2_routine::RoutineServiceConnection::PatchRoutine");
  auto scope = opentelemetry::trace::Scope(span);
...
Status RoutineServiceTracingConnection::DeleteRoutine(
  ...
  auto span = internal::MakeSpan(
      "bigquerycontrol_v2_routine::RoutineServiceConnection::DeleteRoutine");
  auto scope = opentelemetry::trace::Scope(span);
...
RoutineServiceTracingConnection::ListRoutines(
  ...
  auto span = internal::MakeSpan(
      "bigquerycontrol_v2_routine::RoutineServiceConnection::ListRoutines");
  auto scope = opentelemetry::trace::Scope(span);
...
std::shared_ptr<bigquerycontrol_v2_routine::RoutineServiceConnection>
