...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_BIGQUERYCONTROL_V2_MOCKS_MOCK_ROUTINE_CONNECTION_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_BIGQUERYCONTROL_V2_MOCKS_MOCK_ROUTINE_CONNECTION_H
...
/**
 * A class to mock `RoutineServiceConnection`.
 *
 * Application developers may want to test their code with simulated responses,
 * including errors, from an object of type `RoutineServiceClient`. To do so,
 * construct an object of type `RoutineServiceClient` with an instance of this
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_BIGQUERYCONTROL_V2_MOCKS_MOCK_ROUTINE_CONNECTION_H
