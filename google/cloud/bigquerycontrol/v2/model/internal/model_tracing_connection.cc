...
#include "google/cloud/bigquerycontrol/v2/model/internal/model_tracing_connection.h"
...
ModelServiceTracingConnection::GetModel(
  ...
  auto span = internal::MakeSpan(
      "bigquerycontrol_v2_model::ModelServiceConnection::GetModel");
...
ModelServiceTracingConnection::ListModels(
  ...
  auto span = internal::MakeSpan(
      "bigquerycontrol_v2_model::ModelServiceConnection::ListModels");
  internal::OTelScope scope(span);
  auto sr = child_->ListModels(std::move(request));
  return internal::MakeTracedStreamRange<google::cloud::bigquery::v2::Model>(
...
ModelServiceTracingConnection::PatchModel(
  ...
  auto span = internal::MakeSpan(
      "bigquerycontrol_v2_model::ModelServiceConnection::PatchModel");
  auto scope = opentelemetry::trace::Scope(span);
...
Status ModelServiceTracingConnection::DeleteModel(
  ...
  auto span = internal::MakeSpan(
      "bigquerycontrol_v2_model::ModelServiceConnection::DeleteModel");
  auto scope = opentelemetry::trace::Scope(span);
