...
// clang-format off
// main-dox-marker: bigquerycontrol_v2::ModelServiceClient
// clang-format on
namespace {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto c2 = google::cloud::bigquerycontrol_v2::ModelServiceClient(connection);
  ...
  //     .set<google::cloud::bigquerycontrol_v2::ModelServiceRetryPolicyOption>(
  //       google::cloud::bigquerycontrol_v2::ModelServiceLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
