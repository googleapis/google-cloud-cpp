...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::bigquerycontrol_v2::ProjectServiceClient(
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::bigquerycontrol_v2::ProjectServiceClient(
      google::cloud::bigquerycontrol_v2::MakeProjectServiceConnection(
          ud_options));
