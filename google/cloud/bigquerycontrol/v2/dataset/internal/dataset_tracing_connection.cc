...
DatasetServiceTracingConnection::DatasetServiceTracingConnection(
    std::shared_ptr<bigquerycontrol_v2_dataset::DatasetServiceConnection> child)
...
DatasetServiceTracingConnection::GetDataset(
  ...
  auto span = internal::MakeSpan(
      "bigquerycontrol_v2_dataset::DatasetServiceConnection::GetDataset");
...
DatasetServiceTracingConnection::InsertDataset(
  ...
  auto span = internal::MakeSpan(
      "bigquerycontrol_v2_dataset::DatasetServiceConnection::InsertDataset");
  auto scope = opentelemetry::trace::Scope(span);
...
DatasetServiceTracingConnection::PatchDataset(
  ...
  auto span = internal::MakeSpan(
      "bigquerycontrol_v2_dataset::DatasetServiceConnection::PatchDataset");
  auto scope = opentelemetry::trace::Scope(span);
...
DatasetServiceTracingConnection::UpdateDataset(
    google::cloud::bigquery::v2::UpdateOrPatchDatasetRequest const& request) {
  auto span = internal::MakeSpan(
      "bigquerycontrol_v2_dataset::DatasetServiceConnection::UpdateDataset");
  auto scope = opentelemetry::trace::Scope(span);
...
Status DatasetServiceTracingConnection::DeleteDataset(
  ...
  auto span = internal::MakeSpan(
      "bigquerycontrol_v2_dataset::DatasetServiceConnection::DeleteDataset");
  auto scope = opentelemetry::trace::Scope(span);
...
DatasetServiceTracingConnection::ListDatasets(
  ...
  auto span = internal::MakeSpan(
      "bigquerycontrol_v2_dataset::DatasetServiceConnection::ListDatasets");
...
DatasetServiceTracingConnection::UndeleteDataset(
  ...
  auto span = internal::MakeSpan(
      "bigquerycontrol_v2_dataset::DatasetServiceConnection::UndeleteDataset");
  auto scope = opentelemetry::trace::Scope(span);
