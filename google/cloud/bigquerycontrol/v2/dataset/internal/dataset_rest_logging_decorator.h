...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_BIGQUERYCONTROL_V2_DATASET_INTERNAL_DATASET_REST_LOGGING_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_BIGQUERYCONTROL_V2_DATASET_INTERNAL_DATASET_REST_LOGGING_DECORATOR_H
...
class DatasetServiceRestLogging : public DatasetServiceRestStub {
 public:
  ~DatasetServiceRestLogging() override = default;
  DatasetServiceRestLogging(std::shared_ptr<DatasetServiceRestStub> child,
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_BIGQUERYCONTROL_V2_DATASET_INTERNAL_DATASET_REST_LOGGING_DECORATOR_H
