# HOWTO: using the BigQuery API C++ client in your project

This directory contains small examples showing how to use the BigQuery API C++
...
1. Compile this example using Bazel:
   ...
   ```bash
   cd $HOME/google-cloud-cpp/google/cloud/bigquerycontrol/quickstart
   bazel build ...
   ```
...
[quickstart-link]: https://cloud.google.com/bigquery/docs/quickstarts/quickstart-web-ui
