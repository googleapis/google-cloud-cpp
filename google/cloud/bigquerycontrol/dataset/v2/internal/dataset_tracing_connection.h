...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_BIGQUERYCONTROL_DATASET_V2_INTERNAL_DATASET_TRACING_CONNECTION_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_BIGQUERYCONTROL_DATASET_V2_INTERNAL_DATASET_TRACING_CONNECTION_H
...
class DatasetServiceTracingConnection
 ...
 private:
  std::shared_ptr<bigquerycontrol_dataset_v2::DatasetServiceConnection> child_;
};
...
MakeDatasetServiceTracingConnection(
    std::shared_ptr<bigquerycontrol_dataset_v2::DatasetServiceConnection> conn);
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_BIGQUERYCONTROL_DATASET_V2_INTERNAL_DATASET_TRACING_CONNECTION_H
