...
#include "google/cloud/bigquerycontrol/dataset/v2/internal/dataset_tracing_connection.h"
...
DatasetServiceTracingConnection::DatasetServiceTracingConnection(
    std::shared_ptr<bigquerycontrol_dataset_v2::DatasetServiceConnection> child)
...
DatasetServiceTracingConnection::GetDataset(
  ...
  auto span = internal::MakeSpan(
      "bigquerycontrol_dataset_v2::DatasetServiceConnection::GetDataset");
...
DatasetServiceTracingConnection::InsertDataset(
  ...
  auto span = internal::MakeSpan(
      "bigquerycontrol_dataset_v2::DatasetServiceConnection::InsertDataset");
  auto scope = opentelemetry::trace::Scope(span);
...
DatasetServiceTracingConnection::PatchDataset(
  ...
  auto span = internal::MakeSpan(
      "bigquerycontrol_dataset_v2::DatasetServiceConnection::PatchDataset");
  auto scope = opentelemetry::trace::Scope(span);
...
DatasetServiceTracingConnection::UpdateDataset(
    google::cloud::bigquery::v2::UpdateOrPatchDatasetRequest const& request) {
  auto span = internal::MakeSpan(
      "bigquerycontrol_dataset_v2::DatasetServiceConnection::UpdateDataset");
  auto scope = opentelemetry::trace::Scope(span);
...
Status DatasetServiceTracingConnection::DeleteDataset(
  ...
  auto span = internal::MakeSpan(
      "bigquerycontrol_dataset_v2::DatasetServiceConnection::DeleteDataset");
  auto scope = opentelemetry::trace::Scope(span);
...
DatasetServiceTracingConnection::ListDatasets(
  ...
  auto span = internal::MakeSpan(
      "bigquerycontrol_dataset_v2::DatasetServiceConnection::ListDatasets");
...
DatasetServiceTracingConnection::UndeleteDataset(
  ...
  auto span = internal::MakeSpan(
      "bigquerycontrol_dataset_v2::DatasetServiceConnection::UndeleteDataset");
  auto scope = opentelemetry::trace::Scope(span);
...
std::shared_ptr<bigquerycontrol_dataset_v2::DatasetServiceConnection>
