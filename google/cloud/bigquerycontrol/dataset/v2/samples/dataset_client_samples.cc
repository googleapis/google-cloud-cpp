...
// clang-format off
// main-dox-marker: bigquerycontrol_dataset_v2::DatasetServiceClient
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::bigquerycontrol_dataset_v2::DatasetServiceClient(
      google::cloud::bigquerycontrol_dataset_v2::
...
class CustomIdempotencyPolicy
    : public google::cloud::bigquerycontrol_dataset_v2::
          DatasetServiceConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::bigquerycontrol_dataset_v2::
                      DatasetServiceConnectionIdempotencyPolicy>
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
                     .set<google::cloud::bigquerycontrol_dataset_v2::
                     ...
                     .set<google::cloud::bigquerycontrol_dataset_v2::
                         ...
                         google::cloud::ExponentialBackoffPolicy(
                             ...
                             /*scaling=*/2.0)
                             .clone());
  auto connection = google::cloud::bigquerycontrol_dataset_v2::
      MakeDatasetServiceConnectionRest(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::bigquerycontrol_dataset_v2::DatasetServiceClient(
      connection);
  auto c2 = google::cloud::bigquerycontrol_dataset_v2::DatasetServiceClient(
      connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::bigquerycontrol_dataset_v2::DatasetServiceClient(
      connection,
  ...
  //     .set<google::cloud::bigquerycontrol_dataset_v2::DatasetServiceRetryPolicyOption>(
  //       google::cloud::bigquerycontrol_dataset_v2::DatasetServiceLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::bigquerycontrol_dataset_v2::DatasetServiceClient(
        google::cloud::bigquerycontrol_dataset_v2::
            MakeDatasetServiceConnectionRest(options));
  }
  //! [with-service-account]
