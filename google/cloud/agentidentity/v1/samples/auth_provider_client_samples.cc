...
// clang-format off
// main-dox-marker: agentidentity_v1::AuthProviderServiceClient
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::agentidentity_v1::AuthProviderServiceClient(
      google::cloud::agentidentity_v1::MakeAuthProviderServiceConnection(
          options));
  //! [set-client-endpoint]
}
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::agentidentity_v1::AuthProviderServiceClient(
      google::cloud::agentidentity_v1::MakeAuthProviderServiceConnection(
          *ud_options));
  //! [set-client-universe-domain]
}
...
class CustomIdempotencyPolicy
    : public google::cloud::agentidentity_v1::
          AuthProviderServiceConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::agentidentity_v1::
                      AuthProviderServiceConnectionIdempotencyPolicy>
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options =
      google::cloud::Options{}
          .set<google::cloud::agentidentity_v1::
                   AuthProviderServiceConnectionIdempotencyPolicyOption>(
              CustomIdempotencyPolicy().clone())
          .set<google::cloud::agentidentity_v1::
                   AuthProviderServiceRetryPolicyOption>(
              google::cloud::agentidentity_v1::
                  AuthProviderServiceLimitedErrorCountRetryPolicy(3)
                      .clone())
          .set<google::cloud::agentidentity_v1::
  ...
  auto c1 =
      google::cloud::agentidentity_v1::AuthProviderServiceClient(connection);
  auto c2 =
      google::cloud::agentidentity_v1::AuthProviderServiceClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::agentidentity_v1::AuthProviderServiceClient(
  ...
  //     .set<google::cloud::agentidentity_v1::AuthProviderServiceRetryPolicyOption>(
  //       google::cloud::agentidentity_v1::AuthProviderServiceLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::agentidentity_v1::AuthProviderServiceClient(
        google::cloud::agentidentity_v1::MakeAuthProviderServiceConnection(
            options));
  }
  //! [with-service-account]
