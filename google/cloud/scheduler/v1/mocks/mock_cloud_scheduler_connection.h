...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SCHEDULER_V1_MOCKS_MOCK_CLOUD_SCHEDULER_CONNECTION_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SCHEDULER_V1_MOCKS_MOCK_CLOUD_SCHEDULER_CONNECTION_H
 ...
 */
class MockCloudSchedulerConnection : public scheduler_v1::CloudSchedulerConnection {
 public:
  MOCK_METHOD(Options, options, (), (override));

  MOCK_METHOD((StreamRange<google::cloud::scheduler::v1::Job>),
  ListJobs,
  (google::cloud::scheduler::v1::ListJobsRequest request), (override));

  MOCK_METHOD(StatusOr<google::cloud::scheduler::v1::Job>,
  GetJob,
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SCHEDULER_V1_MOCKS_MOCK_CLOUD_SCHEDULER_CONNECTION_H
