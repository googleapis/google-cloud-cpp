...
/**
 * A retry policy for `CloudSchedulerConnection` that stops retrying after a
...
class CloudSchedulerLimitedErrorCountRetryPolicy
 ...
 public:
  CloudSchedulerLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `CloudSchedulerConnection` that stops retrying after
