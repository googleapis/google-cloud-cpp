...
[Cloud Scheduler API][cloud-service-docs], a service that Creates and manages jobs run on a regular recurring schedule.
...
```cc
#include "google/cloud/scheduler/ EDIT HERE .h"
#include <iostream>
#include <stdexcept>
...
int main(int argc, char* argv[]) try {
  ...
  auto client = scheduler::Client(
      scheduler::MakeConnection(/* EDIT HERE */));
