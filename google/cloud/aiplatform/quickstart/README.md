# HOWTO: using the Vertex AI API C++ client in your project

This directory contains small examples showing how to use the Vertex AI API C++
...
Like most Google Cloud Platform (GCP) services, Vertex AI API requires that
...
1. Install the dependencies with your favorite tools. As an example, if you use
   ...
   ```bash
   cd $HOME/vcpkg
   ./vcpkg install google-cloud-cpp[core,aiplatform]
   ```
...
[quickstart-link]: https://cloud.google.com/aiplatform/docs/quickstart
