...
/**
 * A retry policy for `ModelServiceConnection` that stops retrying after a
...
class ModelServiceLimitedErrorCountRetryPolicy
 ...
 public:
  ModelServiceLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `ModelServiceConnection` that stops retrying after
