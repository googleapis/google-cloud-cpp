...
/**
 * A retry policy for `MatchServiceConnection` that stops retrying after a
...
class MatchServiceLimitedErrorCountRetryPolicy
 ...
 public:
  MatchServiceLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `MatchServiceConnection` that stops retrying after
