...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::aiplatform_v1::ModelGardenServiceClient(
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::aiplatform_v1::ModelGardenServicePollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::aiplatform_v1::ModelGardenServiceRetryPolicyOption::Type,
            google::cloud::aiplatform_v1::ModelGardenServiceBackoffPolicyOption::Type>(
            google::cloud::aiplatform_v1::ModelGardenServiceLimitedTimeRetryPolicy(
