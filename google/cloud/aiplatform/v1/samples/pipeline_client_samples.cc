...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::aiplatform_v1::PipelineServiceClient(
      google::cloud::aiplatform_v1::MakePipelineServiceConnection("unused",
                                                                  options));
  //! [set-client-endpoint]
}
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::aiplatform_v1::PipelineServiceClient(
      google::cloud::aiplatform_v1::MakePipelineServiceConnection(*ud_options));
  //! [set-client-universe-domain]
}
...
class CustomIdempotencyPolicy : public google::cloud::aiplatform_v1::
 ...
 public:
  ...
  std::unique_ptr<
      google::cloud::aiplatform_v1::PipelineServiceConnectionIdempotencyPolicy>
          ...
          .set<google::cloud::aiplatform_v1::PipelineServiceRetryPolicyOption>(
              google::cloud::aiplatform_v1::
                  PipelineServiceLimitedErrorCountRetryPolicy(3)
                      .clone())
          .set<
              google::cloud::aiplatform_v1::PipelineServiceBackoffPolicyOption>(
              google::cloud::ExponentialBackoffPolicy(
                  /*initial_delay=*/std::chrono::milliseconds(200),
                  /*maximum_delay=*/std::chrono::seconds(45),
                  /*scaling=*/2.0)
                  .clone());
  auto connection = google::cloud::aiplatform_v1::MakePipelineServiceConnection(
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options =
      google::cloud::Options{}
          .set<
              google::cloud::aiplatform_v1::PipelineServicePollingPolicyOption>(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::aiplatform_v1::PipelineServiceClient(
        google::cloud::aiplatform_v1::MakePipelineServiceConnection(
