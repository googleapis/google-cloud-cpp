...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::aiplatform_v1::LlmUtilityServiceClient(
      google::cloud::aiplatform_v1::MakeLlmUtilityServiceConnection("unused",
                                                                    options));
  //! [set-client-endpoint]
}
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::aiplatform_v1::LlmUtilityServiceClient(
      google::cloud::aiplatform_v1::MakeLlmUtilityServiceConnection(
          *ud_options));
  //! [set-client-universe-domain]
}
  ...
  auto options =
      google::cloud::Options{}
          .set<google::cloud::aiplatform_v1::
                   LlmUtilityServiceConnectionIdempotencyPolicyOption>(
              CustomIdempotencyPolicy().clone())
          .set<
              google::cloud::aiplatform_v1::LlmUtilityServiceRetryPolicyOption>(
              google::cloud::aiplatform_v1::
                  LlmUtilityServiceLimitedErrorCountRetryPolicy(3)
                      .clone())
          .set<google::cloud::aiplatform_v1::
                   LlmUtilityServiceBackoffPolicyOption>(
