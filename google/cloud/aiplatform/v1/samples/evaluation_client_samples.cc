...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::aiplatform_v1::EvaluationServiceClient(
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options =
      google::cloud::Options{}
          ...
          .set<
              google::cloud::aiplatform_v1::EvaluationServiceRetryPolicyOption>(
              google::cloud::aiplatform_v1::
                  EvaluationServiceLimitedErrorCountRetryPolicy(3)
                      .clone())
          .set<google::cloud::aiplatform_v1::
