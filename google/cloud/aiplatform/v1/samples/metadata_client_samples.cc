...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::aiplatform_v1::MetadataServiceClient(
      google::cloud::aiplatform_v1::MakeMetadataServiceConnection("unused",
                                                                  options));
  //! [set-client-endpoint]
}
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::aiplatform_v1::MetadataServiceClient(
      google::cloud::aiplatform_v1::MakeMetadataServiceConnection(*ud_options));
  //! [set-client-universe-domain]
}
...
class CustomIdempotencyPolicy : public google::cloud::aiplatform_v1::
 ...
 public:
  ...
  std::unique_ptr<
      google::cloud::aiplatform_v1::MetadataServiceConnectionIdempotencyPolicy>
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
      ...
      google::cloud::Options{}
          ...
          .set<google::cloud::aiplatform_v1::MetadataServiceRetryPolicyOption>(
              google::cloud::aiplatform_v1::
                  MetadataServiceLimitedErrorCountRetryPolicy(3)
                      .clone())
          .set<
              google::cloud::aiplatform_v1::MetadataServiceBackoffPolicyOption>(
              google::cloud::ExponentialBackoffPolicy(
                  /*initial_delay=*/std::chrono::milliseconds(200),
                  /*maximum_delay=*/std::chrono::seconds(45),
                  /*scaling=*/2.0)
                  .clone());
  auto connection = google::cloud::aiplatform_v1::MakeMetadataServiceConnection(
  ...
  auto c3 = google::cloud::aiplatform_v1::MetadataServiceClient(
      ...
      google::cloud::Options{}
          .set<google::cloud::aiplatform_v1::MetadataServiceRetryPolicyOption>(
              google::cloud::aiplatform_v1::
                  MetadataServiceLimitedTimeRetryPolicy(std::chrono::minutes(5))
                      .clone()));
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options =
      google::cloud::Options{}
          .set<
              google::cloud::aiplatform_v1::MetadataServicePollingPolicyOption>(
              google::cloud::GenericPollingPolicy<
                  google::cloud::aiplatform_v1::
                      MetadataServiceRetryPolicyOption::Type,
                  google::cloud::aiplatform_v1::
                      MetadataServiceBackoffPolicyOption::Type>(
                  google::cloud::aiplatform_v1::
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::aiplatform_v1::MetadataServiceClient(
        google::cloud::aiplatform_v1::MakeMetadataServiceConnection(
