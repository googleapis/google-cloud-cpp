...
// clang-format off
// main-dox-marker: aiplatform_v1::DatasetServiceClient
// lro-marker: true
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::aiplatform_v1::DatasetServiceClient(
      google::cloud::aiplatform_v1::MakeDatasetServiceConnection("unused", options));
  //! [set-client-endpoint]
}

//! [custom-idempotency-policy]
class CustomIdempotencyPolicy
   : public google::cloud::aiplatform_v1::DatasetServiceConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::aiplatform_v1::DatasetServiceConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::aiplatform_v1::DatasetServiceConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::aiplatform_v1::DatasetServiceRetryPolicyOption>(
      google::cloud::aiplatform_v1::DatasetServiceLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::aiplatform_v1::DatasetServiceBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::aiplatform_v1::MakeDatasetServiceConnection("location-unused-in-this-example", options);
  ...
  auto c3 = google::cloud::aiplatform_v1::DatasetServiceClient(
    connection, google::cloud::Options{}.set<google::cloud::aiplatform_v1::DatasetServiceRetryPolicyOption>(
      google::cloud::aiplatform_v1::DatasetServiceLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::aiplatform_v1::DatasetServicePollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::aiplatform_v1::DatasetServiceRetryPolicyOption::Type,
            google::cloud::aiplatform_v1::DatasetServiceBackoffPolicyOption::Type>(
            google::cloud::aiplatform_v1::DatasetServiceLimitedTimeRetryPolicy(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::aiplatform_v1::DatasetServiceClient(
      google::cloud::aiplatform_v1::MakeDatasetServiceConnection("us-west1" /* regional service region */, options));
  }
  //! [with-service-account]
  (argv.at(0));
}
