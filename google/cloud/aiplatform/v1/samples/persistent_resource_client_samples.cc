...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::aiplatform_v1::PersistentResourceServiceClient(
      google::cloud::aiplatform_v1::MakePersistentResourceServiceConnection(
          "unused", options));
  //! [set-client-endpoint]
}
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options =
      google::cloud::Options{}
          ...
          .set<google::cloud::aiplatform_v1::
                   PersistentResourceServiceRetryPolicyOption>(
              google::cloud::aiplatform_v1::
                  PersistentResourceServiceLimitedErrorCountRetryPolicy(3)
                      .clone())
          .set<google::cloud::aiplatform_v1::
                   PersistentResourceServiceBackoffPolicyOption>(
  ...
  auto c1 =
      google::cloud::aiplatform_v1::PersistentResourceServiceClient(connection);
  auto c2 =
      google::cloud::aiplatform_v1::PersistentResourceServiceClient(connection);
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options =
      google::cloud::Options{}
          .set<google::cloud::aiplatform_v1::
                   PersistentResourceServicePollingPolicyOption>(
              google::cloud::GenericPollingPolicy<
                  google::cloud::aiplatform_v1::
                      PersistentResourceServiceRetryPolicyOption::Type,
                  google::cloud::aiplatform_v1::
                      PersistentResourceServiceBackoffPolicyOption::Type>(
                  google::cloud::aiplatform_v1::
                      PersistentResourceServiceLimitedTimeRetryPolicy(
