...
/**
 * A retry policy for `EndpointServiceConnection` that stops retrying after a
...
class EndpointServiceLimitedErrorCountRetryPolicy
 ...
 public:
  EndpointServiceLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `EndpointServiceConnection` that stops retrying after
