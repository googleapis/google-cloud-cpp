...
CreateDefaultDeploymentResourcePoolServiceStub(
  ...
  auto service_grpc_stub = google::cloud::aiplatform::v1::DeploymentResourcePoolService::NewStub(channel);
  ...
  std::shared_ptr<DeploymentResourcePoolServiceStub> stub =
    std::make_shared<DefaultDeploymentResourcePoolServiceStub>(
      std::move(service_grpc_stub), std::move(service_iampolicy_stub), std::move(service_locations_stub),
      google::longrunning::Operations::NewStub(channel));

  if (auth->RequiresConfigureContext()) {
    stub = std::make_shared<DeploymentResourcePoolServiceAuth>(
