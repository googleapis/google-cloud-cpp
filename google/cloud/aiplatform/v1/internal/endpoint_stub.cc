...
DefaultEndpointServiceStub::AsyncUpdateEndpointLongRunning(
  ...
  return internal::MakeUnaryRpcImpl<google::cloud::aiplatform::v1::UpdateEndpointLongRunningRequest,
                                    google::longrunning::Operation>(
      cq,
      [this](grpc::ClientContext* context,
             google::cloud::aiplatform::v1::UpdateEndpointLongRunningRequest const& request,
...
DefaultEndpointServiceStub::SetIamPolicy(
  grpc::ClientContext& context, Options const&,
...
StatusOr<google::iam::v1::Policy>
DefaultEndpointServiceStub::GetIamPolicy(
  grpc::ClientContext& context, Options const&,
...
Status
DefaultEndpointServiceStub::DeleteOperation(
  grpc::ClientContext& context, Options const&,
...
Status
DefaultEndpointServiceStub::CancelOperation(
  grpc::ClientContext& context, Options const&,
