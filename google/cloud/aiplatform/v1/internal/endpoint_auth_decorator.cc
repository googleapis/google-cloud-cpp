...
EndpointServiceAuth::AsyncCreateEndpoint(
  ...
  return auth_->AsyncConfigureContext(std::move(context))
      .then([cq, child = child_, options,
        ...
        return child->AsyncCreateEndpoint(cq, *std::move(context), options,
                                          request);
      });
}
...
EndpointServiceAuth::AsyncDeleteEndpoint(
  ...
  return auth_->AsyncConfigureContext(std::move(context))
      .then([cq, child = child_, options,
        ...
        return child->AsyncDeleteEndpoint(cq, *std::move(context), options,
                                          request);
      });
}
...
EndpointServiceAuth::AsyncMutateDeployedModel(
  ...
  return auth_->AsyncConfigureContext(std::move(context))
      .then([cq, child = child_, options,
        ...
        return child->AsyncMutateDeployedModel(cq, *std::move(context), options,
                                               request);
      });
}
