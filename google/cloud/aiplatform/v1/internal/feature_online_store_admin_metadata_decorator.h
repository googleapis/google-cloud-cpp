...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_AIPLATFORM_V1_INTERNAL_FEATURE_ONLINE_STORE_ADMIN_METADATA_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_AIPLATFORM_V1_INTERNAL_FEATURE_ONLINE_STORE_ADMIN_METADATA_DECORATOR_H
...
class FeatureOnlineStoreAdminServiceMetadata : public FeatureOnlineStoreAdminServiceStub {
 public:
  ~FeatureOnlineStoreAdminServiceMetadata() override = default;
  FeatureOnlineStoreAdminServiceMetadata(
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_AIPLATFORM_V1_INTERNAL_FEATURE_ONLINE_STORE_ADMIN_METADATA_DECORATOR_H
