...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_AIPLATFORM_V1_INTERNAL_DEPLOYMENT_RESOURCE_POOL_CONNECTION_IMPL_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_AIPLATFORM_V1_INTERNAL_DEPLOYMENT_RESOURCE_POOL_CONNECTION_IMPL_H
...
class DeploymentResourcePoolServiceConnectionImpl
    : public aiplatform_v1::DeploymentResourcePoolServiceConnection {
 public:
  ~DeploymentResourcePoolServiceConnectionImpl() override = default;

  DeploymentResourcePoolServiceConnectionImpl(
    std::unique_ptr<google::cloud::BackgroundThreads> background,
    std::shared_ptr<aiplatform_v1_internal::DeploymentResourcePoolServiceStub> stub,
    Options options);
 ...
 private:
  ...
  std::shared_ptr<aiplatform_v1_internal::DeploymentResourcePoolServiceStub> stub_;
  Options options_;
};
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_AIPLATFORM_V1_INTERNAL_DEPLOYMENT_RESOURCE_POOL_CONNECTION_IMPL_H
