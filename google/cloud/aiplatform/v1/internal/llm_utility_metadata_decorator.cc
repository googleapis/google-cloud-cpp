...
LlmUtilityServiceMetadata::SetIamPolicy(
    grpc::ClientContext& context,
    Options const& options,
...
StatusOr<google::iam::v1::Policy>
LlmUtilityServiceMetadata::GetIamPolicy(
    grpc::ClientContext& context,
    Options const& options,
...
LlmUtilityServiceMetadata::ListOperations(
    grpc::ClientContext& context,
    Options const& options,
...
LlmUtilityServiceMetadata::GetOperation(
    grpc::ClientContext& context,
    Options const& options,
...
Status
LlmUtilityServiceMetadata::DeleteOperation(
    grpc::ClientContext& context,
    Options const& options,
...
Status
LlmUtilityServiceMetadata::CancelOperation(
    grpc::ClientContext& context,
    Options const& options,
...
StatusOr<google::longrunning::Operation>
LlmUtilityServiceMetadata::WaitOperation(
    grpc::ClientContext& context,
    Options const& options,
