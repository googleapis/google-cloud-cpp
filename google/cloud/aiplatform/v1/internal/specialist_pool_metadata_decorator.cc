...
SpecialistPoolServiceMetadata::AsyncUpdateSpecialistPool(
  ...
  SetMetadata(*context, *options, absl::StrCat("specialist_pool.name=", internal::UrlEncode(request.specialist_pool().name())));
...
SpecialistPoolServiceMetadata::SetIamPolicy(
    grpc::ClientContext& context,
    Options const& options,
...
StatusOr<google::iam::v1::Policy>
SpecialistPoolServiceMetadata::GetIamPolicy(
    grpc::ClientContext& context,
    Options const& options,
...
Status
SpecialistPoolServiceMetadata::DeleteOperation(
    grpc::ClientContext& context,
    Options const& options,
...
Status
SpecialistPoolServiceMetadata::CancelOperation(
    grpc::ClientContext& context,
    Options const& options,
