...
DeploymentResourcePoolServiceMetadata::AsyncUpdateDeploymentResourcePool(
  ...
  SetMetadata(*context, *options, absl::StrCat("deployment_resource_pool.name=", internal::UrlEncode(request.deployment_resource_pool().name())));
...
DeploymentResourcePoolServiceMetadata::ListOperations(
    grpc::ClientContext& context,
    Options const& options,
...
StatusOr<google::longrunning::Operation>
DeploymentResourcePoolServiceMetadata::GetOperation(
    grpc::ClientContext& context,
    Options const& options,
...
Status
DeploymentResourcePoolServiceMetadata::DeleteOperation(
    grpc::ClientContext& context,
    Options const& options,
...
Status
DeploymentResourcePoolServiceMetadata::CancelOperation(
    grpc::ClientContext& context,
    Options const& options,
...
StatusOr<google::longrunning::Operation>
DeploymentResourcePoolServiceMetadata::WaitOperation(
    grpc::ClientContext& context,
    Options const& options,
