...
MatchServiceMetadata::GetLocation(
    grpc::ClientContext& context,
    Options const& options,
...
MatchServiceMetadata::SetIamPolicy(
    grpc::ClientContext& context,
    Options const& options,
...
StatusOr<google::iam::v1::Policy>
MatchServiceMetadata::GetIamPolicy(
    grpc::ClientContext& context,
    Options const& options,
...
MatchServiceMetadata::ListOperations(
    grpc::ClientContext& context,
    Options const& options,
...
MatchServiceMetadata::GetOperation(
    grpc::ClientContext& context,
    Options const& options,
...
Status
MatchServiceMetadata::DeleteOperation(
    grpc::ClientContext& context,
    Options const& options,
...
Status
MatchServiceMetadata::CancelOperation(
    grpc::ClientContext& context,
    Options const& options,
...
StatusOr<google::longrunning::Operation>
MatchServiceMetadata::WaitOperation(
    grpc::ClientContext& context,
    Options const& options,
