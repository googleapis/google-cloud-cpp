...
CreateDefaultMatchServiceStub(
  ...
  std::shared_ptr<MatchServiceStub> stub =
    std::make_shared<DefaultMatchServiceStub>(std::move(service_grpc_stub), std::move(service_operations_stub), std::move(service_iampolicy_stub), std::move(service_locations_stub));
