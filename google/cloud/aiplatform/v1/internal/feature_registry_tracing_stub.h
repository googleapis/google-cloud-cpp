...
class FeatureRegistryServiceTracingStub : public FeatureRegistryServiceStub {
 public:
  ...
  explicit FeatureRegistryServiceTracingStub(std::shared_ptr<FeatureRegistryServiceStub> child);
 ...
 * OpenTelemetry.
 */
std::shared_ptr<FeatureRegistryServiceStub> MakeFeatureRegistryServiceTracingStub(
