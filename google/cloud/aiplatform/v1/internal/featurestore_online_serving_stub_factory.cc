...
CreateDefaultFeaturestoreOnlineServingServiceStub(
  ...
  if (!endpoint.ok()) {
    ...
    auto service_grpc_stub = google::cloud::aiplatform::v1::
        FeaturestoreOnlineServingService::NewStub(channel);
    stub = std::make_shared<DefaultFeaturestoreOnlineServingServiceStub>(
  ...
  if (internal::TracingEnabled(options)) {
    stub = MakeFeaturestoreOnlineServingServiceTracingStub(std::move(stub));
  }
  return stub;
}
