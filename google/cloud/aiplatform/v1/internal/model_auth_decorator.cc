...
ModelServiceAuth::AsyncUploadModel(
  ...
  return auth_->AsyncConfigureContext(std::move(context))
      .then([cq, child = child_, options,
        ...
        return child->AsyncUploadModel(cq, *std::move(context), options,
                                       request);
      });
}
...
ModelServiceAuth::AsyncDeleteModelVersion(
  ...
  return auth_->AsyncConfigureContext(std::move(context))
      .then([cq, child = child_, options,
        ...
        return child->AsyncDeleteModelVersion(cq, *std::move(context), options,
                                              request);
      });
}
...
ModelServiceAuth::AsyncCopyModel(
  ...
  return auth_->AsyncConfigureContext(std::move(context))
      .then([cq, child = child_, options,
        ...
        return child->AsyncCopyModel(cq, *std::move(context), options, request);
      });
}
