...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_AIPLATFORM_V1_INTERNAL_TENSORBOARD_METADATA_DECORATOR_H
...
class TensorboardServiceMetadata : public TensorboardServiceStub {
 public:
  ~TensorboardServiceMetadata() override = default;
  TensorboardServiceMetadata(
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_AIPLATFORM_V1_INTERNAL_TENSORBOARD_METADATA_DECORATOR_H
