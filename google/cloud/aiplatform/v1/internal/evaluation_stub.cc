...
DefaultEvaluationServiceStub::EvaluateInstances(
  ...
  google::cloud::aiplatform::v1::EvaluateInstancesRequest const& request) {
    ...
    auto status =
        grpc_stub_->EvaluateInstances(&context, request, &response);
    if (!status.ok()) {
...
DefaultEvaluationServiceStub::SetIamPolicy(
  grpc::ClientContext& context, Options const&,
...
StatusOr<google::iam::v1::Policy>
DefaultEvaluationServiceStub::GetIamPolicy(
  grpc::ClientContext& context, Options const&,
...
Status
DefaultEvaluationServiceStub::DeleteOperation(
  grpc::ClientContext& context, Options const&,
...
Status
DefaultEvaluationServiceStub::CancelOperation(
  grpc::ClientContext& context, Options const&,
