...
PredictionServiceMetadata::RawPredict(
    grpc::ClientContext& context,
    Options const& options,
...
PredictionServiceMetadata::AsyncStreamDirectPredict(
  ...
  return child_->AsyncStreamDirectPredict(cq, std::move(context), std::move(options));
}
...
PredictionServiceMetadata::AsyncStreamDirectRawPredict(
    ...
    google::cloud::internal::ImmutableOptions options) {
  SetMetadata(*context, *options);
  return child_->AsyncStreamDirectRawPredict(cq, std::move(context), std::move(options));
}
...
PredictionServiceMetadata::AsyncStreamingPredict(
    ...
    google::cloud::internal::ImmutableOptions options) {
  SetMetadata(*context, *options);
  return child_->AsyncStreamingPredict(cq, std::move(context), std::move(options));
}
...
PredictionServiceMetadata::AsyncStreamingRawPredict(
    ...
    google::cloud::internal::ImmutableOptions options) {
  SetMetadata(*context, *options);
  return child_->AsyncStreamingRawPredict(cq, std::move(context), std::move(options));
}
...
PredictionServiceMetadata::SetIamPolicy(
    grpc::ClientContext& context,
    Options const& options,
...
StatusOr<google::iam::v1::Policy>
PredictionServiceMetadata::GetIamPolicy(
    grpc::ClientContext& context,
    Options const& options,
...
Status
PredictionServiceMetadata::DeleteOperation(
    grpc::ClientContext& context,
    Options const& options,
...
Status
PredictionServiceMetadata::CancelOperation(
    grpc::ClientContext& context,
    Options const& options,
