...
DefaultDeploymentResourcePoolServiceStub::AsyncUpdateDeploymentResourcePool(
  ...
  return internal::MakeUnaryRpcImpl<google::cloud::aiplatform::v1::UpdateDeploymentResourcePoolRequest,
                                    google::longrunning::Operation>(
      cq,
      [this](grpc::ClientContext* context,
             google::cloud::aiplatform::v1::UpdateDeploymentResourcePoolRequest const& request,
             grpc::CompletionQueue* cq) {
        return grpc_stub_->AsyncUpdateDeploymentResourcePool(context, request, cq);
      },
      request, std::move(context));
}
...
Status
DefaultDeploymentResourcePoolServiceStub::DeleteOperation(
  grpc::ClientContext& context, Options const&,
...
Status
DefaultDeploymentResourcePoolServiceStub::CancelOperation(
  grpc::ClientContext& context, Options const&,
