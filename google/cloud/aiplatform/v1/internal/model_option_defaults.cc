...
Options ModelServiceDefaultOptions(std::string const& location, Options options) {
  ...
  if (!options.has<aiplatform_v1::ModelServiceBackoffPolicyOption>()) {
    options.set<aiplatform_v1::ModelServiceBackoffPolicyOption>(
        ExponentialBackoffPolicy(std::chrono::seconds(0), std::chrono::seconds(1),
            std::chrono::minutes(5), kBackoffScaling, kBackoffScaling).clone());
  }
  if (!options.has<aiplatform_v1::ModelServicePollingPolicyOption>()) {
    options.set<aiplatform_v1::ModelServicePollingPolicyOption>(
        GenericPollingPolicy<
            aiplatform_v1::ModelServiceRetryPolicyOption::Type,
            aiplatform_v1::ModelServiceBackoffPolicyOption::Type>(
            options.get<aiplatform_v1::ModelServiceRetryPolicyOption>()->clone(),
            ExponentialBackoffPolicy(std::chrono::seconds(1),
            std::chrono::minutes(5), kBackoffScaling).clone()).clone());
  }
  if (!options.has<aiplatform_v1::ModelServiceConnectionIdempotencyPolicyOption>()) {
    options.set<aiplatform_v1::ModelServiceConnectionIdempotencyPolicyOption>(
        aiplatform_v1::MakeDefaultModelServiceConnectionIdempotencyPolicy());
  }
