...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_AIPLATFORM_V1_INTERNAL_EVALUATION_CONNECTION_IMPL_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_AIPLATFORM_V1_INTERNAL_EVALUATION_CONNECTION_IMPL_H
...
class EvaluationServiceConnectionImpl
    : public aiplatform_v1::EvaluationServiceConnection {
 public:
  ~EvaluationServiceConnectionImpl() override = default;

  EvaluationServiceConnectionImpl(
 ...
 private:
  ...
  std::shared_ptr<aiplatform_v1_internal::EvaluationServiceStub> stub_;
  Options options_;
};
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_AIPLATFORM_V1_INTERNAL_EVALUATION_CONNECTION_IMPL_H
