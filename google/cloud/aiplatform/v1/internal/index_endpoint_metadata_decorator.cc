...
IndexEndpointServiceMetadata::SetIamPolicy(
    grpc::ClientContext& context,
    Options const& options,
...
StatusOr<google::iam::v1::Policy>
IndexEndpointServiceMetadata::GetIamPolicy(
    grpc::ClientContext& context,
    Options const& options,
...
Status
IndexEndpointServiceMetadata::DeleteOperation(
    grpc::ClientContext& context,
    Options const& options,
...
Status
IndexEndpointServiceMetadata::CancelOperation(
    grpc::ClientContext& context,
    Options const& options,
