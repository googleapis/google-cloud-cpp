...
PipelineServiceLogging::GetLocation(
    grpc::ClientContext& context,
    Options const& options,
...
PipelineServiceLogging::SetIamPolicy(
    grpc::ClientContext& context,
    Options const& options,
...
StatusOr<google::iam::v1::Policy>
PipelineServiceLogging::GetIamPolicy(
    grpc::ClientContext& context,
    Options const& options,
...
Status
PipelineServiceLogging::DeleteOperation(
    grpc::ClientContext& context,
    Options const& options,
...
Status
PipelineServiceLogging::CancelOperation(
    grpc::ClientContext& context,
    Options const& options,
...
StatusOr<google::longrunning::Operation>
PipelineServiceLogging::WaitOperation(
    grpc::ClientContext& context,
    Options const& options,
