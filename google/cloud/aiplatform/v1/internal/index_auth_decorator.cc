...
StatusOr<google::cloud::location::ListLocationsResponse> IndexServiceAuth::ListLocations(
    grpc::ClientContext& context,
    Options const& options,
...
StatusOr<google::iam::v1::TestIamPermissionsResponse> IndexServiceAuth::TestIamPermissions(
    grpc::ClientContext& context,
    Options const& options,
...
StatusOr<google::longrunning::ListOperationsResponse> IndexServiceAuth::ListOperations(
    grpc::ClientContext& context,
    Options const& options,
