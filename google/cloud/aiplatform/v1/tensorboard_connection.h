...
/**
 * A retry policy for `TensorboardServiceConnection` that stops retrying after a
...
class TensorboardServiceLimitedErrorCountRetryPolicy
 ...
 public:
  TensorboardServiceLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `TensorboardServiceConnection` that stops retrying after
