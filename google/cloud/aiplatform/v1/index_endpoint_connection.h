...
/**
 * A retry policy for `IndexEndpointServiceConnection` that stops retrying after
...
class IndexEndpointServiceLimitedErrorCountRetryPolicy
 ...
 public:
  IndexEndpointServiceLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `IndexEndpointServiceConnection` that stops retrying
