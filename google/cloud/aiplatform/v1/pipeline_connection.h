...
/**
 * A retry policy for `PipelineServiceConnection` that stops retrying after a
...
class PipelineServiceLimitedErrorCountRetryPolicy
 ...
 public:
  PipelineServiceLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `PipelineServiceConnection` that stops retrying after
