...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_AIPLATFORM_V1_PERSISTENT_RESOURCE_CONNECTION_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_AIPLATFORM_V1_PERSISTENT_RESOURCE_CONNECTION_H
...
#include <google/cloud/aiplatform/v1/persistent_resource_service.pb.h>
...
class PersistentResourceServiceLimitedTimeRetryPolicy
 ...
 public:
  ...
  std::unique_ptr<RetryPolicy> clone() const override {
    return std::make_unique<PersistentResourceServiceLimitedTimeRetryPolicy>(
        maximum_duration());
  }
...
class PersistentResourceServiceConnection {
 public:
  virtual ~PersistentResourceServiceConnection() = 0;
 ...
 * - `google::cloud::aiplatform_v1::PersistentResourceServicePolicyOptionList`
 *
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_AIPLATFORM_V1_PERSISTENT_RESOURCE_CONNECTION_H
