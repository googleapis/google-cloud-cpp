...
class MockNotebookServiceConnection : public aiplatform_v1::NotebookServiceConnection {
 public:
  ...
  /// EXPECT_CALL(*mock, CreateNotebookRuntimeTemplate(Matcher<google::cloud::aiplatform::v1::CreateNotebookRuntimeTemplateRequest const&>(_)))
  /// @endcode
  ...
  CreateNotebookRuntimeTemplate, (NoAwaitTag,
    google::cloud::aiplatform::v1::CreateNotebookRuntimeTemplateRequest const& request), (override));
  ...
  /// using ::testing::_;
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock, CreateNotebookRuntimeTemplate(Matcher<google::longrunning::Operation const&>(_)))
  /// @endcode
  MOCK_METHOD(future<StatusOr<google::cloud::aiplatform::v1::NotebookRuntimeTemplate>>,
  CreateNotebookRuntimeTemplate, (
  ...
  /// using ::testing::_;
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock, DeleteNotebookRuntimeTemplate(Matcher<google::cloud::aiplatform::v1::DeleteNotebookRuntimeTemplateRequest const&>(_)))
  /// @endcode
  ...
  /// @endcode
  MOCK_METHOD(StatusOr<google::longrunning::Operation>,
  DeleteNotebookRuntimeTemplate, (NoAwaitTag,
    google::cloud::aiplatform::v1::DeleteNotebookRuntimeTemplateRequest const& request), (override));
  ...
  /// using ::testing::_;
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock, DeleteNotebookRuntimeTemplate(Matcher<google::longrunning::Operation const&>(_)))
  /// @endcode
  MOCK_METHOD(future<StatusOr<google::cloud::aiplatform::v1::DeleteOperationMetadata>>,
  DeleteNotebookRuntimeTemplate, (
    google::longrunning::Operation const& operation), (override));
  ...
  /// using ::testing::_;
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock, AssignNotebookRuntime(Matcher<google::cloud::aiplatform::v1::AssignNotebookRuntimeRequest const&>(_)))
  /// @endcode
  ...
  /// @endcode
  MOCK_METHOD(StatusOr<google::longrunning::Operation>,
  AssignNotebookRuntime, (NoAwaitTag,
    google::cloud::aiplatform::v1::AssignNotebookRuntimeRequest const& request), (override));
  ...
  /// using ::testing::_;
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock, AssignNotebookRuntime(Matcher<google::longrunning::Operation const&>(_)))
  /// @endcode
  MOCK_METHOD(future<StatusOr<google::cloud::aiplatform::v1::NotebookRuntime>>,
  AssignNotebookRuntime, (
    google::longrunning::Operation const& operation), (override));
  ...
  /// using ::testing::_;
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock, DeleteNotebookRuntime(Matcher<google::cloud::aiplatform::v1::DeleteNotebookRuntimeRequest const&>(_)))
  /// @endcode
  MOCK_METHOD(future<StatusOr<google::cloud::aiplatform::v1::DeleteOperationMetadata>>,
  ...
  /// @endcode
  MOCK_METHOD(StatusOr<google::longrunning::Operation>,
  DeleteNotebookRuntime, (NoAwaitTag,
    google::cloud::aiplatform::v1::DeleteNotebookRuntimeRequest const& request), (override));
  ...
  /// using ::testing::_;
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock, DeleteNotebookRuntime(Matcher<google::longrunning::Operation const&>(_)))
  /// @endcode
  MOCK_METHOD(future<StatusOr<google::cloud::aiplatform::v1::DeleteOperationMetadata>>,
  DeleteNotebookRuntime, (
    google::longrunning::Operation const& operation), (override));
  ...
  /// using ::testing::_;
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock, UpgradeNotebookRuntime(Matcher<google::cloud::aiplatform::v1::UpgradeNotebookRuntimeRequest const&>(_)))
  /// @endcode
  ...
  /// @endcode
  MOCK_METHOD(StatusOr<google::longrunning::Operation>,
  UpgradeNotebookRuntime, (NoAwaitTag,
    google::cloud::aiplatform::v1::UpgradeNotebookRuntimeRequest const& request), (override));
  ...
  /// using ::testing::_;
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock, UpgradeNotebookRuntime(Matcher<google::longrunning::Operation const&>(_)))
  /// @endcode
  MOCK_METHOD(future<StatusOr<google::cloud::aiplatform::v1::UpgradeNotebookRuntimeResponse>>,
  UpgradeNotebookRuntime, (
    google::longrunning::Operation const& operation), (override));
  ...
  /// using ::testing::_;
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock, StartNotebookRuntime(Matcher<google::cloud::aiplatform::v1::StartNotebookRuntimeRequest const&>(_)))
  /// @endcode
  ...
  /// @endcode
  MOCK_METHOD(StatusOr<google::longrunning::Operation>,
  StartNotebookRuntime, (NoAwaitTag,
    google::cloud::aiplatform::v1::StartNotebookRuntimeRequest const& request), (override));
  ...
  /// using ::testing::_;
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock, StartNotebookRuntime(Matcher<google::longrunning::Operation const&>(_)))
  /// @endcode
  MOCK_METHOD(future<StatusOr<google::cloud::aiplatform::v1::StartNotebookRuntimeResponse>>,
  StartNotebookRuntime, (
    google::longrunning::Operation const& operation), (override));
  ...
  /// using ::testing::_;
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock, StopNotebookRuntime(Matcher<google::cloud::aiplatform::v1::StopNotebookRuntimeRequest const&>(_)))
  /// @endcode
  MOCK_METHOD(future<StatusOr<google::cloud::aiplatform::v1::StopNotebookRuntimeResponse>>,
  StopNotebookRuntime,
  ...
  /// @endcode
  MOCK_METHOD(StatusOr<google::longrunning::Operation>,
  StopNotebookRuntime, (NoAwaitTag,
    google::cloud::aiplatform::v1::StopNotebookRuntimeRequest const& request), (override));
  ...
  /// using ::testing::_;
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock, StopNotebookRuntime(Matcher<google::longrunning::Operation const&>(_)))
  /// @endcode
  MOCK_METHOD(future<StatusOr<google::cloud::aiplatform::v1::StopNotebookRuntimeResponse>>,
  StopNotebookRuntime, (
    google::longrunning::Operation const& operation), (override));
  ...
  /// using ::testing::_;
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock, CreateNotebookExecutionJob(Matcher<google::cloud::aiplatform::v1::CreateNotebookExecutionJobRequest const&>(_)))
  /// @endcode
  MOCK_METHOD(future<StatusOr<google::cloud::aiplatform::v1::NotebookExecutionJob>>,
  ...
  /// @endcode
  MOCK_METHOD(StatusOr<google::longrunning::Operation>,
  CreateNotebookExecutionJob, (NoAwaitTag,
    google::cloud::aiplatform::v1::CreateNotebookExecutionJobRequest const& request), (override));
  ...
  /// using ::testing::_;
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock, CreateNotebookExecutionJob(Matcher<google::longrunning::Operation const&>(_)))
  /// @endcode
  MOCK_METHOD(future<StatusOr<google::cloud::aiplatform::v1::NotebookExecutionJob>>,
  CreateNotebookExecutionJob, (
    google::longrunning::Operation const& operation), (override));

  MOCK_METHOD(StatusOr<google::cloud::aiplatform::v1::NotebookExecutionJob>,
  GetNotebookExecutionJob,
  (google::cloud::aiplatform::v1::GetNotebookExecutionJobRequest const& request), (override));

  MOCK_METHOD((StreamRange<google::cloud::aiplatform::v1::NotebookExecutionJob>),
  ListNotebookExecutionJobs,
  (google::cloud::aiplatform::v1::ListNotebookExecutionJobsRequest request), (override));
  ...
  /// using ::testing::_;
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock, DeleteNotebookExecutionJob(Matcher<google::cloud::aiplatform::v1::DeleteNotebookExecutionJobRequest const&>(_)))
  /// @endcode
  MOCK_METHOD(future<StatusOr<google::cloud::aiplatform::v1::DeleteOperationMetadata>>,
  ...
  /// @endcode
  MOCK_METHOD(StatusOr<google::longrunning::Operation>,
  DeleteNotebookExecutionJob, (NoAwaitTag,
    google::cloud::aiplatform::v1::DeleteNotebookExecutionJobRequest const& request), (override));
  ...
  /// using ::testing::_;
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock, DeleteNotebookExecutionJob(Matcher<google::longrunning::Operation const&>(_)))
  /// @endcode
  MOCK_METHOD(future<StatusOr<google::cloud::aiplatform::v1::DeleteOperationMetadata>>,
  DeleteNotebookExecutionJob, (
    google::longrunning::Operation const& operation), (override));
