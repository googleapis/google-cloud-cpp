...
class MockMigrationServiceConnection : public aiplatform_v1::MigrationServiceConnection {
 public:
  ...
  /// EXPECT_CALL(*mock, BatchMigrateResources(Matcher<google::cloud::aiplatform::v1::BatchMigrateResourcesRequest const&>(_)))
  /// @endcode
  ...
  /// using ::testing::_;
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock, BatchMigrateResources(Matcher<google::longrunning::Operation const&>(_)))
  /// @endcode
  MOCK_METHOD(future<StatusOr<google::cloud::aiplatform::v1::BatchMigrateResourcesResponse>>,
  BatchMigrateResources, (
