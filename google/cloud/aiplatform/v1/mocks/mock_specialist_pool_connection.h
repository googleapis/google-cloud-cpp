...
class MockSpecialistPoolServiceConnection : public aiplatform_v1::SpecialistPoolServiceConnection {
 public:
  ...
  /// EXPECT_CALL(*mock, CreateSpecialistPool(Matcher<google::cloud::aiplatform::v1::CreateSpecialistPoolRequest const&>(_)))
  /// @endcode
  ...
  /// using ::testing::_;
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock, CreateSpecialistPool(Matcher<google::longrunning::Operation const&>(_)))
  /// @endcode
  MOCK_METHOD(future<StatusOr<google::cloud::aiplatform::v1::SpecialistPool>>,
  CreateSpecialistPool, (
  ...
  /// using ::testing::_;
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock, DeleteSpecialistPool(Matcher<google::cloud::aiplatform::v1::DeleteSpecialistPoolRequest const&>(_)))
  /// @endcode
  ...
  /// using ::testing::_;
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock, DeleteSpecialistPool(Matcher<google::longrunning::Operation const&>(_)))
  /// @endcode
  MOCK_METHOD(future<StatusOr<google::cloud::aiplatform::v1::DeleteOperationMetadata>>,
  DeleteSpecialistPool, (
    google::longrunning::Operation const& operation), (override));
  ...
  /// using ::testing::_;
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock, UpdateSpecialistPool(Matcher<google::cloud::aiplatform::v1::UpdateSpecialistPoolRequest const&>(_)))
  /// @endcode
  MOCK_METHOD(future<StatusOr<google::cloud::aiplatform::v1::SpecialistPool>>,
  ...
  /// using ::testing::_;
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock, UpdateSpecialistPool(Matcher<google::longrunning::Operation const&>(_)))
  /// @endcode
  MOCK_METHOD(future<StatusOr<google::cloud::aiplatform::v1::SpecialistPool>>,
  UpdateSpecialistPool, (
    google::longrunning::Operation const& operation), (override));
