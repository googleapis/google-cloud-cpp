...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_AIPLATFORM_V1_EVALUATION_CONNECTION_H
...
/// The retry policy for `EvaluationServiceConnection`.
class EvaluationServiceRetryPolicy : public ::google::cloud::RetryPolicy {
 public:
  /// Creates a new instance of the policy, reset to the initial state.
  virtual std::unique_ptr<EvaluationServiceRetryPolicy> clone() const = 0;
};

/**
 * A retry policy for `EvaluationServiceConnection` based on counting errors.
 *
...
class EvaluationServiceLimitedErrorCountRetryPolicy
 ...
 public:
  ...
  std::unique_ptr<EvaluationServiceRetryPolicy> clone() const override {
    return std::make_unique<EvaluationServiceLimitedErrorCountRetryPolicy>(
        maximum_failures());
  }
...
/**
 * A retry policy for `EvaluationServiceConnection` based on elapsed time.
 *
 * This policy stops retrying if:
 * - An RPC returns a non-transient error.
...
class EvaluationServiceLimitedTimeRetryPolicy
 ...
 public:
  ...
  std::unique_ptr<EvaluationServiceRetryPolicy> clone() const override {
    return std::make_unique<EvaluationServiceLimitedTimeRetryPolicy>(
        maximum_duration());
  }
 ...
 *
 * For mocking, see `aiplatform_v1_mocks::MockEvaluationServiceConnection`.
 */
class EvaluationServiceConnection {
 public:
  virtual ~EvaluationServiceConnection() = 0;
 ...
 * - `google::cloud::aiplatform_v1::EvaluationServicePolicyOptionList`
 *
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_AIPLATFORM_V1_EVALUATION_CONNECTION_H
