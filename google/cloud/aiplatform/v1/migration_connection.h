...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_AIPLATFORM_V1_MIGRATION_CONNECTION_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_AIPLATFORM_V1_MIGRATION_CONNECTION_H
...
/**
 * A retry policy for `MigrationServiceConnection` that stops retrying after a
...
class MigrationServiceLimitedErrorCountRetryPolicy
 ...
 public:
  MigrationServiceLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `MigrationServiceConnection` that stops retrying after
 ...
 *
 * For mocking, see `aiplatform_v1_mocks::MockMigrationServiceConnection`.
 */
 ...
 * - `google::cloud::aiplatform_v1::MigrationServicePolicyOptionList`
 *
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_AIPLATFORM_V1_MIGRATION_CONNECTION_H
