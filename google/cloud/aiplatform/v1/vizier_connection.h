...
/**
 * A retry policy for `VizierServiceConnection` that stops retrying after a
...
class VizierServiceLimitedErrorCountRetryPolicy
 ...
 public:
  VizierServiceLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `VizierServiceConnection` that stops retrying after
