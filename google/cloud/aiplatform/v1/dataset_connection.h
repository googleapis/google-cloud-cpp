...
/**
 * A retry policy for `DatasetServiceConnection` that stops retrying after a
...
class DatasetServiceLimitedErrorCountRetryPolicy
 ...
 public:
  DatasetServiceLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `DatasetServiceConnection` that stops retrying after
