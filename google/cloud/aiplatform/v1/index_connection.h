...
/**
 * A retry policy for `IndexServiceConnection` that stops retrying after a
...
class IndexServiceLimitedErrorCountRetryPolicy
 ...
 public:
  IndexServiceLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `IndexServiceConnection` that stops retrying after
