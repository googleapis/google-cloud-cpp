...
/**
 * A retry policy for `MetadataServiceConnection` that stops retrying after a
...
class MetadataServiceLimitedErrorCountRetryPolicy
 ...
 public:
  MetadataServiceLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `MetadataServiceConnection` that stops retrying after
