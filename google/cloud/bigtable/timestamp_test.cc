...
Timestamp MakeBigtableTimestamp(std::int64_t seconds, std::int32_t nanos) {
  return MakeTimestamp(MakeProtoTimestamp(seconds, nanos)).value();
}

TEST(Timestamp, RegularSemantics) {
  Timestamp const ts = MakeBigtableTimestamp(0, 0);
...
TEST(Timestamp, RelationalOperators) {
  EXPECT_EQ(MakeBigtableTimestamp(1576030524, 611422667),
            MakeBigtableTimestamp(1576030524, 611422667));
  EXPECT_LE(MakeBigtableTimestamp(1576030524, 611422667),
            MakeBigtableTimestamp(1576030524, 611422667));
  EXPECT_GE(MakeBigtableTimestamp(1576030524, 611422667),
            MakeBigtableTimestamp(1576030524, 611422667));

  EXPECT_NE(MakeBigtableTimestamp(1576030524, 611422667),
            MakeBigtableTimestamp(1576030524, 611422668));
  EXPECT_LT(MakeBigtableTimestamp(1576030524, 611422667),
            MakeBigtableTimestamp(1576030524, 611422668));
  EXPECT_NE(MakeBigtableTimestamp(1576030524, 611422667),
            MakeBigtableTimestamp(1576030525, 611422667));
  EXPECT_LT(MakeBigtableTimestamp(1576030524, 611422667),
            MakeBigtableTimestamp(1576030525, 611422667));

  EXPECT_NE(MakeBigtableTimestamp(1576030524, 611422668),
            MakeBigtableTimestamp(1576030524, 611422667));
  EXPECT_GT(MakeBigtableTimestamp(1576030524, 611422668),
            MakeBigtableTimestamp(1576030524, 611422667));
  EXPECT_NE(MakeBigtableTimestamp(1576030525, 611422667),
            MakeBigtableTimestamp(1576030524, 611422667));
  EXPECT_GT(MakeBigtableTimestamp(1576030525, 611422667),
            MakeBigtableTimestamp(1576030524, 611422667));
}

TEST(Timestamp, OutputStreaming) {
  std::ostringstream os;
  os << MakeBigtableTimestamp(1561135942, 123456789);
  EXPECT_EQ("2019-06-21T16:52:22.123456789Z", os.str());
}

TEST(Timestamp, FromRFC3339) {
  EXPECT_EQ(
      MakeBigtableTimestamp(1561135942, 0),
      bigtable_internal::TimestampFromRFC3339("2019-06-21T16:52:22Z").value());
  EXPECT_EQ(
      MakeBigtableTimestamp(1561135942, 9),
      bigtable_internal::TimestampFromRFC3339("2019-06-21T16:52:22.000000009Z")
          .value());
  EXPECT_EQ(
      MakeBigtableTimestamp(1561135942, 89),
      bigtable_internal::TimestampFromRFC3339("2019-06-21T16:52:22.000000089Z")
          .value());
  EXPECT_EQ(
      MakeBigtableTimestamp(1561135942, 789),
      bigtable_internal::TimestampFromRFC3339("2019-06-21T16:52:22.000000789Z")
          .value());
  EXPECT_EQ(
      MakeBigtableTimestamp(1561135942, 6789),
      bigtable_internal::TimestampFromRFC3339("2019-06-21T16:52:22.000006789Z")
          .value());
  EXPECT_EQ(
      MakeBigtableTimestamp(1561135942, 56789),
      bigtable_internal::TimestampFromRFC3339("2019-06-21T16:52:22.000056789Z")
          .value());
  EXPECT_EQ(
      MakeBigtableTimestamp(1561135942, 456789),
      bigtable_internal::TimestampFromRFC3339("2019-06-21T16:52:22.000456789Z")
          .value());
  EXPECT_EQ(
      MakeBigtableTimestamp(1561135942, 3456789),
      bigtable_internal::TimestampFromRFC3339("2019-06-21T16:52:22.003456789Z")
          .value());
  EXPECT_EQ(
      MakeBigtableTimestamp(1561135942, 23456789),
      bigtable_internal::TimestampFromRFC3339("2019-06-21T16:52:22.023456789Z")
          .value());
  EXPECT_EQ(
      MakeBigtableTimestamp(1561135942, 123456789),
      bigtable_internal::TimestampFromRFC3339("2019-06-21T16:52:22.123456789Z")
          .value());
  EXPECT_EQ(
      MakeBigtableTimestamp(1561135942, 123456780),
      bigtable_internal::TimestampFromRFC3339("2019-06-21T16:52:22.12345678Z")
          .value());
  EXPECT_EQ(
      MakeBigtableTimestamp(1561135942, 123456700),
      bigtable_internal::TimestampFromRFC3339("2019-06-21T16:52:22.1234567Z")
          .value());
  EXPECT_EQ(
      MakeBigtableTimestamp(1561135942, 123456000),
      bigtable_internal::TimestampFromRFC3339("2019-06-21T16:52:22.123456Z")
          .value());
  EXPECT_EQ(
      MakeBigtableTimestamp(1561135942, 123450000),
      bigtable_internal::TimestampFromRFC3339("2019-06-21T16:52:22.12345Z")
          .value());
  EXPECT_EQ(MakeBigtableTimestamp(1561135942, 123400000),
            bigtable_internal::TimestampFromRFC3339("2019-06-21T16:52:22.1234Z")
                .value());
  EXPECT_EQ(MakeBigtableTimestamp(1561135942, 123000000),
            bigtable_internal::TimestampFromRFC3339("2019-06-21T16:52:22.123Z")
                .value());
  EXPECT_EQ(MakeBigtableTimestamp(1561135942, 120000000),
            bigtable_internal::TimestampFromRFC3339("2019-06-21T16:52:22.12Z")
                .value());
  EXPECT_EQ(MakeBigtableTimestamp(1561135942, 100000000),
            bigtable_internal::TimestampFromRFC3339("2019-06-21T16:52:22.1Z")
                .value());
}

TEST(Timestamp, FromRFC3339Offset) {
  EXPECT_EQ(MakeBigtableTimestamp(1546398245, 0),
            bigtable_internal::TimestampFromRFC3339("2019-01-02T03:04:05+00:00")
                .value());
  EXPECT_EQ(MakeBigtableTimestamp(1546398245 + 3600 + 120, 0),
            bigtable_internal::TimestampFromRFC3339("2019-01-02T03:04:05-01:02")
                .value());
  EXPECT_EQ(MakeBigtableTimestamp(1546398245 - 3600 - 120, 0),
            bigtable_internal::TimestampFromRFC3339("2019-01-02T03:04:05+01:02")
                .value());
...
TEST(Timestamp, FromRFC3339Failure) {
  EXPECT_FALSE(bigtable_internal::TimestampFromRFC3339(""));
  EXPECT_FALSE(bigtable_internal::TimestampFromRFC3339("garbage in"));
  EXPECT_FALSE(bigtable_internal::TimestampFromRFC3339("2019-06-21T16:52:22"));
  EXPECT_FALSE(
      bigtable_internal::TimestampFromRFC3339("2019-06-21T16:52:22.9"));
  EXPECT_FALSE(
      bigtable_internal::TimestampFromRFC3339("2019-06-21T16:52:22.Z"));
  EXPECT_FALSE(
      bigtable_internal::TimestampFromRFC3339("2019-06-21T16:52:22ZX"));
  EXPECT_FALSE(
      bigtable_internal::TimestampFromRFC3339("2019-06-21T16:52:-22Z"));

  EXPECT_FALSE(
      bigtable_internal::TimestampFromRFC3339("2019-06-21T16:52:22+0:"));
  EXPECT_FALSE(
      bigtable_internal::TimestampFromRFC3339("2019-06-21T16:52:22+:0"));
  EXPECT_FALSE(
      bigtable_internal::TimestampFromRFC3339("2019-06-21T16:52:22+0:-0"));
  EXPECT_FALSE(
      bigtable_internal::TimestampFromRFC3339("2019-06-21T16:52:22x00:00"));
  EXPECT_FALSE(
      bigtable_internal::TimestampFromRFC3339("2019-06-21T16:52:22+ab:cd"));
  EXPECT_FALSE(
      bigtable_internal::TimestampFromRFC3339("2019-06-21T16:52:22-24:60"));
}

TEST(Timestamp, FromRFC3339Limit) {
  // Verify Bigtable range requirements.
  EXPECT_EQ(
      MakeBigtableTimestamp(-62135596800, 0),
      bigtable_internal::TimestampFromRFC3339("0001-01-01T00:00:00.000000000Z")
          .value());
  EXPECT_EQ(
      MakeBigtableTimestamp(253402300799, 999999999),
      bigtable_internal::TimestampFromRFC3339("9999-12-31T23:59:59.999999999Z")
          .value());

  // One nanosecond before the lower bound is invalid.
  EXPECT_FALSE(
      bigtable_internal::TimestampFromRFC3339("0-12-31T23:59:59.999999999Z"));

  // One nanosecond past the upper bound is invalid.
  EXPECT_FALSE(
      bigtable_internal::TimestampFromRFC3339("10000-01-01T00:00:00Z"));
}

TEST(Timestamp, ToRFC3339) {
  EXPECT_EQ("2019-06-21T16:52:22Z", bigtable_internal::TimestampToRFC3339(
                                        MakeBigtableTimestamp(1561135942, 0)));
  ...
  EXPECT_EQ("2019-06-21T16:52:22.1234Z",
            bigtable_internal::TimestampToRFC3339(
                MakeBigtableTimestamp(1561135942, 123400000)));
  EXPECT_EQ("2019-06-21T16:52:22.123Z",
            bigtable_internal::TimestampToRFC3339(
                MakeBigtableTimestamp(1561135942, 123000000)));
  EXPECT_EQ("2019-06-21T16:52:22.12Z",
            bigtable_internal::TimestampToRFC3339(
                MakeBigtableTimestamp(1561135942, 120000000)));
  EXPECT_EQ("2019-06-21T16:52:22.1Z",
            bigtable_internal::TimestampToRFC3339(
                MakeBigtableTimestamp(1561135942, 100000000)));
}

TEST(Timestamp, ToRFC3339Limit) {
  // Bigtable range requirements.
...
TEST(Timestamp, FromProto) {
  ...
  EXPECT_EQ("1970-01-01T00:00:00Z", bigtable_internal::TimestampToRFC3339(
                                        MakeTimestamp(proto).value()));

  proto = MakeProtoTimestamp(1576030524, 611422667);
  EXPECT_EQ(
      "2019-12-11T02:15:24.611422667Z",
      bigtable_internal::TimestampToRFC3339(MakeTimestamp(proto).value()));

  proto = MakeProtoTimestamp(-62135596800, 0);
  EXPECT_EQ("0001-01-01T00:00:00Z", bigtable_internal::TimestampToRFC3339(
                                        MakeTimestamp(proto).value()));
...
TEST(Timestamp, FromProtoLimit) {
  ...
  EXPECT_EQ(
      bigtable_internal::TimestampFromRFC3339("0001-01-01T00:00:00Z").value(),
      MakeBigtableTimestamp(-62135596800, 0));
  EXPECT_EQ(
      bigtable_internal::TimestampFromRFC3339("9999-12-31T23:59:59.999999999Z")
          .value(),
...
TEST(Timestamp, ToProto) {
  auto proto =
      bigtable_internal::TimestampFromRFC3339("1970-01-01T00:00:00.000000000Z")
          .value()
  ...
  proto =
      bigtable_internal::TimestampFromRFC3339("2019-12-11T02:15:24.611422667Z")
          .value()
          .get<google::protobuf::Timestamp>()
          .value();
...
TEST(Timestamp, ToChrono) {  // i.e., Timestamp::get<sys_time<Duration>>()
  auto const ts_pos = MakeBigtableTimestamp(2123456789, 123456789);
  ...
  auto const ts_neg = MakeBigtableTimestamp(-2123456789, 123456789);
  ...
  auto const ts11 = MakeBigtableTimestamp(9223372036, 854775807);
...
TEST(Timestamp, ToChronoOverflow) {
  auto const ts1 = MakeBigtableTimestamp(20000000000, 0);
  auto const tp1 = ts1.get<sys_time<std::chrono::nanoseconds>>();
  EXPECT_THAT(tp1,
              StatusIs(Not(StatusCode::kOk), HasSubstr("positive overflow")));

  auto const ts2 = MakeBigtableTimestamp(-20000000000, 0);
  ...
  auto const ts3 = MakeBigtableTimestamp(9223372036, 854775808);
  ...
  auto const ts4 = MakeBigtableTimestamp(127, 0);
