...
#ifndef GOOGLE_CLOUD_CPP_BIGTABLE_CLIENT_INTERNAL_STRONG_TYPE_H_
#define GOOGLE_CLOUD_CPP_BIGTABLE_CLIENT_INTERNAL_STRONG_TYPE_H_
...
#endif  // GOOGLE_CLOUD_CPP_BIGTABLE_CLIENT_INTERNAL_STRONG_TYPE_H_
