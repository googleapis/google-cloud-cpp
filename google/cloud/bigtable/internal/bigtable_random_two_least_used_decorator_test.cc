...
TEST_F(BigtableRandomTwoLeastUsedTest, ReadRows) {
  ...
  auto response = decorator->ReadRows(client_context, {}, request, default_oc_);
}
...
TEST_F(BigtableRandomTwoLeastUsedTest, SampleRowKeys) {
  ...
  auto response =
      decorator->SampleRowKeys(client_context, {}, request, default_oc_);
}
...
TEST_F(BigtableRandomTwoLeastUsedTest, MutateRow) {
  ...
  auto response =
      decorator->MutateRow(client_context, {}, request, default_oc_);
}
...
TEST_F(BigtableRandomTwoLeastUsedTest, MutateRows) {
  ...
  auto response =
      decorator->MutateRows(client_context, {}, request, default_oc_);
}
...
TEST_F(BigtableRandomTwoLeastUsedTest, CheckAndMutateRow) {
  ...
  auto response =
      decorator->CheckAndMutateRow(client_context, {}, request, default_oc_);
}
...
TEST_F(BigtableRandomTwoLeastUsedTest, PingAndWarm) {
  ...
  auto response =
      decorator->PingAndWarm(client_context, {}, request, default_oc_);
}
...
TEST_F(BigtableRandomTwoLeastUsedTest, ReadModifyWriteRow) {
  ...
  auto response =
      decorator->ReadModifyWriteRow(client_context, {}, request, default_oc_);
}
...
TEST_F(BigtableRandomTwoLeastUsedTest, PrepareQuery) {
  ...
  auto response =
      decorator->PrepareQuery(client_context, {}, request, default_oc_);
}
...
TEST_F(BigtableRandomTwoLeastUsedTest, ExecuteQuery) {
  ...
  auto response =
      decorator->ExecuteQuery(client_context, {}, request, default_oc_);
}
...
TEST_F(BigtableRandomTwoLeastUsedTest, AsyncReadRows) {
  ...
  google::bigtable::v2::ReadRowsRequest request;
  auto response =
      decorator->AsyncReadRows(cq_, client_context, {}, request, default_oc_);
}
...
TEST_F(BigtableRandomTwoLeastUsedTest, AsyncSampleRowKeys) {
  ...
  auto client_context = std::make_shared<grpc::ClientContext>();
  google::bigtable::v2::SampleRowKeysRequest request;
  auto response = decorator->AsyncSampleRowKeys(cq_, client_context, {},
                                                request, default_oc_);
}
...
TEST_F(BigtableRandomTwoLeastUsedTest, AsyncMutateRow) {
  ...
  google::bigtable::v2::MutateRowRequest request;
  auto response =
      decorator->AsyncMutateRow(cq_, client_context, {}, request, default_oc_);
}
...
TEST_F(BigtableRandomTwoLeastUsedTest, AsyncMutateRows) {
  ...
  google::bigtable::v2::MutateRowsRequest request;
  auto response =
      decorator->AsyncMutateRows(cq_, client_context, {}, request, default_oc_);
}
...
TEST_F(BigtableRandomTwoLeastUsedTest, AsyncPrepareQuery) {
  ...
  auto client_context = std::make_shared<grpc::ClientContext>();
  google::bigtable::v2::PrepareQueryRequest request;
  auto response = decorator->AsyncPrepareQuery(cq_, client_context, {}, request,
                                               default_oc_);
}
