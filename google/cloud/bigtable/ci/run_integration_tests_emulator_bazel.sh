...
production_only_targets=(
  ...
  "//google/cloud/bigtable/tests:table_admin_backup_integration_test-default"
  "//google/cloud/bigtable/tests:table_admin_iam_policy_integration_test-default"
  "//google/cloud/bigtable/tests:table_admin_backup_integration_test-dynamic-pool"
  "//google/cloud/bigtable/tests:table_admin_iam_policy_integration_test-dynamic-pool"
)
