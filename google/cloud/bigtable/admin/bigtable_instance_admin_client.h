...
class BigtableInstanceAdminClient {
 public:
  ...
  ///     backoff policies.
  /// @return
  /// @googleapis_link{google::bigtable::admin::v2::Cluster,google/bigtable/admin/v2/instance.proto#L132}
  ///
  ...
  /// @googleapis_reference_link{google/bigtable/admin/v2/instance.proto#L132}
  ///
  ...
  ///     backoff policies.
  /// @return
  /// @googleapis_link{google::bigtable::admin::v2::AppProfile,google/bigtable/admin/v2/instance.proto#L233}
  ///
  ...
  /// @googleapis_reference_link{google/bigtable/admin/v2/instance.proto#L233}
  ///
  ...
  ///     backoff policies.
  /// @return
  /// @googleapis_link{google::bigtable::admin::v2::HotTablet,google/bigtable/admin/v2/instance.proto#L296}
  ///
  ...
  /// @googleapis_reference_link{google/bigtable/admin/v2/instance.proto#L296}
  ///
