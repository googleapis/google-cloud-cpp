...
class BigtableInstanceAdminClient {
 public:
  ...
  ///     backoff policies.
  /// @return
  /// @googleapis_link{google::bigtable::admin::v2::Cluster,google/bigtable/admin/v2/instance.proto#L140}
  ///
  ...
  /// @googleapis_reference_link{google/bigtable/admin/v2/instance.proto#L140}
  ///
  ...
  ///     backoff policies.
  /// @return
  /// @googleapis_link{google::bigtable::admin::v2::AppProfile,google/bigtable/admin/v2/instance.proto#L241}
  ///
  ...
  /// @googleapis_reference_link{google/bigtable/admin/v2/instance.proto#L241}
  ///
  ...
  ///     backoff policies.
  /// @return
  /// @googleapis_link{google::bigtable::admin::v2::HotTablet,google/bigtable/admin/v2/instance.proto#L304}
  ///
  ...
  /// @googleapis_reference_link{google/bigtable/admin/v2/instance.proto#L304}
  ///
