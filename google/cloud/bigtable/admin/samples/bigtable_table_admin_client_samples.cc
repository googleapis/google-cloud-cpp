...
// main-dox-marker: GOOGLE_CLOUD_CPP_NS::BigtableTableAdminClient
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::GOOGLE_CLOUD_CPP_NS::BigtableTableAdminClient(
      google::cloud::GOOGLE_CLOUD_CPP_NS::MakeBigtableTableAdminConnection(
          options));
  //! [set-client-endpoint]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::GOOGLE_CLOUD_CPP_NS::BigtableTableAdminClient(
        google::cloud::GOOGLE_CLOUD_CPP_NS::MakeBigtableTableAdminConnection(
            options));
  }
  //! [with-service-account]
