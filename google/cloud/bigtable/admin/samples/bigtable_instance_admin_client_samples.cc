...
// main-dox-marker: GOOGLE_CLOUD_CPP_NS::BigtableInstanceAdminClient
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::GOOGLE_CLOUD_CPP_NS::BigtableInstanceAdminClient(
      google::cloud::GOOGLE_CLOUD_CPP_NS::MakeBigtableInstanceAdminConnection(
          options));
  //! [set-client-endpoint]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::GOOGLE_CLOUD_CPP_NS::BigtableInstanceAdminClient(
        google::cloud::GOOGLE_CLOUD_CPP_NS::MakeBigtableInstanceAdminConnection(
            options));
  }
  //! [with-service-account]
