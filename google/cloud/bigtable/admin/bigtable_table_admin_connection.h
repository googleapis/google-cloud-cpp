...
/**
 * A retry policy for `BigtableTableAdminConnection` that stops retrying after a
...
class BigtableTableAdminLimitedErrorCountRetryPolicy
 ...
 public:
  BigtableTableAdminLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `BigtableTableAdminConnection` that stops retrying after
