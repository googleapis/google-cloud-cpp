...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_BIGTABLE_ADMIN_INTERNAL_BIGTABLE_INSTANCE_ADMIN_TRACING_STUB_H
...
class BigtableInstanceAdminTracingStub : public BigtableInstanceAdminStub {
 public:
  ...
  explicit BigtableInstanceAdminTracingStub(std::shared_ptr<BigtableInstanceAdminStub> child);
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_BIGTABLE_ADMIN_INTERNAL_BIGTABLE_INSTANCE_ADMIN_TRACING_STUB_H
