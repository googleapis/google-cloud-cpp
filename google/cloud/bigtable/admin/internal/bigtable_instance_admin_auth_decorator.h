...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_BIGTABLE_ADMIN_INTERNAL_BIGTABLE_INSTANCE_ADMIN_AUTH_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_BIGTABLE_ADMIN_INTERNAL_BIGTABLE_INSTANCE_ADMIN_AUTH_DECORATOR_H
...
class BigtableInstanceAdminAuth : public BigtableInstanceAdminStub {
 public:
  ~BigtableInstanceAdminAuth() override = default;
  BigtableInstanceAdminAuth(
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_BIGTABLE_ADMIN_INTERNAL_BIGTABLE_INSTANCE_ADMIN_AUTH_DECORATOR_H
