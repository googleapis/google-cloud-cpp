...
class BigtableTableAdminConnectionImpl
 ...
 private:
  ...
  std::unique_ptr<bigtable_admin::BigtableTableAdminConnectionIdempotencyPolicy> idempotency_policy() {
    auto const& options = internal::CurrentOptions();
  ...
  std::unique_ptr<bigtable_admin::BigtableTableAdminRetryPolicy const> retry_policy_prototype_;
  std::unique_ptr<BackoffPolicy const> backoff_policy_prototype_;
  std::unique_ptr<bigtable_admin::BigtableTableAdminConnectionIdempotencyPolicy> idempotency_policy_;
