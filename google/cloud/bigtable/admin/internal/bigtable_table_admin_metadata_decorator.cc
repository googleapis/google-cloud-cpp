...
BigtableTableAdminMetadata::AsyncUpdateTable(
  ...
  SetMetadata(*context, *options, absl::StrCat("table.name=", internal::UrlEncode(request.table().name())));
  return child_->AsyncUpdateTable(
...
Status
BigtableTableAdminMetadata::DeleteTable(
    grpc::ClientContext& context,
    Options const& options,
...
BigtableTableAdminMetadata::AsyncUndeleteTable(
  ...
  SetMetadata(*context, *options, absl::StrCat("name=", internal::UrlEncode(request.name())));
  return child_->AsyncUndeleteTable(
      cq, std::move(context), std::move(options), request);
}
...
BigtableTableAdminMetadata::AsyncCreateAuthorizedView(
  ...
  SetMetadata(*context, *options, absl::StrCat("parent=", internal::UrlEncode(request.parent())));
  return child_->AsyncCreateAuthorizedView(
      cq, std::move(context), std::move(options), request);
}
...
BigtableTableAdminMetadata::AsyncUpdateAuthorizedView(
  ...
  SetMetadata(*context, *options, absl::StrCat("authorized_view.name=", internal::UrlEncode(request.authorized_view().name())));
  return child_->AsyncUpdateAuthorizedView(
      cq, std::move(context), std::move(options), request);
}
...
Status
BigtableTableAdminMetadata::DeleteAuthorizedView(
    grpc::ClientContext& context,
    Options const& options,
...
Status
BigtableTableAdminMetadata::DropRowRange(
    grpc::ClientContext& context,
    Options const& options,
...
Status
BigtableTableAdminMetadata::DeleteBackup(
    grpc::ClientContext& context,
    Options const& options,
...
BigtableTableAdminMetadata::AsyncRestoreTable(
  ...
  SetMetadata(*context, *options, absl::StrCat("parent=", internal::UrlEncode(request.parent())));
  return child_->AsyncRestoreTable(
      cq, std::move(context), std::move(options), request);
}
...
StatusOr<google::longrunning::Operation>
BigtableTableAdminMetadata::CopyBackup(
    grpc::ClientContext& context,
    Options options,
    google::bigtable::admin::v2::CopyBackupRequest const& request) {
  SetMetadata(context, options, absl::StrCat("parent=", internal::UrlEncode(request.parent())));
...
BigtableTableAdminMetadata::GetIamPolicy(
    grpc::ClientContext& context,
    Options const& options,
...
StatusOr<google::iam::v1::Policy>
BigtableTableAdminMetadata::SetIamPolicy(
    grpc::ClientContext& context,
    Options const& options,
...
BigtableTableAdminMetadata::AsyncCreateSchemaBundle(
  ...
  SetMetadata(*context, *options, absl::StrCat("parent=", internal::UrlEncode(request.parent())));
  return child_->AsyncCreateSchemaBundle(
      cq, std::move(context), std::move(options), request);
}
...
BigtableTableAdminMetadata::AsyncUpdateSchemaBundle(
  ...
  SetMetadata(*context, *options, absl::StrCat("schema_bundle.name=", internal::UrlEncode(request.schema_bundle().name())));
  return child_->AsyncUpdateSchemaBundle(
      cq, std::move(context), std::move(options), request);
}
...
Status
BigtableTableAdminMetadata::DeleteSchemaBundle(
    grpc::ClientContext& context,
    Options const& options,
...
BigtableTableAdminMetadata::AsyncCheckConsistency(
      ...
      google::bigtable::admin::v2::CheckConsistencyRequest const& request) {
  SetMetadata(*context, *options, absl::StrCat("name=", internal::UrlEncode(request.name())));
  return child_->AsyncCheckConsistency(
      cq, std::move(context), std::move(options), request);
}
