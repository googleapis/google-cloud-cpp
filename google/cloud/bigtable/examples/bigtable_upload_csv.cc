...
[options] <project> <instance> <table> <family>
The options are:
...
int main(int argc, char* argv[]) try {
  ...
  std::string const filename = options.ConsumeArg(argc, argv, "filename");
  ...
  int const report_reader_progress_rate = 50000;
  // How often do we print a progress marker ('+') in the worker threads.
  int const report_worker_progress_rate = 10;
