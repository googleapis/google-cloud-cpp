...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_BIGTABLE_POLL_LONGRUNNING_OPERATION_H_
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_BIGTABLE_POLL_LONGRUNNING_OPERATION_H_
 ...
 */
class PollLongRunningOperation {
 public:
  template <typename ResultType, typename ClientType>
  ResultType RunOperation(std::shared_ptr<ClientType> client,
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_BIGTABLE_POLL_LONGRUNNING_OPERATION_H_
