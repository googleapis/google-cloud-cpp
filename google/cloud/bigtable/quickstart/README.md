...
This directory contains small examples showing how to use the Cloud Bigtable C++
...
(GCP) project, as well as a Cloud Bigtable instance and table. The
[Cloud Bigtable quickstart][bigtable-quickstart] covers the necessary steps in
detail. Make a note of the GCP project id, the instance id, and the table id as
