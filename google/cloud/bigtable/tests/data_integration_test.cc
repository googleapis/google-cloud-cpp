...
TEST_F(DataIntegrationTest, TableBulkApplyThrottling) {
...
TEST_F(DataIntegrationTest, TableReadRowsReverseScan) {
...
TEST_F(DataIntegrationTest, ClientQueryColumnFamily) {
  if (UsingCloudBigtableEmulator()) GTEST_SKIP();
  auto const table_id = testing::TableTestEnvironment::table_id();
...
TEST_F(DataIntegrationTest, ClientQueryColumnFamilyWithHistory) {
  if (UsingCloudBigtableEmulator()) GTEST_SKIP();
  auto const table_id = testing::TableTestEnvironment::table_id();
  auto retry_policy_option = DataLimitedErrorCountRetryPolicy(0).clone();
  auto backoff_policy_option =
...
TEST_F(DataIntegrationTest, SingleColumnQuery) {
  if (UsingCloudBigtableEmulator()) GTEST_SKIP();
  auto const table_id = testing::TableTestEnvironment::table_id();
  auto retry_policy_option = DataLimitedErrorCountRetryPolicy(0).clone();
  auto backoff_policy_option =
...
TEST_F(DataIntegrationTest, SingleColumnQueryWithHistory) {
  if (UsingCloudBigtableEmulator()) GTEST_SKIP();
  auto const table_id = testing::TableTestEnvironment::table_id();
  auto retry_policy_option = DataLimitedErrorCountRetryPolicy(0).clone();
  auto backoff_policy_option =
...
TEST_F(DataIntegrationTest, MultiColumnQuery) {
  if (UsingCloudBigtableEmulator()) GTEST_SKIP();
  auto const table_id = testing::TableTestEnvironment::table_id();
  auto retry_policy_option = DataLimitedErrorCountRetryPolicy(0).clone();
  auto backoff_policy_option =
...
TEST_F(DataIntegrationTest, QueryWithNulls) {
  if (UsingCloudBigtableEmulator()) GTEST_SKIP();
  auto const table_id = testing::TableTestEnvironment::table_id();
  auto retry_policy_option = DataLimitedErrorCountRetryPolicy(0).clone();
  auto backoff_policy_option =
