...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DATACATALOG_INTERNAL_POLICY_TAG_MANAGER_SERIALIZATION_TRACING_CONNECTION_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DATACATALOG_INTERNAL_POLICY_TAG_MANAGER_SERIALIZATION_TRACING_CONNECTION_H
...
class PolicyTagManagerSerializationTracingConnection
 ...
 private:
  std::shared_ptr<datacatalog::PolicyTagManagerSerializationConnection> child_;
};
...
MakePolicyTagManagerSerializationTracingConnection(
    std::shared_ptr<datacatalog::PolicyTagManagerSerializationConnection> conn);
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DATACATALOG_INTERNAL_POLICY_TAG_MANAGER_SERIALIZATION_TRACING_CONNECTION_H
