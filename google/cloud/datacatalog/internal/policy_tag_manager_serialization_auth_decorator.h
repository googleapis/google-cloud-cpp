...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DATACATALOG_INTERNAL_POLICY_TAG_MANAGER_SERIALIZATION_AUTH_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DATACATALOG_INTERNAL_POLICY_TAG_MANAGER_SERIALIZATION_AUTH_DECORATOR_H
...
class PolicyTagManagerSerializationAuth
    : public PolicyTagManagerSerializationStub {
 public:
  ~PolicyTagManagerSerializationAuth() override = default;
  PolicyTagManagerSerializationAuth(
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DATACATALOG_INTERNAL_POLICY_TAG_MANAGER_SERIALIZATION_AUTH_DECORATOR_H
