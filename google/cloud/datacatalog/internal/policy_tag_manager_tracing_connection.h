...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DATACATALOG_INTERNAL_POLICY_TAG_MANAGER_TRACING_CONNECTION_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DATACATALOG_INTERNAL_POLICY_TAG_MANAGER_TRACING_CONNECTION_H
...
class PolicyTagManagerTracingConnection
 ...
 private:
  std::shared_ptr<datacatalog::PolicyTagManagerConnection> child_;
};
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DATACATALOG_INTERNAL_POLICY_TAG_MANAGER_TRACING_CONNECTION_H
