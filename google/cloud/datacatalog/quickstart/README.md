# HOWTO: using the Google Cloud Data Catalog API C++ client in your project

This directory contains small examples showing how to use the Google Cloud Data Catalog API C++
...
Like most Google Cloud Platform (GCP) services, Google Cloud Data Catalog API requires that
...
2. Install the dependencies with your favorite tools. As an example, if you use
   ...
   ```bash
   cd $HOME/vcpkg
   ./vcpkg install google-cloud-cpp[core,datacatalog]
   ```
...
3. Configure CMake, if necessary, configure the directory where you installed
   ...
   ```bash
   cd $HOME/gooogle-cloud-cpp/google/cloud/datacatalog/quickstart
...
[quickstart-link]: https://cloud.google.com/data-catalog/docs/tag-bigquery-dataset
