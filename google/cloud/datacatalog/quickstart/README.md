...
This directory contains small examples showing how to use the Google Cloud Data
Catalog API C++ client library in your own project. These instructions assume
