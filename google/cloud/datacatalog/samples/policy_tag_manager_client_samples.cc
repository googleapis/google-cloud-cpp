...
// main-dox-marker: GOOGLE_CLOUD_CPP_NS::PolicyTagManagerClient
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::GOOGLE_CLOUD_CPP_NS::PolicyTagManagerClient(
      google::cloud::GOOGLE_CLOUD_CPP_NS::MakePolicyTagManagerConnection(
          options));
  //! [set-client-endpoint]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::GOOGLE_CLOUD_CPP_NS::PolicyTagManagerClient(
        google::cloud::GOOGLE_CLOUD_CPP_NS::MakePolicyTagManagerConnection(
            options));
  }
  //! [with-service-account]
