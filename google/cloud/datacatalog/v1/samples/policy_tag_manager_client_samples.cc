...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::datacatalog_v1::PolicyTagManagerClient(
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::datacatalog_v1::PolicyTagManagerClient(
      google::cloud::datacatalog_v1::MakePolicyTagManagerConnection(
          *ud_options));
  //! [set-client-universe-domain]
}
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options =
      google::cloud::Options{}
          ...
          .set<
              google::cloud::datacatalog_v1::PolicyTagManagerRetryPolicyOption>(
              google::cloud::datacatalog_v1::
                  PolicyTagManagerLimitedErrorCountRetryPolicy(3)
                      .clone())
          .set<google::cloud::datacatalog_v1::
