...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::datacatalog_v1::DataCatalogClient(
...
class CustomIdempotencyPolicy
   : public google::cloud::datacatalog_v1::DataCatalogConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::datacatalog_v1::DataCatalogConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::datacatalog_v1::DataCatalogConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::datacatalog_v1::DataCatalogRetryPolicyOption>(
      google::cloud::datacatalog_v1::DataCatalogLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::datacatalog_v1::DataCatalogBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::datacatalog_v1::MakeDataCatalogConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::datacatalog_v1::DataCatalogClient(connection);
  auto c2 = google::cloud::datacatalog_v1::DataCatalogClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::datacatalog_v1::DataCatalogClient(
    connection, google::cloud::Options{}.set<google::cloud::datacatalog_v1::DataCatalogRetryPolicyOption>(
      google::cloud::datacatalog_v1::DataCatalogLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::datacatalog_v1::DataCatalogRetryPolicyOption>(
  //       google::cloud::datacatalog_v1::DataCatalogLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::datacatalog_v1::DataCatalogPollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::datacatalog_v1::DataCatalogRetryPolicyOption::Type,
            google::cloud::datacatalog_v1::DataCatalogBackoffPolicyOption::Type>(
            google::cloud::datacatalog_v1::DataCatalogLimitedTimeRetryPolicy(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::datacatalog_v1::DataCatalogClient(
      google::cloud::datacatalog_v1::MakeDataCatalogConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
