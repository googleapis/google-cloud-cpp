...
/**
 * A retry policy for `PolicyTagManagerConnection` that stops retrying after a
...
class PolicyTagManagerLimitedErrorCountRetryPolicy
 ...
 public:
  PolicyTagManagerLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `PolicyTagManagerConnection` that stops retrying after
