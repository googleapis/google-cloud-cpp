 ...
 * including errors, from an object of type `PolicyTagManagerSerializationClient`. To do so,
 * construct an object of type `PolicyTagManagerSerializationClient` with an instance of this
 ...
 */
class MockPolicyTagManagerSerializationConnection : public datacatalog_v1::PolicyTagManagerSerializationConnection {
 public:
  ...
  MOCK_METHOD(StatusOr<google::cloud::datacatalog::v1::ImportTaxonomiesResponse>,
  ImportTaxonomies,
  (google::cloud::datacatalog::v1::ImportTaxonomiesRequest const& request), (override));

  MOCK_METHOD(StatusOr<google::cloud::datacatalog::v1::ExportTaxonomiesResponse>,
  ExportTaxonomies,
