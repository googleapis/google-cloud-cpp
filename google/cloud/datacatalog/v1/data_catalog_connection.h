...
/**
 * A retry policy for `DataCatalogConnection` that stops retrying after a
...
class DataCatalogLimitedErrorCountRetryPolicy : public DataCatalogRetryPolicy {
 public:
  DataCatalogLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `DataCatalogConnection` that stops retrying after
