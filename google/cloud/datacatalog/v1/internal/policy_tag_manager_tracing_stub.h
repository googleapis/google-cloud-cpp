...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DATACATALOG_V1_INTERNAL_POLICY_TAG_MANAGER_TRACING_STUB_H
...
class PolicyTagManagerTracingStub : public PolicyTagManagerStub {
 public:
  ~PolicyTagManagerTracingStub() override = default;

  explicit PolicyTagManagerTracingStub(std::shared_ptr<PolicyTagManagerStub> child);
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DATACATALOG_V1_INTERNAL_POLICY_TAG_MANAGER_TRACING_STUB_H
