...
DataCatalogMetadata::UpdateEntryGroup(
  ...
  SetMetadata(context, options, absl::StrCat("entry_group.name=", internal::UrlEncode(request.entry_group().name())));
  return child_->UpdateEntryGroup(context, options, request);
}

Status
DataCatalogMetadata::DeleteEntryGroup(
    grpc::ClientContext& context,
    Options const& options,
...
DataCatalogMetadata::UpdateEntry(
  ...
  SetMetadata(context, options, absl::StrCat("entry.name=", internal::UrlEncode(request.entry().name())));
  return child_->UpdateEntry(context, options, request);
}

Status
DataCatalogMetadata::DeleteEntry(
    grpc::ClientContext& context,
    Options const& options,
...
DataCatalogMetadata::UpdateTagTemplate(
  ...
  SetMetadata(context, options, absl::StrCat("tag_template.name=", internal::UrlEncode(request.tag_template().name())));
  return child_->UpdateTagTemplate(context, options, request);
}

Status
DataCatalogMetadata::DeleteTagTemplate(
    grpc::ClientContext& context,
    Options const& options,
...
Status
DataCatalogMetadata::DeleteTagTemplateField(
    grpc::ClientContext& context,
    Options const& options,
...
DataCatalogMetadata::AsyncReconcileTags(
  ...
  SetMetadata(*context, *options, absl::StrCat("parent=", internal::UrlEncode(request.parent())));
  return child_->AsyncReconcileTags(
      cq, std::move(context), std::move(options), request);
}

StatusOr<google::longrunning::Operation>
DataCatalogMetadata::ReconcileTags(
    grpc::ClientContext& context,
    Options options,
    google::cloud::datacatalog::v1::ReconcileTagsRequest const& request) {
  SetMetadata(context, options, absl::StrCat("parent=", internal::UrlEncode(request.parent())));
...
DataCatalogMetadata::SetIamPolicy(
    grpc::ClientContext& context,
    Options const& options,
...
StatusOr<google::iam::v1::Policy>
DataCatalogMetadata::GetIamPolicy(
    grpc::ClientContext& context,
    Options const& options,
...
DataCatalogMetadata::AsyncImportEntries(
  ...
  SetMetadata(*context, *options, absl::StrCat("parent=", internal::UrlEncode(request.parent())));
  return child_->AsyncImportEntries(
      cq, std::move(context), std::move(options), request);
}

StatusOr<google::longrunning::Operation>
DataCatalogMetadata::ImportEntries(
    grpc::ClientContext& context,
    Options options,
    google::cloud::datacatalog::v1::ImportEntriesRequest const& request) {
  SetMetadata(context, options, absl::StrCat("parent=", internal::UrlEncode(request.parent())));
...
StatusOr<google::longrunning::Operation>
DataCatalogMetadata::GetOperation(
    grpc::ClientContext& context,
    Options const& options,
...
Status
DataCatalogMetadata::DeleteOperation(
    grpc::ClientContext& context,
    Options const& options,
...
Status
DataCatalogMetadata::CancelOperation(
    grpc::ClientContext& context,
    Options const& options,
