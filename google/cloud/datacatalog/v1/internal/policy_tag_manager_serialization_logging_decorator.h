...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DATACATALOG_V1_INTERNAL_POLICY_TAG_MANAGER_SERIALIZATION_LOGGING_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DATACATALOG_V1_INTERNAL_POLICY_TAG_MANAGER_SERIALIZATION_LOGGING_DECORATOR_H
...
class PolicyTagManagerSerializationLogging : public PolicyTagManagerSerializationStub {
 public:
  ~PolicyTagManagerSerializationLogging() override = default;
  PolicyTagManagerSerializationLogging(std::shared_ptr<PolicyTagManagerSerializationStub> child,
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DATACATALOG_V1_INTERNAL_POLICY_TAG_MANAGER_SERIALIZATION_LOGGING_DECORATOR_H
