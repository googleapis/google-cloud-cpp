...
std::shared_ptr<PolicyTagManagerStub> CreateDefaultPolicyTagManagerStub(
  ...
  auto endpoint = internal::DetermineServiceEndpoint(
      internal::GetEnv("GOOGLE_CLOUD_CPP_POLICY_TAG_MANAGER_ENDPOINT"),
  ...
  if (!endpoint.ok()) {
    ...
    stub = std::make_shared<DefaultPolicyTagManagerStub>(
  ...
  if (internal::TracingEnabled(options)) {
    stub = MakePolicyTagManagerTracingStub(std::move(stub));
  }
  return stub;
}
