 ...
 * @ingroup google-cloud-datacatalog-options
 */
struct LineageBackoffPolicyOption {
 ...
 * @ingroup google-cloud-datacatalog-options
 */
struct LineageConnectionIdempotencyPolicyOption {
  using Type = std::shared_ptr<LineageConnectionIdempotencyPolicy>;
};
 ...
 * @ingroup google-cloud-datacatalog-options
 */
struct LineagePollingPolicyOption {
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DATACATALOG_LINEAGE_V1_LINEAGE_OPTIONS_H
