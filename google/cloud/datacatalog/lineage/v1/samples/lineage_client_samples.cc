...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::datacatalog_lineage_v1::LineageClient(
...
class CustomIdempotencyPolicy
   : public google::cloud::datacatalog_lineage_v1::LineageConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::datacatalog_lineage_v1::LineageConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::datacatalog_lineage_v1::LineageConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::datacatalog_lineage_v1::LineageRetryPolicyOption>(
      google::cloud::datacatalog_lineage_v1::LineageLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::datacatalog_lineage_v1::LineageBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::datacatalog_lineage_v1::MakeLineageConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::datacatalog_lineage_v1::LineageClient(connection);
  auto c2 = google::cloud::datacatalog_lineage_v1::LineageClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::datacatalog_lineage_v1::LineageClient(
    connection, google::cloud::Options{}.set<google::cloud::datacatalog_lineage_v1::LineageRetryPolicyOption>(
      google::cloud::datacatalog_lineage_v1::LineageLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::datacatalog_lineage_v1::LineageRetryPolicyOption>(
  //       google::cloud::datacatalog_lineage_v1::LineageLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::datacatalog_lineage_v1::LineagePollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::datacatalog_lineage_v1::LineageRetryPolicyOption::Type,
            google::cloud::datacatalog_lineage_v1::LineageBackoffPolicyOption::Type>(
            google::cloud::datacatalog_lineage_v1::LineageLimitedTimeRetryPolicy(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::datacatalog_lineage_v1::LineageClient(
      google::cloud::datacatalog_lineage_v1::MakeLineageConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
