...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DATACATALOG_LINEAGE_CONFIGMANAGEMENT_V1_CONFIG_MANAGEMENT_CLIENT_H
...
///
class ConfigManagementServiceClient {
 public:
  explicit ConfigManagementServiceClient(
      std::shared_ptr<ConfigManagementServiceConnection> connection,
      Options opts = {});
  ~ConfigManagementServiceClient();

  ///@{
  /// @name Copy and move support
  ConfigManagementServiceClient(ConfigManagementServiceClient const&) = default;
  ConfigManagementServiceClient& operator=(
      ConfigManagementServiceClient const&) = default;
  ConfigManagementServiceClient(ConfigManagementServiceClient&&) = default;
  ConfigManagementServiceClient& operator=(ConfigManagementServiceClient&&) =
      default;
  ///@}

  ///@{
  /// @name Equality
  friend bool operator==(ConfigManagementServiceClient const& a,
                         ConfigManagementServiceClient const& b) {
  ...
  ///
  /// @param name  Required. REQUIRED: The resource name of the config to be fetched.
  ///  Format:
  ...
  /// [google.cloud.datacatalog.lineage.configmanagement.v1.Config]: @googleapis_reference_link{google/cloud/datacatalog/lineage/configmanagement/v1/configmanagement.proto#L96}
  /// [google.cloud.datacatalog.lineage.configmanagement.v1.GetConfigRequest]: @googleapis_reference_link{google/cloud/datacatalog/lineage/configmanagement/v1/configmanagement.proto#L72}
  ///
  // clang-format on
  ...
  /// [`Status`]: @ref google::cloud::Status
  /// [google.cloud.datacatalog.lineage.configmanagement.v1.Config]: @googleapis_reference_link{google/cloud/datacatalog/lineage/configmanagement/v1/configmanagement.proto#L96}
  /// [google.cloud.datacatalog.lineage.configmanagement.v1.UpdateConfigRequest]: @googleapis_reference_link{google/cloud/datacatalog/lineage/configmanagement/v1/configmanagement.proto#L88}
  ///
  // clang-format on
  StatusOr<google::cloud::datacatalog::lineage::configmanagement::v1::Config>
  UpdateConfig(
 ...
 private:
  std::shared_ptr<ConfigManagementServiceConnection> connection_;
  Options options_;
};
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DATACATALOG_LINEAGE_CONFIGMANAGEMENT_V1_CONFIG_MANAGEMENT_CLIENT_H
