...
CreateDefaultCertificateAuthorityServiceStub(
  ...
  auto service_grpc_stub = google::cloud::security::privateca::v1::CertificateAuthorityService::NewStub(channel);
  ...
  if (auth->RequiresConfigureContext()) {
    stub = std::make_shared<CertificateAuthorityServiceAuth>(
