...
/**
 * A retry policy for `ContextsConnection` that stops retrying after a
...
class ContextsLimitedErrorCountRetryPolicy : public ContextsRetryPolicy {
 public:
  ContextsLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `ContextsConnection` that stops retrying after
