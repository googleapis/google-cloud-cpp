...
/**
 * A retry policy for `EntityTypesConnection` that stops retrying after a
...
class EntityTypesLimitedErrorCountRetryPolicy : public EntityTypesRetryPolicy {
 public:
  EntityTypesLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `EntityTypesConnection` that stops retrying after
