...
StreamRange<google::cloud::dialogflow::v2::Agent> AgentsConnection::SearchAgents(
    google::cloud::dialogflow::v2::SearchAgentsRequest) {  // NOLINT(performance-unnecessary-value-param)
...
std::shared_ptr<AgentsConnection> MakeAgentsConnection(
  ...
  options = dialogflow_es_internal::AgentsDefaultOptions(
      location, std::move(options));
  auto background = internal::MakeBackgroundThreadsFactory(options)();
  auto auth = internal::CreateAuthenticationStrategy(background->cq(), options);
  auto stub = dialogflow_es_internal::CreateDefaultAgentsStub(
