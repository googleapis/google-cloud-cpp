...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::dialogflow_es::ConversationDatasetsClient(
...
class CustomIdempotencyPolicy
   : public google::cloud::dialogflow_es::ConversationDatasetsConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::dialogflow_es::ConversationDatasetsConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::dialogflow_es::ConversationDatasetsConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::dialogflow_es::ConversationDatasetsRetryPolicyOption>(
      google::cloud::dialogflow_es::ConversationDatasetsLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::dialogflow_es::ConversationDatasetsBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::dialogflow_es::MakeConversationDatasetsConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::dialogflow_es::ConversationDatasetsClient(connection);
  auto c2 = google::cloud::dialogflow_es::ConversationDatasetsClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::dialogflow_es::ConversationDatasetsClient(
    connection, google::cloud::Options{}.set<google::cloud::dialogflow_es::ConversationDatasetsRetryPolicyOption>(
      google::cloud::dialogflow_es::ConversationDatasetsLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::dialogflow_es::ConversationDatasetsPollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::dialogflow_es::ConversationDatasetsRetryPolicyOption::Type,
            google::cloud::dialogflow_es::ConversationDatasetsBackoffPolicyOption::Type>(
            google::cloud::dialogflow_es::ConversationDatasetsLimitedTimeRetryPolicy(
