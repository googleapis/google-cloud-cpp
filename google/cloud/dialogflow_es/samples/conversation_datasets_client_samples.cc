...
// main-dox-marker: GOOGLE_CLOUD_CPP_NS::ConversationDatasetsClient
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::GOOGLE_CLOUD_CPP_NS::ConversationDatasetsClient(
      google::cloud::GOOGLE_CLOUD_CPP_NS::MakeConversationDatasetsConnection(
          options));
  //! [set-client-endpoint]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::GOOGLE_CLOUD_CPP_NS::ConversationDatasetsClient(
        google::cloud::GOOGLE_CLOUD_CPP_NS::MakeConversationDatasetsConnection(
            options));
  }
  //! [with-service-account]
