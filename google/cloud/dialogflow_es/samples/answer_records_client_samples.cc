...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::dialogflow_es::AnswerRecordsClient(
...
class CustomIdempotencyPolicy
   : public google::cloud::dialogflow_es::AnswerRecordsConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::dialogflow_es::AnswerRecordsConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::dialogflow_es::AnswerRecordsConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::dialogflow_es::AnswerRecordsRetryPolicyOption>(
      google::cloud::dialogflow_es::AnswerRecordsLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::dialogflow_es::AnswerRecordsBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::dialogflow_es::MakeAnswerRecordsConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::dialogflow_es::AnswerRecordsClient(connection);
  auto c2 = google::cloud::dialogflow_es::AnswerRecordsClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::dialogflow_es::AnswerRecordsClient(
    connection, google::cloud::Options{}.set<google::cloud::dialogflow_es::AnswerRecordsRetryPolicyOption>(
      google::cloud::dialogflow_es::AnswerRecordsLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::dialogflow_es::AnswerRecordsRetryPolicyOption>(
  //       google::cloud::dialogflow_es::AnswerRecordsLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
