...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::dialogflow_es::AgentsClient(
...
class CustomIdempotencyPolicy
   : public google::cloud::dialogflow_es::AgentsConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::dialogflow_es::AgentsConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::dialogflow_es::AgentsConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::dialogflow_es::AgentsRetryPolicyOption>(
      google::cloud::dialogflow_es::AgentsLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::dialogflow_es::AgentsBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::dialogflow_es::MakeAgentsConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::dialogflow_es::AgentsClient(connection);
  auto c2 = google::cloud::dialogflow_es::AgentsClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::dialogflow_es::AgentsClient(
    connection, google::cloud::Options{}.set<google::cloud::dialogflow_es::AgentsRetryPolicyOption>(
      google::cloud::dialogflow_es::AgentsLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::dialogflow_es::AgentsRetryPolicyOption>(
  //       google::cloud::dialogflow_es::AgentsLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::dialogflow_es::AgentsPollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::dialogflow_es::AgentsRetryPolicyOption::Type,
            google::cloud::dialogflow_es::AgentsBackoffPolicyOption::Type>(
            google::cloud::dialogflow_es::AgentsLimitedTimeRetryPolicy(
