...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::dialogflow_es::GeneratorsClient(
      google::cloud::dialogflow_es::MakeGeneratorsConnection(ud_options));
...
class CustomIdempotencyPolicy : public google::cloud::dialogflow_es::
 ...
 public:
  ...
  std::unique_ptr<
      google::cloud::dialogflow_es::GeneratorsConnectionIdempotencyPolicy>
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
      ...
      google::cloud::Options{}
          ...
          .set<google::cloud::dialogflow_es::GeneratorsRetryPolicyOption>(
              google::cloud::dialogflow_es::
                  GeneratorsLimitedErrorCountRetryPolicy(3)
                      .clone())
  ...
  auto c3 = google::cloud::dialogflow_es::GeneratorsClient(
      ...
      google::cloud::Options{}
          .set<google::cloud::dialogflow_es::GeneratorsRetryPolicyOption>(
              google::cloud::dialogflow_es::GeneratorsLimitedTimeRetryPolicy(
