...
// main-dox-marker: GOOGLE_CLOUD_CPP_NS::ConversationProfilesClient
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::GOOGLE_CLOUD_CPP_NS::ConversationProfilesClient(
      google::cloud::GOOGLE_CLOUD_CPP_NS::MakeConversationProfilesConnection(
          options));
  //! [set-client-endpoint]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::GOOGLE_CLOUD_CPP_NS::ConversationProfilesClient(
        google::cloud::GOOGLE_CLOUD_CPP_NS::MakeConversationProfilesConnection(
            options));
  }
  //! [with-service-account]
