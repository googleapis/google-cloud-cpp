...
Idempotency VersionsConnectionIdempotencyPolicy::ListVersions(google::cloud::dialogflow::v2::ListVersionsRequest) {  // NOLINT
  return Idempotency::kIdempotent;
}

Idempotency VersionsConnectionIdempotencyPolicy::GetVersion(google::cloud::dialogflow::v2::GetVersionRequest const&) {
  return Idempotency::kIdempotent;
}

Idempotency VersionsConnectionIdempotencyPolicy::CreateVersion(google::cloud::dialogflow::v2::CreateVersionRequest const&) {
  return Idempotency::kNonIdempotent;
}

Idempotency VersionsConnectionIdempotencyPolicy::UpdateVersion(google::cloud::dialogflow::v2::UpdateVersionRequest const&) {
  return Idempotency::kNonIdempotent;
}

Idempotency VersionsConnectionIdempotencyPolicy::DeleteVersion(google::cloud::dialogflow::v2::DeleteVersionRequest const&) {
  return Idempotency::kNonIdempotent;
}
