...
/**
 * A retry policy for `ParticipantsConnection` that stops retrying after a
...
class ParticipantsLimitedErrorCountRetryPolicy
 ...
 public:
  ParticipantsLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `ParticipantsConnection` that stops retrying after
