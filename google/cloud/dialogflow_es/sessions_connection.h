...
/**
 * A retry policy for `SessionsConnection` that stops retrying after a
...
class SessionsLimitedErrorCountRetryPolicy : public SessionsRetryPolicy {
 public:
  SessionsLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `SessionsConnection` that stops retrying after
