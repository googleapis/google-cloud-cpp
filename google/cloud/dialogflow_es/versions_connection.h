...
/**
 * A retry policy for `VersionsConnection` that stops retrying after a
...
class VersionsLimitedErrorCountRetryPolicy : public VersionsRetryPolicy {
 public:
  VersionsLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `VersionsConnection` that stops retrying after
