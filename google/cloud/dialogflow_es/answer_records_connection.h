...
/**
 * A retry policy for `AnswerRecordsConnection` that stops retrying after a
...
class AnswerRecordsLimitedErrorCountRetryPolicy
 ...
 public:
  AnswerRecordsLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `AnswerRecordsConnection` that stops retrying after
