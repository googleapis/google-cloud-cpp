...
/**
 * A retry policy for `AgentsConnection` that stops retrying after a
...
class AgentsLimitedErrorCountRetryPolicy : public AgentsRetryPolicy {
 public:
  AgentsLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `AgentsConnection` that stops retrying after
