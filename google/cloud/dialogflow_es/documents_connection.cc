...
StreamRange<google::cloud::dialogflow::v2::Document> DocumentsConnection::ListDocuments(
    google::cloud::dialogflow::v2::ListDocumentsRequest) {  // NOLINT(performance-unnecessary-value-param)
...
StreamRange<google::cloud::location::Location> DocumentsConnection::ListLocations(
...
DocumentsConnection::GetLocation(
...
StatusOr<google::longrunning::Operation>
DocumentsConnection::GetOperation(
    google::longrunning::GetOperationRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

Status
DocumentsConnection::CancelOperation(
...
std::shared_ptr<DocumentsConnection> MakeDocumentsConnection(
  ...
  options = dialogflow_es_internal::DocumentsDefaultOptions(
