...
class DocumentsRetryPolicy : public ::google::cloud::RetryPolicy {
 public:
  /// Creates a new instance of the policy, reset to the initial state.
  virtual std::unique_ptr<DocumentsRetryPolicy> clone() const = 0;
};
 ...
 */
class DocumentsLimitedErrorCountRetryPolicy : public DocumentsRetryPolicy {
 public:
  /**
  ...
  std::unique_ptr<DocumentsRetryPolicy> clone() const override {
    return std::make_unique<DocumentsLimitedErrorCountRetryPolicy>(
        maximum_failures());
  }
 ...
 * - [`kUnavailable`](@ref google::cloud::StatusCode)
 */
class DocumentsLimitedTimeRetryPolicy : public DocumentsRetryPolicy {
 public:
  /**
  ...
  std::unique_ptr<DocumentsRetryPolicy> clone() const override {
    return std::make_unique<DocumentsLimitedTimeRetryPolicy>(
        maximum_duration());
  }
...
class DocumentsConnection {
 public:
  ...
  virtual future<StatusOr<google::cloud::dialogflow::v2::Document>>
  CreateDocument(google::cloud::ExperimentalTag,
  ...
  virtual future<StatusOr<google::cloud::dialogflow::v2::Document>>
  UpdateDocument(google::cloud::ExperimentalTag,
                 google::longrunning::Operation const& operation);
  ...
  virtual future<StatusOr<google::cloud::dialogflow::v2::Document>>
  ReloadDocument(google::cloud::ExperimentalTag,
                 google::longrunning::Operation const& operation);
  ...
  virtual future<StatusOr<google::cloud::dialogflow::v2::Document>>
  ExportDocument(google::cloud::ExperimentalTag,
                 google::longrunning::Operation const& operation);
};
