...
/**
 * A retry policy for `DocumentsConnection` that stops retrying after a
...
class DocumentsLimitedErrorCountRetryPolicy : public DocumentsRetryPolicy {
 public:
  DocumentsLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `DocumentsConnection` that stops retrying after
