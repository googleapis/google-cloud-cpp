...
Status
DefaultConversationProfilesStub::DeleteConversationProfile(
  grpc::ClientContext& context, Options const&,
...
DefaultConversationProfilesStub::AsyncSetSuggestionFeatureConfig(
  ...
  return internal::MakeUnaryRpcImpl<google::cloud::dialogflow::v2::SetSuggestionFeatureConfigRequest,
                                    google::longrunning::Operation>(
      cq,
      [this](grpc::ClientContext* context,
             google::cloud::dialogflow::v2::SetSuggestionFeatureConfigRequest const& request,
             grpc::CompletionQueue* cq) {
        return grpc_stub_->AsyncSetSuggestionFeatureConfig(context, request, cq);
      },
...
DefaultConversationProfilesStub::AsyncClearSuggestionFeatureConfig(
  ...
  return internal::MakeUnaryRpcImpl<google::cloud::dialogflow::v2::ClearSuggestionFeatureConfigRequest,
                                    google::longrunning::Operation>(
      cq,
      [this](grpc::ClientContext* context,
             google::cloud::dialogflow::v2::ClearSuggestionFeatureConfigRequest const& request,
             grpc::CompletionQueue* cq) {
        return grpc_stub_->AsyncClearSuggestionFeatureConfig(context, request, cq);
      },
      request, std::move(context));
}
...
Status
DefaultConversationProfilesStub::CancelOperation(
  grpc::ClientContext& context, Options const&,
