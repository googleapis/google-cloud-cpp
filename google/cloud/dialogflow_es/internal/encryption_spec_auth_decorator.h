...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_ES_INTERNAL_ENCRYPTION_SPEC_AUTH_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_ES_INTERNAL_ENCRYPTION_SPEC_AUTH_DECORATOR_H
...
class EncryptionSpecServiceAuth : public EncryptionSpecServiceStub {
 public:
  ~EncryptionSpecServiceAuth() override = default;
  EncryptionSpecServiceAuth(
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_ES_INTERNAL_ENCRYPTION_SPEC_AUTH_DECORATOR_H
