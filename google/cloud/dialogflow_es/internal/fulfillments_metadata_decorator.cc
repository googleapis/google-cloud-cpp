...
FulfillmentsMetadata::UpdateFulfillment(
  ...
  SetMetadata(context, options, absl::StrCat("fulfillment.name=", internal::UrlEncode(request.fulfillment().name())));
  return child_->UpdateFulfillment(context, options, request);
}

StatusOr<google::cloud::location::ListLocationsResponse>
FulfillmentsMetadata::ListLocations(
    grpc::ClientContext& context,
    Options const& options,
...
FulfillmentsMetadata::GetLocation(
    grpc::ClientContext& context,
    Options const& options,
...
FulfillmentsMetadata::ListOperations(
    grpc::ClientContext& context,
    Options const& options,
...
FulfillmentsMetadata::GetOperation(
    grpc::ClientContext& context,
    Options const& options,
...
Status
FulfillmentsMetadata::CancelOperation(
    grpc::ClientContext& context,
    Options const& options,
