...
class SessionEntityTypesStub {
 public:
  ...
  virtual StatusOr<google::cloud::dialogflow::v2::ListSessionEntityTypesResponse> ListSessionEntityTypes(
      grpc::ClientContext& context,
      Options const& options,
      google::cloud::dialogflow::v2::ListSessionEntityTypesRequest const& request) = 0;

  virtual StatusOr<google::cloud::dialogflow::v2::SessionEntityType> GetSessionEntityType(
      grpc::ClientContext& context,
      Options const& options,
      google::cloud::dialogflow::v2::GetSessionEntityTypeRequest const& request) = 0;

  virtual StatusOr<google::cloud::dialogflow::v2::SessionEntityType> CreateSessionEntityType(
      grpc::ClientContext& context,
      Options const& options,
      google::cloud::dialogflow::v2::CreateSessionEntityTypeRequest const& request) = 0;

  virtual StatusOr<google::cloud::dialogflow::v2::SessionEntityType> UpdateSessionEntityType(
      grpc::ClientContext& context,
      Options const& options,
      google::cloud::dialogflow::v2::UpdateSessionEntityTypeRequest const& request) = 0;

  virtual Status DeleteSessionEntityType(
      grpc::ClientContext& context,
      Options const& options,
      google::cloud::dialogflow::v2::DeleteSessionEntityTypeRequest const& request) = 0;
...
class DefaultSessionEntityTypesStub : public SessionEntityTypesStub {
 public:
  explicit DefaultSessionEntityTypesStub(
      std::unique_ptr<google::cloud::dialogflow::v2::SessionEntityTypes::StubInterface> grpc_stub,
...
,
 ...
 private:
  std::unique_ptr<google::cloud::dialogflow::v2::SessionEntityTypes::StubInterface> grpc_stub_;
