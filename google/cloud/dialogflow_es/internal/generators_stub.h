...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_ES_INTERNAL_GENERATORS_STUB_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_ES_INTERNAL_GENERATORS_STUB_H
...
class GeneratorsStub {
 public:
  ...
  virtual StatusOr<google::cloud::dialogflow::v2::Generator> CreateGenerator(
      ...
      google::cloud::dialogflow::v2::CreateGeneratorRequest const& request) = 0;

  virtual StatusOr<google::cloud::dialogflow::v2::Generator> GetGenerator(
      grpc::ClientContext& context,
      Options const& options,
      google::cloud::dialogflow::v2::GetGeneratorRequest const& request) = 0;

  virtual StatusOr<google::cloud::dialogflow::v2::ListGeneratorsResponse> ListGenerators(
      grpc::ClientContext& context,
      Options const& options,
      google::cloud::dialogflow::v2::ListGeneratorsRequest const& request) = 0;

  virtual Status DeleteGenerator(
      grpc::ClientContext& context,
      Options const& options,
      google::cloud::dialogflow::v2::DeleteGeneratorRequest const& request) = 0;

  virtual StatusOr<google::cloud::dialogflow::v2::Generator> UpdateGenerator(
      grpc::ClientContext& context,
      Options const& options,
      google::cloud::dialogflow::v2::UpdateGeneratorRequest const& request) = 0;
...
class DefaultGeneratorsStub : public GeneratorsStub {
 public:
  explicit DefaultGeneratorsStub(
      std::unique_ptr<google::cloud::dialogflow::v2::Generators::StubInterface> grpc_stub,
...
,
 ...
 private:
  std::unique_ptr<google::cloud::dialogflow::v2::Generators::StubInterface> grpc_stub_;
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_ES_INTERNAL_GENERATORS_STUB_H
