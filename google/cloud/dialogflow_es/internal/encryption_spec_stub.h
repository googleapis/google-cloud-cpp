...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_ES_INTERNAL_ENCRYPTION_SPEC_STUB_H
...
class EncryptionSpecServiceStub {
 public:
  virtual ~EncryptionSpecServiceStub() = 0;

  virtual StatusOr<google::cloud::dialogflow::v2::EncryptionSpec> GetEncryptionSpec(
      grpc::ClientContext& context,
      Options const& options,
      google::cloud::dialogflow::v2::GetEncryptionSpecRequest const& request) = 0;

  virtual future<StatusOr<google::longrunning::Operation>> AsyncInitializeEncryptionSpec(
      google::cloud::CompletionQueue& cq,
      std::shared_ptr<grpc::ClientContext> context,
      google::cloud::internal::ImmutableOptions options,
      google::cloud::dialogflow::v2::InitializeEncryptionSpecRequest const& request) = 0;
...
class DefaultEncryptionSpecServiceStub : public EncryptionSpecServiceStub {
 public:
  DefaultEncryptionSpecServiceStub(
      std::unique_ptr<google::cloud::dialogflow::v2::EncryptionSpecService::StubInterface> grpc_stub,
 ...
 private:
  std::unique_ptr<google::cloud::dialogflow::v2::EncryptionSpecService::StubInterface> grpc_stub_;
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_ES_INTERNAL_ENCRYPTION_SPEC_STUB_H
