...
CreateDefaultEnvironmentsStub(
  ...
  auto service_grpc_stub = google::cloud::dialogflow::v2::Environments::NewStub(channel);
  ...
  std::shared_ptr<EnvironmentsStub> stub =
    std::make_shared<DefaultEnvironmentsStub>(std::move(service_grpc_stub), std::move(service_operations_stub), std::move(service_locations_stub));
