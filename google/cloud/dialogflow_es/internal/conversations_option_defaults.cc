...
Options ConversationsDefaultOptions(std::string const& location,
  ...
  if (!options.has<GOOGLE_CLOUD_CPP_NS::ConversationsRetryPolicyOption>()) {
    options.set<GOOGLE_CLOUD_CPP_NS::ConversationsRetryPolicyOption>(
        GOOGLE_CLOUD_CPP_NS::ConversationsLimitedTimeRetryPolicy(
            std::chrono::minutes(30))
            .clone());
  }
  if (!options.has<GOOGLE_CLOUD_CPP_NS::ConversationsBackoffPolicyOption>()) {
    options.set<GOOGLE_CLOUD_CPP_NS::ConversationsBackoffPolicyOption>(
  ...
  if (!options.has<GOOGLE_CLOUD_CPP_NS::
    ...
    options.set<
        GOOGLE_CLOUD_CPP_NS::ConversationsConnectionIdempotencyPolicyOption>(
        GOOGLE_CLOUD_CPP_NS::
