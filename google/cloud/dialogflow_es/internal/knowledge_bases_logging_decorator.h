...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_ES_INTERNAL_KNOWLEDGE_BASES_LOGGING_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_ES_INTERNAL_KNOWLEDGE_BASES_LOGGING_DECORATOR_H
...
class KnowledgeBasesLogging : public KnowledgeBasesStub {
 public:
  ...
  StatusOr<google::cloud::dialogflow::v2::ListKnowledgeBasesResponse> ListKnowledgeBases(
      grpc::ClientContext& context,
      Options const& options,
      google::cloud::dialogflow::v2::ListKnowledgeBasesRequest const& request) override;
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_ES_INTERNAL_KNOWLEDGE_BASES_LOGGING_DECORATOR_H
