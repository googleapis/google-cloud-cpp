...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_ES_INTERNAL_SESSIONS_TRACING_STUB_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_ES_INTERNAL_SESSIONS_TRACING_STUB_H
...
class SessionsTracingStub : public SessionsStub {
 public:
  ~SessionsTracingStub() override = default;
  ...
  StatusOr<google::cloud::dialogflow::v2::DetectIntentResponse> DetectIntent(
      ...
      google::cloud::dialogflow::v2::DetectIntentRequest const& request) override;
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_ES_INTERNAL_SESSIONS_TRACING_STUB_H
