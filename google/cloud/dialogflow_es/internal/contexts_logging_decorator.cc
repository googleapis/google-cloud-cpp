...
ContextsLogging::ContextsLogging(
...
Status
ContextsLogging::DeleteAllContexts(
    grpc::ClientContext& context,
    Options const& options,
...
Status
ContextsLogging::CancelOperation(
    grpc::ClientContext& context,
    Options const& options,
