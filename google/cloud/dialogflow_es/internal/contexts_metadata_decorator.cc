...
Status
ContextsMetadata::DeleteContext(
    grpc::ClientContext& context,
    Options const& options,
...
Status
ContextsMetadata::DeleteAllContexts(
    grpc::ClientContext& context,
    Options const& options,
...
ContextsMetadata::ListOperations(
    grpc::ClientContext& context,
    Options const& options,
...
Status
ContextsMetadata::CancelOperation(
    grpc::ClientContext& context,
    Options const& options,
