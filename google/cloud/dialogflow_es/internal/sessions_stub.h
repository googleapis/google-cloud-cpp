...
class SessionsStub {
 public:
  ...
  virtual StatusOr<google::cloud::dialogflow::v2::DetectIntentResponse> DetectIntent(
...
class DefaultSessionsStub : public SessionsStub {
 public:
  explicit DefaultSessionsStub(
      std::unique_ptr<google::cloud::dialogflow::v2::Sessions::StubInterface> grpc_stub,
...
,
 ...
 private:
  std::unique_ptr<google::cloud::dialogflow::v2::Sessions::StubInterface> grpc_stub_;
