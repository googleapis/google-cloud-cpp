...
Options EntityTypesDefaultOptions(std::string const& location, Options options) {
  ...
  if (!options.has<dialogflow_es::EntityTypesConnectionIdempotencyPolicyOption>()) {
    options.set<dialogflow_es::EntityTypesConnectionIdempotencyPolicyOption>(
        dialogflow_es::MakeDefaultEntityTypesConnectionIdempotencyPolicy());
  }
