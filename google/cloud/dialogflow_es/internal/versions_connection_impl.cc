...
inline std::unique_ptr<dialogflow_es::VersionsRetryPolicy> retry_policy() {
  return internal::CurrentOptions()
      .get<dialogflow_es::VersionsRetryPolicyOption>()
      ->clone();
}

inline std::unique_ptr<BackoffPolicy> backoff_policy() {
  return internal::CurrentOptions()
      .get<dialogflow_es::VersionsBackoffPolicyOption>()
      ->clone();
}

inline std::unique_ptr<dialogflow_es::VersionsConnectionIdempotencyPolicy>
idempotency_policy() {
  return internal::CurrentOptions()
