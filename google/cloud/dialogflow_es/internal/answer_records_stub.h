...
class AnswerRecordsStub {
 public:
  ...
  virtual StatusOr<google::cloud::dialogflow::v2::ListAnswerRecordsResponse> ListAnswerRecords(
      grpc::ClientContext& context,
      Options const& options,
      google::cloud::dialogflow::v2::ListAnswerRecordsRequest const& request) = 0;

  virtual StatusOr<google::cloud::dialogflow::v2::AnswerRecord> UpdateAnswerRecord(
      grpc::ClientContext& context,
      Options const& options,
      google::cloud::dialogflow::v2::UpdateAnswerRecordRequest const& request) = 0;
...
class DefaultAnswerRecordsStub : public AnswerRecordsStub {
 public:
  explicit DefaultAnswerRecordsStub(
      std::unique_ptr<google::cloud::dialogflow::v2::AnswerRecords::StubInterface> grpc_stub,
...
,
 ...
 private:
  std::unique_ptr<google::cloud::dialogflow::v2::AnswerRecords::StubInterface> grpc_stub_;
