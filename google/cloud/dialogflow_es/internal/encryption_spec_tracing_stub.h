...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_ES_INTERNAL_ENCRYPTION_SPEC_TRACING_STUB_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_ES_INTERNAL_ENCRYPTION_SPEC_TRACING_STUB_H
...
class EncryptionSpecServiceTracingStub : public EncryptionSpecServiceStub {
 public:
  ~EncryptionSpecServiceTracingStub() override = default;

  explicit EncryptionSpecServiceTracingStub(std::shared_ptr<EncryptionSpecServiceStub> child);
 ...
 private:
  std::shared_ptr<EncryptionSpecServiceStub> child_;
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_ES_INTERNAL_ENCRYPTION_SPEC_TRACING_STUB_H
