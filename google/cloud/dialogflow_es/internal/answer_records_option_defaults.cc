...
Options AnswerRecordsDefaultOptions(std::string const& location, Options options) {
  ...
  if (!options.has<dialogflow_es::AnswerRecordsConnectionIdempotencyPolicyOption>()) {
