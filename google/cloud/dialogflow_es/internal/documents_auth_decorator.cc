...
StatusOr<google::cloud::dialogflow::v2::ListDocumentsResponse> DocumentsAuth::ListDocuments(
...
DocumentsAuth::AsyncCreateDocument(
  ...
  return auth_->AsyncConfigureContext(std::move(context)).then(
      [cq, child = child_, options = std::move(options), request](
        ...
        return child->AsyncCreateDocument(
            cq, *std::move(context), std::move(options), request);
      });
}

StatusOr<google::longrunning::Operation>
DocumentsAuth::CreateDocument(
      grpc::ClientContext& context,
      Options options,
      google::cloud::dialogflow::v2::CreateDocumentRequest const& request) {
  auto status = auth_->ConfigureContext(context);
...
DocumentsAuth::AsyncDeleteDocument(
  ...
  return auth_->AsyncConfigureContext(std::move(context)).then(
      [cq, child = child_, options = std::move(options), request](
        ...
        return child->AsyncDeleteDocument(
            cq, *std::move(context), std::move(options), request);
      });
}

StatusOr<google::longrunning::Operation>
DocumentsAuth::DeleteDocument(
      grpc::ClientContext& context,
      Options options,
      google::cloud::dialogflow::v2::DeleteDocumentRequest const& request) {
  auto status = auth_->ConfigureContext(context);
...
DocumentsAuth::AsyncUpdateDocument(
  ...
  return auth_->AsyncConfigureContext(std::move(context)).then(
      [cq, child = child_, options = std::move(options), request](
        ...
        return child->AsyncUpdateDocument(
            cq, *std::move(context), std::move(options), request);
      });
}

StatusOr<google::longrunning::Operation>
DocumentsAuth::UpdateDocument(
      grpc::ClientContext& context,
      Options options,
      google::cloud::dialogflow::v2::UpdateDocumentRequest const& request) {
  auto status = auth_->ConfigureContext(context);
...
DocumentsAuth::AsyncReloadDocument(
  ...
  return auth_->AsyncConfigureContext(std::move(context)).then(
      [cq, child = child_, options = std::move(options), request](
        ...
        return child->AsyncReloadDocument(
            cq, *std::move(context), std::move(options), request);
      });
}

StatusOr<google::longrunning::Operation>
DocumentsAuth::ReloadDocument(
      grpc::ClientContext& context,
      Options options,
      google::cloud::dialogflow::v2::ReloadDocumentRequest const& request) {
  auto status = auth_->ConfigureContext(context);
...
DocumentsAuth::AsyncExportDocument(
  ...
  return auth_->AsyncConfigureContext(std::move(context)).then(
      [cq, child = child_, options = std::move(options), request](
        ...
        return child->AsyncExportDocument(
            cq, *std::move(context), std::move(options), request);
      });
}

StatusOr<google::longrunning::Operation>
DocumentsAuth::ExportDocument(
      grpc::ClientContext& context,
      Options options,
      google::cloud::dialogflow::v2::ExportDocumentRequest const& request) {
  auto status = auth_->ConfigureContext(context);
...
StatusOr<google::cloud::location::ListLocationsResponse> DocumentsAuth::ListLocations(
    grpc::ClientContext& context,
    Options const& options,
...
StatusOr<google::longrunning::ListOperationsResponse> DocumentsAuth::ListOperations(
    grpc::ClientContext& context,
    Options const& options,
