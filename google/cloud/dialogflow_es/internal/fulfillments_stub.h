...
class FulfillmentsStub {
 public:
  ...
  virtual StatusOr<google::cloud::dialogflow::v2::Fulfillment> UpdateFulfillment(
      grpc::ClientContext& context,
      Options const& options,
      google::cloud::dialogflow::v2::UpdateFulfillmentRequest const& request) = 0;
...
class DefaultFulfillmentsStub : public FulfillmentsStub {
 public:
  explicit DefaultFulfillmentsStub(
      std::unique_ptr<google::cloud::dialogflow::v2::Fulfillments::StubInterface> grpc_stub,
...
,
 ...
 private:
  std::unique_ptr<google::cloud::dialogflow::v2::Fulfillments::StubInterface> grpc_stub_;
