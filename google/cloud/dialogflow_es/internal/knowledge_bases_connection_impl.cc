...
inline std::unique_ptr<dialogflow_es::KnowledgeBasesRetryPolicy>
retry_policy() {
  return internal::CurrentOptions()
      .get<dialogflow_es::KnowledgeBasesRetryPolicyOption>()
      ->clone();
}

inline std::unique_ptr<BackoffPolicy> backoff_policy() {
  return internal::CurrentOptions()
      .get<dialogflow_es::KnowledgeBasesBackoffPolicyOption>()
      ->clone();
}

inline std::unique_ptr<dialogflow_es::KnowledgeBasesConnectionIdempotencyPolicy>
idempotency_policy() {
  return internal::CurrentOptions()
