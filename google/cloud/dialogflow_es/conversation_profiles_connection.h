 ...
 * behavior (e.g., with a Google Mock object) in a `ConversationProfilesClient`
...
/**
 * A factory function to construct a `ConversationProfilesConnection` object.
 *
 * The returned connection object should not be used directly; instead it
 * should be given to a `ConversationProfilesClient` instance, and methods
 * should be invoked on `ConversationProfilesClient`.
 *
