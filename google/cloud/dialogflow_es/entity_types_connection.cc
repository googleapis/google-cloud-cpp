...
StreamRange<google::cloud::dialogflow::v2::EntityType> EntityTypesConnection::ListEntityTypes(
    google::cloud::dialogflow::v2::ListEntityTypesRequest) {  // NOLINT(performance-unnecessary-value-param)
