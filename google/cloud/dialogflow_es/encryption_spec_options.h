 ...
 */
struct EncryptionSpecServiceRetryPolicyOption {
  using Type = std::shared_ptr<EncryptionSpecServiceRetryPolicy>;
};
 ...
 * @ingroup google-cloud-dialogflow_es-options
 */
struct EncryptionSpecServiceBackoffPolicyOption {
 ...
 * @ingroup google-cloud-dialogflow_es-options
 */
struct EncryptionSpecServicePollingPolicyOption {
  using Type = std::shared_ptr<PollingPolicy>;
};

/**
 * The options applicable to EncryptionSpecService.
 *
 * @ingroup google-cloud-dialogflow_es-options
 */
using EncryptionSpecServicePolicyOptionList =
    OptionList<EncryptionSpecServiceRetryPolicyOption,
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_ES_ENCRYPTION_SPEC_OPTIONS_H
