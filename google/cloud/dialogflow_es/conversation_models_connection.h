...
/**
 * A retry policy for `ConversationModelsConnection` that stops retrying after a
...
class ConversationModelsLimitedErrorCountRetryPolicy
 ...
 public:
  ConversationModelsLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `ConversationModelsConnection` that stops retrying after
