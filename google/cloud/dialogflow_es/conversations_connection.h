...
/**
 * A retry policy for `ConversationsConnection` that stops retrying after a
...
class ConversationsLimitedErrorCountRetryPolicy
 ...
 public:
  ConversationsLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `ConversationsConnection` that stops retrying after
