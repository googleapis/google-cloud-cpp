...
/**
 * A retry policy for `IntentsConnection` that stops retrying after a
...
class IntentsLimitedErrorCountRetryPolicy : public IntentsRetryPolicy {
 public:
  IntentsLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `IntentsConnection` that stops retrying after
