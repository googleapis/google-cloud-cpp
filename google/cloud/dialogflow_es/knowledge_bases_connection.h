...
/**
 * A retry policy for `KnowledgeBasesConnection` that stops retrying after a
...
class KnowledgeBasesLimitedErrorCountRetryPolicy
 ...
 public:
  KnowledgeBasesLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `KnowledgeBasesConnection` that stops retrying after
