...
This directory contains small examples showing how to use the Storage Transfer
...
1. Install the dependencies with your favorite tools. As an example, if you use
   ...
   ```bash
   cd $HOME/vcpkg
   ./vcpkg install google-cloud-cpp[core,storagetransfer]
   ```
...
[quickstart-link]: https://cloud.google.com/storage-transfer/docs/create-manage-transfer-program
