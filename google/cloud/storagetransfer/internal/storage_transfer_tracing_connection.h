...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_STORAGETRANSFER_INTERNAL_STORAGE_TRANSFER_TRACING_CONNECTION_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_STORAGETRANSFER_INTERNAL_STORAGE_TRANSFER_TRACING_CONNECTION_H
...
class StorageTransferServiceTracingConnection
 ...
 public:
  ...
  explicit StorageTransferServiceTracingConnection(
      std::shared_ptr<storagetransfer::StorageTransferServiceConnection> child);
 ...
 private:
  std::shared_ptr<storagetransfer::StorageTransferServiceConnection> child_;
};
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_STORAGETRANSFER_INTERNAL_STORAGE_TRANSFER_TRACING_CONNECTION_H
