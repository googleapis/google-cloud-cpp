...
class StorageTransferServiceConnectionImpl
 ...
 private:
  std::unique_ptr<storagetransfer::StorageTransferServiceRetryPolicy> retry_policy() {
    auto const& options = internal::CurrentOptions();
    if (options.has<storagetransfer::StorageTransferServiceRetryPolicyOption>()) {
      return options.get<storagetransfer::StorageTransferServiceRetryPolicyOption>()->clone();
    }
  ...
  std::unique_ptr<BackoffPolicy> backoff_policy() {
    auto const& options = internal::CurrentOptions();
    if (options.has<storagetransfer::StorageTransferServiceBackoffPolicyOption>()) {
      return options.get<storagetransfer::StorageTransferServiceBackoffPolicyOption>()->clone();
    }
    return backoff_policy_prototype_->clone();
  }

  std::unique_ptr<storagetransfer::StorageTransferServiceConnectionIdempotencyPolicy> idempotency_policy() {
    auto const& options = internal::CurrentOptions();
    if (options.has<storagetransfer::StorageTransferServiceConnectionIdempotencyPolicyOption>()) {
      return options.get<storagetransfer::StorageTransferServiceConnectionIdempotencyPolicyOption>()->clone();
    }
  ...
  std::unique_ptr<storagetransfer::StorageTransferServiceRetryPolicy const> retry_policy_prototype_;
  std::unique_ptr<BackoffPolicy const> backoff_policy_prototype_;
  std::unique_ptr<storagetransfer::StorageTransferServiceConnectionIdempotencyPolicy> idempotency_policy_;

  std::unique_ptr<PollingPolicy> polling_policy() {
    auto const& options = internal::CurrentOptions();
    if (options.has<storagetransfer::StorageTransferServicePollingPolicyOption>()) {
      return options.get<storagetransfer::StorageTransferServicePollingPolicyOption>()->clone();
    }
