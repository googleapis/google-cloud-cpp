...
// main-dox-marker: GOOGLE_CLOUD_CPP_NS::StorageTransferServiceClient
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client =
      google::cloud::GOOGLE_CLOUD_CPP_NS::StorageTransferServiceClient(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::GOOGLE_CLOUD_CPP_NS::StorageTransferServiceClient(
        google::cloud::GOOGLE_CLOUD_CPP_NS::
            MakeStorageTransferServiceConnection(options));
  }
  //! [with-service-account]
