 ...
 * including errors, from an object of type `StorageTransferServiceClient`. To do so,
 * construct an object of type `StorageTransferServiceClient` with an instance of this
 ...
 */
class MockStorageTransferServiceConnection : public storagetransfer_v1::StorageTransferServiceConnection {
 public:
  MOCK_METHOD(Options, options, (), (override));

  MOCK_METHOD(StatusOr<google::storagetransfer::v1::GoogleServiceAccount>,
  GetGoogleServiceAccount,
  (google::storagetransfer::v1::GetGoogleServiceAccountRequest const& request), (override));

  MOCK_METHOD(StatusOr<google::storagetransfer::v1::TransferJob>,
  CreateTransferJob,
  ...
  /// EXPECT_CALL(*mock, RunTransferJob(Matcher<google::storagetransfer::v1::RunTransferJobRequest const&>(_)))
  /// @endcode
  ...
  /// using ::testing::_;
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock, RunTransferJob(Matcher<google::longrunning::Operation const&>(_)))
  /// @endcode
  MOCK_METHOD(future<StatusOr<google::storagetransfer::v1::TransferOperation>>,
  RunTransferJob, (
  ...
  MOCK_METHOD(StatusOr<google::storagetransfer::v1::AgentPool>,
  CreateAgentPool,
