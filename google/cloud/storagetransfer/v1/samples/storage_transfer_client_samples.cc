...
// clang-format off
// main-dox-marker: storagetransfer_v1::StorageTransferServiceClient
// lro-marker: true
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::storagetransfer_v1::StorageTransferServiceClient(
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  //       google::cloud::storagetransfer_v1::StorageTransferServiceLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
