...
CreateDefaultSecurityCenterManagementStub(google::cloud::CompletionQueue cq,
  ...
  auto endpoint = internal::DetermineServiceEndpoint(
      internal::GetEnv("GOOGLE_CLOUD_CPP_SECURITY_CENTER_MANAGEMENT_ENDPOINT"),
      internal::FetchOption<EndpointOption>(options),
      "securitycentermanagement.googleapis.com", options);
  ...
  if (!endpoint.ok()) {
    ...
    stub = std::make_shared<DefaultSecurityCenterManagementStub>(
