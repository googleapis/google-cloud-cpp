...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_OSCONFIG_INTERNAL_AGENT_ENDPOINT_TRACING_CONNECTION_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_OSCONFIG_INTERNAL_AGENT_ENDPOINT_TRACING_CONNECTION_H
...
class AgentEndpointServiceTracingConnection
 ...
 public:
  ...
  explicit AgentEndpointServiceTracingConnection(
      std::shared_ptr<osconfig::AgentEndpointServiceConnection> child);
 ...
 private:
  std::shared_ptr<osconfig::AgentEndpointServiceConnection> child_;
};
...
MakeAgentEndpointServiceTracingConnection(
    std::shared_ptr<osconfig::AgentEndpointServiceConnection> conn);
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_OSCONFIG_INTERNAL_AGENT_ENDPOINT_TRACING_CONNECTION_H
