...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_OSCONFIG_INTERNAL_OS_CONFIG_TRACING_CONNECTION_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_OSCONFIG_INTERNAL_OS_CONFIG_TRACING_CONNECTION_H
...
class OsConfigServiceTracingConnection
 ...
 private:
  std::shared_ptr<osconfig::OsConfigServiceConnection> child_;
};
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_OSCONFIG_INTERNAL_OS_CONFIG_TRACING_CONNECTION_H
