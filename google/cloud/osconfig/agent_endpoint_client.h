...
///     types defined in osconfig_agentendpoint_v1 instead of the aliases defined in
///     this namespace.
namespace osconfig {
GOOGLE_CLOUD_CPP_INLINE_NAMESPACE_BEGIN

/// @deprecated Use osconfig_agentendpoint_v1::AgentEndpointServiceClient directly.
using ::google::cloud::osconfig_agentendpoint_v1::AgentEndpointServiceClient;
