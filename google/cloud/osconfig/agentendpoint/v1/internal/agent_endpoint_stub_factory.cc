...
std::shared_ptr<AgentEndpointServiceStub> CreateDefaultAgentEndpointServiceStub(
  ...
  auto endpoint = internal::DetermineServiceEndpoint(
      ...
      std::move(endpoint_option), "osconfig.googleapis.com", options);
  ...
  if (!endpoint.ok()) {
    ...
    auto service_grpc_stub = google::cloud::osconfig::agentendpoint::v1::
        AgentEndpointService::NewStub(channel);
    stub = std::make_shared<DefaultAgentEndpointServiceStub>(
