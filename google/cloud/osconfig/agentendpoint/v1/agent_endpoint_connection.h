...
/**
 * A retry policy for `AgentEndpointServiceConnection` that stops retrying after
...
class AgentEndpointServiceLimitedErrorCountRetryPolicy
 ...
 public:
  AgentEndpointServiceLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `AgentEndpointServiceConnection` that stops retrying
