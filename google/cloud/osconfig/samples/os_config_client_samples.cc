...
// main-dox-marker: GOOGLE_CLOUD_CPP_NS::OsConfigServiceClient
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::GOOGLE_CLOUD_CPP_NS::OsConfigServiceClient(
      google::cloud::GOOGLE_CLOUD_CPP_NS::MakeOsConfigServiceConnection(
          options));
  //! [set-client-endpoint]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::GOOGLE_CLOUD_CPP_NS::OsConfigServiceClient(
        google::cloud::GOOGLE_CLOUD_CPP_NS::MakeOsConfigServiceConnection(
            options));
  }
  //! [with-service-account]
