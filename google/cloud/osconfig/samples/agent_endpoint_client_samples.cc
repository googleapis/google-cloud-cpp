...
// main-dox-marker: GOOGLE_CLOUD_CPP_NS::AgentEndpointServiceClient
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::GOOGLE_CLOUD_CPP_NS::AgentEndpointServiceClient(
      google::cloud::GOOGLE_CLOUD_CPP_NS::MakeAgentEndpointServiceConnection(
          options));
  //! [set-client-endpoint]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::GOOGLE_CLOUD_CPP_NS::AgentEndpointServiceClient(
        google::cloud::GOOGLE_CLOUD_CPP_NS::MakeAgentEndpointServiceConnection(
            options));
  }
  //! [with-service-account]
