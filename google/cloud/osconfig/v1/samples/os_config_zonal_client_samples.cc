...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::osconfig_v1::OsConfigZonalServiceClient(
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::osconfig_v1::OsConfigZonalServiceClient(
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto c2 = google::cloud::osconfig_v1::OsConfigZonalServiceClient(connection);
  ...
  //       google::cloud::osconfig_v1::OsConfigZonalServiceLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
