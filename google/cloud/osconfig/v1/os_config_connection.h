...
class OsConfigServiceRetryPolicy : public ::google::cloud::RetryPolicy {
 public:
  /// Creates a new instance with the initial state, as-if no errors had been
  /// handled.
  virtual std::unique_ptr<OsConfigServiceRetryPolicy> clone() const = 0;
};

/**
 * A retry policy for `OsConfigServiceConnection` that stops retrying after a
...
class OsConfigServiceLimitedErrorCountRetryPolicy
 ...
 public:
  OsConfigServiceLimitedErrorCountRetryPolicy(int maximum_failures)
  ...
  std::unique_ptr<OsConfigServiceRetryPolicy> clone() const override {
    return std::make_unique<OsConfigServiceLimitedErrorCountRetryPolicy>(
        maximum_failures());
  }
...
/// A retry policy for `OsConfigServiceConnection` that stops retrying after
...
class OsConfigServiceLimitedTimeRetryPolicy
 ...
 public:
  ...
  std::unique_ptr<OsConfigServiceRetryPolicy> clone() const override {
    return std::make_unique<OsConfigServiceLimitedTimeRetryPolicy>(
        maximum_duration());
  }
