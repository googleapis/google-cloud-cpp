...
DefaultOsConfigZonalServiceStub::AsyncCreateOSPolicyAssignment(
  ...
  return internal::MakeUnaryRpcImpl<google::cloud::osconfig::v1::CreateOSPolicyAssignmentRequest,
...
DefaultOsConfigZonalServiceStub::AsyncUpdateOSPolicyAssignment(
  ...
  return internal::MakeUnaryRpcImpl<google::cloud::osconfig::v1::UpdateOSPolicyAssignmentRequest,
                                    google::longrunning::Operation>(
      cq,
      [this](grpc::ClientContext* context,
             google::cloud::osconfig::v1::UpdateOSPolicyAssignmentRequest const& request,
...
DefaultOsConfigZonalServiceStub::GetOSPolicyAssignment(
  ...
  google::cloud::osconfig::v1::GetOSPolicyAssignmentRequest const& request) {
    ...
    auto status =
        grpc_stub_->GetOSPolicyAssignment(&context, request, &response);
    if (!status.ok()) {
      return google::cloud::MakeStatusFromRpcError(status);
    }
    return response;
...
DefaultOsConfigZonalServiceStub::AsyncDeleteOSPolicyAssignment(
  ...
  return internal::MakeUnaryRpcImpl<google::cloud::osconfig::v1::DeleteOSPolicyAssignmentRequest,
                                    google::longrunning::Operation>(
      cq,
      [this](grpc::ClientContext* context,
             google::cloud::osconfig::v1::DeleteOSPolicyAssignmentRequest const& request,
...
DefaultOsConfigZonalServiceStub::GetInventory(
  ...
  google::cloud::osconfig::v1::GetInventoryRequest const& request) {
    ...
    auto status =
        grpc_stub_->GetInventory(&context, request, &response);
    if (!status.ok()) {
      return google::cloud::MakeStatusFromRpcError(status);
    }
    return response;
...
DefaultOsConfigZonalServiceStub::ListInventories(
  ...
  google::cloud::osconfig::v1::ListInventoriesRequest const& request) {
    ...
    auto status =
        grpc_stub_->ListInventories(&context, request, &response);
    if (!status.ok()) {
      return google::cloud::MakeStatusFromRpcError(status);
    }
    return response;
