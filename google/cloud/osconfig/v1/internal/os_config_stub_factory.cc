...
std::shared_ptr<OsConfigServiceStub> CreateDefaultOsConfigServiceStub(
  ...
  auto endpoint = internal::DetermineServiceEndpoint(
      internal::GetEnv("GOOGLE_CLOUD_CPP_OS_CONFIG_SERVICE_ENDPOINT"),
  ...
  if (!endpoint.ok()) {
    ...
    auto service_grpc_stub =
        google::cloud::osconfig::v1::OsConfigService::NewStub(channel);
    stub = std::make_shared<DefaultOsConfigServiceStub>(
