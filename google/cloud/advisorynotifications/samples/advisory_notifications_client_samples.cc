...
// main-dox-marker: advisorynotifications::AdvisoryNotificationsServiceClient
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client =
      google::cloud::advisorynotifications::AdvisoryNotificationsServiceClient(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::advisorynotifications::
