# HOWTO: using the Advisory Notifications API C++ client in your project

This directory contains small examples showing how to use the Advisory
Notifications API C++ client library in your own project. These instructions
...
1. Install the dependencies with your favorite tools. As an example, if you use
   ...
   ```bash
   cd $HOME/vcpkg
   ./vcpkg install google-cloud-cpp[core,advisorynotifications]
   ```
...
1. Configure CMake, if necessary, configure the directory where you installed
   ...
   ```bash
   cd $HOME/gooogle-cloud-cpp/google/cloud/advisorynotifications/quickstart
...
[quickstart-link]: https://cloud.google.com/advisory-notifications/docs/quickstart
