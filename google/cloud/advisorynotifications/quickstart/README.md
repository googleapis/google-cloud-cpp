...
This directory contains small examples showing how to use the Advisory Notifications API C++
...
[quickstart-link]: https://cloud.google.com/advisorynotifications/docs/quickstart
