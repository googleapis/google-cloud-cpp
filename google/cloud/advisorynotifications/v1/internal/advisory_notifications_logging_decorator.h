...
class AdvisoryNotificationsServiceLogging : public AdvisoryNotificationsServiceStub {
 public:
  ~AdvisoryNotificationsServiceLogging() override = default;
  AdvisoryNotificationsServiceLogging(std::shared_ptr<AdvisoryNotificationsServiceStub> child,
