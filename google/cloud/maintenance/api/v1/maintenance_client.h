...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_MAINTENANCE_API_V1_MAINTENANCE_CLIENT_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_MAINTENANCE_API_V1_MAINTENANCE_CLIENT_H
...
class MaintenanceClient {
 public:
  explicit MaintenanceClient(std::shared_ptr<MaintenanceConnection> connection,
                             Options opts = {});
  ~MaintenanceClient();

  ///@{
  /// @name Copy and move support
  MaintenanceClient(MaintenanceClient const&) = default;
  MaintenanceClient& operator=(MaintenanceClient const&) = default;
  MaintenanceClient(MaintenanceClient&&) = default;
  MaintenanceClient& operator=(MaintenanceClient&&) = default;
  ///@}

  ///@{
  /// @name Equality
  friend bool operator==(MaintenanceClient const& a,
                         MaintenanceClient const& b) {
  ...
  ///     [google.cloud.maintenance.api.v1.MaintenanceSummary], or rather,
  ...
  SummarizeMaintenances(std::string const& parent, Options opts = {});
  ...
  ///     that there are no resources meeting the request criteria.
  ///     On a successful iteration the `StatusOr<T>` contains elements of type
  ///     [google.cloud.maintenance.api.v1.ResourceMaintenance], or rather,
  ///     the C++ class generated by Protobuf from that type. Please consult the
  ///     Protobuf documentation for details on the [Protobuf mapping rules].
  ///
  /// [Protobuf mapping rules]: https://protobuf.dev/reference/cpp/cpp-generated/
  ...
  ListResourceMaintenances(std::string const& parent, Options opts = {});
  ...
  GetResourceMaintenance(std::string const& name, Options opts = {});
 ...
 private:
  std::shared_ptr<MaintenanceConnection> connection_;
  Options options_;
};
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_MAINTENANCE_API_V1_MAINTENANCE_CLIENT_H
