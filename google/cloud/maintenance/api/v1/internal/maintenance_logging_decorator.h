...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_MAINTENANCE_API_V1_INTERNAL_MAINTENANCE_LOGGING_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_MAINTENANCE_API_V1_INTERNAL_MAINTENANCE_LOGGING_DECORATOR_H
...
class MaintenanceLogging : public MaintenanceStub {
 public:
  ~MaintenanceLogging() override = default;
  MaintenanceLogging(std::shared_ptr<MaintenanceStub> child,
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_MAINTENANCE_API_V1_INTERNAL_MAINTENANCE_LOGGING_DECORATOR_H
