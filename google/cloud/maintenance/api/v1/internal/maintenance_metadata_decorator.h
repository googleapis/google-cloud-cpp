...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_MAINTENANCE_API_V1_INTERNAL_MAINTENANCE_METADATA_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_MAINTENANCE_API_V1_INTERNAL_MAINTENANCE_METADATA_DECORATOR_H
...
class MaintenanceMetadata : public MaintenanceStub {
 public:
  ~MaintenanceMetadata() override = default;
  MaintenanceMetadata(std::shared_ptr<MaintenanceStub> child,
