...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_MAINTENANCE_API_V1_INTERNAL_MAINTENANCE_TRACING_STUB_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_MAINTENANCE_API_V1_INTERNAL_MAINTENANCE_TRACING_STUB_H
...
class MaintenanceTracingStub : public MaintenanceStub {
 public:
  ~MaintenanceTracingStub() override = default;

  explicit MaintenanceTracingStub(std::shared_ptr<MaintenanceStub> child);
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_MAINTENANCE_API_V1_INTERNAL_MAINTENANCE_TRACING_STUB_H
