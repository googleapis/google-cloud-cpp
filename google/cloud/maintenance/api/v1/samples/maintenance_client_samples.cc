...
// clang-format off
// main-dox-marker: maintenance_api_v1::MaintenanceClient
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::maintenance_api_v1::MaintenanceClient(
      google::cloud::maintenance_api_v1::MakeMaintenanceConnection(options));
  //! [set-client-endpoint]
}
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::maintenance_api_v1::MaintenanceClient(
      google::cloud::maintenance_api_v1::MakeMaintenanceConnection(
          *ud_options));
  //! [set-client-universe-domain]
}

//! [custom-idempotency-policy]
class CustomIdempotencyPolicy : public google::cloud::maintenance_api_v1::
                                    MaintenanceConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<
      google::cloud::maintenance_api_v1::MaintenanceConnectionIdempotencyPolicy>
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options =
      google::cloud::Options{}
          .set<google::cloud::maintenance_api_v1::
                   MaintenanceConnectionIdempotencyPolicyOption>(
              CustomIdempotencyPolicy().clone())
          .set<google::cloud::maintenance_api_v1::MaintenanceRetryPolicyOption>(
              google::cloud::maintenance_api_v1::
                  MaintenanceLimitedErrorCountRetryPolicy(3)
                      .clone())
          .set<google::cloud::maintenance_api_v1::
  ...
  auto c1 = google::cloud::maintenance_api_v1::MaintenanceClient(connection);
  auto c2 = google::cloud::maintenance_api_v1::MaintenanceClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::maintenance_api_v1::MaintenanceClient(
      connection,
      google::cloud::Options{}
          .set<google::cloud::maintenance_api_v1::MaintenanceRetryPolicyOption>(
              google::cloud::maintenance_api_v1::
                  MaintenanceLimitedTimeRetryPolicy(std::chrono::minutes(5))
                      .clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::maintenance_api_v1::MaintenanceRetryPolicyOption>(
  //       google::cloud::maintenance_api_v1::MaintenanceLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::maintenance_api_v1::MaintenanceClient(
        google::cloud::maintenance_api_v1::MakeMaintenanceConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
