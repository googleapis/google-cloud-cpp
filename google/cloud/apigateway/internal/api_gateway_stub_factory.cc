...
std::shared_ptr<ApiGatewayServiceStub> CreateDefaultApiGatewayServiceStub(
  ...
  auto service_grpc_stub =
      google::cloud::apigateway::v1::ApiGatewayService::NewStub(channel);
  std::shared_ptr<ApiGatewayServiceStub> stub =
      std::make_shared<DefaultApiGatewayServiceStub>(
  ...
  if (internal::TracingEnabled(options)) {
    stub = MakeApiGatewayServiceTracingStub(std::move(stub));
  }
  return stub;
}
