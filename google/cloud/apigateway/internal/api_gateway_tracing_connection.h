...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_APIGATEWAY_INTERNAL_API_GATEWAY_TRACING_CONNECTION_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_APIGATEWAY_INTERNAL_API_GATEWAY_TRACING_CONNECTION_H
...
class ApiGatewayServiceTracingConnection
 ...
 public:
  ...
  explicit ApiGatewayServiceTracingConnection(
      std::shared_ptr<apigateway::ApiGatewayServiceConnection> child);
 ...
 private:
  std::shared_ptr<apigateway::ApiGatewayServiceConnection> child_;
};
...
MakeApiGatewayServiceTracingConnection(
    std::shared_ptr<apigateway::ApiGatewayServiceConnection> conn);
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_APIGATEWAY_INTERNAL_API_GATEWAY_TRACING_CONNECTION_H
