...
// main-dox-marker: GOOGLE_CLOUD_CPP_NS::ApiGatewayServiceClient
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::GOOGLE_CLOUD_CPP_NS::ApiGatewayServiceClient(
      google::cloud::GOOGLE_CLOUD_CPP_NS::MakeApiGatewayServiceConnection(
          options));
  //! [set-client-endpoint]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::GOOGLE_CLOUD_CPP_NS::ApiGatewayServiceClient(
        google::cloud::GOOGLE_CLOUD_CPP_NS::MakeApiGatewayServiceConnection(
            options));
  }
  //! [with-service-account]
