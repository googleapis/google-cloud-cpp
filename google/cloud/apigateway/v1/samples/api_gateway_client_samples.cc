...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::apigateway_v1::ApiGatewayServiceClient(
      google::cloud::apigateway_v1::MakeApiGatewayServiceConnection(options));
  //! [set-client-endpoint]
}

//! [custom-idempotency-policy]
class CustomIdempotencyPolicy
   : public google::cloud::apigateway_v1::ApiGatewayServiceConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::apigateway_v1::ApiGatewayServiceConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::apigateway_v1::ApiGatewayServiceConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::apigateway_v1::ApiGatewayServiceRetryPolicyOption>(
      google::cloud::apigateway_v1::ApiGatewayServiceLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::apigateway_v1::ApiGatewayServiceBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::apigateway_v1::MakeApiGatewayServiceConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::apigateway_v1::ApiGatewayServiceClient(connection);
  auto c2 = google::cloud::apigateway_v1::ApiGatewayServiceClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::apigateway_v1::ApiGatewayServiceClient(
    connection, google::cloud::Options{}.set<google::cloud::apigateway_v1::ApiGatewayServiceRetryPolicyOption>(
      google::cloud::apigateway_v1::ApiGatewayServiceLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::apigateway_v1::ApiGatewayServiceRetryPolicyOption>(
  //       google::cloud::apigateway_v1::ApiGatewayServiceLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::apigateway_v1::ApiGatewayServicePollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::apigateway_v1::ApiGatewayServiceRetryPolicyOption::Type,
            google::cloud::apigateway_v1::ApiGatewayServiceBackoffPolicyOption::Type>(
            google::cloud::apigateway_v1::ApiGatewayServiceLimitedTimeRetryPolicy(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::apigateway_v1::ApiGatewayServiceClient(
      google::cloud::apigateway_v1::MakeApiGatewayServiceConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
