...
/**
 * A retry policy for `ApiGatewayServiceConnection` that stops retrying after a
...
class ApiGatewayServiceLimitedErrorCountRetryPolicy
 ...
 public:
  ApiGatewayServiceLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `ApiGatewayServiceConnection` that stops retrying after
