...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_TALENT_INTERNAL_TENANT_LOGGING_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_TALENT_INTERNAL_TENANT_LOGGING_DECORATOR_H
...
class TenantServiceLogging : public TenantServiceStub {
 public:
  ~TenantServiceLogging() override = default;
  TenantServiceLogging(std::shared_ptr<TenantServiceStub> child,
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_TALENT_INTERNAL_TENANT_LOGGING_DECORATOR_H
