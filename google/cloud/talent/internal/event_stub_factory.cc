...
#include "google/cloud/talent/internal/event_auth_decorator.h"
...
std::shared_ptr<EventServiceStub> CreateDefaultEventServiceStub(
  ...
  std::shared_ptr<EventServiceStub> stub =
      std::make_shared<DefaultEventServiceStub>(std::move(service_grpc_stub));
  ...
  if (internal::TracingEnabled(options)) {
    stub = MakeEventServiceTracingStub(std::move(stub));
  }
  return stub;
}
