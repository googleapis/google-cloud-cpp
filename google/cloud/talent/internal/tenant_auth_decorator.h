...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_TALENT_INTERNAL_TENANT_AUTH_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_TALENT_INTERNAL_TENANT_AUTH_DECORATOR_H
...
class TenantServiceAuth : public TenantServiceStub {
 public:
  ~TenantServiceAuth() override = default;
  TenantServiceAuth(
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_TALENT_INTERNAL_TENANT_AUTH_DECORATOR_H
