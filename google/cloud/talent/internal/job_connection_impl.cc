...
inline std::unique_ptr<talent::JobServiceRetryPolicy> retry_policy() {
  return internal::CurrentOptions()
      .get<talent::JobServiceRetryPolicyOption>()
      ->clone();
}

inline std::unique_ptr<BackoffPolicy> backoff_policy() {
  return internal::CurrentOptions()
      .get<talent::JobServiceBackoffPolicyOption>()
      ->clone();
}

inline std::unique_ptr<talent::JobServiceConnectionIdempotencyPolicy>
idempotency_policy() {
  return internal::CurrentOptions()
      .get<talent::JobServiceConnectionIdempotencyPolicyOption>()
      ->clone();
}

inline std::unique_ptr<PollingPolicy> polling_policy() {
  return internal::CurrentOptions()
      .get<talent::JobServicePollingPolicyOption>()
      ->clone();
}
