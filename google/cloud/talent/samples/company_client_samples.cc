...
// main-dox-marker: GOOGLE_CLOUD_CPP_NS::CompanyServiceClient
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::GOOGLE_CLOUD_CPP_NS::CompanyServiceClient(
      google::cloud::GOOGLE_CLOUD_CPP_NS::MakeCompanyServiceConnection(
          options));
  //! [set-client-endpoint]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::GOOGLE_CLOUD_CPP_NS::CompanyServiceClient(
        google::cloud::GOOGLE_CLOUD_CPP_NS::MakeCompanyServiceConnection(
            options));
  }
  //! [with-service-account]
