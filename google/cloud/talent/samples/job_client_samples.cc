...
// main-dox-marker: GOOGLE_CLOUD_CPP_NS::JobServiceClient
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::GOOGLE_CLOUD_CPP_NS::JobServiceClient(
      google::cloud::GOOGLE_CLOUD_CPP_NS::MakeJobServiceConnection(options));
  //! [set-client-endpoint]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::GOOGLE_CLOUD_CPP_NS::JobServiceClient(
        google::cloud::GOOGLE_CLOUD_CPP_NS::MakeJobServiceConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
