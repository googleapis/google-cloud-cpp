...
// main-dox-marker: GOOGLE_CLOUD_CPP_NS::EventServiceClient
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::GOOGLE_CLOUD_CPP_NS::EventServiceClient(
      google::cloud::GOOGLE_CLOUD_CPP_NS::MakeEventServiceConnection(options));
  //! [set-client-endpoint]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::GOOGLE_CLOUD_CPP_NS::EventServiceClient(
        google::cloud::GOOGLE_CLOUD_CPP_NS::MakeEventServiceConnection(
            options));
  }
  //! [with-service-account]
  (argv.at(0));
