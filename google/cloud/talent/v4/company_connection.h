...
/**
 * A retry policy for `CompanyServiceConnection` that stops retrying after a
...
class CompanyServiceLimitedErrorCountRetryPolicy
 ...
 public:
  CompanyServiceLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `CompanyServiceConnection` that stops retrying after
