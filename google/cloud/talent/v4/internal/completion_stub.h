...
class CompletionStub {
 public:
  ...
  virtual StatusOr<google::cloud::talent::v4::CompleteQueryResponse> CompleteQuery(
...
class DefaultCompletionStub : public CompletionStub {
 public:
  explicit DefaultCompletionStub(
      std::unique_ptr<google::cloud::talent::v4::Completion::StubInterface> grpc_stub,
 ...
 private:
  std::unique_ptr<google::cloud::talent::v4::Completion::StubInterface> grpc_stub_;
