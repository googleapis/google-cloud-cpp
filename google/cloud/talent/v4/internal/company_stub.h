...
class CompanyServiceStub {
 public:
  ...
  virtual StatusOr<google::cloud::talent::v4::ListCompaniesResponse> ListCompanies(
      grpc::ClientContext& context,
      Options const& options,
...
class DefaultCompanyServiceStub : public CompanyServiceStub {
 public:
  explicit DefaultCompanyServiceStub(
      std::unique_ptr<google::cloud::talent::v4::CompanyService::StubInterface> grpc_stub,
 ...
 private:
  std::unique_ptr<google::cloud::talent::v4::CompanyService::StubInterface> grpc_stub_;
