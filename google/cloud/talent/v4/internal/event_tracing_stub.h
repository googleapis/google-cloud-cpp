...
class EventServiceTracingStub : public EventServiceStub {
 public:
  ~EventServiceTracingStub() override = default;
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_TALENT_V4_INTERNAL_EVENT_TRACING_STUB_H
