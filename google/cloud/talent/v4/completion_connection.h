...
/**
 * A retry policy for `CompletionConnection` that stops retrying after a
 ...
 */
class CompletionLimitedErrorCountRetryPolicy : public CompletionRetryPolicy {
 public:
  CompletionLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `CompletionConnection` that stops retrying after
/// some wall clock time has elapsed.
class CompletionLimitedTimeRetryPolicy : public CompletionRetryPolicy {
 public:
  /**
 ...
 *
 * For mocking, see `talent_v4_mocks::MockCompletionConnection`.
 */
 ...
 * - `google::cloud::talent_v4::CompletionPolicyOptionList`
 *
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_TALENT_V4_COMPLETION_CONNECTION_H
