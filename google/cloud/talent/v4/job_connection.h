...
/**
 * A retry policy for `JobServiceConnection` that stops retrying after a
...
class JobServiceLimitedErrorCountRetryPolicy : public JobServiceRetryPolicy {
 public:
  JobServiceLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `JobServiceConnection` that stops retrying after
