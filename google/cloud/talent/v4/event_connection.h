...
/**
 * A retry policy for `EventServiceConnection` that stops retrying after a
...
class EventServiceLimitedErrorCountRetryPolicy
 ...
 public:
  EventServiceLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `EventServiceConnection` that stops retrying after
