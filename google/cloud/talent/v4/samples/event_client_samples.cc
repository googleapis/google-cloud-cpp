...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::talent_v4::EventServiceClient(
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::talent_v4::EventServiceClient(
      google::cloud::talent_v4::MakeEventServiceConnection(ud_options));
