...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::talent_v4::JobServiceClient(
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::talent_v4::JobServiceClient(
      google::cloud::talent_v4::MakeJobServiceConnection(*ud_options));
  //! [set-client-universe-domain]
}
      ...
      google::cloud::Options{}
          .set<google::cloud::talent_v4::JobServicePollingPolicyOption>(
              google::cloud::GenericPollingPolicy<
                  ...
                  google::cloud::talent_v4::JobServiceBackoffPolicyOption::
                      Type>(
                  google::cloud::talent_v4::JobServiceLimitedTimeRetryPolicy(
