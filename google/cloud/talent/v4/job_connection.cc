...
JobServiceConnection::CreateJob(
...
StatusOr<google::cloud::talent::v4::Job>
JobServiceConnection::UpdateJob(
...
StreamRange<google::cloud::talent::v4::Job> JobServiceConnection::ListJobs(
    google::cloud::talent::v4::ListJobsRequest) {  // NOLINT(performance-unnecessary-value-param)
...
std::shared_ptr<JobServiceConnection> MakeJobServiceConnection(
  ...
  options = talent_v4_internal::JobServiceDefaultOptions(
      std::move(options));
  auto background = internal::MakeBackgroundThreadsFactory(options)();
  auto auth = internal::CreateAuthenticationStrategy(background->cq(), options);
  auto stub = talent_v4_internal::CreateDefaultJobServiceStub(
