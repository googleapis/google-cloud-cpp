...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_TALENT_MOCKS_MOCK_EVENT_CONNECTION_H
 ...
 * including errors from a `EventServiceClient`. To do so, construct a
 * `EventServiceClient` with an instance of this class. Then use the Google
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_TALENT_MOCKS_MOCK_EVENT_CONNECTION_H
