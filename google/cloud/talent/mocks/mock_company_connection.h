...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_TALENT_MOCKS_MOCK_COMPANY_CONNECTION_H
 ...
 * including errors from a `CompanyServiceClient`. To do so, construct a
 * `CompanyServiceClient` with an instance of this class. Then use the Google
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_TALENT_MOCKS_MOCK_COMPANY_CONNECTION_H
