...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_CONTENTWAREHOUSE_V1_INTERNAL_SYNONYM_SET_METADATA_DECORATOR_H
...
class SynonymSetServiceMetadata : public SynonymSetServiceStub {
 public:
  ~SynonymSetServiceMetadata() override = default;
  SynonymSetServiceMetadata(
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_CONTENTWAREHOUSE_V1_INTERNAL_SYNONYM_SET_METADATA_DECORATOR_H
