...
std::shared_ptr<DocumentServiceStub> CreateDefaultDocumentServiceStub(
  ...
  auto endpoint = internal::DetermineServiceEndpoint(
      internal::GetEnv("GOOGLE_CLOUD_CPP_DOCUMENT_SERVICE_ENDPOINT"),
  ...
  if (!endpoint.ok()) {
    ...
    auto service_grpc_stub =
        google::cloud::contentwarehouse::v1::DocumentService::NewStub(channel);
    stub = std::make_shared<DefaultDocumentServiceStub>(
