...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_CONTENTWAREHOUSE_V1_INTERNAL_PIPELINE_STUB_H
...
class PipelineServiceStub {
 public:
  ...
  virtual future<StatusOr<google::longrunning::Operation>> AsyncRunPipeline(
      google::cloud::CompletionQueue& cq,
      std::shared_ptr<grpc::ClientContext> context,
      google::cloud::internal::ImmutableOptions options,
      google::cloud::contentwarehouse::v1::RunPipelineRequest const& request) = 0;
...
class DefaultPipelineServiceStub : public PipelineServiceStub {
 public:
  DefaultPipelineServiceStub(
      std::unique_ptr<google::cloud::contentwarehouse::v1::PipelineService::StubInterface> grpc_stub,
 ...
 private:
  std::unique_ptr<google::cloud::contentwarehouse::v1::PipelineService::StubInterface> grpc_stub_;
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_CONTENTWAREHOUSE_V1_INTERNAL_PIPELINE_STUB_H
