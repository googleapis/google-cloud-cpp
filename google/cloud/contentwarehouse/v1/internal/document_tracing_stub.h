...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_CONTENTWAREHOUSE_V1_INTERNAL_DOCUMENT_TRACING_STUB_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_CONTENTWAREHOUSE_V1_INTERNAL_DOCUMENT_TRACING_STUB_H
...
class DocumentServiceTracingStub : public DocumentServiceStub {
 public:
  ...
  explicit DocumentServiceTracingStub(std::shared_ptr<DocumentServiceStub> child);
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_CONTENTWAREHOUSE_V1_INTERNAL_DOCUMENT_TRACING_STUB_H
