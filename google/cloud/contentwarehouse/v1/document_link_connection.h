...
class DocumentLinkServiceRetryPolicy : public ::google::cloud::RetryPolicy {
 public:
  /// Creates a new instance of the policy, reset to the initial state.
  virtual std::unique_ptr<DocumentLinkServiceRetryPolicy> clone() const = 0;
};

/**
 * A retry policy for `DocumentLinkServiceConnection` based on counting errors.
 *
...
class DocumentLinkServiceLimitedErrorCountRetryPolicy
 ...
 public:
   ...
   */
  DocumentLinkServiceLimitedErrorCountRetryPolicy(int maximum_failures)
  ...
  std::unique_ptr<DocumentLinkServiceRetryPolicy> clone() const override {
    return std::make_unique<DocumentLinkServiceLimitedErrorCountRetryPolicy>(
        maximum_failures());
  }
...
/**
 * A retry policy for `DocumentLinkServiceConnection` based on elapsed time.
 *
 * This policy stops retrying if:
 * - An RPC returns a non-transient error.
...
class DocumentLinkServiceLimitedTimeRetryPolicy
 ...
 public:
  ...
  std::unique_ptr<DocumentLinkServiceRetryPolicy> clone() const override {
    return std::make_unique<DocumentLinkServiceLimitedTimeRetryPolicy>(
        maximum_duration());
  }
...
class DocumentLinkServiceConnection {
 public:
  virtual ~DocumentLinkServiceConnection() = 0;
 ...
 * - `google::cloud::contentwarehouse_v1::DocumentLinkServicePolicyOptionList`
 *
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_CONTENTWAREHOUSE_V1_DOCUMENT_LINK_CONNECTION_H
