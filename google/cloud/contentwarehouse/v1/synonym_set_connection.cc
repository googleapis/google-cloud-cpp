...
SynonymSetServiceConnection::~SynonymSetServiceConnection() = default;

StatusOr<google::cloud::contentwarehouse::v1::SynonymSet>
SynonymSetServiceConnection::CreateSynonymSet(
    google::cloud::contentwarehouse::v1::CreateSynonymSetRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

StatusOr<google::cloud::contentwarehouse::v1::SynonymSet>
SynonymSetServiceConnection::GetSynonymSet(
    google::cloud::contentwarehouse::v1::GetSynonymSetRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

StatusOr<google::cloud::contentwarehouse::v1::SynonymSet>
SynonymSetServiceConnection::UpdateSynonymSet(
