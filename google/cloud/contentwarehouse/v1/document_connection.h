...
/**
 * A retry policy for `DocumentServiceConnection` that stops retrying after a
...
class DocumentServiceLimitedErrorCountRetryPolicy
 ...
 public:
  DocumentServiceLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `DocumentServiceConnection` that stops retrying after
 ...
 *
 * For mocking, see `contentwarehouse_v1_mocks::MockDocumentServiceConnection`.
 */
 ...
 * - `google::cloud::contentwarehouse_v1::DocumentServicePolicyOptionList`
 *
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_CONTENTWAREHOUSE_V1_DOCUMENT_CONNECTION_H
