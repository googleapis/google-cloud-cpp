...
DocumentSchemaServiceConnection::~DocumentSchemaServiceConnection() = default;

StatusOr<google::cloud::contentwarehouse::v1::DocumentSchema>
DocumentSchemaServiceConnection::CreateDocumentSchema(
    google::cloud::contentwarehouse::v1::CreateDocumentSchemaRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

StatusOr<google::cloud::contentwarehouse::v1::DocumentSchema>
DocumentSchemaServiceConnection::UpdateDocumentSchema(
    google::cloud::contentwarehouse::v1::UpdateDocumentSchemaRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

StatusOr<google::cloud::contentwarehouse::v1::DocumentSchema>
DocumentSchemaServiceConnection::GetDocumentSchema(
...
DocumentSchemaServiceConnection::GetOperation(
