...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::contentwarehouse_v1::DocumentServiceClient(
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::contentwarehouse_v1::DocumentServiceClient(
      google::cloud::contentwarehouse_v1::MakeDocumentServiceConnection(
          *ud_options));
  //! [set-client-universe-domain]
}
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto c1 =
      google::cloud::contentwarehouse_v1::DocumentServiceClient(connection);
  auto c2 =
      google::cloud::contentwarehouse_v1::DocumentServiceClient(connection);
