...
DocumentLinkServiceConnection::~DocumentLinkServiceConnection() = default;

StatusOr<google::cloud::contentwarehouse::v1::ListLinkedTargetsResponse>
DocumentLinkServiceConnection::ListLinkedTargets(
...
DocumentLinkServiceConnection::CreateDocumentLink(
