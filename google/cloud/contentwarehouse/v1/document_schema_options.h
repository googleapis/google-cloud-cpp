 ...
 */
struct DocumentSchemaServiceRetryPolicyOption {
  using Type = std::shared_ptr<DocumentSchemaServiceRetryPolicy>;
};
 ...
 * @ingroup google-cloud-contentwarehouse-options
 */
struct DocumentSchemaServiceBackoffPolicyOption {
 ...
 * @ingroup google-cloud-contentwarehouse-options
 */
using DocumentSchemaServicePolicyOptionList =
    OptionList<DocumentSchemaServiceRetryPolicyOption,
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_CONTENTWAREHOUSE_V1_DOCUMENT_SCHEMA_OPTIONS_H
