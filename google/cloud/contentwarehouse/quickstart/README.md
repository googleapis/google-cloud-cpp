# HOWTO: using the Document AI Warehouse API C++ client in your project

This directory contains small examples showing how to use the Document AI Warehouse API C++
...
Like most Google Cloud Platform (GCP) services, Document AI Warehouse API requires that
...
1. Install the dependencies with your favorite tools. As an example, if you use
   ...
   ```bash
   cd $HOME/vcpkg
   ./vcpkg install google-cloud-cpp[core,contentwarehouse]
   ```
...
[quickstart-link]: https://cloud.google.com/document-warehouse/docs/quickstart
