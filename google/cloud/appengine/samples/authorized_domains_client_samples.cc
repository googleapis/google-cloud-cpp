...
// main-dox-marker: GOOGLE_CLOUD_CPP_NS::AuthorizedDomainsClient
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::GOOGLE_CLOUD_CPP_NS::AuthorizedDomainsClient(
      google::cloud::GOOGLE_CLOUD_CPP_NS::MakeAuthorizedDomainsConnection(
          options));
  //! [set-client-endpoint]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::GOOGLE_CLOUD_CPP_NS::AuthorizedDomainsClient(
        google::cloud::GOOGLE_CLOUD_CPP_NS::MakeAuthorizedDomainsConnection(
            options));
  }
  //! [with-service-account]
