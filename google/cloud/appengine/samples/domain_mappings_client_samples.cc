...
// main-dox-marker: GOOGLE_CLOUD_CPP_NS::DomainMappingsClient
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::GOOGLE_CLOUD_CPP_NS::DomainMappingsClient(
      google::cloud::GOOGLE_CLOUD_CPP_NS::MakeDomainMappingsConnection(
          options));
  //! [set-client-endpoint]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::GOOGLE_CLOUD_CPP_NS::DomainMappingsClient(
        google::cloud::GOOGLE_CLOUD_CPP_NS::MakeDomainMappingsConnection(
            options));
  }
  //! [with-service-account]
