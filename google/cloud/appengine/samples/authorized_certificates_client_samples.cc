...
// main-dox-marker: GOOGLE_CLOUD_CPP_NS::AuthorizedCertificatesClient
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client =
      google::cloud::GOOGLE_CLOUD_CPP_NS::AuthorizedCertificatesClient(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::GOOGLE_CLOUD_CPP_NS::AuthorizedCertificatesClient(
        google::cloud::GOOGLE_CLOUD_CPP_NS::
            MakeAuthorizedCertificatesConnection(options));
  }
  //! [with-service-account]
