...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_APPENGINE_MOCKS_MOCK_AUTHORIZED_CERTIFICATES_CONNECTION_H
 ...
 * including errors from a `AuthorizedCertificatesClient`. To do so, construct a
 * `AuthorizedCertificatesClient` with an instance of this class. Then use the
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_APPENGINE_MOCKS_MOCK_AUTHORIZED_CERTIFICATES_CONNECTION_H
