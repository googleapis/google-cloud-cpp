...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_APPENGINE_MOCKS_MOCK_INSTANCES_CONNECTION_H
 ...
 * including errors from a `InstancesClient`. To do so, construct a
 * `InstancesClient` with an instance of this class. Then use the Google
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_APPENGINE_MOCKS_MOCK_INSTANCES_CONNECTION_H
