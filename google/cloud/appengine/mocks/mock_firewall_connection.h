...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_APPENGINE_MOCKS_MOCK_FIREWALL_CONNECTION_H
 ...
 * including errors from a `FirewallClient`. To do so, construct a
 * `FirewallClient` with an instance of this class. Then use the Google
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_APPENGINE_MOCKS_MOCK_FIREWALL_CONNECTION_H
