...
/// @deprecated Use appengine_v1::MakeDefaultVersionsConnectionIdempotencyPolicy directly.
using ::google::cloud::appengine_v1::MakeDefaultVersionsConnectionIdempotencyPolicy;
