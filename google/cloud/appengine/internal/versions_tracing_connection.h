...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_APPENGINE_INTERNAL_VERSIONS_TRACING_CONNECTION_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_APPENGINE_INTERNAL_VERSIONS_TRACING_CONNECTION_H
...
class VersionsTracingConnection : public appengine::VersionsConnection {
 public:
  ~VersionsTracingConnection() override = default;

  explicit VersionsTracingConnection(
      std::shared_ptr<appengine::VersionsConnection> child);
 ...
 private:
  std::shared_ptr<appengine::VersionsConnection> child_;
};
 ...
 */
std::shared_ptr<appengine::VersionsConnection> MakeVersionsTracingConnection(
    std::shared_ptr<appengine::VersionsConnection> conn);
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_APPENGINE_INTERNAL_VERSIONS_TRACING_CONNECTION_H
