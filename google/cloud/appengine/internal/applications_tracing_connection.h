...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_APPENGINE_INTERNAL_APPLICATIONS_TRACING_CONNECTION_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_APPENGINE_INTERNAL_APPLICATIONS_TRACING_CONNECTION_H
...
class ApplicationsTracingConnection : public appengine::ApplicationsConnection {
 public:
  ~ApplicationsTracingConnection() override = default;

  explicit ApplicationsTracingConnection(
      std::shared_ptr<appengine::ApplicationsConnection> child);
 ...
 private:
  std::shared_ptr<appengine::ApplicationsConnection> child_;
};
 ...
 */
std::shared_ptr<appengine::ApplicationsConnection>
MakeApplicationsTracingConnection(
    std::shared_ptr<appengine::ApplicationsConnection> conn);
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_APPENGINE_INTERNAL_APPLICATIONS_TRACING_CONNECTION_H
