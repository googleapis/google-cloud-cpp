...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_APPENGINE_INTERNAL_AUTHORIZED_DOMAINS_TRACING_CONNECTION_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_APPENGINE_INTERNAL_AUTHORIZED_DOMAINS_TRACING_CONNECTION_H
...
class AuthorizedDomainsTracingConnection
 ...
 public:
  ...
  explicit AuthorizedDomainsTracingConnection(
      std::shared_ptr<appengine::AuthorizedDomainsConnection> child);
 ...
 private:
  std::shared_ptr<appengine::AuthorizedDomainsConnection> child_;
};
...
MakeAuthorizedDomainsTracingConnection(
    std::shared_ptr<appengine::AuthorizedDomainsConnection> conn);
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_APPENGINE_INTERNAL_AUTHORIZED_DOMAINS_TRACING_CONNECTION_H
