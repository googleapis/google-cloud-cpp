...
inline std::unique_ptr<appengine::VersionsRetryPolicy> retry_policy() {
  return internal::CurrentOptions()
      .get<appengine::VersionsRetryPolicyOption>()
      ->clone();
}

inline std::unique_ptr<BackoffPolicy> backoff_policy() {
  return internal::CurrentOptions()
      .get<appengine::VersionsBackoffPolicyOption>()
      ->clone();
}

inline std::unique_ptr<appengine::VersionsConnectionIdempotencyPolicy>
idempotency_policy() {
  return internal::CurrentOptions()
...
inline std::unique_ptr<PollingPolicy> polling_policy() {
  return internal::CurrentOptions()
      .get<appengine::VersionsPollingPolicyOption>()
      ->clone();
}
