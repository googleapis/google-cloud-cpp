...
inline std::unique_ptr<appengine::ServicesRetryPolicy> retry_policy() {
  return internal::CurrentOptions()
      .get<appengine::ServicesRetryPolicyOption>()
      ->clone();
}

inline std::unique_ptr<BackoffPolicy> backoff_policy() {
  return internal::CurrentOptions()
      .get<appengine::ServicesBackoffPolicyOption>()
      ->clone();
}

inline std::unique_ptr<appengine::ServicesConnectionIdempotencyPolicy>
idempotency_policy() {
  return internal::CurrentOptions()
...
inline std::unique_ptr<PollingPolicy> polling_policy() {
  return internal::CurrentOptions()
      .get<appengine::ServicesPollingPolicyOption>()
      ->clone();
}
