...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_APPENGINE_INTERNAL_AUTHORIZED_CERTIFICATES_TRACING_CONNECTION_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_APPENGINE_INTERNAL_AUTHORIZED_CERTIFICATES_TRACING_CONNECTION_H
...
class AuthorizedCertificatesTracingConnection
 ...
 private:
  std::shared_ptr<appengine::AuthorizedCertificatesConnection> child_;
};
...
MakeAuthorizedCertificatesTracingConnection(
    std::shared_ptr<appengine::AuthorizedCertificatesConnection> conn);
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_APPENGINE_INTERNAL_AUTHORIZED_CERTIFICATES_TRACING_CONNECTION_H
