...
inline std::unique_ptr<appengine::InstancesRetryPolicy> retry_policy() {
  return internal::CurrentOptions()
      .get<appengine::InstancesRetryPolicyOption>()
      ->clone();
}

inline std::unique_ptr<BackoffPolicy> backoff_policy() {
  return internal::CurrentOptions()
      .get<appengine::InstancesBackoffPolicyOption>()
      ->clone();
}

inline std::unique_ptr<appengine::InstancesConnectionIdempotencyPolicy>
idempotency_policy() {
  return internal::CurrentOptions()
...
inline std::unique_ptr<PollingPolicy> polling_policy() {
  return internal::CurrentOptions()
      .get<appengine::InstancesPollingPolicyOption>()
      ->clone();
}
