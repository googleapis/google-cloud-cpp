...
#include "google/cloud/appengine/v1/authorized_domains_client.h"
...
/// @deprecated Use appengine_v1::AuthorizedDomainsClient directly.
using ::google::cloud::appengine_v1::AuthorizedDomainsClient;
