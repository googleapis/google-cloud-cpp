...
/// @deprecated Use appengine_v1::MakeDefaultServicesConnectionIdempotencyPolicy directly.
using ::google::cloud::appengine_v1::MakeDefaultServicesConnectionIdempotencyPolicy;
