...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_APPENGINE_V1_SERVICES_CONNECTION_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_APPENGINE_V1_SERVICES_CONNECTION_H
...
class ServicesRetryPolicy : public ::google::cloud::RetryPolicy {
 public:
  /// Creates a new instance with the initial state, as-if no errors had been
  /// handled.
  virtual std::unique_ptr<ServicesRetryPolicy> clone() const = 0;
};

/**
 * A retry policy for `ServicesConnection` that stops retrying after a
 ...
 */
class ServicesLimitedErrorCountRetryPolicy : public ServicesRetryPolicy {
 public:
  ServicesLimitedErrorCountRetryPolicy(int maximum_failures)
  ...
  std::unique_ptr<ServicesRetryPolicy> clone() const override {
    return std::make_unique<ServicesLimitedErrorCountRetryPolicy>(
        maximum_failures());
  }
...
/// A retry policy for `ServicesConnection` that stops retrying after
/// some wall clock time has elapsed.
class ServicesLimitedTimeRetryPolicy : public ServicesRetryPolicy {
 public:
  /**
 ...
 *
 * For mocking, see `appengine_v1_mocks::MockServicesConnection`.
 */
 ...
 * - `google::cloud::appengine_v1::ServicesPolicyOptionList`
 *
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_APPENGINE_V1_SERVICES_CONNECTION_H
