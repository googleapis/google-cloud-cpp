...
/**
 * A retry policy for `AuthorizedDomainsConnection` that stops retrying after a
...
class AuthorizedDomainsLimitedErrorCountRetryPolicy
 ...
 public:
  AuthorizedDomainsLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `AuthorizedDomainsConnection` that stops retrying after
