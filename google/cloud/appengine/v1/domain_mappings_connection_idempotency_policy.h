...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_APPENGINE_V1_DOMAIN_MAPPINGS_CONNECTION_IDEMPOTENCY_POLICY_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_APPENGINE_V1_DOMAIN_MAPPINGS_CONNECTION_IDEMPOTENCY_POLICY_H
...
class DomainMappingsConnectionIdempotencyPolicy {
 public:
  ...
  virtual std::unique_ptr<DomainMappingsConnectionIdempotencyPolicy> clone() const;
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_APPENGINE_V1_DOMAIN_MAPPINGS_CONNECTION_IDEMPOTENCY_POLICY_H
