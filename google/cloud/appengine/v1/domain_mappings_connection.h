...
/**
 * A retry policy for `DomainMappingsConnection` that stops retrying after a
...
class DomainMappingsLimitedErrorCountRetryPolicy
 ...
 public:
  DomainMappingsLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `DomainMappingsConnection` that stops retrying after
