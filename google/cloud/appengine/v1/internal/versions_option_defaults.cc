...
Options VersionsDefaultOptions(Options options) {
  ...
  if (!options.has<appengine_v1::VersionsPollingPolicyOption>()) {
    options.set<appengine_v1::VersionsPollingPolicyOption>(
        GenericPollingPolicy<
            appengine_v1::VersionsRetryPolicyOption::Type,
  ...
  if (!options.has<appengine_v1::VersionsConnectionIdempotencyPolicyOption>()) {
    options.set<appengine_v1::VersionsConnectionIdempotencyPolicyOption>(
        appengine_v1::MakeDefaultVersionsConnectionIdempotencyPolicy());
  }
