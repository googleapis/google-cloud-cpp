...
Options ApplicationsDefaultOptions(Options options) {
  options = internal::PopulateCommonOptions(
      std::move(options), "GOOGLE_CLOUD_CPP_APPLICATIONS_ENDPOINT",
      "", "GOOGLE_CLOUD_CPP_APPLICATIONS_AUTHORITY",
  ...
  if (!options.has<appengine_v1::ApplicationsConnectionIdempotencyPolicyOption>()) {
    options.set<appengine_v1::ApplicationsConnectionIdempotencyPolicyOption>(
        appengine_v1::MakeDefaultApplicationsConnectionIdempotencyPolicy());
  }
