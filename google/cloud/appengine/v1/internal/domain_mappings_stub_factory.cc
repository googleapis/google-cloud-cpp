...
#include "google/cloud/appengine/v1/internal/domain_mappings_auth_decorator.h"
...
std::shared_ptr<DomainMappingsStub> CreateDefaultDomainMappingsStub(
  ...
  auto endpoint = internal::DetermineServiceEndpoint(
      internal::GetEnv("GOOGLE_CLOUD_CPP_DOMAIN_MAPPINGS_ENDPOINT"),
  ...
  if (!endpoint.ok()) {
    ...
    stub = std::make_shared<DefaultDomainMappingsStub>(
  ...
  if (internal::TracingEnabled(options)) {
    stub = MakeDomainMappingsTracingStub(std::move(stub));
  }
  return stub;
}
