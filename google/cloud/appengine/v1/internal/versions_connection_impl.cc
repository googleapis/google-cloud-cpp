...
idempotency_policy(Options const& options) {
  return options.get<appengine_v1::VersionsConnectionIdempotencyPolicyOption>()
      ->clone();
}
...
VersionsConnectionImpl::CreateVersion(
  ...
  return google::cloud::internal::AsyncLongRunningOperation<
      ...
      [stub = stub_](
          ...
          google::appengine::v1::CreateVersionRequest const& request) {
        return stub->AsyncCreateVersion(cq, std::move(context), options,
                                        request);
      },
...
VersionsConnectionImpl::UpdateVersion(
  ...
  return google::cloud::internal::AsyncLongRunningOperation<
      ...
      [stub = stub_](
          ...
          std::shared_ptr<grpc::ClientContext> context, Options const& options,
          google::appengine::v1::UpdateVersionRequest const& request) {
        return stub->AsyncUpdateVersion(cq, std::move(context), options,
                                        request);
      },
      [stub = stub_](google::cloud::CompletionQueue& cq,
                     std::shared_ptr<grpc::ClientContext> context,
