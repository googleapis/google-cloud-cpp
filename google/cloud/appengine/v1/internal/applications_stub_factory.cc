...
#include "google/cloud/appengine/v1/internal/applications_auth_decorator.h"
...
std::shared_ptr<ApplicationsStub> CreateDefaultApplicationsStub(
  ...
  auto endpoint = internal::DetermineServiceEndpoint(
      internal::GetEnv("GOOGLE_CLOUD_CPP_APPLICATIONS_ENDPOINT"),
      std::move(endpoint_option), "appengine.googleapis.com", options);
  ...
  if (!endpoint.ok()) {
    ...
    auto service_grpc_stub =
        google::appengine::v1::Applications::NewStub(channel);
    stub = std::make_shared<DefaultApplicationsStub>(
  ...
  if (internal::TracingEnabled(options)) {
    stub = MakeApplicationsTracingStub(std::move(stub));
  }
  return stub;
}
