...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_APPENGINE_V1_INTERNAL_FIREWALL_LOGGING_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_APPENGINE_V1_INTERNAL_FIREWALL_LOGGING_DECORATOR_H
...
class FirewallLogging : public FirewallStub {
 public:
  ~FirewallLogging() override = default;
  FirewallLogging(std::shared_ptr<FirewallStub> child,
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_APPENGINE_V1_INTERNAL_FIREWALL_LOGGING_DECORATOR_H
