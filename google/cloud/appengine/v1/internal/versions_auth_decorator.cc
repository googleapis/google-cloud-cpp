...
StatusOr<google::appengine::v1::ListVersionsResponse> VersionsAuth::ListVersions(
...
VersionsAuth::AsyncUpdateVersion(
  ...
  return auth_->AsyncConfigureContext(std::move(context)).then(
      [cq, child = child_, options = std::move(options), request](
        ...
        return child->AsyncUpdateVersion(
            cq, *std::move(context), std::move(options), request);
      });
}
...
VersionsAuth::AsyncDeleteVersion(
  ...
  return auth_->AsyncConfigureContext(std::move(context)).then(
      [cq, child = child_, options = std::move(options), request](
        ...
        return child->AsyncDeleteVersion(
            cq, *std::move(context), std::move(options), request);
      });
}

StatusOr<google::longrunning::Operation>
VersionsAuth::DeleteVersion(
      grpc::ClientContext& context,
      Options options,
      google::appengine::v1::DeleteVersionRequest const& request) {
  auto status = auth_->ConfigureContext(context);
