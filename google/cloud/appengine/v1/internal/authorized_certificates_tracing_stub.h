...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_APPENGINE_V1_INTERNAL_AUTHORIZED_CERTIFICATES_TRACING_STUB_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_APPENGINE_V1_INTERNAL_AUTHORIZED_CERTIFICATES_TRACING_STUB_H
...
class AuthorizedCertificatesTracingStub : public AuthorizedCertificatesStub {
 public:
  ...
  explicit AuthorizedCertificatesTracingStub(std::shared_ptr<AuthorizedCertificatesStub> child);
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_APPENGINE_V1_INTERNAL_AUTHORIZED_CERTIFICATES_TRACING_STUB_H
