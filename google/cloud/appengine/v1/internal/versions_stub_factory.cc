...
#include "google/cloud/appengine/v1/internal/versions_auth_decorator.h"
...
std::shared_ptr<VersionsStub> CreateDefaultVersionsStub(
  ...
  auto endpoint = internal::DetermineServiceEndpoint(
      internal::GetEnv("GOOGLE_CLOUD_CPP_VERSIONS_ENDPOINT"),
  ...
  if (!endpoint.ok()) {
    ...
    auto service_grpc_stub = google::appengine::v1::Versions::NewStub(channel);
    stub = std::make_shared<DefaultVersionsStub>(
  ...
  if (internal::TracingEnabled(options)) {
    stub = MakeVersionsTracingStub(std::move(stub));
  }
  return stub;
}
