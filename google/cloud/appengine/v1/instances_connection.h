...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_APPENGINE_V1_INSTANCES_CONNECTION_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_APPENGINE_V1_INSTANCES_CONNECTION_H
...
/**
 * A retry policy for `InstancesConnection` that stops retrying after a
...
class InstancesLimitedErrorCountRetryPolicy : public InstancesRetryPolicy {
 public:
  InstancesLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `InstancesConnection` that stops retrying after
 ...
 * - `google::cloud::appengine_v1::InstancesPolicyOptionList`
 *
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_APPENGINE_V1_INSTANCES_CONNECTION_H
