...
/**
 * A retry policy for `ApplicationsConnection` that stops retrying after a
...
class ApplicationsLimitedErrorCountRetryPolicy
 ...
 public:
  ApplicationsLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `ApplicationsConnection` that stops retrying after
/// some wall clock time has elapsed.
class ApplicationsLimitedTimeRetryPolicy : public ApplicationsRetryPolicy {
 public:
  /**
