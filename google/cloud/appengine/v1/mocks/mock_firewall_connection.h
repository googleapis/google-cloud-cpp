...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_APPENGINE_V1_MOCKS_MOCK_FIREWALL_CONNECTION_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_APPENGINE_V1_MOCKS_MOCK_FIREWALL_CONNECTION_H
...
/**
 * A class to mock `FirewallConnection`.
 *
 * Application developers may want to test their code with simulated responses,
 * including errors, from an object of type `FirewallClient`. To do so,
 * construct an object of type `FirewallClient` with an instance of this
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_APPENGINE_V1_MOCKS_MOCK_FIREWALL_CONNECTION_H
