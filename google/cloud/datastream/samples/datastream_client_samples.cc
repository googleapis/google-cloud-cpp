...
// main-dox-marker: GOOGLE_CLOUD_CPP_NS::DatastreamClient
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::GOOGLE_CLOUD_CPP_NS::DatastreamClient(
      google::cloud::GOOGLE_CLOUD_CPP_NS::MakeDatastreamConnection(options));
  //! [set-client-endpoint]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::GOOGLE_CLOUD_CPP_NS::DatastreamClient(
        google::cloud::GOOGLE_CLOUD_CPP_NS::MakeDatastreamConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
