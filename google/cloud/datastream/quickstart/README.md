# HOWTO: using the Datastream API C++ client in your project

This directory contains small examples showing how to use the Datastream API C++
...
1. Install the dependencies with your favorite tools. As an example, if you use
   ...
   ```bash
   cd $HOME/vcpkg
   ./vcpkg install google-cloud-cpp[core,datastream]
   ```
...
[quickstart-link]: https://cloud.google.com/datastream/docs/quickstarts
