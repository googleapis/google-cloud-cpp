...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::datastream_v1::DatastreamClient(
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::datastream_v1::DatastreamClient(
      google::cloud::datastream_v1::MakeDatastreamConnection(ud_options));
