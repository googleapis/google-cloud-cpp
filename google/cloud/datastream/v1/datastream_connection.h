...
/**
 * A retry policy for `DatastreamConnection` that stops retrying after a
...
class DatastreamLimitedErrorCountRetryPolicy : public DatastreamRetryPolicy {
 public:
  DatastreamLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `DatastreamConnection` that stops retrying after
