...
/**
 * A retry policy for `OrgPolicyConnection` that stops retrying after a
 ...
 */
class OrgPolicyLimitedErrorCountRetryPolicy : public OrgPolicyRetryPolicy {
 public:
  OrgPolicyLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `OrgPolicyConnection` that stops retrying after
/// some wall clock time has elapsed.
class OrgPolicyLimitedTimeRetryPolicy : public OrgPolicyRetryPolicy {
 public:
  /**
