...
// clang-format off
// main-dox-marker: orgpolicy_v2::OrgPolicyClient
// clang-format on
namespace {
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::orgpolicy_v2::OrgPolicyClient(
      google::cloud::orgpolicy_v2::MakeOrgPolicyConnection(*ud_options));
  //! [set-client-universe-domain]
}
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto c2 = google::cloud::orgpolicy_v2::OrgPolicyClient(connection);
  ...
  //     .set<google::cloud::orgpolicy_v2::OrgPolicyRetryPolicyOption>(
  //       google::cloud::orgpolicy_v2::OrgPolicyLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
