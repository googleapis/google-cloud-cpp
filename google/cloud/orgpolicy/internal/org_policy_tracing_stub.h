...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_ORGPOLICY_INTERNAL_ORG_POLICY_TRACING_STUB_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_ORGPOLICY_INTERNAL_ORG_POLICY_TRACING_STUB_H
...
class OrgPolicyTracingStub : public OrgPolicyStub {
 public:
  ...
  explicit OrgPolicyTracingStub(std::shared_ptr<OrgPolicyStub> child);
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_ORGPOLICY_INTERNAL_ORG_POLICY_TRACING_STUB_H
