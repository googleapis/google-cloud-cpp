# HOWTO: using the Organization Policy API C++ client in your project

This directory contains small examples showing how to use the Organization Policy API C++
...
Like most Google Cloud Platform (GCP) services, Organization Policy API requires that
...
1. Install the dependencies with your favorite tools. As an example, if you use
   ...
   ```bash
   cd $HOME/vcpkg
   ./vcpkg install google-cloud-cpp[core,orgpolicy]
   ```
...
1. Configure CMake, if necessary, configure the directory where you installed
   ...
   ```bash
   cd $HOME/gooogle-cloud-cpp/google/cloud/orgpolicy/quickstart
...
[quickstart-link]: https://cloud.google.com/resource-manager/docs/how-to#managing-organization-policy
