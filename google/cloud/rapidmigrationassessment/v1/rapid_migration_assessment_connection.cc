...
RapidMigrationAssessmentConnection::ListOperations(
    google::longrunning::
...
Status RapidMigrationAssessmentConnection::DeleteOperation(
    google::longrunning::DeleteOperationRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

Status RapidMigrationAssessmentConnection::CancelOperation(
