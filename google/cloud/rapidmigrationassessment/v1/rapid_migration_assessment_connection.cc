...
RapidMigrationAssessmentConnection::~RapidMigrationAssessmentConnection() = default;
...
StreamRange<google::cloud::rapidmigrationassessment::v1::Collector> RapidMigrationAssessmentConnection::ListCollectors(
    google::cloud::rapidmigrationassessment::v1::ListCollectorsRequest) {  // NOLINT(performance-unnecessary-value-param)
...
StreamRange<google::cloud::location::Location> RapidMigrationAssessmentConnection::ListLocations(
...
StreamRange<google::longrunning::Operation> RapidMigrationAssessmentConnection::ListOperations(
...
StatusOr<google::longrunning::Operation>
RapidMigrationAssessmentConnection::GetOperation(
    google::longrunning::GetOperationRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

Status
RapidMigrationAssessmentConnection::DeleteOperation(
    google::longrunning::DeleteOperationRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

Status
RapidMigrationAssessmentConnection::CancelOperation(
    google::longrunning::CancelOperationRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

std::shared_ptr<RapidMigrationAssessmentConnection> MakeRapidMigrationAssessmentConnection(
    Options options) {
  internal::CheckExpectedOptions<CommonOptionList, GrpcOptionList,
      UnifiedCredentialsOptionList,
      RapidMigrationAssessmentPolicyOptionList>(options, __func__);
  options = rapidmigrationassessment_v1_internal::RapidMigrationAssessmentDefaultOptions(
      std::move(options));
  auto background = internal::MakeBackgroundThreadsFactory(options)();
  auto auth = internal::CreateAuthenticationStrategy(background->cq(), options);
  auto stub = rapidmigrationassessment_v1_internal::CreateDefaultRapidMigrationAssessmentStub(
    std::move(auth), options);
  return rapidmigrationassessment_v1_internal::MakeRapidMigrationAssessmentTracingConnection(
      std::make_shared<rapidmigrationassessment_v1_internal::RapidMigrationAssessmentConnectionImpl>(
