...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::rapidmigrationassessment_v1::
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::rapidmigrationassessment_v1::
      RapidMigrationAssessmentClient(
          google::cloud::rapidmigrationassessment_v1::
              MakeRapidMigrationAssessmentConnection(*ud_options));
  //! [set-client-universe-domain]
}

//! [custom-idempotency-policy]
class CustomIdempotencyPolicy
    : public google::cloud::rapidmigrationassessment_v1::
          RapidMigrationAssessmentConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::rapidmigrationassessment_v1::
                      RapidMigrationAssessmentConnectionIdempotencyPolicy>
      ...
      google::cloud::Options{}
          ...
          .set<google::cloud::rapidmigrationassessment_v1::
              ...
              google::cloud::ExponentialBackoffPolicy(
                  ...
                  /*scaling=*/2.0)
                  .clone());
  auto connection = google::cloud::rapidmigrationassessment_v1::
      MakeRapidMigrationAssessmentConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::rapidmigrationassessment_v1::
      RapidMigrationAssessmentClient(connection);
  auto c2 = google::cloud::rapidmigrationassessment_v1::
      RapidMigrationAssessmentClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::rapidmigrationassessment_v1::
      RapidMigrationAssessmentClient(
          connection,
          google::cloud::Options{}
              .set<google::cloud::rapidmigrationassessment_v1::
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::rapidmigrationassessment_v1::
        RapidMigrationAssessmentClient(
            google::cloud::rapidmigrationassessment_v1::
                MakeRapidMigrationAssessmentConnection(options));
  }
