...
RapidMigrationAssessmentAuth::AsyncCreateCollector(
  ...
  return auth_->AsyncConfigureContext(std::move(context)).then(
      [cq, child = child_, options = std::move(options), request](
        ...
        return child->AsyncCreateCollector(
...
RapidMigrationAssessmentAuth::AsyncCreateAnnotation(
  ...
  return auth_->AsyncConfigureContext(std::move(context)).then(
      [cq, child = child_, options = std::move(options), request](
        ...
        return child->AsyncCreateAnnotation(
            cq, *std::move(context), std::move(options), request);
      });
}
...
StatusOr<google::cloud::rapidmigrationassessment::v1::Annotation> RapidMigrationAssessmentAuth::GetAnnotation(
    grpc::ClientContext& context,
...
StatusOr<google::cloud::rapidmigrationassessment::v1::ListCollectorsResponse> RapidMigrationAssessmentAuth::ListCollectors(
    grpc::ClientContext& context,
    Options const& options,
...
StatusOr<google::cloud::rapidmigrationassessment::v1::Collector> RapidMigrationAssessmentAuth::GetCollector(
    grpc::ClientContext& context,
    Options const& options,
...
RapidMigrationAssessmentAuth::AsyncUpdateCollector(
  ...
  return auth_->AsyncConfigureContext(std::move(context)).then(
      [cq, child = child_, options = std::move(options), request](
        ...
        return child->AsyncUpdateCollector(
            cq, *std::move(context), std::move(options), request);
      });
}
...
RapidMigrationAssessmentAuth::AsyncDeleteCollector(
  ...
  return auth_->AsyncConfigureContext(std::move(context)).then(
      [cq, child = child_, options = std::move(options), request](
        ...
        return child->AsyncDeleteCollector(
            cq, *std::move(context), std::move(options), request);
      });
}
...
RapidMigrationAssessmentAuth::AsyncResumeCollector(
  ...
  return auth_->AsyncConfigureContext(std::move(context)).then(
      [cq, child = child_, options = std::move(options), request](
        ...
        return child->AsyncResumeCollector(
            cq, *std::move(context), std::move(options), request);
      });
}
...
RapidMigrationAssessmentAuth::AsyncRegisterCollector(
  ...
  return auth_->AsyncConfigureContext(std::move(context)).then(
      [cq, child = child_, options = std::move(options), request](
        ...
        return child->AsyncRegisterCollector(
            cq, *std::move(context), std::move(options), request);
      });
}
...
RapidMigrationAssessmentAuth::AsyncPauseCollector(
  ...
  return auth_->AsyncConfigureContext(std::move(context)).then(
      [cq, child = child_, options = std::move(options), request](
        ...
        return child->AsyncPauseCollector(
            cq, *std::move(context), std::move(options), request);
      });
}
...
StatusOr<google::cloud::location::ListLocationsResponse> RapidMigrationAssessmentAuth::ListLocations(
    grpc::ClientContext& context,
    Options const& options,
...
StatusOr<google::cloud::location::Location> RapidMigrationAssessmentAuth::GetLocation(
    grpc::ClientContext& context,
    Options const& options,
...
StatusOr<google::longrunning::ListOperationsResponse> RapidMigrationAssessmentAuth::ListOperations(
    grpc::ClientContext& context,
    Options const& options,
...
StatusOr<google::longrunning::Operation> RapidMigrationAssessmentAuth::GetOperation(
    grpc::ClientContext& context,
    Options const& options,
