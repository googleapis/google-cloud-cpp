...
RapidMigrationAssessmentMetadata::AsyncCreateCollector(
  ...
  return child_->AsyncCreateCollector(
...
RapidMigrationAssessmentMetadata::AsyncCreateAnnotation(
  ...
  SetMetadata(*context, *options, absl::StrCat("parent=", internal::UrlEncode(request.parent())));
  return child_->AsyncCreateAnnotation(
      cq, std::move(context), std::move(options), request);
}
...
RapidMigrationAssessmentMetadata::AsyncUpdateCollector(
  ...
  SetMetadata(*context, *options, absl::StrCat("collector.name=", internal::UrlEncode(request.collector().name())));
  return child_->AsyncUpdateCollector(
      cq, std::move(context), std::move(options), request);
}
...
RapidMigrationAssessmentMetadata::AsyncDeleteCollector(
  ...
  SetMetadata(*context, *options, absl::StrCat("name=", internal::UrlEncode(request.name())));
  return child_->AsyncDeleteCollector(
      cq, std::move(context), std::move(options), request);
}
...
RapidMigrationAssessmentMetadata::AsyncResumeCollector(
  ...
  SetMetadata(*context, *options, absl::StrCat("name=", internal::UrlEncode(request.name())));
  return child_->AsyncResumeCollector(
      cq, std::move(context), std::move(options), request);
}
...
RapidMigrationAssessmentMetadata::AsyncRegisterCollector(
  ...
  SetMetadata(*context, *options, absl::StrCat("name=", internal::UrlEncode(request.name())));
  return child_->AsyncRegisterCollector(
      cq, std::move(context), std::move(options), request);
}
...
RapidMigrationAssessmentMetadata::AsyncPauseCollector(
  ...
  SetMetadata(*context, *options, absl::StrCat("name=", internal::UrlEncode(request.name())));
  return child_->AsyncPauseCollector(
      cq, std::move(context), std::move(options), request);
}
...
Status
RapidMigrationAssessmentMetadata::DeleteOperation(
    grpc::ClientContext& context,
    Options const& options,
...
Status
RapidMigrationAssessmentMetadata::CancelOperation(
    grpc::ClientContext& context,
    Options const& options,
