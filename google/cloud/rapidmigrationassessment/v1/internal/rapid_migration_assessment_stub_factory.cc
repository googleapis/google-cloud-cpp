...
CreateDefaultRapidMigrationAssessmentStub(
  ...
  auto service_grpc_stub = google::cloud::rapidmigrationassessment::v1::RapidMigrationAssessment::NewStub(channel);
  ...
  std::shared_ptr<RapidMigrationAssessmentStub> stub =
    std::make_shared<DefaultRapidMigrationAssessmentStub>(
      std::move(service_grpc_stub), std::move(service_locations_stub),
      google::longrunning::Operations::NewStub(channel));

  if (auth->RequiresConfigureContext()) {
    stub = std::make_shared<RapidMigrationAssessmentAuth>(
