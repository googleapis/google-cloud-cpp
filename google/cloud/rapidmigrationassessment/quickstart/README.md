# HOWTO: using the Rapid Migration Assessment API C++ client in your project

This directory contains small examples showing how to use the Rapid Migration Assessment API C++
...
Like most Google Cloud Platform (GCP) services, Rapid Migration Assessment API requires that
...
1. Compile this example using Bazel:
   ...
   ```bash
   cd $HOME/google-cloud-cpp/google/cloud/rapidmigrationassessment/quickstart
   bazel build ...
   ```
...
1. Install the dependencies with your favorite tools. As an example, if you use
   ...
   ```bash
   cd $HOME/vcpkg
   ./vcpkg install google-cloud-cpp[core,rapidmigrationassessment]
   ```
...
[quickstart-link]: https://cloud.google.com/migration-center/docs/migration-center-overview
