...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_COMPOSER_INTERNAL_IMAGE_VERSIONS_TRACING_CONNECTION_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_COMPOSER_INTERNAL_IMAGE_VERSIONS_TRACING_CONNECTION_H
...
class ImageVersionsTracingConnection
 ...
 public:
  ...
  explicit ImageVersionsTracingConnection(
      std::shared_ptr<composer::ImageVersionsConnection> child);
 ...
 private:
  std::shared_ptr<composer::ImageVersionsConnection> child_;
};
 ...
 */
std::shared_ptr<composer::ImageVersionsConnection>
MakeImageVersionsTracingConnection(
    std::shared_ptr<composer::ImageVersionsConnection> conn);
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_COMPOSER_INTERNAL_IMAGE_VERSIONS_TRACING_CONNECTION_H
