# HOWTO: using the Cloud Composer API C++ client in your project

This directory contains small examples showing how to use the Cloud Composer API C++
...
Like most Google Cloud Platform (GCP) services, Cloud Composer API requires that
...
2. Install the dependencies with your favorite tools. As an example, if you use
   ...
   ```bash
   cd $HOME/vcpkg
   ./vcpkg install google-cloud-cpp[core,composer]
   ```
...
3. Configure CMake, if necessary, configure the directory where you installed
   ...
   ```bash
   cd $HOME/gooogle-cloud-cpp/google/cloud/composer/quickstart
...
[quickstart-link]: https://cloud.google.com/composer/docs/quickstart
