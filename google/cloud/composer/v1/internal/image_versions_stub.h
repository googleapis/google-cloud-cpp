...
class ImageVersionsStub {
 public:
  ...
  virtual StatusOr<google::cloud::orchestration::airflow::service::v1::ListImageVersionsResponse> ListImageVersions(
      grpc::ClientContext& context,
      Options const& options,
      google::cloud::orchestration::airflow::service::v1::ListImageVersionsRequest const& request) = 0;
...
class DefaultImageVersionsStub : public ImageVersionsStub {
 public:
  explicit DefaultImageVersionsStub(
      std::unique_ptr<google::cloud::orchestration::airflow::service::v1::ImageVersions::StubInterface> grpc_stub,
 ...
 private:
  std::unique_ptr<google::cloud::orchestration::airflow::service::v1::ImageVersions::StubInterface> grpc_stub_;
