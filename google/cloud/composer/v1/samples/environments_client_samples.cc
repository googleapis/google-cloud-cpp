...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::composer_v1::EnvironmentsClient(
...
class CustomIdempotencyPolicy
   : public google::cloud::composer_v1::EnvironmentsConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::composer_v1::EnvironmentsConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::composer_v1::EnvironmentsConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::composer_v1::EnvironmentsRetryPolicyOption>(
      google::cloud::composer_v1::EnvironmentsLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::composer_v1::EnvironmentsBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::composer_v1::MakeEnvironmentsConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::composer_v1::EnvironmentsClient(connection);
  auto c2 = google::cloud::composer_v1::EnvironmentsClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::composer_v1::EnvironmentsClient(
    connection, google::cloud::Options{}.set<google::cloud::composer_v1::EnvironmentsRetryPolicyOption>(
      google::cloud::composer_v1::EnvironmentsLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::composer_v1::EnvironmentsRetryPolicyOption>(
  //       google::cloud::composer_v1::EnvironmentsLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::composer_v1::EnvironmentsPollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::composer_v1::EnvironmentsRetryPolicyOption::Type,
            google::cloud::composer_v1::EnvironmentsBackoffPolicyOption::Type>(
            google::cloud::composer_v1::EnvironmentsLimitedTimeRetryPolicy(
