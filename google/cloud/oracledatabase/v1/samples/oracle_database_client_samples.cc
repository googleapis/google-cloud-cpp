...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::oracledatabase_v1::OracleDatabaseClient(
      google::cloud::oracledatabase_v1::MakeOracleDatabaseConnection(
          ud_options));
...
class CustomIdempotencyPolicy : public google::cloud::oracledatabase_v1::
                                    OracleDatabaseConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::oracledatabase_v1::
                      OracleDatabaseConnectionIdempotencyPolicy>
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
                     .set<google::cloud::oracledatabase_v1::
                              OracleDatabaseConnectionIdempotencyPolicyOption>(
                         CustomIdempotencyPolicy().clone())
                     .set<google::cloud::oracledatabase_v1::
                              OracleDatabaseRetryPolicyOption>(
                         google::cloud::oracledatabase_v1::
                             OracleDatabaseLimitedErrorCountRetryPolicy(3)
                                 .clone())
                     .set<google::cloud::oracledatabase_v1::
  ...
  auto c3 = google::cloud::oracledatabase_v1::OracleDatabaseClient(
      ...
      google::cloud::Options{}
          .set<google::cloud::oracledatabase_v1::
                   OracleDatabaseRetryPolicyOption>(
              google::cloud::oracledatabase_v1::
                  OracleDatabaseLimitedTimeRetryPolicy(std::chrono::minutes(5))
                      .clone()));
      ...
      google::cloud::Options{}
          .set<google::cloud::oracledatabase_v1::
              ...
              google::cloud::GenericPollingPolicy<
                  google::cloud::oracledatabase_v1::
                      OracleDatabaseRetryPolicyOption::Type,
                  google::cloud::oracledatabase_v1::
                      OracleDatabaseBackoffPolicyOption::Type>(
                  google::cloud::oracledatabase_v1::
