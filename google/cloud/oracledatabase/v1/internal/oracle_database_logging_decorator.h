...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_ORACLEDATABASE_V1_INTERNAL_ORACLE_DATABASE_LOGGING_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_ORACLEDATABASE_V1_INTERNAL_ORACLE_DATABASE_LOGGING_DECORATOR_H
...
class OracleDatabaseLogging : public OracleDatabaseStub {
 public:
  ~OracleDatabaseLogging() override = default;
  OracleDatabaseLogging(std::shared_ptr<OracleDatabaseStub> child,
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_ORACLEDATABASE_V1_INTERNAL_ORACLE_DATABASE_LOGGING_DECORATOR_H
