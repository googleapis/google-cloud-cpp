...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_ORACLEDATABASE_V1_INTERNAL_ORACLE_DATABASE_CONNECTION_IMPL_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_ORACLEDATABASE_V1_INTERNAL_ORACLE_DATABASE_CONNECTION_IMPL_H
...
class OracleDatabaseConnectionImpl
    : public oracledatabase_v1::OracleDatabaseConnection {
 public:
  ~OracleDatabaseConnectionImpl() override = default;

  OracleDatabaseConnectionImpl(
 ...
 private:
  ...
  std::shared_ptr<oracledatabase_v1_internal::OracleDatabaseStub> stub_;
  Options options_;
};
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_ORACLEDATABASE_V1_INTERNAL_ORACLE_DATABASE_CONNECTION_IMPL_H
