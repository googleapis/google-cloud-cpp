# HOWTO: using the Anthos Multi-Cloud API C++ client in your project

This directory contains small examples showing how to use the Anthos Multi-Cloud API C++
...
Like most Google Cloud Platform (GCP) services, Anthos Multi-Cloud API requires that
...
1. Install the dependencies with your favorite tools. As an example, if you use
   ...
   ```bash
   cd $HOME/vcpkg
   ./vcpkg install google-cloud-cpp[core,gkemulticloud]
   ```
...
1. Configure CMake, if necessary, configure the directory where you installed
   ...
   ```bash
   cd $HOME/gooogle-cloud-cpp/google/cloud/gkemulticloud/quickstart
...
[quickstart-link]: https://cloud.google.com/anthos/clusters/docs/multi-cloud/attached/aks/how-to/attach-cluster
