...
std::shared_ptr<AzureClustersStub> CreateDefaultAzureClustersStub(
  ...
  auto endpoint = internal::DetermineServiceEndpoint(
      internal::GetEnv("GOOGLE_CLOUD_CPP_AZURE_CLUSTERS_ENDPOINT"),
  ...
  if (!endpoint.ok()) {
    ...
    stub = std::make_shared<DefaultAzureClustersStub>(
  ...
  if (internal::TracingEnabled(options)) {
    stub = MakeAzureClustersTracingStub(std::move(stub));
  }
  return stub;
}
