...
AwsClustersMetadata::AsyncCreateAwsCluster(
  ...
  return child_->AsyncCreateAwsCluster(
      cq, std::move(context), std::move(options), request);
}

StatusOr<google::longrunning::Operation>
AwsClustersMetadata::CreateAwsCluster(
...
AwsClustersMetadata::AsyncUpdateAwsCluster(
  ...
  SetMetadata(*context, *options, absl::StrCat("aws_cluster.name=", internal::UrlEncode(request.aws_cluster().name())));
  return child_->AsyncUpdateAwsCluster(
      cq, std::move(context), std::move(options), request);
}

StatusOr<google::longrunning::Operation>
AwsClustersMetadata::UpdateAwsCluster(
    grpc::ClientContext& context,
    Options options,
    google::cloud::gkemulticloud::v1::UpdateAwsClusterRequest const& request) {
  SetMetadata(context, options, absl::StrCat("aws_cluster.name=", internal::UrlEncode(request.aws_cluster().name())));
...
AwsClustersMetadata::AsyncDeleteAwsCluster(
  ...
  SetMetadata(*context, *options, absl::StrCat("name=", internal::UrlEncode(request.name())));
  return child_->AsyncDeleteAwsCluster(
      cq, std::move(context), std::move(options), request);
}

StatusOr<google::longrunning::Operation>
AwsClustersMetadata::DeleteAwsCluster(
    grpc::ClientContext& context,
    Options options,
    google::cloud::gkemulticloud::v1::DeleteAwsClusterRequest const& request) {
  SetMetadata(context, options, absl::StrCat("name=", internal::UrlEncode(request.name())));
...
AwsClustersMetadata::GenerateAwsClusterAgentToken(
  ...
  SetMetadata(context, options, absl::StrCat("aws_cluster=", internal::UrlEncode(request.aws_cluster())));
...
AwsClustersMetadata::AsyncCreateAwsNodePool(
  ...
  SetMetadata(*context, *options, absl::StrCat("parent=", internal::UrlEncode(request.parent())));
  return child_->AsyncCreateAwsNodePool(
      cq, std::move(context), std::move(options), request);
}

StatusOr<google::longrunning::Operation>
AwsClustersMetadata::CreateAwsNodePool(
    grpc::ClientContext& context,
    Options options,
    google::cloud::gkemulticloud::v1::CreateAwsNodePoolRequest const& request) {
  SetMetadata(context, options, absl::StrCat("parent=", internal::UrlEncode(request.parent())));
...
AwsClustersMetadata::AsyncUpdateAwsNodePool(
  ...
  SetMetadata(*context, *options, absl::StrCat("aws_node_pool.name=", internal::UrlEncode(request.aws_node_pool().name())));
  return child_->AsyncUpdateAwsNodePool(
      cq, std::move(context), std::move(options), request);
}

StatusOr<google::longrunning::Operation>
AwsClustersMetadata::UpdateAwsNodePool(
    grpc::ClientContext& context,
    Options options,
    google::cloud::gkemulticloud::v1::UpdateAwsNodePoolRequest const& request) {
  SetMetadata(context, options, absl::StrCat("aws_node_pool.name=", internal::UrlEncode(request.aws_node_pool().name())));
...
AwsClustersMetadata::AsyncDeleteAwsNodePool(
  ...
  SetMetadata(*context, *options, absl::StrCat("name=", internal::UrlEncode(request.name())));
  return child_->AsyncDeleteAwsNodePool(
      cq, std::move(context), std::move(options), request);
}

StatusOr<google::longrunning::Operation>
AwsClustersMetadata::DeleteAwsNodePool(
    grpc::ClientContext& context,
    Options options,
    google::cloud::gkemulticloud::v1::DeleteAwsNodePoolRequest const& request) {
  SetMetadata(context, options, absl::StrCat("name=", internal::UrlEncode(request.name())));
...
AwsClustersMetadata::ListOperations(
    grpc::ClientContext& context,
    Options const& options,
...
StatusOr<google::longrunning::Operation>
AwsClustersMetadata::GetOperation(
    grpc::ClientContext& context,
    Options const& options,
...
Status
AwsClustersMetadata::DeleteOperation(
    grpc::ClientContext& context,
    Options const& options,
...
Status
AwsClustersMetadata::CancelOperation(
    grpc::ClientContext& context,
    Options const& options,
