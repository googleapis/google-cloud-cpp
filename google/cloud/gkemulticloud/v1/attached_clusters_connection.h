...
/**
 * A retry policy for `AttachedClustersConnection` that stops retrying after a
...
class AttachedClustersLimitedErrorCountRetryPolicy
 ...
 public:
  AttachedClustersLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `AttachedClustersConnection` that stops retrying after
