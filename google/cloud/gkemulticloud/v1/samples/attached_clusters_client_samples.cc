...
// clang-format off
// main-dox-marker: gkemulticloud_v1::AttachedClustersClient
// lro-marker: true
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::gkemulticloud_v1::AttachedClustersClient(
      google::cloud::gkemulticloud_v1::MakeAttachedClustersConnection("unused", options));
  //! [set-client-endpoint]
}

//! [custom-idempotency-policy]
class CustomIdempotencyPolicy
   : public google::cloud::gkemulticloud_v1::AttachedClustersConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::gkemulticloud_v1::AttachedClustersConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::gkemulticloud_v1::AttachedClustersConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::gkemulticloud_v1::AttachedClustersRetryPolicyOption>(
      google::cloud::gkemulticloud_v1::AttachedClustersLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::gkemulticloud_v1::AttachedClustersBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::gkemulticloud_v1::MakeAttachedClustersConnection("location-unused-in-this-example", options);
  ...
  auto c3 = google::cloud::gkemulticloud_v1::AttachedClustersClient(
    connection, google::cloud::Options{}.set<google::cloud::gkemulticloud_v1::AttachedClustersRetryPolicyOption>(
      google::cloud::gkemulticloud_v1::AttachedClustersLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::gkemulticloud_v1::AttachedClustersPollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::gkemulticloud_v1::AttachedClustersRetryPolicyOption::Type,
            google::cloud::gkemulticloud_v1::AttachedClustersBackoffPolicyOption::Type>(
            google::cloud::gkemulticloud_v1::AttachedClustersLimitedTimeRetryPolicy(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::gkemulticloud_v1::AttachedClustersClient(
      google::cloud::gkemulticloud_v1::MakeAttachedClustersConnection("us-west1" /* regional service region */, options));
  }
  //! [with-service-account]
  (argv.at(0));
}
