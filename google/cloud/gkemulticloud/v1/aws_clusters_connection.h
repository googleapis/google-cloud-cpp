...
/**
 * A retry policy for `AwsClustersConnection` that stops retrying after a
...
class AwsClustersLimitedErrorCountRetryPolicy : public AwsClustersRetryPolicy {
 public:
  AwsClustersLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `AwsClustersConnection` that stops retrying after
