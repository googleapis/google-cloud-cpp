...
/**
 * A retry policy for `AzureClustersConnection` that stops retrying after a
...
class AzureClustersLimitedErrorCountRetryPolicy
 ...
 public:
  AzureClustersLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `AzureClustersConnection` that stops retrying after
