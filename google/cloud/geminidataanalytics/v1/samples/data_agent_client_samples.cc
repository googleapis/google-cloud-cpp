...
// clang-format off
// main-dox-marker: geminidataanalytics_v1::DataAgentServiceClient
// lro-marker: true
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client =
      google::cloud::geminidataanalytics_v1::DataAgentServiceClient(
          google::cloud::geminidataanalytics_v1::MakeDataAgentServiceConnection(
              options));
  //! [set-client-endpoint]
}
...
class CustomIdempotencyPolicy
    : public google::cloud::geminidataanalytics_v1::
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
      ...
      google::cloud::Options{}
          ...
          .set<google::cloud::geminidataanalytics_v1::
              ...
              google::cloud::geminidataanalytics_v1::
                  DataAgentServiceLimitedErrorCountRetryPolicy(3)
                      .clone())
          .set<google::cloud::geminidataanalytics_v1::
  ...
  auto c1 =
      google::cloud::geminidataanalytics_v1::DataAgentServiceClient(connection);
  auto c2 =
      google::cloud::geminidataanalytics_v1::DataAgentServiceClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::geminidataanalytics_v1::DataAgentServiceClient(
  ...
  //     .set<google::cloud::geminidataanalytics_v1::DataAgentServiceRetryPolicyOption>(
  //       google::cloud::geminidataanalytics_v1::DataAgentServiceLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
      ...
      google::cloud::Options{}
          .set<google::cloud::geminidataanalytics_v1::
              ...
              google::cloud::GenericPollingPolicy<
                  google::cloud::geminidataanalytics_v1::
                      DataAgentServiceRetryPolicyOption::Type,
                  google::cloud::geminidataanalytics_v1::
                      DataAgentServiceBackoffPolicyOption::Type>(
                  google::cloud::geminidataanalytics_v1::
                      DataAgentServiceLimitedTimeRetryPolicy(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::geminidataanalytics_v1::DataAgentServiceClient(
        google::cloud::geminidataanalytics_v1::MakeDataAgentServiceConnection(
            options));
  }
  //! [with-service-account]
