...
// clang-format off
// main-dox-marker: geminidataanalytics_v1::DataChatServiceClient
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client =
      google::cloud::geminidataanalytics_v1::DataChatServiceClient(
          google::cloud::geminidataanalytics_v1::MakeDataChatServiceConnection(
              options));
  //! [set-client-endpoint]
}
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::geminidataanalytics_v1::DataChatServiceClient(
      google::cloud::geminidataanalytics_v1::MakeDataChatServiceConnection(
          *ud_options));
  //! [set-client-universe-domain]
}
...
class CustomIdempotencyPolicy : public google::cloud::geminidataanalytics_v1::
                                    DataChatServiceConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::geminidataanalytics_v1::
                      DataChatServiceConnectionIdempotencyPolicy>
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
                     .set<google::cloud::geminidataanalytics_v1::
                              DataChatServiceConnectionIdempotencyPolicyOption>(
                         CustomIdempotencyPolicy().clone())
                     .set<google::cloud::geminidataanalytics_v1::
                              DataChatServiceRetryPolicyOption>(
                         google::cloud::geminidataanalytics_v1::
                             DataChatServiceLimitedErrorCountRetryPolicy(3)
                                 .clone())
                     .set<google::cloud::geminidataanalytics_v1::
  ...
  auto c1 =
      google::cloud::geminidataanalytics_v1::DataChatServiceClient(connection);
  auto c2 =
      google::cloud::geminidataanalytics_v1::DataChatServiceClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::geminidataanalytics_v1::DataChatServiceClient(
      connection,
      google::cloud::Options{}
          .set<google::cloud::geminidataanalytics_v1::
                   DataChatServiceRetryPolicyOption>(
              google::cloud::geminidataanalytics_v1::
                  DataChatServiceLimitedTimeRetryPolicy(std::chrono::minutes(5))
                      .clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::geminidataanalytics_v1::DataChatServiceRetryPolicyOption>(
  //       google::cloud::geminidataanalytics_v1::DataChatServiceLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::geminidataanalytics_v1::DataChatServiceClient(
        google::cloud::geminidataanalytics_v1::MakeDataChatServiceConnection(
            options));
  }
  //! [with-service-account]
