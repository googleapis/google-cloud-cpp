...
class MockCloudDeployConnection : public deploy_v1::CloudDeployConnection {
 public:
  ...
  MOCK_METHOD(StatusOr<google::cloud::deploy::v1::DeliveryPipeline>,
  GetDeliveryPipeline,
  ...
  /// EXPECT_CALL(*mock, CreateDeliveryPipeline(Matcher<google::cloud::deploy::v1::CreateDeliveryPipelineRequest const&>(_)))
  /// @endcode
  ...
  /// using ::testing::_;
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock, CreateDeliveryPipeline(Matcher<google::longrunning::Operation const&>(_)))
  /// @endcode
  MOCK_METHOD(future<StatusOr<google::cloud::deploy::v1::DeliveryPipeline>>,
  CreateDeliveryPipeline, (
  ...
  /// using ::testing::_;
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock, UpdateDeliveryPipeline(Matcher<google::cloud::deploy::v1::UpdateDeliveryPipelineRequest const&>(_)))
  /// @endcode
  MOCK_METHOD(future<StatusOr<google::cloud::deploy::v1::DeliveryPipeline>>,
  ...
  /// using ::testing::_;
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock, UpdateDeliveryPipeline(Matcher<google::longrunning::Operation const&>(_)))
  /// @endcode
  MOCK_METHOD(future<StatusOr<google::cloud::deploy::v1::DeliveryPipeline>>,
  UpdateDeliveryPipeline, (
    google::longrunning::Operation const& operation), (override));
  ...
  /// using ::testing::_;
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock, DeleteDeliveryPipeline(Matcher<google::cloud::deploy::v1::DeleteDeliveryPipelineRequest const&>(_)))
  /// @endcode
  ...
  /// using ::testing::_;
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock, DeleteDeliveryPipeline(Matcher<google::longrunning::Operation const&>(_)))
  /// @endcode
  MOCK_METHOD(future<StatusOr<google::cloud::deploy::v1::OperationMetadata>>,
  DeleteDeliveryPipeline, (
    google::longrunning::Operation const& operation), (override));

  MOCK_METHOD((StreamRange<google::cloud::deploy::v1::Target>),
  ListTargets,
  ...
  MOCK_METHOD(StatusOr<google::cloud::deploy::v1::Target>,
  GetTarget,
  ...
  /// using ::testing::_;
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock, CreateTarget(Matcher<google::cloud::deploy::v1::CreateTargetRequest const&>(_)))
  /// @endcode
  ...
  /// using ::testing::_;
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock, CreateTarget(Matcher<google::longrunning::Operation const&>(_)))
  /// @endcode
  MOCK_METHOD(future<StatusOr<google::cloud::deploy::v1::Target>>,
  CreateTarget, (
    google::longrunning::Operation const& operation), (override));
  ...
  /// using ::testing::_;
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock, UpdateTarget(Matcher<google::cloud::deploy::v1::UpdateTargetRequest const&>(_)))
  /// @endcode
  MOCK_METHOD(future<StatusOr<google::cloud::deploy::v1::Target>>,
  UpdateTarget,
  ...
  /// using ::testing::_;
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock, UpdateTarget(Matcher<google::longrunning::Operation const&>(_)))
  /// @endcode
  MOCK_METHOD(future<StatusOr<google::cloud::deploy::v1::Target>>,
  UpdateTarget, (
    google::longrunning::Operation const& operation), (override));
  ...
  /// using ::testing::_;
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock, DeleteTarget(Matcher<google::cloud::deploy::v1::DeleteTargetRequest const&>(_)))
  /// @endcode
  MOCK_METHOD(future<StatusOr<google::cloud::deploy::v1::OperationMetadata>>,
  DeleteTarget,
  ...
  /// using ::testing::_;
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock, DeleteTarget(Matcher<google::longrunning::Operation const&>(_)))
  /// @endcode
  MOCK_METHOD(future<StatusOr<google::cloud::deploy::v1::OperationMetadata>>,
  DeleteTarget, (
    google::longrunning::Operation const& operation), (override));
  ...
  MOCK_METHOD(StatusOr<google::cloud::deploy::v1::CustomTargetType>,
  GetCustomTargetType,
  ...
  /// using ::testing::_;
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock, CreateCustomTargetType(Matcher<google::cloud::deploy::v1::CreateCustomTargetTypeRequest const&>(_)))
  /// @endcode
  ...
  /// using ::testing::_;
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock, CreateCustomTargetType(Matcher<google::longrunning::Operation const&>(_)))
  /// @endcode
  MOCK_METHOD(future<StatusOr<google::cloud::deploy::v1::CustomTargetType>>,
  CreateCustomTargetType, (
    google::longrunning::Operation const& operation), (override));
  ...
  /// using ::testing::_;
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock, UpdateCustomTargetType(Matcher<google::cloud::deploy::v1::UpdateCustomTargetTypeRequest const&>(_)))
  /// @endcode
  MOCK_METHOD(future<StatusOr<google::cloud::deploy::v1::CustomTargetType>>,
  ...
  /// using ::testing::_;
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock, UpdateCustomTargetType(Matcher<google::longrunning::Operation const&>(_)))
  /// @endcode
  MOCK_METHOD(future<StatusOr<google::cloud::deploy::v1::CustomTargetType>>,
  UpdateCustomTargetType, (
    google::longrunning::Operation const& operation), (override));
  ...
  /// using ::testing::_;
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock, DeleteCustomTargetType(Matcher<google::cloud::deploy::v1::DeleteCustomTargetTypeRequest const&>(_)))
  /// @endcode
  MOCK_METHOD(future<StatusOr<google::cloud::deploy::v1::OperationMetadata>>,
  ...
  /// using ::testing::_;
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock, DeleteCustomTargetType(Matcher<google::longrunning::Operation const&>(_)))
  /// @endcode
  MOCK_METHOD(future<StatusOr<google::cloud::deploy::v1::OperationMetadata>>,
  DeleteCustomTargetType, (
    google::longrunning::Operation const& operation), (override));

  MOCK_METHOD((StreamRange<google::cloud::deploy::v1::Release>),
  ListReleases,
  (google::cloud::deploy::v1::ListReleasesRequest request), (override));

  MOCK_METHOD(StatusOr<google::cloud::deploy::v1::Release>,
  GetRelease,
  ...
  /// using ::testing::_;
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock, CreateRelease(Matcher<google::cloud::deploy::v1::CreateReleaseRequest const&>(_)))
  /// @endcode
  ...
  /// using ::testing::_;
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock, CreateDeployPolicy(Matcher<google::cloud::deploy::v1::CreateDeployPolicyRequest const&>(_)))
  /// @endcode
  ...
  /// using ::testing::_;
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock, CreateDeployPolicy(Matcher<google::longrunning::Operation const&>(_)))
  /// @endcode
  MOCK_METHOD(future<StatusOr<google::cloud::deploy::v1::DeployPolicy>>,
  CreateDeployPolicy, (
    google::longrunning::Operation const& operation), (override));
  ...
  /// using ::testing::_;
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock, UpdateDeployPolicy(Matcher<google::cloud::deploy::v1::UpdateDeployPolicyRequest const&>(_)))
  /// @endcode
  MOCK_METHOD(future<StatusOr<google::cloud::deploy::v1::DeployPolicy>>,
  UpdateDeployPolicy,
  ...
  /// using ::testing::_;
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock, UpdateDeployPolicy(Matcher<google::longrunning::Operation const&>(_)))
  /// @endcode
  MOCK_METHOD(future<StatusOr<google::cloud::deploy::v1::DeployPolicy>>,
  UpdateDeployPolicy, (
    google::longrunning::Operation const& operation), (override));
  ...
  /// using ::testing::_;
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock, DeleteDeployPolicy(Matcher<google::cloud::deploy::v1::DeleteDeployPolicyRequest const&>(_)))
  /// @endcode
  MOCK_METHOD(future<StatusOr<google::cloud::deploy::v1::OperationMetadata>>,
  DeleteDeployPolicy,
  ...
  /// using ::testing::_;
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock, DeleteDeployPolicy(Matcher<google::longrunning::Operation const&>(_)))
  /// @endcode
  MOCK_METHOD(future<StatusOr<google::cloud::deploy::v1::OperationMetadata>>,
  DeleteDeployPolicy, (
    google::longrunning::Operation const& operation), (override));
  ...
  MOCK_METHOD(StatusOr<google::cloud::deploy::v1::DeployPolicy>,
  GetDeployPolicy,
  ...
  MOCK_METHOD((StreamRange<google::cloud::deploy::v1::Rollout>),
  ListRollouts,
  (google::cloud::deploy::v1::ListRolloutsRequest request), (override));

  MOCK_METHOD(StatusOr<google::cloud::deploy::v1::Rollout>,
  GetRollout,
  ...
  /// using ::testing::_;
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock, CreateRollout(Matcher<google::cloud::deploy::v1::CreateRolloutRequest const&>(_)))
  /// @endcode
  ...
  /// using ::testing::_;
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock, CreateRollout(Matcher<google::longrunning::Operation const&>(_)))
  /// @endcode
  MOCK_METHOD(future<StatusOr<google::cloud::deploy::v1::Rollout>>,
  CreateRollout, (
    google::longrunning::Operation const& operation), (override));
  ...
  MOCK_METHOD(StatusOr<google::cloud::deploy::v1::RetryJobResponse>,
  RetryJob,
  (google::cloud::deploy::v1::RetryJobRequest const& request), (override));

  MOCK_METHOD((StreamRange<google::cloud::deploy::v1::JobRun>),
  ListJobRuns,
  (google::cloud::deploy::v1::ListJobRunsRequest request), (override));

  MOCK_METHOD(StatusOr<google::cloud::deploy::v1::JobRun>,
  GetJobRun,
  (google::cloud::deploy::v1::GetJobRunRequest const& request), (override));

  MOCK_METHOD(StatusOr<google::cloud::deploy::v1::TerminateJobRunResponse>,
  TerminateJobRun,
  (google::cloud::deploy::v1::TerminateJobRunRequest const& request), (override));

  MOCK_METHOD(StatusOr<google::cloud::deploy::v1::Config>,
  GetConfig,
  ...
  /// using ::testing::_;
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock, CreateAutomation(Matcher<google::cloud::deploy::v1::CreateAutomationRequest const&>(_)))
  /// @endcode
  ...
  /// using ::testing::_;
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock, CreateAutomation(Matcher<google::longrunning::Operation const&>(_)))
  /// @endcode
  MOCK_METHOD(future<StatusOr<google::cloud::deploy::v1::Automation>>,
  CreateAutomation, (
    google::longrunning::Operation const& operation), (override));
  ...
  /// using ::testing::_;
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock, UpdateAutomation(Matcher<google::cloud::deploy::v1::UpdateAutomationRequest const&>(_)))
  /// @endcode
  MOCK_METHOD(future<StatusOr<google::cloud::deploy::v1::Automation>>,
  UpdateAutomation,
  ...
  /// using ::testing::_;
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock, UpdateAutomation(Matcher<google::longrunning::Operation const&>(_)))
  /// @endcode
  MOCK_METHOD(future<StatusOr<google::cloud::deploy::v1::Automation>>,
  UpdateAutomation, (
    google::longrunning::Operation const& operation), (override));
  ...
  /// using ::testing::_;
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock, DeleteAutomation(Matcher<google::cloud::deploy::v1::DeleteAutomationRequest const&>(_)))
  /// @endcode
  MOCK_METHOD(future<StatusOr<google::cloud::deploy::v1::OperationMetadata>>,
  DeleteAutomation,
  ...
  /// using ::testing::_;
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock, DeleteAutomation(Matcher<google::longrunning::Operation const&>(_)))
  /// @endcode
  MOCK_METHOD(future<StatusOr<google::cloud::deploy::v1::OperationMetadata>>,
  DeleteAutomation, (
    google::longrunning::Operation const& operation), (override));

  MOCK_METHOD(StatusOr<google::cloud::deploy::v1::Automation>,
  GetAutomation,
  ...
  MOCK_METHOD(StatusOr<google::cloud::deploy::v1::AutomationRun>,
  GetAutomationRun,
  ...
  MOCK_METHOD(StatusOr<google::cloud::deploy::v1::CancelAutomationRunResponse>,
  CancelAutomationRun,
