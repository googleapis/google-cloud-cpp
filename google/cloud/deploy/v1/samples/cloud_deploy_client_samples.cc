...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::deploy_v1::CloudDeployClient(
...
class CustomIdempotencyPolicy
   : public google::cloud::deploy_v1::CloudDeployConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::deploy_v1::CloudDeployConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::deploy_v1::CloudDeployConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::deploy_v1::CloudDeployRetryPolicyOption>(
      google::cloud::deploy_v1::CloudDeployLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::deploy_v1::CloudDeployBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::deploy_v1::MakeCloudDeployConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::deploy_v1::CloudDeployClient(connection);
  auto c2 = google::cloud::deploy_v1::CloudDeployClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::deploy_v1::CloudDeployClient(
    connection, google::cloud::Options{}.set<google::cloud::deploy_v1::CloudDeployRetryPolicyOption>(
      google::cloud::deploy_v1::CloudDeployLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::deploy_v1::CloudDeployRetryPolicyOption>(
  //       google::cloud::deploy_v1::CloudDeployLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::deploy_v1::CloudDeployPollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::deploy_v1::CloudDeployRetryPolicyOption::Type,
            google::cloud::deploy_v1::CloudDeployBackoffPolicyOption::Type>(
            google::cloud::deploy_v1::CloudDeployLimitedTimeRetryPolicy(
