...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::deploy_v1::CloudDeployClient(
      google::cloud::deploy_v1::MakeCloudDeployConnection(ud_options));
...
class CustomIdempotencyPolicy
 ...
 public:
  ...
  std::unique_ptr<
      google::cloud::deploy_v1::CloudDeployConnectionIdempotencyPolicy>
      ...
      google::cloud::Options{}
          .set<google::cloud::deploy_v1::CloudDeployPollingPolicyOption>(
              google::cloud::GenericPollingPolicy<
                  ...
                  google::cloud::deploy_v1::CloudDeployBackoffPolicyOption::
                      Type>(
                  google::cloud::deploy_v1::CloudDeployLimitedTimeRetryPolicy(
