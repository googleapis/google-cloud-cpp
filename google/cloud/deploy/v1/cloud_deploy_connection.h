...
/**
 * A retry policy for `CloudDeployConnection` that stops retrying after a
...
class CloudDeployLimitedErrorCountRetryPolicy : public CloudDeployRetryPolicy {
 public:
  CloudDeployLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `CloudDeployConnection` that stops retrying after
