...
std::shared_ptr<CloudDeployStub> CreateDefaultCloudDeployStub(
  ...
  auto endpoint = internal::DetermineServiceEndpoint(
      internal::GetEnv("GOOGLE_CLOUD_CPP_CLOUD_DEPLOY_ENDPOINT"),
      std::move(endpoint_option), "clouddeploy.googleapis.com", options);
  ...
  if (!endpoint.ok()) {
    ...
    stub = std::make_shared<DefaultCloudDeployStub>(
