...
/**
 * A retry policy for `BatchServiceConnection` that stops retrying after a
...
class BatchServiceLimitedErrorCountRetryPolicy
 ...
 public:
  BatchServiceLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `BatchServiceConnection` that stops retrying after
