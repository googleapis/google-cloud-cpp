...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_BATCH_INTERNAL_BATCH_TRACING_CONNECTION_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_BATCH_INTERNAL_BATCH_TRACING_CONNECTION_H
...
class BatchServiceTracingConnection : public batch::BatchServiceConnection {
 public:
 ...
 private:
  std::shared_ptr<batch::BatchServiceConnection> child_;
};
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_BATCH_INTERNAL_BATCH_TRACING_CONNECTION_H
