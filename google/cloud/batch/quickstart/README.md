# HOWTO: using the Batch API C++ client in your project

This directory contains small examples showing how to use the Batch API C++
...
Like most Google Cloud Platform (GCP) services, Batch API requires that
...
1. Install the dependencies with your favorite tools. As an example, if you use
   ...
   ```bash
   cd $HOME/vcpkg
   ./vcpkg install google-cloud-cpp[core,batch]
   ```
...
1. Configure CMake, if necessary, configure the directory where you installed
   ...
   ```bash
   cd $HOME/gooogle-cloud-cpp/google/cloud/batch/quickstart
...
[quickstart-link]: https://cloud.google.com/batch/docs/get-started
