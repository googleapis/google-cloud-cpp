...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_IAM_V3_INTERNAL_POLICY_BINDINGS_AUTH_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_IAM_V3_INTERNAL_POLICY_BINDINGS_AUTH_DECORATOR_H
...
class PolicyBindingsAuth : public PolicyBindingsStub {
 public:
  ~PolicyBindingsAuth() override = default;
  PolicyBindingsAuth(
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_IAM_V3_INTERNAL_POLICY_BINDINGS_AUTH_DECORATOR_H
