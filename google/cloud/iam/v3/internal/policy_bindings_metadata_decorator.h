...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_IAM_V3_INTERNAL_POLICY_BINDINGS_METADATA_DECORATOR_H
...
class PolicyBindingsMetadata : public PolicyBindingsStub {
 public:
  ~PolicyBindingsMetadata() override = default;
  PolicyBindingsMetadata(std::shared_ptr<PolicyBindingsStub> child,
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_IAM_V3_INTERNAL_POLICY_BINDINGS_METADATA_DECORATOR_H
