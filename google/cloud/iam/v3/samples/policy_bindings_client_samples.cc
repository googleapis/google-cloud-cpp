...
// clang-format off
// main-dox-marker: iam_v3::PolicyBindingsClient
// lro-marker: true
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::iam_v3::PolicyBindingsClient(
...
class CustomIdempotencyPolicy
   : public google::cloud::iam_v3::PolicyBindingsConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::iam_v3::PolicyBindingsConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::iam_v3::PolicyBindingsConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::iam_v3::PolicyBindingsRetryPolicyOption>(
      google::cloud::iam_v3::PolicyBindingsLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::iam_v3::PolicyBindingsBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::iam_v3::MakePolicyBindingsConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::iam_v3::PolicyBindingsClient(connection);
  auto c2 = google::cloud::iam_v3::PolicyBindingsClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::iam_v3::PolicyBindingsClient(
    connection, google::cloud::Options{}.set<google::cloud::iam_v3::PolicyBindingsRetryPolicyOption>(
      google::cloud::iam_v3::PolicyBindingsLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::iam_v3::PolicyBindingsRetryPolicyOption>(
  //       google::cloud::iam_v3::PolicyBindingsLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::iam_v3::PolicyBindingsPollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::iam_v3::PolicyBindingsRetryPolicyOption::Type,
            google::cloud::iam_v3::PolicyBindingsBackoffPolicyOption::Type>(
            google::cloud::iam_v3::PolicyBindingsLimitedTimeRetryPolicy(
