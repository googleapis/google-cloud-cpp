...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client =
      google::cloud::iam_v3::PrincipalAccessBoundaryPoliciesClient(
          google::cloud::iam_v3::MakePrincipalAccessBoundaryPoliciesConnection(
              options));
  //! [set-client-endpoint]
}
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::iam_v3::PrincipalAccessBoundaryPoliciesClient(
      google::cloud::iam_v3::MakePrincipalAccessBoundaryPoliciesConnection(
          *ud_options));
  //! [set-client-universe-domain]
}
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options =
      google::cloud::Options{}
          ...
          .set<google::cloud::iam_v3::
                   PrincipalAccessBoundaryPoliciesRetryPolicyOption>(
              google::cloud::iam_v3::
                  PrincipalAccessBoundaryPoliciesLimitedErrorCountRetryPolicy(3)
                      .clone())
          .set<google::cloud::iam_v3::
  ...
  auto c1 =
      google::cloud::iam_v3::PrincipalAccessBoundaryPoliciesClient(connection);
  auto c2 =
      google::cloud::iam_v3::PrincipalAccessBoundaryPoliciesClient(connection);
      ...
      google::cloud::Options{}
          .set<google::cloud::iam_v3::
              ...
              google::cloud::GenericPollingPolicy<
                  google::cloud::iam_v3::
                      PrincipalAccessBoundaryPoliciesRetryPolicyOption::Type,
                  google::cloud::iam_v3::
                      PrincipalAccessBoundaryPoliciesBackoffPolicyOption::Type>(
                  google::cloud::iam_v3::
                      PrincipalAccessBoundaryPoliciesLimitedTimeRetryPolicy(
