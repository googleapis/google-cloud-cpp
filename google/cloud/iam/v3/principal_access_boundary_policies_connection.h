...
#include "google/iam/v3/principal_access_boundary_policies_service.pb.h"
...
class PrincipalAccessBoundaryPoliciesConnection {
 public:
  virtual ~PrincipalAccessBoundaryPoliciesConnection() = 0;
 ...
 * - `google::cloud::iam_v3::PrincipalAccessBoundaryPoliciesPolicyOptionList`
 *
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_IAM_V3_PRINCIPAL_ACCESS_BOUNDARY_POLICIES_CONNECTION_H
