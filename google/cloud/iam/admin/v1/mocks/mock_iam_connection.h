...
class MockIAMConnection : public iam_admin_v1::IAMConnection {
 public:
  ...
  MOCK_METHOD(StatusOr<google::iam::admin::v1::UndeleteServiceAccountResponse>,
  ...
  MOCK_METHOD(StatusOr<google::iam::admin::v1::ListServiceAccountKeysResponse>,
  ListServiceAccountKeys,
  (google::iam::admin::v1::ListServiceAccountKeysRequest const& request), (override));

  MOCK_METHOD(StatusOr<google::iam::admin::v1::ServiceAccountKey>,
  ...
  MOCK_METHOD((StreamRange<google::iam::admin::v1::Role>),
  QueryGrantableRoles,
  ...
  MOCK_METHOD(StatusOr<google::iam::admin::v1::Role>,
  GetRole,
  ...
  MOCK_METHOD(StatusOr<google::iam::admin::v1::QueryAuditableServicesResponse>,
