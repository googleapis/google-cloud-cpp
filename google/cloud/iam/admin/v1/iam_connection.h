...
/**
 * A retry policy for `IAMConnection` that stops retrying after a
...
class IAMLimitedErrorCountRetryPolicy : public IAMRetryPolicy {
 public:
  IAMLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `IAMConnection` that stops retrying after
