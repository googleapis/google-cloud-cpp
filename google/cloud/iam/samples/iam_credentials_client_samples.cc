...
// main-dox-marker: GOOGLE_CLOUD_CPP_NS::IAMCredentialsClient
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::GOOGLE_CLOUD_CPP_NS::IAMCredentialsClient(
      google::cloud::GOOGLE_CLOUD_CPP_NS::MakeIAMCredentialsConnection(
          options));
  //! [set-client-endpoint]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::GOOGLE_CLOUD_CPP_NS::IAMCredentialsClient(
        google::cloud::GOOGLE_CLOUD_CPP_NS::MakeIAMCredentialsConnection(
            options));
  }
  //! [with-service-account]
