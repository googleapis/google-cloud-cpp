...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_IAM_INTERNAL_IAM_TRACING_CONNECTION_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_IAM_INTERNAL_IAM_TRACING_CONNECTION_H
...
class IAMTracingConnection : public iam::IAMConnection {
 public:
  ~IAMTracingConnection() override = default;

  explicit IAMTracingConnection(std::shared_ptr<iam::IAMConnection> child);
 ...
 private:
  std::shared_ptr<iam::IAMConnection> child_;
};
 ...
 */
std::shared_ptr<iam::IAMConnection> MakeIAMTracingConnection(
    std::shared_ptr<iam::IAMConnection> conn);
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_IAM_INTERNAL_IAM_TRACING_CONNECTION_H
