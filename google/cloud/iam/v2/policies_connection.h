...
/**
 * A retry policy for `PoliciesConnection` that stops retrying after a
...
class PoliciesLimitedErrorCountRetryPolicy : public PoliciesRetryPolicy {
 public:
  PoliciesLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `PoliciesConnection` that stops retrying after
