...
// clang-format off
// main-dox-marker: iam_v2::PoliciesClient
// lro-marker: true
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::iam_v2::PoliciesClient(
...
class CustomIdempotencyPolicy
 ...
 public:
  ...
  std::unique_ptr<google::cloud::iam_v2::PoliciesConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::iam_v2::PoliciesConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::iam_v2::PoliciesRetryPolicyOption>(
      google::cloud::iam_v2::PoliciesLimitedErrorCountRetryPolicy(3).clone())
  ...
  auto c3 = google::cloud::iam_v2::PoliciesClient(
    connection, google::cloud::Options{}.set<google::cloud::iam_v2::PoliciesRetryPolicyOption>(
      google::cloud::iam_v2::PoliciesLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::iam_v2::PoliciesPollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::iam_v2::PoliciesRetryPolicyOption::Type,
            google::cloud::iam_v2::PoliciesBackoffPolicyOption::Type>(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::iam_v2::PoliciesClient(
      google::cloud::iam_v2::MakePoliciesConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
