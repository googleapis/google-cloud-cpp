...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_IAM_MOCKS_MOCK_IAM_POLICY_CONNECTION_H
 ...
 * including errors from a `IAMPolicyClient`. To do so, construct a
 * `IAMPolicyClient` with an instance of this class. Then use the Google
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_IAM_MOCKS_MOCK_IAM_POLICY_CONNECTION_H
