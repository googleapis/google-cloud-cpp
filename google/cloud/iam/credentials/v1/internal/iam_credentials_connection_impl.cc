...
retry_policy(Options const& options) {
  return options.get<iam_credentials_v1::IAMCredentialsRetryPolicyOption>()->clone();
}

std::unique_ptr<BackoffPolicy>
backoff_policy(Options const& options) {
  return options.get<iam_credentials_v1::IAMCredentialsBackoffPolicyOption>()->clone();
}

std::unique_ptr<iam_credentials_v1::IAMCredentialsConnectionIdempotencyPolicy>
idempotency_policy(Options const& options) {
  return options.get<iam_credentials_v1::IAMCredentialsConnectionIdempotencyPolicyOption>()->clone();
}
