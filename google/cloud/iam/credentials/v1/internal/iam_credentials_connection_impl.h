...
class IAMCredentialsConnectionImpl
 ...
 private:
  ...
  std::shared_ptr<iam_credentials_v1_internal::IAMCredentialsStub> stub_;
  Options options_;
};
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_IAM_CREDENTIALS_V1_INTERNAL_IAM_CREDENTIALS_CONNECTION_IMPL_H
