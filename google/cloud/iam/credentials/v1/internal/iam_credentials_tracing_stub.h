...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_IAM_CREDENTIALS_V1_INTERNAL_IAM_CREDENTIALS_TRACING_STUB_H
...
class IAMCredentialsTracingStub : public IAMCredentialsStub {
 public:
  ~IAMCredentialsTracingStub() override = default;
 ...
 * OpenTelemetry.
 */
std::shared_ptr<IAMCredentialsStub> MakeIAMCredentialsTracingStub(
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_IAM_CREDENTIALS_V1_INTERNAL_IAM_CREDENTIALS_TRACING_STUB_H
