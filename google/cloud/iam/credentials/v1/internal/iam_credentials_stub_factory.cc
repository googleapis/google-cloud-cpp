...
std::shared_ptr<IAMCredentialsStub> CreateDefaultIAMCredentialsStub(
  ...
  auto endpoint = internal::DetermineServiceEndpoint(
      internal::GetEnv("GOOGLE_CLOUD_CPP_IAM_CREDENTIALS_ENDPOINT"),
      std::move(endpoint_option), "iamcredentials.googleapis.com", options);
  ...
  if (!endpoint.ok()) {
    ...
    stub = std::make_shared<DefaultIAMCredentialsStub>(
  ...
  if (internal::TracingEnabled(options)) {
    stub = MakeIAMCredentialsTracingStub(std::move(stub));
  }
  return stub;
}
