...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::iam_v1::IAMPolicyClient(
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::iam_v1::IAMPolicyClient(
      google::cloud::iam_v1::MakeIAMPolicyConnection(*ud_options));
  //! [set-client-universe-domain]
}
