...
class NotebookServiceStub {
 public:
  ...
  virtual StatusOr<google::cloud::notebooks::v2::ListInstancesResponse> ListInstances(
  ...
  virtual StatusOr<google::cloud::notebooks::v2::CheckInstanceUpgradabilityResponse> CheckInstanceUpgradability(
      grpc::ClientContext& context,
      Options const& options,
      google::cloud::notebooks::v2::CheckInstanceUpgradabilityRequest const& request) = 0;
...
class DefaultNotebookServiceStub : public NotebookServiceStub {
 public:
  DefaultNotebookServiceStub(
      std::unique_ptr<google::cloud::notebooks::v2::NotebookService::StubInterface> grpc_stub,
 ...
 private:
  std::unique_ptr<google::cloud::notebooks::v2::NotebookService::StubInterface> grpc_stub_;
