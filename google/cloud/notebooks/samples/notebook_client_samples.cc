...
// main-dox-marker: GOOGLE_CLOUD_CPP_NS::NotebookServiceClient
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::GOOGLE_CLOUD_CPP_NS::NotebookServiceClient(
      google::cloud::GOOGLE_CLOUD_CPP_NS::MakeNotebookServiceConnection(
          options));
  //! [set-client-endpoint]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::GOOGLE_CLOUD_CPP_NS::NotebookServiceClient(
        google::cloud::GOOGLE_CLOUD_CPP_NS::MakeNotebookServiceConnection(
            options));
  }
  //! [with-service-account]
