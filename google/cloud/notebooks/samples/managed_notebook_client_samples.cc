...
// main-dox-marker: GOOGLE_CLOUD_CPP_NS::ManagedNotebookServiceClient
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client =
      google::cloud::GOOGLE_CLOUD_CPP_NS::ManagedNotebookServiceClient(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::GOOGLE_CLOUD_CPP_NS::ManagedNotebookServiceClient(
        google::cloud::GOOGLE_CLOUD_CPP_NS::
            MakeManagedNotebookServiceConnection(options));
  }
  //! [with-service-account]
