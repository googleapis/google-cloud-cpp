...
namespace {
class NotebookServiceConnectionImpl : public NotebookServiceConnection {
 public:
  NotebookServiceConnectionImpl(
      ...
      : background_(std::move(background)),
        ...
        retry_policy_prototype_(
            options.get<NotebookServiceRetryPolicyOption>()->clone()),
        backoff_policy_prototype_(
            options.get<NotebookServiceBackoffPolicyOption>()->clone()),
        polling_policy_prototype_(
            options.get<NotebookServicePollingPolicyOption>()->clone()),
        idempotency_policy_(
            options.get<NotebookServiceConnectionIdempotencyPolicyOption>()
                ->clone()) {}
...
std::shared_ptr<NotebookServiceConnection> MakeNotebookServiceConnection(
  ...
  return std::make_shared<NotebookServiceConnectionImpl>(
...
MakeNotebookServiceConnection(std::shared_ptr<NotebookServiceStub> stub,
  ...
  return std::make_shared<notebooks::NotebookServiceConnectionImpl>(
