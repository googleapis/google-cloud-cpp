...
/**
 * A retry policy for `NotebookServiceConnection` that stops retrying after a
...
class NotebookServiceLimitedErrorCountRetryPolicy
 ...
 public:
  NotebookServiceLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `NotebookServiceConnection` that stops retrying after
