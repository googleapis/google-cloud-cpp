...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::notebooks_v1::ManagedNotebookServiceClient(
      google::cloud::notebooks_v1::MakeManagedNotebookServiceConnection(options));
  //! [set-client-endpoint]
}

//! [custom-idempotency-policy]
class CustomIdempotencyPolicy
   : public google::cloud::notebooks_v1::ManagedNotebookServiceConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::notebooks_v1::ManagedNotebookServiceConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::notebooks_v1::ManagedNotebookServiceConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::notebooks_v1::ManagedNotebookServiceRetryPolicyOption>(
      google::cloud::notebooks_v1::ManagedNotebookServiceLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::notebooks_v1::ManagedNotebookServiceBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::notebooks_v1::MakeManagedNotebookServiceConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::notebooks_v1::ManagedNotebookServiceClient(connection);
  auto c2 = google::cloud::notebooks_v1::ManagedNotebookServiceClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::notebooks_v1::ManagedNotebookServiceClient(
    connection, google::cloud::Options{}.set<google::cloud::notebooks_v1::ManagedNotebookServiceRetryPolicyOption>(
      google::cloud::notebooks_v1::ManagedNotebookServiceLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::notebooks_v1::ManagedNotebookServicePollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::notebooks_v1::ManagedNotebookServiceRetryPolicyOption::Type,
            google::cloud::notebooks_v1::ManagedNotebookServiceBackoffPolicyOption::Type>(
            google::cloud::notebooks_v1::ManagedNotebookServiceLimitedTimeRetryPolicy(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::notebooks_v1::ManagedNotebookServiceClient(
      google::cloud::notebooks_v1::MakeManagedNotebookServiceConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
