...
// clang-format off
// main-dox-marker: notebooks_v1::NotebookServiceClient
// lro-marker: true
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::notebooks_v1::NotebookServiceClient(
...
class CustomIdempotencyPolicy
   : public google::cloud::notebooks_v1::NotebookServiceConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::notebooks_v1::NotebookServiceConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::notebooks_v1::NotebookServiceConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::notebooks_v1::NotebookServiceRetryPolicyOption>(
      google::cloud::notebooks_v1::NotebookServiceLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::notebooks_v1::NotebookServiceBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::notebooks_v1::MakeNotebookServiceConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::notebooks_v1::NotebookServiceClient(connection);
  auto c2 = google::cloud::notebooks_v1::NotebookServiceClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::notebooks_v1::NotebookServiceClient(
    connection, google::cloud::Options{}.set<google::cloud::notebooks_v1::NotebookServiceRetryPolicyOption>(
      google::cloud::notebooks_v1::NotebookServiceLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::notebooks_v1::NotebookServiceRetryPolicyOption>(
  //       google::cloud::notebooks_v1::NotebookServiceLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::notebooks_v1::NotebookServicePollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::notebooks_v1::NotebookServiceRetryPolicyOption::Type,
            google::cloud::notebooks_v1::NotebookServiceBackoffPolicyOption::Type>(
            google::cloud::notebooks_v1::NotebookServiceLimitedTimeRetryPolicy(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::notebooks_v1::NotebookServiceClient(
      google::cloud::notebooks_v1::MakeNotebookServiceConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
