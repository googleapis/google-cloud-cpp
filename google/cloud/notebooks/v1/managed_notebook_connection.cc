...
StreamRange<google::cloud::notebooks::v1::Runtime> ManagedNotebookServiceConnection::ListRuntimes(
    google::cloud::notebooks::v1::ListRuntimesRequest) {  // NOLINT(performance-unnecessary-value-param)
...
StreamRange<google::cloud::location::Location> ManagedNotebookServiceConnection::ListLocations(
...
StreamRange<google::longrunning::Operation> ManagedNotebookServiceConnection::ListOperations(
...
Status
ManagedNotebookServiceConnection::DeleteOperation(
    google::longrunning::DeleteOperationRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

Status
ManagedNotebookServiceConnection::CancelOperation(
...
std::shared_ptr<ManagedNotebookServiceConnection> MakeManagedNotebookServiceConnection(
  ...
  internal::CheckExpectedOptions<CommonOptionList, GrpcOptionList,
      ...
      ManagedNotebookServicePolicyOptionList>(options, __func__);
  ...
  return notebooks_v1_internal::MakeManagedNotebookServiceTracingConnection(
      std::make_shared<notebooks_v1_internal::ManagedNotebookServiceConnectionImpl>(
