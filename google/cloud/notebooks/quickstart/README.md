# HOWTO: using the Notebooks API C++ client in your project

This directory contains small examples showing how to use the Notebooks API C++
...
Like most Google Cloud Platform (GCP) services, Notebooks API requires that
...
2. Install the dependencies with your favorite tools. As an example, if you use
   ...
   ```bash
   cd $HOME/vcpkg
   ./vcpkg install google-cloud-cpp[core,notebooks]
   ```
...
3. Configure CMake, if necessary, configure the directory where you installed
   ...
   ```bash
   cd $HOME/gooogle-cloud-cpp/google/cloud/notebooks/quickstart
...
[quickstart-link]: https://cloud.google.com/vertex-ai/docs/workbench/user-managed/quickstart-create-console
