...
inline std::unique_ptr<notebooks::NotebookServiceRetryPolicy> retry_policy() {
  return internal::CurrentOptions()
      .get<notebooks::NotebookServiceRetryPolicyOption>()
      ->clone();
}

inline std::unique_ptr<BackoffPolicy> backoff_policy() {
  return internal::CurrentOptions()
      .get<notebooks::NotebookServiceBackoffPolicyOption>()
      ->clone();
}

inline std::unique_ptr<notebooks::NotebookServiceConnectionIdempotencyPolicy>
idempotency_policy() {
  return internal::CurrentOptions()
...
inline std::unique_ptr<PollingPolicy> polling_policy() {
  return internal::CurrentOptions()
      .get<notebooks::NotebookServicePollingPolicyOption>()
      ->clone();
}
