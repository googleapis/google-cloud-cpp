...
///     types defined in monitoring_metricsscope_v1 instead of the aliases defined in
///     this namespace.
namespace monitoring {
GOOGLE_CLOUD_CPP_INLINE_NAMESPACE_BEGIN

/// @deprecated Use monitoring_metricsscope_v1::MetricsScopesClient directly.
using ::google::cloud::monitoring_metricsscope_v1::MetricsScopesClient;
