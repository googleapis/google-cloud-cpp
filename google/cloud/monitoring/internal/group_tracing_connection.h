...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_MONITORING_INTERNAL_GROUP_TRACING_CONNECTION_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_MONITORING_INTERNAL_GROUP_TRACING_CONNECTION_H
...
class GroupServiceTracingConnection
    : public monitoring::GroupServiceConnection {
 public:
 ...
 private:
  std::shared_ptr<monitoring::GroupServiceConnection> child_;
};
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_MONITORING_INTERNAL_GROUP_TRACING_CONNECTION_H
