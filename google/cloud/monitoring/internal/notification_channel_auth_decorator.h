...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_MONITORING_INTERNAL_NOTIFICATION_CHANNEL_AUTH_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_MONITORING_INTERNAL_NOTIFICATION_CHANNEL_AUTH_DECORATOR_H
...
class NotificationChannelServiceAuth : public NotificationChannelServiceStub {
 public:
  ~NotificationChannelServiceAuth() override = default;
  NotificationChannelServiceAuth(
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_MONITORING_INTERNAL_NOTIFICATION_CHANNEL_AUTH_DECORATOR_H
