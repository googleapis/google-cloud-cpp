...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_MONITORING_INTERNAL_DASHBOARDS_AUTH_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_MONITORING_INTERNAL_DASHBOARDS_AUTH_DECORATOR_H
...
class DashboardsServiceAuth : public DashboardsServiceStub {
 public:
  ~DashboardsServiceAuth() override = default;
  DashboardsServiceAuth(
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_MONITORING_INTERNAL_DASHBOARDS_AUTH_DECORATOR_H
