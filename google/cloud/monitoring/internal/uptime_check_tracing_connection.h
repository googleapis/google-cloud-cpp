...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_MONITORING_INTERNAL_UPTIME_CHECK_TRACING_CONNECTION_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_MONITORING_INTERNAL_UPTIME_CHECK_TRACING_CONNECTION_H
...
class UptimeCheckServiceTracingConnection
 ...
 private:
  std::shared_ptr<monitoring::UptimeCheckServiceConnection> child_;
};
...
MakeUptimeCheckServiceTracingConnection(
    std::shared_ptr<monitoring::UptimeCheckServiceConnection> conn);
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_MONITORING_INTERNAL_UPTIME_CHECK_TRACING_CONNECTION_H
