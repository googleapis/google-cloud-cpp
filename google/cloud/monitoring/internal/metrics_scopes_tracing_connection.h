...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_MONITORING_INTERNAL_METRICS_SCOPES_TRACING_CONNECTION_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_MONITORING_INTERNAL_METRICS_SCOPES_TRACING_CONNECTION_H
...
class MetricsScopesTracingConnection
    : public monitoring::MetricsScopesConnection {
 public:
 ...
 private:
  std::shared_ptr<monitoring::MetricsScopesConnection> child_;
};
...
MakeMetricsScopesTracingConnection(
    std::shared_ptr<monitoring::MetricsScopesConnection> conn);
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_MONITORING_INTERNAL_METRICS_SCOPES_TRACING_CONNECTION_H
