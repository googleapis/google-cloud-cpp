...
retry_policy(Options const& options) {
  return options.get<monitoring_dashboard_v1::DashboardsServiceRetryPolicyOption>()->clone();
}

std::unique_ptr<BackoffPolicy>
backoff_policy(Options const& options) {
  return options.get<monitoring_dashboard_v1::DashboardsServiceBackoffPolicyOption>()->clone();
}

std::unique_ptr<monitoring_dashboard_v1::DashboardsServiceConnectionIdempotencyPolicy>
idempotency_policy(Options const& options) {
  return options.get<monitoring_dashboard_v1::DashboardsServiceConnectionIdempotencyPolicyOption>()->clone();
}
...
DashboardsServiceConnectionImpl::CreateDashboard(google::monitoring::dashboard::v1::CreateDashboardRequest const& request) {
...
DashboardsServiceConnectionImpl::ListDashboards(google::monitoring::dashboard::v1::ListDashboardsRequest request) {
  request.clear_page_token();
  auto current = google::cloud::internal::SaveCurrentOptions();
  auto idempotency = idempotency_policy(*current)->ListDashboards(request);
  char const* function_name = __func__;
  return google::cloud::internal::MakePaginationRange<StreamRange<google::monitoring::dashboard::v1::Dashboard>>(
      current, std::move(request),
      [idempotency, function_name, stub = stub_,
       retry = std::shared_ptr<monitoring_dashboard_v1::DashboardsServiceRetryPolicy>(retry_policy(*current)),
       backoff = std::shared_ptr<BackoffPolicy>(backoff_policy(*current))](
          Options const& options, google::monitoring::dashboard::v1::ListDashboardsRequest const& r) {
        return google::cloud::internal::RetryLoop(
      ...
      [](google::monitoring::dashboard::v1::ListDashboardsResponse r) {
        std::vector<google::monitoring::dashboard::v1::Dashboard> result(r.dashboards().size());
...
StatusOr<google::monitoring::dashboard::v1::Dashboard>
DashboardsServiceConnectionImpl::GetDashboard(google::monitoring::dashboard::v1::GetDashboardRequest const& request) {
  auto current = google::cloud::internal::SaveCurrentOptions();
  return google::cloud::internal::RetryLoop(
      retry_policy(*current), backoff_policy(*current),
...
Status
DashboardsServiceConnectionImpl::DeleteDashboard(google::monitoring::dashboard::v1::DeleteDashboardRequest const& request) {
  auto current = google::cloud::internal::SaveCurrentOptions();
  return google::cloud::internal::RetryLoop(
      retry_policy(*current), backoff_policy(*current),
...
StatusOr<google::monitoring::dashboard::v1::Dashboard>
DashboardsServiceConnectionImpl::UpdateDashboard(google::monitoring::dashboard::v1::UpdateDashboardRequest const& request) {
  auto current = google::cloud::internal::SaveCurrentOptions();
  return google::cloud::internal::RetryLoop(
      retry_policy(*current), backoff_policy(*current),
