...
/**
 * A retry policy for `DashboardsServiceConnection` that stops retrying after a
...
class DashboardsServiceLimitedErrorCountRetryPolicy
 ...
 public:
  DashboardsServiceLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `DashboardsServiceConnection` that stops retrying after
