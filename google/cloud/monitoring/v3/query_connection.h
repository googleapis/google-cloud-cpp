...
class QueryServiceRetryPolicy : public ::google::cloud::RetryPolicy {
 public:
  ...
  /// handled.
  virtual std::unique_ptr<QueryServiceRetryPolicy> clone() const = 0;
};

/**
 * A retry policy for `QueryServiceConnection` that stops retrying after a
...
class QueryServiceLimitedErrorCountRetryPolicy
 ...
 public:
  QueryServiceLimitedErrorCountRetryPolicy(int maximum_failures)
  ...
  std::unique_ptr<QueryServiceRetryPolicy> clone() const override {
...
/// A retry policy for `QueryServiceConnection` that stops retrying after
