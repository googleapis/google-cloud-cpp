...
Status
ServiceMonitoringServiceMetadata::DeleteService(
    grpc::ClientContext& context,
    Options const& options,
...
ServiceMonitoringServiceMetadata::UpdateServiceLevelObjective(
  ...
  SetMetadata(context, options, absl::StrCat("service_level_objective.name=", internal::UrlEncode(request.service_level_objective().name())));
  return child_->UpdateServiceLevelObjective(context, options, request);
}

Status
ServiceMonitoringServiceMetadata::DeleteServiceLevelObjective(
    grpc::ClientContext& context,
    Options const& options,
