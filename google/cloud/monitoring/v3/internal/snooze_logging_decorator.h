...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_MONITORING_V3_INTERNAL_SNOOZE_LOGGING_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_MONITORING_V3_INTERNAL_SNOOZE_LOGGING_DECORATOR_H
...
class SnoozeServiceLogging : public SnoozeServiceStub {
 public:
  ~SnoozeServiceLogging() override = default;
  SnoozeServiceLogging(std::shared_ptr<SnoozeServiceStub> child,
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_MONITORING_V3_INTERNAL_SNOOZE_LOGGING_DECORATOR_H
