...
std::unique_ptr<monitoring_v3::UptimeCheckServiceRetryPolicy>
retry_policy(Options const& options) {
  return options.get<monitoring_v3::UptimeCheckServiceRetryPolicyOption>()->clone();
}

std::unique_ptr<BackoffPolicy>
backoff_policy(Options const& options) {
  return options.get<monitoring_v3::UptimeCheckServiceBackoffPolicyOption>()->clone();
}

std::unique_ptr<monitoring_v3::UptimeCheckServiceConnectionIdempotencyPolicy>
idempotency_policy(Options const& options) {
  return options.get<monitoring_v3::UptimeCheckServiceConnectionIdempotencyPolicyOption>()->clone();
}
...
UptimeCheckServiceConnectionImpl::ListUptimeCheckConfigs(google::monitoring::v3::ListUptimeCheckConfigsRequest request) {
  request.clear_page_token();
  auto current = google::cloud::internal::SaveCurrentOptions();
  auto idempotency = idempotency_policy(*current)->ListUptimeCheckConfigs(request);
  char const* function_name = __func__;
  return google::cloud::internal::MakePaginationRange<StreamRange<google::monitoring::v3::UptimeCheckConfig>>(
      current, std::move(request),
      [idempotency, function_name, stub = stub_,
       retry = std::shared_ptr<monitoring_v3::UptimeCheckServiceRetryPolicy>(retry_policy(*current)),
       backoff = std::shared_ptr<BackoffPolicy>(backoff_policy(*current))](
          Options const& options, google::monitoring::v3::ListUptimeCheckConfigsRequest const& r) {
      ...
      [](google::monitoring::v3::ListUptimeCheckConfigsResponse r) {
        std::vector<google::monitoring::v3::UptimeCheckConfig> result(r.uptime_check_configs().size());
...
UptimeCheckServiceConnectionImpl::GetUptimeCheckConfig(google::monitoring::v3::GetUptimeCheckConfigRequest const& request) {
  auto current = google::cloud::internal::SaveCurrentOptions();
  return google::cloud::internal::RetryLoop(
...
StatusOr<google::monitoring::v3::UptimeCheckConfig>
UptimeCheckServiceConnectionImpl::CreateUptimeCheckConfig(google::monitoring::v3::CreateUptimeCheckConfigRequest const& request) {
  auto current = google::cloud::internal::SaveCurrentOptions();
  return google::cloud::internal::RetryLoop(
      retry_policy(*current), backoff_policy(*current),
...
StatusOr<google::monitoring::v3::UptimeCheckConfig>
UptimeCheckServiceConnectionImpl::UpdateUptimeCheckConfig(google::monitoring::v3::UpdateUptimeCheckConfigRequest const& request) {
  auto current = google::cloud::internal::SaveCurrentOptions();
  return google::cloud::internal::RetryLoop(
      retry_policy(*current), backoff_policy(*current),
...
Status
UptimeCheckServiceConnectionImpl::DeleteUptimeCheckConfig(google::monitoring::v3::DeleteUptimeCheckConfigRequest const& request) {
  auto current = google::cloud::internal::SaveCurrentOptions();
  return google::cloud::internal::RetryLoop(
      retry_policy(*current), backoff_policy(*current),
...
UptimeCheckServiceConnectionImpl::ListUptimeCheckIps(google::monitoring::v3::ListUptimeCheckIpsRequest request) {
  request.clear_page_token();
  auto current = google::cloud::internal::SaveCurrentOptions();
  auto idempotency = idempotency_policy(*current)->ListUptimeCheckIps(request);
  char const* function_name = __func__;
  return google::cloud::internal::MakePaginationRange<StreamRange<google::monitoring::v3::UptimeCheckIp>>(
      current, std::move(request),
      [idempotency, function_name, stub = stub_,
       retry = std::shared_ptr<monitoring_v3::UptimeCheckServiceRetryPolicy>(retry_policy(*current)),
       backoff = std::shared_ptr<BackoffPolicy>(backoff_policy(*current))](
          Options const& options, google::monitoring::v3::ListUptimeCheckIpsRequest const& r) {
        return google::cloud::internal::RetryLoop(
            retry->clone(), backoff->clone(), idempotency,
            [stub](grpc::ClientContext& context, Options const& options,
      ...
      [](google::monitoring::v3::ListUptimeCheckIpsResponse r) {
        std::vector<google::monitoring::v3::UptimeCheckIp> result(r.uptime_check_ips().size());
