...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_MONITORING_V3_INTERNAL_SERVICE_MONITORING_LOGGING_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_MONITORING_V3_INTERNAL_SERVICE_MONITORING_LOGGING_DECORATOR_H
...
class ServiceMonitoringServiceLogging : public ServiceMonitoringServiceStub {
 public:
  ...
  ServiceMonitoringServiceLogging(std::shared_ptr<ServiceMonitoringServiceStub> child,
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_MONITORING_V3_INTERNAL_SERVICE_MONITORING_LOGGING_DECORATOR_H
