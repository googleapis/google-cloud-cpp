...
Options MetricServiceDefaultOptions(Options options) {
  options = internal::PopulateCommonOptions(
      ...
      "", "GOOGLE_CLOUD_CPP_METRIC_SERVICE_AUTHORITY",
  ...
  if (!options.has<monitoring_v3::MetricServiceConnectionIdempotencyPolicyOption>()) {
    options.set<monitoring_v3::MetricServiceConnectionIdempotencyPolicyOption>(
        monitoring_v3::MakeDefaultMetricServiceConnectionIdempotencyPolicy());
  }
