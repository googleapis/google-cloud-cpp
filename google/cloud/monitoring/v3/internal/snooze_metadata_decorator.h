...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_MONITORING_V3_INTERNAL_SNOOZE_METADATA_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_MONITORING_V3_INTERNAL_SNOOZE_METADATA_DECORATOR_H
...
class SnoozeServiceMetadata : public SnoozeServiceStub {
 public:
  ~SnoozeServiceMetadata() override = default;
  SnoozeServiceMetadata(
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_MONITORING_V3_INTERNAL_SNOOZE_METADATA_DECORATOR_H
