...
/**
 * A retry policy for `MetricServiceConnection` that stops retrying after a
...
class MetricServiceLimitedErrorCountRetryPolicy
 ...
 public:
  MetricServiceLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `MetricServiceConnection` that stops retrying after
/// some wall clock time has elapsed.
class MetricServiceLimitedTimeRetryPolicy : public MetricServiceRetryPolicy {
 public:
  /**
 ...
 *
 * For mocking, see `monitoring_v3_mocks::MockMetricServiceConnection`.
 */
 ...
 * - `google::cloud::monitoring_v3::MetricServicePolicyOptionList`
 *
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_MONITORING_V3_METRIC_CONNECTION_H
