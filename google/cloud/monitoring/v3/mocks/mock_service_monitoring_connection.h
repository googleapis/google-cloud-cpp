 ...
 * including errors, from an object of type `ServiceMonitoringServiceClient`. To do so,
 * construct an object of type `ServiceMonitoringServiceClient` with an instance of this
 ...
 */
class MockServiceMonitoringServiceConnection : public monitoring_v3::ServiceMonitoringServiceConnection {
 public:
  MOCK_METHOD(Options, options, (), (override));

  MOCK_METHOD(StatusOr<google::monitoring::v3::Service>,
  CreateService,
  ...
  MOCK_METHOD((StreamRange<google::monitoring::v3::Service>),
  ListServices,
  ...
  MOCK_METHOD((StreamRange<google::monitoring::v3::ServiceLevelObjective>),
  ListServiceLevelObjectives,
  (google::monitoring::v3::ListServiceLevelObjectivesRequest request), (override));
