...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_MONITORING_V3_MOCKS_MOCK_ALERT_POLICY_CONNECTION_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_MONITORING_V3_MOCKS_MOCK_ALERT_POLICY_CONNECTION_H
 ...
 * including errors, from an object of type `AlertPolicyServiceClient`. To do so,
 * construct an object of type `AlertPolicyServiceClient` with an instance of this
 ...
 */
class MockAlertPolicyServiceConnection : public monitoring_v3::AlertPolicyServiceConnection {
 public:
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_MONITORING_V3_MOCKS_MOCK_ALERT_POLICY_CONNECTION_H
