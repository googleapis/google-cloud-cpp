...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_MONITORING_V3_MOCKS_MOCK_SNOOZE_CONNECTION_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_MONITORING_V3_MOCKS_MOCK_SNOOZE_CONNECTION_H
...
/**
 * A class to mock `SnoozeServiceConnection`.
 *
 * Application developers may want to test their code with simulated responses,
 * including errors, from an object of type `SnoozeServiceClient`. To do so,
 * construct an object of type `SnoozeServiceClient` with an instance of this
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_MONITORING_V3_MOCKS_MOCK_SNOOZE_CONNECTION_H
