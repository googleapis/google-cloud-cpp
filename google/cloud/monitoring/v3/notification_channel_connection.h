...
/**
 * A retry policy for `NotificationChannelServiceConnection` that stops retrying
...
class NotificationChannelServiceLimitedErrorCountRetryPolicy
 ...
 public:
  NotificationChannelServiceLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `NotificationChannelServiceConnection` that stops
 ...
 * - `google::cloud::monitoring_v3::NotificationChannelServicePolicyOptionList`
 *
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_MONITORING_V3_NOTIFICATION_CHANNEL_CONNECTION_H
