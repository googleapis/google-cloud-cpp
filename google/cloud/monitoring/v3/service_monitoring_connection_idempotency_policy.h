...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_MONITORING_V3_SERVICE_MONITORING_CONNECTION_IDEMPOTENCY_POLICY_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_MONITORING_V3_SERVICE_MONITORING_CONNECTION_IDEMPOTENCY_POLICY_H
...
class ServiceMonitoringServiceConnectionIdempotencyPolicy {
 public:
  ...
  virtual std::unique_ptr<ServiceMonitoringServiceConnectionIdempotencyPolicy> clone() const;
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_MONITORING_V3_SERVICE_MONITORING_CONNECTION_IDEMPOTENCY_POLICY_H
