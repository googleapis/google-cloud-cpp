...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_MONITORING_V3_GROUP_CONNECTION_IDEMPOTENCY_POLICY_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_MONITORING_V3_GROUP_CONNECTION_IDEMPOTENCY_POLICY_H
...
class GroupServiceConnectionIdempotencyPolicy {
 public:
  ...
  virtual std::unique_ptr<GroupServiceConnectionIdempotencyPolicy> clone() const;
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_MONITORING_V3_GROUP_CONNECTION_IDEMPOTENCY_POLICY_H
