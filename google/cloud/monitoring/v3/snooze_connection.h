...
/**
 * A retry policy for `SnoozeServiceConnection` based on elapsed time.
 *
 * This policy stops retrying if:
 * - An RPC returns a non-transient error.
 ...
 * - [`kUnavailable`](@ref google::cloud::StatusCode)
 */
class SnoozeServiceLimitedTimeRetryPolicy : public SnoozeServiceRetryPolicy {
 public:
  /**
...
/**
 * The `SnoozeServiceConnection` object for `SnoozeServiceClient`.
 *
 * This interface defines virtual methods for each of the user-facing overload
 * sets in `SnoozeServiceClient`. This allows users to inject custom behavior
 ...
 */
class SnoozeServiceConnection {
 public:
  virtual ~SnoozeServiceConnection() = 0;
 ...
 * should be passed as an argument to the constructor of SnoozeServiceClient.
 *
 * The optional @p options argument may be used to configure aspects of the
 * returned `SnoozeServiceConnection`. Expected options are any of the types in
 * the following option lists:
 *
 * - `google::cloud::CommonOptionList`
 * - `google::cloud::GrpcOptionList`
 * - `google::cloud::UnifiedCredentialsOptionList`
 * - `google::cloud::monitoring_v3::SnoozeServicePolicyOptionList`
 *
 * @note Unexpected options will be ignored. To log unexpected options instead,
 *     set `GOOGLE_CLOUD_CPP_ENABLE_CLOG=yes` in the environment.
 *
 * @param options (optional) Configure the `SnoozeServiceConnection` created by
 * this function.
 */
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_MONITORING_V3_SNOOZE_CONNECTION_H
