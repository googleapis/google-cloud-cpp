...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::monitoring_v3::UptimeCheckServiceClient(
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::monitoring_v3::UptimeCheckServiceClient(
      google::cloud::monitoring_v3::MakeUptimeCheckServiceConnection(
          *ud_options));
  //! [set-client-universe-domain]
}
      ...
      google::cloud::Options{}
          ...
          .set<google::cloud::monitoring_v3::
              ...
              google::cloud::monitoring_v3::
                  UptimeCheckServiceLimitedErrorCountRetryPolicy(3)
                      .clone())
          .set<google::cloud::monitoring_v3::
