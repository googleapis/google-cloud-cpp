...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::monitoring_v3::SnoozeServiceClient(
      google::cloud::monitoring_v3::MakeSnoozeServiceConnection(*ud_options));
  //! [set-client-universe-domain]
}

//! [custom-idempotency-policy]
class CustomIdempotencyPolicy : public google::cloud::monitoring_v3::
                                    SnoozeServiceConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<
      google::cloud::monitoring_v3::SnoozeServiceConnectionIdempotencyPolicy>
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
      ...
      google::cloud::Options{}
          ...
          .set<google::cloud::monitoring_v3::SnoozeServiceRetryPolicyOption>(
              google::cloud::monitoring_v3::
                  SnoozeServiceLimitedErrorCountRetryPolicy(3)
                      .clone())
  ...
  auto c3 = google::cloud::monitoring_v3::SnoozeServiceClient(
      ...
      google::cloud::Options{}
          .set<google::cloud::monitoring_v3::SnoozeServiceRetryPolicyOption>(
              google::cloud::monitoring_v3::SnoozeServiceLimitedTimeRetryPolicy(
