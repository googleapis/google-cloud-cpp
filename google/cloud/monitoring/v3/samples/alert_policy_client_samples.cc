...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::monitoring_v3::AlertPolicyServiceClient(
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::monitoring_v3::AlertPolicyServiceClient(
      google::cloud::monitoring_v3::MakeAlertPolicyServiceConnection(
          *ud_options));
  //! [set-client-universe-domain]
}
      ...
      google::cloud::Options{}
          ...
          .set<google::cloud::monitoring_v3::
              ...
              google::cloud::monitoring_v3::
                  AlertPolicyServiceLimitedErrorCountRetryPolicy(3)
                      .clone())
          .set<google::cloud::monitoring_v3::
