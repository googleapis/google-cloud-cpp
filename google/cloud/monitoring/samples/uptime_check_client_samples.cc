...
// main-dox-marker: GOOGLE_CLOUD_CPP_NS::UptimeCheckServiceClient
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::GOOGLE_CLOUD_CPP_NS::UptimeCheckServiceClient(
      google::cloud::GOOGLE_CLOUD_CPP_NS::MakeUptimeCheckServiceConnection(
          options));
  //! [set-client-endpoint]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::GOOGLE_CLOUD_CPP_NS::UptimeCheckServiceClient(
        google::cloud::GOOGLE_CLOUD_CPP_NS::MakeUptimeCheckServiceConnection(
            options));
  }
  //! [with-service-account]
