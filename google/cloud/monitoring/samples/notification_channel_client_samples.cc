...
// main-dox-marker: GOOGLE_CLOUD_CPP_NS::NotificationChannelServiceClient
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client =
      google::cloud::GOOGLE_CLOUD_CPP_NS::NotificationChannelServiceClient(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::GOOGLE_CLOUD_CPP_NS::NotificationChannelServiceClient(
        google::cloud::GOOGLE_CLOUD_CPP_NS::
            MakeNotificationChannelServiceConnection(options));
  }
  //! [with-service-account]
