...
// main-dox-marker: GOOGLE_CLOUD_CPP_NS::QueryServiceClient
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::GOOGLE_CLOUD_CPP_NS::QueryServiceClient(
      google::cloud::GOOGLE_CLOUD_CPP_NS::MakeQueryServiceConnection(options));
  //! [set-client-endpoint]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::GOOGLE_CLOUD_CPP_NS::QueryServiceClient(
        google::cloud::GOOGLE_CLOUD_CPP_NS::MakeQueryServiceConnection(
            options));
  }
  //! [with-service-account]
  (argv.at(0));
