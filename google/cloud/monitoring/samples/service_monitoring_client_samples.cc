...
// main-dox-marker: GOOGLE_CLOUD_CPP_NS::ServiceMonitoringServiceClient
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client =
      google::cloud::GOOGLE_CLOUD_CPP_NS::ServiceMonitoringServiceClient(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::GOOGLE_CLOUD_CPP_NS::ServiceMonitoringServiceClient(
        google::cloud::GOOGLE_CLOUD_CPP_NS::
            MakeServiceMonitoringServiceConnection(options));
  }
  //! [with-service-account]
