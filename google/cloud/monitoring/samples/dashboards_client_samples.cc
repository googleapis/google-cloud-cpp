...
// main-dox-marker: GOOGLE_CLOUD_CPP_NS::DashboardsServiceClient
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::GOOGLE_CLOUD_CPP_NS::DashboardsServiceClient(
      google::cloud::GOOGLE_CLOUD_CPP_NS::MakeDashboardsServiceConnection(
          options));
  //! [set-client-endpoint]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::GOOGLE_CLOUD_CPP_NS::DashboardsServiceClient(
        google::cloud::GOOGLE_CLOUD_CPP_NS::MakeDashboardsServiceConnection(
            options));
  }
  //! [with-service-account]
