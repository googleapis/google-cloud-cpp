...
// main-dox-marker: GOOGLE_CLOUD_CPP_NS::AlertPolicyServiceClient
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::GOOGLE_CLOUD_CPP_NS::AlertPolicyServiceClient(
      google::cloud::GOOGLE_CLOUD_CPP_NS::MakeAlertPolicyServiceConnection(
          options));
  //! [set-client-endpoint]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::GOOGLE_CLOUD_CPP_NS::AlertPolicyServiceClient(
        google::cloud::GOOGLE_CLOUD_CPP_NS::MakeAlertPolicyServiceConnection(
            options));
  }
  //! [with-service-account]
