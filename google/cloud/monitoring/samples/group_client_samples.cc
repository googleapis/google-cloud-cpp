...
// main-dox-marker: GOOGLE_CLOUD_CPP_NS::GroupServiceClient
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::GOOGLE_CLOUD_CPP_NS::GroupServiceClient(
      google::cloud::GOOGLE_CLOUD_CPP_NS::MakeGroupServiceConnection(options));
  //! [set-client-endpoint]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::GOOGLE_CLOUD_CPP_NS::GroupServiceClient(
        google::cloud::GOOGLE_CLOUD_CPP_NS::MakeGroupServiceConnection(
            options));
  }
  //! [with-service-account]
  (argv.at(0));
