...
// clang-format off
// main-dox-marker: agentregistry_v1::AgentRegistryClient
// lro-marker: true
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::agentregistry_v1::AgentRegistryClient(
      google::cloud::agentregistry_v1::MakeAgentRegistryConnection(options));
  //! [set-client-endpoint]
}
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::agentregistry_v1::AgentRegistryClient(
      google::cloud::agentregistry_v1::MakeAgentRegistryConnection(
          *ud_options));
  //! [set-client-universe-domain]
}

//! [custom-idempotency-policy]
class CustomIdempotencyPolicy : public google::cloud::agentregistry_v1::
                                    AgentRegistryConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<
      google::cloud::agentregistry_v1::AgentRegistryConnectionIdempotencyPolicy>
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options =
      google::cloud::Options{}
          .set<google::cloud::agentregistry_v1::
                   AgentRegistryConnectionIdempotencyPolicyOption>(
              CustomIdempotencyPolicy().clone())
          .set<google::cloud::agentregistry_v1::AgentRegistryRetryPolicyOption>(
              google::cloud::agentregistry_v1::
                  AgentRegistryLimitedErrorCountRetryPolicy(3)
                      .clone())
          .set<google::cloud::agentregistry_v1::
  ...
  auto c1 = google::cloud::agentregistry_v1::AgentRegistryClient(connection);
  auto c2 = google::cloud::agentregistry_v1::AgentRegistryClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::agentregistry_v1::AgentRegistryClient(
      connection,
      google::cloud::Options{}
          .set<google::cloud::agentregistry_v1::AgentRegistryRetryPolicyOption>(
              google::cloud::agentregistry_v1::
                  AgentRegistryLimitedTimeRetryPolicy(std::chrono::minutes(5))
                      .clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::agentregistry_v1::AgentRegistryRetryPolicyOption>(
  //       google::cloud::agentregistry_v1::AgentRegistryLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
      ...
      google::cloud::Options{}
          .set<google::cloud::agentregistry_v1::
              ...
              google::cloud::GenericPollingPolicy<
                  google::cloud::agentregistry_v1::
                      AgentRegistryRetryPolicyOption::Type,
                  google::cloud::agentregistry_v1::
                      AgentRegistryBackoffPolicyOption::Type>(
                  google::cloud::agentregistry_v1::
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::agentregistry_v1::AgentRegistryClient(
        google::cloud::agentregistry_v1::MakeAgentRegistryConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
