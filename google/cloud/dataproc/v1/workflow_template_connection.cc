...
WorkflowTemplateServiceConnection::~WorkflowTemplateServiceConnection() = default;
...
StreamRange<google::cloud::dataproc::v1::WorkflowTemplate> WorkflowTemplateServiceConnection::ListWorkflowTemplates(
    google::cloud::dataproc::v1::ListWorkflowTemplatesRequest) {  // NOLINT(performance-unnecessary-value-param)
  return google::cloud::internal::MakeUnimplementedPaginationRange<
      StreamRange<google::cloud::dataproc::v1::WorkflowTemplate>>();
}

Status
WorkflowTemplateServiceConnection::DeleteWorkflowTemplate(
...
StreamRange<google::longrunning::Operation> WorkflowTemplateServiceConnection::ListOperations(
...
StatusOr<google::longrunning::Operation>
WorkflowTemplateServiceConnection::GetOperation(
    google::longrunning::GetOperationRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

Status
WorkflowTemplateServiceConnection::DeleteOperation(
    google::longrunning::DeleteOperationRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

Status
WorkflowTemplateServiceConnection::CancelOperation(
...
std::shared_ptr<WorkflowTemplateServiceConnection> MakeWorkflowTemplateServiceConnection(
  ...
  internal::CheckExpectedOptions<CommonOptionList, GrpcOptionList,
      ...
      WorkflowTemplateServicePolicyOptionList>(options, __func__);
  ...
  return dataproc_v1_internal::MakeWorkflowTemplateServiceTracingConnection(
      std::make_shared<dataproc_v1_internal::WorkflowTemplateServiceConnectionImpl>(
      std::move(background), std::move(stub), std::move(options)));
}

std::shared_ptr<WorkflowTemplateServiceConnection> MakeWorkflowTemplateServiceConnection(
    Options options) {
  return MakeWorkflowTemplateServiceConnection(std::string{}, std::move(options));
}
