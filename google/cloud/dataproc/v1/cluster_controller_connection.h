...
/**
 * A retry policy for `ClusterControllerConnection` that stops retrying after a
...
class ClusterControllerLimitedErrorCountRetryPolicy
 ...
 public:
  ClusterControllerLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `ClusterControllerConnection` that stops retrying after
