...
// clang-format off
// main-dox-marker: dataproc_v1::JobControllerClient
// lro-marker: true
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::dataproc_v1::JobControllerClient(
...
class CustomIdempotencyPolicy
   : public google::cloud::dataproc_v1::JobControllerConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::dataproc_v1::JobControllerConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::dataproc_v1::JobControllerConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::dataproc_v1::JobControllerRetryPolicyOption>(
      google::cloud::dataproc_v1::JobControllerLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::dataproc_v1::JobControllerBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::dataproc_v1::MakeJobControllerConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::dataproc_v1::JobControllerClient(connection);
  auto c2 = google::cloud::dataproc_v1::JobControllerClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::dataproc_v1::JobControllerClient(
    connection, google::cloud::Options{}.set<google::cloud::dataproc_v1::JobControllerRetryPolicyOption>(
      google::cloud::dataproc_v1::JobControllerLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::dataproc_v1::JobControllerRetryPolicyOption>(
  //       google::cloud::dataproc_v1::JobControllerLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::dataproc_v1::JobControllerPollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::dataproc_v1::JobControllerRetryPolicyOption::Type,
            google::cloud::dataproc_v1::JobControllerBackoffPolicyOption::Type>(
            google::cloud::dataproc_v1::JobControllerLimitedTimeRetryPolicy(
