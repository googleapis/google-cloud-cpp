...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::dataproc_v1::SessionControllerClient(
      google::cloud::dataproc_v1::MakeSessionControllerConnection("unused",
                                                                  options));
  //! [set-client-endpoint]
}
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::dataproc_v1::SessionControllerClient(
      google::cloud::dataproc_v1::MakeSessionControllerConnection(ud_options));
...
class CustomIdempotencyPolicy
 ...
 public:
  ...
  std::unique_ptr<
      google::cloud::dataproc_v1::SessionControllerConnectionIdempotencyPolicy>
      ...
      google::cloud::Options{}
          ...
          .set<google::cloud::dataproc_v1::SessionControllerRetryPolicyOption>(
              google::cloud::dataproc_v1::
                  SessionControllerLimitedErrorCountRetryPolicy(3)
                      .clone())
          .set<
              google::cloud::dataproc_v1::SessionControllerBackoffPolicyOption>(
              google::cloud::ExponentialBackoffPolicy(
                  /*initial_delay=*/std::chrono::milliseconds(200),
                  /*maximum_delay=*/std::chrono::seconds(45),
                  /*scaling=*/2.0)
                  .clone());
  auto connection = google::cloud::dataproc_v1::MakeSessionControllerConnection(
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options =
      google::cloud::Options{}
          .set<
              google::cloud::dataproc_v1::SessionControllerPollingPolicyOption>(
              google::cloud::GenericPollingPolicy<
                  google::cloud::dataproc_v1::
                      SessionControllerRetryPolicyOption::Type,
                  google::cloud::dataproc_v1::
                      SessionControllerBackoffPolicyOption::Type>(
                  google::cloud::dataproc_v1::
                      SessionControllerLimitedTimeRetryPolicy(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::dataproc_v1::SessionControllerClient(
        google::cloud::dataproc_v1::MakeSessionControllerConnection(
