...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DATAPROC_V1_CLUSTER_CONTROLLER_CONNECTION_IDEMPOTENCY_POLICY_H
...
class ClusterControllerConnectionIdempotencyPolicy {
 public:
  ...
  virtual std::unique_ptr<ClusterControllerConnectionIdempotencyPolicy> clone() const;
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DATAPROC_V1_CLUSTER_CONTROLLER_CONNECTION_IDEMPOTENCY_POLICY_H
