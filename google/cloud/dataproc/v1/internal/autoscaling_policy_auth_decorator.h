...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DATAPROC_V1_INTERNAL_AUTOSCALING_POLICY_AUTH_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DATAPROC_V1_INTERNAL_AUTOSCALING_POLICY_AUTH_DECORATOR_H
...
class AutoscalingPolicyServiceAuth : public AutoscalingPolicyServiceStub {
 public:
  ~AutoscalingPolicyServiceAuth() override = default;
  AutoscalingPolicyServiceAuth(
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DATAPROC_V1_INTERNAL_AUTOSCALING_POLICY_AUTH_DECORATOR_H
