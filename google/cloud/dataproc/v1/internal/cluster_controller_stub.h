...
class ClusterControllerStub {
 public:
  ...
  virtual StatusOr<google::cloud::dataproc::v1::ListClustersResponse> ListClusters(
      grpc::ClientContext& context,
      Options const& options,
...
class DefaultClusterControllerStub : public ClusterControllerStub {
 public:
  DefaultClusterControllerStub(
      std::unique_ptr<google::cloud::dataproc::v1::ClusterController::StubInterface> grpc_stub,
 ...
 private:
  std::unique_ptr<google::cloud::dataproc::v1::ClusterController::StubInterface> grpc_stub_;
