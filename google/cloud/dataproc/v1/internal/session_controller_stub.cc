...
DefaultSessionControllerStub::AsyncCreateSession(
  ...
  return internal::MakeUnaryRpcImpl<google::cloud::dataproc::v1::CreateSessionRequest,
...
DefaultSessionControllerStub::AsyncTerminateSession(
  ...
  return internal::MakeUnaryRpcImpl<google::cloud::dataproc::v1::TerminateSessionRequest,
                                    google::longrunning::Operation>(
      cq,
      [this](grpc::ClientContext* context,
             google::cloud::dataproc::v1::TerminateSessionRequest const& request,
...
DefaultSessionControllerStub::TerminateSession(
    ...
    google::longrunning::Operation response;
    auto status =
        grpc_stub_->TerminateSession(&context, request, &response);
    if (!status.ok()) {
      return google::cloud::MakeStatusFromRpcError(status);
    }
    return response;
...
DefaultSessionControllerStub::AsyncDeleteSession(
  ...
  return internal::MakeUnaryRpcImpl<google::cloud::dataproc::v1::DeleteSessionRequest,
                                    google::longrunning::Operation>(
      cq,
      [this](grpc::ClientContext* context,
             google::cloud::dataproc::v1::DeleteSessionRequest const& request,
...
DefaultSessionControllerStub::SetIamPolicy(
  grpc::ClientContext& context, Options const&,
...
StatusOr<google::iam::v1::Policy>
DefaultSessionControllerStub::GetIamPolicy(
  grpc::ClientContext& context, Options const&,
...
Status
DefaultSessionControllerStub::DeleteOperation(
  grpc::ClientContext& context, Options const&,
...
Status
DefaultSessionControllerStub::CancelOperation(
  grpc::ClientContext& context, Options const&,
