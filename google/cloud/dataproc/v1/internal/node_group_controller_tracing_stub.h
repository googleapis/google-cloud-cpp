...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DATAPROC_V1_INTERNAL_NODE_GROUP_CONTROLLER_TRACING_STUB_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DATAPROC_V1_INTERNAL_NODE_GROUP_CONTROLLER_TRACING_STUB_H
...
class NodeGroupControllerTracingStub : public NodeGroupControllerStub {
 public:
  ~NodeGroupControllerTracingStub() override = default;

  explicit NodeGroupControllerTracingStub(std::shared_ptr<NodeGroupControllerStub> child);
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DATAPROC_V1_INTERNAL_NODE_GROUP_CONTROLLER_TRACING_STUB_H
