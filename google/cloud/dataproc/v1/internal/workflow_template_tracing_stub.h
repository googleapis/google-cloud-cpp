...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DATAPROC_V1_INTERNAL_WORKFLOW_TEMPLATE_TRACING_STUB_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DATAPROC_V1_INTERNAL_WORKFLOW_TEMPLATE_TRACING_STUB_H
...
class WorkflowTemplateServiceTracingStub : public WorkflowTemplateServiceStub {
 public:
  ...
  explicit WorkflowTemplateServiceTracingStub(std::shared_ptr<WorkflowTemplateServiceStub> child);
 ...
 * OpenTelemetry.
 */
std::shared_ptr<WorkflowTemplateServiceStub> MakeWorkflowTemplateServiceTracingStub(
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DATAPROC_V1_INTERNAL_WORKFLOW_TEMPLATE_TRACING_STUB_H
