...
ClusterControllerAuth::CreateCluster(
...
StatusOr<google::longrunning::Operation>
ClusterControllerAuth::UpdateCluster(
      grpc::ClientContext& context,
      Options options,
      google::cloud::dataproc::v1::UpdateClusterRequest const& request) {
  auto status = auth_->ConfigureContext(context);
...
ClusterControllerAuth::AsyncStopCluster(
  ...
  return auth_->AsyncConfigureContext(std::move(context)).then(
      [cq, child = child_, options = std::move(options), request](
        ...
        return child->AsyncStopCluster(
            cq, *std::move(context), std::move(options), request);
      });
}

StatusOr<google::longrunning::Operation>
ClusterControllerAuth::StopCluster(
      grpc::ClientContext& context,
      Options options,
      google::cloud::dataproc::v1::StopClusterRequest const& request) {
  auto status = auth_->ConfigureContext(context);
...
ClusterControllerAuth::AsyncStartCluster(
  ...
  return auth_->AsyncConfigureContext(std::move(context)).then(
      [cq, child = child_, options = std::move(options), request](
        ...
        return child->AsyncStartCluster(
            cq, *std::move(context), std::move(options), request);
      });
}

StatusOr<google::longrunning::Operation>
ClusterControllerAuth::StartCluster(
      grpc::ClientContext& context,
      Options options,
      google::cloud::dataproc::v1::StartClusterRequest const& request) {
  auto status = auth_->ConfigureContext(context);
...
StatusOr<google::longrunning::Operation>
ClusterControllerAuth::DeleteCluster(
      grpc::ClientContext& context,
      Options options,
      google::cloud::dataproc::v1::DeleteClusterRequest const& request) {
  auto status = auth_->ConfigureContext(context);
...
StatusOr<google::cloud::dataproc::v1::Cluster> ClusterControllerAuth::GetCluster(
    grpc::ClientContext& context,
...
StatusOr<google::cloud::dataproc::v1::ListClustersResponse> ClusterControllerAuth::ListClusters(
    grpc::ClientContext& context,
    Options const& options,
...
ClusterControllerAuth::AsyncDiagnoseCluster(
  ...
  return auth_->AsyncConfigureContext(std::move(context)).then(
      [cq, child = child_, options = std::move(options), request](
        ...
        return child->AsyncDiagnoseCluster(
            cq, *std::move(context), std::move(options), request);
      });
}

StatusOr<google::longrunning::Operation>
ClusterControllerAuth::DiagnoseCluster(
      grpc::ClientContext& context,
      Options options,
      google::cloud::dataproc::v1::DiagnoseClusterRequest const& request) {
  auto status = auth_->ConfigureContext(context);
...
StatusOr<google::iam::v1::TestIamPermissionsResponse> ClusterControllerAuth::TestIamPermissions(
    grpc::ClientContext& context,
    Options const& options,
...
StatusOr<google::longrunning::ListOperationsResponse> ClusterControllerAuth::ListOperations(
    grpc::ClientContext& context,
    Options const& options,
