...
BatchControllerMetadata::AsyncCreateBatch(
  ...
  return child_->AsyncCreateBatch(
      cq, std::move(context), std::move(options), request);
}

StatusOr<google::longrunning::Operation>
BatchControllerMetadata::CreateBatch(
...
BatchControllerMetadata::GetBatch(
    grpc::ClientContext& context,
...
Status
BatchControllerMetadata::DeleteBatch(
    grpc::ClientContext& context,
    Options const& options,
...
BatchControllerMetadata::SetIamPolicy(
    grpc::ClientContext& context,
    Options const& options,
...
StatusOr<google::iam::v1::Policy>
BatchControllerMetadata::GetIamPolicy(
    grpc::ClientContext& context,
    Options const& options,
...
StatusOr<google::longrunning::Operation>
BatchControllerMetadata::GetOperation(
    grpc::ClientContext& context,
    Options const& options,
...
Status
BatchControllerMetadata::DeleteOperation(
    grpc::ClientContext& context,
    Options const& options,
...
Status
BatchControllerMetadata::CancelOperation(
    grpc::ClientContext& context,
    Options const& options,
