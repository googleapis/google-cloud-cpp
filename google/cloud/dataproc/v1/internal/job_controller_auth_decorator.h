...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DATAPROC_V1_INTERNAL_JOB_CONTROLLER_AUTH_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DATAPROC_V1_INTERNAL_JOB_CONTROLLER_AUTH_DECORATOR_H
...
class JobControllerAuth : public JobControllerStub {
 public:
  ~JobControllerAuth() override = default;
  JobControllerAuth(
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DATAPROC_V1_INTERNAL_JOB_CONTROLLER_AUTH_DECORATOR_H
