...
DefaultNodeGroupControllerStub::AsyncCreateNodeGroup(
  ...
  return internal::MakeUnaryRpcImpl<google::cloud::dataproc::v1::CreateNodeGroupRequest,
...
DefaultNodeGroupControllerStub::CreateNodeGroup(
    ...
    auto status =
        grpc_stub_->CreateNodeGroup(&context, request, &response);
    if (!status.ok()) {
...
DefaultNodeGroupControllerStub::AsyncResizeNodeGroup(
  ...
  return internal::MakeUnaryRpcImpl<google::cloud::dataproc::v1::ResizeNodeGroupRequest,
                                    google::longrunning::Operation>(
      cq,
      [this](grpc::ClientContext* context,
             google::cloud::dataproc::v1::ResizeNodeGroupRequest const& request,
...
DefaultNodeGroupControllerStub::ResizeNodeGroup(
    ...
    google::longrunning::Operation response;
    auto status =
        grpc_stub_->ResizeNodeGroup(&context, request, &response);
    if (!status.ok()) {
      return google::cloud::MakeStatusFromRpcError(status);
    }
    return response;
...
DefaultNodeGroupControllerStub::GetNodeGroup(
  ...
  google::cloud::dataproc::v1::GetNodeGroupRequest const& request) {
    ...
    auto status =
        grpc_stub_->GetNodeGroup(&context, request, &response);
    if (!status.ok()) {
      return google::cloud::MakeStatusFromRpcError(status);
    }
    return response;
...
DefaultNodeGroupControllerStub::SetIamPolicy(
  grpc::ClientContext& context, Options const&,
...
StatusOr<google::iam::v1::Policy>
DefaultNodeGroupControllerStub::GetIamPolicy(
  grpc::ClientContext& context, Options const&,
...
Status
DefaultNodeGroupControllerStub::DeleteOperation(
  grpc::ClientContext& context, Options const&,
...
Status
DefaultNodeGroupControllerStub::CancelOperation(
  grpc::ClientContext& context, Options const&,
