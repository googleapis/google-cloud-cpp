...
DefaultAutoscalingPolicyServiceStub::GetAutoscalingPolicy(
  ...
  google::cloud::dataproc::v1::GetAutoscalingPolicyRequest const& request) {
    google::cloud::dataproc::v1::AutoscalingPolicy response;
    auto status =
        grpc_stub_->GetAutoscalingPolicy(&context, request, &response);
    if (!status.ok()) {
      return google::cloud::MakeStatusFromRpcError(status);
    }
    return response;
...
Status
DefaultAutoscalingPolicyServiceStub::DeleteAutoscalingPolicy(
  grpc::ClientContext& context, Options const&,
...
Status
DefaultAutoscalingPolicyServiceStub::DeleteOperation(
  grpc::ClientContext& context, Options const&,
...
Status
DefaultAutoscalingPolicyServiceStub::CancelOperation(
  grpc::ClientContext& context, Options const&,
