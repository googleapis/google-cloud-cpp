...
StatusOr<google::longrunning::Operation> BatchControllerLogging::GetOperation(
    grpc::ClientContext& context, Options const& options,
...
Status BatchControllerLogging::DeleteOperation(
    grpc::ClientContext& context, Options const& options,
...
Status BatchControllerLogging::CancelOperation(
    grpc::ClientContext& context, Options const& options,
