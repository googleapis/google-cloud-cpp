...
BatchControllerLogging::CreateBatch(
...
BatchControllerLogging::GetBatch(
    grpc::ClientContext& context,
    Options const& options,
...
Status
BatchControllerLogging::DeleteBatch(
    grpc::ClientContext& context,
    Options const& options,
...
BatchControllerLogging::SetIamPolicy(
    grpc::ClientContext& context,
    Options const& options,
...
StatusOr<google::iam::v1::Policy>
BatchControllerLogging::GetIamPolicy(
    grpc::ClientContext& context,
    Options const& options,
...
BatchControllerLogging::ListOperations(
    grpc::ClientContext& context,
    Options const& options,
...
StatusOr<google::longrunning::Operation>
BatchControllerLogging::GetOperation(
    grpc::ClientContext& context,
    Options const& options,
...
Status
BatchControllerLogging::DeleteOperation(
    grpc::ClientContext& context,
    Options const& options,
...
Status
BatchControllerLogging::CancelOperation(
    grpc::ClientContext& context,
    Options const& options,
