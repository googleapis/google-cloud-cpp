...
std::shared_ptr<NodeGroupControllerStub> CreateDefaultNodeGroupControllerStub(
  ...
  auto endpoint = internal::DetermineServiceEndpoint(
      internal::GetEnv("GOOGLE_CLOUD_CPP_NODE_GROUP_CONTROLLER_ENDPOINT"),
  ...
  if (!endpoint.ok()) {
    ...
    stub = std::make_shared<DefaultNodeGroupControllerStub>(
  ...
  if (internal::TracingEnabled(options)) {
    stub = MakeNodeGroupControllerTracingStub(std::move(stub));
  }
  return stub;
}
