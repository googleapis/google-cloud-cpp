...
/**
 * A retry policy for `BatchControllerConnection` that stops retrying after a
...
class BatchControllerLimitedErrorCountRetryPolicy
 ...
 public:
  BatchControllerLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `BatchControllerConnection` that stops retrying after
