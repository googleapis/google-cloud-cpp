...
/**
 * A retry policy for `JobControllerConnection` that stops retrying after a
...
class JobControllerLimitedErrorCountRetryPolicy
 ...
 public:
  JobControllerLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `JobControllerConnection` that stops retrying after
