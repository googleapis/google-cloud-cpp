...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DATAPROC_INTERNAL_JOB_CONTROLLER_TRACING_CONNECTION_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DATAPROC_INTERNAL_JOB_CONTROLLER_TRACING_CONNECTION_H
...
class JobControllerTracingConnection
    : public dataproc::JobControllerConnection {
 public:
  ~JobControllerTracingConnection() override = default;

  explicit JobControllerTracingConnection(
      std::shared_ptr<dataproc::JobControllerConnection> child);
 ...
 private:
  std::shared_ptr<dataproc::JobControllerConnection> child_;
};
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DATAPROC_INTERNAL_JOB_CONTROLLER_TRACING_CONNECTION_H
