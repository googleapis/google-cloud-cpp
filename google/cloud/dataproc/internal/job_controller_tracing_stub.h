...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DATAPROC_INTERNAL_JOB_CONTROLLER_TRACING_STUB_H
...
class JobControllerTracingStub : public JobControllerStub {
 public:
  ...
  explicit JobControllerTracingStub(std::shared_ptr<JobControllerStub> child);
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DATAPROC_INTERNAL_JOB_CONTROLLER_TRACING_STUB_H
