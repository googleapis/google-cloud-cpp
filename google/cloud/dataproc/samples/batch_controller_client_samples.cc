...
// main-dox-marker: GOOGLE_CLOUD_CPP_NS::BatchControllerClient
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::GOOGLE_CLOUD_CPP_NS::BatchControllerClient(
      google::cloud::GOOGLE_CLOUD_CPP_NS::MakeBatchControllerConnection(
          options));
  //! [set-client-endpoint]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::GOOGLE_CLOUD_CPP_NS::BatchControllerClient(
        google::cloud::GOOGLE_CLOUD_CPP_NS::MakeBatchControllerConnection(
            options));
  }
  //! [with-service-account]
