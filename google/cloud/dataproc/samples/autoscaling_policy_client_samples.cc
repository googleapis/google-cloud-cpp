...
// main-dox-marker: GOOGLE_CLOUD_CPP_NS::AutoscalingPolicyServiceClient
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client =
      google::cloud::GOOGLE_CLOUD_CPP_NS::AutoscalingPolicyServiceClient(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::GOOGLE_CLOUD_CPP_NS::AutoscalingPolicyServiceClient(
        google::cloud::GOOGLE_CLOUD_CPP_NS::
            MakeAutoscalingPolicyServiceConnection(options));
  }
  //! [with-service-account]
