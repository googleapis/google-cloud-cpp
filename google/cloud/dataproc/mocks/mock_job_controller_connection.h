...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DATAPROC_MOCKS_MOCK_JOB_CONTROLLER_CONNECTION_H
 ...
 * including errors from a `JobControllerClient`. To do so, construct a
 * `JobControllerClient` with an instance of this class. Then use the Google
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DATAPROC_MOCKS_MOCK_JOB_CONTROLLER_CONNECTION_H
