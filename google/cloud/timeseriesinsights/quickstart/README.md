# HOWTO: using the Timeseries Insights API C++ client in your project

This directory contains small examples showing how to use the Timeseries Insights API C++
...
Like most Google Cloud Platform (GCP) services, Timeseries Insights API requires that
...
1. Install the dependencies with your favorite tools. As an example, if you use
   ...
   ```bash
   cd $HOME/vcpkg
   ./vcpkg install google-cloud-cpp[core,timeseriesinsights]
   ```
...
[quickstart-link]: https://cloud.google.com/timeseriesinsights/docs/quickstart
