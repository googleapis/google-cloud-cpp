# HOWTO: using the Network Security API C++ client in your project

This directory contains small examples showing how to use the Network Security API C++
...
Like most Google Cloud Platform (GCP) services, Network Security API requires that
...
1. Install the dependencies with your favorite tools. As an example, if you use
   ...
   ```bash
   cd $HOME/vcpkg
   ./vcpkg install google-cloud-cpp[core,networksecurity]
   ```
...
[quickstart-link]: https://cloud.google.com/secure-web-proxy/docs/initial-setup-steps
