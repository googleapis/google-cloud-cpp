...
/**
 * A retry policy for `NetworkSecurityConnection` that stops retrying after a
...
class NetworkSecurityLimitedErrorCountRetryPolicy
 ...
 public:
  NetworkSecurityLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `NetworkSecurityConnection` that stops retrying after
