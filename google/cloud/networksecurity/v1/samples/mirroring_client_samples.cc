...
// clang-format off
// main-dox-marker: networksecurity_v1::MirroringClient
// lro-marker: true
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::networksecurity_v1::MirroringClient(
      google::cloud::networksecurity_v1::MakeMirroringConnection(options));
  //! [set-client-endpoint]
}
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::networksecurity_v1::MirroringClient(
      google::cloud::networksecurity_v1::MakeMirroringConnection(*ud_options));
  //! [set-client-universe-domain]
}
...
class CustomIdempotencyPolicy : public google::cloud::networksecurity_v1::
 ...
 public:
  ...
  std::unique_ptr<
      google::cloud::networksecurity_v1::MirroringConnectionIdempotencyPolicy>
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options =
      google::cloud::Options{}
          ...
          .set<google::cloud::networksecurity_v1::MirroringRetryPolicyOption>(
              google::cloud::networksecurity_v1::
                  MirroringLimitedErrorCountRetryPolicy(3)
                      .clone())
          .set<google::cloud::networksecurity_v1::MirroringBackoffPolicyOption>(
  ...
  auto c1 = google::cloud::networksecurity_v1::MirroringClient(connection);
  auto c2 = google::cloud::networksecurity_v1::MirroringClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::networksecurity_v1::MirroringClient(
      connection,
      google::cloud::Options{}
          .set<google::cloud::networksecurity_v1::MirroringRetryPolicyOption>(
              google::cloud::networksecurity_v1::
                  MirroringLimitedTimeRetryPolicy(std::chrono::minutes(5))
                      .clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::networksecurity_v1::MirroringRetryPolicyOption>(
  //       google::cloud::networksecurity_v1::MirroringLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options =
      google::cloud::Options{}
          .set<google::cloud::networksecurity_v1::MirroringPollingPolicyOption>(
              google::cloud::GenericPollingPolicy<
                  google::cloud::networksecurity_v1::
                      MirroringRetryPolicyOption::Type,
                  google::cloud::networksecurity_v1::
                      MirroringBackoffPolicyOption::Type>(
                  google::cloud::networksecurity_v1::
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::networksecurity_v1::MirroringClient(
        google::cloud::networksecurity_v1::MakeMirroringConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
