...
// clang-format off
// main-dox-marker: networksecurity_v1::OrganizationSecurityProfileGroupServiceClient
// lro-marker: true
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::networksecurity_v1::
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::networksecurity_v1::
      OrganizationSecurityProfileGroupServiceClient(
          google::cloud::networksecurity_v1::
              MakeOrganizationSecurityProfileGroupServiceConnection(
                  *ud_options));
  //! [set-client-universe-domain]
}
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
      ...
      google::cloud::Options{}
          ...
          .set<google::cloud::networksecurity_v1::
              ...
              google::cloud::ExponentialBackoffPolicy(
                  ...
                  /*scaling=*/2.0)
                  .clone());
  auto connection = google::cloud::networksecurity_v1::
      MakeOrganizationSecurityProfileGroupServiceConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::networksecurity_v1::
      OrganizationSecurityProfileGroupServiceClient(connection);
  auto c2 = google::cloud::networksecurity_v1::
      OrganizationSecurityProfileGroupServiceClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::networksecurity_v1::
      OrganizationSecurityProfileGroupServiceClient(
          connection,
          google::cloud::Options{}
              .set<
  ...
  //     .set<google::cloud::networksecurity_v1::OrganizationSecurityProfileGroupServiceRetryPolicyOption>(
  //       google::cloud::networksecurity_v1::OrganizationSecurityProfileGroupServiceLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::networksecurity_v1::
        OrganizationSecurityProfileGroupServiceClient(
            google::cloud::networksecurity_v1::
                MakeOrganizationSecurityProfileGroupServiceConnection(options));
  }
