...
// clang-format off
// main-dox-marker: networksecurity_v1::DnsThreatDetectorServiceClient
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client =
      google::cloud::networksecurity_v1::DnsThreatDetectorServiceClient(
          google::cloud::networksecurity_v1::
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client =
      google::cloud::networksecurity_v1::DnsThreatDetectorServiceClient(
          google::cloud::networksecurity_v1::
              MakeDnsThreatDetectorServiceConnection(*ud_options));
  //! [set-client-universe-domain]
}

//! [custom-idempotency-policy]
class CustomIdempotencyPolicy
    : public google::cloud::networksecurity_v1::
          DnsThreatDetectorServiceConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::networksecurity_v1::
                      DnsThreatDetectorServiceConnectionIdempotencyPolicy>
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
      ...
      google::cloud::Options{}
          ...
          .set<google::cloud::networksecurity_v1::
              ...
              google::cloud::ExponentialBackoffPolicy(
                  ...
                  .clone());
  auto connection =
      google::cloud::networksecurity_v1::MakeDnsThreatDetectorServiceConnection(
          options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::networksecurity_v1::DnsThreatDetectorServiceClient(
      connection);
  auto c2 = google::cloud::networksecurity_v1::DnsThreatDetectorServiceClient(
      connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::networksecurity_v1::DnsThreatDetectorServiceClient(
  ...
  //     .set<google::cloud::networksecurity_v1::DnsThreatDetectorServiceRetryPolicyOption>(
  //       google::cloud::networksecurity_v1::DnsThreatDetectorServiceLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::networksecurity_v1::DnsThreatDetectorServiceClient(
        google::cloud::networksecurity_v1::
            MakeDnsThreatDetectorServiceConnection(options));
  }
  //! [with-service-account]
