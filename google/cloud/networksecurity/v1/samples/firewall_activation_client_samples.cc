...
// clang-format off
// main-dox-marker: networksecurity_v1::FirewallActivationClient
// lro-marker: true
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::networksecurity_v1::FirewallActivationClient(
      google::cloud::networksecurity_v1::MakeFirewallActivationConnection(
          options));
  //! [set-client-endpoint]
}
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::networksecurity_v1::FirewallActivationClient(
      google::cloud::networksecurity_v1::MakeFirewallActivationConnection(
          *ud_options));
  //! [set-client-universe-domain]
}
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
      ...
      google::cloud::Options{}
          ...
          .set<google::cloud::networksecurity_v1::
              ...
              google::cloud::networksecurity_v1::
                  FirewallActivationLimitedErrorCountRetryPolicy(3)
                      .clone())
          .set<google::cloud::networksecurity_v1::
  ...
  auto c1 =
      google::cloud::networksecurity_v1::FirewallActivationClient(connection);
  auto c2 =
      google::cloud::networksecurity_v1::FirewallActivationClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::networksecurity_v1::FirewallActivationClient(
  ...
  //     .set<google::cloud::networksecurity_v1::FirewallActivationRetryPolicyOption>(
  //       google::cloud::networksecurity_v1::FirewallActivationLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
      ...
      google::cloud::Options{}
          .set<google::cloud::networksecurity_v1::
              ...
              google::cloud::GenericPollingPolicy<
                  google::cloud::networksecurity_v1::
                      FirewallActivationRetryPolicyOption::Type,
                  google::cloud::networksecurity_v1::
                      FirewallActivationBackoffPolicyOption::Type>(
                  google::cloud::networksecurity_v1::
                      FirewallActivationLimitedTimeRetryPolicy(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::networksecurity_v1::FirewallActivationClient(
        google::cloud::networksecurity_v1::MakeFirewallActivationConnection(
            options));
  }
  //! [with-service-account]
