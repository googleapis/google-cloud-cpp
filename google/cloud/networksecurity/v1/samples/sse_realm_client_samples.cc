...
// clang-format off
// main-dox-marker: networksecurity_v1::SSERealmServiceClient
// lro-marker: true
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::networksecurity_v1::SSERealmServiceClient(
      google::cloud::networksecurity_v1::MakeSSERealmServiceConnection(
          options));
  //! [set-client-endpoint]
}
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::networksecurity_v1::SSERealmServiceClient(
      google::cloud::networksecurity_v1::MakeSSERealmServiceConnection(
          *ud_options));
  //! [set-client-universe-domain]
}
  ...
  auto options = google::cloud::Options{}
                     ...
                     .set<google::cloud::networksecurity_v1::
                         ...
                         google::cloud::networksecurity_v1::
                             SSERealmServiceLimitedErrorCountRetryPolicy(3)
                                 .clone())
                     .set<google::cloud::networksecurity_v1::
                         ...
                         google::cloud::ExponentialBackoffPolicy(
                             ...
                             .clone());
  auto connection =
      google::cloud::networksecurity_v1::MakeSSERealmServiceConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 =
      google::cloud::networksecurity_v1::SSERealmServiceClient(connection);
  auto c2 =
      google::cloud::networksecurity_v1::SSERealmServiceClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::networksecurity_v1::SSERealmServiceClient(
      connection,
      google::cloud::Options{}
          .set<google::cloud::networksecurity_v1::
                   SSERealmServiceRetryPolicyOption>(
              google::cloud::networksecurity_v1::
                  SSERealmServiceLimitedTimeRetryPolicy(std::chrono::minutes(5))
                      .clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::networksecurity_v1::SSERealmServiceRetryPolicyOption>(
  //       google::cloud::networksecurity_v1::SSERealmServiceLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
      ...
      google::cloud::Options{}
          .set<google::cloud::networksecurity_v1::
              ...
              google::cloud::GenericPollingPolicy<
                  google::cloud::networksecurity_v1::
                      SSERealmServiceRetryPolicyOption::Type,
                  google::cloud::networksecurity_v1::
                      SSERealmServiceBackoffPolicyOption::Type>(
                  google::cloud::networksecurity_v1::
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::networksecurity_v1::SSERealmServiceClient(
        google::cloud::networksecurity_v1::MakeSSERealmServiceConnection(
            options));
  }
  //! [with-service-account]
