...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::networksecurity_v1::NetworkSecurityClient(
      google::cloud::networksecurity_v1::MakeNetworkSecurityConnection(options));
  //! [set-client-endpoint]
}

//! [custom-idempotency-policy]
class CustomIdempotencyPolicy
   : public google::cloud::networksecurity_v1::NetworkSecurityConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::networksecurity_v1::NetworkSecurityConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::networksecurity_v1::NetworkSecurityConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::networksecurity_v1::NetworkSecurityRetryPolicyOption>(
      google::cloud::networksecurity_v1::NetworkSecurityLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::networksecurity_v1::NetworkSecurityBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::networksecurity_v1::MakeNetworkSecurityConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::networksecurity_v1::NetworkSecurityClient(connection);
  auto c2 = google::cloud::networksecurity_v1::NetworkSecurityClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::networksecurity_v1::NetworkSecurityClient(
    connection, google::cloud::Options{}.set<google::cloud::networksecurity_v1::NetworkSecurityRetryPolicyOption>(
      google::cloud::networksecurity_v1::NetworkSecurityLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::networksecurity_v1::NetworkSecurityRetryPolicyOption>(
  //       google::cloud::networksecurity_v1::NetworkSecurityLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::networksecurity_v1::NetworkSecurityPollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::networksecurity_v1::NetworkSecurityRetryPolicyOption::Type,
            google::cloud::networksecurity_v1::NetworkSecurityBackoffPolicyOption::Type>(
            google::cloud::networksecurity_v1::NetworkSecurityLimitedTimeRetryPolicy(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::networksecurity_v1::NetworkSecurityClient(
      google::cloud::networksecurity_v1::MakeNetworkSecurityConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
