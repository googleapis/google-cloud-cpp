...
// clang-format off
// main-dox-marker: networksecurity_v1::InterceptClient
// lro-marker: true
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::networksecurity_v1::InterceptClient(
      google::cloud::networksecurity_v1::MakeInterceptConnection(options));
  //! [set-client-endpoint]
}
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::networksecurity_v1::InterceptClient(
      google::cloud::networksecurity_v1::MakeInterceptConnection(*ud_options));
  //! [set-client-universe-domain]
}
...
class CustomIdempotencyPolicy : public google::cloud::networksecurity_v1::
 ...
 public:
  ...
  std::unique_ptr<
      google::cloud::networksecurity_v1::InterceptConnectionIdempotencyPolicy>
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options =
      google::cloud::Options{}
          ...
          .set<google::cloud::networksecurity_v1::InterceptRetryPolicyOption>(
              google::cloud::networksecurity_v1::
                  InterceptLimitedErrorCountRetryPolicy(3)
                      .clone())
          .set<google::cloud::networksecurity_v1::InterceptBackoffPolicyOption>(
  ...
  auto c1 = google::cloud::networksecurity_v1::InterceptClient(connection);
  auto c2 = google::cloud::networksecurity_v1::InterceptClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::networksecurity_v1::InterceptClient(
      connection,
      google::cloud::Options{}
          .set<google::cloud::networksecurity_v1::InterceptRetryPolicyOption>(
              google::cloud::networksecurity_v1::
                  InterceptLimitedTimeRetryPolicy(std::chrono::minutes(5))
                      .clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::networksecurity_v1::InterceptRetryPolicyOption>(
  //       google::cloud::networksecurity_v1::InterceptLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options =
      google::cloud::Options{}
          .set<google::cloud::networksecurity_v1::InterceptPollingPolicyOption>(
              google::cloud::GenericPollingPolicy<
                  google::cloud::networksecurity_v1::
                      InterceptRetryPolicyOption::Type,
                  google::cloud::networksecurity_v1::
                      InterceptBackoffPolicyOption::Type>(
                  google::cloud::networksecurity_v1::
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::networksecurity_v1::InterceptClient(
        google::cloud::networksecurity_v1::MakeInterceptConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
