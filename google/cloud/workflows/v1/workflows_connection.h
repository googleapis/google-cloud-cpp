...
/**
 * A retry policy for `WorkflowsConnection` that stops retrying after a
...
class WorkflowsLimitedErrorCountRetryPolicy : public WorkflowsRetryPolicy {
 public:
  WorkflowsLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `WorkflowsConnection` that stops retrying after
