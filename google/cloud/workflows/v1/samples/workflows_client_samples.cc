...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::workflows_v1::WorkflowsClient(
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::workflows_v1::WorkflowsClient(
      google::cloud::workflows_v1::MakeWorkflowsConnection(*ud_options));
  //! [set-client-universe-domain]
}
