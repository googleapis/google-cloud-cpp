...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_WORKFLOWS_V1_INTERNAL_WORKFLOWS_LOGGING_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_WORKFLOWS_V1_INTERNAL_WORKFLOWS_LOGGING_DECORATOR_H
...
class WorkflowsLogging : public WorkflowsStub {
 public:
  ~WorkflowsLogging() override = default;
  WorkflowsLogging(std::shared_ptr<WorkflowsStub> child,
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_WORKFLOWS_V1_INTERNAL_WORKFLOWS_LOGGING_DECORATOR_H
