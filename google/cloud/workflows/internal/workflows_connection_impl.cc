...
inline std::unique_ptr<workflows::WorkflowsRetryPolicy> retry_policy() {
  return internal::CurrentOptions()
      .get<workflows::WorkflowsRetryPolicyOption>()
      ->clone();
}

inline std::unique_ptr<BackoffPolicy> backoff_policy() {
  return internal::CurrentOptions()
      .get<workflows::WorkflowsBackoffPolicyOption>()
      ->clone();
}

inline std::unique_ptr<workflows::WorkflowsConnectionIdempotencyPolicy>
idempotency_policy() {
  return internal::CurrentOptions()
...
inline std::unique_ptr<PollingPolicy> polling_policy() {
  return internal::CurrentOptions()
      .get<workflows::WorkflowsPollingPolicyOption>()
      ->clone();
}
