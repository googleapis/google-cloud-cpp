...
inline std::unique_ptr<workflows::ExecutionsRetryPolicy> retry_policy() {
  return internal::CurrentOptions()
      .get<workflows::ExecutionsRetryPolicyOption>()
      ->clone();
}

inline std::unique_ptr<BackoffPolicy> backoff_policy() {
  return internal::CurrentOptions()
      .get<workflows::ExecutionsBackoffPolicyOption>()
      ->clone();
}

inline std::unique_ptr<workflows::ExecutionsConnectionIdempotencyPolicy>
idempotency_policy() {
  return internal::CurrentOptions()
