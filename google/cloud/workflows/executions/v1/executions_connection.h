...
/**
 * A retry policy for `ExecutionsConnection` that stops retrying after a
...
class ExecutionsLimitedErrorCountRetryPolicy : public ExecutionsRetryPolicy {
 public:
  ExecutionsLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `ExecutionsConnection` that stops retrying after
 ...
 * - `google::cloud::workflows_executions_v1::ExecutionsPolicyOptionList`
 *
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_WORKFLOWS_EXECUTIONS_V1_EXECUTIONS_CONNECTION_H
