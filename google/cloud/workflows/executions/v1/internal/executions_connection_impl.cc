...
retry_policy(Options const& options) {
  return options.get<workflows_executions_v1::ExecutionsRetryPolicyOption>()->clone();
}

std::unique_ptr<BackoffPolicy>
backoff_policy(Options const& options) {
  return options.get<workflows_executions_v1::ExecutionsBackoffPolicyOption>()->clone();
}

std::unique_ptr<workflows_executions_v1::ExecutionsConnectionIdempotencyPolicy>
idempotency_policy(Options const& options) {
  return options.get<workflows_executions_v1::ExecutionsConnectionIdempotencyPolicyOption>()->clone();
}
...
ExecutionsConnectionImpl::ListExecutions(google::cloud::workflows::executions::v1::ListExecutionsRequest request) {
  ...
  return google::cloud::internal::MakePaginationRange<StreamRange<google::cloud::workflows::executions::v1::Execution>>(
      ...
      [idempotency, function_name, stub = stub_,
       retry = std::shared_ptr<workflows_executions_v1::ExecutionsRetryPolicy>(retry_policy(*current)),
       backoff = std::shared_ptr<BackoffPolicy>(backoff_policy(*current))](
          Options const& options, google::cloud::workflows::executions::v1::ListExecutionsRequest const& r) {
