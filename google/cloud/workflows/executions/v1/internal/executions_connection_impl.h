...
class ExecutionsConnectionImpl
 ...
 private:
  ...
  std::shared_ptr<workflows_executions_v1_internal::ExecutionsStub> stub_;
  Options options_;
};
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_WORKFLOWS_EXECUTIONS_V1_INTERNAL_EXECUTIONS_CONNECTION_IMPL_H
