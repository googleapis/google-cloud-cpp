...
///     types defined in workflows_executions_v1 instead of the aliases defined in
///     this namespace.
namespace workflows {
GOOGLE_CLOUD_CPP_INLINE_NAMESPACE_BEGIN

/// @deprecated Use workflows_executions_v1::ExecutionsClient directly.
using ::google::cloud::workflows_executions_v1::ExecutionsClient;
