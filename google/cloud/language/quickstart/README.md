# HOWTO: using the Cloud Natural Language API C++ client in your project

This directory contains small examples showing how to use the Cloud Natural Language API C++
...
Like most Google Cloud Platform (GCP) services, Cloud Natural Language API requires that
...
1. Install the dependencies with your favorite tools. As an example, if you use
   ...
   ```bash
   cd $HOME/vcpkg
   ./vcpkg install google-cloud-cpp[core,language]
   ```
...
1. Configure CMake, if necessary, configure the directory where you installed
   ...
   ```bash
   cd $HOME/gooogle-cloud-cpp/google/cloud/language/quickstart
...
[quickstart-link]: https://cloud.google.com/natural-language/docs/quickstart
