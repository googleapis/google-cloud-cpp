...
// main-dox-marker: GOOGLE_CLOUD_CPP_NS::LanguageServiceClient
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::GOOGLE_CLOUD_CPP_NS::LanguageServiceClient(
      google::cloud::GOOGLE_CLOUD_CPP_NS::MakeLanguageServiceConnection(
          options));
  //! [set-client-endpoint]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::GOOGLE_CLOUD_CPP_NS::LanguageServiceClient(
        google::cloud::GOOGLE_CLOUD_CPP_NS::MakeLanguageServiceConnection(
            options));
  }
  //! [with-service-account]
