...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::language_v2::LanguageServiceClient(
      google::cloud::language_v2::MakeLanguageServiceConnection(*ud_options));
  //! [set-client-universe-domain]
}

//! [custom-idempotency-policy]
class CustomIdempotencyPolicy : public google::cloud::language_v2::
                                    LanguageServiceConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<
      google::cloud::language_v2::LanguageServiceConnectionIdempotencyPolicy>
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
      ...
      google::cloud::Options{}
          ...
          .set<google::cloud::language_v2::LanguageServiceRetryPolicyOption>(
              google::cloud::language_v2::
                  LanguageServiceLimitedErrorCountRetryPolicy(3)
                      .clone())
  ...
  auto c3 = google::cloud::language_v2::LanguageServiceClient(
      ...
      google::cloud::Options{}
          .set<google::cloud::language_v2::LanguageServiceRetryPolicyOption>(
              google::cloud::language_v2::LanguageServiceLimitedTimeRetryPolicy(
