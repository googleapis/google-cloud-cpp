...
std::shared_ptr<LanguageServiceStub> CreateDefaultLanguageServiceStub(
  ...
  auto endpoint = internal::DetermineServiceEndpoint(
      internal::GetEnv("GOOGLE_CLOUD_CPP_LANGUAGE_SERVICE_ENDPOINT"),
      internal::FetchOption<EndpointOption>(options), "language.googleapis.com",
      options);
  ...
  if (!endpoint.ok()) {
    ...
    auto service_grpc_stub =
        google::cloud::language::v2::LanguageService::NewStub(channel);
    stub = std::make_shared<DefaultLanguageServiceStub>(
