...
class LanguageServiceLimitedErrorCountRetryPolicy : public LanguageServiceRetryPolicy {
 ...
 private:
  google::cloud::internal::LimitedErrorCountRetryPolicy<language_v1_internal::LanguageServiceRetryTraits> impl_;
};
...
class LanguageServiceLimitedTimeRetryPolicy : public LanguageServiceRetryPolicy {
 ...
 private:
  google::cloud::internal::LimitedTimeRetryPolicy<language_v1_internal::LanguageServiceRetryTraits> impl_;
};
