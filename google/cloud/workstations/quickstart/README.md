# HOWTO: using the Cloud Workstations API C++ client in your project

This directory contains small examples showing how to use the Cloud Workstations API C++
...
1. Install the dependencies with your favorite tools. As an example, if you use
   ...
   ```bash
   cd $HOME/vcpkg
   ./vcpkg install google-cloud-cpp[core,workstations]
   ```
...
[quickstart-link]: https://cloud.google.com/workstations/docs/quickstart
