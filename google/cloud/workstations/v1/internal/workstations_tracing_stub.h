...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_WORKSTATIONS_V1_INTERNAL_WORKSTATIONS_TRACING_STUB_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_WORKSTATIONS_V1_INTERNAL_WORKSTATIONS_TRACING_STUB_H
...
class WorkstationsTracingStub : public WorkstationsStub {
 public:
  ~WorkstationsTracingStub() override = default;

  explicit WorkstationsTracingStub(std::shared_ptr<WorkstationsStub> child);
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_WORKSTATIONS_V1_INTERNAL_WORKSTATIONS_TRACING_STUB_H
