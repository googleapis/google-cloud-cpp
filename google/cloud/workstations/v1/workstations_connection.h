...
/**
 * A retry policy for `WorkstationsConnection` that stops retrying after a
...
class WorkstationsLimitedErrorCountRetryPolicy
 ...
 public:
  WorkstationsLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `WorkstationsConnection` that stops retrying after
