 ...
 */
struct WorkstationsRetryPolicyOption {
  using Type = std::shared_ptr<WorkstationsRetryPolicy>;
};
 ...
 * @ingroup google-cloud-workstations-options
 */
struct WorkstationsBackoffPolicyOption {
 ...
 * @ingroup google-cloud-workstations-options
 */
struct WorkstationsConnectionIdempotencyPolicyOption {
  using Type = std::shared_ptr<WorkstationsConnectionIdempotencyPolicy>;
};
 ...
 * @ingroup google-cloud-workstations-options
 */
struct WorkstationsPollingPolicyOption {
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_WORKSTATIONS_V1_WORKSTATIONS_OPTIONS_H
