 ...
 */
struct RuleServiceRetryPolicyOption {
  using Type = std::shared_ptr<RuleServiceRetryPolicy>;
};
 ...
 * @ingroup google-cloud-chronicle-options
 */
struct RuleServiceBackoffPolicyOption {
 ...
 * @ingroup google-cloud-chronicle-options
 */
struct RuleServiceConnectionIdempotencyPolicyOption {
  using Type = std::shared_ptr<RuleServiceConnectionIdempotencyPolicy>;
};
 ...
 * @ingroup google-cloud-chronicle-options
 */
struct RuleServicePollingPolicyOption {
  using Type = std::shared_ptr<PollingPolicy>;
};

/**
 * The options applicable to RuleService.
 *
 * @ingroup google-cloud-chronicle-options
 */
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_CHRONICLE_V1_RULE_OPTIONS_H
