...
#include <google/cloud/chronicle/v1/rule.pb.h>
...
class RuleServiceRetryPolicy : public ::google::cloud::RetryPolicy {
 public:
  /// Creates a new instance of the policy, reset to the initial state.
  virtual std::unique_ptr<RuleServiceRetryPolicy> clone() const = 0;
};
 ...
 */
class RuleServiceLimitedErrorCountRetryPolicy : public RuleServiceRetryPolicy {
 public:
  /**
  ...
  std::unique_ptr<RuleServiceRetryPolicy> clone() const override {
    return std::make_unique<RuleServiceLimitedErrorCountRetryPolicy>(
        maximum_failures());
  }
 ...
 * - [`kUnavailable`](@ref google::cloud::StatusCode)
 */
class RuleServiceLimitedTimeRetryPolicy : public RuleServiceRetryPolicy {
 public:
  /**
  ...
  std::unique_ptr<RuleServiceRetryPolicy> clone() const override {
    return std::make_unique<RuleServiceLimitedTimeRetryPolicy>(
        maximum_duration());
  }
 ...
 * sets in `RuleServiceClient`. This allows users to inject custom behavior
 ...
 */
class RuleServiceConnection {
 public:
  virtual ~RuleServiceConnection() = 0;
 ...
 * should be passed as an argument to the constructor of RuleServiceClient.
 *
 * The optional @p options argument may be used to configure aspects of the
 * returned `RuleServiceConnection`. Expected options are any of the types in
 * the following option lists:
 *
 * - `google::cloud::CommonOptionList`
 * - `google::cloud::GrpcOptionList`
 * - `google::cloud::UnifiedCredentialsOptionList`
 * - `google::cloud::chronicle_v1::RuleServicePolicyOptionList`
 *
 * @note Unexpected options will be ignored. To log unexpected options instead,
 *     set `GOOGLE_CLOUD_CPP_ENABLE_CLOG=yes` in the environment.
 *
 * @param options (optional) Configure the `RuleServiceConnection` created by
 * this function.
 */
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_CHRONICLE_V1_RULE_CONNECTION_H
