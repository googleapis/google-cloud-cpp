...
#include <google/cloud/chronicle/v1/entity.pb.h>
#include <memory>
...
class EntityServiceRetryPolicy : public ::google::cloud::RetryPolicy {
 public:
  /// Creates a new instance of the policy, reset to the initial state.
  virtual std::unique_ptr<EntityServiceRetryPolicy> clone() const = 0;
};
...
class EntityServiceLimitedErrorCountRetryPolicy : public EntityServiceRetryPolicy {
 public:
  ...
  std::unique_ptr<EntityServiceRetryPolicy> clone() const override {
    return std::make_unique<EntityServiceLimitedErrorCountRetryPolicy>(
        maximum_failures());
  }
 ...
 * - [`kUnavailable`](@ref google::cloud::StatusCode)
 */
class EntityServiceLimitedTimeRetryPolicy : public EntityServiceRetryPolicy {
 public:
  /**
  ...
  std::unique_ptr<EntityServiceRetryPolicy> clone() const override {
    return std::make_unique<EntityServiceLimitedTimeRetryPolicy>(
        maximum_duration());
  }
 ...
 * sets in `EntityServiceClient`. This allows users to inject custom behavior
 ...
 */
class EntityServiceConnection {
 public:
  virtual ~EntityServiceConnection() = 0;
 ...
 * should be passed as an argument to the constructor of EntityServiceClient.
 *
 * The optional @p options argument may be used to configure aspects of the
 * returned `EntityServiceConnection`. Expected options are any of the types in
 * the following option lists:
 *
 * - `google::cloud::CommonOptionList`
 * - `google::cloud::GrpcOptionList`
 * - `google::cloud::UnifiedCredentialsOptionList`
 * - `google::cloud::chronicle_v1::EntityServicePolicyOptionList`
 *
 * @note Unexpected options will be ignored. To log unexpected options instead,
 *     set `GOOGLE_CLOUD_CPP_ENABLE_CLOG=yes` in the environment.
 *
 * @param options (optional) Configure the `EntityServiceConnection` created by
 * this function.
 */
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_CHRONICLE_V1_ENTITY_CONNECTION_H
