...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_CHRONICLE_V1_INTERNAL_ENTITY_TRACING_STUB_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_CHRONICLE_V1_INTERNAL_ENTITY_TRACING_STUB_H
...
class EntityServiceTracingStub : public EntityServiceStub {
 public:
  ~EntityServiceTracingStub() override = default;

  explicit EntityServiceTracingStub(std::shared_ptr<EntityServiceStub> child);
 ...
 private:
  std::shared_ptr<EntityServiceStub> child_;
 ...
 * OpenTelemetry.
 */
std::shared_ptr<EntityServiceStub> MakeEntityServiceTracingStub(
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_CHRONICLE_V1_INTERNAL_ENTITY_TRACING_STUB_H
