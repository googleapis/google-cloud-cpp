...
class DataAccessControlServiceConnectionImpl
 ...
 private:
  ...
  std::shared_ptr<chronicle_v1_internal::DataAccessControlServiceStub> stub_;
  Options options_;
};
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_CHRONICLE_V1_INTERNAL_DATA_ACCESS_CONTROL_CONNECTION_IMPL_H
