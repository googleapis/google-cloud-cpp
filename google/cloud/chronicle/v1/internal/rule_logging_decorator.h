...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_CHRONICLE_V1_INTERNAL_RULE_LOGGING_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_CHRONICLE_V1_INTERNAL_RULE_LOGGING_DECORATOR_H
...
class RuleServiceLogging : public RuleServiceStub {
 public:
  ~RuleServiceLogging() override = default;
  RuleServiceLogging(std::shared_ptr<RuleServiceStub> child,
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_CHRONICLE_V1_INTERNAL_RULE_LOGGING_DECORATOR_H
