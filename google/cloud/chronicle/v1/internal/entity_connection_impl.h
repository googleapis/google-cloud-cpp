...
class EntityServiceConnectionImpl
 ...
 private:
  ...
  std::shared_ptr<chronicle_v1_internal::EntityServiceStub> stub_;
  Options options_;
};
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_CHRONICLE_V1_INTERNAL_ENTITY_CONNECTION_IMPL_H
