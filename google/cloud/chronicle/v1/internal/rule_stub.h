...
class RuleServiceStub {
 public:
  ...
  virtual StatusOr<google::cloud::chronicle::v1::ListRuleRevisionsResponse> ListRuleRevisions(
      grpc::ClientContext& context,
      Options const& options,
      google::cloud::chronicle::v1::ListRuleRevisionsRequest const& request) = 0;
  ...
  virtual StatusOr<google::cloud::chronicle::v1::ListRetrohuntsResponse> ListRetrohunts(
      grpc::ClientContext& context,
      Options const& options,
      google::cloud::chronicle::v1::ListRetrohuntsRequest const& request) = 0;

  virtual StatusOr<google::cloud::chronicle::v1::RuleDeployment> GetRuleDeployment(
      grpc::ClientContext& context,
      Options const& options,
      google::cloud::chronicle::v1::GetRuleDeploymentRequest const& request) = 0;

  virtual StatusOr<google::cloud::chronicle::v1::ListRuleDeploymentsResponse> ListRuleDeployments(
      grpc::ClientContext& context,
      Options const& options,
      google::cloud::chronicle::v1::ListRuleDeploymentsRequest const& request) = 0;

  virtual StatusOr<google::cloud::chronicle::v1::RuleDeployment> UpdateRuleDeployment(
      grpc::ClientContext& context,
      Options const& options,
      google::cloud::chronicle::v1::UpdateRuleDeploymentRequest const& request) = 0;
...
class DefaultRuleServiceStub : public RuleServiceStub {
 public:
  DefaultRuleServiceStub(
      std::unique_ptr<google::cloud::chronicle::v1::RuleService::StubInterface> grpc_stub,
 ...
 private:
  std::unique_ptr<google::cloud::chronicle::v1::RuleService::StubInterface> grpc_stub_;
