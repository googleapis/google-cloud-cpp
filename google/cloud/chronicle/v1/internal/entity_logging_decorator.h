...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_CHRONICLE_V1_INTERNAL_ENTITY_LOGGING_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_CHRONICLE_V1_INTERNAL_ENTITY_LOGGING_DECORATOR_H
...
class EntityServiceLogging : public EntityServiceStub {
 public:
  ~EntityServiceLogging() override = default;
  EntityServiceLogging(std::shared_ptr<EntityServiceStub> child,
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_CHRONICLE_V1_INTERNAL_ENTITY_LOGGING_DECORATOR_H
