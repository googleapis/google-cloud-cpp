...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_CHRONICLE_V1_INTERNAL_INSTANCE_CONNECTION_IMPL_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_CHRONICLE_V1_INTERNAL_INSTANCE_CONNECTION_IMPL_H
...
class InstanceServiceConnectionImpl
    : public chronicle_v1::InstanceServiceConnection {
 public:
  ~InstanceServiceConnectionImpl() override = default;

  InstanceServiceConnectionImpl(
 ...
 private:
  ...
  std::shared_ptr<chronicle_v1_internal::InstanceServiceStub> stub_;
  Options options_;
};
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_CHRONICLE_V1_INTERNAL_INSTANCE_CONNECTION_IMPL_H
