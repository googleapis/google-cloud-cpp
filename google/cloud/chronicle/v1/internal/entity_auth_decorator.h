...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_CHRONICLE_V1_INTERNAL_ENTITY_AUTH_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_CHRONICLE_V1_INTERNAL_ENTITY_AUTH_DECORATOR_H
...
class EntityServiceAuth : public EntityServiceStub {
 public:
  ~EntityServiceAuth() override = default;
  EntityServiceAuth(
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_CHRONICLE_V1_INTERNAL_ENTITY_AUTH_DECORATOR_H
