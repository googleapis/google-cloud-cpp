...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_CHRONICLE_V1_INTERNAL_REFERENCE_LIST_LOGGING_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_CHRONICLE_V1_INTERNAL_REFERENCE_LIST_LOGGING_DECORATOR_H
...
class ReferenceListServiceLogging : public ReferenceListServiceStub {
 public:
  ~ReferenceListServiceLogging() override = default;
  ReferenceListServiceLogging(std::shared_ptr<ReferenceListServiceStub> child,
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_CHRONICLE_V1_INTERNAL_REFERENCE_LIST_LOGGING_DECORATOR_H
