...
std::unique_ptr<chronicle_v1::InstanceServiceRetryPolicy>
...
backoff_policy(Options const& options) {
  return options.get<chronicle_v1::InstanceServiceBackoffPolicyOption>()->clone();
}

std::unique_ptr<chronicle_v1::InstanceServiceConnectionIdempotencyPolicy>
idempotency_policy(Options const& options) {
  return options.get<chronicle_v1::InstanceServiceConnectionIdempotencyPolicyOption>()->clone();
}
...
InstanceServiceConnectionImpl::GetInstance(google::cloud::chronicle::v1::GetInstanceRequest const& request) {
...
InstanceServiceConnectionImpl::ListOperations(google::longrunning::ListOperationsRequest request) {
  ...
  return google::cloud::internal::MakePaginationRange<StreamRange<google::longrunning::Operation>>(
      ...
      [idempotency, function_name, stub = stub_,
       retry = std::shared_ptr<chronicle_v1::InstanceServiceRetryPolicy>(retry_policy(*current)),
...
InstanceServiceConnectionImpl::GetOperation(google::longrunning::GetOperationRequest const& request) {
  auto current = google::cloud::internal::SaveCurrentOptions();
  return google::cloud::internal::RetryLoop(
      retry_policy(*current), backoff_policy(*current),
...
Status
InstanceServiceConnectionImpl::DeleteOperation(google::longrunning::DeleteOperationRequest const& request) {
  auto current = google::cloud::internal::SaveCurrentOptions();
  return google::cloud::internal::RetryLoop(
      retry_policy(*current), backoff_policy(*current),
...
Status
InstanceServiceConnectionImpl::CancelOperation(google::longrunning::CancelOperationRequest const& request) {
  auto current = google::cloud::internal::SaveCurrentOptions();
  return google::cloud::internal::RetryLoop(
      retry_policy(*current), backoff_policy(*current),
