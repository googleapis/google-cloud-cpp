...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_CHRONICLE_V1_MOCKS_MOCK_ENTITY_CONNECTION_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_CHRONICLE_V1_MOCKS_MOCK_ENTITY_CONNECTION_H
...
/**
 * A class to mock `EntityServiceConnection`.
 *
 * Application developers may want to test their code with simulated responses,
 * including errors, from an object of type `EntityServiceClient`. To do so,
 * construct an object of type `EntityServiceClient` with an instance of this
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_CHRONICLE_V1_MOCKS_MOCK_ENTITY_CONNECTION_H
