 ...
 */
struct DataAccessControlServiceRetryPolicyOption {
  using Type = std::shared_ptr<DataAccessControlServiceRetryPolicy>;
};
 ...
 * @ingroup google-cloud-chronicle-options
 */
struct DataAccessControlServiceBackoffPolicyOption {
...
/**
 * The options applicable to DataAccessControlService.
 *
 * @ingroup google-cloud-chronicle-options
 */
using DataAccessControlServicePolicyOptionList =
    OptionList<DataAccessControlServiceRetryPolicyOption,
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_CHRONICLE_V1_DATA_ACCESS_CONTROL_OPTIONS_H
