...
#include <google/cloud/chronicle/v1/reference_list.pb.h>
#include <memory>
...
class ReferenceListServiceRetryPolicy : public ::google::cloud::RetryPolicy {
 public:
  /// Creates a new instance of the policy, reset to the initial state.
  virtual std::unique_ptr<ReferenceListServiceRetryPolicy> clone() const = 0;
};
...
class ReferenceListServiceLimitedErrorCountRetryPolicy : public ReferenceListServiceRetryPolicy {
 public:
  ...
  std::unique_ptr<ReferenceListServiceRetryPolicy> clone() const override {
    return std::make_unique<ReferenceListServiceLimitedErrorCountRetryPolicy>(
        maximum_failures());
  }
...
class ReferenceListServiceLimitedTimeRetryPolicy : public ReferenceListServiceRetryPolicy {
 public:
  ...
  std::unique_ptr<ReferenceListServiceRetryPolicy> clone() const override {
    return std::make_unique<ReferenceListServiceLimitedTimeRetryPolicy>(
        maximum_duration());
  }
 ...
 *
 * For mocking, see `chronicle_v1_mocks::MockReferenceListServiceConnection`.
 */
class ReferenceListServiceConnection {
 public:
  virtual ~ReferenceListServiceConnection() = 0;
 ...
 * - `google::cloud::chronicle_v1::ReferenceListServicePolicyOptionList`
 *
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_CHRONICLE_V1_REFERENCE_LIST_CONNECTION_H
