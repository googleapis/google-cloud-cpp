...
// clang-format off
// main-dox-marker: chronicle_v1::RuleServiceClient
// lro-marker: true
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::chronicle_v1::RuleServiceClient(
      google::cloud::chronicle_v1::MakeRuleServiceConnection(options));
  //! [set-client-endpoint]
}

//! [custom-idempotency-policy]
class CustomIdempotencyPolicy
   : public google::cloud::chronicle_v1::RuleServiceConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::chronicle_v1::RuleServiceConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::chronicle_v1::RuleServiceConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::chronicle_v1::RuleServiceRetryPolicyOption>(
      google::cloud::chronicle_v1::RuleServiceLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::chronicle_v1::RuleServiceBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::chronicle_v1::MakeRuleServiceConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::chronicle_v1::RuleServiceClient(connection);
  auto c2 = google::cloud::chronicle_v1::RuleServiceClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::chronicle_v1::RuleServiceClient(
    connection, google::cloud::Options{}.set<google::cloud::chronicle_v1::RuleServiceRetryPolicyOption>(
      google::cloud::chronicle_v1::RuleServiceLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::chronicle_v1::RuleServiceRetryPolicyOption>(
  //       google::cloud::chronicle_v1::RuleServiceLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::chronicle_v1::RuleServicePollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::chronicle_v1::RuleServiceRetryPolicyOption::Type,
            google::cloud::chronicle_v1::RuleServiceBackoffPolicyOption::Type>(
            google::cloud::chronicle_v1::RuleServiceLimitedTimeRetryPolicy(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::chronicle_v1::RuleServiceClient(
      google::cloud::chronicle_v1::MakeRuleServiceConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
