...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::chronicle_v1::EntityServiceClient(
      google::cloud::chronicle_v1::MakeEntityServiceConnection(ud_options));
...
class CustomIdempotencyPolicy : public google::cloud::chronicle_v1::
 ...
 public:
  ...
  std::unique_ptr<
      google::cloud::chronicle_v1::EntityServiceConnectionIdempotencyPolicy>
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
      ...
      google::cloud::Options{}
          ...
          .set<google::cloud::chronicle_v1::EntityServiceRetryPolicyOption>(
              google::cloud::chronicle_v1::
                  EntityServiceLimitedErrorCountRetryPolicy(3)
                      .clone())
  ...
  auto c3 = google::cloud::chronicle_v1::EntityServiceClient(
      ...
      google::cloud::Options{}
          .set<google::cloud::chronicle_v1::EntityServiceRetryPolicyOption>(
              google::cloud::chronicle_v1::EntityServiceLimitedTimeRetryPolicy(
