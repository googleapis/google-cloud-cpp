...
#include <google/cloud/chronicle/v1/data_access_control.pb.h>
#include <memory>
...
class DataAccessControlServiceLimitedTimeRetryPolicy : public DataAccessControlServiceRetryPolicy {
 public:
  ...
  std::unique_ptr<DataAccessControlServiceRetryPolicy> clone() const override {
    return std::make_unique<DataAccessControlServiceLimitedTimeRetryPolicy>(
        maximum_duration());
  }
...
class DataAccessControlServiceConnection {
 public:
  virtual ~DataAccessControlServiceConnection() = 0;
 ...
 * - `google::cloud::chronicle_v1::DataAccessControlServicePolicyOptionList`
 *
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_CHRONICLE_V1_DATA_ACCESS_CONTROL_CONNECTION_H
