...
// main-dox-marker: GOOGLE_CLOUD_CPP_NS::EventarcClient
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::GOOGLE_CLOUD_CPP_NS::EventarcClient(
      google::cloud::GOOGLE_CLOUD_CPP_NS::MakeEventarcConnection(options));
  //! [set-client-endpoint]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::GOOGLE_CLOUD_CPP_NS::EventarcClient(
        google::cloud::GOOGLE_CLOUD_CPP_NS::MakeEventarcConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
