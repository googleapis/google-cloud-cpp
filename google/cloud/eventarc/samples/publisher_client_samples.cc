...
// main-dox-marker: GOOGLE_CLOUD_CPP_NS::PublisherClient
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::GOOGLE_CLOUD_CPP_NS::PublisherClient(
      google::cloud::GOOGLE_CLOUD_CPP_NS::MakePublisherConnection(options));
  //! [set-client-endpoint]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::GOOGLE_CLOUD_CPP_NS::PublisherClient(
        google::cloud::GOOGLE_CLOUD_CPP_NS::MakePublisherConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
