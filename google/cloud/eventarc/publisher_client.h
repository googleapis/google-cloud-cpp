...
///     types defined in eventarc_publishing_v1 instead of the aliases defined in
///     this namespace.
namespace eventarc {
GOOGLE_CLOUD_CPP_INLINE_NAMESPACE_BEGIN

/// @deprecated Use eventarc_publishing_v1::PublisherClient directly.
using ::google::cloud::eventarc_publishing_v1::PublisherClient;
