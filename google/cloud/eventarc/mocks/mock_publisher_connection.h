...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_EVENTARC_MOCKS_MOCK_PUBLISHER_CONNECTION_H
 ...
 * including errors from a `PublisherClient`. To do so, construct a
 * `PublisherClient` with an instance of this class. Then use the Google
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_EVENTARC_MOCKS_MOCK_PUBLISHER_CONNECTION_H
