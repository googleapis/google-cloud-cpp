...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::eventarc_v1::EventarcClient(
      google::cloud::eventarc_v1::MakeEventarcConnection(*ud_options));
  //! [set-client-universe-domain]
}
...
class CustomIdempotencyPolicy
 ...
 public:
  ...
  std::unique_ptr<
      google::cloud::eventarc_v1::EventarcConnectionIdempotencyPolicy>
