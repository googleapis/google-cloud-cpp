...
/**
 * A retry policy for `PublisherConnection` that stops retrying after a
...
class PublisherLimitedErrorCountRetryPolicy : public PublisherRetryPolicy {
 public:
  PublisherLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `PublisherConnection` that stops retrying after
