...
Options PublisherDefaultOptions(Options options) {
  ...
  if (!options.has<eventarc_publishing_v1::PublisherConnectionIdempotencyPolicyOption>()) {
    options.set<eventarc_publishing_v1::PublisherConnectionIdempotencyPolicyOption>(
