# HOWTO: using the Cloud Speech-to-Text API C++ client in your project

This directory contains small examples showing how to use the Cloud Speech-to-Text API C++
...
Like most Google Cloud Platform (GCP) services, Cloud Speech-to-Text API requires that
...
3. Configure CMake, if necessary, configure the directory where you installed
   ...
   ```bash
   cd $HOME/gooogle-cloud-cpp/google/cloud/speech/quickstart
