...
class AdaptationRetryPolicy : public ::google::cloud::RetryPolicy {
 public:
  /// Creates a new instance of the policy, reset to the initial state.
  virtual std::unique_ptr<AdaptationRetryPolicy> clone() const = 0;
};
 ...
 */
class AdaptationLimitedErrorCountRetryPolicy : public AdaptationRetryPolicy {
 public:
  /**
  ...
  std::unique_ptr<AdaptationRetryPolicy> clone() const override {
    return std::make_unique<AdaptationLimitedErrorCountRetryPolicy>(
        maximum_failures());
  }
 ...
 * - [`kUnavailable`](@ref google::cloud::StatusCode)
 */
class AdaptationLimitedTimeRetryPolicy : public AdaptationRetryPolicy {
 public:
  /**
  ...
  std::unique_ptr<AdaptationRetryPolicy> clone() const override {
    return std::make_unique<AdaptationLimitedTimeRetryPolicy>(
        maximum_duration());
  }
 ...
 * sets in `AdaptationClient`. This allows users to inject custom behavior
 ...
 */
class AdaptationConnection {
 public:
  virtual ~AdaptationConnection() = 0;
 ...
 * should be passed as an argument to the constructor of AdaptationClient.
 *
 * The optional @p options argument may be used to configure aspects of the
 * returned `AdaptationConnection`. Expected options are any of the types in
 ...
 *
 * @param options (optional) Configure the `AdaptationConnection` created by
 * this function.
 */
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SPEECH_V1_ADAPTATION_CONNECTION_H
