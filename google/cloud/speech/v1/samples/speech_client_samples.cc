...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::speech_v1::SpeechClient(
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::speech_v1::SpeechClient(
      google::cloud::speech_v1::MakeSpeechConnection(*ud_options));
  //! [set-client-universe-domain]
}
