...
inline std::unique_ptr<speech::SpeechRetryPolicy> retry_policy() {
  return internal::CurrentOptions()
      .get<speech::SpeechRetryPolicyOption>()
      ->clone();
}

inline std::unique_ptr<BackoffPolicy> backoff_policy() {
  return internal::CurrentOptions()
      .get<speech::SpeechBackoffPolicyOption>()
      ->clone();
}

inline std::unique_ptr<speech::SpeechConnectionIdempotencyPolicy>
idempotency_policy() {
  return internal::CurrentOptions()
      .get<speech::SpeechConnectionIdempotencyPolicyOption>()
      ->clone();
}

inline std::unique_ptr<PollingPolicy> polling_policy() {
  return internal::CurrentOptions()
      .get<speech::SpeechPollingPolicyOption>()
      ->clone();
}
