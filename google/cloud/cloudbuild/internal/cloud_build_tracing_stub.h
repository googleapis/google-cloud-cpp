...
class CloudBuildTracingStub : public CloudBuildStub {
 public:
  ~CloudBuildTracingStub() override = default;

  explicit CloudBuildTracingStub(std::shared_ptr<CloudBuildStub> child);
