...
/**
 * A retry policy for `CloudBuildConnection` that stops retrying after a
...
class CloudBuildLimitedErrorCountRetryPolicy : public CloudBuildRetryPolicy {
 public:
  CloudBuildLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `CloudBuildConnection` that stops retrying after
