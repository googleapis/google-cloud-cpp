...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::cloudbuild_v1::CloudBuildClient(
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::cloudbuild_v1::CloudBuildClient(
      google::cloud::cloudbuild_v1::MakeCloudBuildConnection(ud_options));
