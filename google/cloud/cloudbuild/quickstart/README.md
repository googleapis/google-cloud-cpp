# HOWTO: using the Cloud Build API C++ client in your project

This directory contains small examples showing how to use the Cloud Build API C++
...
2. Install the dependencies with your favorite tools. As an example, if you use
   ...
   ```bash
   cd $HOME/vcpkg
   ./vcpkg install google-cloud-cpp[core,cloudbuild]
   ```
...
3. Configure CMake, if necessary, configure the directory where you installed
   ...
   ```bash
   cd $HOME/gooogle-cloud-cpp/google/cloud/cloudbuild/quickstart
...
[quickstart-link]: https://cloud.google.com/cloudbuild/docs/quickstart
