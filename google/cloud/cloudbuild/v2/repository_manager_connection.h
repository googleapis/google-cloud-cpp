...
/**
 * A retry policy for `RepositoryManagerConnection` that stops retrying after a
...
class RepositoryManagerLimitedErrorCountRetryPolicy
 ...
 public:
  RepositoryManagerLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `RepositoryManagerConnection` that stops retrying after
