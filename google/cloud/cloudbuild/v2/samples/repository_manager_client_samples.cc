...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::cloudbuild_v2::RepositoryManagerClient(
...
class CustomIdempotencyPolicy
   : public google::cloud::cloudbuild_v2::RepositoryManagerConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::cloudbuild_v2::RepositoryManagerConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::cloudbuild_v2::RepositoryManagerConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::cloudbuild_v2::RepositoryManagerRetryPolicyOption>(
      google::cloud::cloudbuild_v2::RepositoryManagerLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::cloudbuild_v2::RepositoryManagerBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::cloudbuild_v2::MakeRepositoryManagerConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::cloudbuild_v2::RepositoryManagerClient(connection);
  auto c2 = google::cloud::cloudbuild_v2::RepositoryManagerClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::cloudbuild_v2::RepositoryManagerClient(
    connection, google::cloud::Options{}.set<google::cloud::cloudbuild_v2::RepositoryManagerRetryPolicyOption>(
      google::cloud::cloudbuild_v2::RepositoryManagerLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::cloudbuild_v2::RepositoryManagerRetryPolicyOption>(
  //       google::cloud::cloudbuild_v2::RepositoryManagerLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::cloudbuild_v2::RepositoryManagerPollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::cloudbuild_v2::RepositoryManagerRetryPolicyOption::Type,
            google::cloud::cloudbuild_v2::RepositoryManagerBackoffPolicyOption::Type>(
            google::cloud::cloudbuild_v2::RepositoryManagerLimitedTimeRetryPolicy(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::cloudbuild_v2::RepositoryManagerClient(
      google::cloud::cloudbuild_v2::MakeRepositoryManagerConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
