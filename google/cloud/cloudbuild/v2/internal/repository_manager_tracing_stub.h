...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_CLOUDBUILD_V2_INTERNAL_REPOSITORY_MANAGER_TRACING_STUB_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_CLOUDBUILD_V2_INTERNAL_REPOSITORY_MANAGER_TRACING_STUB_H
...
class RepositoryManagerTracingStub : public RepositoryManagerStub {
 public:
  ~RepositoryManagerTracingStub() override = default;

  explicit RepositoryManagerTracingStub(std::shared_ptr<RepositoryManagerStub> child);
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_CLOUDBUILD_V2_INTERNAL_REPOSITORY_MANAGER_TRACING_STUB_H
