...
std::shared_ptr<RepositoryManagerStub> CreateDefaultRepositoryManagerStub(
  ...
  auto endpoint = internal::DetermineServiceEndpoint(
      internal::GetEnv("GOOGLE_CLOUD_CPP_REPOSITORY_MANAGER_ENDPOINT"),
  ...
  if (!endpoint.ok()) {
    ...
    stub = std::make_shared<DefaultRepositoryManagerStub>(
  ...
  if (internal::TracingEnabled(options)) {
    stub = MakeRepositoryManagerTracingStub(std::move(stub));
  }
  return stub;
}
