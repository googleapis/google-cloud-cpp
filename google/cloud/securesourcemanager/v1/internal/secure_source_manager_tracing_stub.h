...
class SecureSourceManagerTracingStub : public SecureSourceManagerStub {
 public:
  ...
  explicit SecureSourceManagerTracingStub(std::shared_ptr<SecureSourceManagerStub> child);

  StatusOr<google::cloud::securesourcemanager::v1::ListInstancesResponse> ListInstances(
      grpc::ClientContext& context,
      Options const& options,
      google::cloud::securesourcemanager::v1::ListInstancesRequest const& request) override;
  ...
  StatusOr<google::cloud::securesourcemanager::v1::ListRepositoriesResponse> ListRepositories(
      grpc::ClientContext& context,
      Options const& options,
      google::cloud::securesourcemanager::v1::ListRepositoriesRequest const& request) override;
  ...
  StatusOr<google::cloud::securesourcemanager::v1::ListBranchRulesResponse> ListBranchRules(
      grpc::ClientContext& context,
      Options const& options,
      google::cloud::securesourcemanager::v1::ListBranchRulesRequest const& request) override;
