...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_PARALLELSTORE_V1_INTERNAL_PARALLELSTORE_LOGGING_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_PARALLELSTORE_V1_INTERNAL_PARALLELSTORE_LOGGING_DECORATOR_H
...
class ParallelstoreLogging : public ParallelstoreStub {
 public:
  ~ParallelstoreLogging() override = default;
  ParallelstoreLogging(std::shared_ptr<ParallelstoreStub> child,
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_PARALLELSTORE_V1_INTERNAL_PARALLELSTORE_LOGGING_DECORATOR_H
