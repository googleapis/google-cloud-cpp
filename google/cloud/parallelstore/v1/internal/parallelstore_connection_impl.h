...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_PARALLELSTORE_V1_INTERNAL_PARALLELSTORE_CONNECTION_IMPL_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_PARALLELSTORE_V1_INTERNAL_PARALLELSTORE_CONNECTION_IMPL_H
...
class ParallelstoreConnectionImpl
    : public parallelstore_v1::ParallelstoreConnection {
 public:
  ~ParallelstoreConnectionImpl() override = default;

  ParallelstoreConnectionImpl(
 ...
 private:
  ...
  std::shared_ptr<parallelstore_v1_internal::ParallelstoreStub> stub_;
  Options options_;
};
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_PARALLELSTORE_V1_INTERNAL_PARALLELSTORE_CONNECTION_IMPL_H
