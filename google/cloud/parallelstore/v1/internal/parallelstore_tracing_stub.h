...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_PARALLELSTORE_V1_INTERNAL_PARALLELSTORE_TRACING_STUB_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_PARALLELSTORE_V1_INTERNAL_PARALLELSTORE_TRACING_STUB_H
...
class ParallelstoreTracingStub : public ParallelstoreStub {
 public:
  ~ParallelstoreTracingStub() override = default;

  explicit ParallelstoreTracingStub(std::shared_ptr<ParallelstoreStub> child);
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_PARALLELSTORE_V1_INTERNAL_PARALLELSTORE_TRACING_STUB_H
