...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_PARALLELSTORE_V1_INTERNAL_PARALLELSTORE_STUB_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_PARALLELSTORE_V1_INTERNAL_PARALLELSTORE_STUB_H
...
class ParallelstoreStub {
 public:
  virtual ~ParallelstoreStub() = 0;

  virtual StatusOr<google::cloud::parallelstore::v1::ListInstancesResponse> ListInstances(
      grpc::ClientContext& context,
      Options const& options,
      google::cloud::parallelstore::v1::ListInstancesRequest const& request) = 0;

  virtual StatusOr<google::cloud::parallelstore::v1::Instance> GetInstance(
      grpc::ClientContext& context,
      Options const& options,
      google::cloud::parallelstore::v1::GetInstanceRequest const& request) = 0;

  virtual future<StatusOr<google::longrunning::Operation>> AsyncCreateInstance(
      google::cloud::CompletionQueue& cq,
      std::shared_ptr<grpc::ClientContext> context,
      google::cloud::internal::ImmutableOptions options,
      google::cloud::parallelstore::v1::CreateInstanceRequest const& request) = 0;
  ...
  virtual future<StatusOr<google::longrunning::Operation>> AsyncUpdateInstance(
      ...
      std::shared_ptr<grpc::ClientContext> context,
      google::cloud::internal::ImmutableOptions options,
      google::cloud::parallelstore::v1::UpdateInstanceRequest const& request) = 0;
  ...
  virtual future<StatusOr<google::longrunning::Operation>> AsyncDeleteInstance(
      ...
      std::shared_ptr<grpc::ClientContext> context,
      google::cloud::internal::ImmutableOptions options,
      google::cloud::parallelstore::v1::DeleteInstanceRequest const& request) = 0;
  ...
  virtual future<StatusOr<google::longrunning::Operation>> AsyncImportData(
      ...
      std::shared_ptr<grpc::ClientContext> context,
      google::cloud::internal::ImmutableOptions options,
      google::cloud::parallelstore::v1::ImportDataRequest const& request) = 0;
  ...
  virtual future<StatusOr<google::longrunning::Operation>> AsyncExportData(
      ...
      std::shared_ptr<grpc::ClientContext> context,
      google::cloud::internal::ImmutableOptions options,
      google::cloud::parallelstore::v1::ExportDataRequest const& request) = 0;
...
class DefaultParallelstoreStub : public ParallelstoreStub {
 public:
  DefaultParallelstoreStub(
      std::unique_ptr<google::cloud::parallelstore::v1::Parallelstore::StubInterface> grpc_stub,
 ...
 private:
  std::unique_ptr<google::cloud::parallelstore::v1::Parallelstore::StubInterface> grpc_stub_;
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_PARALLELSTORE_V1_INTERNAL_PARALLELSTORE_STUB_H
