...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_CONFIGDELIVERY_V1_INTERNAL_CONFIG_DELIVERY_METADATA_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_CONFIGDELIVERY_V1_INTERNAL_CONFIG_DELIVERY_METADATA_DECORATOR_H
...
class ConfigDeliveryMetadata : public ConfigDeliveryStub {
 public:
  ~ConfigDeliveryMetadata() override = default;
  ConfigDeliveryMetadata(std::shared_ptr<ConfigDeliveryStub> child,
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_CONFIGDELIVERY_V1_INTERNAL_CONFIG_DELIVERY_METADATA_DECORATOR_H
