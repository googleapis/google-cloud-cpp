...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_CONFIGDELIVERY_V1_INTERNAL_CONFIG_DELIVERY_AUTH_DECORATOR_H
...
class ConfigDeliveryAuth : public ConfigDeliveryStub {
 public:
  ~ConfigDeliveryAuth() override = default;
  ConfigDeliveryAuth(
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_CONFIGDELIVERY_V1_INTERNAL_CONFIG_DELIVERY_AUTH_DECORATOR_H
