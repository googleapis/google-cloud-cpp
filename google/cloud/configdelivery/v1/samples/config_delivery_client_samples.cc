...
// clang-format off
// main-dox-marker: configdelivery_v1::ConfigDeliveryClient
// lro-marker: true
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::configdelivery_v1::ConfigDeliveryClient(
...
class CustomIdempotencyPolicy
   : public google::cloud::configdelivery_v1::ConfigDeliveryConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::configdelivery_v1::ConfigDeliveryConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::configdelivery_v1::ConfigDeliveryConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::configdelivery_v1::ConfigDeliveryRetryPolicyOption>(
      google::cloud::configdelivery_v1::ConfigDeliveryLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::configdelivery_v1::ConfigDeliveryBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::configdelivery_v1::MakeConfigDeliveryConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::configdelivery_v1::ConfigDeliveryClient(connection);
  auto c2 = google::cloud::configdelivery_v1::ConfigDeliveryClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::configdelivery_v1::ConfigDeliveryClient(
    connection, google::cloud::Options{}.set<google::cloud::configdelivery_v1::ConfigDeliveryRetryPolicyOption>(
      google::cloud::configdelivery_v1::ConfigDeliveryLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::configdelivery_v1::ConfigDeliveryRetryPolicyOption>(
  //       google::cloud::configdelivery_v1::ConfigDeliveryLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::configdelivery_v1::ConfigDeliveryPollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::configdelivery_v1::ConfigDeliveryRetryPolicyOption::Type,
            google::cloud::configdelivery_v1::ConfigDeliveryBackoffPolicyOption::Type>(
            google::cloud::configdelivery_v1::ConfigDeliveryLimitedTimeRetryPolicy(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::configdelivery_v1::ConfigDeliveryClient(
      google::cloud::configdelivery_v1::MakeConfigDeliveryConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
