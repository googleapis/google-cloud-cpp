...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::configdelivery_v1::ConfigDeliveryClient(
      google::cloud::configdelivery_v1::MakeConfigDeliveryConnection(
          *ud_options));
  //! [set-client-universe-domain]
}

//! [custom-idempotency-policy]
class CustomIdempotencyPolicy : public google::cloud::configdelivery_v1::
                                    ConfigDeliveryConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::configdelivery_v1::
                      ConfigDeliveryConnectionIdempotencyPolicy>
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
                     .set<google::cloud::configdelivery_v1::
                              ConfigDeliveryConnectionIdempotencyPolicyOption>(
                         CustomIdempotencyPolicy().clone())
                     .set<google::cloud::configdelivery_v1::
                              ConfigDeliveryRetryPolicyOption>(
                         google::cloud::configdelivery_v1::
                             ConfigDeliveryLimitedErrorCountRetryPolicy(3)
                                 .clone())
                     .set<google::cloud::configdelivery_v1::
  ...
  auto c3 = google::cloud::configdelivery_v1::ConfigDeliveryClient(
      ...
      google::cloud::Options{}
          .set<google::cloud::configdelivery_v1::
                   ConfigDeliveryRetryPolicyOption>(
              google::cloud::configdelivery_v1::
                  ConfigDeliveryLimitedTimeRetryPolicy(std::chrono::minutes(5))
                      .clone()));
      ...
      google::cloud::Options{}
          .set<google::cloud::configdelivery_v1::
              ...
              google::cloud::GenericPollingPolicy<
                  google::cloud::configdelivery_v1::
                      ConfigDeliveryRetryPolicyOption::Type,
                  google::cloud::configdelivery_v1::
                      ConfigDeliveryBackoffPolicyOption::Type>(
                  google::cloud::configdelivery_v1::
