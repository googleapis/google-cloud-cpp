...
class MockLivestreamServiceConnection
 ...
 public:
  ...
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock,
  /// StartDistribution(Matcher<google::cloud::video::livestream::v1::StartDistributionRequest
  /// const&>(_)))
  /// @endcode
  MOCK_METHOD(
      future<StatusOr<
  ...
  /// @code
  /// using ::testing::_;
  /// EXPECT_CALL(*mock, StartDistribution(_, _))
  /// @endcode
  MOCK_METHOD(
  ...
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock,
  /// StartDistribution(Matcher<google::longrunning::Operation const&>(_)))
  /// @endcode
  MOCK_METHOD(
      future<StatusOr<
          google::cloud::video::livestream::v1::ChannelOperationResponse>>,
  ...
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock,
  /// StopDistribution(Matcher<google::cloud::video::livestream::v1::StopDistributionRequest
  /// const&>(_)))
  /// @endcode
  MOCK_METHOD(
      future<StatusOr<
  ...
  /// @code
  /// using ::testing::_;
  /// EXPECT_CALL(*mock, StopDistribution(_, _))
  /// @endcode
  MOCK_METHOD(
  ...
  /// using ::testing::_;
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock, StopDistribution(Matcher<google::longrunning::Operation
  /// const&>(_)))
  /// @endcode
  MOCK_METHOD(
      future<StatusOr<
  ...
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock,
  /// CreateDvrSession(Matcher<google::cloud::video::livestream::v1::CreateDvrSessionRequest
  /// const&>(_)))
  /// @endcode
  MOCK_METHOD(
  ...
  /// using ::testing::_;
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock, CreateDvrSession(Matcher<google::longrunning::Operation
  /// const&>(_)))
  /// @endcode
  MOCK_METHOD(
      future<StatusOr<google::cloud::video::livestream::v1::DvrSession>>,
  ...
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock,
  /// DeleteDvrSession(Matcher<google::cloud::video::livestream::v1::DeleteDvrSessionRequest
  /// const&>(_)))
  /// @endcode
  MOCK_METHOD(
      future<StatusOr<google::cloud::video::livestream::v1::OperationMetadata>>,
  ...
  /// using ::testing::_;
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock, DeleteDvrSession(Matcher<google::longrunning::Operation
  /// const&>(_)))
  /// @endcode
  MOCK_METHOD(
      future<StatusOr<google::cloud::video::livestream::v1::OperationMetadata>>,
  ...
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock,
  /// UpdateDvrSession(Matcher<google::cloud::video::livestream::v1::UpdateDvrSessionRequest
  /// const&>(_)))
  /// @endcode
  MOCK_METHOD(
      future<StatusOr<google::cloud::video::livestream::v1::DvrSession>>,
  ...
  /// using ::testing::_;
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock, UpdateDvrSession(Matcher<google::longrunning::Operation
  /// const&>(_)))
  /// @endcode
  MOCK_METHOD(
      future<StatusOr<google::cloud::video::livestream::v1::DvrSession>>,
