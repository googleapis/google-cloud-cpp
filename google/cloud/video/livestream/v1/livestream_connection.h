...
/**
 * A retry policy for `LivestreamServiceConnection` that stops retrying after a
...
class LivestreamServiceLimitedErrorCountRetryPolicy
 ...
 public:
  LivestreamServiceLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `LivestreamServiceConnection` that stops retrying after
