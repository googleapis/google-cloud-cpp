...
future<StatusOr<google::cloud::video::livestream::v1::ChannelOperationResponse>>
LivestreamServiceConnectionImpl::StartDistribution(
    google::cloud::video::livestream::v1::StartDistributionRequest const&
        request) {
  auto current = google::cloud::internal::SaveCurrentOptions();
  auto request_copy = request;
  auto const idempotent =
      idempotency_policy(*current)->StartDistribution(request_copy);
  return google::cloud::internal::AsyncLongRunningOperation<
      google::cloud::video::livestream::v1::ChannelOperationResponse>(
      background_->cq(), current, std::move(request_copy),
      [stub = stub_](
          ...
          google::cloud::video::livestream::v1::StartDistributionRequest const&
              request) {
        return stub->AsyncStartDistribution(cq, std::move(context),
                                            std::move(options), request);
      },
      [stub = stub_](google::cloud::CompletionQueue& cq,
                     std::shared_ptr<grpc::ClientContext> context,
...
LivestreamServiceConnectionImpl::StartDistribution(
  ...
  return google::cloud::internal::RetryLoop(
      retry_policy(*current), backoff_policy(*current),
      idempotency_policy(*current)->StartDistribution(request),
      [this](
          grpc::ClientContext& context, Options const& options,
          google::cloud::video::livestream::v1::StartDistributionRequest const&
              request) {
        return stub_->StartDistribution(context, options, request);
      },
      *current, request, __func__);
}
...
LivestreamServiceConnectionImpl::StartDistribution(
  ...
  if (!operation.metadata()
    ...
    return make_ready_future<StatusOr<
        google::cloud::video::livestream::v1::ChannelOperationResponse>>(
        internal::InvalidArgumentError(
            "operation does not correspond to StartDistribution",
            GCP_ERROR_INFO().WithMetadata("operation",
                                          operation.metadata().DebugString())));
  }
...
future<StatusOr<google::cloud::video::livestream::v1::ChannelOperationResponse>>
LivestreamServiceConnectionImpl::StopDistribution(
    google::cloud::video::livestream::v1::StopDistributionRequest const&
        request) {
  auto current = google::cloud::internal::SaveCurrentOptions();
  auto request_copy = request;
  auto const idempotent =
      idempotency_policy(*current)->StopDistribution(request_copy);
  return google::cloud::internal::AsyncLongRunningOperation<
      google::cloud::video::livestream::v1::ChannelOperationResponse>(
      background_->cq(), current, std::move(request_copy),
      [stub = stub_](
          ...
          google::cloud::video::livestream::v1::StopDistributionRequest const&
              request) {
        return stub->AsyncStopDistribution(cq, std::move(context),
                                           std::move(options), request);
      },
      [stub = stub_](google::cloud::CompletionQueue& cq,
                     std::shared_ptr<grpc::ClientContext> context,
...
LivestreamServiceConnectionImpl::StopDistribution(
  ...
  return google::cloud::internal::RetryLoop(
      retry_policy(*current), backoff_policy(*current),
      idempotency_policy(*current)->StopDistribution(request),
      [this](
          grpc::ClientContext& context, Options const& options,
          google::cloud::video::livestream::v1::StopDistributionRequest const&
              request) {
        return stub_->StopDistribution(context, options, request);
      },
      *current, request, __func__);
}
...
LivestreamServiceConnectionImpl::StopDistribution(
  ...
  if (!operation.metadata()
    ...
    return make_ready_future<StatusOr<
        google::cloud::video::livestream::v1::ChannelOperationResponse>>(
        internal::InvalidArgumentError(
            "operation does not correspond to StopDistribution",
            GCP_ERROR_INFO().WithMetadata("operation",
                                          operation.metadata().DebugString())));
  }
...
LivestreamServiceConnectionImpl::PreviewInput(
    google::cloud::video::livestream::v1::PreviewInputRequest const& request) {
  auto current = google::cloud::internal::SaveCurrentOptions();
  return google::cloud::internal::RetryLoop(
      retry_policy(*current), backoff_policy(*current),
      idempotency_policy(*current)->PreviewInput(request),
      [this](grpc::ClientContext& context, Options const& options,
             google::cloud::video::livestream::v1::PreviewInputRequest const&
                 request) {
        return stub_->PreviewInput(context, options, request);
      },
      *current, request, __func__);
}
