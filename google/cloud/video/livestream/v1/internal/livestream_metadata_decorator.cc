...
LivestreamServiceMetadata::AsyncStartChannel(
  ...
  SetMetadata(*context, *options, absl::StrCat("name=", internal::UrlEncode(request.name())));
  return child_->AsyncStartChannel(
      cq, std::move(context), std::move(options), request);
}
...
LivestreamServiceMetadata::AsyncStopChannel(
  ...
  SetMetadata(*context, *options, absl::StrCat("name=", internal::UrlEncode(request.name())));
  return child_->AsyncStopChannel(
      cq, std::move(context), std::move(options), request);
}

StatusOr<google::longrunning::Operation>
LivestreamServiceMetadata::StopChannel(
    grpc::ClientContext& context,
    Options options,
    google::cloud::video::livestream::v1::StopChannelRequest const& request) {
  SetMetadata(context, options, absl::StrCat("name=", internal::UrlEncode(request.name())));
...
LivestreamServiceMetadata::AsyncCreateInput(
  ...
  SetMetadata(*context, *options, absl::StrCat("parent=", internal::UrlEncode(request.parent())));
  return child_->AsyncCreateInput(
      cq, std::move(context), std::move(options), request);
}

StatusOr<google::longrunning::Operation>
LivestreamServiceMetadata::CreateInput(
    grpc::ClientContext& context,
    Options options,
    google::cloud::video::livestream::v1::CreateInputRequest const& request) {
  SetMetadata(context, options, absl::StrCat("parent=", internal::UrlEncode(request.parent())));
...
LivestreamServiceMetadata::AsyncDeleteInput(
  ...
  SetMetadata(*context, *options, absl::StrCat("name=", internal::UrlEncode(request.name())));
  return child_->AsyncDeleteInput(
      cq, std::move(context), std::move(options), request);
}

StatusOr<google::longrunning::Operation>
LivestreamServiceMetadata::DeleteInput(
    grpc::ClientContext& context,
    Options options,
    google::cloud::video::livestream::v1::DeleteInputRequest const& request) {
  SetMetadata(context, options, absl::StrCat("name=", internal::UrlEncode(request.name())));
...
LivestreamServiceMetadata::AsyncUpdateInput(
  ...
  SetMetadata(*context, *options, absl::StrCat("input.name=", internal::UrlEncode(request.input().name())));
  return child_->AsyncUpdateInput(
      cq, std::move(context), std::move(options), request);
}

StatusOr<google::longrunning::Operation>
LivestreamServiceMetadata::UpdateInput(
    grpc::ClientContext& context,
    Options options,
    google::cloud::video::livestream::v1::UpdateInputRequest const& request) {
  SetMetadata(context, options, absl::StrCat("input.name=", internal::UrlEncode(request.input().name())));
...
Status
LivestreamServiceMetadata::DeleteEvent(
    grpc::ClientContext& context,
    Options const& options,
...
LivestreamServiceMetadata::AsyncCreateClip(
  ...
  SetMetadata(*context, *options, absl::StrCat("parent=", internal::UrlEncode(request.parent())));
  return child_->AsyncCreateClip(
      cq, std::move(context), std::move(options), request);
}

StatusOr<google::longrunning::Operation>
LivestreamServiceMetadata::CreateClip(
    grpc::ClientContext& context,
    Options options,
    google::cloud::video::livestream::v1::CreateClipRequest const& request) {
  SetMetadata(context, options, absl::StrCat("parent=", internal::UrlEncode(request.parent())));
...
LivestreamServiceMetadata::AsyncDeleteClip(
  ...
  SetMetadata(*context, *options, absl::StrCat("name=", internal::UrlEncode(request.name())));
  return child_->AsyncDeleteClip(
      cq, std::move(context), std::move(options), request);
}

StatusOr<google::longrunning::Operation>
LivestreamServiceMetadata::DeleteClip(
    grpc::ClientContext& context,
    Options options,
    google::cloud::video::livestream::v1::DeleteClipRequest const& request) {
  SetMetadata(context, options, absl::StrCat("name=", internal::UrlEncode(request.name())));
...
LivestreamServiceMetadata::AsyncCreateDvrSession(
  ...
  SetMetadata(*context, *options, absl::StrCat("parent=", internal::UrlEncode(request.parent())));
  return child_->AsyncCreateDvrSession(
      cq, std::move(context), std::move(options), request);
}
...
LivestreamServiceMetadata::AsyncDeleteDvrSession(
  ...
  SetMetadata(*context, *options, absl::StrCat("name=", internal::UrlEncode(request.name())));
  return child_->AsyncDeleteDvrSession(
      cq, std::move(context), std::move(options), request);
}
...
LivestreamServiceMetadata::AsyncUpdateDvrSession(
  ...
  SetMetadata(*context, *options, absl::StrCat("dvr_session.name=", internal::UrlEncode(request.dvr_session().name())));
  return child_->AsyncUpdateDvrSession(
      cq, std::move(context), std::move(options), request);
}
...
StatusOr<google::longrunning::Operation>
LivestreamServiceMetadata::CreateAsset(
    grpc::ClientContext& context,
    Options options,
    google::cloud::video::livestream::v1::CreateAssetRequest const& request) {
  SetMetadata(context, options, absl::StrCat("parent=", internal::UrlEncode(request.parent())));
...
StatusOr<google::longrunning::Operation>
LivestreamServiceMetadata::DeleteAsset(
    grpc::ClientContext& context,
    Options options,
    google::cloud::video::livestream::v1::DeleteAssetRequest const& request) {
  SetMetadata(context, options, absl::StrCat("name=", internal::UrlEncode(request.name())));
...
LivestreamServiceMetadata::AsyncUpdatePool(
  ...
  SetMetadata(*context, *options, absl::StrCat("pool.name=", internal::UrlEncode(request.pool().name())));
  return child_->AsyncUpdatePool(
      cq, std::move(context), std::move(options), request);
}

StatusOr<google::longrunning::Operation>
LivestreamServiceMetadata::UpdatePool(
    grpc::ClientContext& context,
    Options options,
    google::cloud::video::livestream::v1::UpdatePoolRequest const& request) {
  SetMetadata(context, options, absl::StrCat("pool.name=", internal::UrlEncode(request.pool().name())));
...
Status
LivestreamServiceMetadata::DeleteOperation(
    grpc::ClientContext& context,
    Options const& options,
...
Status
LivestreamServiceMetadata::CancelOperation(
    grpc::ClientContext& context,
    Options const& options,
