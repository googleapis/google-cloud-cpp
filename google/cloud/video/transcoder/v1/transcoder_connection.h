...
/**
 * A retry policy for `TranscoderServiceConnection` that stops retrying after a
...
class TranscoderServiceLimitedErrorCountRetryPolicy
 ...
 public:
  TranscoderServiceLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `TranscoderServiceConnection` that stops retrying after
