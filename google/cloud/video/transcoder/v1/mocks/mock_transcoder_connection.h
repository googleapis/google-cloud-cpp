 ...
 * construct an object of type `TranscoderServiceClient` with an instance of this
 ...
 */
class MockTranscoderServiceConnection : public video_transcoder_v1::TranscoderServiceConnection {
 public:
  MOCK_METHOD(Options, options, (), (override));

  MOCK_METHOD(StatusOr<google::cloud::video::transcoder::v1::Job>,
  CreateJob,
  ...
  MOCK_METHOD(StatusOr<google::cloud::video::transcoder::v1::JobTemplate>,
  CreateJobTemplate,
  (google::cloud::video::transcoder::v1::CreateJobTemplateRequest const& request), (override));

  MOCK_METHOD((StreamRange<google::cloud::video::transcoder::v1::JobTemplate>),
  ListJobTemplates,
  (google::cloud::video::transcoder::v1::ListJobTemplatesRequest request), (override));
