...
std::shared_ptr<TranscoderServiceStub> CreateDefaultTranscoderServiceStub(
  ...
  auto endpoint = internal::DetermineServiceEndpoint(
      internal::GetEnv("GOOGLE_CLOUD_CPP_TRANSCODER_SERVICE_ENDPOINT"),
      std::move(endpoint_option), "transcoder.googleapis.com", options);
  ...
  if (!endpoint.ok()) {
    ...
    auto service_grpc_stub =
        google::cloud::video::transcoder::v1::TranscoderService::NewStub(
            channel);
    stub = std::make_shared<DefaultTranscoderServiceStub>(
