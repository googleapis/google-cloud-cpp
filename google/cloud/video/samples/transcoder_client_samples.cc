...
// main-dox-marker: GOOGLE_CLOUD_CPP_NS::TranscoderServiceClient
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::GOOGLE_CLOUD_CPP_NS::TranscoderServiceClient(
      google::cloud::GOOGLE_CLOUD_CPP_NS::MakeTranscoderServiceConnection(
          options));
  //! [set-client-endpoint]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::GOOGLE_CLOUD_CPP_NS::TranscoderServiceClient(
        google::cloud::GOOGLE_CLOUD_CPP_NS::MakeTranscoderServiceConnection(
            options));
  }
  //! [with-service-account]
