...
// main-dox-marker: GOOGLE_CLOUD_CPP_NS::VideoStitcherServiceClient
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::GOOGLE_CLOUD_CPP_NS::VideoStitcherServiceClient(
      google::cloud::GOOGLE_CLOUD_CPP_NS::MakeVideoStitcherServiceConnection(
          options));
  //! [set-client-endpoint]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::GOOGLE_CLOUD_CPP_NS::VideoStitcherServiceClient(
        google::cloud::GOOGLE_CLOUD_CPP_NS::MakeVideoStitcherServiceConnection(
            options));
  }
  //! [with-service-account]
