...
/**
 * A retry policy for `VideoStitcherServiceConnection` that stops retrying after
...
class VideoStitcherServiceLimitedErrorCountRetryPolicy
 ...
 public:
  VideoStitcherServiceLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `VideoStitcherServiceConnection` that stops retrying
