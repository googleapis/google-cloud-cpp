...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_VIDEO_INTERNAL_TRANSCODER_AUTH_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_VIDEO_INTERNAL_TRANSCODER_AUTH_DECORATOR_H
...
class TranscoderServiceAuth : public TranscoderServiceStub {
 public:
  ~TranscoderServiceAuth() override = default;
  TranscoderServiceAuth(
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_VIDEO_INTERNAL_TRANSCODER_AUTH_DECORATOR_H
