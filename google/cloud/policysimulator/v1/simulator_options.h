 ...
 */
struct SimulatorRetryPolicyOption {
  using Type = std::shared_ptr<SimulatorRetryPolicy>;
};
 ...
 * @ingroup google-cloud-policysimulator-options
 */
struct SimulatorBackoffPolicyOption {
 ...
 * @ingroup google-cloud-policysimulator-options
 */
struct SimulatorConnectionIdempotencyPolicyOption {
  using Type = std::shared_ptr<SimulatorConnectionIdempotencyPolicy>;
};
 ...
 * @ingroup google-cloud-policysimulator-options
 */
struct SimulatorPollingPolicyOption {
  using Type = std::shared_ptr<PollingPolicy>;
};

/**
 * The options applicable to Simulator.
 *
 * @ingroup google-cloud-policysimulator-options
 */
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_POLICYSIMULATOR_V1_SIMULATOR_OPTIONS_H
