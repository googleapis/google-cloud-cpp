...
StreamRange<google::cloud::policysimulator::v1::ReplayResult> SimulatorConnection::ListReplayResults(
    google::cloud::policysimulator::v1::ListReplayResultsRequest) {  // NOLINT(performance-unnecessary-value-param)
...
std::shared_ptr<SimulatorConnection> MakeSimulatorConnection(
  ...
  options = policysimulator_v1_internal::SimulatorDefaultOptions(
      std::move(options));
