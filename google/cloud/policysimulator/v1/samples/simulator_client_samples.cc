...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::policysimulator_v1::SimulatorClient(
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::policysimulator_v1::SimulatorClient(
      google::cloud::policysimulator_v1::MakeSimulatorConnection(ud_options));

  //! [set-client-universe-domain]
}

//! [custom-idempotency-policy]
class CustomIdempotencyPolicy : public google::cloud::policysimulator_v1::
                                    SimulatorConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<
      google::cloud::policysimulator_v1::SimulatorConnectionIdempotencyPolicy>
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto c3 = google::cloud::policysimulator_v1::SimulatorClient(
      ...
      google::cloud::Options{}
          .set<google::cloud::policysimulator_v1::SimulatorRetryPolicyOption>(
              google::cloud::policysimulator_v1::
                  SimulatorLimitedTimeRetryPolicy(std::chrono::minutes(5))
                      .clone()));
      ...
      google::cloud::Options{}
          .set<google::cloud::policysimulator_v1::SimulatorPollingPolicyOption>(
              google::cloud::GenericPollingPolicy<
                  google::cloud::policysimulator_v1::
                      SimulatorRetryPolicyOption::Type,
                  google::cloud::policysimulator_v1::
                      SimulatorBackoffPolicyOption::Type>(
                  google::cloud::policysimulator_v1::
