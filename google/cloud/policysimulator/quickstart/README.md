# HOWTO: using the Policy Simulator API C++ client in your project

This directory contains small examples showing how to use the Policy Simulator
...
1. Compile this example using Bazel:
   ...
   ```bash
   cd $HOME/google-cloud-cpp/google/cloud/policysimulator/quickstart
   bazel build ...
   ```
...
1. Install the dependencies with your favorite tools. As an example, if you use
   ...
   ```bash
   cd $HOME/vcpkg
   ./vcpkg install google-cloud-cpp[core,policysimulator]
   ```
...
[quickstart-link]: https://cloud.google.com/policy-intelligence/docs/simulate-iam-policies
