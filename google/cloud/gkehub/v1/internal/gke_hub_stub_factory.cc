...
std::shared_ptr<GkeHubStub> CreateDefaultGkeHubStub(
  ...
  auto endpoint = internal::DetermineServiceEndpoint(
      internal::GetEnv("GOOGLE_CLOUD_CPP_GKE_HUB_ENDPOINT"),
      internal::FetchOption<EndpointOption>(options), "gkehub.googleapis.com",
      options);
  ...
  if (!endpoint.ok()) {
    ...
    auto service_grpc_stub =
        google::cloud::gkehub::v1::GkeHub::NewStub(channel);
    stub = std::make_shared<DefaultGkeHubStub>(
