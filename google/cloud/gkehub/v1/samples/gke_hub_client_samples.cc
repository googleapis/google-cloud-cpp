...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::gkehub_v1::GkeHubClient(
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::gkehub_v1::GkeHubClient(
      google::cloud::gkehub_v1::MakeGkeHubConnection(ud_options));
