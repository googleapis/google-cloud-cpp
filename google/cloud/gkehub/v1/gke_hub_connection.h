...
/**
 * A retry policy for `GkeHubConnection` that stops retrying after a
...
class GkeHubLimitedErrorCountRetryPolicy : public GkeHubRetryPolicy {
 public:
  GkeHubLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `GkeHubConnection` that stops retrying after
