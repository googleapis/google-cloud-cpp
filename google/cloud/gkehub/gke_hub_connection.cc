 ...
 public:
  GkeHubConnectionImpl(
      ...
      : background_(std::move(background)), stub_(std::move(stub)),
        retry_policy_prototype_(options.get<GkeHubRetryPolicyOption>()->clone()),
        backoff_policy_prototype_(options.get<GkeHubBackoffPolicyOption>()->clone()),
        polling_policy_prototype_(options.get<GkeHubPollingPolicyOption>()->clone()),
        idempotency_policy_(options.get<GkeHubConnectionIdempotencyPolicyOption>()->clone()) {}
  ...
  StreamRange<google::cloud::gkehub::v1::Membership> ListMemberships(
    ...
    auto stub = stub_;
    auto retry =
        std::shared_ptr<GkeHubRetryPolicy const>(retry_policy_prototype_->clone());
...
std::shared_ptr<GkeHubConnection> MakeGkeHubConnection(
  ...
  options = gkehub_internal::GkeHubDefaultOptions(
      std::move(options));
  auto background = internal::MakeBackgroundThreadsFactory(options)();
  auto stub = gkehub_internal::CreateDefaultGkeHubStub(
    background->cq(), options);
  return std::make_shared<GkeHubConnectionImpl>(
...
std::shared_ptr<gkehub::GkeHubConnection>
MakeGkeHubConnection(
