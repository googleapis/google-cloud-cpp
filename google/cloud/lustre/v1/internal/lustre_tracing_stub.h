...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_LUSTRE_V1_INTERNAL_LUSTRE_TRACING_STUB_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_LUSTRE_V1_INTERNAL_LUSTRE_TRACING_STUB_H
...
class LustreTracingStub : public LustreStub {
 public:
  ~LustreTracingStub() override = default;

  explicit LustreTracingStub(std::shared_ptr<LustreStub> child);
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_LUSTRE_V1_INTERNAL_LUSTRE_TRACING_STUB_H
