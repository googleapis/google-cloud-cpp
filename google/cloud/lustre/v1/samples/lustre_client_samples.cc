...
// clang-format off
// main-dox-marker: lustre_v1::LustreClient
// lro-marker: true
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::lustre_v1::LustreClient(
      google::cloud::lustre_v1::MakeLustreConnection(options));
  //! [set-client-endpoint]
}

//! [custom-idempotency-policy]
class CustomIdempotencyPolicy
   : public google::cloud::lustre_v1::LustreConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::lustre_v1::LustreConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::lustre_v1::LustreConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::lustre_v1::LustreRetryPolicyOption>(
      google::cloud::lustre_v1::LustreLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::lustre_v1::LustreBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::lustre_v1::MakeLustreConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::lustre_v1::LustreClient(connection);
  auto c2 = google::cloud::lustre_v1::LustreClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::lustre_v1::LustreClient(
    connection, google::cloud::Options{}.set<google::cloud::lustre_v1::LustreRetryPolicyOption>(
      google::cloud::lustre_v1::LustreLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::lustre_v1::LustreRetryPolicyOption>(
  //       google::cloud::lustre_v1::LustreLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::lustre_v1::LustrePollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::lustre_v1::LustreRetryPolicyOption::Type,
            google::cloud::lustre_v1::LustreBackoffPolicyOption::Type>(
            google::cloud::lustre_v1::LustreLimitedTimeRetryPolicy(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::lustre_v1::LustreClient(
      google::cloud::lustre_v1::MakeLustreConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
