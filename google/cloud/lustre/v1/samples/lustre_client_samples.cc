...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::lustre_v1::LustreClient(
      google::cloud::lustre_v1::MakeLustreConnection(ud_options));
...
class CustomIdempotencyPolicy
 ...
 public:
  ...
  std::unique_ptr<google::cloud::lustre_v1::LustreConnectionIdempotencyPolicy>
