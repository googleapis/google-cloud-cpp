...
StreamRange<google::cloud::lustre::v1::Instance> LustreConnection::ListInstances(
    google::cloud::lustre::v1::ListInstancesRequest) {  // NOLINT(performance-unnecessary-value-param)
  return google::cloud::internal::MakeUnimplementedPaginationRange<
      StreamRange<google::cloud::lustre::v1::Instance>>();
}

StatusOr<google::cloud::lustre::v1::Instance>
LustreConnection::GetInstance(
...
StatusOr<google::longrunning::Operation>
LustreConnection::GetOperation(
    google::longrunning::GetOperationRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

Status
LustreConnection::DeleteOperation(
    google::longrunning::DeleteOperationRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

Status
LustreConnection::CancelOperation(
...
std::shared_ptr<LustreConnection> MakeLustreConnection(
  ...
  options = lustre_v1_internal::LustreDefaultOptions(
      std::move(options));
  auto background = internal::MakeBackgroundThreadsFactory(options)();
  auto auth = internal::CreateAuthenticationStrategy(background->cq(), options);
  auto stub = lustre_v1_internal::CreateDefaultLustreStub(
