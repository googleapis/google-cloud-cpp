...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_LUSTRE_V1_MOCKS_MOCK_LUSTRE_CONNECTION_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_LUSTRE_V1_MOCKS_MOCK_LUSTRE_CONNECTION_H
...
namespace google {
namespace cloud {
namespace lustre_v1_mocks {
GOOGLE_CLOUD_CPP_INLINE_NAMESPACE_BEGIN

/**
 * A class to mock `LustreConnection`.
 *
 * Application developers may want to test their code with simulated responses,
 * including errors, from an object of type `LustreClient`. To do so,
 * construct an object of type `LustreClient` with an instance of this
 ...
 */
class MockLustreConnection : public lustre_v1::LustreConnection {
 public:
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_LUSTRE_V1_MOCKS_MOCK_LUSTRE_CONNECTION_H
