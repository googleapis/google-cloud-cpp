 ...
 */
struct LustreRetryPolicyOption {
  using Type = std::shared_ptr<LustreRetryPolicy>;
};
 ...
 * @ingroup google-cloud-lustre-options
 */
struct LustreBackoffPolicyOption {
 ...
 * @ingroup google-cloud-lustre-options
 */
struct LustreConnectionIdempotencyPolicyOption {
  using Type = std::shared_ptr<LustreConnectionIdempotencyPolicy>;
};
 ...
 * @ingroup google-cloud-lustre-options
 */
struct LustrePollingPolicyOption {
  using Type = std::shared_ptr<PollingPolicy>;
};

/**
 * The options applicable to Lustre.
 *
 * @ingroup google-cloud-lustre-options
 */
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_LUSTRE_V1_LUSTRE_OPTIONS_H
