...
std::shared_ptr<TelcoAutomationStub> CreateDefaultTelcoAutomationStub(
  ...
  auto endpoint = internal::DetermineServiceEndpoint(
      internal::GetEnv("GOOGLE_CLOUD_CPP_TELCO_AUTOMATION_ENDPOINT"),
      std::move(endpoint_option), "telcoautomation.googleapis.com", options);
  ...
  if (!endpoint.ok()) {
    ...
    stub = std::make_shared<DefaultTelcoAutomationStub>(
