# HOWTO: using the Telco Automation API C++ client in your project

This directory contains small examples showing how to use the Telco Automation
...
1. Compile this example using Bazel:
   ...
   ```bash
   cd $HOME/google-cloud-cpp/google/cloud/telcoautomation/quickstart
   bazel build ...
   ```
...
1. Install the dependencies with your favorite tools. As an example, if you use
   ...
   ```bash
   cd $HOME/vcpkg
   ./vcpkg install google-cloud-cpp[core,telcoautomation]
   ```
...
[quickstart-link]: https://cloud.google.com/telcoautomation/docs/quickstart
