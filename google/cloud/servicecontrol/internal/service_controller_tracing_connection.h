...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SERVICECONTROL_INTERNAL_SERVICE_CONTROLLER_TRACING_CONNECTION_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SERVICECONTROL_INTERNAL_SERVICE_CONTROLLER_TRACING_CONNECTION_H
...
class ServiceControllerTracingConnection
 ...
 public:
  ...
  explicit ServiceControllerTracingConnection(
      std::shared_ptr<servicecontrol::ServiceControllerConnection> child);
 ...
 private:
  std::shared_ptr<servicecontrol::ServiceControllerConnection> child_;
};
...
MakeServiceControllerTracingConnection(
    std::shared_ptr<servicecontrol::ServiceControllerConnection> conn);
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SERVICECONTROL_INTERNAL_SERVICE_CONTROLLER_TRACING_CONNECTION_H
