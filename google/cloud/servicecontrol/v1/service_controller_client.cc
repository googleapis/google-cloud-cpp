...
ServiceControllerClient::Check(google::api::servicecontrol::v1::CheckRequest const& request, Options opts) {
  internal::OptionsSpan span(internal::MergeOptions(std::move(opts), options_));
  return connection_->Check(request);
}

StatusOr<google::api::servicecontrol::v1::ReportResponse>
ServiceControllerClient::Report(google::api::servicecontrol::v1::ReportRequest const& request, Options opts) {
  internal::OptionsSpan span(internal::MergeOptions(std::move(opts), options_));
