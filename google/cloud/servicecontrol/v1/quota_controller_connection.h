...
class QuotaControllerRetryPolicy : public ::google::cloud::RetryPolicy {
 public:
  /// Creates a new instance with the initial state, as-if no errors had been
  /// handled.
  virtual std::unique_ptr<QuotaControllerRetryPolicy> clone() const = 0;
};

/**
 * A retry policy for `QuotaControllerConnection` that stops retrying after a
...
class QuotaControllerLimitedErrorCountRetryPolicy
 ...
 public:
  QuotaControllerLimitedErrorCountRetryPolicy(int maximum_failures)
  ...
  std::unique_ptr<QuotaControllerRetryPolicy> clone() const override {
    return std::make_unique<QuotaControllerLimitedErrorCountRetryPolicy>(
        maximum_failures());
  }
...
/// A retry policy for `QuotaControllerConnection` that stops retrying after
...
class QuotaControllerLimitedTimeRetryPolicy
 ...
 public:
  ...
  std::unique_ptr<QuotaControllerRetryPolicy> clone() const override {
    return std::make_unique<QuotaControllerLimitedTimeRetryPolicy>(
        maximum_duration());
  }
 ...
 * - `google::cloud::servicecontrol_v1::QuotaControllerPolicyOptionList`
 *
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SERVICECONTROL_V1_QUOTA_CONTROLLER_CONNECTION_H
