...
class ServiceControllerLimitedErrorCountRetryPolicy : public ServiceControllerRetryPolicy {
 ...
 private:
  google::cloud::internal::LimitedErrorCountRetryPolicy<servicecontrol_v1_internal::ServiceControllerRetryTraits> impl_;
};
...
class ServiceControllerLimitedTimeRetryPolicy : public ServiceControllerRetryPolicy {
 ...
 private:
  google::cloud::internal::LimitedTimeRetryPolicy<servicecontrol_v1_internal::ServiceControllerRetryTraits> impl_;
};
...
class ServiceControllerConnection {
 public:
  ...
  virtual StatusOr<google::api::servicecontrol::v1::CheckResponse>
  Check(google::api::servicecontrol::v1::CheckRequest const& request);

  virtual StatusOr<google::api::servicecontrol::v1::ReportResponse>
