...
std::shared_ptr<QuotaControllerStub> CreateDefaultQuotaControllerStub(
  ...
  auto endpoint = internal::DetermineServiceEndpoint(
      internal::GetEnv("GOOGLE_CLOUD_CPP_QUOTA_CONTROLLER_ENDPOINT"),
  ...
  if (!endpoint.ok()) {
    ...
    auto service_grpc_stub =
        google::api::servicecontrol::v1::QuotaController::NewStub(channel);
    stub = std::make_shared<DefaultQuotaControllerStub>(
