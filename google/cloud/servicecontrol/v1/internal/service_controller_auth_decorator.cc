...
StatusOr<google::api::servicecontrol::v1::CheckResponse> ServiceControllerAuth::Check(
...
StatusOr<google::api::servicecontrol::v1::ReportResponse> ServiceControllerAuth::Report(
    grpc::ClientContext& context,
    Options const& options,
