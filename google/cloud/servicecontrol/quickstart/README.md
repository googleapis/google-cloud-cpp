# HOWTO: using the Service Control API C++ client in your project

This directory contains small examples showing how to use the Service Control API C++
...
Like most Google Cloud Platform (GCP) services, Service Control API requires that
...
1. Install the dependencies with your favorite tools. As an example, if you use
   ...
   ```bash
   cd $HOME/vcpkg
   ./vcpkg install google-cloud-cpp[core,servicecontrol]
   ```
...
1. Configure CMake, if necessary, configure the directory where you installed
   ...
   ```bash
   cd $HOME/gooogle-cloud-cpp/google/cloud/servicecontrol/quickstart
...
[quickstart-link]: https://cloud.google.com/service-infrastructure/docs/service-control/getting-started
