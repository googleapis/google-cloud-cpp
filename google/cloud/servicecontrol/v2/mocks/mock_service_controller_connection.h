...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SERVICECONTROL_V2_MOCKS_MOCK_SERVICE_CONTROLLER_CONNECTION_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SERVICECONTROL_V2_MOCKS_MOCK_SERVICE_CONTROLLER_CONNECTION_H
...
namespace google {
namespace cloud {
namespace servicecontrol_v2_mocks {
 ...
 */
class MockServiceControllerConnection : public servicecontrol_v2::ServiceControllerConnection {
 public:
  MOCK_METHOD(Options, options, (), (override));

  MOCK_METHOD(StatusOr<google::api::servicecontrol::v2::CheckResponse>,
  Check,
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SERVICECONTROL_V2_MOCKS_MOCK_SERVICE_CONTROLLER_CONNECTION_H
