...
std::unique_ptr<servicecontrol_v2::ServiceControllerRetryPolicy>
retry_policy(Options const& options) {
  return options.get<servicecontrol_v2::ServiceControllerRetryPolicyOption>()->clone();
}

std::unique_ptr<BackoffPolicy>
backoff_policy(Options const& options) {
  return options.get<servicecontrol_v2::ServiceControllerBackoffPolicyOption>()->clone();
}

std::unique_ptr<servicecontrol_v2::ServiceControllerConnectionIdempotencyPolicy>
idempotency_policy(Options const& options) {
  return options.get<servicecontrol_v2::ServiceControllerConnectionIdempotencyPolicyOption>()->clone();
}
...
ServiceControllerConnectionImpl::Check(google::api::servicecontrol::v2::CheckRequest const& request) {
...
ServiceControllerConnectionImpl::Report(google::api::servicecontrol::v2::ReportRequest const& request) {
  auto current = google::cloud::internal::SaveCurrentOptions();
  return google::cloud::internal::RetryLoop(
      retry_policy(*current), backoff_policy(*current),
