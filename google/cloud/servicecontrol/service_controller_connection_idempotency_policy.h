...
class ServiceControllerConnectionIdempotencyPolicy {
 public:
  virtual ~ServiceControllerConnectionIdempotencyPolicy() = 0;
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SERVICECONTROL_SERVICE_CONTROLLER_CONNECTION_IDEMPOTENCY_POLICY_H
