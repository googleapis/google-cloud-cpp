# HOWTO: using the NetApp API C++ client in your project

This directory contains small examples showing how to use the NetApp API C++
...
1. Compile this example using Bazel:
   ...
   ```bash
   cd $HOME/google-cloud-cpp/google/cloud/netapp/quickstart
   bazel build ...
   ```
...
1. Install the dependencies with your favorite tools. As an example, if you use
   ...
   ```bash
   cd $HOME/vcpkg
   ./vcpkg install google-cloud-cpp[core,netapp]
   ```
...
[quickstart-link]: https://cloud.google.com/architecture/partners/netapp-cloud-volumes/quickstart
