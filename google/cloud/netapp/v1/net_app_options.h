 ...
 */
struct NetAppRetryPolicyOption {
  using Type = std::shared_ptr<NetAppRetryPolicy>;
};
 ...
 * @ingroup google-cloud-netapp-options
 */
struct NetAppBackoffPolicyOption {
 ...
 * @ingroup google-cloud-netapp-options
 */
struct NetAppConnectionIdempotencyPolicyOption {
  using Type = std::shared_ptr<NetAppConnectionIdempotencyPolicy>;
};
 ...
 * @ingroup google-cloud-netapp-options
 */
struct NetAppPollingPolicyOption {
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_NETAPP_V1_NET_APP_OPTIONS_H
