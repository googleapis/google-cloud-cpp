...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_NETAPP_V1_INTERNAL_NET_APP_AUTH_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_NETAPP_V1_INTERNAL_NET_APP_AUTH_DECORATOR_H
...
class NetAppAuth : public NetAppStub {
 public:
  ~NetAppAuth() override = default;
  NetAppAuth(
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_NETAPP_V1_INTERNAL_NET_APP_AUTH_DECORATOR_H
