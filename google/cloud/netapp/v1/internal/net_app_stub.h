...
class NetAppStub {
 public:
  ...
  virtual future<StatusOr<google::longrunning::Operation>> AsyncValidateDirectoryService(
      google::cloud::CompletionQueue& cq,
      std::shared_ptr<grpc::ClientContext> context,
      google::cloud::internal::ImmutableOptions options,
      google::cloud::netapp::v1::ValidateDirectoryServiceRequest const& request) = 0;
  ...
  virtual StatusOr<google::cloud::netapp::v1::ListQuotaRulesResponse> ListQuotaRules(
      grpc::ClientContext& context,
      Options const& options,
