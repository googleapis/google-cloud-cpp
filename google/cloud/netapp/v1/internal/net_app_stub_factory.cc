...
std::shared_ptr<NetAppStub> CreateDefaultNetAppStub(
  ...
  auto endpoint = internal::DetermineServiceEndpoint(
      internal::GetEnv("GOOGLE_CLOUD_CPP_NET_APP_ENDPOINT"),
      internal::FetchOption<EndpointOption>(options), "netapp.googleapis.com",
      options);
  ...
  if (!endpoint.ok()) {
    ...
    auto service_grpc_stub =
        google::cloud::netapp::v1::NetApp::NewStub(channel);
    stub = std::make_shared<DefaultNetAppStub>(
