# HOWTO: using the reCAPTCHA Enterprise API C++ client in your project

This directory contains small examples showing how to use the reCAPTCHA Enterprise API C++
...
Like most Google Cloud Platform (GCP) services, reCAPTCHA Enterprise API requires that
...
1. Install the dependencies with your favorite tools. As an example, if you use
   ...
   ```bash
   cd $HOME/vcpkg
   ./vcpkg install google-cloud-cpp[core,recaptchaenterprise]
   ```
...
[quickstart-link]: https://cloud.google.com/recaptcha-enterprise/docs/quickstart
