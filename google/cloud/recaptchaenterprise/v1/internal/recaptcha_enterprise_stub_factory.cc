...
CreateDefaultRecaptchaEnterpriseServiceStub(google::cloud::CompletionQueue cq,
  ...
  auto endpoint = internal::DetermineServiceEndpoint(
      ...
      std::move(endpoint_option), "recaptchaenterprise.googleapis.com",
      options);
  ...
  if (!endpoint.ok()) {
    ...
    stub = std::make_shared<DefaultRecaptchaEnterpriseServiceStub>(
  ...
  if (internal::TracingEnabled(options)) {
    stub = MakeRecaptchaEnterpriseServiceTracingStub(std::move(stub));
  }
  return stub;
}
