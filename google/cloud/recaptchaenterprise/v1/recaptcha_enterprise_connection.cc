...
RecaptchaEnterpriseServiceConnection::~RecaptchaEnterpriseServiceConnection() = default;
...
StreamRange<google::cloud::recaptchaenterprise::v1::Key> RecaptchaEnterpriseServiceConnection::ListKeys(
    google::cloud::recaptchaenterprise::v1::ListKeysRequest) {  // NOLINT(performance-unnecessary-value-param)
...
Status
RecaptchaEnterpriseServiceConnection::DeleteKey(
...
StreamRange<google::cloud::recaptchaenterprise::v1::IpOverrideData> RecaptchaEnterpriseServiceConnection::ListIpOverrides(
    google::cloud::recaptchaenterprise::v1::ListIpOverridesRequest) {  // NOLINT(performance-unnecessary-value-param)
  return google::cloud::internal::MakeUnimplementedPaginationRange<
...
StreamRange<google::cloud::recaptchaenterprise::v1::FirewallPolicy> RecaptchaEnterpriseServiceConnection::ListFirewallPolicies(
    google::cloud::recaptchaenterprise::v1::ListFirewallPoliciesRequest) {  // NOLINT(performance-unnecessary-value-param)
  return google::cloud::internal::MakeUnimplementedPaginationRange<
...
Status
RecaptchaEnterpriseServiceConnection::DeleteFirewallPolicy(
...
StreamRange<google::cloud::recaptchaenterprise::v1::RelatedAccountGroup> RecaptchaEnterpriseServiceConnection::ListRelatedAccountGroups(
    google::cloud::recaptchaenterprise::v1::ListRelatedAccountGroupsRequest) {  // NOLINT(performance-unnecessary-value-param)
  return google::cloud::internal::MakeUnimplementedPaginationRange<
      StreamRange<google::cloud::recaptchaenterprise::v1::RelatedAccountGroup>>();
}

StreamRange<google::cloud::recaptchaenterprise::v1::RelatedAccountGroupMembership> RecaptchaEnterpriseServiceConnection::ListRelatedAccountGroupMemberships(
    google::cloud::recaptchaenterprise::v1::ListRelatedAccountGroupMembershipsRequest) {  // NOLINT(performance-unnecessary-value-param)
  return google::cloud::internal::MakeUnimplementedPaginationRange<
      StreamRange<google::cloud::recaptchaenterprise::v1::RelatedAccountGroupMembership>>();
}

StreamRange<google::cloud::recaptchaenterprise::v1::RelatedAccountGroupMembership> RecaptchaEnterpriseServiceConnection::SearchRelatedAccountGroupMemberships(
    google::cloud::recaptchaenterprise::v1::SearchRelatedAccountGroupMembershipsRequest) {  // NOLINT(performance-unnecessary-value-param)
  return google::cloud::internal::MakeUnimplementedPaginationRange<
      StreamRange<google::cloud::recaptchaenterprise::v1::RelatedAccountGroupMembership>>();
}
...
std::shared_ptr<RecaptchaEnterpriseServiceConnection> MakeRecaptchaEnterpriseServiceConnection(
  ...
  internal::CheckExpectedOptions<CommonOptionList, GrpcOptionList,
      ...
      RecaptchaEnterpriseServicePolicyOptionList>(options, __func__);
  options = recaptchaenterprise_v1_internal::RecaptchaEnterpriseServiceDefaultOptions(
      std::move(options));
  auto background = internal::MakeBackgroundThreadsFactory(options)();
  auto auth = internal::CreateAuthenticationStrategy(background->cq(), options);
  auto stub = recaptchaenterprise_v1_internal::CreateDefaultRecaptchaEnterpriseServiceStub(
    std::move(auth), options);
  return recaptchaenterprise_v1_internal::MakeRecaptchaEnterpriseServiceTracingConnection(
      std::make_shared<recaptchaenterprise_v1_internal::RecaptchaEnterpriseServiceConnectionImpl>(
