# HOWTO: using the VMware Engine API C++ client in your project

This directory contains small examples showing how to use the VMware Engine API C++
...
1. Install the dependencies with your favorite tools. As an example, if you use
   ...
   ```bash
   cd $HOME/vcpkg
   ./vcpkg install google-cloud-cpp[core,vmwareengine]
   ```
...
1. Configure CMake, if necessary, configure the directory where you installed
   ...
   ```bash
   cd $HOME/gooogle-cloud-cpp/google/cloud/vmwareengine/quickstart
...
[quickstart-link]: https://cloud.google.com/vmware-engine/docs/create-vmware-vm
