...
// clang-format off
// main-dox-marker: vmwareengine_v1::VmwareEngineClient
// lro-marker: true
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::vmwareengine_v1::VmwareEngineClient(
...
class CustomIdempotencyPolicy
   : public google::cloud::vmwareengine_v1::VmwareEngineConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::vmwareengine_v1::VmwareEngineConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::vmwareengine_v1::VmwareEngineConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::vmwareengine_v1::VmwareEngineRetryPolicyOption>(
      google::cloud::vmwareengine_v1::VmwareEngineLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::vmwareengine_v1::VmwareEngineBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::vmwareengine_v1::MakeVmwareEngineConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::vmwareengine_v1::VmwareEngineClient(connection);
  auto c2 = google::cloud::vmwareengine_v1::VmwareEngineClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::vmwareengine_v1::VmwareEngineClient(
    connection, google::cloud::Options{}.set<google::cloud::vmwareengine_v1::VmwareEngineRetryPolicyOption>(
      google::cloud::vmwareengine_v1::VmwareEngineLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::vmwareengine_v1::VmwareEngineRetryPolicyOption>(
  //       google::cloud::vmwareengine_v1::VmwareEngineLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::vmwareengine_v1::VmwareEnginePollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::vmwareengine_v1::VmwareEngineRetryPolicyOption::Type,
            google::cloud::vmwareengine_v1::VmwareEngineBackoffPolicyOption::Type>(
            google::cloud::vmwareengine_v1::VmwareEngineLimitedTimeRetryPolicy(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::vmwareengine_v1::VmwareEngineClient(
      google::cloud::vmwareengine_v1::MakeVmwareEngineConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
