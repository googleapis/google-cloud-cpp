 ...
 */
struct VmwareEngineRetryPolicyOption {
  using Type = std::shared_ptr<VmwareEngineRetryPolicy>;
};
 ...
 * @ingroup google-cloud-vmwareengine-options
 */
struct VmwareEngineBackoffPolicyOption {
 ...
 * @ingroup google-cloud-vmwareengine-options
 */
struct VmwareEngineConnectionIdempotencyPolicyOption {
  using Type = std::shared_ptr<VmwareEngineConnectionIdempotencyPolicy>;
};
 ...
 * @ingroup google-cloud-vmwareengine-options
 */
struct VmwareEnginePollingPolicyOption {
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_VMWAREENGINE_V1_VMWARE_ENGINE_OPTIONS_H
