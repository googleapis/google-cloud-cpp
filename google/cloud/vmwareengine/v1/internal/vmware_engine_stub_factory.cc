...
std::shared_ptr<VmwareEngineStub> CreateDefaultVmwareEngineStub(
  ...
  auto endpoint = internal::DetermineServiceEndpoint(
      internal::GetEnv("GOOGLE_CLOUD_CPP_VMWARE_ENGINE_ENDPOINT"),
      std::move(endpoint_option), "vmwareengine.googleapis.com", options);
  ...
  if (!endpoint.ok()) {
    ...
    stub = std::make_shared<DefaultVmwareEngineStub>(
