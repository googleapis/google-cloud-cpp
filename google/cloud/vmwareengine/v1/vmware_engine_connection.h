...
/**
 * A retry policy for `VmwareEngineConnection` that stops retrying after a
...
class VmwareEngineLimitedErrorCountRetryPolicy
 ...
 public:
  VmwareEngineLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `VmwareEngineConnection` that stops retrying after
