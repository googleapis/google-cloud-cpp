# HOWTO: using the Contact Center AI Insights API C++ client in your project

This directory contains small examples showing how to use the Contact Center AI Insights API C++
...
1. Install the dependencies with your favorite tools. As an example, if you use
   ...
   ```bash
   cd $HOME/vcpkg
   ./vcpkg install google-cloud-cpp[core,contactcenterinsights]
   ```
...
1. Configure CMake, if necessary, configure the directory where you installed
   ...
   ```bash
   cd $HOME/gooogle-cloud-cpp/google/cloud/contactcenterinsights/quickstart
