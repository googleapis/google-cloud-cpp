...
This directory contains small examples showing how to use the Contact Center AI
Insights API C++ client library in your own project. These instructions assume
