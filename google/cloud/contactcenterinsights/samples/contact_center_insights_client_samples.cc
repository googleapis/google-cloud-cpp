...
// main-dox-marker: GOOGLE_CLOUD_CPP_NS::ContactCenterInsightsClient
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::GOOGLE_CLOUD_CPP_NS::ContactCenterInsightsClient(
      google::cloud::GOOGLE_CLOUD_CPP_NS::MakeContactCenterInsightsConnection(
          options));
  //! [set-client-endpoint]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::GOOGLE_CLOUD_CPP_NS::ContactCenterInsightsClient(
        google::cloud::GOOGLE_CLOUD_CPP_NS::MakeContactCenterInsightsConnection(
            options));
  }
  //! [with-service-account]
