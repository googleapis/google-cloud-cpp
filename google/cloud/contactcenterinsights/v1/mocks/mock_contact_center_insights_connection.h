...
class MockContactCenterInsightsConnection
 ...
 public:
  ...
  // EXPECT_CALL(*mock, UploadConversation(_)) instead.
  MOCK_METHOD(
  ...
  // EXPECT_CALL(*mock, CreateAnalysis(_)) instead.
  MOCK_METHOD(
  ...
  // EXPECT_CALL(*mock, BulkAnalyzeConversations(_)) instead.
  ...
  // EXPECT_CALL(*mock, BulkDeleteConversations(_)) instead.
  MOCK_METHOD(future<StatusOr<google::cloud::contactcenterinsights::v1::
  ...
  // EXPECT_CALL(*mock, IngestConversations(_)) instead.
  MOCK_METHOD(future<StatusOr<google::cloud::contactcenterinsights::v1::
  ...
  // EXPECT_CALL(*mock, ExportInsightsData(_)) instead.
  MOCK_METHOD(future<StatusOr<google::cloud::contactcenterinsights::v1::
  ...
  // EXPECT_CALL(*mock, CreateIssueModel(_)) instead.
  MOCK_METHOD(
  ...
  // EXPECT_CALL(*mock, DeleteIssueModel(_)) instead.
  MOCK_METHOD(
      future<StatusOr<
  ...
  // EXPECT_CALL(*mock, DeployIssueModel(_)) instead.
  MOCK_METHOD(
      future<StatusOr<
  ...
  // EXPECT_CALL(*mock, UndeployIssueModel(_)) instead.
  MOCK_METHOD(future<StatusOr<google::cloud::contactcenterinsights::v1::
