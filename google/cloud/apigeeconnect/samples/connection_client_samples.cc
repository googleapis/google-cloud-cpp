...
// main-dox-marker: GOOGLE_CLOUD_CPP_NS::ConnectionServiceClient
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::GOOGLE_CLOUD_CPP_NS::ConnectionServiceClient(
      google::cloud::GOOGLE_CLOUD_CPP_NS::MakeConnectionServiceConnection(
          options));
  //! [set-client-endpoint]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::GOOGLE_CLOUD_CPP_NS::ConnectionServiceClient(
        google::cloud::GOOGLE_CLOUD_CPP_NS::MakeConnectionServiceConnection(
            options));
  }
  //! [with-service-account]
