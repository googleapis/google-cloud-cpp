...
std::shared_ptr<ConnectionServiceStub> CreateDefaultConnectionServiceStub(
  ...
  auto endpoint = internal::DetermineServiceEndpoint(
      internal::GetEnv("GOOGLE_CLOUD_CPP_APIGEE_CONNECTION_SERVICE_ENDPOINT"),
      std::move(endpoint_option), "apigeeconnect.googleapis.com", options);
  ...
  if (!endpoint.ok()) {
    ...
    stub = std::make_shared<DefaultConnectionServiceStub>(
