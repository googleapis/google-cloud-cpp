 ...
 private:
  ...
  retry_policy() {
    ...
    if (options.has<apigeeconnect_v1::ConnectionServiceRetryPolicyOption>()) {
      return options
          .get<apigeeconnect_v1::ConnectionServiceRetryPolicyOption>()
          ->clone();
    }
    return options_.get<apigeeconnect_v1::ConnectionServiceRetryPolicyOption>()
        ->clone();
  }
  ...
  std::unique_ptr<BackoffPolicy> backoff_policy() {
    ...
    if (options.has<apigeeconnect_v1::ConnectionServiceBackoffPolicyOption>()) {
      return options
          .get<apigeeconnect_v1::ConnectionServiceBackoffPolicyOption>()
          ->clone();
    }
    return options_
        .get<apigeeconnect_v1::ConnectionServiceBackoffPolicyOption>()
  ...
  std::unique_ptr<
      apigeeconnect_v1::ConnectionServiceConnectionIdempotencyPolicy>
  idempotency_policy() {
    auto const& options = internal::CurrentOptions();
