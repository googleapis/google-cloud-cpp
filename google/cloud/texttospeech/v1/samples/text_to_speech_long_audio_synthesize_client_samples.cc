...
// clang-format off
// main-dox-marker: texttospeech_v1::TextToSpeechLongAudioSynthesizeClient
// lro-marker: true
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client =
      google::cloud::texttospeech_v1::TextToSpeechLongAudioSynthesizeClient(
          google::cloud::texttospeech_v1::
              MakeTextToSpeechLongAudioSynthesizeConnection(options));
  //! [set-client-endpoint]
}

//! [custom-idempotency-policy]
class CustomIdempotencyPolicy
    : public google::cloud::texttospeech_v1::
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options =
      google::cloud::Options{}
          ...
          .set<google::cloud::texttospeech_v1::
                   TextToSpeechLongAudioSynthesizeRetryPolicyOption>(
              google::cloud::texttospeech_v1::
                  TextToSpeechLongAudioSynthesizeLimitedErrorCountRetryPolicy(3)
                      .clone())
          .set<google::cloud::texttospeech_v1::
              ...
              google::cloud::ExponentialBackoffPolicy(
                  ...
                  /*scaling=*/2.0)
                  .clone());
  auto connection = google::cloud::texttospeech_v1::
      MakeTextToSpeechLongAudioSynthesizeConnection(options);
  ...
  //     .set<google::cloud::texttospeech_v1::TextToSpeechLongAudioSynthesizeRetryPolicyOption>(
  //       google::cloud::texttospeech_v1::TextToSpeechLongAudioSynthesizeLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
      ...
      google::cloud::Options{}
          .set<google::cloud::texttospeech_v1::
              ...
              google::cloud::GenericPollingPolicy<
                  google::cloud::texttospeech_v1::
                      TextToSpeechLongAudioSynthesizeRetryPolicyOption::Type,
                  google::cloud::texttospeech_v1::
                      TextToSpeechLongAudioSynthesizeBackoffPolicyOption::Type>(
                  google::cloud::texttospeech_v1::
                      TextToSpeechLongAudioSynthesizeLimitedTimeRetryPolicy(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::texttospeech_v1::
