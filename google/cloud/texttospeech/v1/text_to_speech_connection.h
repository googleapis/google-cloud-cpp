...
/**
 * A retry policy for `TextToSpeechConnection` that stops retrying after a
...
class TextToSpeechLimitedErrorCountRetryPolicy
 ...
 public:
  TextToSpeechLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `TextToSpeechConnection` that stops retrying after
