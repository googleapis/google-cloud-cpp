...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::cloudcontrolspartner_v1::
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::cloudcontrolspartner_v1::
      CloudControlsPartnerMonitoringClient(
          google::cloud::cloudcontrolspartner_v1::
              MakeCloudControlsPartnerMonitoringConnection(*ud_options));
  //! [set-client-universe-domain]
}

//! [custom-idempotency-policy]
class CustomIdempotencyPolicy
    : public google::cloud::cloudcontrolspartner_v1::
          CloudControlsPartnerMonitoringConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::cloudcontrolspartner_v1::
                      CloudControlsPartnerMonitoringConnectionIdempotencyPolicy>
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options =
      google::cloud::Options{}
          ...
          .set<google::cloud::cloudcontrolspartner_v1::
                   CloudControlsPartnerMonitoringRetryPolicyOption>(
              google::cloud::cloudcontrolspartner_v1::
                  CloudControlsPartnerMonitoringLimitedErrorCountRetryPolicy(3)
                      .clone())
          .set<google::cloud::cloudcontrolspartner_v1::
              ...
              google::cloud::ExponentialBackoffPolicy(
                  ...
                  /*scaling=*/2.0)
                  .clone());
  auto connection = google::cloud::cloudcontrolspartner_v1::
      MakeCloudControlsPartnerMonitoringConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::cloudcontrolspartner_v1::
      CloudControlsPartnerMonitoringClient(connection);
  auto c2 = google::cloud::cloudcontrolspartner_v1::
      CloudControlsPartnerMonitoringClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::cloudcontrolspartner_v1::
      CloudControlsPartnerMonitoringClient(
          connection,
          google::cloud::Options{}
              .set<google::cloud::cloudcontrolspartner_v1::
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::cloudcontrolspartner_v1::
        CloudControlsPartnerMonitoringClient(
            google::cloud::cloudcontrolspartner_v1::
                MakeCloudControlsPartnerMonitoringConnection(options));
  }
