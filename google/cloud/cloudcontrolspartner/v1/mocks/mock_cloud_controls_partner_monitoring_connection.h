 ...
 * `CloudControlsPartnerMonitoringClient`. To do so, construct an object of type
 * `CloudControlsPartnerMonitoringClient` with an instance of this class. Then
 ...
 */
class MockCloudControlsPartnerMonitoringConnection
