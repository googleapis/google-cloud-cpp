...
class CloudControlsPartnerMonitoringConnection {
 public:
  virtual ~CloudControlsPartnerMonitoringConnection() = 0;
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_CLOUDCONTROLSPARTNER_V1_CLOUD_CONTROLS_PARTNER_MONITORING_CONNECTION_H
