 ...
 * @ingroup google-cloud-cloudcontrolspartner-options
 */
struct CloudControlsPartnerCoreBackoffPolicyOption {
 ...
 * @ingroup google-cloud-cloudcontrolspartner-options
 */
struct CloudControlsPartnerCoreConnectionIdempotencyPolicyOption {
  using Type = std::shared_ptr<CloudControlsPartnerCoreConnectionIdempotencyPolicy>;
};

/**
 * The options applicable to CloudControlsPartnerCore.
 *
 * @ingroup google-cloud-cloudcontrolspartner-options
 */
using CloudControlsPartnerCorePolicyOptionList =
    OptionList<CloudControlsPartnerCoreRetryPolicyOption,
