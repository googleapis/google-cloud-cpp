 ...
 */
struct CloudControlsPartnerMonitoringRetryPolicyOption {
  using Type = std::shared_ptr<CloudControlsPartnerMonitoringRetryPolicy>;
};
 ...
 * @ingroup google-cloud-cloudcontrolspartner-options
 */
struct CloudControlsPartnerMonitoringBackoffPolicyOption {
...
/**
 * The options applicable to CloudControlsPartnerMonitoring.
 *
 * @ingroup google-cloud-cloudcontrolspartner-options
 */
using CloudControlsPartnerMonitoringPolicyOptionList =
    OptionList<CloudControlsPartnerMonitoringRetryPolicyOption,
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_CLOUDCONTROLSPARTNER_V1_CLOUD_CONTROLS_PARTNER_MONITORING_OPTIONS_H
