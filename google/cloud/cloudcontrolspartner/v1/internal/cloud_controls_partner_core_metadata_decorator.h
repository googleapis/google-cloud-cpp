...
class CloudControlsPartnerCoreMetadata : public CloudControlsPartnerCoreStub {
 public:
  ~CloudControlsPartnerCoreMetadata() override = default;
  CloudControlsPartnerCoreMetadata(
