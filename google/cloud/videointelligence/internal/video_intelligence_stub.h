...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_VIDEOINTELLIGENCE_INTERNAL_VIDEO_INTELLIGENCE_STUB_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_VIDEOINTELLIGENCE_INTERNAL_VIDEO_INTELLIGENCE_STUB_H
...
class VideoIntelligenceServiceStub {
 public:
  virtual ~VideoIntelligenceServiceStub() = 0;

  virtual future<StatusOr<google::longrunning::Operation>> AsyncAnnotateVideo(
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_VIDEOINTELLIGENCE_INTERNAL_VIDEO_INTELLIGENCE_STUB_H
