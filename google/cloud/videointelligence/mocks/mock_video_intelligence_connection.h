 ...
 * including errors from a `VideoIntelligenceServiceClient`. To do so, construct
 * a `VideoIntelligenceServiceClient` with an instance of this class. Then use
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_VIDEOINTELLIGENCE_MOCKS_MOCK_VIDEO_INTELLIGENCE_CONNECTION_H
