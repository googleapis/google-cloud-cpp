...
CreateDefaultVideoIntelligenceServiceStub(google::cloud::CompletionQueue cq,
  ...
  auto endpoint = internal::DetermineServiceEndpoint(
      internal::GetEnv("GOOGLE_CLOUD_CPP_VIDEO_INTELLIGENCE_SERVICE_ENDPOINT"),
      std::move(endpoint_option), "videointelligence.googleapis.com", options);
  ...
  if (!endpoint.ok()) {
    ...
    auto service_grpc_stub =
        google::cloud::videointelligence::v1::VideoIntelligenceService::NewStub(
            channel);
    stub = std::make_shared<DefaultVideoIntelligenceServiceStub>(
