...
class VideoIntelligenceServiceAuth : public VideoIntelligenceServiceStub {
 public:
  ~VideoIntelligenceServiceAuth() override = default;
  VideoIntelligenceServiceAuth(
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_VIDEOINTELLIGENCE_V1_INTERNAL_VIDEO_INTELLIGENCE_AUTH_DECORATOR_H
