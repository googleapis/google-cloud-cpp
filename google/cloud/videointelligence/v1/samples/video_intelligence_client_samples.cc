...
// clang-format off
// main-dox-marker: videointelligence_v1::VideoIntelligenceServiceClient
// lro-marker: true
// clang-format on
namespace {
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client =
      google::cloud::videointelligence_v1::VideoIntelligenceServiceClient(
          google::cloud::videointelligence_v1::
              MakeVideoIntelligenceServiceConnection(*ud_options));
  //! [set-client-universe-domain]
}
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  //       google::cloud::videointelligence_v1::VideoIntelligenceServiceLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
