...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_RUN_INTERNAL_REVISIONS_TRACING_CONNECTION_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_RUN_INTERNAL_REVISIONS_TRACING_CONNECTION_H
...
class RevisionsTracingConnection : public run::RevisionsConnection {
 public:
 ...
 private:
  std::shared_ptr<run::RevisionsConnection> child_;
};
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_RUN_INTERNAL_REVISIONS_TRACING_CONNECTION_H
