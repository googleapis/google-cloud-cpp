...
RevisionsTracingConnection::RevisionsTracingConnection(
    std::shared_ptr<run::RevisionsConnection> child)
...
std::shared_ptr<run::RevisionsConnection> MakeRevisionsTracingConnection(
    std::shared_ptr<run::RevisionsConnection> conn) {
#ifdef GOOGLE_CLOUD_CPP_HAVE_OPENTELEMETRY
