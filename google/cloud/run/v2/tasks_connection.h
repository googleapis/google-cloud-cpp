...
#include "google/cloud/run/v2/task.pb.h"
...
class TasksRetryPolicy : public ::google::cloud::RetryPolicy {
 public:
  /// Creates a new instance of the policy, reset to the initial state.
  virtual std::unique_ptr<TasksRetryPolicy> clone() const = 0;
};

/**
 * A retry policy for `TasksConnection` based on counting errors.
 *
 ...
 */
class TasksLimitedErrorCountRetryPolicy : public TasksRetryPolicy {
 public:
  /**
  ...
  std::unique_ptr<TasksRetryPolicy> clone() const override {
    return std::make_unique<TasksLimitedErrorCountRetryPolicy>(
        maximum_failures());
  }
...
/**
 * A retry policy for `TasksConnection` based on elapsed time.
 *
 * This policy stops retrying if:
 * - An RPC returns a non-transient error.
 ...
 * - [`kUnavailable`](@ref google::cloud::StatusCode)
 */
class TasksLimitedTimeRetryPolicy : public TasksRetryPolicy {
 public:
  /**
...
/**
 * The `TasksConnection` object for `TasksClient`.
 *
 * This interface defines virtual methods for each of the user-facing overload
 * sets in `TasksClient`. This allows users to inject custom behavior
 * (e.g., with a Google Mock object) when writing tests that use objects of type
 * `TasksClient`.
 *
 * To create a concrete instance, see `MakeTasksConnection()`.
 *
 * For mocking, see `run_v2_mocks::MockTasksConnection`.
 */
class TasksConnection {
 public:
  virtual ~TasksConnection() = 0;
 ...
 * should be passed as an argument to the constructor of TasksClient.
 *
 * The optional @p options argument may be used to configure aspects of the
 * returned `TasksConnection`. Expected options are any of the types in
 * the following option lists:
 *
 * - `google::cloud::CommonOptionList`
 * - `google::cloud::GrpcOptionList`
 * - `google::cloud::UnifiedCredentialsOptionList`
 * - `google::cloud::run_v2::TasksPolicyOptionList`
 *
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_RUN_V2_TASKS_CONNECTION_H
