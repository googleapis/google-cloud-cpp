...
/**
 * A retry policy for `RevisionsConnection` that stops retrying after a
...
class RevisionsLimitedErrorCountRetryPolicy : public RevisionsRetryPolicy {
 public:
  RevisionsLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `RevisionsConnection` that stops retrying after
