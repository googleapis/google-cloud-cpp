...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_RUN_V2_INTERNAL_REVISIONS_STUB_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_RUN_V2_INTERNAL_REVISIONS_STUB_H
...
class DefaultRevisionsStub : public RevisionsStub {
 public:
  DefaultRevisionsStub(
      std::unique_ptr<google::cloud::run::v2::Revisions::StubInterface> grpc_stub,
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_RUN_V2_INTERNAL_REVISIONS_STUB_H
