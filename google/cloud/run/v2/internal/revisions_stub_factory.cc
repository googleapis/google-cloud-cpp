...
#include "google/cloud/run/v2/internal/revisions_logging_decorator.h"
...
std::shared_ptr<RevisionsStub> CreateDefaultRevisionsStub(
    google::cloud::CompletionQueue cq, Options const& options) {
  auto endpoint = internal::DetermineServiceEndpoint(
      internal::GetEnv("GOOGLE_CLOUD_CPP_REVISIONS_ENDPOINT"),
      internal::FetchOption<EndpointOption>(options), "run.googleapis.com",
      options);
  ...
  if (!endpoint.ok()) {
    ...
    auto service_grpc_stub =
        google::cloud::run::v2::Revisions::NewStub(channel);
    stub = std::make_shared<DefaultRevisionsStub>(
