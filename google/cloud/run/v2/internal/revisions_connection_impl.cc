...
std::unique_ptr<run_v2::RevisionsRetryPolicy>
...
idempotency_policy(Options const& options) {
  return options.get<run_v2::RevisionsConnectionIdempotencyPolicyOption>()->clone();
}
...
RevisionsConnectionImpl::GetRevision(google::cloud::run::v2::GetRevisionRequest const& request) {
...
RevisionsConnectionImpl::ListRevisions(google::cloud::run::v2::ListRevisionsRequest request) {
  request.clear_page_token();
  auto current = google::cloud::internal::SaveCurrentOptions();
  auto idempotency = idempotency_policy(*current)->ListRevisions(request);
  char const* function_name = __func__;
  return google::cloud::internal::MakePaginationRange<StreamRange<google::cloud::run::v2::Revision>>(
      current, std::move(request),
      [idempotency, function_name, stub = stub_,
       retry = std::shared_ptr<run_v2::RevisionsRetryPolicy>(retry_policy(*current)),
       backoff = std::shared_ptr<BackoffPolicy>(backoff_policy(*current))](
          Options const& options, google::cloud::run::v2::ListRevisionsRequest const& r) {
        return google::cloud::internal::RetryLoop(
      ...
      [](google::cloud::run::v2::ListRevisionsResponse r) {
        std::vector<google::cloud::run::v2::Revision> result(r.revisions().size());
...
RevisionsConnectionImpl::DeleteRevision(google::cloud::run::v2::DeleteRevisionRequest const& request) {
  auto current = google::cloud::internal::SaveCurrentOptions();
  auto request_copy = request;
  auto const idempotent =
      idempotency_policy(*current)->DeleteRevision(request_copy);
  return google::cloud::internal::AsyncLongRunningOperation<google::cloud::run::v2::Revision>(
    background_->cq(), current, std::move(request_copy),
    [stub = stub_](google::cloud::CompletionQueue& cq,
                   std::shared_ptr<grpc::ClientContext> context,
                   google::cloud::internal::ImmutableOptions options,
                   google::cloud::run::v2::DeleteRevisionRequest const& request) {
     return stub->AsyncDeleteRevision(
    ...
    &google::cloud::internal::ExtractLongRunningResultResponse<google::cloud::run::v2::Revision>,
...
RevisionsConnectionImpl::DeleteRevision(
  ...
  if (!operation.metadata().Is<typename google::cloud::run::v2::Revision>()) {
    return make_ready_future<StatusOr<google::cloud::run::v2::Revision>>(
        internal::InvalidArgumentError("operation does not correspond to DeleteRevision",
                                       GCP_ERROR_INFO().WithMetadata("operation", operation.metadata().DebugString())));
  }

  return google::cloud::internal::AsyncAwaitLongRunningOperation<google::cloud::run::v2::Revision>(
...
RevisionsConnectionImpl::ListOperations(google::longrunning::ListOperationsRequest request) {
  request.clear_page_token();
  auto current = google::cloud::internal::SaveCurrentOptions();
...
StatusOr<google::longrunning::Operation>
RevisionsConnectionImpl::GetOperation(google::longrunning::GetOperationRequest const& request) {
  auto current = google::cloud::internal::SaveCurrentOptions();
  return google::cloud::internal::RetryLoop(
      retry_policy(*current), backoff_policy(*current),
...
Status
RevisionsConnectionImpl::DeleteOperation(google::longrunning::DeleteOperationRequest const& request) {
  auto current = google::cloud::internal::SaveCurrentOptions();
  return google::cloud::internal::RetryLoop(
      retry_policy(*current), backoff_policy(*current),
...
StatusOr<google::longrunning::Operation>
RevisionsConnectionImpl::WaitOperation(google::longrunning::WaitOperationRequest const& request) {
  auto current = google::cloud::internal::SaveCurrentOptions();
  return google::cloud::internal::RetryLoop(
      retry_policy(*current), backoff_policy(*current),
