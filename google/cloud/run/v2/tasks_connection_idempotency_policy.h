...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_RUN_V2_TASKS_CONNECTION_IDEMPOTENCY_POLICY_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_RUN_V2_TASKS_CONNECTION_IDEMPOTENCY_POLICY_H
...
class TasksConnectionIdempotencyPolicy {
 public:
  virtual ~TasksConnectionIdempotencyPolicy();
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_RUN_V2_TASKS_CONNECTION_IDEMPOTENCY_POLICY_H
