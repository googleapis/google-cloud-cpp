...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::run_v2::ExecutionsClient(
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::run_v2::ExecutionsClient(
      google::cloud::run_v2::MakeExecutionsConnection(*ud_options));
  //! [set-client-universe-domain]
}
