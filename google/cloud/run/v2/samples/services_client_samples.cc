...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::run_v2::ServicesClient(
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::run_v2::ServicesClient(
      google::cloud::run_v2::MakeServicesConnection(*ud_options));
  //! [set-client-universe-domain]
}
