...
// clang-format off
// main-dox-marker: run_v2::TasksClient
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::run_v2::TasksClient(
...
class CustomIdempotencyPolicy
 ...
 public:
  ...
  std::unique_ptr<google::cloud::run_v2::TasksConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    ...
    .set<google::cloud::run_v2::TasksRetryPolicyOption>(
      google::cloud::run_v2::TasksLimitedErrorCountRetryPolicy(3).clone())
  ...
  auto c3 = google::cloud::run_v2::TasksClient(
    connection, google::cloud::Options{}.set<google::cloud::run_v2::TasksRetryPolicyOption>(
      google::cloud::run_v2::TasksLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::run_v2::TasksClient(
      google::cloud::run_v2::MakeTasksConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
