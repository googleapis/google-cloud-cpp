...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::run_v2::RevisionsClient(
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::run_v2::RevisionsClient(
      google::cloud::run_v2::MakeRevisionsConnection(*ud_options));
  //! [set-client-universe-domain]
}
