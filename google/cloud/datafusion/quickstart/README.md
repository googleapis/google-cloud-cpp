# HOWTO: using the Cloud Data Fusion API C++ client in your project

This directory contains small examples showing how to use the Cloud Data Fusion API C++
...
Like most Google Cloud Platform (GCP) services, Cloud Data Fusion API requires that
...
[quickstart-link]: https://cloud.google.com/data-fusion/docs/how-to/enable-service
