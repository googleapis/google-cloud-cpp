...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DATAFUSION_V1_INTERNAL_DATA_FUSION_TRACING_STUB_H
...
class DataFusionTracingStub : public DataFusionStub {
 public:
  ~DataFusionTracingStub() override = default;

  explicit DataFusionTracingStub(std::shared_ptr<DataFusionStub> child);
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DATAFUSION_V1_INTERNAL_DATA_FUSION_TRACING_STUB_H
