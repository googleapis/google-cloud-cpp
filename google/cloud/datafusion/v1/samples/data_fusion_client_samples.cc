...
class CustomIdempotencyPolicy
   : public google::cloud::datafusion_v1::DataFusionConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::datafusion_v1::DataFusionConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::datafusion_v1::DataFusionConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::datafusion_v1::DataFusionRetryPolicyOption>(
      google::cloud::datafusion_v1::DataFusionLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::datafusion_v1::DataFusionBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::datafusion_v1::MakeDataFusionConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::datafusion_v1::DataFusionClient(connection);
  auto c2 = google::cloud::datafusion_v1::DataFusionClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::datafusion_v1::DataFusionClient(
    connection, google::cloud::Options{}.set<google::cloud::datafusion_v1::DataFusionRetryPolicyOption>(
      google::cloud::datafusion_v1::DataFusionLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::datafusion_v1::DataFusionRetryPolicyOption>(
  //       google::cloud::datafusion_v1::DataFusionLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::datafusion_v1::DataFusionPollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::datafusion_v1::DataFusionRetryPolicyOption::Type,
            google::cloud::datafusion_v1::DataFusionBackoffPolicyOption::Type>(
            google::cloud::datafusion_v1::DataFusionLimitedTimeRetryPolicy(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::datafusion_v1::DataFusionClient(
      google::cloud::datafusion_v1::MakeDataFusionConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
