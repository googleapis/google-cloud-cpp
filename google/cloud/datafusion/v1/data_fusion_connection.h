...
using DataFusionRetryPolicy = ::google::cloud::internal::TraitBasedRetryPolicy<
    datafusion_v1_internal::DataFusionRetryTraits>;

using DataFusionLimitedTimeRetryPolicy =
    ::google::cloud::internal::LimitedTimeRetryPolicy<
        datafusion_v1_internal::DataFusionRetryTraits>;

using DataFusionLimitedErrorCountRetryPolicy =
