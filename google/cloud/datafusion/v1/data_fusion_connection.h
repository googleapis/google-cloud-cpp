...
/**
 * A retry policy for `DataFusionConnection` that stops retrying after a
 ...
 */
class DataFusionLimitedErrorCountRetryPolicy : public DataFusionRetryPolicy {
 public:
  DataFusionLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `DataFusionConnection` that stops retrying after
/// some wall clock time has elapsed.
class DataFusionLimitedTimeRetryPolicy : public DataFusionRetryPolicy {
 public:
  /**
...
/**
 * The `DataFusionConnection` object for `DataFusionClient`.
 *
 * This interface defines virtual methods for each of the user-facing overload
 * sets in `DataFusionClient`. This allows users to inject custom behavior
 * (e.g., with a Google Mock object) when writing tests that use objects of type
 * `DataFusionClient`.
 *
 * To create a concrete instance, see `MakeDataFusionConnection()`.
 *
 * For mocking, see `datafusion_v1_mocks::MockDataFusionConnection`.
 */
class DataFusionConnection {
 public:
  virtual ~DataFusionConnection() = 0;
...
/**
 * A factory function to construct an object of type `DataFusionConnection`.
 *
 * The returned connection object should not be used directly; instead it
 * should be passed as an argument to the constructor of DataFusionClient.
 *
 * The optional @p options argument may be used to configure aspects of the
 * returned `DataFusionConnection`. Expected options are any of the types in
 * the following option lists:
 *
 * - `google::cloud::CommonOptionList`
 * - `google::cloud::GrpcOptionList`
 * - `google::cloud::UnifiedCredentialsOptionList`
 * - `google::cloud::datafusion_v1::DataFusionPolicyOptionList`
 *
 * @note Unexpected options will be ignored. To log unexpected options instead,
 *     set `GOOGLE_CLOUD_CPP_ENABLE_CLOG=yes` in the environment.
 *
 * @param options (optional) Configure the `DataFusionConnection` created by
 * this function.
 */
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DATAFUSION_V1_DATA_FUSION_CONNECTION_H
