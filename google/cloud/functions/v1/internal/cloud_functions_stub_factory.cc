...
CreateDefaultCloudFunctionsServiceStub(google::cloud::CompletionQueue cq,
  ...
  auto endpoint = internal::DetermineServiceEndpoint(
      ...
      std::move(endpoint_option), "cloudfunctions.googleapis.com", options);
  ...
  if (!endpoint.ok()) {
    ...
    stub = std::make_shared<DefaultCloudFunctionsServiceStub>(
  ...
  if (internal::TracingEnabled(options)) {
    stub = MakeCloudFunctionsServiceTracingStub(std::move(stub));
  }
  return stub;
}
