...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::functions_v1::CloudFunctionsServiceClient(
      google::cloud::functions_v1::MakeCloudFunctionsServiceConnection(options));
  //! [set-client-endpoint]
}

//! [custom-idempotency-policy]
class CustomIdempotencyPolicy
   : public google::cloud::functions_v1::CloudFunctionsServiceConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::functions_v1::CloudFunctionsServiceConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::functions_v1::CloudFunctionsServiceConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::functions_v1::CloudFunctionsServiceRetryPolicyOption>(
      google::cloud::functions_v1::CloudFunctionsServiceLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::functions_v1::CloudFunctionsServiceBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::functions_v1::MakeCloudFunctionsServiceConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::functions_v1::CloudFunctionsServiceClient(connection);
  auto c2 = google::cloud::functions_v1::CloudFunctionsServiceClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::functions_v1::CloudFunctionsServiceClient(
    connection, google::cloud::Options{}.set<google::cloud::functions_v1::CloudFunctionsServiceRetryPolicyOption>(
      google::cloud::functions_v1::CloudFunctionsServiceLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::functions_v1::CloudFunctionsServiceRetryPolicyOption>(
  //       google::cloud::functions_v1::CloudFunctionsServiceLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::functions_v1::CloudFunctionsServicePollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::functions_v1::CloudFunctionsServiceRetryPolicyOption::Type,
            google::cloud::functions_v1::CloudFunctionsServiceBackoffPolicyOption::Type>(
            google::cloud::functions_v1::CloudFunctionsServiceLimitedTimeRetryPolicy(
