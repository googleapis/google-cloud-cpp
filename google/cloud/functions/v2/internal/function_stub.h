...
class FunctionServiceStub {
 public:
  ...
  virtual StatusOr<google::cloud::functions::v2::ListFunctionsResponse> ListFunctions(
      grpc::ClientContext& context,
      Options const& options,
  ...
  virtual StatusOr<google::cloud::functions::v2::GenerateUploadUrlResponse> GenerateUploadUrl(
      grpc::ClientContext& context,
      Options const& options,
      google::cloud::functions::v2::GenerateUploadUrlRequest const& request) = 0;

  virtual StatusOr<google::cloud::functions::v2::GenerateDownloadUrlResponse> GenerateDownloadUrl(
      grpc::ClientContext& context,
      Options const& options,
      google::cloud::functions::v2::GenerateDownloadUrlRequest const& request) = 0;

  virtual StatusOr<google::cloud::functions::v2::ListRuntimesResponse> ListRuntimes(
      grpc::ClientContext& context,
      Options const& options,
...
class DefaultFunctionServiceStub : public FunctionServiceStub {
 public:
  DefaultFunctionServiceStub(
      std::unique_ptr<google::cloud::functions::v2::FunctionService::StubInterface> grpc_stub,
 ...
 private:
  std::unique_ptr<google::cloud::functions::v2::FunctionService::StubInterface> grpc_stub_;
