...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::functions_v2::FunctionServiceClient(
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::functions_v2::FunctionServiceClient(
      google::cloud::functions_v2::MakeFunctionServiceConnection(*ud_options));
  //! [set-client-universe-domain]
}

//! [custom-idempotency-policy]
class CustomIdempotencyPolicy : public google::cloud::functions_v2::
                                    FunctionServiceConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<
      google::cloud::functions_v2::FunctionServiceConnectionIdempotencyPolicy>
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
      ...
      google::cloud::Options{}
          ...
          .set<google::cloud::functions_v2::FunctionServiceRetryPolicyOption>(
              google::cloud::functions_v2::
                  FunctionServiceLimitedErrorCountRetryPolicy(3)
                      .clone())
  ...
  auto c3 = google::cloud::functions_v2::FunctionServiceClient(
      ...
      google::cloud::Options{}
          .set<google::cloud::functions_v2::FunctionServiceRetryPolicyOption>(
              google::cloud::functions_v2::
                  FunctionServiceLimitedTimeRetryPolicy(std::chrono::minutes(5))
                      .clone()));
      ...
      google::cloud::Options{}
          .set<google::cloud::functions_v2::FunctionServicePollingPolicyOption>(
              google::cloud::GenericPollingPolicy<
                  google::cloud::functions_v2::
                      FunctionServiceRetryPolicyOption::Type,
                  google::cloud::functions_v2::
                      FunctionServiceBackoffPolicyOption::Type>(
                  google::cloud::functions_v2::
