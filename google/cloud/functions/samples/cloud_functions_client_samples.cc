...
// main-dox-marker: GOOGLE_CLOUD_CPP_NS::CloudFunctionsServiceClient
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::GOOGLE_CLOUD_CPP_NS::CloudFunctionsServiceClient(
      google::cloud::GOOGLE_CLOUD_CPP_NS::MakeCloudFunctionsServiceConnection(
          options));
  //! [set-client-endpoint]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::GOOGLE_CLOUD_CPP_NS::CloudFunctionsServiceClient(
        google::cloud::GOOGLE_CLOUD_CPP_NS::MakeCloudFunctionsServiceConnection(
            options));
  }
  //! [with-service-account]
