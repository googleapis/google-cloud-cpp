...
inline std::unique_ptr<functions::CloudFunctionsServiceRetryPolicy>
retry_policy() {
  return internal::CurrentOptions()
      .get<functions::CloudFunctionsServiceRetryPolicyOption>()
      ->clone();
}

inline std::unique_ptr<BackoffPolicy> backoff_policy() {
  return internal::CurrentOptions()
      .get<functions::CloudFunctionsServiceBackoffPolicyOption>()
      ->clone();
}

inline std::unique_ptr<
    functions::CloudFunctionsServiceConnectionIdempotencyPolicy>
idempotency_policy() {
  return internal::CurrentOptions()
      .get<functions::CloudFunctionsServiceConnectionIdempotencyPolicyOption>()
      ->clone();
}

inline std::unique_ptr<PollingPolicy> polling_policy() {
  return internal::CurrentOptions()
      .get<functions::CloudFunctionsServicePollingPolicyOption>()
      ->clone();
}
