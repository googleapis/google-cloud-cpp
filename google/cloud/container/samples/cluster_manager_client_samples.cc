...
// main-dox-marker: GOOGLE_CLOUD_CPP_NS::ClusterManagerClient
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::GOOGLE_CLOUD_CPP_NS::ClusterManagerClient(
      google::cloud::GOOGLE_CLOUD_CPP_NS::MakeClusterManagerConnection(
          options));
  //! [set-client-endpoint]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::GOOGLE_CLOUD_CPP_NS::ClusterManagerClient(
        google::cloud::GOOGLE_CLOUD_CPP_NS::MakeClusterManagerConnection(
            options));
  }
  //! [with-service-account]
