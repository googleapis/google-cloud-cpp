...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::container_v1::ClusterManagerClient(
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::container_v1::ClusterManagerClient(
      google::cloud::container_v1::MakeClusterManagerConnection(*ud_options));
  //! [set-client-universe-domain]
}
