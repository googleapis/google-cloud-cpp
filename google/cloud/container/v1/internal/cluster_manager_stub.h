...
class ClusterManagerStub {
 public:
  ...
  virtual StatusOr<google::container::v1::ListOperationsResponse> ListOperations(
      grpc::ClientContext& context,
      Options const& options,
  ...
  virtual StatusOr<google::container::v1::GetJSONWebKeysResponse> GetJSONWebKeys(
      grpc::ClientContext& context,
      Options const& options,
  ...
  virtual StatusOr<google::container::v1::ListUsableSubnetworksResponse> ListUsableSubnetworks(
      grpc::ClientContext& context,
      Options const& options,
      google::container::v1::ListUsableSubnetworksRequest const& request) = 0;

  virtual StatusOr<google::container::v1::CheckAutopilotCompatibilityResponse> CheckAutopilotCompatibility(
      grpc::ClientContext& context,
      Options const& options,
      google::container::v1::CheckAutopilotCompatibilityRequest const& request) = 0;

  virtual StatusOr<google::container::v1::ClusterUpgradeInfo> FetchClusterUpgradeInfo(
      grpc::ClientContext& context,
      Options const& options,
      google::container::v1::FetchClusterUpgradeInfoRequest const& request) = 0;

  virtual StatusOr<google::container::v1::NodePoolUpgradeInfo> FetchNodePoolUpgradeInfo(
      grpc::ClientContext& context,
      Options const& options,
      google::container::v1::FetchNodePoolUpgradeInfoRequest const& request) = 0;
};

class DefaultClusterManagerStub : public ClusterManagerStub {
 public:
  explicit DefaultClusterManagerStub(
      std::unique_ptr<google::container::v1::ClusterManager::StubInterface> grpc_stub)
  ...
  StatusOr<google::container::v1::ListUsableSubnetworksResponse> ListUsableSubnetworks(
      grpc::ClientContext& context,
      Options const& options,
      google::container::v1::ListUsableSubnetworksRequest const& request) override;

  StatusOr<google::container::v1::CheckAutopilotCompatibilityResponse> CheckAutopilotCompatibility(
      grpc::ClientContext& context,
      Options const& options,
 ...
 private:
  std::unique_ptr<google::container::v1::ClusterManager::StubInterface> grpc_stub_;
};
