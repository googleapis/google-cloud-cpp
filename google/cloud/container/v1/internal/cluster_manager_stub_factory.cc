...
std::shared_ptr<ClusterManagerStub> CreateDefaultClusterManagerStub(
  ...
  auto endpoint = internal::DetermineServiceEndpoint(
      internal::GetEnv("GOOGLE_CLOUD_CPP_CLUSTER_MANAGER_ENDPOINT"),
      std::move(endpoint_option), "container.googleapis.com", options);
  ...
  if (!endpoint.ok()) {
    ...
    stub = std::make_shared<DefaultClusterManagerStub>(
