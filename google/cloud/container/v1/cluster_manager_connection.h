...
/**
 * A retry policy for `ClusterManagerConnection` that stops retrying after a
...
class ClusterManagerLimitedErrorCountRetryPolicy
 ...
 public:
  ClusterManagerLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `ClusterManagerConnection` that stops retrying after
