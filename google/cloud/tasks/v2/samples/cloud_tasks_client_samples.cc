...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::tasks_v2::CloudTasksClient(
      google::cloud::tasks_v2::MakeCloudTasksConnection(*ud_options));
  //! [set-client-universe-domain]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options =
      google::cloud::Options{}
          .set<google::cloud::tasks_v2::CloudTasksPollingPolicyOption>(
              google::cloud::GenericPollingPolicy<
                  google::cloud::tasks_v2::CloudTasksRetryPolicyOption::Type,
                  google::cloud::tasks_v2::CloudTasksBackoffPolicyOption::Type>(
                  google::cloud::tasks_v2::CloudTasksLimitedTimeRetryPolicy(
