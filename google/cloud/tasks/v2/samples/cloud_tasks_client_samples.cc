...
// clang-format off
// main-dox-marker: tasks_v2::CloudTasksClient
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::tasks_v2::CloudTasksClient(
...
class CustomIdempotencyPolicy
 ...
 public:
  ...
  std::unique_ptr<google::cloud::tasks_v2::CloudTasksConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::tasks_v2::CloudTasksConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::tasks_v2::CloudTasksRetryPolicyOption>(
      google::cloud::tasks_v2::CloudTasksLimitedErrorCountRetryPolicy(3).clone())
  ...
  auto c3 = google::cloud::tasks_v2::CloudTasksClient(
    connection, google::cloud::Options{}.set<google::cloud::tasks_v2::CloudTasksRetryPolicyOption>(
      google::cloud::tasks_v2::CloudTasksLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::tasks_v2::CloudTasksClient(
      google::cloud::tasks_v2::MakeCloudTasksConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
