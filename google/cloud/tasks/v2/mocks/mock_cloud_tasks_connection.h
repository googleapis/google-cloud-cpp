...
class MockCloudTasksConnection : public tasks_v2::CloudTasksConnection {
 public:
  ...
  MOCK_METHOD((StreamRange<google::cloud::tasks::v2::Queue>),
  ListQueues,
  (google::cloud::tasks::v2::ListQueuesRequest request), (override));

  MOCK_METHOD(StatusOr<google::cloud::tasks::v2::Queue>,
  GetQueue,
  ...
  MOCK_METHOD((StreamRange<google::cloud::tasks::v2::Task>),
  ListTasks,
  (google::cloud::tasks::v2::ListTasksRequest request), (override));

  MOCK_METHOD(StatusOr<google::cloud::tasks::v2::Task>,
  GetTask,
