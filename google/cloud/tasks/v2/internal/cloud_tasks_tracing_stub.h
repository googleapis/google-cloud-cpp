...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_TASKS_V2_INTERNAL_CLOUD_TASKS_TRACING_STUB_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_TASKS_V2_INTERNAL_CLOUD_TASKS_TRACING_STUB_H
...
class CloudTasksTracingStub : public CloudTasksStub {
 public:
  ...
  explicit CloudTasksTracingStub(std::shared_ptr<CloudTasksStub> child);
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_TASKS_V2_INTERNAL_CLOUD_TASKS_TRACING_STUB_H
