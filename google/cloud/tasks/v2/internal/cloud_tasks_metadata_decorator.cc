...
StatusOr<google::cloud::tasks::v2::Queue>
CloudTasksMetadata::CreateQueue(
    grpc::ClientContext& context,
    Options const& options,
...
StatusOr<google::cloud::tasks::v2::Queue>
CloudTasksMetadata::UpdateQueue(
    grpc::ClientContext& context,
    Options const& options,
    google::cloud::tasks::v2::UpdateQueueRequest const& request) {
  SetMetadata(context, options, absl::StrCat("queue.name=", internal::UrlEncode(request.queue().name())));
  return child_->UpdateQueue(context, options, request);
}

Status
CloudTasksMetadata::DeleteQueue(
    grpc::ClientContext& context,
    Options const& options,
...
StatusOr<google::cloud::tasks::v2::Queue>
CloudTasksMetadata::ResumeQueue(
    grpc::ClientContext& context,
    Options const& options,
...
CloudTasksMetadata::GetIamPolicy(
    grpc::ClientContext& context,
    Options const& options,
...
StatusOr<google::iam::v1::Policy>
CloudTasksMetadata::SetIamPolicy(
    grpc::ClientContext& context,
    Options const& options,
...
CloudTasksMetadata::GetLocation(
    grpc::ClientContext& context,
    Options const& options,
