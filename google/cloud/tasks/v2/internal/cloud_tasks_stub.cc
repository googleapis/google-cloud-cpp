...
DefaultCloudTasksStub::ListQueues(
  ...
  google::cloud::tasks::v2::ListQueuesRequest const& request) {
    ...
    auto status =
        grpc_stub_->ListQueues(&context, request, &response);
    if (!status.ok()) {
...
StatusOr<google::cloud::tasks::v2::Queue>
DefaultCloudTasksStub::CreateQueue(
  grpc::ClientContext& context, Options const&,
  google::cloud::tasks::v2::CreateQueueRequest const& request) {
    google::cloud::tasks::v2::Queue response;
    auto status =
        grpc_stub_->CreateQueue(&context, request, &response);
    if (!status.ok()) {
      return google::cloud::MakeStatusFromRpcError(status);
    }
    return response;
...
StatusOr<google::cloud::tasks::v2::Queue>
DefaultCloudTasksStub::UpdateQueue(
  grpc::ClientContext& context, Options const&,
  google::cloud::tasks::v2::UpdateQueueRequest const& request) {
    google::cloud::tasks::v2::Queue response;
    auto status =
        grpc_stub_->UpdateQueue(&context, request, &response);
    if (!status.ok()) {
      return google::cloud::MakeStatusFromRpcError(status);
    }
    return response;
...
Status
DefaultCloudTasksStub::DeleteQueue(
  grpc::ClientContext& context, Options const&,
  google::cloud::tasks::v2::DeleteQueueRequest const& request) {
    google::protobuf::Empty response;
    auto status =
        grpc_stub_->DeleteQueue(&context, request, &response);
    if (!status.ok()) {
      return google::cloud::MakeStatusFromRpcError(status);
    }
...
StatusOr<google::cloud::tasks::v2::Queue>
DefaultCloudTasksStub::PurgeQueue(
  grpc::ClientContext& context, Options const&,
  google::cloud::tasks::v2::PurgeQueueRequest const& request) {
    google::cloud::tasks::v2::Queue response;
    auto status =
        grpc_stub_->PurgeQueue(&context, request, &response);
    if (!status.ok()) {
      return google::cloud::MakeStatusFromRpcError(status);
    }
    return response;
...
StatusOr<google::cloud::tasks::v2::Queue>
DefaultCloudTasksStub::PauseQueue(
  grpc::ClientContext& context, Options const&,
  google::cloud::tasks::v2::PauseQueueRequest const& request) {
    google::cloud::tasks::v2::Queue response;
    auto status =
        grpc_stub_->PauseQueue(&context, request, &response);
    if (!status.ok()) {
      return google::cloud::MakeStatusFromRpcError(status);
    }
    return response;
...
StatusOr<google::cloud::tasks::v2::Queue>
DefaultCloudTasksStub::ResumeQueue(
  grpc::ClientContext& context, Options const&,
  google::cloud::tasks::v2::ResumeQueueRequest const& request) {
    google::cloud::tasks::v2::Queue response;
    auto status =
        grpc_stub_->ResumeQueue(&context, request, &response);
    if (!status.ok()) {
      return google::cloud::MakeStatusFromRpcError(status);
    }
    return response;
...
DefaultCloudTasksStub::GetIamPolicy(
  grpc::ClientContext& context, Options const&,
...
StatusOr<google::iam::v1::Policy>
DefaultCloudTasksStub::SetIamPolicy(
  grpc::ClientContext& context, Options const&,
...
StatusOr<google::cloud::tasks::v2::Task>
DefaultCloudTasksStub::CreateTask(
  grpc::ClientContext& context, Options const&,
  google::cloud::tasks::v2::CreateTaskRequest const& request) {
    google::cloud::tasks::v2::Task response;
    auto status =
        grpc_stub_->CreateTask(&context, request, &response);
    if (!status.ok()) {
      return google::cloud::MakeStatusFromRpcError(status);
    }
    return response;
...
Status
DefaultCloudTasksStub::DeleteTask(
  grpc::ClientContext& context, Options const&,
  google::cloud::tasks::v2::DeleteTaskRequest const& request) {
    google::protobuf::Empty response;
    auto status =
        grpc_stub_->DeleteTask(&context, request, &response);
    if (!status.ok()) {
      return google::cloud::MakeStatusFromRpcError(status);
    }
    return google::cloud::Status();
...
StatusOr<google::cloud::tasks::v2::Task>
DefaultCloudTasksStub::RunTask(
  grpc::ClientContext& context, Options const&,
  google::cloud::tasks::v2::RunTaskRequest const& request) {
    google::cloud::tasks::v2::Task response;
    auto status =
        grpc_stub_->RunTask(&context, request, &response);
    if (!status.ok()) {
      return google::cloud::MakeStatusFromRpcError(status);
    }
    return response;
...
DefaultCloudTasksStub::GetLocation(
  grpc::ClientContext& context, Options const&,
