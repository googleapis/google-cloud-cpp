...
/**
 * A retry policy for `CloudTasksConnection` that stops retrying after a
...
class CloudTasksLimitedErrorCountRetryPolicy : public CloudTasksRetryPolicy {
 public:
  CloudTasksLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `CloudTasksConnection` that stops retrying after
