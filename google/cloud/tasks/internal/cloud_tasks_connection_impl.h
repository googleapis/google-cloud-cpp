...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_TASKS_INTERNAL_CLOUD_TASKS_CONNECTION_IMPL_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_TASKS_INTERNAL_CLOUD_TASKS_CONNECTION_IMPL_H
...
class CloudTasksConnectionImpl
    : public tasks::CloudTasksConnection {
 public:
 ...
 private:
  ...
  std::unique_ptr<tasks::CloudTasksConnectionIdempotencyPolicy> idempotency_policy() {
    auto const& options = internal::CurrentOptions();
    if (options.has<tasks::CloudTasksConnectionIdempotencyPolicyOption>()) {
      return options.get<tasks::CloudTasksConnectionIdempotencyPolicyOption>()->clone();
    }
  ...
  std::unique_ptr<tasks::CloudTasksConnectionIdempotencyPolicy> idempotency_policy_;
};
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_TASKS_INTERNAL_CLOUD_TASKS_CONNECTION_IMPL_H
