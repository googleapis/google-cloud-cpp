...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_TASKS_INTERNAL_CLOUD_TASKS_TRACING_CONNECTION_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_TASKS_INTERNAL_CLOUD_TASKS_TRACING_CONNECTION_H
...
class CloudTasksTracingConnection : public tasks::CloudTasksConnection {
 public:
 ...
 private:
  std::shared_ptr<tasks::CloudTasksConnection> child_;
};
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_TASKS_INTERNAL_CLOUD_TASKS_TRACING_CONNECTION_H
