...
inline char const* Standard() { return "STANDARD"; }

inline char const* MultiRegional() { return "MULTI_REGIONAL"; }

inline char const* Regional() { return "REGIONAL"; }

inline char const* Nearline() { return "NEARLINE"; }

inline char const* Coldline() { return "COLDLINE"; }
