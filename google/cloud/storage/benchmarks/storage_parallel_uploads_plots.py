...
(p9.ggplot(data=data,
 ...
 + p9.geom_point()).save(args.output_prefix + '.by-mib.png')

# %%
(p9.ggplot(data=data,
           mapping=p9.aes(x='ShardCount', y='MiBs', color='MiB'))
 + p9.geom_point()).save(args.output_prefix + '.by-shard-count.png')
