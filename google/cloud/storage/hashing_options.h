 ...
 *
 * @deprecated Use `UploadChecksumValidationOption` and `DownloadChecksumValidationOption` instead.
 */
struct [[deprecated("Use UploadChecksumValidationOption and DownloadChecksumValidationOption instead")]] DisableMD5Hash : public internal::ComplexOption<DisableMD5Hash, bool> {
 ...
 * @deprecated Use `UploadChecksumValidationOption` and `DownloadChecksumValidationOption` instead.
 */
struct [[deprecated("Use UploadChecksumValidationOption and DownloadChecksumValidationOption instead")]] DisableCrc32cChecksum
