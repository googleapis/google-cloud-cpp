...
/**
 * Base class for implementing specific credential types.
 */
class Credentials {
 public:
  ...
  /**
   * Return the full "Authorization: <value>" HTTP header string. If this
   * credential does not contain a valid value, it will obtain one (e.g.
   * fetching an access token from the service).
   */
