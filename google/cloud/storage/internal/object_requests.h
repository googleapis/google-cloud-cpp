...
class CopyObjectRequest
 ...
 public:
  ...
  CopyObjectRequest(std::string destination_bucket,
                    std::string destination_object, std::string source_bucket,
                    std::string source_object, ObjectMetadata const& metadata)
