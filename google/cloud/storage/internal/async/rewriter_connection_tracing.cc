...
MakeTracingAsyncRewriterConnection(
  ...
  return std::make_shared<AsyncRewriterConnectionTracing>(std::move(impl),
                                                          std::move(span));
}
