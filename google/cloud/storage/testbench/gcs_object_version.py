...
"""A class to simulate a GCS object version in the client test bench."""
...
class GcsObjectVersion(object):
    ...
    def validate_encryption_for_read(self, request,
        ...
        gcs_service.validate_customer_encryption_headers(
    ...
    def _update_predefined_acl(self, predefined_acl):
        ...
        if predefined_acl == 'authenticatedRead':
            ...
            self.insert_acl(
                gcs_service.canonical_entity_name('allUsers'), 'READER')
        else:
            raise error_response.ErrorResponse(
