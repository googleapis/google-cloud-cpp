...
class AsyncClient {
 public:
  ...
  /*
    ...
    We recommend using `StartBufferedUpload()` and `ResumeBufferedUpload()` to
    upload data of unknown or arbitrary size.
    ...
    We recommend using `StartUnbufferedUpload()` and `ResumeBufferedUpload()` to
    upload data where the upload can efficiently resume from arbitrary points.
