 ...
 */
struct [[deprecated("Use UploadChecksumValidationOption and DownloadChecksumValidationOption instead")]] EnableCrc32cValidationOption {
  using Type = bool;
};
 ...
 * @deprecated Use `UploadChecksumValidationOption` and `DownloadChecksumValidationOption` instead.
 */
struct [[deprecated("Use UploadChecksumValidationOption and DownloadChecksumValidationOption instead")]] EnableMD5ValidationOption {
  using Type = bool;
};
