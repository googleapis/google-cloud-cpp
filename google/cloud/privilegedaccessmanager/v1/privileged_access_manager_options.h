 ...
 */
struct PrivilegedAccessManagerRetryPolicyOption {
  using Type = std::shared_ptr<PrivilegedAccessManagerRetryPolicy>;
};
 ...
 * @ingroup google-cloud-privilegedaccessmanager-options
 */
struct PrivilegedAccessManagerBackoffPolicyOption {
 ...
 * @ingroup google-cloud-privilegedaccessmanager-options
 */
struct PrivilegedAccessManagerPollingPolicyOption {
  using Type = std::shared_ptr<PollingPolicy>;
};

/**
 * The options applicable to PrivilegedAccessManager.
 *
 * @ingroup google-cloud-privilegedaccessmanager-options
 */
using PrivilegedAccessManagerPolicyOptionList =
    OptionList<PrivilegedAccessManagerRetryPolicyOption,
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_PRIVILEGEDACCESSMANAGER_V1_PRIVILEGED_ACCESS_MANAGER_OPTIONS_H
