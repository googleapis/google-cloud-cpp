...
[Access Approval API][cloud-service-docs], a service that An API for controlling access to data by Google personnel.
...
[cloud-service-docs]: https://cloud.google.com/accessapproval
...
```cc
#include "google/cloud/accessapproval/ EDIT HERE .h"
#include <iostream>
#include <stdexcept>
...
int main(int argc, char* argv[]) try {
  ...
  auto client = accessapproval::Client(
      accessapproval::MakeConnection(/* EDIT HERE */));
