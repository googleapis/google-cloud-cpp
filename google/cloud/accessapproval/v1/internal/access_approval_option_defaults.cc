...
Options AccessApprovalDefaultOptions(Options options) {
  ...
  if (!options.has<accessapproval_v1::AccessApprovalConnectionIdempotencyPolicyOption>()) {
    options.set<accessapproval_v1::AccessApprovalConnectionIdempotencyPolicyOption>(
