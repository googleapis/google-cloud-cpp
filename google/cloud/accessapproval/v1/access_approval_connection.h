...
/**
 * A retry policy for `AccessApprovalConnection` that stops retrying after a
...
class AccessApprovalLimitedErrorCountRetryPolicy
 ...
 public:
  AccessApprovalLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `AccessApprovalConnection` that stops retrying after
