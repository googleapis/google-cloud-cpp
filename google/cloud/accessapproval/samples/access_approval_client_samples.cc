...
// main-dox-marker: GOOGLE_CLOUD_CPP_NS::AccessApprovalClient
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::GOOGLE_CLOUD_CPP_NS::AccessApprovalClient(
      google::cloud::GOOGLE_CLOUD_CPP_NS::MakeAccessApprovalConnection(
          options));
  //! [set-client-endpoint]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::GOOGLE_CLOUD_CPP_NS::AccessApprovalClient(
        google::cloud::GOOGLE_CLOUD_CPP_NS::MakeAccessApprovalConnection(
            options));
  }
  //! [with-service-account]
