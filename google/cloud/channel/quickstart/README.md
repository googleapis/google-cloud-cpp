# HOWTO: using the Cloud Channel API C++ client in your project

This directory contains small examples showing how to use the Cloud Channel API C++
...
1. Install the dependencies with your favorite tools. As an example, if you use
   ...
   ```bash
   cd $HOME/vcpkg
   ./vcpkg install google-cloud-cpp[core,channel]
   ```
...
1. Configure CMake, if necessary, configure the directory where you installed
   ...
   ```bash
   cd $HOME/gooogle-cloud-cpp/google/cloud/channel/quickstart
...
[quickstart-link]: https://cloud.google.com/channel/docs/access-api
