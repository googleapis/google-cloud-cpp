...
std::shared_ptr<CloudChannelServiceStub> CreateDefaultCloudChannelServiceStub(
  ...
  auto endpoint = internal::DetermineServiceEndpoint(
      internal::GetEnv("GOOGLE_CLOUD_CPP_CLOUD_CHANNEL_SERVICE_ENDPOINT"),
      std::move(endpoint_option), "cloudchannel.googleapis.com", options);
  ...
  if (!endpoint.ok()) {
    ...
    auto service_grpc_stub =
        google::cloud::channel::v1::CloudChannelService::NewStub(channel);
    stub = std::make_shared<DefaultCloudChannelServiceStub>(
