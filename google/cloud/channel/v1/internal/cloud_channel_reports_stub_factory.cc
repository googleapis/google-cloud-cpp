...
CreateDefaultCloudChannelReportsServiceStub(google::cloud::CompletionQueue cq,
  ...
  if (!endpoint.ok()) {
    ...
    auto service_grpc_stub =
        google::cloud::channel::v1::CloudChannelReportsService::NewStub(
            channel);
    stub = std::make_shared<DefaultCloudChannelReportsServiceStub>(
