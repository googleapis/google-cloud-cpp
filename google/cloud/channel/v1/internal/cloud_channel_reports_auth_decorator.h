...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_CHANNEL_V1_INTERNAL_CLOUD_CHANNEL_REPORTS_AUTH_DECORATOR_H
...
class CloudChannelReportsServiceAuth : public CloudChannelReportsServiceStub {
 public:
  ~CloudChannelReportsServiceAuth() override = default;
  CloudChannelReportsServiceAuth(
