...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_CHANNEL_V1_INTERNAL_CLOUD_CHANNEL_REPORTS_METADATA_DECORATOR_H
...
class CloudChannelReportsServiceMetadata : public CloudChannelReportsServiceStub {
 public:
