...
// clang-format off
// main-dox-marker: channel_v1::CloudChannelServiceClient
// lro-marker: true
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::channel_v1::CloudChannelServiceClient(
...
class CustomIdempotencyPolicy
   : public google::cloud::channel_v1::CloudChannelServiceConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::channel_v1::CloudChannelServiceConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::channel_v1::CloudChannelServiceConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::channel_v1::CloudChannelServiceRetryPolicyOption>(
      google::cloud::channel_v1::CloudChannelServiceLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::channel_v1::CloudChannelServiceBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::channel_v1::MakeCloudChannelServiceConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::channel_v1::CloudChannelServiceClient(connection);
  auto c2 = google::cloud::channel_v1::CloudChannelServiceClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::channel_v1::CloudChannelServiceClient(
    connection, google::cloud::Options{}.set<google::cloud::channel_v1::CloudChannelServiceRetryPolicyOption>(
      google::cloud::channel_v1::CloudChannelServiceLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::channel_v1::CloudChannelServiceRetryPolicyOption>(
  //       google::cloud::channel_v1::CloudChannelServiceLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::channel_v1::CloudChannelServicePollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::channel_v1::CloudChannelServiceRetryPolicyOption::Type,
            google::cloud::channel_v1::CloudChannelServiceBackoffPolicyOption::Type>(
            google::cloud::channel_v1::CloudChannelServiceLimitedTimeRetryPolicy(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::channel_v1::CloudChannelServiceClient(
      google::cloud::channel_v1::MakeCloudChannelServiceConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
