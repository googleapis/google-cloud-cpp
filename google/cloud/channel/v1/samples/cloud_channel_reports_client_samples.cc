...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::channel_v1::CloudChannelReportsServiceClient(
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::channel_v1::CloudChannelReportsServiceClient(
      google::cloud::channel_v1::MakeCloudChannelReportsServiceConnection(
          *ud_options));
  //! [set-client-universe-domain]
}
      ...
      google::cloud::Options{}
          .set<google::cloud::channel_v1::
              ...
              google::cloud::GenericPollingPolicy<
                  google::cloud::channel_v1::
                      CloudChannelReportsServiceRetryPolicyOption::Type,
                  google::cloud::channel_v1::
                      CloudChannelReportsServiceBackoffPolicyOption::Type>(
                  google::cloud::channel_v1::
                      CloudChannelReportsServiceLimitedTimeRetryPolicy(
