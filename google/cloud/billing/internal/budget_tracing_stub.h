...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_BILLING_INTERNAL_BUDGET_TRACING_STUB_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_BILLING_INTERNAL_BUDGET_TRACING_STUB_H
...
class BudgetServiceTracingStub : public BudgetServiceStub {
 public:
  ...
  explicit BudgetServiceTracingStub(std::shared_ptr<BudgetServiceStub> child);
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_BILLING_INTERNAL_BUDGET_TRACING_STUB_H
