...
inline std::unique_ptr<billing::CloudBillingRetryPolicy> retry_policy() {
  return internal::CurrentOptions()
      .get<billing::CloudBillingRetryPolicyOption>()
      ->clone();
}

inline std::unique_ptr<BackoffPolicy> backoff_policy() {
  return internal::CurrentOptions()
      .get<billing::CloudBillingBackoffPolicyOption>()
      ->clone();
}

inline std::unique_ptr<billing::CloudBillingConnectionIdempotencyPolicy>
idempotency_policy() {
  return internal::CurrentOptions()
