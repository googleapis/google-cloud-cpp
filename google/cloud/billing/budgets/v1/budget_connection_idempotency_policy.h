...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_BILLING_BUDGETS_V1_BUDGET_CONNECTION_IDEMPOTENCY_POLICY_H
...
class BudgetServiceConnectionIdempotencyPolicy {
 public:
  ...
  virtual std::unique_ptr<BudgetServiceConnectionIdempotencyPolicy> clone() const;
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_BILLING_BUDGETS_V1_BUDGET_CONNECTION_IDEMPOTENCY_POLICY_H
