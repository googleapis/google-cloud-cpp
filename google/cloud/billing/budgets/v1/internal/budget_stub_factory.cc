...
std::shared_ptr<BudgetServiceStub> CreateDefaultBudgetServiceStub(
  ...
  auto endpoint = internal::DetermineServiceEndpoint(
      internal::GetEnv("GOOGLE_CLOUD_CPP_BUDGET_SERVICE_ENDPOINT"),
      std::move(endpoint_option), "billingbudgets.googleapis.com", options);
  ...
  if (!endpoint.ok()) {
    ...
    auto service_grpc_stub =
        google::cloud::billing::budgets::v1::BudgetService::NewStub(channel);
    stub = std::make_shared<DefaultBudgetServiceStub>(
