...
/**
 * A retry policy for `BudgetServiceConnection` that stops retrying after a
...
class BudgetServiceLimitedErrorCountRetryPolicy
 ...
 public:
  BudgetServiceLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `BudgetServiceConnection` that stops retrying after
