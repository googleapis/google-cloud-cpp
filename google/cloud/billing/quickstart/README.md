# HOWTO: using the Cloud Billing Budget API C++ client in your project

This directory contains small examples showing how to use the Cloud Billing Budget API C++
...
2. Install the dependencies with your favorite tools. As an example, if you use
   ...
   ```bash
   cd $HOME/vcpkg
   ./vcpkg install google-cloud-cpp[core,billing]
   ```
...
3. Configure CMake, if necessary, configure the directory where you installed
   ...
   ```bash
   cd $HOME/gooogle-cloud-cpp/google/cloud/billing/quickstart
...
[quickstart-link]: https://cloud.google.com/billing/docs
