...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_BILLING_MOCKS_MOCK_BUDGET_CONNECTION_H
 ...
 * including errors from a `BudgetServiceClient`. To do so, construct a
 * `BudgetServiceClient` with an instance of this class. Then use the Google
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_BILLING_MOCKS_MOCK_BUDGET_CONNECTION_H
