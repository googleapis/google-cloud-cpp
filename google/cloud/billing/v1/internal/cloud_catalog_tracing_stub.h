...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_BILLING_V1_INTERNAL_CLOUD_CATALOG_TRACING_STUB_H
...
class CloudCatalogTracingStub : public CloudCatalogStub {
 public:
  ~CloudCatalogTracingStub() override = default;
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_BILLING_V1_INTERNAL_CLOUD_CATALOG_TRACING_STUB_H
