...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_BILLING_V1_INTERNAL_CLOUD_BILLING_LOGGING_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_BILLING_V1_INTERNAL_CLOUD_BILLING_LOGGING_DECORATOR_H
...
class CloudBillingLogging : public CloudBillingStub {
 public:
  ~CloudBillingLogging() override = default;
  CloudBillingLogging(std::shared_ptr<CloudBillingStub> child,
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_BILLING_V1_INTERNAL_CLOUD_BILLING_LOGGING_DECORATOR_H
