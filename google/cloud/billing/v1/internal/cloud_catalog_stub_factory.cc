...
std::shared_ptr<CloudCatalogStub> CreateDefaultCloudCatalogStub(
  ...
  auto endpoint = internal::DetermineServiceEndpoint(
      internal::GetEnv("GOOGLE_CLOUD_CPP_CLOUD_CATALOG_ENDPOINT"),
      std::move(endpoint_option), "cloudbilling.googleapis.com", options);
  ...
  if (internal::TracingEnabled(options)) {
    stub = MakeCloudCatalogTracingStub(std::move(stub));
  }
  return stub;
}
