...
/**
 * A retry policy for `CloudBillingConnection` that stops retrying after a
...
class CloudBillingLimitedErrorCountRetryPolicy
 ...
 public:
  CloudBillingLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `CloudBillingConnection` that stops retrying after
