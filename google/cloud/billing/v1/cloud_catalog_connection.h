...
/**
 * A retry policy for `CloudCatalogConnection` that stops retrying after a
...
class CloudCatalogLimitedErrorCountRetryPolicy
 ...
 public:
  CloudCatalogLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `CloudCatalogConnection` that stops retrying after
