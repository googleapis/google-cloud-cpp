...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_CLOUDPROFILER_INTERNAL_PROFILER_AUTH_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_CLOUDPROFILER_INTERNAL_PROFILER_AUTH_DECORATOR_H
...
class ProfilerServiceAuth : public ProfilerServiceStub {
 public:
  ~ProfilerServiceAuth() override = default;
  ProfilerServiceAuth(
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_CLOUDPROFILER_INTERNAL_PROFILER_AUTH_DECORATOR_H
