...
class ExportServiceAuth : public ExportServiceStub {
 public:
  ~ExportServiceAuth() override = default;
  ExportServiceAuth(
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_PROFILER_V2_INTERNAL_EXPORT_AUTH_DECORATOR_H
