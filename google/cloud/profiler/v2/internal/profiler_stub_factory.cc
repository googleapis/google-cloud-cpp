...
std::shared_ptr<ProfilerServiceStub> CreateDefaultProfilerServiceStub(
  ...
  auto endpoint = internal::DetermineServiceEndpoint(
      internal::GetEnv("GOOGLE_CLOUD_CPP_PROFILER_SERVICE_ENDPOINT"),
      std::move(endpoint_option), "cloudprofiler.googleapis.com", options);
  ...
  if (!endpoint.ok()) {
    ...
    stub = std::make_shared<DefaultProfilerServiceStub>(
