...
class ExportServiceTracingStub : public ExportServiceStub {
 public:
  ~ExportServiceTracingStub() override = default;
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_PROFILER_V2_INTERNAL_EXPORT_TRACING_STUB_H
