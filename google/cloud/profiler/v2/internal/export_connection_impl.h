...
class ExportServiceConnectionImpl
 ...
 private:
  ...
  std::shared_ptr<profiler_v2_internal::ExportServiceStub> stub_;
  Options options_;
};
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_PROFILER_V2_INTERNAL_EXPORT_CONNECTION_IMPL_H
