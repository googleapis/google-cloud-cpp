...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_PROFILER_V2_EXPORT_CONNECTION_IDEMPOTENCY_POLICY_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_PROFILER_V2_EXPORT_CONNECTION_IDEMPOTENCY_POLICY_H
...
class ExportServiceConnectionIdempotencyPolicy {
 public:
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_PROFILER_V2_EXPORT_CONNECTION_IDEMPOTENCY_POLICY_H
