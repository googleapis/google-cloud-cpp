...
/**
 * A retry policy for `ProfilerServiceConnection` that stops retrying after a
...
class ProfilerServiceLimitedErrorCountRetryPolicy
 ...
 public:
  ProfilerServiceLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `ProfilerServiceConnection` that stops retrying after
