...
/**
 * A retry policy for `VmMigrationConnection` that stops retrying after a
...
class VmMigrationLimitedErrorCountRetryPolicy : public VmMigrationRetryPolicy {
 public:
  VmMigrationLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `VmMigrationConnection` that stops retrying after
