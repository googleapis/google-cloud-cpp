...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::vmmigration_v1::VmMigrationClient(
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::vmmigration_v1::VmMigrationClient(
      google::cloud::vmmigration_v1::MakeVmMigrationConnection(*ud_options));
  //! [set-client-universe-domain]
}
