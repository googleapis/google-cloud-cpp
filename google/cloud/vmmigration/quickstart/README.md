...
This directory contains small examples showing how to use the VM Migration API
...
1. Install the dependencies with your favorite tools. As an example, if you use
   ...
   ```bash
   cd $HOME/vcpkg
   ./vcpkg install google-cloud-cpp[core,vmmigration]
   ```
...
[quickstart-link]: https://cloud.google.com/migrate/compute-engine/docs/quickstarts
