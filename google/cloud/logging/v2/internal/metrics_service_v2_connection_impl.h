...
class MetricsServiceV2ConnectionImpl
 ...
 private:
  std::unique_ptr<logging_v2::MetricsServiceV2RetryPolicy> retry_policy() {
    ...
    return options_.get<logging_v2::MetricsServiceV2RetryPolicyOption>()->clone();
  }
  ...
  std::unique_ptr<BackoffPolicy> backoff_policy() {
    ...
    return options_.get<logging_v2::MetricsServiceV2BackoffPolicyOption>()->clone();
  }

  std::unique_ptr<logging_v2::MetricsServiceV2ConnectionIdempotencyPolicy> idempotency_policy() {
    auto const& options = internal::CurrentOptions();
    ...
    return options_.get<logging_v2::MetricsServiceV2ConnectionIdempotencyPolicyOption>()->
clone();
  }
