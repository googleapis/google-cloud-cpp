...
DefaultConfigServiceV2Stub::ListBuckets(
  ...
  google::logging::v2::ListBucketsRequest const& request) {
    ...
    auto status =
        grpc_stub_->ListBuckets(&client_context, request, &response);
    if (!status.ok()) {
...
DefaultConfigServiceV2Stub::GetBucket(
  ...
  google::logging::v2::GetBucketRequest const& request) {
    ...
    auto status =
        grpc_stub_->GetBucket(&client_context, request, &response);
    if (!status.ok()) {
      return google::cloud::MakeStatusFromRpcError(status);
    }
    return response;
...
DefaultConfigServiceV2Stub::CreateBucket(
  ...
  google::logging::v2::CreateBucketRequest const& request) {
    google::logging::v2::LogBucket response;
    auto status =
        grpc_stub_->CreateBucket(&client_context, request, &response);
    if (!status.ok()) {
      return google::cloud::MakeStatusFromRpcError(status);
    }
    return response;
...
DefaultConfigServiceV2Stub::UpdateBucket(
  ...
  google::logging::v2::UpdateBucketRequest const& request) {
    google::logging::v2::LogBucket response;
    auto status =
        grpc_stub_->UpdateBucket(&client_context, request, &response);
    if (!status.ok()) {
      return google::cloud::MakeStatusFromRpcError(status);
    }
    return response;
...
DefaultConfigServiceV2Stub::DeleteBucket(
  ...
  google::logging::v2::DeleteBucketRequest const& request) {
    ...
    auto status =
        grpc_stub_->DeleteBucket(&client_context, request, &response);
    if (!status.ok()) {
      return google::cloud::MakeStatusFromRpcError(status);
    }
...
DefaultConfigServiceV2Stub::UndeleteBucket(
  ...
  google::logging::v2::UndeleteBucketRequest const& request) {
    google::protobuf::Empty response;
    auto status =
        grpc_stub_->UndeleteBucket(&client_context, request, &response);
    if (!status.ok()) {
      return google::cloud::MakeStatusFromRpcError(status);
    }
    return google::cloud::Status();
...
DefaultConfigServiceV2Stub::ListViews(
  ...
  google::logging::v2::ListViewsRequest const& request) {
    ...
    auto status =
        grpc_stub_->ListViews(&client_context, request, &response);
    if (!status.ok()) {
      return google::cloud::MakeStatusFromRpcError(status);
    }
    return response;
...
DefaultConfigServiceV2Stub::GetView(
  ...
  google::logging::v2::GetViewRequest const& request) {
    ...
    auto status =
        grpc_stub_->GetView(&client_context, request, &response);
    if (!status.ok()) {
      return google::cloud::MakeStatusFromRpcError(status);
    }
    return response;
...
DefaultConfigServiceV2Stub::CreateView(
  ...
  google::logging::v2::CreateViewRequest const& request) {
    google::logging::v2::LogView response;
    auto status =
        grpc_stub_->CreateView(&client_context, request, &response);
    if (!status.ok()) {
      return google::cloud::MakeStatusFromRpcError(status);
    }
    return response;
...
DefaultConfigServiceV2Stub::UpdateView(
  ...
  google::logging::v2::UpdateViewRequest const& request) {
    google::logging::v2::LogView response;
    auto status =
        grpc_stub_->UpdateView(&client_context, request, &response);
    if (!status.ok()) {
      return google::cloud::MakeStatusFromRpcError(status);
    }
    return response;
...
DefaultConfigServiceV2Stub::DeleteView(
  ...
  google::logging::v2::DeleteViewRequest const& request) {
    google::protobuf::Empty response;
    auto status =
        grpc_stub_->DeleteView(&client_context, request, &response);
    if (!status.ok()) {
      return google::cloud::MakeStatusFromRpcError(status);
    }
    return google::cloud::Status();
...
DefaultConfigServiceV2Stub::ListSinks(
  ...
  google::logging::v2::ListSinksRequest const& request) {
    ...
    auto status =
        grpc_stub_->ListSinks(&client_context, request, &response);
    if (!status.ok()) {
      return google::cloud::MakeStatusFromRpcError(status);
    }
    return response;
...
DefaultConfigServiceV2Stub::GetSink(
  ...
  google::logging::v2::GetSinkRequest const& request) {
    ...
    auto status =
        grpc_stub_->GetSink(&client_context, request, &response);
    if (!status.ok()) {
      return google::cloud::MakeStatusFromRpcError(status);
    }
    return response;
...
DefaultConfigServiceV2Stub::CreateSink(
  ...
  google::logging::v2::CreateSinkRequest const& request) {
    google::logging::v2::LogSink response;
    auto status =
        grpc_stub_->CreateSink(&client_context, request, &response);
    if (!status.ok()) {
      return google::cloud::MakeStatusFromRpcError(status);
    }
    return response;
...
DefaultConfigServiceV2Stub::UpdateSink(
  ...
  google::logging::v2::UpdateSinkRequest const& request) {
    google::logging::v2::LogSink response;
    auto status =
        grpc_stub_->UpdateSink(&client_context, request, &response);
    if (!status.ok()) {
      return google::cloud::MakeStatusFromRpcError(status);
    }
    return response;
...
DefaultConfigServiceV2Stub::DeleteSink(
  ...
  google::logging::v2::DeleteSinkRequest const& request) {
    google::protobuf::Empty response;
    auto status =
        grpc_stub_->DeleteSink(&client_context, request, &response);
    if (!status.ok()) {
      return google::cloud::MakeStatusFromRpcError(status);
    }
    return google::cloud::Status();
...
DefaultConfigServiceV2Stub::ListLinks(
  ...
  google::logging::v2::ListLinksRequest const& request) {
    ...
    auto status =
        grpc_stub_->ListLinks(&client_context, request, &response);
    if (!status.ok()) {
      return google::cloud::MakeStatusFromRpcError(status);
    }
    return response;
...
DefaultConfigServiceV2Stub::GetLink(
  ...
  google::logging::v2::GetLinkRequest const& request) {
    ...
    auto status =
        grpc_stub_->GetLink(&client_context, request, &response);
    if (!status.ok()) {
      return google::cloud::MakeStatusFromRpcError(status);
    }
    return response;
...
DefaultConfigServiceV2Stub::ListExclusions(
  ...
  google::logging::v2::ListExclusionsRequest const& request) {
    ...
    auto status =
        grpc_stub_->ListExclusions(&client_context, request, &response);
    if (!status.ok()) {
      return google::cloud::MakeStatusFromRpcError(status);
    }
    return response;
...
DefaultConfigServiceV2Stub::GetExclusion(
  ...
  google::logging::v2::GetExclusionRequest const& request) {
    ...
    auto status =
        grpc_stub_->GetExclusion(&client_context, request, &response);
    if (!status.ok()) {
      return google::cloud::MakeStatusFromRpcError(status);
    }
    return response;
...
DefaultConfigServiceV2Stub::GetSettings(
  ...
  google::logging::v2::GetSettingsRequest const& request) {
    ...
    auto status =
        grpc_stub_->GetSettings(&client_context, request, &response);
    if (!status.ok()) {
      return google::cloud::MakeStatusFromRpcError(status);
    }
    return response;
...
DefaultConfigServiceV2Stub::UpdateSettings(
  ...
  google::logging::v2::UpdateSettingsRequest const& request) {
    google::logging::v2::Settings response;
    auto status =
        grpc_stub_->UpdateSettings(&client_context, request, &response);
    if (!status.ok()) {
      return google::cloud::MakeStatusFromRpcError(status);
    }
    return response;
