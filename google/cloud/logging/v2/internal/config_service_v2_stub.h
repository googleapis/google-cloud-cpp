...
class ConfigServiceV2Stub {
 public:
  ...
  virtual future<StatusOr<google::longrunning::Operation>> AsyncCreateBucketAsync(
  ...
  virtual future<StatusOr<google::longrunning::Operation>> AsyncUpdateBucketAsync(
      google::cloud::CompletionQueue& cq,
      std::shared_ptr<grpc::ClientContext> context,
      google::cloud::internal::ImmutableOptions options,
...
class DefaultConfigServiceV2Stub : public ConfigServiceV2Stub {
 public:
  DefaultConfigServiceV2Stub(
      std::unique_ptr<google::logging::v2::ConfigServiceV2::StubInterface> grpc_stub,
 ...
 private:
  std::unique_ptr<google::logging::v2::ConfigServiceV2::StubInterface> grpc_stub_;
