...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_LOGGING_V2_INTERNAL_CONFIG_SERVICE_V2_TRACING_STUB_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_LOGGING_V2_INTERNAL_CONFIG_SERVICE_V2_TRACING_STUB_H
...
class ConfigServiceV2TracingStub : public ConfigServiceV2Stub {
 public:
  ~ConfigServiceV2TracingStub() override = default;

  explicit ConfigServiceV2TracingStub(std::shared_ptr<ConfigServiceV2Stub> child);
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_LOGGING_V2_INTERNAL_CONFIG_SERVICE_V2_TRACING_STUB_H
