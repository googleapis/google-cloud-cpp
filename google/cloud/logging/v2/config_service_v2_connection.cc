...
StreamRange<google::logging::v2::LogBucket> ConfigServiceV2Connection::ListBuckets(
    google::logging::v2::ListBucketsRequest) {  // NOLINT(performance-unnecessary-value-param)
  return google::cloud::internal::MakeUnimplementedPaginationRange<
      StreamRange<google::logging::v2::LogBucket>>();
}

StatusOr<google::logging::v2::LogBucket>
ConfigServiceV2Connection::GetBucket(
...
StreamRange<google::logging::v2::Link> ConfigServiceV2Connection::ListLinks(
    google::logging::v2::ListLinksRequest) {  // NOLINT(performance-unnecessary-value-param)
  return google::cloud::internal::MakeUnimplementedPaginationRange<
      StreamRange<google::logging::v2::Link>>();
}

StatusOr<google::logging::v2::Link>
ConfigServiceV2Connection::GetLink(
    google::logging::v2::GetLinkRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

StreamRange<google::logging::v2::LogExclusion> ConfigServiceV2Connection::ListExclusions(
    google::logging::v2::ListExclusionsRequest) {  // NOLINT(performance-unnecessary-value-param)
  return google::cloud::internal::MakeUnimplementedPaginationRange<
...
Status
ConfigServiceV2Connection::DeleteExclusion(
...
ConfigServiceV2Connection::GetSettings(
...
StreamRange<google::longrunning::Operation> ConfigServiceV2Connection::ListOperations(
...
Status
ConfigServiceV2Connection::CancelOperation(
...
std::shared_ptr<ConfigServiceV2Connection> MakeConfigServiceV2Connection(
  ...
  internal::CheckExpectedOptions<CommonOptionList, GrpcOptionList,
      ...
      ConfigServiceV2PolicyOptionList>(options, __func__);
  options = logging_v2_internal::ConfigServiceV2DefaultOptions(
      std::move(options));
