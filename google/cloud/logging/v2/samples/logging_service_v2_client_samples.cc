...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::logging_v2::LoggingServiceV2Client(
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::logging_v2::LoggingServiceV2Client(
      google::cloud::logging_v2::MakeLoggingServiceV2Connection(ud_options));
