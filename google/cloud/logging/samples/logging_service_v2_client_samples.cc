...
// main-dox-marker: GOOGLE_CLOUD_CPP_NS::LoggingServiceV2Client
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::GOOGLE_CLOUD_CPP_NS::LoggingServiceV2Client(
      google::cloud::GOOGLE_CLOUD_CPP_NS::MakeLoggingServiceV2Connection(
          options));
  //! [set-client-endpoint]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::GOOGLE_CLOUD_CPP_NS::LoggingServiceV2Client(
        google::cloud::GOOGLE_CLOUD_CPP_NS::MakeLoggingServiceV2Connection(
            options));
  }
  //! [with-service-account]
