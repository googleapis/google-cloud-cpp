...
// main-dox-marker: GOOGLE_CLOUD_CPP_NS::BareMetalSolutionClient
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::GOOGLE_CLOUD_CPP_NS::BareMetalSolutionClient(
      google::cloud::GOOGLE_CLOUD_CPP_NS::MakeBareMetalSolutionConnection(
          options));
  //! [set-client-endpoint]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::GOOGLE_CLOUD_CPP_NS::BareMetalSolutionClient(
        google::cloud::GOOGLE_CLOUD_CPP_NS::MakeBareMetalSolutionConnection(
            options));
  }
  //! [with-service-account]
