...
class BareMetalSolutionConnection {
 public:
  ...
  virtual future<StatusOr<google::cloud::baremetalsolution::v2::Instance>>
  DetachLun(ExperimentalTag, google::longrunning::Operation const& operation);
