...
/**
 * A retry policy for `BareMetalSolutionConnection` that stops retrying after a
...
class BareMetalSolutionLimitedErrorCountRetryPolicy
 ...
 public:
  BareMetalSolutionLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `BareMetalSolutionConnection` that stops retrying after
