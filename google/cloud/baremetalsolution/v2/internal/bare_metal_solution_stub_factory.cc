...
std::shared_ptr<BareMetalSolutionStub> CreateDefaultBareMetalSolutionStub(
  ...
  auto endpoint = internal::DetermineServiceEndpoint(
      ...
      std::move(endpoint_option), "baremetalsolution.googleapis.com", options);
  ...
  if (!endpoint.ok()) {
    ...
    auto service_grpc_stub =
        google::cloud::baremetalsolution::v2::BareMetalSolution::NewStub(
            channel);
    stub = std::make_shared<DefaultBareMetalSolutionStub>(
