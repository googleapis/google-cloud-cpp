...
class StorageBatchOperationsConnectionIdempotencyPolicy {
 public:
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_STORAGEBATCHOPERATIONS_V1_STORAGE_BATCH_OPERATIONS_CONNECTION_IDEMPOTENCY_POLICY_H
