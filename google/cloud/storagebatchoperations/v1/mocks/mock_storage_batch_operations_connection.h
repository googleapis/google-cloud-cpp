 ...
 * including errors, from an object of type `StorageBatchOperationsClient`. To
 * do so, construct an object of type `StorageBatchOperationsClient` with an
 ...
 */
class MockStorageBatchOperationsConnection
 ...
 public:
  ...
  /// EXPECT_CALL(*mock,
  /// CreateJob(Matcher<google::cloud::storagebatchoperations::v1::CreateJobRequest
  /// const&>(_)))
  /// @endcode
  MOCK_METHOD(
