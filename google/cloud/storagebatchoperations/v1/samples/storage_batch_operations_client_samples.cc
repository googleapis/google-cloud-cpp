...
// clang-format off
// main-dox-marker: storagebatchoperations_v1::StorageBatchOperationsClient
// lro-marker: true
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::storagebatchoperations_v1::StorageBatchOperationsClient(
      google::cloud::storagebatchoperations_v1::MakeStorageBatchOperationsConnection(options));
  //! [set-client-endpoint]
}

//! [custom-idempotency-policy]
class CustomIdempotencyPolicy
   : public google::cloud::storagebatchoperations_v1::StorageBatchOperationsConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::storagebatchoperations_v1::StorageBatchOperationsConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::storagebatchoperations_v1::StorageBatchOperationsConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::storagebatchoperations_v1::StorageBatchOperationsRetryPolicyOption>(
      google::cloud::storagebatchoperations_v1::StorageBatchOperationsLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::storagebatchoperations_v1::StorageBatchOperationsBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::storagebatchoperations_v1::MakeStorageBatchOperationsConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::storagebatchoperations_v1::StorageBatchOperationsClient(connection);
  auto c2 = google::cloud::storagebatchoperations_v1::StorageBatchOperationsClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::storagebatchoperations_v1::StorageBatchOperationsClient(
    connection, google::cloud::Options{}.set<google::cloud::storagebatchoperations_v1::StorageBatchOperationsRetryPolicyOption>(
      google::cloud::storagebatchoperations_v1::StorageBatchOperationsLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::storagebatchoperations_v1::StorageBatchOperationsPollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::storagebatchoperations_v1::StorageBatchOperationsRetryPolicyOption::Type,
            google::cloud::storagebatchoperations_v1::StorageBatchOperationsBackoffPolicyOption::Type>(
            google::cloud::storagebatchoperations_v1::StorageBatchOperationsLimitedTimeRetryPolicy(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::storagebatchoperations_v1::StorageBatchOperationsClient(
      google::cloud::storagebatchoperations_v1::MakeStorageBatchOperationsConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
