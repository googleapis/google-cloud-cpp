# HOWTO: using the Storage Batch Operations API C++ client in your project

This directory contains small examples showing how to use the Storage Batch
Operations API C++ client library in your own project. These instructions assume
...
Like most Google Cloud Platform (GCP) services, Storage Batch Operations API
...
1. Compile this example using Bazel:
   ...
   ```bash
   cd $HOME/google-cloud-cpp/google/cloud/storagebatchoperations/quickstart
   bazel build ...
   ```
...
1. Install the dependencies with your favorite tools. As an example, if you use
   ...
   ```bash
   cd $HOME/vcpkg
   ./vcpkg install google-cloud-cpp[core,storagebatchoperations]
   ```
