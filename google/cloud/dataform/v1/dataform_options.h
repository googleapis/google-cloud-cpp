 ...
 */
struct DataformRetryPolicyOption {
  using Type = std::shared_ptr<DataformRetryPolicy>;
};
 ...
 * @ingroup google-cloud-dataform-options
 */
struct DataformBackoffPolicyOption {
 ...
 * @ingroup google-cloud-dataform-options
 */
struct DataformConnectionIdempotencyPolicyOption {
  using Type = std::shared_ptr<DataformConnectionIdempotencyPolicy>;
};
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DATAFORM_V1_DATAFORM_OPTIONS_H
