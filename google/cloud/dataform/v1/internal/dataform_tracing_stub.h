...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DATAFORM_V1_INTERNAL_DATAFORM_TRACING_STUB_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DATAFORM_V1_INTERNAL_DATAFORM_TRACING_STUB_H
...
class DataformTracingStub : public DataformStub {
 public:
  ~DataformTracingStub() override = default;

  explicit DataformTracingStub(std::shared_ptr<DataformStub> child);
