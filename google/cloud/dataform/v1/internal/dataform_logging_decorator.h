...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DATAFORM_V1_INTERNAL_DATAFORM_LOGGING_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DATAFORM_V1_INTERNAL_DATAFORM_LOGGING_DECORATOR_H
...
class DataformLogging : public DataformStub {
 public:
  ~DataformLogging() override = default;
  DataformLogging(std::shared_ptr<DataformStub> child,
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DATAFORM_V1_INTERNAL_DATAFORM_LOGGING_DECORATOR_H
