# HOWTO: using the Cloud Security Compliance API C++ client in your project

This directory contains small examples showing how to use the Cloud Security
Compliance API C++ client library in your own project. These instructions assume
...
Like most Google Cloud Platform (GCP) services, Cloud Security Compliance API
...
1. Compile this example using Bazel:
   ...
   ```bash
   cd $HOME/google-cloud-cpp/google/cloud/cloudsecuritycompliance/quickstart
   bazel build ...
   ```
...
1. Install the dependencies with your favorite tools. As an example, if you use
   ...
   ```bash
   cd $HOME/vcpkg
   ./vcpkg install google-cloud-cpp[core,cloudsecuritycompliance]
   ```
