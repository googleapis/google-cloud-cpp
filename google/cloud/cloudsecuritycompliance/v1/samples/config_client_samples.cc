...
// clang-format off
// main-dox-marker: cloudsecuritycompliance_v1::ConfigClient
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::cloudsecuritycompliance_v1::ConfigClient(
      google::cloud::cloudsecuritycompliance_v1::MakeConfigConnection(options));
  //! [set-client-endpoint]
}
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::cloudsecuritycompliance_v1::ConfigClient(
      google::cloud::cloudsecuritycompliance_v1::MakeConfigConnection(
          ud_options));
...
class CustomIdempotencyPolicy
    : public google::cloud::cloudsecuritycompliance_v1::
          ConfigConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::cloudsecuritycompliance_v1::
                      ConfigConnectionIdempotencyPolicy>
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto c1 = google::cloud::cloudsecuritycompliance_v1::ConfigClient(connection);
  auto c2 = google::cloud::cloudsecuritycompliance_v1::ConfigClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::cloudsecuritycompliance_v1::ConfigClient(
      connection,
      google::cloud::Options{}
          .set<google::cloud::cloudsecuritycompliance_v1::
                   ConfigRetryPolicyOption>(
              google::cloud::cloudsecuritycompliance_v1::
                  ConfigLimitedTimeRetryPolicy(std::chrono::minutes(5))
                      .clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::cloudsecuritycompliance_v1::ConfigRetryPolicyOption>(
  //       google::cloud::cloudsecuritycompliance_v1::ConfigLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::cloudsecuritycompliance_v1::ConfigClient(
        google::cloud::cloudsecuritycompliance_v1::MakeConfigConnection(
            options));
  }
  //! [with-service-account]
