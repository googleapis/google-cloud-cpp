...
// clang-format off
// main-dox-marker: cloudsecuritycompliance_v1::DeploymentClient
// lro-marker: true
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::cloudsecuritycompliance_v1::DeploymentClient(
      google::cloud::cloudsecuritycompliance_v1::MakeDeploymentConnection(
          options));
  //! [set-client-endpoint]
}
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::cloudsecuritycompliance_v1::DeploymentClient(
      google::cloud::cloudsecuritycompliance_v1::MakeDeploymentConnection(
          *ud_options));
  //! [set-client-universe-domain]
}
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
                     ...
                     .set<google::cloud::cloudsecuritycompliance_v1::
                         ...
                         google::cloud::cloudsecuritycompliance_v1::
                             DeploymentLimitedErrorCountRetryPolicy(3)
                                 .clone())
                     .set<google::cloud::cloudsecuritycompliance_v1::
  ...
  auto c1 =
      google::cloud::cloudsecuritycompliance_v1::DeploymentClient(connection);
  auto c2 =
      google::cloud::cloudsecuritycompliance_v1::DeploymentClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::cloudsecuritycompliance_v1::DeploymentClient(
      connection,
      google::cloud::Options{}
          .set<google::cloud::cloudsecuritycompliance_v1::
                   DeploymentRetryPolicyOption>(
              google::cloud::cloudsecuritycompliance_v1::
                  DeploymentLimitedTimeRetryPolicy(std::chrono::minutes(5))
                      .clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::cloudsecuritycompliance_v1::DeploymentRetryPolicyOption>(
  //       google::cloud::cloudsecuritycompliance_v1::DeploymentLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
      ...
      google::cloud::Options{}
          .set<google::cloud::cloudsecuritycompliance_v1::
              ...
              google::cloud::GenericPollingPolicy<
                  google::cloud::cloudsecuritycompliance_v1::
                      DeploymentRetryPolicyOption::Type,
                  google::cloud::cloudsecuritycompliance_v1::
                      DeploymentBackoffPolicyOption::Type>(
                  google::cloud::cloudsecuritycompliance_v1::
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::cloudsecuritycompliance_v1::DeploymentClient(
        google::cloud::cloudsecuritycompliance_v1::MakeDeploymentConnection(
            options));
  }
  //! [with-service-account]
