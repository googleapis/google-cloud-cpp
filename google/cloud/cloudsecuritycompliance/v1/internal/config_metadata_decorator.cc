...
#include "google/cloud/cloudsecuritycompliance/v1/internal/config_metadata_decorator.h"
...
StatusOr<google::cloud::cloudsecuritycompliance::v1::Framework>
ConfigMetadata::CreateFramework(
    grpc::ClientContext& context, Options const& options,
...
StatusOr<google::cloud::cloudsecuritycompliance::v1::Framework>
ConfigMetadata::UpdateFramework(
    grpc::ClientContext& context, Options const& options,
    google::cloud::cloudsecuritycompliance::v1::UpdateFrameworkRequest const&
        request) {
  SetMetadata(context, options,
              absl::StrCat("framework.name=",
                           internal::UrlEncode(request.framework().name())));
  return child_->UpdateFramework(context, options, request);
}

Status ConfigMetadata::DeleteFramework(
    grpc::ClientContext& context, Options const& options,
...
ConfigMetadata::ListCloudControls(
    grpc::ClientContext& context, Options const& options,
...
ConfigMetadata::GetCloudControl(
    grpc::ClientContext& context, Options const& options,
...
StatusOr<google::cloud::cloudsecuritycompliance::v1::CloudControl>
ConfigMetadata::CreateCloudControl(
    grpc::ClientContext& context, Options const& options,
...
StatusOr<google::cloud::cloudsecuritycompliance::v1::CloudControl>
ConfigMetadata::UpdateCloudControl(
    grpc::ClientContext& context, Options const& options,
    google::cloud::cloudsecuritycompliance::v1::UpdateCloudControlRequest const&
        request) {
  SetMetadata(
      context, options,
      absl::StrCat("cloud_control.name=",
                   internal::UrlEncode(request.cloud_control().name())));
  return child_->UpdateCloudControl(context, options, request);
}

Status ConfigMetadata::DeleteCloudControl(
    grpc::ClientContext& context, Options const& options,
