...
DeploymentMetadata::AsyncCreateFrameworkDeployment(
  ...
  return child_->AsyncCreateFrameworkDeployment(cq, std::move(context),
                                                std::move(options), request);
}

StatusOr<google::longrunning::Operation>
DeploymentMetadata::CreateFrameworkDeployment(
...
future<StatusOr<google::longrunning::Operation>>
DeploymentMetadata::AsyncDeleteFrameworkDeployment(
    google::cloud::CompletionQueue& cq,
    std::shared_ptr<grpc::ClientContext> context,
    google::cloud::internal::ImmutableOptions options,
    google::cloud::cloudsecuritycompliance::v1::
  ...
  return child_->AsyncDeleteFrameworkDeployment(cq, std::move(context),
                                                std::move(options), request);
}

StatusOr<google::longrunning::Operation>
DeploymentMetadata::DeleteFrameworkDeployment(
    grpc::ClientContext& context, Options options,
    google::cloud::cloudsecuritycompliance::v1::
        DeleteFrameworkDeploymentRequest const& request) {
  SetMetadata(context, options,
...
DeploymentMetadata::GetFrameworkDeployment(
...
DeploymentMetadata::ListFrameworkDeployments(
    grpc::ClientContext& context, Options const& options,
    google::cloud::cloudsecuritycompliance::v1::
...
DeploymentMetadata::GetCloudControlDeployment(
    grpc::ClientContext& context, Options const& options,
    google::cloud::cloudsecuritycompliance::v1::
...
DeploymentMetadata::ListCloudControlDeployments(
    grpc::ClientContext& context, Options const& options,
    google::cloud::cloudsecuritycompliance::v1::
...
DeploymentMetadata::ListLocations(
    grpc::ClientContext& context, Options const& options,
...
StatusOr<google::cloud::location::Location> DeploymentMetadata::GetLocation(
    grpc::ClientContext& context, Options const& options,
...
DeploymentMetadata::ListOperations(
    grpc::ClientContext& context, Options const& options,
...
StatusOr<google::longrunning::Operation> DeploymentMetadata::GetOperation(
    grpc::ClientContext& context, Options const& options,
...
Status DeploymentMetadata::DeleteOperation(
    grpc::ClientContext& context, Options const& options,
...
Status DeploymentMetadata::CancelOperation(
    grpc::ClientContext& context, Options const& options,
...
future<StatusOr<google::longrunning::Operation>>
DeploymentMetadata::AsyncGetOperation(
    google::cloud::CompletionQueue& cq,
    std::shared_ptr<grpc::ClientContext> context,
    google::cloud::internal::ImmutableOptions options,
    google::longrunning::GetOperationRequest const& request) {
...
future<Status> DeploymentMetadata::AsyncCancelOperation(
    google::cloud::CompletionQueue& cq,
    std::shared_ptr<grpc::ClientContext> context,
    google::cloud::internal::ImmutableOptions options,
    google::longrunning::CancelOperationRequest const& request) {
...
void DeploymentMetadata::SetMetadata(grpc::ClientContext& context,
