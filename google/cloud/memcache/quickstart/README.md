...
This directory contains small examples showing how to use the Cloud Memorystore for Memcached API C++
...
[quickstart-link]: https://cloud.google.com/memcache/docs/quickstart
