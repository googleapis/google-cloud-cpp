...
/**
 * A retry policy for `CloudMemcacheConnection` that stops retrying after a
...
class CloudMemcacheLimitedErrorCountRetryPolicy
 ...
 public:
  CloudMemcacheLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `CloudMemcacheConnection` that stops retrying after
