...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_MEMCACHE_V1_CLOUD_MEMCACHE_CONNECTION_IDEMPOTENCY_POLICY_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_MEMCACHE_V1_CLOUD_MEMCACHE_CONNECTION_IDEMPOTENCY_POLICY_H
...
class CloudMemcacheConnectionIdempotencyPolicy {
 public:
  ...
  virtual std::unique_ptr<CloudMemcacheConnectionIdempotencyPolicy> clone() const;
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_MEMCACHE_V1_CLOUD_MEMCACHE_CONNECTION_IDEMPOTENCY_POLICY_H
