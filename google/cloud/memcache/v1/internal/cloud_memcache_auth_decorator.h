...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_MEMCACHE_V1_INTERNAL_CLOUD_MEMCACHE_AUTH_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_MEMCACHE_V1_INTERNAL_CLOUD_MEMCACHE_AUTH_DECORATOR_H
...
class CloudMemcacheAuth : public CloudMemcacheStub {
 public:
  ~CloudMemcacheAuth() override = default;
  CloudMemcacheAuth(
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_MEMCACHE_V1_INTERNAL_CLOUD_MEMCACHE_AUTH_DECORATOR_H
