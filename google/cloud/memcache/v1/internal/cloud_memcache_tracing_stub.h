...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_MEMCACHE_V1_INTERNAL_CLOUD_MEMCACHE_TRACING_STUB_H
...
class CloudMemcacheTracingStub : public CloudMemcacheStub {
 public:
  ~CloudMemcacheTracingStub() override = default;

  explicit CloudMemcacheTracingStub(std::shared_ptr<CloudMemcacheStub> child);
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_MEMCACHE_V1_INTERNAL_CLOUD_MEMCACHE_TRACING_STUB_H
