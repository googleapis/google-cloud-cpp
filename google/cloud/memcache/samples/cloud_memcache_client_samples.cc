...
// main-dox-marker: GOOGLE_CLOUD_CPP_NS::CloudMemcacheClient
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::GOOGLE_CLOUD_CPP_NS::CloudMemcacheClient(
      google::cloud::GOOGLE_CLOUD_CPP_NS::MakeCloudMemcacheConnection(options));
  //! [set-client-endpoint]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::GOOGLE_CLOUD_CPP_NS::CloudMemcacheClient(
        google::cloud::GOOGLE_CLOUD_CPP_NS::MakeCloudMemcacheConnection(
            options));
  }
  //! [with-service-account]
  (argv.at(0));
