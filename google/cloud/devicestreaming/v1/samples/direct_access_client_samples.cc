...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client =
      google::cloud::devicestreaming_v1::DirectAccessServiceClient(
          google::cloud::devicestreaming_v1::MakeDirectAccessServiceConnection(
              options));
  //! [set-client-endpoint]
}
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::devicestreaming_v1::DirectAccessServiceClient(
      google::cloud::devicestreaming_v1::MakeDirectAccessServiceConnection(
          *ud_options));
  //! [set-client-universe-domain]
}
...
class CustomIdempotencyPolicy
    : public google::cloud::devicestreaming_v1::
          DirectAccessServiceConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::devicestreaming_v1::
                      DirectAccessServiceConnectionIdempotencyPolicy>
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options =
      google::cloud::Options{}
          .set<google::cloud::devicestreaming_v1::
                   DirectAccessServiceConnectionIdempotencyPolicyOption>(
              CustomIdempotencyPolicy().clone())
          .set<google::cloud::devicestreaming_v1::
                   DirectAccessServiceRetryPolicyOption>(
              google::cloud::devicestreaming_v1::
                  DirectAccessServiceLimitedErrorCountRetryPolicy(3)
                      .clone())
          .set<google::cloud::devicestreaming_v1::
                   DirectAccessServiceBackoffPolicyOption>(
  ...
  auto c1 =
      google::cloud::devicestreaming_v1::DirectAccessServiceClient(connection);
  auto c2 =
      google::cloud::devicestreaming_v1::DirectAccessServiceClient(connection);
