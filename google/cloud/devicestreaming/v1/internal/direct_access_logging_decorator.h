...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DEVICESTREAMING_V1_INTERNAL_DIRECT_ACCESS_LOGGING_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DEVICESTREAMING_V1_INTERNAL_DIRECT_ACCESS_LOGGING_DECORATOR_H
...
class DirectAccessServiceLogging : public DirectAccessServiceStub {
 public:
  ~DirectAccessServiceLogging() override = default;
  DirectAccessServiceLogging(std::shared_ptr<DirectAccessServiceStub> child,
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DEVICESTREAMING_V1_INTERNAL_DIRECT_ACCESS_LOGGING_DECORATOR_H
