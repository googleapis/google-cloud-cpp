# HOWTO: using the Artifact Registry API C++ client in your project

This directory contains small examples showing how to use the Artifact Registry API C++
...
Like most Google Cloud Platform (GCP) services, Artifact Registry API requires that
...
1. Install the dependencies with your favorite tools. As an example, if you use
   ...
   ```bash
   cd $HOME/vcpkg
   ./vcpkg install google-cloud-cpp[core,artifactregistry]
   ```
...
[quickstart-link]: https://cloud.google.com/artifact-registry/docs/quickstarts
