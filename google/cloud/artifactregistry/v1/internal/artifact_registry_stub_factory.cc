...
std::shared_ptr<ArtifactRegistryStub> CreateDefaultArtifactRegistryStub(
  ...
  auto endpoint = internal::DetermineServiceEndpoint(
      internal::GetEnv("GOOGLE_CLOUD_CPP_ARTIFACT_REGISTRY_ENDPOINT"),
      std::move(endpoint_option), "artifactregistry.googleapis.com", options);
  ...
  if (!endpoint.ok()) {
    ...
    auto service_grpc_stub =
        google::devtools::artifactregistry::v1::ArtifactRegistry::NewStub(
            channel);
    stub = std::make_shared<DefaultArtifactRegistryStub>(
