...
/**
 * A retry policy for `ArtifactRegistryConnection` that stops retrying after a
...
class ArtifactRegistryLimitedErrorCountRetryPolicy
 ...
 public:
  ArtifactRegistryLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `ArtifactRegistryConnection` that stops retrying after
