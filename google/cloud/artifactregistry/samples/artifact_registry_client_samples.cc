...
// main-dox-marker: GOOGLE_CLOUD_CPP_NS::ArtifactRegistryClient
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::GOOGLE_CLOUD_CPP_NS::ArtifactRegistryClient(
      google::cloud::GOOGLE_CLOUD_CPP_NS::MakeArtifactRegistryConnection(
          options));
  //! [set-client-endpoint]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::GOOGLE_CLOUD_CPP_NS::ArtifactRegistryClient(
        google::cloud::GOOGLE_CLOUD_CPP_NS::MakeArtifactRegistryConnection(
            options));
  }
  //! [with-service-account]
