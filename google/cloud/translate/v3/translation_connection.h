...
/**
 * A retry policy for `TranslationServiceConnection` that stops retrying after a
...
class TranslationServiceLimitedErrorCountRetryPolicy
 ...
 public:
  TranslationServiceLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `TranslationServiceConnection` that stops retrying after
