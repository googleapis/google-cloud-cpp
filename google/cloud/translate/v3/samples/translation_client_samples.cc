...
// clang-format off
// main-dox-marker: translate_v3::TranslationServiceClient
// lro-marker: true
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::translate_v3::TranslationServiceClient(
...
class CustomIdempotencyPolicy
   : public google::cloud::translate_v3::TranslationServiceConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::translate_v3::TranslationServiceConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::translate_v3::TranslationServiceConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::translate_v3::TranslationServiceRetryPolicyOption>(
      google::cloud::translate_v3::TranslationServiceLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::translate_v3::TranslationServiceBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::translate_v3::MakeTranslationServiceConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::translate_v3::TranslationServiceClient(connection);
  auto c2 = google::cloud::translate_v3::TranslationServiceClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::translate_v3::TranslationServiceClient(
    connection, google::cloud::Options{}.set<google::cloud::translate_v3::TranslationServiceRetryPolicyOption>(
      google::cloud::translate_v3::TranslationServiceLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::translate_v3::TranslationServiceRetryPolicyOption>(
  //       google::cloud::translate_v3::TranslationServiceLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::translate_v3::TranslationServicePollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::translate_v3::TranslationServiceRetryPolicyOption::Type,
            google::cloud::translate_v3::TranslationServiceBackoffPolicyOption::Type>(
            google::cloud::translate_v3::TranslationServiceLimitedTimeRetryPolicy(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::translate_v3::TranslationServiceClient(
      google::cloud::translate_v3::MakeTranslationServiceConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
