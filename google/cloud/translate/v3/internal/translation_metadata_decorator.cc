...
TranslationServiceMetadata::AsyncBatchTranslateText(
  ...
  SetMetadata(*context, *options, absl::StrCat("parent=", internal::UrlEncode(request.parent())));
  return child_->AsyncBatchTranslateText(
...
TranslationServiceMetadata::AsyncBatchTranslateDocument(
  ...
  SetMetadata(*context, *options, absl::StrCat("parent=", internal::UrlEncode(request.parent())));
  return child_->AsyncBatchTranslateDocument(
      cq, std::move(context), std::move(options), request);
}
...
TranslationServiceMetadata::AsyncCreateGlossary(
  ...
  SetMetadata(*context, *options, absl::StrCat("parent=", internal::UrlEncode(request.parent())));
  return child_->AsyncCreateGlossary(
      cq, std::move(context), std::move(options), request);
}
...
TranslationServiceMetadata::AsyncUpdateGlossary(
  ...
  SetMetadata(*context, *options, absl::StrCat("glossary.name=", internal::UrlEncode(request.glossary().name())));
  return child_->AsyncUpdateGlossary(
      cq, std::move(context), std::move(options), request);
}
...
TranslationServiceMetadata::AsyncDeleteGlossary(
  ...
  SetMetadata(*context, *options, absl::StrCat("name=", internal::UrlEncode(request.name())));
  return child_->AsyncDeleteGlossary(
      cq, std::move(context), std::move(options), request);
}
...
TranslationServiceMetadata::UpdateGlossaryEntry(
  ...
  SetMetadata(context, options, absl::StrCat("glossary_entry.name=", internal::UrlEncode(request.glossary_entry().name())));
  return child_->UpdateGlossaryEntry(context, options, request);
}

Status
TranslationServiceMetadata::DeleteGlossaryEntry(
    grpc::ClientContext& context,
    Options const& options,
...
Status
TranslationServiceMetadata::DeleteAdaptiveMtDataset(
    grpc::ClientContext& context,
    Options const& options,
...
Status
TranslationServiceMetadata::DeleteAdaptiveMtFile(
    grpc::ClientContext& context,
    Options const& options,
...
StatusOr<google::longrunning::Operation>
TranslationServiceMetadata::ImportData(
    grpc::ClientContext& context,
    Options options,
    google::cloud::translation::v3::ImportDataRequest const& request) {
  SetMetadata(context, options, absl::StrCat("dataset=", internal::UrlEncode(request.dataset())));
...
StatusOr<google::longrunning::Operation>
TranslationServiceMetadata::ExportData(
    grpc::ClientContext& context,
    Options options,
    google::cloud::translation::v3::ExportDataRequest const& request) {
  SetMetadata(context, options, absl::StrCat("dataset=", internal::UrlEncode(request.dataset())));
...
Status
TranslationServiceMetadata::DeleteOperation(
    grpc::ClientContext& context,
    Options const& options,
...
Status
TranslationServiceMetadata::CancelOperation(
    grpc::ClientContext& context,
    Options const& options,
