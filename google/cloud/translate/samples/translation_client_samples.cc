...
// main-dox-marker: GOOGLE_CLOUD_CPP_NS::TranslationServiceClient
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::GOOGLE_CLOUD_CPP_NS::TranslationServiceClient(
      google::cloud::GOOGLE_CLOUD_CPP_NS::MakeTranslationServiceConnection(
          options));
  //! [set-client-endpoint]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::GOOGLE_CLOUD_CPP_NS::TranslationServiceClient(
        google::cloud::GOOGLE_CLOUD_CPP_NS::MakeTranslationServiceConnection(
            options));
  }
  //! [with-service-account]
