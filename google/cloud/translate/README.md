...
[Cloud Translation API][cloud-service-docs], a service to Integrates text translation into your website or application.
...
```cc
#include "google/cloud/translate/ EDIT HERE .h"
...
int main(int argc, char* argv[]) try {
  ...
  auto client = translate::Client(translate::MakeConnection(/* EDIT HERE */));
