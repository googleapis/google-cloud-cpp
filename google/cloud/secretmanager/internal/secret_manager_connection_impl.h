...
class SecretManagerServiceConnectionImpl
 ...
 private:
  std::unique_ptr<secretmanager::SecretManagerServiceRetryPolicy> retry_policy() {
    auto const& options = internal::CurrentOptions();
    if (options.has<secretmanager::SecretManagerServiceRetryPolicyOption>()) {
      return options.get<secretmanager::SecretManagerServiceRetryPolicyOption>()->clone();
    }
  ...
  std::unique_ptr<BackoffPolicy> backoff_policy() {
    ...
    if (options.has<secretmanager::SecretManagerServiceBackoffPolicyOption>()) {
      return options.get<secretmanager::SecretManagerServiceBackoffPolicyOption>()->clone();
    }
    return backoff_policy_prototype_->clone();
  }

  std::unique_ptr<secretmanager::SecretManagerServiceConnectionIdempotencyPolicy> idempotency_policy() {
    auto const& options = internal::CurrentOptions();
    if (options.has<secretmanager::SecretManagerServiceConnectionIdempotencyPolicyOption>()) {
      return options.get<secretmanager::SecretManagerServiceConnectionIdempotencyPolicyOption>()->clone();
    }
  ...
  std::unique_ptr<secretmanager::SecretManagerServiceRetryPolicy const> retry_policy_prototype_;
  std::unique_ptr<BackoffPolicy const> backoff_policy_prototype_;
  std::unique_ptr<secretmanager::SecretManagerServiceConnectionIdempotencyPolicy> idempotency_policy_;
};
