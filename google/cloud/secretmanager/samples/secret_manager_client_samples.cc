...
// main-dox-marker: GOOGLE_CLOUD_CPP_NS::SecretManagerServiceClient
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::GOOGLE_CLOUD_CPP_NS::SecretManagerServiceClient(
      google::cloud::GOOGLE_CLOUD_CPP_NS::MakeSecretManagerServiceConnection(
          options));
  //! [set-client-endpoint]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::GOOGLE_CLOUD_CPP_NS::SecretManagerServiceClient(
        google::cloud::GOOGLE_CLOUD_CPP_NS::MakeSecretManagerServiceConnection(
            options));
  }
  //! [with-service-account]
