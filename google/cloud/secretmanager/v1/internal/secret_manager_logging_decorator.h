...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SECRETMANAGER_V1_INTERNAL_SECRET_MANAGER_LOGGING_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SECRETMANAGER_V1_INTERNAL_SECRET_MANAGER_LOGGING_DECORATOR_H
...
class SecretManagerServiceLogging : public SecretManagerServiceStub {
 public:
  ~SecretManagerServiceLogging() override = default;
  SecretManagerServiceLogging(std::shared_ptr<SecretManagerServiceStub> child,
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SECRETMANAGER_V1_INTERNAL_SECRET_MANAGER_LOGGING_DECORATOR_H
