...
/**
 * A retry policy for `SecretManagerServiceConnection` that stops retrying after
...
class SecretManagerServiceLimitedErrorCountRetryPolicy
 ...
 public:
  SecretManagerServiceLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `SecretManagerServiceConnection` that stops retrying
