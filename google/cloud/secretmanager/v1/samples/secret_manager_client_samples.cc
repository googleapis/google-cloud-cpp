...
// clang-format off
// main-dox-marker: secretmanager_v1::SecretManagerServiceClient
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::secretmanager_v1::SecretManagerServiceClient(
      google::cloud::secretmanager_v1::MakeSecretManagerServiceConnection(options));
  //! [set-client-endpoint]
}

//! [custom-idempotency-policy]
class CustomIdempotencyPolicy
   : public google::cloud::secretmanager_v1::SecretManagerServiceConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::secretmanager_v1::SecretManagerServiceConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::secretmanager_v1::SecretManagerServiceConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::secretmanager_v1::SecretManagerServiceRetryPolicyOption>(
      google::cloud::secretmanager_v1::SecretManagerServiceLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::secretmanager_v1::SecretManagerServiceBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::secretmanager_v1::MakeSecretManagerServiceConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::secretmanager_v1::SecretManagerServiceClient(connection);
  auto c2 = google::cloud::secretmanager_v1::SecretManagerServiceClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::secretmanager_v1::SecretManagerServiceClient(
    connection, google::cloud::Options{}.set<google::cloud::secretmanager_v1::SecretManagerServiceRetryPolicyOption>(
      google::cloud::secretmanager_v1::SecretManagerServiceLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));
