...
// clang-format off
// main-dox-marker: config_v1::ConfigClient
// lro-marker: true
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::config_v1::ConfigClient(
      google::cloud::config_v1::MakeConfigConnection(options));
  //! [set-client-endpoint]
}
...
class CustomIdempotencyPolicy
 ...
 public:
  ...
  std::unique_ptr<google::cloud::config_v1::ConfigConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::config_v1::ConfigConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::config_v1::ConfigRetryPolicyOption>(
      google::cloud::config_v1::ConfigLimitedErrorCountRetryPolicy(3).clone())
  ...
  auto c3 = google::cloud::config_v1::ConfigClient(
    connection, google::cloud::Options{}.set<google::cloud::config_v1::ConfigRetryPolicyOption>(
      google::cloud::config_v1::ConfigLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::config_v1::ConfigClient(
      google::cloud::config_v1::MakeConfigConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
