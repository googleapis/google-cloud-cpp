...
StatusOr<google::cloud::config::v1::ListDeploymentsResponse> ConfigAuth::ListDeployments(
...
ConfigAuth::AsyncCreateDeployment(
  ...
  return auth_->AsyncConfigureContext(std::move(context)).then(
      [cq, child = child_, options = std::move(options), request](
        ...
        return child->AsyncCreateDeployment(
            cq, *std::move(context), std::move(options), request);
      });
}

StatusOr<google::longrunning::Operation>
ConfigAuth::CreateDeployment(
      grpc::ClientContext& context,
      Options options,
      google::cloud::config::v1::CreateDeploymentRequest const& request) {
  auto status = auth_->ConfigureContext(context);
...
ConfigAuth::AsyncUpdateDeployment(
  ...
  return auth_->AsyncConfigureContext(std::move(context)).then(
      [cq, child = child_, options = std::move(options), request](
        ...
        return child->AsyncUpdateDeployment(
            cq, *std::move(context), std::move(options), request);
      });
}

StatusOr<google::longrunning::Operation>
ConfigAuth::UpdateDeployment(
      grpc::ClientContext& context,
      Options options,
      google::cloud::config::v1::UpdateDeploymentRequest const& request) {
  auto status = auth_->ConfigureContext(context);
...
ConfigAuth::AsyncDeleteDeployment(
  ...
  return auth_->AsyncConfigureContext(std::move(context)).then(
      [cq, child = child_, options = std::move(options), request](
        ...
        return child->AsyncDeleteDeployment(
            cq, *std::move(context), std::move(options), request);
      });
}

StatusOr<google::longrunning::Operation>
ConfigAuth::DeleteDeployment(
      grpc::ClientContext& context,
      Options options,
      google::cloud::config::v1::DeleteDeploymentRequest const& request) {
  auto status = auth_->ConfigureContext(context);
...
StatusOr<google::cloud::config::v1::ListRevisionsResponse> ConfigAuth::ListRevisions(
    grpc::ClientContext& context,
    Options const& options,
...
StatusOr<google::cloud::config::v1::ListResourcesResponse> ConfigAuth::ListResources(
    grpc::ClientContext& context,
    Options const& options,
...
StatusOr<google::cloud::config::v1::Statefile> ConfigAuth::ExportDeploymentStatefile(
    grpc::ClientContext& context,
    Options const& options,
...
StatusOr<google::cloud::config::v1::Statefile> ConfigAuth::ExportRevisionStatefile(
    grpc::ClientContext& context,
    Options const& options,
...
ConfigAuth::AsyncLockDeployment(
  ...
  return auth_->AsyncConfigureContext(std::move(context)).then(
      [cq, child = child_, options = std::move(options), request](
        ...
        return child->AsyncLockDeployment(
            cq, *std::move(context), std::move(options), request);
      });
}

StatusOr<google::longrunning::Operation>
ConfigAuth::LockDeployment(
      grpc::ClientContext& context,
      Options options,
      google::cloud::config::v1::LockDeploymentRequest const& request) {
  auto status = auth_->ConfigureContext(context);
...
ConfigAuth::AsyncUnlockDeployment(
  ...
  return auth_->AsyncConfigureContext(std::move(context)).then(
      [cq, child = child_, options = std::move(options), request](
        ...
        return child->AsyncUnlockDeployment(
            cq, *std::move(context), std::move(options), request);
      });
}

StatusOr<google::longrunning::Operation>
ConfigAuth::UnlockDeployment(
      grpc::ClientContext& context,
      Options options,
      google::cloud::config::v1::UnlockDeploymentRequest const& request) {
  auto status = auth_->ConfigureContext(context);
...
ConfigAuth::AsyncCreatePreview(
  ...
  return auth_->AsyncConfigureContext(std::move(context)).then(
      [cq, child = child_, options = std::move(options), request](
        ...
        return child->AsyncCreatePreview(
            cq, *std::move(context), std::move(options), request);
      });
}

StatusOr<google::longrunning::Operation>
ConfigAuth::CreatePreview(
      grpc::ClientContext& context,
      Options options,
      google::cloud::config::v1::CreatePreviewRequest const& request) {
  auto status = auth_->ConfigureContext(context);
...
StatusOr<google::cloud::config::v1::ListPreviewsResponse> ConfigAuth::ListPreviews(
    grpc::ClientContext& context,
    Options const& options,
...
ConfigAuth::AsyncDeletePreview(
  ...
  return auth_->AsyncConfigureContext(std::move(context)).then(
      [cq, child = child_, options = std::move(options), request](
        ...
        return child->AsyncDeletePreview(
            cq, *std::move(context), std::move(options), request);
      });
}

StatusOr<google::longrunning::Operation>
ConfigAuth::DeletePreview(
      grpc::ClientContext& context,
      Options options,
      google::cloud::config::v1::DeletePreviewRequest const& request) {
  auto status = auth_->ConfigureContext(context);
...
StatusOr<google::cloud::config::v1::ExportPreviewResultResponse> ConfigAuth::ExportPreviewResult(
    grpc::ClientContext& context,
    Options const& options,
...
StatusOr<google::cloud::config::v1::ListTerraformVersionsResponse> ConfigAuth::ListTerraformVersions(
    grpc::ClientContext& context,
    Options const& options,
...
StatusOr<google::cloud::config::v1::TerraformVersion> ConfigAuth::GetTerraformVersion(
    grpc::ClientContext& context,
    Options const& options,
...
StatusOr<google::cloud::location::ListLocationsResponse> ConfigAuth::ListLocations(
    grpc::ClientContext& context,
    Options const& options,
...
StatusOr<google::iam::v1::TestIamPermissionsResponse> ConfigAuth::TestIamPermissions(
    grpc::ClientContext& context,
    Options const& options,
...
StatusOr<google::longrunning::ListOperationsResponse> ConfigAuth::ListOperations(
    grpc::ClientContext& context,
    Options const& options,
