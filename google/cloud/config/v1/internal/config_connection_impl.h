...
class ConfigConnectionImpl : public config_v1::ConfigConnection {
 ...
 private:
  std::unique_ptr<config_v1::ConfigRetryPolicy> retry_policy() {
    ...
    return options_.get<config_v1::ConfigRetryPolicyOption>()->clone();
  }
  ...
  std::unique_ptr<BackoffPolicy> backoff_policy() {
    ...
    return options_.get<config_v1::ConfigBackoffPolicyOption>()->clone();
  }
  ...
  idempotency_policy() {
    ...
    return options_.get<config_v1::ConfigConnectionIdempotencyPolicyOption>()
        ->clone();
  }
  ...
  std::unique_ptr<PollingPolicy> polling_policy() {
    ...
    return options_.get<config_v1::ConfigPollingPolicyOption>()->clone();
  }
