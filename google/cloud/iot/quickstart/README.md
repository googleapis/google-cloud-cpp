...
(GCP) project. The [IoT technical overview][overview-link] provides some
necessary background.

## Configuring authentication for the C++ Client Library

Like most Google Cloud Platform (GCP) services, Cloud IoT API requires that your
...
1. Install the dependencies with your favorite tools. As an example, if you use
   ...
   ```bash
   cd $HOME/vcpkg
   ./vcpkg install google-cloud-cpp[core,iot]
   ```
...
[overview-link]: https://cloud.google.com/architecture/iot-overview
