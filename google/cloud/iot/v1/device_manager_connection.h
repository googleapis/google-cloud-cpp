...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_IOT_V1_DEVICE_MANAGER_CONNECTION_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_IOT_V1_DEVICE_MANAGER_CONNECTION_H
...
/**
 * A retry policy for `DeviceManagerConnection` that stops retrying after a
...
class DeviceManagerLimitedErrorCountRetryPolicy
 ...
 public:
  DeviceManagerLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `DeviceManagerConnection` that stops retrying after
 ...
 *
 * For mocking, see `iot_v1_mocks::MockDeviceManagerConnection`.
 */
 ...
 * - `google::cloud::iot_v1::DeviceManagerPolicyOptionList`
 *
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_IOT_V1_DEVICE_MANAGER_CONNECTION_H
