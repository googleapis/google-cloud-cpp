...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_IOT_INTERNAL_DEVICE_MANAGER_TRACING_CONNECTION_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_IOT_INTERNAL_DEVICE_MANAGER_TRACING_CONNECTION_H
...
class DeviceManagerTracingConnection : public iot::DeviceManagerConnection {
 public:
 ...
 private:
  std::shared_ptr<iot::DeviceManagerConnection> child_;
};
 ...
 */
std::shared_ptr<iot::DeviceManagerConnection>
MakeDeviceManagerTracingConnection(
    std::shared_ptr<iot::DeviceManagerConnection> conn);
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_IOT_INTERNAL_DEVICE_MANAGER_TRACING_CONNECTION_H
