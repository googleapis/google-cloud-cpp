...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_LICENSEMANAGER_V1_INTERNAL_LICENSE_MANAGER_METADATA_DECORATOR_H
...
class LicenseManagerMetadata : public LicenseManagerStub {
 public:
  ~LicenseManagerMetadata() override = default;
  LicenseManagerMetadata(std::shared_ptr<LicenseManagerStub> child,
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_LICENSEMANAGER_V1_INTERNAL_LICENSE_MANAGER_METADATA_DECORATOR_H
