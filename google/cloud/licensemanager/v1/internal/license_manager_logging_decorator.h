...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_LICENSEMANAGER_V1_INTERNAL_LICENSE_MANAGER_LOGGING_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_LICENSEMANAGER_V1_INTERNAL_LICENSE_MANAGER_LOGGING_DECORATOR_H
...
class LicenseManagerLogging : public LicenseManagerStub {
 public:
  ~LicenseManagerLogging() override = default;
  LicenseManagerLogging(std::shared_ptr<LicenseManagerStub> child,
 ...
 private:
  std::shared_ptr<LicenseManagerStub> child_;
  TracingOptions tracing_options_;
};  // LicenseManagerLogging
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_LICENSEMANAGER_V1_INTERNAL_LICENSE_MANAGER_LOGGING_DECORATOR_H
