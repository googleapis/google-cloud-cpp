...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_LICENSEMANAGER_V1_INTERNAL_LICENSE_MANAGER_TRACING_STUB_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_LICENSEMANAGER_V1_INTERNAL_LICENSE_MANAGER_TRACING_STUB_H
...
class LicenseManagerTracingStub : public LicenseManagerStub {
 public:
  ~LicenseManagerTracingStub() override = default;

  explicit LicenseManagerTracingStub(std::shared_ptr<LicenseManagerStub> child);
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_LICENSEMANAGER_V1_INTERNAL_LICENSE_MANAGER_TRACING_STUB_H
