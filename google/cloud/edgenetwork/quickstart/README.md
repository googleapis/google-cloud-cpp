# HOWTO: using the Distributed Cloud Edge Network API C++ client in your project

This directory contains small examples showing how to use the Distributed Cloud
Edge Network API C++ client library in your own project. These instructions
...
Like most Google Cloud Platform (GCP) services, Distributed Cloud Edge Network
...
1. Compile this example using Bazel:
   ...
   ```bash
   cd $HOME/google-cloud-cpp/google/cloud/edgenetwork/quickstart
   bazel build ...
   ```
...
1. Install the dependencies with your favorite tools. As an example, if you use
   ...
   ```bash
   cd $HOME/vcpkg
   ./vcpkg install google-cloud-cpp[core,edgenetwork]
   ```
...
[quickstart-link]: https://cloud.google.com/distributed-cloud/edge/latest/docs/zones
