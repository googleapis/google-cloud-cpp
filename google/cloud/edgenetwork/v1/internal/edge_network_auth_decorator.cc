...
EdgeNetworkAuth::AsyncCreateNetwork(
  ...
  return auth_->AsyncConfigureContext(std::move(context))
      .then([cq, child,
        ...
        return child->AsyncCreateNetwork(cq, *std::move(context), request);
      });
}
...
EdgeNetworkAuth::AsyncDeleteNetwork(
  ...
  return auth_->AsyncConfigureContext(std::move(context))
      .then([cq, child,
        ...
        return child->AsyncDeleteNetwork(cq, *std::move(context), request);
      });
}
...
EdgeNetworkAuth::AsyncCreateSubnet(
  ...
  return auth_->AsyncConfigureContext(std::move(context))
      .then([cq, child,
        ...
        return child->AsyncCreateSubnet(cq, *std::move(context), request);
      });
}
...
EdgeNetworkAuth::AsyncDeleteSubnet(
  ...
  return auth_->AsyncConfigureContext(std::move(context))
      .then([cq, child,
        ...
        return child->AsyncDeleteSubnet(cq, *std::move(context), request);
      });
}
...
EdgeNetworkAuth::AsyncCreateRouter(
  ...
  return auth_->AsyncConfigureContext(std::move(context))
      .then([cq, child,
        ...
        return child->AsyncCreateRouter(cq, *std::move(context), request);
      });
}
...
EdgeNetworkAuth::AsyncUpdateRouter(
  ...
  return auth_->AsyncConfigureContext(std::move(context))
      .then([cq, child,
        ...
        return child->AsyncUpdateRouter(cq, *std::move(context), request);
      });
}
...
EdgeNetworkAuth::AsyncDeleteRouter(
  ...
  return auth_->AsyncConfigureContext(std::move(context))
      .then([cq, child,
        ...
        return child->AsyncDeleteRouter(cq, *std::move(context), request);
      });
}
