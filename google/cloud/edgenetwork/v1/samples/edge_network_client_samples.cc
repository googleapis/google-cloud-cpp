...
// clang-format off
// main-dox-marker: edgenetwork_v1::EdgeNetworkClient
// lro-marker: true
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::edgenetwork_v1::EdgeNetworkClient(
...
class CustomIdempotencyPolicy
   : public google::cloud::edgenetwork_v1::EdgeNetworkConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::edgenetwork_v1::EdgeNetworkConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::edgenetwork_v1::EdgeNetworkConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::edgenetwork_v1::EdgeNetworkRetryPolicyOption>(
      google::cloud::edgenetwork_v1::EdgeNetworkLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::edgenetwork_v1::EdgeNetworkBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::edgenetwork_v1::MakeEdgeNetworkConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::edgenetwork_v1::EdgeNetworkClient(connection);
  auto c2 = google::cloud::edgenetwork_v1::EdgeNetworkClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::edgenetwork_v1::EdgeNetworkClient(
    connection, google::cloud::Options{}.set<google::cloud::edgenetwork_v1::EdgeNetworkRetryPolicyOption>(
      google::cloud::edgenetwork_v1::EdgeNetworkLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::edgenetwork_v1::EdgeNetworkRetryPolicyOption>(
  //       google::cloud::edgenetwork_v1::EdgeNetworkLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::edgenetwork_v1::EdgeNetworkPollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::edgenetwork_v1::EdgeNetworkRetryPolicyOption::Type,
            google::cloud::edgenetwork_v1::EdgeNetworkBackoffPolicyOption::Type>(
            google::cloud::edgenetwork_v1::EdgeNetworkLimitedTimeRetryPolicy(
