 ...
 *
 * @ingroup google-cloud-edgenetwork-options
 */
struct EdgeNetworkRetryPolicyOption {
  using Type = std::shared_ptr<EdgeNetworkRetryPolicy>;
};
 ...
 * @ingroup google-cloud-edgenetwork-options
 */
struct EdgeNetworkBackoffPolicyOption {
 ...
 * @ingroup google-cloud-edgenetwork-options
 */
struct EdgeNetworkConnectionIdempotencyPolicyOption {
  using Type = std::shared_ptr<EdgeNetworkConnectionIdempotencyPolicy>;
};
 ...
 * @ingroup google-cloud-edgenetwork-options
 */
struct EdgeNetworkPollingPolicyOption {
 ...
 * @ingroup google-cloud-edgenetwork-options
 */
using EdgeNetworkPolicyOptionList =
    OptionList<EdgeNetworkRetryPolicyOption, EdgeNetworkBackoffPolicyOption,
