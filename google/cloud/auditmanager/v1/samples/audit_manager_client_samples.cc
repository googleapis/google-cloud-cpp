...
// clang-format off
// main-dox-marker: auditmanager_v1::AuditManagerClient
// lro-marker: true
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::auditmanager_v1::AuditManagerClient(
      google::cloud::auditmanager_v1::MakeAuditManagerConnection(options));
  //! [set-client-endpoint]
}
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::auditmanager_v1::AuditManagerClient(
      google::cloud::auditmanager_v1::MakeAuditManagerConnection(*ud_options));
  //! [set-client-universe-domain]
}

//! [custom-idempotency-policy]
class CustomIdempotencyPolicy : public google::cloud::auditmanager_v1::
                                    AuditManagerConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<
      google::cloud::auditmanager_v1::AuditManagerConnectionIdempotencyPolicy>
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options =
      google::cloud::Options{}
          .set<google::cloud::auditmanager_v1::
                   AuditManagerConnectionIdempotencyPolicyOption>(
              CustomIdempotencyPolicy().clone())
          .set<google::cloud::auditmanager_v1::AuditManagerRetryPolicyOption>(
              google::cloud::auditmanager_v1::
                  AuditManagerLimitedErrorCountRetryPolicy(3)
                      .clone())
          .set<google::cloud::auditmanager_v1::AuditManagerBackoffPolicyOption>(
  ...
  auto c1 = google::cloud::auditmanager_v1::AuditManagerClient(connection);
  auto c2 = google::cloud::auditmanager_v1::AuditManagerClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::auditmanager_v1::AuditManagerClient(
      connection,
      google::cloud::Options{}
          .set<google::cloud::auditmanager_v1::AuditManagerRetryPolicyOption>(
              google::cloud::auditmanager_v1::
                  AuditManagerLimitedTimeRetryPolicy(std::chrono::minutes(5))
                      .clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::auditmanager_v1::AuditManagerRetryPolicyOption>(
  //       google::cloud::auditmanager_v1::AuditManagerLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options =
      google::cloud::Options{}
          .set<google::cloud::auditmanager_v1::AuditManagerPollingPolicyOption>(
              google::cloud::GenericPollingPolicy<
                  google::cloud::auditmanager_v1::
                      AuditManagerRetryPolicyOption::Type,
                  google::cloud::auditmanager_v1::
                      AuditManagerBackoffPolicyOption::Type>(
                  google::cloud::auditmanager_v1::
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::auditmanager_v1::AuditManagerClient(
        google::cloud::auditmanager_v1::MakeAuditManagerConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
