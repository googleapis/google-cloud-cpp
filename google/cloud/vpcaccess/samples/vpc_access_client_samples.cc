...
// main-dox-marker: GOOGLE_CLOUD_CPP_NS::VpcAccessServiceClient
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::GOOGLE_CLOUD_CPP_NS::VpcAccessServiceClient(
      google::cloud::GOOGLE_CLOUD_CPP_NS::MakeVpcAccessServiceConnection(
          options));
  //! [set-client-endpoint]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::GOOGLE_CLOUD_CPP_NS::VpcAccessServiceClient(
        google::cloud::GOOGLE_CLOUD_CPP_NS::MakeVpcAccessServiceConnection(
            options));
  }
  //! [with-service-account]
