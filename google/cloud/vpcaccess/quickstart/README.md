...
This directory contains small examples showing how to use the Serverless VPC
Access API C++ client library in your own project. These instructions assume
...
1. Install the dependencies with your favorite tools. As an example, if you use
   ...
   ```bash
   cd $HOME/vcpkg
   ./vcpkg install google-cloud-cpp[core,vpcaccess]
   ```
...
[quickstart-link]: https://cloud.google.com/vpc/docs/configure-serverless-vpc-access
