...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_VPCACCESS_INTERNAL_VPC_ACCESS_TRACING_CONNECTION_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_VPCACCESS_INTERNAL_VPC_ACCESS_TRACING_CONNECTION_H
...
class VpcAccessServiceTracingConnection
 ...
 public:
  ...
  explicit VpcAccessServiceTracingConnection(
      std::shared_ptr<vpcaccess::VpcAccessServiceConnection> child);
 ...
 private:
  std::shared_ptr<vpcaccess::VpcAccessServiceConnection> child_;
};
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_VPCACCESS_INTERNAL_VPC_ACCESS_TRACING_CONNECTION_H
