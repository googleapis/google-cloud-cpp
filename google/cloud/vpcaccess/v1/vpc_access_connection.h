...
/**
 * A retry policy for `VpcAccessServiceConnection` that stops retrying after a
...
class VpcAccessServiceLimitedErrorCountRetryPolicy
 ...
 public:
  VpcAccessServiceLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `VpcAccessServiceConnection` that stops retrying after
