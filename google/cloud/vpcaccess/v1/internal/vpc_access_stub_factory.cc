...
std::shared_ptr<VpcAccessServiceStub> CreateDefaultVpcAccessServiceStub(
  ...
  auto endpoint = internal::DetermineServiceEndpoint(
      internal::GetEnv("GOOGLE_CLOUD_CPP_VPC_ACCESS_SERVICE_ENDPOINT"),
      std::move(endpoint_option), "vpcaccess.googleapis.com", options);
  ...
  if (!endpoint.ok()) {
    ...
    stub = std::make_shared<DefaultVpcAccessServiceStub>(
  ...
  if (internal::TracingEnabled(options)) {
    stub = MakeVpcAccessServiceTracingStub(std::move(stub));
  }
  return stub;
}
