...
class VpcAccessServiceAuth : public VpcAccessServiceStub {
 public:
  ~VpcAccessServiceAuth() override = default;
  VpcAccessServiceAuth(
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_VPCACCESS_V1_INTERNAL_VPC_ACCESS_AUTH_DECORATOR_H
