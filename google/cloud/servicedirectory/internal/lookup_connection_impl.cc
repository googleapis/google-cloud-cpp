...
inline std::unique_ptr<servicedirectory::LookupServiceRetryPolicy>
retry_policy() {
  return internal::CurrentOptions()
      .get<servicedirectory::LookupServiceRetryPolicyOption>()
      ->clone();
}

inline std::unique_ptr<BackoffPolicy> backoff_policy() {
  return internal::CurrentOptions()
      .get<servicedirectory::LookupServiceBackoffPolicyOption>()
      ->clone();
}

inline std::unique_ptr<
    servicedirectory::LookupServiceConnectionIdempotencyPolicy>
idempotency_policy() {
  return internal::CurrentOptions()
