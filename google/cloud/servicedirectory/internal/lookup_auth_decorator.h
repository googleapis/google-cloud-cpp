...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SERVICEDIRECTORY_INTERNAL_LOOKUP_AUTH_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SERVICEDIRECTORY_INTERNAL_LOOKUP_AUTH_DECORATOR_H
...
class LookupServiceAuth : public LookupServiceStub {
 public:
  ~LookupServiceAuth() override = default;
  LookupServiceAuth(
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SERVICEDIRECTORY_INTERNAL_LOOKUP_AUTH_DECORATOR_H
