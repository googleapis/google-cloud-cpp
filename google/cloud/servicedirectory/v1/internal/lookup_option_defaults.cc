...
Options LookupServiceDefaultOptions(Options options) {
  options = internal::PopulateCommonOptions(
      std::move(options), "GOOGLE_CLOUD_CPP_LOOKUP_SERVICE_ENDPOINT",
      "", "GOOGLE_CLOUD_CPP_LOOKUP_SERVICE_AUTHORITY",
  ...
  if (!options.has<servicedirectory_v1::LookupServiceConnectionIdempotencyPolicyOption>()) {
    options.set<servicedirectory_v1::LookupServiceConnectionIdempotencyPolicyOption>(
