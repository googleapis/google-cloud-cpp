...
class LookupServiceRetryPolicy : public ::google::cloud::RetryPolicy {
 public:
  ...
  /// handled.
  virtual std::unique_ptr<LookupServiceRetryPolicy> clone() const = 0;
};

/**
 * A retry policy for `LookupServiceConnection` that stops retrying after a
...
class LookupServiceLimitedErrorCountRetryPolicy
 ...
 public:
  LookupServiceLimitedErrorCountRetryPolicy(int maximum_failures)
  ...
  std::unique_ptr<LookupServiceRetryPolicy> clone() const override {
    return std::make_unique<LookupServiceLimitedErrorCountRetryPolicy>(
        maximum_failures());
  }
...
/// A retry policy for `LookupServiceConnection` that stops retrying after
/// some wall clock time has elapsed.
class LookupServiceLimitedTimeRetryPolicy : public LookupServiceRetryPolicy {
 public:
  /**
  ...
  std::unique_ptr<LookupServiceRetryPolicy> clone() const override {
    return std::make_unique<LookupServiceLimitedTimeRetryPolicy>(
        maximum_duration());
  }
