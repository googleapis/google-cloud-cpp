...
/**
 * A retry policy for `CloudShellServiceConnection` that stops retrying after a
...
class CloudShellServiceLimitedErrorCountRetryPolicy
 ...
 public:
  CloudShellServiceLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `CloudShellServiceConnection` that stops retrying after
