 ...
 */
class CloudShellServiceLimitedErrorCountRetryPolicy : public CloudShellServiceRetryPolicy {
 public:
  /**
 ...
 private:
  google::cloud::internal::LimitedErrorCountRetryPolicy<shell_v1_internal::CloudShellServiceRetryTraits> impl_;
};
 ...
 * - [`kUnknown`](@ref google::cloud::StatusCode)
 */
class CloudShellServiceLimitedTimeRetryPolicy : public CloudShellServiceRetryPolicy {
 public:
  /**
  ...
  CloudShellServiceLimitedTimeRetryPolicy(CloudShellServiceLimitedTimeRetryPolicy&& rhs) noexcept
    : CloudShellServiceLimitedTimeRetryPolicy(rhs.maximum_duration()) {}
  CloudShellServiceLimitedTimeRetryPolicy(CloudShellServiceLimitedTimeRetryPolicy const& rhs) noexcept
    : CloudShellServiceLimitedTimeRetryPolicy(rhs.maximum_duration()) {}
 ...
 private:
  google::cloud::internal::LimitedTimeRetryPolicy<shell_v1_internal::CloudShellServiceRetryTraits> impl_;
};
 ...
 * sets in `CloudShellServiceClient`. This allows users to inject custom behavior
...
class CloudShellServiceConnection {
 public:
  ...
  virtual StatusOr<google::cloud::shell::v1::Environment>
  ...
  StartEnvironment(NoAwaitTag, google::cloud::shell::v1::StartEnvironmentRequest const& request);

  virtual future<StatusOr<google::cloud::shell::v1::StartEnvironmentResponse>>
  StartEnvironment( google::longrunning::Operation const& operation);

  virtual future<StatusOr<google::cloud::shell::v1::AuthorizeEnvironmentResponse>>
  AuthorizeEnvironment(google::cloud::shell::v1::AuthorizeEnvironmentRequest const& request);

  virtual StatusOr<google::longrunning::Operation>
  AuthorizeEnvironment(NoAwaitTag, google::cloud::shell::v1::AuthorizeEnvironmentRequest const& request);
  ...
  virtual StatusOr<google::longrunning::Operation>
  AddPublicKey(NoAwaitTag, google::cloud::shell::v1::AddPublicKeyRequest const& request);
  ...
  virtual StatusOr<google::longrunning::Operation>
  RemovePublicKey(NoAwaitTag, google::cloud::shell::v1::RemovePublicKeyRequest const& request);
 ...
 * should be passed as an argument to the constructor of CloudShellServiceClient.
 *
 * The optional @p options argument may be used to configure aspects of the
 * returned `CloudShellServiceConnection`. Expected options are any of the types in
 ...
 *
 * @param options (optional) Configure the `CloudShellServiceConnection` created by
 * this function.
 */
