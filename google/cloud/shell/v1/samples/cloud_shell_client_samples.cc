...
// clang-format off
// main-dox-marker: shell_v1::CloudShellServiceClient
// lro-marker: true
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::shell_v1::CloudShellServiceClient(
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::shell_v1::CloudShellServiceClient(
      google::cloud::shell_v1::MakeCloudShellServiceConnection(*ud_options));
  //! [set-client-universe-domain]
}
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto c2 = google::cloud::shell_v1::CloudShellServiceClient(connection);
  ...
  //     .set<google::cloud::shell_v1::CloudShellServiceRetryPolicyOption>(
  //       google::cloud::shell_v1::CloudShellServiceLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
