...
inline std::unique_ptr<shell::CloudShellServiceRetryPolicy> retry_policy() {
  return internal::CurrentOptions()
      .get<shell::CloudShellServiceRetryPolicyOption>()
      ->clone();
}

inline std::unique_ptr<BackoffPolicy> backoff_policy() {
  return internal::CurrentOptions()
      .get<shell::CloudShellServiceBackoffPolicyOption>()
      ->clone();
}

inline std::unique_ptr<shell::CloudShellServiceConnectionIdempotencyPolicy>
idempotency_policy() {
  return internal::CurrentOptions()
...
inline std::unique_ptr<PollingPolicy> polling_policy() {
  return internal::CurrentOptions()
      .get<shell::CloudShellServicePollingPolicyOption>()
      ->clone();
}
