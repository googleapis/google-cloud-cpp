...
// main-dox-marker: GOOGLE_CLOUD_CPP_NS::CloudShellServiceClient
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::GOOGLE_CLOUD_CPP_NS::CloudShellServiceClient(
      google::cloud::GOOGLE_CLOUD_CPP_NS::MakeCloudShellServiceConnection(
          options));
  //! [set-client-endpoint]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::GOOGLE_CLOUD_CPP_NS::CloudShellServiceClient(
        google::cloud::GOOGLE_CLOUD_CPP_NS::MakeCloudShellServiceConnection(
            options));
  }
  //! [with-service-account]
