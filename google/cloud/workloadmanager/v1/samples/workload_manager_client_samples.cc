...
// clang-format off
// main-dox-marker: workloadmanager_v1::WorkloadManagerClient
// lro-marker: true
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::workloadmanager_v1::WorkloadManagerClient(
      google::cloud::workloadmanager_v1::MakeWorkloadManagerConnection(
          options));
  //! [set-client-endpoint]
}
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::workloadmanager_v1::WorkloadManagerClient(
      google::cloud::workloadmanager_v1::MakeWorkloadManagerConnection(
          *ud_options));
  //! [set-client-universe-domain]
}
...
class CustomIdempotencyPolicy : public google::cloud::workloadmanager_v1::
                                    WorkloadManagerConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::workloadmanager_v1::
                      WorkloadManagerConnectionIdempotencyPolicy>
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
                     .set<google::cloud::workloadmanager_v1::
                              WorkloadManagerConnectionIdempotencyPolicyOption>(
                         CustomIdempotencyPolicy().clone())
                     .set<google::cloud::workloadmanager_v1::
                              WorkloadManagerRetryPolicyOption>(
                         google::cloud::workloadmanager_v1::
                             WorkloadManagerLimitedErrorCountRetryPolicy(3)
                                 .clone())
                     .set<google::cloud::workloadmanager_v1::
                         ...
                         google::cloud::ExponentialBackoffPolicy(
                             ...
                             .clone());
  auto connection =
      google::cloud::workloadmanager_v1::MakeWorkloadManagerConnection(options);
  ...
  auto c3 = google::cloud::workloadmanager_v1::WorkloadManagerClient(
      connection,
      google::cloud::Options{}
          .set<google::cloud::workloadmanager_v1::
                   WorkloadManagerRetryPolicyOption>(
              google::cloud::workloadmanager_v1::
                  WorkloadManagerLimitedTimeRetryPolicy(std::chrono::minutes(5))
                      .clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::workloadmanager_v1::WorkloadManagerRetryPolicyOption>(
  //       google::cloud::workloadmanager_v1::WorkloadManagerLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
      ...
      google::cloud::Options{}
          .set<google::cloud::workloadmanager_v1::
              ...
              google::cloud::GenericPollingPolicy<
                  google::cloud::workloadmanager_v1::
                      WorkloadManagerRetryPolicyOption::Type,
                  google::cloud::workloadmanager_v1::
                      WorkloadManagerBackoffPolicyOption::Type>(
                  google::cloud::workloadmanager_v1::
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::workloadmanager_v1::WorkloadManagerClient(
        google::cloud::workloadmanager_v1::MakeWorkloadManagerConnection(
            options));
  }
  //! [with-service-account]
