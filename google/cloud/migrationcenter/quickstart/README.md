# HOWTO: using the Migration Center API C++ client in your project

This directory contains small examples showing how to use the Migration Center API C++
...
Like most Google Cloud Platform (GCP) services, Migration Center API requires that
...
1. Compile this example using Bazel:
   ...
   ```bash
   cd $HOME/google-cloud-cpp/google/cloud/migrationcenter/quickstart
   bazel build ...
   ```
...
1. Install the dependencies with your favorite tools. As an example, if you use
   ...
   ```bash
   cd $HOME/vcpkg
   ./vcpkg install google-cloud-cpp[core,migrationcenter]
   ```
...
[quickstart-link]: https://cloud.google.com/migration-center/docs/get-started-with-google-cloud
