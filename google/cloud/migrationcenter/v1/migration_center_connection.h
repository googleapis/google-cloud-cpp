...
/**
 * A retry policy for `MigrationCenterConnection` that stops retrying after a
...
class MigrationCenterLimitedErrorCountRetryPolicy
 ...
 public:
  MigrationCenterLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `MigrationCenterConnection` that stops retrying after
