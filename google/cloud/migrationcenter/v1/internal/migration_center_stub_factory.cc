...
std::shared_ptr<MigrationCenterStub> CreateDefaultMigrationCenterStub(
  ...
  auto endpoint = internal::DetermineServiceEndpoint(
      internal::GetEnv("GOOGLE_CLOUD_CPP_MIGRATION_CENTER_ENDPOINT"),
      std::move(endpoint_option), "migrationcenter.googleapis.com", options);
  ...
  if (!endpoint.ok()) {
    ...
    stub = std::make_shared<DefaultMigrationCenterStub>(
