...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_OSLOGIN_INTERNAL_OS_LOGIN_TRACING_STUB_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_OSLOGIN_INTERNAL_OS_LOGIN_TRACING_STUB_H
...
class OsLoginServiceTracingStub : public OsLoginServiceStub {
 public:
  ...
  explicit OsLoginServiceTracingStub(std::shared_ptr<OsLoginServiceStub> child);
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_OSLOGIN_INTERNAL_OS_LOGIN_TRACING_STUB_H
