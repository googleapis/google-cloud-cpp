...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_OSLOGIN_INTERNAL_OS_LOGIN_TRACING_CONNECTION_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_OSLOGIN_INTERNAL_OS_LOGIN_TRACING_CONNECTION_H
...
class OsLoginServiceTracingConnection
 ...
 public:
  ...
  explicit OsLoginServiceTracingConnection(
      std::shared_ptr<oslogin::OsLoginServiceConnection> child);
 ...
 private:
  std::shared_ptr<oslogin::OsLoginServiceConnection> child_;
};
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_OSLOGIN_INTERNAL_OS_LOGIN_TRACING_CONNECTION_H
