...
class OsLoginServiceRetryPolicy : public ::google::cloud::RetryPolicy {
 public:
  ...
  /// handled.
  virtual std::unique_ptr<OsLoginServiceRetryPolicy> clone() const = 0;
};

/**
 * A retry policy for `OsLoginServiceConnection` that stops retrying after a
...
class OsLoginServiceLimitedErrorCountRetryPolicy
 ...
 public:
  OsLoginServiceLimitedErrorCountRetryPolicy(int maximum_failures)
  ...
  std::unique_ptr<OsLoginServiceRetryPolicy> clone() const override {
    return std::make_unique<OsLoginServiceLimitedErrorCountRetryPolicy>(
        maximum_failures());
  }
...
/// A retry policy for `OsLoginServiceConnection` that stops retrying after
/// some wall clock time has elapsed.
class OsLoginServiceLimitedTimeRetryPolicy : public OsLoginServiceRetryPolicy {
 public:
  /**
  ...
  std::unique_ptr<OsLoginServiceRetryPolicy> clone() const override {
    return std::make_unique<OsLoginServiceLimitedTimeRetryPolicy>(
        maximum_duration());
  }
