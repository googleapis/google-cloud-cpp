...
class OsLoginServiceConnectionIdempotencyPolicy {
 public:
  ...
  virtual std::unique_ptr<OsLoginServiceConnectionIdempotencyPolicy> clone() const;
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_OSLOGIN_V1_OS_LOGIN_CONNECTION_IDEMPOTENCY_POLICY_H
