...
This directory contains small examples showing how to use the Cloud OS Login API
...
(GCP) project. The [setup guide][setup-link] covers the basic steps for setting
up OS Login.
...
1. Install the dependencies with your favorite tools. As an example, if you use
   ...
   ```bash
   cd $HOME/vcpkg
   ./vcpkg install google-cloud-cpp[core,oslogin]
   ```
...
[setup-link]: https://cloud.google.com/compute/docs/instances/managing-instance-access
