...
// main-dox-marker: GOOGLE_CLOUD_CPP_NS::OsLoginServiceClient
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::GOOGLE_CLOUD_CPP_NS::OsLoginServiceClient(
      google::cloud::GOOGLE_CLOUD_CPP_NS::MakeOsLoginServiceConnection(
          options));
  //! [set-client-endpoint]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::GOOGLE_CLOUD_CPP_NS::OsLoginServiceClient(
        google::cloud::GOOGLE_CLOUD_CPP_NS::MakeOsLoginServiceConnection(
            options));
  }
  //! [with-service-account]
