# HOWTO: using the Dataproc Metastore API C++ client in your project

This directory contains small examples showing how to use the Dataproc Metastore API C++
...
Like most Google Cloud Platform (GCP) services, Dataproc Metastore API requires that
...
1. Install the dependencies with your favorite tools. As an example, if you use
   ...
   ```bash
   cd $HOME/vcpkg
   ./vcpkg install google-cloud-cpp[core,metastore]
   ```
...
[quickstart-link]: https://cloud.google.com/dataproc-metastore/docs/create-service-cluster
