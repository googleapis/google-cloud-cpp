...
using DataprocMetastoreFederationRetryPolicy =
    ::google::cloud::internal::TraitBasedRetryPolicy<
        metastore_v1_internal::DataprocMetastoreFederationRetryTraits>;

using DataprocMetastoreFederationLimitedTimeRetryPolicy =
    ::google::cloud::internal::LimitedTimeRetryPolicy<
        metastore_v1_internal::DataprocMetastoreFederationRetryTraits>;

using DataprocMetastoreFederationLimitedErrorCountRetryPolicy =
