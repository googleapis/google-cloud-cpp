...
class MockDataprocMetastoreConnection
 ...
 public:
  ...
  // EXPECT_CALL(*mock, CreateMetadataImport(_)) instead.
  ...
  // EXPECT_CALL(*mock, UpdateMetadataImport(_)) instead.
  MOCK_METHOD(future<StatusOr<google::cloud::metastore::v1::MetadataImport>>,
  ...
  // EXPECT_CALL(*mock, ExportMetadata(_)) instead.
  MOCK_METHOD(
  ...
  // EXPECT_CALL(*mock, RestoreService(_)) instead.
  MOCK_METHOD(
  ...
  // EXPECT_CALL(*mock, QueryMetadata(_)) instead.
  MOCK_METHOD(
  ...
  // EXPECT_CALL(*mock, MoveTableToDatabase(_)) instead.
  MOCK_METHOD(
      future<
  ...
  // EXPECT_CALL(*mock, AlterMetadataResourceLocation(_)) instead.
  MOCK_METHOD(
      future<StatusOr<
