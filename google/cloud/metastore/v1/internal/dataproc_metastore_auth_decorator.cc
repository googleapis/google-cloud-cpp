...
StatusOr<google::cloud::metastore::v1::ListServicesResponse> DataprocMetastoreAuth::ListServices(
...
StatusOr<google::cloud::metastore::v1::Service> DataprocMetastoreAuth::GetService(
    grpc::ClientContext& context,
    Options const& options,
...
DataprocMetastoreAuth::CreateService(
      grpc::ClientContext& context,
      Options options,
      google::cloud::metastore::v1::CreateServiceRequest const& request) {
  auto status = auth_->ConfigureContext(context);
...
StatusOr<google::longrunning::Operation>
DataprocMetastoreAuth::UpdateService(
      grpc::ClientContext& context,
      Options options,
      google::cloud::metastore::v1::UpdateServiceRequest const& request) {
  auto status = auth_->ConfigureContext(context);
...
StatusOr<google::longrunning::Operation>
DataprocMetastoreAuth::DeleteService(
      grpc::ClientContext& context,
      Options options,
      google::cloud::metastore::v1::DeleteServiceRequest const& request) {
  auto status = auth_->ConfigureContext(context);
...
StatusOr<google::cloud::metastore::v1::ListMetadataImportsResponse> DataprocMetastoreAuth::ListMetadataImports(
    grpc::ClientContext& context,
    Options const& options,
...
StatusOr<google::cloud::metastore::v1::MetadataImport> DataprocMetastoreAuth::GetMetadataImport(
    grpc::ClientContext& context,
    Options const& options,
...
DataprocMetastoreAuth::AsyncCreateMetadataImport(
  ...
  return auth_->AsyncConfigureContext(std::move(context)).then(
      [cq, child = child_, options = std::move(options), request](
        ...
        return child->AsyncCreateMetadataImport(
            cq, *std::move(context), std::move(options), request);
      });
}
...
DataprocMetastoreAuth::AsyncUpdateMetadataImport(
  ...
  return auth_->AsyncConfigureContext(std::move(context)).then(
      [cq, child = child_, options = std::move(options), request](
        ...
        return child->AsyncUpdateMetadataImport(
            cq, *std::move(context), std::move(options), request);
      });
}
...
DataprocMetastoreAuth::AsyncExportMetadata(
  ...
  return auth_->AsyncConfigureContext(std::move(context)).then(
      [cq, child = child_, options = std::move(options), request](
        ...
        return child->AsyncExportMetadata(
            cq, *std::move(context), std::move(options), request);
      });
}

StatusOr<google::longrunning::Operation>
DataprocMetastoreAuth::ExportMetadata(
      grpc::ClientContext& context,
      Options options,
      google::cloud::metastore::v1::ExportMetadataRequest const& request) {
  auto status = auth_->ConfigureContext(context);
...
DataprocMetastoreAuth::AsyncRestoreService(
  ...
  return auth_->AsyncConfigureContext(std::move(context)).then(
      [cq, child = child_, options = std::move(options), request](
        ...
        return child->AsyncRestoreService(
            cq, *std::move(context), std::move(options), request);
      });
}

StatusOr<google::longrunning::Operation>
DataprocMetastoreAuth::RestoreService(
      grpc::ClientContext& context,
      Options options,
      google::cloud::metastore::v1::RestoreServiceRequest const& request) {
  auto status = auth_->ConfigureContext(context);
...
StatusOr<google::cloud::metastore::v1::ListBackupsResponse> DataprocMetastoreAuth::ListBackups(
    grpc::ClientContext& context,
    Options const& options,
...
StatusOr<google::longrunning::Operation>
DataprocMetastoreAuth::CreateBackup(
      grpc::ClientContext& context,
      Options options,
      google::cloud::metastore::v1::CreateBackupRequest const& request) {
  auto status = auth_->ConfigureContext(context);
...
StatusOr<google::longrunning::Operation>
DataprocMetastoreAuth::DeleteBackup(
      grpc::ClientContext& context,
      Options options,
      google::cloud::metastore::v1::DeleteBackupRequest const& request) {
  auto status = auth_->ConfigureContext(context);
...
DataprocMetastoreAuth::AsyncQueryMetadata(
  ...
  return auth_->AsyncConfigureContext(std::move(context)).then(
      [cq, child = child_, options = std::move(options), request](
        ...
        return child->AsyncQueryMetadata(
            cq, *std::move(context), std::move(options), request);
      });
}

StatusOr<google::longrunning::Operation>
DataprocMetastoreAuth::QueryMetadata(
      grpc::ClientContext& context,
      Options options,
      google::cloud::metastore::v1::QueryMetadataRequest const& request) {
  auto status = auth_->ConfigureContext(context);
...
DataprocMetastoreAuth::AsyncMoveTableToDatabase(
  ...
  return auth_->AsyncConfigureContext(std::move(context)).then(
      [cq, child = child_, options = std::move(options), request](
        ...
        return child->AsyncMoveTableToDatabase(
            cq, *std::move(context), std::move(options), request);
      });
}
...
StatusOr<google::cloud::location::ListLocationsResponse> DataprocMetastoreAuth::ListLocations(
    grpc::ClientContext& context,
    Options const& options,
...
StatusOr<google::iam::v1::TestIamPermissionsResponse> DataprocMetastoreAuth::TestIamPermissions(
    grpc::ClientContext& context,
    Options const& options,
...
StatusOr<google::longrunning::ListOperationsResponse> DataprocMetastoreAuth::ListOperations(
    grpc::ClientContext& context,
    Options const& options,
