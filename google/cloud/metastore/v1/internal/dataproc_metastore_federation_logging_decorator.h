...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_METASTORE_V1_INTERNAL_DATAPROC_METASTORE_FEDERATION_LOGGING_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_METASTORE_V1_INTERNAL_DATAPROC_METASTORE_FEDERATION_LOGGING_DECORATOR_H
...
class DataprocMetastoreFederationLogging : public DataprocMetastoreFederationStub {
 public:
  ~DataprocMetastoreFederationLogging() override = default;
  DataprocMetastoreFederationLogging(std::shared_ptr<DataprocMetastoreFederationStub> child,
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_METASTORE_V1_INTERNAL_DATAPROC_METASTORE_FEDERATION_LOGGING_DECORATOR_H
