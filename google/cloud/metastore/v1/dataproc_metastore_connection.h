...
/**
 * A retry policy for `DataprocMetastoreConnection` that stops retrying after a
...
class DataprocMetastoreLimitedErrorCountRetryPolicy
 ...
 public:
  DataprocMetastoreLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `DataprocMetastoreConnection` that stops retrying after
