...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_MEMORYSTORE_V1_INTERNAL_MEMORYSTORE_LOGGING_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_MEMORYSTORE_V1_INTERNAL_MEMORYSTORE_LOGGING_DECORATOR_H
...
class MemorystoreLogging : public MemorystoreStub {
 public:
  ~MemorystoreLogging() override = default;
  MemorystoreLogging(std::shared_ptr<MemorystoreStub> child,
 ...
 private:
  std::shared_ptr<MemorystoreStub> child_;
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_MEMORYSTORE_V1_INTERNAL_MEMORYSTORE_LOGGING_DECORATOR_H
