...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_MEMORYSTORE_V1_INTERNAL_MEMORYSTORE_TRACING_STUB_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_MEMORYSTORE_V1_INTERNAL_MEMORYSTORE_TRACING_STUB_H
...
class MemorystoreTracingStub : public MemorystoreStub {
 public:
  ...
  explicit MemorystoreTracingStub(std::shared_ptr<MemorystoreStub> child);
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_MEMORYSTORE_V1_INTERNAL_MEMORYSTORE_TRACING_STUB_H
