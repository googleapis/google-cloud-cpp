...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_MEMORYSTORE_V1_INTERNAL_MEMORYSTORE_METADATA_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_MEMORYSTORE_V1_INTERNAL_MEMORYSTORE_METADATA_DECORATOR_H
...
class MemorystoreMetadata : public MemorystoreStub {
 public:
  ~MemorystoreMetadata() override = default;
  MemorystoreMetadata(std::shared_ptr<MemorystoreStub> child,
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_MEMORYSTORE_V1_INTERNAL_MEMORYSTORE_METADATA_DECORATOR_H
