...
// clang-format off
// main-dox-marker: memorystore_v1::MemorystoreClient
// lro-marker: true
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::memorystore_v1::MemorystoreClient(
      google::cloud::memorystore_v1::MakeMemorystoreConnection(options));
  //! [set-client-endpoint]
}

//! [custom-idempotency-policy]
class CustomIdempotencyPolicy
   : public google::cloud::memorystore_v1::MemorystoreConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::memorystore_v1::MemorystoreConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::memorystore_v1::MemorystoreConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::memorystore_v1::MemorystoreRetryPolicyOption>(
      google::cloud::memorystore_v1::MemorystoreLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::memorystore_v1::MemorystoreBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::memorystore_v1::MakeMemorystoreConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::memorystore_v1::MemorystoreClient(connection);
  auto c2 = google::cloud::memorystore_v1::MemorystoreClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::memorystore_v1::MemorystoreClient(
    connection, google::cloud::Options{}.set<google::cloud::memorystore_v1::MemorystoreRetryPolicyOption>(
      google::cloud::memorystore_v1::MemorystoreLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::memorystore_v1::MemorystoreRetryPolicyOption>(
  //       google::cloud::memorystore_v1::MemorystoreLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::memorystore_v1::MemorystorePollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::memorystore_v1::MemorystoreRetryPolicyOption::Type,
            google::cloud::memorystore_v1::MemorystoreBackoffPolicyOption::Type>(
            google::cloud::memorystore_v1::MemorystoreLimitedTimeRetryPolicy(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::memorystore_v1::MemorystoreClient(
      google::cloud::memorystore_v1::MakeMemorystoreConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
