...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::memorystore_v1::MemorystoreClient(
      google::cloud::memorystore_v1::MakeMemorystoreConnection(*ud_options));
  //! [set-client-universe-domain]
}

//! [custom-idempotency-policy]
class CustomIdempotencyPolicy : public google::cloud::memorystore_v1::
                                    MemorystoreConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<
      google::cloud::memorystore_v1::MemorystoreConnectionIdempotencyPolicy>
      ...
      google::cloud::Options{}
          .set<google::cloud::memorystore_v1::MemorystorePollingPolicyOption>(
              google::cloud::GenericPollingPolicy<
                  google::cloud::memorystore_v1::MemorystoreRetryPolicyOption::
                      Type,
                  google::cloud::memorystore_v1::
                      MemorystoreBackoffPolicyOption::Type>(
                  google::cloud::memorystore_v1::
