...
#include <google/cloud/memorystore/v1/memorystore.pb.h>
...
class MemorystoreRetryPolicy : public ::google::cloud::RetryPolicy {
 public:
  /// Creates a new instance of the policy, reset to the initial state.
  virtual std::unique_ptr<MemorystoreRetryPolicy> clone() const = 0;
};
 ...
 */
class MemorystoreLimitedErrorCountRetryPolicy : public MemorystoreRetryPolicy {
 public:
  /**
  ...
  std::unique_ptr<MemorystoreRetryPolicy> clone() const override {
    return std::make_unique<MemorystoreLimitedErrorCountRetryPolicy>(
        maximum_failures());
  }
 ...
 * - [`kUnavailable`](@ref google::cloud::StatusCode)
 */
class MemorystoreLimitedTimeRetryPolicy : public MemorystoreRetryPolicy {
 public:
  /**
  ...
  std::unique_ptr<MemorystoreRetryPolicy> clone() const override {
    return std::make_unique<MemorystoreLimitedTimeRetryPolicy>(
        maximum_duration());
  }
 ...
 * sets in `MemorystoreClient`. This allows users to inject custom behavior
 * (e.g., with a Google Mock object) when writing tests that use objects of type
 * `MemorystoreClient`.
 *
 * To create a concrete instance, see `MakeMemorystoreConnection()`.
 *
 * For mocking, see `memorystore_v1_mocks::MockMemorystoreConnection`.
 */
class MemorystoreConnection {
 public:
  virtual ~MemorystoreConnection() = 0;
 ...
 * should be passed as an argument to the constructor of MemorystoreClient.
 *
 * The optional @p options argument may be used to configure aspects of the
 * returned `MemorystoreConnection`. Expected options are any of the types in
 * the following option lists:
 *
 * - `google::cloud::CommonOptionList`
 * - `google::cloud::GrpcOptionList`
 * - `google::cloud::UnifiedCredentialsOptionList`
 * - `google::cloud::memorystore_v1::MemorystorePolicyOptionList`
 *
 * @note Unexpected options will be ignored. To log unexpected options instead,
 *     set `GOOGLE_CLOUD_CPP_ENABLE_CLOG=yes` in the environment.
 *
 * @param options (optional) Configure the `MemorystoreConnection` created by
 * this function.
 */
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_MEMORYSTORE_V1_MEMORYSTORE_CONNECTION_H
