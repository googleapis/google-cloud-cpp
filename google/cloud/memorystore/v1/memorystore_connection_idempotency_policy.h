...
class MemorystoreConnectionIdempotencyPolicy {
 public:
  virtual ~MemorystoreConnectionIdempotencyPolicy();
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_MEMORYSTORE_V1_MEMORYSTORE_CONNECTION_IDEMPOTENCY_POLICY_H
