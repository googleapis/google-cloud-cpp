# HOWTO: using the Cloud Domains API C++ client in your project

This directory contains small examples showing how to use the Cloud Domains API C++
...
1. Install the dependencies with your favorite tools. As an example, if you use
   ...
   ```bash
   cd $HOME/vcpkg
   ./vcpkg install google-cloud-cpp[core,domains]
   ```
...
[quickstart-link]: https://cloud.google.com/domains/docs/buy-register-domain
