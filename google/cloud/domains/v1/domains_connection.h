...
/**
 * A retry policy for `DomainsConnection` that stops retrying after a
...
class DomainsLimitedErrorCountRetryPolicy : public DomainsRetryPolicy {
 public:
  DomainsLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `DomainsConnection` that stops retrying after
