...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::domains_v1::DomainsClient(
      google::cloud::domains_v1::MakeDomainsConnection(*ud_options));
  //! [set-client-universe-domain]
}
...
class CustomIdempotencyPolicy
 ...
 public:
  ...
  std::unique_ptr<google::cloud::domains_v1::DomainsConnectionIdempotencyPolicy>
