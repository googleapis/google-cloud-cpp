...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::domains_v1::DomainsClient(
...
class CustomIdempotencyPolicy
   : public google::cloud::domains_v1::DomainsConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::domains_v1::DomainsConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::domains_v1::DomainsConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::domains_v1::DomainsRetryPolicyOption>(
      google::cloud::domains_v1::DomainsLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::domains_v1::DomainsBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::domains_v1::MakeDomainsConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::domains_v1::DomainsClient(connection);
  auto c2 = google::cloud::domains_v1::DomainsClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::domains_v1::DomainsClient(
    connection, google::cloud::Options{}.set<google::cloud::domains_v1::DomainsRetryPolicyOption>(
      google::cloud::domains_v1::DomainsLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::domains_v1::DomainsRetryPolicyOption>(
  //       google::cloud::domains_v1::DomainsLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::domains_v1::DomainsPollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::domains_v1::DomainsRetryPolicyOption::Type,
            google::cloud::domains_v1::DomainsBackoffPolicyOption::Type>(
            google::cloud::domains_v1::DomainsLimitedTimeRetryPolicy(
