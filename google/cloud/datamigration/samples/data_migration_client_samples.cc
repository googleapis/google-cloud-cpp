...
// main-dox-marker: GOOGLE_CLOUD_CPP_NS::DataMigrationServiceClient
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::GOOGLE_CLOUD_CPP_NS::DataMigrationServiceClient(
      google::cloud::GOOGLE_CLOUD_CPP_NS::MakeDataMigrationServiceConnection(
          options));
  //! [set-client-endpoint]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::GOOGLE_CLOUD_CPP_NS::DataMigrationServiceClient(
        google::cloud::GOOGLE_CLOUD_CPP_NS::MakeDataMigrationServiceConnection(
            options));
  }
  //! [with-service-account]
