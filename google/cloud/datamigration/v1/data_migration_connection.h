...
/**
 * A retry policy for `DataMigrationServiceConnection` that stops retrying after
...
class DataMigrationServiceLimitedErrorCountRetryPolicy
 ...
 public:
  DataMigrationServiceLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `DataMigrationServiceConnection` that stops retrying
