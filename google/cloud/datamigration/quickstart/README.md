...
This directory contains small examples showing how to use the Database Migration
...
1. Install the dependencies with your favorite tools. As an example, if you use
   ...
   ```bash
   cd $HOME/vcpkg
   ./vcpkg install google-cloud-cpp[core,datamigration]
   ```
...
[quickstart-link]: https://cloud.google.com/database-migration/docs/quickstarts
