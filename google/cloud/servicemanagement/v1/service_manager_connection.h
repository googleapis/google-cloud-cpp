...
/**
 * A retry policy for `ServiceManagerConnection` that stops retrying after a
...
class ServiceManagerLimitedErrorCountRetryPolicy
 ...
 public:
  ServiceManagerLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `ServiceManagerConnection` that stops retrying after
