...
std::shared_ptr<ServiceManagerStub> CreateDefaultServiceManagerStub(
  ...
  auto endpoint = internal::DetermineServiceEndpoint(
      internal::GetEnv("GOOGLE_CLOUD_CPP_SERVICE_MANAGER_ENDPOINT"),
      std::move(endpoint_option), "servicemanagement.googleapis.com", options);
  ...
  if (!endpoint.ok()) {
    ...
    stub = std::make_shared<DefaultServiceManagerStub>(
  ...
  if (internal::TracingEnabled(options)) {
    stub = MakeServiceManagerTracingStub(std::move(stub));
  }
  return stub;
}
