...
StatusOr<google::api::servicemanagement::v1::ListServicesResponse> ServiceManagerAuth::ListServices(
...
StatusOr<google::api::servicemanagement::v1::ManagedService> ServiceManagerAuth::GetService(
    grpc::ClientContext& context,
    Options const& options,
...
ServiceManagerAuth::CreateService(
      grpc::ClientContext& context,
      Options options,
      google::api::servicemanagement::v1::CreateServiceRequest const& request) {
  auto status = auth_->ConfigureContext(context);
...
StatusOr<google::longrunning::Operation>
ServiceManagerAuth::DeleteService(
      grpc::ClientContext& context,
      Options options,
      google::api::servicemanagement::v1::DeleteServiceRequest const& request) {
  auto status = auth_->ConfigureContext(context);
...
ServiceManagerAuth::AsyncUndeleteService(
  ...
  return auth_->AsyncConfigureContext(std::move(context)).then(
      [cq, child = child_, options = std::move(options), request](
        ...
        return child->AsyncUndeleteService(
            cq, *std::move(context), std::move(options), request);
      });
}

StatusOr<google::longrunning::Operation>
ServiceManagerAuth::UndeleteService(
      grpc::ClientContext& context,
      Options options,
      google::api::servicemanagement::v1::UndeleteServiceRequest const& request) {
  auto status = auth_->ConfigureContext(context);
...
StatusOr<google::api::servicemanagement::v1::ListServiceConfigsResponse> ServiceManagerAuth::ListServiceConfigs(
    grpc::ClientContext& context,
    Options const& options,
...
ServiceManagerAuth::AsyncSubmitConfigSource(
  ...
  return auth_->AsyncConfigureContext(std::move(context)).then(
      [cq, child = child_, options = std::move(options), request](
        ...
        return child->AsyncSubmitConfigSource(
            cq, *std::move(context), std::move(options), request);
      });
}

StatusOr<google::longrunning::Operation>
ServiceManagerAuth::SubmitConfigSource(
      grpc::ClientContext& context,
      Options options,
      google::api::servicemanagement::v1::SubmitConfigSourceRequest const& request) {
  auto status = auth_->ConfigureContext(context);
...
StatusOr<google::api::servicemanagement::v1::ListServiceRolloutsResponse> ServiceManagerAuth::ListServiceRollouts(
    grpc::ClientContext& context,
    Options const& options,
...
StatusOr<google::api::servicemanagement::v1::Rollout> ServiceManagerAuth::GetServiceRollout(
    grpc::ClientContext& context,
    Options const& options,
...
ServiceManagerAuth::AsyncCreateServiceRollout(
  ...
  return auth_->AsyncConfigureContext(std::move(context)).then(
      [cq, child = child_, options = std::move(options), request](
        ...
        return child->AsyncCreateServiceRollout(
            cq, *std::move(context), std::move(options), request);
      });
}
...
StatusOr<google::api::servicemanagement::v1::GenerateConfigReportResponse> ServiceManagerAuth::GenerateConfigReport(
    grpc::ClientContext& context,
    Options const& options,
...
StatusOr<google::iam::v1::TestIamPermissionsResponse> ServiceManagerAuth::TestIamPermissions(
    grpc::ClientContext& context,
    Options const& options,
...
StatusOr<google::longrunning::ListOperationsResponse> ServiceManagerAuth::ListOperations(
    grpc::ClientContext& context,
    Options const& options,
