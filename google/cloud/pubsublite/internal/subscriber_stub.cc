...
DefaultSubscriberServiceStub::AsyncSubscribe(
  ...
  return google::cloud::internal::MakeStreamingReadWriteRpc<google::cloud::pubsublite::v1::SubscribeRequest, google::cloud::pubsublite::v1::SubscribeResponse>(
...
Status
DefaultSubscriberServiceStub::DeleteOperation(
  grpc::ClientContext& context, Options const&,
...
Status
DefaultSubscriberServiceStub::CancelOperation(
  grpc::ClientContext& context, Options const&,
