...
class AdminServiceConnectionImpl
 ...
 private:
  ...
  std::unique_ptr<pubsublite::AdminServiceConnectionIdempotencyPolicy> idempotency_policy() {
    auto const& options = internal::CurrentOptions();
  ...
  std::unique_ptr<pubsublite::AdminServiceRetryPolicy const> retry_policy_prototype_;
  std::unique_ptr<BackoffPolicy const> backoff_policy_prototype_;
  std::unique_ptr<pubsublite::AdminServiceConnectionIdempotencyPolicy> idempotency_policy_;
