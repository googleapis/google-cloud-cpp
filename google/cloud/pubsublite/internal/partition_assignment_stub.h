...
class DefaultPartitionAssignmentServiceStub : public PartitionAssignmentServiceStub {
 public:
  explicit DefaultPartitionAssignmentServiceStub(
      std::unique_ptr<google::cloud::pubsublite::v1::PartitionAssignmentService::StubInterface> grpc_stub,
 ...
 private:
  std::unique_ptr<google::cloud::pubsublite::v1::PartitionAssignmentService::StubInterface> grpc_stub_;
