...
class TopicStatsServiceAuth : public TopicStatsServiceStub {
 public:
  ~TopicStatsServiceAuth() override = default;
  TopicStatsServiceAuth(
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_PUBSUBLITE_INTERNAL_TOPIC_STATS_AUTH_DECORATOR_H
