...
DefaultPartitionAssignmentServiceStub::AsyncAssignPartitions(
  ...
  return google::cloud::internal::MakeStreamingReadWriteRpc<google::cloud::pubsublite::v1::PartitionAssignmentRequest, google::cloud::pubsublite::v1::PartitionAssignment>(
...
Status
DefaultPartitionAssignmentServiceStub::DeleteOperation(
  grpc::ClientContext& context, Options const&,
...
Status
DefaultPartitionAssignmentServiceStub::CancelOperation(
  grpc::ClientContext& context, Options const&,
