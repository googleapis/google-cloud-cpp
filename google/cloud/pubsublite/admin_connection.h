...
/**
 * A retry policy for `AdminServiceConnection` that stops retrying after a
...
class AdminServiceLimitedErrorCountRetryPolicy
 ...
 public:
  AdminServiceLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `AdminServiceConnection` that stops retrying after
