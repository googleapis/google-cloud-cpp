...
class BatchingOptions {
 public:
  ...
  void set_maximum_batch_message_count(std::int64_t v) {
    max_batch_messages_ = std::min<std::int64_t>(v, 1000);
  }
  ...
  void set_maximum_batch_bytes(std::int64_t v) {
    max_batch_bytes_ = std::min<std::int64_t>(v, 1024 * 1024 * 7 / 2);
  }
 ...
 private:
  std::int64_t max_batch_messages_{1000};
  std::int64_t max_batch_bytes_{1024 * 1024 * 7 / 2};
