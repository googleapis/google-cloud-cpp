...
/**
 * A retry policy for `TopicStatsServiceConnection` that stops retrying after a
...
class TopicStatsServiceLimitedErrorCountRetryPolicy
 ...
 public:
  TopicStatsServiceLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `TopicStatsServiceConnection` that stops retrying after
