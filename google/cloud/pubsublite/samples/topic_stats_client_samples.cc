...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::pubsublite::TopicStatsServiceClient(
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::pubsublite::TopicStatsServiceClient(
      google::cloud::pubsublite::MakeTopicStatsServiceConnection(*ud_options));
  //! [set-client-universe-domain]
}

//! [custom-idempotency-policy]
class CustomIdempotencyPolicy
    : public google::cloud::pubsublite::
          TopicStatsServiceConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<
      google::cloud::pubsublite::TopicStatsServiceConnectionIdempotencyPolicy>
      ...
      google::cloud::Options{}
          ...
          .set<google::cloud::pubsublite::TopicStatsServiceRetryPolicyOption>(
              google::cloud::pubsublite::
                  TopicStatsServiceLimitedErrorCountRetryPolicy(3)
                      .clone())
