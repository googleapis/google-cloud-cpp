...
// main-dox-marker: GOOGLE_CLOUD_CPP_NS::AdminServiceClient
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::GOOGLE_CLOUD_CPP_NS::AdminServiceClient(
      google::cloud::GOOGLE_CLOUD_CPP_NS::MakeAdminServiceConnection(options));
  //! [set-client-endpoint]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::GOOGLE_CLOUD_CPP_NS::AdminServiceClient(
        google::cloud::GOOGLE_CLOUD_CPP_NS::MakeAdminServiceConnection(
            options));
  }
  //! [with-service-account]
  (argv.at(0));
