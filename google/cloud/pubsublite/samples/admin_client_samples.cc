...
class CustomIdempotencyPolicy
   : public google::cloud::pubsublite::AdminServiceConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::pubsublite::AdminServiceConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::pubsublite::AdminServiceConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::pubsublite::AdminServiceRetryPolicyOption>(
      google::cloud::pubsublite::AdminServiceLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::pubsublite::AdminServiceBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::pubsublite::MakeAdminServiceConnection(options);
  ...
  auto c3 = google::cloud::pubsublite::AdminServiceClient(
    connection, google::cloud::Options{}.set<google::cloud::pubsublite::AdminServiceRetryPolicyOption>(
      google::cloud::pubsublite::AdminServiceLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::pubsublite::AdminServicePollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::pubsublite::AdminServiceRetryPolicyOption::Type,
            google::cloud::pubsublite::AdminServiceBackoffPolicyOption::Type>(
