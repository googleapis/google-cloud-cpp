...
class TopicStatsServiceConnectionIdempotencyPolicy {
 public:
  ...
  virtual std::unique_ptr<TopicStatsServiceConnectionIdempotencyPolicy> clone() const;
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_PUBSUBLITE_TOPIC_STATS_CONNECTION_IDEMPOTENCY_POLICY_H
