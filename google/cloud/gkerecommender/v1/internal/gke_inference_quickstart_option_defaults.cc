...
Options GkeInferenceQuickstartDefaultOptions(Options options) {
  options = internal::PopulateCommonOptions(
      std::move(options), "GOOGLE_CLOUD_CPP_GKE_INFERENCE_QUICKSTART_ENDPOINT",
  ...
  if (!options.has<
          gkerecommender_v1::GkeInferenceQuickstartBackoffPolicyOption>()) {
    options.set<gkerecommender_v1::GkeInferenceQuickstartBackoffPolicyOption>(
