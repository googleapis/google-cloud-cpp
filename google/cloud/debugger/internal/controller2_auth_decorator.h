...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DEBUGGER_INTERNAL_CONTROLLER2_AUTH_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DEBUGGER_INTERNAL_CONTROLLER2_AUTH_DECORATOR_H
...
class Controller2Auth : public Controller2Stub {
 public:
  ~Controller2Auth() override = default;
  Controller2Auth(
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DEBUGGER_INTERNAL_CONTROLLER2_AUTH_DECORATOR_H
