...
#include "google/cloud/debugger/v2/internal/debugger2_connection_impl.h"
#include "google/cloud/debugger/v2/internal/debugger2_option_defaults.h"
...
std::shared_ptr<Debugger2Connection> MakeDebugger2Connection(Options options) {
  ...
  options = debugger_v2_internal::Debugger2DefaultOptions(std::move(options));
  auto background = internal::MakeBackgroundThreadsFactory(options)();
  auto stub = debugger_v2_internal::CreateDefaultDebugger2Stub(background->cq(),
                                                               options);
  return debugger_v2_internal::MakeDebugger2TracingConnection(
      std::make_shared<debugger_v2_internal::Debugger2ConnectionImpl>(
