...
#include "google/cloud/debugger/v2/internal/controller2_stub_factory.h"
...
std::shared_ptr<Controller2Connection> MakeController2Connection(
  ...
  internal::CheckExpectedOptions<CommonOptionList, GrpcOptionList,
                                 ...
                                 Controller2PolicyOptionList>(options,
                                                              __func__);
  options = debugger_v2_internal::Controller2DefaultOptions(std::move(options));
  auto background = internal::MakeBackgroundThreadsFactory(options)();
  auto stub = debugger_v2_internal::CreateDefaultController2Stub(
      background->cq(), options);
  return debugger_v2_internal::MakeController2TracingConnection(
      std::make_shared<debugger_v2_internal::Controller2ConnectionImpl>(
