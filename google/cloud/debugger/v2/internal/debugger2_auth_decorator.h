...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DEBUGGER_V2_INTERNAL_DEBUGGER2_AUTH_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DEBUGGER_V2_INTERNAL_DEBUGGER2_AUTH_DECORATOR_H
...
class Debugger2Auth : public Debugger2Stub {
 public:
  ~Debugger2Auth() override = default;
  Debugger2Auth(
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DEBUGGER_V2_INTERNAL_DEBUGGER2_AUTH_DECORATOR_H
