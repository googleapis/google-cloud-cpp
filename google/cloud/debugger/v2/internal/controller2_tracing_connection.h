...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DEBUGGER_V2_INTERNAL_CONTROLLER2_TRACING_CONNECTION_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DEBUGGER_V2_INTERNAL_CONTROLLER2_TRACING_CONNECTION_H
...
class Controller2TracingConnection : public debugger_v2::Controller2Connection {
 public:
  ~Controller2TracingConnection() override = default;

  explicit Controller2TracingConnection(
      std::shared_ptr<debugger_v2::Controller2Connection> child);
 ...
 private:
  std::shared_ptr<debugger_v2::Controller2Connection> child_;
};
 ...
 */
std::shared_ptr<debugger_v2::Controller2Connection>
MakeController2TracingConnection(
    std::shared_ptr<debugger_v2::Controller2Connection> conn);
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DEBUGGER_V2_INTERNAL_CONTROLLER2_TRACING_CONNECTION_H
