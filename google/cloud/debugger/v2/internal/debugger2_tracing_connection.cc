...
#include "google/cloud/debugger/v2/internal/debugger2_tracing_connection.h"
...
Debugger2TracingConnection::SetBreakpoint(
  ...
  auto span =
      internal::MakeSpan("debugger_v2::Debugger2Connection::SetBreakpoint");
...
Debugger2TracingConnection::GetBreakpoint(
  ...
  auto span =
      internal::MakeSpan("debugger_v2::Debugger2Connection::GetBreakpoint");
  auto scope = opentelemetry::trace::Scope(span);
...
Status Debugger2TracingConnection::DeleteBreakpoint(
    google::devtools::clouddebugger::v2::DeleteBreakpointRequest const&
        request) {
  auto span =
      internal::MakeSpan("debugger_v2::Debugger2Connection::DeleteBreakpoint");
  auto scope = opentelemetry::trace::Scope(span);
...
Debugger2TracingConnection::ListBreakpoints(
    google::devtools::clouddebugger::v2::ListBreakpointsRequest const&
        request) {
  auto span =
      internal::MakeSpan("debugger_v2::Debugger2Connection::ListBreakpoints");
  auto scope = opentelemetry::trace::Scope(span);
...
Debugger2TracingConnection::ListDebuggees(
  ...
  auto span =
      internal::MakeSpan("debugger_v2::Debugger2Connection::ListDebuggees");
  auto scope = opentelemetry::trace::Scope(span);
