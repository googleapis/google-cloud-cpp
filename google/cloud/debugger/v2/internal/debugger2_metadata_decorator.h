...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DEBUGGER_V2_INTERNAL_DEBUGGER2_METADATA_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DEBUGGER_V2_INTERNAL_DEBUGGER2_METADATA_DECORATOR_H
...
class Debugger2Metadata : public Debugger2Stub {
 public:
  ~Debugger2Metadata() override = default;
  explicit Debugger2Metadata(std::shared_ptr<Debugger2Stub> child);
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DEBUGGER_V2_INTERNAL_DEBUGGER2_METADATA_DECORATOR_H
