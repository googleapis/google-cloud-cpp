...
#include "google/cloud/debugger/v2/internal/controller2_connection_impl.h"
#include "google/cloud/debugger/v2/internal/controller2_option_defaults.h"
...
Controller2ConnectionImpl::Controller2ConnectionImpl(
    ...
    std::shared_ptr<debugger_v2_internal::Controller2Stub> stub,
    Options options)
