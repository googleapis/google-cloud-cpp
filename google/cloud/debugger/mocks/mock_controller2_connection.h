...
#include "google/cloud/debugger/v2/mocks/mock_controller2_connection.h"
...
/// @deprecated Use debugger_v2_mocks::MockController2Connection directly.
using ::google::cloud::debugger_v2_mocks::MockController2Connection;
