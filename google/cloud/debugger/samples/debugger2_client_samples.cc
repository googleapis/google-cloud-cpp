...
// main-dox-marker: GOOGLE_CLOUD_CPP_NS::Debugger2Client
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::GOOGLE_CLOUD_CPP_NS::Debugger2Client(
      google::cloud::GOOGLE_CLOUD_CPP_NS::MakeDebugger2Connection(options));
  //! [set-client-endpoint]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::GOOGLE_CLOUD_CPP_NS::Debugger2Client(
        google::cloud::GOOGLE_CLOUD_CPP_NS::MakeDebugger2Connection(options));
  }
  //! [with-service-account]
  (argv.at(0));
