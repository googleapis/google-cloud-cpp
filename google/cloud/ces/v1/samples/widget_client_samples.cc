...
// clang-format off
// main-dox-marker: ces_v1::WidgetServiceClient
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::ces_v1::WidgetServiceClient(
      google::cloud::ces_v1::MakeWidgetServiceConnection(options));
  //! [set-client-endpoint]
}
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::ces_v1::WidgetServiceClient(
      google::cloud::ces_v1::MakeWidgetServiceConnection(*ud_options));
  //! [set-client-universe-domain]
}

//! [custom-idempotency-policy]
class CustomIdempotencyPolicy
    : public google::cloud::ces_v1::WidgetServiceConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<
      google::cloud::ces_v1::WidgetServiceConnectionIdempotencyPolicy>
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options =
      google::cloud::Options{}
          ...
          .set<google::cloud::ces_v1::WidgetServiceRetryPolicyOption>(
              google::cloud::ces_v1::WidgetServiceLimitedErrorCountRetryPolicy(
                  3)
                  .clone())
          .set<google::cloud::ces_v1::WidgetServiceBackoffPolicyOption>(
              google::cloud::ExponentialBackoffPolicy(
                  /*initial_delay=*/std::chrono::milliseconds(200),
                  /*maximum_delay=*/std::chrono::seconds(45),
                  /*scaling=*/2.0)
                  .clone());
  auto connection = google::cloud::ces_v1::MakeWidgetServiceConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::ces_v1::WidgetServiceClient(connection);
  auto c2 = google::cloud::ces_v1::WidgetServiceClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::ces_v1::WidgetServiceClient(
      connection,
      google::cloud::Options{}
          .set<google::cloud::ces_v1::WidgetServiceRetryPolicyOption>(
              google::cloud::ces_v1::WidgetServiceLimitedTimeRetryPolicy(
  ...
  //     .set<google::cloud::ces_v1::WidgetServiceRetryPolicyOption>(
  //       google::cloud::ces_v1::WidgetServiceLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::ces_v1::WidgetServiceClient(
        google::cloud::ces_v1::MakeWidgetServiceConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
