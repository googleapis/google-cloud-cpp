...
// clang-format off
// main-dox-marker: ces_v1::SessionServiceClient
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::ces_v1::SessionServiceClient(
      google::cloud::ces_v1::MakeSessionServiceConnection(options));
  //! [set-client-endpoint]
}
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::ces_v1::SessionServiceClient(
      google::cloud::ces_v1::MakeSessionServiceConnection(*ud_options));
  //! [set-client-universe-domain]
}

//! [custom-idempotency-policy]
class CustomIdempotencyPolicy
    : public google::cloud::ces_v1::SessionServiceConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<
      google::cloud::ces_v1::SessionServiceConnectionIdempotencyPolicy>
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options =
      google::cloud::Options{}
          ...
          .set<google::cloud::ces_v1::SessionServiceRetryPolicyOption>(
              google::cloud::ces_v1::SessionServiceLimitedErrorCountRetryPolicy(
                  3)
                  .clone())
          .set<google::cloud::ces_v1::SessionServiceBackoffPolicyOption>(
  ...
  auto c1 = google::cloud::ces_v1::SessionServiceClient(connection);
  auto c2 = google::cloud::ces_v1::SessionServiceClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::ces_v1::SessionServiceClient(
      connection,
      google::cloud::Options{}
          .set<google::cloud::ces_v1::SessionServiceRetryPolicyOption>(
              google::cloud::ces_v1::SessionServiceLimitedTimeRetryPolicy(
  ...
  //     .set<google::cloud::ces_v1::SessionServiceRetryPolicyOption>(
  //       google::cloud::ces_v1::SessionServiceLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::ces_v1::SessionServiceClient(
        google::cloud::ces_v1::MakeSessionServiceConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
