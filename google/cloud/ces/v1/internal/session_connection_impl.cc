...
std::unique_ptr<ces_v1::SessionServiceRetryPolicy> retry_policy(
    Options const& options) {
  return options.get<ces_v1::SessionServiceRetryPolicyOption>()->clone();
}

std::unique_ptr<BackoffPolicy> backoff_policy(Options const& options) {
  return options.get<ces_v1::SessionServiceBackoffPolicyOption>()->clone();
}

std::unique_ptr<ces_v1::SessionServiceConnectionIdempotencyPolicy>
idempotency_policy(Options const& options) {
  return options.get<ces_v1::SessionServiceConnectionIdempotencyPolicyOption>()
      ->clone();
}
...
SessionServiceConnectionImpl::AsyncBidiRunSession() {
  return stub_->AsyncBidiRunSession(background_->cq(),
                                    std::make_shared<grpc::ClientContext>(),
                                    internal::SaveCurrentOptions());
}

StreamRange<google::cloud::location::Location>
SessionServiceConnectionImpl::ListLocations(
  ...
  return google::cloud::internal::MakePaginationRange<
      ...
      [idempotency, function_name, stub = stub_,
       retry = std::shared_ptr<ces_v1::SessionServiceRetryPolicy>(
...
SessionServiceConnectionImpl::GetLocation(
...
SessionServiceConnectionImpl::ListOperations(
...
SessionServiceConnectionImpl::GetOperation(
...
Status SessionServiceConnectionImpl::DeleteOperation(
...
Status SessionServiceConnectionImpl::CancelOperation(
