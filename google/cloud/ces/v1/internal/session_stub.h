...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_CES_V1_INTERNAL_SESSION_STUB_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_CES_V1_INTERNAL_SESSION_STUB_H
...
class SessionServiceStub {
 public:
  ...
  AsyncBidiRunSession(google::cloud::CompletionQueue const& cq,
...
class DefaultSessionServiceStub : public SessionServiceStub {
 public:
  explicit DefaultSessionServiceStub(
      std::unique_ptr<google::cloud::ces::v1::SessionService::StubInterface>
          grpc_stub,
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_CES_V1_INTERNAL_SESSION_STUB_H
