...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_TRACE_MOCKS_MOCK_TRACE_CONNECTION_H
 ...
 * including errors from a `TraceServiceClient`. To do so, construct a
 * `TraceServiceClient` with an instance of this class. Then use the Google
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_TRACE_MOCKS_MOCK_TRACE_CONNECTION_H
