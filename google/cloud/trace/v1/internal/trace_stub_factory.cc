...
std::shared_ptr<TraceServiceStub> CreateDefaultTraceServiceStub(
  ...
  auto endpoint = internal::DetermineServiceEndpoint(
      internal::GetEnv("GOOGLE_CLOUD_CPP_TRACE_SERVICE_ENDPOINT"),
      std::move(endpoint_option), "cloudtrace.googleapis.com", options);
  ...
  if (!endpoint.ok()) {
    ...
    auto service_grpc_stub =
        google::devtools::cloudtrace::v1::TraceService::NewStub(channel);
    stub =
