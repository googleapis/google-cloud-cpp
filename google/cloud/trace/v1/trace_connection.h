...
/**
 * A retry policy for `TraceServiceConnection` that stops retrying after a
...
class TraceServiceLimitedErrorCountRetryPolicy
 ...
 public:
  TraceServiceLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `TraceServiceConnection` that stops retrying after
