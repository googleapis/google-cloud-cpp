...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_TRACE_V1_TRACE_CONNECTION_IDEMPOTENCY_POLICY_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_TRACE_V1_TRACE_CONNECTION_IDEMPOTENCY_POLICY_H
...
class TraceServiceConnectionIdempotencyPolicy {
 public:
  ...
  virtual google::cloud::Idempotency ListTraces(
      google::devtools::cloudtrace::v1::ListTracesRequest request);

  virtual google::cloud::Idempotency GetTrace(
      google::devtools::cloudtrace::v1::GetTraceRequest const& request);

  virtual google::cloud::Idempotency PatchTraces(
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_TRACE_V1_TRACE_CONNECTION_IDEMPOTENCY_POLICY_H
