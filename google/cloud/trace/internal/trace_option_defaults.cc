...
Options TraceServiceDefaultOptions(Options options) {
  ...
  if (!options.has<GOOGLE_CLOUD_CPP_NS::TraceServiceRetryPolicyOption>()) {
    options.set<GOOGLE_CLOUD_CPP_NS::TraceServiceRetryPolicyOption>(
        GOOGLE_CLOUD_CPP_NS::TraceServiceLimitedTimeRetryPolicy(
            std::chrono::minutes(30))
            .clone());
  }
  if (!options.has<GOOGLE_CLOUD_CPP_NS::TraceServiceBackoffPolicyOption>()) {
    options.set<GOOGLE_CLOUD_CPP_NS::TraceServiceBackoffPolicyOption>(
  ...
  if (!options.has<GOOGLE_CLOUD_CPP_NS::
    ...
    options.set<
        GOOGLE_CLOUD_CPP_NS::TraceServiceConnectionIdempotencyPolicyOption>(
        GOOGLE_CLOUD_CPP_NS::
