...
This directory contains small examples showing how to use the Cloud Trace API
...
1. Install the dependencies with your favorite tools. As an example, if you use
   ...
   ```bash
   cd $HOME/vcpkg
   ./vcpkg install google-cloud-cpp[core,trace]
   ```
...
[quickstart-link]: https://cloud.google.com/trace/docs/quickstart
