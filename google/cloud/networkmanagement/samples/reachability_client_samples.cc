...
// main-dox-marker: GOOGLE_CLOUD_CPP_NS::ReachabilityServiceClient
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::GOOGLE_CLOUD_CPP_NS::ReachabilityServiceClient(
      google::cloud::GOOGLE_CLOUD_CPP_NS::MakeReachabilityServiceConnection(
          options));
  //! [set-client-endpoint]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::GOOGLE_CLOUD_CPP_NS::ReachabilityServiceClient(
        google::cloud::GOOGLE_CLOUD_CPP_NS::MakeReachabilityServiceConnection(
            options));
  }
  //! [with-service-account]
