# HOWTO: using the Network Management API C++ client in your project

This directory contains small examples showing how to use the Network Management API C++
...
Like most Google Cloud Platform (GCP) services, Network Management API requires that
...
2. Install the dependencies with your favorite tools. As an example, if you use
   ...
   ```bash
   cd $HOME/vcpkg
   ./vcpkg install google-cloud-cpp[core,networkmanagement]
   ```
...
3. Configure CMake, if necessary, configure the directory where you installed
   ...
   ```bash
   cd $HOME/gooogle-cloud-cpp/google/cloud/networkmanagement/quickstart
...
[quickstart-link]: https://cloud.google.com/network-intelligence-center/docs/connectivity-tests/how-to/running-connectivity-tests
