 ...
 * behavior (e.g., with a Google Mock object) in a `ReachabilityServiceClient`
...
/**
 * A factory function to construct a `ReachabilityServiceConnection` object.
 *
 * The returned connection object should not be used directly; instead it
 * should be given to a `ReachabilityServiceClient` instance, and methods should
 * be invoked on `ReachabilityServiceClient`.
 *
