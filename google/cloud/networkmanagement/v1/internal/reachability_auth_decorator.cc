...
StatusOr<google::cloud::networkmanagement::v1::ListConnectivityTestsResponse> ReachabilityServiceAuth::ListConnectivityTests(
...
StatusOr<google::cloud::networkmanagement::v1::ConnectivityTest> ReachabilityServiceAuth::GetConnectivityTest(
    grpc::ClientContext& context,
    Options const& options,
...
ReachabilityServiceAuth::AsyncCreateConnectivityTest(
  ...
  return auth_->AsyncConfigureContext(std::move(context)).then(
      [cq, child = child_, options = std::move(options), request](
        ...
        return child->AsyncCreateConnectivityTest(
...
ReachabilityServiceAuth::AsyncUpdateConnectivityTest(
  ...
  return auth_->AsyncConfigureContext(std::move(context)).then(
      [cq, child = child_, options = std::move(options), request](
        ...
        return child->AsyncUpdateConnectivityTest(
            cq, *std::move(context), std::move(options), request);
      });
}
...
ReachabilityServiceAuth::AsyncRerunConnectivityTest(
  ...
  return auth_->AsyncConfigureContext(std::move(context)).then(
      [cq, child = child_, options = std::move(options), request](
        ...
        return child->AsyncRerunConnectivityTest(
            cq, *std::move(context), std::move(options), request);
      });
}
...
ReachabilityServiceAuth::AsyncDeleteConnectivityTest(
  ...
  return auth_->AsyncConfigureContext(std::move(context)).then(
      [cq, child = child_, options = std::move(options), request](
        ...
        return child->AsyncDeleteConnectivityTest(
            cq, *std::move(context), std::move(options), request);
      });
}
...
StatusOr<google::cloud::location::ListLocationsResponse> ReachabilityServiceAuth::ListLocations(
    grpc::ClientContext& context,
    Options const& options,
...
StatusOr<google::cloud::location::Location> ReachabilityServiceAuth::GetLocation(
    grpc::ClientContext& context,
    Options const& options,
...
StatusOr<google::iam::v1::Policy> ReachabilityServiceAuth::SetIamPolicy(
    grpc::ClientContext& context,
    Options const& options,
...
StatusOr<google::iam::v1::Policy> ReachabilityServiceAuth::GetIamPolicy(
    grpc::ClientContext& context,
    Options const& options,
...
StatusOr<google::iam::v1::TestIamPermissionsResponse> ReachabilityServiceAuth::TestIamPermissions(
    grpc::ClientContext& context,
    Options const& options,
...
StatusOr<google::longrunning::ListOperationsResponse> ReachabilityServiceAuth::ListOperations(
    grpc::ClientContext& context,
    Options const& options,
...
StatusOr<google::longrunning::Operation> ReachabilityServiceAuth::GetOperation(
    grpc::ClientContext& context,
    Options const& options,
...
Status ReachabilityServiceAuth::DeleteOperation(
    grpc::ClientContext& context,
    Options const& options,
...
Status ReachabilityServiceAuth::CancelOperation(
    grpc::ClientContext& context,
    Options const& options,
