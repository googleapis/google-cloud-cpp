...
ReachabilityServiceMetadata::AsyncCreateConnectivityTest(
  ...
  SetMetadata(*context, *options, absl::StrCat("parent=", internal::UrlEncode(request.parent())));
  return child_->AsyncCreateConnectivityTest(
...
ReachabilityServiceMetadata::AsyncUpdateConnectivityTest(
  ...
  SetMetadata(*context, *options, absl::StrCat("resource.name=", internal::UrlEncode(request.resource().name())));
  return child_->AsyncUpdateConnectivityTest(
      cq, std::move(context), std::move(options), request);
}
...
ReachabilityServiceMetadata::AsyncRerunConnectivityTest(
  ...
  SetMetadata(*context, *options, absl::StrCat("name=", internal::UrlEncode(request.name())));
  return child_->AsyncRerunConnectivityTest(
      cq, std::move(context), std::move(options), request);
}
...
ReachabilityServiceMetadata::AsyncDeleteConnectivityTest(
  ...
  SetMetadata(*context, *options, absl::StrCat("name=", internal::UrlEncode(request.name())));
  return child_->AsyncDeleteConnectivityTest(
      cq, std::move(context), std::move(options), request);
}
...
ReachabilityServiceMetadata::SetIamPolicy(
    grpc::ClientContext& context,
    Options const& options,
...
StatusOr<google::iam::v1::Policy>
ReachabilityServiceMetadata::GetIamPolicy(
    grpc::ClientContext& context,
    Options const& options,
...
Status
ReachabilityServiceMetadata::DeleteOperation(
    grpc::ClientContext& context,
    Options const& options,
...
Status
ReachabilityServiceMetadata::CancelOperation(
    grpc::ClientContext& context,
    Options const& options,
