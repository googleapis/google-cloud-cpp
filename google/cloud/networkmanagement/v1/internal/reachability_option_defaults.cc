...
Options ReachabilityServiceDefaultOptions(Options options) {
  ...
  if (!options.has<networkmanagement_v1::ReachabilityServiceRetryPolicyOption>()) {
  ...
  if (!options.has<networkmanagement_v1::ReachabilityServiceBackoffPolicyOption>()) {
    options.set<networkmanagement_v1::ReachabilityServiceBackoffPolicyOption>(
        ExponentialBackoffPolicy(std::chrono::seconds(0), std::chrono::seconds(1),
            std::chrono::minutes(5), kBackoffScaling, kBackoffScaling).clone());
  }
  if (!options.has<networkmanagement_v1::ReachabilityServicePollingPolicyOption>()) {
  ...
  if (!options.has<networkmanagement_v1::ReachabilityServiceConnectionIdempotencyPolicyOption>()) {
    options.set<networkmanagement_v1::ReachabilityServiceConnectionIdempotencyPolicyOption>(
