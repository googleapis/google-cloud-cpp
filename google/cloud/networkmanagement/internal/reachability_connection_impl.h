...
class ReachabilityServiceConnectionImpl
 ...
 private:
  std::unique_ptr<networkmanagement::ReachabilityServiceRetryPolicy> retry_policy() {
    auto const& options = internal::CurrentOptions();
    if (options.has<networkmanagement::ReachabilityServiceRetryPolicyOption>()) {
      return options.get<networkmanagement::ReachabilityServiceRetryPolicyOption>()->clone();
    }
  ...
  std::unique_ptr<BackoffPolicy> backoff_policy() {
    auto const& options = internal::CurrentOptions();
    if (options.has<networkmanagement::ReachabilityServiceBackoffPolicyOption>()) {
      return options.get<networkmanagement::ReachabilityServiceBackoffPolicyOption>()->clone();
    }
    return backoff_policy_prototype_->clone();
  }

  std::unique_ptr<networkmanagement::ReachabilityServiceConnectionIdempotencyPolicy> idempotency_policy() {
    auto const& options = internal::CurrentOptions();
    if (options.has<networkmanagement::ReachabilityServiceConnectionIdempotencyPolicyOption>()) {
      return options.get<networkmanagement::ReachabilityServiceConnectionIdempotencyPolicyOption>()->clone();
    }
  ...
  std::unique_ptr<networkmanagement::ReachabilityServiceRetryPolicy const> retry_policy_prototype_;
  std::unique_ptr<BackoffPolicy const> backoff_policy_prototype_;
  std::unique_ptr<networkmanagement::ReachabilityServiceConnectionIdempotencyPolicy> idempotency_policy_;

  std::unique_ptr<PollingPolicy> polling_policy() {
    auto const& options = internal::CurrentOptions();
    if (options.has<networkmanagement::ReachabilityServicePollingPolicyOption>()) {
      return options.get<networkmanagement::ReachabilityServicePollingPolicyOption>()->clone();
    }
