...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_RESOURCEMANAGER_MOCKS_MOCK_FOLDERS_CONNECTION_H
 ...
 * including errors from a `FoldersClient`. To do so, construct a
 * `FoldersClient` with an instance of this class. Then use the Google
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_RESOURCEMANAGER_MOCKS_MOCK_FOLDERS_CONNECTION_H
