...
StreamRange<google::cloud::resourcemanager::v3::Organization> OrganizationsConnection::SearchOrganizations(
  ...
  return google::cloud::internal::MakePaginationRange<StreamRange<
    ...
    [](google::cloud::resourcemanager::v3::SearchOrganizationsRequest const&) {
      return StatusOr<google::cloud::resourcemanager::v3::SearchOrganizationsResponse>{};
    },
    [](google::cloud::resourcemanager::v3::SearchOrganizationsResponse const&) {
 ...
 public:
  OrganizationsConnectionImpl(
      ...
      : background_(std::move(background)), stub_(std::move(stub)),
        retry_policy_prototype_(options.get<OrganizationsRetryPolicyOption>()->clone()),
        backoff_policy_prototype_(options.get<OrganizationsBackoffPolicyOption>()->clone()),
        idempotency_policy_(options.get<OrganizationsConnectionIdempotencyPolicyOption>()->clone()) {}
  ...
  StreamRange<google::cloud::resourcemanager::v3::Organization> SearchOrganizations(
      google::cloud::resourcemanager::v3::SearchOrganizationsRequest request) override {
    request.clear_page_token();
    auto stub = stub_;
    auto retry =
        std::shared_ptr<OrganizationsRetryPolicy const>(retry_policy_prototype_->clone());
...
std::shared_ptr<OrganizationsConnection> MakeOrganizationsConnection(
  ...
  options = resourcemanager_internal::OrganizationsDefaultOptions(
      std::move(options));
...
MakeOrganizationsConnection(
    std::shared_ptr<OrganizationsStub> stub, Options options) {
