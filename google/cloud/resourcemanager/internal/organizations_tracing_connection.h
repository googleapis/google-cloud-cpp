...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_RESOURCEMANAGER_INTERNAL_ORGANIZATIONS_TRACING_CONNECTION_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_RESOURCEMANAGER_INTERNAL_ORGANIZATIONS_TRACING_CONNECTION_H
...
class OrganizationsTracingConnection
 ...
 public:
  ...
  explicit OrganizationsTracingConnection(
      std::shared_ptr<resourcemanager::OrganizationsConnection> child);
 ...
 private:
  std::shared_ptr<resourcemanager::OrganizationsConnection> child_;
};
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_RESOURCEMANAGER_INTERNAL_ORGANIZATIONS_TRACING_CONNECTION_H
