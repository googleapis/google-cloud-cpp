...
DefaultFoldersStub::GetFolder(
  ...
  google::cloud::resourcemanager::v3::GetFolderRequest const& request) {
    ...
    auto status =
        grpc_stub_->GetFolder(&client_context, request, &response);
    if (!status.ok()) {
...
DefaultFoldersStub::ListFolders(
  ...
  google::cloud::resourcemanager::v3::ListFoldersRequest const& request) {
    ...
    auto status =
        grpc_stub_->ListFolders(&client_context, request, &response);
    if (!status.ok()) {
      return google::cloud::MakeStatusFromRpcError(status);
    }
    return response;
...
DefaultFoldersStub::SearchFolders(
  ...
  google::cloud::resourcemanager::v3::SearchFoldersRequest const& request) {
    ...
    auto status =
        grpc_stub_->SearchFolders(&client_context, request, &response);
    if (!status.ok()) {
      return google::cloud::MakeStatusFromRpcError(status);
    }
    return response;
