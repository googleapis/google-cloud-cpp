...
This directory contains small examples showing how to use the Cloud Resource Manager API C++
...
2. Install the dependencies with your favorite tools. As an example, if you use
   ...
   ```bash
   cd $HOME/vcpkg
   ./vcpkg install google-cloud-cpp[core,resourcemanager]
   ```
...
3. Configure CMake, if necessary, configure the directory where you installed
   ...
   ```bash
   cd $HOME/gooogle-cloud-cpp/google/cloud/resourcemanager/quickstart
...
[quickstart-link]: https://cloud.google.com/resourcemanager/docs/quickstart
