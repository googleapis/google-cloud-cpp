...
class TagBindingsRetryPolicy : public ::google::cloud::RetryPolicy {
 public:
  /// Creates a new instance of the policy, reset to the initial state.
  virtual std::unique_ptr<TagBindingsRetryPolicy> clone() const = 0;
};
 ...
 */
class TagBindingsLimitedErrorCountRetryPolicy : public TagBindingsRetryPolicy {
 public:
  /**
  ...
  std::unique_ptr<TagBindingsRetryPolicy> clone() const override {
    return std::make_unique<TagBindingsLimitedErrorCountRetryPolicy>(
        maximum_failures());
  }
 ...
 * - [`kUnavailable`](@ref google::cloud::StatusCode)
 */
class TagBindingsLimitedTimeRetryPolicy : public TagBindingsRetryPolicy {
 public:
  /**
  ...
  std::unique_ptr<TagBindingsRetryPolicy> clone() const override {
    return std::make_unique<TagBindingsLimitedTimeRetryPolicy>(
        maximum_duration());
  }
 ...
 * sets in `TagBindingsClient`. This allows users to inject custom behavior
 * (e.g., with a Google Mock object) when writing tests that use objects of type
 * `TagBindingsClient`.
 *
 * To create a concrete instance, see `MakeTagBindingsConnection()`.
 *
 * For mocking, see `resourcemanager_v3_mocks::MockTagBindingsConnection`.
 */
class TagBindingsConnection {
 public:
  virtual ~TagBindingsConnection() = 0;
 ...
 * should be passed as an argument to the constructor of TagBindingsClient.
 *
 * The optional @p options argument may be used to configure aspects of the
 * returned `TagBindingsConnection`. Expected options are any of the types in
 * the following option lists:
 *
 * - `google::cloud::CommonOptionList`
 * - `google::cloud::GrpcOptionList`
 * - `google::cloud::UnifiedCredentialsOptionList`
 * - `google::cloud::resourcemanager_v3::TagBindingsPolicyOptionList`
 *
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_RESOURCEMANAGER_V3_TAG_BINDINGS_CONNECTION_H
