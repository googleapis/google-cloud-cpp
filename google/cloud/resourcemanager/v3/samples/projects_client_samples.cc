...
// clang-format off
// main-dox-marker: resourcemanager_v3::ProjectsClient
// lro-marker: true
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::resourcemanager_v3::ProjectsClient(
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::resourcemanager_v3::ProjectsClient(
      google::cloud::resourcemanager_v3::MakeProjectsConnection(*ud_options));
  //! [set-client-universe-domain]
}
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto c2 = google::cloud::resourcemanager_v3::ProjectsClient(connection);
  ...
  //     .set<google::cloud::resourcemanager_v3::ProjectsRetryPolicyOption>(
  //       google::cloud::resourcemanager_v3::ProjectsLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
