...
// clang-format off
// main-dox-marker: resourcemanager_v3::TagHoldsClient
// lro-marker: true
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::resourcemanager_v3::TagHoldsClient(
      google::cloud::resourcemanager_v3::MakeTagHoldsConnection("europe-central2"));

  // This configuration is common with Private Google Access:
  //     https://cloud.google.com/vpc/docs/private-google-access
  auto options = google::cloud::Options{}.set<google::cloud::EndpointOption>(
      "private.googleapis.com");
  auto vpc_client = google::cloud::resourcemanager_v3::TagHoldsClient(
      google::cloud::resourcemanager_v3::MakeTagHoldsConnection(options));
  //! [set-client-endpoint]
}

//! [custom-idempotency-policy]
class CustomIdempotencyPolicy
   : public google::cloud::resourcemanager_v3::TagHoldsConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::resourcemanager_v3::TagHoldsConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::resourcemanager_v3::TagHoldsConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::resourcemanager_v3::TagHoldsRetryPolicyOption>(
      google::cloud::resourcemanager_v3::TagHoldsLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::resourcemanager_v3::TagHoldsBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::resourcemanager_v3::MakeTagHoldsConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::resourcemanager_v3::TagHoldsClient(connection);
  auto c2 = google::cloud::resourcemanager_v3::TagHoldsClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::resourcemanager_v3::TagHoldsClient(
    connection, google::cloud::Options{}.set<google::cloud::resourcemanager_v3::TagHoldsRetryPolicyOption>(
      google::cloud::resourcemanager_v3::TagHoldsLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::resourcemanager_v3::TagHoldsRetryPolicyOption>(
  //       google::cloud::resourcemanager_v3::TagHoldsLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::resourcemanager_v3::TagHoldsPollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::resourcemanager_v3::TagHoldsRetryPolicyOption::Type,
            google::cloud::resourcemanager_v3::TagHoldsBackoffPolicyOption::Type>(
            google::cloud::resourcemanager_v3::TagHoldsLimitedTimeRetryPolicy(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::resourcemanager_v3::TagHoldsClient(
      google::cloud::resourcemanager_v3::MakeTagHoldsConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
