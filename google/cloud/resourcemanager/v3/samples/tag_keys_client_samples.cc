...
// clang-format off
// main-dox-marker: resourcemanager_v3::TagKeysClient
// lro-marker: true
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::resourcemanager_v3::TagKeysClient(
      google::cloud::resourcemanager_v3::MakeTagKeysConnection("europe-central2"));

  // This configuration is common with Private Google Access:
  //     https://cloud.google.com/vpc/docs/private-google-access
  auto options = google::cloud::Options{}.set<google::cloud::EndpointOption>(
      "private.googleapis.com");
  auto vpc_client = google::cloud::resourcemanager_v3::TagKeysClient(
      google::cloud::resourcemanager_v3::MakeTagKeysConnection(options));
  //! [set-client-endpoint]
}

//! [custom-idempotency-policy]
class CustomIdempotencyPolicy
   : public google::cloud::resourcemanager_v3::TagKeysConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::resourcemanager_v3::TagKeysConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::resourcemanager_v3::TagKeysConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::resourcemanager_v3::TagKeysRetryPolicyOption>(
      google::cloud::resourcemanager_v3::TagKeysLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::resourcemanager_v3::TagKeysBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::resourcemanager_v3::MakeTagKeysConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::resourcemanager_v3::TagKeysClient(connection);
  auto c2 = google::cloud::resourcemanager_v3::TagKeysClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::resourcemanager_v3::TagKeysClient(
    connection, google::cloud::Options{}.set<google::cloud::resourcemanager_v3::TagKeysRetryPolicyOption>(
      google::cloud::resourcemanager_v3::TagKeysLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::resourcemanager_v3::TagKeysRetryPolicyOption>(
  //       google::cloud::resourcemanager_v3::TagKeysLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::resourcemanager_v3::TagKeysPollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::resourcemanager_v3::TagKeysRetryPolicyOption::Type,
            google::cloud::resourcemanager_v3::TagKeysBackoffPolicyOption::Type>(
            google::cloud::resourcemanager_v3::TagKeysLimitedTimeRetryPolicy(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::resourcemanager_v3::TagKeysClient(
      google::cloud::resourcemanager_v3::MakeTagKeysConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
