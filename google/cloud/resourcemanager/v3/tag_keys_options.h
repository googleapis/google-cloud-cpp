 ...
 */
struct TagKeysRetryPolicyOption {
  using Type = std::shared_ptr<TagKeysRetryPolicy>;
};
 ...
 * @ingroup google-cloud-resourcemanager-options
 */
struct TagKeysBackoffPolicyOption {
 ...
 * @ingroup google-cloud-resourcemanager-options
 */
struct TagKeysConnectionIdempotencyPolicyOption {
  using Type = std::shared_ptr<TagKeysConnectionIdempotencyPolicy>;
};
 ...
 * @ingroup google-cloud-resourcemanager-options
 */
struct TagKeysPollingPolicyOption {
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_RESOURCEMANAGER_V3_TAG_KEYS_OPTIONS_H
