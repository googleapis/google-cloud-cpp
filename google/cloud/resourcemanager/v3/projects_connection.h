...
/**
 * A retry policy for `ProjectsConnection` that stops retrying after a
...
class ProjectsLimitedErrorCountRetryPolicy : public ProjectsRetryPolicy {
 public:
  ProjectsLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `ProjectsConnection` that stops retrying after
