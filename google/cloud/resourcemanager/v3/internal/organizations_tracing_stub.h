...
class OrganizationsTracingStub : public OrganizationsStub {
 public:
  ~OrganizationsTracingStub() override = default;
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_RESOURCEMANAGER_V3_INTERNAL_ORGANIZATIONS_TRACING_STUB_H
