...
class TagBindingsTracingStub : public TagBindingsStub {
 public:
  ~TagBindingsTracingStub() override = default;
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_RESOURCEMANAGER_V3_INTERNAL_TAG_BINDINGS_TRACING_STUB_H
