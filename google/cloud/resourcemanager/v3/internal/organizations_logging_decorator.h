...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_RESOURCEMANAGER_V3_INTERNAL_ORGANIZATIONS_LOGGING_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_RESOURCEMANAGER_V3_INTERNAL_ORGANIZATIONS_LOGGING_DECORATOR_H
...
class OrganizationsLogging : public OrganizationsStub {
 public:
  ~OrganizationsLogging() override = default;
  OrganizationsLogging(std::shared_ptr<OrganizationsStub> child,
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_RESOURCEMANAGER_V3_INTERNAL_ORGANIZATIONS_LOGGING_DECORATOR_H
