...
TagHoldsTracingStub::TagHoldsTracingStub(
...
TagHoldsTracingStub::AsyncCreateTagHold(
  ...
  auto span = internal::MakeSpanGrpc("google.cloud.resourcemanager.v3.TagHolds", "CreateTagHold");
  internal::OTelScope scope(span);
  internal::InjectTraceContext(*context, *propagator_);
  auto f = child_->AsyncCreateTagHold(cq, context, std::move(options), request);
  return internal::EndSpan(std::move(context), std::move(span), std::move(f));
}

StatusOr<google::longrunning::Operation>
TagHoldsTracingStub::CreateTagHold(
...
TagHoldsTracingStub::AsyncDeleteTagHold(
  ...
  auto span = internal::MakeSpanGrpc("google.cloud.resourcemanager.v3.TagHolds", "DeleteTagHold");
  internal::OTelScope scope(span);
  internal::InjectTraceContext(*context, *propagator_);
...
StatusOr<google::longrunning::Operation>
TagHoldsTracingStub::DeleteTagHold(
      grpc::ClientContext& context,
      Options options,
      google::cloud::resourcemanager::v3::DeleteTagHoldRequest const& request) {
  auto span = internal::MakeSpanGrpc("google.cloud.resourcemanager.v3.TagHolds", "DeleteTagHold");
...
StatusOr<google::cloud::resourcemanager::v3::ListTagHoldsResponse> TagHoldsTracingStub::ListTagHolds(
    grpc::ClientContext& context,
    Options const& options,
    google::cloud::resourcemanager::v3::ListTagHoldsRequest const& request) {
  auto span = internal::MakeSpanGrpc("google.cloud.resourcemanager.v3.TagHolds", "ListTagHolds");
  auto scope = opentelemetry::trace::Scope(span);
  internal::InjectTraceContext(context, *propagator_);
  return internal::EndSpan(context, *span,
...
StatusOr<google::longrunning::Operation> TagHoldsTracingStub::GetOperation(
  ...
  auto span = internal::MakeSpanGrpc("google.cloud.resourcemanager.v3.TagHolds", "GetOperation");
  auto scope = opentelemetry::trace::Scope(span);
  internal::InjectTraceContext(context, *propagator_);
  return internal::EndSpan(context, *span,
