...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_RESOURCEMANAGER_V3_INTERNAL_TAG_HOLDS_AUTH_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_RESOURCEMANAGER_V3_INTERNAL_TAG_HOLDS_AUTH_DECORATOR_H
...
class TagHoldsAuth : public TagHoldsStub {
 public:
  ~TagHoldsAuth() override = default;
  TagHoldsAuth(
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_RESOURCEMANAGER_V3_INTERNAL_TAG_HOLDS_AUTH_DECORATOR_H
