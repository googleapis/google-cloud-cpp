...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_RESOURCEMANAGER_V3_TAG_KEYS_CONNECTION_IDEMPOTENCY_POLICY_H
...
class TagKeysConnectionIdempotencyPolicy {
 public:
  virtual ~TagKeysConnectionIdempotencyPolicy();
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_RESOURCEMANAGER_V3_TAG_KEYS_CONNECTION_IDEMPOTENCY_POLICY_H
