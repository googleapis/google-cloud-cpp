...
std::shared_ptr<SecurityCenterStub> CreateDefaultSecurityCenterStub(
  ...
  auto endpoint = internal::DetermineServiceEndpoint(
      internal::GetEnv("GOOGLE_CLOUD_CPP_SECURITY_CENTER_ENDPOINT"),
      std::move(endpoint_option), "securitycenter.googleapis.com", options);
  ...
  if (!endpoint.ok()) {
    ...
    auto service_grpc_stub =
        google::cloud::securitycenter::v1::SecurityCenter::NewStub(channel);
    stub = std::make_shared<DefaultSecurityCenterStub>(
