...
/**
 * A retry policy for `SecurityCenterConnection` that stops retrying after a
...
class SecurityCenterLimitedErrorCountRetryPolicy
 ...
 public:
  SecurityCenterLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `SecurityCenterConnection` that stops retrying after
