...
// main-dox-marker: GOOGLE_CLOUD_CPP_NS::SecurityCenterClient
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::GOOGLE_CLOUD_CPP_NS::SecurityCenterClient(
      google::cloud::GOOGLE_CLOUD_CPP_NS::MakeSecurityCenterConnection(
          options));
  //! [set-client-endpoint]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::GOOGLE_CLOUD_CPP_NS::SecurityCenterClient(
        google::cloud::GOOGLE_CLOUD_CPP_NS::MakeSecurityCenterConnection(
            options));
  }
  //! [with-service-account]
