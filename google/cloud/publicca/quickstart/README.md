# HOWTO: using the Public Certificate Authority API C++ client in your project

This directory contains small examples showing how to use the Public Certificate
Authority API C++ client library in your own project. These instructions assume
...
1. Compile this example using Bazel:
   ...
   ```bash
   cd $HOME/google-cloud-cpp/google/cloud/publicca/quickstart
   bazel build ...
   ```
...
1. Install the dependencies with your favorite tools. As an example, if you use
   ...
   ```bash
   cd $HOME/vcpkg
   ./vcpkg install google-cloud-cpp[core,publicca]
   ```
...
[quickstart-link]: https://cloud.google.com/publicca/docs/quickstart
