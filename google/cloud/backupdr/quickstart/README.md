# HOWTO: using the Backup and DR Service API C++ client in your project

This directory contains small examples showing how to use the Backup and DR
Service API C++ client library in your own project. These instructions assume
...
1. Compile this example using Bazel:
   ...
   ```bash
   cd $HOME/google-cloud-cpp/google/cloud/backupdr/quickstart
   bazel build ...
   ```
...
1. Install the dependencies with your favorite tools. As an example, if you use
   ...
   ```bash
   cd $HOME/vcpkg
   ./vcpkg install google-cloud-cpp[core,backupdr]
   ```
...
[quickstart-link]: https://cloud.google.com/backup-disaster-recovery/docs/concepts/backup-dr
