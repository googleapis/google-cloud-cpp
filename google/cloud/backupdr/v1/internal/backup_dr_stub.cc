...
DefaultBackupDRStub::AsyncInitializeService(
  ...
  return internal::MakeUnaryRpcImpl<google::cloud::backupdr::v1::InitializeServiceRequest,
                                    google::longrunning::Operation>(
      cq,
      [this](grpc::ClientContext* context,
             google::cloud::backupdr::v1::InitializeServiceRequest const& request,
...
StatusOr<google::longrunning::Operation>
DefaultBackupDRStub::InitializeService(
      grpc::ClientContext& context,
      Options,
      google::cloud::backupdr::v1::InitializeServiceRequest const& request) {
    google::longrunning::Operation response;
    auto status =
        grpc_stub_->InitializeService(&context, request, &response);
    if (!status.ok()) {
      return google::cloud::MakeStatusFromRpcError(status);
    }
    return response;
