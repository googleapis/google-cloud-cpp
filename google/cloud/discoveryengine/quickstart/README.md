...
This directory contains small examples showing how to use the Discovery Engine API C++
...
[quickstart-link]: https://cloud.google.com/discoveryengine/docs/quickstart
