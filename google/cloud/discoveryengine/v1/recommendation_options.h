 ...
 */
struct RecommendationServiceRetryPolicyOption {
  using Type = std::shared_ptr<RecommendationServiceRetryPolicy>;
};
 ...
 * @ingroup google-cloud-discoveryengine-options
 */
struct RecommendationServiceBackoffPolicyOption {
...
/**
 * The options applicable to RecommendationService.
 *
 * @ingroup google-cloud-discoveryengine-options
 */
using RecommendationServicePolicyOptionList =
    OptionList<RecommendationServiceRetryPolicyOption,
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DISCOVERYENGINE_V1_RECOMMENDATION_OPTIONS_H
