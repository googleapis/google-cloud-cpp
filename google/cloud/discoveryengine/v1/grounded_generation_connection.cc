...
GroundedGenerationServiceConnection::~GroundedGenerationServiceConnection() = default;
...
StreamRange<google::longrunning::Operation> GroundedGenerationServiceConnection::ListOperations(
...
Status
GroundedGenerationServiceConnection::CancelOperation(
...
std::shared_ptr<GroundedGenerationServiceConnection> MakeGroundedGenerationServiceConnection(
  ...
  internal::CheckExpectedOptions<CommonOptionList, GrpcOptionList,
      ...
      GroundedGenerationServicePolicyOptionList>(options, __func__);
  options = discoveryengine_v1_internal::GroundedGenerationServiceDefaultOptions(
      std::move(options));
  auto background = internal::MakeBackgroundThreadsFactory(options)();
  auto auth = internal::CreateAuthenticationStrategy(background->cq(), options);
  auto stub = discoveryengine_v1_internal::CreateDefaultGroundedGenerationServiceStub(
    std::move(auth), options);
  return discoveryengine_v1_internal::MakeGroundedGenerationServiceTracingConnection(
      std::make_shared<discoveryengine_v1_internal::GroundedGenerationServiceConnectionImpl>(
