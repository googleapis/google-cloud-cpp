...
class GroundedGenerationServiceLimitedTimeRetryPolicy : public GroundedGenerationServiceRetryPolicy {
 public:
  ...
  std::unique_ptr<GroundedGenerationServiceRetryPolicy> clone() const override {
    return std::make_unique<GroundedGenerationServiceLimitedTimeRetryPolicy>(
        maximum_duration());
  }
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DISCOVERYENGINE_V1_GROUNDED_GENERATION_CONNECTION_H
