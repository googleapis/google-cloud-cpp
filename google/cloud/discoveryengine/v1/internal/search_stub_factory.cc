...
#include "google/cloud/discoveryengine/v1/internal/search_auth_decorator.h"
#include "google/cloud/discoveryengine/v1/internal/search_logging_decorator.h"
#include "google/cloud/discoveryengine/v1/internal/search_metadata_decorator.h"
...
std::shared_ptr<SearchServiceStub> CreateDefaultSearchServiceStub(
  ...
  auto endpoint = internal::DetermineServiceEndpoint(
      internal::GetEnv("GOOGLE_CLOUD_CPP_SEARCH_SERVICE_ENDPOINT"),
      std::move(endpoint_option), "discoveryengine.googleapis.com", options);
  ...
  if (!endpoint.ok()) {
    ...
    auto service_grpc_stub =
        google::cloud::discoveryengine::v1::SearchService::NewStub(channel);
    stub = std::make_shared<DefaultSearchServiceStub>(
  ...
  if (internal::TracingEnabled(options)) {
    stub = MakeSearchServiceTracingStub(std::move(stub));
  }
  return stub;
}
