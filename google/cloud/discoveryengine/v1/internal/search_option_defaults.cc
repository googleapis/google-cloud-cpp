...
Options SearchServiceDefaultOptions(Options options) {
  ...
  if (!options.has<discoveryengine_v1::SearchServiceConnectionIdempotencyPolicyOption>()) {
    options.set<discoveryengine_v1::SearchServiceConnectionIdempotencyPolicyOption>(
        discoveryengine_v1::MakeDefaultSearchServiceConnectionIdempotencyPolicy());
  }
