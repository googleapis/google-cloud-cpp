...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DISCOVERYENGINE_V1_INTERNAL_ENGINE_TRACING_STUB_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DISCOVERYENGINE_V1_INTERNAL_ENGINE_TRACING_STUB_H
...
class EngineServiceTracingStub : public EngineServiceStub {
 public:
  ~EngineServiceTracingStub() override = default;

  explicit EngineServiceTracingStub(std::shared_ptr<EngineServiceStub> child);
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DISCOVERYENGINE_V1_INTERNAL_ENGINE_TRACING_STUB_H
