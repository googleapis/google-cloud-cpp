...
class SearchServiceStub {
 public:
  ...
  virtual StatusOr<google::cloud::discoveryengine::v1::SearchResponse> SearchLite(
      grpc::ClientContext& context,
      Options const& options,
      google::cloud::discoveryengine::v1::SearchRequest const& request) = 0;
...
class DefaultSearchServiceStub : public SearchServiceStub {
 public:
  explicit DefaultSearchServiceStub(
      std::unique_ptr<google::cloud::discoveryengine::v1::SearchService::StubInterface> grpc_stub,
 ...
 private:
  std::unique_ptr<google::cloud::discoveryengine::v1::SearchService::StubInterface> grpc_stub_;
