...
ProjectServiceAuth::ProjectServiceAuth(
    std::shared_ptr<google::cloud::internal::GrpcAuthenticationStrategy> auth,
    std::shared_ptr<ProjectServiceStub> child)
    : auth_(std::move(auth)), child_(std::move(child)) {}

future<StatusOr<google::longrunning::Operation>>
ProjectServiceAuth::AsyncProvisionProject(
  ...
  return auth_->AsyncConfigureContext(std::move(context)).then(
      [cq, child = child_, options = std::move(options), request](
        ...
        return child->AsyncProvisionProject(
            cq, *std::move(context), std::move(options), request);
      });
}

StatusOr<google::longrunning::Operation>
ProjectServiceAuth::ProvisionProject(
...
StatusOr<google::longrunning::ListOperationsResponse> ProjectServiceAuth::ListOperations(
    grpc::ClientContext& context,
...
StatusOr<google::longrunning::Operation> ProjectServiceAuth::GetOperation(
    grpc::ClientContext& context,
    Options const& options,
...
Status ProjectServiceAuth::CancelOperation(
    grpc::ClientContext& context,
    Options const& options,
...
future<Status> ProjectServiceAuth::AsyncCancelOperation(
    google::cloud::CompletionQueue& cq,
    std::shared_ptr<grpc::ClientContext> context,
    google::cloud::internal::ImmutableOptions options,
    google::longrunning::CancelOperationRequest const& request) {
