...
Options DocumentServiceDefaultOptions(Options options) {
  ...
  if (!options.has<discoveryengine_v1::DocumentServicePollingPolicyOption>()) {
    options.set<discoveryengine_v1::DocumentServicePollingPolicyOption>(
        GenericPollingPolicy<
            ...
            options.get<discoveryengine_v1::DocumentServiceRetryPolicyOption>()
                ->clone(),
            options
                .get<discoveryengine_v1::DocumentServiceBackoffPolicyOption>()
                ->clone())
            .clone());
  }
  if (!options.has<discoveryengine_v1::
    ...
    options.set<
        discoveryengine_v1::DocumentServiceConnectionIdempotencyPolicyOption>(
        discoveryengine_v1::
