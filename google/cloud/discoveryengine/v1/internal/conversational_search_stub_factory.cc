...
CreateDefaultConversationalSearchServiceStub(google::cloud::CompletionQueue cq,
  ...
  if (!endpoint.ok()) {
    ...
    auto service_grpc_stub = google::cloud::discoveryengine::v1::
        ConversationalSearchService::NewStub(channel);
    stub = std::make_shared<DefaultConversationalSearchServiceStub>(
  ...
  if (internal::TracingEnabled(options)) {
    stub = MakeConversationalSearchServiceTracingStub(std::move(stub));
  }
  return stub;
}
