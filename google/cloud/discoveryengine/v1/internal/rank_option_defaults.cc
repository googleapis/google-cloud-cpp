...
Options RankServiceDefaultOptions(Options options) {
  ...
  if (!options.has<discoveryengine_v1::RankServiceConnectionIdempotencyPolicyOption>()) {
    options.set<discoveryengine_v1::RankServiceConnectionIdempotencyPolicyOption>(
        discoveryengine_v1::MakeDefaultRankServiceConnectionIdempotencyPolicy());
  }
