...
SchemaServiceAuth::AsyncCreateSchema(
  ...
  return auth_->AsyncConfigureContext(std::move(context))
      .then([cq, child = child_, options,
        ...
        return child->AsyncCreateSchema(cq, *std::move(context), options,
                                        request);
      });
}
...
SchemaServiceAuth::AsyncUpdateSchema(
  ...
  return auth_->AsyncConfigureContext(std::move(context))
      .then([cq, child = child_, options,
        ...
        return child->AsyncUpdateSchema(cq, *std::move(context), options,
                                        request);
      });
}
...
SchemaServiceAuth::AsyncDeleteSchema(
  ...
  return auth_->AsyncConfigureContext(std::move(context))
      .then([cq, child = child_, options,
        ...
        return child->AsyncDeleteSchema(cq, *std::move(context), options,
                                        request);
      });
}
