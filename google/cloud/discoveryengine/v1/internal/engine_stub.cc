...
DefaultEngineServiceStub::AsyncCreateEngine(
  ...
  return internal::MakeUnaryRpcImpl<google::cloud::discoveryengine::v1::CreateEngineRequest,
...
DefaultEngineServiceStub::CreateEngine(
      grpc::ClientContext& context,
      Options,
      google::cloud::discoveryengine::v1::CreateEngineRequest const& request) {
    google::longrunning::Operation response;
    auto status =
        grpc_stub_->CreateEngine(&context, request, &response);
    if (!status.ok()) {
...
DefaultEngineServiceStub::AsyncDeleteEngine(
  ...
  return internal::MakeUnaryRpcImpl<google::cloud::discoveryengine::v1::DeleteEngineRequest,
                                    google::longrunning::Operation>(
      cq,
      [this](grpc::ClientContext* context,
             google::cloud::discoveryengine::v1::DeleteEngineRequest const& request,
...
StatusOr<google::longrunning::Operation>
DefaultEngineServiceStub::DeleteEngine(
      grpc::ClientContext& context,
      Options,
      google::cloud::discoveryengine::v1::DeleteEngineRequest const& request) {
    google::longrunning::Operation response;
    auto status =
        grpc_stub_->DeleteEngine(&context, request, &response);
    if (!status.ok()) {
      return google::cloud::MakeStatusFromRpcError(status);
    }
    return response;
...
DefaultEngineServiceStub::UpdateEngine(
  ...
  google::cloud::discoveryengine::v1::UpdateEngineRequest const& request) {
    ...
    auto status =
        grpc_stub_->UpdateEngine(&context, request, &response);
    if (!status.ok()) {
      return google::cloud::MakeStatusFromRpcError(status);
    }
    return response;
...
DefaultEngineServiceStub::GetEngine(
  ...
  google::cloud::discoveryengine::v1::GetEngineRequest const& request) {
    google::cloud::discoveryengine::v1::Engine response;
    auto status =
        grpc_stub_->GetEngine(&context, request, &response);
    if (!status.ok()) {
      return google::cloud::MakeStatusFromRpcError(status);
    }
    return response;
...
DefaultEngineServiceStub::ListEngines(
  ...
  google::cloud::discoveryengine::v1::ListEnginesRequest const& request) {
    ...
    auto status =
        grpc_stub_->ListEngines(&context, request, &response);
    if (!status.ok()) {
      return google::cloud::MakeStatusFromRpcError(status);
    }
    return response;
...
StatusOr<google::longrunning::Operation>
DefaultEngineServiceStub::GetOperation(
  grpc::ClientContext& context, Options const&,
...
Status
DefaultEngineServiceStub::CancelOperation(
  grpc::ClientContext& context, Options const&,
