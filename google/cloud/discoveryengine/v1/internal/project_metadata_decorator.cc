...
ProjectServiceMetadata::ListOperations(
...
StatusOr<google::longrunning::Operation> ProjectServiceMetadata::GetOperation(
    grpc::ClientContext& context, Options const& options,
...
Status ProjectServiceMetadata::CancelOperation(
    grpc::ClientContext& context, Options const& options,
