...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DISCOVERYENGINE_V1_INTERNAL_SITE_SEARCH_ENGINE_TRACING_STUB_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DISCOVERYENGINE_V1_INTERNAL_SITE_SEARCH_ENGINE_TRACING_STUB_H
...
class SiteSearchEngineServiceTracingStub : public SiteSearchEngineServiceStub {
 public:
  ~SiteSearchEngineServiceTracingStub() override = default;

  explicit SiteSearchEngineServiceTracingStub(std::shared_ptr<SiteSearchEngineServiceStub> child);
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DISCOVERYENGINE_V1_INTERNAL_SITE_SEARCH_ENGINE_TRACING_STUB_H
