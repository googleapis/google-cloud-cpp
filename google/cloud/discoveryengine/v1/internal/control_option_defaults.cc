...
Options ControlServiceDefaultOptions(Options options) {
  ...
  if (!options.has<discoveryengine_v1::ControlServiceBackoffPolicyOption>()) {
    options.set<discoveryengine_v1::ControlServiceBackoffPolicyOption>(
        ExponentialBackoffPolicy(std::chrono::seconds(0), std::chrono::seconds(1),
            std::chrono::minutes(5), kBackoffScaling, kBackoffScaling).clone());
  }
  if (!options.has<discoveryengine_v1::ControlServiceConnectionIdempotencyPolicyOption>()) {
    options.set<discoveryengine_v1::ControlServiceConnectionIdempotencyPolicyOption>(
        discoveryengine_v1::MakeDefaultControlServiceConnectionIdempotencyPolicy());
  }
