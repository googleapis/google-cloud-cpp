...
class EngineServiceConnectionImpl
 ...
 private:
  ...
  std::shared_ptr<discoveryengine_v1_internal::EngineServiceStub> stub_;
  Options options_;
};
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DISCOVERYENGINE_V1_INTERNAL_ENGINE_CONNECTION_IMPL_H
