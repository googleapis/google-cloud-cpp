...
GroundedGenerationServiceAuth::GroundedGenerationServiceAuth(
...
GroundedGenerationServiceAuth::AsyncStreamGenerateGroundedContent(
  ...
  auto call = [child = child_, cq, options = std::move(options)](
    ...
    return child->AsyncStreamGenerateGroundedContent(cq, std::move(ctx), options);
  };
  return std::make_unique<StreamAuth>(
    std::move(context), auth_, StreamAuth::StreamFactory(std::move(call)));
}

StatusOr<google::cloud::discoveryengine::v1::GenerateGroundedContentResponse> GroundedGenerationServiceAuth::GenerateGroundedContent(
...
StatusOr<google::cloud::discoveryengine::v1::CheckGroundingResponse> GroundedGenerationServiceAuth::CheckGrounding(
    grpc::ClientContext& context,
    Options const& options,
...
StatusOr<google::longrunning::ListOperationsResponse> GroundedGenerationServiceAuth::ListOperations(
    grpc::ClientContext& context,
    Options const& options,
...
StatusOr<google::longrunning::Operation> GroundedGenerationServiceAuth::GetOperation(
    grpc::ClientContext& context,
    Options const& options,
...
Status GroundedGenerationServiceAuth::CancelOperation(
    grpc::ClientContext& context,
    Options const& options,
