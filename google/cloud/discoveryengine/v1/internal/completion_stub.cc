...
DefaultCompletionServiceStub::AsyncImportSuggestionDenyListEntries(
  ...
  return internal::MakeUnaryRpcImpl<google::cloud::discoveryengine::v1::ImportSuggestionDenyListEntriesRequest,
                                    google::longrunning::Operation>(
      cq,
      [this](grpc::ClientContext* context,
             google::cloud::discoveryengine::v1::ImportSuggestionDenyListEntriesRequest const& request,
             grpc::CompletionQueue* cq) {
        return grpc_stub_->AsyncImportSuggestionDenyListEntries(context, request, cq);
      },
...
DefaultCompletionServiceStub::AsyncPurgeSuggestionDenyListEntries(
  ...
  return internal::MakeUnaryRpcImpl<google::cloud::discoveryengine::v1::PurgeSuggestionDenyListEntriesRequest,
                                    google::longrunning::Operation>(
      cq,
      [this](grpc::ClientContext* context,
             google::cloud::discoveryengine::v1::PurgeSuggestionDenyListEntriesRequest const& request,
             grpc::CompletionQueue* cq) {
        return grpc_stub_->AsyncPurgeSuggestionDenyListEntries(context, request, cq);
      },
      request, std::move(context));
}
...
DefaultCompletionServiceStub::AsyncImportCompletionSuggestions(
  ...
  return internal::MakeUnaryRpcImpl<google::cloud::discoveryengine::v1::ImportCompletionSuggestionsRequest,
                                    google::longrunning::Operation>(
      cq,
      [this](grpc::ClientContext* context,
             google::cloud::discoveryengine::v1::ImportCompletionSuggestionsRequest const& request,
             grpc::CompletionQueue* cq) {
        return grpc_stub_->AsyncImportCompletionSuggestions(context, request, cq);
      },
      request, std::move(context));
}
...
DefaultCompletionServiceStub::AsyncPurgeCompletionSuggestions(
  ...
  return internal::MakeUnaryRpcImpl<google::cloud::discoveryengine::v1::PurgeCompletionSuggestionsRequest,
                                    google::longrunning::Operation>(
      cq,
      [this](grpc::ClientContext* context,
             google::cloud::discoveryengine::v1::PurgeCompletionSuggestionsRequest const& request,
             grpc::CompletionQueue* cq) {
        return grpc_stub_->AsyncPurgeCompletionSuggestions(context, request, cq);
      },
      request, std::move(context));
}
...
Status
DefaultCompletionServiceStub::CancelOperation(
  grpc::ClientContext& context, Options const&,
