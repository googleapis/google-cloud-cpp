...
class SchemaServiceConnectionImpl
 ...
 private:
  std::unique_ptr<discoveryengine_v1::SchemaServiceRetryPolicy> retry_policy() {
    ...
    return options_.get<discoveryengine_v1::SchemaServiceRetryPolicyOption>()
        ->clone();
  }
  ...
  std::unique_ptr<BackoffPolicy> backoff_policy() {
    ...
    if (options.has<discoveryengine_v1::SchemaServiceBackoffPolicyOption>()) {
      return options
          .get<discoveryengine_v1::SchemaServiceBackoffPolicyOption>()
          ->clone();
    }
    return options_.get<discoveryengine_v1::SchemaServiceBackoffPolicyOption>()
        ->clone();
  }
  ...
  std::unique_ptr<PollingPolicy> polling_policy() {
    auto const& options = internal::CurrentOptions();
    if (options.has<discoveryengine_v1::SchemaServicePollingPolicyOption>()) {
      return options
          .get<discoveryengine_v1::SchemaServicePollingPolicyOption>()
          ->clone();
    }
    return options_.get<discoveryengine_v1::SchemaServicePollingPolicyOption>()
        ->clone();
  }
