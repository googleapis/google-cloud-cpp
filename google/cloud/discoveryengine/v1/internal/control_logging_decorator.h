...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DISCOVERYENGINE_V1_INTERNAL_CONTROL_LOGGING_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DISCOVERYENGINE_V1_INTERNAL_CONTROL_LOGGING_DECORATOR_H
...
class ControlServiceLogging : public ControlServiceStub {
 public:
  ~ControlServiceLogging() override = default;
  ControlServiceLogging(std::shared_ptr<ControlServiceStub> child,
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DISCOVERYENGINE_V1_INTERNAL_CONTROL_LOGGING_DECORATOR_H
