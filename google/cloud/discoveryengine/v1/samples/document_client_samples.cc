...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::discoveryengine_v1::DocumentServiceClient(
...
class CustomIdempotencyPolicy
   : public google::cloud::discoveryengine_v1::DocumentServiceConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::discoveryengine_v1::DocumentServiceConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::discoveryengine_v1::DocumentServiceConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::discoveryengine_v1::DocumentServiceRetryPolicyOption>(
      google::cloud::discoveryengine_v1::DocumentServiceLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::discoveryengine_v1::DocumentServiceBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::discoveryengine_v1::MakeDocumentServiceConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::discoveryengine_v1::DocumentServiceClient(connection);
  auto c2 = google::cloud::discoveryengine_v1::DocumentServiceClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::discoveryengine_v1::DocumentServiceClient(
    connection, google::cloud::Options{}.set<google::cloud::discoveryengine_v1::DocumentServiceRetryPolicyOption>(
      google::cloud::discoveryengine_v1::DocumentServiceLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::discoveryengine_v1::DocumentServicePollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::discoveryengine_v1::DocumentServiceRetryPolicyOption::Type,
            google::cloud::discoveryengine_v1::DocumentServiceBackoffPolicyOption::Type>(
            google::cloud::discoveryengine_v1::DocumentServiceLimitedTimeRetryPolicy(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::discoveryengine_v1::DocumentServiceClient(
      google::cloud::discoveryengine_v1::MakeDocumentServiceConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
