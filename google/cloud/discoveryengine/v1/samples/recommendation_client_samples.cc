...
// clang-format off
// main-dox-marker: discoveryengine_v1::RecommendationServiceClient
// clang-format on
namespace {
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client =
      google::cloud::discoveryengine_v1::RecommendationServiceClient(
          google::cloud::discoveryengine_v1::
              MakeRecommendationServiceConnection(ud_options));
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  //       google::cloud::discoveryengine_v1::RecommendationServiceLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
