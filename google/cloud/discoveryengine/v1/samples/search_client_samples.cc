...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::discoveryengine_v1::SearchServiceClient(
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::discoveryengine_v1::SearchServiceClient(
      google::cloud::discoveryengine_v1::MakeSearchServiceConnection(
          *ud_options));
  //! [set-client-universe-domain]
}
  ...
  auto c3 = google::cloud::discoveryengine_v1::SearchServiceClient(
      ...
      google::cloud::Options{}
          .set<google::cloud::discoveryengine_v1::
                   SearchServiceRetryPolicyOption>(
              google::cloud::discoveryengine_v1::
                  SearchServiceLimitedTimeRetryPolicy(std::chrono::minutes(5))
                      .clone()));
