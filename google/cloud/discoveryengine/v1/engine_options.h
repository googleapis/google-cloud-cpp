 ...
 */
struct EngineServiceRetryPolicyOption {
  using Type = std::shared_ptr<EngineServiceRetryPolicy>;
};
 ...
 * @ingroup google-cloud-discoveryengine-options
 */
struct EngineServiceBackoffPolicyOption {
 ...
 * @ingroup google-cloud-discoveryengine-options
 */
struct EngineServiceConnectionIdempotencyPolicyOption {
  using Type = std::shared_ptr<EngineServiceConnectionIdempotencyPolicy>;
};
 ...
 * @ingroup google-cloud-discoveryengine-options
 */
struct EngineServicePollingPolicyOption {
  using Type = std::shared_ptr<PollingPolicy>;
};

/**
 * The options applicable to EngineService.
 *
 * @ingroup google-cloud-discoveryengine-options
 */
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DISCOVERYENGINE_V1_ENGINE_OPTIONS_H
