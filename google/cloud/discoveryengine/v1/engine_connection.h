...
#include <google/cloud/discoveryengine/v1/engine_service.pb.h>
...
class EngineServiceRetryPolicy : public ::google::cloud::RetryPolicy {
 public:
  /// Creates a new instance of the policy, reset to the initial state.
  virtual std::unique_ptr<EngineServiceRetryPolicy> clone() const = 0;
};
...
class EngineServiceLimitedErrorCountRetryPolicy
 ...
 public:
  ...
  std::unique_ptr<EngineServiceRetryPolicy> clone() const override {
    return std::make_unique<EngineServiceLimitedErrorCountRetryPolicy>(
        maximum_failures());
  }
 ...
 * - [`kUnavailable`](@ref google::cloud::StatusCode)
 */
class EngineServiceLimitedTimeRetryPolicy : public EngineServiceRetryPolicy {
 public:
  /**
  ...
  std::unique_ptr<EngineServiceRetryPolicy> clone() const override {
    return std::make_unique<EngineServiceLimitedTimeRetryPolicy>(
        maximum_duration());
  }
 ...
 * sets in `EngineServiceClient`. This allows users to inject custom behavior
 * (e.g., with a Google Mock object) when writing tests that use objects of type
 * `EngineServiceClient`.
 *
 * To create a concrete instance, see `MakeEngineServiceConnection()`.
 *
 * For mocking, see `discoveryengine_v1_mocks::MockEngineServiceConnection`.
 */
class EngineServiceConnection {
 public:
  virtual ~EngineServiceConnection() = 0;
 ...
 * should be passed as an argument to the constructor of EngineServiceClient.
 *
 * The optional @p options argument may be used to configure aspects of the
 * returned `EngineServiceConnection`. Expected options are any of the types in
 * the following option lists:
 *
 * - `google::cloud::CommonOptionList`
 * - `google::cloud::GrpcOptionList`
 * - `google::cloud::UnifiedCredentialsOptionList`
 * - `google::cloud::discoveryengine_v1::EngineServicePolicyOptionList`
 *
 * @note Unexpected options will be ignored. To log unexpected options instead,
 *     set `GOOGLE_CLOUD_CPP_ENABLE_CLOG=yes` in the environment.
 *
 * @param options (optional) Configure the `EngineServiceConnection` created by
 * this function.
 */
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DISCOVERYENGINE_V1_ENGINE_CONNECTION_H
