...
StreamRange<google::cloud::discoveryengine::v1::SearchResponse::SearchResult> SearchServiceConnection::Search(
    google::cloud::discoveryengine::v1::SearchRequest) {  // NOLINT(performance-unnecessary-value-param)
  return google::cloud::internal::MakeUnimplementedPaginationRange<
      StreamRange<google::cloud::discoveryengine::v1::SearchResponse::SearchResult>>();
}

StreamRange<google::cloud::discoveryengine::v1::SearchResponse::SearchResult> SearchServiceConnection::SearchLite(
    google::cloud::discoveryengine::v1::SearchRequest) {  // NOLINT(performance-unnecessary-value-param)
  return google::cloud::internal::MakeUnimplementedPaginationRange<
      StreamRange<google::cloud::discoveryengine::v1::SearchResponse::SearchResult>>();
}
...
Status
SearchServiceConnection::CancelOperation(
...
std::shared_ptr<SearchServiceConnection> MakeSearchServiceConnection(
  ...
  return discoveryengine_v1_internal::MakeSearchServiceTracingConnection(
      std::make_shared<discoveryengine_v1_internal::SearchServiceConnectionImpl>(
