...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DISCOVERYENGINE_V1_RANK_CONNECTION_IDEMPOTENCY_POLICY_H
...
class RankServiceConnectionIdempotencyPolicy {
 public:
  virtual ~RankServiceConnectionIdempotencyPolicy();
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DISCOVERYENGINE_V1_RANK_CONNECTION_IDEMPOTENCY_POLICY_H
