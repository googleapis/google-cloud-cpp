...
(GCP) project, as well as a Cloud Spanner instance and database. The
[Cloud Spanner quickstart][spanner-quickstart-link] covers the necessary steps
in detail. Make a note of the GCP project id, the instance id, and the database
id as you will need them below.
