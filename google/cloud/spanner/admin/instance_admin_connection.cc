...
StreamRange<google::spanner::admin::instance::v1::InstanceConfig> InstanceAdminConnection::ListInstanceConfigs(
  ...
  return google::cloud::internal::MakePaginationRange<StreamRange<
    ...
    [](google::spanner::admin::instance::v1::ListInstanceConfigsRequest const&) {
      return StatusOr<google::spanner::admin::instance::v1::ListInstanceConfigsResponse>{};
    },
    [](google::spanner::admin::instance::v1::ListInstanceConfigsResponse const&) {
      return std::vector<google::spanner::admin::instance::v1::InstanceConfig>();
    });
}
...
StreamRange<google::spanner::admin::instance::v1::Instance> InstanceAdminConnection::ListInstances(
  ...
  return google::cloud::internal::MakePaginationRange<StreamRange<
    ...
    [](google::spanner::admin::instance::v1::ListInstancesRequest const&) {
      return StatusOr<google::spanner::admin::instance::v1::ListInstancesResponse>{};
    },
 ...
 public:
  InstanceAdminConnectionImpl(
      ...
      : background_(std::move(background)), stub_(std::move(stub)),
        retry_policy_prototype_(options.get<InstanceAdminRetryPolicyOption>()->clone()),
        backoff_policy_prototype_(options.get<InstanceAdminBackoffPolicyOption>()->clone()),
        polling_policy_prototype_(options.get<InstanceAdminPollingPolicyOption>()->clone()),
        idempotency_policy_(options.get<InstanceAdminConnectionIdempotencyPolicyOption>()->clone()) {}

  ~InstanceAdminConnectionImpl() override = default;

  StreamRange<google::spanner::admin::instance::v1::InstanceConfig> ListInstanceConfigs(
      google::spanner::admin::instance::v1::ListInstanceConfigsRequest request) override {
    request.clear_page_token();
    auto stub = stub_;
    auto retry =
        std::shared_ptr<InstanceAdminRetryPolicy const>(retry_policy_prototype_->clone());
...
MakeInstanceAdminConnection(
    std::shared_ptr<InstanceAdminStub> stub, Options options) {
