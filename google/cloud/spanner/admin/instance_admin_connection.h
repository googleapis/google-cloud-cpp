...
/**
 * A retry policy for `InstanceAdminConnection` that stops retrying after a
...
class InstanceAdminLimitedErrorCountRetryPolicy
 ...
 public:
  InstanceAdminLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `InstanceAdminConnection` that stops retrying after
