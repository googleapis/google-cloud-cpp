...
std::shared_ptr<InstanceAdminStub> CreateDefaultInstanceAdminStub(
  ...
  auto endpoint = internal::DetermineServiceEndpoint(
      ...
      std::move(endpoint_option), "spanner.googleapis.com", options);
  ...
  if (!endpoint.ok()) {
    ...
    auto service_grpc_stub =
        google::spanner::admin::instance::v1::InstanceAdmin::NewStub(channel);
    stub = std::make_shared<DefaultInstanceAdminStub>(
