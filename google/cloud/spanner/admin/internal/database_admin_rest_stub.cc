...
DefaultDatabaseAdminRestStub::AddSplitPoints(
  ...
  std::vector<std::pair<std::string, std::string>> query_params;
  return rest_internal::Post<google::spanner::admin::database::v1::AddSplitPointsResponse>(
      *service_, rest_context, request, false,
      absl::StrCat("/", rest_internal::DetermineApiVersion("v1", options), "/", request.database(), ":addSplitPoints"), std::move(query_params));
}
