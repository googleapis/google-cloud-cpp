...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SPANNER_ADMIN_INTERNAL_DATABASE_ADMIN_LOGGING_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SPANNER_ADMIN_INTERNAL_DATABASE_ADMIN_LOGGING_DECORATOR_H
...
class DatabaseAdminLogging : public DatabaseAdminStub {
 public:
  ...
  StatusOr<google::spanner::admin::database::v1::ListDatabasesResponse> ListDatabases(
      ...
      google::spanner::admin::database::v1::ListDatabasesRequest const& request) override;
  ...
  StatusOr<google::spanner::admin::database::v1::ListBackupsResponse> ListBackups(
      grpc::ClientContext& context,
      Options const& options,
      google::spanner::admin::database::v1::ListBackupsRequest const& request) override;
  ...
  StatusOr<google::spanner::admin::database::v1::ListDatabaseOperationsResponse> ListDatabaseOperations(
      grpc::ClientContext& context,
      Options const& options,
      google::spanner::admin::database::v1::ListDatabaseOperationsRequest const& request) override;

  StatusOr<google::spanner::admin::database::v1::ListBackupOperationsResponse> ListBackupOperations(
      grpc::ClientContext& context,
      Options const& options,
      google::spanner::admin::database::v1::ListBackupOperationsRequest const& request) override;

  StatusOr<google::spanner::admin::database::v1::ListDatabaseRolesResponse> ListDatabaseRoles(
      grpc::ClientContext& context,
      Options const& options,
      google::spanner::admin::database::v1::ListDatabaseRolesRequest const& request) override;

  StatusOr<google::spanner::admin::database::v1::AddSplitPointsResponse> AddSplitPoints(
      grpc::ClientContext& context,
      Options const& options,
      google::spanner::admin::database::v1::AddSplitPointsRequest const& request) override;

  StatusOr<google::spanner::admin::database::v1::BackupSchedule> CreateBackupSchedule(
      grpc::ClientContext& context,
      Options const& options,
      google::spanner::admin::database::v1::CreateBackupScheduleRequest const& request) override;

  StatusOr<google::spanner::admin::database::v1::BackupSchedule> GetBackupSchedule(
      grpc::ClientContext& context,
      Options const& options,
      google::spanner::admin::database::v1::GetBackupScheduleRequest const& request) override;

  StatusOr<google::spanner::admin::database::v1::BackupSchedule> UpdateBackupSchedule(
      grpc::ClientContext& context,
      Options const& options,
      google::spanner::admin::database::v1::UpdateBackupScheduleRequest const& request) override;

  Status DeleteBackupSchedule(
      grpc::ClientContext& context,
      Options const& options,
      google::spanner::admin::database::v1::DeleteBackupScheduleRequest const& request) override;

  StatusOr<google::spanner::admin::database::v1::ListBackupSchedulesResponse> ListBackupSchedules(
      grpc::ClientContext& context,
      Options const& options,
      google::spanner::admin::database::v1::ListBackupSchedulesRequest const& request) override;
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SPANNER_ADMIN_INTERNAL_DATABASE_ADMIN_LOGGING_DECORATOR_H
