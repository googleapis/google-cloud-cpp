...
std::shared_ptr<DatabaseAdminRestStub>
CreateDefaultDatabaseAdminRestStub(Options const& options) {
  auto opts = internal::PopulateRestOptions(options);
  std::shared_ptr<DatabaseAdminRestStub> stub =
      std::make_shared<DefaultDatabaseAdminRestStub>(std::move(opts));
