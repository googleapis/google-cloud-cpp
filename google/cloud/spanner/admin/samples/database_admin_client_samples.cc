...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::spanner_admin::DatabaseAdminClient(
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::spanner_admin::DatabaseAdminClient(
      google::cloud::spanner_admin::MakeDatabaseAdminConnection(ud_options));
      ...
      google::cloud::Options{}
          ...
          .set<google::cloud::spanner_admin::DatabaseAdminRetryPolicyOption>(
              google::cloud::spanner_admin::
                  DatabaseAdminLimitedErrorCountRetryPolicy(3)
                      .clone())
          ...
          .set<google::cloud::spanner_admin::DatabaseAdminPollingPolicyOption>(
              google::cloud::GenericPollingPolicy<
                  google::cloud::spanner_admin::DatabaseAdminRetryPolicyOption::
                      Type,
                  google::cloud::spanner_admin::
                      DatabaseAdminBackoffPolicyOption::Type>(
                  google::cloud::spanner_admin::
