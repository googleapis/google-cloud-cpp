...
// main-dox-marker: GOOGLE_CLOUD_CPP_NS::InstanceAdminClient
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::GOOGLE_CLOUD_CPP_NS::InstanceAdminClient(
      google::cloud::GOOGLE_CLOUD_CPP_NS::MakeInstanceAdminConnection(options));
  //! [set-client-endpoint]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::GOOGLE_CLOUD_CPP_NS::InstanceAdminClient(
        google::cloud::GOOGLE_CLOUD_CPP_NS::MakeInstanceAdminConnection(
            options));
  }
  //! [with-service-account]
  (argv.at(0));
