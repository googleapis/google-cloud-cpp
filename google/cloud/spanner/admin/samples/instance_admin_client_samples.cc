...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::spanner_admin::InstanceAdminClient(
      google::cloud::spanner_admin::MakeInstanceAdminConnection(*ud_options));
  //! [set-client-universe-domain]
}
      ...
      google::cloud::Options{}
          ...
          .set<google::cloud::spanner_admin::InstanceAdminRetryPolicyOption>(
              google::cloud::spanner_admin::
                  InstanceAdminLimitedErrorCountRetryPolicy(3)
                      .clone())
          ...
          .set<google::cloud::spanner_admin::InstanceAdminPollingPolicyOption>(
              google::cloud::GenericPollingPolicy<
                  google::cloud::spanner_admin::InstanceAdminRetryPolicyOption::
                      Type,
                  google::cloud::spanner_admin::
                      InstanceAdminBackoffPolicyOption::Type>(
                  google::cloud::spanner_admin::
