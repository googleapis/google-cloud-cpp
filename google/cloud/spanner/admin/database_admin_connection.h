...
/**
 * A retry policy for `DatabaseAdminConnection` that stops retrying after a
...
class DatabaseAdminLimitedErrorCountRetryPolicy
 ...
 public:
  DatabaseAdminLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `DatabaseAdminConnection` that stops retrying after
