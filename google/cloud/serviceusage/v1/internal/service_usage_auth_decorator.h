...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SERVICEUSAGE_V1_INTERNAL_SERVICE_USAGE_AUTH_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SERVICEUSAGE_V1_INTERNAL_SERVICE_USAGE_AUTH_DECORATOR_H
...
class ServiceUsageAuth : public ServiceUsageStub {
 public:
  ~ServiceUsageAuth() override = default;
  ServiceUsageAuth(
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SERVICEUSAGE_V1_INTERNAL_SERVICE_USAGE_AUTH_DECORATOR_H
