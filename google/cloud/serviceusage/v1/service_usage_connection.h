...
/**
 * A retry policy for `ServiceUsageConnection` that stops retrying after a
...
class ServiceUsageLimitedErrorCountRetryPolicy
 ...
 public:
  ServiceUsageLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `ServiceUsageConnection` that stops retrying after
