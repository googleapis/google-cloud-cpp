...
inline std::unique_ptr<serviceusage::ServiceUsageRetryPolicy> retry_policy() {
  return internal::CurrentOptions()
      .get<serviceusage::ServiceUsageRetryPolicyOption>()
      ->clone();
}

inline std::unique_ptr<BackoffPolicy> backoff_policy() {
  return internal::CurrentOptions()
      .get<serviceusage::ServiceUsageBackoffPolicyOption>()
      ->clone();
}

inline std::unique_ptr<serviceusage::ServiceUsageConnectionIdempotencyPolicy>
idempotency_policy() {
  return internal::CurrentOptions()
...
inline std::unique_ptr<PollingPolicy> polling_policy() {
  return internal::CurrentOptions()
      .get<serviceusage::ServiceUsagePollingPolicyOption>()
      ->clone();
}
