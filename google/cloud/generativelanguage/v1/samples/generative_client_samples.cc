...
// clang-format off
// main-dox-marker: generativelanguage_v1::GenerativeServiceClient
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::generativelanguage_v1::GenerativeServiceClient(
      google::cloud::generativelanguage_v1::MakeGenerativeServiceConnection(
          options));
  //! [set-client-endpoint]
}
...
class CustomIdempotencyPolicy
    : public google::cloud::generativelanguage_v1::
          GenerativeServiceConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::generativelanguage_v1::
                      GenerativeServiceConnectionIdempotencyPolicy>
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options =
      google::cloud::Options{}
          .set<google::cloud::generativelanguage_v1::
          ...
          .set<google::cloud::generativelanguage_v1::
              ...
              google::cloud::generativelanguage_v1::
                  GenerativeServiceLimitedErrorCountRetryPolicy(3)
                      .clone())
          .set<google::cloud::generativelanguage_v1::
  ...
  auto c1 =
      google::cloud::generativelanguage_v1::GenerativeServiceClient(connection);
  auto c2 =
      google::cloud::generativelanguage_v1::GenerativeServiceClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::generativelanguage_v1::GenerativeServiceClient(
  ...
  //     .set<google::cloud::generativelanguage_v1::GenerativeServiceRetryPolicyOption>(
  //       google::cloud::generativelanguage_v1::GenerativeServiceLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::generativelanguage_v1::GenerativeServiceClient(
        google::cloud::generativelanguage_v1::MakeGenerativeServiceConnection(
            options));
  }
  //! [with-service-account]
