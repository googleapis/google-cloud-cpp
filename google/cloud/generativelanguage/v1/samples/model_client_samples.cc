...
// clang-format off
// main-dox-marker: generativelanguage_v1::ModelServiceClient
// clang-format on
namespace {
...
class CustomIdempotencyPolicy : public google::cloud::generativelanguage_v1::
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
                     ...
                     .set<google::cloud::generativelanguage_v1::
                         ...
                         google::cloud::ExponentialBackoffPolicy(
                             ...
                             .clone());
  auto connection =
      google::cloud::generativelanguage_v1::MakeModelServiceConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 =
      google::cloud::generativelanguage_v1::ModelServiceClient(connection);
  auto c2 =
      google::cloud::generativelanguage_v1::ModelServiceClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::generativelanguage_v1::ModelServiceClient(
      connection,
  ...
  //     .set<google::cloud::generativelanguage_v1::ModelServiceRetryPolicyOption>(
  //       google::cloud::generativelanguage_v1::ModelServiceLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::generativelanguage_v1::ModelServiceClient(
        google::cloud::generativelanguage_v1::MakeModelServiceConnection(
            options));
  }
  //! [with-service-account]
