...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_GENERATIVELANGUAGE_V1_INTERNAL_GENERATIVE_STUB_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_GENERATIVELANGUAGE_V1_INTERNAL_GENERATIVE_STUB_H
...
class GenerativeServiceStub {
 public:
  virtual ~GenerativeServiceStub() = 0;
  ...
  CountTokens(grpc::ClientContext& context, Options const& options,
              google::ai::generativelanguage::v1::CountTokensRequest const&
                  request) = 0;
};

class DefaultGenerativeServiceStub : public GenerativeServiceStub {
 public:
  explicit DefaultGenerativeServiceStub(
      std::unique_ptr<
          google::ai::generativelanguage::v1::GenerativeService::StubInterface>
          grpc_stub)
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_GENERATIVELANGUAGE_V1_INTERNAL_GENERATIVE_STUB_H
