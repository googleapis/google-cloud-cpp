...
Options ModelServiceDefaultOptions(Options options) {
  ...
  if (!options.has<generativelanguage_v1::ModelServiceRetryPolicyOption>()) {
    options.set<generativelanguage_v1::ModelServiceRetryPolicyOption>(
        generativelanguage_v1::ModelServiceLimitedTimeRetryPolicy(
            std::chrono::minutes(30))
            .clone());
  }
  if (!options.has<generativelanguage_v1::ModelServiceBackoffPolicyOption>()) {
    options.set<generativelanguage_v1::ModelServiceBackoffPolicyOption>(
        ExponentialBackoffPolicy(
            std::chrono::seconds(0), std::chrono::seconds(1),
            std::chrono::minutes(5), kBackoffScaling, kBackoffScaling)
            .clone());
  }
  if (!options.has<generativelanguage_v1::
                       ModelServiceConnectionIdempotencyPolicyOption>()) {
    options.set<
        generativelanguage_v1::ModelServiceConnectionIdempotencyPolicyOption>(
