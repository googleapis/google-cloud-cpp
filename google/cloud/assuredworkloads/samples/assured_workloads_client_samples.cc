...
// main-dox-marker: GOOGLE_CLOUD_CPP_NS::AssuredWorkloadsServiceClient
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client =
      google::cloud::GOOGLE_CLOUD_CPP_NS::AssuredWorkloadsServiceClient(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::GOOGLE_CLOUD_CPP_NS::AssuredWorkloadsServiceClient(
        google::cloud::GOOGLE_CLOUD_CPP_NS::
            MakeAssuredWorkloadsServiceConnection(options));
  }
  //! [with-service-account]
