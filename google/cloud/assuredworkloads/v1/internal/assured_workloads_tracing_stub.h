...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_ASSUREDWORKLOADS_V1_INTERNAL_ASSURED_WORKLOADS_TRACING_STUB_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_ASSUREDWORKLOADS_V1_INTERNAL_ASSURED_WORKLOADS_TRACING_STUB_H
...
class AssuredWorkloadsServiceTracingStub : public AssuredWorkloadsServiceStub {
 public:
  ...
  explicit AssuredWorkloadsServiceTracingStub(std::shared_ptr<AssuredWorkloadsServiceStub> child);
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_ASSUREDWORKLOADS_V1_INTERNAL_ASSURED_WORKLOADS_TRACING_STUB_H
