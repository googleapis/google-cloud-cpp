...
// clang-format off
// main-dox-marker: ftp_v1::CloudFtpClient
// lro-marker: true
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::ftp_v1::CloudFtpClient(
      google::cloud::ftp_v1::MakeCloudFtpConnectionRest(options));
  //! [set-client-endpoint]
}
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::ftp_v1::CloudFtpClient(
      google::cloud::ftp_v1::MakeCloudFtpConnectionRest(*ud_options));
  //! [set-client-universe-domain]
}

//! [custom-idempotency-policy]
class CustomIdempotencyPolicy
    : public google::cloud::ftp_v1::CloudFtpConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::ftp_v1::CloudFtpConnectionIdempotencyPolicy>
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options =
      google::cloud::Options{}
          .set<
              google::cloud::ftp_v1::CloudFtpConnectionIdempotencyPolicyOption>(
              CustomIdempotencyPolicy().clone())
          .set<google::cloud::ftp_v1::CloudFtpRetryPolicyOption>(
              google::cloud::ftp_v1::CloudFtpLimitedErrorCountRetryPolicy(3)
                  .clone())
          .set<google::cloud::ftp_v1::CloudFtpBackoffPolicyOption>(
              google::cloud::ExponentialBackoffPolicy(
                  /*initial_delay=*/std::chrono::milliseconds(200),
                  /*maximum_delay=*/std::chrono::seconds(45),
                  /*scaling=*/2.0)
                  .clone());
  auto connection = google::cloud::ftp_v1::MakeCloudFtpConnectionRest(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::ftp_v1::CloudFtpClient(connection);
  auto c2 = google::cloud::ftp_v1::CloudFtpClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::ftp_v1::CloudFtpClient(
      connection, google::cloud::Options{}
                      .set<google::cloud::ftp_v1::CloudFtpRetryPolicyOption>(
                          google::cloud::ftp_v1::CloudFtpLimitedTimeRetryPolicy(
  ...
  //     .set<google::cloud::ftp_v1::CloudFtpRetryPolicyOption>(
  //       google::cloud::ftp_v1::CloudFtpLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options =
      google::cloud::Options{}
          .set<google::cloud::ftp_v1::CloudFtpPollingPolicyOption>(
              google::cloud::GenericPollingPolicy<
                  google::cloud::ftp_v1::CloudFtpRetryPolicyOption::Type,
                  google::cloud::ftp_v1::CloudFtpBackoffPolicyOption::Type>(
                  google::cloud::ftp_v1::CloudFtpLimitedTimeRetryPolicy(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::ftp_v1::CloudFtpClient(
        google::cloud::ftp_v1::MakeCloudFtpConnectionRest(options));
  }
  //! [with-service-account]
  (argv.at(0));
