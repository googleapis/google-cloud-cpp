...
StatusOr<google::cloud::bigquery::storage::v1::WriteStream> BigQueryWriteAuth::CreateWriteStream(
...
BigQueryWriteAuth::AsyncAppendRows(
  ...
  auto call = [child = child_, cq, options = std::move(options)](
    ...
    return child->AsyncAppendRows(cq, std::move(ctx), options);
  };
  return std::make_unique<StreamAuth>(
    std::move(context), auth_, StreamAuth::StreamFactory(std::move(call)));
}

StatusOr<google::cloud::bigquery::storage::v1::WriteStream> BigQueryWriteAuth::GetWriteStream(
    grpc::ClientContext& context,
    Options const& options,
...
StatusOr<google::cloud::bigquery::storage::v1::FinalizeWriteStreamResponse> BigQueryWriteAuth::FinalizeWriteStream(
    grpc::ClientContext& context,
    Options const& options,
...
StatusOr<google::cloud::bigquery::storage::v1::BatchCommitWriteStreamsResponse> BigQueryWriteAuth::BatchCommitWriteStreams(
    grpc::ClientContext& context,
    Options const& options,
...
StatusOr<google::cloud::bigquery::storage::v1::FlushRowsResponse> BigQueryWriteAuth::FlushRows(
    grpc::ClientContext& context,
    Options const& options,
