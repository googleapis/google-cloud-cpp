...
std::shared_ptr<BigQueryWriteStub> CreateDefaultBigQueryWriteStub(
  ...
  auto endpoint = internal::DetermineServiceEndpoint(
      internal::GetEnv("GOOGLE_CLOUD_CPP_BIGQUERY_WRITE_ENDPOINT"),
      std::move(endpoint_option), "bigquerystorage.googleapis.com", options);
  ...
  if (!endpoint.ok()) {
    ...
    stub = std::make_shared<DefaultBigQueryWriteStub>(
  ...
  if (internal::TracingEnabled(options)) {
    stub = MakeBigQueryWriteTracingStub(std::move(stub));
  }
  return stub;
}
