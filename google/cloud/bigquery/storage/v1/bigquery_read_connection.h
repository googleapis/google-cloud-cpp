...
/**
 * A retry policy for `BigQueryReadConnection` that stops retrying after a
...
class BigQueryReadLimitedErrorCountRetryPolicy
 ...
 public:
  BigQueryReadLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `BigQueryReadConnection` that stops retrying after
