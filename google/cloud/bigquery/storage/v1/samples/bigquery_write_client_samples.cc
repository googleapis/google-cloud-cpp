...
// clang-format off
// main-dox-marker: bigquery_storage_v1::BigQueryWriteClient
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::bigquery_storage_v1::BigQueryWriteClient(
...
class CustomIdempotencyPolicy
 ...
 public:
  ...
  std::unique_ptr<google::cloud::bigquery_storage_v1::BigQueryWriteConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    ...
    .set<google::cloud::bigquery_storage_v1::BigQueryWriteRetryPolicyOption>(
      google::cloud::bigquery_storage_v1::BigQueryWriteLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::bigquery_storage_v1::BigQueryWriteBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::bigquery_storage_v1::MakeBigQueryWriteConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::bigquery_storage_v1::BigQueryWriteClient(connection);
  auto c2 = google::cloud::bigquery_storage_v1::BigQueryWriteClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::bigquery_storage_v1::BigQueryWriteClient(
    connection, google::cloud::Options{}.set<google::cloud::bigquery_storage_v1::BigQueryWriteRetryPolicyOption>(
      google::cloud::bigquery_storage_v1::BigQueryWriteLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::bigquery_storage_v1::BigQueryWriteClient(
      google::cloud::bigquery_storage_v1::MakeBigQueryWriteConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
