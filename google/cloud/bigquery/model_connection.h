 ...
 * (e.g., with a Google Mock object) in a `ModelServiceClient` object for use
 * in their own tests.
 *
...
/**
 * A factory function to construct a `ModelServiceConnection` object.
 *
 * The returned connection object should not be used directly; instead it
 * should be given to a `ModelServiceClient` instance, and methods should be
 * invoked on `ModelServiceClient`.
 *
