...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_BIGQUERY_MOCKS_MOCK_MODEL_CONNECTION_H
 ...
 * including errors from a `ModelServiceClient`. To do so, construct a
 * `ModelServiceClient` with an instance of this class. Then use the Google
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_BIGQUERY_MOCKS_MOCK_MODEL_CONNECTION_H
