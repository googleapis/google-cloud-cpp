...
/**
 * A retry policy for `MetastoreServiceConnection` that stops retrying after a
...
class MetastoreServiceLimitedErrorCountRetryPolicy
 ...
 public:
  MetastoreServiceLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `MetastoreServiceConnection` that stops retrying after
