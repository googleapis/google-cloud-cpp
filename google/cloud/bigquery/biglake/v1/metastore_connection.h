...
using MetastoreServiceRetryPolicy = ::google::cloud::internal::TraitBasedRetryPolicy<
    bigquery_biglake_v1_internal::MetastoreServiceRetryTraits>;

using MetastoreServiceLimitedTimeRetryPolicy = ::google::cloud::internal::LimitedTimeRetryPolicy<
    bigquery_biglake_v1_internal::MetastoreServiceRetryTraits>;
