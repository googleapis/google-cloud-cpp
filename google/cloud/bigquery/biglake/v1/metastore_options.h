...
struct MetastoreServiceConnectionIdempotencyPolicyOption {
  using Type = std::shared_ptr<MetastoreServiceConnectionIdempotencyPolicy>;
};
 ...
 * @ingroup google-cloud-bigquery-options
 */
using MetastoreServicePolicyOptionList =
    OptionList<MetastoreServiceRetryPolicyOption,
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_BIGQUERY_BIGLAKE_V1_METASTORE_OPTIONS_H
