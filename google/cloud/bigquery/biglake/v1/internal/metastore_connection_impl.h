...
class MetastoreServiceConnectionImpl
 ...
 private:
  std::unique_ptr<bigquery_biglake_v1::MetastoreServiceRetryPolicy> retry_policy() {
    ...
    return options_.get<bigquery_biglake_v1::MetastoreServiceRetryPolicyOption>()->clone();
  }
  ...
  std::unique_ptr<BackoffPolicy> backoff_policy() {
    ...
    return options_.get<bigquery_biglake_v1::MetastoreServiceBackoffPolicyOption>()->clone();
  }

  std::unique_ptr<bigquery_biglake_v1::MetastoreServiceConnectionIdempotencyPolicy> idempotency_policy() {
    auto const& options = internal::CurrentOptions();
    ...
    return options_.get<bigquery_biglake_v1::MetastoreServiceConnectionIdempotencyPolicyOption>()->
clone();
  }
