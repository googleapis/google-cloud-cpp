...
///     types defined in bigquery_reservation_v1 instead of the aliases defined in
///     this namespace.
namespace bigquery {
GOOGLE_CLOUD_CPP_INLINE_NAMESPACE_BEGIN

/// @deprecated Use bigquery_reservation_v1::ReservationServiceClient directly.
using ::google::cloud::bigquery_reservation_v1::ReservationServiceClient;
