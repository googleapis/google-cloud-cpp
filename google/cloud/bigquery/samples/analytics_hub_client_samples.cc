...
// main-dox-marker: GOOGLE_CLOUD_CPP_NS::AnalyticsHubServiceClient
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::GOOGLE_CLOUD_CPP_NS::AnalyticsHubServiceClient(
      google::cloud::GOOGLE_CLOUD_CPP_NS::MakeAnalyticsHubServiceConnection(
          options));
  //! [set-client-endpoint]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::GOOGLE_CLOUD_CPP_NS::AnalyticsHubServiceClient(
        google::cloud::GOOGLE_CLOUD_CPP_NS::MakeAnalyticsHubServiceConnection(
            options));
  }
  //! [with-service-account]
