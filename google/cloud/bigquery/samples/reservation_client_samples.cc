...
// main-dox-marker: GOOGLE_CLOUD_CPP_NS::ReservationServiceClient
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::GOOGLE_CLOUD_CPP_NS::ReservationServiceClient(
      google::cloud::GOOGLE_CLOUD_CPP_NS::MakeReservationServiceConnection(
          options));
  //! [set-client-endpoint]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::GOOGLE_CLOUD_CPP_NS::ReservationServiceClient(
        google::cloud::GOOGLE_CLOUD_CPP_NS::MakeReservationServiceConnection(
            options));
  }
  //! [with-service-account]
