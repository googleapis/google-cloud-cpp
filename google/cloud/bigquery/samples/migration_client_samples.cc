...
// main-dox-marker: GOOGLE_CLOUD_CPP_NS::MigrationServiceClient
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::GOOGLE_CLOUD_CPP_NS::MigrationServiceClient(
      google::cloud::GOOGLE_CLOUD_CPP_NS::MakeMigrationServiceConnection(
          options));
  //! [set-client-endpoint]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::GOOGLE_CLOUD_CPP_NS::MigrationServiceClient(
        google::cloud::GOOGLE_CLOUD_CPP_NS::MakeMigrationServiceConnection(
            options));
  }
  //! [with-service-account]
