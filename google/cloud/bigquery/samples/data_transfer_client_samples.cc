...
// main-dox-marker: GOOGLE_CLOUD_CPP_NS::DataTransferServiceClient
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::GOOGLE_CLOUD_CPP_NS::DataTransferServiceClient(
      google::cloud::GOOGLE_CLOUD_CPP_NS::MakeDataTransferServiceConnection(
          options));
  //! [set-client-endpoint]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::GOOGLE_CLOUD_CPP_NS::DataTransferServiceClient(
        google::cloud::GOOGLE_CLOUD_CPP_NS::MakeDataTransferServiceConnection(
            options));
  }
  //! [with-service-account]
