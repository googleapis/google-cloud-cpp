...
// main-dox-marker: bigquery::DataPolicyServiceClient
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::bigquery::DataPolicyServiceClient(
      google::cloud::bigquery::MakeDataPolicyServiceConnection(options));
  //! [set-client-endpoint]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::bigquery::DataPolicyServiceClient(
        google::cloud::bigquery::MakeDataPolicyServiceConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
