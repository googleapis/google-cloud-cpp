...
class BigQueryReadClient {
 public:
   ...
   * @return
   * [google::cloud::bigquery::storage::v1::ReadSession](https://github.com/googleapis/googleapis/blob/80f404215a9346259db760d80d0671f28c433453/google/cloud/bigquery/storage/v1/stream.proto#L46)
   */
   ...
   * @return
   * [google::cloud::bigquery::storage::v1::ReadRowsResponse](https://github.com/googleapis/googleapis/blob/80f404215a9346259db760d80d0671f28c433453/google/cloud/bigquery/storage/v1/storage.proto#L184)
   */
   ...
   *
   * @param request
   * [google::cloud::bigquery::storage::v1::CreateReadSessionRequest](https://github.com/googleapis/googleapis/blob/80f404215a9346259db760d80d0671f28c433453/google/cloud/bigquery/storage/v1/storage.proto#L109)
   * @return
   * [google::cloud::bigquery::storage::v1::ReadSession](https://github.com/googleapis/googleapis/blob/80f404215a9346259db760d80d0671f28c433453/google/cloud/bigquery/storage/v1/stream.proto#L46)
   */
  StatusOr<google::cloud::bigquery::storage::v1::ReadSession> CreateReadSession(
   ...
   *
   * @param request
   * [google::cloud::bigquery::storage::v1::ReadRowsRequest](https://github.com/googleapis/googleapis/blob/80f404215a9346259db760d80d0671f28c433453/google/cloud/bigquery/storage/v1/storage.proto#L134)
   * @return
   * [google::cloud::bigquery::storage::v1::ReadRowsResponse](https://github.com/googleapis/googleapis/blob/80f404215a9346259db760d80d0671f28c433453/google/cloud/bigquery/storage/v1/storage.proto#L184)
   */
  StreamRange<google::cloud::bigquery::storage::v1::ReadRowsResponse> ReadRows(
   ...
   *
   * @param request
   * [google::cloud::bigquery::storage::v1::SplitReadStreamRequest](https://github.com/googleapis/googleapis/blob/80f404215a9346259db760d80d0671f28c433453/google/cloud/bigquery/storage/v1/storage.proto#L219)
   * @return
   * [google::cloud::bigquery::storage::v1::SplitReadStreamResponse](https://github.com/googleapis/googleapis/blob/80f404215a9346259db760d80d0671f28c433453/google/cloud/bigquery/storage/v1/storage.proto#L239)
   */
