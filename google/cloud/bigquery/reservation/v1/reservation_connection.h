...
/**
 * A retry policy for `ReservationServiceConnection` that stops retrying after a
...
class ReservationServiceLimitedErrorCountRetryPolicy
 ...
 public:
  ReservationServiceLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `ReservationServiceConnection` that stops retrying after
