...
Status
DefaultReservationServiceStub::DeleteReservation(
  grpc::ClientContext& context, Options const&,
...
DefaultReservationServiceStub::FailoverReservation(
  ...
  google::cloud::bigquery::reservation::v1::FailoverReservationRequest const& request) {
    google::cloud::bigquery::reservation::v1::Reservation response;
    auto status =
        grpc_stub_->FailoverReservation(&context, request, &response);
    if (!status.ok()) {
      return google::cloud::MakeStatusFromRpcError(status);
    }
    return response;
...
DefaultReservationServiceStub::ListCapacityCommitments(
  ...
  google::cloud::bigquery::reservation::v1::ListCapacityCommitmentsRequest const& request) {
    google::cloud::bigquery::reservation::v1::ListCapacityCommitmentsResponse response;
    auto status =
...
DefaultReservationServiceStub::GetCapacityCommitment(
  ...
  google::cloud::bigquery::reservation::v1::GetCapacityCommitmentRequest const& request) {
    google::cloud::bigquery::reservation::v1::CapacityCommitment response;
    auto status =
        grpc_stub_->GetCapacityCommitment(&context, request, &response);
    if (!status.ok()) {
      return google::cloud::MakeStatusFromRpcError(status);
    }
    return response;
...
Status
DefaultReservationServiceStub::DeleteCapacityCommitment(
  grpc::ClientContext& context, Options const&,
...
DefaultReservationServiceStub::SplitCapacityCommitment(
  ...
  google::cloud::bigquery::reservation::v1::SplitCapacityCommitmentRequest const& request) {
    google::cloud::bigquery::reservation::v1::SplitCapacityCommitmentResponse response;
    auto status =
...
DefaultReservationServiceStub::CreateAssignment(
  ...
  google::cloud::bigquery::reservation::v1::CreateAssignmentRequest const& request) {
    ...
    auto status =
        grpc_stub_->CreateAssignment(&context, request, &response);
    if (!status.ok()) {
      return google::cloud::MakeStatusFromRpcError(status);
    }
    return response;
...
DefaultReservationServiceStub::ListAssignments(
  ...
  google::cloud::bigquery::reservation::v1::ListAssignmentsRequest const& request) {
    ...
    auto status =
        grpc_stub_->ListAssignments(&context, request, &response);
    if (!status.ok()) {
      return google::cloud::MakeStatusFromRpcError(status);
    }
    return response;
...
Status
DefaultReservationServiceStub::DeleteAssignment(
  grpc::ClientContext& context, Options const&,
  google::cloud::bigquery::reservation::v1::DeleteAssignmentRequest const& request) {
    google::protobuf::Empty response;
    auto status =
        grpc_stub_->DeleteAssignment(&context, request, &response);
    if (!status.ok()) {
      return google::cloud::MakeStatusFromRpcError(status);
    }
    return google::cloud::Status();
...
DefaultReservationServiceStub::SearchAssignments(
  ...
  google::cloud::bigquery::reservation::v1::SearchAssignmentsRequest const& request) {
    ...
    auto status =
        grpc_stub_->SearchAssignments(&context, request, &response);
    if (!status.ok()) {
      return google::cloud::MakeStatusFromRpcError(status);
    }
    return response;
...
DefaultReservationServiceStub::SearchAllAssignments(
  ...
  google::cloud::bigquery::reservation::v1::SearchAllAssignmentsRequest const& request) {
    google::cloud::bigquery::reservation::v1::SearchAllAssignmentsResponse response;
    auto status =
        grpc_stub_->SearchAllAssignments(&context, request, &response);
    if (!status.ok()) {
      return google::cloud::MakeStatusFromRpcError(status);
    }
    return response;
...
DefaultReservationServiceStub::MoveAssignment(
  ...
  google::cloud::bigquery::reservation::v1::MoveAssignmentRequest const& request) {
    google::cloud::bigquery::reservation::v1::Assignment response;
    auto status =
        grpc_stub_->MoveAssignment(&context, request, &response);
    if (!status.ok()) {
      return google::cloud::MakeStatusFromRpcError(status);
    }
    return response;
...
DefaultReservationServiceStub::UpdateAssignment(
  ...
  google::cloud::bigquery::reservation::v1::UpdateAssignmentRequest const& request) {
    google::cloud::bigquery::reservation::v1::Assignment response;
    auto status =
        grpc_stub_->UpdateAssignment(&context, request, &response);
    if (!status.ok()) {
      return google::cloud::MakeStatusFromRpcError(status);
    }
    return response;
...
DefaultReservationServiceStub::GetBiReservation(
  ...
  google::cloud::bigquery::reservation::v1::GetBiReservationRequest const& request) {
    ...
    auto status =
        grpc_stub_->GetBiReservation(&context, request, &response);
    if (!status.ok()) {
      return google::cloud::MakeStatusFromRpcError(status);
    }
    return response;
...
DefaultReservationServiceStub::UpdateBiReservation(
  ...
  google::cloud::bigquery::reservation::v1::UpdateBiReservationRequest const& request) {
    google::cloud::bigquery::reservation::v1::BiReservation response;
    auto status =
        grpc_stub_->UpdateBiReservation(&context, request, &response);
    if (!status.ok()) {
      return google::cloud::MakeStatusFromRpcError(status);
    }
    return response;
