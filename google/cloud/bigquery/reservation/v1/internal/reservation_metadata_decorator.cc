...
Status
ReservationServiceMetadata::DeleteReservation(
    grpc::ClientContext& context,
    Options const& options,
...
Status
ReservationServiceMetadata::DeleteCapacityCommitment(
    grpc::ClientContext& context,
    Options const& options,
...
ReservationServiceMetadata::UpdateCapacityCommitment(
  ...
  SetMetadata(context, options, absl::StrCat("capacity_commitment.name=", internal::UrlEncode(request.capacity_commitment().name())));
...
Status
ReservationServiceMetadata::DeleteAssignment(
    grpc::ClientContext& context,
    Options const& options,
...
ReservationServiceMetadata::UpdateAssignment(
  ...
  SetMetadata(context, options, absl::StrCat("assignment.name=", internal::UrlEncode(request.assignment().name())));
...
ReservationServiceMetadata::UpdateBiReservation(
  ...
  SetMetadata(context, options, absl::StrCat("bi_reservation.name=", internal::UrlEncode(request.bi_reservation().name())));
