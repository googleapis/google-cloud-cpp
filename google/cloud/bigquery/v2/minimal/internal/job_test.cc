...
TEST(JobTest, ListFormatJobToFromJson) {
  auto const* const expected_text =
      ...
      R"(,"flattenResults":true,"maximumBytesBilled":0,"parameterMode":"job-param-mode")"
      R"(,"preserveNulls":true,"priority":"job-priority","query":"select 1;")"
      R"(,"queryParameters":[{"name":"query-parameter-name","parameterType":{"arrayType":{)"
      R"("structTypes":[{"description":"array-struct-description","name":"array-struct-name")"
      R"(,"type":{"structTypes":[],"type":"array-struct-type"}}],"type":"array-type"})"
      R"(,"structTypes":[{"description":"qp-struct-description","name":"qp-struct-name")"
      R"(,"type":{"structTypes":[],"type":"qp-struct-type"}}],"type":"query-parameter-type"})"
      R"(,"parameterValue":{"arrayValues":[{"arrayValues":[{"arrayValues":[])"
      R"(,"structValues":{"array-map-key":{"arrayValues":[],"structValues":{})"
      R"(,"value":"array-map-value"}},"value":"array-val-2"}],"structValues":{})"
      R"(,"value":"array-val-1"}],"structValues":{"qp-map-key":{"arrayValues":[])"
      R"(,"structValues":{},"value":"qp-map-value"}},"value":"query-parameter-value"}}])"
      ...
      R"(,"schemaUpdateOptions":["job-update-options"],"scriptOptions":{"keyResultStatement":{)"
      R"("value":"FIRST_SELECT"},"statementByteBudget":10,"statementTimeoutMs":10})"
      R"(,"systemVariables":{"types":{"sql-struct-type-key-1":{"structType":{"fields":[{)"
      R"("name":"f1-sql-struct-type-int64"}]},"sub_type_index":2,"typeKind":{"value":"INT64"}})"
      R"(,"sql-struct-type-key-2":{"structType":{"fields":[{"name":"f2-sql-struct-type-string"}]})"
      R"(,"sub_type_index":2,"typeKind":{"value":"STRING"}},"sql-struct-type-key-3":{)"
      R"("arrayElementType":{"structType":{"fields":[{"name":"f2-sql-struct-type-string"}]})"
      R"(,"sub_type_index":2,"typeKind":{"value":"STRING"}},"sub_type_index":1,"typeKind":{"value":"STRING"}}})"
      R"(,"values":{"fields":{"bool-key":{"kind_index":3,"valueKind":true},"double-key":{"kind_index":1)"
      R"(,"valueKind":3.4},"string-key":{"kind_index":2,"valueKind":"val3"}}}})"
      R"(,"timePartitioning":{"expiration_time":0,"field":"tp-field-1","type":"tp-field-type"})"
      R"(,"useLegacySql":true,"useQueryCache":true,"writeDisposition":"job-write-disposition"}})"
      R"(,"errorResult":{"location":"","message":"","reason":""},"id":"1","jobReference":{"jobId":"2")"
      R"(,"location":"us-east","projectId":"1"},"kind":"Job","principal_subject":"principal-sub")"
      R"(,"state":"DONE","statistics":{"completionRatio":1234.1234,"creationTime":10)"
      R"(,"dataMaskingStatistics":{"dataMaskingApplied":true},"endTime":10)"
      R"(,"finalExecutionDurationMs":10,"numChildJobs":1234,"parentJobId":"parent-job-123")"
      R"(,"query":{"billingTier":1234,"cacheHit":true,"dclTargetDataset":{)"
      R"("datasetId":"1","projectId":"2"},"dclTargetTable":{"datasetId":"1","projectId":"2")"
      R"(,"tableId":"3"},"dclTargetView":{"datasetId":"1","projectId":"2","tableId":"3"})"
      ...
      R"("insufficientShuffleQuota":true,"slotContention":true,"stageId":1234}})"
      R"(,"queryPlan":[{"completedParallelInputs":1234,"computeMode":{"value":"BIGQUERY"})"
      R"(,"computeMsAvg":10,"computeMsMax":10,"computeRatioAvg":1234.1234)"
      R"(,"computeRatioMax":1234.1234,"endMs":10,"id":1234,"inputStages":[1234])"
      R"(,"name":"test-explain","parallelInputs":1234,"readMsAvg":10,"readMsMax":10)"
      R"(,"readRatioAvg":1234.1234,"readRatioMax":1234.1234,"recordsRead":1234)"
      R"(,"recordsWritten":1234,"shuffleOutputBytes":1234,"shuffleOutputBytesSpilled":1234)"
      R"(,"slotMs":10,"startMs":10,"status":"explain-status","steps":[{"kind":"sub-step-kind")"
      R"(,"substeps":["sub-step-1"]}],"waitMsAvg":10,"waitMsMax":10,"waitRatioAvg":1234.1234)"
      R"(,"waitRatioMax":1234.1234,"writeMsAvg":10,"writeMsMax":10,"writeRatioAvg":1234.1234)"
      ...
      R"(,"tableId":"3"},"code":{"value":"BASE_TABLE_TOO_SMALL"},"indexName":"test-index")"
      R"(,"message":""}],"indexUsageMode":{"value":"PARTIALLY_USED"}},"statementType":"statement_type")"
      ...
      R"(,"stackFrames":[{"endColumn":1234,"endLine":1234,"procedureId":"proc-id")"
      R"(,"startColumn":1234,"startLine":1234,"text":"stack-frame-text"}]})"
      R"(,"sessionInfo":{"sessionId":"session-id-123"},"startTime":10,"totalBytesProcessed":1234)"
      R"(,"totalSlotMs":10,"transactionInfo":{"transactionId":"transaction-id-123"}})"
      R"(,"status":{"errorResult":{"location":"","message":"","reason":""},"errors":[])"
      R"(,"state":"DONE"},"user_email":"a@b.com"})";
