...
TEST(JobTest, JobToFromJson) {
  auto const* const expected_text =
      ...
      R"("allow_large_results":false,"clustering":{"fields":[]})"
      R"(,"connection_properties":[],"continuous":false)"
      R"(,"create_disposition":"","create_session":false)"
      R"(,"default_dataset":{"dataset_id":"","project_id":""})"
      R"(,"destination_encryption_configuration":{)"
      R"("kms_key_name":""},"destination_table":{"dataset_id":"")"
      R"(,"project_id":"","table_id":""},"flatten_results":false)"
      R"(,"maximum_bytes_billed":0,"parameter_mode":"","preserve_nulls":false)"
      R"(,"priority":"","query":"select 1;","query_parameters":[])"
      R"(,"range_partitioning":{"field":"","range":{"end":"","interval":"")"
      R"(,"start":""}},"schema_update_options":[],"script_options":{)"
      R"("key_result_statement":{"value":""},"statement_byte_budget":0)"
      R"(,"statement_timeout_ms":0},"system_variables":{"types":{},"values":{)"
      R"("fields":{}}},"time_partitioning":{"expiration_time":0,"field":"")"
      R"(,"type":""},"use_legacy_sql":false,"use_query_cache":false)"
      R"(,"write_disposition":""}},"etag":"etag","id":"1","kind":"Job")"
      R"(,"reference":{"job_id":"2","location":"","project_id":"1"})"
      R"(,"self_link":"","statistics":{"completion_ratio":1234.1234)"
      R"(,"creation_time":10,"data_masking_applied":true,"end_time":10)"
      ...
      R"(,"statement_type":"statement_type","timeline":[{)"
      R"("active_units":1234,"completed_units":1234,"elapsed_time":10)"
...
TEST(JobTest, ListFormatJobToFromJson) {
  auto const* const expected_text =
      ...
      R"(,"query":"select 1;","query_parameters":[],"range_partitioning":{)"
      R"("field":"","range":{"end":"","interval":"","start":""}})"
      R"(,"schema_update_options":[],"script_options":{)"
      R"("key_result_statement":{"value":""},"statement_byte_budget":0)"
      R"(,"statement_timeout_ms":0},"system_variables":{"types":{})"
      R"(,"values":{"fields":{}}},"time_partitioning":{"expiration_time":0)"
      R"(,"field":"","type":""},"use_legacy_sql":false)"
      R"(,"use_query_cache":false,"write_disposition":""}})"
      R"(,"error_result":{"location":"","message":"","reason":""})"
      R"(,"id":"1","kind":"Job","principal_subject":"","reference":{)"
      ...
      R"(,"parallel_inputs":1234)"
      R"(,"read_avg_time_spent":10,"read_max_time_spent":10)"
      R"(,"read_ratio_avg":1234.1234)"
      R"(,"read_ratio_max":1234.1234,"records_read":1234)"
      ...
      R"(,"session_id":"session-id-123","start_time":10)"
      R"(,"total_bytes_processed":1234,"total_modified_partitions":1234)"
      R"(,"total_slot_time":10,"transaction_id":"transaction-id-123"},"status":{)"
      R"("error_result":{"location":"","message":"","reason":""},"errors":[])"
      R"(,"state":"DONE"},"user_email":""})";
