...
std::string Table::DebugString(absl::string_view name,
  ...
  return internal::DebugFormatter(name, options, indent)
      ...
      .StringField("num_time_travel_physical_bytes",
                   num_time_travel_physical_bytes)
      .StringField("num_total_logical_bytes", num_total_logical_bytes)
      .StringField("num_active_logical_bytes", num_active_logical_bytes)
      .StringField("num_long_term_logical_bytes", num_long_term_logical_bytes)
      .StringField("num_total_physical_bytes", num_total_physical_bytes)
      .StringField("num_active_physical_bytes", num_active_physical_bytes)
      .StringField("num_long_term_physical_bytes", num_long_term_physical_bytes)
      .StringField("num_partitions", num_partitions)
      .StringField("num_bytes", num_bytes)
      .StringField("num_physical_bytes", num_physical_bytes)
      .StringField("num_long_term_bytes", num_long_term_bytes)
      .Field("labels", labels)
