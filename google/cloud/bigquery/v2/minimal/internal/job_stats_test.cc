...
TEST(JobStatsTest, JobStatsToFromJson) {
  auto const* const expected_text =
      ...
      R"(,"computeMode":{"value":"BIGQUERY"},"computeMsAvg":10,"computeMsMax":10,"computeRatioAvg":1234.1234)"
      ...
      R"(,"scriptStatistics":{"evaluationKind":{"value":"STATEMENT"},"stackFrames":[{"endColumn":1234)"
