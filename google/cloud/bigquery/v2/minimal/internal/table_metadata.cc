...
// Implementation of internal interface for Bigquery V2 Table resource.
...
StatusOr<ListTablesResponse> TableMetadata::ListTables(
    rest_internal::RestContext& context, ListTablesRequest const& request) {
  SetMetadata(context);
  return child_->ListTables(context, request);
}

void TableMetadata::SetMetadata(rest_internal::RestContext& rest_context,
