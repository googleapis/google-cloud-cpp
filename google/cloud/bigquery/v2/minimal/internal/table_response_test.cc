...
TEST(GetTableResponseTest, DebugString) {
  ...
  EXPECT_EQ(
      ...
      R"( description: "t-description" type: "t-type" location: "t-location")"
      R"( default_collation: "t-defaultcollation" max_staleness: "stale")"
      R"( require_partition_filter: true case_insensitive: true)"
      ...
      R"( table_id: "t-123" } schema { fields { name: "fname-1" type: "")"
      R"( mode: "fmode" description: "" collation: "" default_value_expression: "")"
      R"( max_length: 0 precision: 0 scale: 0 is_measure: true)"
      ...
      R"( field: "range-partition-field" range { start: "" end: "" interval: "" } })"
      R"( clustering { fields: "c-field-1" } clone_definition { base_table_reference {)"
      R"( project_id: "t-123" dataset_id: "t-123" table_id: "t-123" })"
      R"( clone_time { "1970-01-01T00:00:00Z" } } table_constraints {)"
      R"( primary_key { columns: "pcol-1" } foreign_keys { key_name: "fkey-1")"
      R"( referenced_table { project_id: "" dataset_id: "" table_id: "" } } })"
      R"( view { query: "select 1;" use_legacy_sql: false)"
      R"( use_explicit_column_names: true } materialized_view {)"
      R"( query: "select 1;" max_staleness: "" allow_non_incremental_definition: false)"
      R"( enable_refresh: true refresh_interval_time { "0" } last_refresh_time {)"
      R"( "1970-01-01T00:00:00Z" } } materialized_view_status {)"
  ...
  EXPECT_EQ(
      ...
      R"(GetTableResponse { table { kind: "t-kind" etag: "t-etag" id: "t-id")"
      R"( self_link: "t-selfl...<truncated>..." friendly_name: "t-frien...<truncated>...")"
      R"( description: "t-descr...<truncated>..." type: "t-type")"
      R"( location: "t-locat...<truncated>..." default_collation: "t-defau...<truncated>...")"
      R"( max_staleness: "stale" require_partition_filter: true case_insensitive: true)"
      R"( creation_time { "1970-01-01T00:00:00.001Z" })"
      R"( expiration_time { "1970-01-01T00:00:00.001Z" })"
      R"( last_modified_time { "1970-01-01T00:00:00.001Z" })"
      R"( num_time_travel_physical_bytes: 1 num_total_logical_bytes: 1)"
      ...
      R"( description: "" collation: "" default_value_expression: "" max_length: 0)"
      R"( precision: 0 scale: 0 is_measure: true)"
      R"( categories { } policy_tags { } data_classification_tags { })"
      R"( rounding_mode { value: "" } range_element_type { type: "" } } })"
      R"( default_rounding_mode { value: "ROUND_H...<truncated>..." })"
      R"( time_partitioning { type: "" expiration_time { "123ms" })"
      R"( field: "time-pa...<truncated>..." } range_partitioning {)"
      R"( field: "range-p...<truncated>..." range { start: "" end: "" interval: "" } })"
      R"( clustering { fields: "c-field...<truncated>..." })"
      R"( clone_definition { base_table_reference {)"
      R"( project_id: "t-123" dataset_id: "t-123" table_id: "t-123" })"
      R"( clone_time { "1970-01-01T00:00:00Z" } } table_constraints {)"
      R"( primary_key { columns: "pcol-1" } foreign_keys {)"
      R"( key_name: "fkey-1" referenced_table {)"
      R"( project_id: "" dataset_id: "" table_id: "" } } })"
      R"( view { query: "select ...<truncated>..." use_legacy_sql: false)"
      R"( use_explicit_column_names: true } materialized_view {)"
      R"( query: "select ...<truncated>..." max_staleness: "")"
      R"( allow_non_incremental_definition: false enable_refresh: true)"
      R"( refresh_interval_time { "0" } last_refresh_time { "1970-01-01T00:00:00Z" } })"
      R"( materialized_view_status { last_refresh_status {)"
      R"( reason: "" location: "" message: "" })"
      R"( refresh_watermark { "1970-01-01T00:00:00.123Z" } } })"
      R"( http_response { status_code: 200)"
      R"( http_headers { key: "header1" value: "value1" } payload: REDACTED } })");
