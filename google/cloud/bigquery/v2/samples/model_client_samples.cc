...
// main-dox-marker: bigquery_v2::ModelServiceClient
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::bigquery_v2::ModelServiceClient(
      google::cloud::bigquery_v2::MakeModelServiceConnection(options));
  //! [set-client-endpoint]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::bigquery_v2::ModelServiceClient(
        google::cloud::bigquery_v2::MakeModelServiceConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
