...
#include "google/cloud/bigquery/v2/internal/model_connection_impl.h"
#include "google/cloud/bigquery/v2/internal/model_option_defaults.h"
...
std::shared_ptr<ModelServiceConnection> MakeModelServiceConnection(
  ...
  internal::CheckExpectedOptions<CommonOptionList, GrpcOptionList,
                                 ...
                                 ModelServicePolicyOptionList>(options,
                                                               __func__);
  options =
      bigquery_v2_internal::ModelServiceDefaultOptions(std::move(options));
  auto background = internal::MakeBackgroundThreadsFactory(options)();
  auto stub = bigquery_v2_internal::CreateDefaultModelServiceStub(
      background->cq(), options);
  return bigquery_v2_internal::MakeModelServiceTracingConnection(
      std::make_shared<bigquery_v2_internal::ModelServiceConnectionImpl>(
