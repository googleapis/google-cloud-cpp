...
///     types defined in bigquery_datapolicies_v1 instead of the aliases defined in
///     this namespace.
namespace bigquery {
GOOGLE_CLOUD_CPP_INLINE_NAMESPACE_BEGIN

/// @deprecated Use bigquery_datapolicies_v1::DataPolicyServiceClient directly.
using ::google::cloud::bigquery_datapolicies_v1::DataPolicyServiceClient;
