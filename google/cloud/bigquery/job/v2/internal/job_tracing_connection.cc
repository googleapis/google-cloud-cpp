...
JobServiceTracingConnection::CancelJob(
  ...
  auto span =
      internal::MakeSpan("bigquery_job_v2::JobServiceConnection::CancelJob");
...
StatusOr<google::cloud::bigquery::v2::Job> JobServiceTracingConnection::GetJob(
  ...
  auto span =
      internal::MakeSpan("bigquery_job_v2::JobServiceConnection::GetJob");
  auto scope = opentelemetry::trace::Scope(span);
...
JobServiceTracingConnection::InsertJob(
  ...
  auto span =
      internal::MakeSpan("bigquery_job_v2::JobServiceConnection::InsertJob");
  auto scope = opentelemetry::trace::Scope(span);
...
Status JobServiceTracingConnection::DeleteJob(
  ...
  auto span =
      internal::MakeSpan("bigquery_job_v2::JobServiceConnection::DeleteJob");
  auto scope = opentelemetry::trace::Scope(span);
...
JobServiceTracingConnection::ListJobs(
  ...
  auto span =
      internal::MakeSpan("bigquery_job_v2::JobServiceConnection::ListJobs");
...
JobServiceTracingConnection::GetQueryResults(
  ...
  auto span = internal::MakeSpan(
      "bigquery_job_v2::JobServiceConnection::GetQueryResults");
  auto scope = opentelemetry::trace::Scope(span);
...
JobServiceTracingConnection::Query(
  ...
  auto span =
      internal::MakeSpan("bigquery_job_v2::JobServiceConnection::Query");
  auto scope = opentelemetry::trace::Scope(span);
