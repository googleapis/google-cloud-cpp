...
// clang-format off
// main-dox-marker: bigquery_datapolicies_v2::DataPolicyServiceClient
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client =
      google::cloud::bigquery_datapolicies_v2::DataPolicyServiceClient(
          google::cloud::bigquery_datapolicies_v2::
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client =
      google::cloud::bigquery_datapolicies_v2::DataPolicyServiceClient(
          google::cloud::bigquery_datapolicies_v2::
              MakeDataPolicyServiceConnection(*ud_options));
  //! [set-client-universe-domain]
}

//! [custom-idempotency-policy]
class CustomIdempotencyPolicy
    : public google::cloud::bigquery_datapolicies_v2::
          DataPolicyServiceConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::bigquery_datapolicies_v2::
                      DataPolicyServiceConnectionIdempotencyPolicy>
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
      ...
      google::cloud::Options{}
          ...
          .set<google::cloud::bigquery_datapolicies_v2::
              ...
              google::cloud::ExponentialBackoffPolicy(
                  ...
                  .clone());
  auto connection =
      google::cloud::bigquery_datapolicies_v2::MakeDataPolicyServiceConnection(
          options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::bigquery_datapolicies_v2::DataPolicyServiceClient(
      connection);
  auto c2 = google::cloud::bigquery_datapolicies_v2::DataPolicyServiceClient(
      connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::bigquery_datapolicies_v2::DataPolicyServiceClient(
  ...
  //     .set<google::cloud::bigquery_datapolicies_v2::DataPolicyServiceRetryPolicyOption>(
  //       google::cloud::bigquery_datapolicies_v2::DataPolicyServiceLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::bigquery_datapolicies_v2::DataPolicyServiceClient(
        google::cloud::bigquery_datapolicies_v2::
            MakeDataPolicyServiceConnection(options));
  }
  //! [with-service-account]
