...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_BIGQUERY_DATAPOLICIES_V2_INTERNAL_DATA_POLICY_STUB_H
...
class DefaultDataPolicyServiceStub : public DataPolicyServiceStub {
 public:
  explicit DefaultDataPolicyServiceStub(
      std::unique_ptr<google::cloud::bigquery::datapolicies::v2::
 ...
 private:
  std::unique_ptr<google::cloud::bigquery::datapolicies::v2::DataPolicyService::
                      StubInterface>
      grpc_stub_;
};
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_BIGQUERY_DATAPOLICIES_V2_INTERNAL_DATA_POLICY_STUB_H
