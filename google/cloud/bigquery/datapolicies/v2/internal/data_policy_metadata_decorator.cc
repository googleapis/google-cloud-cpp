...
#include "google/cloud/bigquery/datapolicies/v2/internal/data_policy_metadata_decorator.h"
...
StatusOr<google::cloud::bigquery::datapolicies::v2::DataPolicy>
DataPolicyServiceMetadata::AddGrantees(
    grpc::ClientContext& context, Options const& options,
    google::cloud::bigquery::datapolicies::v2::AddGranteesRequest const&
        request) {
  SetMetadata(
      context, options,
      absl::StrCat("data_policy=", internal::UrlEncode(request.data_policy())));
  return child_->AddGrantees(context, options, request);
}

StatusOr<google::cloud::bigquery::datapolicies::v2::DataPolicy>
DataPolicyServiceMetadata::RemoveGrantees(
    grpc::ClientContext& context, Options const& options,
  ...
  SetMetadata(
      context, options,
      absl::StrCat("data_policy=", internal::UrlEncode(request.data_policy())));
  return child_->RemoveGrantees(context, options, request);
}
