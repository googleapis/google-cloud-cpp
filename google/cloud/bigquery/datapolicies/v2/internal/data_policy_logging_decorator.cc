...
#include "google/cloud/bigquery/datapolicies/v2/internal/data_policy_logging_decorator.h"
...
StatusOr<google::cloud::bigquery::datapolicies::v2::DataPolicy>
DataPolicyServiceLogging::AddGrantees(
    grpc::ClientContext& context, Options const& options,
...
StatusOr<google::cloud::bigquery::datapolicies::v2::DataPolicy>
DataPolicyServiceLogging::RemoveGrantees(
    grpc::ClientContext& context, Options const& options,
  ...
  return google::cloud::internal::LogWrapper(
      [this](grpc::ClientContext& context, Options const& options,
             google::cloud::bigquery::datapolicies::v2::
                 RemoveGranteesRequest const& request) {
