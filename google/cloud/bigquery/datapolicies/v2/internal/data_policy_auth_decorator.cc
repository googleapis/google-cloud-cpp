...
#include "google/cloud/bigquery/datapolicies/v2/internal/data_policy_auth_decorator.h"
...
StatusOr<google::cloud::bigquery::datapolicies::v2::DataPolicy>
DataPolicyServiceAuth::AddGrantees(
    grpc::ClientContext& context, Options const& options,
...
StatusOr<google::cloud::bigquery::datapolicies::v2::DataPolicy>
DataPolicyServiceAuth::RemoveGrantees(
    grpc::ClientContext& context, Options const& options,
