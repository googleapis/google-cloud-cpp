...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_BIGQUERY_DATAPOLICIES_V2_DATA_POLICY_CONNECTION_IDEMPOTENCY_POLICY_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_BIGQUERY_DATAPOLICIES_V2_DATA_POLICY_CONNECTION_IDEMPOTENCY_POLICY_H
...
class DataPolicyServiceConnectionIdempotencyPolicy {
 public:
  ...
  virtual google::cloud::Idempotency AddGrantees(
      google::cloud::bigquery::datapolicies::v2::AddGranteesRequest const&
          request);

  virtual google::cloud::Idempotency RemoveGrantees(
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_BIGQUERY_DATAPOLICIES_V2_DATA_POLICY_CONNECTION_IDEMPOTENCY_POLICY_H
