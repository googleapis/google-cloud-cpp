...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_BIGQUERY_DATAPOLICIES_V1_INTERNAL_DATA_POLICY_TRACING_STUB_H
...
class DataPolicyServiceTracingStub : public DataPolicyServiceStub {
 public:
  ...
  explicit DataPolicyServiceTracingStub(std::shared_ptr<DataPolicyServiceStub> child);
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_BIGQUERY_DATAPOLICIES_V1_INTERNAL_DATA_POLICY_TRACING_STUB_H
