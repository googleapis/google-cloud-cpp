...
/**
 * A retry policy for `DataPolicyServiceConnection` that stops retrying after a
...
class DataPolicyServiceLimitedErrorCountRetryPolicy
 ...
 public:
  DataPolicyServiceLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `DataPolicyServiceConnection` that stops retrying after
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_BIGQUERY_DATAPOLICIES_V1_DATA_POLICY_CONNECTION_H
