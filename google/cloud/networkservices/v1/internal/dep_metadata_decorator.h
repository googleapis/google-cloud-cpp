...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_NETWORKSERVICES_V1_INTERNAL_DEP_METADATA_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_NETWORKSERVICES_V1_INTERNAL_DEP_METADATA_DECORATOR_H
...
class DepServiceMetadata : public DepServiceStub {
 public:
  ~DepServiceMetadata() override = default;
  DepServiceMetadata(std::shared_ptr<DepServiceStub> child,
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_NETWORKSERVICES_V1_INTERNAL_DEP_METADATA_DECORATOR_H
