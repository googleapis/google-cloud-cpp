...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_NETWORKSERVICES_V1_INTERNAL_DEP_LOGGING_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_NETWORKSERVICES_V1_INTERNAL_DEP_LOGGING_DECORATOR_H
...
class DepServiceLogging : public DepServiceStub {
 public:
  ~DepServiceLogging() override = default;
  DepServiceLogging(std::shared_ptr<DepServiceStub> child,
