...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::networkservices_v1::DepServiceClient(
      google::cloud::networkservices_v1::MakeDepServiceConnection(*ud_options));
  //! [set-client-universe-domain]
}
...
class CustomIdempotencyPolicy : public google::cloud::networkservices_v1::
 ...
 public:
  ...
  std::unique_ptr<
      google::cloud::networkservices_v1::DepServiceConnectionIdempotencyPolicy>
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
      ...
      google::cloud::Options{}
          ...
          .set<google::cloud::networkservices_v1::DepServiceRetryPolicyOption>(
              google::cloud::networkservices_v1::
                  DepServiceLimitedErrorCountRetryPolicy(3)
                      .clone())
          .set<
              google::cloud::networkservices_v1::DepServiceBackoffPolicyOption>(
  ...
  auto c3 = google::cloud::networkservices_v1::DepServiceClient(
      ...
      google::cloud::Options{}
          .set<google::cloud::networkservices_v1::DepServiceRetryPolicyOption>(
              google::cloud::networkservices_v1::
                  DepServiceLimitedTimeRetryPolicy(std::chrono::minutes(5))
                      .clone()));
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options =
      google::cloud::Options{}
          .set<
              google::cloud::networkservices_v1::DepServicePollingPolicyOption>(
              google::cloud::GenericPollingPolicy<
                  google::cloud::networkservices_v1::
                      DepServiceRetryPolicyOption::Type,
                  google::cloud::networkservices_v1::
                      DepServiceBackoffPolicyOption::Type>(
                  google::cloud::networkservices_v1::
