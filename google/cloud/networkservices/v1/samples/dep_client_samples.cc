...
// clang-format off
// main-dox-marker: networkservices_v1::DepServiceClient
// lro-marker: true
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::networkservices_v1::DepServiceClient(
...
class CustomIdempotencyPolicy
   : public google::cloud::networkservices_v1::DepServiceConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::networkservices_v1::DepServiceConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::networkservices_v1::DepServiceConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::networkservices_v1::DepServiceRetryPolicyOption>(
      google::cloud::networkservices_v1::DepServiceLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::networkservices_v1::DepServiceBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::networkservices_v1::MakeDepServiceConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::networkservices_v1::DepServiceClient(connection);
  auto c2 = google::cloud::networkservices_v1::DepServiceClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::networkservices_v1::DepServiceClient(
    connection, google::cloud::Options{}.set<google::cloud::networkservices_v1::DepServiceRetryPolicyOption>(
      google::cloud::networkservices_v1::DepServiceLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::networkservices_v1::DepServiceRetryPolicyOption>(
  //       google::cloud::networkservices_v1::DepServiceLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::networkservices_v1::DepServicePollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::networkservices_v1::DepServiceRetryPolicyOption::Type,
            google::cloud::networkservices_v1::DepServiceBackoffPolicyOption::Type>(
            google::cloud::networkservices_v1::DepServiceLimitedTimeRetryPolicy(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::networkservices_v1::DepServiceClient(
      google::cloud::networkservices_v1::MakeDepServiceConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
