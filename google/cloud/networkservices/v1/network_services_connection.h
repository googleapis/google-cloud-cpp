...
/**
 * A retry policy for `NetworkServicesConnection` that stops retrying after a
...
class NetworkServicesLimitedErrorCountRetryPolicy
 ...
 public:
  NetworkServicesLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `NetworkServicesConnection` that stops retrying after
