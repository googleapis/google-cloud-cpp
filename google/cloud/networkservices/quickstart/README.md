# HOWTO: using the Network Services API C++ client in your project

This directory contains small examples showing how to use the Network Services API C++
...
Like most Google Cloud Platform (GCP) services, Network Services API requires that
...
1. Install the dependencies with your favorite tools. As an example, if you use
   ...
   ```bash
   cd $HOME/vcpkg
   ./vcpkg install google-cloud-cpp[core,networkservices]
   ```
...
[quickstart-link]: https://cloud.google.com/traffic-director/docs/service-routing-setup-guides
