...
std::shared_ptr<AppConnectorsServiceStub> CreateDefaultAppConnectorsServiceStub(
  ...
  auto service_grpc_stub = google::cloud::beyondcorp::appconnectors::v1::
      AppConnectorsService::NewStub(channel);
  std::shared_ptr<AppConnectorsServiceStub> stub =
      std::make_shared<DefaultAppConnectorsServiceStub>(
  ...
  if (internal::TracingEnabled(options)) {
    stub = MakeAppConnectorsServiceTracingStub(std::move(stub));
  }
  return stub;
}
