...
#include "google/cloud/beyondcorp/internal/client_connector_services_logging_decorator.h"
#include "google/cloud/beyondcorp/internal/client_connector_services_metadata_decorator.h"
...
CreateDefaultClientConnectorServicesServiceStub(
  ...
  auto service_grpc_stub = google::cloud::beyondcorp::clientconnectorservices::
      v1::ClientConnectorServicesService::NewStub(channel);
  std::shared_ptr<ClientConnectorServicesServiceStub> stub =
      std::make_shared<DefaultClientConnectorServicesServiceStub>(
  ...
  if (internal::TracingEnabled(options)) {
    stub = MakeClientConnectorServicesServiceTracingStub(std::move(stub));
  }
  return stub;
}
