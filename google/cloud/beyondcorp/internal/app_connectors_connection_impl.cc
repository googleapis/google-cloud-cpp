...
inline std::unique_ptr<beyondcorp::AppConnectorsServiceRetryPolicy>
retry_policy() {
  return internal::CurrentOptions()
      .get<beyondcorp::AppConnectorsServiceRetryPolicyOption>()
      ->clone();
}

inline std::unique_ptr<BackoffPolicy> backoff_policy() {
  return internal::CurrentOptions()
      .get<beyondcorp::AppConnectorsServiceBackoffPolicyOption>()
      ->clone();
}

inline std::unique_ptr<
    beyondcorp::AppConnectorsServiceConnectionIdempotencyPolicy>
idempotency_policy() {
  return internal::CurrentOptions()
      .get<beyondcorp::AppConnectorsServiceConnectionIdempotencyPolicyOption>()
      ->clone();
}

inline std::unique_ptr<PollingPolicy> polling_policy() {
  return internal::CurrentOptions()
      .get<beyondcorp::AppConnectorsServicePollingPolicyOption>()
      ->clone();
}
