...
#include "google/cloud/beyondcorp/internal/app_connectors_auth_decorator.h"
...
AppConnectorsServiceAuth::AppConnectorsServiceAuth(
...
AppConnectorsServiceAuth::AsyncCreateAppConnector(
  ...
  return auth_->AsyncConfigureContext(std::move(context))
      .then([cq, child,
        ...
        return child->AsyncCreateAppConnector(cq, *std::move(context), request);
      });
}
...
AppConnectorsServiceAuth::AsyncUpdateAppConnector(
  ...
  return auth_->AsyncConfigureContext(std::move(context))
      .then([cq, child,
        ...
        return child->AsyncUpdateAppConnector(cq, *std::move(context), request);
      });
}

future<StatusOr<google::longrunning::Operation>>
AppConnectorsServiceAuth::AsyncDeleteAppConnector(
    google::cloud::CompletionQueue& cq,
    std::unique_ptr<grpc::ClientContext> context,
    google::cloud::beyondcorp::appconnectors::v1::
  ...
  return auth_->AsyncConfigureContext(std::move(context))
      .then([cq, child,
        ...
        return child->AsyncDeleteAppConnector(cq, *std::move(context), request);
      });
}
...
AppConnectorsServiceAuth::AsyncReportStatus(
  ...
  return auth_->AsyncConfigureContext(std::move(context))
      .then([cq, child,
        ...
        return child->AsyncReportStatus(cq, *std::move(context), request);
      });
}

future<StatusOr<google::longrunning::Operation>>
AppConnectorsServiceAuth::AsyncGetOperation(
    google::cloud::CompletionQueue& cq,
    std::unique_ptr<grpc::ClientContext> context,
...
future<Status> AppConnectorsServiceAuth::AsyncCancelOperation(
    google::cloud::CompletionQueue& cq,
    std::unique_ptr<grpc::ClientContext> context,
