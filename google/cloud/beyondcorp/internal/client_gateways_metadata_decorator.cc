...
#include "google/cloud/beyondcorp/internal/client_gateways_metadata_decorator.h"
...
ClientGatewaysServiceMetadata::ListClientGateways(
...
ClientGatewaysServiceMetadata::GetClientGateway(
    grpc::ClientContext& context,
    google::cloud::beyondcorp::clientgateways::v1::
...
void ClientGatewaysServiceMetadata::SetMetadata(
