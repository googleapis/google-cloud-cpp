...
///     types defined in beyondcorp_appconnections_v1 instead of the aliases defined in
///     this namespace.
namespace beyondcorp {
GOOGLE_CLOUD_CPP_INLINE_NAMESPACE_BEGIN

/// @deprecated Use beyondcorp_appconnections_v1::AppConnectionsServiceClient directly.
using ::google::cloud::beyondcorp_appconnections_v1::AppConnectionsServiceClient;
