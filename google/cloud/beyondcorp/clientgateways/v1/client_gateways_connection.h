...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_BEYONDCORP_CLIENTGATEWAYS_V1_CLIENT_GATEWAYS_CONNECTION_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_BEYONDCORP_CLIENTGATEWAYS_V1_CLIENT_GATEWAYS_CONNECTION_H
...
/**
 * A retry policy for `ClientGatewaysServiceConnection` that stops retrying
...
class ClientGatewaysServiceLimitedErrorCountRetryPolicy
 ...
 public:
  ClientGatewaysServiceLimitedErrorCountRetryPolicy(int maximum_failures)
 ...
 * -
 * `google::cloud::beyondcorp_clientgateways_v1::ClientGatewaysServicePolicyOptionList`
 *
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_BEYONDCORP_CLIENTGATEWAYS_V1_CLIENT_GATEWAYS_CONNECTION_H
