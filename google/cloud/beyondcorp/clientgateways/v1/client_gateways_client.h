...
class ClientGatewaysServiceClient {
 public:
  ...
  ///     [google.cloud.beyondcorp.clientgateways.v1.ClientGateway], or rather,
  ...
  /// [google.cloud.beyondcorp.clientgateways.v1.ClientGateway]: @googleapis_reference_link{google/cloud/beyondcorp/clientgateways/v1/client_gateways_service.proto#L97}
  /// [google.cloud.beyondcorp.clientgateways.v1.ListClientGatewaysRequest]: @googleapis_reference_link{google/cloud/beyondcorp/clientgateways/v1/client_gateways_service.proto#L153}
  ///
  // clang-format on
  ...
  /// [`Status`]: @ref google::cloud::Status
  /// [google.cloud.beyondcorp.clientgateways.v1.ClientGateway]: @googleapis_reference_link{google/cloud/beyondcorp/clientgateways/v1/client_gateways_service.proto#L97}
  /// [google.cloud.beyondcorp.clientgateways.v1.GetClientGatewayRequest]: @googleapis_reference_link{google/cloud/beyondcorp/clientgateways/v1/client_gateways_service.proto#L189}
  ///
  // clang-format on
  ...
  /// @param client_gateway_id  Optional. User-settable client gateway resource ID.
  ...
  ///     [google.cloud.beyondcorp.clientgateways.v1.ClientGateway] proto message.
  ...
  /// [`Status`]: @ref google::cloud::Status
  /// [google.cloud.beyondcorp.clientgateways.v1.ClientGateway]: @googleapis_reference_link{google/cloud/beyondcorp/clientgateways/v1/client_gateways_service.proto#L97}
  /// [google.cloud.beyondcorp.clientgateways.v1.CreateClientGatewayRequest]: @googleapis_reference_link{google/cloud/beyondcorp/clientgateways/v1/client_gateways_service.proto#L200}
  ///
  // clang-format on
  ...
  ///     error. If the LRO completes successfully the value of the future
  ///     contains the LRO's result. For this RPC the result is a
  ///     [google.cloud.beyondcorp.clientgateways.v1.ClientGatewayOperationMetadata] proto message.
  ///     The C++ class representing this message is created by Protobuf, using
  ///     the [Protobuf mapping rules].
  ///
  /// [Protobuf mapping rules]: https://protobuf.dev/reference/cpp/cpp-generated/
  ...
  /// [`StatusOr`]: @ref google::cloud::StatusOr
  /// [`Status`]: @ref google::cloud::Status
  /// [google.cloud.beyondcorp.clientgateways.v1.ClientGatewayOperationMetadata]: @googleapis_reference_link{google/cloud/beyondcorp/clientgateways/v1/client_gateways_service.proto#L269}
  /// [google.cloud.beyondcorp.clientgateways.v1.DeleteClientGatewayRequest]: @googleapis_reference_link{google/cloud/beyondcorp/clientgateways/v1/client_gateways_service.proto#L239}
  ///
  // clang-format on
