...
#include "google/cloud/beyondcorp/clientconnectorservices/v1/mocks/mock_client_connector_services_connection.h"
...
/// directly.
using ::google::cloud::beyondcorp_clientconnectorservices_v1_mocks::
