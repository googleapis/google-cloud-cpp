...
AppGatewaysServiceMetadata::SetIamPolicy(
    grpc::ClientContext& context,
    Options const& options,
...
StatusOr<google::iam::v1::Policy>
AppGatewaysServiceMetadata::GetIamPolicy(
    grpc::ClientContext& context,
    Options const& options,
...
Status
AppGatewaysServiceMetadata::DeleteOperation(
    grpc::ClientContext& context,
    Options const& options,
...
Status
AppGatewaysServiceMetadata::CancelOperation(
    grpc::ClientContext& context,
    Options const& options,
