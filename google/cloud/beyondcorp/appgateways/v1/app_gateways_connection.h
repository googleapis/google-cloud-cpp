...
/**
 * A retry policy for `AppGatewaysServiceConnection` that stops retrying after a
...
class AppGatewaysServiceLimitedErrorCountRetryPolicy
 ...
 public:
  AppGatewaysServiceLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `AppGatewaysServiceConnection` that stops retrying after
