...
class MockAppConnectorsServiceConnection : public beyondcorp_appconnectors_v1::AppConnectorsServiceConnection {
 public:
  ...
  /// EXPECT_CALL(*mock, CreateAppConnector(Matcher<google::cloud::beyondcorp::appconnectors::v1::CreateAppConnectorRequest const&>(_)))
  /// @endcode
  ...
  /// using ::testing::_;
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock, CreateAppConnector(Matcher<google::longrunning::Operation const&>(_)))
  /// @endcode
  MOCK_METHOD(future<StatusOr<google::cloud::beyondcorp::appconnectors::v1::AppConnector>>,
  CreateAppConnector, (
  ...
  /// using ::testing::_;
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock, UpdateAppConnector(Matcher<google::cloud::beyondcorp::appconnectors::v1::UpdateAppConnectorRequest const&>(_)))
  /// @endcode
  MOCK_METHOD(future<StatusOr<google::cloud::beyondcorp::appconnectors::v1::AppConnector>>,
  UpdateAppConnector,
  ...
  /// using ::testing::_;
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock, UpdateAppConnector(Matcher<google::longrunning::Operation const&>(_)))
  /// @endcode
  MOCK_METHOD(future<StatusOr<google::cloud::beyondcorp::appconnectors::v1::AppConnector>>,
  UpdateAppConnector, (
    google::longrunning::Operation const& operation), (override));
  ...
  /// using ::testing::_;
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock, DeleteAppConnector(Matcher<google::cloud::beyondcorp::appconnectors::v1::DeleteAppConnectorRequest const&>(_)))
  /// @endcode
  ...
  /// using ::testing::_;
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock, DeleteAppConnector(Matcher<google::longrunning::Operation const&>(_)))
  /// @endcode
  MOCK_METHOD(future<StatusOr<google::cloud::beyondcorp::appconnectors::v1::AppConnectorOperationMetadata>>,
  DeleteAppConnector, (
    google::longrunning::Operation const& operation), (override));
  ...
  /// using ::testing::_;
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock, ReportStatus(Matcher<google::cloud::beyondcorp::appconnectors::v1::ReportStatusRequest const&>(_)))
  /// @endcode
  MOCK_METHOD(future<StatusOr<google::cloud::beyondcorp::appconnectors::v1::AppConnector>>,
  ReportStatus,
  ...
  /// using ::testing::_;
  /// using ::testing::Matcher;
  /// EXPECT_CALL(*mock, ReportStatus(Matcher<google::longrunning::Operation const&>(_)))
  /// @endcode
  MOCK_METHOD(future<StatusOr<google::cloud::beyondcorp::appconnectors::v1::AppConnector>>,
  ReportStatus, (
    google::longrunning::Operation const& operation), (override));
