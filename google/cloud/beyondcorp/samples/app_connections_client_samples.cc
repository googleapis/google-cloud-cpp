...
// main-dox-marker: GOOGLE_CLOUD_CPP_NS::AppConnectionsServiceClient
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::GOOGLE_CLOUD_CPP_NS::AppConnectionsServiceClient(
      google::cloud::GOOGLE_CLOUD_CPP_NS::MakeAppConnectionsServiceConnection(
          options));
  //! [set-client-endpoint]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::GOOGLE_CLOUD_CPP_NS::AppConnectionsServiceClient(
        google::cloud::GOOGLE_CLOUD_CPP_NS::MakeAppConnectionsServiceConnection(
            options));
  }
  //! [with-service-account]
