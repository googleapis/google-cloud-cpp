...
// main-dox-marker: GOOGLE_CLOUD_CPP_NS::AppGatewaysServiceClient
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::GOOGLE_CLOUD_CPP_NS::AppGatewaysServiceClient(
      google::cloud::GOOGLE_CLOUD_CPP_NS::MakeAppGatewaysServiceConnection(
          options));
  //! [set-client-endpoint]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::GOOGLE_CLOUD_CPP_NS::AppGatewaysServiceClient(
        google::cloud::GOOGLE_CLOUD_CPP_NS::MakeAppGatewaysServiceConnection(
            options));
  }
  //! [with-service-account]
