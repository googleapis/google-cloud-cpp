...
// main-dox-marker: GOOGLE_CLOUD_CPP_NS::AppConnectorsServiceClient
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::GOOGLE_CLOUD_CPP_NS::AppConnectorsServiceClient(
      google::cloud::GOOGLE_CLOUD_CPP_NS::MakeAppConnectorsServiceConnection(
          options));
  //! [set-client-endpoint]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::GOOGLE_CLOUD_CPP_NS::AppConnectorsServiceClient(
        google::cloud::GOOGLE_CLOUD_CPP_NS::MakeAppConnectorsServiceConnection(
            options));
  }
  //! [with-service-account]
