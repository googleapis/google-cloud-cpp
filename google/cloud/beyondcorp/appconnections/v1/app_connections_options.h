...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_BEYONDCORP_APPCONNECTIONS_V1_APP_CONNECTIONS_OPTIONS_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_BEYONDCORP_APPCONNECTIONS_V1_APP_CONNECTIONS_OPTIONS_H
...
struct AppConnectionsServiceConnectionIdempotencyPolicyOption {
  using Type = std::shared_ptr<AppConnectionsServiceConnectionIdempotencyPolicy>;
};
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_BEYONDCORP_APPCONNECTIONS_V1_APP_CONNECTIONS_OPTIONS_H
