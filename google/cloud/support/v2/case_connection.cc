...
StreamRange<google::cloud::support::v2::Case> CaseServiceConnection::ListCases(
    google::cloud::support::v2::ListCasesRequest) {  // NOLINT(performance-unnecessary-value-param)
  return google::cloud::internal::MakeUnimplementedPaginationRange<
      StreamRange<google::cloud::support::v2::Case>>();
}

StreamRange<google::cloud::support::v2::Case> CaseServiceConnection::SearchCases(
    google::cloud::support::v2::SearchCasesRequest) {  // NOLINT(performance-unnecessary-value-param)
  return google::cloud::internal::MakeUnimplementedPaginationRange<
      StreamRange<google::cloud::support::v2::Case>>();
}

StatusOr<google::cloud::support::v2::Case>
CaseServiceConnection::CreateCase(
    google::cloud::support::v2::CreateCaseRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

StatusOr<google::cloud::support::v2::Case>
CaseServiceConnection::UpdateCase(
    google::cloud::support::v2::UpdateCaseRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

StatusOr<google::cloud::support::v2::Case>
CaseServiceConnection::EscalateCase(
    google::cloud::support::v2::EscalateCaseRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

StatusOr<google::cloud::support::v2::Case>
CaseServiceConnection::CloseCase(
    google::cloud::support::v2::CloseCaseRequest const&) {
  return Status(StatusCode::kUnimplemented, "not implemented");
}

StreamRange<google::cloud::support::v2::CaseClassification> CaseServiceConnection::SearchCaseClassifications(
    google::cloud::support::v2::SearchCaseClassificationsRequest) {  // NOLINT(performance-unnecessary-value-param)
  return google::cloud::internal::MakeUnimplementedPaginationRange<
...
std::shared_ptr<CaseServiceConnection> MakeCaseServiceConnection(
  ...
  internal::CheckExpectedOptions<CommonOptionList, GrpcOptionList,
      ...
      CaseServicePolicyOptionList>(options, __func__);
  options = support_v2_internal::CaseServiceDefaultOptions(
      std::move(options));
