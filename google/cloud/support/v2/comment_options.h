 ...
 */
struct CommentServiceRetryPolicyOption {
  using Type = std::shared_ptr<CommentServiceRetryPolicy>;
};
 ...
 * @ingroup google-cloud-support-options
 */
struct CommentServiceBackoffPolicyOption {
 ...
 * @ingroup google-cloud-support-options
 */
struct CommentServiceConnectionIdempotencyPolicyOption {
  using Type = std::shared_ptr<CommentServiceConnectionIdempotencyPolicy>;
};
 ...
 * @ingroup google-cloud-support-options
 */
using CommentServicePolicyOptionList =
    OptionList<CommentServiceRetryPolicyOption,
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SUPPORT_V2_COMMENT_OPTIONS_H
