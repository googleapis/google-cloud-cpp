...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SUPPORT_V2_MOCKS_MOCK_COMMENT_CONNECTION_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SUPPORT_V2_MOCKS_MOCK_COMMENT_CONNECTION_H
...
/**
 * A class to mock `CommentServiceConnection`.
 *
 * Application developers may want to test their code with simulated responses,
 * including errors, from an object of type `CommentServiceClient`. To do so,
 * construct an object of type `CommentServiceClient` with an instance of this
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SUPPORT_V2_MOCKS_MOCK_COMMENT_CONNECTION_H
