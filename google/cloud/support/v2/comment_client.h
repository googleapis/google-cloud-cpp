...
class CommentServiceClient {
 public:
  ...
  ///     backoff policies.
  /// @return
  /// @googleapis_link{google::cloud::support::v2::Comment,google/cloud/support/v2/comment.proto#L33}
  ///
  /// [google.cloud.support.v2.Comment]:
  /// @googleapis_reference_link{google/cloud/support/v2/comment.proto#L33}
  /// [google.cloud.support.v2.ListCommentsRequest]:
  /// @googleapis_reference_link{google/cloud/support/v2/comment_service.proto#L66}
  ///
  ...
  ///
  /// @param request
  /// @googleapis_link{google::cloud::support::v2::ListCommentsRequest,google/cloud/support/v2/comment_service.proto#L66}
  /// @param opts Optional. Override the class-level options, such as retry and
  ///     backoff policies.
  /// @return
  /// @googleapis_link{google::cloud::support::v2::Comment,google/cloud/support/v2/comment.proto#L33}
  ...
  /// @googleapis_reference_link{google/cloud/support/v2/comment_service.proto#L96}
  ///
  ...
  ///
  /// @param request
  /// @googleapis_link{google::cloud::support::v2::CreateCommentRequest,google/cloud/support/v2/comment_service.proto#L96}
  /// @param opts Optional. Override the class-level options, such as retry and
  ///     backoff policies.
  /// @return
  /// @googleapis_link{google::cloud::support::v2::Comment,google/cloud/support/v2/comment.proto#L33}
