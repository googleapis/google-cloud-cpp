...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::support_v2::CommentServiceClient(
...
void SetClientUniverseDomain(std::vector<std::string> const& argv) {
  ...
  auto ud_client = google::cloud::support_v2::CommentServiceClient(
      google::cloud::support_v2::MakeCommentServiceConnection(*ud_options));
  //! [set-client-universe-domain]
}
