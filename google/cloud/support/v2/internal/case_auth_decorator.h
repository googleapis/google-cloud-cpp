...
class CaseServiceAuth : public CaseServiceStub {
 public:
  ~CaseServiceAuth() override = default;
  CaseServiceAuth(
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SUPPORT_V2_INTERNAL_CASE_AUTH_DECORATOR_H
