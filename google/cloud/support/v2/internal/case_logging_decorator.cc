...
CaseServiceLogging::CaseServiceLogging(
...
StatusOr<google::cloud::support::v2::Case>
CaseServiceLogging::EscalateCase(
    grpc::ClientContext& context,
    Options const& options,
