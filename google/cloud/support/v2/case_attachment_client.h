...
class CaseAttachmentServiceClient {
 public:
  ...
  ///     backoff policies.
  /// @return
  /// @googleapis_link{google::cloud::support::v2::Attachment,google/cloud/support/v2/attachment.proto#L33}
  ///
  /// [google.cloud.support.v2.Attachment]:
  /// @googleapis_reference_link{google/cloud/support/v2/attachment.proto#L33}
  /// [google.cloud.support.v2.ListAttachmentsRequest]:
  /// @googleapis_reference_link{google/cloud/support/v2/attachment_service.proto#L53}
  ///
  ...
  ///
  /// @param request
  /// @googleapis_link{google::cloud::support::v2::ListAttachmentsRequest,google/cloud/support/v2/attachment_service.proto#L53}
  /// @param opts Optional. Override the class-level options, such as retry and
  ///     backoff policies.
  /// @return
  /// @googleapis_link{google::cloud::support::v2::Attachment,google/cloud/support/v2/attachment.proto#L33}
