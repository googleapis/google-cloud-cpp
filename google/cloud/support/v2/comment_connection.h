...
/**
 * A retry policy for `CommentServiceConnection` that stops retrying after a
...
class CommentServiceLimitedErrorCountRetryPolicy
 ...
 public:
  CommentServiceLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `CommentServiceConnection` that stops retrying after
