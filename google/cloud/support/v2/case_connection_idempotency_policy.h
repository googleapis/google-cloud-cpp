...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SUPPORT_V2_CASE_CONNECTION_IDEMPOTENCY_POLICY_H
...
class CaseServiceConnectionIdempotencyPolicy {
 public:
  virtual ~CaseServiceConnectionIdempotencyPolicy();
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SUPPORT_V2_CASE_CONNECTION_IDEMPOTENCY_POLICY_H
