 ...
 */
struct CaseAttachmentServiceRetryPolicyOption {
  using Type = std::shared_ptr<CaseAttachmentServiceRetryPolicy>;
};
 ...
 * @ingroup google-cloud-support-options
 */
struct CaseAttachmentServiceBackoffPolicyOption {
 ...
 * @ingroup google-cloud-support-options
 */
using CaseAttachmentServicePolicyOptionList =
    OptionList<CaseAttachmentServiceRetryPolicyOption,
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SUPPORT_V2_CASE_ATTACHMENT_OPTIONS_H
