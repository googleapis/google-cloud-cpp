# HOWTO: using the Google Cloud Support API C++ client in your project

This directory contains small examples showing how to use the Google
Cloud Support API C++ client library in your own project. These
...
Like most Google Cloud Platform (GCP) services, Google Cloud Support API requires that
...
1. Install the dependencies with your favorite tools. As an example, if you use
   ...
   ```bash
   cd $HOME/vcpkg
   ./vcpkg install google-cloud-cpp[core,support]
   ```
...
[quickstart-link]: https://cloud.google.com/support/docs
