...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto vpc_client = google::cloud::certificatemanager_v1::CertificateManagerClient(
      google::cloud::certificatemanager_v1::MakeCertificateManagerConnection(options));
  //! [set-client-endpoint]
}

//! [custom-idempotency-policy]
class CustomIdempotencyPolicy
   : public google::cloud::certificatemanager_v1::CertificateManagerConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::certificatemanager_v1::CertificateManagerConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::certificatemanager_v1::CertificateManagerConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::certificatemanager_v1::CertificateManagerRetryPolicyOption>(
      google::cloud::certificatemanager_v1::CertificateManagerLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::certificatemanager_v1::CertificateManagerBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::certificatemanager_v1::MakeCertificateManagerConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::certificatemanager_v1::CertificateManagerClient(connection);
  auto c2 = google::cloud::certificatemanager_v1::CertificateManagerClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::certificatemanager_v1::CertificateManagerClient(
    connection, google::cloud::Options{}.set<google::cloud::certificatemanager_v1::CertificateManagerRetryPolicyOption>(
      google::cloud::certificatemanager_v1::CertificateManagerLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::certificatemanager_v1::CertificateManagerRetryPolicyOption>(
  //       google::cloud::certificatemanager_v1::CertificateManagerLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::certificatemanager_v1::CertificateManagerPollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::certificatemanager_v1::CertificateManagerRetryPolicyOption::Type,
            google::cloud::certificatemanager_v1::CertificateManagerBackoffPolicyOption::Type>(
            google::cloud::certificatemanager_v1::CertificateManagerLimitedTimeRetryPolicy(
