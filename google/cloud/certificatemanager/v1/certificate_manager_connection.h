...
/**
 * A retry policy for `CertificateManagerConnection` that stops retrying after a
...
class CertificateManagerLimitedErrorCountRetryPolicy
 ...
 public:
  CertificateManagerLimitedErrorCountRetryPolicy(int maximum_failures)
...
/// A retry policy for `CertificateManagerConnection` that stops retrying after
